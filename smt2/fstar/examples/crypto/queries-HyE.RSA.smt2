...
; Externals for module Platform.Bytes


; <Start encoding val Platform.Bytes.repr_bytes>

(declare-fun Platform.Bytes.repr_bytes (Term) Term)
(declare-fun Tm_refine_afd51579b90d50ea23e03b743a1fa001 () Term)
;;;;;;;;;;;;;;;;_: Prims.nat -> Prims.GTot (n: Prims.nat{n > 0})
(declare-fun Tm_ghost_arrow_e8dde62a64f921f287ef0a724591b3a2 () Term)
(declare-fun Platform.Bytes.repr_bytes@tok () Term)


; </end encoding val Platform.Bytes.repr_bytes>


; <Start encoding val Platform.Bytes.lemma_repr_bytes_values>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun Platform.Bytes.lemma_repr_bytes_values (Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun Platform.Bytes.lemma_repr_bytes_values@tok () Term)

; </end encoding val Platform.Bytes.lemma_repr_bytes_values>


; <Start encoding let byte>

(declare-fun Platform.Bytes.byte () Term)

; </end encoding let byte>


; <Start encoding let cbytes>

(declare-fun Platform.Bytes.cbytes (Dummy_sort) Term)

; </end encoding let cbytes>


; <Start encoding let bytes>

(declare-fun Platform.Bytes.bytes () Term)

; </end encoding let bytes>


; <Start encoding assume Platform.Bytes.HasEq_bytes>


; </end encoding assume Platform.Bytes.HasEq_bytes>


; <Skipped val Platform.Bytes.seq_of_bytes/>


; <Start encoding let seq_of_bytes>

(declare-fun Platform.Bytes.seq_of_bytes (Term) Term)
;;;;;;;;;;;;;;;;b: bytes -> Prims.GTot (FStar.Seq.Base.seq FStar.UInt8.t)
(declare-fun Tm_ghost_arrow_e8dc5ff8d3aeaaab9d17b93a0e3c09c9 () Term)
(declare-fun Platform.Bytes.seq_of_bytes@tok () Term)

; </end encoding let seq_of_bytes>


; <Skipped val Platform.Bytes.op_At_Bar/>


; <Start encoding let op_At_Bar>

(declare-fun Platform.Bytes.op_At_Bar (Term Term) Term)
;;;;;;;;;;;;;;;;b1: bytes -> b2: bytes -> bytes
(declare-fun Tm_arrow_9e2030d31b883d5b9e98cf3d0b69422d () Term)
(declare-fun Platform.Bytes.op_At_Bar@tok () Term)

; </end encoding let op_At_Bar>


; <Skipped val Platform.Bytes.length/>


; <Start encoding let length>

(declare-fun Platform.Bytes.length (Term) Term)
;;;;;;;;;;;;;;;;b: bytes -> Prims.nat
(declare-fun Tm_arrow_365e3ea077448db51133be0c8d32bf2b () Term)
(declare-fun Platform.Bytes.length@tok () Term)

; </end encoding let length>


; <Start encoding let lbytes>

(declare-fun Platform.Bytes.lbytes (Term) Term)

(declare-fun Platform.Bytes.lbytes@tok () Term)
(declare-fun Tm_refine_b3982a6d174e1d047431ae85c35dc7d8 (Term) Term)

; </end encoding let lbytes>


; <Skipped val Platform.Bytes.empty_bytes/>


; <Start encoding let empty_bytes>

(declare-fun Platform.Bytes.empty_bytes (Dummy_sort) Term)

; </end encoding let empty_bytes>


; <Start encoding val Platform.Bytes.abytes>

(declare-fun Platform.Bytes.abytes (Term) Term)
;;;;;;;;;;;;;;;;_: cbytes -> bytes
(declare-fun Tm_arrow_d811ce1b6039f1eed3242d952da317f5 () Term)
(declare-fun Platform.Bytes.abytes@tok () Term)

; </end encoding val Platform.Bytes.abytes>


; <Skipped val Platform.Bytes.abyte/>


; <Start encoding let abyte>

(declare-fun Platform.Bytes.abyte (Term) Term)
;;;;;;;;;;;;;;;;b: FStar.UInt8.t -> bytes
(declare-fun Tm_arrow_2bfe5899ce4c38431792fbd0437e5d26 () Term)
(declare-fun Platform.Bytes.abyte@tok () Term)

; </end encoding let abyte>


; <Skipped val Platform.Bytes.abyte2/>


; <Start encoding let abyte2>

(declare-fun Platform.Bytes.abyte2 (Term) Term)
;;;;;;;;;;;;;;;;_: FStar.UInt8.t & FStar.UInt8.t -> bytes
(declare-fun Tm_arrow_1e59dd8ff440083c930196dc7123121c () Term)
(declare-fun Platform.Bytes.abyte2@tok () Term)

; </end encoding let abyte2>


; <Start encoding val Platform.Bytes.get_cbytes>

(declare-fun Platform.Bytes.get_cbytes (Term) Term)
;;;;;;;;;;;;;;;;_: bytes -> cbytes
(declare-fun Tm_arrow_c7ed6d2d7b62865e87ae9247b55f3834 () Term)
(declare-fun Platform.Bytes.get_cbytes@tok () Term)

; </end encoding val Platform.Bytes.get_cbytes>


; <Skipped val Platform.Bytes.cbyte/>


; <Start encoding let cbyte>

(declare-fun Tm_refine_9f61c0ee1ebed7248bd016eb62ec2174 () Term)
(declare-fun Platform.Bytes.cbyte (Term) Term)

;;;;;;;;;;;;;;;;b: bytes{FStar.Seq.Base.length b > 0} -> FStar.UInt8.t
(declare-fun Tm_arrow_66303a1b5a3916ded9d3fef296f86ee7 () Term)
(declare-fun Platform.Bytes.cbyte@tok () Term)


; </end encoding let cbyte>


; <Skipped val Platform.Bytes.cbyte2/>


; <Start encoding let cbyte2>

(declare-fun Tm_refine_ea5dbefce270769c7885e1a331aaf62b () Term)
(declare-fun Platform.Bytes.cbyte2 (Term) Term)

;;;;;;;;;;;;;;;;b: bytes{FStar.Seq.Base.length b >= 2} -> FStar.UInt8.t & FStar.UInt8.t
(declare-fun Tm_arrow_1f42bedfe0d82226258d1361e589af11 () Term)
(declare-fun Platform.Bytes.cbyte2@tok () Term)


; </end encoding let cbyte2>


; <Skipped val Platform.Bytes.index/>


; <Start encoding let index>

(declare-fun Tm_refine_4c9438b7d33c86109a70d224911faa33 (Term) Term)
(declare-fun Platform.Bytes.index (Term Term) Term)

;;;;;;;;;;;;;;;;b: bytes -> i: Prims.nat{FStar.Seq.Base.length b > i} -> FStar.UInt8.t
(declare-fun Tm_arrow_07cc7cc66f331194c3b882149ce28766 () Term)
(declare-fun Platform.Bytes.index@tok () Term)


; </end encoding let index>


; <Skipped val Platform.Bytes.createBytes/>


; <Start encoding let createBytes>

(declare-fun Platform.Bytes.createBytes (Term Term) Term)
;;;;;;;;;;;;;;;;l: Prims.nat -> b: FStar.UInt8.t -> lbytes l
(declare-fun Tm_arrow_6bf77242b040691fd10f6bf058169ac5 () Term)
(declare-fun Platform.Bytes.createBytes@tok () Term)

; </end encoding let createBytes>


; <Skipped val Platform.Bytes.initBytes/>


; <Start encoding let initBytes>


;;;;;;;;;;;;;;;;i: Prims.nat{i < l} -> FStar.UInt8.t
(declare-fun Tm_arrow_21e30605255fc38aaeb948ae6522c51a (Term) Term)
(declare-fun Platform.Bytes.initBytes (Term Term) Term)


;;;;;;;;;;;;;;;;l: Prims.nat -> f: (i: Prims.nat{i < l} -> FStar.UInt8.t) -> lbytes l
(declare-fun Tm_arrow_179a4316fb6ead7b244373dc83201ec6 () Term)
(declare-fun Platform.Bytes.initBytes@tok () Term)



; </end encoding let initBytes>


; <Start encoding val Platform.Bytes.equalBytes>

(declare-fun Platform.Bytes.equalBytes (Term Term) Term)
(declare-fun Tm_refine_80ee390faac14219b179447f9069a246 (Term Term) Term)
;;;;;;;;;;;;;;;;b1: bytes -> b2: bytes -> b: Prims.bool{b = (b1 = b2)}
(declare-fun Tm_arrow_5fd4d0191ad796c30bb9f9bccc05c2a0 () Term)
(declare-fun Platform.Bytes.equalBytes@tok () Term)


; </end encoding val Platform.Bytes.equalBytes>


; <Start encoding val Platform.Bytes.xor>

(declare-fun Platform.Bytes.xor (Term Term Term) Term)
;;;;;;;;;;;;;;;;l: Prims.nat -> _: lbytes l -> _: lbytes l -> lbytes l
(declare-fun Tm_arrow_0ba185ff2a025cfdfce96efef38446ef () Term)
(declare-fun Platform.Bytes.xor@tok () Term)

; </end encoding val Platform.Bytes.xor>


; <Skipped val Platform.Bytes.split/>


; <Start encoding let split>

(declare-fun Tm_refine_667a832d49afa5939e79462b1abb7118 (Term) Term)
(declare-fun Platform.Bytes.split (Term Term) Term)

(declare-fun Tm_refine_aec271157dda1ea0055f91dea0fb91e2 (Term Term) Term)
;;;;;;;;;;;;;;;;b: bytes -> n: Prims.nat{n <= FStar.Seq.Base.length b}   -> x:     (bytes & bytes)       { FStar.Seq.Base.length (FStar.Pervasives.Native.fst x) = n /\         FStar.Seq.Base.length (FStar.Pervasives.Native.snd x) == FStar.Seq.Base.length b - n }
(declare-fun Tm_arrow_0c08065242a27aebe1edbeecad0010d3 () Term)
(declare-fun Platform.Bytes.split@tok () Term)
...
; <Skipped val Platform.Bytes.lemma_split/>


; <Start encoding let lemma_split>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun Platform.Bytes.lemma_split (Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun Platform.Bytes.lemma_split@tok () Term)

; </end encoding let lemma_split>


; <Skipped val Platform.Bytes.split_eq/>


; <Start encoding let split_eq>

(declare-fun Tm_refine_9765e8d5fa76912a9e96f2f886b65533 (Term) Term)
(declare-fun Platform.Bytes.split_eq (Term Term) Term)

(declare-fun Tm_refine_ac93c9c62e39fbf770521004ecbde3ee (Term Term) Term)
;;;;;;;;;;;;;;;;s: bytes -> i: Prims.nat{0 <= i /\ i <= length s}   -> Prims.Pure     (x:       (bytes & bytes)         { length (FStar.Pervasives.Native.fst x) = i &&           length (FStar.Pervasives.Native.snd x) = length s - i })
(declare-fun Tm_arrow_332e655e81cb3766e5d90b520f36b906 () Term)
(declare-fun Platform.Bytes.split_eq@tok () Term)
...
; <Skipped val Platform.Bytes.lemma_append_inj/>


; <Start encoding let lemma_append_inj>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun Platform.Bytes.lemma_append_inj (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun Platform.Bytes.lemma_append_inj@tok () Term)

; </end encoding let lemma_append_inj>


; <Start encoding let append_empty_bytes_l>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun Platform.Bytes.append_empty_bytes_l (Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun Platform.Bytes.append_empty_bytes_l@tok () Term)

; </end encoding let append_empty_bytes_l>


; <Start encoding let append_empty_bytes_r>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun Platform.Bytes.append_empty_bytes_r (Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun Platform.Bytes.append_empty_bytes_r@tok () Term)

; </end encoding let append_empty_bytes_r>


; <Start encoding let append_assoc>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun Platform.Bytes.append_assoc (Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun Platform.Bytes.append_assoc@tok () Term)

; </end encoding let append_assoc>


; <Start encoding val Platform.Bytes.split2>


(declare-fun Tm_refine_2a78c953ca46f869031ed988eff33673 (Term Term) Term)
(declare-fun Platform.Bytes.split2 (Term Term Term) Term)


;;;;;;;;;;;;;;;;b: bytes ->     n1: Prims.nat{n1 <= FStar.Seq.Base.length b} ->     n2: Prims.nat{n1 + n2 <= FStar.Seq.Base.length b}   -> lbytes n1 & lbytes n2 & lbytes (length b - n1 - n2)
(declare-fun Tm_arrow_581a969ceb402b2d98879a43de722ddc () Term)
(declare-fun Platform.Bytes.split2@tok () Term)

; </end encoding val Platform.Bytes.split2>


; <Start encoding val Platform.Bytes.bytes_of_int>

(declare-fun Tm_refine_dea97037577a331b16b27d60ea1f3274 (Term) Term)
(declare-fun Platform.Bytes.bytes_of_int (Term Term) Term)

;;;;;;;;;;;;;;;;l: Prims.nat -> n: Prims.nat{repr_bytes n <= l} -> lbytes l
(declare-fun Tm_arrow_4ea791e849d95d60871431972b62c0dc () Term)
(declare-fun Platform.Bytes.bytes_of_int@tok () Term)

; </end encoding val Platform.Bytes.bytes_of_int>


; <Start encoding val Platform.Bytes.int_of_bytes>

(declare-fun Platform.Bytes.int_of_bytes (Term) Term)
(declare-fun Tm_refine_0643f30616668b6c2208c12d5e73aa3a (Term) Term)
;;;;;;;;;;;;;;;;b: bytes   -> n:     Prims.nat       { repr_bytes n <= FStar.Seq.Base.length b /\ (FStar.Seq.Base.length b = 1 ==> n < 256) /\         b = bytes_of_int (FStar.Seq.Base.length b) n }
(declare-fun Tm_arrow_9a8068ed500be53ad1c006c422935575 () Term)
(declare-fun Platform.Bytes.int_of_bytes@tok () Term)


; </end encoding val Platform.Bytes.int_of_bytes>


; <Start encoding val Platform.Bytes.int_of_bytes_of_int>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun Platform.Bytes.int_of_bytes_of_int (Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun Platform.Bytes.int_of_bytes_of_int@tok () Term)

; </end encoding val Platform.Bytes.int_of_bytes_of_int>


; <Start encoding val Platform.Bytes.utf8>

(declare-fun Platform.Bytes.utf8 (Term) Term)
;;;;;;;;;;;;;;;;_: Prims.string -> bytes
(declare-fun Tm_arrow_1f7cc8992de6f854f838e918b4b31066 () Term)
(declare-fun Platform.Bytes.utf8@tok () Term)

; </end encoding val Platform.Bytes.utf8>


; <Start encoding val Platform.Bytes.iutf8_opt>

(declare-fun Platform.Bytes.iutf8_opt (Term) Term)
(declare-fun Tm_refine_60dec82ab41f03ba1c1a91d4aee1d1ea (Term) Term)
;;;;;;;;;;;;;;;;m: bytes -> FStar.Pervasives.Native.option (s: Prims.string{utf8 s = m})
(declare-fun Tm_arrow_cbd7788405177a03e40f355760facb1d () Term)
(declare-fun Platform.Bytes.iutf8_opt@tok () Term)


; </end encoding val Platform.Bytes.iutf8_opt>


; <Start encoding val Platform.Bytes.iutf8>

(declare-fun Platform.Bytes.iutf8 (Term) Term)

;;;;;;;;;;;;;;;;m: bytes -> s: Prims.string{utf8 s = m}
(declare-fun Tm_arrow_5e592d1f8f5f0f80d51b66f469faa86c () Term)
(declare-fun Platform.Bytes.iutf8@tok () Term)


; </end encoding val Platform.Bytes.iutf8>


; <Start encoding val Platform.Bytes.print_bytes>

(declare-fun Platform.Bytes.print_bytes (Term) Term)
;;;;;;;;;;;;;;;;_: bytes -> Prims.string
(declare-fun Tm_arrow_d57341c8cc4d2442a37b9d0c16dce2f8 () Term)
(declare-fun Platform.Bytes.print_bytes@tok () Term)

; </end encoding val Platform.Bytes.print_bytes>


; <Skipped val Platform.Bytes.byte_of_int/>


; <Start encoding let byte_of_int>

(declare-fun Tm_refine_31c7d3d85d92cb942c95a78642e657c7 () Term)
(declare-fun Platform.Bytes.byte_of_int (Term) Term)

;;;;;;;;;;;;;;;;n: Prims.nat{n < 256} -> FStar.UInt8.t
(declare-fun Tm_arrow_dc0caa3ac4d2eb60e55b41b249a44c6a () Term)
(declare-fun Platform.Bytes.byte_of_int@tok () Term)


; </end encoding let byte_of_int>


; <Start encoding val Platform.Bytes.bytes_of_hex>

(declare-fun Platform.Bytes.bytes_of_hex (Term) Term)

(declare-fun Platform.Bytes.bytes_of_hex@tok () Term)

; </end encoding val Platform.Bytes.bytes_of_hex>


; <Start encoding val Platform.Bytes.hex_of_bytes>

(declare-fun Platform.Bytes.hex_of_bytes (Term) Term)

(declare-fun Platform.Bytes.hex_of_bytes@tok () Term)

; </end encoding val Platform.Bytes.hex_of_bytes>


; <Start encoding val Platform.Bytes.string_of_hex>

(declare-fun Platform.Bytes.string_of_hex (Term) Term)
;;;;;;;;;;;;;;;;_: Prims.string -> Prims.string
(declare-fun Tm_arrow_70affe4dada4ca8ba18740c614ba5211 () Term)
(declare-fun Platform.Bytes.string_of_hex@tok () Term)

; </end encoding val Platform.Bytes.string_of_hex>


; <Start encoding val Platform.Bytes.hex_of_string>

(declare-fun Platform.Bytes.hex_of_string (Term) Term)

(declare-fun Platform.Bytes.hex_of_string@tok () Term)

; </end encoding val Platform.Bytes.hex_of_string>


; End Externals for module Platform.Bytes


; Externals for module CoreCrypto


; <Start encoding type CoreCrypto.hash_alg>

;;;;;;;;;;;;;;;;Constructor
(declare-fun CoreCrypto.hash_alg () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun CoreCrypto.MD5 () Term)
;;;;;;;;;;;;;;;;data constructor proxy: CoreCrypto.MD5
(declare-fun CoreCrypto.MD5@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun CoreCrypto.SHA1 () Term)
;;;;;;;;;;;;;;;;data constructor proxy: CoreCrypto.SHA1
(declare-fun CoreCrypto.SHA1@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun CoreCrypto.SHA224 () Term)
;;;;;;;;;;;;;;;;data constructor proxy: CoreCrypto.SHA224
(declare-fun CoreCrypto.SHA224@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun CoreCrypto.SHA256 () Term)
;;;;;;;;;;;;;;;;data constructor proxy: CoreCrypto.SHA256
(declare-fun CoreCrypto.SHA256@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun CoreCrypto.SHA384 () Term)
;;;;;;;;;;;;;;;;data constructor proxy: CoreCrypto.SHA384
(declare-fun CoreCrypto.SHA384@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun CoreCrypto.SHA512 () Term)
;;;;;;;;;;;;;;;;data constructor proxy: CoreCrypto.SHA512
(declare-fun CoreCrypto.SHA512@tok () Term)

; <start constructor CoreCrypto.hash_alg>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-CoreCrypto.hash_alg ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
101)
(= __@x0
CoreCrypto.hash_alg)))

; </end constructor CoreCrypto.hash_alg>


; <start constructor CoreCrypto.MD5>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-CoreCrypto.MD5 ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
107)
(= __@x0
CoreCrypto.MD5)))

; </end constructor CoreCrypto.MD5>


; <start constructor CoreCrypto.SHA1>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-CoreCrypto.SHA1 ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
109)
(= __@x0
CoreCrypto.SHA1)))

; </end constructor CoreCrypto.SHA1>


; <start constructor CoreCrypto.SHA224>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-CoreCrypto.SHA224 ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
111)
(= __@x0
CoreCrypto.SHA224)))

; </end constructor CoreCrypto.SHA224>


; <start constructor CoreCrypto.SHA256>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-CoreCrypto.SHA256 ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
113)
(= __@x0
CoreCrypto.SHA256)))

; </end constructor CoreCrypto.SHA256>


; <start constructor CoreCrypto.SHA384>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-CoreCrypto.SHA384 ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
115)
(= __@x0
CoreCrypto.SHA384)))

; </end constructor CoreCrypto.SHA384>


; <start constructor CoreCrypto.SHA512>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-CoreCrypto.SHA512 ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
117)
(= __@x0
CoreCrypto.SHA512)))

; </end constructor CoreCrypto.SHA512>


; </end encoding type CoreCrypto.hash_alg>


; <Start encoding assume CoreCrypto.hash_alg__uu___haseq>


; </end encoding assume CoreCrypto.hash_alg__uu___haseq>


; <Start encoding val CoreCrypto.uu___is_MD5>

(declare-fun CoreCrypto.uu___is_MD5 (Term) Term)
;;;;;;;;;;;;;;;;projectee: hash_alg -> Prims.bool
(declare-fun Tm_arrow_7aba0b7da43c44df0b0653ccc2a25e40 () Term)
(declare-fun CoreCrypto.uu___is_MD5@tok () Term)

; </end encoding val CoreCrypto.uu___is_MD5>


; <Skipped let uu___is_MD5/>


; <Start encoding val CoreCrypto.uu___is_SHA1>

(declare-fun CoreCrypto.uu___is_SHA1 (Term) Term)

(declare-fun CoreCrypto.uu___is_SHA1@tok () Term)

; </end encoding val CoreCrypto.uu___is_SHA1>


; <Skipped let uu___is_SHA1/>


; <Start encoding val CoreCrypto.uu___is_SHA224>

(declare-fun CoreCrypto.uu___is_SHA224 (Term) Term)

(declare-fun CoreCrypto.uu___is_SHA224@tok () Term)

; </end encoding val CoreCrypto.uu___is_SHA224>


; <Skipped let uu___is_SHA224/>


; <Start encoding val CoreCrypto.uu___is_SHA256>

(declare-fun CoreCrypto.uu___is_SHA256 (Term) Term)

(declare-fun CoreCrypto.uu___is_SHA256@tok () Term)

; </end encoding val CoreCrypto.uu___is_SHA256>


; <Skipped let uu___is_SHA256/>


; <Start encoding val CoreCrypto.uu___is_SHA384>

(declare-fun CoreCrypto.uu___is_SHA384 (Term) Term)

(declare-fun CoreCrypto.uu___is_SHA384@tok () Term)

; </end encoding val CoreCrypto.uu___is_SHA384>


; <Skipped let uu___is_SHA384/>


; <Start encoding val CoreCrypto.uu___is_SHA512>

(declare-fun CoreCrypto.uu___is_SHA512 (Term) Term)

(declare-fun CoreCrypto.uu___is_SHA512@tok () Term)

; </end encoding val CoreCrypto.uu___is_SHA512>


; <Skipped let uu___is_SHA512/>


; <Start encoding let hashSize>

(declare-fun CoreCrypto.hashSize (Term) Term)
;;;;;;;;;;;;;;;;_: hash_alg -> Prims.int
(declare-fun Tm_arrow_d1bb27529af64f54130ffb82af6b0361 () Term)
(declare-fun CoreCrypto.hashSize@tok () Term)

; </end encoding let hashSize>


; <Start encoding val CoreCrypto.hash>

(declare-fun CoreCrypto.hash (Term Term) Term)
(declare-fun Tm_refine_ae61e173a3c4cc520beacd1d06b1ca39 (Term) Term)
;;;;;;;;;;;;;;;;alg: hash_alg -> _: Platform.Bytes.bytes   -> h: Platform.Bytes.bytes{Platform.Bytes.length h = hashSize alg}
(declare-fun Tm_arrow_d8fe9a308b4c4ae434826b627a3e932e () Term)
(declare-fun CoreCrypto.hash@tok () Term)


; </end encoding val CoreCrypto.hash>


; <Start encoding val CoreCrypto.hmac>

(declare-fun CoreCrypto.hmac (Term Term Term) Term)

;;;;;;;;;;;;;;;;alg: hash_alg -> _: Platform.Bytes.bytes -> _: Platform.Bytes.bytes   -> h: Platform.Bytes.bytes{Platform.Bytes.length h = hashSize alg}
(declare-fun Tm_arrow_5d94b49591c099cee2ba5c5e627be790 () Term)
(declare-fun CoreCrypto.hmac@tok () Term)


; </end encoding val CoreCrypto.hmac>


; <Start encoding val CoreCrypto.hash_ctx>

(declare-fun CoreCrypto.hash_ctx () Term)

; </end encoding val CoreCrypto.hash_ctx>


; <Start encoding val CoreCrypto.digest_create>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun CoreCrypto.digest_create (Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun CoreCrypto.digest_create@tok () Term)

; </end encoding val CoreCrypto.digest_create>


; <Start encoding val CoreCrypto.digest_update>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun CoreCrypto.digest_update (Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun CoreCrypto.digest_update@tok () Term)

; </end encoding val CoreCrypto.digest_update>


; <Start encoding val CoreCrypto.digest_final>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun CoreCrypto.digest_final (Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun CoreCrypto.digest_final@tok () Term)

; </end encoding val CoreCrypto.digest_final>


; <Start encoding type CoreCrypto.sig_alg>

;;;;;;;;;;;;;;;;Constructor
(declare-fun CoreCrypto.sig_alg () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun CoreCrypto.RSASIG () Term)
;;;;;;;;;;;;;;;;data constructor proxy: CoreCrypto.RSASIG
(declare-fun CoreCrypto.RSASIG@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun CoreCrypto.DSA () Term)
;;;;;;;;;;;;;;;;data constructor proxy: CoreCrypto.DSA
(declare-fun CoreCrypto.DSA@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun CoreCrypto.ECDSA () Term)
;;;;;;;;;;;;;;;;data constructor proxy: CoreCrypto.ECDSA
(declare-fun CoreCrypto.ECDSA@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun CoreCrypto.RSAPSS () Term)
;;;;;;;;;;;;;;;;data constructor proxy: CoreCrypto.RSAPSS
(declare-fun CoreCrypto.RSAPSS@tok () Term)

; <start constructor CoreCrypto.sig_alg>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-CoreCrypto.sig_alg ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
140)
(= __@x0
CoreCrypto.sig_alg)))

; </end constructor CoreCrypto.sig_alg>


; <start constructor CoreCrypto.RSASIG>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-CoreCrypto.RSASIG ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
146)
(= __@x0
CoreCrypto.RSASIG)))

; </end constructor CoreCrypto.RSASIG>


; <start constructor CoreCrypto.DSA>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-CoreCrypto.DSA ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
148)
(= __@x0
CoreCrypto.DSA)))

; </end constructor CoreCrypto.DSA>


; <start constructor CoreCrypto.ECDSA>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-CoreCrypto.ECDSA ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
150)
(= __@x0
CoreCrypto.ECDSA)))

; </end constructor CoreCrypto.ECDSA>


; <start constructor CoreCrypto.RSAPSS>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-CoreCrypto.RSAPSS ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
152)
(= __@x0
CoreCrypto.RSAPSS)))

; </end constructor CoreCrypto.RSAPSS>


; </end encoding type CoreCrypto.sig_alg>


; <Start encoding assume CoreCrypto.sig_alg__uu___haseq>


; </end encoding assume CoreCrypto.sig_alg__uu___haseq>


; <Start encoding val CoreCrypto.uu___is_RSASIG>

(declare-fun CoreCrypto.uu___is_RSASIG (Term) Term)
;;;;;;;;;;;;;;;;projectee: sig_alg -> Prims.bool
(declare-fun Tm_arrow_87132be0fdb8b82a1a165dbc5c8cfdf2 () Term)
(declare-fun CoreCrypto.uu___is_RSASIG@tok () Term)

; </end encoding val CoreCrypto.uu___is_RSASIG>


; <Skipped let uu___is_RSASIG/>


; <Start encoding val CoreCrypto.uu___is_DSA>

(declare-fun CoreCrypto.uu___is_DSA (Term) Term)

(declare-fun CoreCrypto.uu___is_DSA@tok () Term)

; </end encoding val CoreCrypto.uu___is_DSA>


; <Skipped let uu___is_DSA/>


; <Start encoding val CoreCrypto.uu___is_ECDSA>

(declare-fun CoreCrypto.uu___is_ECDSA (Term) Term)

(declare-fun CoreCrypto.uu___is_ECDSA@tok () Term)

; </end encoding val CoreCrypto.uu___is_ECDSA>


; <Skipped let uu___is_ECDSA/>


; <Start encoding val CoreCrypto.uu___is_RSAPSS>

(declare-fun CoreCrypto.uu___is_RSAPSS (Term) Term)

(declare-fun CoreCrypto.uu___is_RSAPSS@tok () Term)

; </end encoding val CoreCrypto.uu___is_RSAPSS>


; <Skipped let uu___is_RSAPSS/>


; <Start encoding type CoreCrypto.block_cipher>

;;;;;;;;;;;;;;;;Constructor
(declare-fun CoreCrypto.block_cipher () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun CoreCrypto.AES_128_CBC () Term)
;;;;;;;;;;;;;;;;data constructor proxy: CoreCrypto.AES_128_CBC
(declare-fun CoreCrypto.AES_128_CBC@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun CoreCrypto.AES_256_CBC () Term)
;;;;;;;;;;;;;;;;data constructor proxy: CoreCrypto.AES_256_CBC
(declare-fun CoreCrypto.AES_256_CBC@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun CoreCrypto.TDES_EDE_CBC () Term)
;;;;;;;;;;;;;;;;data constructor proxy: CoreCrypto.TDES_EDE_CBC
(declare-fun CoreCrypto.TDES_EDE_CBC@tok () Term)

; <start constructor CoreCrypto.block_cipher>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-CoreCrypto.block_cipher ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
161)
(= __@x0
CoreCrypto.block_cipher)))

; </end constructor CoreCrypto.block_cipher>


; <start constructor CoreCrypto.AES_128_CBC>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-CoreCrypto.AES_128_CBC ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
167)
(= __@x0
CoreCrypto.AES_128_CBC)))

; </end constructor CoreCrypto.AES_128_CBC>


; <start constructor CoreCrypto.AES_256_CBC>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-CoreCrypto.AES_256_CBC ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
169)
(= __@x0
CoreCrypto.AES_256_CBC)))

; </end constructor CoreCrypto.AES_256_CBC>


; <start constructor CoreCrypto.TDES_EDE_CBC>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-CoreCrypto.TDES_EDE_CBC ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
171)
(= __@x0
CoreCrypto.TDES_EDE_CBC)))

; </end constructor CoreCrypto.TDES_EDE_CBC>


; </end encoding type CoreCrypto.block_cipher>


; <Start encoding assume CoreCrypto.block_cipher__uu___haseq>


; </end encoding assume CoreCrypto.block_cipher__uu___haseq>


; <Start encoding val CoreCrypto.uu___is_AES_128_CBC>

(declare-fun CoreCrypto.uu___is_AES_128_CBC (Term) Term)
;;;;;;;;;;;;;;;;projectee: block_cipher -> Prims.bool
(declare-fun Tm_arrow_80709bc0fe5e99c1a067aef6cb1da0ba () Term)
(declare-fun CoreCrypto.uu___is_AES_128_CBC@tok () Term)

; </end encoding val CoreCrypto.uu___is_AES_128_CBC>


; <Skipped let uu___is_AES_128_CBC/>


; <Start encoding val CoreCrypto.uu___is_AES_256_CBC>

(declare-fun CoreCrypto.uu___is_AES_256_CBC (Term) Term)

(declare-fun CoreCrypto.uu___is_AES_256_CBC@tok () Term)

; </end encoding val CoreCrypto.uu___is_AES_256_CBC>


; <Skipped let uu___is_AES_256_CBC/>


; <Start encoding val CoreCrypto.uu___is_TDES_EDE_CBC>

(declare-fun CoreCrypto.uu___is_TDES_EDE_CBC (Term) Term)

(declare-fun CoreCrypto.uu___is_TDES_EDE_CBC@tok () Term)

; </end encoding val CoreCrypto.uu___is_TDES_EDE_CBC>


; <Skipped let uu___is_TDES_EDE_CBC/>


; <Start encoding type CoreCrypto.stream_cipher>

;;;;;;;;;;;;;;;;Constructor
(declare-fun CoreCrypto.stream_cipher () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun CoreCrypto.RC4_128 () Term)
;;;;;;;;;;;;;;;;data constructor proxy: CoreCrypto.RC4_128
(declare-fun CoreCrypto.RC4_128@tok () Term)

; <start constructor CoreCrypto.stream_cipher>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-CoreCrypto.stream_cipher ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
178)
(= __@x0
CoreCrypto.stream_cipher)))

; </end constructor CoreCrypto.stream_cipher>


; <start constructor CoreCrypto.RC4_128>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-CoreCrypto.RC4_128 ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
184)
(= __@x0
CoreCrypto.RC4_128)))

; </end constructor CoreCrypto.RC4_128>


; </end encoding type CoreCrypto.stream_cipher>


; <Start encoding assume CoreCrypto.stream_cipher__uu___haseq>


; </end encoding assume CoreCrypto.stream_cipher__uu___haseq>


; <Start encoding val CoreCrypto.uu___is_RC4_128>

(declare-fun CoreCrypto.uu___is_RC4_128 (Term) Term)
;;;;;;;;;;;;;;;;projectee: stream_cipher -> Prims.bool
(declare-fun Tm_arrow_61300cb0309caf3778a2087618edee70 () Term)
(declare-fun CoreCrypto.uu___is_RC4_128@tok () Term)

; </end encoding val CoreCrypto.uu___is_RC4_128>


; <Skipped let uu___is_RC4_128/>


; <Start encoding type CoreCrypto.rsa_padding>

;;;;;;;;;;;;;;;;Constructor
(declare-fun CoreCrypto.rsa_padding () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun CoreCrypto.Pad_none () Term)
;;;;;;;;;;;;;;;;data constructor proxy: CoreCrypto.Pad_none
(declare-fun CoreCrypto.Pad_none@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun CoreCrypto.Pad_PKCS1 () Term)
;;;;;;;;;;;;;;;;data constructor proxy: CoreCrypto.Pad_PKCS1
(declare-fun CoreCrypto.Pad_PKCS1@tok () Term)

; <start constructor CoreCrypto.rsa_padding>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-CoreCrypto.rsa_padding ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
187)
(= __@x0
CoreCrypto.rsa_padding)))

; </end constructor CoreCrypto.rsa_padding>


; <start constructor CoreCrypto.Pad_none>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-CoreCrypto.Pad_none ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
193)
(= __@x0
CoreCrypto.Pad_none)))

; </end constructor CoreCrypto.Pad_none>


; <start constructor CoreCrypto.Pad_PKCS1>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-CoreCrypto.Pad_PKCS1 ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
195)
(= __@x0
CoreCrypto.Pad_PKCS1)))

; </end constructor CoreCrypto.Pad_PKCS1>


; </end encoding type CoreCrypto.rsa_padding>


; <Start encoding assume CoreCrypto.rsa_padding__uu___haseq>


; </end encoding assume CoreCrypto.rsa_padding__uu___haseq>


; <Start encoding val CoreCrypto.uu___is_Pad_none>

(declare-fun CoreCrypto.uu___is_Pad_none (Term) Term)
;;;;;;;;;;;;;;;;projectee: rsa_padding -> Prims.bool
(declare-fun Tm_arrow_f4f3eb26219c8963b3e69dee11690882 () Term)
(declare-fun CoreCrypto.uu___is_Pad_none@tok () Term)

; </end encoding val CoreCrypto.uu___is_Pad_none>


; <Skipped let uu___is_Pad_none/>


; <Start encoding val CoreCrypto.uu___is_Pad_PKCS1>

(declare-fun CoreCrypto.uu___is_Pad_PKCS1 (Term) Term)

(declare-fun CoreCrypto.uu___is_Pad_PKCS1@tok () Term)

; </end encoding val CoreCrypto.uu___is_Pad_PKCS1>


; <Skipped let uu___is_Pad_PKCS1/>


; <Start encoding let blockSize>

(declare-fun CoreCrypto.blockSize (Term) Term)
;;;;;;;;;;;;;;;;_: block_cipher -> Prims.int
(declare-fun Tm_arrow_34d4407b4847871220b83734c8f993df () Term)
(declare-fun CoreCrypto.blockSize@tok () Term)

; </end encoding let blockSize>


; <Start encoding type CoreCrypto.aead_cipher>

;;;;;;;;;;;;;;;;Constructor
(declare-fun CoreCrypto.aead_cipher () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun CoreCrypto.AES_128_GCM () Term)
;;;;;;;;;;;;;;;;data constructor proxy: CoreCrypto.AES_128_GCM
(declare-fun CoreCrypto.AES_128_GCM@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun CoreCrypto.AES_256_GCM () Term)
;;;;;;;;;;;;;;;;data constructor proxy: CoreCrypto.AES_256_GCM
(declare-fun CoreCrypto.AES_256_GCM@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun CoreCrypto.CHACHA20_POLY1305 () Term)
;;;;;;;;;;;;;;;;data constructor proxy: CoreCrypto.CHACHA20_POLY1305
(declare-fun CoreCrypto.CHACHA20_POLY1305@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun CoreCrypto.AES_128_CCM () Term)
;;;;;;;;;;;;;;;;data constructor proxy: CoreCrypto.AES_128_CCM
(declare-fun CoreCrypto.AES_128_CCM@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun CoreCrypto.AES_256_CCM () Term)
;;;;;;;;;;;;;;;;data constructor proxy: CoreCrypto.AES_256_CCM
(declare-fun CoreCrypto.AES_256_CCM@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun CoreCrypto.AES_128_CCM_8 () Term)
;;;;;;;;;;;;;;;;data constructor proxy: CoreCrypto.AES_128_CCM_8
(declare-fun CoreCrypto.AES_128_CCM_8@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun CoreCrypto.AES_256_CCM_8 () Term)
;;;;;;;;;;;;;;;;data constructor proxy: CoreCrypto.AES_256_CCM_8
(declare-fun CoreCrypto.AES_256_CCM_8@tok () Term)

; <start constructor CoreCrypto.aead_cipher>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-CoreCrypto.aead_cipher ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
202)
(= __@x0
CoreCrypto.aead_cipher)))

; </end constructor CoreCrypto.aead_cipher>


; <start constructor CoreCrypto.AES_128_GCM>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-CoreCrypto.AES_128_GCM ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
208)
(= __@x0
CoreCrypto.AES_128_GCM)))

; </end constructor CoreCrypto.AES_128_GCM>


; <start constructor CoreCrypto.AES_256_GCM>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-CoreCrypto.AES_256_GCM ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
210)
(= __@x0
CoreCrypto.AES_256_GCM)))

; </end constructor CoreCrypto.AES_256_GCM>


; <start constructor CoreCrypto.CHACHA20_POLY1305>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-CoreCrypto.CHACHA20_POLY1305 ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
212)
(= __@x0
CoreCrypto.CHACHA20_POLY1305)))

; </end constructor CoreCrypto.CHACHA20_POLY1305>


; <start constructor CoreCrypto.AES_128_CCM>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-CoreCrypto.AES_128_CCM ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
214)
(= __@x0
CoreCrypto.AES_128_CCM)))

; </end constructor CoreCrypto.AES_128_CCM>


; <start constructor CoreCrypto.AES_256_CCM>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-CoreCrypto.AES_256_CCM ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
216)
(= __@x0
CoreCrypto.AES_256_CCM)))

; </end constructor CoreCrypto.AES_256_CCM>


; <start constructor CoreCrypto.AES_128_CCM_8>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-CoreCrypto.AES_128_CCM_8 ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
218)
(= __@x0
CoreCrypto.AES_128_CCM_8)))

; </end constructor CoreCrypto.AES_128_CCM_8>


; <start constructor CoreCrypto.AES_256_CCM_8>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-CoreCrypto.AES_256_CCM_8 ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
220)
(= __@x0
CoreCrypto.AES_256_CCM_8)))

; </end constructor CoreCrypto.AES_256_CCM_8>


; </end encoding type CoreCrypto.aead_cipher>


; <Start encoding assume CoreCrypto.aead_cipher__uu___haseq>


; </end encoding assume CoreCrypto.aead_cipher__uu___haseq>


; <Start encoding val CoreCrypto.uu___is_AES_128_GCM>

(declare-fun CoreCrypto.uu___is_AES_128_GCM (Term) Term)
;;;;;;;;;;;;;;;;projectee: aead_cipher -> Prims.bool
(declare-fun Tm_arrow_e27e7ba96adfbacbc98cfd708884c631 () Term)
(declare-fun CoreCrypto.uu___is_AES_128_GCM@tok () Term)

; </end encoding val CoreCrypto.uu___is_AES_128_GCM>


; <Skipped let uu___is_AES_128_GCM/>


; <Start encoding val CoreCrypto.uu___is_AES_256_GCM>

(declare-fun CoreCrypto.uu___is_AES_256_GCM (Term) Term)

(declare-fun CoreCrypto.uu___is_AES_256_GCM@tok () Term)

; </end encoding val CoreCrypto.uu___is_AES_256_GCM>


; <Skipped let uu___is_AES_256_GCM/>


; <Start encoding val CoreCrypto.uu___is_CHACHA20_POLY1305>

(declare-fun CoreCrypto.uu___is_CHACHA20_POLY1305 (Term) Term)

(declare-fun CoreCrypto.uu___is_CHACHA20_POLY1305@tok () Term)

; </end encoding val CoreCrypto.uu___is_CHACHA20_POLY1305>


; <Skipped let uu___is_CHACHA20_POLY1305/>


; <Start encoding val CoreCrypto.uu___is_AES_128_CCM>

(declare-fun CoreCrypto.uu___is_AES_128_CCM (Term) Term)

(declare-fun CoreCrypto.uu___is_AES_128_CCM@tok () Term)

; </end encoding val CoreCrypto.uu___is_AES_128_CCM>


; <Skipped let uu___is_AES_128_CCM/>


; <Start encoding val CoreCrypto.uu___is_AES_256_CCM>

(declare-fun CoreCrypto.uu___is_AES_256_CCM (Term) Term)

(declare-fun CoreCrypto.uu___is_AES_256_CCM@tok () Term)

; </end encoding val CoreCrypto.uu___is_AES_256_CCM>


; <Skipped let uu___is_AES_256_CCM/>


; <Start encoding val CoreCrypto.uu___is_AES_128_CCM_8>

(declare-fun CoreCrypto.uu___is_AES_128_CCM_8 (Term) Term)

(declare-fun CoreCrypto.uu___is_AES_128_CCM_8@tok () Term)

; </end encoding val CoreCrypto.uu___is_AES_128_CCM_8>


; <Skipped let uu___is_AES_128_CCM_8/>


; <Start encoding val CoreCrypto.uu___is_AES_256_CCM_8>

(declare-fun CoreCrypto.uu___is_AES_256_CCM_8 (Term) Term)

(declare-fun CoreCrypto.uu___is_AES_256_CCM_8@tok () Term)

; </end encoding val CoreCrypto.uu___is_AES_256_CCM_8>


; <Skipped let uu___is_AES_256_CCM_8/>


; <Start encoding let aeadKeySize>

(declare-fun CoreCrypto.aeadKeySize (Term) Term)
;;;;;;;;;;;;;;;;_: aead_cipher -> Prims.int
(declare-fun Tm_arrow_24e71811a80be9b4a157831d5ba24137 () Term)
(declare-fun CoreCrypto.aeadKeySize@tok () Term)

; </end encoding let aeadKeySize>


; <Start encoding let aeadRealIVSize>

(declare-fun CoreCrypto.aeadRealIVSize (Term) Term)

(declare-fun CoreCrypto.aeadRealIVSize@tok () Term)

; </end encoding let aeadRealIVSize>


; <Start encoding let aeadTagSize>

(declare-fun CoreCrypto.aeadTagSize (Term) Term)

(declare-fun CoreCrypto.aeadTagSize@tok () Term)

; </end encoding let aeadTagSize>


; <Start encoding val CoreCrypto.aead_encryptT>

(declare-fun CoreCrypto.aead_encryptT (Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;a: aead_cipher ->     k: Platform.Bytes.lbytes (aeadKeySize a) ->     iv: Platform.Bytes.lbytes (aeadRealIVSize a) ->     ad: Platform.Bytes.bytes ->     plain: Platform.Bytes.bytes   -> Prims.GTot (Platform.Bytes.lbytes (Platform.Bytes.length plain + aeadTagSize a))
(declare-fun Tm_ghost_arrow_5f4432a42c59ddb6ab8f88f6c09eea4d () Term)
(declare-fun CoreCrypto.aead_encryptT@tok () Term)

; </end encoding val CoreCrypto.aead_encryptT>


; <Start encoding val CoreCrypto.aead_encrypt>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun CoreCrypto.aead_encrypt (Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun CoreCrypto.aead_encrypt@tok () Term)

; </end encoding val CoreCrypto.aead_encrypt>


; <Start encoding val CoreCrypto.aead_decrypt>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun CoreCrypto.aead_decrypt (Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun CoreCrypto.aead_decrypt@tok () Term)

; </end encoding val CoreCrypto.aead_decrypt>


; <Start encoding type CoreCrypto.rsa_key>

;;;;;;;;;;;;;;;;Constructor
(declare-fun CoreCrypto.rsa_key () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun CoreCrypto.Mkrsa_key (Term Term Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun CoreCrypto.Mkrsa_key_rsa_mod (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun CoreCrypto.Mkrsa_key_rsa_pub_exp (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun CoreCrypto.Mkrsa_key_rsa_prv_exp (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: CoreCrypto.Mkrsa_key
(declare-fun CoreCrypto.Mkrsa_key@tok () Term)
;;;;;;;;;;;;;;;;rsa_mod: Platform.Bytes.bytes ->     rsa_pub_exp: Platform.Bytes.bytes ->     rsa_prv_exp: FStar.Pervasives.Native.option Platform.Bytes.bytes   -> rsa_key
(declare-fun Tm_arrow_473a13a651441c6bdb1ac0e8623baa10 () Term)

; <start constructor CoreCrypto.rsa_key>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-CoreCrypto.rsa_key ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
243)
(= __@x0
CoreCrypto.rsa_key)))

; </end constructor CoreCrypto.rsa_key>


; <start constructor CoreCrypto.Mkrsa_key>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-CoreCrypto.Mkrsa_key ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
249)
(= __@x0
(CoreCrypto.Mkrsa_key (CoreCrypto.Mkrsa_key_rsa_mod __@x0)
(CoreCrypto.Mkrsa_key_rsa_pub_exp __@x0)
(CoreCrypto.Mkrsa_key_rsa_prv_exp __@x0)))))

; </end constructor CoreCrypto.Mkrsa_key>


; </end encoding type CoreCrypto.rsa_key>


; <Start encoding assume CoreCrypto.rsa_key__uu___haseq>


; </end encoding assume CoreCrypto.rsa_key__uu___haseq>


; <Start encoding val CoreCrypto.__proj__Mkrsa_key__item__rsa_mod>

(declare-fun CoreCrypto.__proj__Mkrsa_key__item__rsa_mod (Term) Term)
;;;;;;;;;;;;;;;;projectee: rsa_key -> Platform.Bytes.bytes
(declare-fun Tm_arrow_d7e5fa61505a75a7b98b7effb654ccb2 () Term)
(declare-fun CoreCrypto.__proj__Mkrsa_key__item__rsa_mod@tok () Term)

; </end encoding val CoreCrypto.__proj__Mkrsa_key__item__rsa_mod>


; <Skipped let __proj__Mkrsa_key__item__rsa_mod/>


; <Start encoding val CoreCrypto.__proj__Mkrsa_key__item__rsa_pub_exp>

(declare-fun CoreCrypto.__proj__Mkrsa_key__item__rsa_pub_exp (Term) Term)

(declare-fun CoreCrypto.__proj__Mkrsa_key__item__rsa_pub_exp@tok () Term)

; </end encoding val CoreCrypto.__proj__Mkrsa_key__item__rsa_pub_exp>


; <Skipped let __proj__Mkrsa_key__item__rsa_pub_exp/>


; <Start encoding val CoreCrypto.__proj__Mkrsa_key__item__rsa_prv_exp>

(declare-fun CoreCrypto.__proj__Mkrsa_key__item__rsa_prv_exp (Term) Term)
;;;;;;;;;;;;;;;;projectee: rsa_key -> FStar.Pervasives.Native.option Platform.Bytes.bytes
(declare-fun Tm_arrow_db1f970b2252ab2546e48ae32bebc970 () Term)
(declare-fun CoreCrypto.__proj__Mkrsa_key__item__rsa_prv_exp@tok () Term)

; </end encoding val CoreCrypto.__proj__Mkrsa_key__item__rsa_prv_exp>


; <Skipped let __proj__Mkrsa_key__item__rsa_prv_exp/>


; <Start encoding type CoreCrypto.dsa_params>

;;;;;;;;;;;;;;;;Constructor
(declare-fun CoreCrypto.dsa_params () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun CoreCrypto.Mkdsa_params (Term Term Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun CoreCrypto.Mkdsa_params_dsa_p (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun CoreCrypto.Mkdsa_params_dsa_q (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun CoreCrypto.Mkdsa_params_dsa_g (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: CoreCrypto.Mkdsa_params
(declare-fun CoreCrypto.Mkdsa_params@tok () Term)
;;;;;;;;;;;;;;;;dsa_p: Platform.Bytes.bytes -> dsa_q: Platform.Bytes.bytes -> dsa_g: Platform.Bytes.bytes   -> dsa_params
(declare-fun Tm_arrow_f32237224cc9adfb9820860b7fc6fdf0 () Term)

; <start constructor CoreCrypto.dsa_params>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-CoreCrypto.dsa_params ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
259)
(= __@x0
CoreCrypto.dsa_params)))

; </end constructor CoreCrypto.dsa_params>


; <start constructor CoreCrypto.Mkdsa_params>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-CoreCrypto.Mkdsa_params ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
265)
(= __@x0
(CoreCrypto.Mkdsa_params (CoreCrypto.Mkdsa_params_dsa_p __@x0)
(CoreCrypto.Mkdsa_params_dsa_q __@x0)
(CoreCrypto.Mkdsa_params_dsa_g __@x0)))))

; </end constructor CoreCrypto.Mkdsa_params>


; </end encoding type CoreCrypto.dsa_params>


; <Start encoding assume CoreCrypto.dsa_params__uu___haseq>


; </end encoding assume CoreCrypto.dsa_params__uu___haseq>


; <Start encoding val CoreCrypto.__proj__Mkdsa_params__item__dsa_p>

(declare-fun CoreCrypto.__proj__Mkdsa_params__item__dsa_p (Term) Term)
;;;;;;;;;;;;;;;;projectee: dsa_params -> Platform.Bytes.bytes
(declare-fun Tm_arrow_cc8d8d259c8160df1830db32676205c3 () Term)
(declare-fun CoreCrypto.__proj__Mkdsa_params__item__dsa_p@tok () Term)

; </end encoding val CoreCrypto.__proj__Mkdsa_params__item__dsa_p>


; <Skipped let __proj__Mkdsa_params__item__dsa_p/>


; <Start encoding val CoreCrypto.__proj__Mkdsa_params__item__dsa_q>

(declare-fun CoreCrypto.__proj__Mkdsa_params__item__dsa_q (Term) Term)

(declare-fun CoreCrypto.__proj__Mkdsa_params__item__dsa_q@tok () Term)

; </end encoding val CoreCrypto.__proj__Mkdsa_params__item__dsa_q>


; <Skipped let __proj__Mkdsa_params__item__dsa_q/>


; <Start encoding val CoreCrypto.__proj__Mkdsa_params__item__dsa_g>

(declare-fun CoreCrypto.__proj__Mkdsa_params__item__dsa_g (Term) Term)

(declare-fun CoreCrypto.__proj__Mkdsa_params__item__dsa_g@tok () Term)

; </end encoding val CoreCrypto.__proj__Mkdsa_params__item__dsa_g>


; <Skipped let __proj__Mkdsa_params__item__dsa_g/>


; <Start encoding type CoreCrypto.dsa_key>

;;;;;;;;;;;;;;;;Constructor
(declare-fun CoreCrypto.dsa_key () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun CoreCrypto.Mkdsa_key (Term Term Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun CoreCrypto.Mkdsa_key_dsa_params (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun CoreCrypto.Mkdsa_key_dsa_public (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun CoreCrypto.Mkdsa_key_dsa_private (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: CoreCrypto.Mkdsa_key
(declare-fun CoreCrypto.Mkdsa_key@tok () Term)
;;;;;;;;;;;;;;;;dsa_params: dsa_params ->     dsa_public: Platform.Bytes.bytes ->     dsa_private: FStar.Pervasives.Native.option Platform.Bytes.bytes   -> dsa_key
(declare-fun Tm_arrow_bebc0cdf7b1f673f13a64344ec3ed409 () Term)

; <start constructor CoreCrypto.dsa_key>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-CoreCrypto.dsa_key ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
275)
(= __@x0
CoreCrypto.dsa_key)))

; </end constructor CoreCrypto.dsa_key>


; <start constructor CoreCrypto.Mkdsa_key>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-CoreCrypto.Mkdsa_key ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
281)
(= __@x0
(CoreCrypto.Mkdsa_key (CoreCrypto.Mkdsa_key_dsa_params __@x0)
(CoreCrypto.Mkdsa_key_dsa_public __@x0)
(CoreCrypto.Mkdsa_key_dsa_private __@x0)))))

; </end constructor CoreCrypto.Mkdsa_key>


; </end encoding type CoreCrypto.dsa_key>


; <Start encoding assume CoreCrypto.dsa_key__uu___haseq>


; </end encoding assume CoreCrypto.dsa_key__uu___haseq>


; <Start encoding val CoreCrypto.__proj__Mkdsa_key__item__dsa_params>

(declare-fun CoreCrypto.__proj__Mkdsa_key__item__dsa_params (Term) Term)
;;;;;;;;;;;;;;;;projectee: dsa_key -> dsa_params
(declare-fun Tm_arrow_abbf4e9573962b368856b21ff671cbe3 () Term)
(declare-fun CoreCrypto.__proj__Mkdsa_key__item__dsa_params@tok () Term)

; </end encoding val CoreCrypto.__proj__Mkdsa_key__item__dsa_params>


; <Skipped let __proj__Mkdsa_key__item__dsa_params/>


; <Start encoding val CoreCrypto.__proj__Mkdsa_key__item__dsa_public>

(declare-fun CoreCrypto.__proj__Mkdsa_key__item__dsa_public (Term) Term)
;;;;;;;;;;;;;;;;projectee: dsa_key -> Platform.Bytes.bytes
(declare-fun Tm_arrow_f514b7471a4808d34fcffc6d11d5b937 () Term)
(declare-fun CoreCrypto.__proj__Mkdsa_key__item__dsa_public@tok () Term)

; </end encoding val CoreCrypto.__proj__Mkdsa_key__item__dsa_public>


; <Skipped let __proj__Mkdsa_key__item__dsa_public/>


; <Start encoding val CoreCrypto.__proj__Mkdsa_key__item__dsa_private>

(declare-fun CoreCrypto.__proj__Mkdsa_key__item__dsa_private (Term) Term)
;;;;;;;;;;;;;;;;projectee: dsa_key -> FStar.Pervasives.Native.option Platform.Bytes.bytes
(declare-fun Tm_arrow_77bb0d3ef4022c0b6c8a323c51c8c755 () Term)
(declare-fun CoreCrypto.__proj__Mkdsa_key__item__dsa_private@tok () Term)

; </end encoding val CoreCrypto.__proj__Mkdsa_key__item__dsa_private>


; <Skipped let __proj__Mkdsa_key__item__dsa_private/>


; <Start encoding type CoreCrypto.dh_params>

;;;;;;;;;;;;;;;;Constructor
(declare-fun CoreCrypto.dh_params () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun CoreCrypto.Mkdh_params (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun CoreCrypto.Mkdh_params_dh_p (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun CoreCrypto.Mkdh_params_dh_g (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun CoreCrypto.Mkdh_params_dh_q (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun CoreCrypto.Mkdh_params_safe_prime (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: CoreCrypto.Mkdh_params
(declare-fun CoreCrypto.Mkdh_params@tok () Term)
;;;;;;;;;;;;;;;;dh_p: Platform.Bytes.bytes ->     dh_g: Platform.Bytes.bytes ->     dh_q: FStar.Pervasives.Native.option Platform.Bytes.bytes ->     safe_prime: Prims.bool   -> dh_params
(declare-fun Tm_arrow_da9cd0f913de89fea650ff522688aab9 () Term)

; <start constructor CoreCrypto.dh_params>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-CoreCrypto.dh_params ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
291)
(= __@x0
CoreCrypto.dh_params)))

; </end constructor CoreCrypto.dh_params>


; <start constructor CoreCrypto.Mkdh_params>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-CoreCrypto.Mkdh_params ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
297)
(= __@x0
(CoreCrypto.Mkdh_params (CoreCrypto.Mkdh_params_dh_p __@x0)
(CoreCrypto.Mkdh_params_dh_g __@x0)
(CoreCrypto.Mkdh_params_dh_q __@x0)
(CoreCrypto.Mkdh_params_safe_prime __@x0)))))

; </end constructor CoreCrypto.Mkdh_params>


; </end encoding type CoreCrypto.dh_params>


; <Start encoding assume CoreCrypto.dh_params__uu___haseq>


; </end encoding assume CoreCrypto.dh_params__uu___haseq>


; <Start encoding val CoreCrypto.__proj__Mkdh_params__item__dh_p>

(declare-fun CoreCrypto.__proj__Mkdh_params__item__dh_p (Term) Term)
;;;;;;;;;;;;;;;;projectee: dh_params -> Platform.Bytes.bytes
(declare-fun Tm_arrow_9fac6c99fbfc98a40b9832cdc0a1c403 () Term)
(declare-fun CoreCrypto.__proj__Mkdh_params__item__dh_p@tok () Term)

; </end encoding val CoreCrypto.__proj__Mkdh_params__item__dh_p>


; <Skipped let __proj__Mkdh_params__item__dh_p/>


; <Start encoding val CoreCrypto.__proj__Mkdh_params__item__dh_g>

(declare-fun CoreCrypto.__proj__Mkdh_params__item__dh_g (Term) Term)

(declare-fun CoreCrypto.__proj__Mkdh_params__item__dh_g@tok () Term)

; </end encoding val CoreCrypto.__proj__Mkdh_params__item__dh_g>


; <Skipped let __proj__Mkdh_params__item__dh_g/>


; <Start encoding val CoreCrypto.__proj__Mkdh_params__item__dh_q>

(declare-fun CoreCrypto.__proj__Mkdh_params__item__dh_q (Term) Term)
;;;;;;;;;;;;;;;;projectee: dh_params -> FStar.Pervasives.Native.option Platform.Bytes.bytes
(declare-fun Tm_arrow_ebd84d38042f2607eb1176bcbfc0448f () Term)
(declare-fun CoreCrypto.__proj__Mkdh_params__item__dh_q@tok () Term)

; </end encoding val CoreCrypto.__proj__Mkdh_params__item__dh_q>


; <Skipped let __proj__Mkdh_params__item__dh_q/>


; <Start encoding val CoreCrypto.__proj__Mkdh_params__item__safe_prime>

(declare-fun CoreCrypto.__proj__Mkdh_params__item__safe_prime (Term) Term)
;;;;;;;;;;;;;;;;projectee: dh_params -> Prims.bool
(declare-fun Tm_arrow_8dbefde71063bfc0a8b44212253890ad () Term)
(declare-fun CoreCrypto.__proj__Mkdh_params__item__safe_prime@tok () Term)

; </end encoding val CoreCrypto.__proj__Mkdh_params__item__safe_prime>


; <Skipped let __proj__Mkdh_params__item__safe_prime/>


; <Start encoding type CoreCrypto.dh_key>

;;;;;;;;;;;;;;;;Constructor
(declare-fun CoreCrypto.dh_key () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun CoreCrypto.Mkdh_key (Term Term Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun CoreCrypto.Mkdh_key_dh_params (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun CoreCrypto.Mkdh_key_dh_public (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun CoreCrypto.Mkdh_key_dh_private (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: CoreCrypto.Mkdh_key
(declare-fun CoreCrypto.Mkdh_key@tok () Term)
;;;;;;;;;;;;;;;;dh_params: dh_params ->     dh_public: Platform.Bytes.bytes ->     dh_private: FStar.Pervasives.Native.option Platform.Bytes.bytes   -> dh_key
(declare-fun Tm_arrow_2c5ff7c8f92d03490ca9a4543baac4ab () Term)

; <start constructor CoreCrypto.dh_key>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-CoreCrypto.dh_key ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
309)
(= __@x0
CoreCrypto.dh_key)))

; </end constructor CoreCrypto.dh_key>


; <start constructor CoreCrypto.Mkdh_key>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-CoreCrypto.Mkdh_key ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
315)
(= __@x0
(CoreCrypto.Mkdh_key (CoreCrypto.Mkdh_key_dh_params __@x0)
(CoreCrypto.Mkdh_key_dh_public __@x0)
(CoreCrypto.Mkdh_key_dh_private __@x0)))))

; </end constructor CoreCrypto.Mkdh_key>


; </end encoding type CoreCrypto.dh_key>


; <Start encoding assume CoreCrypto.dh_key__uu___haseq>


; </end encoding assume CoreCrypto.dh_key__uu___haseq>


; <Start encoding val CoreCrypto.__proj__Mkdh_key__item__dh_params>

(declare-fun CoreCrypto.__proj__Mkdh_key__item__dh_params (Term) Term)
;;;;;;;;;;;;;;;;projectee: dh_key -> dh_params
(declare-fun Tm_arrow_447f76351643e97491dd8bc421120fd7 () Term)
(declare-fun CoreCrypto.__proj__Mkdh_key__item__dh_params@tok () Term)

; </end encoding val CoreCrypto.__proj__Mkdh_key__item__dh_params>


; <Skipped let __proj__Mkdh_key__item__dh_params/>


; <Start encoding val CoreCrypto.__proj__Mkdh_key__item__dh_public>

(declare-fun CoreCrypto.__proj__Mkdh_key__item__dh_public (Term) Term)
;;;;;;;;;;;;;;;;projectee: dh_key -> Platform.Bytes.bytes
(declare-fun Tm_arrow_9b2d6ea85d388ba5e6f67f08e97f0ec2 () Term)
(declare-fun CoreCrypto.__proj__Mkdh_key__item__dh_public@tok () Term)

; </end encoding val CoreCrypto.__proj__Mkdh_key__item__dh_public>


; <Skipped let __proj__Mkdh_key__item__dh_public/>


; <Start encoding val CoreCrypto.__proj__Mkdh_key__item__dh_private>

(declare-fun CoreCrypto.__proj__Mkdh_key__item__dh_private (Term) Term)
;;;;;;;;;;;;;;;;projectee: dh_key -> FStar.Pervasives.Native.option Platform.Bytes.bytes
(declare-fun Tm_arrow_a6567ed42d33aa58b0f2e1f435690e60 () Term)
(declare-fun CoreCrypto.__proj__Mkdh_key__item__dh_private@tok () Term)

; </end encoding val CoreCrypto.__proj__Mkdh_key__item__dh_private>


; <Skipped let __proj__Mkdh_key__item__dh_private/>


; <Start encoding val CoreCrypto.block_encrypt>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun CoreCrypto.block_encrypt (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun CoreCrypto.block_encrypt@tok () Term)

; </end encoding val CoreCrypto.block_encrypt>


; <Start encoding val CoreCrypto.block_decrypt>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun CoreCrypto.block_decrypt (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun CoreCrypto.block_decrypt@tok () Term)

; </end encoding val CoreCrypto.block_decrypt>


; <Start encoding val CoreCrypto.cipher_stream>

(declare-fun CoreCrypto.cipher_stream () Term)

; </end encoding val CoreCrypto.cipher_stream>


; <Start encoding val CoreCrypto.stream_encryptor>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun CoreCrypto.stream_encryptor (Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun CoreCrypto.stream_encryptor@tok () Term)

; </end encoding val CoreCrypto.stream_encryptor>


; <Start encoding val CoreCrypto.stream_decryptor>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun CoreCrypto.stream_decryptor (Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun CoreCrypto.stream_decryptor@tok () Term)

; </end encoding val CoreCrypto.stream_decryptor>


; <Start encoding val CoreCrypto.stream_process>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun CoreCrypto.stream_process (Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun CoreCrypto.stream_process@tok () Term)

; </end encoding val CoreCrypto.stream_process>


; <Start encoding val CoreCrypto.stream_fini>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun CoreCrypto.stream_fini (Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun CoreCrypto.stream_fini@tok () Term)

; </end encoding val CoreCrypto.stream_fini>


; <Start encoding val CoreCrypto.random>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun CoreCrypto.random (Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun CoreCrypto.random@tok () Term)

; </end encoding val CoreCrypto.random>


; <Start encoding val CoreCrypto.rsa_gen_key>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun CoreCrypto.rsa_gen_key (Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun CoreCrypto.rsa_gen_key@tok () Term)

; </end encoding val CoreCrypto.rsa_gen_key>


; <Start encoding val CoreCrypto.rsa_encrypt>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun CoreCrypto.rsa_encrypt (Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun CoreCrypto.rsa_encrypt@tok () Term)

; </end encoding val CoreCrypto.rsa_encrypt>


; <Start encoding val CoreCrypto.rsa_decrypt>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun CoreCrypto.rsa_decrypt (Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun CoreCrypto.rsa_decrypt@tok () Term)

; </end encoding val CoreCrypto.rsa_decrypt>


; <Start encoding val CoreCrypto.rsa_sign>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun CoreCrypto.rsa_sign (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun CoreCrypto.rsa_sign@tok () Term)

; </end encoding val CoreCrypto.rsa_sign>


; <Start encoding val CoreCrypto.rsa_verify>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun CoreCrypto.rsa_verify (Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun CoreCrypto.rsa_verify@tok () Term)

; </end encoding val CoreCrypto.rsa_verify>


; <Start encoding val CoreCrypto.dsa_gen_key>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun CoreCrypto.dsa_gen_key (Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun CoreCrypto.dsa_gen_key@tok () Term)

; </end encoding val CoreCrypto.dsa_gen_key>


; <Start encoding val CoreCrypto.dsa_sign>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun CoreCrypto.dsa_sign (Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun CoreCrypto.dsa_sign@tok () Term)

; </end encoding val CoreCrypto.dsa_sign>


; <Start encoding val CoreCrypto.dsa_verify>

(declare-fun CoreCrypto.dsa_verify (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;_: FStar.Pervasives.Native.option hash_alg ->     _: dsa_key ->     _: Platform.Bytes.bytes ->     _: Platform.Bytes.bytes   -> Prims.bool
(declare-fun Tm_arrow_a3751620a8f11eaaf2c5c9d073e0e3a0 () Term)
(declare-fun CoreCrypto.dsa_verify@tok () Term)

; </end encoding val CoreCrypto.dsa_verify>


; <Start encoding val CoreCrypto.dh_gen_params>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun CoreCrypto.dh_gen_params (Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun CoreCrypto.dh_gen_params@tok () Term)

; </end encoding val CoreCrypto.dh_gen_params>


; <Start encoding val CoreCrypto.dh_gen_key>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun CoreCrypto.dh_gen_key (Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun CoreCrypto.dh_gen_key@tok () Term)

; </end encoding val CoreCrypto.dh_gen_key>


; <Start encoding val CoreCrypto.dh_agreement>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun CoreCrypto.dh_agreement (Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun CoreCrypto.dh_agreement@tok () Term)

; </end encoding val CoreCrypto.dh_agreement>


; <Start encoding type CoreCrypto.ec_curve>

;;;;;;;;;;;;;;;;Constructor
(declare-fun CoreCrypto.ec_curve () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun CoreCrypto.ECC_P256 () Term)
;;;;;;;;;;;;;;;;data constructor proxy: CoreCrypto.ECC_P256
(declare-fun CoreCrypto.ECC_P256@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun CoreCrypto.ECC_P384 () Term)
;;;;;;;;;;;;;;;;data constructor proxy: CoreCrypto.ECC_P384
(declare-fun CoreCrypto.ECC_P384@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun CoreCrypto.ECC_P521 () Term)
;;;;;;;;;;;;;;;;data constructor proxy: CoreCrypto.ECC_P521
(declare-fun CoreCrypto.ECC_P521@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun CoreCrypto.ECC_X25519 () Term)
;;;;;;;;;;;;;;;;data constructor proxy: CoreCrypto.ECC_X25519
(declare-fun CoreCrypto.ECC_X25519@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun CoreCrypto.ECC_X448 () Term)
;;;;;;;;;;;;;;;;data constructor proxy: CoreCrypto.ECC_X448
(declare-fun CoreCrypto.ECC_X448@tok () Term)

; <start constructor CoreCrypto.ec_curve>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-CoreCrypto.ec_curve ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
330)
(= __@x0
CoreCrypto.ec_curve)))

; </end constructor CoreCrypto.ec_curve>


; <start constructor CoreCrypto.ECC_P256>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-CoreCrypto.ECC_P256 ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
336)
(= __@x0
CoreCrypto.ECC_P256)))

; </end constructor CoreCrypto.ECC_P256>


; <start constructor CoreCrypto.ECC_P384>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-CoreCrypto.ECC_P384 ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
338)
(= __@x0
CoreCrypto.ECC_P384)))

; </end constructor CoreCrypto.ECC_P384>


; <start constructor CoreCrypto.ECC_P521>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-CoreCrypto.ECC_P521 ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
340)
(= __@x0
CoreCrypto.ECC_P521)))

; </end constructor CoreCrypto.ECC_P521>


; <start constructor CoreCrypto.ECC_X25519>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-CoreCrypto.ECC_X25519 ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
342)
(= __@x0
CoreCrypto.ECC_X25519)))

; </end constructor CoreCrypto.ECC_X25519>


; <start constructor CoreCrypto.ECC_X448>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-CoreCrypto.ECC_X448 ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
344)
(= __@x0
CoreCrypto.ECC_X448)))

; </end constructor CoreCrypto.ECC_X448>


; </end encoding type CoreCrypto.ec_curve>


; <Start encoding assume CoreCrypto.ec_curve__uu___haseq>


; </end encoding assume CoreCrypto.ec_curve__uu___haseq>


; <Start encoding val CoreCrypto.uu___is_ECC_P256>

(declare-fun CoreCrypto.uu___is_ECC_P256 (Term) Term)
;;;;;;;;;;;;;;;;projectee: ec_curve -> Prims.bool
(declare-fun Tm_arrow_e5b5849946c6d29b6f104c40a9a6a167 () Term)
(declare-fun CoreCrypto.uu___is_ECC_P256@tok () Term)

; </end encoding val CoreCrypto.uu___is_ECC_P256>


; <Skipped let uu___is_ECC_P256/>


; <Start encoding val CoreCrypto.uu___is_ECC_P384>

(declare-fun CoreCrypto.uu___is_ECC_P384 (Term) Term)

(declare-fun CoreCrypto.uu___is_ECC_P384@tok () Term)

; </end encoding val CoreCrypto.uu___is_ECC_P384>


; <Skipped let uu___is_ECC_P384/>


; <Start encoding val CoreCrypto.uu___is_ECC_P521>

(declare-fun CoreCrypto.uu___is_ECC_P521 (Term) Term)

(declare-fun CoreCrypto.uu___is_ECC_P521@tok () Term)

; </end encoding val CoreCrypto.uu___is_ECC_P521>


; <Skipped let uu___is_ECC_P521/>


; <Start encoding val CoreCrypto.uu___is_ECC_X25519>

(declare-fun CoreCrypto.uu___is_ECC_X25519 (Term) Term)

(declare-fun CoreCrypto.uu___is_ECC_X25519@tok () Term)

; </end encoding val CoreCrypto.uu___is_ECC_X25519>


; <Skipped let uu___is_ECC_X25519/>


; <Start encoding val CoreCrypto.uu___is_ECC_X448>

(declare-fun CoreCrypto.uu___is_ECC_X448 (Term) Term)

(declare-fun CoreCrypto.uu___is_ECC_X448@tok () Term)

; </end encoding val CoreCrypto.uu___is_ECC_X448>


; <Skipped let uu___is_ECC_X448/>


; <Skipped val CoreCrypto.ec_bytelen/>


; <Start encoding let ec_bytelen>

(declare-fun CoreCrypto.ec_bytelen (Term) Term)
(declare-fun Tm_refine_379d104eb4e93e4b7c171c2bc0c85c67 () Term)
;;;;;;;;;;;;;;;;_: ec_curve -> n: Prims.nat{n <= 127}
(declare-fun Tm_arrow_93525dc6c2dd659fb6a60632411ddcfb () Term)
(declare-fun CoreCrypto.ec_bytelen@tok () Term)


; </end encoding let ec_bytelen>


; <Start encoding type CoreCrypto.ec_params>

;;;;;;;;;;;;;;;;Constructor
(declare-fun CoreCrypto.ec_params () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun CoreCrypto.Mkec_params (Term Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun CoreCrypto.Mkec_params_curve (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun CoreCrypto.Mkec_params_point_compression (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: CoreCrypto.Mkec_params
(declare-fun CoreCrypto.Mkec_params@tok () Term)
;;;;;;;;;;;;;;;;curve: ec_curve -> point_compression: Prims.bool -> ec_params
(declare-fun Tm_arrow_d1f1ab271939c61eb6e197c5df271e1f () Term)

; <start constructor CoreCrypto.ec_params>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-CoreCrypto.ec_params ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
359)
(= __@x0
CoreCrypto.ec_params)))

; </end constructor CoreCrypto.ec_params>


; <start constructor CoreCrypto.Mkec_params>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-CoreCrypto.Mkec_params ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
365)
(= __@x0
(CoreCrypto.Mkec_params (CoreCrypto.Mkec_params_curve __@x0)
(CoreCrypto.Mkec_params_point_compression __@x0)))))

; </end constructor CoreCrypto.Mkec_params>


; </end encoding type CoreCrypto.ec_params>


; <Start encoding assume CoreCrypto.ec_params__uu___haseq>


; </end encoding assume CoreCrypto.ec_params__uu___haseq>


; <Start encoding val CoreCrypto.__proj__Mkec_params__item__curve>

(declare-fun CoreCrypto.__proj__Mkec_params__item__curve (Term) Term)
;;;;;;;;;;;;;;;;projectee: ec_params -> ec_curve
(declare-fun Tm_arrow_fc53fedfd9f662e4953f600478d41808 () Term)
(declare-fun CoreCrypto.__proj__Mkec_params__item__curve@tok () Term)

; </end encoding val CoreCrypto.__proj__Mkec_params__item__curve>


; <Skipped let __proj__Mkec_params__item__curve/>


; <Start encoding val CoreCrypto.__proj__Mkec_params__item__point_compression>

(declare-fun CoreCrypto.__proj__Mkec_params__item__point_compression (Term) Term)
;;;;;;;;;;;;;;;;projectee: ec_params -> Prims.bool
(declare-fun Tm_arrow_13f4202a8faa5d57c331ff9fd9e33345 () Term)
(declare-fun CoreCrypto.__proj__Mkec_params__item__point_compression@tok () Term)

; </end encoding val CoreCrypto.__proj__Mkec_params__item__point_compression>


; <Skipped let __proj__Mkec_params__item__point_compression/>


; <Start encoding type CoreCrypto.ec_point>

;;;;;;;;;;;;;;;;Constructor
(declare-fun CoreCrypto.ec_point () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun CoreCrypto.Mkec_point (Term Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun CoreCrypto.Mkec_point_ecx (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun CoreCrypto.Mkec_point_ecy (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: CoreCrypto.Mkec_point
(declare-fun CoreCrypto.Mkec_point@tok () Term)
;;;;;;;;;;;;;;;;ecx: Platform.Bytes.bytes -> ecy: Platform.Bytes.bytes -> ec_point
(declare-fun Tm_arrow_e66aca6a4636eb360ba91c56fde7a176 () Term)

; <start constructor CoreCrypto.ec_point>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-CoreCrypto.ec_point ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
373)
(= __@x0
CoreCrypto.ec_point)))

; </end constructor CoreCrypto.ec_point>


; <start constructor CoreCrypto.Mkec_point>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-CoreCrypto.Mkec_point ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
379)
(= __@x0
(CoreCrypto.Mkec_point (CoreCrypto.Mkec_point_ecx __@x0)
(CoreCrypto.Mkec_point_ecy __@x0)))))

; </end constructor CoreCrypto.Mkec_point>


; </end encoding type CoreCrypto.ec_point>


; <Start encoding assume CoreCrypto.ec_point__uu___haseq>


; </end encoding assume CoreCrypto.ec_point__uu___haseq>


; <Start encoding val CoreCrypto.__proj__Mkec_point__item__ecx>

(declare-fun CoreCrypto.__proj__Mkec_point__item__ecx (Term) Term)
;;;;;;;;;;;;;;;;projectee: ec_point -> Platform.Bytes.bytes
(declare-fun Tm_arrow_c2ce1d7d613e4123286fcb0796a32492 () Term)
(declare-fun CoreCrypto.__proj__Mkec_point__item__ecx@tok () Term)

; </end encoding val CoreCrypto.__proj__Mkec_point__item__ecx>


; <Skipped let __proj__Mkec_point__item__ecx/>


; <Start encoding val CoreCrypto.__proj__Mkec_point__item__ecy>

(declare-fun CoreCrypto.__proj__Mkec_point__item__ecy (Term) Term)

(declare-fun CoreCrypto.__proj__Mkec_point__item__ecy@tok () Term)

; </end encoding val CoreCrypto.__proj__Mkec_point__item__ecy>


; <Skipped let __proj__Mkec_point__item__ecy/>


; <Start encoding type CoreCrypto.ec_key>

;;;;;;;;;;;;;;;;Constructor
(declare-fun CoreCrypto.ec_key () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun CoreCrypto.Mkec_key (Term Term Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun CoreCrypto.Mkec_key_ec_params (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun CoreCrypto.Mkec_key_ec_point (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun CoreCrypto.Mkec_key_ec_priv (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: CoreCrypto.Mkec_key
(declare-fun CoreCrypto.Mkec_key@tok () Term)
;;;;;;;;;;;;;;;;ec_params: ec_params ->     ec_point: ec_point ->     ec_priv: FStar.Pervasives.Native.option Platform.Bytes.bytes   -> ec_key
(declare-fun Tm_arrow_befaa340dfce74ffa2c320d442098acf () Term)

; <start constructor CoreCrypto.ec_key>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-CoreCrypto.ec_key ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
387)
(= __@x0
CoreCrypto.ec_key)))

; </end constructor CoreCrypto.ec_key>


; <start constructor CoreCrypto.Mkec_key>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-CoreCrypto.Mkec_key ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
393)
(= __@x0
(CoreCrypto.Mkec_key (CoreCrypto.Mkec_key_ec_params __@x0)
(CoreCrypto.Mkec_key_ec_point __@x0)
(CoreCrypto.Mkec_key_ec_priv __@x0)))))

; </end constructor CoreCrypto.Mkec_key>


; </end encoding type CoreCrypto.ec_key>


; <Start encoding assume CoreCrypto.ec_key__uu___haseq>


; </end encoding assume CoreCrypto.ec_key__uu___haseq>


; <Start encoding val CoreCrypto.__proj__Mkec_key__item__ec_params>

(declare-fun CoreCrypto.__proj__Mkec_key__item__ec_params (Term) Term)
;;;;;;;;;;;;;;;;projectee: ec_key -> ec_params
(declare-fun Tm_arrow_04c1d6a60b2f643d99cc02b005365313 () Term)
(declare-fun CoreCrypto.__proj__Mkec_key__item__ec_params@tok () Term)

; </end encoding val CoreCrypto.__proj__Mkec_key__item__ec_params>


; <Skipped let __proj__Mkec_key__item__ec_params/>


; <Start encoding val CoreCrypto.__proj__Mkec_key__item__ec_point>

(declare-fun CoreCrypto.__proj__Mkec_key__item__ec_point (Term) Term)
;;;;;;;;;;;;;;;;projectee: ec_key -> ec_point
(declare-fun Tm_arrow_be756e88eded68a1fc929ba5b9cc9a49 () Term)
(declare-fun CoreCrypto.__proj__Mkec_key__item__ec_point@tok () Term)

; </end encoding val CoreCrypto.__proj__Mkec_key__item__ec_point>


; <Skipped let __proj__Mkec_key__item__ec_point/>


; <Start encoding val CoreCrypto.__proj__Mkec_key__item__ec_priv>

(declare-fun CoreCrypto.__proj__Mkec_key__item__ec_priv (Term) Term)
;;;;;;;;;;;;;;;;projectee: ec_key -> FStar.Pervasives.Native.option Platform.Bytes.bytes
(declare-fun Tm_arrow_287c5481d9e8883a280532ff599fe88f () Term)
(declare-fun CoreCrypto.__proj__Mkec_key__item__ec_priv@tok () Term)

; </end encoding val CoreCrypto.__proj__Mkec_key__item__ec_priv>


; <Skipped let __proj__Mkec_key__item__ec_priv/>


; <Start encoding val CoreCrypto.ec_is_on_curve>

(declare-fun CoreCrypto.ec_is_on_curve (Term Term) Term)
;;;;;;;;;;;;;;;;_: ec_params -> _: ec_point -> Prims.bool
(declare-fun Tm_arrow_8ed86a2a0a2b9f561c1bb07c09351fde () Term)
(declare-fun CoreCrypto.ec_is_on_curve@tok () Term)

; </end encoding val CoreCrypto.ec_is_on_curve>


; <Start encoding val CoreCrypto.ecdh_agreement>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun CoreCrypto.ecdh_agreement (Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun CoreCrypto.ecdh_agreement@tok () Term)

; </end encoding val CoreCrypto.ecdh_agreement>


; <Start encoding val CoreCrypto.ecdsa_sign>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun CoreCrypto.ecdsa_sign (Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun CoreCrypto.ecdsa_sign@tok () Term)

; </end encoding val CoreCrypto.ecdsa_sign>


; <Start encoding val CoreCrypto.ecdsa_verify>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun CoreCrypto.ecdsa_verify (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun CoreCrypto.ecdsa_verify@tok () Term)

; </end encoding val CoreCrypto.ecdsa_verify>


; <Start encoding val CoreCrypto.ec_gen_key>

;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun CoreCrypto.ec_gen_key (Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun CoreCrypto.ec_gen_key@tok () Term)

; </end encoding val CoreCrypto.ec_gen_key>


; <Start encoding type CoreCrypto.key>

;;;;;;;;;;;;;;;;Constructor
(declare-fun CoreCrypto.key () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun CoreCrypto.KeyRSA (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun CoreCrypto.KeyRSA__0 (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: CoreCrypto.KeyRSA
(declare-fun CoreCrypto.KeyRSA@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun CoreCrypto.KeyDSA (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun CoreCrypto.KeyDSA__0 (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: CoreCrypto.KeyDSA
(declare-fun CoreCrypto.KeyDSA@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun CoreCrypto.KeyECDSA (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun CoreCrypto.KeyECDSA__0 (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: CoreCrypto.KeyECDSA
(declare-fun CoreCrypto.KeyECDSA@tok () Term)
;;;;;;;;;;;;;;;;_0: rsa_key -> key
(declare-fun Tm_arrow_70ddbfa59f5af35ba108f4ab98e12ab0 () Term)
;;;;;;;;;;;;;;;;_0: dsa_key -> key
(declare-fun Tm_arrow_860e0ff8d9686813074c4d7f8fefe01b () Term)
;;;;;;;;;;;;;;;;_0: ec_key -> key
(declare-fun Tm_arrow_ff43cc8ce72ef7d80e91ec317c836cc0 () Term)

; <start constructor CoreCrypto.key>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-CoreCrypto.key ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
405)
(= __@x0
CoreCrypto.key)))

; </end constructor CoreCrypto.key>


; <start constructor CoreCrypto.KeyRSA>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-CoreCrypto.KeyRSA ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
411)
(= __@x0
(CoreCrypto.KeyRSA (CoreCrypto.KeyRSA__0 __@x0)))))

; </end constructor CoreCrypto.KeyRSA>


; <start constructor CoreCrypto.KeyDSA>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-CoreCrypto.KeyDSA ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
416)
(= __@x0
(CoreCrypto.KeyDSA (CoreCrypto.KeyDSA__0 __@x0)))))

; </end constructor CoreCrypto.KeyDSA>


; <start constructor CoreCrypto.KeyECDSA>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-CoreCrypto.KeyECDSA ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
421)
(= __@x0
(CoreCrypto.KeyECDSA (CoreCrypto.KeyECDSA__0 __@x0)))))

; </end constructor CoreCrypto.KeyECDSA>


; </end encoding type CoreCrypto.key>


; <Start encoding assume CoreCrypto.key__uu___haseq>


; </end encoding assume CoreCrypto.key__uu___haseq>


; <Start encoding val CoreCrypto.uu___is_KeyRSA>

(declare-fun CoreCrypto.uu___is_KeyRSA (Term) Term)
;;;;;;;;;;;;;;;;projectee: key -> Prims.bool
(declare-fun Tm_arrow_41e7eec302725cdbae8986c90f354e6e () Term)
(declare-fun CoreCrypto.uu___is_KeyRSA@tok () Term)

; </end encoding val CoreCrypto.uu___is_KeyRSA>


; <Skipped let uu___is_KeyRSA/>


; <Start encoding val CoreCrypto.__proj__KeyRSA__item___0>

(declare-fun Tm_refine_0ccdfda7973351dc5ff7cc6bafd38aaa () Term)
(declare-fun CoreCrypto.__proj__KeyRSA__item___0 (Term) Term)

;;;;;;;;;;;;;;;;projectee: _: key{KeyRSA? _} -> rsa_key
(declare-fun Tm_arrow_db97275fde56ba045e605c3fc0182bac () Term)
(declare-fun CoreCrypto.__proj__KeyRSA__item___0@tok () Term)

; </end encoding val CoreCrypto.__proj__KeyRSA__item___0>


; <Skipped let __proj__KeyRSA__item___0/>


; <Start encoding val CoreCrypto.uu___is_KeyDSA>

(declare-fun CoreCrypto.uu___is_KeyDSA (Term) Term)

(declare-fun CoreCrypto.uu___is_KeyDSA@tok () Term)

; </end encoding val CoreCrypto.uu___is_KeyDSA>


; <Skipped let uu___is_KeyDSA/>


; <Start encoding val CoreCrypto.__proj__KeyDSA__item___0>

(declare-fun Tm_refine_8184647406e79faa584c9195e044d39a () Term)
(declare-fun CoreCrypto.__proj__KeyDSA__item___0 (Term) Term)

;;;;;;;;;;;;;;;;projectee: _: key{KeyDSA? _} -> dsa_key
(declare-fun Tm_arrow_b26d768b050f66c31bd482cf0d82c91c () Term)
(declare-fun CoreCrypto.__proj__KeyDSA__item___0@tok () Term)

; </end encoding val CoreCrypto.__proj__KeyDSA__item___0>


; <Skipped let __proj__KeyDSA__item___0/>


; <Start encoding val CoreCrypto.uu___is_KeyECDSA>

(declare-fun CoreCrypto.uu___is_KeyECDSA (Term) Term)

(declare-fun CoreCrypto.uu___is_KeyECDSA@tok () Term)

; </end encoding val CoreCrypto.uu___is_KeyECDSA>


; <Skipped let uu___is_KeyECDSA/>


; <Start encoding val CoreCrypto.__proj__KeyECDSA__item___0>

(declare-fun Tm_refine_79c3e6481f3e7856a6797273cdc8189d () Term)
(declare-fun CoreCrypto.__proj__KeyECDSA__item___0 (Term) Term)

;;;;;;;;;;;;;;;;projectee: _: key{KeyECDSA? _} -> ec_key
(declare-fun Tm_arrow_dfa72896b66a07902be5566b8e54cee2 () Term)
(declare-fun CoreCrypto.__proj__KeyECDSA__item___0@tok () Term)

; </end encoding val CoreCrypto.__proj__KeyECDSA__item___0>


; <Skipped let __proj__KeyECDSA__item___0/>


; <Start encoding let has_priv>

(declare-fun CoreCrypto.has_priv (Term) Term)
;;;;;;;;;;;;;;;;_: key -> Type
(declare-fun Tm_arrow_0366bb15df7f2c11f48c371484f5de9c () Term)
(declare-fun CoreCrypto.has_priv@tok () Term)

; </end encoding let has_priv>


; <Start encoding val CoreCrypto.validate_chain>

(declare-fun CoreCrypto.validate_chain (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;der_list: Prims.list Platform.Bytes.bytes ->     for_signing: Prims.bool ->     hostname: FStar.Pervasives.Native.option Prims.string ->     ca_file: Prims.string   -> Prims.bool
(declare-fun Tm_arrow_0e32699ea649ee5900fa88c4f6cbdc68 () Term)
(declare-fun CoreCrypto.validate_chain@tok () Term)

; </end encoding val CoreCrypto.validate_chain>


; <Start encoding val CoreCrypto.get_key_from_cert>

(declare-fun CoreCrypto.get_key_from_cert (Term) Term)
;;;;;;;;;;;;;;;;_: Platform.Bytes.bytes -> FStar.Pervasives.Native.option key
(declare-fun Tm_arrow_eb83537a29a786e91a366bcdf2518943 () Term)
(declare-fun CoreCrypto.get_key_from_cert@tok () Term)

; </end encoding val CoreCrypto.get_key_from_cert>


; <Start encoding val CoreCrypto.hash_and_sign>

(declare-fun Tm_refine_c87092464f5ff3a833f2bcc94b2ebe36 () Term)
(declare-fun CoreCrypto.hash_and_sign (Term Term Term) Term)

;;;;;;;;;;;;;;;;k: key{has_priv k} -> _: hash_alg -> _: Platform.Bytes.bytes -> Platform.Bytes.bytes
(declare-fun Tm_arrow_427c0de408d777d6fdd46649e8343fc7 () Term)
(declare-fun CoreCrypto.hash_and_sign@tok () Term)

; </end encoding val CoreCrypto.hash_and_sign>


; <Start encoding val CoreCrypto.verify_signature>

(declare-fun CoreCrypto.verify_signature (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;_: key -> _: hash_alg -> tbs: Platform.Bytes.bytes -> sigv: Platform.Bytes.bytes -> Prims.bool
(declare-fun Tm_arrow_92ec031cfa248a66025b56430261acdb () Term)
(declare-fun CoreCrypto.verify_signature@tok () Term)

; </end encoding val CoreCrypto.verify_signature>


; <Start encoding val CoreCrypto.load_chain>

(declare-fun CoreCrypto.load_chain (Term) Term)
;;;;;;;;;;;;;;;;pemfile: Prims.string -> FStar.Pervasives.Native.option (Prims.list Platform.Bytes.bytes)
(declare-fun Tm_arrow_19e73122833f75d5aa8efb5b1abecf97 () Term)
(declare-fun CoreCrypto.load_chain@tok () Term)

; </end encoding val CoreCrypto.load_chain>


; <Start encoding val CoreCrypto.load_key>

(declare-fun CoreCrypto.load_key (Term) Term)

;;;;;;;;;;;;;;;;keyfile: Prims.string -> FStar.Pervasives.Native.option (k: key{has_priv k})
(declare-fun Tm_arrow_09e94613c1d18e6de382b159c4c143b5 () Term)
(declare-fun CoreCrypto.load_key@tok () Term)


; </end encoding val CoreCrypto.load_key>


; End Externals for module CoreCrypto

(push) ;; push{1

; Internals for HyE.RSA


; encoding sigelt val HyE.RSA.pkey


; <Start encoding val HyE.RSA.pkey>

(declare-fun HyE.RSA.pkey () Term)

; </end encoding val HyE.RSA.pkey>


; encoding sigelt val HyE.RSA.skey


; <Start encoding val HyE.RSA.skey>

(declare-fun HyE.RSA.skey () Term)

; </end encoding val HyE.RSA.skey>


; encoding sigelt let plainsize


; <Start encoding let plainsize>

(declare-fun HyE.RSA.plainsize (Dummy_sort) Term)

; </end encoding let plainsize>


; encoding sigelt val HyE.RSA.ciphersize


; <Start encoding val HyE.RSA.ciphersize>

(declare-fun HyE.RSA.ciphersize (Dummy_sort) Term)

; </end encoding val HyE.RSA.ciphersize>
...
;;; Fact-ids: Name CoreCrypto.aead_cipher; Namespace CoreCrypto; Name CoreCrypto.AES_128_GCM; Namespace CoreCrypto; Name CoreCrypto.AES_256_GCM; Namespace CoreCrypto; Name CoreCrypto.CHACHA20_POLY1305; Namespace CoreCrypto; Name CoreCrypto.AES_128_CCM; Namespace CoreCrypto; Name CoreCrypto.AES_256_CCM; Namespace CoreCrypto; Name CoreCrypto.AES_128_CCM_8; Namespace CoreCrypto; Name CoreCrypto.AES_256_CCM_8; Namespace CoreCrypto
(assert (! (HasType CoreCrypto.CHACHA20_POLY1305@tok
CoreCrypto.aead_cipher)
:named typing_tok_CoreCrypto.CHACHA20_POLY1305@tok))
;;;;;;;;;;;;;;;;typing for data constructor proxy
;;; Fact-ids: Name CoreCrypto.aead_cipher; Namespace CoreCrypto; Name CoreCrypto.AES_128_GCM; Namespace CoreCrypto; Name CoreCrypto.AES_256_GCM; Namespace CoreCrypto; Name CoreCrypto.CHACHA20_POLY1305; Namespace CoreCrypto; Name CoreCrypto.AES_128_CCM; Namespace CoreCrypto; Name CoreCrypto.AES_256_CCM; Namespace CoreCrypto; Name CoreCrypto.AES_128_CCM_8; Namespace CoreCrypto; Name CoreCrypto.AES_256_CCM_8; Namespace CoreCrypto
(assert (! (HasType CoreCrypto.AES_256_GCM@tok
CoreCrypto.aead_cipher)
:named typing_tok_CoreCrypto.AES_256_GCM@tok))
;;;;;;;;;;;;;;;;typing for data constructor proxy
;;; Fact-ids: Name CoreCrypto.aead_cipher; Namespace CoreCrypto; Name CoreCrypto.AES_128_GCM; Namespace CoreCrypto; Name CoreCrypto.AES_256_GCM; Namespace CoreCrypto; Name CoreCrypto.CHACHA20_POLY1305; Namespace CoreCrypto; Name CoreCrypto.AES_128_CCM; Namespace CoreCrypto; Name CoreCrypto.AES_256_CCM; Namespace CoreCrypto; Name CoreCrypto.AES_128_CCM_8; Namespace CoreCrypto; Name CoreCrypto.AES_256_CCM_8; Namespace CoreCrypto
(assert (! (HasType CoreCrypto.AES_256_CCM_8@tok
CoreCrypto.aead_cipher)
:named typing_tok_CoreCrypto.AES_256_CCM_8@tok))
;;;;;;;;;;;;;;;;typing for data constructor proxy
;;; Fact-ids: Name CoreCrypto.aead_cipher; Namespace CoreCrypto; Name CoreCrypto.AES_128_GCM; Namespace CoreCrypto; Name CoreCrypto.AES_256_GCM; Namespace CoreCrypto; Name CoreCrypto.CHACHA20_POLY1305; Namespace CoreCrypto; Name CoreCrypto.AES_128_CCM; Namespace CoreCrypto; Name CoreCrypto.AES_256_CCM; Namespace CoreCrypto; Name CoreCrypto.AES_128_CCM_8; Namespace CoreCrypto; Name CoreCrypto.AES_256_CCM_8; Namespace CoreCrypto
(assert (! (HasType CoreCrypto.AES_256_CCM@tok
CoreCrypto.aead_cipher)
:named typing_tok_CoreCrypto.AES_256_CCM@tok))
;;;;;;;;;;;;;;;;typing for data constructor proxy
;;; Fact-ids: Name CoreCrypto.aead_cipher; Namespace CoreCrypto; Name CoreCrypto.AES_128_GCM; Namespace CoreCrypto; Name CoreCrypto.AES_256_GCM; Namespace CoreCrypto; Name CoreCrypto.CHACHA20_POLY1305; Namespace CoreCrypto; Name CoreCrypto.AES_128_CCM; Namespace CoreCrypto; Name CoreCrypto.AES_256_CCM; Namespace CoreCrypto; Name CoreCrypto.AES_128_CCM_8; Namespace CoreCrypto; Name CoreCrypto.AES_256_CCM_8; Namespace CoreCrypto
(assert (! (HasType CoreCrypto.AES_128_GCM@tok
CoreCrypto.aead_cipher)
:named typing_tok_CoreCrypto.AES_128_GCM@tok))
;;;;;;;;;;;;;;;;typing for data constructor proxy
;;; Fact-ids: Name CoreCrypto.aead_cipher; Namespace CoreCrypto; Name CoreCrypto.AES_128_GCM; Namespace CoreCrypto; Name CoreCrypto.AES_256_GCM; Namespace CoreCrypto; Name CoreCrypto.CHACHA20_POLY1305; Namespace CoreCrypto; Name CoreCrypto.AES_128_CCM; Namespace CoreCrypto; Name CoreCrypto.AES_256_CCM; Namespace CoreCrypto; Name CoreCrypto.AES_128_CCM_8; Namespace CoreCrypto; Name CoreCrypto.AES_256_CCM_8; Namespace CoreCrypto
(assert (! (HasType CoreCrypto.AES_128_CCM_8@tok
CoreCrypto.aead_cipher)
:named typing_tok_CoreCrypto.AES_128_CCM_8@tok))
;;;;;;;;;;;;;;;;typing for data constructor proxy
;;; Fact-ids: Name CoreCrypto.aead_cipher; Namespace CoreCrypto; Name CoreCrypto.AES_128_GCM; Namespace CoreCrypto; Name CoreCrypto.AES_256_GCM; Namespace CoreCrypto; Name CoreCrypto.CHACHA20_POLY1305; Namespace CoreCrypto; Name CoreCrypto.AES_128_CCM; Namespace CoreCrypto; Name CoreCrypto.AES_256_CCM; Namespace CoreCrypto; Name CoreCrypto.AES_128_CCM_8; Namespace CoreCrypto; Name CoreCrypto.AES_256_CCM_8; Namespace CoreCrypto
(assert (! (HasType CoreCrypto.AES_128_CCM@tok
CoreCrypto.aead_cipher)
:named typing_tok_CoreCrypto.AES_128_CCM@tok))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Prims.unit; Namespace Prims
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name HyE.RSA.plainsize; Namespace HyE.RSA
(assert (! 
;; def=HyE.RSA.fst(40,4-40,13); use=HyE.RSA.fst(40,4-40,13)
(forall ((@u0 Dummy_sort))
 (! (HasType (HyE.RSA.plainsize @u0)
Prims.int)
 

:pattern ((HyE.RSA.plainsize @u0))
:qid typing_HyE.RSA.plainsize))

:named typing_HyE.RSA.plainsize))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name CoreCrypto.aeadKeySize; Namespace CoreCrypto
(assert (! 
;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/CoreCrypto/fst/CoreCrypto.fst(77,4-77,15); use=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/CoreCrypto/fst/CoreCrypto.fst(77,4-77,15)
(forall ((@x0 Term))
 (! (implies (HasType @x0
CoreCrypto.aead_cipher)
(HasType (CoreCrypto.aeadKeySize @x0)
Prims.int))
 

:pattern ((CoreCrypto.aeadKeySize @x0))
:qid typing_CoreCrypto.aeadKeySize))

:named typing_CoreCrypto.aeadKeySize))
;;;;;;;;;;;;;;;;refinement kinding
...
;;; Fact-ids: Name CoreCrypto.aead_cipher; Namespace CoreCrypto; Name CoreCrypto.AES_128_GCM; Namespace CoreCrypto; Name CoreCrypto.AES_256_GCM; Namespace CoreCrypto; Name CoreCrypto.CHACHA20_POLY1305; Namespace CoreCrypto; Name CoreCrypto.AES_128_CCM; Namespace CoreCrypto; Name CoreCrypto.AES_256_CCM; Namespace CoreCrypto; Name CoreCrypto.AES_128_CCM_8; Namespace CoreCrypto; Name CoreCrypto.AES_256_CCM_8; Namespace CoreCrypto
(assert (! (HasType CoreCrypto.aead_cipher
Tm_type)
:named kinding_CoreCrypto.aead_cipher@tok))
;;;;;;;;;;;;;;;;int typing
;;; Fact-ids: Name Prims.int; Namespace Prims
(assert (! (forall ((@u0 Int))
 (! (HasType (BoxInt @u0)
...
;;; Fact-ids: Name CoreCrypto.aead_cipher; Namespace CoreCrypto; Name CoreCrypto.AES_128_GCM; Namespace CoreCrypto; Name CoreCrypto.AES_256_GCM; Namespace CoreCrypto; Name CoreCrypto.CHACHA20_POLY1305; Namespace CoreCrypto; Name CoreCrypto.AES_128_CCM; Namespace CoreCrypto; Name CoreCrypto.AES_256_CCM; Namespace CoreCrypto; Name CoreCrypto.AES_128_CCM_8; Namespace CoreCrypto; Name CoreCrypto.AES_256_CCM_8; Namespace CoreCrypto
(assert (! 
;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/CoreCrypto/fst/CoreCrypto.fst(66,5-66,16); use=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/CoreCrypto/fst/CoreCrypto.fst(66,5-66,16)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel (SFuel @u0)
@x1
CoreCrypto.aead_cipher)
(or (is-CoreCrypto.AES_128_GCM @x1)
(is-CoreCrypto.AES_256_GCM @x1)
(is-CoreCrypto.CHACHA20_POLY1305 @x1)
(is-CoreCrypto.AES_128_CCM @x1)
(is-CoreCrypto.AES_256_CCM @x1)
(is-CoreCrypto.AES_128_CCM_8 @x1)
(is-CoreCrypto.AES_256_CCM_8 @x1)))
 

:pattern ((HasTypeFuel (SFuel @u0)
@x1
CoreCrypto.aead_cipher))
:qid fuel_guarded_inversion_CoreCrypto.aead_cipher))

:named fuel_guarded_inversion_CoreCrypto.aead_cipher))
...
;;;;;;;;;;;;;;;;Equation for HyE.RSA.plainsize
;;; Fact-ids: Name HyE.RSA.plainsize; Namespace HyE.RSA
(assert (! 
;; def=HyE.RSA.fst(40,4-40,13); use=HyE.RSA.fst(40,4-40,13)
(forall ((@u0 Dummy_sort))
 (! (= 
;; def=HyE.RSA.fst(40,4-40,13); use=HyE.RSA.fst(40,4-40,13)
(HyE.RSA.plainsize @u0)

(CoreCrypto.aeadKeySize CoreCrypto.AES_128_GCM@tok))
...
:qid equation_HyE.RSA.plainsize))

:named equation_HyE.RSA.plainsize))
;;;;;;;;;;;;;;;;Equation for CoreCrypto.aeadKeySize
;;; Fact-ids: Name CoreCrypto.aeadKeySize; Namespace CoreCrypto
(assert (! 
;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/CoreCrypto/fst/CoreCrypto.fst(77,4-77,15); use=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/CoreCrypto/fst/CoreCrypto.fst(77,4-77,15)
(forall ((@x0 Term))
 (! (= (CoreCrypto.aeadKeySize @x0)
(let ((@lb1 @x0))
(ite (is-CoreCrypto.AES_128_CCM @lb1)
(BoxInt 16)
(ite (is-CoreCrypto.AES_128_CCM_8 @lb1)
(BoxInt 16)
(ite (is-CoreCrypto.AES_128_GCM @lb1)
(BoxInt 16)
(ite (is-CoreCrypto.AES_256_CCM @lb1)
(BoxInt 32)
(ite (is-CoreCrypto.AES_256_CCM_8 @lb1)
(BoxInt 32)
(ite (is-CoreCrypto.AES_256_GCM @lb1)
(BoxInt 32)
(ite (is-CoreCrypto.CHACHA20_POLY1305 @lb1)
(BoxInt 32)
Tm_unit)))))))))
 

:pattern ((CoreCrypto.aeadKeySize @x0))
:qid equation_CoreCrypto.aeadKeySize))

:named equation_CoreCrypto.aeadKeySize))
;;;;;;;;;;;;;;;;equality for proxy
;;; Fact-ids: Name CoreCrypto.aead_cipher; Namespace CoreCrypto; Name CoreCrypto.AES_128_GCM; Namespace CoreCrypto; Name CoreCrypto.AES_256_GCM; Namespace CoreCrypto; Name CoreCrypto.CHACHA20_POLY1305; Namespace CoreCrypto; Name CoreCrypto.AES_128_CCM; Namespace CoreCrypto; Name CoreCrypto.AES_256_CCM; Namespace CoreCrypto; Name CoreCrypto.AES_128_CCM_8; Namespace CoreCrypto; Name CoreCrypto.AES_256_CCM_8; Namespace CoreCrypto
(assert (! (= CoreCrypto.CHACHA20_POLY1305@tok
CoreCrypto.CHACHA20_POLY1305)
:named equality_tok_CoreCrypto.CHACHA20_POLY1305@tok))
;;;;;;;;;;;;;;;;equality for proxy
;;; Fact-ids: Name CoreCrypto.aead_cipher; Namespace CoreCrypto; Name CoreCrypto.AES_128_GCM; Namespace CoreCrypto; Name CoreCrypto.AES_256_GCM; Namespace CoreCrypto; Name CoreCrypto.CHACHA20_POLY1305; Namespace CoreCrypto; Name CoreCrypto.AES_128_CCM; Namespace CoreCrypto; Name CoreCrypto.AES_256_CCM; Namespace CoreCrypto; Name CoreCrypto.AES_128_CCM_8; Namespace CoreCrypto; Name CoreCrypto.AES_256_CCM_8; Namespace CoreCrypto
(assert (! (= CoreCrypto.AES_256_GCM@tok
CoreCrypto.AES_256_GCM)
:named equality_tok_CoreCrypto.AES_256_GCM@tok))
;;;;;;;;;;;;;;;;equality for proxy
;;; Fact-ids: Name CoreCrypto.aead_cipher; Namespace CoreCrypto; Name CoreCrypto.AES_128_GCM; Namespace CoreCrypto; Name CoreCrypto.AES_256_GCM; Namespace CoreCrypto; Name CoreCrypto.CHACHA20_POLY1305; Namespace CoreCrypto; Name CoreCrypto.AES_128_CCM; Namespace CoreCrypto; Name CoreCrypto.AES_256_CCM; Namespace CoreCrypto; Name CoreCrypto.AES_128_CCM_8; Namespace CoreCrypto; Name CoreCrypto.AES_256_CCM_8; Namespace CoreCrypto
(assert (! (= CoreCrypto.AES_256_CCM_8@tok
CoreCrypto.AES_256_CCM_8)
:named equality_tok_CoreCrypto.AES_256_CCM_8@tok))
;;;;;;;;;;;;;;;;equality for proxy
;;; Fact-ids: Name CoreCrypto.aead_cipher; Namespace CoreCrypto; Name CoreCrypto.AES_128_GCM; Namespace CoreCrypto; Name CoreCrypto.AES_256_GCM; Namespace CoreCrypto; Name CoreCrypto.CHACHA20_POLY1305; Namespace CoreCrypto; Name CoreCrypto.AES_128_CCM; Namespace CoreCrypto; Name CoreCrypto.AES_256_CCM; Namespace CoreCrypto; Name CoreCrypto.AES_128_CCM_8; Namespace CoreCrypto; Name CoreCrypto.AES_256_CCM_8; Namespace CoreCrypto
(assert (! (= CoreCrypto.AES_256_CCM@tok
CoreCrypto.AES_256_CCM)
:named equality_tok_CoreCrypto.AES_256_CCM@tok))
;;;;;;;;;;;;;;;;equality for proxy
;;; Fact-ids: Name CoreCrypto.aead_cipher; Namespace CoreCrypto; Name CoreCrypto.AES_128_GCM; Namespace CoreCrypto; Name CoreCrypto.AES_256_GCM; Namespace CoreCrypto; Name CoreCrypto.CHACHA20_POLY1305; Namespace CoreCrypto; Name CoreCrypto.AES_128_CCM; Namespace CoreCrypto; Name CoreCrypto.AES_256_CCM; Namespace CoreCrypto; Name CoreCrypto.AES_128_CCM_8; Namespace CoreCrypto; Name CoreCrypto.AES_256_CCM_8; Namespace CoreCrypto
(assert (! (= CoreCrypto.AES_128_GCM@tok
CoreCrypto.AES_128_GCM)
:named equality_tok_CoreCrypto.AES_128_GCM@tok))
;;;;;;;;;;;;;;;;equality for proxy
;;; Fact-ids: Name CoreCrypto.aead_cipher; Namespace CoreCrypto; Name CoreCrypto.AES_128_GCM; Namespace CoreCrypto; Name CoreCrypto.AES_256_GCM; Namespace CoreCrypto; Name CoreCrypto.CHACHA20_POLY1305; Namespace CoreCrypto; Name CoreCrypto.AES_128_CCM; Namespace CoreCrypto; Name CoreCrypto.AES_256_CCM; Namespace CoreCrypto; Name CoreCrypto.AES_128_CCM_8; Namespace CoreCrypto; Name CoreCrypto.AES_256_CCM_8; Namespace CoreCrypto
(assert (! (= CoreCrypto.AES_128_CCM_8@tok
CoreCrypto.AES_128_CCM_8)
:named equality_tok_CoreCrypto.AES_128_CCM_8@tok))
;;;;;;;;;;;;;;;;equality for proxy
;;; Fact-ids: Name CoreCrypto.aead_cipher; Namespace CoreCrypto; Name CoreCrypto.AES_128_GCM; Namespace CoreCrypto; Name CoreCrypto.AES_256_GCM; Namespace CoreCrypto; Name CoreCrypto.CHACHA20_POLY1305; Namespace CoreCrypto; Name CoreCrypto.AES_128_CCM; Namespace CoreCrypto; Name CoreCrypto.AES_256_CCM; Namespace CoreCrypto; Name CoreCrypto.AES_128_CCM_8; Namespace CoreCrypto; Name CoreCrypto.AES_256_CCM_8; Namespace CoreCrypto
(assert (! (= CoreCrypto.AES_128_CCM@tok
CoreCrypto.AES_128_CCM)
:named equality_tok_CoreCrypto.AES_128_CCM@tok))
...
;;; Fact-ids: Name CoreCrypto.aead_cipher; Namespace CoreCrypto; Name CoreCrypto.AES_128_GCM; Namespace CoreCrypto; Name CoreCrypto.AES_256_GCM; Namespace CoreCrypto; Name CoreCrypto.CHACHA20_POLY1305; Namespace CoreCrypto; Name CoreCrypto.AES_128_CCM; Namespace CoreCrypto; Name CoreCrypto.AES_256_CCM; Namespace CoreCrypto; Name CoreCrypto.AES_128_CCM_8; Namespace CoreCrypto; Name CoreCrypto.AES_256_CCM_8; Namespace CoreCrypto
(assert (! 
;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/CoreCrypto/fst/CoreCrypto.fst(69,4-69,21); use=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/CoreCrypto/fst/CoreCrypto.fst(69,4-69,21)
(forall ((@u0 Fuel))
 (! (HasTypeFuel @u0
CoreCrypto.CHACHA20_POLY1305
CoreCrypto.aead_cipher)
...
CoreCrypto.CHACHA20_POLY1305
CoreCrypto.aead_cipher))
:qid data_typing_intro_CoreCrypto.CHACHA20_POLY1305@tok))

:named data_typing_intro_CoreCrypto.CHACHA20_POLY1305@tok))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name CoreCrypto.aead_cipher; Namespace CoreCrypto; Name CoreCrypto.AES_128_GCM; Namespace CoreCrypto; Name CoreCrypto.AES_256_GCM; Namespace CoreCrypto; Name CoreCrypto.CHACHA20_POLY1305; Namespace CoreCrypto; Name CoreCrypto.AES_128_CCM; Namespace CoreCrypto; Name CoreCrypto.AES_256_CCM; Namespace CoreCrypto; Name CoreCrypto.AES_128_CCM_8; Namespace CoreCrypto; Name CoreCrypto.AES_256_CCM_8; Namespace CoreCrypto
(assert (! 
;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/CoreCrypto/fst/CoreCrypto.fst(68,4-68,15); use=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/CoreCrypto/fst/CoreCrypto.fst(68,4-68,15)
(forall ((@u0 Fuel))
 (! (HasTypeFuel @u0
CoreCrypto.AES_256_GCM
CoreCrypto.aead_cipher)
...
CoreCrypto.AES_256_GCM
CoreCrypto.aead_cipher))
:qid data_typing_intro_CoreCrypto.AES_256_GCM@tok))

:named data_typing_intro_CoreCrypto.AES_256_GCM@tok))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name CoreCrypto.aead_cipher; Namespace CoreCrypto; Name CoreCrypto.AES_128_GCM; Namespace CoreCrypto; Name CoreCrypto.AES_256_GCM; Namespace CoreCrypto; Name CoreCrypto.CHACHA20_POLY1305; Namespace CoreCrypto; Name CoreCrypto.AES_128_CCM; Namespace CoreCrypto; Name CoreCrypto.AES_256_CCM; Namespace CoreCrypto; Name CoreCrypto.AES_128_CCM_8; Namespace CoreCrypto; Name CoreCrypto.AES_256_CCM_8; Namespace CoreCrypto
(assert (! 
;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/CoreCrypto/fst/CoreCrypto.fst(73,4-73,17); use=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/CoreCrypto/fst/CoreCrypto.fst(73,4-73,17)
(forall ((@u0 Fuel))
 (! (HasTypeFuel @u0
CoreCrypto.AES_256_CCM_8
CoreCrypto.aead_cipher)
...
CoreCrypto.AES_256_CCM_8
CoreCrypto.aead_cipher))
:qid data_typing_intro_CoreCrypto.AES_256_CCM_8@tok))

:named data_typing_intro_CoreCrypto.AES_256_CCM_8@tok))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name CoreCrypto.aead_cipher; Namespace CoreCrypto; Name CoreCrypto.AES_128_GCM; Namespace CoreCrypto; Name CoreCrypto.AES_256_GCM; Namespace CoreCrypto; Name CoreCrypto.CHACHA20_POLY1305; Namespace CoreCrypto; Name CoreCrypto.AES_128_CCM; Namespace CoreCrypto; Name CoreCrypto.AES_256_CCM; Namespace CoreCrypto; Name CoreCrypto.AES_128_CCM_8; Namespace CoreCrypto; Name CoreCrypto.AES_256_CCM_8; Namespace CoreCrypto
(assert (! 
;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/CoreCrypto/fst/CoreCrypto.fst(71,4-71,15); use=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/CoreCrypto/fst/CoreCrypto.fst(71,4-71,15)
(forall ((@u0 Fuel))
 (! (HasTypeFuel @u0
CoreCrypto.AES_256_CCM
CoreCrypto.aead_cipher)
...
CoreCrypto.AES_256_CCM
CoreCrypto.aead_cipher))
:qid data_typing_intro_CoreCrypto.AES_256_CCM@tok))

:named data_typing_intro_CoreCrypto.AES_256_CCM@tok))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name CoreCrypto.aead_cipher; Namespace CoreCrypto; Name CoreCrypto.AES_128_GCM; Namespace CoreCrypto; Name CoreCrypto.AES_256_GCM; Namespace CoreCrypto; Name CoreCrypto.CHACHA20_POLY1305; Namespace CoreCrypto; Name CoreCrypto.AES_128_CCM; Namespace CoreCrypto; Name CoreCrypto.AES_256_CCM; Namespace CoreCrypto; Name CoreCrypto.AES_128_CCM_8; Namespace CoreCrypto; Name CoreCrypto.AES_256_CCM_8; Namespace CoreCrypto
(assert (! 
;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/CoreCrypto/fst/CoreCrypto.fst(67,4-67,15); use=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/CoreCrypto/fst/CoreCrypto.fst(67,4-67,15)
(forall ((@u0 Fuel))
 (! (HasTypeFuel @u0
CoreCrypto.AES_128_GCM
CoreCrypto.aead_cipher)
...
CoreCrypto.AES_128_GCM
CoreCrypto.aead_cipher))
:qid data_typing_intro_CoreCrypto.AES_128_GCM@tok))

:named data_typing_intro_CoreCrypto.AES_128_GCM@tok))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name CoreCrypto.aead_cipher; Namespace CoreCrypto; Name CoreCrypto.AES_128_GCM; Namespace CoreCrypto; Name CoreCrypto.AES_256_GCM; Namespace CoreCrypto; Name CoreCrypto.CHACHA20_POLY1305; Namespace CoreCrypto; Name CoreCrypto.AES_128_CCM; Namespace CoreCrypto; Name CoreCrypto.AES_256_CCM; Namespace CoreCrypto; Name CoreCrypto.AES_128_CCM_8; Namespace CoreCrypto; Name CoreCrypto.AES_256_CCM_8; Namespace CoreCrypto
(assert (! 
;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/CoreCrypto/fst/CoreCrypto.fst(72,4-72,17); use=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/CoreCrypto/fst/CoreCrypto.fst(72,4-72,17)
(forall ((@u0 Fuel))
 (! (HasTypeFuel @u0
CoreCrypto.AES_128_CCM_8
CoreCrypto.aead_cipher)
...
CoreCrypto.AES_128_CCM_8
CoreCrypto.aead_cipher))
:qid data_typing_intro_CoreCrypto.AES_128_CCM_8@tok))

:named data_typing_intro_CoreCrypto.AES_128_CCM_8@tok))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name CoreCrypto.aead_cipher; Namespace CoreCrypto; Name CoreCrypto.AES_128_GCM; Namespace CoreCrypto; Name CoreCrypto.AES_256_GCM; Namespace CoreCrypto; Name CoreCrypto.CHACHA20_POLY1305; Namespace CoreCrypto; Name CoreCrypto.AES_128_CCM; Namespace CoreCrypto; Name CoreCrypto.AES_256_CCM; Namespace CoreCrypto; Name CoreCrypto.AES_128_CCM_8; Namespace CoreCrypto; Name CoreCrypto.AES_256_CCM_8; Namespace CoreCrypto
(assert (! 
;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/CoreCrypto/fst/CoreCrypto.fst(70,4-70,15); use=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/CoreCrypto/fst/CoreCrypto.fst(70,4-70,15)
(forall ((@u0 Fuel))
 (! (HasTypeFuel @u0
CoreCrypto.AES_128_CCM
CoreCrypto.aead_cipher)
...
CoreCrypto.AES_128_CCM
CoreCrypto.aead_cipher))
:qid data_typing_intro_CoreCrypto.AES_128_CCM@tok))

:named data_typing_intro_CoreCrypto.AES_128_CCM@tok))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Prims.unit; Namespace Prims
(assert (! (= 125
...
;;; Fact-ids: Name CoreCrypto.aead_cipher; Namespace CoreCrypto; Name CoreCrypto.AES_128_GCM; Namespace CoreCrypto; Name CoreCrypto.AES_256_GCM; Namespace CoreCrypto; Name CoreCrypto.CHACHA20_POLY1305; Namespace CoreCrypto; Name CoreCrypto.AES_128_CCM; Namespace CoreCrypto; Name CoreCrypto.AES_256_CCM; Namespace CoreCrypto; Name CoreCrypto.AES_128_CCM_8; Namespace CoreCrypto; Name CoreCrypto.AES_256_CCM_8; Namespace CoreCrypto
(assert (! (= 202
(Term_constr_id CoreCrypto.aead_cipher))
:named constructor_distinct_CoreCrypto.aead_cipher))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name CoreCrypto.aead_cipher; Namespace CoreCrypto; Name CoreCrypto.AES_128_GCM; Namespace CoreCrypto; Name CoreCrypto.AES_256_GCM; Namespace CoreCrypto; Name CoreCrypto.CHACHA20_POLY1305; Namespace CoreCrypto; Name CoreCrypto.AES_128_CCM; Namespace CoreCrypto; Name CoreCrypto.AES_256_CCM; Namespace CoreCrypto; Name CoreCrypto.AES_128_CCM_8; Namespace CoreCrypto; Name CoreCrypto.AES_256_CCM_8; Namespace CoreCrypto
(assert (! (= 212
(Term_constr_id CoreCrypto.CHACHA20_POLY1305))
:named constructor_distinct_CoreCrypto.CHACHA20_POLY1305))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name CoreCrypto.aead_cipher; Namespace CoreCrypto; Name CoreCrypto.AES_128_GCM; Namespace CoreCrypto; Name CoreCrypto.AES_256_GCM; Namespace CoreCrypto; Name CoreCrypto.CHACHA20_POLY1305; Namespace CoreCrypto; Name CoreCrypto.AES_128_CCM; Namespace CoreCrypto; Name CoreCrypto.AES_256_CCM; Namespace CoreCrypto; Name CoreCrypto.AES_128_CCM_8; Namespace CoreCrypto; Name CoreCrypto.AES_256_CCM_8; Namespace CoreCrypto
(assert (! (= 210
(Term_constr_id CoreCrypto.AES_256_GCM))
:named constructor_distinct_CoreCrypto.AES_256_GCM))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name CoreCrypto.aead_cipher; Namespace CoreCrypto; Name CoreCrypto.AES_128_GCM; Namespace CoreCrypto; Name CoreCrypto.AES_256_GCM; Namespace CoreCrypto; Name CoreCrypto.CHACHA20_POLY1305; Namespace CoreCrypto; Name CoreCrypto.AES_128_CCM; Namespace CoreCrypto; Name CoreCrypto.AES_256_CCM; Namespace CoreCrypto; Name CoreCrypto.AES_128_CCM_8; Namespace CoreCrypto; Name CoreCrypto.AES_256_CCM_8; Namespace CoreCrypto
(assert (! (= 220
(Term_constr_id CoreCrypto.AES_256_CCM_8))
:named constructor_distinct_CoreCrypto.AES_256_CCM_8))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name CoreCrypto.aead_cipher; Namespace CoreCrypto; Name CoreCrypto.AES_128_GCM; Namespace CoreCrypto; Name CoreCrypto.AES_256_GCM; Namespace CoreCrypto; Name CoreCrypto.CHACHA20_POLY1305; Namespace CoreCrypto; Name CoreCrypto.AES_128_CCM; Namespace CoreCrypto; Name CoreCrypto.AES_256_CCM; Namespace CoreCrypto; Name CoreCrypto.AES_128_CCM_8; Namespace CoreCrypto; Name CoreCrypto.AES_256_CCM_8; Namespace CoreCrypto
(assert (! (= 216
(Term_constr_id CoreCrypto.AES_256_CCM))
:named constructor_distinct_CoreCrypto.AES_256_CCM))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name CoreCrypto.aead_cipher; Namespace CoreCrypto; Name CoreCrypto.AES_128_GCM; Namespace CoreCrypto; Name CoreCrypto.AES_256_GCM; Namespace CoreCrypto; Name CoreCrypto.CHACHA20_POLY1305; Namespace CoreCrypto; Name CoreCrypto.AES_128_CCM; Namespace CoreCrypto; Name CoreCrypto.AES_256_CCM; Namespace CoreCrypto; Name CoreCrypto.AES_128_CCM_8; Namespace CoreCrypto; Name CoreCrypto.AES_256_CCM_8; Namespace CoreCrypto
(assert (! (= 208
(Term_constr_id CoreCrypto.AES_128_GCM))
:named constructor_distinct_CoreCrypto.AES_128_GCM))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name CoreCrypto.aead_cipher; Namespace CoreCrypto; Name CoreCrypto.AES_128_GCM; Namespace CoreCrypto; Name CoreCrypto.AES_256_GCM; Namespace CoreCrypto; Name CoreCrypto.CHACHA20_POLY1305; Namespace CoreCrypto; Name CoreCrypto.AES_128_CCM; Namespace CoreCrypto; Name CoreCrypto.AES_256_CCM; Namespace CoreCrypto; Name CoreCrypto.AES_128_CCM_8; Namespace CoreCrypto; Name CoreCrypto.AES_256_CCM_8; Namespace CoreCrypto
(assert (! (= 218
(Term_constr_id CoreCrypto.AES_128_CCM_8))
:named constructor_distinct_CoreCrypto.AES_128_CCM_8))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name CoreCrypto.aead_cipher; Namespace CoreCrypto; Name CoreCrypto.AES_128_GCM; Namespace CoreCrypto; Name CoreCrypto.AES_256_GCM; Namespace CoreCrypto; Name CoreCrypto.CHACHA20_POLY1305; Namespace CoreCrypto; Name CoreCrypto.AES_128_CCM; Namespace CoreCrypto; Name CoreCrypto.AES_256_CCM; Namespace CoreCrypto; Name CoreCrypto.AES_128_CCM_8; Namespace CoreCrypto; Name CoreCrypto.AES_256_CCM_8; Namespace CoreCrypto
(assert (! (= 214
(Term_constr_id CoreCrypto.AES_128_CCM))
:named constructor_distinct_CoreCrypto.AES_128_CCM))
;;;;;;;;;;;;;;;;bool typing
;;; Fact-ids: Name Prims.bool; Namespace Prims
(assert (! (forall ((@u0 Bool))
 (! (HasType (BoxBool @u0)
...
;;;;;;;;;;;;;;;;Assumption: CoreCrypto.aead_cipher__uu___haseq
;;; Fact-ids: Name CoreCrypto.aead_cipher__uu___haseq; Namespace CoreCrypto
(assert (! (Valid (Prims.hasEq CoreCrypto.aead_cipher))
:named assumption_CoreCrypto.aead_cipher__uu___haseq))
;;;;;;;;;;;;;;;;pretyping
;;; Fact-ids: Name Prims.unit; Namespace Prims
(assert (! 
...
@x0
CoreCrypto.aead_cipher))
:qid CoreCrypto_pretyping_3d5f8f9ae6a94bdaf2e0e80dbcfea8a1))

:named CoreCrypto_pretyping_3d5f8f9ae6a94bdaf2e0e80dbcfea8a1))
(push) ;; push{2

; Starting query at HyE.RSA.fst(42,5-42,10)

(declare-fun label_1 () Bool)

; Encoding query formula : HyE.RSA.plainsize >= 0


; Context: While encoding a query
; While checking for top-level effects
; While typechecking the top-level declaration `let plain`
...
;;; Fact-ids: 
(assert (! (not 
;; def=Prims.fst(680,18-680,24); use=HyE.RSA.fst(42,22-42,31)
(or label_1

;; def=Prims.fst(680,18-680,24); use=HyE.RSA.fst(42,22-42,31)
(>= (BoxInt_proj_0 (HyE.RSA.plainsize Dummy_value))
(BoxInt_proj_0 (BoxInt 0)))
)
)
:named @query))
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (HyE.RSA.plain, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, constructor_distinct_CoreCrypto.AES_128_GCM, equality_tok_CoreCrypto.AES_128_GCM@tok, equation_CoreCrypto.aeadKeySize, equation_HyE.RSA.plainsize, projection_inverse_BoxInt_proj_0
...
; encoding sigelt let plain


; <Start encoding let plain>

(declare-fun HyE.RSA.plain () Term)

; </end encoding let plain>


; encoding sigelt let cipher


; <Start encoding let cipher>

(declare-fun HyE.RSA.cipher () Term)

; </end encoding let cipher>


; encoding sigelt let keypair


; <Start encoding let keypair>

(declare-fun HyE.RSA.keypair () Term)

; </end encoding let keypair>


; encoding sigelt val HyE.RSA.generated


; <Start encoding val HyE.RSA.generated>

(declare-fun HyE.RSA.generated (Term) Term)
;;;;;;;;;;;;;;;;_: keypair -> Prims.bool
(declare-fun Tm_arrow_9708fb6fcb5c6f3ba64b7edece1ff174 () Term)
(declare-fun HyE.RSA.generated@tok () Term)

; </end encoding val HyE.RSA.generated>


; encoding sigelt val HyE.RSA.gen


; <Start encoding val HyE.RSA.gen>

(declare-fun HyE.RSA.gen (Term) Term)
(declare-fun Tm_refine_f1274e9940692ad16f41c84e1b77d164 () Term)
;;;;;;;;;;;;;;;;_: Prims.unit -> x: keypair{generated x}
(declare-fun Tm_arrow_c3f36cd7a9cec2f901e300377f11b012 () Term)
(declare-fun HyE.RSA.gen@tok () Term)


; </end encoding val HyE.RSA.gen>


; encoding sigelt val HyE.RSA.dec


; <Start encoding val HyE.RSA.dec>

(declare-fun HyE.RSA.dec (Term Term) Term)
;;;;;;;;;;;;;;;;_: skey -> _: cipher -> FStar.Pervasives.Native.option plain
(declare-fun Tm_arrow_d7a64f39747c104779db42e89a97a8bd () Term)
(declare-fun HyE.RSA.dec@tok () Term)

; </end encoding val HyE.RSA.dec>
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Platform.Bytes.length; Namespace Platform.Bytes
(assert (! 
;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(71,4-71,10); use=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(71,4-71,10)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Platform.Bytes.bytes)
(HasType (Platform.Bytes.length @x0)
Prims.nat))
 

:pattern ((Platform.Bytes.length @x0))
:qid typing_Platform.Bytes.length))

:named typing_Platform.Bytes.length))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Platform.Bytes.lbytes; Namespace Platform.Bytes
(assert (! 
;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(74,5-74,11); use=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(74,5-74,11)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Prims.nat)
(HasType (Platform.Bytes.lbytes @x0)
Tm_type))
 

:pattern ((Platform.Bytes.lbytes @x0))
:qid typing_Platform.Bytes.lbytes))

:named typing_Platform.Bytes.lbytes))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Platform.Bytes.bytes; Namespace Platform.Bytes
(assert (! (HasType Platform.Bytes.bytes
Tm_type)
:named typing_Platform.Bytes.bytes))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name HyE.RSA.skey; Namespace HyE.RSA
(assert (! (HasType HyE.RSA.skey
Tm_type)
:named typing_HyE.RSA.skey))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name HyE.RSA.plain; Namespace HyE.RSA
(assert (! (HasType HyE.RSA.plain
Tm_type)
:named typing_HyE.RSA.plain))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name HyE.RSA.pkey; Namespace HyE.RSA
(assert (! (HasType HyE.RSA.pkey
Tm_type)
:named typing_HyE.RSA.pkey))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name HyE.RSA.keypair; Namespace HyE.RSA
(assert (! (HasType HyE.RSA.keypair
Tm_type)
:named typing_HyE.RSA.keypair))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name HyE.RSA.generated; Namespace HyE.RSA
(assert (! 
;; def=HyE.RSA.fst(46,11-46,20); use=HyE.RSA.fst(46,11-46,20)
(forall ((@x0 Term))
 (! (implies (HasType @x0
HyE.RSA.keypair)
(HasType (HyE.RSA.generated @x0)
Prims.bool))
 

:pattern ((HyE.RSA.generated @x0))
:qid typing_HyE.RSA.generated))

:named typing_HyE.RSA.generated))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name HyE.RSA.ciphersize; Namespace HyE.RSA
(assert (! 
;; def=HyE.RSA.fst(41,11-41,21); use=HyE.RSA.fst(41,11-41,21)
(forall ((@u0 Dummy_sort))
 (! (HasType (HyE.RSA.ciphersize @u0)
Prims.nat)
 

:pattern ((HyE.RSA.ciphersize @u0))
:qid typing_HyE.RSA.ciphersize))

:named typing_HyE.RSA.ciphersize))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name HyE.RSA.cipher; Namespace HyE.RSA
(assert (! (HasType HyE.RSA.cipher
Tm_type)
:named typing_HyE.RSA.cipher))
;;;;;;;;;;;;;;;;free var typing
...
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name HyE.RSA.gen; Namespace HyE.RSA
(assert (! (HasType Tm_refine_f1274e9940692ad16f41c84e1b77d164
Tm_type)
:named refinement_kinding_Tm_refine_f1274e9940692ad16f41c84e1b77d164))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name Platform.Bytes.cbyte2; Namespace Platform.Bytes
(assert (! (HasType Tm_refine_ea5dbefce270769c7885e1a331aaf62b
Tm_type)
:named refinement_kinding_Tm_refine_ea5dbefce270769c7885e1a331aaf62b))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name Platform.Bytes.lbytes; Namespace Platform.Bytes
(assert (! 
;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(74,22-74,43); use=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(74,22-74,43)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_b3982a6d174e1d047431ae85c35dc7d8 @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_b3982a6d174e1d047431ae85c35dc7d8 @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_b3982a6d174e1d047431ae85c35dc7d8))

:named refinement_kinding_Tm_refine_b3982a6d174e1d047431ae85c35dc7d8))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name Platform.Bytes.repr_bytes; Namespace Platform.Bytes
...
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name Platform.Bytes.cbyte; Namespace Platform.Bytes
(assert (! (HasType Tm_refine_9f61c0ee1ebed7248bd016eb62ec2174
Tm_type)
:named refinement_kinding_Tm_refine_9f61c0ee1ebed7248bd016eb62ec2174))
;;;;;;;;;;;;;;;;refinement kinding
...
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name CoreCrypto.ec_bytelen; Namespace CoreCrypto
(assert (! (HasType Tm_refine_379d104eb4e93e4b7c171c2bc0c85c67
Tm_type)
:named refinement_kinding_Tm_refine_379d104eb4e93e4b7c171c2bc0c85c67))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name Platform.Bytes.byte_of_int; Namespace Platform.Bytes
...
;;; Fact-ids: Name HyE.RSA.gen; Namespace HyE.RSA
(assert (! 
;; def=HyE.RSA.fst(48,24-48,46); use=HyE.RSA.fst(48,24-48,46)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_f1274e9940692ad16f41c84e1b77d164)
(and (HasTypeFuel @u0
@x1
HyE.RSA.keypair)

;; def=HyE.RSA.fst(48,34-48,45); use=HyE.RSA.fst(48,34-48,45)
(BoxBool_proj_0 (HyE.RSA.generated @x1))
))
...
@x1
Tm_refine_f1274e9940692ad16f41c84e1b77d164))
:qid refinement_interpretation_Tm_refine_f1274e9940692ad16f41c84e1b77d164))

:named refinement_interpretation_Tm_refine_f1274e9940692ad16f41c84e1b77d164))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name Platform.Bytes.cbyte2; Namespace Platform.Bytes
(assert (! 
;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(96,13-96,39); use=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(97,4-97,10)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_ea5dbefce270769c7885e1a331aaf62b)
(and (HasTypeFuel @u0
@x1
Platform.Bytes.bytes)

;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(96,21-96,38); use=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(97,4-97,10)
(>= (BoxInt_proj_0 (FStar.Seq.Base.length (FStar.UInt8.t Dummy_value)
@x1))
...
@x1
Tm_refine_ea5dbefce270769c7885e1a331aaf62b))
:qid refinement_interpretation_Tm_refine_ea5dbefce270769c7885e1a331aaf62b))

:named refinement_interpretation_Tm_refine_ea5dbefce270769c7885e1a331aaf62b))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name Platform.Bytes.lbytes; Namespace Platform.Bytes
(assert (! 
;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(74,22-74,43); use=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(74,22-74,43)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_b3982a6d174e1d047431ae85c35dc7d8 @x2))
(and (HasTypeFuel @u0
@x1
Platform.Bytes.bytes)

;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(74,30-74,42); use=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(74,30-74,42)
(= (Platform.Bytes.length @x1)
@x2)
))
...
@x1
(Tm_refine_b3982a6d174e1d047431ae85c35dc7d8 @x2)))
:qid refinement_interpretation_Tm_refine_b3982a6d174e1d047431ae85c35dc7d8))

:named refinement_interpretation_Tm_refine_b3982a6d174e1d047431ae85c35dc7d8))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name Platform.Bytes.repr_bytes; Namespace Platform.Bytes
(assert (! 
;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(18,36-18,48); use=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(18,36-18,48)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
...
;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(18,43-18,46); use=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(18,43-18,46)
(> (BoxInt_proj_0 @x1)
(BoxInt_proj_0 (BoxInt 0)))
))
...
;;; Fact-ids: Name Platform.Bytes.cbyte; Namespace Platform.Bytes
(assert (! 
;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(93,12-93,37); use=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(94,4-94,9)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_9f61c0ee1ebed7248bd016eb62ec2174)
(and (HasTypeFuel @u0
@x1
Platform.Bytes.bytes)

;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(93,20-93,36); use=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(94,4-94,9)
(> (BoxInt_proj_0 (FStar.Seq.Base.length (FStar.UInt8.t Dummy_value)
@x1))
(BoxInt_proj_0 (BoxInt 0)))
))
...
@x1
Tm_refine_9f61c0ee1ebed7248bd016eb62ec2174))
:qid refinement_interpretation_Tm_refine_9f61c0ee1ebed7248bd016eb62ec2174))

:named refinement_interpretation_Tm_refine_9f61c0ee1ebed7248bd016eb62ec2174))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name FStar.UInt8.one; Namespace FStar.UInt8
(assert (! 
...
;;; Fact-ids: Name CoreCrypto.ec_bytelen; Namespace CoreCrypto
(assert (! 
;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/CoreCrypto/fst/CoreCrypto.fst(194,32-194,49); use=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/CoreCrypto/fst/CoreCrypto.fst(195,4-195,14)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_379d104eb4e93e4b7c171c2bc0c85c67)
(and (HasTypeFuel @u0
@x1
Prims.nat)

;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/CoreCrypto/fst/CoreCrypto.fst(194,39-194,47); use=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/CoreCrypto/fst/CoreCrypto.fst(195,4-195,14)
(<= (BoxInt_proj_0 @x1)
(BoxInt_proj_0 (BoxInt 127)))
))
...
@x1
Tm_refine_379d104eb4e93e4b7c171c2bc0c85c67))
:qid refinement_interpretation_Tm_refine_379d104eb4e93e4b7c171c2bc0c85c67))

:named refinement_interpretation_Tm_refine_379d104eb4e93e4b7c171c2bc0c85c67))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name Platform.Bytes.byte_of_int; Namespace Platform.Bytes
(assert (! 
;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(199,17-199,31); use=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(200,4-200,15)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
...
;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(199,23-199,30); use=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(200,4-200,15)
(< (BoxInt_proj_0 @x1)
...
;;;;;;;;;;;;;;;;haseq for Tm_refine_f1274e9940692ad16f41c84e1b77d164
;;; Fact-ids: Name HyE.RSA.gen; Namespace HyE.RSA
(assert (! (iff (Valid (Prims.hasEq Tm_refine_f1274e9940692ad16f41c84e1b77d164))
(Valid (Prims.hasEq HyE.RSA.keypair)))
:named haseqTm_refine_f1274e9940692ad16f41c84e1b77d164))
;;;;;;;;;;;;;;;;haseq for Tm_refine_ea5dbefce270769c7885e1a331aaf62b
;;; Fact-ids: Name Platform.Bytes.cbyte2; Namespace Platform.Bytes
(assert (! (iff (Valid (Prims.hasEq Tm_refine_ea5dbefce270769c7885e1a331aaf62b))
(Valid (Prims.hasEq Platform.Bytes.bytes)))
:named haseqTm_refine_ea5dbefce270769c7885e1a331aaf62b))
;;;;;;;;;;;;;;;;haseq for Tm_refine_b3982a6d174e1d047431ae85c35dc7d8
;;; Fact-ids: Name Platform.Bytes.lbytes; Namespace Platform.Bytes
(assert (! 
;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(74,22-74,43); use=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(74,22-74,43)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_b3982a6d174e1d047431ae85c35dc7d8 @x0)))
(Valid (Prims.hasEq Platform.Bytes.bytes)))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_b3982a6d174e1d047431ae85c35dc7d8 @x0))))
:qid haseqTm_refine_b3982a6d174e1d047431ae85c35dc7d8))

:named haseqTm_refine_b3982a6d174e1d047431ae85c35dc7d8))
...
;;;;;;;;;;;;;;;;haseq for Tm_refine_9f61c0ee1ebed7248bd016eb62ec2174
;;; Fact-ids: Name Platform.Bytes.cbyte; Namespace Platform.Bytes
(assert (! (iff (Valid (Prims.hasEq Tm_refine_9f61c0ee1ebed7248bd016eb62ec2174))
(Valid (Prims.hasEq Platform.Bytes.bytes)))
:named haseqTm_refine_9f61c0ee1ebed7248bd016eb62ec2174))
...
;;;;;;;;;;;;;;;;haseq for Tm_refine_379d104eb4e93e4b7c171c2bc0c85c67
;;; Fact-ids: Name CoreCrypto.ec_bytelen; Namespace CoreCrypto
(assert (! (iff (Valid (Prims.hasEq Tm_refine_379d104eb4e93e4b7c171c2bc0c85c67))
(Valid (Prims.hasEq Prims.nat)))
:named haseqTm_refine_379d104eb4e93e4b7c171c2bc0c85c67))
...
(assert (! (HasType Platform.Bytes.bytes
Tm_type)
:named function_token_typing_Platform.Bytes.bytes))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: Name HyE.RSA.skey; Namespace HyE.RSA
(assert (! (HasType HyE.RSA.skey
Tm_type)
:named function_token_typing_HyE.RSA.skey))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: Name HyE.RSA.plain; Namespace HyE.RSA
(assert (! (HasType HyE.RSA.plain
Tm_type)
:named function_token_typing_HyE.RSA.plain))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: Name HyE.RSA.pkey; Namespace HyE.RSA
(assert (! (HasType HyE.RSA.pkey
Tm_type)
:named function_token_typing_HyE.RSA.pkey))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: Name HyE.RSA.keypair; Namespace HyE.RSA
(assert (! (HasType HyE.RSA.keypair
Tm_type)
:named function_token_typing_HyE.RSA.keypair))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: Name HyE.RSA.cipher; Namespace HyE.RSA
(assert (! (HasType HyE.RSA.cipher
Tm_type)
:named function_token_typing_HyE.RSA.cipher))
;;;;;;;;;;;;;;;;inversion axiom
;;; Fact-ids: Name FStar.Pervasives.Native.tuple2; Namespace FStar.Pervasives.Native; Name FStar.Pervasives.Native.Mktuple2; Namespace FStar.Pervasives.Native
(assert (! 
;; def=FStar.Pervasives.Native.fst(59,5-59,11); use=FStar.Pervasives.Native.fst(59,5-59,11)
...
;;;;;;;;;;;;;;;;Equation for Platform.Bytes.length
;;; Fact-ids: Name Platform.Bytes.length; Namespace Platform.Bytes
(assert (! 
;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(71,4-71,10); use=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(71,4-71,10)
(forall ((@x0 Term))
 (! (= (Platform.Bytes.length @x0)
(FStar.Seq.Base.length (FStar.UInt8.t Dummy_value)
@x0))
 

:pattern ((Platform.Bytes.length @x0))
:qid equation_Platform.Bytes.length))

:named equation_Platform.Bytes.length))
;;;;;;;;;;;;;;;;Equation for Platform.Bytes.lbytes
;;; Fact-ids: Name Platform.Bytes.lbytes; Namespace Platform.Bytes
(assert (! 
;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(74,5-74,11); use=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(74,5-74,11)
(forall ((@x0 Term))
 (! (= (Platform.Bytes.lbytes @x0)
(Tm_refine_b3982a6d174e1d047431ae85c35dc7d8 @x0))
 

:pattern ((Platform.Bytes.lbytes @x0))
:qid equation_Platform.Bytes.lbytes))

:named equation_Platform.Bytes.lbytes))
;;;;;;;;;;;;;;;;Equation for Platform.Bytes.bytes
;;; Fact-ids: Name Platform.Bytes.bytes; Namespace Platform.Bytes
(assert (! (= Platform.Bytes.bytes
(FStar.Seq.Base.seq (FStar.UInt8.t Dummy_value)))
:named equation_Platform.Bytes.bytes))
;;;;;;;;;;;;;;;;Equation for HyE.RSA.plain
;;; Fact-ids: Name HyE.RSA.plain; Namespace HyE.RSA
(assert (! (= HyE.RSA.plain
(Platform.Bytes.lbytes (HyE.RSA.plainsize Dummy_value)))
:named equation_HyE.RSA.plain))
;;;;;;;;;;;;;;;;Equation for HyE.RSA.keypair
;;; Fact-ids: Name HyE.RSA.keypair; Namespace HyE.RSA
(assert (! (= HyE.RSA.keypair
(FStar.Pervasives.Native.tuple2 HyE.RSA.pkey
HyE.RSA.skey))
:named equation_HyE.RSA.keypair))
;;;;;;;;;;;;;;;;Equation for HyE.RSA.cipher
;;; Fact-ids: Name HyE.RSA.cipher; Namespace HyE.RSA
(assert (! (= HyE.RSA.cipher
(Platform.Bytes.lbytes (HyE.RSA.ciphersize Dummy_value)))
:named equation_HyE.RSA.cipher))
...
:named b2t_def))
;;;;;;;;;;;;;;;;Assumption: Platform.Bytes.HasEq_bytes
;;; Fact-ids: Name Platform.Bytes.HasEq_bytes; Namespace Platform.Bytes
(assert (! 
;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(59,20-59,31); use=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(59,20-59,31)
(Valid 
;; def=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(59,20-59,31); use=/home/runner/work/smt-logs/smt-logs/fstar/fstar/contrib/Platform/fst/Platform.Bytes.fst(59,20-59,31)
(Prims.hasEq Platform.Bytes.bytes)
)

:named assumption_Platform.Bytes.HasEq_bytes))
...
; Starting query at HyE.RSA.fst(50,7-50,100)

(declare-fun label_1 () Bool)

; Encoding query formula : forall (pk: HyE.RSA.pkey) (t: HyE.RSA.plain).
;   (*  - Subtyping check failed
;   - Expected type Type0 got type Type0
; *)
;   forall (c: HyE.RSA.cipher) (sk: HyE.RSA.skey).
;     HyE.RSA.generated (pk, sk) ==> Prims.hasEq (FStar.Pervasives.Native.option HyE.RSA.plain)


; Context: While encoding a query
; While typechecking the top-level declaration `val HyE.RSA.enc`
...
;;; Fact-ids: 
(assert (! (not 
;; def=dummy(0,0-0,0); use=HyE.RSA.fst(50,7-50,100)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
HyE.RSA.pkey)
(HasType @x1
...
;; def=dummy(0,0-0,0); use=HyE.RSA.fst(50,19-50,100)
...
;; def=HyE.RSA.fst(50,60-50,78); use=HyE.RSA.fst(50,60-50,78)
(BoxBool_proj_0 (HyE.RSA.generated (FStar.Pervasives.Native.Mktuple2 HyE.RSA.pkey
HyE.RSA.skey
@x0
@x3)))
)

;; def=Prims.fst(73,23-73,30); use=HyE.RSA.fst(50,92-50,96)
(or label_1

;; def=Prims.fst(73,23-73,30); use=HyE.RSA.fst(50,92-50,96)
(Valid 
;; def=Prims.fst(73,23-73,30); use=HyE.RSA.fst(50,92-50,96)
(Prims.hasEq (FStar.Pervasives.Native.option HyE.RSA.plain))
)
)
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (HyE.RSA.enc, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, assumption_FStar.Pervasives.Native.option__uu___haseq, assumption_Platform.Bytes.HasEq_bytes, equality_tok_CoreCrypto.AES_128_GCM@tok, equation_CoreCrypto.aeadKeySize, equation_HyE.RSA.plain, equation_HyE.RSA.plainsize, equation_Platform.Bytes.lbytes, haseqTm_refine_b3982a6d174e1d047431ae85c35dc7d8, typing_HyE.RSA.plain
