...
; Internals for CPS.SimpleLambdaLifting


; encoding sigelt val CPS.SimpleLambdaLifting.add_cps_intern


; <Skipped val CPS.SimpleLambdaLifting.add_cps_intern/>


; encoding sigelt let add_cps_intern


; <Start encoding let add_cps_intern>

;;;;;;;;;;;;;;;;_: Prims.int -> 'a
(declare-fun Tm_arrow_8928427c3e013c0cd8946aaaf1c65a29 (Term) Term)
(declare-fun CPS.SimpleLambdaLifting.add_cps_intern (Term Term Term Term) Term)

;;;;;;;;;;;;;;;;k: (_: Prims.int -> 'a) -> x: Prims.int -> y: Prims.int -> 'a
(declare-fun Tm_arrow_513b25dbd891c49fba5fe6949c4e594a () Term)
(declare-fun CPS.SimpleLambdaLifting.add_cps_intern@tok () Term)


; </end encoding let add_cps_intern>


; encoding sigelt val CPS.SimpleLambdaLifting.add_cps


; <Skipped val CPS.SimpleLambdaLifting.add_cps/>
...
;;; Fact-ids: Name CPS.SimpleLambdaLifting.add_cps_intern; Namespace CPS.SimpleLambdaLifting
(assert (! 
;; def=CPS.SimpleLambdaLifting.fst(20,22-20,35); use=CPS.SimpleLambdaLifting.fst(20,33-21,18)
(forall ((@x0 Term))
...
@x1
(Tm_arrow_8928427c3e013c0cd8946aaaf1c65a29 @x2)))
:qid CPS.SimpleLambdaLifting_pre_typing_Tm_arrow_8928427c3e013c0cd8946aaaf1c65a29))

:named CPS.SimpleLambdaLifting_pre_typing_Tm_arrow_8928427c3e013c0cd8946aaaf1c65a29))
...
:pattern ((ApplyTT @x0
@x2))
:qid CPS.SimpleLambdaLifting_interpretation_Tm_arrow_8928427c3e013c0cd8946aaaf1c65a29.1))
...
:pattern ((HasTypeZ @x0
(Tm_arrow_8928427c3e013c0cd8946aaaf1c65a29 @x1)))
:qid CPS.SimpleLambdaLifting_interpretation_Tm_arrow_8928427c3e013c0cd8946aaaf1c65a29))

:named CPS.SimpleLambdaLifting_interpretation_Tm_arrow_8928427c3e013c0cd8946aaaf1c65a29))
(push) ;; push{2

; Starting query at CPS.SimpleLambdaLifting.fst(24,22-26,46)
...
;;; Fact-ids: 
(assert (! 
;; def=CPS.SimpleLambdaLifting.fst(23,27-24,17); use=CPS.SimpleLambdaLifting.fst(24,8-24,17)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
...
@x1
Tm_arrow_094ce55a57888abb184d0bc2fc7e0d5b))
:qid CPS.SimpleLambdaLifting_pre_typing_Tm_arrow_094ce55a57888abb184d0bc2fc7e0d5b))

:named CPS.SimpleLambdaLifting_pre_typing_Tm_arrow_094ce55a57888abb184d0bc2fc7e0d5b))
...
:pattern ((ApplyTT @x0
@x1))
:qid CPS.SimpleLambdaLifting_interpretation_Tm_arrow_094ce55a57888abb184d0bc2fc7e0d5b.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_094ce55a57888abb184d0bc2fc7e0d5b))
:qid CPS.SimpleLambdaLifting_interpretation_Tm_arrow_094ce55a57888abb184d0bc2fc7e0d5b))

:named CPS.SimpleLambdaLifting_interpretation_Tm_arrow_094ce55a57888abb184d0bc2fc7e0d5b))
...
(declare-fun Tm_refine_3031ad478e119cf262e8cba0e2ba7904 (Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=CPS.SimpleLambdaLifting.fst(24,22-26,46); use=CPS.SimpleLambdaLifting.fst(24,22-26,46)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_refine_3031ad478e119cf262e8cba0e2ba7904 @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_refine_3031ad478e119cf262e8cba0e2ba7904 @x0
@x1)
Tm_type))
:qid refinement_kinding_Tm_refine_3031ad478e119cf262e8cba0e2ba7904))

:named refinement_kinding_Tm_refine_3031ad478e119cf262e8cba0e2ba7904))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=CPS.SimpleLambdaLifting.fst(24,22-26,46); use=CPS.SimpleLambdaLifting.fst(24,22-26,46)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_3031ad478e119cf262e8cba0e2ba7904 @x2
@x3))
(and (HasTypeFuel @u0
@x1
(Tm_arrow_8928427c3e013c0cd8946aaaf1c65a29 @x2))
...
(Tm_refine_3031ad478e119cf262e8cba0e2ba7904 @x2
@x3)))
:qid refinement_interpretation_Tm_refine_3031ad478e119cf262e8cba0e2ba7904))

:named refinement_interpretation_Tm_refine_3031ad478e119cf262e8cba0e2ba7904))
;;;;;;;;;;;;;;;;haseq for Tm_refine_3031ad478e119cf262e8cba0e2ba7904
;;; Fact-ids: 
(assert (! 
;; def=CPS.SimpleLambdaLifting.fst(24,22-26,46); use=CPS.SimpleLambdaLifting.fst(24,22-26,46)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_3031ad478e119cf262e8cba0e2ba7904 @x0
@x1)))
(Valid (Prims.hasEq (Tm_arrow_8928427c3e013c0cd8946aaaf1c65a29 @x0))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_3031ad478e119cf262e8cba0e2ba7904 @x0
@x1))))
:qid haseqTm_refine_3031ad478e119cf262e8cba0e2ba7904))

:named haseqTm_refine_3031ad478e119cf262e8cba0e2ba7904))
(declare-fun CPS.SimpleLambdaLifting.add_cps (Term Term Term) Term)


;;;;;;;;;;;;;;;;_: Prims.list Prims.int -> _: _: (_: Prims.int -> 'a){_ << l} -> 'a
(declare-fun Tm_arrow_972b7f5b26d7e4b3c01d2b8d982fe0ee () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_972b7f5b26d7e4b3c01d2b8d982fe0ee
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_972b7f5b26d7e4b3c01d2b8d982fe0ee
Tm_type)
:named kinding_Tm_arrow_972b7f5b26d7e4b3c01d2b8d982fe0ee))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=CPS.SimpleLambdaLifting.fst(23,14-26,46); use=CPS.SimpleLambdaLifting.fst(23,49-26,46)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_972b7f5b26d7e4b3c01d2b8d982fe0ee)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_972b7f5b26d7e4b3c01d2b8d982fe0ee))
:qid CPS.SimpleLambdaLifting_pre_typing_Tm_arrow_972b7f5b26d7e4b3c01d2b8d982fe0ee))

:named CPS.SimpleLambdaLifting_pre_typing_Tm_arrow_972b7f5b26d7e4b3c01d2b8d982fe0ee))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_972b7f5b26d7e4b3c01d2b8d982fe0ee
;;; Fact-ids: 
(assert (! 
;; def=CPS.SimpleLambdaLifting.fst(23,14-26,46); use=CPS.SimpleLambdaLifting.fst(23,49-26,46)
(forall ((@x0 Term))
...
(Prims.list Prims.int))
(HasType @x3
(Tm_refine_3031ad478e119cf262e8cba0e2ba7904 @x1
@x2)))
...
@x2)
@x3))
:qid CPS.SimpleLambdaLifting_interpretation_Tm_arrow_972b7f5b26d7e4b3c01d2b8d982fe0ee.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid CPS.SimpleLambdaLifting_interpretation_Tm_arrow_972b7f5b26d7e4b3c01d2b8d982fe0ee.2))
...
@x1)
@x2))
:qid CPS.SimpleLambdaLifting_interpretation_Tm_arrow_972b7f5b26d7e4b3c01d2b8d982fe0ee.3))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_972b7f5b26d7e4b3c01d2b8d982fe0ee))
:qid CPS.SimpleLambdaLifting_interpretation_Tm_arrow_972b7f5b26d7e4b3c01d2b8d982fe0ee))

:named CPS.SimpleLambdaLifting_interpretation_Tm_arrow_972b7f5b26d7e4b3c01d2b8d982fe0ee))
(declare-fun CPS.SimpleLambdaLifting.add_cps@tok () Term)
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: 
(assert (! 
;; def=CPS.SimpleLambdaLifting.fst(24,8-24,15); use=CPS.SimpleLambdaLifting.fst(24,8-24,15)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (ApplyTT (ApplyTT (ApplyTT CPS.SimpleLambdaLifting.add_cps@tok
@x0)
@x1)
@x2)
(CPS.SimpleLambdaLifting.add_cps @x0
@x1
@x2))
 

:pattern ((ApplyTT (ApplyTT (ApplyTT CPS.SimpleLambdaLifting.add_cps@tok
@x0)
@x1)
@x2))
:qid token_correspondence_CPS.SimpleLambdaLifting.add_cps))

:named token_correspondence_CPS.SimpleLambdaLifting.add_cps))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: 
(assert (! 
;; def=CPS.SimpleLambdaLifting.fst(24,8-24,15); use=CPS.SimpleLambdaLifting.fst(24,8-24,15)
(forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType CPS.SimpleLambdaLifting.add_cps@tok
Tm_arrow_972b7f5b26d7e4b3c01d2b8d982fe0ee))
...
@x2)
@x3)
(CPS.SimpleLambdaLifting.add_cps @x1
@x2
@x3))
 

:pattern ((CPS.SimpleLambdaLifting.add_cps @x1
@x2
@x3))
:qid function_token_typing_CPS.SimpleLambdaLifting.add_cps.1))
)
 

:pattern ((ApplyTT @x0
CPS.SimpleLambdaLifting.add_cps@tok))
:qid function_token_typing_CPS.SimpleLambdaLifting.add_cps))

:named function_token_typing_CPS.SimpleLambdaLifting.add_cps))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: 
(assert (! 
;; def=CPS.SimpleLambdaLifting.fst(24,8-24,15); use=CPS.SimpleLambdaLifting.fst(24,8-24,15)
...
(Prims.list Prims.int))
(HasType @x2
(Tm_refine_3031ad478e119cf262e8cba0e2ba7904 @x0
@x1)))
(HasType (CPS.SimpleLambdaLifting.add_cps @x0
@x1
@x2)
@x0))
 

:pattern ((CPS.SimpleLambdaLifting.add_cps @x0
@x1
@x2))
:qid typing_CPS.SimpleLambdaLifting.add_cps))

:named typing_CPS.SimpleLambdaLifting.add_cps))
...
;; def=Prims.fst(402,27-402,88); use=CPS.SimpleLambdaLifting.fst(24,22-26,46)
(forall ((@x1 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=CPS.SimpleLambdaLifting.fst(24,22-26,46)
(Valid 
;; def=Prims.fst(402,84-402,87); use=CPS.SimpleLambdaLifting.fst(24,22-26,46)
(ApplyTT @x0
@x1)
...
;; def=Prims.fst(459,77-459,89); use=CPS.SimpleLambdaLifting.fst(24,22-26,46)
(and (implies 
;; def=CPS.SimpleLambdaLifting.fst(24,16-24,17); use=CPS.SimpleLambdaLifting.fst(24,28-24,29)
(and 
;; def=CPS.SimpleLambdaLifting.fst(24,16-24,17); use=CPS.SimpleLambdaLifting.fst(24,28-24,29)
(not 
;; def=CPS.SimpleLambdaLifting.fst(24,16-24,17); use=CPS.SimpleLambdaLifting.fst(24,28-24,29)
...
label_1)
(implies 
;; def=Prims.fst(389,19-389,21); use=CPS.SimpleLambdaLifting.fst(24,22-26,46)
(not 
;; def=CPS.SimpleLambdaLifting.fst(24,16-24,17); use=CPS.SimpleLambdaLifting.fst(24,28-24,29)
(BoxBool_proj_0 (Prims.uu___is_Nil Prims.int
x_66b03f5c7897b05649fed8196554c587_2))
...
;; def=Prims.fst(413,99-413,120); use=CPS.SimpleLambdaLifting.fst(24,22-26,46)
(forall ((@x1 Term))
 (! (implies (HasType @x1
Prims.int)
...
;; def=CPS.SimpleLambdaLifting.fst(24,16-26,10); use=CPS.SimpleLambdaLifting.fst(24,28-26,10)
(= x_66b03f5c7897b05649fed8196554c587_2
...
;; def=CPS.SimpleLambdaLifting.fst(24,22-26,46); use=CPS.SimpleLambdaLifting.fst(26,25-26,46)
(or label_2
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (CPS.SimpleLambdaLifting.add_cps, 1)
; STATUS: unsat
