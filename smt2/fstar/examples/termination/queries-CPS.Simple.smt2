...
; Internals for CPS.Simple


; encoding sigelt val CPS.Simple.add_cps


; <Skipped val CPS.Simple.add_cps/>
...
; Starting query at CPS.Simple.fst(27,22-29,52)
...
(declare-fun x_66b03f5c7897b05649fed8196554c587_2 () Term)
;;;;;;;;;;;;;;;;binder_x_66b03f5c7897b05649fed8196554c587_2
;;; Fact-ids: 
(assert (! (HasType x_66b03f5c7897b05649fed8196554c587_2
(Prims.list Prims.int))
:named binder_x_66b03f5c7897b05649fed8196554c587_2))
...
;;; Fact-ids: 
(assert (! 
;; def=CPS.Simple.fst(26,27-27,17); use=CPS.Simple.fst(27,8-27,17)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
...
@x1
Tm_arrow_094ce55a57888abb184d0bc2fc7e0d5b))
:qid CPS.Simple_pre_typing_Tm_arrow_094ce55a57888abb184d0bc2fc7e0d5b))

:named CPS.Simple_pre_typing_Tm_arrow_094ce55a57888abb184d0bc2fc7e0d5b))
...
:pattern ((ApplyTT @x0
@x1))
:qid CPS.Simple_interpretation_Tm_arrow_094ce55a57888abb184d0bc2fc7e0d5b.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_094ce55a57888abb184d0bc2fc7e0d5b))
:qid CPS.Simple_interpretation_Tm_arrow_094ce55a57888abb184d0bc2fc7e0d5b))

:named CPS.Simple_interpretation_Tm_arrow_094ce55a57888abb184d0bc2fc7e0d5b))
...
;;; Fact-ids: 
(assert (! 
;; def=CPS.Simple.fst(26,27-26,40); use=CPS.Simple.fst(26,38-27,15)
(forall ((@x0 Term))
...
@x1
(Tm_arrow_8928427c3e013c0cd8946aaaf1c65a29 @x2)))
:qid CPS.Simple_pre_typing_Tm_arrow_8928427c3e013c0cd8946aaaf1c65a29))

:named CPS.Simple_pre_typing_Tm_arrow_8928427c3e013c0cd8946aaaf1c65a29))
...
:pattern ((ApplyTT @x0
@x2))
:qid CPS.Simple_interpretation_Tm_arrow_8928427c3e013c0cd8946aaaf1c65a29.1))
...
:pattern ((HasTypeZ @x0
(Tm_arrow_8928427c3e013c0cd8946aaaf1c65a29 @x1)))
:qid CPS.Simple_interpretation_Tm_arrow_8928427c3e013c0cd8946aaaf1c65a29))

:named CPS.Simple_interpretation_Tm_arrow_8928427c3e013c0cd8946aaaf1c65a29))
(declare-fun Tm_refine_94a468694fb2dc436d2305bb8b2cdb41 (Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=CPS.Simple.fst(27,22-29,52); use=CPS.Simple.fst(27,22-29,52)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_refine_94a468694fb2dc436d2305bb8b2cdb41 @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_refine_94a468694fb2dc436d2305bb8b2cdb41 @x0
@x1)
Tm_type))
:qid refinement_kinding_Tm_refine_94a468694fb2dc436d2305bb8b2cdb41))

:named refinement_kinding_Tm_refine_94a468694fb2dc436d2305bb8b2cdb41))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=CPS.Simple.fst(27,22-29,52); use=CPS.Simple.fst(27,22-29,52)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_94a468694fb2dc436d2305bb8b2cdb41 @x2
@x3))
(and (HasTypeFuel @u0
@x1
(Tm_arrow_8928427c3e013c0cd8946aaaf1c65a29 @x2))
...
(Prims.list Prims.int)
@x3
x_66b03f5c7897b05649fed8196554c587_2)
)
...
(Tm_refine_94a468694fb2dc436d2305bb8b2cdb41 @x2
@x3)))
:qid refinement_interpretation_Tm_refine_94a468694fb2dc436d2305bb8b2cdb41))

:named refinement_interpretation_Tm_refine_94a468694fb2dc436d2305bb8b2cdb41))
;;;;;;;;;;;;;;;;haseq for Tm_refine_94a468694fb2dc436d2305bb8b2cdb41
;;; Fact-ids: 
(assert (! 
;; def=CPS.Simple.fst(27,22-29,52); use=CPS.Simple.fst(27,22-29,52)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_94a468694fb2dc436d2305bb8b2cdb41 @x0
@x1)))
(Valid (Prims.hasEq (Tm_arrow_8928427c3e013c0cd8946aaaf1c65a29 @x0))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_94a468694fb2dc436d2305bb8b2cdb41 @x0
@x1))))
:qid haseqTm_refine_94a468694fb2dc436d2305bb8b2cdb41))

:named haseqTm_refine_94a468694fb2dc436d2305bb8b2cdb41))
(declare-fun CPS.Simple.add_cps (Term Term Term) Term)


;;;;;;;;;;;;;;;;_: Prims.list Prims.int -> _: _: (_: Prims.int -> 'a){_ << l} -> 'a
(declare-fun Tm_arrow_3e14998c3a4b157eabf85a193d783092 () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_3e14998c3a4b157eabf85a193d783092
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_3e14998c3a4b157eabf85a193d783092
Tm_type)
:named kinding_Tm_arrow_3e14998c3a4b157eabf85a193d783092))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=CPS.Simple.fst(26,14-29,52); use=CPS.Simple.fst(26,49-29,52)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_3e14998c3a4b157eabf85a193d783092)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_3e14998c3a4b157eabf85a193d783092))
:qid CPS.Simple_pre_typing_Tm_arrow_3e14998c3a4b157eabf85a193d783092))

:named CPS.Simple_pre_typing_Tm_arrow_3e14998c3a4b157eabf85a193d783092))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_3e14998c3a4b157eabf85a193d783092
;;; Fact-ids: 
(assert (! 
;; def=CPS.Simple.fst(26,14-29,52); use=CPS.Simple.fst(26,49-29,52)
(forall ((@x0 Term))
...
(Prims.list Prims.int))
(HasType @x3
(Tm_refine_94a468694fb2dc436d2305bb8b2cdb41 @x1
@x2)))
...
@x2)
@x3))
:qid CPS.Simple_interpretation_Tm_arrow_3e14998c3a4b157eabf85a193d783092.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid CPS.Simple_interpretation_Tm_arrow_3e14998c3a4b157eabf85a193d783092.2))
...
@x1)
@x2))
:qid CPS.Simple_interpretation_Tm_arrow_3e14998c3a4b157eabf85a193d783092.3))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_3e14998c3a4b157eabf85a193d783092))
:qid CPS.Simple_interpretation_Tm_arrow_3e14998c3a4b157eabf85a193d783092))

:named CPS.Simple_interpretation_Tm_arrow_3e14998c3a4b157eabf85a193d783092))
(declare-fun CPS.Simple.add_cps@tok () Term)
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: 
(assert (! 
;; def=CPS.Simple.fst(27,8-27,15); use=CPS.Simple.fst(27,8-27,15)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (ApplyTT (ApplyTT (ApplyTT CPS.Simple.add_cps@tok
@x0)
@x1)
@x2)
(CPS.Simple.add_cps @x0
@x1
@x2))
 

:pattern ((ApplyTT (ApplyTT (ApplyTT CPS.Simple.add_cps@tok
@x0)
@x1)
@x2))
:qid token_correspondence_CPS.Simple.add_cps))

:named token_correspondence_CPS.Simple.add_cps))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: 
(assert (! 
;; def=CPS.Simple.fst(27,8-27,15); use=CPS.Simple.fst(27,8-27,15)
(forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType CPS.Simple.add_cps@tok
Tm_arrow_3e14998c3a4b157eabf85a193d783092))
...
@x2)
@x3)
(CPS.Simple.add_cps @x1
@x2
@x3))
 

:pattern ((CPS.Simple.add_cps @x1
@x2
@x3))
:qid function_token_typing_CPS.Simple.add_cps.1))
)
 

:pattern ((ApplyTT @x0
CPS.Simple.add_cps@tok))
:qid function_token_typing_CPS.Simple.add_cps))

:named function_token_typing_CPS.Simple.add_cps))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: 
(assert (! 
;; def=CPS.Simple.fst(27,8-27,15); use=CPS.Simple.fst(27,8-27,15)
...
(Prims.list Prims.int))
(HasType @x2
(Tm_refine_94a468694fb2dc436d2305bb8b2cdb41 @x0
@x1)))
(HasType (CPS.Simple.add_cps @x0
@x1
@x2)
@x0))
 

:pattern ((CPS.Simple.add_cps @x0
@x1
@x2))
:qid typing_CPS.Simple.add_cps))

:named typing_CPS.Simple.add_cps))
...
;   (~(Nil? l) ==> (forall (b: Prims.int) (b: Prims.list Prims.int). l == b :: b ==> b << l))
...
;; def=Prims.fst(402,27-402,88); use=CPS.Simple.fst(27,22-29,52)
(forall ((@x1 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=CPS.Simple.fst(27,22-29,52)
(Valid 
;; def=Prims.fst(402,84-402,87); use=CPS.Simple.fst(27,22-29,52)
(ApplyTT @x0
@x1)
...
;; def=Prims.fst(459,77-459,89); use=CPS.Simple.fst(27,22-29,52)
(and (implies 
;; def=CPS.Simple.fst(27,16-27,17); use=CPS.Simple.fst(27,28-27,29)
(and 
;; def=CPS.Simple.fst(27,16-27,17); use=CPS.Simple.fst(27,28-27,29)
(not 
;; def=CPS.Simple.fst(27,16-27,17); use=CPS.Simple.fst(27,28-27,29)
...
label_1)
(implies 
;; def=Prims.fst(389,19-389,21); use=CPS.Simple.fst(27,22-29,52)
(not 
;; def=CPS.Simple.fst(27,16-27,17); use=CPS.Simple.fst(27,28-27,29)
(BoxBool_proj_0 (Prims.uu___is_Nil Prims.int
x_66b03f5c7897b05649fed8196554c587_2))
...
;; def=Prims.fst(413,99-413,120); use=CPS.Simple.fst(27,22-29,52)
(forall ((@x1 Term))
 (! (implies (HasType @x1
Prims.int)
...
;; def=CPS.Simple.fst(27,16-29,10); use=CPS.Simple.fst(27,28-29,10)
(= x_66b03f5c7897b05649fed8196554c587_2
...
;; def=CPS.Simple.fst(27,22-29,52); use=CPS.Simple.fst(29,41-29,51)
(or label_2
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (CPS.Simple.add_cps, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, Prims_pretyping_ae567c2fb75be05905677af440075565, binder_x_66b03f5c7897b05649fed8196554c587_2, disc_equation_Prims.Cons, disc_equation_Prims.Nil, fuel_guarded_inversion_Prims.list, function_token_typing_Prims.__cache_version_number__, projection_inverse_BoxBool_proj_0, projection_inverse_Prims.Cons_tl, subterm_ordering_Prims.Cons
