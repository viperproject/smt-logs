...
; encoding sigelt type CPS.Expr.expr
...
; Starting query at CPS.Expr.fst(18,0-20,31)

(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)

; Encoding query formula : Prims.hasEq CPS.Expr.expr ==>
; (forall (_0: CPS.Expr.expr) (_1: CPS.Expr.expr).
;     Prims.hasEq CPS.Expr.expr /\ Prims.hasEq CPS.Expr.expr)


; Context: While encoding a query
; While typechecking the top-level declaration `type CPS.Expr.expr`
...
;;; Fact-ids: 
(assert (! (not (implies 
;; def=CPS.Expr.fst(18,0-20,31); use=CPS.Expr.fst(18,0-20,31)
(Valid 
;; def=CPS.Expr.fst(18,0-20,31); use=CPS.Expr.fst(18,0-20,31)
(Prims.hasEq CPS.Expr.expr)
)
...
;; def=CPS.Expr.fst(18,0-20,31); use=CPS.Expr.fst(18,0-20,31)
(and 
;; def=CPS.Expr.fst(18,0-20,31); use=CPS.Expr.fst(20,11-20,15)
(or label_1
...
;; def=CPS.Expr.fst(18,0-20,31); use=CPS.Expr.fst(20,19-20,23)
(or label_2
...
; encoding sigelt assume CPS.Expr.expr__uu___haseq
...
; encoding sigelt val CPS.Expr.uu___is_Const
...
; encoding sigelt val CPS.Expr.__proj__Const__item___0
...
; Encoding query formula : forall (projectee: _: CPS.Expr.expr{Const? _}).
...
(not 
;; def=CPS.Expr.fst(19,4-19,9); use=CPS.Expr.fst(19,4-19,9)
(BoxBool_proj_0 (CPS.Expr.uu___is_Const @x0))
)
)
label_1)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (CPS.Expr.__proj__Const__item___0, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_61068dfb8b28ba423ea3dca285d5c282
...
; encoding sigelt val CPS.Expr.uu___is_Plus
...
; encoding sigelt val CPS.Expr.__proj__Plus__item___0
...
; Encoding query formula : forall (projectee: _: CPS.Expr.expr{Plus? _}).
;   (*  - Could not prove post-condition
; *) ~(Plus? projectee) ==> Prims.l_False


; Context: While encoding a query
; While typechecking the top-level declaration `let __proj__Plus__item___0`
...
(not 
;; def=CPS.Expr.fst(20,4-20,8); use=CPS.Expr.fst(20,4-20,8)
(BoxBool_proj_0 (CPS.Expr.uu___is_Plus @x0))
)
)
label_1)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (CPS.Expr.__proj__Plus__item___0, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_1ca93587daff7a0ff146b7192bd79c66
...
; encoding sigelt let __proj__Plus__item___0


; <Skipped let __proj__Plus__item___0/>


; encoding sigelt val CPS.Expr.__proj__Plus__item___1
...
; Context: While encoding a query
; While typechecking the top-level declaration `let __proj__Plus__item___1`
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (CPS.Expr.__proj__Plus__item___1, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_1ca93587daff7a0ff146b7192bd79c66
