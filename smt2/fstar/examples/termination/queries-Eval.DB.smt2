...
; Internals for Eval.DB


; encoding sigelt type Eval.DB.var


; <Start encoding type Eval.DB.var>

;;;;;;;;;;;;;;;;Constructor
(declare-fun Eval.DB.var (Term Term) Term)
;;;;;;;;;;;;;;;;token
(declare-fun Eval.DB.var@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun Eval.DB.O (Term Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Eval.DB.O_g (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Eval.DB.O_a (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: Eval.DB.O
(declare-fun Eval.DB.O@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun Eval.DB.S (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Eval.DB.S_g (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Eval.DB.S_a (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Eval.DB.S_b (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Eval.DB.S__3 (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: Eval.DB.S
(declare-fun Eval.DB.S@tok () Term)
;;;;;;;;;;;;;;;;g: Type -> a: Type -> var (g & a) a
(declare-fun Tm_arrow_9aae8d085b83d8af85a0defaec2ead03 () Term)
;;;;;;;;;;;;;;;;g: Type -> a: Type -> b: Type -> _3: var g a -> var (g & b) a
(declare-fun Tm_arrow_15baeabf94f1abab766b3090090b450c () Term)

; <start constructor Eval.DB.var>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Eval.DB.var ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
104)
(exists ((@x0 Term) (@x1 Term))
 (! (= __@x0
...
; </end constructor Eval.DB.var>


; <start constructor Eval.DB.O>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Eval.DB.O ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
111)
(= __@x0
(Eval.DB.O (Eval.DB.O_g __@x0)
(Eval.DB.O_a __@x0)))))

; </end constructor Eval.DB.O>


; <start constructor Eval.DB.S>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Eval.DB.S ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
118)
(= __@x0
(Eval.DB.S (Eval.DB.S_g __@x0)
(Eval.DB.S_a __@x0)
(Eval.DB.S_b __@x0)
(Eval.DB.S__3 __@x0)))))

; </end constructor Eval.DB.S>


; </end encoding type Eval.DB.var>


; encoding sigelt val Eval.DB.uu___is_O


; <Start encoding val Eval.DB.uu___is_O>

(declare-fun Eval.DB.uu___is_O (Term Term Term) Term)
;;;;;;;;;;;;;;;;projectee: var _ _ -> Prims.bool
(declare-fun Tm_arrow_16c1bd42b379e70bdc18b8897909e18d () Term)
(declare-fun Eval.DB.uu___is_O@tok () Term)

; </end encoding val Eval.DB.uu___is_O>
...
; encoding sigelt val Eval.DB.__proj__O__item__g


; <Start encoding val Eval.DB.__proj__O__item__g>

(declare-fun Tm_refine_484127013bba2593946d02c4a721e275 (Term Term) Term)
(declare-fun Eval.DB.__proj__O__item__g (Term Term Term) Term)

;;;;;;;;;;;;;;;;projectee: _: var _ _ {O? _} -> Type
(declare-fun Tm_arrow_e85fa0a05e0a6d31d6d1285c59cf0cae () Term)
(declare-fun Eval.DB.__proj__O__item__g@tok () Term)

; </end encoding val Eval.DB.__proj__O__item__g>
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Eval.DB.uu___is_O; Namespace Eval.DB
(assert (! 
;; def=Eval.DB.fst(19,5-19,6); use=Eval.DB.fst(19,5-19,6)
...
(Eval.DB.var @x0
@x1)))
(HasType (Eval.DB.uu___is_O @x0
@x1
@x2)
Prims.bool))
 

:pattern ((Eval.DB.uu___is_O @x0
@x1
@x2))
:qid typing_Eval.DB.uu___is_O))

:named typing_Eval.DB.uu___is_O))
...
;;;;;;;;;;;;;;;;name-token correspondence
;;; Fact-ids: Name Eval.DB.var; Namespace Eval.DB; Name Eval.DB.O; Namespace Eval.DB; Name Eval.DB.S; Namespace Eval.DB
(assert (! 
;; def=Eval.DB.fst(18,10-18,13); use=Eval.DB.fst(18,10-18,13)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (ApplyTT Eval.DB.var@tok
@x0)
@x1)
(Eval.DB.var @x0
@x1))
...
:pattern ((ApplyTT (ApplyTT Eval.DB.var@tok
@x0)
@x1))

:pattern ((Eval.DB.var @x0
@x1))
:qid token_correspondence_Eval.DB.var@tok))

:named token_correspondence_Eval.DB.var@tok))
;;;;;;;;;;;;;;;;subterm ordering
;;; Fact-ids: Name FStar.Pervasives.Native.tuple2; Namespace FStar.Pervasives.Native; Name FStar.Pervasives.Native.Mktuple2; Namespace FStar.Pervasives.Native
(assert (! 
...
;;; Fact-ids: Name Eval.DB.var; Namespace Eval.DB; Name Eval.DB.O; Namespace Eval.DB; Name Eval.DB.S; Namespace Eval.DB
(assert (! 
;; def=Eval.DB.fst(20,5-20,6); use=Eval.DB.fst(20,5-20,6)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term) (@x6 Term))
 (! (implies (HasTypeFuel (SFuel @u0)
(Eval.DB.S @x1
@x2
...
(Eval.DB.var @x5
@x6)))
:qid subterm_ordering_Eval.DB.S))

:named subterm_ordering_Eval.DB.S))
;;;;;;;;;;;;;;;;subterm ordering
;;; Fact-ids: Name Eval.DB.var; Namespace Eval.DB; Name Eval.DB.O; Namespace Eval.DB; Name Eval.DB.S; Namespace Eval.DB
(assert (! 
;; def=Eval.DB.fst(19,5-19,6); use=Eval.DB.fst(19,5-19,6)
...
(Eval.DB.var @x3
@x4)))
:qid subterm_ordering_Eval.DB.O))

:named subterm_ordering_Eval.DB.O))
;;;;;;;;;;;;;;;;refinement kinding
...
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name Eval.DB.__proj__O__item__g; Namespace Eval.DB
(assert (! 
;; def=Eval.DB.fst(19,5-19,6); use=Eval.DB.fst(19,5-19,6)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_refine_484127013bba2593946d02c4a721e275 @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_refine_484127013bba2593946d02c4a721e275 @x0
@x1)
Tm_type))
:qid refinement_kinding_Tm_refine_484127013bba2593946d02c4a721e275))

:named refinement_kinding_Tm_refine_484127013bba2593946d02c4a721e275))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name Prims.eqtype; Namespace Prims
...
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_484127013bba2593946d02c4a721e275 @x2
@x3))
(and (HasTypeFuel @u0
@x1
(Eval.DB.var @x2
...
;; def=Eval.DB.fst(19,5-19,6); use=Eval.DB.fst(19,5-19,6)
(BoxBool_proj_0 (Eval.DB.uu___is_O @x2
@x3
@x1))
))
...
(Tm_refine_484127013bba2593946d02c4a721e275 @x2
@x3)))
:qid refinement_interpretation_Tm_refine_484127013bba2593946d02c4a721e275))

:named refinement_interpretation_Tm_refine_484127013bba2593946d02c4a721e275))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name Prims.eqtype; Namespace Prims
(assert (! 
...
:pattern ((Eval.DB.S @x0
@x1
@x2
@x3))
:qid projection_inverse_Eval.DB.S_g))

:named projection_inverse_Eval.DB.S_g))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Eval.DB.var; Namespace Eval.DB; Name Eval.DB.O; Namespace Eval.DB; Name Eval.DB.S; Namespace Eval.DB
(assert (! 
;; def=Eval.DB.fst(20,5-20,6); use=Eval.DB.fst(20,5-20,6)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (Eval.DB.S_b (Eval.DB.S @x0
@x1
@x2
@x3))
@x2)
...
@x2
@x3))
:qid projection_inverse_Eval.DB.S_b))

:named projection_inverse_Eval.DB.S_b))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Eval.DB.var; Namespace Eval.DB; Name Eval.DB.O; Namespace Eval.DB; Name Eval.DB.S; Namespace Eval.DB
(assert (! 
;; def=Eval.DB.fst(20,5-20,6); use=Eval.DB.fst(20,5-20,6)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (Eval.DB.S_a (Eval.DB.S @x0
@x1
@x2
@x3))
@x1)
...
@x2
@x3))
:qid projection_inverse_Eval.DB.S_a))

:named projection_inverse_Eval.DB.S_a))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Eval.DB.var; Namespace Eval.DB; Name Eval.DB.O; Namespace Eval.DB; Name Eval.DB.S; Namespace Eval.DB
(assert (! 
;; def=Eval.DB.fst(20,5-20,6); use=Eval.DB.fst(20,5-20,6)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (Eval.DB.S__3 (Eval.DB.S @x0
@x1
@x2
@x3))
@x3)
...
@x2
@x3))
:qid projection_inverse_Eval.DB.S__3))

:named projection_inverse_Eval.DB.S__3))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Eval.DB.var; Namespace Eval.DB; Name Eval.DB.O; Namespace Eval.DB; Name Eval.DB.S; Namespace Eval.DB
(assert (! 
;; def=Eval.DB.fst(19,5-19,6); use=Eval.DB.fst(19,5-19,6)
(forall ((@x0 Term) (@x1 Term))
 (! (= (Eval.DB.O_g (Eval.DB.O @x0
@x1))
@x0)
 

:pattern ((Eval.DB.O @x0
@x1))
:qid projection_inverse_Eval.DB.O_g))

:named projection_inverse_Eval.DB.O_g))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Eval.DB.var; Namespace Eval.DB; Name Eval.DB.O; Namespace Eval.DB; Name Eval.DB.S; Namespace Eval.DB
(assert (! 
;; def=Eval.DB.fst(19,5-19,6); use=Eval.DB.fst(19,5-19,6)
(forall ((@x0 Term) (@x1 Term))
 (! (= (Eval.DB.O_a (Eval.DB.O @x0
@x1))
@x1)
...
:pattern ((Eval.DB.O @x0
@x1))
:qid projection_inverse_Eval.DB.O_a))

:named projection_inverse_Eval.DB.O_a))
;;;;;;;;;;;;;;;;kinding
;;; Fact-ids: Name FStar.Pervasives.Native.tuple2; Namespace FStar.Pervasives.Native; Name FStar.Pervasives.Native.Mktuple2; Namespace FStar.Pervasives.Native
...
;;;;;;;;;;;;;;;;kinding
;;; Fact-ids: Name Eval.DB.var; Namespace Eval.DB; Name Eval.DB.O; Namespace Eval.DB; Name Eval.DB.S; Namespace Eval.DB
(assert (! (is-Tm_arrow (PreType Eval.DB.var@tok))
:named pre_kinding_Eval.DB.var@tok))
;;; Fact-ids: Name FStar.Pervasives.Native.tuple2; Namespace FStar.Pervasives.Native; Name FStar.Pervasives.Native.Mktuple2; Namespace FStar.Pervasives.Native
...
;;; Fact-ids: Name Eval.DB.var; Namespace Eval.DB; Name Eval.DB.O; Namespace Eval.DB; Name Eval.DB.S; Namespace Eval.DB
(assert (! (and (IsTotFun Eval.DB.var@tok)

;; def=Eval.DB.fst(18,10-18,13); use=Eval.DB.fst(18,10-18,13)
(forall ((@x0 Term))
 (! (IsTotFun (ApplyTT Eval.DB.var@tok
@x0))
 

:pattern ((ApplyTT Eval.DB.var@tok
@x0))
:qid kinding_Eval.DB.var@tok))
...
:pattern ((Eval.DB.var @x0
@x1))
:qid kinding_Eval.DB.var@tok.1))
)
:named kinding_Eval.DB.var@tok))
...
;;;;;;;;;;;;;;;;haseq for Tm_refine_484127013bba2593946d02c4a721e275
;;; Fact-ids: Name Eval.DB.__proj__O__item__g; Namespace Eval.DB
(assert (! 
;; def=Eval.DB.fst(19,5-19,6); use=Eval.DB.fst(19,5-19,6)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_484127013bba2593946d02c4a721e275 @x0
@x1)))
(Valid (Prims.hasEq (Eval.DB.var @x0
@x1))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_484127013bba2593946d02c4a721e275 @x0
@x1))))
:qid haseqTm_refine_484127013bba2593946d02c4a721e275))

:named haseqTm_refine_484127013bba2593946d02c4a721e275))
...
(Eval.DB.var @x2
@x3))
(or (and (is-Eval.DB.O @x1)
(= @x2
(FStar.Pervasives.Native.tuple2 (Eval.DB.O_g @x1)
(Eval.DB.O_a @x1)))
(= @x3
(Eval.DB.O_a @x1)))
(and (is-Eval.DB.S @x1)
(= @x2
(FStar.Pervasives.Native.tuple2 (Eval.DB.S_g @x1)
(Eval.DB.S_b @x1)))
(= @x3
(Eval.DB.S_a @x1)))))
...
(Eval.DB.var @x2
@x3)))
:qid fuel_guarded_inversion_Eval.DB.var))

:named fuel_guarded_inversion_Eval.DB.var))
;;;;;;;;;;;;;;;;fresh token
;;; Fact-ids: Name FStar.Pervasives.Native.tuple2; Namespace FStar.Pervasives.Native; Name FStar.Pervasives.Native.Mktuple2; Namespace FStar.Pervasives.Native
(assert (! (= 126
...
;;; Fact-ids: Name Eval.DB.var; Namespace Eval.DB; Name Eval.DB.O; Namespace Eval.DB; Name Eval.DB.S; Namespace Eval.DB
(assert (! (= 105
(Term_constr_id Eval.DB.var@tok))
:named fresh_token_Eval.DB.var@tok))
...
;; def=Eval.DB.fst(19,5-19,6); use=Eval.DB.fst(19,5-19,6)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (Eval.DB.uu___is_O @x0
@x1
@x2)
(BoxBool (is-Eval.DB.O @x2)))
 

:pattern ((Eval.DB.uu___is_O @x0
@x1
@x2))
:qid disc_equation_Eval.DB.O))

:named disc_equation_Eval.DB.O))
...
(Eval.DB.var @x5
@x6)))
:qid data_typing_intro_Eval.DB.S@tok))

:named data_typing_intro_Eval.DB.S@tok))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name Eval.DB.var; Namespace Eval.DB; Name Eval.DB.O; Namespace Eval.DB; Name Eval.DB.S; Namespace Eval.DB
(assert (! 
;; def=Eval.DB.fst(19,5-19,6); use=Eval.DB.fst(19,5-19,6)
...
(Eval.DB.var @x3
@x4)))
:qid data_typing_intro_Eval.DB.O@tok))

:named data_typing_intro_Eval.DB.O@tok))
...
(Eval.DB.var @x5
@x6)))
:qid data_elim_Eval.DB.S))

:named data_elim_Eval.DB.S))
;;;;;;;;;;;;;;;;data constructor typing elim
;;; Fact-ids: Name Eval.DB.var; Namespace Eval.DB; Name Eval.DB.O; Namespace Eval.DB; Name Eval.DB.S; Namespace Eval.DB
(assert (! 
;; def=Eval.DB.fst(19,5-19,6); use=Eval.DB.fst(19,5-19,6)
...
(Eval.DB.var @x3
@x4)))
:qid data_elim_Eval.DB.O))

:named data_elim_Eval.DB.O))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Prims.unit; Namespace Prims
(assert (! (= 125
...
(forall ((@x0 Term) (@x1 Term))
 (! (= 104
(Term_constr_id (Eval.DB.var @x0
@x1)))
 

:pattern ((Eval.DB.var @x0
@x1))
:qid constructor_distinct_Eval.DB.var))

:named constructor_distinct_Eval.DB.var))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Eval.DB.var; Namespace Eval.DB; Name Eval.DB.O; Namespace Eval.DB; Name Eval.DB.S; Namespace Eval.DB
(assert (! 
;; def=Eval.DB.fst(20,5-20,6); use=Eval.DB.fst(20,5-20,6)
...
@x2
@x3))
:qid constructor_distinct_Eval.DB.S))

:named constructor_distinct_Eval.DB.S))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Eval.DB.var; Namespace Eval.DB; Name Eval.DB.O; Namespace Eval.DB; Name Eval.DB.S; Namespace Eval.DB
(assert (! 
;; def=Eval.DB.fst(19,5-19,6); use=Eval.DB.fst(19,5-19,6)
(forall ((@x0 Term) (@x1 Term))
 (! (= 111
(Term_constr_id (Eval.DB.O @x0
@x1)))
 

:pattern ((Eval.DB.O @x0
@x1))
:qid constructor_distinct_Eval.DB.O))

:named constructor_distinct_Eval.DB.O))
;;;;;;;;;;;;;;;;bool typing
;;; Fact-ids: Name Prims.bool; Namespace Prims
(assert (! (forall ((@u0 Bool))
 (! (HasType (BoxBool @u0)
...
(Eval.DB.var @x2
@x3)))
:qid Eval.DB_pretyping_3bc617e756d7ae617e4bc8a40ec17316))

:named Eval.DB_pretyping_3bc617e756d7ae617e4bc8a40ec17316))
(push) ;; push{2

; Starting query at Eval.DB.fst(19,9-19,10)

(declare-fun label_1 () Bool)


; Encoding query formula : forall (_: Type) (_: Type) (projectee: _: Eval.DB.var _ _ {O? _}).
;   (*  - Could not prove post-condition
; *) ~(O? projectee) ==> Prims.l_False


; Context: While encoding a query
; While typechecking the top-level declaration `let __proj__O__item__g`
...
Tm_type)
(HasType @x2
(Tm_refine_484127013bba2593946d02c4a721e275 @x0
@x1))

;; def=Eval.DB.fst(19,5-19,6); use=Eval.DB.fst(19,9-19,10)
(not 
;; def=Eval.DB.fst(19,5-19,6); use=Eval.DB.fst(19,9-19,10)
(BoxBool_proj_0 (Eval.DB.uu___is_O @x0
@x1
@x2))
)
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Eval.DB.__proj__O__item__g, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_484127013bba2593946d02c4a721e275
...
; encoding sigelt let __proj__O__item__g


; <Skipped let __proj__O__item__g/>


; encoding sigelt val Eval.DB.__proj__O__item__a


; <Start encoding val Eval.DB.__proj__O__item__a>


(declare-fun Eval.DB.__proj__O__item__a (Term Term Term) Term)


(declare-fun Eval.DB.__proj__O__item__a@tok () Term)

; </end encoding val Eval.DB.__proj__O__item__a>

(push) ;; push{2

; Starting query at Eval.DB.fst(19,19-19,20)
...
; Context: While encoding a query
; While typechecking the top-level declaration `let __proj__O__item__a`
...
;; def=Eval.DB.fst(19,5-19,6); use=Eval.DB.fst(19,19-19,20)
(not 
;; def=Eval.DB.fst(19,5-19,6); use=Eval.DB.fst(19,19-19,20)
(BoxBool_proj_0 (Eval.DB.uu___is_O @x0
@x1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Eval.DB.__proj__O__item__a, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_484127013bba2593946d02c4a721e275
...
; encoding sigelt let __proj__O__item__a


; <Skipped let __proj__O__item__a/>


; encoding sigelt val Eval.DB.uu___is_S


; <Start encoding val Eval.DB.uu___is_S>

(declare-fun Eval.DB.uu___is_S (Term Term Term) Term)

(declare-fun Eval.DB.uu___is_S@tok () Term)

; </end encoding val Eval.DB.uu___is_S>
...
; encoding sigelt val Eval.DB.__proj__S__item__g


; <Start encoding val Eval.DB.__proj__S__item__g>

(declare-fun Tm_refine_7953764d4affd5fc53963a3447f7bdde (Term Term) Term)
(declare-fun Eval.DB.__proj__S__item__g (Term Term Term) Term)

;;;;;;;;;;;;;;;;projectee: _: var _ _ {S? _} -> Type
(declare-fun Tm_arrow_83a17b85dbc1b260738aed3d4d385847 () Term)
(declare-fun Eval.DB.__proj__S__item__g@tok () Term)

; </end encoding val Eval.DB.__proj__S__item__g>

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Eval.DB.uu___is_S; Namespace Eval.DB
(assert (! 
;; def=Eval.DB.fst(20,5-20,6); use=Eval.DB.fst(20,5-20,6)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x0
...
(Eval.DB.var @x0
@x1)))
(HasType (Eval.DB.uu___is_S @x0
@x1
@x2)
Prims.bool))
 

:pattern ((Eval.DB.uu___is_S @x0
@x1
@x2))
:qid typing_Eval.DB.uu___is_S))

:named typing_Eval.DB.uu___is_S))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name Eval.DB.__proj__S__item__g; Namespace Eval.DB
(assert (! 
;; def=Eval.DB.fst(20,5-20,6); use=Eval.DB.fst(20,5-20,6)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_refine_7953764d4affd5fc53963a3447f7bdde @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_refine_7953764d4affd5fc53963a3447f7bdde @x0
@x1)
Tm_type))
:qid refinement_kinding_Tm_refine_7953764d4affd5fc53963a3447f7bdde))

:named refinement_kinding_Tm_refine_7953764d4affd5fc53963a3447f7bdde))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name Eval.DB.__proj__S__item__g; Namespace Eval.DB
(assert (! 
;; def=Eval.DB.fst(20,5-20,6); use=Eval.DB.fst(20,5-20,6)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_7953764d4affd5fc53963a3447f7bdde @x2
@x3))
(and (HasTypeFuel @u0
@x1
(Eval.DB.var @x2
...
;; def=Eval.DB.fst(20,5-20,6); use=Eval.DB.fst(20,5-20,6)
(BoxBool_proj_0 (Eval.DB.uu___is_S @x2
@x3
@x1))
))
...
(Tm_refine_7953764d4affd5fc53963a3447f7bdde @x2
@x3)))
:qid refinement_interpretation_Tm_refine_7953764d4affd5fc53963a3447f7bdde))

:named refinement_interpretation_Tm_refine_7953764d4affd5fc53963a3447f7bdde))
;;;;;;;;;;;;;;;;haseq for Tm_refine_7953764d4affd5fc53963a3447f7bdde
;;; Fact-ids: Name Eval.DB.__proj__S__item__g; Namespace Eval.DB
(assert (! 
;; def=Eval.DB.fst(20,5-20,6); use=Eval.DB.fst(20,5-20,6)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_7953764d4affd5fc53963a3447f7bdde @x0
@x1)))
(Valid (Prims.hasEq (Eval.DB.var @x0
@x1))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_7953764d4affd5fc53963a3447f7bdde @x0
@x1))))
:qid haseqTm_refine_7953764d4affd5fc53963a3447f7bdde))

:named haseqTm_refine_7953764d4affd5fc53963a3447f7bdde))
;;;;;;;;;;;;;;;;Discriminator equation
;;; Fact-ids: Name Eval.DB.uu___is_S; Namespace Eval.DB
(assert (! 
;; def=Eval.DB.fst(20,5-20,6); use=Eval.DB.fst(20,5-20,6)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (Eval.DB.uu___is_S @x0
@x1
@x2)
(BoxBool (is-Eval.DB.S @x2)))
 

:pattern ((Eval.DB.uu___is_S @x0
@x1
@x2))
:qid disc_equation_Eval.DB.S))

:named disc_equation_Eval.DB.S))
(push) ;; push{2

; Starting query at Eval.DB.fst(20,9-20,10)

(declare-fun label_1 () Bool)


; Encoding query formula : forall (_: Type) (_: Type) (projectee: _: Eval.DB.var _ _ {S? _}).
;   (*  - Could not prove post-condition
; *) ~(S? projectee) ==> Prims.l_False


; Context: While encoding a query
; While typechecking the top-level declaration `let __proj__S__item__g`
...
Tm_type)
(HasType @x2
(Tm_refine_7953764d4affd5fc53963a3447f7bdde @x0
@x1))

;; def=Eval.DB.fst(20,5-20,6); use=Eval.DB.fst(20,9-20,10)
(not 
;; def=Eval.DB.fst(20,5-20,6); use=Eval.DB.fst(20,9-20,10)
(BoxBool_proj_0 (Eval.DB.uu___is_S @x0
@x1
@x2))
)
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Eval.DB.__proj__S__item__g, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_7953764d4affd5fc53963a3447f7bdde
...
; encoding sigelt let __proj__S__item__g


; <Skipped let __proj__S__item__g/>


; encoding sigelt val Eval.DB.__proj__S__item__a


; <Start encoding val Eval.DB.__proj__S__item__a>


(declare-fun Eval.DB.__proj__S__item__a (Term Term Term) Term)


(declare-fun Eval.DB.__proj__S__item__a@tok () Term)

; </end encoding val Eval.DB.__proj__S__item__a>

(push) ;; push{2

; Starting query at Eval.DB.fst(20,19-20,20)
...
; Context: While encoding a query
; While typechecking the top-level declaration `let __proj__S__item__a`
...
;; def=Eval.DB.fst(20,5-20,6); use=Eval.DB.fst(20,19-20,20)
(not 
;; def=Eval.DB.fst(20,5-20,6); use=Eval.DB.fst(20,19-20,20)
(BoxBool_proj_0 (Eval.DB.uu___is_S @x0
@x1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Eval.DB.__proj__S__item__a, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_7953764d4affd5fc53963a3447f7bdde
...
; encoding sigelt let __proj__S__item__a


; <Skipped let __proj__S__item__a/>


; encoding sigelt val Eval.DB.__proj__S__item__b


; <Start encoding val Eval.DB.__proj__S__item__b>


(declare-fun Eval.DB.__proj__S__item__b (Term Term Term) Term)


(declare-fun Eval.DB.__proj__S__item__b@tok () Term)

; </end encoding val Eval.DB.__proj__S__item__b>

(push) ;; push{2

; Starting query at Eval.DB.fst(20,29-20,30)
...
; Context: While encoding a query
; While typechecking the top-level declaration `let __proj__S__item__b`
...
;; def=Eval.DB.fst(20,5-20,6); use=Eval.DB.fst(20,29-20,30)
(not 
;; def=Eval.DB.fst(20,5-20,6); use=Eval.DB.fst(20,29-20,30)
(BoxBool_proj_0 (Eval.DB.uu___is_S @x0
@x1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Eval.DB.__proj__S__item__b, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_7953764d4affd5fc53963a3447f7bdde
...
; encoding sigelt let __proj__S__item__b


; <Skipped let __proj__S__item__b/>


; encoding sigelt val Eval.DB.__proj__S__item___3


; <Start encoding val Eval.DB.__proj__S__item___3>


(declare-fun Eval.DB.__proj__S__item___3 (Term Term Term) Term)

;;;;;;;;;;;;;;;;projectee: _: var _ _ {S? _} -> var projectee.g projectee.a
(declare-fun Tm_arrow_ba4b34b2b270e77f6ad58bc315ea6855 () Term)
(declare-fun Eval.DB.__proj__S__item___3@tok () Term)

; </end encoding val Eval.DB.__proj__S__item___3>

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Eval.DB.__proj__S__item__g; Namespace Eval.DB
(assert (! 
;; def=Eval.DB.fst(20,9-20,10); use=Eval.DB.fst(20,9-20,10)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
...
(Tm_refine_7953764d4affd5fc53963a3447f7bdde @x0
@x1)))
(HasType (Eval.DB.__proj__S__item__g @x0
@x1
@x2)
Tm_type))
 

:pattern ((Eval.DB.__proj__S__item__g @x0
@x1
@x2))
:qid typing_Eval.DB.__proj__S__item__g))

:named typing_Eval.DB.__proj__S__item__g))
;;;;;;;;;;;;;;;;Projector equation
;;; Fact-ids: Name Eval.DB.__proj__S__item__g; Namespace Eval.DB
(assert (! 
;; def=Eval.DB.fst(20,9-20,10); use=Eval.DB.fst(20,9-20,10)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (Eval.DB.__proj__S__item__g @x0
@x1
@x2)
(Eval.DB.S_g @x2))
...
@x1
@x2))
:qid proj_equation_Eval.DB.S_g))

:named proj_equation_Eval.DB.S_g))
(push) ;; push{2
...
; *)
;   (~(S? projectee) ==> Prims.l_False) /\
;   (forall (b: Type) (b: Type) (b: Type) (b: Eval.DB.var b b).
;       projectee == Eval.DB.S b b b b ==>
;       b == _ /\ b & b == _ /\ S? (Eval.DB.S b b b b) /\
;       (forall (return_val: _: Eval.DB.var _ _ {S? _}).
;           return_val == Eval.DB.S b b b b ==>
;           (forall (any_result: Type).
;               (Eval.DB.S b b b b).g == any_result ==> b == _ /\ b & b == _ /\ S? (Eval.DB.S b b b b)
;           )))


; Context: While encoding a query
; While typechecking the top-level declaration `let __proj__S__item___3`
...
;; def=Prims.fst(459,77-459,89); use=Prims.fst(459,77-459,89)
(and 
;; def=dummy(0,0-0,0); use=Eval.DB.fst(20,5-20,6)
(or label_2
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Eval.DB.__proj__S__item___3, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, data_elim_Eval.DB.S, refinement_interpretation_Tm_refine_7953764d4affd5fc53963a3447f7bdde
...
; encoding sigelt let __proj__S__item___3


; <Skipped let __proj__S__item___3/>


; encoding sigelt type Eval.DB.tm


; <Start encoding type Eval.DB.tm>

;;;;;;;;;;;;;;;;Constructor
(declare-fun Eval.DB.tm (Term Term) Term)
;;;;;;;;;;;;;;;;token
(declare-fun Eval.DB.tm@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun Eval.DB.Var (Term Term Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Eval.DB.Var_g (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Eval.DB.Var_a (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Eval.DB.Var__2 (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: Eval.DB.Var
(declare-fun Eval.DB.Var@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun Eval.DB.Lam (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Eval.DB.Lam_g (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Eval.DB.Lam_a (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Eval.DB.Lam_b (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Eval.DB.Lam_body (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: Eval.DB.Lam
(declare-fun Eval.DB.Lam@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun Eval.DB.App (Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Eval.DB.App_g (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Eval.DB.App_a (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Eval.DB.App_b (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Eval.DB.App_e1 (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Eval.DB.App_e2 (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: Eval.DB.App
(declare-fun Eval.DB.App@tok () Term)
;;;;;;;;;;;;;;;;_: a -> b
(declare-fun Tm_arrow_5eb73fcd7e0c3d391166a6e670b615d2 (Term) Term)
;;;;;;;;;;;;;;;;g: Type -> a: Type -> _2: var g a -> tm g a
(declare-fun Tm_arrow_db81732815a97740c17dc6cdfa1490f5 () Term)
;;;;;;;;;;;;;;;;_: a -> b
(declare-fun Tm_arrow_6980332764c4493a7b0df5c02f7aefbe (Term Term) Term)

;;;;;;;;;;;;;;;;g: Type -> a: Type -> b: Type -> body: tm (g & a) b -> tm g (_: a -> b)
(declare-fun Tm_arrow_f3a5f03e408bc8b093aba5c052c5b42b () Term)



;;;;;;;;;;;;;;;;g: Type -> a: Type -> b: Type -> e1: tm g (_: a -> b) -> e2: tm g a -> tm g b
(declare-fun Tm_arrow_f4fe3a7625cad30ba733711c84edcd40 () Term)

; <start constructor Eval.DB.tm>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Eval.DB.tm ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
159)
(exists ((@x0 Term) (@x1 Term))
 (! (= __@x0
...
168)
(= __@x0
(Eval.DB.Var (Eval.DB.Var_g __@x0)
(Eval.DB.Var_a __@x0)
(Eval.DB.Var__2 __@x0)))))

; </end constructor Eval.DB.Var>


; <start constructor Eval.DB.Lam>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Eval.DB.Lam ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
175)
(= __@x0
(Eval.DB.Lam (Eval.DB.Lam_g __@x0)
(Eval.DB.Lam_a __@x0)
(Eval.DB.Lam_b __@x0)
(Eval.DB.Lam_body __@x0)))))

; </end constructor Eval.DB.Lam>


; <start constructor Eval.DB.App>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Eval.DB.App ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
190)
(= __@x0
(Eval.DB.App (Eval.DB.App_g __@x0)
(Eval.DB.App_a __@x0)
(Eval.DB.App_b __@x0)
(Eval.DB.App_e1 __@x0)
(Eval.DB.App_e2 __@x0)))))

; </end constructor Eval.DB.App>


; </end encoding type Eval.DB.tm>


; encoding sigelt val Eval.DB.uu___is_Var


; <Start encoding val Eval.DB.uu___is_Var>

(declare-fun Eval.DB.uu___is_Var (Term Term Term) Term)
;;;;;;;;;;;;;;;;projectee: tm _ _ -> Prims.bool
(declare-fun Tm_arrow_757e83fb6bd8b8474dd0b59ba6a1f824 () Term)
(declare-fun Eval.DB.uu___is_Var@tok () Term)

; </end encoding val Eval.DB.uu___is_Var>
...
; encoding sigelt val Eval.DB.__proj__Var__item__g


; <Start encoding val Eval.DB.__proj__Var__item__g>

(declare-fun Tm_refine_510090c4b8d9bd9a52cee793ac3e6455 (Term Term) Term)
(declare-fun Eval.DB.__proj__Var__item__g (Term Term Term) Term)

;;;;;;;;;;;;;;;;projectee: _: tm _ _ {Var? _} -> Type
(declare-fun Tm_arrow_aa42ea5e62fd607f94242f8847039ed2 () Term)
(declare-fun Eval.DB.__proj__Var__item__g@tok () Term)

; </end encoding val Eval.DB.__proj__Var__item__g>

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Eval.DB.uu___is_Var; Namespace Eval.DB
(assert (! 
;; def=Eval.DB.fst(23,5-23,8); use=Eval.DB.fst(23,5-23,8)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
...
(Eval.DB.tm @x0
@x1)))
(HasType (Eval.DB.uu___is_Var @x0
@x1
@x2)
Prims.bool))
 

:pattern ((Eval.DB.uu___is_Var @x0
@x1
@x2))
:qid typing_Eval.DB.uu___is_Var))

:named typing_Eval.DB.uu___is_Var))
;;;;;;;;;;;;;;;;name-token correspondence
;;; Fact-ids: Name Eval.DB.tm; Namespace Eval.DB; Name Eval.DB.Var; Namespace Eval.DB; Name Eval.DB.Lam; Namespace Eval.DB; Name Eval.DB.App; Namespace Eval.DB
(assert (! 
;; def=Eval.DB.fst(22,10-22,12); use=Eval.DB.fst(22,10-22,12)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (ApplyTT Eval.DB.tm@tok
@x0)
@x1)
(Eval.DB.tm @x0
@x1))
...
:pattern ((ApplyTT (ApplyTT Eval.DB.tm@tok
@x0)
@x1))

:pattern ((Eval.DB.tm @x0
@x1))
:qid token_correspondence_Eval.DB.tm@tok))

:named token_correspondence_Eval.DB.tm@tok))
;;;;;;;;;;;;;;;;subterm ordering
;;; Fact-ids: Name Eval.DB.tm; Namespace Eval.DB; Name Eval.DB.Var; Namespace Eval.DB; Name Eval.DB.Lam; Namespace Eval.DB; Name Eval.DB.App; Namespace Eval.DB
(assert (! 
;; def=Eval.DB.fst(23,5-23,8); use=Eval.DB.fst(23,5-23,8)
...
(Eval.DB.tm @x4
@x5)))
:qid subterm_ordering_Eval.DB.Var))

:named subterm_ordering_Eval.DB.Var))
;;;;;;;;;;;;;;;;subterm ordering
;;; Fact-ids: Name Eval.DB.tm; Namespace Eval.DB; Name Eval.DB.Var; Namespace Eval.DB; Name Eval.DB.Lam; Namespace Eval.DB; Name Eval.DB.App; Namespace Eval.DB
(assert (! 
;; def=Eval.DB.fst(24,5-24,8); use=Eval.DB.fst(24,5-24,8)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term) (@x6 Term))
 (! (implies (HasTypeFuel (SFuel @u0)
(Eval.DB.Lam @x1
@x2
...
(Eval.DB.tm @x5
@x6)))
:qid subterm_ordering_Eval.DB.Lam))

:named subterm_ordering_Eval.DB.Lam))
;;;;;;;;;;;;;;;;subterm ordering
;;; Fact-ids: Name Eval.DB.tm; Namespace Eval.DB; Name Eval.DB.Var; Namespace Eval.DB; Name Eval.DB.Lam; Namespace Eval.DB; Name Eval.DB.App; Namespace Eval.DB
(assert (! 
;; def=Eval.DB.fst(25,5-25,8); use=Eval.DB.fst(25,5-25,8)
...
(Eval.DB.tm @x6
@x7)))
:qid subterm_ordering_Eval.DB.App))

:named subterm_ordering_Eval.DB.App))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name Eval.DB.__proj__Var__item__g; Namespace Eval.DB
(assert (! 
;; def=Eval.DB.fst(23,5-23,8); use=Eval.DB.fst(23,5-23,8)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_refine_510090c4b8d9bd9a52cee793ac3e6455 @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_refine_510090c4b8d9bd9a52cee793ac3e6455 @x0
@x1)
Tm_type))
:qid refinement_kinding_Tm_refine_510090c4b8d9bd9a52cee793ac3e6455))

:named refinement_kinding_Tm_refine_510090c4b8d9bd9a52cee793ac3e6455))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name Eval.DB.__proj__Var__item__g; Namespace Eval.DB
(assert (! 
;; def=Eval.DB.fst(23,5-23,8); use=Eval.DB.fst(23,5-23,8)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_510090c4b8d9bd9a52cee793ac3e6455 @x2
@x3))
(and (HasTypeFuel @u0
@x1
(Eval.DB.tm @x2
...
;; def=Eval.DB.fst(23,5-23,8); use=Eval.DB.fst(23,5-23,8)
(BoxBool_proj_0 (Eval.DB.uu___is_Var @x2
@x3
@x1))
))
...
(Tm_refine_510090c4b8d9bd9a52cee793ac3e6455 @x2
@x3)))
:qid refinement_interpretation_Tm_refine_510090c4b8d9bd9a52cee793ac3e6455))

:named refinement_interpretation_Tm_refine_510090c4b8d9bd9a52cee793ac3e6455))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Eval.DB.tm; Namespace Eval.DB; Name Eval.DB.Var; Namespace Eval.DB; Name Eval.DB.Lam; Namespace Eval.DB; Name Eval.DB.App; Namespace Eval.DB
(assert (! 
;; def=Eval.DB.fst(23,5-23,8); use=Eval.DB.fst(23,5-23,8)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (Eval.DB.Var_g (Eval.DB.Var @x0
@x1
@x2))
@x0)
...
@x1
@x2))
:qid projection_inverse_Eval.DB.Var_g))

:named projection_inverse_Eval.DB.Var_g))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Eval.DB.tm; Namespace Eval.DB; Name Eval.DB.Var; Namespace Eval.DB; Name Eval.DB.Lam; Namespace Eval.DB; Name Eval.DB.App; Namespace Eval.DB
(assert (! 
;; def=Eval.DB.fst(23,5-23,8); use=Eval.DB.fst(23,5-23,8)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (Eval.DB.Var_a (Eval.DB.Var @x0
@x1
@x2))
@x1)
...
@x1
@x2))
:qid projection_inverse_Eval.DB.Var_a))

:named projection_inverse_Eval.DB.Var_a))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Eval.DB.tm; Namespace Eval.DB; Name Eval.DB.Var; Namespace Eval.DB; Name Eval.DB.Lam; Namespace Eval.DB; Name Eval.DB.App; Namespace Eval.DB
(assert (! 
;; def=Eval.DB.fst(23,5-23,8); use=Eval.DB.fst(23,5-23,8)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (Eval.DB.Var__2 (Eval.DB.Var @x0
@x1
@x2))
@x2)
...
@x1
@x2))
:qid projection_inverse_Eval.DB.Var__2))

:named projection_inverse_Eval.DB.Var__2))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Eval.DB.tm; Namespace Eval.DB; Name Eval.DB.Var; Namespace Eval.DB; Name Eval.DB.Lam; Namespace Eval.DB; Name Eval.DB.App; Namespace Eval.DB
(assert (! 
;; def=Eval.DB.fst(24,5-24,8); use=Eval.DB.fst(24,5-24,8)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (Eval.DB.Lam_g (Eval.DB.Lam @x0
@x1
@x2
@x3))
@x0)
...
:pattern ((Eval.DB.Lam @x0
@x1
@x2
@x3))
:qid projection_inverse_Eval.DB.Lam_g))

:named projection_inverse_Eval.DB.Lam_g))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Eval.DB.tm; Namespace Eval.DB; Name Eval.DB.Var; Namespace Eval.DB; Name Eval.DB.Lam; Namespace Eval.DB; Name Eval.DB.App; Namespace Eval.DB
(assert (! 
;; def=Eval.DB.fst(24,5-24,8); use=Eval.DB.fst(24,5-24,8)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (Eval.DB.Lam_body (Eval.DB.Lam @x0
@x1
@x2
@x3))
@x3)
...
@x2
@x3))
:qid projection_inverse_Eval.DB.Lam_body))

:named projection_inverse_Eval.DB.Lam_body))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Eval.DB.tm; Namespace Eval.DB; Name Eval.DB.Var; Namespace Eval.DB; Name Eval.DB.Lam; Namespace Eval.DB; Name Eval.DB.App; Namespace Eval.DB
(assert (! 
;; def=Eval.DB.fst(24,5-24,8); use=Eval.DB.fst(24,5-24,8)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (Eval.DB.Lam_b (Eval.DB.Lam @x0
@x1
@x2
@x3))
@x2)
...
@x2
@x3))
:qid projection_inverse_Eval.DB.Lam_b))

:named projection_inverse_Eval.DB.Lam_b))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Eval.DB.tm; Namespace Eval.DB; Name Eval.DB.Var; Namespace Eval.DB; Name Eval.DB.Lam; Namespace Eval.DB; Name Eval.DB.App; Namespace Eval.DB
(assert (! 
;; def=Eval.DB.fst(24,5-24,8); use=Eval.DB.fst(24,5-24,8)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (Eval.DB.Lam_a (Eval.DB.Lam @x0
@x1
@x2
@x3))
@x1)
...
@x2
@x3))
:qid projection_inverse_Eval.DB.Lam_a))

:named projection_inverse_Eval.DB.Lam_a))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Eval.DB.tm; Namespace Eval.DB; Name Eval.DB.Var; Namespace Eval.DB; Name Eval.DB.Lam; Namespace Eval.DB; Name Eval.DB.App; Namespace Eval.DB
(assert (! 
;; def=Eval.DB.fst(25,5-25,8); use=Eval.DB.fst(25,5-25,8)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (= (Eval.DB.App_g (Eval.DB.App @x0
@x1
@x2
@x3
@x4))
...
:pattern ((Eval.DB.App @x0
@x1
@x2
@x3
@x4))
:qid projection_inverse_Eval.DB.App_g))

:named projection_inverse_Eval.DB.App_g))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Eval.DB.tm; Namespace Eval.DB; Name Eval.DB.Var; Namespace Eval.DB; Name Eval.DB.Lam; Namespace Eval.DB; Name Eval.DB.App; Namespace Eval.DB
(assert (! 
;; def=Eval.DB.fst(25,5-25,8); use=Eval.DB.fst(25,5-25,8)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (= (Eval.DB.App_e2 (Eval.DB.App @x0
@x1
@x2
@x3
@x4))
...
@x3
@x4))
:qid projection_inverse_Eval.DB.App_e2))

:named projection_inverse_Eval.DB.App_e2))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Eval.DB.tm; Namespace Eval.DB; Name Eval.DB.Var; Namespace Eval.DB; Name Eval.DB.Lam; Namespace Eval.DB; Name Eval.DB.App; Namespace Eval.DB
(assert (! 
;; def=Eval.DB.fst(25,5-25,8); use=Eval.DB.fst(25,5-25,8)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (= (Eval.DB.App_e1 (Eval.DB.App @x0
@x1
@x2
@x3
@x4))
...
@x3
@x4))
:qid projection_inverse_Eval.DB.App_e1))

:named projection_inverse_Eval.DB.App_e1))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Eval.DB.tm; Namespace Eval.DB; Name Eval.DB.Var; Namespace Eval.DB; Name Eval.DB.Lam; Namespace Eval.DB; Name Eval.DB.App; Namespace Eval.DB
(assert (! 
;; def=Eval.DB.fst(25,5-25,8); use=Eval.DB.fst(25,5-25,8)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (= (Eval.DB.App_b (Eval.DB.App @x0
@x1
@x2
@x3
@x4))
...
@x3
@x4))
:qid projection_inverse_Eval.DB.App_b))

:named projection_inverse_Eval.DB.App_b))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Eval.DB.tm; Namespace Eval.DB; Name Eval.DB.Var; Namespace Eval.DB; Name Eval.DB.Lam; Namespace Eval.DB; Name Eval.DB.App; Namespace Eval.DB
(assert (! 
;; def=Eval.DB.fst(25,5-25,8); use=Eval.DB.fst(25,5-25,8)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (= (Eval.DB.App_a (Eval.DB.App @x0
@x1
@x2
@x3
@x4))
...
@x3
@x4))
:qid projection_inverse_Eval.DB.App_a))

:named projection_inverse_Eval.DB.App_a))
;;;;;;;;;;;;;;;;kinding
;;; Fact-ids: Name Eval.DB.tm; Namespace Eval.DB; Name Eval.DB.Var; Namespace Eval.DB; Name Eval.DB.Lam; Namespace Eval.DB; Name Eval.DB.App; Namespace Eval.DB
(assert (! (is-Tm_arrow (PreType Eval.DB.tm@tok))
:named pre_kinding_Eval.DB.tm@tok))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_6980332764c4493a7b0df5c02f7aefbe
;;; Fact-ids: Name Eval.DB.tm; Namespace Eval.DB; Name Eval.DB.Var; Namespace Eval.DB; Name Eval.DB.Lam; Namespace Eval.DB; Name Eval.DB.App; Namespace Eval.DB
(assert (! 
;; def=Eval.DB.fst(24,21-24,32); use=Eval.DB.fst(24,68-24,78)
(forall ((@x0 Term) (@x1 Term))
...
;;;;;;;;;;;;;;;;kinding_Tm_arrow_5eb73fcd7e0c3d391166a6e670b615d2
;;; Fact-ids: Name Eval.DB.tm; Namespace Eval.DB; Name Eval.DB.Var; Namespace Eval.DB; Name Eval.DB.Lam; Namespace Eval.DB; Name Eval.DB.App; Namespace Eval.DB
(assert (! 
;; def=Eval.DB.fst(24,21-24,32); use=Eval.DB.fst(24,5-24,8)
(forall ((@x0 Term))
 (! (HasType (Tm_arrow_5eb73fcd7e0c3d391166a6e670b615d2 @x0)
Tm_type)
 

:pattern ((HasType (Tm_arrow_5eb73fcd7e0c3d391166a6e670b615d2 @x0)
Tm_type))
:qid kinding_Tm_arrow_5eb73fcd7e0c3d391166a6e670b615d2))

:named kinding_Tm_arrow_5eb73fcd7e0c3d391166a6e670b615d2))
;;; Fact-ids: Name Eval.DB.tm; Namespace Eval.DB; Name Eval.DB.Var; Namespace Eval.DB; Name Eval.DB.Lam; Namespace Eval.DB; Name Eval.DB.App; Namespace Eval.DB
(assert (! (and (IsTotFun Eval.DB.tm@tok)

;; def=Eval.DB.fst(22,10-22,12); use=Eval.DB.fst(22,10-22,12)
(forall ((@x0 Term))
 (! (IsTotFun (ApplyTT Eval.DB.tm@tok
@x0))
 

:pattern ((ApplyTT Eval.DB.tm@tok
@x0))
:qid kinding_Eval.DB.tm@tok))
...
:pattern ((Eval.DB.tm @x0
@x1))
:qid kinding_Eval.DB.tm@tok.1))
)
:named kinding_Eval.DB.tm@tok))
;;;;;;;;;;;;;;;;haseq for Tm_refine_510090c4b8d9bd9a52cee793ac3e6455
;;; Fact-ids: Name Eval.DB.__proj__Var__item__g; Namespace Eval.DB
(assert (! 
;; def=Eval.DB.fst(23,5-23,8); use=Eval.DB.fst(23,5-23,8)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_510090c4b8d9bd9a52cee793ac3e6455 @x0
@x1)))
(Valid (Prims.hasEq (Eval.DB.tm @x0
@x1))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_510090c4b8d9bd9a52cee793ac3e6455 @x0
@x1))))
:qid haseqTm_refine_510090c4b8d9bd9a52cee793ac3e6455))

:named haseqTm_refine_510090c4b8d9bd9a52cee793ac3e6455))
;;;;;;;;;;;;;;;;inversion axiom
;;; Fact-ids: Name Eval.DB.tm; Namespace Eval.DB; Name Eval.DB.Var; Namespace Eval.DB; Name Eval.DB.Lam; Namespace Eval.DB; Name Eval.DB.App; Namespace Eval.DB
(assert (! 
;; def=Eval.DB.fst(22,10-22,12); use=Eval.DB.fst(22,10-22,12)
...
(Eval.DB.tm @x2
@x3))
(or (and (is-Eval.DB.Var @x1)
(= @x2
(Eval.DB.Var_g @x1))
(= @x3
(Eval.DB.Var_a @x1)))
(and (is-Eval.DB.Lam @x1)
(= @x2
(Eval.DB.Lam_g @x1))
(= @x3
(Tm_arrow_5eb73fcd7e0c3d391166a6e670b615d2 @x1)))
(and (is-Eval.DB.App @x1)
(= @x2
(Eval.DB.App_g @x1))
(= @x3
(Eval.DB.App_b @x1)))))
...
(Eval.DB.tm @x2
@x3)))
:qid fuel_guarded_inversion_Eval.DB.tm))

:named fuel_guarded_inversion_Eval.DB.tm))
;;;;;;;;;;;;;;;;fresh token
;;; Fact-ids: Name Eval.DB.tm; Namespace Eval.DB; Name Eval.DB.Var; Namespace Eval.DB; Name Eval.DB.Lam; Namespace Eval.DB; Name Eval.DB.App; Namespace Eval.DB
(assert (! (= 160
(Term_constr_id Eval.DB.tm@tok))
:named fresh_token_Eval.DB.tm@tok))
;;;;;;;;;;;;;;;;Discriminator equation
;;; Fact-ids: Name Eval.DB.uu___is_Var; Namespace Eval.DB
(assert (! 
;; def=Eval.DB.fst(23,5-23,8); use=Eval.DB.fst(23,5-23,8)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (Eval.DB.uu___is_Var @x0
@x1
@x2)
(BoxBool (is-Eval.DB.Var @x2)))
 

:pattern ((Eval.DB.uu___is_Var @x0
@x1
@x2))
:qid disc_equation_Eval.DB.Var))

:named disc_equation_Eval.DB.Var))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name Eval.DB.tm; Namespace Eval.DB; Name Eval.DB.Var; Namespace Eval.DB; Name Eval.DB.Lam; Namespace Eval.DB; Name Eval.DB.App; Namespace Eval.DB
(assert (! 
;; def=Eval.DB.fst(23,5-23,8); use=Eval.DB.fst(23,5-23,8)
...
(Eval.DB.tm @x4
@x5)))
:qid data_typing_intro_Eval.DB.Var@tok))

:named data_typing_intro_Eval.DB.Var@tok))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name Eval.DB.tm; Namespace Eval.DB; Name Eval.DB.Var; Namespace Eval.DB; Name Eval.DB.Lam; Namespace Eval.DB; Name Eval.DB.App; Namespace Eval.DB
(assert (! 
;; def=Eval.DB.fst(24,5-24,8); use=Eval.DB.fst(24,5-24,8)
...
(HasTypeFuel @u0
@x4
(Eval.DB.tm (FStar.Pervasives.Native.tuple2 @x1
@x2)
@x3))
(= @x1
@x5)
...
(Eval.DB.tm @x5
@x6)))
:qid data_typing_intro_Eval.DB.Lam@tok))

:named data_typing_intro_Eval.DB.Lam@tok))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name Eval.DB.tm; Namespace Eval.DB; Name Eval.DB.Var; Namespace Eval.DB; Name Eval.DB.Lam; Namespace Eval.DB; Name Eval.DB.App; Namespace Eval.DB
(assert (! 
;; def=Eval.DB.fst(25,5-25,8); use=Eval.DB.fst(25,5-25,8)
...
(Eval.DB.tm @x6
@x7)))
:qid data_typing_intro_Eval.DB.App@tok))

:named data_typing_intro_Eval.DB.App@tok))
;;;;;;;;;;;;;;;;data constructor typing elim
;;; Fact-ids: Name Eval.DB.tm; Namespace Eval.DB; Name Eval.DB.Var; Namespace Eval.DB; Name Eval.DB.Lam; Namespace Eval.DB; Name Eval.DB.App; Namespace Eval.DB
(assert (! 
;; def=Eval.DB.fst(23,5-23,8); use=Eval.DB.fst(23,5-23,8)
...
(Eval.DB.tm @x4
@x5)))
:qid data_elim_Eval.DB.Var))

:named data_elim_Eval.DB.Var))
;;;;;;;;;;;;;;;;data constructor typing elim
;;; Fact-ids: Name Eval.DB.tm; Namespace Eval.DB; Name Eval.DB.Var; Namespace Eval.DB; Name Eval.DB.Lam; Namespace Eval.DB; Name Eval.DB.App; Namespace Eval.DB
(assert (! 
;; def=Eval.DB.fst(24,5-24,8); use=Eval.DB.fst(24,5-24,8)
...
(Eval.DB.tm @x5
@x6))
(and (= (Tm_arrow_6980332764c4493a7b0df5c02f7aefbe @x3
@x2)
@x6)
(= @x1
@x5)
...
(Eval.DB.tm @x5
@x6)))
:qid data_elim_Eval.DB.Lam))

:named data_elim_Eval.DB.Lam))
;;;;;;;;;;;;;;;;data constructor typing elim
;;; Fact-ids: Name Eval.DB.tm; Namespace Eval.DB; Name Eval.DB.Var; Namespace Eval.DB; Name Eval.DB.Lam; Namespace Eval.DB; Name Eval.DB.App; Namespace Eval.DB
(assert (! 
;; def=Eval.DB.fst(25,5-25,8); use=Eval.DB.fst(25,5-25,8)
...
(Eval.DB.tm @x6
@x7)))
:qid data_elim_Eval.DB.App))

:named data_elim_Eval.DB.App))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Eval.DB.tm; Namespace Eval.DB; Name Eval.DB.Var; Namespace Eval.DB; Name Eval.DB.Lam; Namespace Eval.DB; Name Eval.DB.App; Namespace Eval.DB
(assert (! 
;; def=Eval.DB.fst(22,10-22,12); use=Eval.DB.fst(22,10-22,12)
(forall ((@x0 Term) (@x1 Term))
 (! (= 159
(Term_constr_id (Eval.DB.tm @x0
@x1)))
 

:pattern ((Eval.DB.tm @x0
@x1))
:qid constructor_distinct_Eval.DB.tm))

:named constructor_distinct_Eval.DB.tm))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Eval.DB.tm; Namespace Eval.DB; Name Eval.DB.Var; Namespace Eval.DB; Name Eval.DB.Lam; Namespace Eval.DB; Name Eval.DB.App; Namespace Eval.DB
(assert (! 
;; def=Eval.DB.fst(23,5-23,8); use=Eval.DB.fst(23,5-23,8)
...
@x2
@x3))
:qid constructor_distinct_Eval.DB.Lam))

:named constructor_distinct_Eval.DB.Lam))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Eval.DB.tm; Namespace Eval.DB; Name Eval.DB.Var; Namespace Eval.DB; Name Eval.DB.Lam; Namespace Eval.DB; Name Eval.DB.App; Namespace Eval.DB
(assert (! 
;; def=Eval.DB.fst(25,5-25,8); use=Eval.DB.fst(25,5-25,8)
...
@x3
@x4))
:qid constructor_distinct_Eval.DB.App))

:named constructor_distinct_Eval.DB.App))
;;;;;;;;;;;;;;;;pretyping
;;; Fact-ids: Name Eval.DB.tm; Namespace Eval.DB; Name Eval.DB.Var; Namespace Eval.DB; Name Eval.DB.Lam; Namespace Eval.DB; Name Eval.DB.App; Namespace Eval.DB
(assert (! 
;; def=Eval.DB.fst(22,10-22,12); use=Eval.DB.fst(22,10-22,12)
...
(Eval.DB.tm @x2
@x3)))
:qid Eval.DB_pretyping_f7e47844c428b6abea45b804668ee9c4))

:named Eval.DB_pretyping_f7e47844c428b6abea45b804668ee9c4))
...
(Tm_arrow_6980332764c4493a7b0df5c02f7aefbe @x2
@x3)))
:qid Eval.DB_pre_typing_Tm_arrow_6980332764c4493a7b0df5c02f7aefbe))

:named Eval.DB_pre_typing_Tm_arrow_6980332764c4493a7b0df5c02f7aefbe))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name Eval.DB.tm; Namespace Eval.DB; Name Eval.DB.Var; Namespace Eval.DB; Name Eval.DB.Lam; Namespace Eval.DB; Name Eval.DB.App; Namespace Eval.DB
(assert (! 
;; def=Eval.DB.fst(24,21-24,32); use=Eval.DB.fst(24,5-24,8)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_5eb73fcd7e0c3d391166a6e670b615d2 @x2))
(is-Tm_arrow (PreType @x1)))
...
@x1
(Tm_arrow_5eb73fcd7e0c3d391166a6e670b615d2 @x2)))
:qid Eval.DB_pre_typing_Tm_arrow_5eb73fcd7e0c3d391166a6e670b615d2))

:named Eval.DB_pre_typing_Tm_arrow_5eb73fcd7e0c3d391166a6e670b615d2))
...
:pattern ((ApplyTT @x0
@x3))
:qid Eval.DB_interpretation_Tm_arrow_6980332764c4493a7b0df5c02f7aefbe.1))
...
(Tm_arrow_6980332764c4493a7b0df5c02f7aefbe @x1
@x2)))
:qid Eval.DB_interpretation_Tm_arrow_6980332764c4493a7b0df5c02f7aefbe))

:named Eval.DB_interpretation_Tm_arrow_6980332764c4493a7b0df5c02f7aefbe))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_5eb73fcd7e0c3d391166a6e670b615d2
;;; Fact-ids: Name Eval.DB.tm; Namespace Eval.DB; Name Eval.DB.Var; Namespace Eval.DB; Name Eval.DB.Lam; Namespace Eval.DB; Name Eval.DB.App; Namespace Eval.DB
(assert (! 
;; def=Eval.DB.fst(24,21-24,32); use=Eval.DB.fst(24,5-24,8)
(forall ((@x0 Term) (@x1 Term))
...
:pattern ((ApplyTT @x0
@x2))
:qid Eval.DB_interpretation_Tm_arrow_5eb73fcd7e0c3d391166a6e670b615d2.1))
...
:pattern ((HasTypeZ @x0
(Tm_arrow_5eb73fcd7e0c3d391166a6e670b615d2 @x1)))
:qid Eval.DB_interpretation_Tm_arrow_5eb73fcd7e0c3d391166a6e670b615d2))

:named Eval.DB_interpretation_Tm_arrow_5eb73fcd7e0c3d391166a6e670b615d2))
(push) ;; push{2

; Starting query at Eval.DB.fst(23,11-23,12)

(declare-fun label_1 () Bool)


; Encoding query formula : forall (_: Type) (_: Type) (projectee: _: Eval.DB.tm _ _ {Var? _}).
;   (*  - Could not prove post-condition
...
Tm_type)
(HasType @x2
(Tm_refine_510090c4b8d9bd9a52cee793ac3e6455 @x0
@x1))

;; def=Eval.DB.fst(23,5-23,8); use=Eval.DB.fst(23,11-23,12)
(not 
;; def=Eval.DB.fst(23,5-23,8); use=Eval.DB.fst(23,11-23,12)
(BoxBool_proj_0 (Eval.DB.uu___is_Var @x0
@x1
@x2))
)
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Eval.DB.__proj__Var__item__g, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_510090c4b8d9bd9a52cee793ac3e6455
...
; encoding sigelt val Eval.DB.__proj__Var__item__a


; <Start encoding val Eval.DB.__proj__Var__item__a>


(declare-fun Eval.DB.__proj__Var__item__a (Term Term Term) Term)


(declare-fun Eval.DB.__proj__Var__item__a@tok () Term)

; </end encoding val Eval.DB.__proj__Var__item__a>

(push) ;; push{2

; Starting query at Eval.DB.fst(23,21-23,22)
...
; Context: While encoding a query
; While typechecking the top-level declaration `let __proj__Var__item__a`
...
;; def=Eval.DB.fst(23,5-23,8); use=Eval.DB.fst(23,21-23,22)
(not 
;; def=Eval.DB.fst(23,5-23,8); use=Eval.DB.fst(23,21-23,22)
(BoxBool_proj_0 (Eval.DB.uu___is_Var @x0
@x1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Eval.DB.__proj__Var__item__a, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_510090c4b8d9bd9a52cee793ac3e6455
...
; encoding sigelt let __proj__Var__item__a


; <Skipped let __proj__Var__item__a/>


; encoding sigelt val Eval.DB.__proj__Var__item___2


; <Start encoding val Eval.DB.__proj__Var__item___2>


(declare-fun Eval.DB.__proj__Var__item___2 (Term Term Term) Term)

;;;;;;;;;;;;;;;;projectee: _: tm _ _ {Var? _} -> var projectee.g projectee.a
(declare-fun Tm_arrow_85fb51552fd92b0065374960797d9f0a () Term)
(declare-fun Eval.DB.__proj__Var__item___2@tok () Term)

; </end encoding val Eval.DB.__proj__Var__item___2>

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Eval.DB.__proj__Var__item__g; Namespace Eval.DB
(assert (! 
;; def=Eval.DB.fst(23,11-23,12); use=Eval.DB.fst(23,11-23,12)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
...
(Tm_refine_510090c4b8d9bd9a52cee793ac3e6455 @x0
@x1)))
(HasType (Eval.DB.__proj__Var__item__g @x0
@x1
@x2)
Tm_type))
 

:pattern ((Eval.DB.__proj__Var__item__g @x0
@x1
@x2))
:qid typing_Eval.DB.__proj__Var__item__g))

:named typing_Eval.DB.__proj__Var__item__g))
;;;;;;;;;;;;;;;;Projector equation
;;; Fact-ids: Name Eval.DB.__proj__Var__item__g; Namespace Eval.DB
(assert (! 
;; def=Eval.DB.fst(23,11-23,12); use=Eval.DB.fst(23,11-23,12)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (Eval.DB.__proj__Var__item__g @x0
@x1
@x2)
(Eval.DB.Var_g @x2))
...
@x1
@x2))
:qid proj_equation_Eval.DB.Var_g))

:named proj_equation_Eval.DB.Var_g))
(push) ;; push{2
...
; *)
;   (~(Var? projectee) ==> Prims.l_False) /\
;   (forall (b: Type) (b: Type) (b: Eval.DB.var b b).
;       projectee == Eval.DB.Var b b b ==>
;       b == _ /\ b == _ /\ Var? (Eval.DB.Var b b b) /\
;       (forall (return_val: _: Eval.DB.tm _ _ {Var? _}).
;           return_val == Eval.DB.Var b b b ==>
;           (forall (any_result: Type).
;               (Eval.DB.Var b b b).g == any_result ==> b == _ /\ b == _ /\ Var? (Eval.DB.Var b b b)))
;   )


; Context: While encoding a query
; While typechecking the top-level declaration `let __proj__Var__item___2`
...
;; def=Prims.fst(459,77-459,89); use=Prims.fst(459,77-459,89)
(and 
;; def=dummy(0,0-0,0); use=Eval.DB.fst(23,5-23,8)
(or label_2
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Eval.DB.__proj__Var__item___2, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, data_elim_Eval.DB.Var, refinement_interpretation_Tm_refine_510090c4b8d9bd9a52cee793ac3e6455
...
; encoding sigelt let __proj__Var__item___2


; <Skipped let __proj__Var__item___2/>


; encoding sigelt val Eval.DB.uu___is_Lam


; <Start encoding val Eval.DB.uu___is_Lam>

(declare-fun Eval.DB.uu___is_Lam (Term Term Term) Term)

(declare-fun Eval.DB.uu___is_Lam@tok () Term)

; </end encoding val Eval.DB.uu___is_Lam>
...
; encoding sigelt val Eval.DB.__proj__Lam__item__g


; <Start encoding val Eval.DB.__proj__Lam__item__g>

(declare-fun Tm_refine_8ba4e4e3f13cea313e3b1698266f8372 (Term Term) Term)
(declare-fun Eval.DB.__proj__Lam__item__g (Term Term Term) Term)

;;;;;;;;;;;;;;;;projectee: _: tm _ _ {Lam? _} -> Type
(declare-fun Tm_arrow_81f5ae4299ac789c33ce7b9b3f1e7d30 () Term)
(declare-fun Eval.DB.__proj__Lam__item__g@tok () Term)

; </end encoding val Eval.DB.__proj__Lam__item__g>

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Eval.DB.uu___is_Lam; Namespace Eval.DB
(assert (! 
;; def=Eval.DB.fst(24,5-24,8); use=Eval.DB.fst(24,5-24,8)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x0
...
(Eval.DB.tm @x0
@x1)))
(HasType (Eval.DB.uu___is_Lam @x0
@x1
@x2)
Prims.bool))
 

:pattern ((Eval.DB.uu___is_Lam @x0
@x1
@x2))
:qid typing_Eval.DB.uu___is_Lam))

:named typing_Eval.DB.uu___is_Lam))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name Eval.DB.__proj__Lam__item__g; Namespace Eval.DB
(assert (! 
;; def=Eval.DB.fst(24,5-24,8); use=Eval.DB.fst(24,5-24,8)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_refine_8ba4e4e3f13cea313e3b1698266f8372 @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_refine_8ba4e4e3f13cea313e3b1698266f8372 @x0
@x1)
Tm_type))
:qid refinement_kinding_Tm_refine_8ba4e4e3f13cea313e3b1698266f8372))

:named refinement_kinding_Tm_refine_8ba4e4e3f13cea313e3b1698266f8372))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name Eval.DB.__proj__Lam__item__g; Namespace Eval.DB
(assert (! 
;; def=Eval.DB.fst(24,5-24,8); use=Eval.DB.fst(24,5-24,8)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_8ba4e4e3f13cea313e3b1698266f8372 @x2
@x3))
(and (HasTypeFuel @u0
@x1
(Eval.DB.tm @x2
...
;; def=Eval.DB.fst(24,5-24,8); use=Eval.DB.fst(24,5-24,8)
(BoxBool_proj_0 (Eval.DB.uu___is_Lam @x2
@x3
@x1))
))
...
(Tm_refine_8ba4e4e3f13cea313e3b1698266f8372 @x2
@x3)))
:qid refinement_interpretation_Tm_refine_8ba4e4e3f13cea313e3b1698266f8372))

:named refinement_interpretation_Tm_refine_8ba4e4e3f13cea313e3b1698266f8372))
;;;;;;;;;;;;;;;;haseq for Tm_refine_8ba4e4e3f13cea313e3b1698266f8372
;;; Fact-ids: Name Eval.DB.__proj__Lam__item__g; Namespace Eval.DB
(assert (! 
;; def=Eval.DB.fst(24,5-24,8); use=Eval.DB.fst(24,5-24,8)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_8ba4e4e3f13cea313e3b1698266f8372 @x0
@x1)))
(Valid (Prims.hasEq (Eval.DB.tm @x0
@x1))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_8ba4e4e3f13cea313e3b1698266f8372 @x0
@x1))))
:qid haseqTm_refine_8ba4e4e3f13cea313e3b1698266f8372))

:named haseqTm_refine_8ba4e4e3f13cea313e3b1698266f8372))
;;;;;;;;;;;;;;;;Discriminator equation
;;; Fact-ids: Name Eval.DB.uu___is_Lam; Namespace Eval.DB
(assert (! 
;; def=Eval.DB.fst(24,5-24,8); use=Eval.DB.fst(24,5-24,8)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (Eval.DB.uu___is_Lam @x0
@x1
@x2)
(BoxBool (is-Eval.DB.Lam @x2)))
 

:pattern ((Eval.DB.uu___is_Lam @x0
@x1
@x2))
:qid disc_equation_Eval.DB.Lam))

:named disc_equation_Eval.DB.Lam))
(push) ;; push{2

; Starting query at Eval.DB.fst(24,11-24,12)

(declare-fun label_1 () Bool)


; Encoding query formula : forall (_: Type) (_: Type) (projectee: _: Eval.DB.tm _ _ {Lam? _}).
;   (*  - Could not prove post-condition
; *) ~(Lam? projectee) ==> Prims.l_False


; Context: While encoding a query
; While typechecking the top-level declaration `let __proj__Lam__item__g`
...
Tm_type)
(HasType @x2
(Tm_refine_8ba4e4e3f13cea313e3b1698266f8372 @x0
@x1))

;; def=Eval.DB.fst(24,5-24,8); use=Eval.DB.fst(24,11-24,12)
(not 
;; def=Eval.DB.fst(24,5-24,8); use=Eval.DB.fst(24,11-24,12)
(BoxBool_proj_0 (Eval.DB.uu___is_Lam @x0
@x1
@x2))
)
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Eval.DB.__proj__Lam__item__g, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_8ba4e4e3f13cea313e3b1698266f8372
...
; encoding sigelt let __proj__Lam__item__g


; <Skipped let __proj__Lam__item__g/>


; encoding sigelt val Eval.DB.__proj__Lam__item__a


; <Start encoding val Eval.DB.__proj__Lam__item__a>


(declare-fun Eval.DB.__proj__Lam__item__a (Term Term Term) Term)


(declare-fun Eval.DB.__proj__Lam__item__a@tok () Term)

; </end encoding val Eval.DB.__proj__Lam__item__a>

(push) ;; push{2

; Starting query at Eval.DB.fst(24,21-24,22)
...
; Context: While encoding a query
; While typechecking the top-level declaration `let __proj__Lam__item__a`
...
;; def=Eval.DB.fst(24,5-24,8); use=Eval.DB.fst(24,21-24,22)
(not 
;; def=Eval.DB.fst(24,5-24,8); use=Eval.DB.fst(24,21-24,22)
(BoxBool_proj_0 (Eval.DB.uu___is_Lam @x0
@x1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Eval.DB.__proj__Lam__item__a, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_8ba4e4e3f13cea313e3b1698266f8372
...
; encoding sigelt let __proj__Lam__item__a


; <Skipped let __proj__Lam__item__a/>


; encoding sigelt val Eval.DB.__proj__Lam__item__b


; <Start encoding val Eval.DB.__proj__Lam__item__b>


(declare-fun Eval.DB.__proj__Lam__item__b (Term Term Term) Term)


(declare-fun Eval.DB.__proj__Lam__item__b@tok () Term)

; </end encoding val Eval.DB.__proj__Lam__item__b>

(push) ;; push{2

; Starting query at Eval.DB.fst(24,31-24,32)
...
; Context: While encoding a query
; While typechecking the top-level declaration `let __proj__Lam__item__b`
...
;; def=Eval.DB.fst(24,5-24,8); use=Eval.DB.fst(24,31-24,32)
(not 
;; def=Eval.DB.fst(24,5-24,8); use=Eval.DB.fst(24,31-24,32)
(BoxBool_proj_0 (Eval.DB.uu___is_Lam @x0
@x1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Eval.DB.__proj__Lam__item__b, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_8ba4e4e3f13cea313e3b1698266f8372
...
; encoding sigelt let __proj__Lam__item__b


; <Skipped let __proj__Lam__item__b/>


; encoding sigelt val Eval.DB.__proj__Lam__item__body


; <Start encoding val Eval.DB.__proj__Lam__item__body>


(declare-fun Eval.DB.__proj__Lam__item__body (Term Term Term) Term)

;;;;;;;;;;;;;;;;projectee: _: tm _ _ {Lam? _} -> tm (projectee.g & projectee.a) projectee.b
(declare-fun Tm_arrow_46254c213bbcb47cfaaab2022c05312d () Term)
(declare-fun Eval.DB.__proj__Lam__item__body@tok () Term)

; </end encoding val Eval.DB.__proj__Lam__item__body>

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Eval.DB.__proj__Lam__item__g; Namespace Eval.DB
(assert (! 
;; def=Eval.DB.fst(24,11-24,12); use=Eval.DB.fst(24,11-24,12)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
...
(Tm_refine_8ba4e4e3f13cea313e3b1698266f8372 @x0
@x1)))
(HasType (Eval.DB.__proj__Lam__item__g @x0
@x1
@x2)
Tm_type))
 

:pattern ((Eval.DB.__proj__Lam__item__g @x0
@x1
@x2))
:qid typing_Eval.DB.__proj__Lam__item__g))

:named typing_Eval.DB.__proj__Lam__item__g))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Eval.DB.__proj__Lam__item__a; Namespace Eval.DB
(assert (! 
;; def=Eval.DB.fst(24,21-24,22); use=Eval.DB.fst(24,21-24,22)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
...
(Tm_refine_8ba4e4e3f13cea313e3b1698266f8372 @x0
@x1)))
(HasType (Eval.DB.__proj__Lam__item__a @x0
@x1
@x2)
Tm_type))
 

:pattern ((Eval.DB.__proj__Lam__item__a @x0
@x1
@x2))
:qid typing_Eval.DB.__proj__Lam__item__a))

:named typing_Eval.DB.__proj__Lam__item__a))
;;;;;;;;;;;;;;;;Projector equation
;;; Fact-ids: Name Eval.DB.__proj__Lam__item__g; Namespace Eval.DB
(assert (! 
;; def=Eval.DB.fst(24,11-24,12); use=Eval.DB.fst(24,11-24,12)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (Eval.DB.__proj__Lam__item__g @x0
@x1
@x2)
(Eval.DB.Lam_g @x2))
...
@x1
@x2))
:qid proj_equation_Eval.DB.Lam_g))

:named proj_equation_Eval.DB.Lam_g))
;;;;;;;;;;;;;;;;Projector equation
;;; Fact-ids: Name Eval.DB.__proj__Lam__item__a; Namespace Eval.DB
(assert (! 
;; def=Eval.DB.fst(24,21-24,22); use=Eval.DB.fst(24,21-24,22)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (Eval.DB.__proj__Lam__item__a @x0
@x1
@x2)
(Eval.DB.Lam_a @x2))
...
@x1
@x2))
:qid proj_equation_Eval.DB.Lam_a))

:named proj_equation_Eval.DB.Lam_a))
(push) ;; push{2

; Starting query at Eval.DB.fst(24,41-24,45)
...
; *)
;   (~(Lam? projectee) ==> Prims.l_False) /\
;   (forall (b: Type) (b: Type) (b: Type) (b: Eval.DB.tm (b & b) b).
;       projectee == Eval.DB.Lam b b b b ==>
;       (_: b -> b) == _ /\ b == _ /\ Lam? (Eval.DB.Lam b b b b) /\
;       (forall (return_val: _: Eval.DB.tm _ _ {Lam? _}).
;           return_val == Eval.DB.Lam b b b b ==>
;           (forall (any_result: Type).
;               (Eval.DB.Lam b b b b).g == any_result ==>
;               (_: b -> b) == _ /\ b == _ /\ Lam? (Eval.DB.Lam b b b b) /\
;               (forall (return_val: _: Eval.DB.tm _ _ {Lam? _}).
;                   return_val == Eval.DB.Lam b b b b ==>
;                   (forall (any_result: Type).
;                       (Eval.DB.Lam b b b b).a == any_result ==>
;                       (forall (any_result: Type).
;                           (Eval.DB.Lam b b b b).g & (Eval.DB.Lam b b b b).a == any_result ==>
;                           (_: b -> b) == _ /\ b == _ /\ Lam? (Eval.DB.Lam b b b b)))))))


; Context: While encoding a query
; While typechecking the top-level declaration `let __proj__Lam__item__body`
...
;; def=Prims.fst(459,77-459,89); use=Eval.DB.fst(24,41-24,45)
(and (implies 
;; def=Eval.DB.fst(24,5-24,8); use=Eval.DB.fst(24,41-24,45)
(not 
;; def=Eval.DB.fst(24,5-24,8); use=Eval.DB.fst(24,41-24,45)
(BoxBool_proj_0 (Eval.DB.uu___is_Lam @x0
@x1
...
;; def=Prims.fst(413,99-413,120); use=Eval.DB.fst(24,41-24,45)
(forall ((@x3 Term))
 (! (implies (HasType @x3
Tm_type)
...
(forall ((@x6 Term))
 (! (implies (and (HasType @x6
(Eval.DB.tm (FStar.Pervasives.Native.tuple2 @x3
@x4)
@x5))
...
;; def=dummy(0,0-0,0); use=Eval.DB.fst(24,41-24,45)
(= (Tm_arrow_6980332764c4493a7b0df5c02f7aefbe @x5
@x4)
@x1)
)
...
;; def=Prims.fst(356,2-356,58); use=Eval.DB.fst(24,41-24,45)
(forall ((@x7 Term))
 (! (implies (and (HasType @x7
(Tm_refine_8ba4e4e3f13cea313e3b1698266f8372 @x0
@x1))

;; def=Prims.fst(356,26-356,41); use=Eval.DB.fst(24,41-24,45)
(= @x7
(Eval.DB.Lam @x3
@x4
@x5
...
;; def=Prims.fst(451,66-451,102); use=Eval.DB.fst(24,41-24,45)
(forall ((@x8 Term))
 (! (implies (and (HasType @x8
Tm_type)

;; def=FStar.Pervasives.Native.fst(59,12-59,14); use=Eval.DB.fst(24,41-24,45)
(= (Eval.DB.__proj__Lam__item__g @x0
@x1
(Eval.DB.Lam @x3
@x4
...
;; def=FStar.Pervasives.Native.fst(59,15-59,17); use=Eval.DB.fst(24,41-24,45)
(= (Eval.DB.__proj__Lam__item__a @x0
@x1
(Eval.DB.Lam @x3
@x4
...
;; def=dummy(0,0-0,0); use=Eval.DB.fst(24,41-24,45)
(= (FStar.Pervasives.Native.tuple2 (Eval.DB.__proj__Lam__item__g @x0
@x1
(Eval.DB.Lam @x3
@x4
@x5
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Eval.DB.__proj__Lam__item__body, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, data_elim_Eval.DB.Lam, refinement_interpretation_Tm_refine_8ba4e4e3f13cea313e3b1698266f8372
...
; encoding sigelt let __proj__Lam__item__body


; <Skipped let __proj__Lam__item__body/>


; encoding sigelt val Eval.DB.uu___is_App


; <Start encoding val Eval.DB.uu___is_App>

(declare-fun Eval.DB.uu___is_App (Term Term Term) Term)

(declare-fun Eval.DB.uu___is_App@tok () Term)

; </end encoding val Eval.DB.uu___is_App>
...
; encoding sigelt val Eval.DB.__proj__App__item__g


; <Start encoding val Eval.DB.__proj__App__item__g>

(declare-fun Tm_refine_2349da90c7b3931f487aa92691daa8cd (Term Term) Term)
(declare-fun Eval.DB.__proj__App__item__g (Term Term Term) Term)

;;;;;;;;;;;;;;;;projectee: _: tm _ _ {App? _} -> Type
(declare-fun Tm_arrow_899560eb2ab599447bdcc6081419eaa1 () Term)
(declare-fun Eval.DB.__proj__App__item__g@tok () Term)

; </end encoding val Eval.DB.__proj__App__item__g>

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Eval.DB.uu___is_App; Namespace Eval.DB
(assert (! 
;; def=Eval.DB.fst(25,5-25,8); use=Eval.DB.fst(25,5-25,8)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x0
...
(Eval.DB.tm @x0
@x1)))
(HasType (Eval.DB.uu___is_App @x0
@x1
@x2)
Prims.bool))
 

:pattern ((Eval.DB.uu___is_App @x0
@x1
@x2))
:qid typing_Eval.DB.uu___is_App))

:named typing_Eval.DB.uu___is_App))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name Eval.DB.__proj__App__item__g; Namespace Eval.DB
(assert (! 
;; def=Eval.DB.fst(25,5-25,8); use=Eval.DB.fst(25,5-25,8)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_refine_2349da90c7b3931f487aa92691daa8cd @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_refine_2349da90c7b3931f487aa92691daa8cd @x0
@x1)
Tm_type))
:qid refinement_kinding_Tm_refine_2349da90c7b3931f487aa92691daa8cd))

:named refinement_kinding_Tm_refine_2349da90c7b3931f487aa92691daa8cd))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name Eval.DB.__proj__App__item__g; Namespace Eval.DB
(assert (! 
;; def=Eval.DB.fst(25,5-25,8); use=Eval.DB.fst(25,5-25,8)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_2349da90c7b3931f487aa92691daa8cd @x2
@x3))
(and (HasTypeFuel @u0
@x1
(Eval.DB.tm @x2
...
;; def=Eval.DB.fst(25,5-25,8); use=Eval.DB.fst(25,5-25,8)
(BoxBool_proj_0 (Eval.DB.uu___is_App @x2
@x3
@x1))
))
...
(Tm_refine_2349da90c7b3931f487aa92691daa8cd @x2
@x3)))
:qid refinement_interpretation_Tm_refine_2349da90c7b3931f487aa92691daa8cd))

:named refinement_interpretation_Tm_refine_2349da90c7b3931f487aa92691daa8cd))
;;;;;;;;;;;;;;;;haseq for Tm_refine_2349da90c7b3931f487aa92691daa8cd
;;; Fact-ids: Name Eval.DB.__proj__App__item__g; Namespace Eval.DB
(assert (! 
;; def=Eval.DB.fst(25,5-25,8); use=Eval.DB.fst(25,5-25,8)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_2349da90c7b3931f487aa92691daa8cd @x0
@x1)))
(Valid (Prims.hasEq (Eval.DB.tm @x0
@x1))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_2349da90c7b3931f487aa92691daa8cd @x0
@x1))))
:qid haseqTm_refine_2349da90c7b3931f487aa92691daa8cd))

:named haseqTm_refine_2349da90c7b3931f487aa92691daa8cd))
;;;;;;;;;;;;;;;;Discriminator equation
;;; Fact-ids: Name Eval.DB.uu___is_App; Namespace Eval.DB
(assert (! 
;; def=Eval.DB.fst(25,5-25,8); use=Eval.DB.fst(25,5-25,8)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (Eval.DB.uu___is_App @x0
@x1
@x2)
(BoxBool (is-Eval.DB.App @x2)))
 

:pattern ((Eval.DB.uu___is_App @x0
@x1
@x2))
:qid disc_equation_Eval.DB.App))

:named disc_equation_Eval.DB.App))
(push) ;; push{2

; Starting query at Eval.DB.fst(25,11-25,12)

(declare-fun label_1 () Bool)


; Encoding query formula : forall (_: Type) (_: Type) (projectee: _: Eval.DB.tm _ _ {App? _}).
;   (*  - Could not prove post-condition
; *) ~(App? projectee) ==> Prims.l_False


; Context: While encoding a query
; While typechecking the top-level declaration `let __proj__App__item__g`
...
Tm_type)
(HasType @x2
(Tm_refine_2349da90c7b3931f487aa92691daa8cd @x0
@x1))

;; def=Eval.DB.fst(25,5-25,8); use=Eval.DB.fst(25,11-25,12)
(not 
;; def=Eval.DB.fst(25,5-25,8); use=Eval.DB.fst(25,11-25,12)
(BoxBool_proj_0 (Eval.DB.uu___is_App @x0
@x1
@x2))
)
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Eval.DB.__proj__App__item__g, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_2349da90c7b3931f487aa92691daa8cd
...
; encoding sigelt let __proj__App__item__g


; <Skipped let __proj__App__item__g/>


; encoding sigelt val Eval.DB.__proj__App__item__a


; <Start encoding val Eval.DB.__proj__App__item__a>


(declare-fun Eval.DB.__proj__App__item__a (Term Term Term) Term)


(declare-fun Eval.DB.__proj__App__item__a@tok () Term)

; </end encoding val Eval.DB.__proj__App__item__a>

(push) ;; push{2

; Starting query at Eval.DB.fst(25,21-25,22)
...
; Context: While encoding a query
; While typechecking the top-level declaration `let __proj__App__item__a`
...
;; def=Eval.DB.fst(25,5-25,8); use=Eval.DB.fst(25,21-25,22)
(not 
;; def=Eval.DB.fst(25,5-25,8); use=Eval.DB.fst(25,21-25,22)
(BoxBool_proj_0 (Eval.DB.uu___is_App @x0
@x1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Eval.DB.__proj__App__item__a, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_2349da90c7b3931f487aa92691daa8cd
...
; encoding sigelt let __proj__App__item__a


; <Skipped let __proj__App__item__a/>


; encoding sigelt val Eval.DB.__proj__App__item__b


; <Start encoding val Eval.DB.__proj__App__item__b>


(declare-fun Eval.DB.__proj__App__item__b (Term Term Term) Term)


(declare-fun Eval.DB.__proj__App__item__b@tok () Term)

; </end encoding val Eval.DB.__proj__App__item__b>

(push) ;; push{2

; Starting query at Eval.DB.fst(25,31-25,32)
...
; Context: While encoding a query
; While typechecking the top-level declaration `let __proj__App__item__b`
...
;; def=Eval.DB.fst(25,5-25,8); use=Eval.DB.fst(25,31-25,32)
(not 
;; def=Eval.DB.fst(25,5-25,8); use=Eval.DB.fst(25,31-25,32)
(BoxBool_proj_0 (Eval.DB.uu___is_App @x0
@x1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Eval.DB.__proj__App__item__b, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_2349da90c7b3931f487aa92691daa8cd
...
; encoding sigelt let __proj__App__item__b


; <Skipped let __proj__App__item__b/>


; encoding sigelt val Eval.DB.__proj__App__item__e1


; <Start encoding val Eval.DB.__proj__App__item__e1>


(declare-fun Eval.DB.__proj__App__item__e1 (Term Term Term) Term)

;;;;;;;;;;;;;;;;_: projectee.a -> projectee.b
(declare-fun Tm_arrow_1b25105957abc3f03834f2e449a1b0d4 (Term Term Term) Term)
;;;;;;;;;;;;;;;;projectee: _: tm _ _ {App? _} -> tm projectee.g (_: projectee.a -> projectee.b)
(declare-fun Tm_arrow_73dc1f1b11d555caa959def4b79532ee () Term)
(declare-fun Eval.DB.__proj__App__item__e1@tok () Term)


; </end encoding val Eval.DB.__proj__App__item__e1>

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Eval.DB.__proj__App__item__g; Namespace Eval.DB
(assert (! 
;; def=Eval.DB.fst(25,11-25,12); use=Eval.DB.fst(25,11-25,12)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
...
(Tm_refine_2349da90c7b3931f487aa92691daa8cd @x0
@x1)))
(HasType (Eval.DB.__proj__App__item__g @x0
@x1
@x2)
Tm_type))
 

:pattern ((Eval.DB.__proj__App__item__g @x0
@x1
@x2))
:qid typing_Eval.DB.__proj__App__item__g))

:named typing_Eval.DB.__proj__App__item__g))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Eval.DB.__proj__App__item__a; Namespace Eval.DB
(assert (! 
;; def=Eval.DB.fst(25,21-25,22); use=Eval.DB.fst(25,21-25,22)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
...
(Tm_refine_2349da90c7b3931f487aa92691daa8cd @x0
@x1)))
(HasType (Eval.DB.__proj__App__item__a @x0
@x1
@x2)
Tm_type))
 

:pattern ((Eval.DB.__proj__App__item__a @x0
@x1
@x2))
:qid typing_Eval.DB.__proj__App__item__a))

:named typing_Eval.DB.__proj__App__item__a))
;;;;;;;;;;;;;;;;Projector equation
;;; Fact-ids: Name Eval.DB.__proj__App__item__g; Namespace Eval.DB
(assert (! 
;; def=Eval.DB.fst(25,11-25,12); use=Eval.DB.fst(25,11-25,12)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (Eval.DB.__proj__App__item__g @x0
@x1
@x2)
(Eval.DB.App_g @x2))
...
@x1
@x2))
:qid proj_equation_Eval.DB.App_g))

:named proj_equation_Eval.DB.App_g))
;;;;;;;;;;;;;;;;Projector equation
;;; Fact-ids: Name Eval.DB.__proj__App__item__a; Namespace Eval.DB
(assert (! 
;; def=Eval.DB.fst(25,21-25,22); use=Eval.DB.fst(25,21-25,22)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (Eval.DB.__proj__App__item__a @x0
@x1
@x2)
(Eval.DB.App_a @x2))
...
@x1
@x2))
:qid proj_equation_Eval.DB.App_a))

:named proj_equation_Eval.DB.App_a))
(push) ;; push{2

; Starting query at Eval.DB.fst(25,41-25,43)
...
; *)
;   (~(App? projectee) ==> Prims.l_False) /\
;   (forall (b: Type) (b: Type) (b: Type) (b: Eval.DB.tm b (_: b -> b)) (b: Eval.DB.tm b b).
;       projectee == Eval.DB.App b b b b b ==>
;       b == _ /\ b == _ /\ App? (Eval.DB.App b b b b b) /\
;       (forall (return_val: _: Eval.DB.tm _ _ {App? _}).
;           return_val == Eval.DB.App b b b b b ==>
;           (forall (any_result: Type).
;               (Eval.DB.App b b b b b).g == any_result ==>
;               b == _ /\ b == _ /\ App? (Eval.DB.App b b b b b) /\
;               (forall (_: (Eval.DB.App b b b b b).a).
;                   (*  - Subtyping check failed
;   - Expected type _: tm _ _ {App? _} got type tm g b
; *)
;                   b == _ /\ b == _ /\ App? (Eval.DB.App b b b b b)))))


; Context: While encoding a query
; While typechecking the top-level declaration `let __proj__App__item__e1`
...
;; def=Prims.fst(459,77-459,89); use=Eval.DB.fst(25,41-25,43)
(and (implies 
;; def=Eval.DB.fst(25,5-25,8); use=Eval.DB.fst(25,41-25,43)
(not 
;; def=Eval.DB.fst(25,5-25,8); use=Eval.DB.fst(25,41-25,43)
(BoxBool_proj_0 (Eval.DB.uu___is_App @x0
@x1
...
;; def=Prims.fst(413,99-413,120); use=Eval.DB.fst(25,41-25,43)
(forall ((@x3 Term))
 (! (implies (HasType @x3
Tm_type)
...
;; def=dummy(0,0-0,0); use=Eval.DB.fst(25,41-25,43)
(= @x5
@x1)
)
...
;; def=Prims.fst(356,2-356,58); use=Eval.DB.fst(25,41-25,43)
(forall ((@x8 Term))
 (! (implies (and (HasType @x8
(Tm_refine_2349da90c7b3931f487aa92691daa8cd @x0
@x1))

;; def=Prims.fst(356,26-356,41); use=Eval.DB.fst(25,41-25,43)
(= @x8
(Eval.DB.App @x3
@x4
@x5
...
;; def=Prims.fst(451,66-451,102); use=Eval.DB.fst(25,41-25,43)
(forall ((@x9 Term))
 (! (implies (and (HasType @x9
Tm_type)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Eval.DB.__proj__App__item__e1, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, data_elim_Eval.DB.App, refinement_interpretation_Tm_refine_2349da90c7b3931f487aa92691daa8cd
...
; encoding sigelt let __proj__App__item__e1


; <Skipped let __proj__App__item__e1/>


; encoding sigelt val Eval.DB.__proj__App__item__e2


; <Start encoding val Eval.DB.__proj__App__item__e2>


(declare-fun Eval.DB.__proj__App__item__e2 (Term Term Term) Term)

;;;;;;;;;;;;;;;;projectee: _: tm _ _ {App? _} -> tm projectee.g projectee.a
(declare-fun Tm_arrow_484f870d6c14f5b081476328bda14b20 () Term)
(declare-fun Eval.DB.__proj__App__item__e2@tok () Term)

; </end encoding val Eval.DB.__proj__App__item__e2>

(push) ;; push{2

; Starting query at Eval.DB.fst(25,65-25,67)
...
; Context: While encoding a query
; While typechecking the top-level declaration `let __proj__App__item__e2`
...
;; def=Prims.fst(459,77-459,89); use=Eval.DB.fst(25,65-25,67)
(and (implies 
;; def=Eval.DB.fst(25,5-25,8); use=Eval.DB.fst(25,65-25,67)
(not 
;; def=Eval.DB.fst(25,5-25,8); use=Eval.DB.fst(25,65-25,67)
(BoxBool_proj_0 (Eval.DB.uu___is_App @x0
@x1
...
;; def=Prims.fst(413,99-413,120); use=Eval.DB.fst(25,65-25,67)
(forall ((@x3 Term))
 (! (implies (HasType @x3
Tm_type)
...
;; def=dummy(0,0-0,0); use=Eval.DB.fst(25,65-25,67)
(= @x5
@x1)
)
...
;; def=Prims.fst(356,2-356,58); use=Eval.DB.fst(25,65-25,67)
(forall ((@x8 Term))
 (! (implies (and (HasType @x8
(Tm_refine_2349da90c7b3931f487aa92691daa8cd @x0
@x1))

;; def=Prims.fst(356,26-356,41); use=Eval.DB.fst(25,65-25,67)
(= @x8
(Eval.DB.App @x3
@x4
@x5
...
;; def=Prims.fst(451,66-451,102); use=Eval.DB.fst(25,65-25,67)
(forall ((@x9 Term))
 (! (implies (and (HasType @x9
Tm_type)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Eval.DB.__proj__App__item__e2, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, data_elim_Eval.DB.App, refinement_interpretation_Tm_refine_2349da90c7b3931f487aa92691daa8cd
...
; encoding sigelt let __proj__App__item__e2


; <Skipped let __proj__App__item__e2/>


; encoding sigelt val Eval.DB.eval_var


; <Skipped val Eval.DB.eval_var/>
...
; Starting query at Eval.DB.fst(28,43-30,62)
...
;;;;;;;;;;;;;;;;v : Eval.DB.var g a (Eval.DB.var g a)
(declare-fun x_04eaea7bd4f83bcbe98e3ee87b22ddff_4 () Term)
;;;;;;;;;;;;;;;;binder_x_04eaea7bd4f83bcbe98e3ee87b22ddff_4
;;; Fact-ids: 
(assert (! (HasType x_04eaea7bd4f83bcbe98e3ee87b22ddff_4
(Eval.DB.var x_fe28d8bcde588226b4e538b35321de05_2
x_fe28d8bcde588226b4e538b35321de05_3))
:named binder_x_04eaea7bd4f83bcbe98e3ee87b22ddff_4))
;;;;;;;;;;;;;;;;env : g (g)
(declare-fun x_64a6f2da4341770a4dee8aa1d0d4ae69_5 () Term)
;;;;;;;;;;;;;;;;binder_x_64a6f2da4341770a4dee8aa1d0d4ae69_5
;;; Fact-ids: 
(assert (! (HasType x_64a6f2da4341770a4dee8aa1d0d4ae69_5
x_fe28d8bcde588226b4e538b35321de05_2)
:named binder_x_64a6f2da4341770a4dee8aa1d0d4ae69_5))
(declare-fun Tm_refine_dacb92b6b05d293c478445a46e529c32 (Term Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=Eval.DB.fst(28,35-30,62); use=Eval.DB.fst(28,35-30,62)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (HasType (Tm_refine_dacb92b6b05d293c478445a46e529c32 @x0
@x1
@x2)
Tm_type)
 

:pattern ((HasType (Tm_refine_dacb92b6b05d293c478445a46e529c32 @x0
@x1
@x2)
Tm_type))
:qid refinement_kinding_Tm_refine_dacb92b6b05d293c478445a46e529c32))

:named refinement_kinding_Tm_refine_dacb92b6b05d293c478445a46e529c32))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Eval.DB.fst(28,35-30,62); use=Eval.DB.fst(28,35-30,62)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_dacb92b6b05d293c478445a46e529c32 @x2
@x3
@x4))
(and (HasTypeFuel @u0
@x1
...
;; def=Eval.DB.fst(28,35-30,62); use=Eval.DB.fst(28,35-30,62)
(or 
;; def=Eval.DB.fst(28,43-30,62); use=Eval.DB.fst(28,43-30,62)
(Valid 
;; def=Eval.DB.fst(28,43-30,62); use=Eval.DB.fst(28,43-30,62)
(Prims.precedes (Eval.DB.var @x2
@x3)
(Eval.DB.var x_fe28d8bcde588226b4e538b35321de05_2
x_fe28d8bcde588226b4e538b35321de05_3)
@x4
x_04eaea7bd4f83bcbe98e3ee87b22ddff_4)
)


;; def=Eval.DB.fst(28,35-30,62); use=Eval.DB.fst(28,35-30,62)
(and 
;; def=Eval.DB.fst(28,35-28,36); use=Eval.DB.fst(28,35-28,36)
(Valid 
;; def=Eval.DB.fst(28,35-28,36); use=Eval.DB.fst(28,35-28,36)
(Prims.op_Equals_Equals_Equals (Eval.DB.var @x2
@x3)
(Eval.DB.var x_fe28d8bcde588226b4e538b35321de05_2
x_fe28d8bcde588226b4e538b35321de05_3)
@x4
...
x_fe28d8bcde588226b4e538b35321de05_2
@x1
x_64a6f2da4341770a4dee8aa1d0d4ae69_5)
)
)
)
...
@x3
@x4)))
:qid refinement_interpretation_Tm_refine_dacb92b6b05d293c478445a46e529c32))

:named refinement_interpretation_Tm_refine_dacb92b6b05d293c478445a46e529c32))
;;;;;;;;;;;;;;;;haseq for Tm_refine_dacb92b6b05d293c478445a46e529c32
;;; Fact-ids: 
(assert (! 
;; def=Eval.DB.fst(28,35-30,62); use=Eval.DB.fst(28,35-30,62)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_dacb92b6b05d293c478445a46e529c32 @x0
@x1
@x2)))
(Valid (Prims.hasEq @x0)))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_dacb92b6b05d293c478445a46e529c32 @x0
@x1
@x2))))
:qid haseqTm_refine_dacb92b6b05d293c478445a46e529c32))

:named haseqTm_refine_dacb92b6b05d293c478445a46e529c32))
(declare-fun Eval.DB.eval_var (Term Term Term Term) Term)

;;;;;;;;;;;;;;;;g: Type -> a: Type -> _: var g a -> _: _: g{_ << v \/ _ === v /\ _ << env} -> a
(declare-fun Tm_arrow_0023f2e7436e8bea4dc53e1013039b02 () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_0023f2e7436e8bea4dc53e1013039b02
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_0023f2e7436e8bea4dc53e1013039b02
Tm_type)
:named kinding_Tm_arrow_0023f2e7436e8bea4dc53e1013039b02))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=Eval.DB.fst(27,17-30,62); use=Eval.DB.fst(27,55-30,62)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_0023f2e7436e8bea4dc53e1013039b02)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_0023f2e7436e8bea4dc53e1013039b02))
:qid Eval.DB_pre_typing_Tm_arrow_0023f2e7436e8bea4dc53e1013039b02))

:named Eval.DB_pre_typing_Tm_arrow_0023f2e7436e8bea4dc53e1013039b02))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_0023f2e7436e8bea4dc53e1013039b02
;;; Fact-ids: 
(assert (! 
;; def=Eval.DB.fst(27,17-30,62); use=Eval.DB.fst(27,55-30,62)
(forall ((@x0 Term))
...
@x2))
(HasType @x4
(Tm_refine_dacb92b6b05d293c478445a46e529c32 @x1
@x2
@x3)))
...
@x3)
@x4))
:qid Eval.DB_interpretation_Tm_arrow_0023f2e7436e8bea4dc53e1013039b02.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid Eval.DB_interpretation_Tm_arrow_0023f2e7436e8bea4dc53e1013039b02.2))
...
@x1)
@x2))
:qid Eval.DB_interpretation_Tm_arrow_0023f2e7436e8bea4dc53e1013039b02.3))
...
@x2)
@x3))
:qid Eval.DB_interpretation_Tm_arrow_0023f2e7436e8bea4dc53e1013039b02.4))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_0023f2e7436e8bea4dc53e1013039b02))
:qid Eval.DB_interpretation_Tm_arrow_0023f2e7436e8bea4dc53e1013039b02))

:named Eval.DB_interpretation_Tm_arrow_0023f2e7436e8bea4dc53e1013039b02))
(declare-fun Eval.DB.eval_var@tok () Term)
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: 
(assert (! 
;; def=Eval.DB.fst(28,8-28,16); use=Eval.DB.fst(28,8-28,16)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (ApplyTT (ApplyTT (ApplyTT (ApplyTT Eval.DB.eval_var@tok
@x0)
@x1)
@x2)
@x3)
...
:pattern ((ApplyTT (ApplyTT (ApplyTT (ApplyTT Eval.DB.eval_var@tok
@x0)
@x1)
@x2)
@x3))
:qid token_correspondence_Eval.DB.eval_var))

:named token_correspondence_Eval.DB.eval_var))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: 
(assert (! 
;; def=Eval.DB.fst(28,8-28,16); use=Eval.DB.fst(28,8-28,16)
...
:pattern ((Eval.DB.eval_var @x1
@x2
@x3
@x4))
:qid function_token_typing_Eval.DB.eval_var.1))
)
 

:pattern ((ApplyTT @x0
Eval.DB.eval_var@tok))
:qid function_token_typing_Eval.DB.eval_var))

:named function_token_typing_Eval.DB.eval_var))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: 
(assert (! 
;; def=Eval.DB.fst(28,8-28,16); use=Eval.DB.fst(28,8-28,16)
...
@x1))
(HasType @x3
(Tm_refine_dacb92b6b05d293c478445a46e529c32 @x0
@x1
@x2)))
(HasType (Eval.DB.eval_var @x0
@x1
@x2
@x3)
@x1))
...
:pattern ((Eval.DB.eval_var @x0
@x1
@x2
@x3))
:qid typing_Eval.DB.eval_var))

:named typing_Eval.DB.eval_var))
(declare-fun label_5 () Bool)
(declare-fun label_4 () Bool)
(declare-fun label_3 () Bool)
(declare-fun label_2 () Bool)
...
;   (~(O? v) /\ ~(S? v) ==> Prims.l_False) /\
;   (forall (b: Type) (b: Type). v == Eval.DB.O b b ==> Prims.has_type env (b & a)) /\
;   (~(O? v) ==>
;     (forall (b: Type) (b: Type) (b: Type) (b: Eval.DB.var b b).
;         v == Eval.DB.S b b b b ==>
;         Prims.has_type env (b & b) /\
;         (forall (any_result: g).
;             env == any_result ==>
;             (forall (any_result: b).
;                 FStar.Pervasives.Native.fst env == any_result ==>
;                 (b << v \/ b === v /\ FStar.Pervasives.Native.fst env << env) /\
;                 (forall (return_val: _: b{b << v \/ b === v /\ _ << env}).
;                     return_val == FStar.Pervasives.Native.fst env ==>
;                     FStar.Pervasives.Native.fst env == return_val ==>
;                     (forall (any_result: b).
;                         Eval.DB.eval_var b b b (FStar.Pervasives.Native.fst env) == any_result ==>
;                         Prims.has_type (Eval.DB.eval_var b b b (FStar.Pervasives.Native.fst env)) a)
;                 )))))


; Context: While encoding a query
; While typechecking the top-level declaration `let rec eval_var`
...
;; def=Prims.fst(402,27-402,88); use=Eval.DB.fst(28,43-30,62)
(forall ((@x1 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=Eval.DB.fst(28,43-30,62)
(Valid 
;; def=Prims.fst(402,84-402,87); use=Eval.DB.fst(28,43-30,62)
(ApplyTT @x0
@x1)
...
;; def=Prims.fst(459,77-459,89); use=Eval.DB.fst(28,43-30,62)
(and (implies 
;; def=Eval.DB.fst(28,35-28,36); use=Eval.DB.fst(28,49-28,50)
(and 
;; def=Eval.DB.fst(28,35-28,36); use=Eval.DB.fst(28,49-28,50)
(not 
;; def=Eval.DB.fst(28,35-28,36); use=Eval.DB.fst(28,49-28,50)
(BoxBool_proj_0 (Eval.DB.uu___is_O x_fe28d8bcde588226b4e538b35321de05_2
x_fe28d8bcde588226b4e538b35321de05_3
x_04eaea7bd4f83bcbe98e3ee87b22ddff_4))
)
...
(not 
;; def=Eval.DB.fst(28,35-28,36); use=Eval.DB.fst(28,49-28,50)
(BoxBool_proj_0 (Eval.DB.uu___is_S x_fe28d8bcde588226b4e538b35321de05_2
x_fe28d8bcde588226b4e538b35321de05_3
x_04eaea7bd4f83bcbe98e3ee87b22ddff_4))
)
)
...
;; def=Prims.fst(413,99-413,120); use=Eval.DB.fst(28,43-30,62)
(forall ((@x1 Term))
 (! (implies (HasType @x1
Tm_type)
...
;; def=Eval.DB.fst(28,35-29,13); use=Eval.DB.fst(28,49-29,13)
(= x_04eaea7bd4f83bcbe98e3ee87b22ddff_4
(Eval.DB.O @x1
@x2))
)

;; def=Eval.DB.fst(28,37-28,40); use=Eval.DB.fst(29,29-29,32)
(or label_2
(HasType x_64a6f2da4341770a4dee8aa1d0d4ae69_5
(FStar.Pervasives.Native.tuple2 @x1
x_fe28d8bcde588226b4e538b35321de05_3)))
)
...
(implies 
;; def=Prims.fst(389,19-389,21); use=Eval.DB.fst(28,43-30,62)
(not 
;; def=Eval.DB.fst(28,35-28,36); use=Eval.DB.fst(28,49-28,50)
(BoxBool_proj_0 (Eval.DB.uu___is_O x_fe28d8bcde588226b4e538b35321de05_2
x_fe28d8bcde588226b4e538b35321de05_3
...
;; def=Eval.DB.fst(28,35-30,20); use=Eval.DB.fst(28,49-30,20)
(= x_04eaea7bd4f83bcbe98e3ee87b22ddff_4
(Eval.DB.S @x1
@x2
@x3
...
;; def=Prims.fst(459,77-459,89); use=Eval.DB.fst(28,43-30,62)
(and 
;; def=Eval.DB.fst(28,37-28,40); use=Eval.DB.fst(30,58-30,61)
(or label_3
(HasType x_64a6f2da4341770a4dee8aa1d0d4ae69_5
(FStar.Pervasives.Native.tuple2 @x1
@x3)))
...
;; def=Prims.fst(451,66-451,102); use=Eval.DB.fst(28,43-30,62)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
x_fe28d8bcde588226b4e538b35321de05_2)

;; def=FStar.Pervasives.Native.fst(62,9-62,10); use=Eval.DB.fst(28,43-30,62)
(= x_64a6f2da4341770a4dee8aa1d0d4ae69_5
@x5)
)
...
;; def=Eval.DB.fst(28,35-30,62); use=Eval.DB.fst(28,43-30,62)
...
;; def=Prims.fst(459,77-459,89); use=Eval.DB.fst(28,43-30,62)
(and 
;; def=Eval.DB.fst(28,35-30,62); use=Eval.DB.fst(30,43-30,62)
(or label_4

;; def=Eval.DB.fst(28,43-30,62); use=Eval.DB.fst(30,43-30,62)
(Valid 
;; def=Eval.DB.fst(28,43-30,62); use=Eval.DB.fst(30,43-30,62)
(Prims.precedes (Eval.DB.var @x1
@x2)
(Eval.DB.var x_fe28d8bcde588226b4e538b35321de05_2
x_fe28d8bcde588226b4e538b35321de05_3)
@x4
...
;; def=Eval.DB.fst(28,35-30,62); use=Eval.DB.fst(30,43-30,62)
(and 
;; def=Eval.DB.fst(28,35-28,36); use=Eval.DB.fst(30,43-30,62)
(Valid 
;; def=Eval.DB.fst(28,35-28,36); use=Eval.DB.fst(30,43-30,62)
(Prims.op_Equals_Equals_Equals (Eval.DB.var @x1
@x2)
(Eval.DB.var x_fe28d8bcde588226b4e538b35321de05_2
x_fe28d8bcde588226b4e538b35321de05_3)
@x4
...
;; def=Prims.fst(356,2-356,58); use=Eval.DB.fst(28,43-30,62)
(forall ((@x7 Term))
 (! (implies (and (HasType @x7
(Tm_refine_dacb92b6b05d293c478445a46e529c32 @x1
@x2
...
;; def=Prims.fst(356,26-356,41); use=Eval.DB.fst(28,43-30,62)
(= @x7
(FStar.Pervasives.Native.fst @x1
@x3
x_64a6f2da4341770a4dee8aa1d0d4ae69_5))
...
;; def=dummy(0,0-0,0); use=Eval.DB.fst(28,43-30,62)
(= (FStar.Pervasives.Native.fst @x1
@x3
x_64a6f2da4341770a4dee8aa1d0d4ae69_5)
@x7)
...
;; def=Eval.DB.fst(28,27-30,62); use=Eval.DB.fst(28,43-30,62)
(= (Eval.DB.eval_var @x1
@x2
@x4
(FStar.Pervasives.Native.fst @x1
...
;; def=Eval.DB.fst(30,24-30,62); use=Eval.DB.fst(30,24-30,62)
(or label_5
(HasType (Eval.DB.eval_var @x1
@x2
@x4
(FStar.Pervasives.Native.fst @x1
@x3
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Eval.DB.eval_var, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, binder_x_04eaea7bd4f83bcbe98e3ee87b22ddff_4, binder_x_64a6f2da4341770a4dee8aa1d0d4ae69_5, data_elim_Eval.DB.O, data_elim_Eval.DB.S, disc_equation_Eval.DB.O, disc_equation_Eval.DB.S, fuel_guarded_inversion_Eval.DB.var, projection_inverse_BoxBool_proj_0, subterm_ordering_Eval.DB.S
...
; encoding sigelt let rec eval_var


; <Start encoding let rec eval_var>

;;;;;;;;;;;;;;;;Fuel-instrumented function name
(declare-fun Eval.DB.eval_var.fuel_instrumented (Fuel Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Token for fuel-instrumented partial applications
(declare-fun Eval.DB.eval_var.fuel_instrumented_token () Term)
(declare-fun Eval.DB.eval_var (Term Term Term Term) Term)
(declare-fun Eval.DB.eval_var@tok () Term)
;;;;;;;;;;;;;;;;g: Type -> a: Type -> v: var g a -> env: g -> a
(declare-fun Tm_arrow_6e91bf74935297b98bc1e26fdce1fff5 () Term)

; </end encoding let rec eval_var>


; encoding sigelt val Eval.DB.eval


; <Skipped val Eval.DB.eval/>

(push) ;; push{2

; Starting query at Eval.DB.fst(33,39-39,24)
...
Tm_type)
:named binder_x_fe28d8bcde588226b4e538b35321de05_2))
;;;;;;;;;;;;;;;;t : Eval.DB.tm g a (Eval.DB.tm g a)
(declare-fun x_469181b3de8c335ece34fd70f472f78d_3 () Term)
;;;;;;;;;;;;;;;;binder_x_469181b3de8c335ece34fd70f472f78d_3
;;; Fact-ids: 
(assert (! (HasType x_469181b3de8c335ece34fd70f472f78d_3
(Eval.DB.tm x_fe28d8bcde588226b4e538b35321de05_1
x_fe28d8bcde588226b4e538b35321de05_2))
:named binder_x_469181b3de8c335ece34fd70f472f78d_3))
;;;;;;;;;;;;;;;;env : g (g)
...
(declare-fun Tm_refine_38d2b6782b747f8ad96b3c232e02b6cc (Term Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=Eval.DB.fst(33,31-39,24); use=Eval.DB.fst(33,31-39,24)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (HasType (Tm_refine_38d2b6782b747f8ad96b3c232e02b6cc @x0
@x1
@x2)
Tm_type)
 

:pattern ((HasType (Tm_refine_38d2b6782b747f8ad96b3c232e02b6cc @x0
@x1
@x2)
Tm_type))
:qid refinement_kinding_Tm_refine_38d2b6782b747f8ad96b3c232e02b6cc))

:named refinement_kinding_Tm_refine_38d2b6782b747f8ad96b3c232e02b6cc))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Eval.DB.fst(33,31-39,24); use=Eval.DB.fst(33,31-39,24)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_38d2b6782b747f8ad96b3c232e02b6cc @x2
@x3
@x4))
(and (HasTypeFuel @u0
@x1
...
;; def=Eval.DB.fst(33,31-39,24); use=Eval.DB.fst(33,31-39,24)
(or 
;; def=Eval.DB.fst(33,39-39,24); use=Eval.DB.fst(33,39-39,24)
(Valid 
;; def=Eval.DB.fst(33,39-39,24); use=Eval.DB.fst(33,39-39,24)
(Prims.precedes (Eval.DB.tm @x2
@x3)
(Eval.DB.tm x_fe28d8bcde588226b4e538b35321de05_1
x_fe28d8bcde588226b4e538b35321de05_2)
@x4
x_469181b3de8c335ece34fd70f472f78d_3)
)


;; def=Eval.DB.fst(33,31-39,24); use=Eval.DB.fst(33,31-39,24)
(and 
;; def=Eval.DB.fst(33,31-33,32); use=Eval.DB.fst(33,31-33,32)
(Valid 
;; def=Eval.DB.fst(33,31-33,32); use=Eval.DB.fst(33,31-33,32)
(Prims.op_Equals_Equals_Equals (Eval.DB.tm @x2
@x3)
(Eval.DB.tm x_fe28d8bcde588226b4e538b35321de05_1
x_fe28d8bcde588226b4e538b35321de05_2)
@x4
...
@x3
@x4)))
:qid refinement_interpretation_Tm_refine_38d2b6782b747f8ad96b3c232e02b6cc))

:named refinement_interpretation_Tm_refine_38d2b6782b747f8ad96b3c232e02b6cc))
;;;;;;;;;;;;;;;;haseq for Tm_refine_38d2b6782b747f8ad96b3c232e02b6cc
;;; Fact-ids: 
(assert (! 
;; def=Eval.DB.fst(33,31-39,24); use=Eval.DB.fst(33,31-39,24)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_38d2b6782b747f8ad96b3c232e02b6cc @x0
@x1
@x2)))
(Valid (Prims.hasEq @x0)))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_38d2b6782b747f8ad96b3c232e02b6cc @x0
@x1
@x2))))
:qid haseqTm_refine_38d2b6782b747f8ad96b3c232e02b6cc))

:named haseqTm_refine_38d2b6782b747f8ad96b3c232e02b6cc))
(declare-fun Eval.DB.eval (Term Term Term Term) Term)

;;;;;;;;;;;;;;;;g: Type -> a: Type -> _: tm g a -> _: _: g{_ << t \/ _ === t /\ _ << env} -> a
(declare-fun Tm_arrow_681ca220d568fc1bf580a813b21520d2 () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_681ca220d568fc1bf580a813b21520d2
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_681ca220d568fc1bf580a813b21520d2
Tm_type)
:named kinding_Tm_arrow_681ca220d568fc1bf580a813b21520d2))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=Eval.DB.fst(32,12-39,24); use=Eval.DB.fst(32,49-39,24)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_681ca220d568fc1bf580a813b21520d2)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_681ca220d568fc1bf580a813b21520d2))
:qid Eval.DB_pre_typing_Tm_arrow_681ca220d568fc1bf580a813b21520d2))

:named Eval.DB_pre_typing_Tm_arrow_681ca220d568fc1bf580a813b21520d2))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_681ca220d568fc1bf580a813b21520d2
;;; Fact-ids: 
(assert (! 
;; def=Eval.DB.fst(32,12-39,24); use=Eval.DB.fst(32,49-39,24)
(forall ((@x0 Term))
...
@x2))
(HasType @x4
(Tm_refine_38d2b6782b747f8ad96b3c232e02b6cc @x1
@x2
@x3)))
(HasType (ApplyTT (ApplyTT (ApplyTT (ApplyTT @x0
@x1)
...
@x3)
@x4))
:qid Eval.DB_interpretation_Tm_arrow_681ca220d568fc1bf580a813b21520d2.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid Eval.DB_interpretation_Tm_arrow_681ca220d568fc1bf580a813b21520d2.2))
...
@x1)
@x2))
:qid Eval.DB_interpretation_Tm_arrow_681ca220d568fc1bf580a813b21520d2.3))
...
@x2)
@x3))
:qid Eval.DB_interpretation_Tm_arrow_681ca220d568fc1bf580a813b21520d2.4))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_681ca220d568fc1bf580a813b21520d2))
:qid Eval.DB_interpretation_Tm_arrow_681ca220d568fc1bf580a813b21520d2))

:named Eval.DB_interpretation_Tm_arrow_681ca220d568fc1bf580a813b21520d2))
(declare-fun Eval.DB.eval@tok () Term)
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: 
(assert (! 
;; def=Eval.DB.fst(33,8-33,12); use=Eval.DB.fst(33,8-33,12)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (ApplyTT (ApplyTT (ApplyTT (ApplyTT Eval.DB.eval@tok
@x0)
@x1)
@x2)
@x3)
...
:pattern ((ApplyTT (ApplyTT (ApplyTT (ApplyTT Eval.DB.eval@tok
@x0)
@x1)
@x2)
@x3))
:qid token_correspondence_Eval.DB.eval))

:named token_correspondence_Eval.DB.eval))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: 
(assert (! 
;; def=Eval.DB.fst(33,8-33,12); use=Eval.DB.fst(33,8-33,12)
...
:pattern ((Eval.DB.eval @x1
@x2
@x3
@x4))
:qid function_token_typing_Eval.DB.eval.1))
)
 

:pattern ((ApplyTT @x0
Eval.DB.eval@tok))
:qid function_token_typing_Eval.DB.eval))

:named function_token_typing_Eval.DB.eval))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: 
(assert (! 
;; def=Eval.DB.fst(33,8-33,12); use=Eval.DB.fst(33,8-33,12)
...
@x1))
(HasType @x3
(Tm_refine_38d2b6782b747f8ad96b3c232e02b6cc @x0
@x1
@x2)))
(HasType (Eval.DB.eval @x0
@x1
@x2
@x3)
@x1))
...
:pattern ((Eval.DB.eval @x0
@x1
@x2
@x3))
:qid typing_Eval.DB.eval))

:named typing_Eval.DB.eval))
...
(declare-fun Tm_abs_c20f56d85af2ce8374268dea0663a5c9 (Term Term Term) Term)
;;;;;;;;;;;;;;;;typing_Tm_abs_c20f56d85af2ce8374268dea0663a5c9
;;; Fact-ids: 
(assert (! 
;; def=Eval.DB.fst(36,21-36,54); use=Eval.DB.fst(36,21-36,54)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (HasType (Tm_abs_c20f56d85af2ce8374268dea0663a5c9 @x0
@x1
@x2)
(Tm_arrow_6980332764c4493a7b0df5c02f7aefbe @x1
@x2))
...
:pattern ((Tm_abs_c20f56d85af2ce8374268dea0663a5c9 @x0
@x1
@x2))
:qid typing_Tm_abs_c20f56d85af2ce8374268dea0663a5c9))

:named typing_Tm_abs_c20f56d85af2ce8374268dea0663a5c9))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_c20f56d85af2ce8374268dea0663a5c9
;;; Fact-ids: 
(assert (! 
;; def=Eval.DB.fst(36,21-36,54); use=Eval.DB.fst(36,21-36,54)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (ApplyTT (Tm_abs_c20f56d85af2ce8374268dea0663a5c9 @x1
@x2
@x3)
@x0)
(Eval.DB.eval (FStar.Pervasives.Native.tuple2 x_fe28d8bcde588226b4e538b35321de05_1
@x3)
@x2
@x1
(FStar.Pervasives.Native.Mktuple2 x_fe28d8bcde588226b4e538b35321de05_1
@x3
x_e09860b75d8922ab497a3e5bc9347578_4
@x0)))
 

:pattern ((ApplyTT (Tm_abs_c20f56d85af2ce8374268dea0663a5c9 @x1
@x2
@x3)
@x0))
:qid interpretation_Tm_abs_c20f56d85af2ce8374268dea0663a5c9))

:named interpretation_Tm_abs_c20f56d85af2ce8374268dea0663a5c9))
...
Eval.DB.eval@tok))
:named @kick_partial_app_e0a68dfac86e324468935b19f16ada16))



; Encoding query formula : forall (k: Prims.pure_post a).
;   (forall (x: a). {:pattern Prims.guard_free (k x)} Prims.auto_squash (k x)) ==>
;   (~(Var? t) /\ ~(Lam? t) /\ ~(App? t) ==> Prims.l_False) /\
;   (forall (b: Type) (b: Type) (b: Eval.DB.var b b). t == Eval.DB.Var b b b ==> b == a /\ b == g) /\
;   (~(Var? t) ==>
;     (forall (b: Type) (b: Type) (b: Type) (b: Eval.DB.tm (b & b) b).
;         t == Eval.DB.Lam b b b b ==>
;         (forall (x: b).
;             (*  - Could not prove post-condition
; *)
;             b == g /\
;             (forall (any_result: Eval.DB.tm (b & b) b).
;                 b == any_result ==> b << t \/ b === t /\ (env, x) << env)) /\
;         Prims.has_type (fun x -> Eval.DB.eval (g & b) b b (env, x)) a) /\
;     (~(Lam? t) ==>
;       (forall (b: Type) (b: Type) (b: Type) (b: Eval.DB.tm b (_: b -> b)) (b: Eval.DB.tm b b).
;           t == Eval.DB.App b b b b b ==>
;           b == g /\
;           (forall (any_result: Eval.DB.tm b (_: b -> b)).
;               b == any_result ==>
;               (b << t \/ b === t /\ env << env) /\
;               (forall (any_result: g).
;                   env == any_result ==>
;                   (forall (any_result: (_: b -> b)).
;                       b == g /\
;                       (forall (any_result: Eval.DB.tm b b).
;                           b == any_result ==>
;                           (b << t \/ b === t /\ env << env) /\
;                           (forall (any_result: g).
;                               env == any_result ==>
;                               (forall (any_result: b).
;                                   Eval.DB.eval g b b env == any_result ==>
;                                   (forall (any_result: b).
;                                       Eval.DB.eval g (_: b -> b) b env (Eval.DB.eval g b b env) ==
;                                       any_result ==>
;                                       Prims.has_type (Eval.DB.eval g
;                                             (_: b -> b)
;                                             b
;                                             env
;                                             (Eval.DB.eval g b b env))
;                                         a))))))))))
...
;; def=Prims.fst(402,27-402,88); use=Eval.DB.fst(33,39-39,24)
(forall ((@x1 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=Eval.DB.fst(33,39-39,24)
(Valid 
;; def=Prims.fst(402,84-402,87); use=Eval.DB.fst(33,39-39,24)
(ApplyTT @x0
@x1)
...
;; def=Prims.fst(459,77-459,89); use=Eval.DB.fst(33,39-39,24)
(and (implies 
;; def=Eval.DB.fst(33,31-33,32); use=Eval.DB.fst(33,45-33,46)
(and 
;; def=Eval.DB.fst(33,31-33,32); use=Eval.DB.fst(33,45-33,46)
(not 
;; def=Eval.DB.fst(33,31-33,32); use=Eval.DB.fst(33,45-33,46)
(BoxBool_proj_0 (Eval.DB.uu___is_Var x_fe28d8bcde588226b4e538b35321de05_1
x_fe28d8bcde588226b4e538b35321de05_2
x_469181b3de8c335ece34fd70f472f78d_3))
)
...
(not 
;; def=Eval.DB.fst(33,31-33,32); use=Eval.DB.fst(33,45-33,46)
(BoxBool_proj_0 (Eval.DB.uu___is_Lam x_fe28d8bcde588226b4e538b35321de05_1
x_fe28d8bcde588226b4e538b35321de05_2
x_469181b3de8c335ece34fd70f472f78d_3))
)
...
(not 
;; def=Eval.DB.fst(33,31-33,32); use=Eval.DB.fst(33,45-33,46)
(BoxBool_proj_0 (Eval.DB.uu___is_App x_fe28d8bcde588226b4e538b35321de05_1
x_fe28d8bcde588226b4e538b35321de05_2
x_469181b3de8c335ece34fd70f472f78d_3))
)
)
...
;; def=Prims.fst(413,99-413,120); use=Eval.DB.fst(33,39-39,24)
(forall ((@x1 Term))
 (! (implies (HasType @x1
Tm_type)
...
;; def=Eval.DB.fst(33,31-34,12); use=Eval.DB.fst(33,45-34,12)
(= x_469181b3de8c335ece34fd70f472f78d_3
(Eval.DB.Var @x1
@x2
@x3))
...
;; def=dummy(0,0-0,0); use=Eval.DB.fst(34,29-34,30)
(and 
;; def=Eval.DB.fst(33,23-34,10); use=Eval.DB.fst(34,29-34,30)
(or label_2
...
;; def=Eval.DB.fst(33,14-34,8); use=Eval.DB.fst(34,29-34,30)
(or label_3
...
(implies 
;; def=Prims.fst(389,19-389,21); use=Eval.DB.fst(33,39-39,24)
(not 
;; def=Eval.DB.fst(33,31-33,32); use=Eval.DB.fst(33,45-33,46)
(BoxBool_proj_0 (Eval.DB.uu___is_Var x_fe28d8bcde588226b4e538b35321de05_1
x_fe28d8bcde588226b4e538b35321de05_2
...
;; def=Prims.fst(389,2-389,39); use=Eval.DB.fst(33,39-39,24)
(and 
;; def=Prims.fst(413,99-413,120); use=Eval.DB.fst(33,39-39,24)
(forall ((@x1 Term))
 (! (implies (HasType @x1
...
;; def=Eval.DB.fst(33,31-35,25); use=Eval.DB.fst(33,45-35,25)
(= x_469181b3de8c335ece34fd70f472f78d_3
(Eval.DB.Lam @x1
@x2
@x3
...
;; def=dummy(0,0-0,0); use=Eval.DB.fst(36,21-36,54)
(and 
;; def=dummy(0,0-0,0); use=Eval.DB.fst(33,39-39,24)
(forall ((@x5 Term))
 (! (implies (HasType @x5
@x2)

;; def=Prims.fst(459,77-459,89); use=Eval.DB.fst(36,21-36,54)
(and 
;; def=Eval.DB.fst(33,14-35,10); use=Eval.DB.fst(36,42-36,46)
(or label_4
...
;; def=Prims.fst(451,66-451,102); use=Eval.DB.fst(36,21-36,54)
(forall ((@x6 Term))
 (! (implies (and (HasType @x6
(Eval.DB.tm (FStar.Pervasives.Native.tuple2 @x1
@x2)
...
;; def=Eval.DB.fst(33,31-39,24); use=Eval.DB.fst(36,47-36,54)
(or label_5

;; def=Eval.DB.fst(33,39-39,24); use=Eval.DB.fst(36,47-36,54)
(Valid 
;; def=Eval.DB.fst(33,39-39,24); use=Eval.DB.fst(36,47-36,54)
(Prims.precedes (Eval.DB.tm (FStar.Pervasives.Native.tuple2 x_fe28d8bcde588226b4e538b35321de05_1
@x2)
@x3)
(Eval.DB.tm x_fe28d8bcde588226b4e538b35321de05_1
x_fe28d8bcde588226b4e538b35321de05_2)
...
;; def=Eval.DB.fst(33,31-39,24); use=Eval.DB.fst(36,47-36,54)
(and 
;; def=Eval.DB.fst(33,31-33,32); use=Eval.DB.fst(36,47-36,54)
(Valid 
;; def=Eval.DB.fst(33,31-33,32); use=Eval.DB.fst(36,47-36,54)
(Prims.op_Equals_Equals_Equals (Eval.DB.tm (FStar.Pervasives.Native.tuple2 x_fe28d8bcde588226b4e538b35321de05_1
@x2)
@x3)
(Eval.DB.tm x_fe28d8bcde588226b4e538b35321de05_1
x_fe28d8bcde588226b4e538b35321de05_2)
...
(Valid 
;; def=Eval.DB.fst(33,39-39,24); use=Eval.DB.fst(36,47-36,54)
(Prims.precedes (FStar.Pervasives.Native.tuple2 x_fe28d8bcde588226b4e538b35321de05_1
@x2)
x_fe28d8bcde588226b4e538b35321de05_1
(FStar.Pervasives.Native.Mktuple2 x_fe28d8bcde588226b4e538b35321de05_1
@x2
...
;; def=Eval.DB.fst(36,21-36,54); use=Eval.DB.fst(36,21-36,54)
(or label_6
(HasType (Tm_abs_c20f56d85af2ce8374268dea0663a5c9 @x4
@x3
@x2)
x_fe28d8bcde588226b4e538b35321de05_2))
)
...
;; def=Eval.DB.fst(33,31-37,26); use=Eval.DB.fst(33,45-37,26)
(= x_469181b3de8c335ece34fd70f472f78d_3
(Eval.DB.App @x1
@x2
@x3
...
;; def=Prims.fst(459,77-459,89); use=Eval.DB.fst(33,39-39,24)
(and 
;; def=Eval.DB.fst(33,14-37,10); use=Eval.DB.fst(38,31-38,33)
(or label_7
...
;; def=Prims.fst(451,66-451,102); use=Eval.DB.fst(33,39-39,24)
(forall ((@x6 Term))
 (! (implies (and (HasType @x6
(Eval.DB.tm @x1
(Tm_arrow_6980332764c4493a7b0df5c02f7aefbe @x3
...
;; def=Prims.fst(459,77-459,89); use=Eval.DB.fst(33,39-39,24)
(and 
;; def=Eval.DB.fst(33,31-39,24); use=Eval.DB.fst(38,34-38,37)
(or label_8

;; def=Eval.DB.fst(33,39-39,24); use=Eval.DB.fst(38,34-38,37)
(Valid 
;; def=Eval.DB.fst(33,39-39,24); use=Eval.DB.fst(38,34-38,37)
(Prims.precedes (Eval.DB.tm x_fe28d8bcde588226b4e538b35321de05_1
(Tm_arrow_6980332764c4493a7b0df5c02f7aefbe @x3
@x2))
(Eval.DB.tm x_fe28d8bcde588226b4e538b35321de05_1
x_fe28d8bcde588226b4e538b35321de05_2)
...
;; def=Eval.DB.fst(33,31-39,24); use=Eval.DB.fst(38,34-38,37)
(and 
;; def=Eval.DB.fst(33,31-33,32); use=Eval.DB.fst(38,34-38,37)
(Valid 
;; def=Eval.DB.fst(33,31-33,32); use=Eval.DB.fst(38,34-38,37)
(Prims.op_Equals_Equals_Equals (Eval.DB.tm x_fe28d8bcde588226b4e538b35321de05_1
(Tm_arrow_6980332764c4493a7b0df5c02f7aefbe @x3
@x2))
(Eval.DB.tm x_fe28d8bcde588226b4e538b35321de05_1
x_fe28d8bcde588226b4e538b35321de05_2)
...
;; def=Prims.fst(459,77-459,89); use=Eval.DB.fst(33,39-39,24)
(and 
;; def=Eval.DB.fst(33,14-37,10); use=Eval.DB.fst(39,17-39,19)
(or label_9
...
;; def=Prims.fst(459,77-459,89); use=Eval.DB.fst(33,39-39,24)
(and 
;; def=Eval.DB.fst(33,31-39,24); use=Eval.DB.fst(39,20-39,23)
(or label_10

;; def=Eval.DB.fst(33,39-39,24); use=Eval.DB.fst(39,20-39,23)
(Valid 
;; def=Eval.DB.fst(33,39-39,24); use=Eval.DB.fst(39,20-39,23)
(Prims.precedes (Eval.DB.tm x_fe28d8bcde588226b4e538b35321de05_1
@x2)
...
;; def=Eval.DB.fst(33,31-39,24); use=Eval.DB.fst(39,20-39,23)
(and 
;; def=Eval.DB.fst(33,31-33,32); use=Eval.DB.fst(39,20-39,23)
(Valid 
;; def=Eval.DB.fst(33,31-33,32); use=Eval.DB.fst(39,20-39,23)
(Prims.op_Equals_Equals_Equals (Eval.DB.tm x_fe28d8bcde588226b4e538b35321de05_1
@x2)
...
;; def=dummy(0,0-0,0); use=Eval.DB.fst(33,39-39,24)
(= (Eval.DB.eval x_fe28d8bcde588226b4e538b35321de05_1
@x2
@x5
x_e09860b75d8922ab497a3e5bc9347578_4)
@x11)
...
;; def=Eval.DB.fst(33,23-39,24); use=Eval.DB.fst(33,39-39,24)
(= (ApplyTT (ApplyTT (ApplyTT (ApplyTT (ApplyTT Eval.DB.eval@tok
x_fe28d8bcde588226b4e538b35321de05_1)
(Tm_arrow_6980332764c4493a7b0df5c02f7aefbe @x3
@x2))
@x4)
...
;; def=Eval.DB.fst(38,4-39,24); use=Eval.DB.fst(38,4-39,24)
(or label_11
(HasType (ApplyTT (ApplyTT (ApplyTT (ApplyTT (ApplyTT Eval.DB.eval@tok
x_fe28d8bcde588226b4e538b35321de05_1)
(Tm_arrow_6980332764c4493a7b0df5c02f7aefbe @x3
@x2))
@x4)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Eval.DB.eval, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, binder_x_469181b3de8c335ece34fd70f472f78d_3, constructor_distinct_Eval.DB.App, constructor_distinct_Eval.DB.Lam, data_elim_Eval.DB.App, data_elim_Eval.DB.Lam, data_elim_Eval.DB.Var, disc_equation_Eval.DB.App, disc_equation_Eval.DB.Lam, disc_equation_Eval.DB.Var, fuel_guarded_inversion_Eval.DB.tm, projection_inverse_BoxBool_proj_0, projection_inverse_Eval.DB.App_a, projection_inverse_Eval.DB.App_b, projection_inverse_Eval.DB.App_e1, projection_inverse_Eval.DB.App_e2, projection_inverse_Eval.DB.App_g, projection_inverse_Eval.DB.Lam_a, projection_inverse_Eval.DB.Lam_b, projection_inverse_Eval.DB.Lam_g, subterm_ordering_Eval.DB.App, subterm_ordering_Eval.DB.Lam, typing_Tm_abs_c20f56d85af2ce8374268dea0663a5c9
