...
; Internals for CPS.Double


; encoding sigelt val CPS.Double.eval_cps


; <Skipped val CPS.Double.eval_cps/>
...
; Starting query at CPS.Double.fst(22,2-24,79)
...
;;; Fact-ids: 
(assert (! 
;; def=CPS.Double.fst(20,24-21,18); use=CPS.Double.fst(21,8-21,18)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
...
@x1
Tm_arrow_094ce55a57888abb184d0bc2fc7e0d5b))
:qid CPS.Double_pre_typing_Tm_arrow_094ce55a57888abb184d0bc2fc7e0d5b))

:named CPS.Double_pre_typing_Tm_arrow_094ce55a57888abb184d0bc2fc7e0d5b))
...
:pattern ((ApplyTT @x0
@x1))
:qid CPS.Double_interpretation_Tm_arrow_094ce55a57888abb184d0bc2fc7e0d5b.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_094ce55a57888abb184d0bc2fc7e0d5b))
:qid CPS.Double_interpretation_Tm_arrow_094ce55a57888abb184d0bc2fc7e0d5b))

:named CPS.Double_interpretation_Tm_arrow_094ce55a57888abb184d0bc2fc7e0d5b))
...
;;; Fact-ids: 
(assert (! 
;; def=CPS.Double.fst(20,24-20,37); use=CPS.Double.fst(20,35-21,16)
(forall ((@x0 Term))
...
@x1
(Tm_arrow_8928427c3e013c0cd8946aaaf1c65a29 @x2)))
:qid CPS.Double_pre_typing_Tm_arrow_8928427c3e013c0cd8946aaaf1c65a29))

:named CPS.Double_pre_typing_Tm_arrow_8928427c3e013c0cd8946aaaf1c65a29))
...
:pattern ((ApplyTT @x0
@x2))
:qid CPS.Double_interpretation_Tm_arrow_8928427c3e013c0cd8946aaaf1c65a29.1))
...
:pattern ((HasTypeZ @x0
(Tm_arrow_8928427c3e013c0cd8946aaaf1c65a29 @x1)))
:qid CPS.Double_interpretation_Tm_arrow_8928427c3e013c0cd8946aaaf1c65a29))

:named CPS.Double_interpretation_Tm_arrow_8928427c3e013c0cd8946aaaf1c65a29))
(declare-fun Tm_refine_00be7588dd5c1bf1e1aae3d0ea823bed (Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=CPS.Double.fst(22,2-24,79); use=CPS.Double.fst(22,2-24,79)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_refine_00be7588dd5c1bf1e1aae3d0ea823bed @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_refine_00be7588dd5c1bf1e1aae3d0ea823bed @x0
@x1)
Tm_type))
:qid refinement_kinding_Tm_refine_00be7588dd5c1bf1e1aae3d0ea823bed))

:named refinement_kinding_Tm_refine_00be7588dd5c1bf1e1aae3d0ea823bed))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=CPS.Double.fst(22,2-24,79); use=CPS.Double.fst(22,2-24,79)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_00be7588dd5c1bf1e1aae3d0ea823bed @x2
@x3))
(and (HasTypeFuel @u0
@x1
(Tm_arrow_8928427c3e013c0cd8946aaaf1c65a29 @x2))
...
(Tm_refine_00be7588dd5c1bf1e1aae3d0ea823bed @x2
@x3)))
:qid refinement_interpretation_Tm_refine_00be7588dd5c1bf1e1aae3d0ea823bed))

:named refinement_interpretation_Tm_refine_00be7588dd5c1bf1e1aae3d0ea823bed))
;;;;;;;;;;;;;;;;haseq for Tm_refine_00be7588dd5c1bf1e1aae3d0ea823bed
;;; Fact-ids: 
(assert (! 
;; def=CPS.Double.fst(22,2-24,79); use=CPS.Double.fst(22,2-24,79)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_00be7588dd5c1bf1e1aae3d0ea823bed @x0
@x1)))
(Valid (Prims.hasEq (Tm_arrow_8928427c3e013c0cd8946aaaf1c65a29 @x0))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_00be7588dd5c1bf1e1aae3d0ea823bed @x0
@x1))))
:qid haseqTm_refine_00be7588dd5c1bf1e1aae3d0ea823bed))

:named haseqTm_refine_00be7588dd5c1bf1e1aae3d0ea823bed))
(declare-fun CPS.Double.eval_cps (Term Term Term) Term)


;;;;;;;;;;;;;;;;_: CPS.Expr.expr -> _: _: (_: Prims.int -> 'a){_ << e} -> 'a
(declare-fun Tm_arrow_7bdef5ad90906bca58a14be5498f3704 () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_7bdef5ad90906bca58a14be5498f3704
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_7bdef5ad90906bca58a14be5498f3704
Tm_type)
:named kinding_Tm_arrow_7bdef5ad90906bca58a14be5498f3704))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=CPS.Double.fst(20,15-24,79); use=CPS.Double.fst(20,46-24,79)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_7bdef5ad90906bca58a14be5498f3704)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_7bdef5ad90906bca58a14be5498f3704))
:qid CPS.Double_pre_typing_Tm_arrow_7bdef5ad90906bca58a14be5498f3704))

:named CPS.Double_pre_typing_Tm_arrow_7bdef5ad90906bca58a14be5498f3704))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_7bdef5ad90906bca58a14be5498f3704
;;; Fact-ids: 
(assert (! 
;; def=CPS.Double.fst(20,15-24,79); use=CPS.Double.fst(20,46-24,79)
(forall ((@x0 Term))
...
CPS.Expr.expr)
(HasType @x3
(Tm_refine_00be7588dd5c1bf1e1aae3d0ea823bed @x1
@x2)))
...
@x2)
@x3))
:qid CPS.Double_interpretation_Tm_arrow_7bdef5ad90906bca58a14be5498f3704.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid CPS.Double_interpretation_Tm_arrow_7bdef5ad90906bca58a14be5498f3704.2))
...
@x1)
@x2))
:qid CPS.Double_interpretation_Tm_arrow_7bdef5ad90906bca58a14be5498f3704.3))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_7bdef5ad90906bca58a14be5498f3704))
:qid CPS.Double_interpretation_Tm_arrow_7bdef5ad90906bca58a14be5498f3704))

:named CPS.Double_interpretation_Tm_arrow_7bdef5ad90906bca58a14be5498f3704))
(declare-fun CPS.Double.eval_cps@tok () Term)
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: 
(assert (! 
;; def=CPS.Double.fst(21,8-21,16); use=CPS.Double.fst(21,8-21,16)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (ApplyTT (ApplyTT (ApplyTT CPS.Double.eval_cps@tok
@x0)
@x1)
@x2)
(CPS.Double.eval_cps @x0
@x1
@x2))
 

:pattern ((ApplyTT (ApplyTT (ApplyTT CPS.Double.eval_cps@tok
@x0)
@x1)
@x2))
:qid token_correspondence_CPS.Double.eval_cps))

:named token_correspondence_CPS.Double.eval_cps))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: 
(assert (! 
;; def=CPS.Double.fst(21,8-21,16); use=CPS.Double.fst(21,8-21,16)
(forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType CPS.Double.eval_cps@tok
Tm_arrow_7bdef5ad90906bca58a14be5498f3704))
...
@x2)
@x3)
(CPS.Double.eval_cps @x1
@x2
@x3))
 

:pattern ((CPS.Double.eval_cps @x1
@x2
@x3))
:qid function_token_typing_CPS.Double.eval_cps.1))
)
 

:pattern ((ApplyTT @x0
CPS.Double.eval_cps@tok))
:qid function_token_typing_CPS.Double.eval_cps))

:named function_token_typing_CPS.Double.eval_cps))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: 
(assert (! 
;; def=CPS.Double.fst(21,8-21,16); use=CPS.Double.fst(21,8-21,16)
...
CPS.Expr.expr)
(HasType @x2
(Tm_refine_00be7588dd5c1bf1e1aae3d0ea823bed @x0
@x1)))
(HasType (CPS.Double.eval_cps @x0
@x1
@x2)
@x0))
 

:pattern ((CPS.Double.eval_cps @x0
@x1
@x2))
:qid typing_CPS.Double.eval_cps))

:named typing_CPS.Double.eval_cps))
...
;         e == CPS.Expr.Plus b b ==>
;         (forall (r1: Prims.int). (*  - Could not prove post-condition
; *) b << e) /\ b << e))
...
;; def=Prims.fst(402,27-402,88); use=CPS.Double.fst(22,2-24,79)
(forall ((@x1 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=CPS.Double.fst(22,2-24,79)
(Valid 
;; def=Prims.fst(402,84-402,87); use=CPS.Double.fst(22,2-24,79)
(ApplyTT @x0
@x1)
...
;; def=Prims.fst(459,77-459,89); use=CPS.Double.fst(22,2-24,79)
(and (implies 
;; def=CPS.Double.fst(21,17-21,18); use=CPS.Double.fst(22,8-22,9)
(and 
;; def=CPS.Double.fst(21,17-21,18); use=CPS.Double.fst(22,8-22,9)
(not 
;; def=CPS.Double.fst(21,17-21,18); use=CPS.Double.fst(22,8-22,9)
...
label_1)
(implies 
;; def=Prims.fst(389,19-389,21); use=CPS.Double.fst(22,2-24,79)
(not 
;; def=CPS.Double.fst(21,17-21,18); use=CPS.Double.fst(22,8-22,9)
(BoxBool_proj_0 (CPS.Expr.uu___is_Const x_0c607185f6c6768f1786fe5f14f15ea1_2))
)
...
;; def=Prims.fst(413,99-413,120); use=CPS.Double.fst(22,2-24,79)
(forall ((@x1 Term))
 (! (implies (HasType @x1
CPS.Expr.expr)
...
;; def=CPS.Double.fst(21,17-24,16); use=CPS.Double.fst(22,8-24,16)
(= x_0c607185f6c6768f1786fe5f14f15ea1_2
(CPS.Expr.Plus @x1
@x2))
)
...
;; def=CPS.Double.fst(22,2-24,79); use=CPS.Double.fst(22,2-24,79)
(and 
;; def=dummy(0,0-0,0); use=CPS.Double.fst(22,2-24,79)
(forall ((@x3 Term))
 (! (implies (HasType @x3
Prims.int)

;; def=CPS.Double.fst(22,2-24,79); use=CPS.Double.fst(24,66-24,77)
(or label_2
...
;; def=CPS.Double.fst(22,2-24,79); use=CPS.Double.fst(24,43-24,78)
(or label_3
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (CPS.Double.eval_cps, 1)
; STATUS: unsat
