...
; Internals for Termination


; encoding sigelt val Termination.factorial


; <Skipped val Termination.factorial/>
...
; Starting query at Termination.fst(20,2-22,34)
...
(declare-fun Tm_refine_db1fa2f3c07ad7563afd72b467a7c617 () Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! (HasType Tm_refine_db1fa2f3c07ad7563afd72b467a7c617
Tm_type)
:named refinement_kinding_Tm_refine_db1fa2f3c07ad7563afd72b467a7c617))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(20,2-22,34); use=Termination.fst(20,2-22,34)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_db1fa2f3c07ad7563afd72b467a7c617)
(and (HasTypeFuel @u0
@x1
Prims.nat)
...
@x1
Tm_refine_db1fa2f3c07ad7563afd72b467a7c617))
:qid refinement_interpretation_Tm_refine_db1fa2f3c07ad7563afd72b467a7c617))

:named refinement_interpretation_Tm_refine_db1fa2f3c07ad7563afd72b467a7c617))
;;;;;;;;;;;;;;;;haseq for Tm_refine_db1fa2f3c07ad7563afd72b467a7c617
;;; Fact-ids: 
(assert (! (iff (Valid (Prims.hasEq Tm_refine_db1fa2f3c07ad7563afd72b467a7c617))
(Valid (Prims.hasEq Prims.nat)))
:named haseqTm_refine_db1fa2f3c07ad7563afd72b467a7c617))
(declare-fun Termination.factorial (Term) Term)

;;;;;;;;;;;;;;;;_: _: Prims.nat{_ << x} -> Prims.nat
(declare-fun Tm_arrow_bdaa429e46d3b354507ae37266b9144d () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_bdaa429e46d3b354507ae37266b9144d
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_bdaa429e46d3b354507ae37266b9144d
Tm_type)
:named kinding_Tm_arrow_bdaa429e46d3b354507ae37266b9144d))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(18,26-22,34); use=Termination.fst(19,8-22,34)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_bdaa429e46d3b354507ae37266b9144d)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_bdaa429e46d3b354507ae37266b9144d))
:qid Termination_pre_typing_Tm_arrow_bdaa429e46d3b354507ae37266b9144d))

:named Termination_pre_typing_Tm_arrow_bdaa429e46d3b354507ae37266b9144d))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_bdaa429e46d3b354507ae37266b9144d
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(18,26-22,34); use=Termination.fst(19,8-22,34)
(forall ((@x0 Term))
...
:pattern ((ApplyTT @x0
@x1))
:qid Termination_interpretation_Tm_arrow_bdaa429e46d3b354507ae37266b9144d.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_bdaa429e46d3b354507ae37266b9144d))
:qid Termination_interpretation_Tm_arrow_bdaa429e46d3b354507ae37266b9144d))

:named Termination_interpretation_Tm_arrow_bdaa429e46d3b354507ae37266b9144d))
(declare-fun Termination.factorial@tok () Term)
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(19,8-19,17); use=Termination.fst(19,8-19,17)
(forall ((@x0 Term))
 (! (= (ApplyTT Termination.factorial@tok
@x0)
(Termination.factorial @x0))
 

:pattern ((ApplyTT Termination.factorial@tok
@x0))
:qid token_correspondence_Termination.factorial))

:named token_correspondence_Termination.factorial))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(19,8-19,17); use=Termination.fst(19,8-19,17)
(forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType Termination.factorial@tok
Tm_arrow_bdaa429e46d3b354507ae37266b9144d))
...
(forall ((@x1 Term))
 (! (= (ApplyTT Termination.factorial@tok
@x1)
(Termination.factorial @x1))
 

:pattern ((Termination.factorial @x1))
:qid function_token_typing_Termination.factorial.1))
)
 

:pattern ((ApplyTT @x0
Termination.factorial@tok))
:qid function_token_typing_Termination.factorial))

:named function_token_typing_Termination.factorial))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(19,8-19,17); use=Termination.fst(19,8-19,17)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_refine_db1fa2f3c07ad7563afd72b467a7c617)
(HasType (Termination.factorial @x0)
Prims.nat))
 

:pattern ((Termination.factorial @x0))
:qid typing_Termination.factorial))

:named typing_Termination.factorial))
...
;       x == b ==>
;       x - 1 >= 0 /\ x - 1 << x /\
;       (forall (return_val: _: Prims.nat{_ << x}).
;           return_val == x - 1 ==>
;           (forall (any_result: Prims.nat).
;               Termination.factorial (x - 1) == any_result ==>
;               (forall (return_val: Prims.nat).
;                   return_val == Termination.factorial (x - 1) ==>
;                   Termination.factorial (x - 1) == return_val ==>
;                   (forall (any_result: Prims.int).
;                       x + Termination.factorial (x - 1) == any_result ==>
;                       x + Termination.factorial (x - 1) >= 0)))))


; Context: While encoding a query
; While typechecking the top-level declaration `let rec factorial`
...
;; def=Prims.fst(402,27-402,88); use=Termination.fst(20,2-22,34)
(forall ((@x1 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=Termination.fst(20,2-22,34)
(Valid 
;; def=Prims.fst(402,84-402,87); use=Termination.fst(20,2-22,34)
(ApplyTT @x0
@x1)
...
;; def=Prims.fst(389,19-389,21); use=Termination.fst(20,2-22,34)
(not 
;; def=Termination.fst(19,18-21,7); use=Termination.fst(20,8-21,7)
(= x_bb4e1c9af0265270f8e7a5f250f730e2_0
(BoxInt 0))
)
)

;; def=Prims.fst(413,99-413,120); use=Termination.fst(20,2-22,34)
(forall ((@x1 Term))
 (! (implies (and (HasType @x1
Prims.int)

;; def=Termination.fst(19,18-22,7); use=Termination.fst(20,8-22,7)
(= x_bb4e1c9af0265270f8e7a5f250f730e2_0
@x1)
)

;; def=Prims.fst(459,77-459,89); use=Termination.fst(20,2-22,34)
(and 
;; def=Prims.fst(680,18-680,24); use=Termination.fst(22,26-22,33)
(or label_1
...
;; def=Termination.fst(20,2-22,34); use=Termination.fst(22,26-22,33)
(or label_2
...
;; def=Prims.fst(356,2-356,58); use=Termination.fst(20,2-22,34)
(forall ((@x2 Term))
 (! (implies (and (HasType @x2
Tm_refine_db1fa2f3c07ad7563afd72b467a7c617)

;; def=Prims.fst(356,26-356,41); use=Termination.fst(20,2-22,34)
(= @x2
(Prims.op_Subtraction x_bb4e1c9af0265270f8e7a5f250f730e2_0
(BoxInt 1)))
)

;; def=Prims.fst(451,66-451,102); use=Termination.fst(20,2-22,34)
(forall ((@x3 Term))
 (! (implies (and (HasType @x3
Prims.nat)

;; def=Termination.fst(18,26-22,33); use=Termination.fst(22,16-22,33)
(= (Termination.factorial (Prims.op_Subtraction x_bb4e1c9af0265270f8e7a5f250f730e2_0
(BoxInt 1)))
@x3)
)
...
;; def=dummy(0,0-0,0); use=Termination.fst(20,2-22,34)
(= (Termination.factorial (Prims.op_Subtraction x_bb4e1c9af0265270f8e7a5f250f730e2_0
(BoxInt 1)))
@x4)
)
...
;; def=Termination.fst(18,26-22,34); use=Termination.fst(20,2-22,34)
(= (Prims.op_Addition x_bb4e1c9af0265270f8e7a5f250f730e2_0
(Termination.factorial (Prims.op_Subtraction x_bb4e1c9af0265270f8e7a5f250f730e2_0
(BoxInt 1))))
@x5)
)

;; def=Prims.fst(680,18-680,24); use=Termination.fst(22,11-22,34)
(or label_3

;; def=Prims.fst(680,18-680,24); use=Termination.fst(22,11-22,34)
(>= (BoxInt_proj_0 (Prims.op_Addition x_bb4e1c9af0265270f8e7a5f250f730e2_0
(Termination.factorial (Prims.op_Subtraction x_bb4e1c9af0265270f8e7a5f250f730e2_0
(BoxInt 1)))))
(BoxInt_proj_0 (BoxInt 0)))
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Termination.factorial, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, binder_x_bb4e1c9af0265270f8e7a5f250f730e2_0, equation_Prims.nat, int_inversion, int_typing, primitive_Prims.op_Addition, primitive_Prims.op_Subtraction, projection_inverse_BoxInt_proj_0, refinement_interpretation_Tm_refine_542f9d4f129664613f2483a6c88bc7c2, well-founded-ordering-on-nat
...
; encoding sigelt let rec factorial


; <Start encoding let rec factorial>

;;;;;;;;;;;;;;;;Fuel-instrumented function name
(declare-fun Termination.factorial.fuel_instrumented (Fuel Term) Term)
;;;;;;;;;;;;;;;;Token for fuel-instrumented partial applications
(declare-fun Termination.factorial.fuel_instrumented_token () Term)
(declare-fun Termination.factorial (Term) Term)
(declare-fun Termination.factorial@tok () Term)
;;;;;;;;;;;;;;;;x: Prims.nat -> Prims.nat
(declare-fun Tm_arrow_b71b847c8a1dce9fbabbfc40fd470d89 () Term)

; </end encoding let rec factorial>


; encoding sigelt val Termination.fibonacci


; <Skipped val Termination.fibonacci/>
...
; Starting query at Termination.fst(26,2-27,44)
...
Prims.nat)
:named binder_x_bb4e1c9af0265270f8e7a5f250f730e2_0))
(declare-fun Tm_refine_f32e2ba5407973c3cda26d5073819154 () Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! (HasType Tm_refine_f32e2ba5407973c3cda26d5073819154
Tm_type)
:named refinement_kinding_Tm_refine_f32e2ba5407973c3cda26d5073819154))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(26,2-27,44); use=Termination.fst(26,2-27,44)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_f32e2ba5407973c3cda26d5073819154)
(and (HasTypeFuel @u0
@x1
Prims.nat)
...
@x1
Tm_refine_f32e2ba5407973c3cda26d5073819154))
:qid refinement_interpretation_Tm_refine_f32e2ba5407973c3cda26d5073819154))

:named refinement_interpretation_Tm_refine_f32e2ba5407973c3cda26d5073819154))
;;;;;;;;;;;;;;;;haseq for Tm_refine_f32e2ba5407973c3cda26d5073819154
;;; Fact-ids: 
(assert (! (iff (Valid (Prims.hasEq Tm_refine_f32e2ba5407973c3cda26d5073819154))
(Valid (Prims.hasEq Prims.nat)))
:named haseqTm_refine_f32e2ba5407973c3cda26d5073819154))
(declare-fun Termination.fibonacci (Term) Term)

;;;;;;;;;;;;;;;;_: _: Prims.nat{_ << n} -> Prims.nat
(declare-fun Tm_arrow_02912db1d1acb226712a17a538a8dd5d () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_02912db1d1acb226712a17a538a8dd5d
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_02912db1d1acb226712a17a538a8dd5d
Tm_type)
:named kinding_Tm_arrow_02912db1d1acb226712a17a538a8dd5d))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(24,26-27,44); use=Termination.fst(25,8-27,44)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_02912db1d1acb226712a17a538a8dd5d)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_02912db1d1acb226712a17a538a8dd5d))
:qid Termination_pre_typing_Tm_arrow_02912db1d1acb226712a17a538a8dd5d))

:named Termination_pre_typing_Tm_arrow_02912db1d1acb226712a17a538a8dd5d))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_02912db1d1acb226712a17a538a8dd5d
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(24,26-27,44); use=Termination.fst(25,8-27,44)
(forall ((@x0 Term))
...
:pattern ((ApplyTT @x0
@x1))
:qid Termination_interpretation_Tm_arrow_02912db1d1acb226712a17a538a8dd5d.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_02912db1d1acb226712a17a538a8dd5d))
:qid Termination_interpretation_Tm_arrow_02912db1d1acb226712a17a538a8dd5d))

:named Termination_interpretation_Tm_arrow_02912db1d1acb226712a17a538a8dd5d))
(declare-fun Termination.fibonacci@tok () Term)
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(25,8-25,17); use=Termination.fst(25,8-25,17)
(forall ((@x0 Term))
 (! (= (ApplyTT Termination.fibonacci@tok
@x0)
(Termination.fibonacci @x0))
 

:pattern ((ApplyTT Termination.fibonacci@tok
@x0))
:qid token_correspondence_Termination.fibonacci))

:named token_correspondence_Termination.fibonacci))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(25,8-25,17); use=Termination.fst(25,8-25,17)
(forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType Termination.fibonacci@tok
Tm_arrow_02912db1d1acb226712a17a538a8dd5d))
...
(forall ((@x1 Term))
 (! (= (ApplyTT Termination.fibonacci@tok
@x1)
(Termination.fibonacci @x1))
 

:pattern ((Termination.fibonacci @x1))
:qid function_token_typing_Termination.fibonacci.1))
)
 

:pattern ((ApplyTT @x0
Termination.fibonacci@tok))
:qid function_token_typing_Termination.fibonacci))

:named function_token_typing_Termination.fibonacci))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(25,8-25,17); use=Termination.fst(25,8-25,17)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_refine_f32e2ba5407973c3cda26d5073819154)
(HasType (Termination.fibonacci @x0)
Prims.nat))
 

:pattern ((Termination.fibonacci @x0))
:qid typing_Termination.fibonacci))

:named typing_Termination.fibonacci))
...
;       n <= 1 == b ==>
;       n - 1 >= 0 /\ n - 1 << n /\
;       (forall (return_val: _: Prims.nat{_ << n}).
;           return_val == n - 1 ==>
;           (forall (any_result: Prims.nat).
;               Termination.fibonacci (n - 1) == any_result ==>
;               (forall (return_val: Prims.nat).
;                   return_val == Termination.fibonacci (n - 1) ==>
;                   Termination.fibonacci (n - 1) == return_val ==>
;                   n - 2 >= 0 /\ n - 2 << n /\
;                   (forall (return_val: _: Prims.nat{_ << n}).
;                       return_val == n - 2 ==>
;                       (forall (any_result: Prims.nat).
;                           Termination.fibonacci (n - 2) == any_result ==>
;                           (forall (return_val: Prims.nat).
;                               return_val == Termination.fibonacci (n - 2) ==>
;                               Termination.fibonacci (n - 2) == return_val ==>
;                               (forall (any_result: Prims.int).
;                                   Termination.fibonacci (n - 1) + Termination.fibonacci (n - 2) ==
;                                   any_result ==>
;                                   Termination.fibonacci (n - 1) + Termination.fibonacci (n - 2) >= 0
;                               ))))))))


; Context: While encoding a query
; While typechecking the top-level declaration `let rec fibonacci`
...
;; def=Prims.fst(402,27-402,88); use=Termination.fst(26,2-27,44)
(forall ((@x1 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=Termination.fst(26,2-27,44)
(Valid 
;; def=Prims.fst(402,84-402,87); use=Termination.fst(26,2-27,44)
(ApplyTT @x0
@x1)
...
;; def=Prims.fst(389,19-389,21); use=Termination.fst(26,2-27,44)
(not 
;; def=Termination.fst(26,5-26,9); use=Termination.fst(26,5-26,9)
(= (Prims.op_LessThanOrEqual x_bb4e1c9af0265270f8e7a5f250f730e2_0
(BoxInt 1))
(BoxBool true))
)
)

;; def=Prims.fst(413,99-413,120); use=Termination.fst(26,2-27,44)
(forall ((@x1 Term))
 (! (implies (and (HasType @x1
Prims.bool)

;; def=Termination.fst(26,5-27,44); use=Termination.fst(26,5-27,44)
(= (Prims.op_LessThanOrEqual x_bb4e1c9af0265270f8e7a5f250f730e2_0
(BoxInt 1))
@x1)
)

;; def=Prims.fst(459,77-459,89); use=Termination.fst(26,2-27,44)
(and 
;; def=Prims.fst(680,18-680,24); use=Termination.fst(27,17-27,24)
(or label_1
...
;; def=Termination.fst(26,2-27,44); use=Termination.fst(27,17-27,24)
(or label_2
...
;; def=Prims.fst(356,2-356,58); use=Termination.fst(26,2-27,44)
(forall ((@x2 Term))
 (! (implies (and (HasType @x2
Tm_refine_f32e2ba5407973c3cda26d5073819154)

;; def=Prims.fst(356,26-356,41); use=Termination.fst(26,2-27,44)
(= @x2
(Prims.op_Subtraction x_bb4e1c9af0265270f8e7a5f250f730e2_0
(BoxInt 1)))
)

;; def=Prims.fst(451,66-451,102); use=Termination.fst(26,2-27,44)
(forall ((@x3 Term))
 (! (implies (and (HasType @x3
Prims.nat)

;; def=Termination.fst(24,26-27,24); use=Termination.fst(27,7-27,24)
(= (Termination.fibonacci (Prims.op_Subtraction x_bb4e1c9af0265270f8e7a5f250f730e2_0
(BoxInt 1)))
@x3)
)
...
;; def=dummy(0,0-0,0); use=Termination.fst(26,2-27,44)
(= (Termination.fibonacci (Prims.op_Subtraction x_bb4e1c9af0265270f8e7a5f250f730e2_0
(BoxInt 1)))
@x4)
)
...
;; def=Prims.fst(459,77-459,89); use=Termination.fst(26,2-27,44)
(and 
;; def=Prims.fst(680,18-680,24); use=Termination.fst(27,37-27,44)
(or label_3
...
;; def=Termination.fst(26,2-27,44); use=Termination.fst(27,37-27,44)
(or label_4
...
;; def=Termination.fst(24,26-27,44); use=Termination.fst(27,27-27,44)
(= (Termination.fibonacci (Prims.op_Subtraction x_bb4e1c9af0265270f8e7a5f250f730e2_0
(BoxInt 2)))
@x6)
)
...
;; def=Termination.fst(24,26-27,44); use=Termination.fst(26,2-27,44)
(= (Prims.op_Addition (Termination.fibonacci (Prims.op_Subtraction x_bb4e1c9af0265270f8e7a5f250f730e2_0
(BoxInt 1)))
(Termination.fibonacci (Prims.op_Subtraction x_bb4e1c9af0265270f8e7a5f250f730e2_0
(BoxInt 2))))
@x8)
...
;; def=Prims.fst(680,18-680,24); use=Termination.fst(27,7-27,44)
(or label_5

;; def=Prims.fst(680,18-680,24); use=Termination.fst(27,7-27,44)
(>= (BoxInt_proj_0 (Prims.op_Addition (Termination.fibonacci (Prims.op_Subtraction x_bb4e1c9af0265270f8e7a5f250f730e2_0
(BoxInt 1)))
(Termination.fibonacci (Prims.op_Subtraction x_bb4e1c9af0265270f8e7a5f250f730e2_0
(BoxInt 2)))))
(BoxInt_proj_0 (BoxInt 0)))
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Termination.fibonacci, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, binder_x_bb4e1c9af0265270f8e7a5f250f730e2_0, equation_Prims.nat, int_inversion, int_typing, primitive_Prims.op_Addition, primitive_Prims.op_LessThanOrEqual, primitive_Prims.op_Subtraction, projection_inverse_BoxInt_proj_0, refinement_interpretation_Tm_refine_542f9d4f129664613f2483a6c88bc7c2, well-founded-ordering-on-nat
...
; encoding sigelt let rec fibonacci


; <Start encoding let rec fibonacci>

;;;;;;;;;;;;;;;;Fuel-instrumented function name
(declare-fun Termination.fibonacci.fuel_instrumented (Fuel Term) Term)
;;;;;;;;;;;;;;;;Token for fuel-instrumented partial applications
(declare-fun Termination.fibonacci.fuel_instrumented_token () Term)
(declare-fun Termination.fibonacci (Term) Term)
(declare-fun Termination.fibonacci@tok () Term)


; </end encoding let rec fibonacci>


; encoding sigelt val Termination.ackermann


; <Skipped val Termination.ackermann/>
...
; Starting query at Termination.fst(31,2-33,46)
...
(declare-fun Tm_refine_976a75ba6f54147ea3b5ee713806c920 (Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(29,15-33,46); use=Termination.fst(29,15-33,46)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_976a75ba6f54147ea3b5ee713806c920 @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_976a75ba6f54147ea3b5ee713806c920 @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_976a75ba6f54147ea3b5ee713806c920))

:named refinement_kinding_Tm_refine_976a75ba6f54147ea3b5ee713806c920))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(29,15-33,46); use=Termination.fst(29,15-33,46)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_976a75ba6f54147ea3b5ee713806c920 @x2))
(and (HasTypeFuel @u0
@x1
Prims.nat)
...
;; def=Termination.fst(29,15-33,46); use=Termination.fst(29,15-33,46)
(or 
;; def=Termination.fst(31,2-33,46); use=Termination.fst(31,2-33,46)
(Valid 
;; def=Termination.fst(31,2-33,46); use=Termination.fst(31,2-33,46)
(Prims.precedes Prims.nat
Prims.nat
...
;; def=Termination.fst(29,15-33,46); use=Termination.fst(29,15-33,46)
(and 
;; def=Termination.fst(29,15-30,19); use=Termination.fst(29,15-30,19)
(Valid 
;; def=Termination.fst(29,15-30,19); use=Termination.fst(29,15-30,19)
...
@x1
(Tm_refine_976a75ba6f54147ea3b5ee713806c920 @x2)))
:qid refinement_interpretation_Tm_refine_976a75ba6f54147ea3b5ee713806c920))

:named refinement_interpretation_Tm_refine_976a75ba6f54147ea3b5ee713806c920))
;;;;;;;;;;;;;;;;haseq for Tm_refine_976a75ba6f54147ea3b5ee713806c920
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(29,15-33,46); use=Termination.fst(29,15-33,46)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_976a75ba6f54147ea3b5ee713806c920 @x0)))
(Valid (Prims.hasEq Prims.nat)))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_976a75ba6f54147ea3b5ee713806c920 @x0))))
:qid haseqTm_refine_976a75ba6f54147ea3b5ee713806c920))

:named haseqTm_refine_976a75ba6f54147ea3b5ee713806c920))
(declare-fun Termination.ackermann (Term Term) Term)

;;;;;;;;;;;;;;;;m: Prims.nat -> n: Prims.nat{m << m \/ m === m /\ n << n} -> Prims.nat
(declare-fun Tm_arrow_1196fbe74490d25a8db0b0afef4713e5 () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_1196fbe74490d25a8db0b0afef4713e5
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_1196fbe74490d25a8db0b0afef4713e5
Tm_type)
:named kinding_Tm_arrow_1196fbe74490d25a8db0b0afef4713e5))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(29,15-33,46); use=Termination.fst(29,15-33,46)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_1196fbe74490d25a8db0b0afef4713e5)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_1196fbe74490d25a8db0b0afef4713e5))
:qid Termination_pre_typing_Tm_arrow_1196fbe74490d25a8db0b0afef4713e5))

:named Termination_pre_typing_Tm_arrow_1196fbe74490d25a8db0b0afef4713e5))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_1196fbe74490d25a8db0b0afef4713e5
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(29,15-33,46); use=Termination.fst(29,15-33,46)
(forall ((@x0 Term))
...
Prims.nat)
(HasType @x2
(Tm_refine_976a75ba6f54147ea3b5ee713806c920 @x1)))
(HasType (ApplyTT (ApplyTT @x0
@x1)
@x2)
Prims.nat))
...
@x1)
@x2))
:qid Termination_interpretation_Tm_arrow_1196fbe74490d25a8db0b0afef4713e5.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid Termination_interpretation_Tm_arrow_1196fbe74490d25a8db0b0afef4713e5.2))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_1196fbe74490d25a8db0b0afef4713e5))
:qid Termination_interpretation_Tm_arrow_1196fbe74490d25a8db0b0afef4713e5))

:named Termination_interpretation_Tm_arrow_1196fbe74490d25a8db0b0afef4713e5))
(declare-fun Termination.ackermann@tok () Term)
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(30,8-30,17); use=Termination.fst(30,8-30,17)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (ApplyTT Termination.ackermann@tok
@x0)
@x1)
(Termination.ackermann @x0
@x1))
 

:pattern ((ApplyTT (ApplyTT Termination.ackermann@tok
@x0)
@x1))
:qid token_correspondence_Termination.ackermann))

:named token_correspondence_Termination.ackermann))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(30,8-30,17); use=Termination.fst(30,8-30,17)
(forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType Termination.ackermann@tok
Tm_arrow_1196fbe74490d25a8db0b0afef4713e5))
...
@x1)
@x2)
(Termination.ackermann @x1
@x2))
 

:pattern ((Termination.ackermann @x1
@x2))
:qid function_token_typing_Termination.ackermann.1))
)
 

:pattern ((ApplyTT @x0
Termination.ackermann@tok))
:qid function_token_typing_Termination.ackermann))

:named function_token_typing_Termination.ackermann))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(30,8-30,17); use=Termination.fst(30,8-30,17)
...
Prims.nat)
(HasType @x1
(Tm_refine_976a75ba6f54147ea3b5ee713806c920 @x0)))
(HasType (Termination.ackermann @x0
@x1)
Prims.nat))
 

:pattern ((Termination.ackermann @x0
@x1))
:qid typing_Termination.ackermann))

:named typing_Termination.ackermann))
...
(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)
(declare-fun Tm_refine_4d0dbf840bf82974dfed96d5d22cbc75 () Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! (HasType Tm_refine_4d0dbf840bf82974dfed96d5d22cbc75
Tm_type)
:named refinement_kinding_Tm_refine_4d0dbf840bf82974dfed96d5d22cbc75))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(29,15-33,46); use=Termination.fst(33,26-33,35)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_4d0dbf840bf82974dfed96d5d22cbc75)
(and (HasTypeFuel @u0
@x1
Prims.nat)
...
;; def=Termination.fst(29,15-33,46); use=Termination.fst(33,26-33,35)
(or 
;; def=Termination.fst(31,2-33,46); use=Termination.fst(33,26-33,35)
(Valid 
;; def=Termination.fst(31,2-33,46); use=Termination.fst(33,26-33,35)
(Prims.precedes Prims.nat
Prims.nat
...
@x1
Tm_refine_4d0dbf840bf82974dfed96d5d22cbc75))
:qid refinement_interpretation_Tm_refine_4d0dbf840bf82974dfed96d5d22cbc75))

:named refinement_interpretation_Tm_refine_4d0dbf840bf82974dfed96d5d22cbc75))
;;;;;;;;;;;;;;;;haseq for Tm_refine_4d0dbf840bf82974dfed96d5d22cbc75
;;; Fact-ids: 
(assert (! (iff (Valid (Prims.hasEq Tm_refine_4d0dbf840bf82974dfed96d5d22cbc75))
(Valid (Prims.hasEq Prims.nat)))
:named haseqTm_refine_4d0dbf840bf82974dfed96d5d22cbc75))
...
;               m - 1 >= 0 /\
;               (forall (return_val: Prims.nat).
;                   return_val == m - 1 ==> m - 1 << m \/ m - 1 === m /\ 1 << n)) /\
;             (~(n = 0 = true) ==>
;               (forall (b: Prims.bool).
;                   n = 0 == b ==>
;                   m - 1 >= 0 /\
...
;                       return_val == m - 1 ==>
;                       n - 1 >= 0 /\ (m << m \/ n - 1 << n) /\
;                       (forall (return_val: n: Prims.nat{m << m \/ n << n}).
;                           return_val == n - 1 ==>
;                           (forall (any_result: Prims.nat).
;                               Termination.ackermann m (n - 1) == any_result ==>
;                               m - 1 << m \/ m - 1 === m /\ Termination.ackermann m (n - 1) << n)))))
;         )))


; Context: While encoding a query
; While typechecking the top-level declaration `let rec ackermann`
...
;; def=Prims.fst(402,27-402,88); use=Termination.fst(31,2-33,46)
(forall ((@x1 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=Termination.fst(31,2-33,46)
(Valid 
;; def=Prims.fst(402,84-402,87); use=Termination.fst(31,2-33,46)
(ApplyTT @x0
@x1)
...
;; def=Prims.fst(389,2-389,39); use=Termination.fst(31,2-33,46)
(and (implies 
;; def=Termination.fst(31,5-31,8); use=Termination.fst(31,5-31,8)
...
;; def=Prims.fst(680,18-680,24); use=Termination.fst(31,14-31,19)
(or label_1

;; def=Prims.fst(680,18-680,24); use=Termination.fst(31,14-31,19)
(>= (BoxInt_proj_0 (Prims.op_Addition x_bb4e1c9af0265270f8e7a5f250f730e2_1
(BoxInt 1)))
(BoxInt_proj_0 (BoxInt 0)))
)
)
(implies 
;; def=Prims.fst(389,19-389,21); use=Termination.fst(31,2-33,46)
(not 
;; def=Termination.fst(31,5-31,8); use=Termination.fst(31,5-31,8)
(= (Prims.op_Equality Prims.int
x_bb4e1c9af0265270f8e7a5f250f730e2_0
...
;; def=Prims.fst(413,99-413,120); use=Termination.fst(31,2-33,46)
(forall ((@x1 Term))
 (! (implies (and (HasType @x1
Prims.bool)

;; def=Termination.fst(31,5-33,46); use=Termination.fst(31,5-33,46)
(= (Prims.op_Equality Prims.int
x_bb4e1c9af0265270f8e7a5f250f730e2_0
(BoxInt 0))
@x1)
...
;; def=Prims.fst(389,2-389,39); use=Termination.fst(31,2-33,46)
(and (implies 
;; def=Termination.fst(32,10-32,15); use=Termination.fst(32,10-32,15)
(= (Prims.op_Equality Prims.int
x_bb4e1c9af0265270f8e7a5f250f730e2_1
(BoxInt 0))
(BoxBool true))
...
;; def=Prims.fst(459,77-459,89); use=Termination.fst(31,2-33,46)
(and 
;; def=Prims.fst(680,18-680,24); use=Termination.fst(32,31-32,38)
(or label_2
...
;; def=Prims.fst(356,2-356,58); use=Termination.fst(31,2-33,46)
(forall ((@x3 Term))
 (! (implies (and (HasType @x3
Prims.nat)

;; def=Prims.fst(356,26-356,41); use=Termination.fst(31,2-33,46)
(= @x3
(Prims.op_Subtraction x_bb4e1c9af0265270f8e7a5f250f730e2_0
(BoxInt 1)))
)

;; def=Termination.fst(29,15-33,46); use=Termination.fst(32,39-32,40)
(or label_3

;; def=Termination.fst(31,2-33,46); use=Termination.fst(32,39-32,40)
(Valid 
;; def=Termination.fst(31,2-33,46); use=Termination.fst(32,39-32,40)
(Prims.precedes Prims.nat
Prims.nat
...
;; def=Termination.fst(29,15-33,46); use=Termination.fst(32,39-32,40)
(and 
;; def=Termination.fst(29,15-30,19); use=Termination.fst(32,39-32,40)
(Valid 
;; def=Termination.fst(29,15-30,19); use=Termination.fst(32,39-32,40)
(Prims.op_Equals_Equals_Equals Prims.nat
Prims.nat
...
;; def=Termination.fst(32,10-33,46); use=Termination.fst(32,10-33,46)
(= (Prims.op_Equality Prims.int
x_bb4e1c9af0265270f8e7a5f250f730e2_1
(BoxInt 0))
@x3)
...
;; def=Prims.fst(459,77-459,89); use=Termination.fst(31,2-33,46)
(and 
;; def=Prims.fst(680,18-680,24); use=Termination.fst(33,17-33,24)
(or label_4
...
;; def=Prims.fst(459,77-459,89); use=Termination.fst(31,2-33,46)
(and 
;; def=Prims.fst(680,18-680,24); use=Termination.fst(33,38-33,45)
(or label_5
...
;; def=Termination.fst(29,15-33,46); use=Termination.fst(33,38-33,45)
(or label_6

;; def=Termination.fst(31,2-33,46); use=Termination.fst(33,38-33,45)
(Valid 
;; def=Termination.fst(31,2-33,46); use=Termination.fst(33,38-33,45)
(Prims.precedes Prims.nat
Prims.nat
...
;; def=Prims.fst(451,66-451,102); use=Termination.fst(31,2-33,46)
(forall ((@x6 Term))
 (! (implies (and (HasType @x6
Prims.nat)

;; def=Termination.fst(29,15-33,46); use=Termination.fst(31,2-33,46)
(= (Termination.ackermann x_bb4e1c9af0265270f8e7a5f250f730e2_0
(Prims.op_Subtraction x_bb4e1c9af0265270f8e7a5f250f730e2_1
(BoxInt 1)))
@x6)
)

;; def=Termination.fst(29,15-33,46); use=Termination.fst(33,25-33,46)
(or label_7

;; def=Termination.fst(31,2-33,46); use=Termination.fst(33,25-33,46)
(Valid 
;; def=Termination.fst(31,2-33,46); use=Termination.fst(33,25-33,46)
(Prims.precedes Prims.nat
Prims.nat
...
;; def=Termination.fst(29,15-33,46); use=Termination.fst(33,25-33,46)
(and 
;; def=Termination.fst(29,15-30,19); use=Termination.fst(33,25-33,46)
(Valid 
;; def=Termination.fst(29,15-30,19); use=Termination.fst(33,25-33,46)
(Prims.op_Equals_Equals_Equals Prims.nat
Prims.nat
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Termination.ackermann, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, Prims_pretyping_ae567c2fb75be05905677af440075565, binder_x_bb4e1c9af0265270f8e7a5f250f730e2_0, binder_x_bb4e1c9af0265270f8e7a5f250f730e2_1, equation_Prims.nat, function_token_typing_Prims.__cache_version_number__, int_inversion, int_typing, primitive_Prims.op_Addition, primitive_Prims.op_Equality, primitive_Prims.op_Subtraction, projection_inverse_BoxInt_proj_0, refinement_interpretation_Tm_refine_542f9d4f129664613f2483a6c88bc7c2, well-founded-ordering-on-nat
...
; encoding sigelt let rec ackermann


; <Start encoding let rec ackermann>

;;;;;;;;;;;;;;;;Fuel-instrumented function name
(declare-fun Termination.ackermann.fuel_instrumented (Fuel Term Term) Term)
;;;;;;;;;;;;;;;;Token for fuel-instrumented partial applications
(declare-fun Termination.ackermann.fuel_instrumented_token () Term)
(declare-fun Termination.ackermann (Term Term) Term)
(declare-fun Termination.ackermann@tok () Term)
;;;;;;;;;;;;;;;;m: Prims.nat -> n: Prims.nat -> Prims.nat
(declare-fun Tm_arrow_2bb228db8432d0cdc106cb64c22e55ba () Term)

; </end encoding let rec ackermann>


; encoding sigelt val Termination.ack_swap


; <Skipped val Termination.ack_swap/>

(push) ;; push{2

; Starting query at Termination.fst(37,2-39,44)
...
Prims.nat)
:named binder_x_bb4e1c9af0265270f8e7a5f250f730e2_1))
(declare-fun Tm_refine_085f228a664831a5273357125bfd326a (Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(35,23-39,44); use=Termination.fst(35,23-39,44)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_085f228a664831a5273357125bfd326a @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_085f228a664831a5273357125bfd326a @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_085f228a664831a5273357125bfd326a))

:named refinement_kinding_Tm_refine_085f228a664831a5273357125bfd326a))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(35,23-39,44); use=Termination.fst(35,23-39,44)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_085f228a664831a5273357125bfd326a @x2))
(and (HasTypeFuel @u0
@x1
Prims.nat)

;; def=Termination.fst(35,23-39,44); use=Termination.fst(35,53-39,44)

;; def=Termination.fst(35,23-39,44); use=Termination.fst(35,53-39,44)
(or 
;; def=Termination.fst(37,2-39,44); use=Termination.fst(37,2-39,44)
(Valid 
;; def=Termination.fst(37,2-39,44); use=Termination.fst(37,2-39,44)
(Prims.precedes Prims.nat
Prims.nat
...
;; def=Termination.fst(35,23-39,44); use=Termination.fst(35,53-39,44)
(and 
;; def=Termination.fst(35,23-36,20); use=Termination.fst(35,53-36,20)
(Valid 
;; def=Termination.fst(35,23-36,20); use=Termination.fst(35,53-36,20)
(Prims.op_Equals_Equals_Equals Prims.nat
Prims.nat
...
@x1
(Tm_refine_085f228a664831a5273357125bfd326a @x2)))
:qid refinement_interpretation_Tm_refine_085f228a664831a5273357125bfd326a))

:named refinement_interpretation_Tm_refine_085f228a664831a5273357125bfd326a))
;;;;;;;;;;;;;;;;haseq for Tm_refine_085f228a664831a5273357125bfd326a
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(35,23-39,44); use=Termination.fst(35,23-39,44)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_085f228a664831a5273357125bfd326a @x0)))
(Valid (Prims.hasEq Prims.nat)))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_085f228a664831a5273357125bfd326a @x0))))
:qid haseqTm_refine_085f228a664831a5273357125bfd326a))

:named haseqTm_refine_085f228a664831a5273357125bfd326a))
(declare-fun Termination.ack_swap (Term Term) Term)

;;;;;;;;;;;;;;;;n: Prims.nat -> m: Prims.nat{m << m \/ m === m /\ n << n} -> Prims.Tot Prims.nat
(declare-fun Tm_arrow_752cd41f67d1f0b66f0d5a7d1ac59339 () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_752cd41f67d1f0b66f0d5a7d1ac59339
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_752cd41f67d1f0b66f0d5a7d1ac59339
Tm_type)
:named kinding_Tm_arrow_752cd41f67d1f0b66f0d5a7d1ac59339))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(35,16-39,44); use=Termination.fst(35,23-39,44)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_752cd41f67d1f0b66f0d5a7d1ac59339)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_752cd41f67d1f0b66f0d5a7d1ac59339))
:qid Termination_pre_typing_Tm_arrow_752cd41f67d1f0b66f0d5a7d1ac59339))

:named Termination_pre_typing_Tm_arrow_752cd41f67d1f0b66f0d5a7d1ac59339))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_752cd41f67d1f0b66f0d5a7d1ac59339
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(35,16-39,44); use=Termination.fst(35,23-39,44)
(forall ((@x0 Term))
...
Prims.nat)
(HasType @x2
(Tm_refine_085f228a664831a5273357125bfd326a @x1)))
(HasType (ApplyTT (ApplyTT @x0
@x1)
@x2)
Prims.nat))
...
@x1)
@x2))
:qid Termination_interpretation_Tm_arrow_752cd41f67d1f0b66f0d5a7d1ac59339.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid Termination_interpretation_Tm_arrow_752cd41f67d1f0b66f0d5a7d1ac59339.2))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_752cd41f67d1f0b66f0d5a7d1ac59339))
:qid Termination_interpretation_Tm_arrow_752cd41f67d1f0b66f0d5a7d1ac59339))

:named Termination_interpretation_Tm_arrow_752cd41f67d1f0b66f0d5a7d1ac59339))
(declare-fun Termination.ack_swap@tok () Term)
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(36,8-36,16); use=Termination.fst(36,8-36,16)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (ApplyTT Termination.ack_swap@tok
@x0)
@x1)
(Termination.ack_swap @x0
@x1))
 

:pattern ((ApplyTT (ApplyTT Termination.ack_swap@tok
@x0)
@x1))
:qid token_correspondence_Termination.ack_swap))

:named token_correspondence_Termination.ack_swap))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(36,8-36,16); use=Termination.fst(36,8-36,16)
(forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType Termination.ack_swap@tok
Tm_arrow_752cd41f67d1f0b66f0d5a7d1ac59339))
...
@x1)
@x2)
(Termination.ack_swap @x1
@x2))
 

:pattern ((Termination.ack_swap @x1
@x2))
:qid function_token_typing_Termination.ack_swap.1))
)
 

:pattern ((ApplyTT @x0
Termination.ack_swap@tok))
:qid function_token_typing_Termination.ack_swap))

:named function_token_typing_Termination.ack_swap))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(36,8-36,16); use=Termination.fst(36,8-36,16)
...
Prims.nat)
(HasType @x1
(Tm_refine_085f228a664831a5273357125bfd326a @x0)))
(HasType (Termination.ack_swap @x0
@x1)
Prims.nat))
 

:pattern ((Termination.ack_swap @x0
@x1))
:qid typing_Termination.ack_swap))

:named typing_Termination.ack_swap))
(declare-fun label_7 () Bool)
(declare-fun label_6 () Bool)
(declare-fun label_5 () Bool)
(declare-fun label_4 () Bool)
...
;         (forall (k: Prims.pure_post Prims.nat).
;             (forall (x: Prims.nat). {:pattern Prims.guard_free (k x)} Prims.auto_squash (k x)) ==>
;             (n = 0 == true ==> m - 1 >= 0 /\ (m - 1 << m \/ m - 1 === m /\ 1 << n)) /\
;             (~(n = 0 = true) ==>
;               (forall (b: Prims.bool).
;                   n = 0 == b ==>
;                   n - 1 >= 0 /\
...
;                           m == any_result ==>
;                           (forall (any_result: Prims.nat).
;                               Termination.ack_swap (n - 1) m == any_result ==>
;                               m - 1 >= 0 /\
;                               (m - 1 << m \/ m - 1 === m /\ Termination.ack_swap (n - 1) m << n)))))
;             ))))


; Context: While encoding a query
; While typechecking the top-level declaration `let rec ack_swap`
...
;; def=Prims.fst(402,27-402,88); use=Termination.fst(37,2-39,44)
(forall ((@x1 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=Termination.fst(37,2-39,44)
(Valid 
;; def=Prims.fst(402,84-402,87); use=Termination.fst(37,2-39,44)
(ApplyTT @x0
@x1)
...
;; def=Prims.fst(389,2-389,39); use=Termination.fst(37,2-39,44)
(and (implies 
;; def=Termination.fst(37,5-37,8); use=Termination.fst(37,5-37,8)
(= (Prims.op_Equality Prims.int
x_bb4e1c9af0265270f8e7a5f250f730e2_1
(BoxInt 0))
(BoxBool true))
...
;; def=Prims.fst(680,18-680,24); use=Termination.fst(37,14-37,19)
(or label_1
...
(implies 
;; def=Prims.fst(389,19-389,21); use=Termination.fst(37,2-39,44)
(not 
;; def=Termination.fst(37,5-37,8); use=Termination.fst(37,5-37,8)
(= (Prims.op_Equality Prims.int
x_bb4e1c9af0265270f8e7a5f250f730e2_1
...
;; def=Prims.fst(413,99-413,120); use=Termination.fst(37,2-39,44)
(forall ((@x1 Term))
 (! (implies (and (HasType @x1
Prims.bool)

;; def=Termination.fst(37,5-39,44); use=Termination.fst(37,5-39,44)
(= (Prims.op_Equality Prims.int
x_bb4e1c9af0265270f8e7a5f250f730e2_1
(BoxInt 0))
@x1)
...
;; def=Prims.fst(389,2-389,39); use=Termination.fst(37,2-39,44)
(and (implies 
;; def=Termination.fst(38,10-38,15); use=Termination.fst(38,10-38,15)
(= (Prims.op_Equality Prims.int
x_bb4e1c9af0265270f8e7a5f250f730e2_0
(BoxInt 0))
(BoxBool true))
...
;; def=Termination.fst(35,23-39,44); use=Termination.fst(38,32-38,39)
(and 
;; def=Prims.fst(680,18-680,24); use=Termination.fst(38,32-38,39)
(or label_2
...
;; def=Termination.fst(37,2-39,44); use=Termination.fst(38,32-38,39)
(Valid 
;; def=Termination.fst(37,2-39,44); use=Termination.fst(38,32-38,39)
(Prims.precedes Prims.nat
Prims.nat
...
;; def=Termination.fst(35,23-39,44); use=Termination.fst(38,32-38,39)
(and 
;; def=Termination.fst(35,23-36,20); use=Termination.fst(38,32-38,39)
(Valid 
;; def=Termination.fst(35,23-36,20); use=Termination.fst(38,32-38,39)
(Prims.op_Equals_Equals_Equals Prims.nat
Prims.nat
...
;; def=Termination.fst(38,10-39,44); use=Termination.fst(38,10-39,44)
(= (Prims.op_Equality Prims.int
x_bb4e1c9af0265270f8e7a5f250f730e2_0
(BoxInt 0))
@x3)
...
;; def=Prims.fst(459,77-459,89); use=Termination.fst(37,2-39,44)
(and 
;; def=Prims.fst(680,18-680,24); use=Termination.fst(39,26-39,33)
(or label_4
...
;; def=Prims.fst(356,2-356,58); use=Termination.fst(37,2-39,44)
(forall ((@x4 Term))
 (! (implies (and (HasType @x4
Prims.nat)

;; def=Prims.fst(356,26-356,41); use=Termination.fst(37,2-39,44)
(= @x4
(Prims.op_Subtraction x_bb4e1c9af0265270f8e7a5f250f730e2_0
(BoxInt 1)))
)
...
;; def=Prims.fst(459,77-459,89); use=Termination.fst(37,2-39,44)
(and 
;; def=Termination.fst(35,23-39,44); use=Termination.fst(39,34-39,35)
(or label_5

;; def=Termination.fst(37,2-39,44); use=Termination.fst(39,34-39,35)
(Valid 
;; def=Termination.fst(37,2-39,44); use=Termination.fst(39,34-39,35)
(Prims.precedes Prims.nat
Prims.nat
...
;; def=Prims.fst(451,66-451,102); use=Termination.fst(37,2-39,44)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
Prims.nat)

;; def=Termination.fst(35,23-36,20); use=Termination.fst(37,2-39,44)
(= x_bb4e1c9af0265270f8e7a5f250f730e2_1
@x5)
)
...
;; def=Termination.fst(35,14-39,36); use=Termination.fst(37,2-39,44)
(= (Termination.ack_swap (Prims.op_Subtraction x_bb4e1c9af0265270f8e7a5f250f730e2_0
(BoxInt 1))
x_bb4e1c9af0265270f8e7a5f250f730e2_1)
@x6)
)

;; def=Termination.fst(35,23-39,44); use=Termination.fst(39,37-39,44)
(and 
;; def=Prims.fst(680,18-680,24); use=Termination.fst(39,37-39,44)
(or label_6
...
;; def=Termination.fst(37,2-39,44); use=Termination.fst(39,37-39,44)
(Valid 
;; def=Termination.fst(37,2-39,44); use=Termination.fst(39,37-39,44)
(Prims.precedes Prims.nat
Prims.nat
...
;; def=Termination.fst(35,23-39,44); use=Termination.fst(39,37-39,44)
(and 
;; def=Termination.fst(35,23-36,20); use=Termination.fst(39,37-39,44)
(Valid 
;; def=Termination.fst(35,23-36,20); use=Termination.fst(39,37-39,44)
(Prims.op_Equals_Equals_Equals Prims.nat
Prims.nat
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Termination.ack_swap, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, Prims_pretyping_ae567c2fb75be05905677af440075565, binder_x_bb4e1c9af0265270f8e7a5f250f730e2_0, binder_x_bb4e1c9af0265270f8e7a5f250f730e2_1, equation_Prims.nat, function_token_typing_Prims.__cache_version_number__, int_inversion, int_typing, primitive_Prims.op_Addition, primitive_Prims.op_Equality, primitive_Prims.op_Subtraction, projection_inverse_BoxInt_proj_0, refinement_interpretation_Tm_refine_542f9d4f129664613f2483a6c88bc7c2, well-founded-ordering-on-nat
...
; encoding sigelt let rec ack_swap


; <Start encoding let rec ack_swap>

;;;;;;;;;;;;;;;;Fuel-instrumented function name
(declare-fun Termination.ack_swap.fuel_instrumented (Fuel Term Term) Term)
;;;;;;;;;;;;;;;;Token for fuel-instrumented partial applications
(declare-fun Termination.ack_swap.fuel_instrumented_token () Term)
(declare-fun Termination.ack_swap (Term Term) Term)
(declare-fun Termination.ack_swap@tok () Term)


; </end encoding let rec ack_swap>


; encoding sigelt val Termination.length


; <Skipped val Termination.length/>
...
; Starting query at Termination.fst(42,19-44,26)
...
(declare-fun Tm_refine_67fc396c2c954defeb64f6f73ae5e493 (Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(42,19-44,26); use=Termination.fst(42,19-44,26)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_67fc396c2c954defeb64f6f73ae5e493 @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_67fc396c2c954defeb64f6f73ae5e493 @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_67fc396c2c954defeb64f6f73ae5e493))

:named refinement_kinding_Tm_refine_67fc396c2c954defeb64f6f73ae5e493))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(42,19-44,26); use=Termination.fst(42,19-44,26)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_67fc396c2c954defeb64f6f73ae5e493 @x2))
(and (HasTypeFuel @u0
@x1
(Prims.list @x2))
...
@x1
(Tm_refine_67fc396c2c954defeb64f6f73ae5e493 @x2)))
:qid refinement_interpretation_Tm_refine_67fc396c2c954defeb64f6f73ae5e493))

:named refinement_interpretation_Tm_refine_67fc396c2c954defeb64f6f73ae5e493))
;;;;;;;;;;;;;;;;haseq for Tm_refine_67fc396c2c954defeb64f6f73ae5e493
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(42,19-44,26); use=Termination.fst(42,19-44,26)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_67fc396c2c954defeb64f6f73ae5e493 @x0)))
(Valid (Prims.hasEq (Prims.list @x0))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_67fc396c2c954defeb64f6f73ae5e493 @x0))))
:qid haseqTm_refine_67fc396c2c954defeb64f6f73ae5e493))

:named haseqTm_refine_67fc396c2c954defeb64f6f73ae5e493))
(declare-fun Termination.length (Term Term) Term)

;;;;;;;;;;;;;;;;_: _: Prims.list 'a {_ << l} -> Prims.nat
(declare-fun Tm_arrow_05a4876c6cdcb2a170e6008dc4da5249 () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_05a4876c6cdcb2a170e6008dc4da5249
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_05a4876c6cdcb2a170e6008dc4da5249
Tm_type)
:named kinding_Tm_arrow_05a4876c6cdcb2a170e6008dc4da5249))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(41,17-44,26); use=Termination.fst(42,8-44,26)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_05a4876c6cdcb2a170e6008dc4da5249)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_05a4876c6cdcb2a170e6008dc4da5249))
:qid Termination_pre_typing_Tm_arrow_05a4876c6cdcb2a170e6008dc4da5249))

:named Termination_pre_typing_Tm_arrow_05a4876c6cdcb2a170e6008dc4da5249))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_05a4876c6cdcb2a170e6008dc4da5249
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(41,17-44,26); use=Termination.fst(42,8-44,26)
(forall ((@x0 Term))
...
Tm_type)
(HasType @x2
(Tm_refine_67fc396c2c954defeb64f6f73ae5e493 @x1)))
(HasType (ApplyTT (ApplyTT @x0
@x1)
@x2)
Prims.nat))
...
@x1)
@x2))
:qid Termination_interpretation_Tm_arrow_05a4876c6cdcb2a170e6008dc4da5249.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid Termination_interpretation_Tm_arrow_05a4876c6cdcb2a170e6008dc4da5249.2))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_05a4876c6cdcb2a170e6008dc4da5249))
:qid Termination_interpretation_Tm_arrow_05a4876c6cdcb2a170e6008dc4da5249))

:named Termination_interpretation_Tm_arrow_05a4876c6cdcb2a170e6008dc4da5249))
(declare-fun Termination.length@tok () Term)
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(42,8-42,14); use=Termination.fst(42,8-42,14)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (ApplyTT Termination.length@tok
@x0)
@x1)
(Termination.length @x0
@x1))
 

:pattern ((ApplyTT (ApplyTT Termination.length@tok
@x0)
@x1))
:qid token_correspondence_Termination.length))

:named token_correspondence_Termination.length))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(42,8-42,14); use=Termination.fst(42,8-42,14)
(forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType Termination.length@tok
Tm_arrow_05a4876c6cdcb2a170e6008dc4da5249))
...
@x1)
@x2)
(Termination.length @x1
@x2))
 

:pattern ((Termination.length @x1
@x2))
:qid function_token_typing_Termination.length.1))
)
 

:pattern ((ApplyTT @x0
Termination.length@tok))
:qid function_token_typing_Termination.length))

:named function_token_typing_Termination.length))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(42,8-42,14); use=Termination.fst(42,8-42,14)
...
Tm_type)
(HasType @x1
(Tm_refine_67fc396c2c954defeb64f6f73ae5e493 @x0)))
(HasType (Termination.length @x0
@x1)
Prims.nat))
 

:pattern ((Termination.length @x0
@x1))
:qid typing_Termination.length))

:named typing_Termination.length))
(declare-fun label_3 () Bool)
(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)
...
;             b == any_result ==>
;             (forall (any_result: Prims.nat).
;                 Termination.length b == any_result ==>
;                 (forall (return_val: Prims.nat).
;                     return_val == Termination.length b ==>
;                     Termination.length b == return_val ==>
;                     (forall (any_result: Prims.int).
;                         1 + Termination.length b == any_result ==> 1 + Termination.length b >= 0))))
;     ))
...
;; def=Prims.fst(402,27-402,88); use=Termination.fst(42,19-44,26)
(forall ((@x1 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=Termination.fst(42,19-44,26)
(Valid 
;; def=Prims.fst(402,84-402,87); use=Termination.fst(42,19-44,26)
(ApplyTT @x0
@x1)
...
;; def=Prims.fst(459,77-459,89); use=Termination.fst(42,19-44,26)
(and (implies 
;; def=Termination.fst(42,15-42,16); use=Termination.fst(42,25-42,26)
(and 
;; def=Termination.fst(42,15-42,16); use=Termination.fst(42,25-42,26)
(not 
;; def=Termination.fst(42,15-42,16); use=Termination.fst(42,25-42,26)
...
label_1)
(implies 
;; def=Prims.fst(389,19-389,21); use=Termination.fst(42,19-44,26)
(not 
;; def=Termination.fst(42,15-42,16); use=Termination.fst(42,25-42,26)
(BoxBool_proj_0 (Prims.uu___is_Nil x_fe28d8bcde588226b4e538b35321de05_1
x_0a56e3de562c08d8ab59f4ac6f626a98_2))
...
;; def=Prims.fst(413,99-413,120); use=Termination.fst(42,19-44,26)
(forall ((@x1 Term))
 (! (implies (HasType @x1
...
;; def=Termination.fst(42,15-44,9); use=Termination.fst(42,25-44,9)
(= x_0a56e3de562c08d8ab59f4ac6f626a98_2
...
;; def=Prims.fst(459,77-459,89); use=Termination.fst(42,19-44,26)
(and 
;; def=Termination.fst(42,19-44,26); use=Termination.fst(44,24-44,26)
(or label_2
...
;; def=Prims.fst(451,66-451,102); use=Termination.fst(42,19-44,26)
(forall ((@x3 Term))
 (! (implies (and (HasType @x3
(Prims.list x_fe28d8bcde588226b4e538b35321de05_1))

;; def=dummy(0,0-0,0); use=Termination.fst(42,19-44,26)
(= @x2
@x3)
)
...
;; def=Termination.fst(41,27-44,26); use=Termination.fst(44,17-44,26)
(= (Termination.length x_fe28d8bcde588226b4e538b35321de05_1
@x2)
@x4)
)

;; def=Prims.fst(356,2-356,58); use=Termination.fst(42,19-44,26)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
Prims.nat)

;; def=Prims.fst(356,26-356,41); use=Termination.fst(42,19-44,26)
(= @x5
(Termination.length x_fe28d8bcde588226b4e538b35321de05_1
@x2))
...
;; def=Termination.fst(41,27-44,26); use=Termination.fst(42,19-44,26)
...
;; def=Prims.fst(680,18-680,24); use=Termination.fst(44,13-44,26)
(or label_3
...
;;;;;;;;;;;;;;;;Fuel-instrumented function name
(declare-fun Termination.length.fuel_instrumented (Fuel Term Term) Term)
;;;;;;;;;;;;;;;;Token for fuel-instrumented partial applications
(declare-fun Termination.length.fuel_instrumented_token () Term)
(declare-fun Termination.length (Term Term) Term)
(declare-fun Termination.length@tok () Term)
...
; encoding sigelt val Termination.half_length


; <Skipped val Termination.half_length/>
...
; Starting query at Termination.fst(47,24-50,34)
...
(Prims.list x_fe28d8bcde588226b4e538b35321de05_1))
:named binder_x_0a56e3de562c08d8ab59f4ac6f626a98_2))
(declare-fun Tm_refine_d18e0d244faabf8886f70085ff25935c (Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(47,24-50,34); use=Termination.fst(47,24-50,34)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_d18e0d244faabf8886f70085ff25935c @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_d18e0d244faabf8886f70085ff25935c @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_d18e0d244faabf8886f70085ff25935c))

:named refinement_kinding_Tm_refine_d18e0d244faabf8886f70085ff25935c))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(47,24-50,34); use=Termination.fst(47,24-50,34)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_d18e0d244faabf8886f70085ff25935c @x2))
(and (HasTypeFuel @u0
@x1
(Prims.list @x2))
...
@x1
(Tm_refine_d18e0d244faabf8886f70085ff25935c @x2)))
:qid refinement_interpretation_Tm_refine_d18e0d244faabf8886f70085ff25935c))

:named refinement_interpretation_Tm_refine_d18e0d244faabf8886f70085ff25935c))
;;;;;;;;;;;;;;;;haseq for Tm_refine_d18e0d244faabf8886f70085ff25935c
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(47,24-50,34); use=Termination.fst(47,24-50,34)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_d18e0d244faabf8886f70085ff25935c @x0)))
(Valid (Prims.hasEq (Prims.list @x0))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_d18e0d244faabf8886f70085ff25935c @x0))))
:qid haseqTm_refine_d18e0d244faabf8886f70085ff25935c))

:named haseqTm_refine_d18e0d244faabf8886f70085ff25935c))
(declare-fun Termination.half_length (Term Term) Term)

;;;;;;;;;;;;;;;;_: _: Prims.list 'a {_ << l} -> Prims.nat
(declare-fun Tm_arrow_541ea33aebb9269d172c282cbf227581 () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_541ea33aebb9269d172c282cbf227581
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_541ea33aebb9269d172c282cbf227581
Tm_type)
:named kinding_Tm_arrow_541ea33aebb9269d172c282cbf227581))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(46,22-50,34); use=Termination.fst(47,8-50,34)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_541ea33aebb9269d172c282cbf227581)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_541ea33aebb9269d172c282cbf227581))
:qid Termination_pre_typing_Tm_arrow_541ea33aebb9269d172c282cbf227581))

:named Termination_pre_typing_Tm_arrow_541ea33aebb9269d172c282cbf227581))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_541ea33aebb9269d172c282cbf227581
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(46,22-50,34); use=Termination.fst(47,8-50,34)
(forall ((@x0 Term))
...
Tm_type)
(HasType @x2
(Tm_refine_d18e0d244faabf8886f70085ff25935c @x1)))
(HasType (ApplyTT (ApplyTT @x0
@x1)
@x2)
Prims.nat))
...
@x1)
@x2))
:qid Termination_interpretation_Tm_arrow_541ea33aebb9269d172c282cbf227581.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid Termination_interpretation_Tm_arrow_541ea33aebb9269d172c282cbf227581.2))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_541ea33aebb9269d172c282cbf227581))
:qid Termination_interpretation_Tm_arrow_541ea33aebb9269d172c282cbf227581))

:named Termination_interpretation_Tm_arrow_541ea33aebb9269d172c282cbf227581))
(declare-fun Termination.half_length@tok () Term)
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(47,8-47,19); use=Termination.fst(47,8-47,19)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (ApplyTT Termination.half_length@tok
@x0)
@x1)
(Termination.half_length @x0
@x1))
 

:pattern ((ApplyTT (ApplyTT Termination.half_length@tok
@x0)
@x1))
:qid token_correspondence_Termination.half_length))

:named token_correspondence_Termination.half_length))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(47,8-47,19); use=Termination.fst(47,8-47,19)
(forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType Termination.half_length@tok
Tm_arrow_541ea33aebb9269d172c282cbf227581))
...
@x1)
@x2)
(Termination.half_length @x1
@x2))
 

:pattern ((Termination.half_length @x1
@x2))
:qid function_token_typing_Termination.half_length.1))
)
 

:pattern ((ApplyTT @x0
Termination.half_length@tok))
:qid function_token_typing_Termination.half_length))

:named function_token_typing_Termination.half_length))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(47,8-47,19); use=Termination.fst(47,8-47,19)
...
Tm_type)
(HasType @x1
(Tm_refine_d18e0d244faabf8886f70085ff25935c @x0)))
(HasType (Termination.half_length @x0
@x1)
Prims.nat))
 

:pattern ((Termination.half_length @x0
@x1))
:qid typing_Termination.half_length))

:named typing_Termination.half_length))
(declare-fun label_3 () Bool)
(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)
...
; Encoding query formula : forall (k: Prims.pure_post Prims.nat).
;   (forall (x: Prims.nat). {:pattern Prims.guard_free (k x)} Prims.auto_squash (k x)) ==>
;   (~(Nil? l) /\ ~(Cons? l && Nil? l.tl) /\ ~(Cons? l && Cons? l.tl) ==> Prims.l_False) /\
;   (~(Nil? l) ==>
;     ~(Cons? l && Nil? l.tl) ==>
;     (forall (b: 'a) (b: 'a) (b: Prims.list 'a).
;         l == b :: b :: b ==>
;         b << l /\
;         (forall (any_result: Prims.list 'a).
;             b == any_result ==>
;             (forall (any_result: Prims.nat).
;                 Termination.half_length b == any_result ==>
;                 (forall (return_val: Prims.nat).
;                     return_val == Termination.half_length b ==>
;                     Termination.half_length b == return_val ==>
;                     (forall (any_result: Prims.int).
;                         1 + Termination.half_length b == any_result ==>
;                         1 + Termination.half_length b >= 0))))))


; Context: While encoding a query
; While typechecking the top-level declaration `let rec half_length`
...
;; def=Prims.fst(402,27-402,88); use=Termination.fst(47,24-50,34)
(forall ((@x1 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=Termination.fst(47,24-50,34)
(Valid 
;; def=Prims.fst(402,84-402,87); use=Termination.fst(47,24-50,34)
(ApplyTT @x0
@x1)
...
;; def=Prims.fst(459,77-459,89); use=Termination.fst(47,24-50,34)
(and (implies 
;; def=Termination.fst(47,20-50,34); use=Termination.fst(47,24-50,34)
(and 
;; def=Termination.fst(47,20-47,21); use=Termination.fst(47,30-47,31)
(not 
;; def=Termination.fst(47,20-47,21); use=Termination.fst(47,30-47,31)
(BoxBool_proj_0 (Prims.uu___is_Nil x_fe28d8bcde588226b4e538b35321de05_1
x_0a56e3de562c08d8ab59f4ac6f626a98_2))
...
label_1)
(implies 
;; def=Prims.fst(389,18-389,39); use=Termination.fst(47,24-50,34)
(and 
;; def=Prims.fst(389,19-389,21); use=Termination.fst(47,24-50,34)
(not 
;; def=Termination.fst(47,20-47,21); use=Termination.fst(47,30-47,31)
(BoxBool_proj_0 (Prims.uu___is_Nil x_fe28d8bcde588226b4e538b35321de05_1
x_0a56e3de562c08d8ab59f4ac6f626a98_2))
...
;; def=Prims.fst(413,99-413,120); use=Termination.fst(47,24-50,34)
(forall ((@x1 Term))
 (! (implies (HasType @x1
x_fe28d8bcde588226b4e538b35321de05_1)
...
;; def=Termination.fst(47,20-50,12); use=Termination.fst(47,30-50,12)
(= x_0a56e3de562c08d8ab59f4ac6f626a98_2
(Prims.Cons x_fe28d8bcde588226b4e538b35321de05_1
@x1
(Prims.Cons x_fe28d8bcde588226b4e538b35321de05_1
...
;; def=Prims.fst(459,77-459,89); use=Termination.fst(47,24-50,34)
(and 
;; def=Termination.fst(47,24-50,34); use=Termination.fst(50,32-50,34)
(or label_2
...
;; def=Prims.fst(451,66-451,102); use=Termination.fst(47,24-50,34)
(forall ((@x4 Term))
 (! (implies (and (HasType @x4
(Prims.list x_fe28d8bcde588226b4e538b35321de05_1))

;; def=dummy(0,0-0,0); use=Termination.fst(47,24-50,34)
(= @x3
@x4)
)
...
;; def=Termination.fst(46,32-50,34); use=Termination.fst(50,20-50,34)
(= (Termination.half_length x_fe28d8bcde588226b4e538b35321de05_1
@x3)
@x5)
)

;; def=Prims.fst(356,2-356,58); use=Termination.fst(47,24-50,34)
(forall ((@x6 Term))
 (! (implies (and (HasType @x6
Prims.nat)

;; def=Prims.fst(356,26-356,41); use=Termination.fst(47,24-50,34)
(= @x6
(Termination.half_length x_fe28d8bcde588226b4e538b35321de05_1
@x3))
...
;; def=Termination.fst(46,32-50,34); use=Termination.fst(47,24-50,34)
(= (Prims.op_Addition (BoxInt 1)
(Termination.half_length x_fe28d8bcde588226b4e538b35321de05_1
@x3))
@x7)
...
;; def=Prims.fst(680,18-680,24); use=Termination.fst(50,16-50,34)
(or label_3
...
; encoding sigelt let rec half_length


; <Start encoding let rec half_length>

;;;;;;;;;;;;;;;;Fuel-instrumented function name
(declare-fun Termination.half_length.fuel_instrumented (Fuel Term Term) Term)
;;;;;;;;;;;;;;;;Token for fuel-instrumented partial applications
(declare-fun Termination.half_length.fuel_instrumented_token () Term)
(declare-fun Termination.half_length (Term Term) Term)
(declare-fun Termination.half_length@tok () Term)


; </end encoding let rec half_length>


; encoding sigelt val Termination.sumto


; <Skipped val Termination.sumto/>

(push) ;; push{2

; Starting query at Termination.fst(56,2-58,26)
...
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(54,23-54,36); use=Termination.fst(55,8-55,13)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
...
;; def=Termination.fst(54,29-54,35); use=Termination.fst(55,8-55,13)
(<= (BoxInt_proj_0 @x1)
...
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(54,23-54,47); use=Termination.fst(55,8-55,13)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
...
@x1
Tm_arrow_2829e6db9e17263f6b653060a4e4f6c3))
:qid Termination_pre_typing_Tm_arrow_2829e6db9e17263f6b653060a4e4f6c3))

:named Termination_pre_typing_Tm_arrow_2829e6db9e17263f6b653060a4e4f6c3))
...
:pattern ((ApplyTT @x0
@x1))
:qid Termination_interpretation_Tm_arrow_2829e6db9e17263f6b653060a4e4f6c3.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_2829e6db9e17263f6b653060a4e4f6c3))
:qid Termination_interpretation_Tm_arrow_2829e6db9e17263f6b653060a4e4f6c3))

:named Termination_interpretation_Tm_arrow_2829e6db9e17263f6b653060a4e4f6c3))
...
@x1
(Tm_arrow_9f4e67be58ddd3d74556be910c8a21e9 @x2)))
:qid Termination_pre_typing_Tm_arrow_9f4e67be58ddd3d74556be910c8a21e9))

:named Termination_pre_typing_Tm_arrow_9f4e67be58ddd3d74556be910c8a21e9))
...
:pattern ((ApplyTT @x0
@x2))
:qid Termination_interpretation_Tm_arrow_9f4e67be58ddd3d74556be910c8a21e9.1))
...
:pattern ((HasTypeZ @x0
(Tm_arrow_9f4e67be58ddd3d74556be910c8a21e9 @x1)))
:qid Termination_interpretation_Tm_arrow_9f4e67be58ddd3d74556be910c8a21e9))

:named Termination_interpretation_Tm_arrow_9f4e67be58ddd3d74556be910c8a21e9))
(declare-fun Tm_refine_914ccfd849c10f9fa187fe6e0e1eca14 (Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(54,20-58,26); use=Termination.fst(54,20-58,26)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_914ccfd849c10f9fa187fe6e0e1eca14 @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_914ccfd849c10f9fa187fe6e0e1eca14 @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_914ccfd849c10f9fa187fe6e0e1eca14))

:named refinement_kinding_Tm_refine_914ccfd849c10f9fa187fe6e0e1eca14))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(54,20-58,26); use=Termination.fst(54,20-58,26)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_914ccfd849c10f9fa187fe6e0e1eca14 @x2))
(and (HasTypeFuel @u0
@x1
(Tm_arrow_9f4e67be58ddd3d74556be910c8a21e9 @x2))

;; def=Termination.fst(56,2-58,26); use=Termination.fst(56,2-58,26)
...
@x1
(Tm_refine_914ccfd849c10f9fa187fe6e0e1eca14 @x2)))
:qid refinement_interpretation_Tm_refine_914ccfd849c10f9fa187fe6e0e1eca14))

:named refinement_interpretation_Tm_refine_914ccfd849c10f9fa187fe6e0e1eca14))
;;;;;;;;;;;;;;;;haseq for Tm_refine_914ccfd849c10f9fa187fe6e0e1eca14
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(54,20-58,26); use=Termination.fst(54,20-58,26)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_914ccfd849c10f9fa187fe6e0e1eca14 @x0)))
(Valid (Prims.hasEq (Tm_arrow_9f4e67be58ddd3d74556be910c8a21e9 @x0))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_914ccfd849c10f9fa187fe6e0e1eca14 @x0))))
:qid haseqTm_refine_914ccfd849c10f9fa187fe6e0e1eca14))

:named haseqTm_refine_914ccfd849c10f9fa187fe6e0e1eca14))
(declare-fun Termination.sumto (Term Term) Term)



;;;;;;;;;;;;;;;;i: Prims.nat -> f: (x: Prims.nat{x <= i} -> Prims.nat){i << i} -> Prims.nat
(declare-fun Tm_arrow_b55724be6c7f830d009cf953e506ab6b () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_b55724be6c7f830d009cf953e506ab6b
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_b55724be6c7f830d009cf953e506ab6b
Tm_type)
:named kinding_Tm_arrow_b55724be6c7f830d009cf953e506ab6b))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(54,13-58,26); use=Termination.fst(54,20-58,26)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_b55724be6c7f830d009cf953e506ab6b)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_b55724be6c7f830d009cf953e506ab6b))
:qid Termination_pre_typing_Tm_arrow_b55724be6c7f830d009cf953e506ab6b))

:named Termination_pre_typing_Tm_arrow_b55724be6c7f830d009cf953e506ab6b))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_b55724be6c7f830d009cf953e506ab6b
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(54,13-58,26); use=Termination.fst(54,20-58,26)
(forall ((@x0 Term))
...
Prims.nat)
(HasType @x2
(Tm_refine_914ccfd849c10f9fa187fe6e0e1eca14 @x1)))
(HasType (ApplyTT (ApplyTT @x0
@x1)
@x2)
Prims.nat))
...
@x1)
@x2))
:qid Termination_interpretation_Tm_arrow_b55724be6c7f830d009cf953e506ab6b.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid Termination_interpretation_Tm_arrow_b55724be6c7f830d009cf953e506ab6b.2))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_b55724be6c7f830d009cf953e506ab6b))
:qid Termination_interpretation_Tm_arrow_b55724be6c7f830d009cf953e506ab6b))

:named Termination_interpretation_Tm_arrow_b55724be6c7f830d009cf953e506ab6b))
(declare-fun Termination.sumto@tok () Term)
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(55,8-55,13); use=Termination.fst(55,8-55,13)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (ApplyTT Termination.sumto@tok
@x0)
@x1)
(Termination.sumto @x0
@x1))
 

:pattern ((ApplyTT (ApplyTT Termination.sumto@tok
@x0)
@x1))
:qid token_correspondence_Termination.sumto))

:named token_correspondence_Termination.sumto))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(55,8-55,13); use=Termination.fst(55,8-55,13)
...
@x1)
@x2)
(Termination.sumto @x1
@x2))
 

:pattern ((Termination.sumto @x1
@x2))
:qid function_token_typing_Termination.sumto.1))
)
 

:pattern ((ApplyTT @x0
Termination.sumto@tok))
:qid function_token_typing_Termination.sumto))

:named function_token_typing_Termination.sumto))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(55,8-55,13); use=Termination.fst(55,8-55,13)
...
Prims.nat)
(HasType @x1
(Tm_refine_914ccfd849c10f9fa187fe6e0e1eca14 @x0)))
(HasType (Termination.sumto @x0
@x1)
Prims.nat))
 

:pattern ((Termination.sumto @x0
@x1))
:qid typing_Termination.sumto))

:named typing_Termination.sumto))
(declare-fun label_6 () Bool)
(declare-fun label_5 () Bool)
(declare-fun label_4 () Bool)
(declare-fun label_3 () Bool)
...
;                             f == any_result ==>
;                             (forall (any_result: Prims.nat).
;                                 Termination.sumto (i - 1) f == any_result ==>
;                                 (forall (return_val: Prims.nat).
;                                     return_val == Termination.sumto (i - 1) f ==>
;                                     Termination.sumto (i - 1) f == return_val ==>
;                                     (forall (any_result: Prims.int).
;                                         f i + Termination.sumto (i - 1) f == any_result ==>
;                                         f i + Termination.sumto (i - 1) f >= 0))))))))))
...
;; def=Prims.fst(402,27-402,88); use=Termination.fst(56,2-58,26)
(forall ((@x1 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=Termination.fst(56,2-58,26)
(Valid 
;; def=Prims.fst(402,84-402,87); use=Termination.fst(56,2-58,26)
(ApplyTT @x0
@x1)
...
;; def=Prims.fst(389,2-389,39); use=Termination.fst(56,2-58,26)
(and (implies 
;; def=Termination.fst(56,5-56,10); use=Termination.fst(56,5-56,10)
(= (Prims.op_Equality Prims.int
x_bb4e1c9af0265270f8e7a5f250f730e2_0
(BoxInt 0))
(BoxBool true))
...
;; def=Termination.fst(54,29-54,35); use=Termination.fst(57,9-57,10)
(or label_1
...
(implies 
;; def=Prims.fst(389,19-389,21); use=Termination.fst(56,2-58,26)
(not 
;; def=Termination.fst(56,5-56,10); use=Termination.fst(56,5-56,10)
(= (Prims.op_Equality Prims.int
x_bb4e1c9af0265270f8e7a5f250f730e2_0
...
;; def=Prims.fst(413,99-413,120); use=Termination.fst(56,2-58,26)
(forall ((@x1 Term))
 (! (implies (and (HasType @x1
Prims.bool)

;; def=Termination.fst(56,5-58,26); use=Termination.fst(56,5-58,26)
(= (Prims.op_Equality Prims.int
x_bb4e1c9af0265270f8e7a5f250f730e2_0
(BoxInt 0))
@x1)
...
;; def=Prims.fst(459,77-459,89); use=Termination.fst(56,2-58,26)
(and 
;; def=Termination.fst(54,29-54,35); use=Termination.fst(58,9-58,10)
(or label_2
...
;; def=Prims.fst(451,66-451,102); use=Termination.fst(56,2-58,26)
(forall ((@x2 Term))
 (! (implies (and (HasType @x2
Prims.nat)

;; def=Termination.fst(54,23-55,15); use=Termination.fst(56,2-58,26)
(= x_bb4e1c9af0265270f8e7a5f250f730e2_0
@x2)
)
...
;; def=Termination.fst(54,44-58,10); use=Termination.fst(58,7-58,10)
(= (ApplyTT x_b749b2a4dc34f4afe39604e45e98a00b_1
x_bb4e1c9af0265270f8e7a5f250f730e2_0)
@x3)
)

;; def=Prims.fst(356,2-356,58); use=Termination.fst(56,2-58,26)
(forall ((@x4 Term))
 (! (implies (and (HasType @x4
Prims.nat)

;; def=Prims.fst(356,26-356,41); use=Termination.fst(56,2-58,26)
(= @x4
(ApplyTT x_b749b2a4dc34f4afe39604e45e98a00b_1
x_bb4e1c9af0265270f8e7a5f250f730e2_0))


;; def=dummy(0,0-0,0); use=Termination.fst(56,2-58,26)
(= (ApplyTT x_b749b2a4dc34f4afe39604e45e98a00b_1
x_bb4e1c9af0265270f8e7a5f250f730e2_0)
@x4)
)
...
;; def=Prims.fst(459,77-459,89); use=Termination.fst(56,2-58,26)
(and 
;; def=Prims.fst(680,18-680,24); use=Termination.fst(58,19-58,24)
(or label_3
...
;; def=Prims.fst(459,77-459,89); use=Termination.fst(56,2-58,26)
(and 
;; def=dummy(0,0-0,0); use=Termination.fst(58,25-58,26)
(forall ((@x6 Term))
 (! (implies (and (HasType @x6
Prims.nat)

;; def=Termination.fst(54,29-54,35); use=Termination.fst(58,25-58,26)
(<= (BoxInt_proj_0 @x6)
(BoxInt_proj_0 (Prims.op_Subtraction x_bb4e1c9af0265270f8e7a5f250f730e2_0
(BoxInt 1))))
)
...
;; def=Termination.fst(56,2-58,26); use=Termination.fst(58,25-58,26)
(or label_5
...
;; def=Termination.fst(54,20-55,17); use=Termination.fst(56,2-58,26)
...
;; def=Termination.fst(54,56-58,26); use=Termination.fst(58,13-58,26)
(= (Termination.sumto (Prims.op_Subtraction x_bb4e1c9af0265270f8e7a5f250f730e2_0
(BoxInt 1))
x_b749b2a4dc34f4afe39604e45e98a00b_1)
@x7)
)
...
;; def=Termination.fst(54,56-58,26); use=Termination.fst(56,2-58,26)
...
;; def=Prims.fst(680,18-680,24); use=Termination.fst(58,7-58,26)
(or label_6
...
;;;;;;;;;;;;;;;;Fuel-instrumented function name
(declare-fun Termination.sumto.fuel_instrumented (Fuel Term Term) Term)
;;;;;;;;;;;;;;;;Token for fuel-instrumented partial applications
(declare-fun Termination.sumto.fuel_instrumented_token () Term)
(declare-fun Termination.sumto (Term Term) Term)
(declare-fun Termination.sumto@tok () Term)
(declare-fun Tm_refine_7e0b9b2dbca36eab00de093c1b701c6d (Term) Term)
;;;;;;;;;;;;;;;;x: Prims.nat{x <= i} -> Prims.nat
...
; encoding sigelt val Termination.strangeZero


; <Skipped val Termination.strangeZero/>

(push) ;; push{2

; Starting query at Termination.fst(62,2-64,30)
...
Prims.nat)
:named binder_x_bb4e1c9af0265270f8e7a5f250f730e2_0))
(declare-fun Tm_refine_cd3b5f863adcae23e84080daccc2795d () Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! (HasType Tm_refine_cd3b5f863adcae23e84080daccc2795d
Tm_type)
:named refinement_kinding_Tm_refine_cd3b5f863adcae23e84080daccc2795d))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(62,2-64,30); use=Termination.fst(62,2-64,30)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_cd3b5f863adcae23e84080daccc2795d)
(and (HasTypeFuel @u0
@x1
Prims.nat)
...
@x1
Tm_refine_cd3b5f863adcae23e84080daccc2795d))
:qid refinement_interpretation_Tm_refine_cd3b5f863adcae23e84080daccc2795d))

:named refinement_interpretation_Tm_refine_cd3b5f863adcae23e84080daccc2795d))
;;;;;;;;;;;;;;;;haseq for Tm_refine_cd3b5f863adcae23e84080daccc2795d
;;; Fact-ids: 
(assert (! (iff (Valid (Prims.hasEq Tm_refine_cd3b5f863adcae23e84080daccc2795d))
(Valid (Prims.hasEq Prims.nat)))
:named haseqTm_refine_cd3b5f863adcae23e84080daccc2795d))
(declare-fun Termination.strangeZero (Term) Term)

;;;;;;;;;;;;;;;;_: _: Prims.nat{_ << v} -> Prims.nat
(declare-fun Tm_arrow_a6d28189e523310deecae31370b1649f () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_a6d28189e523310deecae31370b1649f
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_a6d28189e523310deecae31370b1649f
Tm_type)
:named kinding_Tm_arrow_a6d28189e523310deecae31370b1649f))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(60,28-64,30); use=Termination.fst(61,8-64,30)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_a6d28189e523310deecae31370b1649f)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_a6d28189e523310deecae31370b1649f))
:qid Termination_pre_typing_Tm_arrow_a6d28189e523310deecae31370b1649f))

:named Termination_pre_typing_Tm_arrow_a6d28189e523310deecae31370b1649f))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_a6d28189e523310deecae31370b1649f
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(60,28-64,30); use=Termination.fst(61,8-64,30)
(forall ((@x0 Term))
...
:pattern ((ApplyTT @x0
@x1))
:qid Termination_interpretation_Tm_arrow_a6d28189e523310deecae31370b1649f.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_a6d28189e523310deecae31370b1649f))
:qid Termination_interpretation_Tm_arrow_a6d28189e523310deecae31370b1649f))

:named Termination_interpretation_Tm_arrow_a6d28189e523310deecae31370b1649f))
(declare-fun Termination.strangeZero@tok () Term)
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(61,8-61,19); use=Termination.fst(61,8-61,19)
(forall ((@x0 Term))
 (! (= (ApplyTT Termination.strangeZero@tok
@x0)
(Termination.strangeZero @x0))
 

:pattern ((ApplyTT Termination.strangeZero@tok
@x0))
:qid token_correspondence_Termination.strangeZero))

:named token_correspondence_Termination.strangeZero))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(61,8-61,19); use=Termination.fst(61,8-61,19)
(forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType Termination.strangeZero@tok
Tm_arrow_a6d28189e523310deecae31370b1649f))
...
(forall ((@x1 Term))
 (! (= (ApplyTT Termination.strangeZero@tok
@x1)
(Termination.strangeZero @x1))
 

:pattern ((Termination.strangeZero @x1))
:qid function_token_typing_Termination.strangeZero.1))
)
 

:pattern ((ApplyTT @x0
Termination.strangeZero@tok))
:qid function_token_typing_Termination.strangeZero))

:named function_token_typing_Termination.strangeZero))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(61,8-61,19); use=Termination.fst(61,8-61,19)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_refine_cd3b5f863adcae23e84080daccc2795d)
(HasType (Termination.strangeZero @x0)
Prims.nat))
 

:pattern ((Termination.strangeZero @x0))
:qid typing_Termination.strangeZero))

:named typing_Termination.strangeZero))
(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)
...
;       v - 1 >= 0 /\
;       (forall (return_val: Prims.nat).
;           return_val == v - 1 ==> (forall (x: Prims.nat). x <= v - 1 ==> x << v)))


; Context: While encoding a query
; While typechecking the top-level declaration `let rec strangeZero`
...
;; def=Prims.fst(402,27-402,88); use=Termination.fst(62,2-64,30)
(forall ((@x1 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=Termination.fst(62,2-64,30)
(Valid 
;; def=Prims.fst(402,84-402,87); use=Termination.fst(62,2-64,30)
(ApplyTT @x0
@x1)
...
;; def=Prims.fst(389,19-389,21); use=Termination.fst(62,2-64,30)
(not 
;; def=Termination.fst(62,5-62,10); use=Termination.fst(62,5-62,10)
(= (Prims.op_Equality Prims.int
x_bb4e1c9af0265270f8e7a5f250f730e2_0
(BoxInt 0))
(BoxBool true))
...
;; def=Prims.fst(413,99-413,120); use=Termination.fst(62,2-64,30)
(forall ((@x1 Term))
 (! (implies (and (HasType @x1
Prims.bool)

;; def=Termination.fst(62,5-64,30); use=Termination.fst(62,5-64,30)
(= (Prims.op_Equality Prims.int
x_bb4e1c9af0265270f8e7a5f250f730e2_0
(BoxInt 0))
@x1)
...
;; def=Prims.fst(459,77-459,89); use=Termination.fst(62,2-64,30)
(and 
;; def=Prims.fst(680,18-680,24); use=Termination.fst(64,13-64,18)
(or label_1
...
;; def=Prims.fst(356,2-356,58); use=Termination.fst(62,2-64,30)
(forall ((@x2 Term))
 (! (implies (and (HasType @x2
Prims.nat)

;; def=Prims.fst(356,26-356,41); use=Termination.fst(62,2-64,30)
(= @x2
(Prims.op_Subtraction x_bb4e1c9af0265270f8e7a5f250f730e2_0
(BoxInt 1)))
)

;; def=dummy(0,0-0,0); use=Termination.fst(64,19-64,30)
(forall ((@x3 Term))
 (! (implies (and (HasType @x3
Prims.nat)

;; def=Termination.fst(54,29-54,35); use=Termination.fst(64,19-64,30)
(<= (BoxInt_proj_0 @x3)
(BoxInt_proj_0 (Prims.op_Subtraction x_bb4e1c9af0265270f8e7a5f250f730e2_0
(BoxInt 1))))
)

;; def=Termination.fst(62,2-64,30); use=Termination.fst(64,19-64,30)
(or label_2
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Termination.strangeZero, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, binder_x_bb4e1c9af0265270f8e7a5f250f730e2_0, equation_Prims.nat, int_inversion, primitive_Prims.op_Equality, primitive_Prims.op_Subtraction, projection_inverse_BoxInt_proj_0, refinement_interpretation_Tm_refine_542f9d4f129664613f2483a6c88bc7c2, well-founded-ordering-on-nat
...
; encoding sigelt let rec strangeZero


; <Start encoding let rec strangeZero>

;;;;;;;;;;;;;;;;Fuel-instrumented function name
(declare-fun Termination.strangeZero.fuel_instrumented (Fuel Term) Term)
;;;;;;;;;;;;;;;;Token for fuel-instrumented partial applications
(declare-fun Termination.strangeZero.fuel_instrumented_token () Term)
(declare-fun Termination.strangeZero (Term) Term)
(declare-fun Termination.strangeZero@tok () Term)


; </end encoding let rec strangeZero>


; encoding sigelt val Termination.map


; <Skipped val Termination.map/>
...
; Starting query at Termination.fst(69,18-71,28)
...
;;;;;;;;;;;;;;;;'b : Type (Type)
(declare-fun x_fe28d8bcde588226b4e538b35321de05_3 () Term)
;;;;;;;;;;;;;;;;binder_x_fe28d8bcde588226b4e538b35321de05_3
;;; Fact-ids: 
(assert (! (HasType x_fe28d8bcde588226b4e538b35321de05_3
Tm_type)
:named binder_x_fe28d8bcde588226b4e538b35321de05_3))
;;;;;;;;;;;;;;;;f : _: 'a -> 'b (_: 'a -> 'b)
(declare-fun x_57af2c0907f883669f14a9b761d251ac_4 () Term)
;;;;;;;;;;;;;;;;_: 'a -> 'b
(declare-fun Tm_arrow_f0e39fda591bb23469f07b4ffb1ad647 () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_f0e39fda591bb23469f07b4ffb1ad647
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_f0e39fda591bb23469f07b4ffb1ad647
Tm_type)
:named kinding_Tm_arrow_f0e39fda591bb23469f07b4ffb1ad647))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(69,12-69,13); use=Termination.fst(69,12-69,13)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_f0e39fda591bb23469f07b4ffb1ad647)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_f0e39fda591bb23469f07b4ffb1ad647))
:qid Termination_pre_typing_Tm_arrow_f0e39fda591bb23469f07b4ffb1ad647))

:named Termination_pre_typing_Tm_arrow_f0e39fda591bb23469f07b4ffb1ad647))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_f0e39fda591bb23469f07b4ffb1ad647
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(69,12-69,13); use=Termination.fst(69,12-69,13)
(forall ((@x0 Term))
...
(HasType (ApplyTT @x0
@x1)
x_fe28d8bcde588226b4e538b35321de05_3))
 

:pattern ((ApplyTT @x0
@x1))
:qid Termination_interpretation_Tm_arrow_f0e39fda591bb23469f07b4ffb1ad647.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_f0e39fda591bb23469f07b4ffb1ad647))
:qid Termination_interpretation_Tm_arrow_f0e39fda591bb23469f07b4ffb1ad647))

:named Termination_interpretation_Tm_arrow_f0e39fda591bb23469f07b4ffb1ad647))
;;;;;;;;;;;;;;;;binder_x_57af2c0907f883669f14a9b761d251ac_4
;;; Fact-ids: 
(assert (! (HasType x_57af2c0907f883669f14a9b761d251ac_4
Tm_arrow_f0e39fda591bb23469f07b4ffb1ad647)
:named binder_x_57af2c0907f883669f14a9b761d251ac_4))
;;;;;;;;;;;;;;;;l : Prims.list 'a (Prims.list 'a)
(declare-fun x_3dddec8ced2db740e4e8aaf70542be7a_5 () Term)
;;;;;;;;;;;;;;;;binder_x_3dddec8ced2db740e4e8aaf70542be7a_5
;;; Fact-ids: 
(assert (! (HasType x_3dddec8ced2db740e4e8aaf70542be7a_5
(Prims.list x_fe28d8bcde588226b4e538b35321de05_2))
:named binder_x_3dddec8ced2db740e4e8aaf70542be7a_5))

(declare-fun Tm_refine_22c1fea83e0b0694f54f9736b1f7f13d (Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(69,18-71,28); use=Termination.fst(69,18-71,28)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_22c1fea83e0b0694f54f9736b1f7f13d @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_22c1fea83e0b0694f54f9736b1f7f13d @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_22c1fea83e0b0694f54f9736b1f7f13d))

:named refinement_kinding_Tm_refine_22c1fea83e0b0694f54f9736b1f7f13d))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(69,18-71,28); use=Termination.fst(69,18-71,28)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_22c1fea83e0b0694f54f9736b1f7f13d @x2))
(and (HasTypeFuel @u0
@x1
(Prims.list @x2))
...
(Prims.list x_fe28d8bcde588226b4e538b35321de05_2)
@x1
x_3dddec8ced2db740e4e8aaf70542be7a_5)
)
...
@x1
(Tm_refine_22c1fea83e0b0694f54f9736b1f7f13d @x2)))
:qid refinement_interpretation_Tm_refine_22c1fea83e0b0694f54f9736b1f7f13d))

:named refinement_interpretation_Tm_refine_22c1fea83e0b0694f54f9736b1f7f13d))
;;;;;;;;;;;;;;;;haseq for Tm_refine_22c1fea83e0b0694f54f9736b1f7f13d
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(69,18-71,28); use=Termination.fst(69,18-71,28)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_22c1fea83e0b0694f54f9736b1f7f13d @x0)))
(Valid (Prims.hasEq (Prims.list @x0))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_22c1fea83e0b0694f54f9736b1f7f13d @x0))))
:qid haseqTm_refine_22c1fea83e0b0694f54f9736b1f7f13d))

:named haseqTm_refine_22c1fea83e0b0694f54f9736b1f7f13d))
(declare-fun Termination.map (Term Term Term Term) Term)


;;;;;;;;;;;;;;;;f: (_: 'a -> 'b) -> _: _: Prims.list 'a {_ << l} -> Prims.list 'b
(declare-fun Tm_arrow_95c9547c6b2d86f8bdbd6767862975ff () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_95c9547c6b2d86f8bdbd6767862975ff
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_95c9547c6b2d86f8bdbd6767862975ff
Tm_type)
:named kinding_Tm_arrow_95c9547c6b2d86f8bdbd6767862975ff))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(68,13-71,28); use=Termination.fst(68,13-71,28)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_95c9547c6b2d86f8bdbd6767862975ff)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_95c9547c6b2d86f8bdbd6767862975ff))
:qid Termination_pre_typing_Tm_arrow_95c9547c6b2d86f8bdbd6767862975ff))

:named Termination_pre_typing_Tm_arrow_95c9547c6b2d86f8bdbd6767862975ff))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_95c9547c6b2d86f8bdbd6767862975ff
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(68,13-71,28); use=Termination.fst(68,13-71,28)
(forall ((@x0 Term))
...
@x1))
(HasType @x4
(Tm_refine_22c1fea83e0b0694f54f9736b1f7f13d @x1)))
...
@x3)
@x4))
:qid Termination_interpretation_Tm_arrow_95c9547c6b2d86f8bdbd6767862975ff.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid Termination_interpretation_Tm_arrow_95c9547c6b2d86f8bdbd6767862975ff.2))
...
@x1)
@x2))
:qid Termination_interpretation_Tm_arrow_95c9547c6b2d86f8bdbd6767862975ff.3))
...
@x2)
@x3))
:qid Termination_interpretation_Tm_arrow_95c9547c6b2d86f8bdbd6767862975ff.4))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_95c9547c6b2d86f8bdbd6767862975ff))
:qid Termination_interpretation_Tm_arrow_95c9547c6b2d86f8bdbd6767862975ff))

:named Termination_interpretation_Tm_arrow_95c9547c6b2d86f8bdbd6767862975ff))
(declare-fun Termination.map@tok () Term)
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(69,8-69,11); use=Termination.fst(69,8-69,11)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (ApplyTT (ApplyTT (ApplyTT (ApplyTT Termination.map@tok
@x0)
@x1)
@x2)
@x3)
...
:pattern ((ApplyTT (ApplyTT (ApplyTT (ApplyTT Termination.map@tok
@x0)
@x1)
@x2)
@x3))
:qid token_correspondence_Termination.map))

:named token_correspondence_Termination.map))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(69,8-69,11); use=Termination.fst(69,8-69,11)
...
:pattern ((Termination.map @x1
@x2
@x3
@x4))
:qid function_token_typing_Termination.map.1))
)
 

:pattern ((ApplyTT @x0
Termination.map@tok))
:qid function_token_typing_Termination.map))

:named function_token_typing_Termination.map))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(69,8-69,11); use=Termination.fst(69,8-69,11)
...
@x0))
(HasType @x3
(Tm_refine_22c1fea83e0b0694f54f9736b1f7f13d @x0)))
(HasType (Termination.map @x0
@x1
@x2
@x3)
(Prims.list @x1)))
...
:pattern ((Termination.map @x0
@x1
@x2
@x3))
:qid typing_Termination.map))

:named typing_Termination.map))
(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)

; Encoding query formula : forall (k: Prims.pure_post (Prims.list 'b)).
;   (forall (x: Prims.list 'b). {:pattern Prims.guard_free (k x)} Prims.auto_squash (k x)) ==>
;   (~(Nil? l) /\ ~(Cons? l) ==> Prims.l_False) /\
;   (~(Nil? l) ==> (forall (b: 'a) (b: Prims.list 'a). l == b :: b ==> b << l))
...
(assert (! (not (forall ((@x0 Term))
 (! (implies (and (HasType @x0
(Prims.pure_post (Prims.list x_fe28d8bcde588226b4e538b35321de05_3)))

;; def=Prims.fst(402,27-402,88); use=Termination.fst(69,18-71,28)
(forall ((@x1 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=Termination.fst(69,18-71,28)
(Valid 
;; def=Prims.fst(402,84-402,87); use=Termination.fst(69,18-71,28)
(ApplyTT @x0
@x1)
...
;; def=Prims.fst(459,77-459,89); use=Termination.fst(69,18-71,28)
(and (implies 
;; def=Termination.fst(69,14-69,15); use=Termination.fst(69,24-69,25)
(and 
;; def=Termination.fst(69,14-69,15); use=Termination.fst(69,24-69,25)
(not 
;; def=Termination.fst(69,14-69,15); use=Termination.fst(69,24-69,25)
(BoxBool_proj_0 (Prims.uu___is_Nil x_fe28d8bcde588226b4e538b35321de05_2
x_3dddec8ced2db740e4e8aaf70542be7a_5))
)
...
(not 
;; def=Termination.fst(69,14-69,15); use=Termination.fst(69,24-69,25)
(BoxBool_proj_0 (Prims.uu___is_Cons x_fe28d8bcde588226b4e538b35321de05_2
x_3dddec8ced2db740e4e8aaf70542be7a_5))
)
)
...
label_1)
(implies 
;; def=Prims.fst(389,19-389,21); use=Termination.fst(69,18-71,28)
(not 
;; def=Termination.fst(69,14-69,15); use=Termination.fst(69,24-69,25)
(BoxBool_proj_0 (Prims.uu___is_Nil x_fe28d8bcde588226b4e538b35321de05_2
x_3dddec8ced2db740e4e8aaf70542be7a_5))
...
;; def=Prims.fst(413,99-413,120); use=Termination.fst(69,18-71,28)
(forall ((@x1 Term))
 (! (implies (HasType @x1
x_fe28d8bcde588226b4e538b35321de05_2)
...
;; def=Termination.fst(69,14-71,10); use=Termination.fst(69,24-71,10)
(= x_3dddec8ced2db740e4e8aaf70542be7a_5
(Prims.Cons x_fe28d8bcde588226b4e538b35321de05_2
@x1
@x2))
)

;; def=Termination.fst(69,18-71,28); use=Termination.fst(71,26-71,28)
(or label_2

;; def=Termination.fst(69,18-71,28); use=Termination.fst(71,26-71,28)
(Valid 
;; def=Termination.fst(69,18-71,28); use=Termination.fst(71,26-71,28)
(Prims.precedes (Prims.list x_fe28d8bcde588226b4e538b35321de05_2)
(Prims.list x_fe28d8bcde588226b4e538b35321de05_2)
@x2
x_3dddec8ced2db740e4e8aaf70542be7a_5)
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Termination.map, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, binder_x_3dddec8ced2db740e4e8aaf70542be7a_5, disc_equation_Prims.Cons, disc_equation_Prims.Nil, fuel_guarded_inversion_Prims.list, projection_inverse_BoxBool_proj_0, projection_inverse_Prims.Cons_tl, subterm_ordering_Prims.Cons
...
;;;;;;;;;;;;;;;;Fuel-instrumented function name
(declare-fun Termination.map.fuel_instrumented (Fuel Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Token for fuel-instrumented partial applications
(declare-fun Termination.map.fuel_instrumented_token () Term)
(declare-fun Termination.map (Term Term Term Term) Term)
(declare-fun Termination.map@tok () Term)
...
; encoding sigelt val Termination.mem


; <Skipped val Termination.mem/>

(push) ;; push{2

; Starting query at Termination.fst(74,21-77,20)
...
;;;;;;;;;;;;;;;;x : a (a)
(declare-fun x_157b99e815dc43d99415725267e9c452_1 () Term)
;;;;;;;;;;;;;;;;binder_x_157b99e815dc43d99415725267e9c452_1
;;; Fact-ids: 
(assert (! (HasType x_157b99e815dc43d99415725267e9c452_1
x_9cd1733a5204f989dbb2f01d5984df93_0)
:named binder_x_157b99e815dc43d99415725267e9c452_1))
;;;;;;;;;;;;;;;;l : Prims.list a (Prims.list a)
...
(declare-fun Tm_refine_5eb17dd3b19f13d8980cd5a4df464fb5 (Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(73,10-77,20); use=Termination.fst(73,10-77,20)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_refine_5eb17dd3b19f13d8980cd5a4df464fb5 @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_refine_5eb17dd3b19f13d8980cd5a4df464fb5 @x0
@x1)
Tm_type))
:qid refinement_kinding_Tm_refine_5eb17dd3b19f13d8980cd5a4df464fb5))

:named refinement_kinding_Tm_refine_5eb17dd3b19f13d8980cd5a4df464fb5))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(73,10-77,20); use=Termination.fst(73,10-77,20)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_5eb17dd3b19f13d8980cd5a4df464fb5 @x2
@x3))
(and (HasTypeFuel @u0
@x1
(Prims.list @x2))
...
;; def=Termination.fst(73,10-77,20); use=Termination.fst(73,10-77,20)
(or 
;; def=Termination.fst(74,21-77,20); use=Termination.fst(74,21-77,20)
(Valid 
;; def=Termination.fst(74,21-77,20); use=Termination.fst(74,21-77,20)
...
;; def=Termination.fst(73,10-77,20); use=Termination.fst(73,10-77,20)
(and 
;; def=Termination.fst(73,10-74,14); use=Termination.fst(73,10-74,14)
(Valid 
;; def=Termination.fst(73,10-74,14); use=Termination.fst(73,10-74,14)
...
;; def=Termination.fst(73,22-77,20); use=Termination.fst(73,22-77,20)
(or 
;; def=Termination.fst(74,21-77,20); use=Termination.fst(74,21-77,20)
(Valid 
;; def=Termination.fst(74,21-77,20); use=Termination.fst(74,21-77,20)
...
x_9cd1733a5204f989dbb2f01d5984df93_0
@x3
x_157b99e815dc43d99415725267e9c452_1)
)


;; def=Termination.fst(73,22-77,20); use=Termination.fst(73,22-77,20)
(and 
;; def=Termination.fst(73,22-74,16); use=Termination.fst(73,22-74,16)
(Valid 
;; def=Termination.fst(73,22-74,16); use=Termination.fst(73,22-74,16)
...
(Tm_refine_5eb17dd3b19f13d8980cd5a4df464fb5 @x2
@x3)))
:qid refinement_interpretation_Tm_refine_5eb17dd3b19f13d8980cd5a4df464fb5))

:named refinement_interpretation_Tm_refine_5eb17dd3b19f13d8980cd5a4df464fb5))
;;;;;;;;;;;;;;;;haseq for Tm_refine_5eb17dd3b19f13d8980cd5a4df464fb5
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(73,10-77,20); use=Termination.fst(73,10-77,20)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_5eb17dd3b19f13d8980cd5a4df464fb5 @x0
@x1)))
(Valid (Prims.hasEq (Prims.list @x0))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_5eb17dd3b19f13d8980cd5a4df464fb5 @x0
@x1))))
:qid haseqTm_refine_5eb17dd3b19f13d8980cd5a4df464fb5))

:named haseqTm_refine_5eb17dd3b19f13d8980cd5a4df464fb5))
(declare-fun Termination.mem (Term Term Term) Term)

;;;;;;;;;;;;;;;;x: a -> _: _: Prims.list a {a << a \/ a === a /\ (x << x \/ x === x /\ _ << l)} -> Prims.bool
(declare-fun Tm_arrow_fcee16e600580d434632a1cb3d988094 () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_fcee16e600580d434632a1cb3d988094
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_fcee16e600580d434632a1cb3d988094
Tm_type)
:named kinding_Tm_arrow_fcee16e600580d434632a1cb3d988094))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(73,10-77,20); use=Termination.fst(73,10-77,20)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_fcee16e600580d434632a1cb3d988094)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_fcee16e600580d434632a1cb3d988094))
:qid Termination_pre_typing_Tm_arrow_fcee16e600580d434632a1cb3d988094))

:named Termination_pre_typing_Tm_arrow_fcee16e600580d434632a1cb3d988094))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_fcee16e600580d434632a1cb3d988094
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(73,10-77,20); use=Termination.fst(73,10-77,20)
(forall ((@x0 Term))
...
@x1)
(HasType @x3
(Tm_refine_5eb17dd3b19f13d8980cd5a4df464fb5 @x1
@x2)))
...
@x2)
@x3))
:qid Termination_interpretation_Tm_arrow_fcee16e600580d434632a1cb3d988094.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid Termination_interpretation_Tm_arrow_fcee16e600580d434632a1cb3d988094.2))
...
@x1)
@x2))
:qid Termination_interpretation_Tm_arrow_fcee16e600580d434632a1cb3d988094.3))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_fcee16e600580d434632a1cb3d988094))
:qid Termination_interpretation_Tm_arrow_fcee16e600580d434632a1cb3d988094))

:named Termination_interpretation_Tm_arrow_fcee16e600580d434632a1cb3d988094))
(declare-fun Termination.mem@tok () Term)
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(74,8-74,11); use=Termination.fst(74,8-74,11)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (ApplyTT (ApplyTT (ApplyTT Termination.mem@tok
@x0)
@x1)
@x2)
(Termination.mem @x0
...
:pattern ((ApplyTT (ApplyTT (ApplyTT Termination.mem@tok
@x0)
@x1)
@x2))
:qid token_correspondence_Termination.mem))

:named token_correspondence_Termination.mem))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(74,8-74,11); use=Termination.fst(74,8-74,11)
...
:pattern ((Termination.mem @x1
@x2
@x3))
:qid function_token_typing_Termination.mem.1))
)
 

:pattern ((ApplyTT @x0
Termination.mem@tok))
:qid function_token_typing_Termination.mem))

:named function_token_typing_Termination.mem))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(74,8-74,11); use=Termination.fst(74,8-74,11)
...
@x0)
(HasType @x2
(Tm_refine_5eb17dd3b19f13d8980cd5a4df464fb5 @x0
@x1)))
(HasType (Termination.mem @x0
@x1
@x2)
Prims.bool))
 

:pattern ((Termination.mem @x0
@x1
@x2))
:qid typing_Termination.mem))

:named typing_Termination.mem))
(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)
...
;   (~(Nil? l) /\ ~(Cons? l) ==> Prims.l_False) /\
;   (~(Nil? l) ==>
;     (forall (b: a) (b: Prims.list a). l == b :: b ==> ~(b = x) ==> a << a \/ (x << x \/ b << l)))


; Context: While encoding a query
; While typechecking the top-level declaration `let rec mem`
...
;; def=Prims.fst(402,27-402,88); use=Termination.fst(74,21-77,20)
(forall ((@x1 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=Termination.fst(74,21-77,20)
(Valid 
;; def=Prims.fst(402,84-402,87); use=Termination.fst(74,21-77,20)
(ApplyTT @x0
@x1)
...
;; def=Prims.fst(459,77-459,89); use=Termination.fst(74,21-77,20)
(and (implies 
;; def=Termination.fst(74,17-74,18); use=Termination.fst(74,27-74,28)
(and 
;; def=Termination.fst(74,17-74,18); use=Termination.fst(74,27-74,28)
(not 
;; def=Termination.fst(74,17-74,18); use=Termination.fst(74,27-74,28)
...
label_1)
(implies 
;; def=Prims.fst(389,19-389,21); use=Termination.fst(74,21-77,20)
(not 
;; def=Termination.fst(74,17-74,18); use=Termination.fst(74,27-74,28)
(BoxBool_proj_0 (Prims.uu___is_Nil x_9cd1733a5204f989dbb2f01d5984df93_0
x_374b44ccfcb77ed85d505dbc44265913_2))
...
;; def=Prims.fst(413,99-413,120); use=Termination.fst(74,21-77,20)
(forall ((@x1 Term))
 (! (implies (HasType @x1
x_9cd1733a5204f989dbb2f01d5984df93_0)
...
;; def=Termination.fst(74,17-76,10); use=Termination.fst(74,27-76,10)
(= x_374b44ccfcb77ed85d505dbc44265913_2
...
;; def=Termination.fst(77,4-77,8); use=Termination.fst(77,4-77,8)
(not 
;; def=Termination.fst(77,4-77,8); use=Termination.fst(77,4-77,8)
(= @x1
x_157b99e815dc43d99415725267e9c452_1)
...
;; def=Termination.fst(73,10-77,20); use=Termination.fst(77,18-77,20)
(or label_2

;; def=Termination.fst(74,21-77,20); use=Termination.fst(77,18-77,20)
(Valid 
;; def=Termination.fst(74,21-77,20); use=Termination.fst(77,18-77,20)
(Prims.precedes Prims.eqtype
Prims.eqtype
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Termination.mem, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, binder_x_374b44ccfcb77ed85d505dbc44265913_2, disc_equation_Prims.Cons, disc_equation_Prims.Nil, fuel_guarded_inversion_Prims.list, projection_inverse_BoxBool_proj_0, projection_inverse_Prims.Cons_tl, subterm_ordering_Prims.Cons
...
; encoding sigelt let rec mem


; <Start encoding let rec mem>

;;;;;;;;;;;;;;;;Fuel-instrumented function name
(declare-fun Termination.mem.fuel_instrumented (Fuel Term Term Term) Term)
;;;;;;;;;;;;;;;;Token for fuel-instrumented partial applications
(declare-fun Termination.mem.fuel_instrumented_token () Term)
(declare-fun Termination.mem (Term Term Term) Term)
(declare-fun Termination.mem@tok () Term)
...
; encoding sigelt val Termination.list_subterm_ordering_coercion


; <Skipped val Termination.list_subterm_ordering_coercion/>

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Termination.mem; Namespace Termination
(assert (! 
;; def=Termination.fst(74,8-74,11); use=Termination.fst(74,8-74,11)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x0
...
(HasType @x3
(Prims.list @x1)))
(HasType (Termination.mem.fuel_instrumented @u0
@x1
@x2
@x3)
Prims.bool))
...
:pattern ((Termination.mem.fuel_instrumented @u0
@x1
@x2
@x3))
:qid token_correspondence_Termination.mem.fuel_instrumented))

:named token_correspondence_Termination.mem.fuel_instrumented))
...
;;;;;;;;;;;;;;;;Equation for fuel-instrumented recursive function: Termination.mem
;;; Fact-ids: Name Termination.mem; Namespace Termination
(assert (! 
;; def=Termination.fst(74,8-74,11); use=Termination.fst(74,8-74,11)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
...
(HasType @x3
(Prims.list @x1)))
(= (Termination.mem.fuel_instrumented (SFuel @u0)
@x1
@x2
@x3)
(let ((@lb4 @x3))
...
(Prims.op_BarBar (Prims.op_Equality @x1
(Prims.Cons_hd @lb4)
@x2)
(Termination.mem.fuel_instrumented @u0
@x1
@x2
(Prims.Cons_tl @lb4)))
Tm_unit)))))
...
:pattern ((Termination.mem.fuel_instrumented (SFuel @u0)
@x1
@x2
@x3))
:qid equation_with_fuel_Termination.mem.fuel_instrumented))

:named equation_with_fuel_Termination.mem.fuel_instrumented))
;;;;;;;;;;;;;;;;Fuel irrelevance
;;; Fact-ids: Name Termination.mem; Namespace Termination
(assert (! 
;; def=Termination.fst(74,8-74,11); use=Termination.fst(74,8-74,11)
...
@x2
@x3)
(Termination.mem.fuel_instrumented ZFuel
@x1
@x2
@x3))
...
@x2
@x3))
:qid @fuel_irrelevance_Termination.mem.fuel_instrumented))

:named @fuel_irrelevance_Termination.mem.fuel_instrumented))
...
@x1
@x2)
(Termination.mem.fuel_instrumented MaxFuel
@x0
@x1
@x2))
...
@x1
@x2))
:qid @fuel_correspondence_Termination.mem.fuel_instrumented))

:named @fuel_correspondence_Termination.mem.fuel_instrumented))
(push) ;; push{2

; Starting query at Termination.fst(85,55-88,47)

;;;;;;;;;;;;;;;;a : Prims.eqtype (Prims.eqtype)
(declare-fun x_9cd1733a5204f989dbb2f01d5984df93_1 () Term)
;;;;;;;;;;;;;;;;binder_x_9cd1733a5204f989dbb2f01d5984df93_1
;;; Fact-ids: 
(assert (! (HasType x_9cd1733a5204f989dbb2f01d5984df93_1
Prims.eqtype)
:named binder_x_9cd1733a5204f989dbb2f01d5984df93_1))
;;;;;;;;;;;;;;;;b : Type (Type)
(declare-fun x_fe28d8bcde588226b4e538b35321de05_2 () Term)
;;;;;;;;;;;;;;;;binder_x_fe28d8bcde588226b4e538b35321de05_2
;;; Fact-ids: 
...
:named binder_x_fe28d8bcde588226b4e538b35321de05_2))
;;;;;;;;;;;;;;;;l : Prims.list a (Prims.list a)
(declare-fun x_270b3cef5784d1bc5a7008b8b6b27eb6_3 () Term)
;;;;;;;;;;;;;;;;binder_x_270b3cef5784d1bc5a7008b8b6b27eb6_3
;;; Fact-ids: 
(assert (! (HasType x_270b3cef5784d1bc5a7008b8b6b27eb6_3
(Prims.list x_9cd1733a5204f989dbb2f01d5984df93_1))
:named binder_x_270b3cef5784d1bc5a7008b8b6b27eb6_3))
;;;;;;;;;;;;;;;;bound : bound: b{l << bound} (bound: b{l << bound})
(declare-fun x_b854bcaec29d9b05432d1478cbd54165_4 () Term)
(declare-fun Tm_refine_a0e30473eb82c18d4e4dc1a1cc3d49bf () Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! (HasType Tm_refine_a0e30473eb82c18d4e4dc1a1cc3d49bf
Tm_type)
:named refinement_kinding_Tm_refine_a0e30473eb82c18d4e4dc1a1cc3d49bf))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(83,27-83,46); use=Termination.fst(85,8-85,38)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_a0e30473eb82c18d4e4dc1a1cc3d49bf)
(and (HasTypeFuel @u0
@x1
x_fe28d8bcde588226b4e538b35321de05_2)

;; def=Termination.fst(83,35-83,45); use=Termination.fst(85,8-85,38)
(Valid 
;; def=Termination.fst(83,35-83,45); use=Termination.fst(85,8-85,38)
(Prims.precedes (Prims.list x_9cd1733a5204f989dbb2f01d5984df93_1)
x_fe28d8bcde588226b4e538b35321de05_2
x_270b3cef5784d1bc5a7008b8b6b27eb6_3
@x1)
)
))
...
@x1
Tm_refine_a0e30473eb82c18d4e4dc1a1cc3d49bf))
:qid refinement_interpretation_Tm_refine_a0e30473eb82c18d4e4dc1a1cc3d49bf))

:named refinement_interpretation_Tm_refine_a0e30473eb82c18d4e4dc1a1cc3d49bf))
;;;;;;;;;;;;;;;;haseq for Tm_refine_a0e30473eb82c18d4e4dc1a1cc3d49bf
;;; Fact-ids: 
(assert (! (iff (Valid (Prims.hasEq Tm_refine_a0e30473eb82c18d4e4dc1a1cc3d49bf))
(Valid (Prims.hasEq x_fe28d8bcde588226b4e538b35321de05_2)))
:named haseqTm_refine_a0e30473eb82c18d4e4dc1a1cc3d49bf))
;;;;;;;;;;;;;;;;binder_x_b854bcaec29d9b05432d1478cbd54165_4
;;; Fact-ids: 
(assert (! (HasType x_b854bcaec29d9b05432d1478cbd54165_4
Tm_refine_a0e30473eb82c18d4e4dc1a1cc3d49bf)
:named binder_x_b854bcaec29d9b05432d1478cbd54165_4))
(declare-fun Tm_refine_e1f22f18dec66e396c6d581e2473114f (Term Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(80,6-88,47); use=Termination.fst(80,6-88,47)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (HasType (Tm_refine_e1f22f18dec66e396c6d581e2473114f @x0
@x1
@x2)
Tm_type)
 

:pattern ((HasType (Tm_refine_e1f22f18dec66e396c6d581e2473114f @x0
@x1
@x2)
Tm_type))
:qid refinement_kinding_Tm_refine_e1f22f18dec66e396c6d581e2473114f))

:named refinement_kinding_Tm_refine_e1f22f18dec66e396c6d581e2473114f))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(80,6-88,47); use=Termination.fst(80,6-88,47)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_e1f22f18dec66e396c6d581e2473114f @x2
@x3
@x4))
(and (HasTypeFuel @u0
@x1
...
;; def=Termination.fst(80,6-88,47); use=Termination.fst(80,6-88,47)
(or 
;; def=Termination.fst(85,55-88,47); use=Termination.fst(85,55-88,47)
(Valid 
;; def=Termination.fst(85,55-88,47); use=Termination.fst(85,55-88,47)
(Prims.precedes Prims.eqtype
Prims.eqtype
@x2
x_9cd1733a5204f989dbb2f01d5984df93_1)
)


;; def=Termination.fst(80,6-88,47); use=Termination.fst(80,6-88,47)
(and 
;; def=Termination.fst(80,6-85,41); use=Termination.fst(80,6-85,41)
(Valid 
;; def=Termination.fst(80,6-85,41); use=Termination.fst(80,6-85,41)
(Prims.op_Equals_Equals_Equals Prims.eqtype
Prims.eqtype
...
;; def=Termination.fst(82,6-88,47); use=Termination.fst(82,6-88,47)
(or 
;; def=Termination.fst(85,55-88,47); use=Termination.fst(85,55-88,47)
(Valid 
;; def=Termination.fst(85,55-88,47); use=Termination.fst(85,55-88,47)
...
;; def=Termination.fst(82,6-88,47); use=Termination.fst(82,6-88,47)
(and 
;; def=Termination.fst(82,6-85,46); use=Termination.fst(82,6-85,46)
(Valid 
;; def=Termination.fst(82,6-85,46); use=Termination.fst(82,6-85,46)
...
x_fe28d8bcde588226b4e538b35321de05_2
@x1
x_b854bcaec29d9b05432d1478cbd54165_4)
)
)
)
)
...
@x3
@x4)))
:qid refinement_interpretation_Tm_refine_e1f22f18dec66e396c6d581e2473114f))

:named refinement_interpretation_Tm_refine_e1f22f18dec66e396c6d581e2473114f))
;;;;;;;;;;;;;;;;haseq for Tm_refine_e1f22f18dec66e396c6d581e2473114f
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(80,6-88,47); use=Termination.fst(80,6-88,47)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_e1f22f18dec66e396c6d581e2473114f @x0
@x1
@x2)))
(Valid (Prims.hasEq @x1)))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_e1f22f18dec66e396c6d581e2473114f @x0
@x1
@x2))))
:qid haseqTm_refine_e1f22f18dec66e396c6d581e2473114f))

:named haseqTm_refine_e1f22f18dec66e396c6d581e2473114f))
(declare-fun Termination.list_subterm_ordering_coercion (Term Term Term Term) Term)

(declare-fun Tm_refine_8044a5c3094a1b40d6c3d4b66cd5bb71 (Term Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(83,27-83,46); use=Termination.fst(85,8-85,38)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (HasType (Tm_refine_8044a5c3094a1b40d6c3d4b66cd5bb71 @x0
@x1
@x2)
Tm_type)
 

:pattern ((HasType (Tm_refine_8044a5c3094a1b40d6c3d4b66cd5bb71 @x0
@x1
@x2)
Tm_type))
:qid refinement_kinding_Tm_refine_8044a5c3094a1b40d6c3d4b66cd5bb71))

:named refinement_kinding_Tm_refine_8044a5c3094a1b40d6c3d4b66cd5bb71))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(83,27-83,46); use=Termination.fst(85,8-85,38)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_8044a5c3094a1b40d6c3d4b66cd5bb71 @x2
@x3
@x4))
(and (HasTypeFuel @u0
@x1
...
@x3
@x4)))
:qid refinement_interpretation_Tm_refine_8044a5c3094a1b40d6c3d4b66cd5bb71))

:named refinement_interpretation_Tm_refine_8044a5c3094a1b40d6c3d4b66cd5bb71))
;;;;;;;;;;;;;;;;haseq for Tm_refine_8044a5c3094a1b40d6c3d4b66cd5bb71
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(83,27-83,46); use=Termination.fst(85,8-85,38)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_8044a5c3094a1b40d6c3d4b66cd5bb71 @x0
@x1
@x2)))
(Valid (Prims.hasEq @x1)))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_8044a5c3094a1b40d6c3d4b66cd5bb71 @x0
@x1
@x2))))
:qid haseqTm_refine_8044a5c3094a1b40d6c3d4b66cd5bb71))

:named haseqTm_refine_8044a5c3094a1b40d6c3d4b66cd5bb71))
(declare-fun Tm_refine_8b5eece02e0724cd5f7835467ce93986 (Term Term Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(84,31-84,89); use=Termination.fst(85,8-85,38)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (HasType (Tm_refine_8b5eece02e0724cd5f7835467ce93986 @x0
@x1
@x2
@x3)
Tm_type)
...
:pattern ((HasType (Tm_refine_8b5eece02e0724cd5f7835467ce93986 @x0
@x1
@x2
@x3)
Tm_type))
:qid refinement_kinding_Tm_refine_8b5eece02e0724cd5f7835467ce93986))

:named refinement_kinding_Tm_refine_8b5eece02e0724cd5f7835467ce93986))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(84,31-84,89); use=Termination.fst(85,8-85,38)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_8b5eece02e0724cd5f7835467ce93986 @x2
@x3
@x4
@x5))
(and (HasTypeFuel @u0
...
;; def=Termination.fst(84,41-84,45); use=Termination.fst(85,8-85,38)
(= @x2
@x1)


;; def=Termination.fst(84,49-84,87); use=Termination.fst(85,8-85,38)
(forall ((@x6 Term))
 (! (implies (and (HasType @x6
@x3)

;; def=Termination.fst(84,64-84,71); use=Termination.fst(85,8-85,38)
(BoxBool_proj_0 (Termination.mem @x3
@x6
@x1))
)

;; def=Termination.fst(84,76-84,86); use=Termination.fst(85,8-85,38)
(Valid 
;; def=Termination.fst(84,76-84,86); use=Termination.fst(85,8-85,38)
(Prims.precedes @x3
(Tm_refine_8044a5c3094a1b40d6c3d4b66cd5bb71 @x3
@x4
@x2)
@x6
@x5)
...
;;no pats
:qid refinement_interpretation_Tm_refine_8b5eece02e0724cd5f7835467ce93986.1))
))
...
@x4
@x5)))
:qid refinement_interpretation_Tm_refine_8b5eece02e0724cd5f7835467ce93986))

:named refinement_interpretation_Tm_refine_8b5eece02e0724cd5f7835467ce93986))
;;;;;;;;;;;;;;;;haseq for Tm_refine_8b5eece02e0724cd5f7835467ce93986
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(84,31-84,89); use=Termination.fst(85,8-85,38)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_8b5eece02e0724cd5f7835467ce93986 @x0
@x1
@x2
@x3)))
(Valid (Prims.hasEq (Prims.list @x1))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_8b5eece02e0724cd5f7835467ce93986 @x0
@x1
@x2
@x3))))
:qid haseqTm_refine_8b5eece02e0724cd5f7835467ce93986))

:named haseqTm_refine_8b5eece02e0724cd5f7835467ce93986))
;;;;;;;;;;;;;;;;l: Prims.list a ->     bound: (bound: b{l << bound}){a << a \/ a === a /\ (l << l \/ l === l /\ bound << bound)}   -> m: Prims.list a {l == m /\ (forall (x: a). mem x m ==> x << bound)}
(declare-fun Tm_arrow_0832e049fb8b71c0f23e9c9bdd030d87 () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_0832e049fb8b71c0f23e9c9bdd030d87
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_0832e049fb8b71c0f23e9c9bdd030d87
Tm_type)
:named kinding_Tm_arrow_0832e049fb8b71c0f23e9c9bdd030d87))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(80,6-88,47); use=Termination.fst(80,6-88,47)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_0832e049fb8b71c0f23e9c9bdd030d87)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_0832e049fb8b71c0f23e9c9bdd030d87))
:qid Termination_pre_typing_Tm_arrow_0832e049fb8b71c0f23e9c9bdd030d87))

:named Termination_pre_typing_Tm_arrow_0832e049fb8b71c0f23e9c9bdd030d87))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_0832e049fb8b71c0f23e9c9bdd030d87
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(80,6-88,47); use=Termination.fst(80,6-88,47)
(forall ((@x0 Term))
...
(Prims.list @x1))
(HasType @x4
(Tm_refine_e1f22f18dec66e396c6d581e2473114f @x1
@x2
@x3)))
(HasType (ApplyTT (ApplyTT (ApplyTT (ApplyTT @x0
@x1)
...
@x3)
@x4)
(Tm_refine_8b5eece02e0724cd5f7835467ce93986 @x3
@x1
@x2
@x4)))
...
@x3)
@x4))
:qid Termination_interpretation_Tm_arrow_0832e049fb8b71c0f23e9c9bdd030d87.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid Termination_interpretation_Tm_arrow_0832e049fb8b71c0f23e9c9bdd030d87.2))
...
@x1)
@x2))
:qid Termination_interpretation_Tm_arrow_0832e049fb8b71c0f23e9c9bdd030d87.3))
...
@x2)
@x3))
:qid Termination_interpretation_Tm_arrow_0832e049fb8b71c0f23e9c9bdd030d87.4))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_0832e049fb8b71c0f23e9c9bdd030d87))
:qid Termination_interpretation_Tm_arrow_0832e049fb8b71c0f23e9c9bdd030d87))

:named Termination_interpretation_Tm_arrow_0832e049fb8b71c0f23e9c9bdd030d87))
(declare-fun Termination.list_subterm_ordering_coercion@tok () Term)
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(85,8-85,38); use=Termination.fst(85,8-85,38)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (ApplyTT (ApplyTT (ApplyTT (ApplyTT Termination.list_subterm_ordering_coercion@tok
@x0)
@x1)
@x2)
@x3)
(Termination.list_subterm_ordering_coercion @x0
@x1
@x2
@x3))
 

:pattern ((ApplyTT (ApplyTT (ApplyTT (ApplyTT Termination.list_subterm_ordering_coercion@tok
@x0)
@x1)
@x2)
@x3))
:qid token_correspondence_Termination.list_subterm_ordering_coercion))

:named token_correspondence_Termination.list_subterm_ordering_coercion))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(85,8-85,38); use=Termination.fst(85,8-85,38)
(forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType Termination.list_subterm_ordering_coercion@tok
Tm_arrow_0832e049fb8b71c0f23e9c9bdd030d87))
...
@x3)
@x4)
(Termination.list_subterm_ordering_coercion @x1
@x2
@x3
@x4))
 

:pattern ((Termination.list_subterm_ordering_coercion @x1
@x2
@x3
@x4))
:qid function_token_typing_Termination.list_subterm_ordering_coercion.1))
)
 

:pattern ((ApplyTT @x0
Termination.list_subterm_ordering_coercion@tok))
:qid function_token_typing_Termination.list_subterm_ordering_coercion))

:named function_token_typing_Termination.list_subterm_ordering_coercion))
...
(Prims.list @x0))
(HasType @x3
(Tm_refine_e1f22f18dec66e396c6d581e2473114f @x0
@x1
@x2)))
(HasType (Termination.list_subterm_ordering_coercion @x0
@x1
@x2
@x3)
(Tm_refine_8b5eece02e0724cd5f7835467ce93986 @x2
...
:pattern ((Termination.list_subterm_ordering_coercion @x0
@x1
@x2
@x3))
:qid typing_Termination.list_subterm_ordering_coercion))

:named typing_Termination.list_subterm_ordering_coercion))
(declare-fun label_7 () Bool)
(declare-fun label_6 () Bool)
(declare-fun label_5 () Bool)
(declare-fun label_4 () Bool)
...
(declare-fun Tm_refine_67e086f41c78e99d3271deed2f24a147 () Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! (HasType Tm_refine_67e086f41c78e99d3271deed2f24a147
Tm_type)
:named refinement_kinding_Tm_refine_67e086f41c78e99d3271deed2f24a147))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(84,31-84,89); use=Termination.fst(85,55-88,47)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_67e086f41c78e99d3271deed2f24a147)
(and (HasTypeFuel @u0
@x1
(Prims.list x_9cd1733a5204f989dbb2f01d5984df93_1))

;; def=Termination.fst(84,41-84,45); use=Termination.fst(85,55-88,47)
(= x_270b3cef5784d1bc5a7008b8b6b27eb6_3
@x1)


;; def=Termination.fst(84,49-84,87); use=Termination.fst(85,55-88,47)
(forall ((@x2 Term))
 (! (implies (and (HasType @x2
x_9cd1733a5204f989dbb2f01d5984df93_1)

;; def=Termination.fst(84,64-84,71); use=Termination.fst(85,55-88,47)
(BoxBool_proj_0 (Termination.mem x_9cd1733a5204f989dbb2f01d5984df93_1
@x2
@x1))
)

;; def=Termination.fst(84,76-84,86); use=Termination.fst(85,55-88,47)
(Valid 
;; def=Termination.fst(84,76-84,86); use=Termination.fst(85,55-88,47)
(Prims.precedes x_9cd1733a5204f989dbb2f01d5984df93_1
Tm_refine_a0e30473eb82c18d4e4dc1a1cc3d49bf
@x2
x_b854bcaec29d9b05432d1478cbd54165_4)
)
...
;;no pats
:qid refinement_interpretation_Tm_refine_67e086f41c78e99d3271deed2f24a147.1))
))
...
@x1
Tm_refine_67e086f41c78e99d3271deed2f24a147))
:qid refinement_interpretation_Tm_refine_67e086f41c78e99d3271deed2f24a147))

:named refinement_interpretation_Tm_refine_67e086f41c78e99d3271deed2f24a147))
;;;;;;;;;;;;;;;;haseq for Tm_refine_67e086f41c78e99d3271deed2f24a147
;;; Fact-ids: 
(assert (! (iff (Valid (Prims.hasEq Tm_refine_67e086f41c78e99d3271deed2f24a147))
(Valid (Prims.hasEq (Prims.list x_9cd1733a5204f989dbb2f01d5984df93_1))))
:named haseqTm_refine_67e086f41c78e99d3271deed2f24a147))


(declare-fun Tm_refine_ff258fb046bf07201ea7f65ffbcf039a (Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(83,27-83,46); use=Termination.fst(85,55-88,47)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_ff258fb046bf07201ea7f65ffbcf039a @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_ff258fb046bf07201ea7f65ffbcf039a @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_ff258fb046bf07201ea7f65ffbcf039a))

:named refinement_kinding_Tm_refine_ff258fb046bf07201ea7f65ffbcf039a))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(83,27-83,46); use=Termination.fst(85,55-88,47)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_ff258fb046bf07201ea7f65ffbcf039a @x2))
(and (HasTypeFuel @u0
@x1
x_fe28d8bcde588226b4e538b35321de05_2)

;; def=Termination.fst(83,35-83,45); use=Termination.fst(85,55-88,47)
(Valid 
;; def=Termination.fst(83,35-83,45); use=Termination.fst(85,55-88,47)
(Prims.precedes (Prims.list x_9cd1733a5204f989dbb2f01d5984df93_1)
x_fe28d8bcde588226b4e538b35321de05_2
...
@x1
(Tm_refine_ff258fb046bf07201ea7f65ffbcf039a @x2)))
:qid refinement_interpretation_Tm_refine_ff258fb046bf07201ea7f65ffbcf039a))

:named refinement_interpretation_Tm_refine_ff258fb046bf07201ea7f65ffbcf039a))
;;;;;;;;;;;;;;;;haseq for Tm_refine_ff258fb046bf07201ea7f65ffbcf039a
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(83,27-83,46); use=Termination.fst(85,55-88,47)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_ff258fb046bf07201ea7f65ffbcf039a @x0)))
(Valid (Prims.hasEq x_fe28d8bcde588226b4e538b35321de05_2)))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_ff258fb046bf07201ea7f65ffbcf039a @x0))))
:qid haseqTm_refine_ff258fb046bf07201ea7f65ffbcf039a))

:named haseqTm_refine_ff258fb046bf07201ea7f65ffbcf039a))
(declare-fun Tm_refine_7f65e6e96a286ef2fcef6eeaaf4a433e (Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(84,31-84,89); use=Termination.fst(85,55-88,47)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_7f65e6e96a286ef2fcef6eeaaf4a433e @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_7f65e6e96a286ef2fcef6eeaaf4a433e @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_7f65e6e96a286ef2fcef6eeaaf4a433e))

:named refinement_kinding_Tm_refine_7f65e6e96a286ef2fcef6eeaaf4a433e))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(84,31-84,89); use=Termination.fst(85,55-88,47)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_7f65e6e96a286ef2fcef6eeaaf4a433e @x2))
(and (HasTypeFuel @u0
@x1
(Prims.list x_9cd1733a5204f989dbb2f01d5984df93_1))
...
;;no pats
:qid refinement_interpretation_Tm_refine_7f65e6e96a286ef2fcef6eeaaf4a433e.1))
))
...
@x1
(Tm_refine_7f65e6e96a286ef2fcef6eeaaf4a433e @x2)))
:qid refinement_interpretation_Tm_refine_7f65e6e96a286ef2fcef6eeaaf4a433e))

:named refinement_interpretation_Tm_refine_7f65e6e96a286ef2fcef6eeaaf4a433e))
;;;;;;;;;;;;;;;;haseq for Tm_refine_7f65e6e96a286ef2fcef6eeaaf4a433e
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(84,31-84,89); use=Termination.fst(85,55-88,47)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_7f65e6e96a286ef2fcef6eeaaf4a433e @x0)))
(Valid (Prims.hasEq (Prims.list x_9cd1733a5204f989dbb2f01d5984df93_1))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_7f65e6e96a286ef2fcef6eeaaf4a433e @x0))))
:qid haseqTm_refine_7f65e6e96a286ef2fcef6eeaaf4a433e))

:named haseqTm_refine_7f65e6e96a286ef2fcef6eeaaf4a433e))
...
;   Prims.pure_post (m: Prims.list a {l == m /\ (forall (x: a). Termination.mem x m ==> x << bound)}))
; .
;   (forall (x: m: Prims.list a {l == m /\ (forall (x: a). Termination.mem x m ==> x << bound)}).
;       {:pattern Prims.guard_free (k x)}
;       Prims.auto_squash (k x)) ==>
;   (~(Nil? l) /\ ~(Cons? l) ==> Prims.l_False) /\
;   (l == [] ==> l == [] /\ (forall (x: a). Termination.mem x [] ==> x << bound)) /\
;   (~(Nil? l) ==>
;     (forall (b: a) (b: Prims.list a).
;         l == b :: b ==>
;         (l << bound ==> b << bound /\ (a << a \/ (b << l \/ b === l /\ bound << bound))) /\
;         (forall (any_result: bound: b{l << bound}).
;             bound == any_result ==>
;             (forall (any_result:
;                 m: Prims.list a {b == m /\ (forall (x: a). Termination.mem x m ==> x << bound)}).
;                 Termination.list_subterm_ordering_coercion b bound == any_result ==>
;                 (forall (return_val:
;                     m: Prims.list a {b == m /\ (forall (x: a). Termination.mem x m ==> x << bound)})
;                   .
;                     return_val == Termination.list_subterm_ordering_coercion b bound ==>
;                     Termination.list_subterm_ordering_coercion b bound == return_val ==>
;                     (forall (any_result: Prims.list a).
;                         b :: Termination.list_subterm_ordering_coercion b bound == any_result ==>
;                         l == b :: Termination.list_subterm_ordering_coercion b bound /\
;                         (forall (x: a).
;                             Termination.mem x
;                               (b :: Termination.list_subterm_ordering_coercion b bound) ==>
;                             x << bound)))))))


; Context: While encoding a query
; While typechecking the top-level declaration `let rec list_subterm_ordering_coercion`
...
(assert (! (not (forall ((@x0 Term))
 (! (implies (and (HasType @x0
(Prims.pure_post Tm_refine_67e086f41c78e99d3271deed2f24a147))

;; def=Prims.fst(402,27-402,88); use=Termination.fst(85,55-88,47)
(forall ((@x1 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=Termination.fst(85,55-88,47)
(Valid 
;; def=Prims.fst(402,84-402,87); use=Termination.fst(85,55-88,47)
(ApplyTT @x0
@x1)
...
;; def=Prims.fst(459,77-459,89); use=Termination.fst(85,55-88,47)
(and (implies 
;; def=Termination.fst(85,45-85,46); use=Termination.fst(85,61-85,62)
(and 
;; def=Termination.fst(85,45-85,46); use=Termination.fst(85,61-85,62)
(not 
;; def=Termination.fst(85,45-85,46); use=Termination.fst(85,61-85,62)
(BoxBool_proj_0 (Prims.uu___is_Nil x_9cd1733a5204f989dbb2f01d5984df93_1
x_270b3cef5784d1bc5a7008b8b6b27eb6_3))
)
...
(not 
;; def=Termination.fst(85,45-85,46); use=Termination.fst(85,61-85,62)
(BoxBool_proj_0 (Prims.uu___is_Cons x_9cd1733a5204f989dbb2f01d5984df93_1
x_270b3cef5784d1bc5a7008b8b6b27eb6_3))
)
)
...
label_1)
(implies 
;; def=Termination.fst(85,45-86,6); use=Termination.fst(85,61-86,6)
(= x_270b3cef5784d1bc5a7008b8b6b27eb6_3
(Prims.Nil x_9cd1733a5204f989dbb2f01d5984df93_1))


;; def=Termination.fst(84,41-84,87); use=Termination.fst(86,10-86,12)
(and 
;; def=Termination.fst(84,41-84,45); use=Termination.fst(86,10-86,12)
(or label_2
...
;; def=Termination.fst(84,49-84,87); use=Termination.fst(86,10-86,12)
(forall ((@x1 Term))
 (! (implies (and (HasType @x1
x_9cd1733a5204f989dbb2f01d5984df93_1)

;; def=Termination.fst(84,64-84,71); use=Termination.fst(86,10-86,12)
(BoxBool_proj_0 (Termination.mem x_9cd1733a5204f989dbb2f01d5984df93_1
@x1
(Prims.Nil x_9cd1733a5204f989dbb2f01d5984df93_1)))
)

;; def=Termination.fst(84,76-84,86); use=Termination.fst(86,10-86,12)
(or label_3
...
(implies 
;; def=Prims.fst(389,19-389,21); use=Termination.fst(85,55-88,47)
(not 
;; def=Termination.fst(85,45-85,46); use=Termination.fst(85,61-85,62)
(BoxBool_proj_0 (Prims.uu___is_Nil x_9cd1733a5204f989dbb2f01d5984df93_1
x_270b3cef5784d1bc5a7008b8b6b27eb6_3))
...
;; def=Prims.fst(413,99-413,120); use=Termination.fst(85,55-88,47)
(forall ((@x1 Term))
 (! (implies (HasType @x1
x_9cd1733a5204f989dbb2f01d5984df93_1)
...
;; def=Termination.fst(85,45-87,10); use=Termination.fst(85,61-87,10)
(= x_270b3cef5784d1bc5a7008b8b6b27eb6_3
(Prims.Cons x_9cd1733a5204f989dbb2f01d5984df93_1
@x1
@x2))
)
...
;; def=Prims.fst(459,77-459,89); use=Termination.fst(85,55-88,47)
(and (implies 
;; def=Termination.fst(83,35-83,45); use=Termination.fst(88,42-88,47)
(Valid 
;; def=Termination.fst(83,35-83,45); use=Termination.fst(88,42-88,47)
(Prims.precedes (Prims.list x_9cd1733a5204f989dbb2f01d5984df93_1)
x_fe28d8bcde588226b4e538b35321de05_2
...
;; def=Termination.fst(80,6-88,47); use=Termination.fst(88,42-88,47)
(and 
;; def=Termination.fst(83,35-83,45); use=Termination.fst(88,42-88,47)
(or label_4
...
;; def=Termination.fst(85,55-88,47); use=Termination.fst(88,42-88,47)
(Valid 
;; def=Termination.fst(85,55-88,47); use=Termination.fst(88,42-88,47)
(Prims.precedes Prims.eqtype
Prims.eqtype
...
;; def=Termination.fst(82,6-88,47); use=Termination.fst(88,42-88,47)
(and 
;; def=Termination.fst(82,6-85,46); use=Termination.fst(88,42-88,47)
(Valid 
;; def=Termination.fst(82,6-85,46); use=Termination.fst(88,42-88,47)
(Prims.op_Equals_Equals_Equals (Prims.list x_9cd1733a5204f989dbb2f01d5984df93_1)
(Prims.list x_9cd1733a5204f989dbb2f01d5984df93_1)
@x2
x_270b3cef5784d1bc5a7008b8b6b27eb6_3)
)
...
(Valid 
;; def=Termination.fst(85,55-88,47); use=Termination.fst(88,42-88,47)
(Prims.precedes x_fe28d8bcde588226b4e538b35321de05_2
x_fe28d8bcde588226b4e538b35321de05_2
x_b854bcaec29d9b05432d1478cbd54165_4
x_b854bcaec29d9b05432d1478cbd54165_4)
)
...
;; def=Prims.fst(451,66-451,102); use=Termination.fst(85,55-88,47)
(forall ((@x3 Term))
 (! (implies (and (HasType @x3
Tm_refine_a0e30473eb82c18d4e4dc1a1cc3d49bf)

;; def=Termination.fst(83,27-85,52); use=Termination.fst(85,55-88,47)
(= x_b854bcaec29d9b05432d1478cbd54165_4
@x3)
)
...
;; def=Termination.fst(84,31-88,47); use=Termination.fst(88,8-88,47)
(= (Termination.list_subterm_ordering_coercion x_9cd1733a5204f989dbb2f01d5984df93_1
x_fe28d8bcde588226b4e538b35321de05_2
@x2
x_b854bcaec29d9b05432d1478cbd54165_4)
@x4)
...
;; def=Prims.fst(356,2-356,58); use=Termination.fst(85,55-88,47)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
(Tm_refine_7f65e6e96a286ef2fcef6eeaaf4a433e @x2))

;; def=Prims.fst(356,26-356,41); use=Termination.fst(85,55-88,47)
(= @x5
(Termination.list_subterm_ordering_coercion x_9cd1733a5204f989dbb2f01d5984df93_1
x_fe28d8bcde588226b4e538b35321de05_2
@x2
...
;; def=Prims.fst(616,20-616,22); use=Termination.fst(85,55-88,47)
(= (Termination.list_subterm_ordering_coercion x_9cd1733a5204f989dbb2f01d5984df93_1
x_fe28d8bcde588226b4e538b35321de05_2
@x2
x_b854bcaec29d9b05432d1478cbd54165_4)
...
;; def=Termination.fst(84,31-88,47); use=Termination.fst(85,55-88,47)
(= (Prims.Cons x_9cd1733a5204f989dbb2f01d5984df93_1
@x1
(Termination.list_subterm_ordering_coercion x_9cd1733a5204f989dbb2f01d5984df93_1
x_fe28d8bcde588226b4e538b35321de05_2
...
;; def=Termination.fst(84,41-84,87); use=Termination.fst(88,4-88,47)
(and 
;; def=Termination.fst(84,41-84,45); use=Termination.fst(88,4-88,47)
(or label_6
...
;; def=Termination.fst(84,49-84,87); use=Termination.fst(88,4-88,47)
(forall ((@x7 Term))
 (! (implies (and (HasType @x7
x_9cd1733a5204f989dbb2f01d5984df93_1)

;; def=Termination.fst(84,64-84,71); use=Termination.fst(88,4-88,47)
(BoxBool_proj_0 (Termination.mem x_9cd1733a5204f989dbb2f01d5984df93_1
@x7
(Prims.Cons x_9cd1733a5204f989dbb2f01d5984df93_1
@x1
...
;; def=Termination.fst(84,76-84,86); use=Termination.fst(88,4-88,47)
(or label_7
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Termination.list_subterm_ordering_coercion, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxFuel_assumption, @MaxIFuel_assumption, @fuel_correspondence_Termination.mem.fuel_instrumented, @fuel_irrelevance_Termination.mem.fuel_instrumented, @query, binder_x_270b3cef5784d1bc5a7008b8b6b27eb6_3, binder_x_9cd1733a5204f989dbb2f01d5984df93_1, binder_x_b854bcaec29d9b05432d1478cbd54165_4, bool_inversion, constructor_distinct_Prims.Cons, constructor_distinct_Prims.Nil, disc_equation_Prims.Cons, disc_equation_Prims.Nil, equation_with_fuel_Termination.mem.fuel_instrumented, fuel_guarded_inversion_Prims.list, primitive_Prims.op_BarBar, primitive_Prims.op_Equality, projection_inverse_BoxBool_proj_0, projection_inverse_Prims.Cons_a, projection_inverse_Prims.Cons_hd, projection_inverse_Prims.Cons_tl, projection_inverse_Prims.Nil_a, refinement_interpretation_Tm_refine_7f65e6e96a286ef2fcef6eeaaf4a433e, refinement_interpretation_Tm_refine_a0e30473eb82c18d4e4dc1a1cc3d49bf, subterm_ordering_Prims.Cons, token_correspondence_Termination.mem.fuel_instrumented
...
; Starting query at Termination.fst(85,0-88,47)
...
:named haseqTm_refine_8044a5c3094a1b40d6c3d4b66cd5bb71))
(declare-fun Tm_refine_df39568bb7963f73e2da2248da642862 (Term Term Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(80,6-88,47); use=Termination.fst(85,0-88,47)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term) (@x6 Term))
 (! (HasType (Tm_refine_df39568bb7963f73e2da2248da642862 @x0
@x1
@x2
@x3
@x4
...
:pattern ((HasType (Tm_refine_df39568bb7963f73e2da2248da642862 @x0
@x1
@x2
@x3
@x4
...
@x6)
Tm_type))
:qid refinement_kinding_Tm_refine_df39568bb7963f73e2da2248da642862))

:named refinement_kinding_Tm_refine_df39568bb7963f73e2da2248da642862))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(80,6-88,47); use=Termination.fst(85,0-88,47)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term) (@x6 Term) (@x7 Term) (@x8 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_df39568bb7963f73e2da2248da642862 @x2
@x3
@x4
@x5
@x6
...
;; def=Termination.fst(80,6-88,47); use=Termination.fst(85,0-88,47)
(and 
;; def=Termination.fst(80,6-85,41); use=Termination.fst(85,0-88,47)
(Valid 
;; def=Termination.fst(80,6-85,41); use=Termination.fst(85,0-88,47)
(Prims.op_Equals_Equals_Equals Prims.eqtype
Prims.eqtype
...
;; def=Termination.fst(82,6-88,47); use=Termination.fst(85,0-88,47)
(or 
;; def=Termination.fst(85,55-88,47); use=Termination.fst(85,55-88,47)
(Valid 
;; def=Termination.fst(85,55-88,47); use=Termination.fst(85,55-88,47)
...
;; def=Termination.fst(82,6-88,47); use=Termination.fst(85,0-88,47)
(and 
;; def=Termination.fst(82,6-85,46); use=Termination.fst(85,0-88,47)
(Valid 
;; def=Termination.fst(82,6-85,46); use=Termination.fst(85,0-88,47)
(Prims.op_Equals_Equals_Equals (Prims.list @x2)
(Prims.list @x5)
...
@x7
@x8)))
:qid refinement_interpretation_Tm_refine_df39568bb7963f73e2da2248da642862))

:named refinement_interpretation_Tm_refine_df39568bb7963f73e2da2248da642862))
;;;;;;;;;;;;;;;;haseq for Tm_refine_df39568bb7963f73e2da2248da642862
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(80,6-88,47); use=Termination.fst(85,0-88,47)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term) (@x5 Term) (@x6 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_df39568bb7963f73e2da2248da642862 @x0
@x1
@x2
@x3
@x4
...
:pattern ((Valid (Prims.hasEq (Tm_refine_df39568bb7963f73e2da2248da642862 @x0
@x1
@x2
@x3
@x4
@x5
@x6))))
:qid haseqTm_refine_df39568bb7963f73e2da2248da642862))

:named haseqTm_refine_df39568bb7963f73e2da2248da642862))
...
;   (b: Type)
;   (l: Prims.list a)
;   (bound: (bound: b{l << bound}){a << a \/ a === a /\ (l << l \/ l === l /\ bound << bound)}).
;   (*  - Subtyping check failed
;   - Expected type Type0 got type Type0
; *)
;   forall (m: Prims.list a).
;     l == m ==>
;     (forall (x: a).
;         Termination.mem x m ==>
;         l << bound /\ (a << a \/ a === a /\ (l << l \/ l === l /\ bound << bound)) ==> l << bound)
...
;;; Fact-ids: 
(assert (! (not 
;; def=dummy(0,0-0,0); use=Termination.fst(85,0-88,47)
...
(Prims.list @x0))
(HasType @x3
(Tm_refine_8044a5c3094a1b40d6c3d4b66cd5bb71 @x0
@x1
@x2))
(HasType @x4
Prims.eqtype)
...
(Prims.list @x4))
(HasType @x7
(Tm_refine_df39568bb7963f73e2da2248da642862 @x4
@x5
@x6
@x0
@x2
...
;; def=dummy(0,0-0,0); use=Termination.fst(85,8-85,38)
(forall ((@x9 Term))
 (! (implies (and (HasType @x9
@x4)

;; def=Termination.fst(84,64-84,71); use=Termination.fst(85,8-85,38)
(BoxBool_proj_0 (Termination.mem @x4
@x9
@x8))
...
;; def=Termination.fst(80,6-88,47); use=Termination.fst(85,8-85,38)

;; def=Termination.fst(80,6-88,47); use=Termination.fst(85,8-85,38)
(or 
;; def=Termination.fst(85,55-88,47); use=Termination.fst(85,8-85,38)
(Valid 
;; def=Termination.fst(85,55-88,47); use=Termination.fst(85,8-85,38)
(Prims.precedes Prims.eqtype
Prims.eqtype
...
;; def=Termination.fst(80,6-88,47); use=Termination.fst(85,8-85,38)
(and 
;; def=Termination.fst(80,6-85,41); use=Termination.fst(85,8-85,38)
(Valid 
;; def=Termination.fst(80,6-85,41); use=Termination.fst(85,8-85,38)
(Prims.op_Equals_Equals_Equals Prims.eqtype
Prims.eqtype
...
;; def=Termination.fst(82,6-88,47); use=Termination.fst(85,8-85,38)
(or 
;; def=Termination.fst(85,55-88,47); use=Termination.fst(85,8-85,38)
(Valid 
;; def=Termination.fst(85,55-88,47); use=Termination.fst(85,8-85,38)
...
;; def=Termination.fst(82,6-88,47); use=Termination.fst(85,8-85,38)
(and 
;; def=Termination.fst(82,6-85,46); use=Termination.fst(85,8-85,38)
(Valid 
;; def=Termination.fst(82,6-85,46); use=Termination.fst(85,8-85,38)
(Prims.op_Equals_Equals_Equals (Prims.list @x4)
(Prims.list @x0)
@x6
@x2)
)
...
;; def=Termination.fst(83,35-83,45); use=Termination.fst(84,81-84,86)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Termination.list_subterm_ordering_coercion, 2)
; STATUS: unsat
...
; encoding sigelt let rec list_subterm_ordering_coercion


; <Start encoding let rec list_subterm_ordering_coercion>

;;;;;;;;;;;;;;;;Fuel-instrumented function name
(declare-fun Termination.list_subterm_ordering_coercion.fuel_instrumented (Fuel Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Token for fuel-instrumented partial applications
(declare-fun Termination.list_subterm_ordering_coercion.fuel_instrumented_token () Term)
(declare-fun Termination.list_subterm_ordering_coercion (Term Term Term Term) Term)
(declare-fun Termination.list_subterm_ordering_coercion@tok () Term)
(declare-fun Tm_refine_8044a5c3094a1b40d6c3d4b66cd5bb71 (Term Term Term) Term)
...
;;;;;;;;;;;;;;;;l: Prims.list a -> bound: b{l << bound}   -> m: Prims.list a {l == m /\ (forall (x: a). mem x m ==> x << bound)}
(declare-fun Tm_arrow_b54b7a6bafd9f2b09b421b321296f102 () Term)



; </end encoding let rec list_subterm_ordering_coercion>


; encoding sigelt val Termination.list_subterm_ordering_lemma


; <Skipped val Termination.list_subterm_ordering_lemma/>

(push) ;; push{2

; Starting query at Termination.fst(101,54-103,52)
...
:named binder_x_270b3cef5784d1bc5a7008b8b6b27eb6_3))
;;;;;;;;;;;;;;;;bound : b (b)
(declare-fun x_64a6f2da4341770a4dee8aa1d0d4ae69_4 () Term)
;;;;;;;;;;;;;;;;binder_x_64a6f2da4341770a4dee8aa1d0d4ae69_4
;;; Fact-ids: 
(assert (! (HasType x_64a6f2da4341770a4dee8aa1d0d4ae69_4
x_fe28d8bcde588226b4e538b35321de05_2)
:named binder_x_64a6f2da4341770a4dee8aa1d0d4ae69_4))
;;;;;;;;;;;;;;;;x : a (a)
(declare-fun x_d3faed7bbec7b3b3d41ce73e2f001f5c_5 () Term)
;;;;;;;;;;;;;;;;binder_x_d3faed7bbec7b3b3d41ce73e2f001f5c_5
;;; Fact-ids: 
(assert (! (HasType x_d3faed7bbec7b3b3d41ce73e2f001f5c_5
x_9cd1733a5204f989dbb2f01d5984df93_1)
:named binder_x_d3faed7bbec7b3b3d41ce73e2f001f5c_5))
;;;;;;;;;;;;;;;;Uninterpreted function symbol for impure function
(declare-fun Termination.list_subterm_ordering_lemma (Term Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Uninterpreted name for impure function
(declare-fun Termination.list_subterm_ordering_lemma@tok () Term)
(declare-fun label_5 () Bool)
(declare-fun label_4 () Bool)
(declare-fun label_3 () Bool)
(declare-fun label_2 () Bool)
...
;   l << bound /\
;   (forall (pure_result: Prims.unit). (Termination.mem x l ==> x << bound) ==> p pure_result) ==>
...
;         (forall (b: a) (b: Prims.list a).
;             l == b :: b ==>
;             (a << a \/ (b << l \/ b === l /\ (bound << bound \/ x << x))) /\
;             (forall (any_result: a).
;                 x == any_result ==>
;                 b << bound /\
;                 (forall (pure_result: Prims.unit).
;                     (Termination.mem x b ==> x << bound) ==> k pure_result)))))


; Context: While encoding a query
; While typechecking the top-level declaration `let rec list_subterm_ordering_lemma`
...
;;; Fact-ids: 
(assert (! (not 
;; def=Termination.fst(101,54-103,52); use=Termination.fst(101,54-103,52)
(forall ((@x0 Term))
 (! (implies (and (HasType @x0
(Prims.pure_post Prims.unit))

;; def=Termination.fst(97,43-97,55); use=Termination.fst(101,54-103,52)
(Valid 
;; def=Termination.fst(97,43-97,55); use=Termination.fst(101,54-103,52)
(Prims.precedes (Prims.list x_9cd1733a5204f989dbb2f01d5984df93_1)
x_fe28d8bcde588226b4e538b35321de05_2
x_270b3cef5784d1bc5a7008b8b6b27eb6_3
x_64a6f2da4341770a4dee8aa1d0d4ae69_4)
)


;; def=Prims.fst(441,36-441,97); use=Termination.fst(101,54-103,52)
(forall ((@x1 Term))
 (! (implies (and (or label_1
(HasType @x1
Prims.unit))
(implies 
;; def=Termination.fst(98,43-98,50); use=Termination.fst(101,54-103,52)
(BoxBool_proj_0 (Termination.mem x_9cd1733a5204f989dbb2f01d5984df93_1
x_d3faed7bbec7b3b3d41ce73e2f001f5c_5
x_270b3cef5784d1bc5a7008b8b6b27eb6_3))


;; def=Termination.fst(98,55-98,65); use=Termination.fst(101,54-103,52)
(or label_2
...
;; def=Prims.fst(441,83-441,96); use=Termination.fst(101,54-103,52)
(Valid 
;; def=Prims.fst(441,83-441,96); use=Termination.fst(101,54-103,52)
(ApplyTT @x0
@x1)
...
;; def=Prims.fst(402,2-402,97); use=Termination.fst(101,54-103,52)
(forall ((@x1 Term))
 (! (implies (and (HasType @x1
(Prims.pure_post Prims.unit))
...
(forall ((@x2 Term))
 (! (implies 
;; def=Prims.fst(402,73-402,79); use=Termination.fst(101,54-103,52)
(Valid 
;; def=Prims.fst(402,73-402,79); use=Termination.fst(101,54-103,52)
(ApplyTT @x0
@x2)
...
;; def=Prims.fst(402,84-402,87); use=Termination.fst(101,54-103,52)
(Valid 
;; def=Prims.fst(402,84-402,87); use=Termination.fst(101,54-103,52)
(ApplyTT @x1
@x2)
...
;; def=Prims.fst(459,77-459,89); use=Termination.fst(101,54-103,52)
(and (implies 
;; def=Termination.fst(101,42-101,43); use=Termination.fst(101,60-101,61)
(and 
;; def=Termination.fst(101,42-101,43); use=Termination.fst(101,60-101,61)
(not 
;; def=Termination.fst(101,42-101,43); use=Termination.fst(101,60-101,61)
...
label_3)
(implies 
;; def=Termination.fst(101,42-102,6); use=Termination.fst(101,60-102,6)
(= x_270b3cef5784d1bc5a7008b8b6b27eb6_3
(Prims.Nil x_9cd1733a5204f989dbb2f01d5984df93_1))


;; def=Prims.fst(451,66-451,102); use=Termination.fst(101,54-103,52)
(forall ((@x2 Term))
 (! (implies (HasType @x2
Prims.unit)

;; def=Prims.fst(451,90-451,102); use=Termination.fst(101,54-103,52)
(Valid 
;; def=Prims.fst(451,90-451,102); use=Termination.fst(101,54-103,52)
(ApplyTT @x1
@x2)
...
(implies 
;; def=Prims.fst(389,19-389,21); use=Termination.fst(101,54-103,52)
(not 
;; def=Termination.fst(101,42-101,43); use=Termination.fst(101,60-101,61)
(BoxBool_proj_0 (Prims.uu___is_Nil x_9cd1733a5204f989dbb2f01d5984df93_1
x_270b3cef5784d1bc5a7008b8b6b27eb6_3))
...
;; def=Prims.fst(413,99-413,120); use=Termination.fst(101,54-103,52)
(forall ((@x2 Term))
 (! (implies (HasType @x2
x_9cd1733a5204f989dbb2f01d5984df93_1)
...
;; def=Termination.fst(101,42-103,10); use=Termination.fst(101,60-103,10)
(= x_270b3cef5784d1bc5a7008b8b6b27eb6_3
(Prims.Cons x_9cd1733a5204f989dbb2f01d5984df93_1
@x2
@x3))
...
;; def=Prims.fst(459,77-459,89); use=Termination.fst(101,54-103,52)
(and 
;; def=Termination.fst(92,4-103,52); use=Termination.fst(103,51-103,52)
(or label_4

;; def=Termination.fst(101,54-103,52); use=Termination.fst(103,51-103,52)
(Valid 
;; def=Termination.fst(101,54-103,52); use=Termination.fst(103,51-103,52)
(Prims.precedes Prims.eqtype
Prims.eqtype
...
;; def=Termination.fst(94,6-103,52); use=Termination.fst(103,51-103,52)
(and 
;; def=Termination.fst(94,6-101,43); use=Termination.fst(103,51-103,52)
(Valid 
;; def=Termination.fst(94,6-101,43); use=Termination.fst(103,51-103,52)
(Prims.op_Equals_Equals_Equals (Prims.list x_9cd1733a5204f989dbb2f01d5984df93_1)
(Prims.list x_9cd1733a5204f989dbb2f01d5984df93_1)
...
;; def=Termination.fst(95,27-103,52); use=Termination.fst(103,51-103,52)
(or 
;; def=Termination.fst(101,54-103,52); use=Termination.fst(103,51-103,52)
(Valid 
;; def=Termination.fst(101,54-103,52); use=Termination.fst(103,51-103,52)
...
;; def=Termination.fst(96,27-101,51); use=Termination.fst(101,54-103,52)
(= x_d3faed7bbec7b3b3d41ce73e2f001f5c_5
@x4)
)

;; def=Prims.fst(441,29-441,97); use=Termination.fst(103,14-103,41)
(and 
;; def=Termination.fst(97,43-97,55); use=Termination.fst(103,14-103,41)
(or label_5
...
;; def=Prims.fst(441,36-441,97); use=Termination.fst(103,14-103,41)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
Prims.unit)

;; def=Termination.fst(98,42-98,66); use=Termination.fst(103,14-103,41)
(implies 
;; def=Termination.fst(98,43-98,50); use=Termination.fst(103,14-103,41)
(BoxBool_proj_0 (Termination.mem x_9cd1733a5204f989dbb2f01d5984df93_1
x_d3faed7bbec7b3b3d41ce73e2f001f5c_5
@x3))


;; def=Termination.fst(98,55-98,65); use=Termination.fst(103,14-103,41)
(Valid 
;; def=Termination.fst(98,55-98,65); use=Termination.fst(103,14-103,41)
(Prims.precedes x_9cd1733a5204f989dbb2f01d5984df93_1
x_fe28d8bcde588226b4e538b35321de05_2
...
;; def=Prims.fst(441,83-441,96); use=Termination.fst(103,14-103,41)
(Valid 
;; def=Prims.fst(441,83-441,96); use=Termination.fst(103,14-103,41)
(ApplyTT @x1
@x5)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Termination.list_subterm_ordering_lemma, 1)
; STATUS: unsat
...
; encoding sigelt let rec list_subterm_ordering_lemma


; <Start encoding let rec list_subterm_ordering_lemma>
...
; </end encoding let rec list_subterm_ordering_lemma>


; encoding sigelt val Termination.move_refinement


; <Skipped val Termination.move_refinement/>

;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name FStar.Ghost.elift1_p; Namespace FStar.Ghost
(assert (! 
;; def=FStar.Ghost.fsti(121,12-121,21); use=FStar.Ghost.fsti(121,12-121,21)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_refine_9f8cb5a84b67f50c9d5f87a914037545 @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_refine_9f8cb5a84b67f50c9d5f87a914037545 @x0
@x1)
Tm_type))
:qid refinement_kinding_Tm_refine_9f8cb5a84b67f50c9d5f87a914037545))

:named refinement_kinding_Tm_refine_9f8cb5a84b67f50c9d5f87a914037545))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name FStar.Ghost.elift1_p; Namespace FStar.Ghost
(assert (! 
;; def=FStar.Ghost.fsti(121,12-121,21); use=FStar.Ghost.fsti(121,12-121,21)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_9f8cb5a84b67f50c9d5f87a914037545 @x2
@x3))
(and (HasTypeFuel @u0
@x1
@x2)

;; def=FStar.Ghost.fsti(121,17-121,20); use=FStar.Ghost.fsti(121,17-121,20)
(Valid 
;; def=FStar.Ghost.fsti(121,17-121,20); use=FStar.Ghost.fsti(121,17-121,20)
(ApplyTT @x3
@x1)
...
(Tm_refine_9f8cb5a84b67f50c9d5f87a914037545 @x2
@x3)))
:qid refinement_interpretation_Tm_refine_9f8cb5a84b67f50c9d5f87a914037545))

:named refinement_interpretation_Tm_refine_9f8cb5a84b67f50c9d5f87a914037545))
;;;;;;;;;;;;;;;;Lemma: Termination.list_subterm_ordering_lemma
;;; Fact-ids: Name Termination.list_subterm_ordering_lemma; Namespace Termination
...
;; def=Termination.fst(97,43-97,55); use=Termination.fst(101,8-101,35)
(Valid 
;; def=Termination.fst(97,43-97,55); use=Termination.fst(101,8-101,35)
(Prims.precedes (Prims.list @x0)
@x1
@x2
@x3)
)
...
;; def=Termination.fst(98,43-98,50); use=Termination.fst(101,8-101,35)
(BoxBool_proj_0 (Termination.mem.fuel_instrumented ZFuel
@x0
@x4
@x2))
)

;; def=Termination.fst(98,55-98,65); use=Termination.fst(101,8-101,35)
(Valid 
;; def=Termination.fst(98,55-98,65); use=Termination.fst(101,8-101,35)
(Prims.precedes @x0
@x1
...
:pattern ((Termination.mem.fuel_instrumented ZFuel
@x0
@x4
@x2) (Prims.precedes @x0
@x1
@x4
@x3))
:qid lemma_Termination.list_subterm_ordering_lemma))
:named lemma_Termination.list_subterm_ordering_lemma))
...
;;;;;;;;;;;;;;;;haseq for Tm_refine_9f8cb5a84b67f50c9d5f87a914037545
;;; Fact-ids: Name FStar.Ghost.elift1_p; Namespace FStar.Ghost
(assert (! 
;; def=FStar.Ghost.fsti(121,12-121,21); use=FStar.Ghost.fsti(121,12-121,21)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_9f8cb5a84b67f50c9d5f87a914037545 @x0
@x1)))
(Valid (Prims.hasEq @x0)))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_9f8cb5a84b67f50c9d5f87a914037545 @x0
@x1))))
:qid haseqTm_refine_9f8cb5a84b67f50c9d5f87a914037545))

:named haseqTm_refine_9f8cb5a84b67f50c9d5f87a914037545))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name Prims.l_Forall; Namespace Prims
(assert (! 
;; def=Prims.fst(286,16-286,45); use=Prims.fst(286,30-286,45)
...
; Starting query at Termination.fst(109,34-111,42)
...
Prims.eqtype)
:named binder_x_9cd1733a5204f989dbb2f01d5984df93_0))
;;;;;;;;;;;;;;;;p : _: a -> Type0 (_: a -> Type)
(declare-fun x_daf421dbda9e2784ab04c9eee13e21dc_1 () Term)
;;;;;;;;;;;;;;;;_: a -> Type
...
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(106,31-109,26); use=Termination.fst(109,8-109,26)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
...
@x1
Tm_arrow_403cd2562999092693fed8d002e7d96a))
:qid Termination_pre_typing_Tm_arrow_403cd2562999092693fed8d002e7d96a))

:named Termination_pre_typing_Tm_arrow_403cd2562999092693fed8d002e7d96a))
...
:pattern ((ApplyTT @x0
@x1))
:qid Termination_interpretation_Tm_arrow_403cd2562999092693fed8d002e7d96a.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_403cd2562999092693fed8d002e7d96a))
:qid Termination_interpretation_Tm_arrow_403cd2562999092693fed8d002e7d96a))

:named Termination_interpretation_Tm_arrow_403cd2562999092693fed8d002e7d96a))
;;;;;;;;;;;;;;;;binder_x_daf421dbda9e2784ab04c9eee13e21dc_1
;;; Fact-ids: 
(assert (! (HasType x_daf421dbda9e2784ab04c9eee13e21dc_1
Tm_arrow_403cd2562999092693fed8d002e7d96a)
:named binder_x_daf421dbda9e2784ab04c9eee13e21dc_1))
;;;;;;;;;;;;;;;;l : l: Prims.list a {forall (z: a). Termination.mem z l ==> p z} (l: Prims.list a {forall (z: a). Termination.mem z l ==> p z})
(declare-fun x_ee831b716a424052bd35b1d95526a186_2 () Term)
(declare-fun Tm_refine_52da1e478474dd908d45a896648a7fbc () Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! (HasType Tm_refine_52da1e478474dd908d45a896648a7fbc
Tm_type)
:named refinement_kinding_Tm_refine_52da1e478474dd908d45a896648a7fbc))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(107,22-107,57); use=Termination.fst(109,8-109,23)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_52da1e478474dd908d45a896648a7fbc)
(and (HasTypeFuel @u0
@x1
(Prims.list x_9cd1733a5204f989dbb2f01d5984df93_0))

;; def=Termination.fst(107,31-107,56); use=Termination.fst(109,8-109,23)
(forall ((@x2 Term))
 (! (implies (and (HasType @x2
x_9cd1733a5204f989dbb2f01d5984df93_0)

;; def=Termination.fst(107,41-107,48); use=Termination.fst(109,8-109,23)
(BoxBool_proj_0 (Termination.mem x_9cd1733a5204f989dbb2f01d5984df93_0
@x2
@x1))
)

;; def=Termination.fst(107,53-107,56); use=Termination.fst(109,8-109,23)
(Valid 
;; def=Termination.fst(107,53-107,56); use=Termination.fst(109,8-109,23)
(ApplyTT x_daf421dbda9e2784ab04c9eee13e21dc_1
@x2)
)
)
 
;;no pats
:qid refinement_interpretation_Tm_refine_52da1e478474dd908d45a896648a7fbc.1))
))
...
@x1
Tm_refine_52da1e478474dd908d45a896648a7fbc))
:qid refinement_interpretation_Tm_refine_52da1e478474dd908d45a896648a7fbc))

:named refinement_interpretation_Tm_refine_52da1e478474dd908d45a896648a7fbc))
;;;;;;;;;;;;;;;;haseq for Tm_refine_52da1e478474dd908d45a896648a7fbc
;;; Fact-ids: 
(assert (! (iff (Valid (Prims.hasEq Tm_refine_52da1e478474dd908d45a896648a7fbc))
(Valid (Prims.hasEq (Prims.list x_9cd1733a5204f989dbb2f01d5984df93_0))))
:named haseqTm_refine_52da1e478474dd908d45a896648a7fbc))
;;;;;;;;;;;;;;;;binder_x_ee831b716a424052bd35b1d95526a186_2
;;; Fact-ids: 
(assert (! (HasType x_ee831b716a424052bd35b1d95526a186_2
Tm_refine_52da1e478474dd908d45a896648a7fbc)
:named binder_x_ee831b716a424052bd35b1d95526a186_2))

(declare-fun Tm_refine_3b7564bf77b0af5a9dbed9b83c1b763a (Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(105,23-111,42); use=Termination.fst(105,23-111,42)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_refine_3b7564bf77b0af5a9dbed9b83c1b763a @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_refine_3b7564bf77b0af5a9dbed9b83c1b763a @x0
@x1)
Tm_type))
:qid refinement_kinding_Tm_refine_3b7564bf77b0af5a9dbed9b83c1b763a))

:named refinement_kinding_Tm_refine_3b7564bf77b0af5a9dbed9b83c1b763a))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(105,23-111,42); use=Termination.fst(105,23-111,42)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_3b7564bf77b0af5a9dbed9b83c1b763a @x2
@x3))
(and (HasTypeFuel @u0
@x1
(Prims.list @x2))
...
;; def=Termination.fst(107,41-107,48); use=Termination.fst(109,8-109,23)
(BoxBool_proj_0 (Termination.mem @x2
@x4
@x1))
)
...
;;no pats
:qid refinement_interpretation_Tm_refine_3b7564bf77b0af5a9dbed9b83c1b763a.1))
...
;; def=Termination.fst(105,23-111,42); use=Termination.fst(105,23-111,42)
(or 
;; def=Termination.fst(109,34-111,42); use=Termination.fst(109,34-111,42)
(Valid 
;; def=Termination.fst(109,34-111,42); use=Termination.fst(109,34-111,42)
(Prims.precedes Prims.eqtype
Prims.eqtype
...
;; def=Termination.fst(105,23-111,42); use=Termination.fst(105,23-111,42)
(and 
;; def=Termination.fst(105,23-109,26); use=Termination.fst(105,23-109,26)
(Valid 
;; def=Termination.fst(105,23-109,26); use=Termination.fst(105,23-109,26)
(Prims.op_Equals_Equals_Equals Prims.eqtype
Prims.eqtype
...
(Prims.list x_9cd1733a5204f989dbb2f01d5984df93_0)
@x1
x_ee831b716a424052bd35b1d95526a186_2)
)
)
)
...
(Tm_refine_3b7564bf77b0af5a9dbed9b83c1b763a @x2
@x3)))
:qid refinement_interpretation_Tm_refine_3b7564bf77b0af5a9dbed9b83c1b763a))

:named refinement_interpretation_Tm_refine_3b7564bf77b0af5a9dbed9b83c1b763a))
;;;;;;;;;;;;;;;;haseq for Tm_refine_3b7564bf77b0af5a9dbed9b83c1b763a
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(105,23-111,42); use=Termination.fst(105,23-111,42)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_3b7564bf77b0af5a9dbed9b83c1b763a @x0
@x1)))
(Valid (Prims.hasEq (Prims.list @x0))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_3b7564bf77b0af5a9dbed9b83c1b763a @x0
@x1))))
:qid haseqTm_refine_3b7564bf77b0af5a9dbed9b83c1b763a))

:named haseqTm_refine_3b7564bf77b0af5a9dbed9b83c1b763a))
(declare-fun Termination.move_refinement (Term Term Term) Term)



;;;;;;;;;;;;;;;;l: (l: Prims.list a {forall (z: a). mem z l ==> p z}){a << a \/ a === a /\ l << l}   -> Prims.list (x: a{p x})
(declare-fun Tm_arrow_82a34ab94796f2065bb2ee9455d79133 () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_82a34ab94796f2065bb2ee9455d79133
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_82a34ab94796f2065bb2ee9455d79133
Tm_type)
:named kinding_Tm_arrow_82a34ab94796f2065bb2ee9455d79133))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(105,23-111,42); use=Termination.fst(105,23-111,42)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_82a34ab94796f2065bb2ee9455d79133)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_82a34ab94796f2065bb2ee9455d79133))
:qid Termination_pre_typing_Tm_arrow_82a34ab94796f2065bb2ee9455d79133))

:named Termination_pre_typing_Tm_arrow_82a34ab94796f2065bb2ee9455d79133))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_82a34ab94796f2065bb2ee9455d79133
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(105,23-111,42); use=Termination.fst(105,23-111,42)
(forall ((@x0 Term))
...
(Tm_arrow_2eaa01e78f73e9bab5d0955fc1a662da @x1))
(HasType @x3
(Tm_refine_3b7564bf77b0af5a9dbed9b83c1b763a @x1
@x2)))
(HasType (ApplyTT (ApplyTT (ApplyTT @x0
@x1)
@x2)
@x3)
(Prims.list (Tm_refine_9f8cb5a84b67f50c9d5f87a914037545 @x1
@x2))))
...
@x2)
@x3))
:qid Termination_interpretation_Tm_arrow_82a34ab94796f2065bb2ee9455d79133.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid Termination_interpretation_Tm_arrow_82a34ab94796f2065bb2ee9455d79133.2))
...
@x1)
@x2))
:qid Termination_interpretation_Tm_arrow_82a34ab94796f2065bb2ee9455d79133.3))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_82a34ab94796f2065bb2ee9455d79133))
:qid Termination_interpretation_Tm_arrow_82a34ab94796f2065bb2ee9455d79133))

:named Termination_interpretation_Tm_arrow_82a34ab94796f2065bb2ee9455d79133))
(declare-fun Termination.move_refinement@tok () Term)
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(109,8-109,23); use=Termination.fst(109,8-109,23)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (ApplyTT (ApplyTT (ApplyTT Termination.move_refinement@tok
@x0)
@x1)
@x2)
(Termination.move_refinement @x0
@x1
@x2))
 

:pattern ((ApplyTT (ApplyTT (ApplyTT Termination.move_refinement@tok
@x0)
@x1)
@x2))
:qid token_correspondence_Termination.move_refinement))

:named token_correspondence_Termination.move_refinement))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(109,8-109,23); use=Termination.fst(109,8-109,23)
(forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType Termination.move_refinement@tok
Tm_arrow_82a34ab94796f2065bb2ee9455d79133))
...
@x2)
@x3)
(Termination.move_refinement @x1
@x2
@x3))
 

:pattern ((Termination.move_refinement @x1
@x2
@x3))
:qid function_token_typing_Termination.move_refinement.1))
)
 

:pattern ((ApplyTT @x0
Termination.move_refinement@tok))
:qid function_token_typing_Termination.move_refinement))

:named function_token_typing_Termination.move_refinement))
...
(HasType @x2
(Tm_refine_3b7564bf77b0af5a9dbed9b83c1b763a @x0
@x1)))
(HasType (Termination.move_refinement @x0
@x1
@x2)
(Prims.list (Tm_refine_9f8cb5a84b67f50c9d5f87a914037545 @x0
@x1))))
 

:pattern ((Termination.move_refinement @x0
@x1
@x2))
:qid typing_Termination.move_refinement))

:named typing_Termination.move_refinement))
(declare-fun label_4 () Bool)
(declare-fun label_3 () Bool)
(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)
(declare-fun Tm_refine_90df5bdc3cbd9f797319168c2bcd6f16 () Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! (HasType Tm_refine_90df5bdc3cbd9f797319168c2bcd6f16
Tm_type)
:named refinement_kinding_Tm_refine_90df5bdc3cbd9f797319168c2bcd6f16))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(108,32-108,42); use=Termination.fst(109,34-111,42)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_90df5bdc3cbd9f797319168c2bcd6f16)
(and (HasTypeFuel @u0
@x1
x_9cd1733a5204f989dbb2f01d5984df93_0)

;; def=Termination.fst(108,37-108,40); use=Termination.fst(109,34-111,42)
(Valid 
;; def=Termination.fst(108,37-108,40); use=Termination.fst(109,34-111,42)
(ApplyTT x_daf421dbda9e2784ab04c9eee13e21dc_1
@x1)
...
@x1
Tm_refine_90df5bdc3cbd9f797319168c2bcd6f16))
:qid refinement_interpretation_Tm_refine_90df5bdc3cbd9f797319168c2bcd6f16))

:named refinement_interpretation_Tm_refine_90df5bdc3cbd9f797319168c2bcd6f16))
;;;;;;;;;;;;;;;;haseq for Tm_refine_90df5bdc3cbd9f797319168c2bcd6f16
;;; Fact-ids: 
(assert (! (iff (Valid (Prims.hasEq Tm_refine_90df5bdc3cbd9f797319168c2bcd6f16))
(Valid (Prims.hasEq x_9cd1733a5204f989dbb2f01d5984df93_0)))
:named haseqTm_refine_90df5bdc3cbd9f797319168c2bcd6f16))


; Encoding query formula : forall (k: Prims.pure_post (Prims.list (x: a{p x}))).
;   (forall (x: Prims.list (x: a{p x})). {:pattern Prims.guard_free (k x)} Prims.auto_squash (k x)) ==>
;   (~(Nil? l) /\ ~(Cons? l) ==> Prims.l_False) /\
;   (~(Nil? l) ==>
;     (forall (b: a) (b: Prims.list a).
;         l == b :: b ==>
;         Prims.auto_squash (p b) /\
;         (forall (any_result: a).
;             b == any_result ==> (forall (z: a). Termination.mem z b ==> p z) /\ (a << a \/ b << l)))
;   )


; Context: While encoding a query
; While typechecking the top-level declaration `let rec move_refinement`
...
(assert (! (not (forall ((@x0 Term))
 (! (implies (and (HasType @x0
(Prims.pure_post (Prims.list Tm_refine_90df5bdc3cbd9f797319168c2bcd6f16)))

;; def=Prims.fst(402,27-402,88); use=Termination.fst(109,34-111,42)
(forall ((@x1 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=Termination.fst(109,34-111,42)
(Valid 
;; def=Prims.fst(402,84-402,87); use=Termination.fst(109,34-111,42)
(ApplyTT @x0
@x1)
...
;; def=Prims.fst(459,77-459,89); use=Termination.fst(109,34-111,42)
(and (implies 
;; def=Termination.fst(109,30-109,31); use=Termination.fst(109,40-109,41)
(and 
;; def=Termination.fst(109,30-109,31); use=Termination.fst(109,40-109,41)
(not 
;; def=Termination.fst(109,30-109,31); use=Termination.fst(109,40-109,41)
...
label_1)
(implies 
;; def=Prims.fst(389,19-389,21); use=Termination.fst(109,34-111,42)
(not 
;; def=Termination.fst(109,30-109,31); use=Termination.fst(109,40-109,41)
(BoxBool_proj_0 (Prims.uu___is_Nil x_9cd1733a5204f989dbb2f01d5984df93_0
x_ee831b716a424052bd35b1d95526a186_2))
...
;; def=Prims.fst(413,99-413,120); use=Termination.fst(109,34-111,42)
(forall ((@x1 Term))
 (! (implies (HasType @x1
x_9cd1733a5204f989dbb2f01d5984df93_0)
...
;; def=Termination.fst(109,30-111,10); use=Termination.fst(109,40-111,10)
(= x_ee831b716a424052bd35b1d95526a186_2
(Prims.Cons x_9cd1733a5204f989dbb2f01d5984df93_0
@x1
@x2))
...
;; def=Prims.fst(459,77-459,89); use=Termination.fst(109,34-111,42)
(and 
;; def=Termination.fst(108,37-108,40); use=Termination.fst(111,14-111,16)
(or label_2
...
;; def=Prims.fst(451,66-451,102); use=Termination.fst(109,34-111,42)
(forall ((@x3 Term))
 (! (implies (and (HasType @x3
x_9cd1733a5204f989dbb2f01d5984df93_0)

;; def=Prims.fst(616,11-616,13); use=Termination.fst(109,34-111,42)
(= @x1
@x3)
)

;; def=Termination.fst(105,23-111,42); use=Termination.fst(111,40-111,42)
(and 
;; def=Termination.fst(107,31-107,56); use=Termination.fst(111,40-111,42)
(forall ((@x4 Term))
 (! (implies (and (HasType @x4
x_9cd1733a5204f989dbb2f01d5984df93_0)

;; def=Termination.fst(107,41-107,48); use=Termination.fst(111,40-111,42)
(BoxBool_proj_0 (Termination.mem x_9cd1733a5204f989dbb2f01d5984df93_0
@x4
@x2))
)

;; def=Termination.fst(107,53-107,56); use=Termination.fst(111,40-111,42)
(or label_3
...
;; def=Termination.fst(109,34-111,42); use=Termination.fst(111,40-111,42)
(Valid 
;; def=Termination.fst(109,34-111,42); use=Termination.fst(111,40-111,42)
(Prims.precedes Prims.eqtype
Prims.eqtype
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Termination.move_refinement, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxFuel_assumption, @MaxIFuel_assumption, @fuel_correspondence_Termination.mem.fuel_instrumented, @fuel_irrelevance_Termination.mem.fuel_instrumented, @query, binder_x_9cd1733a5204f989dbb2f01d5984df93_0, binder_x_ee831b716a424052bd35b1d95526a186_2, disc_equation_Prims.Cons, disc_equation_Prims.Nil, equation_with_fuel_Termination.mem.fuel_instrumented, fuel_guarded_inversion_Prims.list, primitive_Prims.op_BarBar, primitive_Prims.op_Equality, projection_inverse_BoxBool_proj_0, projection_inverse_Prims.Cons_hd, projection_inverse_Prims.Cons_tl, refinement_interpretation_Tm_refine_52da1e478474dd908d45a896648a7fbc, subterm_ordering_Prims.Cons
...
; encoding sigelt let rec move_refinement


; <Start encoding let rec move_refinement>

;;;;;;;;;;;;;;;;Fuel-instrumented function name
(declare-fun Termination.move_refinement.fuel_instrumented (Fuel Term Term Term) Term)
;;;;;;;;;;;;;;;;Token for fuel-instrumented partial applications
(declare-fun Termination.move_refinement.fuel_instrumented_token () Term)
(declare-fun Termination.move_refinement (Term Term Term) Term)
(declare-fun Termination.move_refinement@tok () Term)

(declare-fun Tm_refine_b9e1673579cdccbda36cfe3f78ac6f4f (Term Term) Term)
...
;;;;;;;;;;;;;;;;l: Prims.list a {forall (z: a). mem z l ==> p z} -> Prims.list (x: a{p x})
(declare-fun Tm_arrow_9cb4991b4de773673df8a31ac4371796 () Term)


; </end encoding let rec move_refinement>
...
; encoding sigelt type Termination.tree


; <Start encoding type Termination.tree>

;;;;;;;;;;;;;;;;Constructor
(declare-fun Termination.tree (Term) Term)
;;;;;;;;;;;;;;;;token
(declare-fun Termination.tree@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun Termination.Leaf (Term Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Termination.Leaf_a (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Termination.Leaf__0 (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: Termination.Leaf
(declare-fun Termination.Leaf@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun Termination.Node (Term Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Termination.Node_a (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun Termination.Node__0 (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: Termination.Node
(declare-fun Termination.Node@tok () Term)
;;;;;;;;;;;;;;;;_0: a -> tree a
(declare-fun Tm_arrow_9f9762cf6e50a1236d66d7e466eaade2 () Term)
;;;;;;;;;;;;;;;;_0: Prims.list (tree a) -> tree a
(declare-fun Tm_arrow_360878b093eedb40a21e0fafbc6c1d11 () Term)

; <start constructor Termination.tree>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Termination.tree ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
293)
(exists ((@x0 Term))
 (! (= __@x0
...
;;no pats
:qid is-Termination.tree))))

; </end constructor Termination.tree>


; <start constructor Termination.Leaf>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Termination.Leaf ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
300)
(= __@x0
(Termination.Leaf (Termination.Leaf_a __@x0)
(Termination.Leaf__0 __@x0)))))

; </end constructor Termination.Leaf>


; <start constructor Termination.Node>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-Termination.Node ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
305)
(= __@x0
(Termination.Node (Termination.Node_a __@x0)
(Termination.Node__0 __@x0)))))

; </end constructor Termination.Node>


; </end encoding type Termination.tree>

;;;;;;;;;;;;;;;;name-token correspondence
;;; Fact-ids: Name Termination.tree; Namespace Termination; Name Termination.Leaf; Namespace Termination; Name Termination.Node; Namespace Termination
(assert (! 
;; def=Termination.fst(113,5-113,9); use=Termination.fst(113,5-113,9)
(forall ((@x0 Term))
 (! (= (ApplyTT Termination.tree@tok
@x0)
(Termination.tree @x0))
 

:pattern ((ApplyTT Termination.tree@tok
@x0))

:pattern ((Termination.tree @x0))
:qid token_correspondence_Termination.tree@tok))

:named token_correspondence_Termination.tree@tok))
;;;;;;;;;;;;;;;;subterm ordering
;;; Fact-ids: Name Termination.tree; Namespace Termination; Name Termination.Leaf; Namespace Termination; Name Termination.Node; Namespace Termination
(assert (! 
;; def=Termination.fst(115,4-115,8); use=Termination.fst(115,4-115,8)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (HasTypeFuel (SFuel @u0)
(Termination.Node @x1
@x2)
...
@x2)
(Termination.tree @x3)))
:qid subterm_ordering_Termination.Node))

:named subterm_ordering_Termination.Node))
;;;;;;;;;;;;;;;;subterm ordering
;;; Fact-ids: Name Termination.tree; Namespace Termination; Name Termination.Leaf; Namespace Termination; Name Termination.Node; Namespace Termination
(assert (! 
;; def=Termination.fst(114,4-114,8); use=Termination.fst(114,4-114,8)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (HasTypeFuel (SFuel @u0)
(Termination.Leaf @x1
@x2)
...
@x2)
(Termination.tree @x3)))
:qid subterm_ordering_Termination.Leaf))

:named subterm_ordering_Termination.Leaf))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Termination.tree; Namespace Termination; Name Termination.Leaf; Namespace Termination; Name Termination.Node; Namespace Termination
(assert (! 
;; def=Termination.fst(115,4-115,8); use=Termination.fst(115,4-115,8)
(forall ((@x0 Term) (@x1 Term))
 (! (= (Termination.Node_a (Termination.Node @x0
@x1))
@x0)
 

:pattern ((Termination.Node @x0
@x1))
:qid projection_inverse_Termination.Node_a))

:named projection_inverse_Termination.Node_a))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Termination.tree; Namespace Termination; Name Termination.Leaf; Namespace Termination; Name Termination.Node; Namespace Termination
(assert (! 
;; def=Termination.fst(115,4-115,8); use=Termination.fst(115,4-115,8)
(forall ((@x0 Term) (@x1 Term))
 (! (= (Termination.Node__0 (Termination.Node @x0
@x1))
@x1)
...
:pattern ((Termination.Node @x0
@x1))
:qid projection_inverse_Termination.Node__0))

:named projection_inverse_Termination.Node__0))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Termination.tree; Namespace Termination; Name Termination.Leaf; Namespace Termination; Name Termination.Node; Namespace Termination
(assert (! 
;; def=Termination.fst(114,4-114,8); use=Termination.fst(114,4-114,8)
(forall ((@x0 Term) (@x1 Term))
 (! (= (Termination.Leaf_a (Termination.Leaf @x0
@x1))
@x0)
 

:pattern ((Termination.Leaf @x0
@x1))
:qid projection_inverse_Termination.Leaf_a))

:named projection_inverse_Termination.Leaf_a))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Termination.tree; Namespace Termination; Name Termination.Leaf; Namespace Termination; Name Termination.Node; Namespace Termination
(assert (! 
;; def=Termination.fst(114,4-114,8); use=Termination.fst(114,4-114,8)
(forall ((@x0 Term) (@x1 Term))
 (! (= (Termination.Leaf__0 (Termination.Leaf @x0
@x1))
@x1)
...
:pattern ((Termination.Leaf @x0
@x1))
:qid projection_inverse_Termination.Leaf__0))

:named projection_inverse_Termination.Leaf__0))
;;;;;;;;;;;;;;;;kinding
;;; Fact-ids: Name Termination.tree; Namespace Termination; Name Termination.Leaf; Namespace Termination; Name Termination.Node; Namespace Termination
(assert (! (is-Tm_arrow (PreType Termination.tree@tok))
:named pre_kinding_Termination.tree@tok))
;;; Fact-ids: Name Termination.tree; Namespace Termination; Name Termination.Leaf; Namespace Termination; Name Termination.Node; Namespace Termination
(assert (! (and (IsTotFun Termination.tree@tok)

;; def=Termination.fst(113,5-113,9); use=Termination.fst(113,5-113,9)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_type)
(HasType (Termination.tree @x0)
Tm_type))
 

:pattern ((Termination.tree @x0))
:qid kinding_Termination.tree@tok))
)
:named kinding_Termination.tree@tok))
;;;;;;;;;;;;;;;;inversion axiom
;;; Fact-ids: Name Termination.tree; Namespace Termination; Name Termination.Leaf; Namespace Termination; Name Termination.Node; Namespace Termination
(assert (! 
;; def=Termination.fst(113,5-113,9); use=Termination.fst(113,5-113,9)
...
@x1
(Termination.tree @x2))
(or (and (is-Termination.Leaf @x1)
(= @x2
(Termination.Leaf_a @x1)))
(and (is-Termination.Node @x1)
(= @x2
(Termination.Node_a @x1)))))
 

:pattern ((HasTypeFuel (SFuel @u0)
@x1
(Termination.tree @x2)))
:qid fuel_guarded_inversion_Termination.tree))

:named fuel_guarded_inversion_Termination.tree))
;;;;;;;;;;;;;;;;fresh token
;;; Fact-ids: Name Termination.tree; Namespace Termination; Name Termination.Leaf; Namespace Termination; Name Termination.Node; Namespace Termination
(assert (! (= 294
(Term_constr_id Termination.tree@tok))
:named fresh_token_Termination.tree@tok))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name Termination.tree; Namespace Termination; Name Termination.Leaf; Namespace Termination; Name Termination.Node; Namespace Termination
(assert (! 
;; def=Termination.fst(115,4-115,8); use=Termination.fst(115,4-115,8)
...
(HasTypeFuel @u0
@x2
(Prims.list (Termination.tree @x1))))
(HasTypeFuel @u0
(Termination.Node @x1
@x2)
(Termination.tree @x1)))
...
@x2)
(Termination.tree @x1)))
:qid data_typing_intro_Termination.Node@tok))

:named data_typing_intro_Termination.Node@tok))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name Termination.tree; Namespace Termination; Name Termination.Leaf; Namespace Termination; Name Termination.Node; Namespace Termination
(assert (! 
;; def=Termination.fst(114,4-114,8); use=Termination.fst(114,4-114,8)
...
@x2)
(Termination.tree @x1)))
:qid data_typing_intro_Termination.Leaf@tok))

:named data_typing_intro_Termination.Leaf@tok))
;;;;;;;;;;;;;;;;data constructor typing elim
;;; Fact-ids: Name Termination.tree; Namespace Termination; Name Termination.Leaf; Namespace Termination; Name Termination.Node; Namespace Termination
(assert (! 
;; def=Termination.fst(115,4-115,8); use=Termination.fst(115,4-115,8)
...
(HasTypeFuel @u0
@x2
(Prims.list (Termination.tree @x3)))))
...
@x2)
(Termination.tree @x3)))
:qid data_elim_Termination.Node))

:named data_elim_Termination.Node))
;;;;;;;;;;;;;;;;data constructor typing elim
;;; Fact-ids: Name Termination.tree; Namespace Termination; Name Termination.Leaf; Namespace Termination; Name Termination.Node; Namespace Termination
(assert (! 
;; def=Termination.fst(114,4-114,8); use=Termination.fst(114,4-114,8)
...
@x2)
(Termination.tree @x3)))
:qid data_elim_Termination.Leaf))

:named data_elim_Termination.Leaf))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Termination.tree; Namespace Termination; Name Termination.Leaf; Namespace Termination; Name Termination.Node; Namespace Termination
(assert (! 
;; def=Termination.fst(113,5-113,9); use=Termination.fst(113,5-113,9)
(forall ((@x0 Term))
 (! (= 293
(Term_constr_id (Termination.tree @x0)))
 

:pattern ((Termination.tree @x0))
:qid constructor_distinct_Termination.tree))

:named constructor_distinct_Termination.tree))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Termination.tree; Namespace Termination; Name Termination.Leaf; Namespace Termination; Name Termination.Node; Namespace Termination
(assert (! 
;; def=Termination.fst(115,4-115,8); use=Termination.fst(115,4-115,8)
(forall ((@x0 Term) (@x1 Term))
 (! (= 305
(Term_constr_id (Termination.Node @x0
@x1)))
 

:pattern ((Termination.Node @x0
@x1))
:qid constructor_distinct_Termination.Node))

:named constructor_distinct_Termination.Node))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Termination.tree; Namespace Termination; Name Termination.Leaf; Namespace Termination; Name Termination.Node; Namespace Termination
(assert (! 
;; def=Termination.fst(114,4-114,8); use=Termination.fst(114,4-114,8)
(forall ((@x0 Term) (@x1 Term))
 (! (= 300
(Term_constr_id (Termination.Leaf @x0
@x1)))
 

:pattern ((Termination.Leaf @x0
@x1))
:qid constructor_distinct_Termination.Leaf))

:named constructor_distinct_Termination.Leaf))
;;;;;;;;;;;;;;;;pretyping
;;; Fact-ids: Name Termination.tree; Namespace Termination; Name Termination.Leaf; Namespace Termination; Name Termination.Node; Namespace Termination
(assert (! 
;; def=Termination.fst(113,5-113,9); use=Termination.fst(113,5-113,9)
...
@x0
(Termination.tree @x2)))
:qid Termination_pretyping_d5615165726ef0ad932ba9fc97b5c6f7))

:named Termination_pretyping_d5615165726ef0ad932ba9fc97b5c6f7))
(push) ;; push{4

; Starting query at Termination.fst(113,0-115,34)
...
;   Prims.hasEq a /\
;   (forall (a: Type). {:pattern Prims.hasEq (Termination.tree a)}
;       Prims.hasEq a ==> Prims.hasEq (Termination.tree a)) ==>
;   (forall (_0: a).
...
; *)
;       Prims.hasEq a) /\
;   (forall (_0: Prims.list (Termination.tree a)).
;       (*  - Failed to prove that the type
;     'Termination.tree'
;     supports decidable equality because of this argument.
;   - Add either the 'noeq' or 'unopteq' qualifier
; *)
;       Prims.hasEq (Prims.list (Termination.tree a)))


; Context: While encoding a query
; While typechecking the top-level declaration `type Termination.tree`
...
;; def=Termination.fst(113,0-115,34); use=Termination.fst(113,0-115,34)
(Valid 
;; def=Termination.fst(113,0-115,34); use=Termination.fst(113,0-115,34)
(Prims.hasEq @x0)
)
...
(Valid 
;; def=Termination.fst(113,0-115,34); use=Termination.fst(113,0-115,34)
(Prims.hasEq (Termination.tree @x1))
)
)
 

:pattern ((Prims.hasEq (Termination.tree @x1)))
:qid @query.1))
)
...
;; def=Termination.fst(113,0-115,34); use=Termination.fst(114,11-114,12)
(or label_1
...
(forall ((@x1 Term))
 (! (implies (HasType @x1
(Prims.list (Termination.tree @x0)))

;; def=Termination.fst(113,0-115,34); use=Termination.fst(115,11-115,24)
(or label_2

;; def=Termination.fst(113,0-115,34); use=Termination.fst(113,0-115,34)
(Valid 
;; def=Termination.fst(113,0-115,34); use=Termination.fst(113,0-115,34)
(Prims.hasEq (Prims.list (Termination.tree @x0)))
)
)
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Termination.tree, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, assumption_Prims.list__uu___haseq, kinding_Termination.tree@tok
...
; encoding sigelt assume Termination.tree__uu___haseq


; <Start encoding assume Termination.tree__uu___haseq>


; </end encoding assume Termination.tree__uu___haseq>


; encoding sigelt val Termination.uu___is_Leaf


; <Start encoding val Termination.uu___is_Leaf>

(declare-fun Termination.uu___is_Leaf (Term Term) Term)
;;;;;;;;;;;;;;;;projectee: tree a -> Prims.bool
(declare-fun Tm_arrow_f87183a38946f9a8ad987ed05d31fb2d () Term)
(declare-fun Termination.uu___is_Leaf@tok () Term)

; </end encoding val Termination.uu___is_Leaf>
...
; encoding sigelt val Termination.__proj__Leaf__item___0


; <Start encoding val Termination.__proj__Leaf__item___0>

(declare-fun Tm_refine_eecc20c444854ed8824621455f36b0bc (Term) Term)
(declare-fun Termination.__proj__Leaf__item___0 (Term Term) Term)

;;;;;;;;;;;;;;;;projectee: _: tree a {Leaf? _} -> a
(declare-fun Tm_arrow_c3c2e6035d071b9e6b3495a047a7058d () Term)
(declare-fun Termination.__proj__Leaf__item___0@tok () Term)

; </end encoding val Termination.__proj__Leaf__item___0>

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Termination.uu___is_Leaf; Namespace Termination
(assert (! 
;; def=Termination.fst(114,4-114,8); use=Termination.fst(114,4-114,8)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
...
(HasType @x1
(Termination.tree @x0)))
(HasType (Termination.uu___is_Leaf @x0
@x1)
Prims.bool))
 

:pattern ((Termination.uu___is_Leaf @x0
@x1))
:qid typing_Termination.uu___is_Leaf))

:named typing_Termination.uu___is_Leaf))
;;;;;;;;;;;;;;;;name-token correspondence
;;; Fact-ids: Name Termination.tree; Namespace Termination; Name Termination.Leaf; Namespace Termination; Name Termination.Node; Namespace Termination
(assert (! 
;; def=Termination.fst(113,5-113,9); use=Termination.fst(113,5-113,9)
...
:named subterm_ordering_Termination.Leaf))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name Termination.__proj__Leaf__item___0; Namespace Termination
(assert (! 
;; def=Termination.fst(114,4-114,8); use=Termination.fst(114,4-114,8)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_eecc20c444854ed8824621455f36b0bc @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_eecc20c444854ed8824621455f36b0bc @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_eecc20c444854ed8824621455f36b0bc))

:named refinement_kinding_Tm_refine_eecc20c444854ed8824621455f36b0bc))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name Termination.__proj__Leaf__item___0; Namespace Termination
(assert (! 
;; def=Termination.fst(114,4-114,8); use=Termination.fst(114,4-114,8)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_eecc20c444854ed8824621455f36b0bc @x2))
(and (HasTypeFuel @u0
@x1
(Termination.tree @x2))

;; def=Termination.fst(114,4-114,8); use=Termination.fst(114,4-114,8)
(BoxBool_proj_0 (Termination.uu___is_Leaf @x2
@x1))
))
...
@x1
(Tm_refine_eecc20c444854ed8824621455f36b0bc @x2)))
:qid refinement_interpretation_Tm_refine_eecc20c444854ed8824621455f36b0bc))

:named refinement_interpretation_Tm_refine_eecc20c444854ed8824621455f36b0bc))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name Termination.tree; Namespace Termination; Name Termination.Leaf; Namespace Termination; Name Termination.Node; Namespace Termination
(assert (! 
;; def=Termination.fst(115,4-115,8); use=Termination.fst(115,4-115,8)
...
:named kinding_Termination.tree@tok))
;;;;;;;;;;;;;;;;haseq for Tm_refine_eecc20c444854ed8824621455f36b0bc
;;; Fact-ids: Name Termination.__proj__Leaf__item___0; Namespace Termination
(assert (! 
;; def=Termination.fst(114,4-114,8); use=Termination.fst(114,4-114,8)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_eecc20c444854ed8824621455f36b0bc @x0)))
(Valid (Prims.hasEq (Termination.tree @x0))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_eecc20c444854ed8824621455f36b0bc @x0))))
:qid haseqTm_refine_eecc20c444854ed8824621455f36b0bc))

:named haseqTm_refine_eecc20c444854ed8824621455f36b0bc))
;;;;;;;;;;;;;;;;inversion axiom
;;; Fact-ids: Name Termination.tree; Namespace Termination; Name Termination.Leaf; Namespace Termination; Name Termination.Node; Namespace Termination
(assert (! 
;; def=Termination.fst(113,5-113,9); use=Termination.fst(113,5-113,9)
...
;; def=Termination.fst(114,4-114,8); use=Termination.fst(114,4-114,8)
(forall ((@x0 Term) (@x1 Term))
 (! (= (Termination.uu___is_Leaf @x0
@x1)
(BoxBool (is-Termination.Leaf @x1)))
 

:pattern ((Termination.uu___is_Leaf @x0
@x1))
:qid disc_equation_Termination.Leaf))

:named disc_equation_Termination.Leaf))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name Termination.tree; Namespace Termination; Name Termination.Leaf; Namespace Termination; Name Termination.Node; Namespace Termination
(assert (! 
;; def=Termination.fst(115,4-115,8); use=Termination.fst(115,4-115,8)
...
:named constructor_distinct_Termination.Leaf))
;;;;;;;;;;;;;;;;Assumption: Termination.tree__uu___haseq
;;; Fact-ids: Name Termination.tree__uu___haseq; Namespace Termination
(assert (! (forall ((@x0 Term))
 (! (implies (and (HasType @x0
Tm_type)
(Valid (Prims.hasEq @x0)))
...
:pattern ((Prims.hasEq (Termination.tree @x0)))
:qid assumption_Termination.tree__uu___haseq))
:named assumption_Termination.tree__uu___haseq))
;;;;;;;;;;;;;;;;pretyping
;;; Fact-ids: Name Termination.tree; Namespace Termination; Name Termination.Leaf; Namespace Termination; Name Termination.Node; Namespace Termination
(assert (! 
;; def=Termination.fst(113,5-113,9); use=Termination.fst(113,5-113,9)
...
; Encoding query formula : forall (a: Type) (projectee: _: Termination.tree a {Leaf? _}).
...
Tm_type)
(HasType @x1
(Tm_refine_eecc20c444854ed8824621455f36b0bc @x0))

;; def=Termination.fst(114,4-114,8); use=Termination.fst(114,4-114,8)
(not 
;; def=Termination.fst(114,4-114,8); use=Termination.fst(114,4-114,8)
(BoxBool_proj_0 (Termination.uu___is_Leaf @x0
@x1))
)
)
label_1)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Termination.__proj__Leaf__item___0, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_eecc20c444854ed8824621455f36b0bc
...
; encoding sigelt val Termination.uu___is_Node


; <Start encoding val Termination.uu___is_Node>

(declare-fun Termination.uu___is_Node (Term Term) Term)

(declare-fun Termination.uu___is_Node@tok () Term)

; </end encoding val Termination.uu___is_Node>
...
; encoding sigelt val Termination.__proj__Node__item___0


; <Start encoding val Termination.__proj__Node__item___0>

(declare-fun Tm_refine_ef7437472d1ef108a142a5a0fa28c50f (Term) Term)
(declare-fun Termination.__proj__Node__item___0 (Term Term) Term)

;;;;;;;;;;;;;;;;projectee: _: tree a {Node? _} -> Prims.list (tree a)
(declare-fun Tm_arrow_9784c32d9471f19f2681d105917d90f3 () Term)
(declare-fun Termination.__proj__Node__item___0@tok () Term)

; </end encoding val Termination.__proj__Node__item___0>

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Termination.uu___is_Node; Namespace Termination
(assert (! 
;; def=Termination.fst(115,4-115,8); use=Termination.fst(115,4-115,8)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
...
(HasType @x1
(Termination.tree @x0)))
(HasType (Termination.uu___is_Node @x0
@x1)
Prims.bool))
 

:pattern ((Termination.uu___is_Node @x0
@x1))
:qid typing_Termination.uu___is_Node))

:named typing_Termination.uu___is_Node))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name Termination.__proj__Node__item___0; Namespace Termination
(assert (! 
;; def=Termination.fst(115,4-115,8); use=Termination.fst(115,4-115,8)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_ef7437472d1ef108a142a5a0fa28c50f @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_ef7437472d1ef108a142a5a0fa28c50f @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_ef7437472d1ef108a142a5a0fa28c50f))

:named refinement_kinding_Tm_refine_ef7437472d1ef108a142a5a0fa28c50f))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name Termination.__proj__Node__item___0; Namespace Termination
(assert (! 
;; def=Termination.fst(115,4-115,8); use=Termination.fst(115,4-115,8)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_ef7437472d1ef108a142a5a0fa28c50f @x2))
(and (HasTypeFuel @u0
@x1
(Termination.tree @x2))

;; def=Termination.fst(115,4-115,8); use=Termination.fst(115,4-115,8)
(BoxBool_proj_0 (Termination.uu___is_Node @x2
@x1))
))
...
@x1
(Tm_refine_ef7437472d1ef108a142a5a0fa28c50f @x2)))
:qid refinement_interpretation_Tm_refine_ef7437472d1ef108a142a5a0fa28c50f))

:named refinement_interpretation_Tm_refine_ef7437472d1ef108a142a5a0fa28c50f))
;;;;;;;;;;;;;;;;haseq for Tm_refine_ef7437472d1ef108a142a5a0fa28c50f
;;; Fact-ids: Name Termination.__proj__Node__item___0; Namespace Termination
(assert (! 
;; def=Termination.fst(115,4-115,8); use=Termination.fst(115,4-115,8)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_ef7437472d1ef108a142a5a0fa28c50f @x0)))
(Valid (Prims.hasEq (Termination.tree @x0))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_ef7437472d1ef108a142a5a0fa28c50f @x0))))
:qid haseqTm_refine_ef7437472d1ef108a142a5a0fa28c50f))

:named haseqTm_refine_ef7437472d1ef108a142a5a0fa28c50f))
;;;;;;;;;;;;;;;;Discriminator equation
;;; Fact-ids: Name Termination.uu___is_Node; Namespace Termination
(assert (! 
;; def=Termination.fst(115,4-115,8); use=Termination.fst(115,4-115,8)
(forall ((@x0 Term) (@x1 Term))
 (! (= (Termination.uu___is_Node @x0
@x1)
(BoxBool (is-Termination.Node @x1)))
 

:pattern ((Termination.uu___is_Node @x0
@x1))
:qid disc_equation_Termination.Node))

:named disc_equation_Termination.Node))
(push) ;; push{2
...
; Encoding query formula : forall (a: Type) (projectee: _: Termination.tree a {Node? _}).
;   (*  - Could not prove post-condition
...
Tm_type)
(HasType @x1
(Tm_refine_ef7437472d1ef108a142a5a0fa28c50f @x0))

;; def=Termination.fst(115,4-115,8); use=Termination.fst(115,4-115,8)
(not 
;; def=Termination.fst(115,4-115,8); use=Termination.fst(115,4-115,8)
(BoxBool_proj_0 (Termination.uu___is_Node @x0
@x1))
)
)
label_1)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Termination.__proj__Node__item___0, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_ef7437472d1ef108a142a5a0fa28c50f
...
; encoding sigelt val Termination.treeMap


; <Skipped val Termination.treeMap/>

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Termination.move_refinement; Namespace Termination
(assert (! 
;; def=Termination.fst(109,8-109,23); use=Termination.fst(109,8-109,23)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x0
...
(Tm_arrow_2eaa01e78f73e9bab5d0955fc1a662da @x0))
(HasType @x2
(Tm_refine_b9e1673579cdccbda36cfe3f78ac6f4f @x0
@x1)))
(HasType (Termination.move_refinement @x0
@x1
@x2)
...
(Tm_arrow_2eaa01e78f73e9bab5d0955fc1a662da @x1))
(HasType @x3
(Tm_refine_b9e1673579cdccbda36cfe3f78ac6f4f @x1
@x2)))
(HasType (Termination.move_refinement.fuel_instrumented @u0
@x1
@x2
@x3)
(Prims.list (Tm_refine_9f8cb5a84b67f50c9d5f87a914037545 @x1
...
:pattern ((Termination.move_refinement.fuel_instrumented @u0
@x1
@x2
@x3))
:qid token_correspondence_Termination.move_refinement.fuel_instrumented))

:named token_correspondence_Termination.move_refinement.fuel_instrumented))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name Termination.move_refinement; Namespace Termination
(assert (! 
;; def=Termination.fst(107,22-107,57); use=Termination.fst(109,8-109,23)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_refine_b9e1673579cdccbda36cfe3f78ac6f4f @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_refine_b9e1673579cdccbda36cfe3f78ac6f4f @x0
@x1)
Tm_type))
:qid refinement_kinding_Tm_refine_b9e1673579cdccbda36cfe3f78ac6f4f))

:named refinement_kinding_Tm_refine_b9e1673579cdccbda36cfe3f78ac6f4f))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name Termination.move_refinement; Namespace Termination
(assert (! 
;; def=Termination.fst(107,22-107,57); use=Termination.fst(109,8-109,23)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_b9e1673579cdccbda36cfe3f78ac6f4f @x2
@x3))
(and (HasTypeFuel @u0
@x1
(Prims.list @x2))
...
;;no pats
:qid refinement_interpretation_Tm_refine_b9e1673579cdccbda36cfe3f78ac6f4f.1))
))
...
(Tm_refine_b9e1673579cdccbda36cfe3f78ac6f4f @x2
@x3)))
:qid refinement_interpretation_Tm_refine_b9e1673579cdccbda36cfe3f78ac6f4f))

:named refinement_interpretation_Tm_refine_b9e1673579cdccbda36cfe3f78ac6f4f))
;;;;;;;;;;;;;;;;haseq for Tm_refine_b9e1673579cdccbda36cfe3f78ac6f4f
;;; Fact-ids: Name Termination.move_refinement; Namespace Termination
(assert (! 
;; def=Termination.fst(107,22-107,57); use=Termination.fst(109,8-109,23)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_b9e1673579cdccbda36cfe3f78ac6f4f @x0
@x1)))
(Valid (Prims.hasEq (Prims.list @x0))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_b9e1673579cdccbda36cfe3f78ac6f4f @x0
@x1))))
:qid haseqTm_refine_b9e1673579cdccbda36cfe3f78ac6f4f))

:named haseqTm_refine_b9e1673579cdccbda36cfe3f78ac6f4f))
;;;;;;;;;;;;;;;;Equation for fuel-instrumented recursive function: Termination.move_refinement
;;; Fact-ids: Name Termination.move_refinement; Namespace Termination
(assert (! 
;; def=Termination.fst(109,8-109,23); use=Termination.fst(109,8-109,23)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
...
(Tm_refine_b9e1673579cdccbda36cfe3f78ac6f4f @x1
@x2)))
(= (Termination.move_refinement.fuel_instrumented (SFuel @u0)
@x1
@x2
@x3)
(let ((@lb4 @x3))
(ite (is-Prims.Nil @lb4)
(Prims.Nil (Tm_refine_9f8cb5a84b67f50c9d5f87a914037545 @x1
@x2))
(ite (is-Prims.Cons @lb4)
(Prims.Cons (Tm_refine_9f8cb5a84b67f50c9d5f87a914037545 @x1
@x2)
(Prims.Cons_hd @lb4)
(Termination.move_refinement.fuel_instrumented @u0
@x1
@x2
(Prims.Cons_tl @lb4)))
Tm_unit)))))
...
:pattern ((Termination.move_refinement.fuel_instrumented (SFuel @u0)
@x1
@x2
@x3))
:qid equation_with_fuel_Termination.move_refinement.fuel_instrumented))

:named equation_with_fuel_Termination.move_refinement.fuel_instrumented))
;;;;;;;;;;;;;;;;Fuel irrelevance
;;; Fact-ids: Name Termination.move_refinement; Namespace Termination
(assert (! 
;; def=Termination.fst(109,8-109,23); use=Termination.fst(109,8-109,23)
...
@x2
@x3)
(Termination.move_refinement.fuel_instrumented ZFuel
@x1
@x2
@x3))
...
@x2
@x3))
:qid @fuel_irrelevance_Termination.move_refinement.fuel_instrumented))

:named @fuel_irrelevance_Termination.move_refinement.fuel_instrumented))
;;;;;;;;;;;;;;;;Correspondence of recursive function to instrumented version
;;; Fact-ids: Name Termination.move_refinement; Namespace Termination
(assert (! 
;; def=Termination.fst(109,8-109,23); use=Termination.fst(109,8-109,23)
...
@x1
@x2)
(Termination.move_refinement.fuel_instrumented MaxFuel
@x0
@x1
@x2))
...
@x1
@x2))
:qid @fuel_correspondence_Termination.move_refinement.fuel_instrumented))

:named @fuel_correspondence_Termination.move_refinement.fuel_instrumented))
(push) ;; push{2

; Starting query at Termination.fst(118,28-125,28)
...
:named binder_x_fe28d8bcde588226b4e538b35321de05_2))
;;;;;;;;;;;;;;;;f : _: a -> b (_: a -> b)
(declare-fun x_ae348e743fc382743020e3adbf38fac9_3 () Term)
;;;;;;;;;;;;;;;;_: a -> b
(declare-fun Tm_arrow_20a5ad0236d74794182db95eb9066fc4 () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_20a5ad0236d74794182db95eb9066fc4
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_20a5ad0236d74794182db95eb9066fc4
Tm_type)
:named kinding_Tm_arrow_20a5ad0236d74794182db95eb9066fc4))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(118,17-118,21); use=Termination.fst(118,17-118,21)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_20a5ad0236d74794182db95eb9066fc4)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_20a5ad0236d74794182db95eb9066fc4))
:qid Termination_pre_typing_Tm_arrow_20a5ad0236d74794182db95eb9066fc4))

:named Termination_pre_typing_Tm_arrow_20a5ad0236d74794182db95eb9066fc4))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_20a5ad0236d74794182db95eb9066fc4
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(118,17-118,21); use=Termination.fst(118,17-118,21)
(forall ((@x0 Term))
...
:pattern ((ApplyTT @x0
@x1))
:qid Termination_interpretation_Tm_arrow_20a5ad0236d74794182db95eb9066fc4.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_20a5ad0236d74794182db95eb9066fc4))
:qid Termination_interpretation_Tm_arrow_20a5ad0236d74794182db95eb9066fc4))

:named Termination_interpretation_Tm_arrow_20a5ad0236d74794182db95eb9066fc4))
;;;;;;;;;;;;;;;;binder_x_ae348e743fc382743020e3adbf38fac9_3
;;; Fact-ids: 
(assert (! (HasType x_ae348e743fc382743020e3adbf38fac9_3
Tm_arrow_20a5ad0236d74794182db95eb9066fc4)
:named binder_x_ae348e743fc382743020e3adbf38fac9_3))
;;;;;;;;;;;;;;;;v : Termination.tree a (Termination.tree a)
(declare-fun x_32126e64b1040b93adb289317bd0c1e7_4 () Term)
;;;;;;;;;;;;;;;;binder_x_32126e64b1040b93adb289317bd0c1e7_4
;;; Fact-ids: 
(assert (! (HasType x_32126e64b1040b93adb289317bd0c1e7_4
(Termination.tree x_9cd1733a5204f989dbb2f01d5984df93_1))
:named binder_x_32126e64b1040b93adb289317bd0c1e7_4))

(declare-fun Tm_refine_8665f3bb85ca64b09ff64ee6e0c8d475 (Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(117,15-125,28); use=Termination.fst(117,15-125,28)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_8665f3bb85ca64b09ff64ee6e0c8d475 @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_8665f3bb85ca64b09ff64ee6e0c8d475 @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_8665f3bb85ca64b09ff64ee6e0c8d475))

:named refinement_kinding_Tm_refine_8665f3bb85ca64b09ff64ee6e0c8d475))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(117,15-125,28); use=Termination.fst(117,15-125,28)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_8665f3bb85ca64b09ff64ee6e0c8d475 @x2))
(and (HasTypeFuel @u0
@x1
(Termination.tree @x2))
...
;; def=Termination.fst(117,15-125,28); use=Termination.fst(117,15-125,28)
(or 
;; def=Termination.fst(118,28-125,28); use=Termination.fst(118,28-125,28)
(Valid 
;; def=Termination.fst(118,28-125,28); use=Termination.fst(118,28-125,28)
(Prims.precedes Prims.eqtype
Prims.eqtype
...
;; def=Termination.fst(117,15-125,28); use=Termination.fst(117,15-125,28)
(and 
;; def=Termination.fst(117,15-118,18); use=Termination.fst(117,15-118,18)
(Valid 
;; def=Termination.fst(117,15-118,18); use=Termination.fst(117,15-118,18)
(Prims.op_Equals_Equals_Equals Prims.eqtype
Prims.eqtype
...
(Valid 
;; def=Termination.fst(118,28-125,28); use=Termination.fst(118,28-125,28)
(Prims.precedes (Termination.tree @x2)
(Termination.tree x_9cd1733a5204f989dbb2f01d5984df93_1)
@x1
x_32126e64b1040b93adb289317bd0c1e7_4)
)
)
)
...
@x1
(Tm_refine_8665f3bb85ca64b09ff64ee6e0c8d475 @x2)))
:qid refinement_interpretation_Tm_refine_8665f3bb85ca64b09ff64ee6e0c8d475))

:named refinement_interpretation_Tm_refine_8665f3bb85ca64b09ff64ee6e0c8d475))
;;;;;;;;;;;;;;;;haseq for Tm_refine_8665f3bb85ca64b09ff64ee6e0c8d475
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(117,15-125,28); use=Termination.fst(117,15-125,28)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_8665f3bb85ca64b09ff64ee6e0c8d475 @x0)))
(Valid (Prims.hasEq (Termination.tree @x0))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_8665f3bb85ca64b09ff64ee6e0c8d475 @x0))))
:qid haseqTm_refine_8665f3bb85ca64b09ff64ee6e0c8d475))

:named haseqTm_refine_8665f3bb85ca64b09ff64ee6e0c8d475))
(declare-fun Termination.treeMap (Term Term Term Term) Term)


;;;;;;;;;;;;;;;;_: (_: a -> b) -> _: _: tree a {a << a \/ a === a /\ _ << v} -> tree b
(declare-fun Tm_arrow_bdca5884abd2fcfce6e37a3495833c25 () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_bdca5884abd2fcfce6e37a3495833c25
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_bdca5884abd2fcfce6e37a3495833c25
Tm_type)
:named kinding_Tm_arrow_bdca5884abd2fcfce6e37a3495833c25))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(117,15-125,28); use=Termination.fst(117,15-125,28)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_bdca5884abd2fcfce6e37a3495833c25)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_bdca5884abd2fcfce6e37a3495833c25))
:qid Termination_pre_typing_Tm_arrow_bdca5884abd2fcfce6e37a3495833c25))

:named Termination_pre_typing_Tm_arrow_bdca5884abd2fcfce6e37a3495833c25))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_bdca5884abd2fcfce6e37a3495833c25
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(117,15-125,28); use=Termination.fst(117,15-125,28)
(forall ((@x0 Term))
...
@x1))
(HasType @x4
(Tm_refine_8665f3bb85ca64b09ff64ee6e0c8d475 @x1)))
(HasType (ApplyTT (ApplyTT (ApplyTT (ApplyTT @x0
@x1)
@x2)
@x3)
...
@x3)
@x4))
:qid Termination_interpretation_Tm_arrow_bdca5884abd2fcfce6e37a3495833c25.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid Termination_interpretation_Tm_arrow_bdca5884abd2fcfce6e37a3495833c25.2))
...
@x1)
@x2))
:qid Termination_interpretation_Tm_arrow_bdca5884abd2fcfce6e37a3495833c25.3))
...
@x2)
@x3))
:qid Termination_interpretation_Tm_arrow_bdca5884abd2fcfce6e37a3495833c25.4))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_bdca5884abd2fcfce6e37a3495833c25))
:qid Termination_interpretation_Tm_arrow_bdca5884abd2fcfce6e37a3495833c25))

:named Termination_interpretation_Tm_arrow_bdca5884abd2fcfce6e37a3495833c25))
(declare-fun Termination.treeMap@tok () Term)
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(118,8-118,15); use=Termination.fst(118,8-118,15)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (ApplyTT (ApplyTT (ApplyTT (ApplyTT Termination.treeMap@tok
@x0)
@x1)
@x2)
@x3)
(Termination.treeMap @x0
@x1
@x2
@x3))
 

:pattern ((ApplyTT (ApplyTT (ApplyTT (ApplyTT Termination.treeMap@tok
@x0)
@x1)
@x2)
@x3))
:qid token_correspondence_Termination.treeMap))

:named token_correspondence_Termination.treeMap))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(118,8-118,15); use=Termination.fst(118,8-118,15)
(forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType Termination.treeMap@tok
Tm_arrow_bdca5884abd2fcfce6e37a3495833c25))
...
@x3)
@x4)
(Termination.treeMap @x1
@x2
@x3
@x4))
 

:pattern ((Termination.treeMap @x1
@x2
@x3
@x4))
:qid function_token_typing_Termination.treeMap.1))
)
 

:pattern ((ApplyTT @x0
Termination.treeMap@tok))
:qid function_token_typing_Termination.treeMap))

:named function_token_typing_Termination.treeMap))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(118,8-118,15); use=Termination.fst(118,8-118,15)
...
@x0))
(HasType @x3
(Tm_refine_8665f3bb85ca64b09ff64ee6e0c8d475 @x0)))
(HasType (Termination.treeMap @x0
@x1
@x2
@x3)
(Termination.tree @x1)))
...
:pattern ((Termination.treeMap @x0
@x1
@x2
@x3))
:qid typing_Termination.treeMap))

:named typing_Termination.treeMap))
(declare-fun label_4 () Bool)
(declare-fun label_3 () Bool)
(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)
(declare-fun Tm_refine_7618526ec8ceccda4948844ddd7a4a04 () Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! (HasType Tm_refine_7618526ec8ceccda4948844ddd7a4a04
Tm_type)
:named refinement_kinding_Tm_refine_7618526ec8ceccda4948844ddd7a4a04))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(108,32-108,42); use=Termination.fst(118,28-125,28)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_7618526ec8ceccda4948844ddd7a4a04)
(and (HasTypeFuel @u0
@x1
(Termination.tree x_9cd1733a5204f989dbb2f01d5984df93_1))

;; def=Termination.fst(124,43-124,50); use=Termination.fst(118,28-125,28)
(Valid 
;; def=Termination.fst(124,43-124,50); use=Termination.fst(118,28-125,28)
(Prims.precedes (Termination.tree x_9cd1733a5204f989dbb2f01d5984df93_1)
(Termination.tree x_9cd1733a5204f989dbb2f01d5984df93_1)
@x1
x_32126e64b1040b93adb289317bd0c1e7_4)
)
...
@x1
Tm_refine_7618526ec8ceccda4948844ddd7a4a04))
:qid refinement_interpretation_Tm_refine_7618526ec8ceccda4948844ddd7a4a04))

:named refinement_interpretation_Tm_refine_7618526ec8ceccda4948844ddd7a4a04))
;;;;;;;;;;;;;;;;haseq for Tm_refine_7618526ec8ceccda4948844ddd7a4a04
;;; Fact-ids: 
(assert (! (iff (Valid (Prims.hasEq Tm_refine_7618526ec8ceccda4948844ddd7a4a04))
(Valid (Prims.hasEq (Termination.tree x_9cd1733a5204f989dbb2f01d5984df93_1))))
:named haseqTm_refine_7618526ec8ceccda4948844ddd7a4a04))
;;;;;;;;;;;;;;;;aa: tree a -> Type0
(declare-fun Tm_arrow_e06966cbb002768cb69c9e1612c61d57 () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_e06966cbb002768cb69c9e1612c61d57
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_e06966cbb002768cb69c9e1612c61d57
Tm_type)
:named kinding_Tm_arrow_e06966cbb002768cb69c9e1612c61d57))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(106,31-115,24); use=Termination.fst(124,12-124,27)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_e06966cbb002768cb69c9e1612c61d57)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_e06966cbb002768cb69c9e1612c61d57))
:qid Termination_pre_typing_Tm_arrow_e06966cbb002768cb69c9e1612c61d57))

:named Termination_pre_typing_Tm_arrow_e06966cbb002768cb69c9e1612c61d57))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_e06966cbb002768cb69c9e1612c61d57
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(106,31-115,24); use=Termination.fst(124,12-124,27)
(forall ((@x0 Term))
...
:pattern ((ApplyTT @x0
@x1))
:qid Termination_interpretation_Tm_arrow_e06966cbb002768cb69c9e1612c61d57.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_e06966cbb002768cb69c9e1612c61d57))
:qid Termination_interpretation_Tm_arrow_e06966cbb002768cb69c9e1612c61d57))

:named Termination_interpretation_Tm_arrow_e06966cbb002768cb69c9e1612c61d57))
(declare-fun Tm_abs_638fa8ff2f517dfbcb3a65ef5f4649c9 () Term)
;;;;;;;;;;;;;;;;typing_Tm_abs_638fa8ff2f517dfbcb3a65ef5f4649c9
;;; Fact-ids: 
(assert (! (HasType Tm_abs_638fa8ff2f517dfbcb3a65ef5f4649c9
Tm_arrow_e06966cbb002768cb69c9e1612c61d57)
:named typing_Tm_abs_638fa8ff2f517dfbcb3a65ef5f4649c9))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_638fa8ff2f517dfbcb3a65ef5f4649c9
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(124,43-124,50); use=Termination.fst(124,43-124,50)
(forall ((@x0 Term))
 (! (= (ApplyTT Tm_abs_638fa8ff2f517dfbcb3a65ef5f4649c9
@x0)
(Prims.precedes (Termination.tree x_9cd1733a5204f989dbb2f01d5984df93_1)
(Termination.tree x_9cd1733a5204f989dbb2f01d5984df93_1)
@x0
...
:pattern ((ApplyTT Tm_abs_638fa8ff2f517dfbcb3a65ef5f4649c9
@x0))
:qid interpretation_Tm_abs_638fa8ff2f517dfbcb3a65ef5f4649c9))

:named interpretation_Tm_abs_638fa8ff2f517dfbcb3a65ef5f4649c9))

; Encoding query formula : forall (k: Prims.pure_post (Termination.tree b)).
;   (forall (x: Termination.tree b). {:pattern Prims.guard_free (k x)} Prims.auto_squash (k x)) ==>
;   (~(Leaf? v) /\ ~(Node? v) ==> Prims.l_False) /\
;   (~(Leaf? v) ==>
;     (forall (b: Prims.list (Termination.tree a)).
;         v == Termination.Node b ==>
;         Prims.hasEq (Termination.tree a) /\
;         (forall (return_val: Prims.eqtype).
;             return_val == Termination.tree a ==>
;             (forall (z: Termination.tree a). Termination.mem z b ==> z << v) /\
;             (forall (any_result: Prims.list (Termination.tree a)).
;                 b == any_result ==>
;                 (forall (any_result: Prims.list (x: Termination.tree a {x << v})).
;                     Termination.move_refinement b == any_result ==>
;                     (forall (x: Termination.tree a). x << v ==> a << a \/ x << v))))))


; Context: While encoding a query
; While typechecking the top-level declaration `let rec treeMap`
...
(assert (! (not (forall ((@x0 Term))
 (! (implies (and (HasType @x0
(Prims.pure_post (Termination.tree x_fe28d8bcde588226b4e538b35321de05_2)))

;; def=Prims.fst(402,27-402,88); use=Termination.fst(118,28-125,28)
(forall ((@x1 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=Termination.fst(118,28-125,28)
(Valid 
;; def=Prims.fst(402,84-402,87); use=Termination.fst(118,28-125,28)
(ApplyTT @x0
@x1)
...
;; def=Prims.fst(459,77-459,89); use=Termination.fst(118,28-125,28)
(and (implies 
;; def=Termination.fst(118,24-118,25); use=Termination.fst(118,34-118,35)
(and 
;; def=Termination.fst(118,24-118,25); use=Termination.fst(118,34-118,35)
(not 
;; def=Termination.fst(118,24-118,25); use=Termination.fst(118,34-118,35)
(BoxBool_proj_0 (Termination.uu___is_Leaf x_9cd1733a5204f989dbb2f01d5984df93_1
x_32126e64b1040b93adb289317bd0c1e7_4))
)
...
(not 
;; def=Termination.fst(118,24-118,25); use=Termination.fst(118,34-118,35)
(BoxBool_proj_0 (Termination.uu___is_Node x_9cd1733a5204f989dbb2f01d5984df93_1
x_32126e64b1040b93adb289317bd0c1e7_4))
)
)
...
label_1)
(implies 
;; def=Prims.fst(389,19-389,21); use=Termination.fst(118,28-125,28)
(not 
;; def=Termination.fst(118,24-118,25); use=Termination.fst(118,34-118,35)
(BoxBool_proj_0 (Termination.uu___is_Leaf x_9cd1733a5204f989dbb2f01d5984df93_1
x_32126e64b1040b93adb289317bd0c1e7_4))
...
;; def=Prims.fst(413,99-413,120); use=Termination.fst(118,28-125,28)
(forall ((@x1 Term))
 (! (implies (and (HasType @x1
(Prims.list (Termination.tree x_9cd1733a5204f989dbb2f01d5984df93_1)))

;; def=Termination.fst(118,24-120,10); use=Termination.fst(118,34-120,10)
(= x_32126e64b1040b93adb289317bd0c1e7_4
(Termination.Node x_9cd1733a5204f989dbb2f01d5984df93_1
@x1))
)

;; def=Prims.fst(459,77-459,89); use=Termination.fst(118,28-125,28)
(and 
;; def=Prims.fst(73,23-73,30); use=Termination.fst(124,52-124,53)
(or label_2

;; def=Prims.fst(73,23-73,30); use=Termination.fst(124,52-124,53)
(Valid 
;; def=Prims.fst(73,23-73,30); use=Termination.fst(124,52-124,53)
(Prims.hasEq (Termination.tree x_9cd1733a5204f989dbb2f01d5984df93_1))
)
)


;; def=Prims.fst(356,2-356,58); use=Termination.fst(118,28-125,28)
(forall ((@x2 Term))
 (! (implies (and (HasType @x2
Prims.eqtype)

;; def=Prims.fst(356,26-356,41); use=Termination.fst(118,28-125,28)
(= @x2
(Termination.tree x_9cd1733a5204f989dbb2f01d5984df93_1))
)
...
;; def=Prims.fst(459,77-459,89); use=Termination.fst(118,28-125,28)
(and 
;; def=Termination.fst(107,31-107,56); use=Termination.fst(124,52-124,53)
(forall ((@x3 Term))
 (! (implies (and (HasType @x3
(Termination.tree x_9cd1733a5204f989dbb2f01d5984df93_1))

;; def=Termination.fst(107,41-107,48); use=Termination.fst(124,52-124,53)
(BoxBool_proj_0 (Termination.mem (Termination.tree x_9cd1733a5204f989dbb2f01d5984df93_1)
@x3
@x1))
)

;; def=Termination.fst(124,43-124,50); use=Termination.fst(124,52-124,53)
(or label_3
...
;; def=Prims.fst(451,66-451,102); use=Termination.fst(118,28-125,28)
(forall ((@x3 Term))
 (! (implies (and (HasType @x3
(Prims.list (Termination.tree x_9cd1733a5204f989dbb2f01d5984df93_1)))

;; def=Termination.fst(107,22-120,10); use=Termination.fst(118,28-125,28)
(= @x1
@x3)
)
...
(forall ((@x4 Term))
 (! (implies (and (HasType @x4
(Prims.list Tm_refine_7618526ec8ceccda4948844ddd7a4a04))

;; def=Termination.fst(124,8-124,53); use=Termination.fst(124,8-124,53)
(= (Termination.move_refinement (Termination.tree x_9cd1733a5204f989dbb2f01d5984df93_1)
Tm_abs_638fa8ff2f517dfbcb3a65ef5f4649c9
@x1)
@x4)
)

;; def=dummy(0,0-0,0); use=Termination.fst(125,14-125,25)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
(Termination.tree x_9cd1733a5204f989dbb2f01d5984df93_1))

;; def=Termination.fst(124,43-124,50); use=Termination.fst(125,14-125,25)
(Valid 
;; def=Termination.fst(124,43-124,50); use=Termination.fst(125,14-125,25)
(Prims.precedes (Termination.tree x_9cd1733a5204f989dbb2f01d5984df93_1)
(Termination.tree x_9cd1733a5204f989dbb2f01d5984df93_1)
...
;; def=Termination.fst(117,15-125,28); use=Termination.fst(125,14-125,25)
(or label_4

;; def=Termination.fst(118,28-125,28); use=Termination.fst(125,14-125,25)
(Valid 
;; def=Termination.fst(118,28-125,28); use=Termination.fst(125,14-125,25)
(Prims.precedes Prims.eqtype
Prims.eqtype
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Termination.treeMap, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxFuel_assumption, @MaxIFuel_assumption, @fuel_correspondence_Termination.mem.fuel_instrumented, @fuel_irrelevance_Termination.mem.fuel_instrumented, @query, assumption_Termination.tree__uu___haseq, binder_x_32126e64b1040b93adb289317bd0c1e7_4, binder_x_9cd1733a5204f989dbb2f01d5984df93_1, disc_equation_Termination.Leaf, disc_equation_Termination.Node, equation_Prims.eqtype, fuel_guarded_inversion_Termination.tree, kinding_Termination.tree@tok, lemma_Termination.list_subterm_ordering_lemma, projection_inverse_BoxBool_proj_0, projection_inverse_Termination.Node__0, refinement_interpretation_Tm_refine_414d0a9f578ab0048252f8c8f552b99f, subterm_ordering_Termination.Node
...
; encoding sigelt let rec treeMap


; <Start encoding let rec treeMap>

;;;;;;;;;;;;;;;;Fuel-instrumented function name
(declare-fun Termination.treeMap.fuel_instrumented (Fuel Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Token for fuel-instrumented partial applications
(declare-fun Termination.treeMap.fuel_instrumented_token () Term)
(declare-fun Termination.treeMap (Term Term Term Term) Term)
(declare-fun Termination.treeMap@tok () Term)

(declare-fun Tm_refine_c89dd35fe5709b0ed79e43b59b668dbc (Term Term) Term)
;;;;;;;;;;;;;;;;aa: tree a -> Type
(declare-fun Tm_arrow_e7cc397321806925b9bf281bdcf212cd (Term) Term)
(declare-fun Tm_abs_3a1a3dc732c714c1ed4eb4ca6d8ec5cc (Term Term) Term)


;;;;;;;;;;;;;;;;f: (_: a -> b) -> v: tree a -> tree b
(declare-fun Tm_arrow_8d9396f5cbb9b18baaf9428d94e34224 () Term)

; </end encoding let rec treeMap>

(push) ;; push{2

; Starting query at Termination.fst(134,2-136,35)
...
(declare-fun x_3dddec8ced2db740e4e8aaf70542be7a_4 () Term)
;;;;;;;;;;;;;;;;binder_x_3dddec8ced2db740e4e8aaf70542be7a_4
;;; Fact-ids: 
(assert (! (HasType x_3dddec8ced2db740e4e8aaf70542be7a_4
(Prims.list x_fe28d8bcde588226b4e538b35321de05_2))
:named binder_x_3dddec8ced2db740e4e8aaf70542be7a_4))
;;;;;;;;;;;;;;;;f : x: 'a{x << xs} -> 'b (x: 'a{x << xs} -> 'b)
(declare-fun x_9a305c3782f75fc0de9ec4fa859ac971_5 () Term)
(declare-fun Tm_refine_f1b459fdb0239e3d69082b2ae49561b1 () Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! (HasType Tm_refine_f1b459fdb0239e3d69082b2ae49561b1
Tm_type)
:named refinement_kinding_Tm_refine_f1b459fdb0239e3d69082b2ae49561b1))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(133,34-133,45); use=Termination.fst(133,34-133,45)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_f1b459fdb0239e3d69082b2ae49561b1)
(and (HasTypeFuel @u0
@x1
x_fe28d8bcde588226b4e538b35321de05_2)

;; def=Termination.fst(133,39-133,44); use=Termination.fst(133,39-133,44)
(Valid 
;; def=Termination.fst(133,39-133,44); use=Termination.fst(133,39-133,44)
(Prims.precedes x_fe28d8bcde588226b4e538b35321de05_2
(Prims.list x_fe28d8bcde588226b4e538b35321de05_2)
@x1
x_3dddec8ced2db740e4e8aaf70542be7a_4)
)
))
...
@x1
Tm_refine_f1b459fdb0239e3d69082b2ae49561b1))
:qid refinement_interpretation_Tm_refine_f1b459fdb0239e3d69082b2ae49561b1))

:named refinement_interpretation_Tm_refine_f1b459fdb0239e3d69082b2ae49561b1))
;;;;;;;;;;;;;;;;haseq for Tm_refine_f1b459fdb0239e3d69082b2ae49561b1
;;; Fact-ids: 
(assert (! (iff (Valid (Prims.hasEq Tm_refine_f1b459fdb0239e3d69082b2ae49561b1))
(Valid (Prims.hasEq x_fe28d8bcde588226b4e538b35321de05_2)))
:named haseqTm_refine_f1b459fdb0239e3d69082b2ae49561b1))
;;;;;;;;;;;;;;;;x: 'a{x << xs} -> 'b
(declare-fun Tm_arrow_1de663e40ea0f878cf097a12c75d068e () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_1de663e40ea0f878cf097a12c75d068e
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_1de663e40ea0f878cf097a12c75d068e
Tm_type)
:named kinding_Tm_arrow_1de663e40ea0f878cf097a12c75d068e))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(133,34-133,51); use=Termination.fst(133,34-133,51)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_1de663e40ea0f878cf097a12c75d068e)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_1de663e40ea0f878cf097a12c75d068e))
:qid Termination_pre_typing_Tm_arrow_1de663e40ea0f878cf097a12c75d068e))

:named Termination_pre_typing_Tm_arrow_1de663e40ea0f878cf097a12c75d068e))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_1de663e40ea0f878cf097a12c75d068e
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(133,34-133,51); use=Termination.fst(133,34-133,51)
(forall ((@x0 Term))
...
:pattern ((ApplyTT @x0
@x1))
:qid Termination_interpretation_Tm_arrow_1de663e40ea0f878cf097a12c75d068e.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_1de663e40ea0f878cf097a12c75d068e))
:qid Termination_interpretation_Tm_arrow_1de663e40ea0f878cf097a12c75d068e))

:named Termination_interpretation_Tm_arrow_1de663e40ea0f878cf097a12c75d068e))
;;;;;;;;;;;;;;;;binder_x_9a305c3782f75fc0de9ec4fa859ac971_5
;;; Fact-ids: 
(assert (! (HasType x_9a305c3782f75fc0de9ec4fa859ac971_5
Tm_arrow_1de663e40ea0f878cf097a12c75d068e)
:named binder_x_9a305c3782f75fc0de9ec4fa859ac971_5))
...
;; def=Termination.fst(133,34-133,45); use=Termination.fst(133,34-133,45)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_refine_c4ca0045c23e9d6917d9058bb1a95736 @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_refine_c4ca0045c23e9d6917d9058bb1a95736 @x0
@x1)
Tm_type))
:qid refinement_kinding_Tm_refine_c4ca0045c23e9d6917d9058bb1a95736))

:named refinement_kinding_Tm_refine_c4ca0045c23e9d6917d9058bb1a95736))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(133,34-133,45); use=Termination.fst(133,34-133,45)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_c4ca0045c23e9d6917d9058bb1a95736 @x2
@x3))
(and (HasTypeFuel @u0
@x1
@x2)
...
(Tm_refine_c4ca0045c23e9d6917d9058bb1a95736 @x2
@x3)))
:qid refinement_interpretation_Tm_refine_c4ca0045c23e9d6917d9058bb1a95736))

:named refinement_interpretation_Tm_refine_c4ca0045c23e9d6917d9058bb1a95736))
;;;;;;;;;;;;;;;;haseq for Tm_refine_c4ca0045c23e9d6917d9058bb1a95736
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(133,34-133,45); use=Termination.fst(133,34-133,45)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_c4ca0045c23e9d6917d9058bb1a95736 @x0
@x1)))
(Valid (Prims.hasEq @x0)))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_c4ca0045c23e9d6917d9058bb1a95736 @x0
@x1))))
:qid haseqTm_refine_c4ca0045c23e9d6917d9058bb1a95736))

:named haseqTm_refine_c4ca0045c23e9d6917d9058bb1a95736))
;;;;;;;;;;;;;;;;x: 'a{x << xs} -> 'b
(declare-fun Tm_arrow_621591658832ae36567b8ddca04eb043 (Term Term Term) Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_621591658832ae36567b8ddca04eb043
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(133,34-133,51); use=Termination.fst(133,34-133,51)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (HasType (Tm_arrow_621591658832ae36567b8ddca04eb043 @x0
@x1
@x2)
Tm_type)
 

:pattern ((HasType (Tm_arrow_621591658832ae36567b8ddca04eb043 @x0
@x1
@x2)
Tm_type))
:qid kinding_Tm_arrow_621591658832ae36567b8ddca04eb043))

:named kinding_Tm_arrow_621591658832ae36567b8ddca04eb043))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(133,34-133,51); use=Termination.fst(133,34-133,51)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_621591658832ae36567b8ddca04eb043 @x2
@x3
@x4))
(is-Tm_arrow (PreType @x1)))
...
@x3
@x4)))
:qid Termination_pre_typing_Tm_arrow_621591658832ae36567b8ddca04eb043))

:named Termination_pre_typing_Tm_arrow_621591658832ae36567b8ddca04eb043))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_621591658832ae36567b8ddca04eb043
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(133,34-133,51); use=Termination.fst(133,34-133,51)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_621591658832ae36567b8ddca04eb043 @x1
@x2
@x3))
(and 
;; def=Termination.fst(133,34-133,51); use=Termination.fst(133,34-133,51)
(forall ((@x4 Term))
 (! (implies (HasType @x4
(Tm_refine_c4ca0045c23e9d6917d9058bb1a95736 @x3
@x2))
(HasType (ApplyTT @x0
@x4)
@x1))
...
:pattern ((ApplyTT @x0
@x4))
:qid Termination_interpretation_Tm_arrow_621591658832ae36567b8ddca04eb043.1))
...
@x2
@x3)))
:qid Termination_interpretation_Tm_arrow_621591658832ae36567b8ddca04eb043))

:named Termination_interpretation_Tm_arrow_621591658832ae36567b8ddca04eb043))
(declare-fun Tm_refine_4cfe9d9b9752735643454772cd7c564c (Term Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(133,31-136,35); use=Termination.fst(133,31-136,35)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (HasType (Tm_refine_4cfe9d9b9752735643454772cd7c564c @x0
@x1
@x2)
Tm_type)
 

:pattern ((HasType (Tm_refine_4cfe9d9b9752735643454772cd7c564c @x0
@x1
@x2)
Tm_type))
:qid refinement_kinding_Tm_refine_4cfe9d9b9752735643454772cd7c564c))

:named refinement_kinding_Tm_refine_4cfe9d9b9752735643454772cd7c564c))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(133,31-136,35); use=Termination.fst(133,31-136,35)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_4cfe9d9b9752735643454772cd7c564c @x2
@x3
@x4))
(and (HasTypeFuel @u0
@x1
...
;; def=Termination.fst(134,2-136,35); use=Termination.fst(134,2-136,35)
...
@x3
@x4)))
:qid refinement_interpretation_Tm_refine_4cfe9d9b9752735643454772cd7c564c))

:named refinement_interpretation_Tm_refine_4cfe9d9b9752735643454772cd7c564c))
;;;;;;;;;;;;;;;;haseq for Tm_refine_4cfe9d9b9752735643454772cd7c564c
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(133,31-136,35); use=Termination.fst(133,31-136,35)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_4cfe9d9b9752735643454772cd7c564c @x0
@x1
@x2)))
(Valid (Prims.hasEq (Tm_arrow_621591658832ae36567b8ddca04eb043 @x0
@x2
@x1))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_4cfe9d9b9752735643454772cd7c564c @x0
@x1
@x2))))
:qid haseqTm_refine_4cfe9d9b9752735643454772cd7c564c))

:named haseqTm_refine_4cfe9d9b9752735643454772cd7c564c))
(declare-fun Termination.list_map (Term Term Term Term) Term)



;;;;;;;;;;;;;;;;xs: Prims.list 'a -> f: (x: 'a{x << xs} -> 'b){xs << xs} -> Prims.list 'b
(declare-fun Tm_arrow_1a975f16c27f41fe861b3c3d7d13be51 () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_1a975f16c27f41fe861b3c3d7d13be51
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_1a975f16c27f41fe861b3c3d7d13be51
Tm_type)
:named kinding_Tm_arrow_1a975f16c27f41fe861b3c3d7d13be51))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(133,21-136,35); use=Termination.fst(133,21-136,35)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_1a975f16c27f41fe861b3c3d7d13be51)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_1a975f16c27f41fe861b3c3d7d13be51))
:qid Termination_pre_typing_Tm_arrow_1a975f16c27f41fe861b3c3d7d13be51))

:named Termination_pre_typing_Tm_arrow_1a975f16c27f41fe861b3c3d7d13be51))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_1a975f16c27f41fe861b3c3d7d13be51
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(133,21-136,35); use=Termination.fst(133,21-136,35)
(forall ((@x0 Term))
...
@x3)
@x4))
:qid Termination_interpretation_Tm_arrow_1a975f16c27f41fe861b3c3d7d13be51.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid Termination_interpretation_Tm_arrow_1a975f16c27f41fe861b3c3d7d13be51.2))
...
@x1)
@x2))
:qid Termination_interpretation_Tm_arrow_1a975f16c27f41fe861b3c3d7d13be51.3))
...
@x2)
@x3))
:qid Termination_interpretation_Tm_arrow_1a975f16c27f41fe861b3c3d7d13be51.4))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_1a975f16c27f41fe861b3c3d7d13be51))
:qid Termination_interpretation_Tm_arrow_1a975f16c27f41fe861b3c3d7d13be51))

:named Termination_interpretation_Tm_arrow_1a975f16c27f41fe861b3c3d7d13be51))
(declare-fun Termination.list_map@tok () Term)
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(133,8-133,16); use=Termination.fst(133,8-133,16)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (ApplyTT (ApplyTT (ApplyTT (ApplyTT Termination.list_map@tok
@x0)
@x1)
@x2)
@x3)
(Termination.list_map @x0
@x1
@x2
@x3))
 

:pattern ((ApplyTT (ApplyTT (ApplyTT (ApplyTT Termination.list_map@tok
@x0)
@x1)
@x2)
@x3))
:qid token_correspondence_Termination.list_map))

:named token_correspondence_Termination.list_map))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(133,8-133,16); use=Termination.fst(133,8-133,16)
(forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType Termination.list_map@tok
Tm_arrow_1a975f16c27f41fe861b3c3d7d13be51))
...
@x3)
@x4)
(Termination.list_map @x1
@x2
@x3
@x4))
 

:pattern ((Termination.list_map @x1
@x2
@x3
@x4))
:qid function_token_typing_Termination.list_map.1))
)
 

:pattern ((ApplyTT @x0
Termination.list_map@tok))
:qid function_token_typing_Termination.list_map))

:named function_token_typing_Termination.list_map))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(133,8-133,16); use=Termination.fst(133,8-133,16)
...
(Prims.list @x0))
(HasType @x3
(Tm_refine_4cfe9d9b9752735643454772cd7c564c @x1
@x0
@x2)))
(HasType (Termination.list_map @x0
@x1
@x2
@x3)
(Prims.list @x1)))
...
:pattern ((Termination.list_map @x0
@x1
@x2
@x3))
:qid typing_Termination.list_map))

:named typing_Termination.list_map))
(declare-fun label_4 () Bool)
(declare-fun label_3 () Bool)
(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)
...
;             b == any_result ==>
;             (forall (any_result: 'b).
;                 f b == any_result ==> (forall (x: 'a). x << b ==> x << xs) /\ b << xs))))


; Context: While encoding a query
; While typechecking the top-level declaration `let rec list_map`
...
;; def=Prims.fst(402,27-402,88); use=Termination.fst(134,2-136,35)
(forall ((@x1 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=Termination.fst(134,2-136,35)
(Valid 
;; def=Prims.fst(402,84-402,87); use=Termination.fst(134,2-136,35)
(ApplyTT @x0
@x1)
...
;; def=Prims.fst(459,77-459,89); use=Termination.fst(134,2-136,35)
(and (implies 
;; def=Termination.fst(133,18-133,20); use=Termination.fst(134,8-134,10)
(and 
;; def=Termination.fst(133,18-133,20); use=Termination.fst(134,8-134,10)
(not 
;; def=Termination.fst(133,18-133,20); use=Termination.fst(134,8-134,10)
...
label_1)
(implies 
;; def=Prims.fst(389,19-389,21); use=Termination.fst(134,2-136,35)
(not 
;; def=Termination.fst(133,18-133,20); use=Termination.fst(134,8-134,10)
(BoxBool_proj_0 (Prims.uu___is_Nil x_fe28d8bcde588226b4e538b35321de05_2
x_3dddec8ced2db740e4e8aaf70542be7a_4))
...
;; def=Prims.fst(413,99-413,120); use=Termination.fst(134,2-136,35)
(forall ((@x1 Term))
 (! (implies (HasType @x1
x_fe28d8bcde588226b4e538b35321de05_2)
...
;; def=Termination.fst(133,18-136,10); use=Termination.fst(134,8-136,10)
(= x_3dddec8ced2db740e4e8aaf70542be7a_4
(Prims.Cons x_fe28d8bcde588226b4e538b35321de05_2
@x1
@x2))
...
;; def=Prims.fst(459,77-459,89); use=Termination.fst(134,2-136,35)
(and 
;; def=Termination.fst(133,39-133,44); use=Termination.fst(136,16-136,17)
(or label_2
...
;; def=Prims.fst(451,66-451,102); use=Termination.fst(134,2-136,35)
(forall ((@x3 Term))
 (! (implies (and (HasType @x3
x_fe28d8bcde588226b4e538b35321de05_2)

;; def=Termination.fst(133,34-136,5); use=Termination.fst(134,2-136,35)
(= @x1
@x3)
)
...
;; def=Prims.fst(616,11-616,13); use=Termination.fst(134,2-136,35)
(= (ApplyTT x_9a305c3782f75fc0de9ec4fa859ac971_5
@x1)
@x4)
)

;; def=Termination.fst(134,2-136,35); use=Termination.fst(136,34-136,35)
(and 
;; def=dummy(0,0-0,0); use=Termination.fst(136,34-136,35)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
x_fe28d8bcde588226b4e538b35321de05_2)

;; def=Termination.fst(133,39-133,44); use=Termination.fst(136,34-136,35)
(Valid 
;; def=Termination.fst(133,39-133,44); use=Termination.fst(136,34-136,35)
(Prims.precedes x_fe28d8bcde588226b4e538b35321de05_2
(Prims.list x_fe28d8bcde588226b4e538b35321de05_2)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Termination.list_map, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, binder_x_3dddec8ced2db740e4e8aaf70542be7a_4, disc_equation_Prims.Cons, disc_equation_Prims.Nil, fuel_guarded_inversion_Prims.list, projection_inverse_BoxBool_proj_0, projection_inverse_Prims.Cons_hd, projection_inverse_Prims.Cons_tl, subterm_ordering_Prims.Cons
...
; encoding sigelt let rec list_map


; <Start encoding let rec list_map>

;;;;;;;;;;;;;;;;Fuel-instrumented function name
(declare-fun Termination.list_map.fuel_instrumented (Fuel Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Token for fuel-instrumented partial applications
(declare-fun Termination.list_map.fuel_instrumented_token () Term)
(declare-fun Termination.list_map (Term Term Term Term) Term)
(declare-fun Termination.list_map@tok () Term)
(declare-fun Tm_refine_c4ca0045c23e9d6917d9058bb1a95736 (Term Term) Term)
;;;;;;;;;;;;;;;;x: 'a{x << xs} -> 'b
...
;;;;;;;;;;;;;;;;xs: Prims.list 'a -> f: (x: 'a{x << xs} -> 'b) -> Prims.list 'b
(declare-fun Tm_arrow_53cc94e0bf24342a714fa9a72d82987e () Term)

; </end encoding let rec list_map>

(push) ;; push{2

; Starting query at Termination.fst(139,2-141,46)
...
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(138,26-138,40); use=Termination.fst(138,20-138,28)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_f0e39fda591bb23469f07b4ffb1ad647)
...
Tm_arrow_f0e39fda591bb23469f07b4ffb1ad647)
:named binder_x_57af2c0907f883669f14a9b761d251ac_4))
;;;;;;;;;;;;;;;;t : Termination.tree 'a (Termination.tree 'a)
(declare-fun x_1b42b469d51f8d2af3c337b491db6005_5 () Term)
;;;;;;;;;;;;;;;;binder_x_1b42b469d51f8d2af3c337b491db6005_5
;;; Fact-ids: 
(assert (! (HasType x_1b42b469d51f8d2af3c337b491db6005_5
(Termination.tree x_fe28d8bcde588226b4e538b35321de05_2))
:named binder_x_1b42b469d51f8d2af3c337b491db6005_5))

(declare-fun Tm_refine_04a9ad9d2717a4707ccbd26015a14a24 (Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(138,31-141,46); use=Termination.fst(138,31-141,46)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_04a9ad9d2717a4707ccbd26015a14a24 @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_04a9ad9d2717a4707ccbd26015a14a24 @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_04a9ad9d2717a4707ccbd26015a14a24))

:named refinement_kinding_Tm_refine_04a9ad9d2717a4707ccbd26015a14a24))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(138,31-141,46); use=Termination.fst(138,31-141,46)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_04a9ad9d2717a4707ccbd26015a14a24 @x2))
(and (HasTypeFuel @u0
@x1
(Termination.tree @x2))

;; def=Termination.fst(139,2-141,46); use=Termination.fst(139,2-141,46)
...
(Termination.tree x_fe28d8bcde588226b4e538b35321de05_2)
@x1
x_1b42b469d51f8d2af3c337b491db6005_5)
)
...
@x1
(Tm_refine_04a9ad9d2717a4707ccbd26015a14a24 @x2)))
:qid refinement_interpretation_Tm_refine_04a9ad9d2717a4707ccbd26015a14a24))

:named refinement_interpretation_Tm_refine_04a9ad9d2717a4707ccbd26015a14a24))
;;;;;;;;;;;;;;;;haseq for Tm_refine_04a9ad9d2717a4707ccbd26015a14a24
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(138,31-141,46); use=Termination.fst(138,31-141,46)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_04a9ad9d2717a4707ccbd26015a14a24 @x0)))
(Valid (Prims.hasEq (Termination.tree @x0))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_04a9ad9d2717a4707ccbd26015a14a24 @x0))))
:qid haseqTm_refine_04a9ad9d2717a4707ccbd26015a14a24))

:named haseqTm_refine_04a9ad9d2717a4707ccbd26015a14a24))
(declare-fun Termination.tree_map (Term Term Term Term) Term)


;;;;;;;;;;;;;;;;f: (_: 'a -> 'b) -> t: tree 'a {t << t} -> tree 'b
(declare-fun Tm_arrow_0ba3c2617ed8dcaa3127d27ba1a4694d () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_0ba3c2617ed8dcaa3127d27ba1a4694d
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_0ba3c2617ed8dcaa3127d27ba1a4694d
Tm_type)
:named kinding_Tm_arrow_0ba3c2617ed8dcaa3127d27ba1a4694d))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(138,26-141,46); use=Termination.fst(138,20-141,46)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_0ba3c2617ed8dcaa3127d27ba1a4694d)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_0ba3c2617ed8dcaa3127d27ba1a4694d))
:qid Termination_pre_typing_Tm_arrow_0ba3c2617ed8dcaa3127d27ba1a4694d))

:named Termination_pre_typing_Tm_arrow_0ba3c2617ed8dcaa3127d27ba1a4694d))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_0ba3c2617ed8dcaa3127d27ba1a4694d
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(138,26-141,46); use=Termination.fst(138,20-141,46)
(forall ((@x0 Term))
...
@x1))
(HasType @x4
(Tm_refine_04a9ad9d2717a4707ccbd26015a14a24 @x1)))
(HasType (ApplyTT (ApplyTT (ApplyTT (ApplyTT @x0
@x1)
@x2)
@x3)
...
@x3)
@x4))
:qid Termination_interpretation_Tm_arrow_0ba3c2617ed8dcaa3127d27ba1a4694d.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid Termination_interpretation_Tm_arrow_0ba3c2617ed8dcaa3127d27ba1a4694d.2))
...
@x1)
@x2))
:qid Termination_interpretation_Tm_arrow_0ba3c2617ed8dcaa3127d27ba1a4694d.3))
...
@x2)
@x3))
:qid Termination_interpretation_Tm_arrow_0ba3c2617ed8dcaa3127d27ba1a4694d.4))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_0ba3c2617ed8dcaa3127d27ba1a4694d))
:qid Termination_interpretation_Tm_arrow_0ba3c2617ed8dcaa3127d27ba1a4694d))

:named Termination_interpretation_Tm_arrow_0ba3c2617ed8dcaa3127d27ba1a4694d))
(declare-fun Termination.tree_map@tok () Term)
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(138,8-138,16); use=Termination.fst(138,8-138,16)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (ApplyTT (ApplyTT (ApplyTT (ApplyTT Termination.tree_map@tok
@x0)
@x1)
@x2)
@x3)
(Termination.tree_map @x0
@x1
@x2
@x3))
 

:pattern ((ApplyTT (ApplyTT (ApplyTT (ApplyTT Termination.tree_map@tok
@x0)
@x1)
@x2)
@x3))
:qid token_correspondence_Termination.tree_map))

:named token_correspondence_Termination.tree_map))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(138,8-138,16); use=Termination.fst(138,8-138,16)
(forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType Termination.tree_map@tok
Tm_arrow_0ba3c2617ed8dcaa3127d27ba1a4694d))
...
@x3)
@x4)
(Termination.tree_map @x1
@x2
@x3
@x4))
 

:pattern ((Termination.tree_map @x1
@x2
@x3
@x4))
:qid function_token_typing_Termination.tree_map.1))
)
 

:pattern ((ApplyTT @x0
Termination.tree_map@tok))
:qid function_token_typing_Termination.tree_map))

:named function_token_typing_Termination.tree_map))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(138,8-138,16); use=Termination.fst(138,8-138,16)
...
@x0))
(HasType @x3
(Tm_refine_04a9ad9d2717a4707ccbd26015a14a24 @x0)))
(HasType (Termination.tree_map @x0
@x1
@x2
@x3)
(Termination.tree @x1)))
...
:pattern ((Termination.tree_map @x0
@x1
@x2
@x3))
:qid typing_Termination.tree_map))

:named typing_Termination.tree_map))
(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)
...
;   (~(Leaf? t) ==>
;     (forall (b: Prims.list (Termination.tree 'a)).
;         t == Termination.Node b ==> (forall (x: Termination.tree 'a). x << b ==> x << t)))


; Context: While encoding a query
; While typechecking the top-level declaration `let rec tree_map`
...
(assert (! (not (forall ((@x0 Term))
 (! (implies (and (HasType @x0
(Prims.pure_post (Termination.tree x_fe28d8bcde588226b4e538b35321de05_3)))

;; def=Prims.fst(402,27-402,88); use=Termination.fst(139,2-141,46)
(forall ((@x1 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=Termination.fst(139,2-141,46)
(Valid 
;; def=Prims.fst(402,84-402,87); use=Termination.fst(139,2-141,46)
(ApplyTT @x0
@x1)
...
;; def=Prims.fst(459,77-459,89); use=Termination.fst(139,2-141,46)
(and (implies 
;; def=Termination.fst(138,31-138,32); use=Termination.fst(139,8-139,9)
(and 
;; def=Termination.fst(138,31-138,32); use=Termination.fst(139,8-139,9)
(not 
;; def=Termination.fst(138,31-138,32); use=Termination.fst(139,8-139,9)
(BoxBool_proj_0 (Termination.uu___is_Leaf x_fe28d8bcde588226b4e538b35321de05_2
x_1b42b469d51f8d2af3c337b491db6005_5))
)
...
(not 
;; def=Termination.fst(138,31-138,32); use=Termination.fst(139,8-139,9)
(BoxBool_proj_0 (Termination.uu___is_Node x_fe28d8bcde588226b4e538b35321de05_2
x_1b42b469d51f8d2af3c337b491db6005_5))
)
)
...
label_1)
(implies 
;; def=Prims.fst(389,19-389,21); use=Termination.fst(139,2-141,46)
(not 
;; def=Termination.fst(138,31-138,32); use=Termination.fst(139,8-139,9)
(BoxBool_proj_0 (Termination.uu___is_Leaf x_fe28d8bcde588226b4e538b35321de05_2
x_1b42b469d51f8d2af3c337b491db6005_5))
...
;; def=Prims.fst(413,99-413,120); use=Termination.fst(139,2-141,46)
(forall ((@x1 Term))
 (! (implies (and (HasType @x1
(Prims.list (Termination.tree x_fe28d8bcde588226b4e538b35321de05_2)))

;; def=Termination.fst(138,31-141,11); use=Termination.fst(139,8-141,11)
(= x_1b42b469d51f8d2af3c337b491db6005_5
(Termination.Node x_fe28d8bcde588226b4e538b35321de05_2
@x1))
)

;; def=dummy(0,0-0,0); use=Termination.fst(141,33-141,45)
(forall ((@x2 Term))
 (! (implies (and (HasType @x2
(Termination.tree x_fe28d8bcde588226b4e538b35321de05_2))

;; def=Termination.fst(133,39-133,44); use=Termination.fst(141,33-141,45)
(Valid 
;; def=Termination.fst(133,39-133,44); use=Termination.fst(141,33-141,45)
(Prims.precedes (Termination.tree x_fe28d8bcde588226b4e538b35321de05_2)
(Prims.list (Termination.tree x_fe28d8bcde588226b4e538b35321de05_2))
@x2
@x1)
)
...
;; def=Termination.fst(139,2-141,46); use=Termination.fst(141,33-141,45)
(or label_2
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Termination.tree_map, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, binder_x_1b42b469d51f8d2af3c337b491db6005_5, disc_equation_Termination.Leaf, disc_equation_Termination.Node, fuel_guarded_inversion_Termination.tree, projection_inverse_BoxBool_proj_0, projection_inverse_Termination.Node__0, subterm_ordering_Termination.Node
...
; encoding sigelt let rec tree_map


; <Start encoding let rec tree_map>

;;;;;;;;;;;;;;;;Fuel-instrumented function name
(declare-fun Termination.tree_map.fuel_instrumented (Fuel Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Token for fuel-instrumented partial applications
(declare-fun Termination.tree_map.fuel_instrumented_token () Term)
(declare-fun Termination.tree_map (Term Term Term Term) Term)
(declare-fun Termination.tree_map@tok () Term)



;;;;;;;;;;;;;;;;f: (_: 'a -> 'b) -> t: tree 'a -> tree 'b
(declare-fun Tm_arrow_817dd03b2fa11ca8dff9720cd9f417a7 () Term)

; </end encoding let rec tree_map>

;;;;;;;;;;;;;;;;kinding_Tm_arrow_121fa5bc200f7b3946a5e35040f266b9
...
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_arrow_121fa5bc200f7b3946a5e35040f266b9 @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_arrow_121fa5bc200f7b3946a5e35040f266b9 @x0
@x1)
Tm_type))
:qid kinding_Tm_arrow_121fa5bc200f7b3946a5e35040f266b9))

:named kinding_Tm_arrow_121fa5bc200f7b3946a5e35040f266b9))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name FStar.List.Tot.Base.concatMap; Namespace FStar.List.Tot.Base
(assert (! 
;; def=FStar.List.Tot.Base.fst(175,26-176,19); use=FStar.List.Tot.Base.fst(176,8-176,19)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_121fa5bc200f7b3946a5e35040f266b9 @x2
@x3))
(is-Tm_arrow (PreType @x1)))
...
(Tm_arrow_121fa5bc200f7b3946a5e35040f266b9 @x2
@x3)))
:qid FStar.List.Tot.Base_pre_typing_Tm_arrow_121fa5bc200f7b3946a5e35040f266b9))

:named FStar.List.Tot.Base_pre_typing_Tm_arrow_121fa5bc200f7b3946a5e35040f266b9))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_121fa5bc200f7b3946a5e35040f266b9
;;; Fact-ids: Name FStar.List.Tot.Base.concatMap; Namespace FStar.List.Tot.Base
(assert (! 
;; def=FStar.List.Tot.Base.fst(175,26-176,19); use=FStar.List.Tot.Base.fst(176,8-176,19)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_121fa5bc200f7b3946a5e35040f266b9 @x1
@x2))
(and 
;; def=FStar.List.Tot.Base.fst(175,26-176,19); use=FStar.List.Tot.Base.fst(176,8-176,19)
(forall ((@x3 Term))
...
:pattern ((ApplyTT @x0
@x3))
:qid FStar.List.Tot.Base_interpretation_Tm_arrow_121fa5bc200f7b3946a5e35040f266b9.1))
...
(Tm_arrow_121fa5bc200f7b3946a5e35040f266b9 @x1
@x2)))
:qid FStar.List.Tot.Base_interpretation_Tm_arrow_121fa5bc200f7b3946a5e35040f266b9))

:named FStar.List.Tot.Base_interpretation_Tm_arrow_121fa5bc200f7b3946a5e35040f266b9))
(push) ;; push{2

; Starting query at Termination.fst(147,2-149,58)
...
Tm_type)
:named binder_x_fe28d8bcde588226b4e538b35321de05_3))
;;;;;;;;;;;;;;;;l : Prims.list b (Prims.list b)
(declare-fun x_8e2b3e2e2d5822bdb0266bcb517fa74a_4 () Term)
;;;;;;;;;;;;;;;;binder_x_8e2b3e2e2d5822bdb0266bcb517fa74a_4
;;; Fact-ids: 
(assert (! (HasType x_8e2b3e2e2d5822bdb0266bcb517fa74a_4
(Prims.list x_fe28d8bcde588226b4e538b35321de05_3))
:named binder_x_8e2b3e2e2d5822bdb0266bcb517fa74a_4))
;;;;;;;;;;;;;;;;f : _: b -> Prims.list a (_: b -> Prims.list a)
(declare-fun x_6c372e9584f5fecb08cf5bf741ee20c9_5 () Term)
;;;;;;;;;;;;;;;;_: b -> Prims.list a
(declare-fun Tm_arrow_a4340c4b10455ab0c7d9aace954da795 () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_a4340c4b10455ab0c7d9aace954da795
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_a4340c4b10455ab0c7d9aace954da795
Tm_type)
:named kinding_Tm_arrow_a4340c4b10455ab0c7d9aace954da795))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(146,26-146,62); use=Termination.fst(146,51-146,62)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_a4340c4b10455ab0c7d9aace954da795)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_a4340c4b10455ab0c7d9aace954da795))
:qid Termination_pre_typing_Tm_arrow_a4340c4b10455ab0c7d9aace954da795))

:named Termination_pre_typing_Tm_arrow_a4340c4b10455ab0c7d9aace954da795))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_a4340c4b10455ab0c7d9aace954da795
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(146,26-146,62); use=Termination.fst(146,51-146,62)
(forall ((@x0 Term))
...
:pattern ((ApplyTT @x0
@x1))
:qid Termination_interpretation_Tm_arrow_a4340c4b10455ab0c7d9aace954da795.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_a4340c4b10455ab0c7d9aace954da795))
:qid Termination_interpretation_Tm_arrow_a4340c4b10455ab0c7d9aace954da795))

:named Termination_interpretation_Tm_arrow_a4340c4b10455ab0c7d9aace954da795))
;;;;;;;;;;;;;;;;binder_x_6c372e9584f5fecb08cf5bf741ee20c9_5
;;; Fact-ids: 
(assert (! (HasType x_6c372e9584f5fecb08cf5bf741ee20c9_5
Tm_arrow_a4340c4b10455ab0c7d9aace954da795)
:named binder_x_6c372e9584f5fecb08cf5bf741ee20c9_5))

(declare-fun Tm_refine_5e9f1d64f1752378a50c17f40d749091 (Term Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(146,48-149,58); use=Termination.fst(146,48-149,58)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (HasType (Tm_refine_5e9f1d64f1752378a50c17f40d749091 @x0
@x1
@x2)
Tm_type)
 

:pattern ((HasType (Tm_refine_5e9f1d64f1752378a50c17f40d749091 @x0
@x1
@x2)
Tm_type))
:qid refinement_kinding_Tm_refine_5e9f1d64f1752378a50c17f40d749091))

:named refinement_kinding_Tm_refine_5e9f1d64f1752378a50c17f40d749091))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(146,48-149,58); use=Termination.fst(146,48-149,58)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_5e9f1d64f1752378a50c17f40d749091 @x2
@x3
@x4))
(and (HasTypeFuel @u0
@x1
...
;; def=Termination.fst(147,2-149,58); use=Termination.fst(147,2-149,58)
...
(Prims.list x_fe28d8bcde588226b4e538b35321de05_3)
@x4
x_8e2b3e2e2d5822bdb0266bcb517fa74a_4)
)
...
@x3
@x4)))
:qid refinement_interpretation_Tm_refine_5e9f1d64f1752378a50c17f40d749091))

:named refinement_interpretation_Tm_refine_5e9f1d64f1752378a50c17f40d749091))
;;;;;;;;;;;;;;;;haseq for Tm_refine_5e9f1d64f1752378a50c17f40d749091
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(146,48-149,58); use=Termination.fst(146,48-149,58)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_5e9f1d64f1752378a50c17f40d749091 @x0
@x1
@x2)))
(Valid (Prims.hasEq (Tm_arrow_121fa5bc200f7b3946a5e35040f266b9 @x0
@x1))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_5e9f1d64f1752378a50c17f40d749091 @x0
@x1
@x2))))
:qid haseqTm_refine_5e9f1d64f1752378a50c17f40d749091))

:named haseqTm_refine_5e9f1d64f1752378a50c17f40d749091))
(declare-fun Termination.flatten_list (Term Term Term Term) Term)


;;;;;;;;;;;;;;;;l: Prims.list b -> f: (_: b -> Prims.list a){l << l} -> Prims.list a
(declare-fun Tm_arrow_c99a639ff8946d06991bde207e0c2771 () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_c99a639ff8946d06991bde207e0c2771
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_c99a639ff8946d06991bde207e0c2771
Tm_type)
:named kinding_Tm_arrow_c99a639ff8946d06991bde207e0c2771))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(146,28-149,58); use=Termination.fst(146,28-149,58)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_c99a639ff8946d06991bde207e0c2771)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_c99a639ff8946d06991bde207e0c2771))
:qid Termination_pre_typing_Tm_arrow_c99a639ff8946d06991bde207e0c2771))

:named Termination_pre_typing_Tm_arrow_c99a639ff8946d06991bde207e0c2771))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_c99a639ff8946d06991bde207e0c2771
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(146,28-149,58); use=Termination.fst(146,28-149,58)
(forall ((@x0 Term))
...
(Prims.list @x2))
(HasType @x4
(Tm_refine_5e9f1d64f1752378a50c17f40d749091 @x1
@x2
@x3)))
(HasType (ApplyTT (ApplyTT (ApplyTT (ApplyTT @x0
@x1)
...
@x3)
@x4))
:qid Termination_interpretation_Tm_arrow_c99a639ff8946d06991bde207e0c2771.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid Termination_interpretation_Tm_arrow_c99a639ff8946d06991bde207e0c2771.2))
...
@x1)
@x2))
:qid Termination_interpretation_Tm_arrow_c99a639ff8946d06991bde207e0c2771.3))
...
@x2)
@x3))
:qid Termination_interpretation_Tm_arrow_c99a639ff8946d06991bde207e0c2771.4))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_c99a639ff8946d06991bde207e0c2771))
:qid Termination_interpretation_Tm_arrow_c99a639ff8946d06991bde207e0c2771))

:named Termination_interpretation_Tm_arrow_c99a639ff8946d06991bde207e0c2771))
(declare-fun Termination.flatten_list@tok () Term)
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(146,8-146,20); use=Termination.fst(146,8-146,20)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (ApplyTT (ApplyTT (ApplyTT (ApplyTT Termination.flatten_list@tok
@x0)
@x1)
@x2)
@x3)
(Termination.flatten_list @x0
@x1
@x2
@x3))
 

:pattern ((ApplyTT (ApplyTT (ApplyTT (ApplyTT Termination.flatten_list@tok
@x0)
@x1)
@x2)
@x3))
:qid token_correspondence_Termination.flatten_list))

:named token_correspondence_Termination.flatten_list))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(146,8-146,20); use=Termination.fst(146,8-146,20)
(forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType Termination.flatten_list@tok
Tm_arrow_c99a639ff8946d06991bde207e0c2771))
...
@x3)
@x4)
(Termination.flatten_list @x1
@x2
@x3
@x4))
 

:pattern ((Termination.flatten_list @x1
@x2
@x3
@x4))
:qid function_token_typing_Termination.flatten_list.1))
)
 

:pattern ((ApplyTT @x0
Termination.flatten_list@tok))
:qid function_token_typing_Termination.flatten_list))

:named function_token_typing_Termination.flatten_list))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(146,8-146,20); use=Termination.fst(146,8-146,20)
...
(Prims.list @x1))
(HasType @x3
(Tm_refine_5e9f1d64f1752378a50c17f40d749091 @x0
@x1
@x2)))
(HasType (Termination.flatten_list @x0
@x1
@x2
@x3)
(Prims.list @x0)))
...
:pattern ((Termination.flatten_list @x0
@x1
@x2
@x3))
:qid typing_Termination.flatten_list))

:named typing_Termination.flatten_list))
(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)
...
;   (~(Nil? l) /\ ~(Cons? l) ==> Prims.l_False) /\
;   (~(Nil? l) ==> (forall (b: b) (b: Prims.list b). l == b :: b ==> b << l))


; Context: While encoding a query
; While typechecking the top-level declaration `let rec flatten_list`
...
(assert (! (not (forall ((@x0 Term))
 (! (implies (and (HasType @x0
(Prims.pure_post (Prims.list x_fe28d8bcde588226b4e538b35321de05_2)))

;; def=Prims.fst(402,27-402,88); use=Termination.fst(147,2-149,58)
(forall ((@x1 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=Termination.fst(147,2-149,58)
(Valid 
;; def=Prims.fst(402,84-402,87); use=Termination.fst(147,2-149,58)
(ApplyTT @x0
@x1)
...
;; def=Prims.fst(459,77-459,89); use=Termination.fst(147,2-149,58)
(and (implies 
;; def=Termination.fst(146,35-146,36); use=Termination.fst(147,8-147,9)
(and 
;; def=Termination.fst(146,35-146,36); use=Termination.fst(147,8-147,9)
(not 
;; def=Termination.fst(146,35-146,36); use=Termination.fst(147,8-147,9)
(BoxBool_proj_0 (Prims.uu___is_Nil x_fe28d8bcde588226b4e538b35321de05_3
x_8e2b3e2e2d5822bdb0266bcb517fa74a_4))
)
...
(not 
;; def=Termination.fst(146,35-146,36); use=Termination.fst(147,8-147,9)
(BoxBool_proj_0 (Prims.uu___is_Cons x_fe28d8bcde588226b4e538b35321de05_3
x_8e2b3e2e2d5822bdb0266bcb517fa74a_4))
)
)
...
label_1)
(implies 
;; def=Prims.fst(389,19-389,21); use=Termination.fst(147,2-149,58)
(not 
;; def=Termination.fst(146,35-146,36); use=Termination.fst(147,8-147,9)
(BoxBool_proj_0 (Prims.uu___is_Nil x_fe28d8bcde588226b4e538b35321de05_3
x_8e2b3e2e2d5822bdb0266bcb517fa74a_4))
...
;; def=Prims.fst(413,99-413,120); use=Termination.fst(147,2-149,58)
(forall ((@x1 Term))
 (! (implies (HasType @x1
x_fe28d8bcde588226b4e538b35321de05_3)
...
;; def=Termination.fst(146,35-149,10); use=Termination.fst(147,8-149,10)
(= x_8e2b3e2e2d5822bdb0266bcb517fa74a_4
(Prims.Cons x_fe28d8bcde588226b4e538b35321de05_3
@x1
@x2))
)

;; def=Termination.fst(147,2-149,58); use=Termination.fst(149,56-149,57)
(or label_2

;; def=Termination.fst(147,2-149,58); use=Termination.fst(149,56-149,57)
(Valid 
;; def=Termination.fst(147,2-149,58); use=Termination.fst(149,56-149,57)
(Prims.precedes (Prims.list x_fe28d8bcde588226b4e538b35321de05_3)
(Prims.list x_fe28d8bcde588226b4e538b35321de05_3)
@x2
x_8e2b3e2e2d5822bdb0266bcb517fa74a_4)
)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Termination.flatten_list, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, binder_x_8e2b3e2e2d5822bdb0266bcb517fa74a_4, disc_equation_Prims.Cons, disc_equation_Prims.Nil, fuel_guarded_inversion_Prims.list, projection_inverse_BoxBool_proj_0, projection_inverse_Prims.Cons_tl, subterm_ordering_Prims.Cons
...
; encoding sigelt let rec flatten_list


; <Start encoding let rec flatten_list>

;;;;;;;;;;;;;;;;Fuel-instrumented function name
(declare-fun Termination.flatten_list.fuel_instrumented (Fuel Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Token for fuel-instrumented partial applications
(declare-fun Termination.flatten_list.fuel_instrumented_token () Term)
(declare-fun Termination.flatten_list (Term Term Term Term) Term)
(declare-fun Termination.flatten_list@tok () Term)



;;;;;;;;;;;;;;;;l: Prims.list b -> f: (_: b -> Prims.list a) -> Prims.list a
(declare-fun Tm_arrow_fa0a8dd5247dcc8ee1b14f0d65a8381c () Term)

; </end encoding let rec flatten_list>

(push) ;; push{2

; Starting query at Termination.fst(154,2-157,41)
...
:named binder_x_9cd1733a5204f989dbb2f01d5984df93_0))
;;;;;;;;;;;;;;;;t : Termination.tree a (Termination.tree a)
(declare-fun x_484068bc8cf479ceebfc1c093bca5255_1 () Term)
;;;;;;;;;;;;;;;;binder_x_484068bc8cf479ceebfc1c093bca5255_1
;;; Fact-ids: 
(assert (! (HasType x_484068bc8cf479ceebfc1c093bca5255_1
(Termination.tree x_9cd1733a5204f989dbb2f01d5984df93_0))
:named binder_x_484068bc8cf479ceebfc1c093bca5255_1))
(declare-fun Tm_refine_6bc27530c4c199ebe7f72f32def59c6f (Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(153,23-157,41); use=Termination.fst(153,23-157,41)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_6bc27530c4c199ebe7f72f32def59c6f @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_6bc27530c4c199ebe7f72f32def59c6f @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_6bc27530c4c199ebe7f72f32def59c6f))

:named refinement_kinding_Tm_refine_6bc27530c4c199ebe7f72f32def59c6f))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(153,23-157,41); use=Termination.fst(153,23-157,41)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_6bc27530c4c199ebe7f72f32def59c6f @x2))
(and (HasTypeFuel @u0
@x1
(Termination.tree @x2))
...
;; def=Termination.fst(153,23-157,41); use=Termination.fst(153,23-157,41)
(or 
;; def=Termination.fst(154,2-157,41); use=Termination.fst(154,2-157,41)
(Valid 
;; def=Termination.fst(154,2-157,41); use=Termination.fst(154,2-157,41)
(Prims.precedes Prims.eqtype
Prims.eqtype
...
;; def=Termination.fst(153,23-157,41); use=Termination.fst(153,23-157,41)
(and 
;; def=Termination.fst(153,23-153,24); use=Termination.fst(153,23-153,24)
(Valid 
;; def=Termination.fst(153,23-153,24); use=Termination.fst(153,23-153,24)
(Prims.op_Equals_Equals_Equals Prims.eqtype
Prims.eqtype
...
(Termination.tree x_9cd1733a5204f989dbb2f01d5984df93_0)
@x1
x_484068bc8cf479ceebfc1c093bca5255_1)
)
)
)
...
@x1
(Tm_refine_6bc27530c4c199ebe7f72f32def59c6f @x2)))
:qid refinement_interpretation_Tm_refine_6bc27530c4c199ebe7f72f32def59c6f))

:named refinement_interpretation_Tm_refine_6bc27530c4c199ebe7f72f32def59c6f))
;;;;;;;;;;;;;;;;haseq for Tm_refine_6bc27530c4c199ebe7f72f32def59c6f
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(153,23-157,41); use=Termination.fst(153,23-157,41)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_6bc27530c4c199ebe7f72f32def59c6f @x0)))
(Valid (Prims.hasEq (Termination.tree @x0))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_6bc27530c4c199ebe7f72f32def59c6f @x0))))
:qid haseqTm_refine_6bc27530c4c199ebe7f72f32def59c6f))

:named haseqTm_refine_6bc27530c4c199ebe7f72f32def59c6f))
(declare-fun Termination.flatten_tree (Term Term) Term)

;;;;;;;;;;;;;;;;t: tree a {a << a \/ a === a /\ t << t} -> Prims.list a
(declare-fun Tm_arrow_058797ef40f0e169269617b36386d9db () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_058797ef40f0e169269617b36386d9db
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_058797ef40f0e169269617b36386d9db
Tm_type)
:named kinding_Tm_arrow_058797ef40f0e169269617b36386d9db))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(153,23-157,41); use=Termination.fst(153,23-157,41)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_058797ef40f0e169269617b36386d9db)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_058797ef40f0e169269617b36386d9db))
:qid Termination_pre_typing_Tm_arrow_058797ef40f0e169269617b36386d9db))

:named Termination_pre_typing_Tm_arrow_058797ef40f0e169269617b36386d9db))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_058797ef40f0e169269617b36386d9db
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(153,23-157,41); use=Termination.fst(153,23-157,41)
(forall ((@x0 Term))
...
Prims.eqtype)
(HasType @x2
(Tm_refine_6bc27530c4c199ebe7f72f32def59c6f @x1)))
(HasType (ApplyTT (ApplyTT @x0
@x1)
@x2)
(Prims.list @x1)))
...
@x1)
@x2))
:qid Termination_interpretation_Tm_arrow_058797ef40f0e169269617b36386d9db.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid Termination_interpretation_Tm_arrow_058797ef40f0e169269617b36386d9db.2))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_058797ef40f0e169269617b36386d9db))
:qid Termination_interpretation_Tm_arrow_058797ef40f0e169269617b36386d9db))

:named Termination_interpretation_Tm_arrow_058797ef40f0e169269617b36386d9db))
(declare-fun Termination.flatten_tree@tok () Term)
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(153,8-153,20); use=Termination.fst(153,8-153,20)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (ApplyTT Termination.flatten_tree@tok
@x0)
@x1)
(Termination.flatten_tree @x0
@x1))
 

:pattern ((ApplyTT (ApplyTT Termination.flatten_tree@tok
@x0)
@x1))
:qid token_correspondence_Termination.flatten_tree))

:named token_correspondence_Termination.flatten_tree))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(153,8-153,20); use=Termination.fst(153,8-153,20)
(forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType Termination.flatten_tree@tok
Tm_arrow_058797ef40f0e169269617b36386d9db))
...
@x1)
@x2)
(Termination.flatten_tree @x1
@x2))
 

:pattern ((Termination.flatten_tree @x1
@x2))
:qid function_token_typing_Termination.flatten_tree.1))
)
 

:pattern ((ApplyTT @x0
Termination.flatten_tree@tok))
:qid function_token_typing_Termination.flatten_tree))

:named function_token_typing_Termination.flatten_tree))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(153,8-153,20); use=Termination.fst(153,8-153,20)
...
Prims.eqtype)
(HasType @x1
(Tm_refine_6bc27530c4c199ebe7f72f32def59c6f @x0)))
(HasType (Termination.flatten_tree @x0
@x1)
(Prims.list @x0)))
 

:pattern ((Termination.flatten_tree @x0
@x1))
:qid typing_Termination.flatten_tree))

:named typing_Termination.flatten_tree))
(declare-fun label_4 () Bool)
(declare-fun label_3 () Bool)
(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)
(declare-fun Tm_refine_3b1734bd55633c32d868cf22b7a2cd5b () Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! (HasType Tm_refine_3b1734bd55633c32d868cf22b7a2cd5b
Tm_type)
:named refinement_kinding_Tm_refine_3b1734bd55633c32d868cf22b7a2cd5b))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(108,32-108,42); use=Termination.fst(154,2-157,41)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_3b1734bd55633c32d868cf22b7a2cd5b)
(and (HasTypeFuel @u0
@x1
(Termination.tree x_9cd1733a5204f989dbb2f01d5984df93_0))

;; def=Termination.fst(156,53-156,60); use=Termination.fst(154,2-157,41)
(Valid 
;; def=Termination.fst(156,53-156,60); use=Termination.fst(154,2-157,41)
(Prims.precedes (Termination.tree x_9cd1733a5204f989dbb2f01d5984df93_0)
(Termination.tree x_9cd1733a5204f989dbb2f01d5984df93_0)
@x1
x_484068bc8cf479ceebfc1c093bca5255_1)
)
...
@x1
Tm_refine_3b1734bd55633c32d868cf22b7a2cd5b))
:qid refinement_interpretation_Tm_refine_3b1734bd55633c32d868cf22b7a2cd5b))

:named refinement_interpretation_Tm_refine_3b1734bd55633c32d868cf22b7a2cd5b))
;;;;;;;;;;;;;;;;haseq for Tm_refine_3b1734bd55633c32d868cf22b7a2cd5b
;;; Fact-ids: 
(assert (! (iff (Valid (Prims.hasEq Tm_refine_3b1734bd55633c32d868cf22b7a2cd5b))
(Valid (Prims.hasEq (Termination.tree x_9cd1733a5204f989dbb2f01d5984df93_0))))
:named haseqTm_refine_3b1734bd55633c32d868cf22b7a2cd5b))
;;;;;;;;;;;;;;;;aa: tree a -> Type0
(declare-fun Tm_arrow_78d4c91ee28136bfa176e96be7f60de8 () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_78d4c91ee28136bfa176e96be7f60de8
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_78d4c91ee28136bfa176e96be7f60de8
Tm_type)
:named kinding_Tm_arrow_78d4c91ee28136bfa176e96be7f60de8))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(106,31-115,24); use=Termination.fst(156,22-156,37)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_78d4c91ee28136bfa176e96be7f60de8)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_78d4c91ee28136bfa176e96be7f60de8))
:qid Termination_pre_typing_Tm_arrow_78d4c91ee28136bfa176e96be7f60de8))

:named Termination_pre_typing_Tm_arrow_78d4c91ee28136bfa176e96be7f60de8))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_78d4c91ee28136bfa176e96be7f60de8
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(106,31-115,24); use=Termination.fst(156,22-156,37)
(forall ((@x0 Term))
...
:pattern ((ApplyTT @x0
@x1))
:qid Termination_interpretation_Tm_arrow_78d4c91ee28136bfa176e96be7f60de8.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_78d4c91ee28136bfa176e96be7f60de8))
:qid Termination_interpretation_Tm_arrow_78d4c91ee28136bfa176e96be7f60de8))

:named Termination_interpretation_Tm_arrow_78d4c91ee28136bfa176e96be7f60de8))
(declare-fun Tm_abs_8373c8c87f6d30e971bc3301bdb72ed7 () Term)
;;;;;;;;;;;;;;;;typing_Tm_abs_8373c8c87f6d30e971bc3301bdb72ed7
;;; Fact-ids: 
(assert (! (HasType Tm_abs_8373c8c87f6d30e971bc3301bdb72ed7
Tm_arrow_78d4c91ee28136bfa176e96be7f60de8)
:named typing_Tm_abs_8373c8c87f6d30e971bc3301bdb72ed7))
;;;;;;;;;;;;;;;;interpretation_Tm_abs_8373c8c87f6d30e971bc3301bdb72ed7
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(156,53-156,60); use=Termination.fst(156,53-156,60)
(forall ((@x0 Term))
 (! (= (ApplyTT Tm_abs_8373c8c87f6d30e971bc3301bdb72ed7
@x0)
(Prims.precedes (Termination.tree x_9cd1733a5204f989dbb2f01d5984df93_0)
(Termination.tree x_9cd1733a5204f989dbb2f01d5984df93_0)
@x0
...
:pattern ((ApplyTT Tm_abs_8373c8c87f6d30e971bc3301bdb72ed7
@x0))
:qid interpretation_Tm_abs_8373c8c87f6d30e971bc3301bdb72ed7))

:named interpretation_Tm_abs_8373c8c87f6d30e971bc3301bdb72ed7))
...
;   (~(Leaf? t) ==>
;     (forall (b: Prims.list (Termination.tree a)).
;         t == Termination.Node b ==>
;         Prims.hasEq (Termination.tree a) /\
;         (forall (return_val: Prims.eqtype).
;             return_val == Termination.tree a ==>
;             (forall (z: Termination.tree a). Termination.mem z b ==> z << t) /\
;             (forall (any_result: Prims.list (Termination.tree a)).
;                 b == any_result ==>
;                 (forall (any_result: Prims.list (x: Termination.tree a {x << t})).
;                     Termination.move_refinement b == any_result ==>
;                     (forall (x: Termination.tree a). x << t ==> a << a \/ x << t))))))


; Context: While encoding a query
; While typechecking the top-level declaration `let rec flatten_tree`
...
;; def=Prims.fst(402,27-402,88); use=Termination.fst(154,2-157,41)
(forall ((@x1 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=Termination.fst(154,2-157,41)
(Valid 
;; def=Prims.fst(402,84-402,87); use=Termination.fst(154,2-157,41)
(ApplyTT @x0
@x1)
...
;; def=Prims.fst(459,77-459,89); use=Termination.fst(154,2-157,41)
(and (implies 
;; def=Termination.fst(153,34-153,35); use=Termination.fst(154,8-154,9)
(and 
;; def=Termination.fst(153,34-153,35); use=Termination.fst(154,8-154,9)
(not 
;; def=Termination.fst(153,34-153,35); use=Termination.fst(154,8-154,9)
(BoxBool_proj_0 (Termination.uu___is_Leaf x_9cd1733a5204f989dbb2f01d5984df93_0
x_484068bc8cf479ceebfc1c093bca5255_1))
)
...
(not 
;; def=Termination.fst(153,34-153,35); use=Termination.fst(154,8-154,9)
(BoxBool_proj_0 (Termination.uu___is_Node x_9cd1733a5204f989dbb2f01d5984df93_0
x_484068bc8cf479ceebfc1c093bca5255_1))
)
)
...
label_1)
(implies 
;; def=Prims.fst(389,19-389,21); use=Termination.fst(154,2-157,41)
(not 
;; def=Termination.fst(153,34-153,35); use=Termination.fst(154,8-154,9)
(BoxBool_proj_0 (Termination.uu___is_Leaf x_9cd1733a5204f989dbb2f01d5984df93_0
x_484068bc8cf479ceebfc1c093bca5255_1))
...
;; def=Prims.fst(413,99-413,120); use=Termination.fst(154,2-157,41)
(forall ((@x1 Term))
 (! (implies (and (HasType @x1
(Prims.list (Termination.tree x_9cd1733a5204f989dbb2f01d5984df93_0)))

;; def=Termination.fst(153,34-156,10); use=Termination.fst(154,8-156,10)
(= x_484068bc8cf479ceebfc1c093bca5255_1
(Termination.Node x_9cd1733a5204f989dbb2f01d5984df93_0
@x1))
)

;; def=Prims.fst(459,77-459,89); use=Termination.fst(154,2-157,41)
(and 
;; def=Prims.fst(73,23-73,30); use=Termination.fst(156,62-156,63)
(or label_2

;; def=Prims.fst(73,23-73,30); use=Termination.fst(156,62-156,63)
(Valid 
;; def=Prims.fst(73,23-73,30); use=Termination.fst(156,62-156,63)
(Prims.hasEq (Termination.tree x_9cd1733a5204f989dbb2f01d5984df93_0))
)
)


;; def=Prims.fst(356,2-356,58); use=Termination.fst(154,2-157,41)
(forall ((@x2 Term))
 (! (implies (and (HasType @x2
Prims.eqtype)

;; def=Prims.fst(356,26-356,41); use=Termination.fst(154,2-157,41)
(= @x2
(Termination.tree x_9cd1733a5204f989dbb2f01d5984df93_0))
)
...
;; def=Prims.fst(459,77-459,89); use=Termination.fst(154,2-157,41)
(and 
;; def=Termination.fst(107,31-107,56); use=Termination.fst(156,62-156,63)
(forall ((@x3 Term))
 (! (implies (and (HasType @x3
(Termination.tree x_9cd1733a5204f989dbb2f01d5984df93_0))

;; def=Termination.fst(107,41-107,48); use=Termination.fst(156,62-156,63)
(BoxBool_proj_0 (Termination.mem (Termination.tree x_9cd1733a5204f989dbb2f01d5984df93_0)
@x3
@x1))
)

;; def=Termination.fst(156,53-156,60); use=Termination.fst(156,62-156,63)
(or label_3
...
;; def=Prims.fst(451,66-451,102); use=Termination.fst(154,2-157,41)
(forall ((@x3 Term))
 (! (implies (and (HasType @x3
(Prims.list (Termination.tree x_9cd1733a5204f989dbb2f01d5984df93_0)))

;; def=Termination.fst(107,22-156,10); use=Termination.fst(154,2-157,41)
(= @x1
@x3)
)
...
(forall ((@x4 Term))
 (! (implies (and (HasType @x4
(Prims.list Tm_refine_3b1734bd55633c32d868cf22b7a2cd5b))

;; def=Termination.fst(156,18-156,63); use=Termination.fst(156,18-156,63)
(= (Termination.move_refinement (Termination.tree x_9cd1733a5204f989dbb2f01d5984df93_0)
Tm_abs_8373c8c87f6d30e971bc3301bdb72ed7
@x1)
@x4)
)

;; def=dummy(0,0-0,0); use=Termination.fst(157,29-157,41)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
(Termination.tree x_9cd1733a5204f989dbb2f01d5984df93_0))

;; def=Termination.fst(156,53-156,60); use=Termination.fst(157,29-157,41)
(Valid 
;; def=Termination.fst(156,53-156,60); use=Termination.fst(157,29-157,41)
(Prims.precedes (Termination.tree x_9cd1733a5204f989dbb2f01d5984df93_0)
(Termination.tree x_9cd1733a5204f989dbb2f01d5984df93_0)
...
;; def=Termination.fst(153,23-157,41); use=Termination.fst(157,29-157,41)
(or label_4

;; def=Termination.fst(154,2-157,41); use=Termination.fst(157,29-157,41)
(Valid 
;; def=Termination.fst(154,2-157,41); use=Termination.fst(157,29-157,41)
(Prims.precedes Prims.eqtype
Prims.eqtype
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (Termination.flatten_tree, 1)
; STATUS: unsat
...
; encoding sigelt let rec flatten_tree


; <Start encoding let rec flatten_tree>

;;;;;;;;;;;;;;;;Fuel-instrumented function name
(declare-fun Termination.flatten_tree.fuel_instrumented (Fuel Term Term) Term)
;;;;;;;;;;;;;;;;Token for fuel-instrumented partial applications
(declare-fun Termination.flatten_tree.fuel_instrumented_token () Term)
(declare-fun Termination.flatten_tree (Term Term) Term)
(declare-fun Termination.flatten_tree@tok () Term)



;;;;;;;;;;;;;;;;t: tree a -> Prims.list a
(declare-fun Tm_arrow_a11fb5ec4d17a3da0c92f411774d15d1 () Term)

; </end encoding let rec flatten_tree>

;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name Termination.list_map; Namespace Termination
(assert (! 
;; def=Termination.fst(133,34-133,45); use=Termination.fst(133,34-133,45)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_refine_c4ca0045c23e9d6917d9058bb1a95736 @x0
...
; Starting query at Termination.fst(162,2-164,59)
...
(Prims.list x_fe28d8bcde588226b4e538b35321de05_3))
:named binder_x_8e2b3e2e2d5822bdb0266bcb517fa74a_4))
;;;;;;;;;;;;;;;;f : x: 'b{x << l} -> Prims.list 'a (x: 'b{x << l} -> Prims.list 'a)
(declare-fun x_fa7ef4a30c0dcc49b8513a96c15f6c9f_5 () Term)
(declare-fun Tm_refine_b3548f63999a5f47066231567819a8cc () Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! (HasType Tm_refine_b3548f63999a5f47066231567819a8cc
Tm_type)
:named refinement_kinding_Tm_refine_b3548f63999a5f47066231567819a8cc))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(161,40-161,52); use=Termination.fst(161,40-161,52)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_b3548f63999a5f47066231567819a8cc)
(and (HasTypeFuel @u0
@x1
x_fe28d8bcde588226b4e538b35321de05_3)

;; def=Termination.fst(161,45-161,51); use=Termination.fst(161,45-161,51)
(Valid 
;; def=Termination.fst(161,45-161,51); use=Termination.fst(161,45-161,51)
(Prims.precedes x_fe28d8bcde588226b4e538b35321de05_3
(Prims.list x_fe28d8bcde588226b4e538b35321de05_3)
@x1
x_8e2b3e2e2d5822bdb0266bcb517fa74a_4)
)
...
@x1
Tm_refine_b3548f63999a5f47066231567819a8cc))
:qid refinement_interpretation_Tm_refine_b3548f63999a5f47066231567819a8cc))

:named refinement_interpretation_Tm_refine_b3548f63999a5f47066231567819a8cc))
;;;;;;;;;;;;;;;;haseq for Tm_refine_b3548f63999a5f47066231567819a8cc
;;; Fact-ids: 
(assert (! (iff (Valid (Prims.hasEq Tm_refine_b3548f63999a5f47066231567819a8cc))
(Valid (Prims.hasEq x_fe28d8bcde588226b4e538b35321de05_3)))
:named haseqTm_refine_b3548f63999a5f47066231567819a8cc))
;;;;;;;;;;;;;;;;x: 'b{x << l} -> Prims.list 'a
(declare-fun Tm_arrow_71cc3d12aac2e5d652047c083c0f0f82 () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_71cc3d12aac2e5d652047c083c0f0f82
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_71cc3d12aac2e5d652047c083c0f0f82
Tm_type)
:named kinding_Tm_arrow_71cc3d12aac2e5d652047c083c0f0f82))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(161,40-161,63); use=Termination.fst(161,40-161,63)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_71cc3d12aac2e5d652047c083c0f0f82)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_71cc3d12aac2e5d652047c083c0f0f82))
:qid Termination_pre_typing_Tm_arrow_71cc3d12aac2e5d652047c083c0f0f82))

:named Termination_pre_typing_Tm_arrow_71cc3d12aac2e5d652047c083c0f0f82))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_71cc3d12aac2e5d652047c083c0f0f82
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(161,40-161,63); use=Termination.fst(161,40-161,63)
(forall ((@x0 Term))
...
:pattern ((ApplyTT @x0
@x1))
:qid Termination_interpretation_Tm_arrow_71cc3d12aac2e5d652047c083c0f0f82.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_71cc3d12aac2e5d652047c083c0f0f82))
:qid Termination_interpretation_Tm_arrow_71cc3d12aac2e5d652047c083c0f0f82))

:named Termination_interpretation_Tm_arrow_71cc3d12aac2e5d652047c083c0f0f82))
;;;;;;;;;;;;;;;;binder_x_fa7ef4a30c0dcc49b8513a96c15f6c9f_5
;;; Fact-ids: 
(assert (! (HasType x_fa7ef4a30c0dcc49b8513a96c15f6c9f_5
Tm_arrow_71cc3d12aac2e5d652047c083c0f0f82)
:named binder_x_fa7ef4a30c0dcc49b8513a96c15f6c9f_5))

;;;;;;;;;;;;;;;;x: 'b{x << l} -> Prims.list 'a
(declare-fun Tm_arrow_4fd455fb6ec78917c153812b21600d68 (Term Term Term) Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_4fd455fb6ec78917c153812b21600d68
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(161,40-161,63); use=Termination.fst(161,40-161,63)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (HasType (Tm_arrow_4fd455fb6ec78917c153812b21600d68 @x0
@x1
@x2)
Tm_type)
 

:pattern ((HasType (Tm_arrow_4fd455fb6ec78917c153812b21600d68 @x0
@x1
@x2)
Tm_type))
:qid kinding_Tm_arrow_4fd455fb6ec78917c153812b21600d68))

:named kinding_Tm_arrow_4fd455fb6ec78917c153812b21600d68))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(161,40-161,63); use=Termination.fst(161,40-161,63)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_4fd455fb6ec78917c153812b21600d68 @x2
@x3
@x4))
(is-Tm_arrow (PreType @x1)))
...
@x3
@x4)))
:qid Termination_pre_typing_Tm_arrow_4fd455fb6ec78917c153812b21600d68))

:named Termination_pre_typing_Tm_arrow_4fd455fb6ec78917c153812b21600d68))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_4fd455fb6ec78917c153812b21600d68
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(161,40-161,63); use=Termination.fst(161,40-161,63)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeZ @x0
(Tm_arrow_4fd455fb6ec78917c153812b21600d68 @x1
@x2
@x3))
(and 
;; def=Termination.fst(161,40-161,63); use=Termination.fst(161,40-161,63)
...
:pattern ((ApplyTT @x0
@x4))
:qid Termination_interpretation_Tm_arrow_4fd455fb6ec78917c153812b21600d68.1))
...
@x2
@x3)))
:qid Termination_interpretation_Tm_arrow_4fd455fb6ec78917c153812b21600d68))

:named Termination_interpretation_Tm_arrow_4fd455fb6ec78917c153812b21600d68))
(declare-fun Tm_refine_ec037382136011912190a803d0b5d365 (Term Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(161,37-164,59); use=Termination.fst(161,37-164,59)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (HasType (Tm_refine_ec037382136011912190a803d0b5d365 @x0
@x1
@x2)
Tm_type)
 

:pattern ((HasType (Tm_refine_ec037382136011912190a803d0b5d365 @x0
@x1
@x2)
Tm_type))
:qid refinement_kinding_Tm_refine_ec037382136011912190a803d0b5d365))

:named refinement_kinding_Tm_refine_ec037382136011912190a803d0b5d365))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(161,37-164,59); use=Termination.fst(161,37-164,59)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term) (@x4 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_ec037382136011912190a803d0b5d365 @x2
@x3
@x4))
(and (HasTypeFuel @u0
@x1
...
;; def=Termination.fst(162,2-164,59); use=Termination.fst(162,2-164,59)
...
@x3
@x4)))
:qid refinement_interpretation_Tm_refine_ec037382136011912190a803d0b5d365))

:named refinement_interpretation_Tm_refine_ec037382136011912190a803d0b5d365))
;;;;;;;;;;;;;;;;haseq for Tm_refine_ec037382136011912190a803d0b5d365
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(161,37-164,59); use=Termination.fst(161,37-164,59)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_ec037382136011912190a803d0b5d365 @x0
@x1
@x2)))
(Valid (Prims.hasEq (Tm_arrow_4fd455fb6ec78917c153812b21600d68 @x0
@x2
@x1))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_ec037382136011912190a803d0b5d365 @x0
@x1
@x2))))
:qid haseqTm_refine_ec037382136011912190a803d0b5d365))

:named haseqTm_refine_ec037382136011912190a803d0b5d365))
(declare-fun Termination.flatten_list_ (Term Term Term Term) Term)



;;;;;;;;;;;;;;;;l: Prims.list 'b -> f: (x: 'b{x << l} -> Prims.list 'a){l << l} -> Prims.list 'a
(declare-fun Tm_arrow_f16e5b4778c50c83c6dbec8b6dbd4a6b () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_f16e5b4778c50c83c6dbec8b6dbd4a6b
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_f16e5b4778c50c83c6dbec8b6dbd4a6b
Tm_type)
:named kinding_Tm_arrow_f16e5b4778c50c83c6dbec8b6dbd4a6b))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(161,25-164,59); use=Termination.fst(161,25-164,59)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_f16e5b4778c50c83c6dbec8b6dbd4a6b)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_f16e5b4778c50c83c6dbec8b6dbd4a6b))
:qid Termination_pre_typing_Tm_arrow_f16e5b4778c50c83c6dbec8b6dbd4a6b))

:named Termination_pre_typing_Tm_arrow_f16e5b4778c50c83c6dbec8b6dbd4a6b))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_f16e5b4778c50c83c6dbec8b6dbd4a6b
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(161,25-164,59); use=Termination.fst(161,25-164,59)
(forall ((@x0 Term))
...
(Prims.list @x2))
(HasType @x4
(Tm_refine_ec037382136011912190a803d0b5d365 @x1
@x2
@x3)))
(HasType (ApplyTT (ApplyTT (ApplyTT (ApplyTT @x0
@x1)
...
@x3)
@x4))
:qid Termination_interpretation_Tm_arrow_f16e5b4778c50c83c6dbec8b6dbd4a6b.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid Termination_interpretation_Tm_arrow_f16e5b4778c50c83c6dbec8b6dbd4a6b.2))
...
@x1)
@x2))
:qid Termination_interpretation_Tm_arrow_f16e5b4778c50c83c6dbec8b6dbd4a6b.3))
...
@x2)
@x3))
:qid Termination_interpretation_Tm_arrow_f16e5b4778c50c83c6dbec8b6dbd4a6b.4))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_f16e5b4778c50c83c6dbec8b6dbd4a6b))
:qid Termination_interpretation_Tm_arrow_f16e5b4778c50c83c6dbec8b6dbd4a6b))

:named Termination_interpretation_Tm_arrow_f16e5b4778c50c83c6dbec8b6dbd4a6b))
(declare-fun Termination.flatten_list_@tok () Term)
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(161,8-161,21); use=Termination.fst(161,8-161,21)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (ApplyTT (ApplyTT (ApplyTT (ApplyTT Termination.flatten_list_@tok
@x0)
@x1)
@x2)
@x3)
(Termination.flatten_list_ @x0
@x1
@x2
@x3))
 

:pattern ((ApplyTT (ApplyTT (ApplyTT (ApplyTT Termination.flatten_list_@tok
@x0)
@x1)
@x2)
@x3))
:qid token_correspondence_Termination.flatten_list_))

:named token_correspondence_Termination.flatten_list_))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(161,8-161,21); use=Termination.fst(161,8-161,21)
(forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType Termination.flatten_list_@tok
Tm_arrow_f16e5b4778c50c83c6dbec8b6dbd4a6b))
...
@x3)
@x4)
(Termination.flatten_list_ @x1
@x2
@x3
@x4))
 

:pattern ((Termination.flatten_list_ @x1
@x2
@x3
@x4))
:qid function_token_typing_Termination.flatten_list_.1))
)
 

:pattern ((ApplyTT @x0
Termination.flatten_list_@tok))
:qid function_token_typing_Termination.flatten_list_))

:named function_token_typing_Termination.flatten_list_))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(161,8-161,21); use=Termination.fst(161,8-161,21)
...
(Prims.list @x1))
(HasType @x3
(Tm_refine_ec037382136011912190a803d0b5d365 @x0
@x1
@x2)))
(HasType (Termination.flatten_list_ @x0
@x1
@x2
@x3)
(Prims.list @x0)))
...
:pattern ((Termination.flatten_list_ @x0
@x1
@x2
@x3))
:qid typing_Termination.flatten_list_))

:named typing_Termination.flatten_list_))
(declare-fun label_4 () Bool)
(declare-fun label_3 () Bool)
(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)
...
;   (~(Nil? l) /\ ~(Cons? l) ==> Prims.l_False) /\
;   (~(Nil? l) ==>
;     (forall (b: 'b) (b: Prims.list 'b).
;         l == b :: b ==>
;         b << l /\
;         (forall (any_result: 'b).
;             b == any_result ==>
;             (forall (any_result: Prims.list 'a).
;                 f b == any_result ==> (forall (x: 'b). x << b ==> x << l) /\ b << l))))
...
;; def=Prims.fst(402,27-402,88); use=Termination.fst(162,2-164,59)
(forall ((@x1 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=Termination.fst(162,2-164,59)
(Valid 
;; def=Prims.fst(402,84-402,87); use=Termination.fst(162,2-164,59)
(ApplyTT @x0
@x1)
...
;; def=Prims.fst(459,77-459,89); use=Termination.fst(162,2-164,59)
(and (implies 
;; def=Termination.fst(161,23-161,24); use=Termination.fst(162,8-162,9)
(and 
;; def=Termination.fst(161,23-161,24); use=Termination.fst(162,8-162,9)
(not 
;; def=Termination.fst(161,23-161,24); use=Termination.fst(162,8-162,9)
...
label_1)
(implies 
;; def=Prims.fst(389,19-389,21); use=Termination.fst(162,2-164,59)
(not 
;; def=Termination.fst(161,23-161,24); use=Termination.fst(162,8-162,9)
(BoxBool_proj_0 (Prims.uu___is_Nil x_fe28d8bcde588226b4e538b35321de05_3
x_8e2b3e2e2d5822bdb0266bcb517fa74a_4))
...
;; def=Prims.fst(413,99-413,120); use=Termination.fst(162,2-164,59)
(forall ((@x1 Term))
 (! (implies (HasType @x1
x_fe28d8bcde588226b4e538b35321de05_3)
...
;; def=Termination.fst(161,23-164,10); use=Termination.fst(162,8-164,10)
(= x_8e2b3e2e2d5822bdb0266bcb517fa74a_4
(Prims.Cons x_fe28d8bcde588226b4e538b35321de05_3
@x1
@x2))
...
;; def=Prims.fst(459,77-459,89); use=Termination.fst(162,2-164,59)
(and 
;; def=Termination.fst(161,45-161,51); use=Termination.fst(164,35-164,37)
(or label_2
...
;; def=Prims.fst(451,66-451,102); use=Termination.fst(162,2-164,59)
(forall ((@x3 Term))
 (! (implies (and (HasType @x3
x_fe28d8bcde588226b4e538b35321de05_3)

;; def=Termination.fst(161,40-164,6); use=Termination.fst(162,2-164,59)
(= @x1
@x3)
)
...
;; def=dummy(0,0-0,0); use=Termination.fst(162,2-164,59)
(= (ApplyTT x_fa7ef4a30c0dcc49b8513a96c15f6c9f_5
@x1)
@x4)
)

;; def=Termination.fst(162,2-164,59); use=Termination.fst(164,57-164,58)
(and 
;; def=dummy(0,0-0,0); use=Termination.fst(164,57-164,58)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
x_fe28d8bcde588226b4e538b35321de05_3)

;; def=Termination.fst(161,45-161,51); use=Termination.fst(164,57-164,58)
(Valid 
;; def=Termination.fst(161,45-161,51); use=Termination.fst(164,57-164,58)
(Prims.precedes x_fe28d8bcde588226b4e538b35321de05_3
(Prims.list x_fe28d8bcde588226b4e538b35321de05_3)
...
; QUERY ID: (Termination.flatten_list', 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, binder_x_8e2b3e2e2d5822bdb0266bcb517fa74a_4, disc_equation_Prims.Cons, disc_equation_Prims.Nil, fuel_guarded_inversion_Prims.list, projection_inverse_BoxBool_proj_0, projection_inverse_Prims.Cons_hd, projection_inverse_Prims.Cons_tl, subterm_ordering_Prims.Cons
...
;;;;;;;;;;;;;;;;Fuel-instrumented function name
(declare-fun Termination.flatten_list_.fuel_instrumented (Fuel Term Term Term Term) Term)
;;;;;;;;;;;;;;;;Token for fuel-instrumented partial applications
(declare-fun Termination.flatten_list_.fuel_instrumented_token () Term)
(declare-fun Termination.flatten_list_ (Term Term Term Term) Term)
(declare-fun Termination.flatten_list_@tok () Term)
...
;;;;;;;;;;;;;;;;l: Prims.list 'b -> f: (x: 'b{x << l} -> Prims.list 'a) -> Prims.list 'a
(declare-fun Tm_arrow_c13086c6af6ea972b46ad315ca2097a7 () Term)

; </end encoding let rec flatten_list'>

(push) ;; push{2

; Starting query at Termination.fst(167,2-169,43)
...
:named binder_x_fe28d8bcde588226b4e538b35321de05_1))
;;;;;;;;;;;;;;;;t : Termination.tree a (Termination.tree a)
(declare-fun x_5d03a1de8ce9244d969fb5b9e35a1b72_2 () Term)
;;;;;;;;;;;;;;;;binder_x_5d03a1de8ce9244d969fb5b9e35a1b72_2
;;; Fact-ids: 
(assert (! (HasType x_5d03a1de8ce9244d969fb5b9e35a1b72_2
(Termination.tree x_fe28d8bcde588226b4e538b35321de05_1))
:named binder_x_5d03a1de8ce9244d969fb5b9e35a1b72_2))
(declare-fun Tm_refine_055377164da2358cb8668c922c366cb9 (Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(166,33-169,43); use=Termination.fst(166,33-169,43)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_055377164da2358cb8668c922c366cb9 @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_055377164da2358cb8668c922c366cb9 @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_055377164da2358cb8668c922c366cb9))

:named refinement_kinding_Tm_refine_055377164da2358cb8668c922c366cb9))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(166,33-169,43); use=Termination.fst(166,33-169,43)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_055377164da2358cb8668c922c366cb9 @x2))
(and (HasTypeFuel @u0
@x1
(Termination.tree @x2))

;; def=Termination.fst(167,2-169,43); use=Termination.fst(167,2-169,43)
...
(Termination.tree x_fe28d8bcde588226b4e538b35321de05_1)
@x1
x_5d03a1de8ce9244d969fb5b9e35a1b72_2)
)
...
@x1
(Tm_refine_055377164da2358cb8668c922c366cb9 @x2)))
:qid refinement_interpretation_Tm_refine_055377164da2358cb8668c922c366cb9))

:named refinement_interpretation_Tm_refine_055377164da2358cb8668c922c366cb9))
;;;;;;;;;;;;;;;;haseq for Tm_refine_055377164da2358cb8668c922c366cb9
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(166,33-169,43); use=Termination.fst(166,33-169,43)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_055377164da2358cb8668c922c366cb9 @x0)))
(Valid (Prims.hasEq (Termination.tree @x0))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_055377164da2358cb8668c922c366cb9 @x0))))
:qid haseqTm_refine_055377164da2358cb8668c922c366cb9))

:named haseqTm_refine_055377164da2358cb8668c922c366cb9))
(declare-fun Termination.flatten_tree_ (Term Term) Term)

;;;;;;;;;;;;;;;;t: tree a {t << t} -> Prims.list a
(declare-fun Tm_arrow_ceace91830d881cc4aa90b1181c4898e () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_ceace91830d881cc4aa90b1181c4898e
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_ceace91830d881cc4aa90b1181c4898e
Tm_type)
:named kinding_Tm_arrow_ceace91830d881cc4aa90b1181c4898e))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(166,26-169,43); use=Termination.fst(166,26-169,43)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_ceace91830d881cc4aa90b1181c4898e)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_ceace91830d881cc4aa90b1181c4898e))
:qid Termination_pre_typing_Tm_arrow_ceace91830d881cc4aa90b1181c4898e))

:named Termination_pre_typing_Tm_arrow_ceace91830d881cc4aa90b1181c4898e))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_ceace91830d881cc4aa90b1181c4898e
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(166,26-169,43); use=Termination.fst(166,26-169,43)
(forall ((@x0 Term))
...
Tm_type)
(HasType @x2
(Tm_refine_055377164da2358cb8668c922c366cb9 @x1)))
(HasType (ApplyTT (ApplyTT @x0
@x1)
@x2)
(Prims.list @x1)))
...
@x1)
@x2))
:qid Termination_interpretation_Tm_arrow_ceace91830d881cc4aa90b1181c4898e.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid Termination_interpretation_Tm_arrow_ceace91830d881cc4aa90b1181c4898e.2))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_ceace91830d881cc4aa90b1181c4898e))
:qid Termination_interpretation_Tm_arrow_ceace91830d881cc4aa90b1181c4898e))

:named Termination_interpretation_Tm_arrow_ceace91830d881cc4aa90b1181c4898e))
(declare-fun Termination.flatten_tree_@tok () Term)
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(166,8-166,21); use=Termination.fst(166,8-166,21)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (ApplyTT Termination.flatten_tree_@tok
@x0)
@x1)
(Termination.flatten_tree_ @x0
@x1))
 

:pattern ((ApplyTT (ApplyTT Termination.flatten_tree_@tok
@x0)
@x1))
:qid token_correspondence_Termination.flatten_tree_))

:named token_correspondence_Termination.flatten_tree_))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(166,8-166,21); use=Termination.fst(166,8-166,21)
(forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType Termination.flatten_tree_@tok
Tm_arrow_ceace91830d881cc4aa90b1181c4898e))
...
@x1)
@x2)
(Termination.flatten_tree_ @x1
@x2))
 

:pattern ((Termination.flatten_tree_ @x1
@x2))
:qid function_token_typing_Termination.flatten_tree_.1))
)
 

:pattern ((ApplyTT @x0
Termination.flatten_tree_@tok))
:qid function_token_typing_Termination.flatten_tree_))

:named function_token_typing_Termination.flatten_tree_))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: 
(assert (! 
;; def=Termination.fst(166,8-166,21); use=Termination.fst(166,8-166,21)
...
Tm_type)
(HasType @x1
(Tm_refine_055377164da2358cb8668c922c366cb9 @x0)))
(HasType (Termination.flatten_tree_ @x0
@x1)
(Prims.list @x0)))
 

:pattern ((Termination.flatten_tree_ @x0
@x1))
:qid typing_Termination.flatten_tree_))

:named typing_Termination.flatten_tree_))
(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)
...
(assert (! (not (forall ((@x0 Term))
 (! (implies (and (HasType @x0
(Prims.pure_post (Prims.list x_fe28d8bcde588226b4e538b35321de05_1)))

;; def=Prims.fst(402,27-402,88); use=Termination.fst(167,2-169,43)
(forall ((@x1 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=Termination.fst(167,2-169,43)
(Valid 
;; def=Prims.fst(402,84-402,87); use=Termination.fst(167,2-169,43)
(ApplyTT @x0
@x1)
...
;; def=Prims.fst(459,77-459,89); use=Termination.fst(167,2-169,43)
(and (implies 
;; def=Termination.fst(166,33-166,34); use=Termination.fst(167,8-167,9)
(and 
;; def=Termination.fst(166,33-166,34); use=Termination.fst(167,8-167,9)
(not 
;; def=Termination.fst(166,33-166,34); use=Termination.fst(167,8-167,9)
(BoxBool_proj_0 (Termination.uu___is_Leaf x_fe28d8bcde588226b4e538b35321de05_1
x_5d03a1de8ce9244d969fb5b9e35a1b72_2))
)
...
(not 
;; def=Termination.fst(166,33-166,34); use=Termination.fst(167,8-167,9)
(BoxBool_proj_0 (Termination.uu___is_Node x_fe28d8bcde588226b4e538b35321de05_1
x_5d03a1de8ce9244d969fb5b9e35a1b72_2))
)
)
...
label_1)
(implies 
;; def=Prims.fst(389,19-389,21); use=Termination.fst(167,2-169,43)
(not 
;; def=Termination.fst(166,33-166,34); use=Termination.fst(167,8-167,9)
(BoxBool_proj_0 (Termination.uu___is_Leaf x_fe28d8bcde588226b4e538b35321de05_1
x_5d03a1de8ce9244d969fb5b9e35a1b72_2))
...
;; def=Prims.fst(413,99-413,120); use=Termination.fst(167,2-169,43)
(forall ((@x1 Term))
 (! (implies (and (HasType @x1
(Prims.list (Termination.tree x_fe28d8bcde588226b4e538b35321de05_1)))

;; def=Termination.fst(166,33-169,10); use=Termination.fst(167,8-169,10)
(= x_5d03a1de8ce9244d969fb5b9e35a1b72_2
(Termination.Node x_fe28d8bcde588226b4e538b35321de05_1
@x1))
)

;; def=dummy(0,0-0,0); use=Termination.fst(169,30-169,43)
(forall ((@x2 Term))
 (! (implies (and (HasType @x2
(Termination.tree x_fe28d8bcde588226b4e538b35321de05_1))

;; def=Termination.fst(161,45-161,51); use=Termination.fst(169,30-169,43)
(Valid 
;; def=Termination.fst(161,45-161,51); use=Termination.fst(169,30-169,43)
(Prims.precedes (Termination.tree x_fe28d8bcde588226b4e538b35321de05_1)
(Prims.list (Termination.tree x_fe28d8bcde588226b4e538b35321de05_1))
@x2
@x1)
)
...
;; def=Termination.fst(167,2-169,43); use=Termination.fst(169,30-169,43)
(or label_2
...
; QUERY ID: (Termination.flatten_tree', 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, binder_x_5d03a1de8ce9244d969fb5b9e35a1b72_2, disc_equation_Termination.Leaf, disc_equation_Termination.Node, fuel_guarded_inversion_Termination.tree, projection_inverse_BoxBool_proj_0, projection_inverse_Termination.Node__0, subterm_ordering_Termination.Node
