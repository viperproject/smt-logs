...
; Starting query at McCarthy91.fst(18,25-18,56)
...
;     ~(x <= 100 = true) ==> (forall (b: Prims.bool). x <= 100 == b ==> x - 10 >= 0)


; Context: While encoding a query
; While typechecking the top-level declaration `let f91_`
...
;; def=Prims.fst(402,27-402,88); use=McCarthy91.fst(18,25-18,56)
(forall ((@x2 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=McCarthy91.fst(18,25-18,56)
(Valid 
;; def=Prims.fst(402,84-402,87); use=McCarthy91.fst(18,25-18,56)
(ApplyTT @x1
@x2)
...
;; def=Prims.fst(389,19-389,21); use=McCarthy91.fst(18,25-18,56)
(not 
;; def=McCarthy91.fst(18,28-18,36); use=McCarthy91.fst(18,28-18,36)
(= (Prims.op_LessThanOrEqual @x0
(BoxInt 100))
(BoxBool true))
)
...
;; def=Prims.fst(413,99-413,120); use=McCarthy91.fst(18,25-18,56)
(forall ((@x2 Term))
 (! (implies (and (HasType @x2
Prims.bool)

;; def=McCarthy91.fst(18,28-18,56); use=McCarthy91.fst(18,28-18,56)
(= (Prims.op_LessThanOrEqual @x0
(BoxInt 100))
@x2)
)

;; def=Prims.fst(680,18-680,24); use=McCarthy91.fst(18,50-18,56)
(or label_1
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (McCarthy91.f91_, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, primitive_Prims.op_LessThanOrEqual, primitive_Prims.op_Subtraction, projection_inverse_BoxInt_proj_0
...
; encoding sigelt let f91_


; <Start encoding let f91_>

(declare-fun McCarthy91.f91_ (Term) Term)
;;;;;;;;;;;;;;;;x: Prims.nat -> Prims.nat
(declare-fun Tm_arrow_b71b847c8a1dce9fbabbfc40fd470d89 () Term)
(declare-fun McCarthy91.f91_@tok () Term)

; </end encoding let f91_>
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name McCarthy91.f91_; Namespace McCarthy91
(assert (! 
;; def=McCarthy91.fst(18,4-18,8); use=McCarthy91.fst(18,4-18,8)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Prims.nat)
(HasType (McCarthy91.f91_ @x0)
Prims.nat))
 

:pattern ((McCarthy91.f91_ @x0))
:qid typing_McCarthy91.f91_))

:named typing_McCarthy91.f91_))
...
;;;;;;;;;;;;;;;;Equation for McCarthy91.f91_
;;; Fact-ids: Name McCarthy91.f91_; Namespace McCarthy91
(assert (! 
;; def=McCarthy91.fst(18,4-18,8); use=McCarthy91.fst(18,4-18,8)
(forall ((@x0 Term))
 (! (= (McCarthy91.f91_ @x0)
(let ((@lb1 (Prims.op_LessThanOrEqual @x0
(BoxInt 100))))
(ite (= @lb1
(BoxBool true))
(BoxInt 91)
...
:pattern ((McCarthy91.f91_ @x0))
:qid equation_McCarthy91.f91_))

:named equation_McCarthy91.f91_))
(push) ;; push{2

; Starting query at McCarthy91.fst(24,0-24,47)
...
(declare-fun Tm_refine_eaf737b07df00e81ffafe73e587c5baa () Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! (HasType Tm_refine_eaf737b07df00e81ffafe73e587c5baa
Tm_type)
:named refinement_kinding_Tm_refine_eaf737b07df00e81ffafe73e587c5baa))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=McCarthy91.fst(21,13-24,47); use=McCarthy91.fst(21,13-24,47)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_eaf737b07df00e81ffafe73e587c5baa)
(and (HasTypeFuel @u0
@x1
Prims.nat)

;; def=McCarthy91.fst(24,0-24,47); use=McCarthy91.fst(24,0-24,47)
...
Prims.int
(Prims.op_Subtraction (BoxInt 112)
@x1)
(Prims.op_Subtraction (BoxInt 112)
...
@x1
Tm_refine_eaf737b07df00e81ffafe73e587c5baa))
:qid refinement_interpretation_Tm_refine_eaf737b07df00e81ffafe73e587c5baa))

:named refinement_interpretation_Tm_refine_eaf737b07df00e81ffafe73e587c5baa))
;;;;;;;;;;;;;;;;haseq for Tm_refine_eaf737b07df00e81ffafe73e587c5baa
;;; Fact-ids: 
(assert (! (iff (Valid (Prims.hasEq Tm_refine_eaf737b07df00e81ffafe73e587c5baa))
(Valid (Prims.hasEq Prims.nat)))
:named haseqTm_refine_eaf737b07df00e81ffafe73e587c5baa))
(declare-fun McCarthy91.f91 (Term) Term)

(declare-fun Tm_refine_368c8d4caceaff2435bb1b18f04ed384 (Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=McCarthy91.fst(21,27-21,30); use=McCarthy91.fst(21,27-21,30)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_368c8d4caceaff2435bb1b18f04ed384 @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_368c8d4caceaff2435bb1b18f04ed384 @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_368c8d4caceaff2435bb1b18f04ed384))

:named refinement_kinding_Tm_refine_368c8d4caceaff2435bb1b18f04ed384))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=McCarthy91.fst(21,27-21,30); use=McCarthy91.fst(21,27-21,30)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_368c8d4caceaff2435bb1b18f04ed384 @x2))
(and (HasTypeFuel @u0
@x1
Prims.nat)

;; def=McCarthy91.fst(22,21-22,31); use=McCarthy91.fst(22,21-22,31)
(= @x1
(McCarthy91.f91_ @x2))
))
...
@x1
(Tm_refine_368c8d4caceaff2435bb1b18f04ed384 @x2)))
:qid refinement_interpretation_Tm_refine_368c8d4caceaff2435bb1b18f04ed384))

:named refinement_interpretation_Tm_refine_368c8d4caceaff2435bb1b18f04ed384))
;;;;;;;;;;;;;;;;haseq for Tm_refine_368c8d4caceaff2435bb1b18f04ed384
;;; Fact-ids: 
(assert (! 
;; def=McCarthy91.fst(21,27-21,30); use=McCarthy91.fst(21,27-21,30)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_368c8d4caceaff2435bb1b18f04ed384 @x0)))
(Valid (Prims.hasEq Prims.nat)))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_368c8d4caceaff2435bb1b18f04ed384 @x0))))
:qid haseqTm_refine_368c8d4caceaff2435bb1b18f04ed384))

:named haseqTm_refine_368c8d4caceaff2435bb1b18f04ed384))
;;;;;;;;;;;;;;;;x: Prims.nat{112 - x << 112 - x} -> Prims.Pure Prims.nat
(declare-fun Tm_arrow_968b940451c5cb203761fc30e412fa49 () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_968b940451c5cb203761fc30e412fa49
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_968b940451c5cb203761fc30e412fa49
Tm_type)
:named kinding_Tm_arrow_968b940451c5cb203761fc30e412fa49))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=McCarthy91.fst(21,13-24,47); use=McCarthy91.fst(21,13-24,47)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_968b940451c5cb203761fc30e412fa49)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_968b940451c5cb203761fc30e412fa49))
:qid McCarthy91_pre_typing_Tm_arrow_968b940451c5cb203761fc30e412fa49))

:named McCarthy91_pre_typing_Tm_arrow_968b940451c5cb203761fc30e412fa49))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_968b940451c5cb203761fc30e412fa49
;;; Fact-ids: 
(assert (! 
;; def=McCarthy91.fst(21,13-24,47); use=McCarthy91.fst(21,13-24,47)
(forall ((@x0 Term))
...
(HasType (ApplyTT @x0
@x1)
(Tm_refine_368c8d4caceaff2435bb1b18f04ed384 @x1)))
 

:pattern ((ApplyTT @x0
@x1))
:qid McCarthy91_interpretation_Tm_arrow_968b940451c5cb203761fc30e412fa49.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_968b940451c5cb203761fc30e412fa49))
:qid McCarthy91_interpretation_Tm_arrow_968b940451c5cb203761fc30e412fa49))

:named McCarthy91_interpretation_Tm_arrow_968b940451c5cb203761fc30e412fa49))
(declare-fun McCarthy91.f91@tok () Term)
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: 
(assert (! 
;; def=McCarthy91.fst(21,8-21,11); use=McCarthy91.fst(21,8-21,11)
(forall ((@x0 Term))
 (! (= (ApplyTT McCarthy91.f91@tok
@x0)
(McCarthy91.f91 @x0))
 

:pattern ((ApplyTT McCarthy91.f91@tok
@x0))
:qid token_correspondence_McCarthy91.f91))

:named token_correspondence_McCarthy91.f91))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: 
(assert (! 
;; def=McCarthy91.fst(21,8-21,11); use=McCarthy91.fst(21,8-21,11)
...
:pattern ((McCarthy91.f91 @x1))
:qid function_token_typing_McCarthy91.f91.1))
)
 

:pattern ((ApplyTT @x0
McCarthy91.f91@tok))
:qid function_token_typing_McCarthy91.f91))

:named function_token_typing_McCarthy91.f91))
...
(forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_refine_eaf737b07df00e81ffafe73e587c5baa)
(HasType (McCarthy91.f91 @x0)
(Tm_refine_368c8d4caceaff2435bb1b18f04ed384 @x0)))
 

:pattern ((McCarthy91.f91 @x0))
:qid typing_McCarthy91.f91))

:named typing_McCarthy91.f91))
...
; Encoding query formula : (forall (r: Prims.nat). (*  - Could not prove post-condition
; *) Prims.hasEq Prims.nat) /\
; (forall (p: Prims.pure_post Prims.nat).
;     (forall (pure_result: Prims.nat). pure_result = McCarthy91.f91_ x ==> p pure_result) ==>
;     (forall (k: Prims.pure_post Prims.nat).
;         (forall (x: Prims.nat). {:pattern Prims.guard_free (k x)}
;             (x ==
;               (match x <= 100 with
;                 | true -> McCarthy91.f91 (McCarthy91.f91 (x + 11))
;                 | _ -> x - 10) ==>
;               (forall (return_val: Prims.nat). return_val == x ==> p return_val)) ==>
;             k x) ==>
;         (x <= 100 == true ==>
;           x + 11 >= 0 /\ 112 - (x + 11) << 112 - x /\
;           (forall (return_val: x: Prims.nat{112 - x << 112 - x}).
;               return_val == x + 11 ==>
;               (forall (pure_result: Prims.nat).
;                   pure_result = McCarthy91.f91_ (x + 11) ==>
;                   McCarthy91.f91 (x + 11) == pure_result ==>
;                   112 - McCarthy91.f91 (x + 11) << 112 - x /\
;                   (forall (return_val: x: Prims.nat{112 - x << 112 - x}).
;                       return_val == McCarthy91.f91 (x + 11) ==>
;                       McCarthy91.f91 (x + 11) == return_val ==>
;                       (forall (pure_result: Prims.nat).
;                           pure_result = McCarthy91.f91_ (McCarthy91.f91 (x + 11)) ==> k pure_result)
;                   )))) /\
;         (~(x <= 100 = true) ==>
;           (forall (b: Prims.bool).
;               x <= 100 == b ==>
;               x - 10 >= 0 /\ (forall (return_val: Prims.nat). return_val == x - 10 ==> k return_val)
;           )))) /\
; (forall (p: Prims.pure_post Prims.nat).
;     (forall (pure_result: Prims.nat). pure_result = McCarthy91.f91_ x ==> p pure_result) ==>
;     (forall (pure_result: Prims.nat).
;         pure_result = McCarthy91.f91_ x ==>
;         pure_result ==
;         (match x <= 100 with
;           | true -> McCarthy91.f91 (McCarthy91.f91 (x + 11))
;           | _ -> x - 10) ==>
...
; Context: While encoding a query
; While typechecking the top-level declaration `let rec f91`
...
(and 
;; def=dummy(0,0-0,0); use=McCarthy91.fst(24,0-24,47)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Prims.nat)

;; def=Prims.fst(73,23-73,30); use=McCarthy91.fst(22,21-22,22)
(or label_1

;; def=Prims.fst(73,23-73,30); use=McCarthy91.fst(24,0-24,47)
(Valid 
;; def=Prims.fst(73,23-73,30); use=McCarthy91.fst(24,0-24,47)
(Prims.hasEq Prims.nat)
)
...
;; def=Prims.fst(441,36-441,97); use=McCarthy91.fst(24,0-24,47)
(forall ((@x1 Term))
 (! (implies (and (or label_2
(HasType @x1
Prims.nat))

;; def=McCarthy91.fst(22,21-22,31); use=McCarthy91.fst(24,0-24,47)
(or label_3

;; def=McCarthy91.fst(22,21-22,31); use=McCarthy91.fst(24,0-24,47)
(= @x1
(McCarthy91.f91_ x_bb4e1c9af0265270f8e7a5f250f730e2_0))
)
)

;; def=Prims.fst(441,83-441,96); use=McCarthy91.fst(24,0-24,47)
(Valid 
;; def=Prims.fst(441,83-441,96); use=McCarthy91.fst(24,0-24,47)
(ApplyTT @x0
@x1)
...
;; def=Prims.fst(402,2-402,97); use=McCarthy91.fst(24,0-24,47)
(forall ((@x1 Term))
 (! (implies (and (HasType @x1
(Prims.pure_post Prims.nat))
...
(forall ((@x2 Term))
 (! (implies (implies 
;; def=McCarthy91.fst(21,27-24,47); use=McCarthy91.fst(24,0-24,47)
(= @x2
(let ((@lb3 (Prims.op_LessThanOrEqual x_bb4e1c9af0265270f8e7a5f250f730e2_0
(BoxInt 100))))
(ite (= @lb3
(BoxBool true))
(McCarthy91.f91 (McCarthy91.f91 (Prims.op_Addition x_bb4e1c9af0265270f8e7a5f250f730e2_0
(BoxInt 11))))
...
;; def=Prims.fst(402,84-402,87); use=McCarthy91.fst(24,0-24,47)
(Valid 
;; def=Prims.fst(402,84-402,87); use=McCarthy91.fst(24,0-24,47)
(ApplyTT @x1
@x2)
...
;; def=Prims.fst(389,2-389,39); use=McCarthy91.fst(24,0-24,47)
(and (implies 
;; def=McCarthy91.fst(24,3-24,11); use=McCarthy91.fst(24,3-24,11)
(= (Prims.op_LessThanOrEqual x_bb4e1c9af0265270f8e7a5f250f730e2_0
(BoxInt 100))
(BoxBool true))


;; def=Prims.fst(459,77-459,89); use=McCarthy91.fst(24,0-24,47)
(and 
;; def=Prims.fst(680,18-680,24); use=McCarthy91.fst(24,26-24,34)
(or label_4
...
;; def=McCarthy91.fst(24,0-24,47); use=McCarthy91.fst(24,26-24,34)
(or label_5
...
;; def=Prims.fst(356,2-356,58); use=McCarthy91.fst(24,0-24,47)
(forall ((@x2 Term))
 (! (implies (and (HasType @x2
Tm_refine_eaf737b07df00e81ffafe73e587c5baa)

;; def=Prims.fst(356,26-356,41); use=McCarthy91.fst(24,0-24,47)
(= @x2
(Prims.op_Addition x_bb4e1c9af0265270f8e7a5f250f730e2_0
(BoxInt 11)))
)

;; def=Prims.fst(441,36-441,97); use=McCarthy91.fst(24,22-24,25)
(forall ((@x3 Term))
 (! (implies (and (HasType @x3
Prims.nat)

;; def=McCarthy91.fst(22,21-22,31); use=McCarthy91.fst(24,22-24,25)
(= @x3
(McCarthy91.f91_ (Prims.op_Addition x_bb4e1c9af0265270f8e7a5f250f730e2_0
(BoxInt 11))))


;; def=McCarthy91.fst(21,13-24,47); use=McCarthy91.fst(24,17-24,35)
(= (McCarthy91.f91 (Prims.op_Addition x_bb4e1c9af0265270f8e7a5f250f730e2_0
(BoxInt 11)))
@x3)
)
...
;; def=Prims.fst(459,77-459,89); use=McCarthy91.fst(24,0-24,47)
(and 
;; def=McCarthy91.fst(24,0-24,47); use=McCarthy91.fst(24,21-24,35)
(or label_6
...
;; def=McCarthy91.fst(21,13-24,35); use=McCarthy91.fst(24,0-24,47)
(= (McCarthy91.f91 (Prims.op_Addition x_bb4e1c9af0265270f8e7a5f250f730e2_0
(BoxInt 11)))
@x4)
)

;; def=Prims.fst(441,36-441,97); use=McCarthy91.fst(24,17-24,20)
(forall ((@x5 Term))
 (! (implies (and (HasType @x5
Prims.nat)

;; def=McCarthy91.fst(22,21-22,31); use=McCarthy91.fst(24,17-24,20)
(= @x5
(McCarthy91.f91_ (McCarthy91.f91 (Prims.op_Addition x_bb4e1c9af0265270f8e7a5f250f730e2_0
(BoxInt 11)))))
)

;; def=Prims.fst(441,83-441,96); use=McCarthy91.fst(24,17-24,20)
(Valid 
;; def=Prims.fst(441,83-441,96); use=McCarthy91.fst(24,17-24,20)
(ApplyTT @x1
@x5)
...
(implies 
;; def=Prims.fst(389,19-389,21); use=McCarthy91.fst(24,0-24,47)
(not 
;; def=McCarthy91.fst(24,3-24,11); use=McCarthy91.fst(24,3-24,11)
(= (Prims.op_LessThanOrEqual x_bb4e1c9af0265270f8e7a5f250f730e2_0
(BoxInt 100))
...
;; def=Prims.fst(413,99-413,120); use=McCarthy91.fst(24,0-24,47)
(forall ((@x2 Term))
 (! (implies (and (HasType @x2
Prims.bool)

;; def=McCarthy91.fst(24,3-24,47); use=McCarthy91.fst(24,3-24,47)
(= (Prims.op_LessThanOrEqual x_bb4e1c9af0265270f8e7a5f250f730e2_0
(BoxInt 100))
@x2)
)
...
;; def=Prims.fst(459,77-459,89); use=McCarthy91.fst(24,0-24,47)
(and 
;; def=Prims.fst(680,18-680,24); use=McCarthy91.fst(24,41-24,47)
(or label_7
...
;; def=Prims.fst(356,46-356,58); use=McCarthy91.fst(24,0-24,47)
(Valid 
;; def=Prims.fst(356,46-356,58); use=McCarthy91.fst(24,0-24,47)
(ApplyTT @x1
@x3)
...
;; def=McCarthy91.fst(21,27-24,47); use=McCarthy91.fst(24,0-24,47)
(= @x1
(let ((@lb2 (Prims.op_LessThanOrEqual x_bb4e1c9af0265270f8e7a5f250f730e2_0
(BoxInt 100))))
(ite (= @lb2
(BoxBool true))
(McCarthy91.f91 (McCarthy91.f91 (Prims.op_Addition x_bb4e1c9af0265270f8e7a5f250f730e2_0
...
; Starting query at McCarthy91.fst(21,0-24,47)

(declare-fun label_1 () Bool)
(declare-fun Tm_refine_c919dabab159bb7d2a9db94384fd08bb (Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=McCarthy91.fst(21,13-24,47); use=McCarthy91.fst(21,13-24,47)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_c919dabab159bb7d2a9db94384fd08bb @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_c919dabab159bb7d2a9db94384fd08bb @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_c919dabab159bb7d2a9db94384fd08bb))

:named refinement_kinding_Tm_refine_c919dabab159bb7d2a9db94384fd08bb))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=McCarthy91.fst(21,13-24,47); use=McCarthy91.fst(21,13-24,47)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_c919dabab159bb7d2a9db94384fd08bb @x2))
(and (HasTypeFuel @u0
@x1
Prims.nat)
...
@x1
(Tm_refine_c919dabab159bb7d2a9db94384fd08bb @x2)))
:qid refinement_interpretation_Tm_refine_c919dabab159bb7d2a9db94384fd08bb))

:named refinement_interpretation_Tm_refine_c919dabab159bb7d2a9db94384fd08bb))
;;;;;;;;;;;;;;;;haseq for Tm_refine_c919dabab159bb7d2a9db94384fd08bb
;;; Fact-ids: 
(assert (! 
;; def=McCarthy91.fst(21,13-24,47); use=McCarthy91.fst(21,13-24,47)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_c919dabab159bb7d2a9db94384fd08bb @x0)))
(Valid (Prims.hasEq Prims.nat)))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_c919dabab159bb7d2a9db94384fd08bb @x0))))
:qid haseqTm_refine_c919dabab159bb7d2a9db94384fd08bb))

:named haseqTm_refine_c919dabab159bb7d2a9db94384fd08bb))

; Encoding query formula : forall (x: Prims.nat) (x: Prims.nat{112 - x << 112 - x}) (r: Prims.nat).
;   (*  - Could not prove post-condition
; *) Prims.hasEq Prims.nat
...
;;; Fact-ids: 
(assert (! (not 
;; def=dummy(0,0-0,0); use=McCarthy91.fst(21,0-24,47)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x0
Prims.nat)
(HasType @x1
(Tm_refine_c919dabab159bb7d2a9db94384fd08bb @x0))
(HasType @x2
Prims.nat))
