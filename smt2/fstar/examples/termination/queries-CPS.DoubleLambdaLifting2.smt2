...
; Externals for module CPS.Expr


; <Start encoding type CPS.Expr.expr>

;;;;;;;;;;;;;;;;Constructor
(declare-fun CPS.Expr.expr () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun CPS.Expr.Const (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun CPS.Expr.Const__0 (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: CPS.Expr.Const
(declare-fun CPS.Expr.Const@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun CPS.Expr.Plus (Term Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun CPS.Expr.Plus__0 (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun CPS.Expr.Plus__1 (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: CPS.Expr.Plus
(declare-fun CPS.Expr.Plus@tok () Term)
;;;;;;;;;;;;;;;;_0: Prims.int -> expr
(declare-fun Tm_arrow_9d38cc7a502678be5e35c3c9f8c85dd4 () Term)
;;;;;;;;;;;;;;;;_0: expr -> _1: expr -> expr
(declare-fun Tm_arrow_a7e8a1b970ea6431bd383f161e5f6f46 () Term)

; <start constructor CPS.Expr.expr>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-CPS.Expr.expr ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
101)
(= __@x0
CPS.Expr.expr)))

; </end constructor CPS.Expr.expr>


; <start constructor CPS.Expr.Const>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-CPS.Expr.Const ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
107)
(= __@x0
(CPS.Expr.Const (CPS.Expr.Const__0 __@x0)))))

; </end constructor CPS.Expr.Const>


; <start constructor CPS.Expr.Plus>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-CPS.Expr.Plus ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
112)
(= __@x0
(CPS.Expr.Plus (CPS.Expr.Plus__0 __@x0)
(CPS.Expr.Plus__1 __@x0)))))

; </end constructor CPS.Expr.Plus>


; </end encoding type CPS.Expr.expr>


; <Start encoding assume CPS.Expr.expr__uu___haseq>


; </end encoding assume CPS.Expr.expr__uu___haseq>


; <Start encoding val CPS.Expr.uu___is_Const>

(declare-fun CPS.Expr.uu___is_Const (Term) Term)
;;;;;;;;;;;;;;;;projectee: expr -> Prims.bool
(declare-fun Tm_arrow_ef3e6588b9d5ee5d9ace3c56e539bce0 () Term)
(declare-fun CPS.Expr.uu___is_Const@tok () Term)

; </end encoding val CPS.Expr.uu___is_Const>


; <Skipped let uu___is_Const/>


; <Start encoding val CPS.Expr.__proj__Const__item___0>

(declare-fun Tm_refine_61068dfb8b28ba423ea3dca285d5c282 () Term)
(declare-fun CPS.Expr.__proj__Const__item___0 (Term) Term)

;;;;;;;;;;;;;;;;projectee: _: expr{Const? _} -> Prims.int
(declare-fun Tm_arrow_670c260e6ddfb5d5ff17d0050ca4bbaa () Term)
(declare-fun CPS.Expr.__proj__Const__item___0@tok () Term)

; </end encoding val CPS.Expr.__proj__Const__item___0>


; <Skipped let __proj__Const__item___0/>


; <Start encoding val CPS.Expr.uu___is_Plus>

(declare-fun CPS.Expr.uu___is_Plus (Term) Term)

(declare-fun CPS.Expr.uu___is_Plus@tok () Term)

; </end encoding val CPS.Expr.uu___is_Plus>


; <Skipped let uu___is_Plus/>


; <Start encoding val CPS.Expr.__proj__Plus__item___0>

(declare-fun Tm_refine_1ca93587daff7a0ff146b7192bd79c66 () Term)
(declare-fun CPS.Expr.__proj__Plus__item___0 (Term) Term)

;;;;;;;;;;;;;;;;projectee: _: expr{Plus? _} -> expr
(declare-fun Tm_arrow_723b9f06f3bc954ca3371128205c1ba6 () Term)
(declare-fun CPS.Expr.__proj__Plus__item___0@tok () Term)

; </end encoding val CPS.Expr.__proj__Plus__item___0>


; <Skipped let __proj__Plus__item___0/>


; <Start encoding val CPS.Expr.__proj__Plus__item___1>


(declare-fun CPS.Expr.__proj__Plus__item___1 (Term) Term)


(declare-fun CPS.Expr.__proj__Plus__item___1@tok () Term)

; </end encoding val CPS.Expr.__proj__Plus__item___1>


; <Skipped let __proj__Plus__item___1/>


; End Externals for module CPS.Expr

(push) ;; push{1

; Internals for CPS.DoubleLambdaLifting2


; encoding sigelt val CPS.DoubleLambdaLifting2.eval_cps1


; <Skipped val CPS.DoubleLambdaLifting2.eval_cps1/>


; encoding sigelt let eval_cps1


; <Start encoding let eval_cps1>

;;;;;;;;;;;;;;;;_: Prims.int -> 'a
(declare-fun Tm_arrow_8928427c3e013c0cd8946aaaf1c65a29 (Term) Term)
(declare-fun CPS.DoubleLambdaLifting2.eval_cps1 (Term Term Term Term) Term)

;;;;;;;;;;;;;;;;k: (_: Prims.int -> 'a) -> r1: Prims.int -> r2: Prims.int -> 'a
(declare-fun Tm_arrow_513b25dbd891c49fba5fe6949c4e594a () Term)
(declare-fun CPS.DoubleLambdaLifting2.eval_cps1@tok () Term)


; </end encoding let eval_cps1>


; encoding sigelt val CPS.DoubleLambdaLifting2.eval_cps2


; <Skipped val CPS.DoubleLambdaLifting2.eval_cps2/>


; encoding sigelt let eval_cps2


; <Start encoding let eval_cps2>



;;;;;;;;;;;;;;;;_: (_: Prims.int -> 'a) -> 'a
(declare-fun Tm_arrow_7c2ea5fcdb21592dad73952e67ded474 (Term) Term)
(declare-fun CPS.DoubleLambdaLifting2.eval_cps2 (Term Term Term Term) Term)



;;;;;;;;;;;;;;;;k: (_: Prims.int -> 'a) -> eval_cps: (_: (_: Prims.int -> 'a) -> 'a) -> r1: Prims.int -> 'a
(declare-fun Tm_arrow_d5645af19d1ecd5b36775cd2e76d55c5 () Term)
(declare-fun CPS.DoubleLambdaLifting2.eval_cps2@tok () Term)




; </end encoding let eval_cps2>


; encoding sigelt val CPS.DoubleLambdaLifting2.eval_cps


; <Skipped val CPS.DoubleLambdaLifting2.eval_cps/>
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name CPS.Expr.uu___is_Plus; Namespace CPS.Expr
(assert (! 
;; def=CPS.Expr.fst(20,4-20,8); use=CPS.Expr.fst(20,4-20,8)
(forall ((@x0 Term))
 (! (implies (HasType @x0
CPS.Expr.expr)
(HasType (CPS.Expr.uu___is_Plus @x0)
Prims.bool))
 

:pattern ((CPS.Expr.uu___is_Plus @x0))
:qid typing_CPS.Expr.uu___is_Plus))

:named typing_CPS.Expr.uu___is_Plus))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name CPS.Expr.uu___is_Const; Namespace CPS.Expr
(assert (! 
;; def=CPS.Expr.fst(19,4-19,9); use=CPS.Expr.fst(19,4-19,9)
(forall ((@x0 Term))
 (! (implies (HasType @x0
CPS.Expr.expr)
(HasType (CPS.Expr.uu___is_Const @x0)
Prims.bool))
 

:pattern ((CPS.Expr.uu___is_Const @x0))
:qid typing_CPS.Expr.uu___is_Const))

:named typing_CPS.Expr.uu___is_Const))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name CPS.DoubleLambdaLifting2.eval_cps2; Namespace CPS.DoubleLambdaLifting2
(assert (! 
;; def=CPS.DoubleLambdaLifting2.fst(24,4-24,13); use=CPS.DoubleLambdaLifting2.fst(24,4-24,13)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
(Tm_arrow_8928427c3e013c0cd8946aaaf1c65a29 @x0))
(HasType @x2
(Tm_arrow_7c2ea5fcdb21592dad73952e67ded474 @x0))
(HasType @x3
Prims.int))
(HasType (CPS.DoubleLambdaLifting2.eval_cps2 @x0
@x1
@x2
@x3)
@x0))
...
:pattern ((CPS.DoubleLambdaLifting2.eval_cps2 @x0
@x1
@x2
@x3))
:qid typing_CPS.DoubleLambdaLifting2.eval_cps2))

:named typing_CPS.DoubleLambdaLifting2.eval_cps2))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name CPS.DoubleLambdaLifting2.eval_cps1; Namespace CPS.DoubleLambdaLifting2
(assert (! 
;; def=CPS.DoubleLambdaLifting2.fst(21,4-21,13); use=CPS.DoubleLambdaLifting2.fst(21,4-21,13)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (and (HasType @x0
Tm_type)
(HasType @x1
...
(HasType @x3
Prims.int))
(HasType (CPS.DoubleLambdaLifting2.eval_cps1 @x0
@x1
@x2
@x3)
@x0))
...
:pattern ((CPS.DoubleLambdaLifting2.eval_cps1 @x0
@x1
@x2
@x3))
:qid typing_CPS.DoubleLambdaLifting2.eval_cps1))

:named typing_CPS.DoubleLambdaLifting2.eval_cps1))
;;;;;;;;;;;;;;;;True interpretation
;;; Fact-ids: Name Prims.l_True; Namespace Prims
...
;; def=CPS.DoubleLambdaLifting2.fst(24,4-24,13); use=CPS.DoubleLambdaLifting2.fst(24,4-24,13)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (ApplyTT (ApplyTT (ApplyTT (ApplyTT CPS.DoubleLambdaLifting2.eval_cps2@tok
@x0)
@x1)
@x2)
@x3)
(CPS.DoubleLambdaLifting2.eval_cps2 @x0
@x1
@x2
@x3))
 

:pattern ((ApplyTT (ApplyTT (ApplyTT (ApplyTT CPS.DoubleLambdaLifting2.eval_cps2@tok
@x0)
@x1)
@x2)
@x3))
:qid token_correspondence_CPS.DoubleLambdaLifting2.eval_cps2))

:named token_correspondence_CPS.DoubleLambdaLifting2.eval_cps2))
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: Name CPS.DoubleLambdaLifting2.eval_cps1; Namespace CPS.DoubleLambdaLifting2
(assert (! 
;; def=CPS.DoubleLambdaLifting2.fst(21,4-21,13); use=CPS.DoubleLambdaLifting2.fst(21,4-21,13)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (ApplyTT (ApplyTT (ApplyTT (ApplyTT CPS.DoubleLambdaLifting2.eval_cps1@tok
@x0)
@x1)
@x2)
@x3)
(CPS.DoubleLambdaLifting2.eval_cps1 @x0
@x1
@x2
@x3))
 

:pattern ((ApplyTT (ApplyTT (ApplyTT (ApplyTT CPS.DoubleLambdaLifting2.eval_cps1@tok
@x0)
@x1)
@x2)
@x3))
:qid token_correspondence_CPS.DoubleLambdaLifting2.eval_cps1))

:named token_correspondence_CPS.DoubleLambdaLifting2.eval_cps1))
;;;;;;;;;;;;;;;;subterm ordering
;;; Fact-ids: Name CPS.Expr.expr; Namespace CPS.Expr; Name CPS.Expr.Const; Namespace CPS.Expr; Name CPS.Expr.Plus; Namespace CPS.Expr
(assert (! 
;; def=CPS.Expr.fst(20,4-20,8); use=CPS.Expr.fst(20,4-20,8)
...
@x2)
CPS.Expr.expr))
:qid subterm_ordering_CPS.Expr.Plus))

:named subterm_ordering_CPS.Expr.Plus))
;;;;;;;;;;;;;;;;subterm ordering
;;; Fact-ids: Name CPS.Expr.expr; Namespace CPS.Expr; Name CPS.Expr.Const; Namespace CPS.Expr; Name CPS.Expr.Plus; Namespace CPS.Expr
(assert (! 
;; def=CPS.Expr.fst(19,4-19,9); use=CPS.Expr.fst(19,4-19,9)
...
(CPS.Expr.Const @x1)
CPS.Expr.expr))
:qid subterm_ordering_CPS.Expr.Const))

:named subterm_ordering_CPS.Expr.Const))
;;;;;;;;;;;;;;;;refinement kinding
...
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name CPS.Expr.__proj__Const__item___0; Namespace CPS.Expr
(assert (! (HasType Tm_refine_61068dfb8b28ba423ea3dca285d5c282
Tm_type)
:named refinement_kinding_Tm_refine_61068dfb8b28ba423ea3dca285d5c282))
;;;;;;;;;;;;;;;;refinement kinding
...
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name CPS.Expr.__proj__Plus__item___0; Namespace CPS.Expr
(assert (! (HasType Tm_refine_1ca93587daff7a0ff146b7192bd79c66
Tm_type)
:named refinement_kinding_Tm_refine_1ca93587daff7a0ff146b7192bd79c66))
;;;;;;;;;;;;;;;;refinement kinding
...
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_61068dfb8b28ba423ea3dca285d5c282)
(and (HasTypeFuel @u0
@x1
CPS.Expr.expr)

;; def=CPS.Expr.fst(19,4-19,9); use=CPS.Expr.fst(19,4-19,9)
(BoxBool_proj_0 (CPS.Expr.uu___is_Const @x1))
))
...
@x1
Tm_refine_61068dfb8b28ba423ea3dca285d5c282))
:qid refinement_interpretation_Tm_refine_61068dfb8b28ba423ea3dca285d5c282))

:named refinement_interpretation_Tm_refine_61068dfb8b28ba423ea3dca285d5c282))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name Prims.nat; Namespace Prims
(assert (! 
...
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_1ca93587daff7a0ff146b7192bd79c66)
(and (HasTypeFuel @u0
@x1
CPS.Expr.expr)

;; def=CPS.Expr.fst(20,4-20,8); use=CPS.Expr.fst(20,4-20,8)
(BoxBool_proj_0 (CPS.Expr.uu___is_Plus @x1))
))
...
@x1
Tm_refine_1ca93587daff7a0ff146b7192bd79c66))
:qid refinement_interpretation_Tm_refine_1ca93587daff7a0ff146b7192bd79c66))

:named refinement_interpretation_Tm_refine_1ca93587daff7a0ff146b7192bd79c66))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name Prims.nonzero; Namespace Prims
(assert (! 
...
;; def=CPS.Expr.fst(20,4-20,8); use=CPS.Expr.fst(20,4-20,8)
(forall ((@x0 Term) (@x1 Term))
 (! (= (CPS.Expr.Plus__1 (CPS.Expr.Plus @x0
@x1))
@x1)
 

:pattern ((CPS.Expr.Plus @x0
@x1))
:qid projection_inverse_CPS.Expr.Plus__1))

:named projection_inverse_CPS.Expr.Plus__1))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name CPS.Expr.expr; Namespace CPS.Expr; Name CPS.Expr.Const; Namespace CPS.Expr; Name CPS.Expr.Plus; Namespace CPS.Expr
(assert (! 
;; def=CPS.Expr.fst(20,4-20,8); use=CPS.Expr.fst(20,4-20,8)
(forall ((@x0 Term) (@x1 Term))
 (! (= (CPS.Expr.Plus__0 (CPS.Expr.Plus @x0
@x1))
@x0)
...
:pattern ((CPS.Expr.Plus @x0
@x1))
:qid projection_inverse_CPS.Expr.Plus__0))

:named projection_inverse_CPS.Expr.Plus__0))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name CPS.Expr.expr; Namespace CPS.Expr; Name CPS.Expr.Const; Namespace CPS.Expr; Name CPS.Expr.Plus; Namespace CPS.Expr
(assert (! 
;; def=CPS.Expr.fst(19,4-19,9); use=CPS.Expr.fst(19,4-19,9)
(forall ((@x0 Term))
 (! (= (CPS.Expr.Const__0 (CPS.Expr.Const @x0))
@x0)
 

:pattern ((CPS.Expr.Const @x0))
:qid projection_inverse_CPS.Expr.Const__0))

:named projection_inverse_CPS.Expr.Const__0))
...
;;;;;;;;;;;;;;;;kinding_Tm_arrow_d5645af19d1ecd5b36775cd2e76d55c5
;;; Fact-ids: Name CPS.DoubleLambdaLifting2.eval_cps2; Namespace CPS.DoubleLambdaLifting2
(assert (! (HasType Tm_arrow_d5645af19d1ecd5b36775cd2e76d55c5
Tm_type)
:named kinding_Tm_arrow_d5645af19d1ecd5b36775cd2e76d55c5))
...
;;;;;;;;;;;;;;;;kinding_Tm_arrow_8928427c3e013c0cd8946aaaf1c65a29
;;; Fact-ids: Name CPS.DoubleLambdaLifting2.eval_cps1; Namespace CPS.DoubleLambdaLifting2
(assert (! 
;; def=CPS.DoubleLambdaLifting2.fst(20,17-20,30); use=CPS.DoubleLambdaLifting2.fst(20,28-21,13)
(forall ((@x0 Term))
 (! (HasType (Tm_arrow_8928427c3e013c0cd8946aaaf1c65a29 @x0)
Tm_type)
 

:pattern ((HasType (Tm_arrow_8928427c3e013c0cd8946aaaf1c65a29 @x0)
Tm_type))
:qid kinding_Tm_arrow_8928427c3e013c0cd8946aaaf1c65a29))

:named kinding_Tm_arrow_8928427c3e013c0cd8946aaaf1c65a29))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_7c2ea5fcdb21592dad73952e67ded474
;;; Fact-ids: Name CPS.DoubleLambdaLifting2.eval_cps2; Namespace CPS.DoubleLambdaLifting2
(assert (! 
;; def=CPS.DoubleLambdaLifting2.fst(23,28-23,40); use=CPS.DoubleLambdaLifting2.fst(23,48-24,13)
(forall ((@x0 Term))
 (! (HasType (Tm_arrow_7c2ea5fcdb21592dad73952e67ded474 @x0)
Tm_type)
 

:pattern ((HasType (Tm_arrow_7c2ea5fcdb21592dad73952e67ded474 @x0)
Tm_type))
:qid kinding_Tm_arrow_7c2ea5fcdb21592dad73952e67ded474))

:named kinding_Tm_arrow_7c2ea5fcdb21592dad73952e67ded474))
;;;;;;;;;;;;;;;;kinding_Tm_arrow_513b25dbd891c49fba5fe6949c4e594a
;;; Fact-ids: Name CPS.DoubleLambdaLifting2.eval_cps1; Namespace CPS.DoubleLambdaLifting2
(assert (! (HasType Tm_arrow_513b25dbd891c49fba5fe6949c4e594a
Tm_type)
:named kinding_Tm_arrow_513b25dbd891c49fba5fe6949c4e594a))
;;; Fact-ids: Name Prims.trivial; Namespace Prims; Name Prims.T; Namespace Prims
(assert (! (HasType Prims.trivial
Tm_type)
:named kinding_Prims.trivial@tok))
;;; Fact-ids: Name CPS.Expr.expr; Namespace CPS.Expr; Name CPS.Expr.Const; Namespace CPS.Expr; Name CPS.Expr.Plus; Namespace CPS.Expr
(assert (! (HasType CPS.Expr.expr
Tm_type)
:named kinding_CPS.Expr.expr@tok))
;;;;;;;;;;;;;;;;int typing
;;; Fact-ids: Name Prims.int; Namespace Prims
(assert (! (forall ((@u0 Int))
 (! (HasType (BoxInt @u0)
...
;;;;;;;;;;;;;;;;haseq for Tm_refine_61068dfb8b28ba423ea3dca285d5c282
;;; Fact-ids: Name CPS.Expr.__proj__Const__item___0; Namespace CPS.Expr
(assert (! (iff (Valid (Prims.hasEq Tm_refine_61068dfb8b28ba423ea3dca285d5c282))
(Valid (Prims.hasEq CPS.Expr.expr)))
:named haseqTm_refine_61068dfb8b28ba423ea3dca285d5c282))
...
;;;;;;;;;;;;;;;;haseq for Tm_refine_1ca93587daff7a0ff146b7192bd79c66
;;; Fact-ids: Name CPS.Expr.__proj__Plus__item___0; Namespace CPS.Expr
(assert (! (iff (Valid (Prims.hasEq Tm_refine_1ca93587daff7a0ff146b7192bd79c66))
(Valid (Prims.hasEq CPS.Expr.expr)))
:named haseqTm_refine_1ca93587daff7a0ff146b7192bd79c66))
...
(forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType CPS.DoubleLambdaLifting2.eval_cps2@tok
Tm_arrow_d5645af19d1ecd5b36775cd2e76d55c5))
...
@x3)
@x4)
(CPS.DoubleLambdaLifting2.eval_cps2 @x1
@x2
@x3
@x4))
 

:pattern ((CPS.DoubleLambdaLifting2.eval_cps2 @x1
@x2
@x3
@x4))
:qid function_token_typing_CPS.DoubleLambdaLifting2.eval_cps2.1))
)
 

:pattern ((ApplyTT @x0
CPS.DoubleLambdaLifting2.eval_cps2@tok))
:qid function_token_typing_CPS.DoubleLambdaLifting2.eval_cps2))

:named function_token_typing_CPS.DoubleLambdaLifting2.eval_cps2))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: Name CPS.DoubleLambdaLifting2.eval_cps1; Namespace CPS.DoubleLambdaLifting2
(assert (! 
;; def=CPS.DoubleLambdaLifting2.fst(21,4-21,13); use=CPS.DoubleLambdaLifting2.fst(21,4-21,13)
(forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType CPS.DoubleLambdaLifting2.eval_cps1@tok
Tm_arrow_513b25dbd891c49fba5fe6949c4e594a))
...
@x3)
@x4)
(CPS.DoubleLambdaLifting2.eval_cps1 @x1
@x2
@x3
@x4))
 

:pattern ((CPS.DoubleLambdaLifting2.eval_cps1 @x1
@x2
@x3
@x4))
:qid function_token_typing_CPS.DoubleLambdaLifting2.eval_cps1.1))
)
 

:pattern ((ApplyTT @x0
CPS.DoubleLambdaLifting2.eval_cps1@tok))
:qid function_token_typing_CPS.DoubleLambdaLifting2.eval_cps1))

:named function_token_typing_CPS.DoubleLambdaLifting2.eval_cps1))
;;;;;;;;;;;;;;;;inversion axiom
;;; Fact-ids: Name Prims.trivial; Namespace Prims; Name Prims.T; Namespace Prims
(assert (! 
...
;;; Fact-ids: Name CPS.Expr.expr; Namespace CPS.Expr; Name CPS.Expr.Const; Namespace CPS.Expr; Name CPS.Expr.Plus; Namespace CPS.Expr
(assert (! 
;; def=CPS.Expr.fst(18,5-18,9); use=CPS.Expr.fst(18,5-18,9)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel (SFuel @u0)
@x1
CPS.Expr.expr)
(or (is-CPS.Expr.Const @x1)
(is-CPS.Expr.Plus @x1)))
...
@x1
CPS.Expr.expr))
:qid fuel_guarded_inversion_CPS.Expr.expr))

:named fuel_guarded_inversion_CPS.Expr.expr))
...
;;;;;;;;;;;;;;;;Equation for CPS.DoubleLambdaLifting2.eval_cps2
;;; Fact-ids: Name CPS.DoubleLambdaLifting2.eval_cps2; Namespace CPS.DoubleLambdaLifting2
(assert (! 
;; def=CPS.DoubleLambdaLifting2.fst(24,4-24,13); use=CPS.DoubleLambdaLifting2.fst(24,4-24,13)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
...
@x3)
(ApplyTT @x2
(ApplyTT (ApplyTT (ApplyTT CPS.DoubleLambdaLifting2.eval_cps1@tok
@x0)
@x1)
@x3)))
...
@x2
@x3))
:qid equation_CPS.DoubleLambdaLifting2.eval_cps2))

:named equation_CPS.DoubleLambdaLifting2.eval_cps2))
;;;;;;;;;;;;;;;;Equation for CPS.DoubleLambdaLifting2.eval_cps1
;;; Fact-ids: Name CPS.DoubleLambdaLifting2.eval_cps1; Namespace CPS.DoubleLambdaLifting2
(assert (! 
;; def=CPS.DoubleLambdaLifting2.fst(21,4-21,13); use=CPS.DoubleLambdaLifting2.fst(21,4-21,13)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
...
@x2
@x3))
:qid equation_CPS.DoubleLambdaLifting2.eval_cps1))

:named equation_CPS.DoubleLambdaLifting2.eval_cps1))
;;;;;;;;;;;;;;;;equality for proxy
;;; Fact-ids: Name Prims.trivial; Namespace Prims; Name Prims.T; Namespace Prims
(assert (! (= Prims.T@tok
Prims.T)
...
;; def=CPS.Expr.fst(20,4-20,8); use=CPS.Expr.fst(20,4-20,8)
(forall ((@x0 Term))
 (! (= (CPS.Expr.uu___is_Plus @x0)
(BoxBool (is-CPS.Expr.Plus @x0)))
 

:pattern ((CPS.Expr.uu___is_Plus @x0))
:qid disc_equation_CPS.Expr.Plus))

:named disc_equation_CPS.Expr.Plus))
;;;;;;;;;;;;;;;;Discriminator equation
;;; Fact-ids: Name CPS.Expr.uu___is_Const; Namespace CPS.Expr
(assert (! 
;; def=CPS.Expr.fst(19,4-19,9); use=CPS.Expr.fst(19,4-19,9)
(forall ((@x0 Term))
 (! (= (CPS.Expr.uu___is_Const @x0)
(BoxBool (is-CPS.Expr.Const @x0)))
 

:pattern ((CPS.Expr.uu___is_Const @x0))
:qid disc_equation_CPS.Expr.Const))

:named disc_equation_CPS.Expr.Const))
...
@x2)
CPS.Expr.expr))
:qid data_typing_intro_CPS.Expr.Plus@tok))

:named data_typing_intro_CPS.Expr.Plus@tok))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name CPS.Expr.expr; Namespace CPS.Expr; Name CPS.Expr.Const; Namespace CPS.Expr; Name CPS.Expr.Plus; Namespace CPS.Expr
(assert (! 
;; def=CPS.Expr.fst(19,4-19,9); use=CPS.Expr.fst(19,4-19,9)
...
(CPS.Expr.Const @x1)
CPS.Expr.expr))
:qid data_typing_intro_CPS.Expr.Const@tok))

:named data_typing_intro_CPS.Expr.Const@tok))
...
@x2)
CPS.Expr.expr))
:qid data_elim_CPS.Expr.Plus))

:named data_elim_CPS.Expr.Plus))
;;;;;;;;;;;;;;;;data constructor typing elim
;;; Fact-ids: Name CPS.Expr.expr; Namespace CPS.Expr; Name CPS.Expr.Const; Namespace CPS.Expr; Name CPS.Expr.Plus; Namespace CPS.Expr
(assert (! 
;; def=CPS.Expr.fst(19,4-19,9); use=CPS.Expr.fst(19,4-19,9)
...
(CPS.Expr.Const @x1)
CPS.Expr.expr))
:qid data_elim_CPS.Expr.Const))

:named data_elim_CPS.Expr.Const))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Prims.unit; Namespace Prims
(assert (! (= 125
...
;;; Fact-ids: Name CPS.Expr.expr; Namespace CPS.Expr; Name CPS.Expr.Const; Namespace CPS.Expr; Name CPS.Expr.Plus; Namespace CPS.Expr
(assert (! (= 101
(Term_constr_id CPS.Expr.expr))
:named constructor_distinct_CPS.Expr.expr))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name CPS.Expr.expr; Namespace CPS.Expr; Name CPS.Expr.Const; Namespace CPS.Expr; Name CPS.Expr.Plus; Namespace CPS.Expr
(assert (! 
;; def=CPS.Expr.fst(20,4-20,8); use=CPS.Expr.fst(20,4-20,8)
(forall ((@x0 Term) (@x1 Term))
 (! (= 112
(Term_constr_id (CPS.Expr.Plus @x0
@x1)))
 

:pattern ((CPS.Expr.Plus @x0
@x1))
:qid constructor_distinct_CPS.Expr.Plus))

:named constructor_distinct_CPS.Expr.Plus))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name CPS.Expr.expr; Namespace CPS.Expr; Name CPS.Expr.Const; Namespace CPS.Expr; Name CPS.Expr.Plus; Namespace CPS.Expr
(assert (! 
;; def=CPS.Expr.fst(19,4-19,9); use=CPS.Expr.fst(19,4-19,9)
(forall ((@x0 Term))
 (! (= 107
(Term_constr_id (CPS.Expr.Const @x0)))
 

:pattern ((CPS.Expr.Const @x0))
:qid constructor_distinct_CPS.Expr.Const))

:named constructor_distinct_CPS.Expr.Const))
;;;;;;;;;;;;;;;;bool typing
;;; Fact-ids: Name Prims.bool; Namespace Prims
(assert (! (forall ((@u0 Bool))
 (! (HasType (BoxBool @u0)
...
;;;;;;;;;;;;;;;;Assumption: CPS.Expr.expr__uu___haseq
;;; Fact-ids: Name CPS.Expr.expr__uu___haseq; Namespace CPS.Expr
(assert (! (Valid (Prims.hasEq CPS.Expr.expr))
:named assumption_CPS.Expr.expr__uu___haseq))
;;;;;;;;;;;;;;;;pretyping
;;; Fact-ids: Name Prims.unit; Namespace Prims
(assert (! 
...
@x0
CPS.Expr.expr))
:qid CPS.Expr_pretyping_0c607185f6c6768f1786fe5f14f15ea1))

:named CPS.Expr_pretyping_0c607185f6c6768f1786fe5f14f15ea1))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name CPS.DoubleLambdaLifting2.eval_cps2; Namespace CPS.DoubleLambdaLifting2
(assert (! 
;; def=CPS.DoubleLambdaLifting2.fst(23,17-23,69); use=CPS.DoubleLambdaLifting2.fst(23,28-24,13)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_d5645af19d1ecd5b36775cd2e76d55c5)
...
@x1
Tm_arrow_d5645af19d1ecd5b36775cd2e76d55c5))
:qid CPS.DoubleLambdaLifting2_pre_typing_Tm_arrow_d5645af19d1ecd5b36775cd2e76d55c5))

:named CPS.DoubleLambdaLifting2_pre_typing_Tm_arrow_d5645af19d1ecd5b36775cd2e76d55c5))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name CPS.DoubleLambdaLifting2.eval_cps1; Namespace CPS.DoubleLambdaLifting2
(assert (! 
;; def=CPS.DoubleLambdaLifting2.fst(20,17-20,30); use=CPS.DoubleLambdaLifting2.fst(20,28-21,13)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_8928427c3e013c0cd8946aaaf1c65a29 @x2))
(is-Tm_arrow (PreType @x1)))
...
@x1
(Tm_arrow_8928427c3e013c0cd8946aaaf1c65a29 @x2)))
:qid CPS.DoubleLambdaLifting2_pre_typing_Tm_arrow_8928427c3e013c0cd8946aaaf1c65a29))

:named CPS.DoubleLambdaLifting2_pre_typing_Tm_arrow_8928427c3e013c0cd8946aaaf1c65a29))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name CPS.DoubleLambdaLifting2.eval_cps2; Namespace CPS.DoubleLambdaLifting2
(assert (! 
;; def=CPS.DoubleLambdaLifting2.fst(23,28-23,40); use=CPS.DoubleLambdaLifting2.fst(23,48-24,13)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (implies (HasTypeFuel @u0
@x1
(Tm_arrow_7c2ea5fcdb21592dad73952e67ded474 @x2))
(is-Tm_arrow (PreType @x1)))
...
@x1
(Tm_arrow_7c2ea5fcdb21592dad73952e67ded474 @x2)))
:qid CPS.DoubleLambdaLifting2_pre_typing_Tm_arrow_7c2ea5fcdb21592dad73952e67ded474))

:named CPS.DoubleLambdaLifting2_pre_typing_Tm_arrow_7c2ea5fcdb21592dad73952e67ded474))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: Name CPS.DoubleLambdaLifting2.eval_cps1; Namespace CPS.DoubleLambdaLifting2
(assert (! 
;; def=CPS.DoubleLambdaLifting2.fst(20,17-20,45); use=CPS.DoubleLambdaLifting2.fst(20,28-21,13)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_513b25dbd891c49fba5fe6949c4e594a)
...
@x1
Tm_arrow_513b25dbd891c49fba5fe6949c4e594a))
:qid CPS.DoubleLambdaLifting2_pre_typing_Tm_arrow_513b25dbd891c49fba5fe6949c4e594a))

:named CPS.DoubleLambdaLifting2_pre_typing_Tm_arrow_513b25dbd891c49fba5fe6949c4e594a))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_d5645af19d1ecd5b36775cd2e76d55c5
;;; Fact-ids: Name CPS.DoubleLambdaLifting2.eval_cps2; Namespace CPS.DoubleLambdaLifting2
(assert (! 
;; def=CPS.DoubleLambdaLifting2.fst(23,17-23,69); use=CPS.DoubleLambdaLifting2.fst(23,28-24,13)
(forall ((@x0 Term))
...
Tm_type)
(HasType @x2
(Tm_arrow_8928427c3e013c0cd8946aaaf1c65a29 @x1))
(HasType @x3
(Tm_arrow_7c2ea5fcdb21592dad73952e67ded474 @x1))
(HasType @x4
Prims.int))
...
@x3)
@x4))
:qid CPS.DoubleLambdaLifting2_interpretation_Tm_arrow_d5645af19d1ecd5b36775cd2e76d55c5.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid CPS.DoubleLambdaLifting2_interpretation_Tm_arrow_d5645af19d1ecd5b36775cd2e76d55c5.2))
...
@x1)
@x2))
:qid CPS.DoubleLambdaLifting2_interpretation_Tm_arrow_d5645af19d1ecd5b36775cd2e76d55c5.3))
...
@x2)
@x3))
:qid CPS.DoubleLambdaLifting2_interpretation_Tm_arrow_d5645af19d1ecd5b36775cd2e76d55c5.4))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_d5645af19d1ecd5b36775cd2e76d55c5))
:qid CPS.DoubleLambdaLifting2_interpretation_Tm_arrow_d5645af19d1ecd5b36775cd2e76d55c5))

:named CPS.DoubleLambdaLifting2_interpretation_Tm_arrow_d5645af19d1ecd5b36775cd2e76d55c5))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_8928427c3e013c0cd8946aaaf1c65a29
;;; Fact-ids: Name CPS.DoubleLambdaLifting2.eval_cps1; Namespace CPS.DoubleLambdaLifting2
(assert (! 
;; def=CPS.DoubleLambdaLifting2.fst(20,17-20,30); use=CPS.DoubleLambdaLifting2.fst(20,28-21,13)
(forall ((@x0 Term) (@x1 Term))
...
:pattern ((ApplyTT @x0
@x2))
:qid CPS.DoubleLambdaLifting2_interpretation_Tm_arrow_8928427c3e013c0cd8946aaaf1c65a29.1))
...
:pattern ((HasTypeZ @x0
(Tm_arrow_8928427c3e013c0cd8946aaaf1c65a29 @x1)))
:qid CPS.DoubleLambdaLifting2_interpretation_Tm_arrow_8928427c3e013c0cd8946aaaf1c65a29))

:named CPS.DoubleLambdaLifting2_interpretation_Tm_arrow_8928427c3e013c0cd8946aaaf1c65a29))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_7c2ea5fcdb21592dad73952e67ded474
;;; Fact-ids: Name CPS.DoubleLambdaLifting2.eval_cps2; Namespace CPS.DoubleLambdaLifting2
(assert (! 
;; def=CPS.DoubleLambdaLifting2.fst(23,28-23,40); use=CPS.DoubleLambdaLifting2.fst(23,48-24,13)
(forall ((@x0 Term) (@x1 Term))
...
:pattern ((ApplyTT @x0
@x2))
:qid CPS.DoubleLambdaLifting2_interpretation_Tm_arrow_7c2ea5fcdb21592dad73952e67ded474.1))
...
:pattern ((HasTypeZ @x0
(Tm_arrow_7c2ea5fcdb21592dad73952e67ded474 @x1)))
:qid CPS.DoubleLambdaLifting2_interpretation_Tm_arrow_7c2ea5fcdb21592dad73952e67ded474))

:named CPS.DoubleLambdaLifting2_interpretation_Tm_arrow_7c2ea5fcdb21592dad73952e67ded474))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_513b25dbd891c49fba5fe6949c4e594a
;;; Fact-ids: Name CPS.DoubleLambdaLifting2.eval_cps1; Namespace CPS.DoubleLambdaLifting2
(assert (! 
;; def=CPS.DoubleLambdaLifting2.fst(20,17-20,45); use=CPS.DoubleLambdaLifting2.fst(20,28-21,13)
(forall ((@x0 Term))
...
@x3)
@x4))
:qid CPS.DoubleLambdaLifting2_interpretation_Tm_arrow_513b25dbd891c49fba5fe6949c4e594a.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid CPS.DoubleLambdaLifting2_interpretation_Tm_arrow_513b25dbd891c49fba5fe6949c4e594a.2))
...
@x1)
@x2))
:qid CPS.DoubleLambdaLifting2_interpretation_Tm_arrow_513b25dbd891c49fba5fe6949c4e594a.3))
...
@x2)
@x3))
:qid CPS.DoubleLambdaLifting2_interpretation_Tm_arrow_513b25dbd891c49fba5fe6949c4e594a.4))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_513b25dbd891c49fba5fe6949c4e594a))
:qid CPS.DoubleLambdaLifting2_interpretation_Tm_arrow_513b25dbd891c49fba5fe6949c4e594a))

:named CPS.DoubleLambdaLifting2_interpretation_Tm_arrow_513b25dbd891c49fba5fe6949c4e594a))
;;;;;;;;;;;;;;;;kick_partial_app
;;; Fact-ids: Name CPS.DoubleLambdaLifting2.eval_cps2; Namespace CPS.DoubleLambdaLifting2
(assert (! (Valid (ApplyTT __uu__PartialApp
CPS.DoubleLambdaLifting2.eval_cps1@tok))
:named @kick_partial_app_c5dd61dbbedf800be52288c49cef8a9d))
(push) ;; push{2

; Starting query at CPS.DoubleLambdaLifting2.fst(28,2-30,59)
...
;;;;;;;;;;;;;;;;e : CPS.Expr.expr (CPS.Expr.expr)
(declare-fun x_0c607185f6c6768f1786fe5f14f15ea1_2 () Term)
;;;;;;;;;;;;;;;;binder_x_0c607185f6c6768f1786fe5f14f15ea1_2
;;; Fact-ids: 
(assert (! (HasType x_0c607185f6c6768f1786fe5f14f15ea1_2
CPS.Expr.expr)
:named binder_x_0c607185f6c6768f1786fe5f14f15ea1_2))
;;;;;;;;;;;;;;;;k : _: Prims.int -> 'a (_: Prims.int -> 'a)
(declare-fun x_8fdc248e81e60966d6c1eb4d02aa7c33_3 () Term)
;;;;;;;;;;;;;;;;_: Prims.int -> 'a
(declare-fun Tm_arrow_094ce55a57888abb184d0bc2fc7e0d5b () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_094ce55a57888abb184d0bc2fc7e0d5b
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_094ce55a57888abb184d0bc2fc7e0d5b
Tm_type)
:named kinding_Tm_arrow_094ce55a57888abb184d0bc2fc7e0d5b))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=CPS.DoubleLambdaLifting2.fst(26,24-27,18); use=CPS.DoubleLambdaLifting2.fst(27,8-27,18)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_094ce55a57888abb184d0bc2fc7e0d5b)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_094ce55a57888abb184d0bc2fc7e0d5b))
:qid CPS.DoubleLambdaLifting2_pre_typing_Tm_arrow_094ce55a57888abb184d0bc2fc7e0d5b))

:named CPS.DoubleLambdaLifting2_pre_typing_Tm_arrow_094ce55a57888abb184d0bc2fc7e0d5b))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_094ce55a57888abb184d0bc2fc7e0d5b
;;; Fact-ids: 
(assert (! 
;; def=CPS.DoubleLambdaLifting2.fst(26,24-27,18); use=CPS.DoubleLambdaLifting2.fst(27,8-27,18)
(forall ((@x0 Term))
...
:pattern ((ApplyTT @x0
@x1))
:qid CPS.DoubleLambdaLifting2_interpretation_Tm_arrow_094ce55a57888abb184d0bc2fc7e0d5b.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_094ce55a57888abb184d0bc2fc7e0d5b))
:qid CPS.DoubleLambdaLifting2_interpretation_Tm_arrow_094ce55a57888abb184d0bc2fc7e0d5b))

:named CPS.DoubleLambdaLifting2_interpretation_Tm_arrow_094ce55a57888abb184d0bc2fc7e0d5b))
;;;;;;;;;;;;;;;;binder_x_8fdc248e81e60966d6c1eb4d02aa7c33_3
;;; Fact-ids: 
(assert (! (HasType x_8fdc248e81e60966d6c1eb4d02aa7c33_3
Tm_arrow_094ce55a57888abb184d0bc2fc7e0d5b)
:named binder_x_8fdc248e81e60966d6c1eb4d02aa7c33_3))

(declare-fun Tm_refine_c802f600988d9f78e8de9da3f529988e (Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=CPS.DoubleLambdaLifting2.fst(28,2-30,59); use=CPS.DoubleLambdaLifting2.fst(28,2-30,59)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_refine_c802f600988d9f78e8de9da3f529988e @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_refine_c802f600988d9f78e8de9da3f529988e @x0
@x1)
Tm_type))
:qid refinement_kinding_Tm_refine_c802f600988d9f78e8de9da3f529988e))

:named refinement_kinding_Tm_refine_c802f600988d9f78e8de9da3f529988e))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=CPS.DoubleLambdaLifting2.fst(28,2-30,59); use=CPS.DoubleLambdaLifting2.fst(28,2-30,59)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_c802f600988d9f78e8de9da3f529988e @x2
@x3))
(and (HasTypeFuel @u0
@x1
(Tm_arrow_8928427c3e013c0cd8946aaaf1c65a29 @x2))
...
(Valid 
;; def=CPS.DoubleLambdaLifting2.fst(28,2-30,59); use=CPS.DoubleLambdaLifting2.fst(28,2-30,59)
(Prims.precedes CPS.Expr.expr
CPS.Expr.expr
@x3
x_0c607185f6c6768f1786fe5f14f15ea1_2)
)
...
(Tm_refine_c802f600988d9f78e8de9da3f529988e @x2
@x3)))
:qid refinement_interpretation_Tm_refine_c802f600988d9f78e8de9da3f529988e))

:named refinement_interpretation_Tm_refine_c802f600988d9f78e8de9da3f529988e))
;;;;;;;;;;;;;;;;haseq for Tm_refine_c802f600988d9f78e8de9da3f529988e
;;; Fact-ids: 
(assert (! 
;; def=CPS.DoubleLambdaLifting2.fst(28,2-30,59); use=CPS.DoubleLambdaLifting2.fst(28,2-30,59)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_c802f600988d9f78e8de9da3f529988e @x0
@x1)))
(Valid (Prims.hasEq (Tm_arrow_8928427c3e013c0cd8946aaaf1c65a29 @x0))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_c802f600988d9f78e8de9da3f529988e @x0
@x1))))
:qid haseqTm_refine_c802f600988d9f78e8de9da3f529988e))

:named haseqTm_refine_c802f600988d9f78e8de9da3f529988e))
(declare-fun CPS.DoubleLambdaLifting2.eval_cps (Term Term Term) Term)


;;;;;;;;;;;;;;;;_: CPS.Expr.expr -> _: _: (_: Prims.int -> 'a){_ << e} -> 'a
(declare-fun Tm_arrow_9b87ac5a667915e6477fb9b502b83c0c () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_9b87ac5a667915e6477fb9b502b83c0c
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_9b87ac5a667915e6477fb9b502b83c0c
Tm_type)
:named kinding_Tm_arrow_9b87ac5a667915e6477fb9b502b83c0c))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=CPS.DoubleLambdaLifting2.fst(26,15-30,59); use=CPS.DoubleLambdaLifting2.fst(26,46-30,59)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_9b87ac5a667915e6477fb9b502b83c0c)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_9b87ac5a667915e6477fb9b502b83c0c))
:qid CPS.DoubleLambdaLifting2_pre_typing_Tm_arrow_9b87ac5a667915e6477fb9b502b83c0c))

:named CPS.DoubleLambdaLifting2_pre_typing_Tm_arrow_9b87ac5a667915e6477fb9b502b83c0c))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_9b87ac5a667915e6477fb9b502b83c0c
;;; Fact-ids: 
(assert (! 
;; def=CPS.DoubleLambdaLifting2.fst(26,15-30,59); use=CPS.DoubleLambdaLifting2.fst(26,46-30,59)
(forall ((@x0 Term))
...
CPS.Expr.expr)
(HasType @x3
(Tm_refine_c802f600988d9f78e8de9da3f529988e @x1
@x2)))
...
@x2)
@x3))
:qid CPS.DoubleLambdaLifting2_interpretation_Tm_arrow_9b87ac5a667915e6477fb9b502b83c0c.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid CPS.DoubleLambdaLifting2_interpretation_Tm_arrow_9b87ac5a667915e6477fb9b502b83c0c.2))
...
@x1)
@x2))
:qid CPS.DoubleLambdaLifting2_interpretation_Tm_arrow_9b87ac5a667915e6477fb9b502b83c0c.3))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_9b87ac5a667915e6477fb9b502b83c0c))
:qid CPS.DoubleLambdaLifting2_interpretation_Tm_arrow_9b87ac5a667915e6477fb9b502b83c0c))

:named CPS.DoubleLambdaLifting2_interpretation_Tm_arrow_9b87ac5a667915e6477fb9b502b83c0c))
(declare-fun CPS.DoubleLambdaLifting2.eval_cps@tok () Term)
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: 
(assert (! 
;; def=CPS.DoubleLambdaLifting2.fst(27,8-27,16); use=CPS.DoubleLambdaLifting2.fst(27,8-27,16)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (ApplyTT (ApplyTT (ApplyTT CPS.DoubleLambdaLifting2.eval_cps@tok
@x0)
@x1)
@x2)
(CPS.DoubleLambdaLifting2.eval_cps @x0
@x1
@x2))
 

:pattern ((ApplyTT (ApplyTT (ApplyTT CPS.DoubleLambdaLifting2.eval_cps@tok
@x0)
@x1)
@x2))
:qid token_correspondence_CPS.DoubleLambdaLifting2.eval_cps))

:named token_correspondence_CPS.DoubleLambdaLifting2.eval_cps))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: 
(assert (! 
;; def=CPS.DoubleLambdaLifting2.fst(27,8-27,16); use=CPS.DoubleLambdaLifting2.fst(27,8-27,16)
(forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType CPS.DoubleLambdaLifting2.eval_cps@tok
Tm_arrow_9b87ac5a667915e6477fb9b502b83c0c))
...
@x2)
@x3)
(CPS.DoubleLambdaLifting2.eval_cps @x1
@x2
@x3))
 

:pattern ((CPS.DoubleLambdaLifting2.eval_cps @x1
@x2
@x3))
:qid function_token_typing_CPS.DoubleLambdaLifting2.eval_cps.1))
)
 

:pattern ((ApplyTT @x0
CPS.DoubleLambdaLifting2.eval_cps@tok))
:qid function_token_typing_CPS.DoubleLambdaLifting2.eval_cps))

:named function_token_typing_CPS.DoubleLambdaLifting2.eval_cps))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: 
(assert (! 
;; def=CPS.DoubleLambdaLifting2.fst(27,8-27,16); use=CPS.DoubleLambdaLifting2.fst(27,8-27,16)
...
CPS.Expr.expr)
(HasType @x2
(Tm_refine_c802f600988d9f78e8de9da3f529988e @x0
@x1)))
(HasType (CPS.DoubleLambdaLifting2.eval_cps @x0
@x1
@x2)
@x0))
 

:pattern ((CPS.DoubleLambdaLifting2.eval_cps @x0
@x1
@x2))
:qid typing_CPS.DoubleLambdaLifting2.eval_cps))

:named typing_CPS.DoubleLambdaLifting2.eval_cps))
...
;;;;;;;;;;;;;;;;_: (_: Prims.int -> 'a) -> 'a
(declare-fun Tm_arrow_75240132627e6ac3d0bc8f890b3b3eed () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_75240132627e6ac3d0bc8f890b3b3eed
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_75240132627e6ac3d0bc8f890b3b3eed
Tm_type)
:named kinding_Tm_arrow_75240132627e6ac3d0bc8f890b3b3eed))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=CPS.DoubleLambdaLifting2.fst(23,37-27,18); use=CPS.DoubleLambdaLifting2.fst(27,17-30,42)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_75240132627e6ac3d0bc8f890b3b3eed)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_75240132627e6ac3d0bc8f890b3b3eed))
:qid CPS.DoubleLambdaLifting2_pre_typing_Tm_arrow_75240132627e6ac3d0bc8f890b3b3eed))

:named CPS.DoubleLambdaLifting2_pre_typing_Tm_arrow_75240132627e6ac3d0bc8f890b3b3eed))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_75240132627e6ac3d0bc8f890b3b3eed
;;; Fact-ids: 
(assert (! 
;; def=CPS.DoubleLambdaLifting2.fst(23,37-27,18); use=CPS.DoubleLambdaLifting2.fst(27,17-30,42)
(forall ((@x0 Term))
...
:pattern ((ApplyTT @x0
@x1))
:qid CPS.DoubleLambdaLifting2_interpretation_Tm_arrow_75240132627e6ac3d0bc8f890b3b3eed.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_75240132627e6ac3d0bc8f890b3b3eed))
:qid CPS.DoubleLambdaLifting2_interpretation_Tm_arrow_75240132627e6ac3d0bc8f890b3b3eed))

:named CPS.DoubleLambdaLifting2_interpretation_Tm_arrow_75240132627e6ac3d0bc8f890b3b3eed))

;;;;;;;;;;;;;;;;kick_partial_app
;;; Fact-ids: 
(assert (! (Valid (ApplyTT __uu__PartialApp
CPS.DoubleLambdaLifting2.eval_cps@tok))
:named @kick_partial_app_a3c27a3552b09c646087d11d827218f2))
;;;;;;;;;;;;;;;;kick_partial_app
;;; Fact-ids: 
(assert (! (Valid (ApplyTT __uu__PartialApp
CPS.DoubleLambdaLifting2.eval_cps2@tok))
:named @kick_partial_app_02ccdc039d3bb8a5c2fd45d5a4b7d170))


; Encoding query formula : forall (k: Prims.pure_post 'a).
;   (forall (x: 'a). {:pattern Prims.guard_free (k x)} Prims.auto_squash (k x)) ==>
;   (~(Const? e) /\ ~(Plus? e) ==> Prims.l_False) /\
;   (~(Const? e) ==>
;     (forall (b: CPS.Expr.expr) (b: CPS.Expr.expr).
;         e == CPS.Expr.Plus b b ==>
;         (forall (_: (_: Prims.int -> 'a)).
;             (*  - Could not prove termination of this recursive call
; *) b << e) /\
;         (forall (return_val: (_: (_: Prims.int -> 'a) -> 'a)).
;             return_val == CPS.DoubleLambdaLifting2.eval_cps b ==>
;             (forall (any_result: (r1: Prims.int -> 'a)).
;                 CPS.DoubleLambdaLifting2.eval_cps2 k (CPS.DoubleLambdaLifting2.eval_cps b) ==
;                 any_result ==>
;                 b << e))))


; Context: While encoding a query
; While typechecking the top-level declaration `let rec eval_cps`
...
;; def=Prims.fst(402,27-402,88); use=CPS.DoubleLambdaLifting2.fst(28,2-30,59)
(forall ((@x1 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=CPS.DoubleLambdaLifting2.fst(28,2-30,59)
(Valid 
;; def=Prims.fst(402,84-402,87); use=CPS.DoubleLambdaLifting2.fst(28,2-30,59)
(ApplyTT @x0
@x1)
...
;; def=Prims.fst(459,77-459,89); use=CPS.DoubleLambdaLifting2.fst(28,2-30,59)
(and (implies 
;; def=CPS.DoubleLambdaLifting2.fst(27,17-27,18); use=CPS.DoubleLambdaLifting2.fst(28,8-28,9)
(and 
;; def=CPS.DoubleLambdaLifting2.fst(27,17-27,18); use=CPS.DoubleLambdaLifting2.fst(28,8-28,9)
(not 
;; def=CPS.DoubleLambdaLifting2.fst(27,17-27,18); use=CPS.DoubleLambdaLifting2.fst(28,8-28,9)
(BoxBool_proj_0 (CPS.Expr.uu___is_Const x_0c607185f6c6768f1786fe5f14f15ea1_2))
)
...
(not 
;; def=CPS.DoubleLambdaLifting2.fst(27,17-27,18); use=CPS.DoubleLambdaLifting2.fst(28,8-28,9)
(BoxBool_proj_0 (CPS.Expr.uu___is_Plus x_0c607185f6c6768f1786fe5f14f15ea1_2))
)
)

label_1)
(implies 
;; def=Prims.fst(389,19-389,21); use=CPS.DoubleLambdaLifting2.fst(28,2-30,59)
(not 
;; def=CPS.DoubleLambdaLifting2.fst(27,17-27,18); use=CPS.DoubleLambdaLifting2.fst(28,8-28,9)
(BoxBool_proj_0 (CPS.Expr.uu___is_Const x_0c607185f6c6768f1786fe5f14f15ea1_2))
)
...
;; def=Prims.fst(413,99-413,120); use=CPS.DoubleLambdaLifting2.fst(28,2-30,59)
(forall ((@x1 Term))
 (! (implies (HasType @x1
CPS.Expr.expr)
...
;; def=CPS.DoubleLambdaLifting2.fst(27,17-30,16); use=CPS.DoubleLambdaLifting2.fst(28,8-30,16)
(= x_0c607185f6c6768f1786fe5f14f15ea1_2
(CPS.Expr.Plus @x1
@x2))
)
...
;; def=Prims.fst(459,77-459,89); use=CPS.DoubleLambdaLifting2.fst(28,2-30,59)
(and 
;; def=dummy(0,0-0,0); use=CPS.DoubleLambdaLifting2.fst(30,45-30,58)
(forall ((@x3 Term))
 (! (implies (HasType @x3
Tm_arrow_094ce55a57888abb184d0bc2fc7e0d5b)

;; def=CPS.DoubleLambdaLifting2.fst(28,2-30,59); use=CPS.DoubleLambdaLifting2.fst(30,45-30,58)
(or label_2
...
;; def=Prims.fst(356,2-356,58); use=CPS.DoubleLambdaLifting2.fst(28,2-30,59)
(forall ((@x3 Term))
 (! (implies (and (HasType @x3
Tm_arrow_75240132627e6ac3d0bc8f890b3b3eed)

;; def=Prims.fst(356,26-356,41); use=CPS.DoubleLambdaLifting2.fst(28,2-30,59)
(= @x3
(ApplyTT (ApplyTT CPS.DoubleLambdaLifting2.eval_cps@tok
x_fe28d8bcde588226b4e538b35321de05_1)
@x2))
)

;; def=Prims.fst(451,66-451,102); use=CPS.DoubleLambdaLifting2.fst(28,2-30,59)
(forall ((@x4 Term))
 (! (implies (and (HasType @x4
Tm_arrow_094ce55a57888abb184d0bc2fc7e0d5b)

;; def=CPS.DoubleLambdaLifting2.fst(28,2-30,59); use=CPS.DoubleLambdaLifting2.fst(28,2-30,59)
(= (ApplyTT (ApplyTT (ApplyTT CPS.DoubleLambdaLifting2.eval_cps2@tok
x_fe28d8bcde588226b4e538b35321de05_1)
x_8fdc248e81e60966d6c1eb4d02aa7c33_3)
(ApplyTT (ApplyTT CPS.DoubleLambdaLifting2.eval_cps@tok
x_fe28d8bcde588226b4e538b35321de05_1)
@x2))
@x4)
...
;; def=CPS.DoubleLambdaLifting2.fst(28,2-30,59); use=CPS.DoubleLambdaLifting2.fst(30,32-30,59)
(or label_3
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (CPS.DoubleLambdaLifting2.eval_cps, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, CPS.Expr_pretyping_0c607185f6c6768f1786fe5f14f15ea1, binder_x_0c607185f6c6768f1786fe5f14f15ea1_2, disc_equation_CPS.Expr.Const, disc_equation_CPS.Expr.Plus, fuel_guarded_inversion_CPS.Expr.expr, projection_inverse_BoxBool_proj_0, projection_inverse_CPS.Expr.Plus__0, projection_inverse_CPS.Expr.Plus__1, subterm_ordering_CPS.Expr.Plus
