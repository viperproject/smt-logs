...
; Starting query at ErrorMsg.fst(20,2-22,32)
...
(declare-fun Tm_refine_ceceaa5ce6f27824b446b8bfbfd65fb1 () Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! (HasType Tm_refine_ceceaa5ce6f27824b446b8bfbfd65fb1
Tm_type)
:named refinement_kinding_Tm_refine_ceceaa5ce6f27824b446b8bfbfd65fb1))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=ErrorMsg.fst(19,19-22,32); use=ErrorMsg.fst(19,19-22,32)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_ceceaa5ce6f27824b446b8bfbfd65fb1)
(and (HasTypeFuel @u0
@x1
Prims.nat)

;; def=ErrorMsg.fst(20,2-22,32); use=ErrorMsg.fst(20,2-22,32)
...
@x1
Tm_refine_ceceaa5ce6f27824b446b8bfbfd65fb1))
:qid refinement_interpretation_Tm_refine_ceceaa5ce6f27824b446b8bfbfd65fb1))

:named refinement_interpretation_Tm_refine_ceceaa5ce6f27824b446b8bfbfd65fb1))
;;;;;;;;;;;;;;;;haseq for Tm_refine_ceceaa5ce6f27824b446b8bfbfd65fb1
;;; Fact-ids: 
(assert (! (iff (Valid (Prims.hasEq Tm_refine_ceceaa5ce6f27824b446b8bfbfd65fb1))
(Valid (Prims.hasEq Prims.nat)))
:named haseqTm_refine_ceceaa5ce6f27824b446b8bfbfd65fb1))
(declare-fun ErrorMsg.factorial (Term) Term)

;;;;;;;;;;;;;;;;x: Prims.nat{x << x} -> Prims.nat
(declare-fun Tm_arrow_d091ee49be39cfee363f11ef3fdfc829 () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_d091ee49be39cfee363f11ef3fdfc829
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_d091ee49be39cfee363f11ef3fdfc829
Tm_type)
:named kinding_Tm_arrow_d091ee49be39cfee363f11ef3fdfc829))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=ErrorMsg.fst(19,19-22,32); use=ErrorMsg.fst(19,19-22,32)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_d091ee49be39cfee363f11ef3fdfc829)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_d091ee49be39cfee363f11ef3fdfc829))
:qid ErrorMsg_pre_typing_Tm_arrow_d091ee49be39cfee363f11ef3fdfc829))

:named ErrorMsg_pre_typing_Tm_arrow_d091ee49be39cfee363f11ef3fdfc829))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_d091ee49be39cfee363f11ef3fdfc829
;;; Fact-ids: 
(assert (! 
;; def=ErrorMsg.fst(19,19-22,32); use=ErrorMsg.fst(19,19-22,32)
(forall ((@x0 Term))
...
:pattern ((ApplyTT @x0
@x1))
:qid ErrorMsg_interpretation_Tm_arrow_d091ee49be39cfee363f11ef3fdfc829.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_d091ee49be39cfee363f11ef3fdfc829))
:qid ErrorMsg_interpretation_Tm_arrow_d091ee49be39cfee363f11ef3fdfc829))

:named ErrorMsg_interpretation_Tm_arrow_d091ee49be39cfee363f11ef3fdfc829))
(declare-fun ErrorMsg.factorial@tok () Term)
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: 
(assert (! 
;; def=ErrorMsg.fst(19,8-19,17); use=ErrorMsg.fst(19,8-19,17)
(forall ((@x0 Term))
 (! (= (ApplyTT ErrorMsg.factorial@tok
@x0)
(ErrorMsg.factorial @x0))
 

:pattern ((ApplyTT ErrorMsg.factorial@tok
@x0))
:qid token_correspondence_ErrorMsg.factorial))

:named token_correspondence_ErrorMsg.factorial))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: 
(assert (! 
;; def=ErrorMsg.fst(19,8-19,17); use=ErrorMsg.fst(19,8-19,17)
(forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType ErrorMsg.factorial@tok
Tm_arrow_d091ee49be39cfee363f11ef3fdfc829))
...
(forall ((@x1 Term))
 (! (= (ApplyTT ErrorMsg.factorial@tok
@x1)
(ErrorMsg.factorial @x1))
 

:pattern ((ErrorMsg.factorial @x1))
:qid function_token_typing_ErrorMsg.factorial.1))
)
 

:pattern ((ApplyTT @x0
ErrorMsg.factorial@tok))
:qid function_token_typing_ErrorMsg.factorial))

:named function_token_typing_ErrorMsg.factorial))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: 
(assert (! 
;; def=ErrorMsg.fst(19,8-19,17); use=ErrorMsg.fst(19,8-19,17)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_refine_ceceaa5ce6f27824b446b8bfbfd65fb1)
(HasType (ErrorMsg.factorial @x0)
Prims.nat))
 

:pattern ((ErrorMsg.factorial @x0))
:qid typing_ErrorMsg.factorial))

:named typing_ErrorMsg.factorial))
...
;               ErrorMsg.factorial (x - 1) == any_result ==>
;               (forall (return_val: Prims.nat).
;                   return_val == ErrorMsg.factorial (x - 1) ==>
;                   ErrorMsg.factorial (x - 1) == return_val ==>
;                   (forall (any_result: Prims.int).
;                       x + ErrorMsg.factorial (x - 1) == any_result ==>
;                       x + ErrorMsg.factorial (x - 1) >= 0)))))
...
;; def=Prims.fst(402,27-402,88); use=ErrorMsg.fst(20,2-22,32)
(forall ((@x1 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=ErrorMsg.fst(20,2-22,32)
(Valid 
;; def=Prims.fst(402,84-402,87); use=ErrorMsg.fst(20,2-22,32)
(ApplyTT @x0
@x1)
...
;; def=Prims.fst(389,19-389,21); use=ErrorMsg.fst(20,2-22,32)
(not 
;; def=ErrorMsg.fst(19,19-21,7); use=ErrorMsg.fst(20,8-21,7)
(= x_bb4e1c9af0265270f8e7a5f250f730e2_0
(BoxInt 0))
)
)

;; def=Prims.fst(413,99-413,120); use=ErrorMsg.fst(20,2-22,32)
(forall ((@x1 Term))
 (! (implies (and (HasType @x1
Prims.int)

;; def=ErrorMsg.fst(19,19-22,7); use=ErrorMsg.fst(20,8-22,7)
(= x_bb4e1c9af0265270f8e7a5f250f730e2_0
@x1)
)

;; def=Prims.fst(459,77-459,89); use=ErrorMsg.fst(20,2-22,32)
(and 
;; def=Prims.fst(680,18-680,24); use=ErrorMsg.fst(22,25-22,32)
(or label_1
...
;; def=ErrorMsg.fst(20,2-22,32); use=ErrorMsg.fst(22,25-22,32)
(or label_2
...
;; def=Prims.fst(356,2-356,58); use=ErrorMsg.fst(20,2-22,32)
(forall ((@x2 Term))
 (! (implies (and (HasType @x2
Tm_refine_ceceaa5ce6f27824b446b8bfbfd65fb1)

;; def=Prims.fst(356,26-356,41); use=ErrorMsg.fst(20,2-22,32)
(= @x2
(Prims.op_Subtraction x_bb4e1c9af0265270f8e7a5f250f730e2_0
(BoxInt 1)))
)

;; def=Prims.fst(451,66-451,102); use=ErrorMsg.fst(20,2-22,32)
(forall ((@x3 Term))
 (! (implies (and (HasType @x3
Prims.nat)

;; def=ErrorMsg.fst(19,28-22,32); use=ErrorMsg.fst(22,15-22,32)
(= (ErrorMsg.factorial (Prims.op_Subtraction x_bb4e1c9af0265270f8e7a5f250f730e2_0
(BoxInt 1)))
@x3)
)
...
;; def=dummy(0,0-0,0); use=ErrorMsg.fst(20,2-22,32)
(= (ErrorMsg.factorial (Prims.op_Subtraction x_bb4e1c9af0265270f8e7a5f250f730e2_0
(BoxInt 1)))
@x4)
)
...
;; def=ErrorMsg.fst(19,28-22,32); use=ErrorMsg.fst(20,2-22,32)
...
;; def=Prims.fst(680,18-680,24); use=ErrorMsg.fst(22,11-22,32)
(or label_3
...
;;;;;;;;;;;;;;;;Fuel-instrumented function name
(declare-fun ErrorMsg.factorial.fuel_instrumented (Fuel Term) Term)
;;;;;;;;;;;;;;;;Token for fuel-instrumented partial applications
(declare-fun ErrorMsg.factorial.fuel_instrumented_token () Term)
(declare-fun ErrorMsg.factorial (Term) Term)
(declare-fun ErrorMsg.factorial@tok () Term)
;;;;;;;;;;;;;;;;x: Prims.nat -> Prims.nat
...
; Starting query at ErrorMsg.fst(27,2-29,33)
...
Prims.nat)
:named binder_x_bb4e1c9af0265270f8e7a5f250f730e2_0))
(declare-fun Tm_refine_03b1fb074af4099d037cea42abfe69b0 () Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! (HasType Tm_refine_03b1fb074af4099d037cea42abfe69b0
Tm_type)
:named refinement_kinding_Tm_refine_03b1fb074af4099d037cea42abfe69b0))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=ErrorMsg.fst(26,20-29,33); use=ErrorMsg.fst(26,20-29,33)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_03b1fb074af4099d037cea42abfe69b0)
(and (HasTypeFuel @u0
@x1
Prims.nat)

;; def=ErrorMsg.fst(27,2-29,33); use=ErrorMsg.fst(27,2-29,33)
...
@x1
Tm_refine_03b1fb074af4099d037cea42abfe69b0))
:qid refinement_interpretation_Tm_refine_03b1fb074af4099d037cea42abfe69b0))

:named refinement_interpretation_Tm_refine_03b1fb074af4099d037cea42abfe69b0))
;;;;;;;;;;;;;;;;haseq for Tm_refine_03b1fb074af4099d037cea42abfe69b0
;;; Fact-ids: 
(assert (! (iff (Valid (Prims.hasEq Tm_refine_03b1fb074af4099d037cea42abfe69b0))
(Valid (Prims.hasEq Prims.nat)))
:named haseqTm_refine_03b1fb074af4099d037cea42abfe69b0))
(declare-fun ErrorMsg.factorial2 (Term) Term)

;;;;;;;;;;;;;;;;x: Prims.nat{x << x} -> Prims.nat
(declare-fun Tm_arrow_bfb07a302416aac7be9fec770068dfaf () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_bfb07a302416aac7be9fec770068dfaf
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_bfb07a302416aac7be9fec770068dfaf
Tm_type)
:named kinding_Tm_arrow_bfb07a302416aac7be9fec770068dfaf))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=ErrorMsg.fst(26,20-29,33); use=ErrorMsg.fst(26,20-29,33)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_bfb07a302416aac7be9fec770068dfaf)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_bfb07a302416aac7be9fec770068dfaf))
:qid ErrorMsg_pre_typing_Tm_arrow_bfb07a302416aac7be9fec770068dfaf))

:named ErrorMsg_pre_typing_Tm_arrow_bfb07a302416aac7be9fec770068dfaf))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_bfb07a302416aac7be9fec770068dfaf
;;; Fact-ids: 
(assert (! 
;; def=ErrorMsg.fst(26,20-29,33); use=ErrorMsg.fst(26,20-29,33)
(forall ((@x0 Term))
...
:pattern ((ApplyTT @x0
@x1))
:qid ErrorMsg_interpretation_Tm_arrow_bfb07a302416aac7be9fec770068dfaf.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_bfb07a302416aac7be9fec770068dfaf))
:qid ErrorMsg_interpretation_Tm_arrow_bfb07a302416aac7be9fec770068dfaf))

:named ErrorMsg_interpretation_Tm_arrow_bfb07a302416aac7be9fec770068dfaf))
(declare-fun ErrorMsg.factorial2@tok () Term)
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: 
(assert (! 
;; def=ErrorMsg.fst(26,8-26,18); use=ErrorMsg.fst(26,8-26,18)
(forall ((@x0 Term))
 (! (= (ApplyTT ErrorMsg.factorial2@tok
@x0)
(ErrorMsg.factorial2 @x0))
 

:pattern ((ApplyTT ErrorMsg.factorial2@tok
@x0))
:qid token_correspondence_ErrorMsg.factorial2))

:named token_correspondence_ErrorMsg.factorial2))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: 
(assert (! 
;; def=ErrorMsg.fst(26,8-26,18); use=ErrorMsg.fst(26,8-26,18)
(forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType ErrorMsg.factorial2@tok
Tm_arrow_bfb07a302416aac7be9fec770068dfaf))
...
(forall ((@x1 Term))
 (! (= (ApplyTT ErrorMsg.factorial2@tok
@x1)
(ErrorMsg.factorial2 @x1))
 

:pattern ((ErrorMsg.factorial2 @x1))
:qid function_token_typing_ErrorMsg.factorial2.1))
)
 

:pattern ((ApplyTT @x0
ErrorMsg.factorial2@tok))
:qid function_token_typing_ErrorMsg.factorial2))

:named function_token_typing_ErrorMsg.factorial2))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: 
(assert (! 
;; def=ErrorMsg.fst(26,8-26,18); use=ErrorMsg.fst(26,8-26,18)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_refine_03b1fb074af4099d037cea42abfe69b0)
(HasType (ErrorMsg.factorial2 @x0)
Prims.nat))
 

:pattern ((ErrorMsg.factorial2 @x0))
:qid typing_ErrorMsg.factorial2))

:named typing_ErrorMsg.factorial2))
(declare-fun label_3 () Bool)
(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)
...
;           return_val == x - 2 ==>
;           (forall (any_result: Prims.nat).
;               ErrorMsg.factorial2 (x - 2) == any_result ==>
;               (forall (return_val: Prims.nat).
;                   return_val == ErrorMsg.factorial2 (x - 2) ==>
;                   ErrorMsg.factorial2 (x - 2) == return_val ==>
;                   (forall (any_result: Prims.int).
;                       x + ErrorMsg.factorial2 (x - 2) == any_result ==>
;                       x + ErrorMsg.factorial2 (x - 2) >= 0)))))


; Context: While encoding a query
; While typechecking the top-level declaration `let rec factorial2`
; While typechecking the top-level declaration `[@@expect_failure] let rec factorial2`
...
;; def=Prims.fst(402,27-402,88); use=ErrorMsg.fst(27,2-29,33)
(forall ((@x1 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=ErrorMsg.fst(27,2-29,33)
(Valid 
;; def=Prims.fst(402,84-402,87); use=ErrorMsg.fst(27,2-29,33)
(ApplyTT @x0
@x1)
...
;; def=Prims.fst(389,19-389,21); use=ErrorMsg.fst(27,2-29,33)
(not 
;; def=ErrorMsg.fst(26,20-28,7); use=ErrorMsg.fst(27,8-28,7)
(= x_bb4e1c9af0265270f8e7a5f250f730e2_0
(BoxInt 0))
)
)

;; def=Prims.fst(413,99-413,120); use=ErrorMsg.fst(27,2-29,33)
(forall ((@x1 Term))
 (! (implies (and (HasType @x1
Prims.int)

;; def=ErrorMsg.fst(26,20-29,7); use=ErrorMsg.fst(27,8-29,7)
(= x_bb4e1c9af0265270f8e7a5f250f730e2_0
@x1)
)

;; def=Prims.fst(459,77-459,89); use=ErrorMsg.fst(27,2-29,33)
(and 
;; def=Prims.fst(680,18-680,24); use=ErrorMsg.fst(29,26-29,33)
(or label_1
...
;; def=ErrorMsg.fst(27,2-29,33); use=ErrorMsg.fst(29,26-29,33)
(or label_2
...
;; def=Prims.fst(356,2-356,58); use=ErrorMsg.fst(27,2-29,33)
(forall ((@x2 Term))
 (! (implies (and (HasType @x2
Tm_refine_03b1fb074af4099d037cea42abfe69b0)

;; def=Prims.fst(356,26-356,41); use=ErrorMsg.fst(27,2-29,33)
(= @x2
(Prims.op_Subtraction x_bb4e1c9af0265270f8e7a5f250f730e2_0
(BoxInt 2)))
)

;; def=Prims.fst(451,66-451,102); use=ErrorMsg.fst(27,2-29,33)
(forall ((@x3 Term))
 (! (implies (and (HasType @x3
Prims.nat)

;; def=ErrorMsg.fst(26,29-29,33); use=ErrorMsg.fst(29,15-29,33)
(= (ErrorMsg.factorial2 (Prims.op_Subtraction x_bb4e1c9af0265270f8e7a5f250f730e2_0
(BoxInt 2)))
@x3)
)
...
;; def=dummy(0,0-0,0); use=ErrorMsg.fst(27,2-29,33)
(= (ErrorMsg.factorial2 (Prims.op_Subtraction x_bb4e1c9af0265270f8e7a5f250f730e2_0
(BoxInt 2)))
@x4)
)
...
;; def=ErrorMsg.fst(26,29-29,33); use=ErrorMsg.fst(27,2-29,33)
(= (Prims.op_Addition x_bb4e1c9af0265270f8e7a5f250f730e2_0
(ErrorMsg.factorial2 (Prims.op_Subtraction x_bb4e1c9af0265270f8e7a5f250f730e2_0
(BoxInt 2))))
@x5)
...
;; def=Prims.fst(680,18-680,24); use=ErrorMsg.fst(29,11-29,33)
(or label_3
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (ErrorMsg.factorial2, 1)
...
; Starting query at ErrorMsg.fst(34,2-36,27)
...
Prims.nat)
:named binder_x_bb4e1c9af0265270f8e7a5f250f730e2_0))
(declare-fun Tm_refine_4f0bda47ec031c550913e32f2311cfc0 () Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! (HasType Tm_refine_4f0bda47ec031c550913e32f2311cfc0
Tm_type)
:named refinement_kinding_Tm_refine_4f0bda47ec031c550913e32f2311cfc0))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=ErrorMsg.fst(33,20-36,27); use=ErrorMsg.fst(33,20-36,27)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_4f0bda47ec031c550913e32f2311cfc0)
(and (HasTypeFuel @u0
@x1
Prims.nat)

;; def=ErrorMsg.fst(34,2-36,27); use=ErrorMsg.fst(34,2-36,27)
...
@x1
Tm_refine_4f0bda47ec031c550913e32f2311cfc0))
:qid refinement_interpretation_Tm_refine_4f0bda47ec031c550913e32f2311cfc0))

:named refinement_interpretation_Tm_refine_4f0bda47ec031c550913e32f2311cfc0))
;;;;;;;;;;;;;;;;haseq for Tm_refine_4f0bda47ec031c550913e32f2311cfc0
;;; Fact-ids: 
(assert (! (iff (Valid (Prims.hasEq Tm_refine_4f0bda47ec031c550913e32f2311cfc0))
(Valid (Prims.hasEq Prims.nat)))
:named haseqTm_refine_4f0bda47ec031c550913e32f2311cfc0))
(declare-fun ErrorMsg.factorial3 (Term) Term)

;;;;;;;;;;;;;;;;x: Prims.nat{x << x} -> Prims.nat
(declare-fun Tm_arrow_8bc85b72838e0900e8e5f9c7c000744c () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_8bc85b72838e0900e8e5f9c7c000744c
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_8bc85b72838e0900e8e5f9c7c000744c
Tm_type)
:named kinding_Tm_arrow_8bc85b72838e0900e8e5f9c7c000744c))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=ErrorMsg.fst(33,20-36,27); use=ErrorMsg.fst(33,20-36,27)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_8bc85b72838e0900e8e5f9c7c000744c)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_8bc85b72838e0900e8e5f9c7c000744c))
:qid ErrorMsg_pre_typing_Tm_arrow_8bc85b72838e0900e8e5f9c7c000744c))

:named ErrorMsg_pre_typing_Tm_arrow_8bc85b72838e0900e8e5f9c7c000744c))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_8bc85b72838e0900e8e5f9c7c000744c
;;; Fact-ids: 
(assert (! 
;; def=ErrorMsg.fst(33,20-36,27); use=ErrorMsg.fst(33,20-36,27)
(forall ((@x0 Term))
...
:pattern ((ApplyTT @x0
@x1))
:qid ErrorMsg_interpretation_Tm_arrow_8bc85b72838e0900e8e5f9c7c000744c.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_8bc85b72838e0900e8e5f9c7c000744c))
:qid ErrorMsg_interpretation_Tm_arrow_8bc85b72838e0900e8e5f9c7c000744c))

:named ErrorMsg_interpretation_Tm_arrow_8bc85b72838e0900e8e5f9c7c000744c))
(declare-fun ErrorMsg.factorial3@tok () Term)
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: 
(assert (! 
;; def=ErrorMsg.fst(33,8-33,18); use=ErrorMsg.fst(33,8-33,18)
(forall ((@x0 Term))
 (! (= (ApplyTT ErrorMsg.factorial3@tok
@x0)
(ErrorMsg.factorial3 @x0))
 

:pattern ((ApplyTT ErrorMsg.factorial3@tok
@x0))
:qid token_correspondence_ErrorMsg.factorial3))

:named token_correspondence_ErrorMsg.factorial3))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: 
(assert (! 
;; def=ErrorMsg.fst(33,8-33,18); use=ErrorMsg.fst(33,8-33,18)
(forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType ErrorMsg.factorial3@tok
Tm_arrow_8bc85b72838e0900e8e5f9c7c000744c))
...
(forall ((@x1 Term))
 (! (= (ApplyTT ErrorMsg.factorial3@tok
@x1)
(ErrorMsg.factorial3 @x1))
 

:pattern ((ErrorMsg.factorial3 @x1))
:qid function_token_typing_ErrorMsg.factorial3.1))
)
 

:pattern ((ApplyTT @x0
ErrorMsg.factorial3@tok))
:qid function_token_typing_ErrorMsg.factorial3))

:named function_token_typing_ErrorMsg.factorial3))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: 
(assert (! 
;; def=ErrorMsg.fst(33,8-33,18); use=ErrorMsg.fst(33,8-33,18)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_refine_4f0bda47ec031c550913e32f2311cfc0)
(HasType (ErrorMsg.factorial3 @x0)
Prims.nat))
 

:pattern ((ErrorMsg.factorial3 @x0))
:qid typing_ErrorMsg.factorial3))

:named typing_ErrorMsg.factorial3))
(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)
...
;           x == any_result ==>
;           (forall (any_result: Prims.nat).
;               ErrorMsg.factorial3 x == any_result ==>
;               (forall (return_val: Prims.nat).
;                   return_val == ErrorMsg.factorial3 x ==>
;                   ErrorMsg.factorial3 x == return_val ==>
;                   (forall (any_result: Prims.int).
;                       x + ErrorMsg.factorial3 x == any_result ==> x + ErrorMsg.factorial3 x >= 0))))
;   )


; Context: While encoding a query
; While typechecking the top-level declaration `let rec factorial3`
; While typechecking the top-level declaration `[@@expect_failure] let rec factorial3`
...
;; def=Prims.fst(402,27-402,88); use=ErrorMsg.fst(34,2-36,27)
(forall ((@x1 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=ErrorMsg.fst(34,2-36,27)
(Valid 
;; def=Prims.fst(402,84-402,87); use=ErrorMsg.fst(34,2-36,27)
(ApplyTT @x0
@x1)
...
;; def=Prims.fst(389,19-389,21); use=ErrorMsg.fst(34,2-36,27)
(not 
;; def=ErrorMsg.fst(33,20-35,7); use=ErrorMsg.fst(34,8-35,7)
(= x_bb4e1c9af0265270f8e7a5f250f730e2_0
(BoxInt 0))
)
)

;; def=Prims.fst(413,99-413,120); use=ErrorMsg.fst(34,2-36,27)
(forall ((@x1 Term))
 (! (implies (and (HasType @x1
Prims.int)

;; def=ErrorMsg.fst(33,20-36,7); use=ErrorMsg.fst(34,8-36,7)
(= x_bb4e1c9af0265270f8e7a5f250f730e2_0
@x1)
)

;; def=Prims.fst(459,77-459,89); use=ErrorMsg.fst(34,2-36,27)
(and 
;; def=ErrorMsg.fst(34,2-36,27); use=ErrorMsg.fst(36,26-36,27)
(or label_1
...
;; def=Prims.fst(451,66-451,102); use=ErrorMsg.fst(34,2-36,27)
(forall ((@x2 Term))
 (! (implies (and (HasType @x2
Prims.nat)

;; def=ErrorMsg.fst(33,20-33,21); use=ErrorMsg.fst(34,2-36,27)
(= x_bb4e1c9af0265270f8e7a5f250f730e2_0
@x2)
)
...
;; def=ErrorMsg.fst(33,33-36,27); use=ErrorMsg.fst(36,15-36,27)
(= (ErrorMsg.factorial3 x_bb4e1c9af0265270f8e7a5f250f730e2_0)
@x3)
)

;; def=Prims.fst(356,2-356,58); use=ErrorMsg.fst(34,2-36,27)
(forall ((@x4 Term))
 (! (implies (and (HasType @x4
Prims.nat)

;; def=Prims.fst(356,26-356,41); use=ErrorMsg.fst(34,2-36,27)
(= @x4
(ErrorMsg.factorial3 x_bb4e1c9af0265270f8e7a5f250f730e2_0))


;; def=dummy(0,0-0,0); use=ErrorMsg.fst(34,2-36,27)
(= (ErrorMsg.factorial3 x_bb4e1c9af0265270f8e7a5f250f730e2_0)
@x4)
)
...
;; def=ErrorMsg.fst(33,33-36,27); use=ErrorMsg.fst(34,2-36,27)
(= (Prims.op_Addition x_bb4e1c9af0265270f8e7a5f250f730e2_0
(ErrorMsg.factorial3 x_bb4e1c9af0265270f8e7a5f250f730e2_0))
@x5)
)

;; def=Prims.fst(680,18-680,24); use=ErrorMsg.fst(36,11-36,27)
(or label_2
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (ErrorMsg.factorial3, 1)
; STATUS: unknown because (incomplete quantifiers)
