...
; encoding sigelt type CPS.DoubleDefun.cont


; <Start encoding type CPS.DoubleDefun.cont>

;;;;;;;;;;;;;;;;Constructor
(declare-fun CPS.DoubleDefun.cont () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun CPS.DoubleDefun.C0 () Term)
;;;;;;;;;;;;;;;;data constructor proxy: CPS.DoubleDefun.C0
(declare-fun CPS.DoubleDefun.C0@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun CPS.DoubleDefun.C1 (Term Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun CPS.DoubleDefun.C1__0 (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun CPS.DoubleDefun.C1__1 (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: CPS.DoubleDefun.C1
(declare-fun CPS.DoubleDefun.C1@tok () Term)
;;;;;;;;;;;;;;;;Constructor
(declare-fun CPS.DoubleDefun.C2 (Term Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun CPS.DoubleDefun.C2__0 (Term) Term)
;;;;;;;;;;;;;;;;Projector
(declare-fun CPS.DoubleDefun.C2__1 (Term) Term)
;;;;;;;;;;;;;;;;data constructor proxy: CPS.DoubleDefun.C2
(declare-fun CPS.DoubleDefun.C2@tok () Term)
;;;;;;;;;;;;;;;;_0: cont -> _1: Prims.int -> cont
(declare-fun Tm_arrow_e1070b1130efd647d571da7c2c53809e () Term)
;;;;;;;;;;;;;;;;_0: cont -> _1: CPS.Expr.expr -> cont
(declare-fun Tm_arrow_1ff42321765f658f14e13c461140c8bd () Term)

; <start constructor CPS.DoubleDefun.cont>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-CPS.DoubleDefun.cont ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
121)
(= __@x0
CPS.DoubleDefun.cont)))

; </end constructor CPS.DoubleDefun.cont>


; <start constructor CPS.DoubleDefun.C0>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-CPS.DoubleDefun.C0 ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
127)
(= __@x0
CPS.DoubleDefun.C0)))

; </end constructor CPS.DoubleDefun.C0>


; <start constructor CPS.DoubleDefun.C1>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-CPS.DoubleDefun.C1 ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
129)
(= __@x0
(CPS.DoubleDefun.C1 (CPS.DoubleDefun.C1__0 __@x0)
(CPS.DoubleDefun.C1__1 __@x0)))))

; </end constructor CPS.DoubleDefun.C1>


; <start constructor CPS.DoubleDefun.C2>

;;;;;;;;;;;;;;;;Discriminator definition
(define-fun is-CPS.DoubleDefun.C2 ((__@x0 Term)) Bool
 (and (= (Term_constr_id __@x0)
134)
(= __@x0
(CPS.DoubleDefun.C2 (CPS.DoubleDefun.C2__0 __@x0)
(CPS.DoubleDefun.C2__1 __@x0)))))

; </end constructor CPS.DoubleDefun.C2>


; </end encoding type CPS.DoubleDefun.cont>
...
;;; Fact-ids: Name CPS.DoubleDefun.cont; Namespace CPS.DoubleDefun; Name CPS.DoubleDefun.C0; Namespace CPS.DoubleDefun; Name CPS.DoubleDefun.C1; Namespace CPS.DoubleDefun; Name CPS.DoubleDefun.C2; Namespace CPS.DoubleDefun
(assert (! (HasType CPS.DoubleDefun.C0@tok
CPS.DoubleDefun.cont)
:named typing_tok_CPS.DoubleDefun.C0@tok))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name Prims.unit; Namespace Prims
...
;;; Fact-ids: Name CPS.DoubleDefun.cont; Namespace CPS.DoubleDefun; Name CPS.DoubleDefun.C0; Namespace CPS.DoubleDefun; Name CPS.DoubleDefun.C1; Namespace CPS.DoubleDefun; Name CPS.DoubleDefun.C2; Namespace CPS.DoubleDefun
(assert (! 
;; def=CPS.DoubleDefun.fst(29,4-29,6); use=CPS.DoubleDefun.fst(29,4-29,6)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (implies (HasTypeFuel (SFuel @u0)
(CPS.DoubleDefun.C2 @x1
@x2)
CPS.DoubleDefun.cont)
(and (Valid (Prims.precedes Prims.lex_t
Prims.lex_t
...
@x2)
CPS.DoubleDefun.cont))
:qid subterm_ordering_CPS.DoubleDefun.C2))

:named subterm_ordering_CPS.DoubleDefun.C2))
;;;;;;;;;;;;;;;;subterm ordering
;;; Fact-ids: Name CPS.DoubleDefun.cont; Namespace CPS.DoubleDefun; Name CPS.DoubleDefun.C0; Namespace CPS.DoubleDefun; Name CPS.DoubleDefun.C1; Namespace CPS.DoubleDefun; Name CPS.DoubleDefun.C2; Namespace CPS.DoubleDefun
(assert (! 
;; def=CPS.DoubleDefun.fst(28,4-28,6); use=CPS.DoubleDefun.fst(28,4-28,6)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (implies (HasTypeFuel (SFuel @u0)
(CPS.DoubleDefun.C1 @x1
@x2)
CPS.DoubleDefun.cont)
(and (Valid (Prims.precedes Prims.lex_t
Prims.lex_t
...
@x2)
CPS.DoubleDefun.cont))
:qid subterm_ordering_CPS.DoubleDefun.C1))

:named subterm_ordering_CPS.DoubleDefun.C1))
;;;;;;;;;;;;;;;;refinement kinding
...
;; def=CPS.DoubleDefun.fst(29,4-29,6); use=CPS.DoubleDefun.fst(29,4-29,6)
(forall ((@x0 Term) (@x1 Term))
 (! (= (CPS.DoubleDefun.C2__1 (CPS.DoubleDefun.C2 @x0
@x1))
@x1)
 

:pattern ((CPS.DoubleDefun.C2 @x0
@x1))
:qid projection_inverse_CPS.DoubleDefun.C2__1))

:named projection_inverse_CPS.DoubleDefun.C2__1))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name CPS.DoubleDefun.cont; Namespace CPS.DoubleDefun; Name CPS.DoubleDefun.C0; Namespace CPS.DoubleDefun; Name CPS.DoubleDefun.C1; Namespace CPS.DoubleDefun; Name CPS.DoubleDefun.C2; Namespace CPS.DoubleDefun
(assert (! 
;; def=CPS.DoubleDefun.fst(29,4-29,6); use=CPS.DoubleDefun.fst(29,4-29,6)
(forall ((@x0 Term) (@x1 Term))
 (! (= (CPS.DoubleDefun.C2__0 (CPS.DoubleDefun.C2 @x0
@x1))
@x0)
...
:pattern ((CPS.DoubleDefun.C2 @x0
@x1))
:qid projection_inverse_CPS.DoubleDefun.C2__0))

:named projection_inverse_CPS.DoubleDefun.C2__0))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name CPS.DoubleDefun.cont; Namespace CPS.DoubleDefun; Name CPS.DoubleDefun.C0; Namespace CPS.DoubleDefun; Name CPS.DoubleDefun.C1; Namespace CPS.DoubleDefun; Name CPS.DoubleDefun.C2; Namespace CPS.DoubleDefun
(assert (! 
;; def=CPS.DoubleDefun.fst(28,4-28,6); use=CPS.DoubleDefun.fst(28,4-28,6)
(forall ((@x0 Term) (@x1 Term))
 (! (= (CPS.DoubleDefun.C1__1 (CPS.DoubleDefun.C1 @x0
@x1))
@x1)
 

:pattern ((CPS.DoubleDefun.C1 @x0
@x1))
:qid projection_inverse_CPS.DoubleDefun.C1__1))

:named projection_inverse_CPS.DoubleDefun.C1__1))
;;;;;;;;;;;;;;;;Projection inverse
;;; Fact-ids: Name CPS.DoubleDefun.cont; Namespace CPS.DoubleDefun; Name CPS.DoubleDefun.C0; Namespace CPS.DoubleDefun; Name CPS.DoubleDefun.C1; Namespace CPS.DoubleDefun; Name CPS.DoubleDefun.C2; Namespace CPS.DoubleDefun
(assert (! 
;; def=CPS.DoubleDefun.fst(28,4-28,6); use=CPS.DoubleDefun.fst(28,4-28,6)
(forall ((@x0 Term) (@x1 Term))
 (! (= (CPS.DoubleDefun.C1__0 (CPS.DoubleDefun.C1 @x0
@x1))
@x0)
...
:pattern ((CPS.DoubleDefun.C1 @x0
@x1))
:qid projection_inverse_CPS.DoubleDefun.C1__0))

:named projection_inverse_CPS.DoubleDefun.C1__0))
;;; Fact-ids: Name CPS.Expr.expr; Namespace CPS.Expr; Name CPS.Expr.Const; Namespace CPS.Expr; Name CPS.Expr.Plus; Namespace CPS.Expr
(assert (! (HasType CPS.Expr.expr
Tm_type)
:named kinding_CPS.Expr.expr@tok))
;;; Fact-ids: Name CPS.DoubleDefun.cont; Namespace CPS.DoubleDefun; Name CPS.DoubleDefun.C0; Namespace CPS.DoubleDefun; Name CPS.DoubleDefun.C1; Namespace CPS.DoubleDefun; Name CPS.DoubleDefun.C2; Namespace CPS.DoubleDefun
(assert (! (HasType CPS.DoubleDefun.cont
Tm_type)
:named kinding_CPS.DoubleDefun.cont@tok))
;;;;;;;;;;;;;;;;int typing
;;; Fact-ids: Name Prims.int; Namespace Prims
(assert (! (forall ((@u0 Int))
 (! (HasType (BoxInt @u0)
...
;;; Fact-ids: Name CPS.DoubleDefun.cont; Namespace CPS.DoubleDefun; Name CPS.DoubleDefun.C0; Namespace CPS.DoubleDefun; Name CPS.DoubleDefun.C1; Namespace CPS.DoubleDefun; Name CPS.DoubleDefun.C2; Namespace CPS.DoubleDefun
(assert (! 
;; def=CPS.DoubleDefun.fst(26,5-26,9); use=CPS.DoubleDefun.fst(26,5-26,9)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel (SFuel @u0)
@x1
CPS.DoubleDefun.cont)
(or (is-CPS.DoubleDefun.C0 @x1)
(is-CPS.DoubleDefun.C1 @x1)
(is-CPS.DoubleDefun.C2 @x1)))
 

:pattern ((HasTypeFuel (SFuel @u0)
@x1
CPS.DoubleDefun.cont))
:qid fuel_guarded_inversion_CPS.DoubleDefun.cont))

:named fuel_guarded_inversion_CPS.DoubleDefun.cont))
...
;;;;;;;;;;;;;;;;equality for proxy
;;; Fact-ids: Name CPS.DoubleDefun.cont; Namespace CPS.DoubleDefun; Name CPS.DoubleDefun.C0; Namespace CPS.DoubleDefun; Name CPS.DoubleDefun.C1; Namespace CPS.DoubleDefun; Name CPS.DoubleDefun.C2; Namespace CPS.DoubleDefun
(assert (! (= CPS.DoubleDefun.C0@tok
CPS.DoubleDefun.C0)
:named equality_tok_CPS.DoubleDefun.C0@tok))
...
@x2)
CPS.DoubleDefun.cont))
:qid data_typing_intro_CPS.DoubleDefun.C2@tok))

:named data_typing_intro_CPS.DoubleDefun.C2@tok))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name CPS.DoubleDefun.cont; Namespace CPS.DoubleDefun; Name CPS.DoubleDefun.C0; Namespace CPS.DoubleDefun; Name CPS.DoubleDefun.C1; Namespace CPS.DoubleDefun; Name CPS.DoubleDefun.C2; Namespace CPS.DoubleDefun
(assert (! 
;; def=CPS.DoubleDefun.fst(28,4-28,6); use=CPS.DoubleDefun.fst(28,4-28,6)
...
@x2)
CPS.DoubleDefun.cont))
:qid data_typing_intro_CPS.DoubleDefun.C1@tok))

:named data_typing_intro_CPS.DoubleDefun.C1@tok))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name CPS.DoubleDefun.cont; Namespace CPS.DoubleDefun; Name CPS.DoubleDefun.C0; Namespace CPS.DoubleDefun; Name CPS.DoubleDefun.C1; Namespace CPS.DoubleDefun; Name CPS.DoubleDefun.C2; Namespace CPS.DoubleDefun
(assert (! 
;; def=CPS.DoubleDefun.fst(27,4-27,6); use=CPS.DoubleDefun.fst(27,4-27,6)
(forall ((@u0 Fuel))
 (! (HasTypeFuel @u0
CPS.DoubleDefun.C0
CPS.DoubleDefun.cont)
...
CPS.DoubleDefun.C0
CPS.DoubleDefun.cont))
:qid data_typing_intro_CPS.DoubleDefun.C0@tok))

:named data_typing_intro_CPS.DoubleDefun.C0@tok))
...
@x2)
CPS.DoubleDefun.cont))
:qid data_elim_CPS.DoubleDefun.C2))

:named data_elim_CPS.DoubleDefun.C2))
;;;;;;;;;;;;;;;;data constructor typing elim
;;; Fact-ids: Name CPS.DoubleDefun.cont; Namespace CPS.DoubleDefun; Name CPS.DoubleDefun.C0; Namespace CPS.DoubleDefun; Name CPS.DoubleDefun.C1; Namespace CPS.DoubleDefun; Name CPS.DoubleDefun.C2; Namespace CPS.DoubleDefun
(assert (! 
;; def=CPS.DoubleDefun.fst(28,4-28,6); use=CPS.DoubleDefun.fst(28,4-28,6)
...
@x2)
CPS.DoubleDefun.cont))
:qid data_elim_CPS.DoubleDefun.C1))

:named data_elim_CPS.DoubleDefun.C1))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name Prims.unit; Namespace Prims
(assert (! (= 125
...
;;; Fact-ids: Name CPS.DoubleDefun.cont; Namespace CPS.DoubleDefun; Name CPS.DoubleDefun.C0; Namespace CPS.DoubleDefun; Name CPS.DoubleDefun.C1; Namespace CPS.DoubleDefun; Name CPS.DoubleDefun.C2; Namespace CPS.DoubleDefun
(assert (! (= 121
(Term_constr_id CPS.DoubleDefun.cont))
:named constructor_distinct_CPS.DoubleDefun.cont))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name CPS.DoubleDefun.cont; Namespace CPS.DoubleDefun; Name CPS.DoubleDefun.C0; Namespace CPS.DoubleDefun; Name CPS.DoubleDefun.C1; Namespace CPS.DoubleDefun; Name CPS.DoubleDefun.C2; Namespace CPS.DoubleDefun
(assert (! 
;; def=CPS.DoubleDefun.fst(29,4-29,6); use=CPS.DoubleDefun.fst(29,4-29,6)
(forall ((@x0 Term) (@x1 Term))
 (! (= 134
(Term_constr_id (CPS.DoubleDefun.C2 @x0
@x1)))
 

:pattern ((CPS.DoubleDefun.C2 @x0
@x1))
:qid constructor_distinct_CPS.DoubleDefun.C2))

:named constructor_distinct_CPS.DoubleDefun.C2))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name CPS.DoubleDefun.cont; Namespace CPS.DoubleDefun; Name CPS.DoubleDefun.C0; Namespace CPS.DoubleDefun; Name CPS.DoubleDefun.C1; Namespace CPS.DoubleDefun; Name CPS.DoubleDefun.C2; Namespace CPS.DoubleDefun
(assert (! 
;; def=CPS.DoubleDefun.fst(28,4-28,6); use=CPS.DoubleDefun.fst(28,4-28,6)
(forall ((@x0 Term) (@x1 Term))
 (! (= 129
(Term_constr_id (CPS.DoubleDefun.C1 @x0
@x1)))
 

:pattern ((CPS.DoubleDefun.C1 @x0
@x1))
:qid constructor_distinct_CPS.DoubleDefun.C1))

:named constructor_distinct_CPS.DoubleDefun.C1))
;;;;;;;;;;;;;;;;Constructor distinct
;;; Fact-ids: Name CPS.DoubleDefun.cont; Namespace CPS.DoubleDefun; Name CPS.DoubleDefun.C0; Namespace CPS.DoubleDefun; Name CPS.DoubleDefun.C1; Namespace CPS.DoubleDefun; Name CPS.DoubleDefun.C2; Namespace CPS.DoubleDefun
(assert (! (= 127
(Term_constr_id CPS.DoubleDefun.C0))
:named constructor_distinct_CPS.DoubleDefun.C0))
;;;;;;;;;;;;;;;;bool typing
;;; Fact-ids: Name Prims.bool; Namespace Prims
(assert (! (forall ((@u0 Bool))
 (! (HasType (BoxBool @u0)
...
@x0
CPS.DoubleDefun.cont))
:qid CPS.DoubleDefun_pretyping_fc08148c0a56a96633a93ae5c4e7943e))

:named CPS.DoubleDefun_pretyping_fc08148c0a56a96633a93ae5c4e7943e))
(push) ;; push{4

; Starting query at CPS.DoubleDefun.fst(26,0-29,29)

(declare-fun label_3 () Bool)
(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)

; Encoding query formula : Prims.hasEq CPS.DoubleDefun.cont ==>
; (forall (_0: CPS.DoubleDefun.cont) (_1: Prims.int).
...
; *)
;     Prims.hasEq CPS.DoubleDefun.cont) /\
; (forall (_0: CPS.DoubleDefun.cont) (_1: CPS.Expr.expr).
;     Prims.hasEq CPS.DoubleDefun.cont /\ Prims.hasEq CPS.Expr.expr)


; Context: While encoding a query
; While typechecking the top-level declaration `type CPS.DoubleDefun.cont`
...
;;; Fact-ids: 
(assert (! (not (implies 
;; def=CPS.DoubleDefun.fst(26,0-29,29); use=CPS.DoubleDefun.fst(26,0-29,29)
(Valid 
;; def=CPS.DoubleDefun.fst(26,0-29,29); use=CPS.DoubleDefun.fst(26,0-29,29)
(Prims.hasEq CPS.DoubleDefun.cont)
)
...
;; def=CPS.DoubleDefun.fst(26,0-29,29); use=CPS.DoubleDefun.fst(28,9-28,13)
(or label_1
...
;; def=CPS.DoubleDefun.fst(26,0-29,29); use=CPS.DoubleDefun.fst(26,0-29,29)
(and 
;; def=CPS.DoubleDefun.fst(26,0-29,29); use=CPS.DoubleDefun.fst(29,9-29,13)
(or label_2
...
;; def=CPS.DoubleDefun.fst(26,0-29,29); use=CPS.DoubleDefun.fst(29,17-29,21)
(or label_3
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (CPS.DoubleDefun.cont, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @query, assumption_CPS.Expr.expr__uu___haseq
...
; encoding sigelt assume CPS.DoubleDefun.cont__uu___haseq


; <Start encoding assume CPS.DoubleDefun.cont__uu___haseq>


; </end encoding assume CPS.DoubleDefun.cont__uu___haseq>


; encoding sigelt val CPS.DoubleDefun.uu___is_C0


; <Start encoding val CPS.DoubleDefun.uu___is_C0>

(declare-fun CPS.DoubleDefun.uu___is_C0 (Term) Term)
;;;;;;;;;;;;;;;;projectee: cont -> Prims.bool
(declare-fun Tm_arrow_d794b34b3d2b5b7a4f5a31bafbc21272 () Term)
(declare-fun CPS.DoubleDefun.uu___is_C0@tok () Term)

; </end encoding val CPS.DoubleDefun.uu___is_C0>
...
; encoding sigelt val CPS.DoubleDefun.uu___is_C1


; <Start encoding val CPS.DoubleDefun.uu___is_C1>

(declare-fun CPS.DoubleDefun.uu___is_C1 (Term) Term)

(declare-fun CPS.DoubleDefun.uu___is_C1@tok () Term)

; </end encoding val CPS.DoubleDefun.uu___is_C1>
...
; encoding sigelt val CPS.DoubleDefun.__proj__C1__item___0


; <Start encoding val CPS.DoubleDefun.__proj__C1__item___0>

(declare-fun Tm_refine_b1d4de3cb1cee3ac5aafed034e069035 () Term)
(declare-fun CPS.DoubleDefun.__proj__C1__item___0 (Term) Term)

;;;;;;;;;;;;;;;;projectee: _: cont{C1? _} -> cont
(declare-fun Tm_arrow_4f8e10dd7618988bd2256a17b7835194 () Term)
(declare-fun CPS.DoubleDefun.__proj__C1__item___0@tok () Term)

; </end encoding val CPS.DoubleDefun.__proj__C1__item___0>
...
:named typing_CPS.Expr.uu___is_Const))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name CPS.DoubleDefun.uu___is_C1; Namespace CPS.DoubleDefun
(assert (! 
;; def=CPS.DoubleDefun.fst(28,4-28,6); use=CPS.DoubleDefun.fst(28,4-28,6)
(forall ((@x0 Term))
 (! (implies (HasType @x0
CPS.DoubleDefun.cont)
(HasType (CPS.DoubleDefun.uu___is_C1 @x0)
Prims.bool))
 

:pattern ((CPS.DoubleDefun.uu___is_C1 @x0))
:qid typing_CPS.DoubleDefun.uu___is_C1))

:named typing_CPS.DoubleDefun.uu___is_C1))
;;;;;;;;;;;;;;;;subterm ordering
;;; Fact-ids: Name CPS.Expr.expr; Namespace CPS.Expr; Name CPS.Expr.Const; Namespace CPS.Expr; Name CPS.Expr.Plus; Namespace CPS.Expr
(assert (! 
;; def=CPS.Expr.fst(20,4-20,8); use=CPS.Expr.fst(20,4-20,8)
...
:named refinement_kinding_Tm_refine_f1ecc6ab6882a651504f328937700647))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name CPS.DoubleDefun.__proj__C1__item___0; Namespace CPS.DoubleDefun
(assert (! (HasType Tm_refine_b1d4de3cb1cee3ac5aafed034e069035
Tm_type)
:named refinement_kinding_Tm_refine_b1d4de3cb1cee3ac5aafed034e069035))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name Prims.pos; Namespace Prims
(assert (! (HasType Tm_refine_774ba3f728d91ead8ef40be66c9802e5
Tm_type)
...
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_b1d4de3cb1cee3ac5aafed034e069035)
(and (HasTypeFuel @u0
@x1
CPS.DoubleDefun.cont)

;; def=CPS.DoubleDefun.fst(28,4-28,6); use=CPS.DoubleDefun.fst(28,4-28,6)
(BoxBool_proj_0 (CPS.DoubleDefun.uu___is_C1 @x1))
))
...
@x1
Tm_refine_b1d4de3cb1cee3ac5aafed034e069035))
:qid refinement_interpretation_Tm_refine_b1d4de3cb1cee3ac5aafed034e069035))

:named refinement_interpretation_Tm_refine_b1d4de3cb1cee3ac5aafed034e069035))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name Prims.pos; Namespace Prims
(assert (! 
;; def=Prims.fst(683,11-683,24); use=Prims.fst(683,11-683,24)
...
(Valid (Prims.hasEq Prims.unit)))
:named haseqTm_refine_f1ecc6ab6882a651504f328937700647))
;;;;;;;;;;;;;;;;haseq for Tm_refine_b1d4de3cb1cee3ac5aafed034e069035
;;; Fact-ids: Name CPS.DoubleDefun.__proj__C1__item___0; Namespace CPS.DoubleDefun
(assert (! (iff (Valid (Prims.hasEq Tm_refine_b1d4de3cb1cee3ac5aafed034e069035))
(Valid (Prims.hasEq CPS.DoubleDefun.cont)))
:named haseqTm_refine_b1d4de3cb1cee3ac5aafed034e069035))
;;;;;;;;;;;;;;;;haseq for Tm_refine_774ba3f728d91ead8ef40be66c9802e5
;;; Fact-ids: Name Prims.pos; Namespace Prims
(assert (! (iff (Valid (Prims.hasEq Tm_refine_774ba3f728d91ead8ef40be66c9802e5))
(Valid (Prims.hasEq Prims.int)))
...
;; def=CPS.DoubleDefun.fst(28,4-28,6); use=CPS.DoubleDefun.fst(28,4-28,6)
(forall ((@x0 Term))
 (! (= (CPS.DoubleDefun.uu___is_C1 @x0)
(BoxBool (is-CPS.DoubleDefun.C1 @x0)))
 

:pattern ((CPS.DoubleDefun.uu___is_C1 @x0))
:qid disc_equation_CPS.DoubleDefun.C1))

:named disc_equation_CPS.DoubleDefun.C1))
;;;;;;;;;;;;;;;;Prop-typing for Prims.subtype_of
;;; Fact-ids: Name Prims.subtype_of; Namespace Prims
(assert (! 
;; def=Prims.fst(291,4-291,14); use=Prims.fst(291,4-291,14)
...
(assert (! (Valid (Prims.hasEq CPS.Expr.expr))
:named assumption_CPS.Expr.expr__uu___haseq))
;;;;;;;;;;;;;;;;Assumption: CPS.DoubleDefun.cont__uu___haseq
;;; Fact-ids: Name CPS.DoubleDefun.cont__uu___haseq; Namespace CPS.DoubleDefun
(assert (! (Valid (Prims.hasEq CPS.DoubleDefun.cont))
:named assumption_CPS.DoubleDefun.cont__uu___haseq))
;;;;;;;;;;;;;;;;pretyping
;;; Fact-ids: Name Prims.unit; Namespace Prims
(assert (! 
;; def=Prims.fst(96,5-96,9); use=Prims.fst(96,5-96,9)
...
; Encoding query formula : forall (projectee: _: CPS.DoubleDefun.cont{C1? _}).
...
(not 
;; def=CPS.DoubleDefun.fst(28,4-28,6); use=CPS.DoubleDefun.fst(28,4-28,6)
(BoxBool_proj_0 (CPS.DoubleDefun.uu___is_C1 @x0))
)
)
label_1)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (CPS.DoubleDefun.__proj__C1__item___0, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_b1d4de3cb1cee3ac5aafed034e069035
...
; encoding sigelt val CPS.DoubleDefun.__proj__C1__item___1


; <Start encoding val CPS.DoubleDefun.__proj__C1__item___1>


(declare-fun CPS.DoubleDefun.__proj__C1__item___1 (Term) Term)

;;;;;;;;;;;;;;;;projectee: _: cont{C1? _} -> Prims.int
(declare-fun Tm_arrow_71c42faa05e904e8714b7a4622a8bd40 () Term)
(declare-fun CPS.DoubleDefun.__proj__C1__item___1@tok () Term)

; </end encoding val CPS.DoubleDefun.__proj__C1__item___1>
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (CPS.DoubleDefun.__proj__C1__item___1, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_b1d4de3cb1cee3ac5aafed034e069035
...
; encoding sigelt val CPS.DoubleDefun.uu___is_C2


; <Start encoding val CPS.DoubleDefun.uu___is_C2>

(declare-fun CPS.DoubleDefun.uu___is_C2 (Term) Term)

(declare-fun CPS.DoubleDefun.uu___is_C2@tok () Term)

; </end encoding val CPS.DoubleDefun.uu___is_C2>


; encoding sigelt let uu___is_C2


; <Skipped let uu___is_C2/>


; encoding sigelt val CPS.DoubleDefun.__proj__C2__item___0


; <Start encoding val CPS.DoubleDefun.__proj__C2__item___0>

(declare-fun Tm_refine_470d7912c558796d2a0ae83a2d7f54a2 () Term)
(declare-fun CPS.DoubleDefun.__proj__C2__item___0 (Term) Term)

;;;;;;;;;;;;;;;;projectee: _: cont{C2? _} -> cont
(declare-fun Tm_arrow_4d3555f1616f7aceafa04fb98fb7978a () Term)
(declare-fun CPS.DoubleDefun.__proj__C2__item___0@tok () Term)

; </end encoding val CPS.DoubleDefun.__proj__C2__item___0>

;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name CPS.DoubleDefun.uu___is_C2; Namespace CPS.DoubleDefun
(assert (! 
;; def=CPS.DoubleDefun.fst(29,4-29,6); use=CPS.DoubleDefun.fst(29,4-29,6)
(forall ((@x0 Term))
 (! (implies (HasType @x0
CPS.DoubleDefun.cont)
(HasType (CPS.DoubleDefun.uu___is_C2 @x0)
Prims.bool))
 

:pattern ((CPS.DoubleDefun.uu___is_C2 @x0))
:qid typing_CPS.DoubleDefun.uu___is_C2))

:named typing_CPS.DoubleDefun.uu___is_C2))
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: Name CPS.DoubleDefun.__proj__C2__item___0; Namespace CPS.DoubleDefun
(assert (! (HasType Tm_refine_470d7912c558796d2a0ae83a2d7f54a2
Tm_type)
:named refinement_kinding_Tm_refine_470d7912c558796d2a0ae83a2d7f54a2))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: Name CPS.DoubleDefun.__proj__C2__item___0; Namespace CPS.DoubleDefun
(assert (! 
;; def=CPS.DoubleDefun.fst(29,4-29,6); use=CPS.DoubleDefun.fst(29,4-29,6)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_470d7912c558796d2a0ae83a2d7f54a2)
(and (HasTypeFuel @u0
@x1
CPS.DoubleDefun.cont)

;; def=CPS.DoubleDefun.fst(29,4-29,6); use=CPS.DoubleDefun.fst(29,4-29,6)
(BoxBool_proj_0 (CPS.DoubleDefun.uu___is_C2 @x1))
))
...
@x1
Tm_refine_470d7912c558796d2a0ae83a2d7f54a2))
:qid refinement_interpretation_Tm_refine_470d7912c558796d2a0ae83a2d7f54a2))

:named refinement_interpretation_Tm_refine_470d7912c558796d2a0ae83a2d7f54a2))
;;;;;;;;;;;;;;;;haseq for Tm_refine_470d7912c558796d2a0ae83a2d7f54a2
;;; Fact-ids: Name CPS.DoubleDefun.__proj__C2__item___0; Namespace CPS.DoubleDefun
(assert (! (iff (Valid (Prims.hasEq Tm_refine_470d7912c558796d2a0ae83a2d7f54a2))
(Valid (Prims.hasEq CPS.DoubleDefun.cont)))
:named haseqTm_refine_470d7912c558796d2a0ae83a2d7f54a2))
;;;;;;;;;;;;;;;;Discriminator equation
;;; Fact-ids: Name CPS.DoubleDefun.uu___is_C2; Namespace CPS.DoubleDefun
(assert (! 
;; def=CPS.DoubleDefun.fst(29,4-29,6); use=CPS.DoubleDefun.fst(29,4-29,6)
(forall ((@x0 Term))
 (! (= (CPS.DoubleDefun.uu___is_C2 @x0)
(BoxBool (is-CPS.DoubleDefun.C2 @x0)))
 

:pattern ((CPS.DoubleDefun.uu___is_C2 @x0))
:qid disc_equation_CPS.DoubleDefun.C2))

:named disc_equation_CPS.DoubleDefun.C2))
(push) ;; push{2
...
; Encoding query formula : forall (projectee: _: CPS.DoubleDefun.cont{C2? _}).
;   (*  - Could not prove post-condition
; *) ~(C2? projectee) ==> Prims.l_False


; Context: While encoding a query
; While typechecking the top-level declaration `let __proj__C2__item___0`
...
(not 
;; def=CPS.DoubleDefun.fst(29,4-29,6); use=CPS.DoubleDefun.fst(29,4-29,6)
(BoxBool_proj_0 (CPS.DoubleDefun.uu___is_C2 @x0))
)
)
label_1)
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (CPS.DoubleDefun.__proj__C2__item___0, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_470d7912c558796d2a0ae83a2d7f54a2
...
; encoding sigelt let __proj__C2__item___0


; <Skipped let __proj__C2__item___0/>


; encoding sigelt val CPS.DoubleDefun.__proj__C2__item___1


; <Start encoding val CPS.DoubleDefun.__proj__C2__item___1>


(declare-fun CPS.DoubleDefun.__proj__C2__item___1 (Term) Term)

;;;;;;;;;;;;;;;;projectee: _: cont{C2? _} -> CPS.Expr.expr
(declare-fun Tm_arrow_740fe42d5f03fc8fe49594902cfd05b7 () Term)
(declare-fun CPS.DoubleDefun.__proj__C2__item___1@tok () Term)

; </end encoding val CPS.DoubleDefun.__proj__C2__item___1>
...
; Context: While encoding a query
; While typechecking the top-level declaration `let __proj__C2__item___1`
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (CPS.DoubleDefun.__proj__C2__item___1, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, refinement_interpretation_Tm_refine_470d7912c558796d2a0ae83a2d7f54a2
...
; encoding sigelt let __proj__C2__item___1


; <Skipped let __proj__C2__item___1/>


; encoding sigelt val CPS.DoubleDefun.stack


; <Skipped val CPS.DoubleDefun.stack/>
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name CPS.DoubleDefun.uu___is_C0; Namespace CPS.DoubleDefun
(assert (! 
;; def=CPS.DoubleDefun.fst(27,4-27,6); use=CPS.DoubleDefun.fst(27,4-27,6)
(forall ((@x0 Term))
 (! (implies (HasType @x0
CPS.DoubleDefun.cont)
(HasType (CPS.DoubleDefun.uu___is_C0 @x0)
Prims.bool))
 

:pattern ((CPS.DoubleDefun.uu___is_C0 @x0))
:qid typing_CPS.DoubleDefun.uu___is_C0))

:named typing_CPS.DoubleDefun.uu___is_C0))
;;;;;;;;;;;;;;;;True interpretation
;;; Fact-ids: Name Prims.l_True; Namespace Prims
...
;; def=CPS.DoubleDefun.fst(27,4-27,6); use=CPS.DoubleDefun.fst(27,4-27,6)
(forall ((@x0 Term))
 (! (= (CPS.DoubleDefun.uu___is_C0 @x0)
(BoxBool (is-CPS.DoubleDefun.C0 @x0)))
 

:pattern ((CPS.DoubleDefun.uu___is_C0 @x0))
:qid disc_equation_CPS.DoubleDefun.C0))

:named disc_equation_CPS.DoubleDefun.C0))
;;;;;;;;;;;;;;;;data constructor typing intro
;;; Fact-ids: Name Prims.trivial; Namespace Prims; Name Prims.T; Namespace Prims
(assert (! 
...
; Starting query at CPS.DoubleDefun.fst(32,16-35,26)

;;;;;;;;;;;;;;;;uu___0 : CPS.DoubleDefun.cont (CPS.DoubleDefun.cont)
(declare-fun x_fc08148c0a56a96633a93ae5c4e7943e_0 () Term)
;;;;;;;;;;;;;;;;binder_x_fc08148c0a56a96633a93ae5c4e7943e_0
;;; Fact-ids: 
(assert (! (HasType x_fc08148c0a56a96633a93ae5c4e7943e_0
CPS.DoubleDefun.cont)
:named binder_x_fc08148c0a56a96633a93ae5c4e7943e_0))
(declare-fun Tm_refine_0bf50535b5501c94ebbda90c2780f8c9 () Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! (HasType Tm_refine_0bf50535b5501c94ebbda90c2780f8c9
Tm_type)
:named refinement_kinding_Tm_refine_0bf50535b5501c94ebbda90c2780f8c9))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=CPS.DoubleDefun.fst(32,16-35,26); use=CPS.DoubleDefun.fst(32,16-35,26)
(forall ((@u0 Fuel) (@x1 Term))
 (! (iff (HasTypeFuel @u0
@x1
Tm_refine_0bf50535b5501c94ebbda90c2780f8c9)
(and (HasTypeFuel @u0
@x1
CPS.DoubleDefun.cont)
...
(Valid 
;; def=CPS.DoubleDefun.fst(32,16-35,26); use=CPS.DoubleDefun.fst(32,16-35,26)
(Prims.precedes CPS.DoubleDefun.cont
CPS.DoubleDefun.cont
@x1
x_fc08148c0a56a96633a93ae5c4e7943e_0)
)
...
@x1
Tm_refine_0bf50535b5501c94ebbda90c2780f8c9))
:qid refinement_interpretation_Tm_refine_0bf50535b5501c94ebbda90c2780f8c9))

:named refinement_interpretation_Tm_refine_0bf50535b5501c94ebbda90c2780f8c9))
;;;;;;;;;;;;;;;;haseq for Tm_refine_0bf50535b5501c94ebbda90c2780f8c9
;;; Fact-ids: 
(assert (! (iff (Valid (Prims.hasEq Tm_refine_0bf50535b5501c94ebbda90c2780f8c9))
(Valid (Prims.hasEq CPS.DoubleDefun.cont)))
:named haseqTm_refine_0bf50535b5501c94ebbda90c2780f8c9))
(declare-fun CPS.DoubleDefun.stack (Term) Term)

;;;;;;;;;;;;;;;;_: _: cont{_ << _} -> Prims.list CPS.Expr.expr
(declare-fun Tm_arrow_7fb5aa6b68de0f843ed1826ced335711 () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_7fb5aa6b68de0f843ed1826ced335711
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_7fb5aa6b68de0f843ed1826ced335711
Tm_type)
:named kinding_Tm_arrow_7fb5aa6b68de0f843ed1826ced335711))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=CPS.DoubleDefun.fst(31,24-35,26); use=CPS.DoubleDefun.fst(32,8-35,26)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_7fb5aa6b68de0f843ed1826ced335711)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_7fb5aa6b68de0f843ed1826ced335711))
:qid CPS.DoubleDefun_pre_typing_Tm_arrow_7fb5aa6b68de0f843ed1826ced335711))

:named CPS.DoubleDefun_pre_typing_Tm_arrow_7fb5aa6b68de0f843ed1826ced335711))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_7fb5aa6b68de0f843ed1826ced335711
;;; Fact-ids: 
(assert (! 
;; def=CPS.DoubleDefun.fst(31,24-35,26); use=CPS.DoubleDefun.fst(32,8-35,26)
(forall ((@x0 Term))
...
(HasType (ApplyTT @x0
@x1)
(Prims.list CPS.Expr.expr)))
 

:pattern ((ApplyTT @x0
@x1))
:qid CPS.DoubleDefun_interpretation_Tm_arrow_7fb5aa6b68de0f843ed1826ced335711.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_7fb5aa6b68de0f843ed1826ced335711))
:qid CPS.DoubleDefun_interpretation_Tm_arrow_7fb5aa6b68de0f843ed1826ced335711))

:named CPS.DoubleDefun_interpretation_Tm_arrow_7fb5aa6b68de0f843ed1826ced335711))
(declare-fun CPS.DoubleDefun.stack@tok () Term)
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: 
(assert (! 
;; def=CPS.DoubleDefun.fst(32,8-32,13); use=CPS.DoubleDefun.fst(32,8-32,13)
(forall ((@x0 Term))
 (! (= (ApplyTT CPS.DoubleDefun.stack@tok
@x0)
(CPS.DoubleDefun.stack @x0))
 

:pattern ((ApplyTT CPS.DoubleDefun.stack@tok
@x0))
:qid token_correspondence_CPS.DoubleDefun.stack))

:named token_correspondence_CPS.DoubleDefun.stack))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: 
(assert (! 
;; def=CPS.DoubleDefun.fst(32,8-32,13); use=CPS.DoubleDefun.fst(32,8-32,13)
(forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType CPS.DoubleDefun.stack@tok
Tm_arrow_7fb5aa6b68de0f843ed1826ced335711))
...
(forall ((@x1 Term))
 (! (= (ApplyTT CPS.DoubleDefun.stack@tok
@x1)
(CPS.DoubleDefun.stack @x1))
 

:pattern ((CPS.DoubleDefun.stack @x1))
:qid function_token_typing_CPS.DoubleDefun.stack.1))
)
 

:pattern ((ApplyTT @x0
CPS.DoubleDefun.stack@tok))
:qid function_token_typing_CPS.DoubleDefun.stack))

:named function_token_typing_CPS.DoubleDefun.stack))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: 
(assert (! 
;; def=CPS.DoubleDefun.fst(32,8-32,13); use=CPS.DoubleDefun.fst(32,8-32,13)
(forall ((@x0 Term))
 (! (implies (HasType @x0
Tm_refine_0bf50535b5501c94ebbda90c2780f8c9)
(HasType (CPS.DoubleDefun.stack @x0)
(Prims.list CPS.Expr.expr)))
 

:pattern ((CPS.DoubleDefun.stack @x0))
:qid typing_CPS.DoubleDefun.stack))

:named typing_CPS.DoubleDefun.stack))
(declare-fun label_3 () Bool)
(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)

; Encoding query formula : forall (k: Prims.pure_post (Prims.list CPS.Expr.expr)).
;   (forall (x: Prims.list CPS.Expr.expr). {:pattern Prims.guard_free (k x)} Prims.auto_squash (k x)) ==>
;   (~(C0? _) /\ ~(C1? _) /\ ~(C2? _) ==> Prims.l_False) /\
;   (~(C0? _) ==>
;     (forall (b: CPS.DoubleDefun.cont) (b: Prims.int). _ == CPS.DoubleDefun.C1 b b ==> b << _) /\
;     (~(C1? _) ==>
;       (forall (b: CPS.DoubleDefun.cont) (b: CPS.Expr.expr). _ == CPS.DoubleDefun.C2 b b ==> b << _))
;   )


; Context: While encoding a query
; While typechecking the top-level declaration `let rec stack`
...
(assert (! (not (forall ((@x0 Term))
 (! (implies (and (HasType @x0
(Prims.pure_post (Prims.list CPS.Expr.expr)))

;; def=Prims.fst(402,27-402,88); use=CPS.DoubleDefun.fst(32,16-35,26)
(forall ((@x1 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=CPS.DoubleDefun.fst(32,16-35,26)
(Valid 
;; def=Prims.fst(402,84-402,87); use=CPS.DoubleDefun.fst(32,16-35,26)
(ApplyTT @x0
@x1)
...
;; def=Prims.fst(459,77-459,89); use=CPS.DoubleDefun.fst(32,16-35,26)
(and (implies 
;; def=CPS.DoubleDefun.fst(32,16-35,26); use=CPS.DoubleDefun.fst(32,16-35,26)
(and 
;; def=CPS.DoubleDefun.fst(32,16-35,26); use=CPS.DoubleDefun.fst(32,16-35,26)
(not 
;; def=CPS.DoubleDefun.fst(32,16-35,26); use=CPS.DoubleDefun.fst(32,16-35,26)
(BoxBool_proj_0 (CPS.DoubleDefun.uu___is_C0 x_fc08148c0a56a96633a93ae5c4e7943e_0))
)
...
(not 
;; def=CPS.DoubleDefun.fst(32,16-35,26); use=CPS.DoubleDefun.fst(32,16-35,26)
(BoxBool_proj_0 (CPS.DoubleDefun.uu___is_C1 x_fc08148c0a56a96633a93ae5c4e7943e_0))
)
...
(not 
;; def=CPS.DoubleDefun.fst(32,16-35,26); use=CPS.DoubleDefun.fst(32,16-35,26)
(BoxBool_proj_0 (CPS.DoubleDefun.uu___is_C2 x_fc08148c0a56a96633a93ae5c4e7943e_0))
)
)

label_1)
(implies 
;; def=Prims.fst(389,19-389,21); use=CPS.DoubleDefun.fst(32,16-35,26)
(not 
;; def=CPS.DoubleDefun.fst(32,16-35,26); use=CPS.DoubleDefun.fst(32,16-35,26)
(BoxBool_proj_0 (CPS.DoubleDefun.uu___is_C0 x_fc08148c0a56a96633a93ae5c4e7943e_0))
)
...
;; def=Prims.fst(389,2-389,39); use=CPS.DoubleDefun.fst(32,16-35,26)
(and 
;; def=Prims.fst(413,99-413,120); use=CPS.DoubleDefun.fst(32,16-35,26)
(forall ((@x1 Term))
 (! (implies (HasType @x1
CPS.DoubleDefun.cont)
...
;; def=CPS.DoubleDefun.fst(32,16-35,26); use=CPS.DoubleDefun.fst(34,20-34,21)
(or label_2
...
;; def=CPS.DoubleDefun.fst(32,16-35,26); use=CPS.DoubleDefun.fst(35,24-35,25)
(or label_3
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (CPS.DoubleDefun.stack, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, CPS.DoubleDefun_pretyping_fc08148c0a56a96633a93ae5c4e7943e, binder_x_fc08148c0a56a96633a93ae5c4e7943e_0, data_typing_intro_CPS.DoubleDefun.C0@tok, disc_equation_CPS.DoubleDefun.C0, disc_equation_CPS.DoubleDefun.C1, disc_equation_CPS.DoubleDefun.C2, fuel_guarded_inversion_CPS.DoubleDefun.cont, projection_inverse_BoxBool_proj_0, subterm_ordering_CPS.DoubleDefun.C1, subterm_ordering_CPS.DoubleDefun.C2
...
; encoding sigelt let rec stack


; <Start encoding let rec stack>

;;;;;;;;;;;;;;;;Fuel-instrumented function name
(declare-fun CPS.DoubleDefun.stack.fuel_instrumented (Fuel Term) Term)
;;;;;;;;;;;;;;;;Token for fuel-instrumented partial applications
(declare-fun CPS.DoubleDefun.stack.fuel_instrumented_token () Term)
(declare-fun CPS.DoubleDefun.stack (Term) Term)
(declare-fun CPS.DoubleDefun.stack@tok () Term)
;;;;;;;;;;;;;;;;_: cont -> Prims.list CPS.Expr.expr
(declare-fun Tm_arrow_1813ac3ef3f48b31bf0ebfb8d55f1e06 () Term)

; </end encoding let rec stack>


; encoding sigelt assume CPS.DoubleDefun.Rstack0


; <Start encoding assume CPS.DoubleDefun.Rstack0>


; </end encoding assume CPS.DoubleDefun.Rstack0>


; encoding sigelt assume CPS.DoubleDefun.Rstack1


; <Start encoding assume CPS.DoubleDefun.Rstack1>


; </end encoding assume CPS.DoubleDefun.Rstack1>


; encoding sigelt assume CPS.DoubleDefun.Rstack2


; <Start encoding assume CPS.DoubleDefun.Rstack2>


; </end encoding assume CPS.DoubleDefun.Rstack2>


; encoding sigelt val CPS.DoubleDefun.apply


; <Skipped val CPS.DoubleDefun.apply/>


; encoding sigelt val CPS.DoubleDefun.eval_cps


; <Skipped val CPS.DoubleDefun.eval_cps/>
...
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: Name CPS.DoubleDefun.stack; Namespace CPS.DoubleDefun
(assert (! 
;; def=CPS.DoubleDefun.fst(32,8-32,13); use=CPS.DoubleDefun.fst(32,8-32,13)
(forall ((@x0 Term))
 (! (implies (HasType @x0
...
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasType @x1
CPS.DoubleDefun.cont)
(HasType (CPS.DoubleDefun.stack.fuel_instrumented @u0
@x1)
(Prims.list CPS.Expr.expr)))
 

:pattern ((CPS.DoubleDefun.stack.fuel_instrumented @u0
@x1))
:qid token_correspondence_CPS.DoubleDefun.stack.fuel_instrumented))

:named token_correspondence_CPS.DoubleDefun.stack.fuel_instrumented))
;;;;;;;;;;;;;;;;Equation for fuel-instrumented recursive function: CPS.DoubleDefun.stack
;;; Fact-ids: Name CPS.DoubleDefun.stack; Namespace CPS.DoubleDefun
(assert (! 
;; def=CPS.DoubleDefun.fst(32,8-32,13); use=CPS.DoubleDefun.fst(32,8-32,13)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasType @x1
CPS.DoubleDefun.cont)
(= (CPS.DoubleDefun.stack.fuel_instrumented (SFuel @u0)
@x1)
(let ((@lb2 @x1))
(ite (is-CPS.DoubleDefun.C0 @lb2)
(Prims.Nil CPS.Expr.expr)
(ite (is-CPS.DoubleDefun.C1 @lb2)
(CPS.DoubleDefun.stack.fuel_instrumented @u0
(CPS.DoubleDefun.C1__0 @lb2))
(ite (is-CPS.DoubleDefun.C2 @lb2)
(Prims.Cons CPS.Expr.expr
(CPS.DoubleDefun.C2__1 @lb2)
(CPS.DoubleDefun.stack.fuel_instrumented @u0
(CPS.DoubleDefun.C2__0 @lb2)))
Tm_unit))))))
 :weight 0


:pattern ((CPS.DoubleDefun.stack.fuel_instrumented (SFuel @u0)
@x1))
:qid equation_with_fuel_CPS.DoubleDefun.stack.fuel_instrumented))

:named equation_with_fuel_CPS.DoubleDefun.stack.fuel_instrumented))
...
;;;;;;;;;;;;;;;;Assumption: CPS.DoubleDefun.Rstack2
;;; Fact-ids: Name CPS.DoubleDefun.Rstack2; Namespace CPS.DoubleDefun
(assert (! 
;; def=CPS.DoubleDefun.fst(41,16-42,49); use=CPS.DoubleDefun.fst(41,16-42,49)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (implies (and (HasType @x0
CPS.Expr.expr)
(HasType @x1
...
;; def=CPS.DoubleDefun.fst(42,4-42,11); use=CPS.DoubleDefun.fst(42,4-42,11)
(Valid 
;; def=CPS.DoubleDefun.fst(42,4-42,11); use=CPS.DoubleDefun.fst(42,4-42,11)
...
;; def=CPS.DoubleDefun.fst(42,16-42,23); use=CPS.DoubleDefun.fst(42,16-42,23)
(Valid 
;; def=CPS.DoubleDefun.fst(42,16-42,23); use=CPS.DoubleDefun.fst(42,16-42,23)
(Prims.precedes CPS.Expr.expr
CPS.Expr.expr
...
;; def=CPS.DoubleDefun.fst(42,28-42,49); use=CPS.DoubleDefun.fst(42,28-42,49)
(Valid 
;; def=CPS.DoubleDefun.fst(42,28-42,49); use=CPS.DoubleDefun.fst(42,28-42,49)
(Prims.precedes (Prims.list CPS.Expr.expr)
(Prims.list CPS.Expr.expr)
(Prims.Cons CPS.Expr.expr
@x0
(Prims.Cons CPS.Expr.expr
...
:pattern ((Prims.precedes (Prims.list CPS.Expr.expr)
(Prims.list CPS.Expr.expr)
(Prims.Cons CPS.Expr.expr
@x0
(Prims.Cons CPS.Expr.expr
...
@x2
@x3)))
:qid assumption_CPS.DoubleDefun.Rstack2))

:named assumption_CPS.DoubleDefun.Rstack2))
;;;;;;;;;;;;;;;;Assumption: CPS.DoubleDefun.Rstack1
;;; Fact-ids: Name CPS.DoubleDefun.Rstack1; Namespace CPS.DoubleDefun
(assert (! 
;; def=CPS.DoubleDefun.fst(39,16-40,33); use=CPS.DoubleDefun.fst(39,16-40,33)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (implies (and (HasType @x0
CPS.Expr.expr)
(HasType @x1
...
;; def=CPS.DoubleDefun.fst(40,4-40,11); use=CPS.DoubleDefun.fst(40,4-40,11)
(Valid 
;; def=CPS.DoubleDefun.fst(40,4-40,11); use=CPS.DoubleDefun.fst(40,4-40,11)
(Prims.precedes CPS.Expr.expr
CPS.Expr.expr
...
;; def=CPS.DoubleDefun.fst(40,16-40,33); use=CPS.DoubleDefun.fst(40,16-40,33)
(Valid 
;; def=CPS.DoubleDefun.fst(40,16-40,33); use=CPS.DoubleDefun.fst(40,16-40,33)
(Prims.precedes (Prims.list CPS.Expr.expr)
(Prims.list CPS.Expr.expr)
...
@x1
@x2)))
:qid assumption_CPS.DoubleDefun.Rstack1))

:named assumption_CPS.DoubleDefun.Rstack1))
;;;;;;;;;;;;;;;;Assumption: CPS.DoubleDefun.Rstack0
;;; Fact-ids: Name CPS.DoubleDefun.Rstack0; Namespace CPS.DoubleDefun
(assert (! 
;; def=CPS.DoubleDefun.fst(38,16-38,96); use=CPS.DoubleDefun.fst(38,16-38,96)
(forall ((@x0 Term) (@x1 Term))
 (! (implies (and (HasType @x0
CPS.Expr.expr)
(HasType @x1
...
;; def=CPS.DoubleDefun.fst(38,87-38,96); use=CPS.DoubleDefun.fst(38,87-38,96)
(Valid 
;; def=CPS.DoubleDefun.fst(38,87-38,96); use=CPS.DoubleDefun.fst(38,87-38,96)
(Prims.precedes (Prims.list CPS.Expr.expr)
(Prims.list CPS.Expr.expr)
...
@x0
@x1)))
:qid assumption_CPS.DoubleDefun.Rstack0))

:named assumption_CPS.DoubleDefun.Rstack0))
;;;;;;;;;;;;;;;;Fuel irrelevance
;;; Fact-ids: Name CPS.DoubleDefun.stack; Namespace CPS.DoubleDefun
(assert (! 
;; def=CPS.DoubleDefun.fst(32,8-32,13); use=CPS.DoubleDefun.fst(32,8-32,13)
(forall ((@u0 Fuel) (@x1 Term))
 (! (= (CPS.DoubleDefun.stack.fuel_instrumented (SFuel @u0)
@x1)
(CPS.DoubleDefun.stack.fuel_instrumented ZFuel
@x1))
 

:pattern ((CPS.DoubleDefun.stack.fuel_instrumented (SFuel @u0)
@x1))
:qid @fuel_irrelevance_CPS.DoubleDefun.stack.fuel_instrumented))

:named @fuel_irrelevance_CPS.DoubleDefun.stack.fuel_instrumented))
...
(forall ((@x0 Term))
 (! (= (CPS.DoubleDefun.stack @x0)
(CPS.DoubleDefun.stack.fuel_instrumented MaxFuel
@x0))
 

:pattern ((CPS.DoubleDefun.stack @x0))
:qid @fuel_correspondence_CPS.DoubleDefun.stack.fuel_instrumented))

:named @fuel_correspondence_CPS.DoubleDefun.stack.fuel_instrumented))
(push) ;; push{2

; Starting query at CPS.DoubleDefun.fst(47,22-50,37)

;;;;;;;;;;;;;;;;e : CPS.Expr.expr (CPS.Expr.expr)
(declare-fun x_0c607185f6c6768f1786fe5f14f15ea1_0 () Term)
;;;;;;;;;;;;;;;;binder_x_0c607185f6c6768f1786fe5f14f15ea1_0
;;; Fact-ids: 
(assert (! (HasType x_0c607185f6c6768f1786fe5f14f15ea1_0
CPS.Expr.expr)
:named binder_x_0c607185f6c6768f1786fe5f14f15ea1_0))
;;;;;;;;;;;;;;;;k : CPS.DoubleDefun.cont (CPS.DoubleDefun.cont)
(declare-fun x_fc08148c0a56a96633a93ae5c4e7943e_1 () Term)
;;;;;;;;;;;;;;;;binder_x_fc08148c0a56a96633a93ae5c4e7943e_1
;;; Fact-ids: 
(assert (! (HasType x_fc08148c0a56a96633a93ae5c4e7943e_1
CPS.DoubleDefun.cont)
:named binder_x_fc08148c0a56a96633a93ae5c4e7943e_1))
...
(declare-fun Tm_refine_42b045a3ade35d2e650fece9377d09ac (Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=CPS.DoubleDefun.fst(44,60-50,37); use=CPS.DoubleDefun.fst(45,25-52,12)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_42b045a3ade35d2e650fece9377d09ac @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_42b045a3ade35d2e650fece9377d09ac @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_42b045a3ade35d2e650fece9377d09ac))

:named refinement_kinding_Tm_refine_42b045a3ade35d2e650fece9377d09ac))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=CPS.DoubleDefun.fst(44,60-50,37); use=CPS.DoubleDefun.fst(45,25-52,12)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_42b045a3ade35d2e650fece9377d09ac @x2))
(and (HasTypeFuel @u0
@x1
CPS.DoubleDefun.cont)

;; def=CPS.DoubleDefun.fst(44,60-50,37); use=CPS.DoubleDefun.fst(45,69-52,12)

;; def=CPS.DoubleDefun.fst(44,60-50,37); use=CPS.DoubleDefun.fst(45,69-52,12)
(or 
;; def=CPS.DoubleDefun.fst(47,22-50,37); use=CPS.DoubleDefun.fst(47,22-50,37)
(Valid 
;; def=CPS.DoubleDefun.fst(47,22-50,37); use=CPS.DoubleDefun.fst(47,22-50,37)
(Prims.precedes (Prims.list CPS.Expr.expr)
(Prims.list CPS.Expr.expr)
...
(CPS.DoubleDefun.stack @x1))
(Prims.Cons CPS.Expr.expr
x_0c607185f6c6768f1786fe5f14f15ea1_0
(CPS.DoubleDefun.stack x_fc08148c0a56a96633a93ae5c4e7943e_1)))
)


;; def=CPS.DoubleDefun.fst(44,60-50,37); use=CPS.DoubleDefun.fst(45,69-52,12)
(and 
;; def=CPS.DoubleDefun.fst(44,60-45,68); use=CPS.DoubleDefun.fst(47,8-52,12)
(Valid 
;; def=CPS.DoubleDefun.fst(44,60-45,68); use=CPS.DoubleDefun.fst(47,8-52,12)
(Prims.op_Equals_Equals_Equals (Prims.list CPS.Expr.expr)
(Prims.list CPS.Expr.expr)
(Prims.Cons CPS.Expr.expr
@x2
(CPS.DoubleDefun.stack @x1))
...
;; def=CPS.DoubleDefun.fst(45,25-50,37); use=CPS.DoubleDefun.fst(45,69-50,37)
(or 
;; def=CPS.DoubleDefun.fst(47,22-50,37); use=CPS.DoubleDefun.fst(47,22-50,37)
(Valid 
;; def=CPS.DoubleDefun.fst(47,22-50,37); use=CPS.DoubleDefun.fst(47,22-50,37)
...
CPS.DoubleDefun.cont
@x1
x_fc08148c0a56a96633a93ae5c4e7943e_1)
)


;; def=CPS.DoubleDefun.fst(45,25-50,37); use=CPS.DoubleDefun.fst(45,69-50,37)
(and 
;; def=CPS.DoubleDefun.fst(45,25-47,17); use=CPS.DoubleDefun.fst(45,69-47,17)
(Valid 
;; def=CPS.DoubleDefun.fst(45,25-47,17); use=CPS.DoubleDefun.fst(45,69-47,17)
(Prims.op_Equals_Equals_Equals CPS.DoubleDefun.cont
CPS.DoubleDefun.cont
@x1
x_fc08148c0a56a96633a93ae5c4e7943e_1)
)
...
@x1
(Tm_refine_42b045a3ade35d2e650fece9377d09ac @x2)))
:qid refinement_interpretation_Tm_refine_42b045a3ade35d2e650fece9377d09ac))

:named refinement_interpretation_Tm_refine_42b045a3ade35d2e650fece9377d09ac))
;;;;;;;;;;;;;;;;haseq for Tm_refine_42b045a3ade35d2e650fece9377d09ac
;;; Fact-ids: 
(assert (! 
;; def=CPS.DoubleDefun.fst(44,60-50,37); use=CPS.DoubleDefun.fst(45,25-52,12)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_42b045a3ade35d2e650fece9377d09ac @x0)))
(Valid (Prims.hasEq CPS.DoubleDefun.cont)))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_42b045a3ade35d2e650fece9377d09ac @x0))))
:qid haseqTm_refine_42b045a3ade35d2e650fece9377d09ac))

:named haseqTm_refine_42b045a3ade35d2e650fece9377d09ac))
(declare-fun CPS.DoubleDefun.eval_cps (Term Term) Term)

;;;;;;;;;;;;;;;;e: CPS.Expr.expr ->     k:       cont         { e :: stack k << e :: stack k \/           e :: stack k === e :: stack k /\ (k << k \/ k === k /\ 1 << 0) }   -> Prims.Tot Prims.int
(declare-fun Tm_arrow_832c411667643d78b053d7f0c30e7a2b () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_832c411667643d78b053d7f0c30e7a2b
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_832c411667643d78b053d7f0c30e7a2b
Tm_type)
:named kinding_Tm_arrow_832c411667643d78b053d7f0c30e7a2b))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=CPS.DoubleDefun.fst(44,60-50,37); use=CPS.DoubleDefun.fst(45,25-52,12)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_832c411667643d78b053d7f0c30e7a2b)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_832c411667643d78b053d7f0c30e7a2b))
:qid CPS.DoubleDefun_pre_typing_Tm_arrow_832c411667643d78b053d7f0c30e7a2b))

:named CPS.DoubleDefun_pre_typing_Tm_arrow_832c411667643d78b053d7f0c30e7a2b))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_832c411667643d78b053d7f0c30e7a2b
;;; Fact-ids: 
(assert (! 
;; def=CPS.DoubleDefun.fst(44,60-50,37); use=CPS.DoubleDefun.fst(45,25-52,12)
(forall ((@x0 Term))
...
CPS.Expr.expr)
(HasType @x2
(Tm_refine_42b045a3ade35d2e650fece9377d09ac @x1)))
...
@x1)
@x2))
:qid CPS.DoubleDefun_interpretation_Tm_arrow_832c411667643d78b053d7f0c30e7a2b.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid CPS.DoubleDefun_interpretation_Tm_arrow_832c411667643d78b053d7f0c30e7a2b.2))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_832c411667643d78b053d7f0c30e7a2b))
:qid CPS.DoubleDefun_interpretation_Tm_arrow_832c411667643d78b053d7f0c30e7a2b))

:named CPS.DoubleDefun_interpretation_Tm_arrow_832c411667643d78b053d7f0c30e7a2b))
(declare-fun CPS.DoubleDefun.eval_cps@tok () Term)
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: 
(assert (! 
;; def=CPS.DoubleDefun.fst(52,4-52,12); use=CPS.DoubleDefun.fst(52,4-52,12)
(forall ((@x0 Term) (@x1 Term))
 (! (= (ApplyTT (ApplyTT CPS.DoubleDefun.eval_cps@tok
@x0)
@x1)
(CPS.DoubleDefun.eval_cps @x0
@x1))
 

:pattern ((ApplyTT (ApplyTT CPS.DoubleDefun.eval_cps@tok
@x0)
@x1))
:qid token_correspondence_CPS.DoubleDefun.eval_cps))

:named token_correspondence_CPS.DoubleDefun.eval_cps))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: 
(assert (! 
;; def=CPS.DoubleDefun.fst(52,4-52,12); use=CPS.DoubleDefun.fst(52,4-52,12)
(forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType CPS.DoubleDefun.eval_cps@tok
Tm_arrow_832c411667643d78b053d7f0c30e7a2b))
...
@x1)
@x2)
(CPS.DoubleDefun.eval_cps @x1
@x2))
 

:pattern ((CPS.DoubleDefun.eval_cps @x1
@x2))
:qid function_token_typing_CPS.DoubleDefun.eval_cps.1))
)
 

:pattern ((ApplyTT @x0
CPS.DoubleDefun.eval_cps@tok))
:qid function_token_typing_CPS.DoubleDefun.eval_cps))

:named function_token_typing_CPS.DoubleDefun.eval_cps))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: 
(assert (! 
;; def=CPS.DoubleDefun.fst(52,4-52,12); use=CPS.DoubleDefun.fst(52,4-52,12)
...
CPS.Expr.expr)
(HasType @x1
(Tm_refine_42b045a3ade35d2e650fece9377d09ac @x0)))
(HasType (CPS.DoubleDefun.eval_cps @x0
@x1)
Prims.int))
 

:pattern ((CPS.DoubleDefun.eval_cps @x0
@x1))
:qid typing_CPS.DoubleDefun.eval_cps))

:named typing_CPS.DoubleDefun.eval_cps))
(declare-fun Tm_refine_8398e6fc44c0d68814870732b0cb57f5 (Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=CPS.DoubleDefun.fst(44,22-50,37); use=CPS.DoubleDefun.fst(44,73-50,37)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_refine_8398e6fc44c0d68814870732b0cb57f5 @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_refine_8398e6fc44c0d68814870732b0cb57f5 @x0
@x1)
Tm_type))
:qid refinement_kinding_Tm_refine_8398e6fc44c0d68814870732b0cb57f5))

:named refinement_kinding_Tm_refine_8398e6fc44c0d68814870732b0cb57f5))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=CPS.DoubleDefun.fst(44,22-50,37); use=CPS.DoubleDefun.fst(44,73-50,37)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_8398e6fc44c0d68814870732b0cb57f5 @x2
@x3))
(and (HasTypeFuel @u0
@x1
Prims.int)
...
;; def=CPS.DoubleDefun.fst(44,22-50,37); use=CPS.DoubleDefun.fst(44,73-50,37)
(and 
;; def=CPS.DoubleDefun.fst(44,60-44,72); use=CPS.DoubleDefun.fst(47,8-47,13)
(Valid 
;; def=CPS.DoubleDefun.fst(44,60-44,72); use=CPS.DoubleDefun.fst(47,8-47,13)
(Prims.op_Equals_Equals_Equals (Prims.list CPS.Expr.expr)
(Prims.list CPS.Expr.expr)
...
;; def=CPS.DoubleDefun.fst(44,22-50,37); use=CPS.DoubleDefun.fst(44,73-50,37)
(and 
;; def=CPS.DoubleDefun.fst(44,22-47,17); use=CPS.DoubleDefun.fst(44,73-47,17)
(Valid 
;; def=CPS.DoubleDefun.fst(44,22-47,17); use=CPS.DoubleDefun.fst(44,73-47,17)
(Prims.op_Equals_Equals_Equals CPS.DoubleDefun.cont
CPS.DoubleDefun.cont
...
(Tm_refine_8398e6fc44c0d68814870732b0cb57f5 @x2
@x3)))
:qid refinement_interpretation_Tm_refine_8398e6fc44c0d68814870732b0cb57f5))

:named refinement_interpretation_Tm_refine_8398e6fc44c0d68814870732b0cb57f5))
;;;;;;;;;;;;;;;;haseq for Tm_refine_8398e6fc44c0d68814870732b0cb57f5
;;; Fact-ids: 
(assert (! 
;; def=CPS.DoubleDefun.fst(44,22-50,37); use=CPS.DoubleDefun.fst(44,73-50,37)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_8398e6fc44c0d68814870732b0cb57f5 @x0
@x1)))
(Valid (Prims.hasEq Prims.int)))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_8398e6fc44c0d68814870732b0cb57f5 @x0
@x1))))
:qid haseqTm_refine_8398e6fc44c0d68814870732b0cb57f5))

:named haseqTm_refine_8398e6fc44c0d68814870732b0cb57f5))
(declare-fun CPS.DoubleDefun.apply (Term Term Term) Term)

;;;;;;;;;;;;;;;;e: CPS.Expr.expr ->     k: cont ->     _:       _:       Prims.int         { e :: stack k << e :: stack k \/           e :: stack k === e :: stack k /\ (k << k \/ k === k /\ 0 << 0) }   -> Prims.Tot Prims.int
(declare-fun Tm_arrow_26408d8536cd579eaa630931329dca2c () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_26408d8536cd579eaa630931329dca2c
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_26408d8536cd579eaa630931329dca2c
Tm_type)
:named kinding_Tm_arrow_26408d8536cd579eaa630931329dca2c))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=CPS.DoubleDefun.fst(44,14-50,37); use=CPS.DoubleDefun.fst(44,73-50,37)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_26408d8536cd579eaa630931329dca2c)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_26408d8536cd579eaa630931329dca2c))
:qid CPS.DoubleDefun_pre_typing_Tm_arrow_26408d8536cd579eaa630931329dca2c))

:named CPS.DoubleDefun_pre_typing_Tm_arrow_26408d8536cd579eaa630931329dca2c))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_26408d8536cd579eaa630931329dca2c
;;; Fact-ids: 
(assert (! 
;; def=CPS.DoubleDefun.fst(44,14-50,37); use=CPS.DoubleDefun.fst(44,73-50,37)
(forall ((@x0 Term))
...
CPS.DoubleDefun.cont)
(HasType @x3
(Tm_refine_8398e6fc44c0d68814870732b0cb57f5 @x1
@x2)))
...
@x2)
@x3))
:qid CPS.DoubleDefun_interpretation_Tm_arrow_26408d8536cd579eaa630931329dca2c.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid CPS.DoubleDefun_interpretation_Tm_arrow_26408d8536cd579eaa630931329dca2c.2))
...
@x1)
@x2))
:qid CPS.DoubleDefun_interpretation_Tm_arrow_26408d8536cd579eaa630931329dca2c.3))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_26408d8536cd579eaa630931329dca2c))
:qid CPS.DoubleDefun_interpretation_Tm_arrow_26408d8536cd579eaa630931329dca2c))

:named CPS.DoubleDefun_interpretation_Tm_arrow_26408d8536cd579eaa630931329dca2c))
(declare-fun CPS.DoubleDefun.apply@tok () Term)
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: 
(assert (! 
;; def=CPS.DoubleDefun.fst(47,8-47,13); use=CPS.DoubleDefun.fst(47,8-47,13)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (ApplyTT (ApplyTT (ApplyTT CPS.DoubleDefun.apply@tok
@x0)
@x1)
@x2)
(CPS.DoubleDefun.apply @x0
@x1
@x2))
 

:pattern ((ApplyTT (ApplyTT (ApplyTT CPS.DoubleDefun.apply@tok
@x0)
@x1)
@x2))
:qid token_correspondence_CPS.DoubleDefun.apply))

:named token_correspondence_CPS.DoubleDefun.apply))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: 
(assert (! 
;; def=CPS.DoubleDefun.fst(47,8-47,13); use=CPS.DoubleDefun.fst(47,8-47,13)
(forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType CPS.DoubleDefun.apply@tok
Tm_arrow_26408d8536cd579eaa630931329dca2c))
...
@x2)
@x3)
(CPS.DoubleDefun.apply @x1
@x2
@x3))
 

:pattern ((CPS.DoubleDefun.apply @x1
@x2
@x3))
:qid function_token_typing_CPS.DoubleDefun.apply.1))
)
 

:pattern ((ApplyTT @x0
CPS.DoubleDefun.apply@tok))
:qid function_token_typing_CPS.DoubleDefun.apply))

:named function_token_typing_CPS.DoubleDefun.apply))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: 
(assert (! 
;; def=CPS.DoubleDefun.fst(47,8-47,13); use=CPS.DoubleDefun.fst(47,8-47,13)
...
CPS.DoubleDefun.cont)
(HasType @x2
(Tm_refine_8398e6fc44c0d68814870732b0cb57f5 @x0
@x1)))
(HasType (CPS.DoubleDefun.apply @x0
@x1
@x2)
Prims.int))
 

:pattern ((CPS.DoubleDefun.apply @x0
@x1
@x2))
:qid typing_CPS.DoubleDefun.apply))

:named typing_CPS.DoubleDefun.apply))
(declare-fun label_3 () Bool)
(declare-fun label_2 () Bool)
(declare-fun label_1 () Bool)
...
;   (~(C0? k) /\ ~(C1? k) /\ ~(C2? k) ==> Prims.l_False) /\
;   (~(C0? k) ==>
;     (forall (b: CPS.DoubleDefun.cont) (b: Prims.int).
;         k == CPS.DoubleDefun.C1 b b ==>
;         e :: CPS.DoubleDefun.stack b << e :: CPS.DoubleDefun.stack k \/
;         e :: CPS.DoubleDefun.stack b === e :: CPS.DoubleDefun.stack k /\
;         (b << k \/ b === k /\ 0 << 0)) /\
;     (~(C1? k) ==>
;       (forall (b: CPS.DoubleDefun.cont) (b: CPS.Expr.expr).
;           k == CPS.DoubleDefun.C2 b b ==>
;           b :: CPS.DoubleDefun.stack (CPS.DoubleDefun.C1 b r) << e :: CPS.DoubleDefun.stack k \/
;           b :: CPS.DoubleDefun.stack (CPS.DoubleDefun.C1 b r) === e :: CPS.DoubleDefun.stack k /\
;           (CPS.DoubleDefun.C1 b r << k \/ CPS.DoubleDefun.C1 b r === k /\ 1 << 0))))


; Context: While encoding a query
; While typechecking the top-level declaration `let rec apply and eval_cps`
...
;; def=Prims.fst(402,27-402,88); use=CPS.DoubleDefun.fst(47,22-50,37)
(forall ((@x1 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=CPS.DoubleDefun.fst(47,22-50,37)
(Valid 
;; def=Prims.fst(402,84-402,87); use=CPS.DoubleDefun.fst(47,22-50,37)
(ApplyTT @x0
@x1)
...
;; def=Prims.fst(459,77-459,89); use=CPS.DoubleDefun.fst(47,22-50,37)
(and (implies 
;; def=CPS.DoubleDefun.fst(47,16-47,17); use=CPS.DoubleDefun.fst(47,28-47,29)
(and 
;; def=CPS.DoubleDefun.fst(47,16-47,17); use=CPS.DoubleDefun.fst(47,28-47,29)
(not 
;; def=CPS.DoubleDefun.fst(47,16-47,17); use=CPS.DoubleDefun.fst(47,28-47,29)
(BoxBool_proj_0 (CPS.DoubleDefun.uu___is_C0 x_fc08148c0a56a96633a93ae5c4e7943e_1))
)
...
(not 
;; def=CPS.DoubleDefun.fst(47,16-47,17); use=CPS.DoubleDefun.fst(47,28-47,29)
(BoxBool_proj_0 (CPS.DoubleDefun.uu___is_C1 x_fc08148c0a56a96633a93ae5c4e7943e_1))
)
...
(not 
;; def=CPS.DoubleDefun.fst(47,16-47,17); use=CPS.DoubleDefun.fst(47,28-47,29)
(BoxBool_proj_0 (CPS.DoubleDefun.uu___is_C2 x_fc08148c0a56a96633a93ae5c4e7943e_1))
)
)

label_1)
(implies 
;; def=Prims.fst(389,19-389,21); use=CPS.DoubleDefun.fst(47,22-50,37)
(not 
;; def=CPS.DoubleDefun.fst(47,16-47,17); use=CPS.DoubleDefun.fst(47,28-47,29)
(BoxBool_proj_0 (CPS.DoubleDefun.uu___is_C0 x_fc08148c0a56a96633a93ae5c4e7943e_1))
)
...
;; def=Prims.fst(389,2-389,39); use=CPS.DoubleDefun.fst(47,22-50,37)
(and 
;; def=Prims.fst(413,99-413,120); use=CPS.DoubleDefun.fst(47,22-50,37)
(forall ((@x1 Term))
 (! (implies (HasType @x1
CPS.DoubleDefun.cont)
...
;; def=CPS.DoubleDefun.fst(47,16-49,13); use=CPS.DoubleDefun.fst(47,28-49,13)
(= x_fc08148c0a56a96633a93ae5c4e7943e_1
(CPS.DoubleDefun.C1 @x1
@x2))
)

;; def=CPS.DoubleDefun.fst(44,22-50,37); use=CPS.DoubleDefun.fst(49,27-49,35)
(or label_2

;; def=CPS.DoubleDefun.fst(47,22-50,37); use=CPS.DoubleDefun.fst(49,27-49,35)
(Valid 
;; def=CPS.DoubleDefun.fst(47,22-50,37); use=CPS.DoubleDefun.fst(49,27-49,35)
(Prims.precedes (Prims.list CPS.Expr.expr)
(Prims.list CPS.Expr.expr)
...
;; def=CPS.DoubleDefun.fst(44,22-50,37); use=CPS.DoubleDefun.fst(49,27-49,35)
(and 
;; def=CPS.DoubleDefun.fst(44,60-44,72); use=CPS.DoubleDefun.fst(49,27-49,35)
(Valid 
;; def=CPS.DoubleDefun.fst(44,60-44,72); use=CPS.DoubleDefun.fst(49,27-49,35)
(Prims.op_Equals_Equals_Equals (Prims.list CPS.Expr.expr)
(Prims.list CPS.Expr.expr)
...
;; def=CPS.DoubleDefun.fst(44,22-50,37); use=CPS.DoubleDefun.fst(49,27-49,35)
(and 
;; def=CPS.DoubleDefun.fst(44,22-47,17); use=CPS.DoubleDefun.fst(49,27-49,35)
(Valid 
;; def=CPS.DoubleDefun.fst(44,22-47,17); use=CPS.DoubleDefun.fst(49,27-49,35)
(Prims.op_Equals_Equals_Equals CPS.DoubleDefun.cont
CPS.DoubleDefun.cont
...
;; def=CPS.DoubleDefun.fst(47,16-50,13); use=CPS.DoubleDefun.fst(47,28-50,13)
(= x_fc08148c0a56a96633a93ae5c4e7943e_1
(CPS.DoubleDefun.C2 @x1
@x2))
)

;; def=CPS.DoubleDefun.fst(44,60-50,37); use=CPS.DoubleDefun.fst(50,29-50,37)
(or label_3

;; def=CPS.DoubleDefun.fst(47,22-50,37); use=CPS.DoubleDefun.fst(50,29-50,37)
(Valid 
;; def=CPS.DoubleDefun.fst(47,22-50,37); use=CPS.DoubleDefun.fst(50,29-50,37)
(Prims.precedes (Prims.list CPS.Expr.expr)
(Prims.list CPS.Expr.expr)
(Prims.Cons CPS.Expr.expr
@x2
(CPS.DoubleDefun.stack (CPS.DoubleDefun.C1 @x1
...
;; def=CPS.DoubleDefun.fst(44,60-50,37); use=CPS.DoubleDefun.fst(50,29-50,37)
(and 
;; def=CPS.DoubleDefun.fst(44,60-45,68); use=CPS.DoubleDefun.fst(50,29-50,37)
(Valid 
;; def=CPS.DoubleDefun.fst(44,60-45,68); use=CPS.DoubleDefun.fst(50,29-50,37)
(Prims.op_Equals_Equals_Equals (Prims.list CPS.Expr.expr)
(Prims.list CPS.Expr.expr)
...
;; def=CPS.DoubleDefun.fst(45,25-50,37); use=CPS.DoubleDefun.fst(50,29-50,37)
(or 
;; def=CPS.DoubleDefun.fst(47,22-50,37); use=CPS.DoubleDefun.fst(50,29-50,37)
(Valid 
;; def=CPS.DoubleDefun.fst(47,22-50,37); use=CPS.DoubleDefun.fst(50,29-50,37)
...
;; def=CPS.DoubleDefun.fst(45,25-50,37); use=CPS.DoubleDefun.fst(50,29-50,37)
(and 
;; def=CPS.DoubleDefun.fst(45,25-47,17); use=CPS.DoubleDefun.fst(50,29-50,37)
(Valid 
;; def=CPS.DoubleDefun.fst(45,25-47,17); use=CPS.DoubleDefun.fst(50,29-50,37)
(Prims.op_Equals_Equals_Equals CPS.DoubleDefun.cont
CPS.DoubleDefun.cont
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (CPS.DoubleDefun.apply, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxFuel_assumption, @MaxIFuel_assumption, @fuel_correspondence_CPS.DoubleDefun.stack.fuel_instrumented, @fuel_irrelevance_CPS.DoubleDefun.stack.fuel_instrumented, @query, CPS.DoubleDefun_pretyping_fc08148c0a56a96633a93ae5c4e7943e, CPS.Expr_pretyping_0c607185f6c6768f1786fe5f14f15ea1, assumption_CPS.DoubleDefun.Rstack0, binder_x_0c607185f6c6768f1786fe5f14f15ea1_0, binder_x_ae567c2fb75be05905677af440075565_2, binder_x_fc08148c0a56a96633a93ae5c4e7943e_1, constructor_distinct_CPS.DoubleDefun.C1, constructor_distinct_CPS.DoubleDefun.C2, data_typing_intro_CPS.DoubleDefun.C0@tok, data_typing_intro_CPS.DoubleDefun.C1@tok, disc_equation_CPS.DoubleDefun.C0, disc_equation_CPS.DoubleDefun.C1, disc_equation_CPS.DoubleDefun.C2, equation_Prims.op_Equals_Equals_Equals, equation_with_fuel_CPS.DoubleDefun.stack.fuel_instrumented, fuel_guarded_inversion_CPS.DoubleDefun.cont, int_inversion, projection_inverse_BoxBool_proj_0, projection_inverse_CPS.DoubleDefun.C1__0, projection_inverse_CPS.DoubleDefun.C1__1, projection_inverse_CPS.DoubleDefun.C2__0, projection_inverse_CPS.DoubleDefun.C2__1, subterm_ordering_CPS.DoubleDefun.C1, typing_CPS.DoubleDefun.stack
...
; Starting query at CPS.DoubleDefun.fst(53,2-55,41)
...
CPS.DoubleDefun.cont)
:named binder_x_fc08148c0a56a96633a93ae5c4e7943e_1))
(declare-fun Tm_refine_c9870ac7931c6de68809eea50be0a435 (Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=CPS.DoubleDefun.fst(45,25-55,41); use=CPS.DoubleDefun.fst(45,25-55,41)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_c9870ac7931c6de68809eea50be0a435 @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_c9870ac7931c6de68809eea50be0a435 @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_c9870ac7931c6de68809eea50be0a435))

:named refinement_kinding_Tm_refine_c9870ac7931c6de68809eea50be0a435))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=CPS.DoubleDefun.fst(45,25-55,41); use=CPS.DoubleDefun.fst(45,25-55,41)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_c9870ac7931c6de68809eea50be0a435 @x2))
(and (HasTypeFuel @u0
@x1
CPS.DoubleDefun.cont)

;; def=CPS.DoubleDefun.fst(45,25-55,41); use=CPS.DoubleDefun.fst(45,69-55,41)

;; def=CPS.DoubleDefun.fst(45,25-55,41); use=CPS.DoubleDefun.fst(45,69-55,41)
(or 
;; def=CPS.DoubleDefun.fst(53,2-55,41); use=CPS.DoubleDefun.fst(53,2-55,41)
(Valid 
;; def=CPS.DoubleDefun.fst(53,2-55,41); use=CPS.DoubleDefun.fst(53,2-55,41)
(Prims.precedes (Prims.list CPS.Expr.expr)
(Prims.list CPS.Expr.expr)
...
;; def=CPS.DoubleDefun.fst(45,25-55,41); use=CPS.DoubleDefun.fst(45,69-55,41)
(and 
;; def=CPS.DoubleDefun.fst(45,56-45,68); use=CPS.DoubleDefun.fst(52,4-52,12)
(Valid 
;; def=CPS.DoubleDefun.fst(45,56-45,68); use=CPS.DoubleDefun.fst(52,4-52,12)
(Prims.op_Equals_Equals_Equals (Prims.list CPS.Expr.expr)
(Prims.list CPS.Expr.expr)
...
;; def=CPS.DoubleDefun.fst(45,25-55,41); use=CPS.DoubleDefun.fst(45,69-55,41)
(and 
;; def=CPS.DoubleDefun.fst(45,25-52,16); use=CPS.DoubleDefun.fst(45,69-52,16)
(Valid 
;; def=CPS.DoubleDefun.fst(45,25-52,16); use=CPS.DoubleDefun.fst(45,69-52,16)
(Prims.op_Equals_Equals_Equals CPS.DoubleDefun.cont
CPS.DoubleDefun.cont
...
@x1
(Tm_refine_c9870ac7931c6de68809eea50be0a435 @x2)))
:qid refinement_interpretation_Tm_refine_c9870ac7931c6de68809eea50be0a435))

:named refinement_interpretation_Tm_refine_c9870ac7931c6de68809eea50be0a435))
;;;;;;;;;;;;;;;;haseq for Tm_refine_c9870ac7931c6de68809eea50be0a435
;;; Fact-ids: 
(assert (! 
;; def=CPS.DoubleDefun.fst(45,25-55,41); use=CPS.DoubleDefun.fst(45,25-55,41)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_c9870ac7931c6de68809eea50be0a435 @x0)))
(Valid (Prims.hasEq CPS.DoubleDefun.cont)))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_c9870ac7931c6de68809eea50be0a435 @x0))))
:qid haseqTm_refine_c9870ac7931c6de68809eea50be0a435))

:named haseqTm_refine_c9870ac7931c6de68809eea50be0a435))
(declare-fun CPS.DoubleDefun.eval_cps (Term Term) Term)

;;;;;;;;;;;;;;;;e: CPS.Expr.expr ->     k:       cont         { e :: stack k << e :: stack k \/           e :: stack k === e :: stack k /\ (k << k \/ k === k /\ 1 << 1) }   -> Prims.Tot Prims.int
(declare-fun Tm_arrow_a7faf1587ae2ca66587d3528583f4f53 () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_a7faf1587ae2ca66587d3528583f4f53
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_a7faf1587ae2ca66587d3528583f4f53
Tm_type)
:named kinding_Tm_arrow_a7faf1587ae2ca66587d3528583f4f53))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=CPS.DoubleDefun.fst(45,17-55,41); use=CPS.DoubleDefun.fst(45,25-55,41)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_a7faf1587ae2ca66587d3528583f4f53)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_a7faf1587ae2ca66587d3528583f4f53))
:qid CPS.DoubleDefun_pre_typing_Tm_arrow_a7faf1587ae2ca66587d3528583f4f53))

:named CPS.DoubleDefun_pre_typing_Tm_arrow_a7faf1587ae2ca66587d3528583f4f53))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_a7faf1587ae2ca66587d3528583f4f53
;;; Fact-ids: 
(assert (! 
;; def=CPS.DoubleDefun.fst(45,17-55,41); use=CPS.DoubleDefun.fst(45,25-55,41)
(forall ((@x0 Term))
...
CPS.Expr.expr)
(HasType @x2
(Tm_refine_c9870ac7931c6de68809eea50be0a435 @x1)))
(HasType (ApplyTT (ApplyTT @x0
@x1)
@x2)
Prims.int))
...
@x1)
@x2))
:qid CPS.DoubleDefun_interpretation_Tm_arrow_a7faf1587ae2ca66587d3528583f4f53.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid CPS.DoubleDefun_interpretation_Tm_arrow_a7faf1587ae2ca66587d3528583f4f53.2))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_a7faf1587ae2ca66587d3528583f4f53))
:qid CPS.DoubleDefun_interpretation_Tm_arrow_a7faf1587ae2ca66587d3528583f4f53))

:named CPS.DoubleDefun_interpretation_Tm_arrow_a7faf1587ae2ca66587d3528583f4f53))
(declare-fun CPS.DoubleDefun.eval_cps@tok () Term)
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: 
(assert (! 
...
CPS.Expr.expr)
(HasType @x1
(Tm_refine_c9870ac7931c6de68809eea50be0a435 @x0)))
(HasType (CPS.DoubleDefun.eval_cps @x0
@x1)
Prims.int))
...
:named typing_CPS.DoubleDefun.eval_cps))
(declare-fun Tm_refine_6b4cc0880a1b7e772907ef17573af4d4 (Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=CPS.DoubleDefun.fst(44,22-55,41); use=CPS.DoubleDefun.fst(44,73-55,41)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_refine_6b4cc0880a1b7e772907ef17573af4d4 @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_refine_6b4cc0880a1b7e772907ef17573af4d4 @x0
@x1)
Tm_type))
:qid refinement_kinding_Tm_refine_6b4cc0880a1b7e772907ef17573af4d4))

:named refinement_kinding_Tm_refine_6b4cc0880a1b7e772907ef17573af4d4))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=CPS.DoubleDefun.fst(44,22-55,41); use=CPS.DoubleDefun.fst(44,73-55,41)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_6b4cc0880a1b7e772907ef17573af4d4 @x2
@x3))
(and (HasTypeFuel @u0
@x1
Prims.int)
...
;; def=CPS.DoubleDefun.fst(44,22-55,41); use=CPS.DoubleDefun.fst(44,73-55,41)
(and 
;; def=CPS.DoubleDefun.fst(44,22-52,16); use=CPS.DoubleDefun.fst(44,73-52,16)
(Valid 
;; def=CPS.DoubleDefun.fst(44,22-52,16); use=CPS.DoubleDefun.fst(44,73-52,16)
(Prims.op_Equals_Equals_Equals CPS.DoubleDefun.cont
CPS.DoubleDefun.cont
...
(Tm_refine_6b4cc0880a1b7e772907ef17573af4d4 @x2
@x3)))
:qid refinement_interpretation_Tm_refine_6b4cc0880a1b7e772907ef17573af4d4))

:named refinement_interpretation_Tm_refine_6b4cc0880a1b7e772907ef17573af4d4))
;;;;;;;;;;;;;;;;haseq for Tm_refine_6b4cc0880a1b7e772907ef17573af4d4
;;; Fact-ids: 
(assert (! 
;; def=CPS.DoubleDefun.fst(44,22-55,41); use=CPS.DoubleDefun.fst(44,73-55,41)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_6b4cc0880a1b7e772907ef17573af4d4 @x0
@x1)))
(Valid (Prims.hasEq Prims.int)))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_6b4cc0880a1b7e772907ef17573af4d4 @x0
@x1))))
:qid haseqTm_refine_6b4cc0880a1b7e772907ef17573af4d4))

:named haseqTm_refine_6b4cc0880a1b7e772907ef17573af4d4))
(declare-fun CPS.DoubleDefun.apply (Term Term Term) Term)

;;;;;;;;;;;;;;;;e: CPS.Expr.expr ->     k: cont ->     _:       _:       Prims.int         { e :: stack k << e :: stack k \/           e :: stack k === e :: stack k /\ (k << k \/ k === k /\ 0 << 1) }   -> Prims.Tot Prims.int
(declare-fun Tm_arrow_a23654ce4e1ebb152f20dca661c219f5 () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_a23654ce4e1ebb152f20dca661c219f5
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_a23654ce4e1ebb152f20dca661c219f5
Tm_type)
:named kinding_Tm_arrow_a23654ce4e1ebb152f20dca661c219f5))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=CPS.DoubleDefun.fst(44,14-55,41); use=CPS.DoubleDefun.fst(44,73-55,41)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_a23654ce4e1ebb152f20dca661c219f5)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_a23654ce4e1ebb152f20dca661c219f5))
:qid CPS.DoubleDefun_pre_typing_Tm_arrow_a23654ce4e1ebb152f20dca661c219f5))

:named CPS.DoubleDefun_pre_typing_Tm_arrow_a23654ce4e1ebb152f20dca661c219f5))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_a23654ce4e1ebb152f20dca661c219f5
;;; Fact-ids: 
(assert (! 
;; def=CPS.DoubleDefun.fst(44,14-55,41); use=CPS.DoubleDefun.fst(44,73-55,41)
(forall ((@x0 Term))
...
CPS.DoubleDefun.cont)
(HasType @x3
(Tm_refine_6b4cc0880a1b7e772907ef17573af4d4 @x1
@x2)))
(HasType (ApplyTT (ApplyTT (ApplyTT @x0
@x1)
@x2)
...
@x2)
@x3))
:qid CPS.DoubleDefun_interpretation_Tm_arrow_a23654ce4e1ebb152f20dca661c219f5.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid CPS.DoubleDefun_interpretation_Tm_arrow_a23654ce4e1ebb152f20dca661c219f5.2))
...
@x1)
@x2))
:qid CPS.DoubleDefun_interpretation_Tm_arrow_a23654ce4e1ebb152f20dca661c219f5.3))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_a23654ce4e1ebb152f20dca661c219f5))
:qid CPS.DoubleDefun_interpretation_Tm_arrow_a23654ce4e1ebb152f20dca661c219f5))

:named CPS.DoubleDefun_interpretation_Tm_arrow_a23654ce4e1ebb152f20dca661c219f5))
(declare-fun CPS.DoubleDefun.apply@tok () Term)
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: 
(assert (! 
...
CPS.DoubleDefun.cont)
(HasType @x2
(Tm_refine_6b4cc0880a1b7e772907ef17573af4d4 @x0
@x1)))
(HasType (CPS.DoubleDefun.apply @x0
@x1
@x2)
...
;   (forall (b: Prims.int).
;       e == CPS.Expr.Const b ==>
;       e :: CPS.DoubleDefun.stack k << e :: CPS.DoubleDefun.stack k \/ (k << k \/ 0 << 1)) /\
;   (~(Const? e) ==>
;     (forall (b: CPS.Expr.expr) (b: CPS.Expr.expr).
;         e == CPS.Expr.Plus b b ==>
;         b :: CPS.DoubleDefun.stack (CPS.DoubleDefun.C2 k b) << e :: CPS.DoubleDefun.stack k \/
;         b :: CPS.DoubleDefun.stack (CPS.DoubleDefun.C2 k b) === e :: CPS.DoubleDefun.stack k /\
;         (CPS.DoubleDefun.C2 k b << k \/ CPS.DoubleDefun.C2 k b === k /\ 1 << 1)))
...
;; def=Prims.fst(402,27-402,88); use=CPS.DoubleDefun.fst(53,2-55,41)
(forall ((@x1 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=CPS.DoubleDefun.fst(53,2-55,41)
(Valid 
;; def=Prims.fst(402,84-402,87); use=CPS.DoubleDefun.fst(53,2-55,41)
(ApplyTT @x0
@x1)
...
;; def=Prims.fst(459,77-459,89); use=CPS.DoubleDefun.fst(53,2-55,41)
(and (implies 
;; def=CPS.DoubleDefun.fst(52,13-52,14); use=CPS.DoubleDefun.fst(53,8-53,9)
(and 
;; def=CPS.DoubleDefun.fst(52,13-52,14); use=CPS.DoubleDefun.fst(53,8-53,9)
(not 
;; def=CPS.DoubleDefun.fst(52,13-52,14); use=CPS.DoubleDefun.fst(53,8-53,9)
(BoxBool_proj_0 (CPS.Expr.uu___is_Const x_0c607185f6c6768f1786fe5f14f15ea1_0))
)
...
(not 
;; def=CPS.DoubleDefun.fst(52,13-52,14); use=CPS.DoubleDefun.fst(53,8-53,9)
(BoxBool_proj_0 (CPS.Expr.uu___is_Plus x_0c607185f6c6768f1786fe5f14f15ea1_0))
)
)

label_1)

;; def=Prims.fst(413,99-413,120); use=CPS.DoubleDefun.fst(53,2-55,41)
(forall ((@x1 Term))
 (! (implies (and (HasType @x1
Prims.int)

;; def=CPS.DoubleDefun.fst(52,13-54,13); use=CPS.DoubleDefun.fst(53,8-54,13)
(= x_0c607185f6c6768f1786fe5f14f15ea1_0
(CPS.Expr.Const @x1))
)

;; def=CPS.DoubleDefun.fst(44,22-55,41); use=CPS.DoubleDefun.fst(54,27-54,28)
(or label_2

;; def=CPS.DoubleDefun.fst(53,2-55,41); use=CPS.DoubleDefun.fst(54,27-54,28)
(Valid 
;; def=CPS.DoubleDefun.fst(53,2-55,41); use=CPS.DoubleDefun.fst(54,27-54,28)
(Prims.precedes (Prims.list CPS.Expr.expr)
(Prims.list CPS.Expr.expr)
...
(implies 
;; def=Prims.fst(389,19-389,21); use=CPS.DoubleDefun.fst(53,2-55,41)
(not 
;; def=CPS.DoubleDefun.fst(52,13-52,14); use=CPS.DoubleDefun.fst(53,8-53,9)
(BoxBool_proj_0 (CPS.Expr.uu___is_Const x_0c607185f6c6768f1786fe5f14f15ea1_0))
)
...
;; def=CPS.DoubleDefun.fst(52,13-55,16); use=CPS.DoubleDefun.fst(53,8-55,16)
(= x_0c607185f6c6768f1786fe5f14f15ea1_0
(CPS.Expr.Plus @x1
@x2))
)

;; def=CPS.DoubleDefun.fst(45,25-55,41); use=CPS.DoubleDefun.fst(55,32-55,41)
(or label_3

;; def=CPS.DoubleDefun.fst(53,2-55,41); use=CPS.DoubleDefun.fst(55,32-55,41)
(Valid 
;; def=CPS.DoubleDefun.fst(53,2-55,41); use=CPS.DoubleDefun.fst(55,32-55,41)
(Prims.precedes (Prims.list CPS.Expr.expr)
(Prims.list CPS.Expr.expr)
(Prims.Cons CPS.Expr.expr
@x1
(CPS.DoubleDefun.stack (CPS.DoubleDefun.C2 x_fc08148c0a56a96633a93ae5c4e7943e_1
@x2)))
(Prims.Cons CPS.Expr.expr
x_0c607185f6c6768f1786fe5f14f15ea1_0
(CPS.DoubleDefun.stack x_fc08148c0a56a96633a93ae5c4e7943e_1)))
...
;; def=CPS.DoubleDefun.fst(45,25-55,41); use=CPS.DoubleDefun.fst(55,32-55,41)
(and 
;; def=CPS.DoubleDefun.fst(45,56-45,68); use=CPS.DoubleDefun.fst(55,32-55,41)
(Valid 
;; def=CPS.DoubleDefun.fst(45,56-45,68); use=CPS.DoubleDefun.fst(55,32-55,41)
(Prims.op_Equals_Equals_Equals (Prims.list CPS.Expr.expr)
(Prims.list CPS.Expr.expr)
...
(Prims.precedes CPS.DoubleDefun.cont
CPS.DoubleDefun.cont
(CPS.DoubleDefun.C2 x_fc08148c0a56a96633a93ae5c4e7943e_1
@x2)
x_fc08148c0a56a96633a93ae5c4e7943e_1)
)
...
;; def=CPS.DoubleDefun.fst(45,25-55,41); use=CPS.DoubleDefun.fst(55,32-55,41)
(and 
;; def=CPS.DoubleDefun.fst(45,25-52,16); use=CPS.DoubleDefun.fst(55,32-55,41)
(Valid 
;; def=CPS.DoubleDefun.fst(45,25-52,16); use=CPS.DoubleDefun.fst(55,32-55,41)
(Prims.op_Equals_Equals_Equals CPS.DoubleDefun.cont
CPS.DoubleDefun.cont
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (CPS.DoubleDefun.apply, 2)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxFuel_assumption, @MaxIFuel_assumption, @fuel_correspondence_CPS.DoubleDefun.stack.fuel_instrumented, @fuel_irrelevance_CPS.DoubleDefun.stack.fuel_instrumented, @query, CPS.Expr_pretyping_0c607185f6c6768f1786fe5f14f15ea1, Prims_pretyping_ae567c2fb75be05905677af440075565, assumption_CPS.DoubleDefun.Rstack2, binder_x_0c607185f6c6768f1786fe5f14f15ea1_0, binder_x_fc08148c0a56a96633a93ae5c4e7943e_1, constructor_distinct_CPS.DoubleDefun.C2, data_typing_intro_CPS.DoubleDefun.C2@tok, disc_equation_CPS.Expr.Const, disc_equation_CPS.Expr.Plus, equation_with_fuel_CPS.DoubleDefun.stack.fuel_instrumented, fuel_guarded_inversion_CPS.Expr.expr, function_token_typing_Prims.__cache_version_number__, int_typing, projection_inverse_BoxBool_proj_0, projection_inverse_BoxInt_proj_0, projection_inverse_CPS.DoubleDefun.C2__0, projection_inverse_CPS.DoubleDefun.C2__1, projection_inverse_CPS.Expr.Plus__0, projection_inverse_CPS.Expr.Plus__1, subterm_ordering_CPS.Expr.Plus, typing_CPS.DoubleDefun.stack, well-founded-ordering-on-nat
