...
; Internals for CPS.DoubleLambdaLifting


; encoding sigelt val CPS.DoubleLambdaLifting.eval_cps1


; <Skipped val CPS.DoubleLambdaLifting.eval_cps1/>
...
(declare-fun CPS.DoubleLambdaLifting.eval_cps1 (Term Term Term Term) Term)

;;;;;;;;;;;;;;;;k: (_: Prims.int -> 'a) -> r1: Prims.int -> r2: Prims.int -> 'a
(declare-fun Tm_arrow_513b25dbd891c49fba5fe6949c4e594a () Term)
(declare-fun CPS.DoubleLambdaLifting.eval_cps1@tok () Term)
...
;;; Fact-ids: Name CPS.DoubleLambdaLifting.eval_cps1; Namespace CPS.DoubleLambdaLifting
(assert (! 
;; def=CPS.DoubleLambdaLifting.fst(20,17-20,30); use=CPS.DoubleLambdaLifting.fst(20,28-21,13)
(forall ((@x0 Term))
...
@x1
(Tm_arrow_8928427c3e013c0cd8946aaaf1c65a29 @x2)))
:qid CPS.DoubleLambdaLifting_pre_typing_Tm_arrow_8928427c3e013c0cd8946aaaf1c65a29))

:named CPS.DoubleLambdaLifting_pre_typing_Tm_arrow_8928427c3e013c0cd8946aaaf1c65a29))
...
:pattern ((ApplyTT @x0
@x2))
:qid CPS.DoubleLambdaLifting_interpretation_Tm_arrow_8928427c3e013c0cd8946aaaf1c65a29.1))
...
:pattern ((HasTypeZ @x0
(Tm_arrow_8928427c3e013c0cd8946aaaf1c65a29 @x1)))
:qid CPS.DoubleLambdaLifting_interpretation_Tm_arrow_8928427c3e013c0cd8946aaaf1c65a29))

:named CPS.DoubleLambdaLifting_interpretation_Tm_arrow_8928427c3e013c0cd8946aaaf1c65a29))
(push) ;; push{2

; Starting query at CPS.DoubleLambdaLifting.fst(25,2-27,46)
...
(declare-fun x_0c607185f6c6768f1786fe5f14f15ea1_3 () Term)
;;;;;;;;;;;;;;;;binder_x_0c607185f6c6768f1786fe5f14f15ea1_3
;;; Fact-ids: 
(assert (! (HasType x_0c607185f6c6768f1786fe5f14f15ea1_3
CPS.Expr.expr)
:named binder_x_0c607185f6c6768f1786fe5f14f15ea1_3))
;;;;;;;;;;;;;;;;k : _: Prims.int -> 'a (_: Prims.int -> 'a)
(declare-fun x_8906cd59beea0c5f7bd83515daa72af7_4 () Term)
;;;;;;;;;;;;;;;;_: Prims.int -> 'a
(declare-fun Tm_arrow_7e8ae3a9c9c4b65c60c374c4d8433d4d () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_7e8ae3a9c9c4b65c60c374c4d8433d4d
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_7e8ae3a9c9c4b65c60c374c4d8433d4d
Tm_type)
:named kinding_Tm_arrow_7e8ae3a9c9c4b65c60c374c4d8433d4d))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=CPS.DoubleLambdaLifting.fst(23,29-23,38); use=CPS.DoubleLambdaLifting.fst(23,29-23,38)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_7e8ae3a9c9c4b65c60c374c4d8433d4d)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_7e8ae3a9c9c4b65c60c374c4d8433d4d))
:qid CPS.DoubleLambdaLifting_pre_typing_Tm_arrow_7e8ae3a9c9c4b65c60c374c4d8433d4d))

:named CPS.DoubleLambdaLifting_pre_typing_Tm_arrow_7e8ae3a9c9c4b65c60c374c4d8433d4d))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_7e8ae3a9c9c4b65c60c374c4d8433d4d
;;; Fact-ids: 
(assert (! 
;; def=CPS.DoubleLambdaLifting.fst(23,29-23,38); use=CPS.DoubleLambdaLifting.fst(23,29-23,38)
(forall ((@x0 Term))
...
:pattern ((ApplyTT @x0
@x1))
:qid CPS.DoubleLambdaLifting_interpretation_Tm_arrow_7e8ae3a9c9c4b65c60c374c4d8433d4d.1))
...
:pattern ((HasTypeZ @x0
Tm_arrow_7e8ae3a9c9c4b65c60c374c4d8433d4d))
:qid CPS.DoubleLambdaLifting_interpretation_Tm_arrow_7e8ae3a9c9c4b65c60c374c4d8433d4d))

:named CPS.DoubleLambdaLifting_interpretation_Tm_arrow_7e8ae3a9c9c4b65c60c374c4d8433d4d))
;;;;;;;;;;;;;;;;binder_x_8906cd59beea0c5f7bd83515daa72af7_4
;;; Fact-ids: 
(assert (! (HasType x_8906cd59beea0c5f7bd83515daa72af7_4
Tm_arrow_7e8ae3a9c9c4b65c60c374c4d8433d4d)
:named binder_x_8906cd59beea0c5f7bd83515daa72af7_4))

(declare-fun Tm_refine_67f1b3d28dea2ecae64a3db5fa2f6334 (Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=CPS.DoubleLambdaLifting.fst(23,18-29,41); use=CPS.DoubleLambdaLifting.fst(23,18-30,24)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_67f1b3d28dea2ecae64a3db5fa2f6334 @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_67f1b3d28dea2ecae64a3db5fa2f6334 @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_67f1b3d28dea2ecae64a3db5fa2f6334))

:named refinement_kinding_Tm_refine_67f1b3d28dea2ecae64a3db5fa2f6334))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=CPS.DoubleLambdaLifting.fst(23,18-29,41); use=CPS.DoubleLambdaLifting.fst(23,18-30,24)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_67f1b3d28dea2ecae64a3db5fa2f6334 @x2))
(and (HasTypeFuel @u0
@x1
Prims.int)

;; def=CPS.DoubleLambdaLifting.fst(23,18-29,17); use=CPS.DoubleLambdaLifting.fst(23,18-30,24)

;; def=CPS.DoubleLambdaLifting.fst(23,18-29,17); use=CPS.DoubleLambdaLifting.fst(23,18-30,24)
(or 
;; def=CPS.DoubleLambdaLifting.fst(25,2-27,46); use=CPS.DoubleLambdaLifting.fst(25,2-27,46)
(Valid 
;; def=CPS.DoubleLambdaLifting.fst(25,2-27,46); use=CPS.DoubleLambdaLifting.fst(25,2-27,46)
(Prims.precedes CPS.Expr.expr
CPS.Expr.expr
@x2
x_0c607185f6c6768f1786fe5f14f15ea1_3)
)
...
(Valid 
;; def=CPS.DoubleLambdaLifting.fst(23,18-29,17); use=CPS.DoubleLambdaLifting.fst(23,18-30,24)
(Prims.op_Equals_Equals_Equals CPS.Expr.expr
CPS.Expr.expr
@x2
x_0c607185f6c6768f1786fe5f14f15ea1_3)
)
...
@x1
(Tm_refine_67f1b3d28dea2ecae64a3db5fa2f6334 @x2)))
:qid refinement_interpretation_Tm_refine_67f1b3d28dea2ecae64a3db5fa2f6334))

:named refinement_interpretation_Tm_refine_67f1b3d28dea2ecae64a3db5fa2f6334))
;;;;;;;;;;;;;;;;haseq for Tm_refine_67f1b3d28dea2ecae64a3db5fa2f6334
;;; Fact-ids: 
(assert (! 
;; def=CPS.DoubleLambdaLifting.fst(23,18-29,41); use=CPS.DoubleLambdaLifting.fst(23,18-30,24)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_67f1b3d28dea2ecae64a3db5fa2f6334 @x0)))
(Valid (Prims.hasEq Prims.int)))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_67f1b3d28dea2ecae64a3db5fa2f6334 @x0))))
:qid haseqTm_refine_67f1b3d28dea2ecae64a3db5fa2f6334))

:named haseqTm_refine_67f1b3d28dea2ecae64a3db5fa2f6334))
(declare-fun CPS.DoubleLambdaLifting.eval_cps2 (Term Term Term Term) Term)


;;;;;;;;;;;;;;;;e2: CPS.Expr.expr -> k: (_: Prims.int -> 'a) -> r1: Prims.int{e2 << e \/ e2 === e /\ 1 << 0}   -> Prims.Tot 'a
(declare-fun Tm_arrow_1340a978d2aa11a0fbadf31920d2dff3 () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_1340a978d2aa11a0fbadf31920d2dff3
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_1340a978d2aa11a0fbadf31920d2dff3
Tm_type)
:named kinding_Tm_arrow_1340a978d2aa11a0fbadf31920d2dff3))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=CPS.DoubleLambdaLifting.fst(23,18-29,41); use=CPS.DoubleLambdaLifting.fst(23,18-30,24)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_1340a978d2aa11a0fbadf31920d2dff3)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_1340a978d2aa11a0fbadf31920d2dff3))
:qid CPS.DoubleLambdaLifting_pre_typing_Tm_arrow_1340a978d2aa11a0fbadf31920d2dff3))

:named CPS.DoubleLambdaLifting_pre_typing_Tm_arrow_1340a978d2aa11a0fbadf31920d2dff3))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_1340a978d2aa11a0fbadf31920d2dff3
;;; Fact-ids: 
(assert (! 
;; def=CPS.DoubleLambdaLifting.fst(23,18-29,41); use=CPS.DoubleLambdaLifting.fst(23,18-30,24)
(forall ((@x0 Term))
...
@x3)
@x4))
:qid CPS.DoubleLambdaLifting_interpretation_Tm_arrow_1340a978d2aa11a0fbadf31920d2dff3.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid CPS.DoubleLambdaLifting_interpretation_Tm_arrow_1340a978d2aa11a0fbadf31920d2dff3.2))
...
@x1)
@x2))
:qid CPS.DoubleLambdaLifting_interpretation_Tm_arrow_1340a978d2aa11a0fbadf31920d2dff3.3))
...
@x2)
@x3))
:qid CPS.DoubleLambdaLifting_interpretation_Tm_arrow_1340a978d2aa11a0fbadf31920d2dff3.4))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_1340a978d2aa11a0fbadf31920d2dff3))
:qid CPS.DoubleLambdaLifting_interpretation_Tm_arrow_1340a978d2aa11a0fbadf31920d2dff3))

:named CPS.DoubleLambdaLifting_interpretation_Tm_arrow_1340a978d2aa11a0fbadf31920d2dff3))
(declare-fun CPS.DoubleLambdaLifting.eval_cps2@tok () Term)
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: 
(assert (! 
;; def=CPS.DoubleLambdaLifting.fst(29,4-29,13); use=CPS.DoubleLambdaLifting.fst(29,4-29,13)
(forall ((@x0 Term) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (= (ApplyTT (ApplyTT (ApplyTT (ApplyTT CPS.DoubleLambdaLifting.eval_cps2@tok
@x0)
@x1)
@x2)
@x3)
(CPS.DoubleLambdaLifting.eval_cps2 @x0
@x1
@x2
@x3))
 

:pattern ((ApplyTT (ApplyTT (ApplyTT (ApplyTT CPS.DoubleLambdaLifting.eval_cps2@tok
@x0)
@x1)
@x2)
@x3))
:qid token_correspondence_CPS.DoubleLambdaLifting.eval_cps2))

:named token_correspondence_CPS.DoubleLambdaLifting.eval_cps2))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: 
(assert (! 
;; def=CPS.DoubleLambdaLifting.fst(29,4-29,13); use=CPS.DoubleLambdaLifting.fst(29,4-29,13)
(forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType CPS.DoubleLambdaLifting.eval_cps2@tok
Tm_arrow_1340a978d2aa11a0fbadf31920d2dff3))
...
@x3)
@x4)
(CPS.DoubleLambdaLifting.eval_cps2 @x1
@x2
@x3
@x4))
 

:pattern ((CPS.DoubleLambdaLifting.eval_cps2 @x1
@x2
@x3
@x4))
:qid function_token_typing_CPS.DoubleLambdaLifting.eval_cps2.1))
)
 

:pattern ((ApplyTT @x0
CPS.DoubleLambdaLifting.eval_cps2@tok))
:qid function_token_typing_CPS.DoubleLambdaLifting.eval_cps2))

:named function_token_typing_CPS.DoubleLambdaLifting.eval_cps2))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: 
(assert (! 
;; def=CPS.DoubleLambdaLifting.fst(29,4-29,13); use=CPS.DoubleLambdaLifting.fst(29,4-29,13)
...
(HasType @x3
(Tm_refine_67f1b3d28dea2ecae64a3db5fa2f6334 @x1)))
(HasType (CPS.DoubleLambdaLifting.eval_cps2 @x0
@x1
@x2
@x3)
@x0))
...
:pattern ((CPS.DoubleLambdaLifting.eval_cps2 @x0
@x1
@x2
@x3))
:qid typing_CPS.DoubleLambdaLifting.eval_cps2))

:named typing_CPS.DoubleLambdaLifting.eval_cps2))

(declare-fun Tm_refine_6a0ac8260cc5f83ce558655b56c3a6c7 (Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=CPS.DoubleLambdaLifting.fst(23,18-27,46); use=CPS.DoubleLambdaLifting.fst(23,18-27,46)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_refine_6a0ac8260cc5f83ce558655b56c3a6c7 @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_refine_6a0ac8260cc5f83ce558655b56c3a6c7 @x0
@x1)
Tm_type))
:qid refinement_kinding_Tm_refine_6a0ac8260cc5f83ce558655b56c3a6c7))

:named refinement_kinding_Tm_refine_6a0ac8260cc5f83ce558655b56c3a6c7))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=CPS.DoubleLambdaLifting.fst(23,18-27,46); use=CPS.DoubleLambdaLifting.fst(23,18-27,46)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_6a0ac8260cc5f83ce558655b56c3a6c7 @x2
@x3))
(and (HasTypeFuel @u0
@x1
(Tm_arrow_8928427c3e013c0cd8946aaaf1c65a29 @x2))
...
;; def=CPS.DoubleLambdaLifting.fst(23,18-27,46); use=CPS.DoubleLambdaLifting.fst(23,18-27,46)
(and 
;; def=CPS.DoubleLambdaLifting.fst(23,18-23,19); use=CPS.DoubleLambdaLifting.fst(23,18-24,23)
(Valid 
;; def=CPS.DoubleLambdaLifting.fst(23,18-23,19); use=CPS.DoubleLambdaLifting.fst(23,18-24,23)
(Prims.op_Equals_Equals_Equals CPS.Expr.expr
CPS.Expr.expr
...
(Tm_refine_6a0ac8260cc5f83ce558655b56c3a6c7 @x2
@x3)))
:qid refinement_interpretation_Tm_refine_6a0ac8260cc5f83ce558655b56c3a6c7))

:named refinement_interpretation_Tm_refine_6a0ac8260cc5f83ce558655b56c3a6c7))
;;;;;;;;;;;;;;;;haseq for Tm_refine_6a0ac8260cc5f83ce558655b56c3a6c7
;;; Fact-ids: 
(assert (! 
;; def=CPS.DoubleLambdaLifting.fst(23,18-27,46); use=CPS.DoubleLambdaLifting.fst(23,18-27,46)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_6a0ac8260cc5f83ce558655b56c3a6c7 @x0
@x1)))
(Valid (Prims.hasEq (Tm_arrow_8928427c3e013c0cd8946aaaf1c65a29 @x0))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_6a0ac8260cc5f83ce558655b56c3a6c7 @x0
@x1))))
:qid haseqTm_refine_6a0ac8260cc5f83ce558655b56c3a6c7))

:named haseqTm_refine_6a0ac8260cc5f83ce558655b56c3a6c7))
(declare-fun CPS.DoubleLambdaLifting.eval_cps (Term Term Term) Term)


;;;;;;;;;;;;;;;;e: CPS.Expr.expr -> k: (_: Prims.int -> 'a){e << e \/ e === e /\ 0 << 0} -> Prims.Tot 'a
(declare-fun Tm_arrow_ede21a3fec33dc6e52097500e16a2194 () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_ede21a3fec33dc6e52097500e16a2194
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_ede21a3fec33dc6e52097500e16a2194
Tm_type)
:named kinding_Tm_arrow_ede21a3fec33dc6e52097500e16a2194))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=CPS.DoubleLambdaLifting.fst(23,18-27,46); use=CPS.DoubleLambdaLifting.fst(23,18-27,46)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_ede21a3fec33dc6e52097500e16a2194)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_ede21a3fec33dc6e52097500e16a2194))
:qid CPS.DoubleLambdaLifting_pre_typing_Tm_arrow_ede21a3fec33dc6e52097500e16a2194))

:named CPS.DoubleLambdaLifting_pre_typing_Tm_arrow_ede21a3fec33dc6e52097500e16a2194))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_ede21a3fec33dc6e52097500e16a2194
;;; Fact-ids: 
(assert (! 
;; def=CPS.DoubleLambdaLifting.fst(23,18-27,46); use=CPS.DoubleLambdaLifting.fst(23,18-27,46)
(forall ((@x0 Term))
...
CPS.Expr.expr)
(HasType @x3
(Tm_refine_6a0ac8260cc5f83ce558655b56c3a6c7 @x1
@x2)))
...
@x2)
@x3))
:qid CPS.DoubleLambdaLifting_interpretation_Tm_arrow_ede21a3fec33dc6e52097500e16a2194.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid CPS.DoubleLambdaLifting_interpretation_Tm_arrow_ede21a3fec33dc6e52097500e16a2194.2))
...
@x1)
@x2))
:qid CPS.DoubleLambdaLifting_interpretation_Tm_arrow_ede21a3fec33dc6e52097500e16a2194.3))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_ede21a3fec33dc6e52097500e16a2194))
:qid CPS.DoubleLambdaLifting_interpretation_Tm_arrow_ede21a3fec33dc6e52097500e16a2194))

:named CPS.DoubleLambdaLifting_interpretation_Tm_arrow_ede21a3fec33dc6e52097500e16a2194))
(declare-fun CPS.DoubleLambdaLifting.eval_cps@tok () Term)
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: 
(assert (! 
;; def=CPS.DoubleLambdaLifting.fst(23,8-23,16); use=CPS.DoubleLambdaLifting.fst(23,8-23,16)
(forall ((@x0 Term) (@x1 Term) (@x2 Term))
 (! (= (ApplyTT (ApplyTT (ApplyTT CPS.DoubleLambdaLifting.eval_cps@tok
@x0)
@x1)
@x2)
(CPS.DoubleLambdaLifting.eval_cps @x0
@x1
@x2))
 

:pattern ((ApplyTT (ApplyTT (ApplyTT CPS.DoubleLambdaLifting.eval_cps@tok
@x0)
@x1)
@x2))
:qid token_correspondence_CPS.DoubleLambdaLifting.eval_cps))

:named token_correspondence_CPS.DoubleLambdaLifting.eval_cps))
;;;;;;;;;;;;;;;;function token typing
;;; Fact-ids: 
(assert (! 
;; def=CPS.DoubleLambdaLifting.fst(23,8-23,16); use=CPS.DoubleLambdaLifting.fst(23,8-23,16)
(forall ((@x0 Term))
 (! (and (NoHoist @x0
(HasType CPS.DoubleLambdaLifting.eval_cps@tok
Tm_arrow_ede21a3fec33dc6e52097500e16a2194))
...
@x2)
@x3)
(CPS.DoubleLambdaLifting.eval_cps @x1
@x2
@x3))
 

:pattern ((CPS.DoubleLambdaLifting.eval_cps @x1
@x2
@x3))
:qid function_token_typing_CPS.DoubleLambdaLifting.eval_cps.1))
)
 

:pattern ((ApplyTT @x0
CPS.DoubleLambdaLifting.eval_cps@tok))
:qid function_token_typing_CPS.DoubleLambdaLifting.eval_cps))

:named function_token_typing_CPS.DoubleLambdaLifting.eval_cps))
;;;;;;;;;;;;;;;;free var typing
;;; Fact-ids: 
(assert (! 
;; def=CPS.DoubleLambdaLifting.fst(23,8-23,16); use=CPS.DoubleLambdaLifting.fst(23,8-23,16)
...
CPS.Expr.expr)
(HasType @x2
(Tm_refine_6a0ac8260cc5f83ce558655b56c3a6c7 @x0
@x1)))
(HasType (CPS.DoubleLambdaLifting.eval_cps @x0
@x1
@x2)
@x0))
 

:pattern ((CPS.DoubleLambdaLifting.eval_cps @x0
@x1
@x2))
:qid typing_CPS.DoubleLambdaLifting.eval_cps))

:named typing_CPS.DoubleLambdaLifting.eval_cps))
...
; While typechecking the top-level declaration `let rec eval_cps and eval_cps2`
...
(assert (! (not (forall ((@x0 Term))
 (! (implies (and (HasType @x0
(Prims.pure_post x_fe28d8bcde588226b4e538b35321de05_2))

;; def=Prims.fst(402,27-402,88); use=CPS.DoubleLambdaLifting.fst(25,2-27,46)
(forall ((@x1 Term))
 (! 
;; def=Prims.fst(402,84-402,87); use=CPS.DoubleLambdaLifting.fst(25,2-27,46)
(Valid 
;; def=Prims.fst(402,84-402,87); use=CPS.DoubleLambdaLifting.fst(25,2-27,46)
(ApplyTT @x0
@x1)
...
;; def=Prims.fst(459,77-459,89); use=CPS.DoubleLambdaLifting.fst(25,2-27,46)
(and (implies 
;; def=CPS.DoubleLambdaLifting.fst(23,18-23,19); use=CPS.DoubleLambdaLifting.fst(25,8-25,9)
(and 
;; def=CPS.DoubleLambdaLifting.fst(23,18-23,19); use=CPS.DoubleLambdaLifting.fst(25,8-25,9)
(not 
;; def=CPS.DoubleLambdaLifting.fst(23,18-23,19); use=CPS.DoubleLambdaLifting.fst(25,8-25,9)
(BoxBool_proj_0 (CPS.Expr.uu___is_Const x_0c607185f6c6768f1786fe5f14f15ea1_3))
)
...
(not 
;; def=CPS.DoubleLambdaLifting.fst(23,18-23,19); use=CPS.DoubleLambdaLifting.fst(25,8-25,9)
(BoxBool_proj_0 (CPS.Expr.uu___is_Plus x_0c607185f6c6768f1786fe5f14f15ea1_3))
)
)

label_1)
(implies 
;; def=Prims.fst(389,19-389,21); use=CPS.DoubleLambdaLifting.fst(25,2-27,46)
(not 
;; def=CPS.DoubleLambdaLifting.fst(23,18-23,19); use=CPS.DoubleLambdaLifting.fst(25,8-25,9)
(BoxBool_proj_0 (CPS.Expr.uu___is_Const x_0c607185f6c6768f1786fe5f14f15ea1_3))
)
...
;; def=Prims.fst(413,99-413,120); use=CPS.DoubleLambdaLifting.fst(25,2-27,46)
(forall ((@x1 Term))
 (! (implies (HasType @x1
CPS.Expr.expr)
...
;; def=CPS.DoubleLambdaLifting.fst(23,18-27,14); use=CPS.DoubleLambdaLifting.fst(25,8-27,14)
(= x_0c607185f6c6768f1786fe5f14f15ea1_3
(CPS.Expr.Plus @x1
@x2))
)

;; def=CPS.DoubleLambdaLifting.fst(23,18-27,46); use=CPS.DoubleLambdaLifting.fst(27,30-27,46)
(and 
;; def=dummy(0,0-0,0); use=CPS.DoubleLambdaLifting.fst(27,30-27,46)
(forall ((@x3 Term))
 (! (implies (HasType @x3
Prims.int)

;; def=CPS.DoubleLambdaLifting.fst(23,18-29,17); use=CPS.DoubleLambdaLifting.fst(27,30-27,46)
(or label_2

;; def=CPS.DoubleLambdaLifting.fst(25,2-27,46); use=CPS.DoubleLambdaLifting.fst(27,30-27,46)
(Valid 
;; def=CPS.DoubleLambdaLifting.fst(25,2-27,46); use=CPS.DoubleLambdaLifting.fst(27,30-27,46)
(Prims.precedes CPS.Expr.expr
CPS.Expr.expr
...
;; def=CPS.DoubleLambdaLifting.fst(23,18-27,46); use=CPS.DoubleLambdaLifting.fst(27,30-27,46)
(and 
;; def=CPS.DoubleLambdaLifting.fst(23,18-23,19); use=CPS.DoubleLambdaLifting.fst(27,30-27,46)
(Valid 
;; def=CPS.DoubleLambdaLifting.fst(23,18-23,19); use=CPS.DoubleLambdaLifting.fst(27,30-27,46)
(Prims.op_Equals_Equals_Equals CPS.Expr.expr
CPS.Expr.expr
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (CPS.DoubleLambdaLifting.eval_cps, 1)
; STATUS: unsat
; UNSAT CORE GENERATED: @MaxIFuel_assumption, @query, CPS.Expr_pretyping_0c607185f6c6768f1786fe5f14f15ea1, binder_x_0c607185f6c6768f1786fe5f14f15ea1_3, disc_equation_CPS.Expr.Const, disc_equation_CPS.Expr.Plus, fuel_guarded_inversion_CPS.Expr.expr, projection_inverse_BoxBool_proj_0, projection_inverse_CPS.Expr.Plus__0, projection_inverse_CPS.Expr.Plus__1, subterm_ordering_CPS.Expr.Plus
...
; Starting query at CPS.DoubleLambdaLifting.fst(31,2-31,30)
...
Tm_type)
:named binder_x_fe28d8bcde588226b4e538b35321de05_2))
;;;;;;;;;;;;;;;;e2 : CPS.Expr.expr (CPS.Expr.expr)
(declare-fun x_0c607185f6c6768f1786fe5f14f15ea1_3 () Term)
;;;;;;;;;;;;;;;;binder_x_0c607185f6c6768f1786fe5f14f15ea1_3
;;; Fact-ids: 
(assert (! (HasType x_0c607185f6c6768f1786fe5f14f15ea1_3
...
;;; Fact-ids: 
(assert (! 
;; def=CPS.DoubleLambdaLifting.fst(29,27-29,36); use=CPS.DoubleLambdaLifting.fst(29,27-29,36)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_7e8ae3a9c9c4b65c60c374c4d8433d4d)
...
Tm_arrow_7e8ae3a9c9c4b65c60c374c4d8433d4d)
:named binder_x_8906cd59beea0c5f7bd83515daa72af7_4))
;;;;;;;;;;;;;;;;r1 : Prims.int (Prims.int)
(declare-fun x_ae567c2fb75be05905677af440075565_5 () Term)
;;;;;;;;;;;;;;;;binder_x_ae567c2fb75be05905677af440075565_5
;;; Fact-ids: 
(assert (! (HasType x_ae567c2fb75be05905677af440075565_5
Prims.int)
:named binder_x_ae567c2fb75be05905677af440075565_5))

(declare-fun Tm_refine_456764870e456492a3de3eaa8a13885d (Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=CPS.DoubleLambdaLifting.fst(29,15-31,30); use=CPS.DoubleLambdaLifting.fst(29,15-31,30)
(forall ((@x0 Term))
 (! (HasType (Tm_refine_456764870e456492a3de3eaa8a13885d @x0)
Tm_type)
 

:pattern ((HasType (Tm_refine_456764870e456492a3de3eaa8a13885d @x0)
Tm_type))
:qid refinement_kinding_Tm_refine_456764870e456492a3de3eaa8a13885d))

:named refinement_kinding_Tm_refine_456764870e456492a3de3eaa8a13885d))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=CPS.DoubleLambdaLifting.fst(29,15-31,30); use=CPS.DoubleLambdaLifting.fst(29,15-31,30)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_456764870e456492a3de3eaa8a13885d @x2))
(and (HasTypeFuel @u0
@x1
Prims.int)
...
;; def=CPS.DoubleLambdaLifting.fst(29,15-31,30); use=CPS.DoubleLambdaLifting.fst(29,15-31,30)
(or 
;; def=CPS.DoubleLambdaLifting.fst(31,2-31,30); use=CPS.DoubleLambdaLifting.fst(31,2-31,30)
(Valid 
;; def=CPS.DoubleLambdaLifting.fst(31,2-31,30); use=CPS.DoubleLambdaLifting.fst(31,2-31,30)
(Prims.precedes CPS.Expr.expr
CPS.Expr.expr
...
;; def=CPS.DoubleLambdaLifting.fst(29,15-31,30); use=CPS.DoubleLambdaLifting.fst(29,15-31,30)
(and 
;; def=CPS.DoubleLambdaLifting.fst(29,15-29,17); use=CPS.DoubleLambdaLifting.fst(29,15-30,24)
(Valid 
;; def=CPS.DoubleLambdaLifting.fst(29,15-29,17); use=CPS.DoubleLambdaLifting.fst(29,15-30,24)
(Prims.op_Equals_Equals_Equals CPS.Expr.expr
CPS.Expr.expr
...
@x1
(Tm_refine_456764870e456492a3de3eaa8a13885d @x2)))
:qid refinement_interpretation_Tm_refine_456764870e456492a3de3eaa8a13885d))

:named refinement_interpretation_Tm_refine_456764870e456492a3de3eaa8a13885d))
;;;;;;;;;;;;;;;;haseq for Tm_refine_456764870e456492a3de3eaa8a13885d
;;; Fact-ids: 
(assert (! 
;; def=CPS.DoubleLambdaLifting.fst(29,15-31,30); use=CPS.DoubleLambdaLifting.fst(29,15-31,30)
(forall ((@x0 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_456764870e456492a3de3eaa8a13885d @x0)))
(Valid (Prims.hasEq Prims.int)))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_456764870e456492a3de3eaa8a13885d @x0))))
:qid haseqTm_refine_456764870e456492a3de3eaa8a13885d))

:named haseqTm_refine_456764870e456492a3de3eaa8a13885d))
(declare-fun CPS.DoubleLambdaLifting.eval_cps2 (Term Term Term Term) Term)


;;;;;;;;;;;;;;;;e2: CPS.Expr.expr -> k: (_: Prims.int -> 'a) -> r1: Prims.int{e2 << e2 \/ e2 === e2 /\ 1 << 1}   -> Prims.Tot 'a
(declare-fun Tm_arrow_16909b554cad9355f4baecd37a077781 () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_16909b554cad9355f4baecd37a077781
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_16909b554cad9355f4baecd37a077781
Tm_type)
:named kinding_Tm_arrow_16909b554cad9355f4baecd37a077781))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=CPS.DoubleLambdaLifting.fst(29,15-31,30); use=CPS.DoubleLambdaLifting.fst(29,15-31,30)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_16909b554cad9355f4baecd37a077781)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_16909b554cad9355f4baecd37a077781))
:qid CPS.DoubleLambdaLifting_pre_typing_Tm_arrow_16909b554cad9355f4baecd37a077781))

:named CPS.DoubleLambdaLifting_pre_typing_Tm_arrow_16909b554cad9355f4baecd37a077781))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_16909b554cad9355f4baecd37a077781
;;; Fact-ids: 
(assert (! 
;; def=CPS.DoubleLambdaLifting.fst(29,15-31,30); use=CPS.DoubleLambdaLifting.fst(29,15-31,30)
(forall ((@x0 Term))
...
@x3)
@x4))
:qid CPS.DoubleLambdaLifting_interpretation_Tm_arrow_16909b554cad9355f4baecd37a077781.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid CPS.DoubleLambdaLifting_interpretation_Tm_arrow_16909b554cad9355f4baecd37a077781.2))
...
@x1)
@x2))
:qid CPS.DoubleLambdaLifting_interpretation_Tm_arrow_16909b554cad9355f4baecd37a077781.3))
...
@x2)
@x3))
:qid CPS.DoubleLambdaLifting_interpretation_Tm_arrow_16909b554cad9355f4baecd37a077781.4))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_16909b554cad9355f4baecd37a077781))
:qid CPS.DoubleLambdaLifting_interpretation_Tm_arrow_16909b554cad9355f4baecd37a077781))

:named CPS.DoubleLambdaLifting_interpretation_Tm_arrow_16909b554cad9355f4baecd37a077781))
(declare-fun CPS.DoubleLambdaLifting.eval_cps2@tok () Term)
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: 
(assert (! 
...
(Tm_arrow_8928427c3e013c0cd8946aaaf1c65a29 @x0))
(HasType @x3
(Tm_refine_456764870e456492a3de3eaa8a13885d @x1)))
(HasType (CPS.DoubleLambdaLifting.eval_cps2 @x0
@x1
@x2
@x3)
...
(declare-fun Tm_refine_441659ba9aa770e825c76ca54ec4a307 (Term Term) Term)
;;;;;;;;;;;;;;;;refinement kinding
;;; Fact-ids: 
(assert (! 
;; def=CPS.DoubleLambdaLifting.fst(23,18-31,30); use=CPS.DoubleLambdaLifting.fst(23,27-31,30)
(forall ((@x0 Term) (@x1 Term))
 (! (HasType (Tm_refine_441659ba9aa770e825c76ca54ec4a307 @x0
@x1)
Tm_type)
 

:pattern ((HasType (Tm_refine_441659ba9aa770e825c76ca54ec4a307 @x0
@x1)
Tm_type))
:qid refinement_kinding_Tm_refine_441659ba9aa770e825c76ca54ec4a307))

:named refinement_kinding_Tm_refine_441659ba9aa770e825c76ca54ec4a307))
;;;;;;;;;;;;;;;;refinement_interpretation
;;; Fact-ids: 
(assert (! 
;; def=CPS.DoubleLambdaLifting.fst(23,18-31,30); use=CPS.DoubleLambdaLifting.fst(23,27-31,30)
(forall ((@u0 Fuel) (@x1 Term) (@x2 Term) (@x3 Term))
 (! (iff (HasTypeFuel @u0
@x1
(Tm_refine_441659ba9aa770e825c76ca54ec4a307 @x2
@x3))
(and (HasTypeFuel @u0
@x1
(Tm_arrow_8928427c3e013c0cd8946aaaf1c65a29 @x2))

;; def=CPS.DoubleLambdaLifting.fst(23,18-31,30); use=CPS.DoubleLambdaLifting.fst(24,22-31,30)
...
;; def=CPS.DoubleLambdaLifting.fst(23,18-31,30); use=CPS.DoubleLambdaLifting.fst(24,22-31,30)
(and 
;; def=CPS.DoubleLambdaLifting.fst(23,18-29,17); use=CPS.DoubleLambdaLifting.fst(24,22-29,17)
(Valid 
;; def=CPS.DoubleLambdaLifting.fst(23,18-29,17); use=CPS.DoubleLambdaLifting.fst(24,22-29,17)
(Prims.op_Equals_Equals_Equals CPS.Expr.expr
CPS.Expr.expr
...
(Tm_refine_441659ba9aa770e825c76ca54ec4a307 @x2
@x3)))
:qid refinement_interpretation_Tm_refine_441659ba9aa770e825c76ca54ec4a307))

:named refinement_interpretation_Tm_refine_441659ba9aa770e825c76ca54ec4a307))
;;;;;;;;;;;;;;;;haseq for Tm_refine_441659ba9aa770e825c76ca54ec4a307
;;; Fact-ids: 
(assert (! 
;; def=CPS.DoubleLambdaLifting.fst(23,18-31,30); use=CPS.DoubleLambdaLifting.fst(23,27-31,30)
(forall ((@x0 Term) (@x1 Term))
 (! (iff (Valid (Prims.hasEq (Tm_refine_441659ba9aa770e825c76ca54ec4a307 @x0
@x1)))
(Valid (Prims.hasEq (Tm_arrow_8928427c3e013c0cd8946aaaf1c65a29 @x0))))
 

:pattern ((Valid (Prims.hasEq (Tm_refine_441659ba9aa770e825c76ca54ec4a307 @x0
@x1))))
:qid haseqTm_refine_441659ba9aa770e825c76ca54ec4a307))

:named haseqTm_refine_441659ba9aa770e825c76ca54ec4a307))
(declare-fun CPS.DoubleLambdaLifting.eval_cps (Term Term Term) Term)


;;;;;;;;;;;;;;;;e: CPS.Expr.expr -> k: (_: Prims.int -> 'a){e << e2 \/ e === e2 /\ 0 << 1} -> Prims.Tot 'a
(declare-fun Tm_arrow_827243bf10950d2defba9179d830cceb () Term)
;;;;;;;;;;;;;;;;kinding_Tm_arrow_827243bf10950d2defba9179d830cceb
;;; Fact-ids: 
(assert (! (HasType Tm_arrow_827243bf10950d2defba9179d830cceb
Tm_type)
:named kinding_Tm_arrow_827243bf10950d2defba9179d830cceb))
;;;;;;;;;;;;;;;;pre-typing for functions
;;; Fact-ids: 
(assert (! 
;; def=CPS.DoubleLambdaLifting.fst(23,18-31,30); use=CPS.DoubleLambdaLifting.fst(23,20-31,30)
(forall ((@u0 Fuel) (@x1 Term))
 (! (implies (HasTypeFuel @u0
@x1
Tm_arrow_827243bf10950d2defba9179d830cceb)
(is-Tm_arrow (PreType @x1)))
...
@x1
Tm_arrow_827243bf10950d2defba9179d830cceb))
:qid CPS.DoubleLambdaLifting_pre_typing_Tm_arrow_827243bf10950d2defba9179d830cceb))

:named CPS.DoubleLambdaLifting_pre_typing_Tm_arrow_827243bf10950d2defba9179d830cceb))
;;;;;;;;;;;;;;;;interpretation_Tm_arrow_827243bf10950d2defba9179d830cceb
;;; Fact-ids: 
(assert (! 
;; def=CPS.DoubleLambdaLifting.fst(23,18-31,30); use=CPS.DoubleLambdaLifting.fst(23,20-31,30)
(forall ((@x0 Term))
...
CPS.Expr.expr)
(HasType @x3
(Tm_refine_441659ba9aa770e825c76ca54ec4a307 @x1
@x2)))
(HasType (ApplyTT (ApplyTT (ApplyTT @x0
@x1)
@x2)
...
@x2)
@x3))
:qid CPS.DoubleLambdaLifting_interpretation_Tm_arrow_827243bf10950d2defba9179d830cceb.1))
...
:pattern ((ApplyTT @x0
@x1))
:qid CPS.DoubleLambdaLifting_interpretation_Tm_arrow_827243bf10950d2defba9179d830cceb.2))
...
@x1)
@x2))
:qid CPS.DoubleLambdaLifting_interpretation_Tm_arrow_827243bf10950d2defba9179d830cceb.3))
))
 

:pattern ((HasTypeZ @x0
Tm_arrow_827243bf10950d2defba9179d830cceb))
:qid CPS.DoubleLambdaLifting_interpretation_Tm_arrow_827243bf10950d2defba9179d830cceb))

:named CPS.DoubleLambdaLifting_interpretation_Tm_arrow_827243bf10950d2defba9179d830cceb))
(declare-fun CPS.DoubleLambdaLifting.eval_cps@tok () Term)
;;;;;;;;;;;;;;;;Name-token correspondence
;;; Fact-ids: 
(assert (! 
...
CPS.Expr.expr)
(HasType @x2
(Tm_refine_441659ba9aa770e825c76ca54ec4a307 @x0
@x1)))
(HasType (CPS.DoubleLambdaLifting.eval_cps @x0
@x1
@x2)
...
; Encoding query formula : e2 << e2 \/ 0 << 1
...
;;; Fact-ids: 
(assert (! (not 
;; def=CPS.DoubleLambdaLifting.fst(23,18-31,30); use=CPS.DoubleLambdaLifting.fst(31,14-31,30)
(or label_1

;; def=CPS.DoubleLambdaLifting.fst(31,2-31,30); use=CPS.DoubleLambdaLifting.fst(31,14-31,30)
(Valid 
;; def=CPS.DoubleLambdaLifting.fst(31,2-31,30); use=CPS.DoubleLambdaLifting.fst(31,14-31,30)
(Prims.precedes CPS.Expr.expr
CPS.Expr.expr
...
(echo "Done!")
(pop) ;; 0}pop
; QUERY ID: (CPS.DoubleLambdaLifting.eval_cps, 2)
; STATUS: unsat
