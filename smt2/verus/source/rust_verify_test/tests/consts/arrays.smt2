...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/consts-b7cab2e74de87614-arrays/test.rs:17:1: 17:37 (#0)
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/consts-b7cab2e74de87614-arrays/test.rs:19:7: 19:16 (#0)
(get-info :all-statistics)
(push)
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/consts-b7cab2e74de87614-arrays/test.rs:23:1: 23:15 (#0)
(get-info :all-statistics)
(push)
 (declare-const no%param Int)
 ...
 (assert
  (not (=>
    (= tmp%2 test_crate!MyArray.?)
    (and
     (=>
      %%location_label%%0
      (req%vstd!array.array_index_get. $ (UINT 32) $ (CONST_INT 3) tmp%2 1)
     )
     (=>
      (ens%vstd!array.array_index_get. $ (UINT 32) $ (CONST_INT 3) tmp%2 1 tmp%1)
      (=>
       (= x@ (%I tmp%1))
       (=>
        (= tmp%3 (= x@ 2))
