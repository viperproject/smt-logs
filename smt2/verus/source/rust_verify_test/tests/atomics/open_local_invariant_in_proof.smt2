...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/atomics-1f6929080cfc21a4-open_local_invariant_in_proof/test.rs:40:1: 40:132 (#0)
  ...
  (not (=>
    ...
    (=>
     ...
     (=>
      (= inner~32@0 tmp%2@0)
      (=>
       (vstd!invariant.LocalInvariant.inv.? A&. A& $ (UINT 8) B&. B& tmp%1 (I inner~32@0))
       (=>
        %%location_label%%0
        (vstd!invariant.LocalInvariant.inv.? A&. A& $ (UINT 8) B&. B& tmp%1 (I inner~32@0))
 )))))))
...
;; Function-Def test_crate::call_do_nothing
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/atomics-1f6929080cfc21a4-open_local_invariant_in_proof/test.rs:48:1: 48:95 (#0)
(get-info :all-statistics)
(push)
 (declare-const A&. Dcr)
 (declare-const A& Type)
 ...
 (declare-const B& Type)
 (declare-const i! Poly)
 (declare-const verus_tmp_credit@ vstd!invariant.OpenInvariantCredit.)
 (declare-const credit@0 vstd!invariant.OpenInvariantCredit.)
 (assert
  fuel_defaults
 )
 (assert
