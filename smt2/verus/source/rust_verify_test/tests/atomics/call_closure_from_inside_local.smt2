...
(assert
 (distinct fuel%vstd!invariant.LocalInvariant.inv. fuel%vstd!array.group_array_axioms.
...
;; Datatypes
(declare-sort anonymous_closure%12. 0)
...
(declare-const TYPE%anonymous_closure%12. Type)
(declare-fun Poly%anonymous_closure%12. (anonymous_closure%12.) Poly)
(declare-fun %Poly%anonymous_closure%12. (Poly) anonymous_closure%12.)
...
(assert
 (forall ((x anonymous_closure%12.)) (!
   (= x (%Poly%anonymous_closure%12. (Poly%anonymous_closure%12. x)))
   :pattern ((Poly%anonymous_closure%12. x))
   :qid internal_crate__anonymous_closure__12_box_axiom_definition
   :skolemid skolem_internal_crate__anonymous_closure__12_box_axiom_definition
)))
(assert
 (forall ((x Poly)) (!
   (=>
    (has_type x TYPE%anonymous_closure%12.)
    (= x (Poly%anonymous_closure%12. (%Poly%anonymous_closure%12. x)))
   )
   :pattern ((has_type x TYPE%anonymous_closure%12.))
   :qid internal_crate__anonymous_closure__12_unbox_axiom_definition
   :skolemid skolem_internal_crate__anonymous_closure__12_unbox_axiom_definition
)))
(assert
 (forall ((x anonymous_closure%12.)) (!
   (has_type (Poly%anonymous_closure%12. x) TYPE%anonymous_closure%12.)
   :pattern ((has_type (Poly%anonymous_closure%12. x) TYPE%anonymous_closure%12.))
   :qid internal_crate__anonymous_closure__12_has_type_always_definition
   :skolemid skolem_internal_crate__anonymous_closure__12_has_type_always_definition
)))
(assert
...
;; Function-Def test_crate::test_clos
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/atomics-1f6929080cfc21a4-call_closure_from_inside_local/test.rs:40:1: 40:98 (#0)
...
(push)
 ...
 (declare-const %closure_return~5 tuple%0.)
 (declare-const tmp%%1 anonymous_closure%12.)
 (declare-const tmp%1 Poly)
 (declare-const tmp%2@0 Int)
 (declare-const inner~40@0 Int)
 (declare-const tmp%3 Poly)
 (declare-const tmp%4 tuple%0.)
 (declare-const t@ anonymous_closure%12.)
 (declare-const credit@ vstd!invariant.OpenInvariantCredit.)
 (assert
  fuel_defaults
 )
 (assert
  (has_type i! (TYPE%vstd!invariant.LocalInvariant. A&. A& $ (UINT 8) B&. B&))
 )
 (assert
  (tr_bound%vstd!invariant.InvariantPredicate. B&. B& A&. A& $ (UINT 8))
 )
  ...
  (not (=>
    (forall ((tmp%%$ Poly)) (!
      (=>
       ...
       (closure_req TYPE%anonymous_closure%12. $ TYPE%tuple%0. (Poly%anonymous_closure%12.
         tmp%%1
        ) tmp%%$
      ))
      :pattern ((closure_req TYPE%anonymous_closure%12. $ TYPE%tuple%0. (Poly%anonymous_closure%12.
         tmp%%1
        ) tmp%%$
      ))
      :qid user_test_crate__test_clos_0
      :skolemid skolem_user_test_crate__test_clos_0
    ))
    (=>
     (= t@ tmp%%1)
     (=>
      ...
      (=>
       ...
       (=>
        (= inner~40@0 tmp%2@0)
        (=>
         (vstd!invariant.LocalInvariant.inv.? A&. A& $ (UINT 8) B&. B& tmp%1 (I inner~40@0))
         (=>
          (= tmp%4 tuple%0./tuple%0)
          (and
           (=>
            %%location_label%%0
            (req%vstd!pervasive.exec_nonstatic_call. $ TYPE%tuple%0. $ TYPE%tuple%0. (REF $) TYPE%anonymous_closure%12.
             (Poly%anonymous_closure%12. t@) (Poly%tuple%0. tmp%4)
           ))
           (and
            (=>
             %%location_label%%1
            ...
            (and
             ...
             (=>
              (ens%vstd!pervasive.exec_nonstatic_call. $ TYPE%tuple%0. $ TYPE%tuple%0. (REF $) TYPE%anonymous_closure%12.
               (Poly%anonymous_closure%12. t@) (Poly%tuple%0. tmp%4) tmp%3
              )
              (=>
               %%location_label%%3
               (vstd!invariant.LocalInvariant.inv.? A&. A& $ (UINT 8) B&. B& tmp%1 (I inner~40@0))
...
;; Function-Recommends test_crate::test_clos
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/atomics-1f6929080cfc21a4-call_closure_from_inside_local/test.rs:40:1: 40:98 (#0)
(get-info :all-statistics)
(push)
 (declare-const A&. Dcr)
