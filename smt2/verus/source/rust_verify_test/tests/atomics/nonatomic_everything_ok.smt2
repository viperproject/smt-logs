...
;; Function-Specs test_crate::do_nothing
(declare-fun ens%test_crate!do_nothing. (Dcr Type Dcr Type Poly Int) Bool)
(assert
 (forall ((A&. Dcr) (A& Type) (B&. Dcr) (B& Type) (i! Poly) (%return! Int)) (!
   (= (ens%test_crate!do_nothing. A&. A& B&. B& i! %return!) (uInv 32 %return!))
   :pattern ((ens%test_crate!do_nothing. A&. A& B&. B& i! %return!))
   :qid internal_ens__test_crate!do_nothing._definition
   :skolemid skolem_internal_ens__test_crate!do_nothing._definition
)))

;; Function-Def test_crate::do_nothing
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/atomics-1f6929080cfc21a4-nonatomic_everything_ok/test.rs:48:9: 50:10 (#0)
...
(push)
 ...
 (assert
  (has_type tmp%1 (TYPE%vstd!invariant.LocalInvariant. A&. A& $ (UINT 8) B&. B&))
 )
 (assert
  (uInv 8 inner~40@0)
 )
...
;; Function-Def test_crate::do_nothing
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/atomics-1f6929080cfc21a4-nonatomic_everything_ok/test.rs:40:1: 40:106 (#0)
(get-info :all-statistics)
(push)
 (declare-const A&. Dcr)
 (declare-const A& Type)
