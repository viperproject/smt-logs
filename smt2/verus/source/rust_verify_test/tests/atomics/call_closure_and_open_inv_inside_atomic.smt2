...
;; Datatypes
(declare-sort anonymous_closure%13. 0)
...
(declare-const TYPE%anonymous_closure%13. Type)
(declare-fun Poly%anonymous_closure%13. (anonymous_closure%13.) Poly)
(declare-fun %Poly%anonymous_closure%13. (Poly) anonymous_closure%13.)
...
(assert
 (forall ((x anonymous_closure%13.)) (!
   (= x (%Poly%anonymous_closure%13. (Poly%anonymous_closure%13. x)))
   :pattern ((Poly%anonymous_closure%13. x))
   :qid internal_crate__anonymous_closure__13_box_axiom_definition
   :skolemid skolem_internal_crate__anonymous_closure__13_box_axiom_definition
)))
(assert
 (forall ((x Poly)) (!
   (=>
    (has_type x TYPE%anonymous_closure%13.)
    (= x (Poly%anonymous_closure%13. (%Poly%anonymous_closure%13. x)))
   )
   :pattern ((has_type x TYPE%anonymous_closure%13.))
   :qid internal_crate__anonymous_closure__13_unbox_axiom_definition
   :skolemid skolem_internal_crate__anonymous_closure__13_unbox_axiom_definition
)))
(assert
 (forall ((x anonymous_closure%13.)) (!
   (has_type (Poly%anonymous_closure%13. x) TYPE%anonymous_closure%13.)
   :pattern ((has_type (Poly%anonymous_closure%13. x) TYPE%anonymous_closure%13.))
   :qid internal_crate__anonymous_closure__13_has_type_always_definition
   :skolemid skolem_internal_crate__anonymous_closure__13_has_type_always_definition
)))
(assert
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/atomics-1f6929080cfc21a4-call_closure_and_open_inv_inside_atomic/test.rs:40:1: 40:15 (#0)
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/atomics-1f6929080cfc21a4-call_closure_and_open_inv_inside_atomic/test.rs:42:1: 42:99 (#0)
(get-info :all-statistics)
(push)
 (declare-const A&. Dcr)
        ...
        (=>
         ...
         (=>
          ...
          (=>
           (= inner~80@0 tmp%4@0)
           (=>
            (vstd!invariant.AtomicInvariant.inv.? A&. A& $ (UINT 8) B&. B& tmp%3 (I inner~80@0))
            (=>
             %%location_label%%0
             (vstd!invariant.AtomicInvariant.inv.? A&. A& $ (UINT 8) B&. B& tmp%3 (I inner~80@0))
        )))))
        (=>
         (forall ((tmp%%$ Poly)) (!
           (=>
            ...
            (closure_req TYPE%anonymous_closure%13. $ TYPE%tuple%0. (Poly%anonymous_closure%13.
              tmp%%1
             ) tmp%%$
           ))
           :pattern ((closure_req TYPE%anonymous_closure%13. $ TYPE%tuple%0. (Poly%anonymous_closure%13.
              tmp%%1
             ) tmp%%$
           ))
         ...
         (=>
          ...
          (and
           ...
           (=>
            ...
            (=>
             %%location_label%%2
             (req%vstd!pervasive.exec_nonstatic_call. $ TYPE%tuple%0. $ TYPE%tuple%0. (REF $) TYPE%anonymous_closure%13.
              (Poly%anonymous_closure%13. t@) (Poly%tuple%0. tmp%6)
 )))))))))))))
 (get-info :version)
 (set-option :rlimit 30000000)
 (check-sat)
