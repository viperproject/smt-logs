...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/atomics-1f6929080cfc21a4-one_atomic_ok/test.rs:40:1: 40:90 (#0)
  ...
  (not (=>
    ...
    (=>
     ...
     (=>
      (= inner~35@0 tmp%2@0)
      (=>
       (vstd!invariant.AtomicInvariant.inv.? A&. A& $ (UINT 8) B&. B& tmp%1 (I inner~35@0))
       (=>
        %%location_label%%0
        (vstd!invariant.AtomicInvariant.inv.? A&. A& $ (UINT 8) B&. B& tmp%1 (I inner~35@0))
 )))))))
