...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/atomics-1f6929080cfc21a4-call_closure_and_open_inv_inside/test.rs:40:1: 40:98 (#0)
...
(push)
 ...
 (declare-const inner~37@0 Int)
 (declare-const %closure_return~44 tuple%0.)
 (declare-const tmp%3 Poly)
 (declare-const tmp%4@0 Int)
 (declare-const inner~76@0 Int)
  ...
  (not (=>
    ...
    (=>
     ...
     (=>
      (= inner~37@0 tmp%2@0)
      (=>
       (vstd!invariant.LocalInvariant.inv.? A&. A& $ (UINT 8) B&. B& tmp%1 (I inner~37@0))
       (and
        (=>
         (= tmp%3 i!)
         (=>
          ...
          (=>
           (= inner~76@0 tmp%4@0)
           (=>
            (vstd!invariant.LocalInvariant.inv.? A&. A& $ (UINT 8) B&. B& tmp%3 (I inner~76@0))
            (=>
             %%location_label%%0
             (vstd!invariant.LocalInvariant.inv.? A&. A& $ (UINT 8) B&. B& tmp%3 (I inner~76@0))
        )))))
