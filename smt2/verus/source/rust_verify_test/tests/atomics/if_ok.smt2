...
(assert
 (distinct fuel%vstd!invariant.AtomicInvariant.inv. fuel%vstd!array.group_array_axioms.
...
;; Function-Decl vstd::invariant::impl&%0::constant
...
;; Function-Axioms vstd::invariant::impl&%0::constant
(assert
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/atomics-1f6929080cfc21a4-if_ok/test.rs:40:1: 40:98 (#0)
...
(push)
 ...
 (assert
  (has_type i! (TYPE%vstd!invariant.AtomicInvariant. A&. A& $ (UINT 8) B&. B&))
 )
 (assert
  (uInv 64 j!)
 )
  ...
  (not (=>
    ...
    (=>
     ...
     (=>
      (= inner~37@0 tmp%2@0)
      (=>
       (vstd!invariant.AtomicInvariant.inv.? A&. A& $ (UINT 8) B&. B& tmp%1 (I inner~37@0))
       (or
        (and
         (=>
          (= j! 1)
