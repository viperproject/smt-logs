...
(assert
 (distinct fuel%vstd!raw_ptr.impl&%4.view. fuel%vstd!raw_ptr.ptrs_mut_eq. fuel%vstd!seq.impl&%0.spec_index.
  ...
  fuel%vstd!view.impl&%24.view. fuel%vstd!view.impl&%42.view. fuel%test_crate!impl&%0.view.
...
(assert
 (= (proj%vstd!view.View./V $ TYPE%test_crate!S.) (UINT 8))
)
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/assoc_type_impls-ff4a593043060323-trait_poly/test.rs:16:7: 16:46 (#0)
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/assoc_type_impls-ff4a593043060323-trait_poly/test.rs:26:1: 26:10 (#0)
(get-info :all-statistics)
(push)
     ...
     (=>
      ...
      (=>
       ...
       (=>
        ...
        (=>
         (= tmp%3 (< (%I (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. x@)))) 256))
         (and
          (=>
           %%location_label%%0
           tmp%3
