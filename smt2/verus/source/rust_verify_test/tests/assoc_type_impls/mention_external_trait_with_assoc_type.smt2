...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/assoc_type_impls-ff4a593043060323-mention_external_trait_with_assoc_type/test.rs:16:1: 16:31 (#0)
...
(push)
 ...
 (assert
  (tr_bound%core!iter.traits.collect.IntoIterator. A&. A&)
 )
 (assert
  (not true)
 )
