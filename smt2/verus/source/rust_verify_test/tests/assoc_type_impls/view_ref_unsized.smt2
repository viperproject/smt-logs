...
;; Function-Specs test_crate::id
(declare-fun ens%test_crate!id. (Dcr Type Poly Poly) Bool)
(assert
 (forall ((T&. Dcr) (T& Type) (t! Poly) (%return! Poly)) (!
   (= (ens%test_crate!id. T&. T& t! %return!) (has_type %return! T&))
   :pattern ((ens%test_crate!id. T&. T& t! %return!))
   :qid internal_ens__test_crate!id._definition
   :skolemid skolem_internal_ens__test_crate!id._definition
)))

;; Function-Def test_crate::id
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/assoc_type_impls-ff4a593043060323-view_ref_unsized/test.rs:16:1: 16:26 (#0)
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/assoc_type_impls-ff4a593043060323-view_ref_unsized/test.rs:19:1: 19:10 (#0)
(get-info :all-statistics)
(push)
 ...
 (declare-const byte_slice@ slice%<u8.>.)
 (assert
  fuel_defaults
 )
