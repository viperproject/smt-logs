...
(declare-const fuel%is_good_integer. FuelId)
(declare-const fuel%is_good_message_10. FuelId)
(assert
 (distinct fuel%impl&%3.arrow_y. fuel%impl&%3.arrow_x. fuel%impl&%3.arrow_Quit_0. fuel%impl&%3.arrow_Move_x.
  fuel%impl&%3.arrow_Move_y. fuel%impl&%3.arrow_Write_0. fuel%is_good_integer. fuel%is_good_message_10.
))
...
;; Function-Decl crate::is_good_integer
(declare-fun is_good_integer.? (Poly) Bool)

;; Function-Decl crate::is_good_message_10
(declare-fun is_good_message_10.? (Poly) Bool)
...
;; Function-Axioms crate::is_good_integer
(assert
 (=>
  (fuel_bool fuel%is_good_integer.)
  (forall ((x! Poly)) (!
    (= (is_good_integer.? x!) (and
      (>= (%I x!) 0)
      (not (= (%I x!) 5))
    ))
    :pattern ((is_good_integer.? x!))
    :qid internal_is_good_integer.?_definition
    :skolemid skolem_internal_is_good_integer.?_definition
))))

;; Function-Axioms crate::is_good_message_10
(assert
 (=>
  (fuel_bool fuel%is_good_message_10.)
  (forall ((msg! Poly)) (!
    (= (is_good_message_10.? msg!) (ite
      ...
      (ite
       ...
       (let
        ...
        (let
         ...
         (is_good_integer.? (I (Sub x$ y$)))
       ))
       (let
        ((b$ (Message./Write/0 (%Poly%Message. msg!))))
        b$
    ))))
    :pattern ((is_good_message_10.? msg!))
    :qid internal_is_good_message_10.?_definition
    :skolemid skolem_internal_is_good_message_10.?_definition
))))

;; Function-Def crate::test_reveal
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/expand_errors-fcd0bf0bcccc130d-test7_local_reveal/test.rs:37:7: 37:30 (#0)
...
(push)
 ...
 (assert
  (not (=>
    (= good_msg@ (Message./Move (%I (I 0)) (%I (I 0))))
    (or
     (and
      (=>
       b!
      ...
      (=>
       ...
       (and
        ...
        (=>
         (= tmp%1 (is_good_message_10.? (Poly%Message. good_msg@)))
         (and
          (=>
           %%location_label%%1
           tmp%1
...
;; Function-Recommends crate::test_reveal
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/expand_errors-fcd0bf0bcccc130d-test7_local_reveal/test.rs:37:7: 37:30 (#0)
(get-info :all-statistics)
(push)
 (declare-const b! Bool)
    ...
    (or
     (and
      ...
      (=>
       (not b!)
       (=>
        (is_good_message_10.? (Poly%Message. good_msg@))
        %%switch_label%%0
     )))
     (not %%switch_label%%0)
 ))))
