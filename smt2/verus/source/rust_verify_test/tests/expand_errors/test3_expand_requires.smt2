...
(declare-const fuel%is_good_integer_3. FuelId)
(declare-const fuel%is_good_message_3. FuelId)
(assert
 (distinct fuel%impl&%3.arrow_x. fuel%impl&%3.arrow_y. fuel%impl&%3.arrow_Quit_0. fuel%impl&%3.arrow_Move_x.
  fuel%impl&%3.arrow_Move_y. fuel%impl&%3.arrow_Write_0. fuel%is_good_integer_3. fuel%is_good_message_3.
))
...
;; Function-Decl crate::is_good_integer_3
(declare-fun is_good_integer_3.? (Poly) Bool)

;; Function-Decl crate::is_good_message_3
(declare-fun is_good_message_3.? (Poly) Bool)
...
;; Function-Axioms crate::is_good_integer_3
(assert
 (fuel_bool_default fuel%is_good_integer_3.)
)
(assert
 (=>
  (fuel_bool fuel%is_good_integer_3.)
  (forall ((x! Poly)) (!
    (= (is_good_integer_3.? x!) (and
      (>= (%I x!) 0)
      (not (= (%I x!) 5))
    ))
    :pattern ((is_good_integer_3.? x!))
    :qid internal_is_good_integer_3.?_definition
    :skolemid skolem_internal_is_good_integer_3.?_definition
))))

;; Function-Axioms crate::is_good_message_3
(assert
 (fuel_bool_default fuel%is_good_message_3.)
)
(assert
 (=>
  (fuel_bool fuel%is_good_message_3.)
  (forall ((msg! Poly)) (!
    (= (is_good_message_3.? msg!) (ite
      ...
      (ite
       ...
       (let
        ...
        (let
         ...
         (is_good_integer_3.? (I (Sub x$ y$)))
       ))
       (let
        ((b$ (Message./Write/0 (%Poly%Message. msg!))))
        b$
    ))))
    :pattern ((is_good_message_3.? msg!))
    :qid internal_is_good_message_3.?_definition
    :skolemid skolem_internal_is_good_message_3.?_definition
))))

;; Function-Specs crate::test_require_failure
(declare-fun req%test_require_failure. (Message. Bool) Bool)
(declare-const %%global_location_label%%0 Bool)
(declare-const %%global_location_label%%1 Bool)
(assert
 (forall ((m! Message.) (b! Bool)) (!
   (= (req%test_require_failure. m! b!) (and
     (=>
     ...
     (=>
      ...
      (is_good_message_3.? (Poly%Message. m!))
   )))
   :pattern ((req%test_require_failure. m! b!))
   :qid internal_req__test_require_failure._definition
   :skolemid skolem_internal_req__test_require_failure._definition
)))
(declare-fun ens%test_require_failure. (Message. Bool Int) Bool)
(assert
 (forall ((m! Message.) (b! Bool) (good_int! Int)) (!
   (= (ens%test_require_failure. m! b! good_int!) (is_good_integer_3.? (I good_int!)))
   :pattern ((ens%test_require_failure. m! b! good_int!))
   :qid internal_ens__test_require_failure._definition
   :skolemid skolem_internal_ens__test_require_failure._definition
)))

;; Function-Def crate::test_require_failure
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/expand_errors-fcd0bf0bcccc130d-test3_expand_requires/test.rs:38:7: 38:68 (#0)
(get-info :all-statistics)
(push)
 (declare-const good_int! Int)
 ...
 (assert
  (has_type (Poly%Message. m!) TYPE%Message.)
 )
 (assert
  b!
 )
...
;; Function-Def crate::test_3
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/expand_errors-fcd0bf0bcccc130d-test3_expand_requires/test.rs:49:7: 49:23 (#0)
(get-info :all-statistics)
(push)
 (declare-const x! Int)
 ...
 (assert
  (not (=>
    (= x@ (Message./Move (%I (I 0)) (%I (I 5))))
    (=>
     %%location_label%%0
     (req%test_require_failure. x@ true)
 ))))
 (get-info :version)
 (set-option :rlimit 30000000)
 (check-sat)
...
;; Function-Expand-Errors crate::test_3
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/expand_errors-fcd0bf0bcccc130d-test3_expand_requires/test.rs:49:7: 49:23 (#0)
(get-info :all-statistics)
(push)
 (declare-const x! Int)
...
(push)
 ...
 (assert
  (not (=>
    ...
    (=>
     %%location_label%%0
     (is_good_message_3.? (Poly%Message. x@))
 ))))
 (get-info :version)
 (set-option :rlimit 30000000)
 (check-sat)
...
;; Function-Recommends crate::test_3
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/expand_errors-fcd0bf0bcccc130d-test3_expand_requires/test.rs:49:7: 49:23 (#0)
(get-info :all-statistics)
(push)
 (declare-const x! Int)
