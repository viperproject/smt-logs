...
(declare-const fuel%is_good_integer_13. FuelId)
(declare-const fuel%is_good_message_13. FuelId)
(assert
 (distinct fuel%impl&%3.arrow_y. fuel%impl&%3.arrow_x. fuel%impl&%3.arrow_Quit_0. fuel%impl&%3.arrow_Move_x.
  fuel%impl&%3.arrow_Move_y. fuel%impl&%3.arrow_Write_0. fuel%is_good_integer_13. fuel%is_good_message_13.
))
...
;; Function-Decl crate::is_good_integer_13
(declare-fun is_good_integer_13.? (Poly) Bool)

;; Function-Decl crate::is_good_message_13
(declare-fun is_good_message_13.? (Poly) Bool)
...
;; Function-Axioms crate::is_good_integer_13
(assert
 (=>
  (fuel_bool fuel%is_good_integer_13.)
  (forall ((x! Poly)) (!
    (= (is_good_integer_13.? x!) (and
      (>= (%I x!) 0)
      (not (= (%I x!) 5))
    ))
    :pattern ((is_good_integer_13.? x!))
    :qid internal_is_good_integer_13.?_definition
    :skolemid skolem_internal_is_good_integer_13.?_definition
))))

;; Function-Axioms crate::is_good_message_13
(assert
 (=>
  (fuel_bool fuel%is_good_message_13.)
  (forall ((msg! Poly)) (!
    (= (is_good_message_13.? msg!) (ite
      ...
      (ite
       ...
       (let
        ...
        (let
         ...
         (is_good_integer_13.? (I (Sub x$ y$)))
       ))
       (let
        ((b$ (Message./Write/0 (%Poly%Message. msg!))))
        b$
    ))))
    :pattern ((is_good_message_13.? msg!))
    :qid internal_is_good_message_13.?_definition
    :skolemid skolem_internal_is_good_message_13.?_definition
))))

;; Function-Specs crate::test_reveal_at_ensures
(declare-fun ens%test_reveal_at_ensures. (Bool Message.) Bool)
(assert
 (forall ((b! Bool) (good_msg! Message.)) (!
   (= (ens%test_reveal_at_ensures. b! good_msg!) (and
     (has_type (Poly%Message. good_msg!) TYPE%Message.)
     (is_good_message_13.? (Poly%Message. good_msg!))
   ))
   :pattern ((ens%test_reveal_at_ensures. b! good_msg!))
   :qid internal_ens__test_reveal_at_ensures._definition
   :skolemid skolem_internal_ens__test_reveal_at_ensures._definition
)))

;; Function-Def crate::test_reveal_at_ensures
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/expand_errors-fcd0bf0bcccc130d-test8_ensures_reveal/test.rs:37:7: 37:63 (#0)
...
;; Function-Expand-Errors crate::test_reveal_at_ensures
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/expand_errors-fcd0bf0bcccc130d-test8_ensures_reveal/test.rs:37:7: 37:63 (#0)
(get-info :all-statistics)
(push)
 (declare-const good_msg! Message.)
       ...
       (=>
        ...
        (=>
         ...
         (=>
          ...
          (=>
           %%location_label%%0
           (is_good_integer_13.? (I (Sub x$$$1 y$$$2)))
 ))))))))))
 (get-info :version)
 (set-option :rlimit 30000000)
 (check-sat)
...
;; Function-Recommends crate::test_reveal_at_ensures
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/expand_errors-fcd0bf0bcccc130d-test8_ensures_reveal/test.rs:37:7: 37:63 (#0)
(get-info :all-statistics)
(push)
 (declare-const good_msg! Message.)
