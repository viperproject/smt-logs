...
;; Function-Decl crate::is_good_integer_4
(declare-fun is_good_integer_4.? (Poly) Bool)
...
;; Function-Axioms crate::is_good_integer_4
(assert
 (fuel_bool_default fuel%is_good_integer_4.)
)
(assert
 (=>
  (fuel_bool fuel%is_good_integer_4.)
  (forall ((x! Poly)) (!
    (= (is_good_integer_4.? x!) (and
      (>= (%I x!) 0)
      (not (= (%I x!) 5))
    ))
    :pattern ((is_good_integer_4.? x!))
    :qid internal_is_good_integer_4.?_definition
    :skolemid skolem_internal_is_good_integer_4.?_definition
))))

;; Function-Axioms crate::is_good_message_4
(assert
 (fuel_bool_default fuel%is_good_message_4.)
)
(assert
 (=>
  (fuel_bool fuel%is_good_message_4.)
  (forall ((msg! Poly)) (!
    (= (is_good_message_4.? msg!) (ite
      ...
      (ite
       ...
       (let
        ...
        (let
         ...
         (is_good_integer_4.? (I (Sub x$ y$)))
       ))
       (let
        ((b$ (Message./Write/0 (%Poly%Message. msg!))))
        b$
    ))))
    :pattern ((is_good_message_4.? msg!))
    :qid internal_is_good_message_4.?_definition
    :skolemid skolem_internal_is_good_message_4.?_definition
))))

;; Function-Specs crate::test_ensures_failure
(declare-fun ens%test_ensures_failure. (Bool Message.) Bool)
(assert
 (forall ((b! Bool) (good_msg! Message.)) (!
   (= (ens%test_ensures_failure. b! good_msg!) (and
     (has_type (Poly%Message. good_msg!) TYPE%Message.)
     (is_good_message_4.? (Poly%Message. good_msg!))
   ))
   :pattern ((ens%test_ensures_failure. b! good_msg!))
   :qid internal_ens__test_ensures_failure._definition
   :skolemid skolem_internal_ens__test_ensures_failure._definition
)))

;; Function-Def crate::test_ensures_failure
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/expand_errors-fcd0bf0bcccc130d-test4_expand_ensures/test.rs:38:7: 38:61 (#0)
(get-info :all-statistics)
(push)
 (declare-const good_msg! Message.)
 (declare-const b! Bool)
 (declare-const ret@0 Message.)
 (assert
  fuel_defaults
 )
 (declare-const ret@1 Message.)
 (declare-const %%switch_label%%0 Bool)
 ;; postcondition not satisfied
 (declare-const %%location_label%%0 Bool)
 (assert
  (not (=>
    (= ret@0 (Message./Write (%B (B true))))
    (or
     (and
      (=>
       (not b!)
       (=>
        (= ret@1 (Message./Move (%I (I 10)) (%I (I 5))))
        %%switch_label%%0
      ))
      (=>
       (not (not b!))
...
;; Function-Expand-Errors crate::test_ensures_failure
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/expand_errors-fcd0bf0bcccc130d-test4_expand_ensures/test.rs:38:7: 38:61 (#0)
(get-info :all-statistics)
(push)
 (declare-const good_msg! Message.)
    ...
    (or
     ...
     (and
      ...
      (=>
       (= good_msg! ret@1)
       (=>
        (is-Message./Quit (%Poly%Message. (Poly%Message. good_msg!)))
        (=>
         (= b$$$0 (Message./Quit/0 (%Poly%Message. (Poly%Message. good_msg!))))
         (=>
          %%location_label%%0
          b$$$0
 )))))))))
    ...
    (or
     ...
     (and
      ...
      (=>
       (= good_msg! ret@1)
       (=>
        (not (is-Message./Quit (%Poly%Message. (Poly%Message. good_msg!))))
        (=>
         (is-Message./Move (%Poly%Message. (Poly%Message. good_msg!)))
         (=>
          (= x$$$1 (Message./Move/x (%Poly%Message. (Poly%Message. good_msg!))))
          (=>
           (= y$$$2 (Message./Move/y (%Poly%Message. (Poly%Message. good_msg!))))
           (=>
            %%location_label%%0
            (>= (%I (I (Sub x$$$1 y$$$2))) 0)
 )))))))))))
     ...
     (and
      ...
      (=>
       ...
       (=>
        (not (is-Message./Quit (%Poly%Message. (Poly%Message. good_msg!))))
        (=>
         (not (is-Message./Move (%Poly%Message. (Poly%Message. good_msg!))))
         (=>
          (= b$$$3 (Message./Write/0 (%Poly%Message. (Poly%Message. good_msg!))))
          (=>
           %%location_label%%0
           b$$$3
 ))))))))))
...
;; Function-Recommends crate::test_ensures_failure
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/expand_errors-fcd0bf0bcccc130d-test4_expand_ensures/test.rs:38:7: 38:61 (#0)
(get-info :all-statistics)
(push)
 (declare-const good_msg! Message.)
