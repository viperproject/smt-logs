...
(declare-const fuel%impl&%1.is_good. FuelId)
(assert
 (distinct fuel%impl&%0.the_inv. fuel%impl&%1.is_good.)
)
...
;; Function-Decl crate::Tr::is_good
(declare-fun Tr.is_good.? (Dcr Type Poly) Poly)
(declare-fun Tr.is_good%default%.? (Dcr Type Poly) Poly)

;; Function-Decl crate::X::the_inv
(declare-fun impl&%0.the_inv.? (Dcr Type Poly) Bool)

;; Function-Axioms crate::Tr::is_good
(assert
 (forall ((Self%&. Dcr) (Self%& Type) (self! Poly)) (!
   (=>
    (has_type self! Self%&)
    (has_type (Tr.is_good.? Self%&. Self%& self!) BOOL)
   )
   :pattern ((Tr.is_good.? Self%&. Self%& self!))
   :qid internal_Tr.is_good.?_pre_post_definition
   :skolemid skolem_internal_Tr.is_good.?_pre_post_definition
)))
...
(assert
 (=>
  ...
  (forall ((T&. Dcr) (T& Type) (self! Poly)) (!
    (= (impl&%0.the_inv.? T&. T& self!) (%B (Tr.is_good.? T&. T& (X./X/i (%Poly%X. self!)))))
...
;; Function-Axioms crate::impl&%1::is_good
(assert
 (fuel_bool_default fuel%impl&%1.is_good.)
)
(assert
 (=>
  (fuel_bool fuel%impl&%1.is_good.)
  (forall ((self! Poly)) (!
    (= (Tr.is_good.? $ (UINT 8) self!) (B (and
       (<= 0 (%I self!))
       (< (%I self!) 15)
    )))
    :pattern ((Tr.is_good.? $ (UINT 8) self!))
    :qid internal_Tr.is_good.?_definition
    :skolemid skolem_internal_Tr.is_good.?_definition
))))
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/user_defined_type_invariants-69821374e4e4d573-test_with_generics_and_traits/test.rs:41:1: 41:13 (#0)
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/user_defined_type_invariants-69821374e4e4d573-test_with_generics_and_traits/test.rs:45:1: 45:15 (#0)
(get-info :all-statistics)
(push)
 (declare-const no%param Int)
 (declare-const tmp%1 X.)
...
;; Function-Specs crate::test_ok2
(declare-fun req%test_ok2. (Dcr Type Poly) Bool)
...
(assert
 (forall ((T&. Dcr) (T& Type) (a! Poly)) (!
   ...
   :pattern ((req%test_ok2. T&. T& a!))
   :qid internal_req__test_ok2._definition
   :skolemid skolem_internal_req__test_ok2._definition
)))

;; Function-Def crate::test_ok2
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/user_defined_type_invariants-69821374e4e4d573-test_with_generics_and_traits/test.rs:49:1: 49:32 (#0)
(get-info :all-statistics)
(push)
 (declare-const T&. Dcr)
...
;; Function-Specs crate::test_fail2
(declare-fun req%test_fail2. (Dcr Type Poly Poly) Bool)
(declare-const %%global_location_label%%1 Bool)
(assert
 (forall ((T&. Dcr) (T& Type) (a! Poly) (b! Poly)) (!
   (= (req%test_fail2. T&. T& a! b!) (=>
     %%global_location_label%%1
     (%B (Tr.is_good.? T&. T& b!))
   ))
   :pattern ((req%test_fail2. T&. T& a! b!))
   :qid internal_req__test_fail2._definition
   :skolemid skolem_internal_req__test_fail2._definition
)))

;; Function-Def crate::test_fail2
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/user_defined_type_invariants-69821374e4e4d573-test_with_generics_and_traits/test.rs:55:1: 55:33 (#0)
(get-info :all-statistics)
(push)
 (declare-const T&. Dcr)
 (declare-const T& Type)
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/user_defined_type_invariants-69821374e4e4d573-test_with_generics_and_traits/test.rs:61:1: 61:41 (#0)
(get-info :all-statistics)
(push)
 (declare-const T&. Dcr)
 (declare-const T& Type)
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/user_defined_type_invariants-69821374e4e4d573-test_with_generics_and_traits/test.rs:65:1: 65:41 (#0)
(get-info :all-statistics)
(push)
 (declare-const T&. Dcr)
 (declare-const T& Type)
