...
(declare-fun ens%test. (Y. Y.) Bool)
(assert
 (forall ((pre%y! Y.) (y! Y.)) (!
   (= (ens%test. pre%y! y!) (has_type (Poly%Y. y!) TYPE%Y.))
   :pattern ((ens%test. pre%y! y!))
   :qid internal_ens__test._definition
   :skolemid skolem_internal_ens__test._definition
)))

;; Function-Def crate::test
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/user_defined_type_invariants-69821374e4e4d573-test_mut_ref_nested/test.rs:38:1: 38:19 (#0)
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/user_defined_type_invariants-69821374e4e4d573-test_mut_ref_nested/test.rs:43:1: 43:20 (#0)
(get-info :all-statistics)
(push)
 (declare-const y!@0 Y.)
 (declare-const tmp%1 X.)
...
;; Function-Specs crate::test_ok
(declare-fun req%test_ok. (Y.) Bool)
(declare-const %%global_location_label%%0 Bool)
(assert
 (forall ((pre%y! Y.)) (!
   (= (req%test_ok. pre%y!) (=>
     %%global_location_label%%0
     (= (X./X/j (%Poly%X. (Poly%X. (Y./Y/x (%Poly%Y. (Poly%Y. pre%y!)))))) 26)
   ))
   :pattern ((req%test_ok. pre%y!))
   :qid internal_req__test_ok._definition
   :skolemid skolem_internal_req__test_ok._definition
)))
(declare-fun ens%test_ok. (Y. Y.) Bool)
(assert
 (forall ((pre%y! Y.) (y! Y.)) (!
   (= (ens%test_ok. pre%y! y!) (has_type (Poly%Y. y!) TYPE%Y.))
   :pattern ((ens%test_ok. pre%y! y!))
   :qid internal_ens__test_ok._definition
   :skolemid skolem_internal_ens__test_ok._definition
)))

;; Function-Def crate::test_ok
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/user_defined_type_invariants-69821374e4e4d573-test_mut_ref_nested/test.rs:47:1: 47:22 (#0)
(get-info :all-statistics)
(push)
 (declare-const y!@0 Y.)
 (declare-const tmp%1 X.)
 ...
 (assert
  (= (X./X/j (%Poly%X. (Poly%X. (Y./Y/x (%Poly%Y. (Poly%Y. y!@0)))))) 26)
 )
 (declare-const y!@1 Y.)
 (declare-const y!@2 Y.)
 ;; constructed value may fail to meet its declared type invariant
