...
;; Datatypes
(declare-datatypes ((Y. 0) (X. 0) (tuple%0. 0)) (((Y./Y (Y./Y/?t Int))) ((X./X (X./X/?i
     Int
    ) (X./X/?j Int) (X./X/?y Y.)
   )
  ) ((tuple%0./tuple%0))
))
(declare-fun Y./Y/t (Y.) Int)
...
(assert
 (forall ((x Y.)) (!
   (= (Y./Y/t x) (Y./Y/?t x))
   :pattern ((Y./Y/t x))
   :qid internal_Y./Y/t_accessor_definition
   :skolemid skolem_internal_Y./Y/t_accessor_definition
)))
(assert
 (forall ((x Y.)) (!
 ...
 (=>
  ...
  (forall ((self! Poly)) (!
    (= (impl&%0.the_inv.? self!) (and
      ...
      (< (Y./Y/t (%Poly%Y. (Poly%Y. (X./X/y (%Poly%X. self!))))) 40)
    ))
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/user_defined_type_invariants-69821374e4e4d573-assignment_to_tracked_needs_check_nested_with_ghost/test.rs:33:7: 33:16 (#0)
...
(push)
 ...
 (assert
  (not (=>
    (= tmp%1 (X./X (%I (I 5)) (%I (I 20)) (%Poly%Y. (Poly%Y. (Y./Y (%I (I 18)))))))
    (=>
     ...
     (and
      ...
      (=>
       ...
       (=>
        (= x@0 tmp%1)
        (=>
         (= (Y./Y/t (%Poly%Y. (Poly%Y. (X./X/y (%Poly%X. (Poly%X. x@1)))))) 50)
         (=>
          (and
           (= (X./X/i x@0) (X./X/i x@1))
           (= (X./X/j x@0) (X./X/j x@1))
