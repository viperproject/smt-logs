...
(declare-fun ens%test. (X. X.) Bool)
(assert
 (forall ((pre%x! X.) (x! X.)) (!
   (= (ens%test. pre%x! x!) (has_type (Poly%X. x!) TYPE%X.))
   :pattern ((ens%test. pre%x! x!))
   :qid internal_ens__test._definition
   :skolemid skolem_internal_ens__test._definition
)))

;; Function-Def crate::test
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/user_defined_type_invariants-69821374e4e4d573-test_mut_ref_whole_ok/test.rs:27:1: 27:19 (#0)
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/user_defined_type_invariants-69821374e4e4d573-test_mut_ref_whole_ok/test.rs:31:1: 31:11 (#0)
(get-info :all-statistics)
(push)
...
(declare-fun ens%test3. (X. X. X.) Bool)
(assert
 (forall ((pre%x! X.) (x! X.) (x2! X.)) (!
   (= (ens%test3. pre%x! x! x2!) (has_type (Poly%X. x!) TYPE%X.))
   :pattern ((ens%test3. pre%x! x! x2!))
   :qid internal_ens__test3._definition
   :skolemid skolem_internal_ens__test3._definition
)))

;; Function-Def crate::test3
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/user_defined_type_invariants-69821374e4e4d573-test_mut_ref_whole_ok/test.rs:36:1: 36:27 (#0)
(get-info :all-statistics)
(push)
 (declare-const x!@0 X.)
 (declare-const x2! X.)
