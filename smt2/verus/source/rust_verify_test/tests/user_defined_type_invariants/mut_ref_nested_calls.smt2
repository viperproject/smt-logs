...
(assert
 (=>
  ...
  (forall ((self! Poly)) (!
    (= (impl&%0.the_inv.? self!) (<= (X./X/i (%Poly%X. self!)) (X./X/j (%Poly%X. self!))))
...
;; Function-Specs crate::set_to
(declare-fun ens%set_to. (Int Int Int Int Int) Bool)
(assert
 (forall ((pre%i! Int) (i! Int) (x! Int) (y! Int) (ret! Int)) (!
   (= (ens%set_to. pre%i! i! x! y! ret!) (and
     (uInv 8 ret!)
     (uInv 8 i!)
     (= i! x!)
     (= ret! y!)
   ))
   :pattern ((ens%set_to. pre%i! i! x! y! ret!))
   :qid internal_ens__set_to._definition
   :skolemid skolem_internal_ens__set_to._definition
)))

;; Function-Def crate::set_to
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/user_defined_type_invariants-69821374e4e4d573-mut_ref_nested_calls/test.rs:27:1: 27:48 (#0)
...
;; Function-Def crate::test_nested_calls
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/user_defined_type_invariants-69821374e4e4d573-mut_ref_nested_calls/test.rs:35:1: 35:23 (#0)
(get-info :all-statistics)
(push)
       ...
       (=>
        ...
        (=>
         ...
         (=>
          ...
          (=>
           (ens%set_to. (X./X/i (%Poly%X. (Poly%X. x@0))) (X./X/i (%Poly%X. (Poly%X. x@1))) 2
            3 tmp$1@
           )
           (=>
            (= tmp%3 x@1)
              ...
              (=>
               ...
               (=>
                ...
                (=>
                 ...
                 (=>
                  (ens%set_to. (X./X/j (%Poly%X. (Poly%X. x@1))) (X./X/j (%Poly%X. (Poly%X. x@2))) tmp$1@
                   0 tmp@
                  )
                  (=>
                   (= tmp%5 x@2)
...
;; Function-Def crate::test_nested_calls2
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/user_defined_type_invariants-69821374e4e4d573-mut_ref_nested_calls/test.rs:42:1: 42:24 (#0)
(get-info :all-statistics)
(push)
 (declare-const no%param Int)
 (declare-const tmp%1 X.)
       ...
       (=>
        ...
        (=>
         ...
         (=>
          (has_type (Poly%X. x@1) TYPE%X.)
          (=>
           (ens%set_to. (X./X/j (%Poly%X. (Poly%X. x@0))) (X./X/j (%Poly%X. (Poly%X. x@1))) 3
            2 tmp$1@
           )
           (=>
            (= tmp%3 x@1)
              ...
              (=>
               ...
               (=>
                ...
                (=>
                 (has_type (Poly%X. x@2) TYPE%X.)
                 (=>
                  (ens%set_to. (X./X/i (%Poly%X. (Poly%X. x@1))) (X./X/i (%Poly%X. (Poly%X. x@2))) tmp$1@
                   0 tmp@
                  )
                  (=>
                   (= tmp%5 x@2)
...
;; Function-Recommends crate::test_nested_calls2
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/user_defined_type_invariants-69821374e4e4d573-mut_ref_nested_calls/test.rs:42:1: 42:24 (#0)
(get-info :all-statistics)
(push)
 (declare-const no%param Int)
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/user_defined_type_invariants-69821374e4e4d573-mut_ref_nested_calls/test.rs:53:1: 53:24 (#0)
(get-info :all-statistics)
(push)
 (declare-const no%param Int)
 (declare-const tmp%1 X.)
