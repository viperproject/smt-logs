...
;; Fuel
(declare-const fuel%impl&%0.wf. FuelId)
(declare-const fuel%impl&%1.wf. FuelId)
(assert
 (distinct fuel%impl&%0.wf. fuel%impl&%1.wf.)
)

;; Datatypes
(declare-datatypes ((X. 0) (Y. 0) (tuple%3. 0)) (((X./X (X./X/?re tuple%3.))) ((Y./Y
    (Y./Y/?re tuple%3.)
   )
  ) ((tuple%3./tuple%3 (tuple%3./tuple%3/?0 Poly) (tuple%3./tuple%3/?1 Poly) (tuple%3./tuple%3/?2
     Poly
)))))
(declare-fun X./X/re (X.) tuple%3.)
(declare-fun Y./Y/re (Y.) tuple%3.)
...
(declare-fun TYPE%X. (Dcr Type Dcr Type) Type)
(declare-fun TYPE%Y. (Dcr Type Dcr Type) Type)
...
(assert
 (forall ((A&. Dcr) (A& Type) (B&. Dcr) (B& Type) (x Poly)) (!
   (=>
    (has_type x (TYPE%X. A&. A& B&. B&))
    (= x (Poly%X. (%Poly%X. x)))
   )
   :pattern ((has_type x (TYPE%X. A&. A& B&. B&)))
   :qid internal_crate__X_unbox_axiom_definition
   :skolemid skolem_internal_crate__X_unbox_axiom_definition
)))
(assert
 (forall ((A&. Dcr) (A& Type) (B&. Dcr) (B& Type) (_re! tuple%3.)) (!
   (=>
    (has_type (Poly%tuple%3. _re!) (TYPE%tuple%3. A&. A& B&. B& A&. A&))
    (has_type (Poly%X. (X./X _re!)) (TYPE%X. A&. A& B&. B&))
   )
   :pattern ((has_type (Poly%X. (X./X _re!)) (TYPE%X. A&. A& B&. B&)))
...
(assert
 (forall ((x X.)) (!
   (= (X./X/re x) (X./X/?re x))
   :pattern ((X./X/re x))
   :qid internal_X./X/re_accessor_definition
   :skolemid skolem_internal_X./X/re_accessor_definition
)))
(assert
 (forall ((A&. Dcr) (A& Type) (B&. Dcr) (B& Type) (x Poly)) (!
   (=>
    (has_type x (TYPE%X. A&. A& B&. B&))
    (has_type (Poly%tuple%3. (X./X/re (%Poly%X. x))) (TYPE%tuple%3. A&. A& B&. B& A&. A&))
   )
   :pattern ((X./X/re (%Poly%X. x)) (has_type x (TYPE%X. A&. A& B&. B&)))
   :qid internal_X./X/re_invariant_definition
   :skolemid skolem_internal_X./X/re_invariant_definition
)))
(assert
 (forall ((x X.)) (!
   (=>
    (is-X./X x)
    (height_lt (height (Poly%tuple%3. (X./X/re x))) (height (Poly%X. x)))
   )
   :pattern ((height (Poly%tuple%3. (X./X/re x))))
   :qid prelude_datatype_height_X./X/re
   :skolemid skolem_prelude_datatype_height_X./X/re
)))
(assert
 (forall ((x Y.)) (!
   (= x (%Poly%Y. (Poly%Y. x)))
...
(assert
 (forall ((A&. Dcr) (A& Type) (B&. Dcr) (B& Type) (x Poly)) (!
   (=>
    (has_type x (TYPE%Y. A&. A& B&. B&))
    (= x (Poly%Y. (%Poly%Y. x)))
   )
   :pattern ((has_type x (TYPE%Y. A&. A& B&. B&)))
...
(assert
 (forall ((A&. Dcr) (A& Type) (B&. Dcr) (B& Type) (_re! tuple%3.)) (!
   (=>
    (has_type (Poly%tuple%3. _re!) (TYPE%tuple%3. A&. A& B&. B& A&. A&))
    (has_type (Poly%Y. (Y./Y _re!)) (TYPE%Y. A&. A& B&. B&))
   )
   :pattern ((has_type (Poly%Y. (Y./Y _re!)) (TYPE%Y. A&. A& B&. B&)))
...
(assert
 (forall ((x Y.)) (!
   (= (Y./Y/re x) (Y./Y/?re x))
   :pattern ((Y./Y/re x))
   :qid internal_Y./Y/re_accessor_definition
   :skolemid skolem_internal_Y./Y/re_accessor_definition
)))
(assert
 (forall ((A&. Dcr) (A& Type) (B&. Dcr) (B& Type) (x Poly)) (!
   (=>
    (has_type x (TYPE%Y. A&. A& B&. B&))
    (has_type (Poly%tuple%3. (Y./Y/re (%Poly%Y. x))) (TYPE%tuple%3. A&. A& B&. B& A&. A&))
   )
   :pattern ((Y./Y/re (%Poly%Y. x)) (has_type x (TYPE%Y. A&. A& B&. B&)))
   :qid internal_Y./Y/re_invariant_definition
   :skolemid skolem_internal_Y./Y/re_invariant_definition
)))
(assert
 (forall ((x Y.)) (!
   (=>
    (is-Y./Y x)
    (height_lt (height (Poly%tuple%3. (Y./Y/re x))) (height (Poly%Y. x)))
   )
   :pattern ((height (Poly%tuple%3. (Y./Y/re x))))
   :qid prelude_datatype_height_Y./Y/re
   :skolemid skolem_prelude_datatype_height_Y./Y/re
)))
(assert
 (forall ((x tuple%3.)) (!
...
(assert
 (forall ((Self%&. Dcr) (Self%& Type) (A1&. Dcr) (A1& Type)) (!
   true
   :pattern ((tr_bound%Tr. Self%&. Self%& A1&. A1&))
...
(declare-fun Tr.foo.? (Dcr Type Dcr Type Poly) Poly)
(declare-fun Tr.foo%default%.? (Dcr Type Dcr Type Poly) Poly)

;; Function-Decl crate::X::wf
(declare-fun impl&%0.wf.? (Dcr Type Dcr Type Poly) Bool)

;; Function-Decl crate::Y::wf
(declare-fun impl&%1.wf.? (Dcr Type Dcr Type Poly) Bool)

;; Function-Axioms crate::Tr::foo
(assert
 (forall ((Self%&. Dcr) (Self%& Type) (A1&. Dcr) (A1& Type) (self! Poly)) (!
   (=>
    (has_type self! Self%&)
    (has_type (Tr.foo.? Self%&. Self%& A1&. A1& self!) BOOL)
   )
   :pattern ((Tr.foo.? Self%&. Self%& A1&. A1& self!))
   :qid internal_Tr.foo.?_pre_post_definition
   :skolemid skolem_internal_Tr.foo.?_pre_post_definition
)))

;; Function-Axioms crate::X::wf
(assert
 (fuel_bool_default fuel%impl&%0.wf.)
)
(assert
 (=>
  (fuel_bool fuel%impl&%0.wf.)
  (forall ((A&. Dcr) (A& Type) (B&. Dcr) (B& Type) (self! Poly)) (!
    (= (impl&%0.wf.? A&. A& B&. B& self!) (= (tuple%3./tuple%3/0 (%Poly%tuple%3. (Poly%tuple%3.
         (X./X/re (%Poly%X. self!))
       ))
      ) (tuple%3./tuple%3/2 (%Poly%tuple%3. (Poly%tuple%3. (X./X/re (%Poly%X. self!)))))
    ))
    :pattern ((impl&%0.wf.? A&. A& B&. B& self!))
    :qid internal_impl&__0.wf.?_definition
    :skolemid skolem_internal_impl&__0.wf.?_definition
))))

;; Function-Axioms crate::Y::wf
(assert
 (fuel_bool_default fuel%impl&%1.wf.)
)
(assert
 (=>
  (fuel_bool fuel%impl&%1.wf.)
  (forall ((A&. Dcr) (A& Type) (B&. Dcr) (B& Type) (self! Poly)) (!
    (= (impl&%1.wf.? A&. A& B&. B& self!) (and
      (= (tuple%3./tuple%3/0 (%Poly%tuple%3. (Poly%tuple%3. (Y./Y/re (%Poly%Y. self!)))))
       (tuple%3./tuple%3/2 (%Poly%tuple%3. (Poly%tuple%3. (Y./Y/re (%Poly%Y. self!)))))
      )
      (%B (Tr.foo.? B&. B& A&. A& (tuple%3./tuple%3/1 (%Poly%tuple%3. (Poly%tuple%3. (Y./Y/re
            (%Poly%Y. self!)
    ))))))))
    :pattern ((impl&%1.wf.? A&. A& B&. B& self!))
    :qid internal_impl&__1.wf.?_definition
    :skolemid skolem_internal_impl&__1.wf.?_definition
))))
