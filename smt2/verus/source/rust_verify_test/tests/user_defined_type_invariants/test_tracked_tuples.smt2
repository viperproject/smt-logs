...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/user_defined_type_invariants-69821374e4e4d573-test_tracked_tuples/test.rs:39:7: 39:40 (#0)
...
(declare-fun req%test1. (tuple%2.) Bool)
(declare-const %%global_location_label%%0 Bool)
(assert
 (forall ((t! tuple%2.)) (!
   (= (req%test1. t!) (=>
     %%global_location_label%%0
     (= t! (tuple%2./tuple%2 (Poly%X. (X./X (%I (I 10)) (%I (I 8)))) (Poly%Y. (Y./Y (%I (I 100))
         (%I (I 100))
   ))))))
   :pattern ((req%test1. t!))
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/user_defined_type_invariants-69821374e4e4d573-test_tracked_tuples/test.rs:41:7: 41:34 (#0)
(get-info :all-statistics)
(push)
 (declare-const t! tuple%2.)
 ...
 (assert
  (has_type (Poly%tuple%2. t!) (TYPE%tuple%2. $ TYPE%X. $ TYPE%Y.))
 )
 (assert
  (= t! (tuple%2./tuple%2 (Poly%X. (X./X (%I (I 10)) (%I (I 8)))) (Poly%Y. (Y./Y (%I (I 100))
      (%I (I 100))
    ...
    (=>
     ...
     (=>
      ...
      (=>
       ...
       (=>
        (= tmp%1 (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. t@1))))
        (=>
         (= tmp%2 (impl&%0.the_inv.? tmp%1))
         (=>
          %%location_label%%0
          tmp%2
 )))))))))
...
(declare-fun req%test2. (tuple%2.) Bool)
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/user_defined_type_invariants-69821374e4e4d573-test_tracked_tuples/test.rs:48:7: 48:34 (#0)
(get-info :all-statistics)
(push)
 (declare-const t! tuple%2.)
 (declare-const tmp%1 Poly)
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/user_defined_type_invariants-69821374e4e4d573-test_tracked_tuples/test.rs:55:7: 55:61 (#0)
(get-info :all-statistics)
(push)
 (declare-const i!@0 Int)
...
(declare-fun req%test4. (tuple%2.) Bool)
(declare-const %%global_location_label%%2 Bool)
(assert
 (forall ((t! tuple%2.)) (!
   (= (req%test4. t!) (=>
     %%global_location_label%%2
     (= t! (tuple%2./tuple%2 (Poly%X. (X./X (%I (I 10)) (%I (I 8)))) (Poly%Y. (Y./Y (%I (I 8))
         (%I (I 8))
   ))))))
   :pattern ((req%test4. t!))
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/user_defined_type_invariants-69821374e4e4d573-test_tracked_tuples/test.rs:61:7: 61:34 (#0)
(get-info :all-statistics)
(push)
 (declare-const t! tuple%2.)
 (declare-const tmp%1 Poly)
        ...
        (=>
         ...
         (and
          ...
          (=>
           tmp%2
           (=>
            (= tmp%3 (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. t@1))))
            (=>
             (= tmp%4 (impl&%0.the_inv.? tmp%3))
             (=>
              %%location_label%%1
              tmp%4
 )))))))))))))
...
(declare-fun req%test5. (tuple%2.) Bool)
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/user_defined_type_invariants-69821374e4e4d573-test_tracked_tuples/test.rs:68:7: 68:34 (#0)
(get-info :all-statistics)
(push)
 (declare-const t! tuple%2.)
 (declare-const tmp%1 Poly)
    ...
    (=>
     ...
     (=>
      ...
      (=>
       ...
       (=>
        (= tmp%1 (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. t@1))))
        (=>
         (= tmp%2 (impl&%1.the_inv.? tmp%1))
         (and
          (=>
           %%location_label%%0
           tmp%2
          ...
          (=>
           tmp%2
           (=>
            (= tmp%3 (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. t@1))))
            (=>
             (= tmp%4 (impl&%1.the_inv.? tmp%3))
             (=>
              %%location_label%%1
              tmp%4
 )))))))))))))
...
(declare-fun req%test6. (tuple%2. Int) Bool)
(declare-const %%global_location_label%%4 Bool)
(assert
 (forall ((t! tuple%2.) (k! Int)) (!
   (= (req%test6. t! k!) (=>
     %%global_location_label%%4
     (= t! (tuple%2./tuple%2 (Poly%X. (X./X (%I (I 10)) (%I (I 8)))) (Poly%Y. (Y./Y (%I (I 8))
         (%I (I 8))
   ))))))
   :pattern ((req%test6. t! k!))
   :qid internal_req__test6._definition
   :skolemid skolem_internal_req__test6._definition
)))

;; Function-Def crate::test6
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/user_defined_type_invariants-69821374e4e4d573-test_tracked_tuples/test.rs:75:7: 75:49 (#0)
(get-info :all-statistics)
(push)
 (declare-const t! tuple%2.)
 (declare-const k! Int)
 ...
 (assert
  (not (=>
    (= t@0 t!)
    (=>
     (= (X./X/i (%Poly%X. (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. t@1))))) k!)
     (=>
      (and
       (= (X./X/j (%Poly%X. (tuple%2./tuple%2/0 t@0))) (X./X/j (%Poly%X. (tuple%2./tuple%2/0
           t@1
