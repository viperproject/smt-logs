...
;; Datatypes
(declare-datatypes ((X. 0) (Y. 0) (tuple%0. 0)) (((X./X (X./X/?i Int) (X./X/?j Int)))
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/user_defined_type_invariants-69821374e4e4d573-test_mut_ref_assign_call/test.rs:38:1: 38:23 (#0)
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/user_defined_type_invariants-69821374e4e4d573-test_mut_ref_assign_call/test.rs:39:1: 39:27 (#0)
(get-info :all-statistics)
(push)
 (declare-const res! Int)
 (declare-const no%param Int)
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/user_defined_type_invariants-69821374e4e4d573-test_mut_ref_assign_call/test.rs:41:1: 41:23 (#0)
(get-info :all-statistics)
(push)
 (declare-const res! Int)
 (declare-const no%param Int)
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/user_defined_type_invariants-69821374e4e4d573-test_mut_ref_assign_call/test.rs:42:1: 42:27 (#0)
(get-info :all-statistics)
(push)
 (declare-const res! Int)
 (declare-const no%param Int)
 ...
 (forall ((pre%y! Y.)) (!
   (= (req%test1. pre%y!) (and
     (=>
      ...
      (let
       ((tmp%%$ (X./X/j (%Poly%X. (Poly%X. (Y./Y/x (%Poly%Y. (Poly%Y. pre%y!))))))))
       (and
        (<= 20 tmp%%$)
        (< tmp%%$ 30)
     )))
     (=>
      ...
      (let
       ((tmp%%$ (X./X/i (%Poly%X. (Poly%X. (Y./Y/x (%Poly%Y. (Poly%Y. pre%y!))))))))
       (and
        (<= 0 tmp%%$)
        (< tmp%%$ 15)
   )))))
   :pattern ((req%test1. pre%y!))
   :qid internal_req__test1._definition
   :skolemid skolem_internal_req__test1._definition
)))
(declare-fun ens%test1. (Y. Y.) Bool)
(assert
 (forall ((pre%y! Y.) (y! Y.)) (!
   (= (ens%test1. pre%y! y!) (has_type (Poly%Y. y!) TYPE%Y.))
   :pattern ((ens%test1. pre%y! y!))
   :qid internal_ens__test1._definition
   :skolemid skolem_internal_ens__test1._definition
)))

;; Function-Def crate::test1
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/user_defined_type_invariants-69821374e4e4d573-test_mut_ref_assign_call/test.rs:44:1: 44:20 (#0)
(get-info :all-statistics)
(push)
 (declare-const y!@0 Y.)
 ...
 (declare-const tmp%4 Y.)
 (declare-const tmp%5 Bool)
 (assert
  fuel_defaults
 )
 (assert
  (has_type (Poly%Y. y!@0) TYPE%Y.)
 )
 (assert
  (let
   ((tmp%%$ (X./X/j (%Poly%X. (Poly%X. (Y./Y/x (%Poly%Y. (Poly%Y. y!@0))))))))
   (and
    (<= 20 tmp%%$)
    (< tmp%%$ 30)
 )))
 (assert
  (let
   ((tmp%%$ (X./X/i (%Poly%X. (Poly%X. (Y./Y/x (%Poly%Y. (Poly%Y. y!@0))))))))
   (and
    (<= 0 tmp%%$)
    (< tmp%%$ 15)
 )))
 ...
 (assert
  (not (=>
    (ens%get_i. 0 tmp%1)
    (=>
     (= (X./X/i (%Poly%X. (Poly%X. (Y./Y/x (%Poly%Y. (Poly%Y. y!@1)))))) tmp%1)
     (=>
      (and
       (= (X./X/j (Y./Y/x y!@0)) (X./X/j (Y./Y/x y!@1)))
      )
      (=>
       (= tmp%2 (Y./Y/x (%Poly%Y. (Poly%Y. y!@1))))
       (=>
        (= tmp%3 (impl&%0.the_inv.? (Poly%X. tmp%2)))
        (and
         (=>
          %%location_label%%0
          tmp%3
         ...
         (=>
          ...
          (=>
           (= tmp%4 y!@1)
           (=>
            (= tmp%5 (impl&%1.the_inv.? (Poly%Y. tmp%4)))
            (=>
             %%location_label%%1
             tmp%5
 ))))))))))))
...
;; Function-Specs crate::test1_bad
(declare-fun req%test1_bad. (Y.) Bool)
(declare-const %%global_location_label%%2 Bool)
(declare-const %%global_location_label%%3 Bool)
(assert
 (forall ((pre%y! Y.)) (!
   (= (req%test1_bad. pre%y!) (and
     (=>
   ...
   :pattern ((req%test1_bad. pre%y!))
   :qid internal_req__test1_bad._definition
   :skolemid skolem_internal_req__test1_bad._definition
)))
(declare-fun ens%test1_bad. (Y. Y.) Bool)
(assert
 (forall ((pre%y! Y.) (y! Y.)) (!
   (= (ens%test1_bad. pre%y! y!) (has_type (Poly%Y. y!) TYPE%Y.))
   :pattern ((ens%test1_bad. pre%y! y!))
   :qid internal_ens__test1_bad._definition
   :skolemid skolem_internal_ens__test1_bad._definition
)))

;; Function-Def crate::test1_bad
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/user_defined_type_invariants-69821374e4e4d573-test_mut_ref_assign_call/test.rs:50:1: 50:24 (#0)
(get-info :all-statistics)
(push)
 (declare-const y!@0 Y.)
 (declare-const tmp%1 Int)
...
(assert
 (forall ((pre%y! Y.)) (!
   ...
   :pattern ((req%test2. pre%y!))
   :qid internal_req__test2._definition
   :skolemid skolem_internal_req__test2._definition
)))
(declare-fun ens%test2. (Y. Y.) Bool)
(assert
 (forall ((pre%y! Y.) (y! Y.)) (!
   (= (ens%test2. pre%y! y!) (has_type (Poly%Y. y!) TYPE%Y.))
   :pattern ((ens%test2. pre%y! y!))
   :qid internal_ens__test2._definition
   :skolemid skolem_internal_ens__test2._definition
)))

;; Function-Def crate::test2
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/user_defined_type_invariants-69821374e4e4d573-test_mut_ref_assign_call/test.rs:56:1: 56:20 (#0)
(get-info :all-statistics)
(push)
 (declare-const y!@0 Y.)
 (declare-const tmp%1 Int)
 ...
 (assert
  (not (=>
    (ens%get_j. 0 tmp%1)
    (=>
     (= (X./X/j (%Poly%X. (Poly%X. (Y./Y/x (%Poly%Y. (Poly%Y. y!@1)))))) tmp%1)
     (=>
      (and
...
;; Function-Specs crate::test2_bad
(declare-fun req%test2_bad. (Y.) Bool)
(declare-const %%global_location_label%%6 Bool)
(declare-const %%global_location_label%%7 Bool)
(assert
 (forall ((pre%y! Y.)) (!
   (= (req%test2_bad. pre%y!) (and
     (=>
   ...
   :pattern ((req%test2_bad. pre%y!))
   :qid internal_req__test2_bad._definition
   :skolemid skolem_internal_req__test2_bad._definition
)))
(declare-fun ens%test2_bad. (Y. Y.) Bool)
(assert
 (forall ((pre%y! Y.) (y! Y.)) (!
   (= (ens%test2_bad. pre%y! y!) (has_type (Poly%Y. y!) TYPE%Y.))
   :pattern ((ens%test2_bad. pre%y! y!))
   :qid internal_ens__test2_bad._definition
   :skolemid skolem_internal_ens__test2_bad._definition
)))

;; Function-Def crate::test2_bad
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/user_defined_type_invariants-69821374e4e4d573-test_mut_ref_assign_call/test.rs:62:1: 62:24 (#0)
(get-info :all-statistics)
(push)
 (declare-const y!@0 Y.)
 (declare-const tmp%1 Int)
