...
;; Datatypes
(declare-datatypes ((Y. 0) (X. 0) (tuple%0. 0)) (((Y./Y (Y./Y/?0 Int))) ((X./X (X./X/?i
     Y.
    ) (X./X/?j Y.)
   )
  ) ((tuple%0./tuple%0))
))
(declare-fun Y./Y/0 (Y.) Int)
(declare-fun X./X/i (X.) Y.)
(declare-fun X./X/j (X.) Y.)
...
(assert
 (forall ((_0! Int)) (!
   (=>
    (uInv 8 _0!)
    (has_type (Poly%Y. (Y./Y _0!)) TYPE%Y.)
   )
   :pattern ((has_type (Poly%Y. (Y./Y _0!)) TYPE%Y.))
...
(assert
 (forall ((x Y.)) (!
   (= (Y./Y/0 x) (Y./Y/?0 x))
   :pattern ((Y./Y/0 x))
   :qid internal_Y./Y/0_accessor_definition
   :skolemid skolem_internal_Y./Y/0_accessor_definition
)))
(assert
 (forall ((x Poly)) (!
   (=>
    (has_type x TYPE%Y.)
    (uInv 8 (Y./Y/0 (%Poly%Y. x)))
   )
   :pattern ((Y./Y/0 (%Poly%Y. x)) (has_type x TYPE%Y.))
   :qid internal_Y./Y/0_invariant_definition
   :skolemid skolem_internal_Y./Y/0_invariant_definition
)))
(assert
 (forall ((x X.)) (!
   (= x (%Poly%X. (Poly%X. x)))
...
(assert
 (forall ((_i! Y.) (_j! Y.)) (!
   (=>
    (and
     (has_type (Poly%Y. _i!) TYPE%Y.)
     (has_type (Poly%Y. _j!) TYPE%Y.)
    )
...
(assert
 (forall ((x Poly)) (!
   (=>
    (has_type x TYPE%X.)
    (has_type (Poly%Y. (X./X/i (%Poly%X. x))) TYPE%Y.)
   )
...
(assert
 (forall ((x Poly)) (!
   (=>
    (has_type x TYPE%X.)
    (has_type (Poly%Y. (X./X/j (%Poly%X. x))) TYPE%Y.)
   )
...
(assert
 (=>
  ...
  (forall ((self! Poly)) (!
    (= (impl&%0.the_inv.? self!) (<= (Y./Y/0 (%Poly%Y. (Poly%Y. (X./X/i (%Poly%X. self!)))))
      (Y./Y/0 (%Poly%Y. (Poly%Y. (X./X/j (%Poly%X. self!)))))
    ))
...
;; Function-Specs crate::Y::set_to
(declare-fun ens%impl&%1.set_to. (Y. Y. Int Int Int) Bool)
(assert
 (forall ((pre%self! Y.) (self! Y.) (x! Int) (y! Int) (ret! Int)) (!
   (= (ens%impl&%1.set_to. pre%self! self! x! y! ret!) (and
     (uInv 8 ret!)
     (has_type (Poly%Y. self!) TYPE%Y.)
     (= (Y./Y/0 (%Poly%Y. (Poly%Y. self!))) x!)
     (= ret! y!)
   ))
   :pattern ((ens%impl&%1.set_to. pre%self! self! x! y! ret!))
   :qid internal_ens__impl&__1.set_to._definition
   :skolemid skolem_internal_ens__impl&__1.set_to._definition
)))

;; Function-Def crate::Y::set_to
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/user_defined_type_invariants-69821374e4e4d573-mut_ref_nested_calls_fail4_two_phase_borrow/test.rs:29:5: 29:51 (#0)
(get-info :all-statistics)
(push)
 (declare-const ret! Int)
 (declare-const self!@0 Y.)
 (declare-const x! Int)
 (declare-const y! Int)
 (assert
  fuel_defaults
...
;; Function-Def crate::test_nested_calls3
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/user_defined_type_invariants-69821374e4e4d573-mut_ref_nested_calls_fail4_two_phase_borrow/test.rs:38:1: 38:24 (#0)
(get-info :all-statistics)
(push)
 ...
 (assert
  (not (=>
    (= tmp%1 (X./X (%Poly%Y. (Poly%Y. (Y./Y (%I (I 5))))) (%Poly%Y. (Poly%Y. (Y./Y (%I (I 10)))))))
    (=>
       ...
       (=>
        ...
        (=>
         ...
         (=>
          ...
          (=>
           (ens%impl&%1.set_to. (X./X/j (%Poly%X. (Poly%X. x@0))) (X./X/j (%Poly%X. (Poly%X. x@1)))
            3 2 tmp$1@
           )
           (=>
            (= tmp%3 x@1)
            (=>
             ...
             (and
              ...
              (=>
               tmp%4
               (=>
                (= tmp%5 (impl&%0.the_inv.? (Poly%X. x@1)))
                (and
                 (=>
                  %%location_label%%2
                  tmp%5
                 ...
                 (=>
                  ...
                  (=>
                   ...
                   (=>
                    (has_type (Poly%X. x@2) TYPE%X.)
                    (=>
                     (ens%impl&%1.set_to. (X./X/i (%Poly%X. (Poly%X. x@1))) (X./X/i (%Poly%X. (Poly%X. x@2)))
                      tmp$1@ 0 tmp@
                     )
                     (=>
                      (= tmp%6 x@2)
...
;; Function-Recommends crate::test_nested_calls3
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/user_defined_type_invariants-69821374e4e4d573-mut_ref_nested_calls_fail4_two_phase_borrow/test.rs:38:1: 38:24 (#0)
(get-info :all-statistics)
(push)
 (declare-const no%param Int)
