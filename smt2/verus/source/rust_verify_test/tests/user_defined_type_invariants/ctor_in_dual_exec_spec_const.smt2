...
(assert
 (distinct fuel%impl&%0.the_inv. fuel%x.)
)

;; Datatypes
(declare-datatypes ((X. 0)) (((X./X (X./X/?i Int) (X./X/?j Int)))))
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/user_defined_type_invariants-69821374e4e4d573-ctor_in_dual_exec_spec_const/test.rs:27:1: 28:6 (#0)
