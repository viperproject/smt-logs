...
(assert
 (distinct fuel%vstd!std_specs.result.impl&%0.is_Ok. fuel%vstd!std_specs.result.impl&%0.is_Err.
...
(declare-fun Poly%test_crate!Err. (test_crate!Err.) Poly)
(declare-fun %Poly%test_crate!Err. (Poly) test_crate!Err.)
...
(assert
 (forall ((x test_crate!Err.)) (!
   (= x (%Poly%test_crate!Err. (Poly%test_crate!Err. x)))
   :pattern ((Poly%test_crate!Err. x))
   :qid internal_test_crate__Err_box_axiom_definition
   :skolemid skolem_internal_test_crate__Err_box_axiom_definition
)))
(assert
 (forall ((x Poly)) (!
   (=>
    (has_type x TYPE%test_crate!Err.)
    (= x (Poly%test_crate!Err. (%Poly%test_crate!Err. x)))
   )
   :pattern ((has_type x TYPE%test_crate!Err.))
   :qid internal_test_crate__Err_unbox_axiom_definition
   :skolemid skolem_internal_test_crate__Err_unbox_axiom_definition
)))
(assert
 (forall ((x test_crate!Err.)) (!
   (= (test_crate!Err./Err/error_code x) (test_crate!Err./Err/?error_code x))
   :pattern ((test_crate!Err./Err/error_code x))
   :qid internal_test_crate!Err./Err/error_code_accessor_definition
   :skolemid skolem_internal_test_crate!Err./Err/error_code_accessor_definition
)))
(assert
 (forall ((x test_crate!Err.)) (!
   (has_type (Poly%test_crate!Err. x) TYPE%test_crate!Err.)
   :pattern ((has_type (Poly%test_crate!Err. x) TYPE%test_crate!Err.))
   :qid internal_test_crate__Err_has_type_always_definition
   :skolemid skolem_internal_test_crate__Err_has_type_always_definition
)))
(assert
 (forall ((x tuple%0.)) (!
...
;; Function-Decl vstd::std_specs::result::ResultAdditionalSpecFns::is_Err
...
;; Function-Axioms vstd::std_specs::result::ResultAdditionalSpecFns::is_Err
(assert
 (forall ((Self%&. Dcr) (Self%& Type) (T&. Dcr) (T& Type) (E&. Dcr) (E& Type) (self!
    Poly
   )
...
;; Function-Axioms vstd::std_specs::result::impl&%0::is_Err
(assert
...
;; Function-Def test_crate::test_ok_result
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/results-6147799b439fda09-test1_fails1/test.rs:21:7: 21:26 (#0)
(get-info :all-statistics)
(push)
 (declare-const no%param Int)
 (declare-const tmp%1 Bool)
 (declare-const ok_result@ core!result.Result.)
 (assert
  fuel_defaults
 )
 ;; assertion failed
 ...
 (assert
  (not (=>
    (= ok_result@ (core!result.Result./Ok (I 1)))
    (=>
     (= tmp%1 (is-core!result.Result./Err ok_result@))
     (=>
      %%location_label%%0
      tmp%1
 )))))
...
;; Function-Recommends test_crate::test_ok_result
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/results-6147799b439fda09-test1_fails1/test.rs:21:7: 21:26 (#0)
(get-info :all-statistics)
(push)
 (declare-const no%param Int)
...
;; Function-Def test_crate::test_err_result
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/results-6147799b439fda09-test1_fails1/test.rs:26:7: 26:27 (#0)
(get-info :all-statistics)
(push)
 (declare-const no%param Int)
 (declare-const tmp%1 Bool)
 (declare-const err_result@ core!result.Result.)
 (assert
  fuel_defaults
 )
 ;; assertion failed
 ...
 (assert
  (not (=>
    (= err_result@ (core!result.Result./Err (Poly%test_crate!Err. (test_crate!Err./Err (%I
         (I (Sub 0 1))
    )))))
    (=>
     (= tmp%1 (is-core!result.Result./Ok err_result@))
     (=>
      %%location_label%%0
      tmp%1
 )))))
...
;; Function-Recommends test_crate::test_err_result
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/results-6147799b439fda09-test1_fails1/test.rs:26:7: 26:27 (#0)
(get-info :all-statistics)
(push)
 (declare-const no%param Int)
