...
(assert
 (distinct fuel%vstd!std_specs.result.impl&%0.is_Ok. fuel%vstd!std_specs.result.impl&%0.get_Ok_0.
  ...
  fuel%vstd!std_specs.result.spec_unwrap. fuel%vstd!array.group_array_axioms. fuel%vstd!map.group_map_axioms.
...
;; Function-Decl vstd::std_specs::result::ResultAdditionalSpecFns::get_Err_0
...
;; Function-Axioms vstd::std_specs::result::ResultAdditionalSpecFns::get_Err_0
(assert
 (forall ((Self%&. Dcr) (Self%& Type) (T&. Dcr) (T& Type) (E&. Dcr) (E& Type) (self!
    Poly
   )
...
;; Function-Axioms vstd::std_specs::result::impl&%0::get_Err_0
(assert
...
;; Trait-Impl-Axiom
(assert
 (tr_bound%core!fmt.Debug. $ TYPE%test_crate!Err.)
)

;; Function-Def test_crate::test_result
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/results-6147799b439fda09-test1/test.rs:32:7: 32:23 (#0)
...
(push)
 ...
 (assert
  (not (=>
    ...
    (=>
     (= tmp%1 (is-core!result.Result./Ok ok_result@))
     (and
      (=>
       %%location_label%%0
       tmp%1
      ...
      (=>
       tmp%1
       (=>
        (= tmp%2 (= (%I (core!result.Result./Ok/0 (%Poly%core!result.Result. (Poly%core!result.Result.
              ok_result@
           )))
          ) 1
        ))
        (and
         ...
         (=>
          ...
          (=>
           ...
           (=>
            (= tmp%3 (is-core!result.Result./Err err_result@))
            (and
             (=>
              %%location_label%%2
              tmp%3
             ...
             (=>
              tmp%3
              (=>
               (= tmp%4 (= (%Poly%test_crate!Err. (core!result.Result./Err/0 (%Poly%core!result.Result.
                    (Poly%core!result.Result. err_result@)
                  ))
                 ) (test_crate!Err./Err (%I (I (Sub 0 1))))
               ))
               (=>
                %%location_label%%3
                tmp%4
