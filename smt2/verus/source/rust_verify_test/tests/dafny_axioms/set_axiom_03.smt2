...
(assert
 (distinct fuel%vstd!set.axiom_set_insert_same. fuel%vstd!set.axiom_set_insert_different.
  ...
  fuel%vstd!set.axiom_set_remove_finite. fuel%vstd!set.axiom_set_insert_len. fuel%vstd!set.axiom_set_remove_len.
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (s! Poly) (a! Poly)) (!
    ...
    :qid user_vstd__set__axiom_set_remove_same_2
    :skolemid skolem_user_vstd__set__axiom_set_remove_same_2
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (s! Poly) (a! Poly)) (!
    ...
    :qid user_vstd__set__axiom_set_remove_insert_3
    :skolemid skolem_user_vstd__set__axiom_set_remove_insert_3
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (s! Poly) (a1! Poly) (a2! Poly)) (!
    ...
    :qid user_vstd__set__axiom_set_remove_different_4
    :skolemid skolem_user_vstd__set__axiom_set_remove_different_4
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (s! Poly) (a! Poly)) (!
    ...
    :qid user_vstd__set__axiom_set_insert_finite_8
    :skolemid skolem_user_vstd__set__axiom_set_insert_finite_8
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (s! Poly) (a! Poly)) (!
    ...
    :qid user_vstd__set__axiom_set_remove_finite_9
    :skolemid skolem_user_vstd__set__axiom_set_remove_finite_9
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (s! Poly) (a! Poly)) (!
    ...
    :qid user_vstd__set__axiom_set_insert_len_10
    :skolemid skolem_user_vstd__set__axiom_set_insert_len_10
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (s! Poly) (a! Poly)) (!
    ...
    :qid user_vstd__set__axiom_set_remove_len_11
    :skolemid skolem_user_vstd__set__axiom_set_remove_len_11
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (s! Poly) (a! Poly)) (!
    ...
    :qid user_vstd__set__axiom_set_contains_len_12
    :skolemid skolem_user_vstd__set__axiom_set_contains_len_12
))))

;; Function-Specs test_crate::lemma_set_remove_len_contains
(declare-fun req%test_crate!lemma_set_remove_len_contains. (Dcr Type Poly Poly) Bool)
(declare-const %%global_location_label%%0 Bool)
(assert
 (forall ((A&. Dcr) (A& Type) (s! Poly) (a! Poly)) (!
   (= (req%test_crate!lemma_set_remove_len_contains. A&. A& s! a!) (=>
     %%global_location_label%%0
     (vstd!set.impl&%0.finite.? A&. A& s!)
   ))
   :pattern ((req%test_crate!lemma_set_remove_len_contains. A&. A& s! a!))
   :qid internal_req__test_crate!lemma_set_remove_len_contains._definition
   :skolemid skolem_internal_req__test_crate!lemma_set_remove_len_contains._definition
)))
(declare-fun ens%test_crate!lemma_set_remove_len_contains. (Dcr Type Poly Poly) Bool)
(assert
 (forall ((A&. Dcr) (A& Type) (s! Poly) (a! Poly)) (!
   (= (ens%test_crate!lemma_set_remove_len_contains. A&. A& s! a!) (and
     (=>
      (vstd!set.impl&%0.contains.? A&. A& s! a!)
     ...
     (=>
      ...
      (= (vstd!set.impl&%0.len.? A&. A& s!) (vstd!set.impl&%0.len.? A&. A& (vstd!set.impl&%0.remove.?
         A&. A& s! a!
   ))))))
   :pattern ((ens%test_crate!lemma_set_remove_len_contains. A&. A& s! a!))
   :qid internal_ens__test_crate!lemma_set_remove_len_contains._definition
   :skolemid skolem_internal_ens__test_crate!lemma_set_remove_len_contains._definition
)))

;; Function-Def test_crate::lemma_set_remove_len_contains
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/dafny_axioms-e2848f0fffb371d8-set_axiom_03/test.rs:19:1: 19:63 (#0)
