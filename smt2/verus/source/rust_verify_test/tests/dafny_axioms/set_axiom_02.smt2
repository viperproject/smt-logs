...
(assert
 (distinct fuel%vstd!set.axiom_set_insert_same. fuel%vstd!set.axiom_set_insert_different.
  fuel%vstd!set.axiom_set_ext_equal. fuel%vstd!set.axiom_set_ext_equal_deep. fuel%vstd!set.axiom_set_insert_finite.
  fuel%vstd!set.axiom_set_insert_len. fuel%vstd!set.axiom_set_contains_len. fuel%vstd!array.group_array_axioms.
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (s! Poly) (a! Poly)) (!
    ...
    :qid user_vstd__set__axiom_set_insert_same_0
    :skolemid skolem_user_vstd__set__axiom_set_insert_same_0
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (s! Poly) (a1! Poly) (a2! Poly)) (!
    ...
    :qid user_vstd__set__axiom_set_insert_different_1
    :skolemid skolem_user_vstd__set__axiom_set_insert_different_1
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (s1! Poly) (s2! Poly)) (!
    ...
    :qid user_vstd__set__axiom_set_ext_equal_deep_4
    :skolemid skolem_user_vstd__set__axiom_set_ext_equal_deep_4
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (s! Poly) (a! Poly)) (!
    ...
    :qid user_vstd__set__axiom_set_insert_finite_5
    :skolemid skolem_user_vstd__set__axiom_set_insert_finite_5
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (s! Poly) (a! Poly)) (!
    ...
    :qid user_vstd__set__axiom_set_insert_len_6
    :skolemid skolem_user_vstd__set__axiom_set_insert_len_6
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (s! Poly) (a! Poly)) (!
    ...
    :qid user_vstd__set__axiom_set_contains_len_7
    :skolemid skolem_user_vstd__set__axiom_set_contains_len_7
))))

;; Function-Specs test_crate::lemma_set_insert_diff_len
(declare-fun req%test_crate!lemma_set_insert_diff_len. (Dcr Type Poly Poly) Bool)
(declare-const %%global_location_label%%0 Bool)
(assert
 (forall ((A&. Dcr) (A& Type) (s! Poly) (a! Poly)) (!
   (= (req%test_crate!lemma_set_insert_diff_len. A&. A& s! a!) (=>
     %%global_location_label%%0
     (vstd!set.impl&%0.finite.? A&. A& s!)
   ))
   :pattern ((req%test_crate!lemma_set_insert_diff_len. A&. A& s! a!))
   :qid internal_req__test_crate!lemma_set_insert_diff_len._definition
   :skolemid skolem_internal_req__test_crate!lemma_set_insert_diff_len._definition
)))
(declare-fun ens%test_crate!lemma_set_insert_diff_len. (Dcr Type Poly Poly) Bool)
(assert
 (forall ((A&. Dcr) (A& Type) (s! Poly) (a! Poly)) (!
   (= (ens%test_crate!lemma_set_insert_diff_len. A&. A& s! a!) (=>
     (not (vstd!set.impl&%0.contains.? A&. A& s! a!))
     (= (vstd!set.impl&%0.len.? A&. A& (vstd!set.impl&%0.insert.? A&. A& s! a!)) (nClip
       (Add (vstd!set.impl&%0.len.? A&. A& s!) 1)
   ))))
   :pattern ((ens%test_crate!lemma_set_insert_diff_len. A&. A& s! a!))
   :qid internal_ens__test_crate!lemma_set_insert_diff_len._definition
   :skolemid skolem_internal_ens__test_crate!lemma_set_insert_diff_len._definition
)))

;; Function-Def test_crate::lemma_set_insert_diff_len
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/dafny_axioms-e2848f0fffb371d8-set_axiom_02/test.rs:18:1: 18:59 (#0)
