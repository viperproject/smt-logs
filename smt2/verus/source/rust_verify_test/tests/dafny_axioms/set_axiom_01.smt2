...
;; Function-Specs test_crate::lemma_set_insert_same_len
(declare-fun req%test_crate!lemma_set_insert_same_len. (Dcr Type Poly Poly) Bool)
(declare-const %%global_location_label%%0 Bool)
(assert
 (forall ((A&. Dcr) (A& Type) (s! Poly) (a! Poly)) (!
   (= (req%test_crate!lemma_set_insert_same_len. A&. A& s! a!) (=>
     %%global_location_label%%0
     (vstd!set.impl&%0.finite.? A&. A& s!)
   ))
   :pattern ((req%test_crate!lemma_set_insert_same_len. A&. A& s! a!))
   :qid internal_req__test_crate!lemma_set_insert_same_len._definition
   :skolemid skolem_internal_req__test_crate!lemma_set_insert_same_len._definition
)))
(declare-fun ens%test_crate!lemma_set_insert_same_len. (Dcr Type Poly Poly) Bool)
(assert
 (forall ((A&. Dcr) (A& Type) (s! Poly) (a! Poly)) (!
   (= (ens%test_crate!lemma_set_insert_same_len. A&. A& s! a!) (=>
     (vstd!set.impl&%0.contains.? A&. A& s! a!)
     (ext_eq false NAT (I (vstd!set.impl&%0.len.? A&. A& (vstd!set.impl&%0.insert.? A&. A&
         s! a!
       ))
      ) (I (vstd!set.impl&%0.len.? A&. A& s!))
   )))
   :pattern ((ens%test_crate!lemma_set_insert_same_len. A&. A& s! a!))
   :qid internal_ens__test_crate!lemma_set_insert_same_len._definition
   :skolemid skolem_internal_ens__test_crate!lemma_set_insert_same_len._definition
)))

;; Function-Def test_crate::lemma_set_insert_same_len
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/dafny_axioms-e2848f0fffb371d8-set_axiom_01/test.rs:18:1: 18:59 (#0)
