...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/calc-4da8883409b33060-calc_hides_intermediates/test.rs:19:7: 19:15 (#0)
...
(push)
 ...
 (assert
  (not (=>
    ...
    (=>
     (= b@ (%Poly%vstd!seq.Seq<u8.>. (vstd!view.View.view.? $ (ARRAY $ (UINT 8) $ (CONST_INT
          2
         )
        ) (array_new $ (UINT 8) 2 (%%array%%0 (I 123) (I 45)))
     )))
     (=>
      (= c@ (%Poly%vstd!seq.Seq<u8.>. (vstd!view.View.view.? $ (ARRAY $ (UINT 8) $ (CONST_INT
           2
          )
         ) (array_new $ (UINT 8) 2 (%%array%%0 (I 67) (I 89)))
      )))
      (=>
       ...
       (and
        ...
        (=>
         (= a@ d@)
         (=>
          (= tmp%1 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<u8.>. b@)
