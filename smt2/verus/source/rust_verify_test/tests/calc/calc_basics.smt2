...
(assert
 (distinct fuel%vstd!array.array_view. fuel%vstd!array.impl&%0.view. fuel%vstd!array.impl&%2.spec_index.
  ...
  fuel%vstd!seq_lib.impl&%0.push_distributes_over_add. fuel%vstd!seq_lib.check_argument_is_seq.
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (a! Poly) (b! Poly) (elt! Poly)) (!
    ...
    :qid user_vstd__seq_lib__impl&%0__push_distributes_over_add_19
    :skolemid skolem_user_vstd__seq_lib__impl&%0__push_distributes_over_add_19
))))
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/calc-4da8883409b33060-calc_basics/test.rs:19:7: 19:15 (#0)
...
(push)
 ...
 (declare-const a@ vstd!seq.Seq<u8.>.)
 (declare-const b@ vstd!seq.Seq<u8.>.)
 (declare-const c@ vstd!seq.Seq<u8.>.)
 (declare-const d@ vstd!seq.Seq<u8.>.)
 (assert
  fuel_defaults
 )
 ...
 (assert
  (not (=>
    (= a@ (%Poly%vstd!seq.Seq<u8.>. (vstd!view.View.view.? $ (ARRAY $ (UINT 8) $ (CONST_INT
         2
        )
       ) (array_new $ (UINT 8) 2 (%%array%%0 (I 1) (I 2)))
    )))
    (=>
     (= b@ (%Poly%vstd!seq.Seq<u8.>. (vstd!seq.Seq.push.? $ (UINT 8) (vstd!seq.Seq.empty.?
         $ (UINT 8)
        ) (I 1)
     )))
     (=>
      (= c@ (%Poly%vstd!seq.Seq<u8.>. (vstd!seq.Seq.push.? $ (UINT 8) (vstd!seq.Seq.empty.?
          $ (UINT 8)
         ) (I 2)
      )))
      (=>
       (= d@ (%Poly%vstd!seq.Seq<u8.>. (vstd!view.View.view.? $ (ARRAY $ (UINT 8) $ (CONST_INT
            2
           )
          ) (array_new $ (UINT 8) 2 (%%array%%0 (I 1) (I 2)))
       )))
       (and
        (and
         (=>
          (= s1@ a@)
          (=>
           (= s2@ (%Poly%vstd!seq.Seq<u8.>. (vstd!seq.Seq.add.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>.
               b@
              ) (Poly%vstd!seq.Seq<u8.>. c@)
           )))
           (and
            (=>
             (= tmp%1 (= (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. s1@)) (vstd!seq.Seq.len.?
                $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. s2@)
             )))
             (and
              (=>
               %%location_label%%0
               ...
               (and
                (=>
                 ...
                 (=>
                  (and
                   (<= 0 (%I idx@))
                   (< (%I idx@) (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. s1@)))
                  )
                  (=>
                   %%location_label%%1
                   (= (vstd!seq.Seq.index.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. s1@) idx@) (vstd!seq.Seq.index.?
                     $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. s2@) idx@
                )))))
                (=>
                 (forall ((idx$ Poly)) (!
                   (=>
                   ...
                   :pattern ((vstd!seq.Seq.index.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. s1@) idx$))
                   :pattern ((vstd!seq.Seq.index.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. s2@) idx$))
                   :qid user_test_crate__foo_20
                   :skolemid skolem_user_test_crate__foo_20
                 ))
                 (=>
                  (= tmp%2 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<u8.>. s1@)
            ...
            (=>
             ...
             (=>
              %%location_label%%4
              (= a@ (%Poly%vstd!seq.Seq<u8.>. (vstd!seq.Seq.add.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>.
                  b@
                 ) (Poly%vstd!seq.Seq<u8.>. c@)
         ))))))))
         (=>
          ...
          (and
           (=>
            (= s1$1@ (%Poly%vstd!seq.Seq<u8.>. (vstd!seq.Seq.add.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>.
                b@
               ) (Poly%vstd!seq.Seq<u8.>. c@)
            )))
            (=>
             ...
             (and
              (=>
               (= tmp%3 (= (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. s1$1@)) (vstd!seq.Seq.len.?
                 ...
                 (and
                  (=>
                   ...
                   (=>
                    (and
                     (<= 0 (%I idx$1@))
                     (< (%I idx$1@) (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. s1$1@)))
                    )
                    (=>
                     %%location_label%%6
                     (= (vstd!seq.Seq.index.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. s1$1@) idx$1@) (vstd!seq.Seq.index.?
                       $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. s2$1@) idx$1@
                  )))))
                  (=>
                   (forall ((idx$ Poly)) (!
                     (=>
                     ...
                     :qid user_test_crate__foo_23
                     :skolemid skolem_user_test_crate__foo_23
                   ))
                   (=>
                    (= tmp%4 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<u8.>. s1$1@)
        ...
        (=>
         (= a@ d@)
         (=>
          (= tmp%5 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<u8.>. a@)
            (Poly%vstd!seq.Seq<u8.>. d@)
          ))
          (=>
           %%location_label%%11
           tmp%5
