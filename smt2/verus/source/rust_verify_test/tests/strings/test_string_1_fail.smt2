...
(assert
 (=>
  ...
  (forall ((s! Poly)) (!
    ...
    :qid user_vstd__string__axiom_str_literal_is_ascii_6
    :skolemid skolem_user_vstd__string__axiom_str_literal_is_ascii_6
))))
...
(assert
 (=>
  ...
  (forall ((s! Poly)) (!
    ...
    :qid user_vstd__string__axiom_str_literal_len_7
    :skolemid skolem_user_vstd__string__axiom_str_literal_len_7
))))
...
(assert
 (=>
  ...
  (forall ((s! Poly) (i! Poly)) (!
    ...
    :qid user_vstd__string__axiom_str_literal_get_char_8
    :skolemid skolem_user_vstd__string__axiom_str_literal_get_char_8
))))

;; Function-Specs vstd::string::impl&%4::from_str
(declare-fun ens%vstd!string.impl&%4.from_str. (strslice%. alloc!string.String.) Bool)
(assert
 (forall ((s! strslice%.) (ret! alloc!string.String.)) (!
   (= (ens%vstd!string.impl&%4.from_str. s! ret!) (and
     (= (vstd!view.View.view.? $ STRSLICE (Poly%strslice%. s!)) (vstd!view.View.view.? $
       TYPE%alloc!string.String. (Poly%alloc!string.String. ret!)
     ))
     (= (vstd!string.str_slice_is_ascii.? (Poly%strslice%. s!)) (vstd!string.string_is_ascii.?
       (Poly%alloc!string.String. ret!)
   ))))
   :pattern ((ens%vstd!string.impl&%4.from_str. s! ret!))
   :qid internal_ens__vstd!string.impl&__4.from_str._definition
   :skolemid skolem_internal_ens__vstd!string.impl&__4.from_str._definition
)))
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/strings-36081f4fa46d4460-test_string_1_fail/test.rs:16:1: 16:10 (#0)
(get-info :all-statistics)
(push)
 (declare-const no%param Int)
 (declare-const tmp%1 strslice%.)
 (declare-const tmp%2 Bool)
 (declare-const a@ alloc!string.String.)
 (assert
  fuel_defaults
 )
 ;; assertion failed
 ...
 (assert
  (not (=>
    (ens%vstd!string.new_strlit. (str%new_strlit 12874110177272889275858083148775298614087114561911955841596002957005842009344403665534665779667059700242099875849763788391163776422516373223328969527702561)
     tmp%1
    )
    (=>
     (ens%vstd!string.impl&%4.from_str. tmp%1 a@)
     (=>
      (and
       (= (str%strslice_is_ascii (str%new_strlit 12874110177272889275858083148775298614087114561911955841596002957005842009344403665534665779667059700242099875849763788391163776422516373223328969527702561))
        true
       )
       (= (str%strslice_len (str%new_strlit 12874110177272889275858083148775298614087114561911955841596002957005842009344403665534665779667059700242099875849763788391163776422516373223328969527702561))
        1
       )
       (and
        (= (str%strslice_get_char (str%new_strlit 12874110177272889275858083148775298614087114561911955841596002957005842009344403665534665779667059700242099875849763788391163776422516373223328969527702561)
          0
         ) 65
      )))
      (=>
       (= tmp%2 (ext_eq false (TYPE%vstd!seq.Seq. $ CHAR) (vstd!view.View.view.? $ TYPE%alloc!string.String.
          (Poly%alloc!string.String. a@)
         ) (vstd!view.View.view.? $ STRSLICE (Poly%strslice%. (vstd!string.new_strlit_spec.?
            (Poly%strslice%. (str%new_strlit 807498828609298088737404645116962888444630591525261622831400507980418669506191540008628212270005428937250159415192411978859162104104927934873045530282884))
       )))))
       (=>
        %%location_label%%0
        tmp%2
