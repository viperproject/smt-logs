...
(assert
 (distinct fuel%vstd!raw_ptr.impl&%4.view. fuel%vstd!raw_ptr.ptrs_mut_eq. fuel%vstd!seq.impl&%0.spec_index.
  fuel%vstd!seq.impl&%0.spec_add. fuel%vstd!seq.axiom_seq_index_decreases. fuel%vstd!seq.axiom_seq_ext_equal.
  fuel%vstd!seq.axiom_seq_ext_equal_deep. fuel%vstd!seq.axiom_seq_add_len. fuel%vstd!seq.axiom_seq_add_index1.
  fuel%vstd!seq.axiom_seq_add_index2. fuel%vstd!seq_lib.impl&%0.add_empty_left. fuel%vstd!seq_lib.impl&%0.add_empty_right.
  fuel%vstd!string.new_strlit_spec. fuel%vstd!string.axiom_str_literal_is_ascii. fuel%vstd!string.axiom_str_literal_len.
  ...
  fuel%vstd!view.impl&%12.view. fuel%vstd!view.impl&%24.view. fuel%vstd!view.impl&%38.view.
...
;; Function-Decl vstd::string::new_strlit_spec
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (s! Poly) (i! Poly)) (!
    ...
    :qid user_vstd__seq__axiom_seq_index_decreases_1
    :skolemid skolem_user_vstd__seq__axiom_seq_index_decreases_1
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (s1! Poly) (s2! Poly)) (!
    ...
    :qid user_vstd__seq__axiom_seq_add_len_6
    :skolemid skolem_user_vstd__seq__axiom_seq_add_len_6
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (s1! Poly) (s2! Poly) (i! Poly)) (!
    ...
    :qid user_vstd__seq__axiom_seq_add_index1_7
    :skolemid skolem_user_vstd__seq__axiom_seq_add_index1_7
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (s1! Poly) (s2! Poly) (i! Poly)) (!
    ...
    :pattern ((vstd!seq.Seq.index.? A&. A& (vstd!seq.Seq.add.? A&. A& s1! s2!) i!))
    :qid user_vstd__seq__axiom_seq_add_index2_8
    :skolemid skolem_user_vstd__seq__axiom_seq_add_index2_8
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (a! Poly) (b! Poly)) (!
    ...
    :qid user_vstd__seq_lib__impl&%0__add_empty_left_9
    :skolemid skolem_user_vstd__seq_lib__impl&%0__add_empty_left_9
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (a! Poly) (b! Poly)) (!
    ...
    :pattern ((vstd!seq.Seq.add.? A&. A& a! b!))
    :qid user_vstd__seq_lib__impl&%0__add_empty_right_10
    :skolemid skolem_user_vstd__seq_lib__impl&%0__add_empty_right_10
))))

;; Function-Specs vstd::string::new_strlit
...
(assert
 (=>
  ...
  (forall ((s! Poly)) (!
    ...
    :qid user_vstd__string__axiom_str_literal_is_ascii_11
    :skolemid skolem_user_vstd__string__axiom_str_literal_is_ascii_11
))))
...
(assert
 (=>
  ...
  (forall ((s! Poly)) (!
    ...
    :qid user_vstd__string__axiom_str_literal_len_12
    :skolemid skolem_user_vstd__string__axiom_str_literal_len_12
))))
...
(assert
 (=>
  ...
  (forall ((s! Poly) (i! Poly)) (!
    ...
    :qid user_vstd__string__axiom_str_literal_get_char_13
    :skolemid skolem_user_vstd__string__axiom_str_literal_get_char_13
))))

;; Function-Specs vstd::string::impl&%4::append
(declare-fun ens%vstd!string.impl&%4.append. (alloc!string.String. alloc!string.String.
  strslice%.
 ) Bool
)
(assert
 (forall ((pre%self! alloc!string.String.) (self! alloc!string.String.) (other! strslice%.))
  (!
   (= (ens%vstd!string.impl&%4.append. pre%self! self! other!) (and
     (= (vstd!view.View.view.? $ TYPE%alloc!string.String. (Poly%alloc!string.String. self!))
      (vstd!seq.Seq.add.? $ CHAR (vstd!view.View.view.? $ TYPE%alloc!string.String. (Poly%alloc!string.String.
         pre%self!
        )
       ) (vstd!view.View.view.? $ STRSLICE (Poly%strslice%. other!))
     ))
     (and
      (= (vstd!string.string_is_ascii.? (Poly%alloc!string.String. self!)) (vstd!string.string_is_ascii.?
        (Poly%alloc!string.String. pre%self!)
      ))
      (vstd!string.str_slice_is_ascii.? (Poly%strslice%. other!))
   )))
   :pattern ((ens%vstd!string.impl&%4.append. pre%self! self! other!))
   :qid internal_ens__vstd!string.impl&__4.append._definition
   :skolemid skolem_internal_ens__vstd!string.impl&__4.append._definition
)))
...
;; Function-Axioms vstd::string::new_strlit_spec
(assert
...
(declare-fun ens%test_crate!foo. (Int alloc!string.String.) Bool)
(assert
 (forall ((no%param Int) (ret! alloc!string.String.)) (!
   (= (ens%test_crate!foo. no%param ret!) (not (= (vstd!view.View.view.? $ TYPE%alloc!string.String.
       (Poly%alloc!string.String. ret!)
      ) (vstd!view.View.view.? $ STRSLICE (Poly%strslice%. (vstd!string.new_strlit_spec.?
         (Poly%strslice%. (str%new_strlit 2610253103873765627762267032978618589083098914407466419898487915154693179526715056273988367866476405368668294505126650186269003808822299056337134346572828))
   ))))))
   :pattern ((ens%test_crate!foo. no%param ret!))
   :qid internal_ens__test_crate!foo._definition
   :skolemid skolem_internal_ens__test_crate!foo._definition
)))

;; Function-Def test_crate::foo
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/strings-36081f4fa46d4460-test_append_2/test.rs:19:1: 19:25 (#0)
(get-info :all-statistics)
(push)
 (declare-const ret! alloc!string.String.)
 (declare-const no%param Int)
 (declare-const tmp%1 strslice%.)
 (declare-const tmp%2 strslice%.)
 (declare-const tmp%3 Bool)
 (declare-const s@0 alloc!string.String.)
 (assert
  fuel_defaults
 )
 (declare-const s@1 alloc!string.String.)
 ;; assertion failed
 ...
 (assert
  (not (=>
    (and
     (= (str%strslice_is_ascii (str%new_strlit 2610253103873765627762267032978618589083098914407466419898487915154693179526715056273988367866476405368668294505126650186269003808822299056337134346572828))
      true
     )
     (= (str%strslice_len (str%new_strlit 2610253103873765627762267032978618589083098914407466419898487915154693179526715056273988367866476405368668294505126650186269003808822299056337134346572828))
      12
     )
     (and
      (= (str%strslice_get_char (str%new_strlit 2610253103873765627762267032978618589083098914407466419898487915154693179526715056273988367866476405368668294505126650186269003808822299056337134346572828)
        0
       ) 104
      )
      (= (str%strslice_get_char (str%new_strlit 2610253103873765627762267032978618589083098914407466419898487915154693179526715056273988367866476405368668294505126650186269003808822299056337134346572828)
    ...
    (=>
     (and
      (= (str%strslice_is_ascii (str%new_strlit 12750604952164595333546527761395809529958382495564313661904832015454304721268283317462802467359666821896678609086217024927581509157941531481323761070653232))
       true
      )
      (= (str%strslice_len (str%new_strlit 12750604952164595333546527761395809529958382495564313661904832015454304721268283317462802467359666821896678609086217024927581509157941531481323761070653232))
       6
      )
      (and
       (= (str%strslice_get_char (str%new_strlit 12750604952164595333546527761395809529958382495564313661904832015454304721268283317462802467359666821896678609086217024927581509157941531481323761070653232)
         0
        ) 104
       )
       (= (str%strslice_get_char (str%new_strlit 12750604952164595333546527761395809529958382495564313661904832015454304721268283317462802467359666821896678609086217024927581509157941531481323761070653232)
     ...
     (=>
      (and
       (= (str%strslice_is_ascii (str%new_strlit 12479496789590729937486936106621599985106898858230461017631902755334919925790492928770707775433412604740044173626950633366785366950313101242988978740495633))
        true
       )
       (= (str%strslice_len (str%new_strlit 12479496789590729937486936106621599985106898858230461017631902755334919925790492928770707775433412604740044173626950633366785366950313101242988978740495633))
        5
       )
       (and
        (= (str%strslice_get_char (str%new_strlit 12479496789590729937486936106621599985106898858230461017631902755334919925790492928770707775433412604740044173626950633366785366950313101242988978740495633)
          0
         ) 119
        )
        (= (str%strslice_get_char (str%new_strlit 12479496789590729937486936106621599985106898858230461017631902755334919925790492928770707775433412604740044173626950633366785366950313101242988978740495633)
      ...
      (=>
       (ens%vstd!string.new_strlit. (str%new_strlit 12750604952164595333546527761395809529958382495564313661904832015454304721268283317462802467359666821896678609086217024927581509157941531481323761070653232)
        tmp%1
       )
       (=>
        (ens%alloc!string.impl&%38.to_string. tmp%1 s@0)
        (=>
         (ens%vstd!string.new_strlit. (str%new_strlit 12479496789590729937486936106621599985106898858230461017631902755334919925790492928770707775433412604740044173626950633366785366950313101242988978740495633)
          tmp%2
         )
         (=>
          (ens%vstd!string.impl&%4.append. s@0 s@1 tmp%2)
          (=>
           (= tmp%3 (not (ext_eq false (TYPE%vstd!seq.Seq. $ CHAR) (vstd!view.View.view.? $ TYPE%alloc!string.String.
               (Poly%alloc!string.String. s@1)
              ) (vstd!view.View.view.? $ STRSLICE (Poly%strslice%. (vstd!string.new_strlit_spec.?
                 (Poly%strslice%. (str%new_strlit 2610253103873765627762267032978618589083098914407466419898487915154693179526715056273988367866476405368668294505126650186269003808822299056337134346572828))
           ))))))
           (and
            ...
            (=>
             ...
             (=>
              ...
              (=>
               %%location_label%%1
               (not (= (vstd!view.View.view.? $ TYPE%alloc!string.String. (Poly%alloc!string.String.
                   ret!
                  )
                 ) (vstd!view.View.view.? $ STRSLICE (Poly%strslice%. (vstd!string.new_strlit_spec.?
                    (Poly%strslice%. (str%new_strlit 2610253103873765627762267032978618589083098914407466419898487915154693179526715056273988367866476405368668294505126650186269003808822299056337134346572828))
