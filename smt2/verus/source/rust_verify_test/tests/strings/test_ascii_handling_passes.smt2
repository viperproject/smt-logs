...
(assert
 (distinct fuel%vstd!raw_ptr.impl&%4.view. fuel%vstd!raw_ptr.ptrs_mut_eq. fuel%vstd!seq.impl&%0.spec_index.
  ...
  fuel%vstd!string.axiom_str_literal_is_ascii. fuel%vstd!string.axiom_str_literal_len.
  ...
  fuel%vstd!view.impl&%38.view. fuel%vstd!array.group_array_axioms. fuel%vstd!map.group_map_axioms.
...
;; Function-Specs vstd::string::impl&%1::get_ascii
...
;; Function-Def test_crate::test_get_ascii_passes
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/strings-36081f4fa46d4460-test_ascii_handling_passes/test.rs:16:1: 16:27 (#0)
  ...
  (not (=>
    ...
    (=>
     ...
     (and
      (=>
       %%location_label%%0
       (req%vstd!string.impl&%1.get_ascii. x@ 0)
      )
      (=>
       (ens%vstd!string.impl&%1.get_ascii. x@ 0 x0@)
       (=>
        (= tmp%1 (= x0@ 72))
        (=>
         %%location_label%%1
