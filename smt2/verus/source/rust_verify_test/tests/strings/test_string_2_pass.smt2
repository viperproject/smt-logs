...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/strings-36081f4fa46d4460-test_string_2_pass/test.rs:16:1: 16:10 (#0)
     ...
     (=>
      ...
      (=>
       ...
       (and
        (=>
         %%location_label%%0
         (req%vstd!string.impl&%1.substring_ascii. tmp%2 1 2)
        )
        (=>
         (ens%vstd!string.impl&%1.substring_ascii. tmp%2 1 2 b@)
         (=>
          (and
