...
(assert
 (distinct fuel%vstd!raw_ptr.impl&%4.view. fuel%vstd!raw_ptr.ptrs_mut_eq. fuel%vstd!seq.impl&%0.spec_index.
  ...
  fuel%vstd!seq.axiom_seq_subrange_index. fuel%vstd!string.new_strlit_spec. fuel%vstd!string.axiom_str_literal_is_ascii.
  ...
  fuel%vstd!view.impl&%24.view. fuel%vstd!view.impl&%38.view. fuel%vstd!array.group_array_axioms.
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (s! Poly) (i! Poly) (j! Poly)) (!
    ...
    :qid user_vstd__seq__axiom_seq_subrange_decreases_2
    :skolemid skolem_user_vstd__seq__axiom_seq_subrange_decreases_2
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (s! Poly) (j! Poly) (k! Poly)) (!
    ...
    :qid user_vstd__seq__axiom_seq_subrange_len_7
    :skolemid skolem_user_vstd__seq__axiom_seq_subrange_len_7
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (s! Poly) (j! Poly) (k! Poly) (i! Poly)) (!
    ...
    :qid user_vstd__seq__axiom_seq_subrange_index_8
    :skolemid skolem_user_vstd__seq__axiom_seq_subrange_index_8
))))
...
;; Function-Specs vstd::string::impl&%1::substring_ascii
...
(assert
 (=>
  ...
  (forall ((s! Poly)) (!
    ...
    :qid user_vstd__string__axiom_str_literal_is_ascii_9
    :skolemid skolem_user_vstd__string__axiom_str_literal_is_ascii_9
))))
...
(assert
 (=>
  ...
  (forall ((s! Poly)) (!
    ...
    :qid user_vstd__string__axiom_str_literal_len_10
    :skolemid skolem_user_vstd__string__axiom_str_literal_len_10
))))
...
(assert
 (=>
  ...
  (forall ((s! Poly) (i! Poly)) (!
    ...
    :qid user_vstd__string__axiom_str_literal_get_char_11
    :skolemid skolem_user_vstd__string__axiom_str_literal_get_char_11
))))
...
;; Function-Specs test_crate::test_substring_passes
(declare-fun ens%test_crate!test_substring_passes. (Int strslice%.) Bool)
(assert
 (forall ((no%param Int) (ret! strslice%.)) (!
   (= (ens%test_crate!test_substring_passes. no%param ret!) (ext_eq false (TYPE%vstd!seq.Seq.
      $ CHAR
     ) (vstd!seq.Seq.subrange.? $ CHAR (vstd!view.View.view.? $ STRSLICE (Poly%strslice%.
        ret!
       )
      ) (I 0) (I 5)
     ) (vstd!view.View.view.? $ STRSLICE (Poly%strslice%. (vstd!string.new_strlit_spec.?
        (Poly%strslice%. (str%new_strlit 1149576597304348905430829758847045164739019033864025442941878553162293532990451185819152297343395787636361014526862184370545617082586934477722038696416566))
   )))))
   :pattern ((ens%test_crate!test_substring_passes. no%param ret!))
   :qid internal_ens__test_crate!test_substring_passes._definition
   :skolemid skolem_internal_ens__test_crate!test_substring_passes._definition
)))

;; Function-Def test_crate::test_substring_passes
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/strings-36081f4fa46d4460-test_passes_substring/test.rs:16:1: 16:53 (#0)
(get-info :all-statistics)
(push)
 (declare-const ret! strslice%.)
 ...
 (assert
  (not (=>
    (and
     (= (str%strslice_is_ascii (str%new_strlit 1149576597304348905430829758847045164739019033864025442941878553162293532990451185819152297343395787636361014526862184370545617082586934477722038696416566))
      true
     )
     (= (str%strslice_len (str%new_strlit 1149576597304348905430829758847045164739019033864025442941878553162293532990451185819152297343395787636361014526862184370545617082586934477722038696416566))
      5
     )
     (and
      (= (str%strslice_get_char (str%new_strlit 1149576597304348905430829758847045164739019033864025442941878553162293532990451185819152297343395787636361014526862184370545617082586934477722038696416566)
        0
       ) 72
      )
      (= (str%strslice_get_char (str%new_strlit 1149576597304348905430829758847045164739019033864025442941878553162293532990451185819152297343395787636361014526862184370545617082586934477722038696416566)
    ...
    (=>
     (and
      (= (str%strslice_is_ascii (str%new_strlit 8132226913314251872076463025656613373697831242566364683608483779018376035223692946730804813149232653073426638137936721205460952480005523490186469253674028))
       true
      )
      (= (str%strslice_len (str%new_strlit 8132226913314251872076463025656613373697831242566364683608483779018376035223692946730804813149232653073426638137936721205460952480005523490186469253674028))
       11
      )
      (and
       (= (str%strslice_get_char (str%new_strlit 8132226913314251872076463025656613373697831242566364683608483779018376035223692946730804813149232653073426638137936721205460952480005523490186469253674028)
         0
        ) 72
       )
       (= (str%strslice_get_char (str%new_strlit 8132226913314251872076463025656613373697831242566364683608483779018376035223692946730804813149232653073426638137936721205460952480005523490186469253674028)
     ...
     (=>
      (ens%vstd!string.new_strlit. (str%new_strlit 8132226913314251872076463025656613373697831242566364683608483779018376035223692946730804813149232653073426638137936721205460952480005523490186469253674028)
       tmp%1
      )
      (=>
       (= ret! tmp%1)
       (=>
        %%location_label%%0
        (ext_eq false (TYPE%vstd!seq.Seq. $ CHAR) (vstd!seq.Seq.subrange.? $ CHAR (vstd!view.View.view.?
           $ STRSLICE (Poly%strslice%. ret!)
          ) (I 0) (I 5)
         ) (vstd!view.View.view.? $ STRSLICE (Poly%strslice%. (vstd!string.new_strlit_spec.?
            (Poly%strslice%. (str%new_strlit 1149576597304348905430829758847045164739019033864025442941878553162293532990451185819152297343395787636361014526862184370545617082586934477722038696416566))
 )))))))))))
...
;; Function-Specs test_crate::test_substring_passes2
(declare-fun ens%test_crate!test_substring_passes2. (Int strslice%.) Bool)
(assert
 (forall ((no%param Int) (ret! strslice%.)) (!
   (= (ens%test_crate!test_substring_passes2. no%param ret!) (ext_eq false (TYPE%vstd!seq.Seq.
      $ CHAR
     ) (vstd!seq.Seq.subrange.? $ CHAR (vstd!view.View.view.? $ STRSLICE (Poly%strslice%.
        ret!
       )
   ...
   :pattern ((ens%test_crate!test_substring_passes2. no%param ret!))
   :qid internal_ens__test_crate!test_substring_passes2._definition
   :skolemid skolem_internal_ens__test_crate!test_substring_passes2._definition
)))

;; Function-Def test_crate::test_substring_passes2
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/strings-36081f4fa46d4460-test_passes_substring/test.rs:28:1: 28:54 (#0)
(get-info :all-statistics)
(push)
 (declare-const ret! strslice%.)
 (declare-const no%param Int)
 (declare-const tmp%1 strslice%.)
 (declare-const x@ strslice%.)
 (assert
  fuel_defaults
 )
    ...
    (=>
     ...
     (=>
      ...
      (and
       (=>
        %%location_label%%0
        (req%vstd!string.impl&%1.substring_ascii. x@ 0 5)
       )
       (=>
        (ens%vstd!string.impl&%1.substring_ascii. x@ 0 5 tmp%1)
        (=>
         (= ret! tmp%1)
         (=>
          %%location_label%%1
