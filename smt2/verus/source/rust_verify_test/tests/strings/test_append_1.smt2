...
(assert
 (forall ((no%param Int) (ret! alloc!string.String.)) (!
   (= (ens%test_crate!foo. no%param ret!) (= (vstd!view.View.view.? $ TYPE%alloc!string.String.
      (Poly%alloc!string.String. ret!)
     ) (vstd!view.View.view.? $ STRSLICE (Poly%strslice%. (vstd!string.new_strlit_spec.?
        (Poly%strslice%. (str%new_strlit 5857653121046279034552476590803892574076708969035808390364295635444593807558796960422749049999998970216024059018244743538121595522469447963771576066547248))
   )))))
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/strings-36081f4fa46d4460-test_append_1/test.rs:19:1: 19:25 (#0)
...
(push)
 ...
 (assert
  (not (=>
    (and
     (= (str%strslice_is_ascii (str%new_strlit 5857653121046279034552476590803892574076708969035808390364295635444593807558796960422749049999998970216024059018244743538121595522469447963771576066547248))
      true
     )
     (= (str%strslice_len (str%new_strlit 5857653121046279034552476590803892574076708969035808390364295635444593807558796960422749049999998970216024059018244743538121595522469447963771576066547248))
      11
     )
     (and
      (= (str%strslice_get_char (str%new_strlit 5857653121046279034552476590803892574076708969035808390364295635444593807558796960422749049999998970216024059018244743538121595522469447963771576066547248)
        0
       ) 104
      )
      (= (str%strslice_get_char (str%new_strlit 5857653121046279034552476590803892574076708969035808390364295635444593807558796960422749049999998970216024059018244743538121595522469447963771576066547248)
       ...
       (=>
        ...
        (=>
         ...
         (=>
          ...
          (=>
           (= tmp%3 (ext_eq false (TYPE%vstd!seq.Seq. $ CHAR) (vstd!view.View.view.? $ TYPE%alloc!string.String.
           ...
           (and
            ...
            (=>
             ...
             (=>
              ...
              (=>
               %%location_label%%1
               (= (vstd!view.View.view.? $ TYPE%alloc!string.String. (Poly%alloc!string.String. ret!))
                (vstd!view.View.view.? $ STRSLICE (Poly%strslice%. (vstd!string.new_strlit_spec.? (Poly%strslice%.
                    (str%new_strlit 5857653121046279034552476590803892574076708969035808390364295635444593807558796960422749049999998970216024059018244743538121595522469447963771576066547248)
 )))))))))))))))))))
 (get-info :version)
