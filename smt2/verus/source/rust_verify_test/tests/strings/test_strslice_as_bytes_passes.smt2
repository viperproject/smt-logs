...
(assert
 (distinct fuel%vstd!raw_ptr.impl&%4.view. fuel%vstd!raw_ptr.ptrs_mut_eq. fuel%vstd!seq.impl&%0.spec_index.
  ...
  fuel%vstd!seq.axiom_seq_ext_equal. fuel%vstd!seq.axiom_seq_ext_equal_deep. fuel%vstd!string.axiom_str_literal_is_ascii.
  ...
  fuel%vstd!view.impl&%14.view. fuel%vstd!view.impl&%24.view. fuel%vstd!view.impl&%38.view.
...
;; Function-Specs vstd::string::impl&%1::as_bytes_vec
(declare-fun req%vstd!string.impl&%1.as_bytes_vec. (strslice%.) Bool)
(declare-const %%global_location_label%%2 Bool)
(assert
 (forall ((self! strslice%.)) (!
   (= (req%vstd!string.impl&%1.as_bytes_vec. self!) (=>
     %%global_location_label%%2
     (vstd!string.str_slice_is_ascii.? (Poly%strslice%. self!))
   ))
   :pattern ((req%vstd!string.impl&%1.as_bytes_vec. self!))
   :qid internal_req__vstd!string.impl&__1.as_bytes_vec._definition
   :skolemid skolem_internal_req__vstd!string.impl&__1.as_bytes_vec._definition
)))
(declare-fun ens%vstd!string.impl&%1.as_bytes_vec. (strslice%. alloc!vec.Vec<u8./allocator_global%.>.)
 Bool
)
(declare-fun %%lambda%%0 (Dcr Type Poly Int) %%Function%%)
(assert
 (forall ((%%hole%%0 Dcr) (%%hole%%1 Type) (%%hole%%2 Poly) (%%hole%%3 Int) (i$ Poly))
  (!
   (= (%%apply%%0 (%%lambda%%0 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3) i$) (I (uClip %%hole%%3
      (%I (vstd!seq.Seq.index.? %%hole%%0 %%hole%%1 %%hole%%2 i$))
   )))
   :pattern ((%%apply%%0 (%%lambda%%0 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3) i$))
)))
(assert
 (forall ((self! strslice%.) (ret! alloc!vec.Vec<u8./allocator_global%.>.)) (!
   (= (ens%vstd!string.impl&%1.as_bytes_vec. self! ret!) (= (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec.
       $ (UINT 8) $ ALLOCATOR_GLOBAL
      ) (Poly%alloc!vec.Vec<u8./allocator_global%.>. ret!)
     ) (vstd!seq.Seq.new.? $ (UINT 8) $ (TYPE%fun%1. $ INT $ (UINT 8)) (I (vstd!seq.Seq.len.?
        $ CHAR (vstd!view.View.view.? $ STRSLICE (Poly%strslice%. self!))
       )
      ) (Poly%fun%1. (mk_fun (%%lambda%%0 $ CHAR (vstd!view.View.view.? $ STRSLICE (Poly%strslice%.
           self!
          )
         ) 8
   ))))))
   :pattern ((ens%vstd!string.impl&%1.as_bytes_vec. self! ret!))
   :qid internal_ens__vstd!string.impl&__1.as_bytes_vec._definition
   :skolemid skolem_internal_ens__vstd!string.impl&__1.as_bytes_vec._definition
)))
...
(assert
 (=>
  ...
  (forall ((s! Poly)) (!
    ...
    :qid user_vstd__string__axiom_str_literal_is_ascii_8
    :skolemid skolem_user_vstd__string__axiom_str_literal_is_ascii_8
))))
...
;; Function-Specs test_crate::test_strslice_as_bytes
(declare-fun req%test_crate!test_strslice_as_bytes. (strslice%.) Bool)
(declare-const %%global_location_label%%3 Bool)
(declare-const %%global_location_label%%4 Bool)
(assert
 (forall ((x! strslice%.)) (!
   (= (req%test_crate!test_strslice_as_bytes. x!) (and
     (=>
      %%global_location_label%%3
      (vstd!string.str_slice_is_ascii.? (Poly%strslice%. x!))
     )
     (=>
      %%global_location_label%%4
      (> (vstd!seq.Seq.len.? $ CHAR (vstd!view.View.view.? $ STRSLICE (Poly%strslice%. x!)))
       10
   ))))
   :pattern ((req%test_crate!test_strslice_as_bytes. x!))
   :qid internal_req__test_crate!test_strslice_as_bytes._definition
   :skolemid skolem_internal_req__test_crate!test_strslice_as_bytes._definition
)))
(declare-fun ens%test_crate!test_strslice_as_bytes. (strslice%. alloc!vec.Vec<u8./allocator_global%.>.)
 Bool
)
(assert
 (forall ((x! strslice%.) (ret! alloc!vec.Vec<u8./allocator_global%.>.)) (!
   (= (ens%test_crate!test_strslice_as_bytes. x! ret!) (> (vstd!seq.Seq.len.? $ (UINT 8)
      (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<u8./allocator_global%.>.
        ret!
      ))
     ) 10
   ))
   :pattern ((ens%test_crate!test_strslice_as_bytes. x! ret!))
   :qid internal_ens__test_crate!test_strslice_as_bytes._definition
   :skolemid skolem_internal_ens__test_crate!test_strslice_as_bytes._definition
)))

;; Function-Def test_crate::test_strslice_as_bytes
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/strings-36081f4fa46d4460-test_strslice_as_bytes_passes/test.rs:18:1: 18:64 (#0)
(get-info :all-statistics)
(push)
 (declare-const ret! alloc!vec.Vec<u8./allocator_global%.>.)
 ...
 (assert
  (not (and
    (=>
     %%location_label%%0
     (req%vstd!string.impl&%1.as_bytes_vec. x!)
    )
    (=>
     (ens%vstd!string.impl&%1.as_bytes_vec. x! tmp%1)
     (=>
      (= ret! tmp%1)
      (=>
       %%location_label%%1
