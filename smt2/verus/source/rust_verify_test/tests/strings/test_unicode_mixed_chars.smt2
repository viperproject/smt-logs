...
(assert
 (distinct fuel%vstd!raw_ptr.impl&%4.view. fuel%vstd!raw_ptr.ptrs_mut_eq. fuel%vstd!seq.impl&%0.spec_index.
  ...
  fuel%vstd!string.new_strlit_spec. fuel%vstd!string.axiom_str_literal_len. fuel%vstd!string.axiom_str_literal_get_char.
...
(assert
 (=>
  ...
  (forall ((s! Poly)) (!
    ...
    :qid user_vstd__string__axiom_str_literal_len_6
    :skolemid skolem_user_vstd__string__axiom_str_literal_len_6
))))
...
(assert
 (=>
  ...
  (forall ((s! Poly) (i! Poly)) (!
    ...
    :qid user_vstd__string__axiom_str_literal_get_char_7
    :skolemid skolem_user_vstd__string__axiom_str_literal_get_char_7
))))
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/strings-36081f4fa46d4460-test_unicode_mixed_chars/test.rs:16:7: 16:16 (#0)
...
(push)
 ...
 (assert
  (not (=>
    (= a@ (vstd!string.new_strlit_spec.? (Poly%strslice%. (str%new_strlit 4403991057887439339753312553923194599613499417190960298679263449832076205852794569242626264616253407441273914753845966494764223706771297048593187140713305))))
    (=>
     (and
      (= (str%strslice_is_ascii (str%new_strlit 4403991057887439339753312553923194599613499417190960298679263449832076205852794569242626264616253407441273914753845966494764223706771297048593187140713305))
       false
      )
      (= (str%strslice_len (str%new_strlit 4403991057887439339753312553923194599613499417190960298679263449832076205852794569242626264616253407441273914753845966494764223706771297048593187140713305))
       4
      )
      (and
       (= (str%strslice_get_char (str%new_strlit 4403991057887439339753312553923194599613499417190960298679263449832076205852794569242626264616253407441273914753845966494764223706771297048593187140713305)
         0
        ) 232
       )
       (= (str%strslice_get_char (str%new_strlit 4403991057887439339753312553923194599613499417190960298679263449832076205852794569242626264616253407441273914753845966494764223706771297048593187140713305)
     ...
     (=>
      (= tmp%1 (= (%I (vstd!seq.Seq.index.? $ CHAR (vstd!view.View.view.? $ STRSLICE (Poly%strslice%.
            a@
           )
          ) (I 0)
         )
