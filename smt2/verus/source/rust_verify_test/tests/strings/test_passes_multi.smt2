...
(assert
 (distinct fuel%vstd!raw_ptr.impl&%4.view. fuel%vstd!raw_ptr.ptrs_mut_eq. fuel%vstd!seq.impl&%0.spec_index.
  ...
  fuel%vstd!seq.axiom_seq_subrange_index. fuel%vstd!string.axiom_str_literal_is_ascii.
   ...
   (= (ens%vstd!string.impl&%1.get_char. self! i! c!) (and
     ...
     (=>
      ...
      (forall ((i$ Poly)) (!
        ...
        :qid user_vstd__string__impl&%1__get_char_9
        :skolemid skolem_user_vstd__string__impl&%1__get_char_9
   )))))
...
(assert
 (=>
  ...
  (forall ((s! Poly)) (!
    ...
    :qid user_vstd__string__axiom_str_literal_is_ascii_10
    :skolemid skolem_user_vstd__string__axiom_str_literal_is_ascii_10
))))
...
(assert
 (=>
  ...
  (forall ((s! Poly)) (!
    ...
    :qid user_vstd__string__axiom_str_literal_len_11
    :skolemid skolem_user_vstd__string__axiom_str_literal_len_11
))))
...
(assert
 (=>
  ...
  (forall ((s! Poly) (i! Poly)) (!
    ...
    :qid user_vstd__string__axiom_str_literal_get_char_12
    :skolemid skolem_user_vstd__string__axiom_str_literal_get_char_12
))))
...
;; Function-Def test_crate::test_multi_passes
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/strings-36081f4fa46d4460-test_passes_multi/test.rs:17:1: 17:23 (#0)
...
(push)
 ...
 (declare-const a@ strslice%.)
 (declare-const a_clone@ strslice%.)
 (declare-const b@ strslice%.)
 (declare-const c@ strslice%.)
 (declare-const abc@ strslice%.)
 (declare-const cba@ strslice%.)
 (declare-const abc_clone@ strslice%.)
 (declare-const a0@ Int)
 (declare-const a0_clone@ Int)
 ...
 (assert
  (not (=>
    (ens%vstd!string.new_strlit. (str%new_strlit 6159496847612966233980601876866254041684030991354692630485059488293109394904353341620368445835143077433845422760124241126867399348183162362550152236646431)
     a@
    )
    (=>
     (ens%vstd!string.new_strlit. (str%new_strlit 6159496847612966233980601876866254041684030991354692630485059488293109394904353341620368445835143077433845422760124241126867399348183162362550152236646431)
     ...
     (=>
      (ens%vstd!string.new_strlit. (str%new_strlit 11465181489552889314994668054784891996889264144985683056416998388417120534826012464343951928413732502245832582997843053143724316433065220416218488011908946)
       b@
      )
      (=>
       (ens%vstd!string.new_strlit. (str%new_strlit 11540929649067931352492096946148896400513352910797619620902175978512577332943046350783063569823445288378310188900326754765064021802439408952452049512809132)
        c@
       )
       (=>
        (ens%vstd!string.new_strlit. (str%new_strlit 8361119213019981353352977961579829722160738195700156076437731416677323235324086675915072119538519968892599422912811282534957932553134606404999611367665629)
         abc@
        )
        (=>
         (ens%vstd!string.new_strlit. (str%new_strlit 6404597927344517456482722099760236947481101011607422328025525428866538510478982752417808797901206025925657927042848399726849915569645763708451525230009659)
          cba@
         )
         (=>
          (ens%vstd!string.new_strlit. (str%new_strlit 8361119213019981353352977961579829722160738195700156076437731416677323235324086675915072119538519968892599422912811282534957932553134606404999611367665629)
          ...
          (=>
           (and
            (= (str%strslice_is_ascii (str%new_strlit 6159496847612966233980601876866254041684030991354692630485059488293109394904353341620368445835143077433845422760124241126867399348183162362550152236646431))
             true
            )
            (= (str%strslice_len (str%new_strlit 6159496847612966233980601876866254041684030991354692630485059488293109394904353341620368445835143077433845422760124241126867399348183162362550152236646431))
             1
            )
            (and
             (= (str%strslice_get_char (str%new_strlit 6159496847612966233980601876866254041684030991354692630485059488293109394904353341620368445835143077433845422760124241126867399348183162362550152236646431)
               0
              ) 97
           )))
           (=>
            (and
             (= (str%strslice_is_ascii (str%new_strlit 11465181489552889314994668054784891996889264144985683056416998388417120534826012464343951928413732502245832582997843053143724316433065220416218488011908946))
              true
             )
             (= (str%strslice_len (str%new_strlit 11465181489552889314994668054784891996889264144985683056416998388417120534826012464343951928413732502245832582997843053143724316433065220416218488011908946))
              1
             )
             (and
              (= (str%strslice_get_char (str%new_strlit 11465181489552889314994668054784891996889264144985683056416998388417120534826012464343951928413732502245832582997843053143724316433065220416218488011908946)
                0
               ) 98
            )))
            (=>
             (and
              (= (str%strslice_is_ascii (str%new_strlit 11540929649067931352492096946148896400513352910797619620902175978512577332943046350783063569823445288378310188900326754765064021802439408952452049512809132))
               true
              )
              (= (str%strslice_len (str%new_strlit 11540929649067931352492096946148896400513352910797619620902175978512577332943046350783063569823445288378310188900326754765064021802439408952452049512809132))
               1
              )
              (and
               (= (str%strslice_get_char (str%new_strlit 11540929649067931352492096946148896400513352910797619620902175978512577332943046350783063569823445288378310188900326754765064021802439408952452049512809132)
                 0
                ) 99
             )))
             (=>
              (and
               (= (str%strslice_is_ascii (str%new_strlit 12875421174486089838561167381013564023947935085358512983004549604557448159382501491271815334843679443195583869113538088071367276186981820732797306589477704))
                true
               )
               (= (str%strslice_len (str%new_strlit 12875421174486089838561167381013564023947935085358512983004549604557448159382501491271815334843679443195583869113538088071367276186981820732797306589477704))
                1
               )
               (and
                (= (str%strslice_get_char (str%new_strlit 12875421174486089838561167381013564023947935085358512983004549604557448159382501491271815334843679443195583869113538088071367276186981820732797306589477704)
                  0
                 ) 100
              )))
              (=>
               (and
                (= (str%strslice_is_ascii (str%new_strlit 8361119213019981353352977961579829722160738195700156076437731416677323235324086675915072119538519968892599422912811282534957932553134606404999611367665629))
                 true
                )
                (= (str%strslice_len (str%new_strlit 8361119213019981353352977961579829722160738195700156076437731416677323235324086675915072119538519968892599422912811282534957932553134606404999611367665629))
                 3
                )
                (and
                 (= (str%strslice_get_char (str%new_strlit 8361119213019981353352977961579829722160738195700156076437731416677323235324086675915072119538519968892599422912811282534957932553134606404999611367665629)
                   0
                  ) 97
                 )
                 (= (str%strslice_get_char (str%new_strlit 8361119213019981353352977961579829722160738195700156076437731416677323235324086675915072119538519968892599422912811282534957932553134606404999611367665629)
               ...
               (=>
                (and
                 (= (str%strslice_is_ascii (str%new_strlit 6404597927344517456482722099760236947481101011607422328025525428866538510478982752417808797901206025925657927042848399726849915569645763708451525230009659))
                  true
                 )
                 (= (str%strslice_len (str%new_strlit 6404597927344517456482722099760236947481101011607422328025525428866538510478982752417808797901206025925657927042848399726849915569645763708451525230009659))
                  3
                 )
                 (and
                  (= (str%strslice_get_char (str%new_strlit 6404597927344517456482722099760236947481101011607422328025525428866538510478982752417808797901206025925657927042848399726849915569645763708451525230009659)
                    0
                   ) 99
                  )
                  (= (str%strslice_get_char (str%new_strlit 6404597927344517456482722099760236947481101011607422328025525428866538510478982752417808797901206025925657927042848399726849915569645763708451525230009659)
                ...
                (and
                 (=>
                  %%location_label%%0
                  (req%vstd!string.impl&%1.get_char. a@ 0)
                 )
                 (=>
                  (ens%vstd!string.impl&%1.get_char. a@ 0 a0@)
                  (and
                   (=>
                    %%location_label%%1
                    (req%vstd!string.impl&%1.get_char. a_clone@ 0)
                   )
                   (=>
                    (ens%vstd!string.impl&%1.get_char. a_clone@ 0 a0_clone@)
                    (and
                     (=>
                      %%location_label%%2
                      (req%vstd!string.impl&%1.get_char. a@ 0)
                     ...
                     (=>
                      (ens%vstd!string.impl&%1.get_char. a@ 0 b0@)
                      (and
                       (=>
                        %%location_label%%3
                        (req%vstd!string.impl&%1.get_char. a@ 0)
                       ...
                       (=>
                        (ens%vstd!string.impl&%1.get_char. a@ 0 c0@)
                        (=>
                         (= tmp%1 (not (= a@ b@)))
                         (and
                          (=>
                           ...
                           (=>
                            ...
                            (and
                             ...
                             (=>
                              tmp%2
                              (=>
                               (= tmp%3 (ext_eq false STRSLICE (Poly%strslice%. a@) (Poly%strslice%. a@)))
                               (and
                                (=>
                                 %%location_label%%6
                                 tmp%3
                                 ...
                                 (=>
                                  ...
                                  (and
                                   ...
                                   (=>
                                    tmp%4
                                    (=>
                                     (= tmp%5 (ext_eq false (TYPE%vstd!seq.Seq. $ CHAR) (vstd!view.View.view.? $ STRSLICE
                                        (Poly%strslice%. a@)
                                     ...
                                     (and
                                      ...
                                      (=>
                                       tmp%5
                                       (=>
                                        (= tmp%6 (ext_eq false (TYPE%vstd!seq.Seq. $ CHAR) (vstd!view.View.view.? $ STRSLICE
                                           (Poly%strslice%. b@)
                                          ) (vstd!seq.Seq.subrange.? $ CHAR (vstd!view.View.view.? $ STRSLICE (Poly%strslice%.
                                             abc@
                                            )
                                        ...
                                        (and
                                         ...
                                         (=>
                                          tmp%6
                                          (=>
                                           (= tmp%7 (ext_eq false (TYPE%vstd!seq.Seq. $ CHAR) (vstd!view.View.view.? $ STRSLICE
                                              (Poly%strslice%. c@)
                                             ) (vstd!seq.Seq.subrange.? $ CHAR (vstd!view.View.view.? $ STRSLICE (Poly%strslice%.
                                                abc@
                                               )
                                             ...
                                             (=>
                                              ...
                                              (and
                                               ...
                                               (=>
                                                tmp%8
                                                (=>
                                                 (= tmp%9 (ext_eq false STRSLICE (Poly%strslice%. abc@) (Poly%strslice%. abc_clone@)))
                                                 (=>
                                                  %%location_label%%12
                                                  tmp%9
 )))))))))))))))))))))))))))))))))))))))))))))))))
