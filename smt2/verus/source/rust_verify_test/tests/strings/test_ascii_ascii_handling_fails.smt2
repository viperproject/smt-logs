...
;; Function-Def test_crate::test_get_ascii_fails
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/strings-36081f4fa46d4460-test_ascii_ascii_handling_fails/test.rs:16:1: 16:26 (#0)
(get-info :all-statistics)
(push)
 (declare-const no%param Int)
 (declare-const y@ strslice%.)
 ...
 (assert
  (not (=>
    (and
     (= (str%strslice_is_ascii (str%new_strlit 9132989572824468725339667455146491497373223091979806522895142586756137172894882225106359289502710890600511124171751364128289709701758795675128681078171145))
      false
     )
     (= (str%strslice_len (str%new_strlit 9132989572824468725339667455146491497373223091979806522895142586756137172894882225106359289502710890600511124171751364128289709701758795675128681078171145))
      11
     )
     (and
      (= (str%strslice_get_char (str%new_strlit 9132989572824468725339667455146491497373223091979806522895142586756137172894882225106359289502710890600511124171751364128289709701758795675128681078171145)
        0
       ) 72
      )
      (= (str%strslice_get_char (str%new_strlit 9132989572824468725339667455146491497373223091979806522895142586756137172894882225106359289502710890600511124171751364128289709701758795675128681078171145)
    ...
    (=>
     (ens%vstd!string.new_strlit. (str%new_strlit 9132989572824468725339667455146491497373223091979806522895142586756137172894882225106359289502710890600511124171751364128289709701758795675128681078171145)
      y@
     )
     (=>
      %%location_label%%0
      (req%vstd!string.impl&%1.get_ascii. y@ 0)
 )))))
 (get-info :version)
...
;; Function-Recommends test_crate::test_get_ascii_fails
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/strings-36081f4fa46d4460-test_ascii_ascii_handling_fails/test.rs:16:1: 16:26 (#0)
(get-info :all-statistics)
(push)
 (declare-const no%param Int)
