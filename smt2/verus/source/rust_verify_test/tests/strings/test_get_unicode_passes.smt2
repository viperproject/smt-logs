...
;; Function-Def test_crate::test_get_unicode_passes
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/strings-36081f4fa46d4460-test_get_unicode_passes/test.rs:16:1: 16:29 (#0)
...
(push)
 ...
 (assert
  (not (=>
    (ens%vstd!string.new_strlit. (str%new_strlit 1149576597304348905430829758847045164739019033864025442941878553162293532990451185819152297343395787636361014526862184370545617082586934477722038696416566)
     x@
    )
    (=>
     (and
     ...
     (and
      ...
      (=>
       (ens%vstd!string.impl&%1.get_char. x@ 0 x0@)
       (=>
        (= tmp%1 (= x0@ 72))
        (=>
         %%location_label%%1
...
;; Function-Def test_crate::test_get_unicode_non_ascii_passes
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/strings-36081f4fa46d4460-test_get_unicode_passes/test.rs:24:1: 24:39 (#0)
(get-info :all-statistics)
(push)
 (declare-const no%param Int)
 (declare-const tmp%1 Bool)
 (declare-const emoji_with_str@ strslice%.)
 (declare-const p@ Int)
 (assert
  fuel_defaults
 )
 ...
 (assert
  (not (=>
    (ens%vstd!string.new_strlit. (str%new_strlit 4495880578222415957940455066850828903693384918453836406255670815224536193458916054072159920528417435133513997150610400237079414955364327837795411119875376)
     emoji_with_str@
    )
    (=>
     (and
      (= (str%strslice_is_ascii (str%new_strlit 4495880578222415957940455066850828903693384918453836406255670815224536193458916054072159920528417435133513997150610400237079414955364327837795411119875376))
       false
      )
      (= (str%strslice_len (str%new_strlit 4495880578222415957940455066850828903693384918453836406255670815224536193458916054072159920528417435133513997150610400237079414955364327837795411119875376))
       1
      )
      (and
       (= (str%strslice_get_char (str%new_strlit 4495880578222415957940455066850828903693384918453836406255670815224536193458916054072159920528417435133513997150610400237079414955364327837795411119875376)
         0
        ) 128169
     )))
     (and
      (=>
       %%location_label%%0
       (req%vstd!string.impl&%1.get_char. emoji_with_str@ 0)
      )
      (=>
       (ens%vstd!string.impl&%1.get_char. emoji_with_str@ 0 p@)
       (=>
        (= tmp%1 (= p@ 128169))
        (=>
         %%location_label%%1
...
;; Function-Def test_crate::test_get_unicode_non_ascii_passes1
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/strings-36081f4fa46d4460-test_get_unicode_passes/test.rs:32:1: 32:40 (#0)
(get-info :all-statistics)
(push)
 (declare-const no%param Int)
 (declare-const tmp%1 Bool)
 ...
 (assert
  (not (=>
    (ens%vstd!string.new_strlit. (str%new_strlit 867956117616506369879503720933923843144283129624488335666145629663399046414478489734004892297735627328690710897168160546348249212230289055977436101679335)
     emoji_with_str@
    )
    (=>
     (and
      (= (str%strslice_is_ascii (str%new_strlit 867956117616506369879503720933923843144283129624488335666145629663399046414478489734004892297735627328690710897168160546348249212230289055977436101679335))
       false
      )
      (= (str%strslice_len (str%new_strlit 867956117616506369879503720933923843144283129624488335666145629663399046414478489734004892297735627328690710897168160546348249212230289055977436101679335))
       7
      )
      (and
       (= (str%strslice_get_char (str%new_strlit 867956117616506369879503720933923843144283129624488335666145629663399046414478489734004892297735627328690710897168160546348249212230289055977436101679335)
         0
        ) 97
       )
       (= (str%strslice_get_char (str%new_strlit 867956117616506369879503720933923843144283129624488335666145629663399046414478489734004892297735627328690710897168160546348249212230289055977436101679335)
