...
;; Function-Specs test_crate::test_strslice_get_passes
(declare-fun req%test_crate!test_strslice_get_passes. (strslice%.) Bool)
(declare-const %%global_location_label%%3 Bool)
(declare-const %%global_location_label%%4 Bool)
(assert
 (forall ((x! strslice%.)) (!
   (= (req%test_crate!test_strslice_get_passes. x!) (and
     (=>
   ...
   :pattern ((req%test_crate!test_strslice_get_passes. x!))
   :qid internal_req__test_crate!test_strslice_get_passes._definition
   :skolemid skolem_internal_req__test_crate!test_strslice_get_passes._definition
)))
(declare-fun ens%test_crate!test_strslice_get_passes. (strslice%. Int) Bool)
(assert
 (forall ((x! strslice%.) (%return! Int)) (!
   (= (ens%test_crate!test_strslice_get_passes. x! %return!) (uInv 8 %return!))
   :pattern ((ens%test_crate!test_strslice_get_passes. x! %return!))
   :qid internal_ens__test_crate!test_strslice_get_passes._definition
   :skolemid skolem_internal_ens__test_crate!test_strslice_get_passes._definition
)))

;; Function-Def test_crate::test_strslice_get_passes
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/strings-36081f4fa46d4460-test_strslice_get/test.rs:16:1: 16:61 (#0)
