...
;; Function-Specs vstd::string::impl&%4::concat
(declare-fun ens%vstd!string.impl&%4.concat. (alloc!string.String. strslice%. alloc!string.String.)
 Bool
)
(assert
 (forall ((self! alloc!string.String.) (other! strslice%.) (ret! alloc!string.String.))
  (!
   (= (ens%vstd!string.impl&%4.concat. self! other! ret!) (and
     ...
     (and
      (= (vstd!string.string_is_ascii.? (Poly%alloc!string.String. ret!)) (vstd!string.string_is_ascii.?
        (Poly%alloc!string.String. self!)
      ))
      (vstd!string.str_slice_is_ascii.? (Poly%strslice%. other!))
   )))
   :pattern ((ens%vstd!string.impl&%4.concat. self! other! ret!))
   :qid internal_ens__vstd!string.impl&__4.concat._definition
   :skolemid skolem_internal_ens__vstd!string.impl&__4.concat._definition
)))
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/strings-36081f4fa46d4460-test_concat_1/test.rs:19:1: 19:25 (#0)
...
(push)
 ...
 (declare-const s1@ alloc!string.String.)
 (declare-const s@ alloc!string.String.)
 (assert
  fuel_defaults
 )
 ;; assertion failed
    ...
    (=>
     ...
     (=>
      ...
      (=>
       ...
       (=>
        (ens%alloc!string.impl&%38.to_string. tmp%1 s1@)
        (=>
