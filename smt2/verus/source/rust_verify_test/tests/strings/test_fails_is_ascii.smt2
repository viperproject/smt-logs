...
(assert
 (distinct fuel%vstd!string.axiom_str_literal_is_ascii. fuel%vstd!array.group_array_axioms.
...
(assert
 (=>
  ...
  (forall ((s! Poly)) (!
    ...
    :qid user_vstd__string__axiom_str_literal_is_ascii_0
    :skolemid skolem_user_vstd__string__axiom_str_literal_is_ascii_0
))))

;; Function-Def test_crate::str_is_ascii_fails
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/strings-36081f4fa46d4460-test_fails_is_ascii/test.rs:16:1: 16:24 (#0)
...
(push)
 ...
 (assert
  (not (=>
    (ens%vstd!string.new_strlit. (str%new_strlit 774325336853432707748797831485073589366119898108165923420733377674686168919368218144793901437915328479989019318657991990516591341118641984409138812292523)
     x@
    )
    (=>
     (and
      (= (str%strslice_is_ascii (str%new_strlit 774325336853432707748797831485073589366119898108165923420733377674686168919368218144793901437915328479989019318657991990516591341118641984409138812292523))
       false
      )
      (= (str%strslice_len (str%new_strlit 774325336853432707748797831485073589366119898108165923420733377674686168919368218144793901437915328479989019318657991990516591341118641984409138812292523))
       1
      )
      (and
       (= (str%strslice_get_char (str%new_strlit 774325336853432707748797831485073589366119898108165923420733377674686168919368218144793901437915328479989019318657991990516591341118641984409138812292523)
         0
        ) 224
     )))
     (=>
      (= tmp%1 (vstd!string.str_slice_is_ascii.? (Poly%strslice%. x@)))
      (=>
       %%location_label%%0
       tmp%1
 ))))))
...
;; Function-Recommends test_crate::str_is_ascii_fails
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/strings-36081f4fa46d4460-test_fails_is_ascii/test.rs:16:1: 16:24 (#0)
(get-info :all-statistics)
(push)
 (declare-const no%param Int)
