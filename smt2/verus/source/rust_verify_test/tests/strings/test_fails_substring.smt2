...
(assert
 (distinct fuel%vstd!raw_ptr.impl&%4.view. fuel%vstd!raw_ptr.ptrs_mut_eq. fuel%vstd!seq.impl&%0.spec_index.
  ...
  fuel%vstd!seq.axiom_seq_subrange_index. fuel%vstd!string.new_strlit_spec. fuel%vstd!string.axiom_str_literal_len.
...
(assert
 (=>
  ...
  (forall ((s! Poly)) (!
    ...
    :qid user_vstd__string__axiom_str_literal_len_9
    :skolemid skolem_user_vstd__string__axiom_str_literal_len_9
))))
...
(assert
 (=>
  ...
  (forall ((s! Poly) (i! Poly)) (!
    ...
    :qid user_vstd__string__axiom_str_literal_get_char_10
    :skolemid skolem_user_vstd__string__axiom_str_literal_get_char_10
))))
...
;; Function-Specs test_crate::test_substring_fails
(declare-fun ens%test_crate!test_substring_fails. (Int strslice%.) Bool)
(assert
 (forall ((no%param Int) (ret! strslice%.)) (!
   (= (ens%test_crate!test_substring_fails. no%param ret!) (ext_eq false (TYPE%vstd!seq.Seq.
      $ CHAR
   ...
   :pattern ((ens%test_crate!test_substring_fails. no%param ret!))
   :qid internal_ens__test_crate!test_substring_fails._definition
   :skolemid skolem_internal_ens__test_crate!test_substring_fails._definition
)))

;; Function-Def test_crate::test_substring_fails
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/strings-36081f4fa46d4460-test_fails_substring/test.rs:16:1: 16:52 (#0)
...
(push)
 ...
 (assert
  (not (=>
    ...
    (=>
     (and
      (= (str%strslice_is_ascii (str%new_strlit 9975559879865410961785420328613919832499501276938838816117994231053306900560077698826977288209083282052938661576628645567030770747902516671089958773405601))
       true
      )
      (= (str%strslice_len (str%new_strlit 9975559879865410961785420328613919832499501276938838816117994231053306900560077698826977288209083282052938661576628645567030770747902516671089958773405601))
       11
      )
      (and
       (= (str%strslice_get_char (str%new_strlit 9975559879865410961785420328613919832499501276938838816117994231053306900560077698826977288209083282052938661576628645567030770747902516671089958773405601)
         0
        ) 71
       )
       (= (str%strslice_get_char (str%new_strlit 9975559879865410961785420328613919832499501276938838816117994231053306900560077698826977288209083282052938661576628645567030770747902516671089958773405601)
     ...
     (=>
      (ens%vstd!string.new_strlit. (str%new_strlit 9975559879865410961785420328613919832499501276938838816117994231053306900560077698826977288209083282052938661576628645567030770747902516671089958773405601)
       tmp%1
      )
      (=>
       (= ret! tmp%1)
...
;; Function-Recommends test_crate::test_substring_fails
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/strings-36081f4fa46d4460-test_fails_substring/test.rs:16:1: 16:52 (#0)
(get-info :all-statistics)
(push)
 (declare-const ret! strslice%.)
    ...
    (=>
     ...
     (=>
      ...
      (=>
       (= ret! tmp%3)
       (=>
        (= tmp%2 (vstd!view.View.view.? $ STRSLICE (Poly%strslice%. ret!)))
        (=>
         %%location_label%%0
         (req%vstd!seq.Seq.subrange. $ CHAR tmp%2 (I 0) (I 5))
 ))))))))
 (get-info :version)
 (set-option :rlimit 30000000)
 (check-sat)
