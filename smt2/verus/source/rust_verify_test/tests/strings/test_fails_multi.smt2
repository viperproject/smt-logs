...
(declare-const fuel%test_crate!z. FuelId)
...
(assert
 (distinct fuel%vstd!raw_ptr.impl&%4.view. fuel%vstd!raw_ptr.ptrs_mut_eq. fuel%vstd!seq.impl&%0.spec_index.
  ...
  fuel%vstd!view.impl&%24.view. fuel%vstd!view.impl&%38.view. fuel%test_crate!x. fuel%test_crate!y.
  fuel%test_crate!z. fuel%vstd!array.group_array_axioms. fuel%vstd!map.group_map_axioms.
...
;; Function-Decl test_crate::z
(declare-fun test_crate!z.? () strslice%.)
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/strings-36081f4fa46d4460-test_fails_multi/test.rs:16:1: 16:44 (#0)
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/strings-36081f4fa46d4460-test_fails_multi/test.rs:17:1: 17:44 (#0)
(get-info :all-statistics)
(push)
 (declare-const %return! strslice%.)
 (assert
...
;; Function-Def test_crate::z
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/strings-36081f4fa46d4460-test_fails_multi/test.rs:18:1: 18:51 (#0)
(get-info :all-statistics)
(push)
 (declare-const %return! strslice%.)
 (assert
...
;; Function-Axioms test_crate::z
(assert
 (fuel_bool_default fuel%test_crate!z.)
)
(assert
 (=>
  (fuel_bool fuel%test_crate!z.)
  (= test_crate!z.? (str%new_strlit 6511664155108117155160440465393861137163434476611231281882978541781312885260138822509299084719407114215921677683797231629595498656100565194540147287588558))
))
...
;; Function-Def test_crate::test_multi_fails1
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/strings-36081f4fa46d4460-test_fails_multi/test.rs:20:1: 20:23 (#0)
(get-info :all-statistics)
(push)
...
;; Function-Recommends test_crate::test_multi_fails1
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/strings-36081f4fa46d4460-test_fails_multi/test.rs:20:1: 20:23 (#0)
(get-info :all-statistics)
(push)
 (declare-const no%param Int)
...
;; Function-Def test_crate::test_multi_fails2
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/strings-36081f4fa46d4460-test_fails_multi/test.rs:24:1: 24:23 (#0)
(get-info :all-statistics)
(push)
 (declare-const no%param Int)
 (declare-const tmp%1 Bool)
 ...
 (assert
  (not (=>
    (= tmp%1 (not (= (vstd!seq.Seq.len.? $ CHAR (vstd!view.View.view.? $ STRSLICE (Poly%strslice%.
          test_crate!x.?
        ))
       ) 11
    )))
...
;; Function-Recommends test_crate::test_multi_fails2
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/strings-36081f4fa46d4460-test_fails_multi/test.rs:24:1: 24:23 (#0)
(get-info :all-statistics)
(push)
 (declare-const no%param Int)
...
;; Function-Def test_crate::test_multi_fails3
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/strings-36081f4fa46d4460-test_fails_multi/test.rs:28:1: 28:23 (#0)
(get-info :all-statistics)
(push)
 (declare-const no%param Int)
 (declare-const tmp%1 Bool)
 ...
 (assert
  (not (=>
    (= tmp%1 (ext_eq false STRSLICE (Poly%strslice%. test_crate!x.?) (Poly%strslice%. test_crate!y.?)))
    (=>
     %%location_label%%0
     tmp%1
 ))))
...
;; Function-Recommends test_crate::test_multi_fails3
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/strings-36081f4fa46d4460-test_fails_multi/test.rs:28:1: 28:23 (#0)
(get-info :all-statistics)
(push)
 (declare-const no%param Int)
