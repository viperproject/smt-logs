...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/strings-36081f4fa46d4460-test_string_2_fail/test.rs:16:1: 16:10 (#0)
...
(push)
 ...
 (assert
  (not (=>
    (ens%vstd!string.new_strlit. (str%new_strlit 1349018604078111690493823870676609963738520480533403424760252908044991056599407634904658653136144913754080724506789101012103601880788751172456430953853241)
     tmp%1
    )
    (=>
     ...
     (=>
      (and
       (= (str%strslice_is_ascii (str%new_strlit 1349018604078111690493823870676609963738520480533403424760252908044991056599407634904658653136144913754080724506789101012103601880788751172456430953853241))
        true
       )
       (= (str%strslice_len (str%new_strlit 1349018604078111690493823870676609963738520480533403424760252908044991056599407634904658653136144913754080724506789101012103601880788751172456430953853241))
        3
       )
       (and
        (= (str%strslice_get_char (str%new_strlit 1349018604078111690493823870676609963738520480533403424760252908044991056599407634904658653136144913754080724506789101012103601880788751172456430953853241)
          0
         ) 65
        )
        (= (str%strslice_get_char (str%new_strlit 1349018604078111690493823870676609963738520480533403424760252908044991056599407634904658653136144913754080724506789101012103601880788751172456430953853241)
      ...
      (=>
       (ens%alloc!string.impl&%0.as_str. a@ tmp%2)
       (and
        (=>
         %%location_label%%0
         (req%vstd!string.impl&%1.substring_ascii. tmp%2 2 3)
        )
        (=>
         (ens%vstd!string.impl&%1.substring_ascii. tmp%2 2 3 b@)
         (=>
          (and
           (= (str%strslice_is_ascii (str%new_strlit 807498828609298088737404645116962888444630591525261622831400507980418669506191540008628212270005428937250159415192411978859162104104927934873045530282884))
            true
           )
           (= (str%strslice_len (str%new_strlit 807498828609298088737404645116962888444630591525261622831400507980418669506191540008628212270005428937250159415192411978859162104104927934873045530282884))
            1
           )
           (and
            (= (str%strslice_get_char (str%new_strlit 807498828609298088737404645116962888444630591525261622831400507980418669506191540008628212270005428937250159415192411978859162104104927934873045530282884)
              0
             ) 66
          )))
          (=>
           (and
            (= (str%strslice_is_ascii (str%new_strlit 13161854157804060622914413254020753464188049949337327575429874391358924022282411656795659205881603167902357146866750721461936000695900770700533568542237501))
             true
            )
            (= (str%strslice_len (str%new_strlit 13161854157804060622914413254020753464188049949337327575429874391358924022282411656795659205881603167902357146866750721461936000695900770700533568542237501))
             1
            )
            (and
             (= (str%strslice_get_char (str%new_strlit 13161854157804060622914413254020753464188049949337327575429874391358924022282411656795659205881603167902357146866750721461936000695900770700533568542237501)
               0
              ) 67
           )))
           (=>
            (= tmp%3 (ext_eq false (TYPE%vstd!seq.Seq. $ CHAR) (vstd!view.View.view.? $ STRSLICE
               (Poly%strslice%. b@)
              ) (vstd!view.View.view.? $ STRSLICE (Poly%strslice%. (vstd!string.new_strlit_spec.?
                 (Poly%strslice%. (str%new_strlit 13161854157804060622914413254020753464188049949337327575429874391358924022282411656795659205881603167902357146866750721461936000695900770700533568542237501))
            )))))
            (and
             (=>
              %%location_label%%1
             ...
             (=>
              tmp%3
              (=>
               (= tmp%4 (ext_eq false (TYPE%vstd!seq.Seq. $ CHAR) (vstd!view.View.view.? $ STRSLICE
                  (Poly%strslice%. b@)
                 ) (vstd!view.View.view.? $ STRSLICE (Poly%strslice%. (vstd!string.new_strlit_spec.?
