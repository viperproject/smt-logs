...
;; Function-Specs vstd::string::impl&%1::get_char
   ...
   (= (ens%vstd!string.impl&%1.get_char. self! i! c!) (and
     ...
     (=>
      ...
      (forall ((i$ Poly)) (!
        ...
        :qid user_vstd__string__impl&%1__get_char_6
        :skolemid skolem_user_vstd__string__impl&%1__get_char_6
   )))))
...
(assert
 (=>
  ...
  (forall ((s! Poly)) (!
    ...
    :qid user_vstd__string__axiom_str_literal_is_ascii_7
    :skolemid skolem_user_vstd__string__axiom_str_literal_is_ascii_7
))))
...
(assert
 (=>
  ...
  (forall ((s! Poly)) (!
    ...
    :qid user_vstd__string__axiom_str_literal_len_8
    :skolemid skolem_user_vstd__string__axiom_str_literal_len_8
))))
...
(assert
 (=>
  ...
  (forall ((s! Poly) (i! Poly)) (!
    ...
    :qid user_vstd__string__axiom_str_literal_get_char_9
    :skolemid skolem_user_vstd__string__axiom_str_literal_get_char_9
))))
...
;; Function-Def test_crate::get_char_fails
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/strings-36081f4fa46d4460-test_fail_get_char/test.rs:16:1: 16:20 (#0)
...
(push)
 ...
 (assert
  (not (=>
    (ens%vstd!string.new_strlit. (str%new_strlit 5857653121046279034552476590803892574076708969035808390364295635444593807558796960422749049999998970216024059018244743538121595522469447963771576066547248)
     x@
    )
    (and
     (=>
      %%location_label%%0
      (req%vstd!string.impl&%1.get_char. x@ 0)
     )
     (=>
      (ens%vstd!string.impl&%1.get_char. x@ 0 val@)
      (=>
       (= tmp%1 (= val@ 104))
       (=>
        %%location_label%%1
...
;; Function-Recommends test_crate::get_char_fails
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/strings-36081f4fa46d4460-test_fail_get_char/test.rs:16:1: 16:20 (#0)
(get-info :all-statistics)
(push)
 (declare-const no%param Int)
