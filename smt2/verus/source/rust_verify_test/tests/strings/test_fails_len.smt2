...
;; Function-Def test_crate::len_fails
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/strings-36081f4fa46d4460-test_fails_len/test.rs:17:1: 17:19 (#0)
...
(push)
 ...
 (assert
  (not (=>
    (ens%vstd!string.new_strlit. (str%new_strlit 12105134011066363001972651399857272613424510895198238126148578716844228555475115707068098806087711483312251576888080873416351301675725649694681508267241187)
     x@
    )
    (=>
     (and
      (= (str%strslice_is_ascii (str%new_strlit 12105134011066363001972651399857272613424510895198238126148578716844228555475115707068098806087711483312251576888080873416351301675725649694681508267241187))
       true
      )
      (= (str%strslice_len (str%new_strlit 12105134011066363001972651399857272613424510895198238126148578716844228555475115707068098806087711483312251576888080873416351301675725649694681508267241187))
       6
      )
      (and
       (= (str%strslice_get_char (str%new_strlit 12105134011066363001972651399857272613424510895198238126148578716844228555475115707068098806087711483312251576888080873416351301675725649694681508267241187)
         0
        ) 97
       )
       (= (str%strslice_get_char (str%new_strlit 12105134011066363001972651399857272613424510895198238126148578716844228555475115707068098806087711483312251576888080873416351301675725649694681508267241187)
...
;; Function-Recommends test_crate::len_fails
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/strings-36081f4fa46d4460-test_fails_len/test.rs:17:1: 17:19 (#0)
(get-info :all-statistics)
(push)
 (declare-const no%param Int)
