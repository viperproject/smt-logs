...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/strings-36081f4fa46d4460-test_string_1_pass/test.rs:16:1: 16:10 (#0)
      ...
      (=>
       (= tmp%2 (ext_eq false (TYPE%vstd!seq.Seq. $ CHAR) (vstd!view.View.view.? $ TYPE%alloc!string.String.
          (Poly%alloc!string.String. a@)
            ...
            (Poly%strslice%. (str%new_strlit 12874110177272889275858083148775298614087114561911955841596002957005842009344403665534665779667059700242099875849763788391163776422516373223328969527702561))
       )))))
       (and
        (=>
         %%location_label%%0
        ...
        (=>
         tmp%2
         (=>
          (= tmp%3 (vstd!string.string_is_ascii.? (Poly%alloc!string.String. a@)))
          (=>
           %%location_label%%1
           tmp%3
 ))))))))))
