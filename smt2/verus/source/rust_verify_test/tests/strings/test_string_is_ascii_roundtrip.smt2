...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/strings-36081f4fa46d4460-test_string_is_ascii_roundtrip/test.rs:16:1: 16:10 (#0)
...
(push)
 ...
 (declare-const b@ alloc!string.String.)
 ...
 (assert
  (not (=>
    ...
    (=>
     (ens%alloc!string.impl&%38.to_string. a@ b@)
     (=>
      (ens%alloc!string.impl&%0.as_str. b@ c@)
      (=>
       (and
       ...
       (=>
        (= tmp%1 (ext_eq false (TYPE%vstd!seq.Seq. $ CHAR) (vstd!view.View.view.? $ STRSLICE
           (Poly%strslice%. a@)
          ) (vstd!view.View.view.? $ STRSLICE (Poly%strslice%. c@))
        ))
        (and
         (=>
          %%location_label%%0
         ...
         (=>
          tmp%1
          (=>
           (= tmp%2 (vstd!string.str_slice_is_ascii.? (Poly%strslice%. a@)))
           (and
            (=>
             %%location_label%%1
             tmp%2
            ...
            (=>
             tmp%2
             (=>
              (= tmp%3 (vstd!string.string_is_ascii.? (Poly%alloc!string.String. b@)))
              (and
               (=>
                %%location_label%%2
                tmp%3
               ...
               (=>
                tmp%3
                (=>
                 (= tmp%4 (vstd!string.str_slice_is_ascii.? (Poly%strslice%. c@)))
                 (=>
                  %%location_label%%3
                  tmp%4
 )))))))))))))))))
