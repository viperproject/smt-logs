...
;; Function-Specs vstd::string::impl&%1::substring_char
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/strings-36081f4fa46d4460-test_unicode_substring_passes/test.rs:16:1: 16:27 (#0)
...
(push)
 ...
 (declare-const x0@ strslice%.)
 (declare-const x1@ strslice%.)
 (assert
  fuel_defaults
 )
 ;; assertion failed
 ...
 (assert
  (not (=>
    (and
     (= (str%strslice_is_ascii (str%new_strlit 9038720198121570375262744663106979804559867001753304710171458910314335930104403358043139843217001500799637627398722886436515522693374784495881920813156230))
      false
     )
     (= (str%strslice_len (str%new_strlit 9038720198121570375262744663106979804559867001753304710171458910314335930104403358043139843217001500799637627398722886436515522693374784495881920813156230))
      6
     )
     (and
      (= (str%strslice_get_char (str%new_strlit 9038720198121570375262744663106979804559867001753304710171458910314335930104403358043139843217001500799637627398722886436515522693374784495881920813156230)
        0
       ) 48
      )
      (= (str%strslice_get_char (str%new_strlit 9038720198121570375262744663106979804559867001753304710171458910314335930104403358043139843217001500799637627398722886436515522693374784495881920813156230)
    ...
    (=>
     (and
      (= (str%strslice_is_ascii (str%new_strlit 6133966064217320592168196458547627854112780877370015635847102121010031092573336269892240588153267869748378672774063407218065470928577415864239381889158167))
       true
      )
      (= (str%strslice_len (str%new_strlit 6133966064217320592168196458547627854112780877370015635847102121010031092573336269892240588153267869748378672774063407218065470928577415864239381889158167))
       3
      )
      (and
       (= (str%strslice_get_char (str%new_strlit 6133966064217320592168196458547627854112780877370015635847102121010031092573336269892240588153267869748378672774063407218065470928577415864239381889158167)
         0
        ) 48
       )
       (= (str%strslice_get_char (str%new_strlit 6133966064217320592168196458547627854112780877370015635847102121010031092573336269892240588153267869748378672774063407218065470928577415864239381889158167)
     ...
     (=>
      (and
       (= (str%strslice_is_ascii (str%new_strlit 9095962212031312257797648792108600727785438254194753685056383017996676890996117860322259008240696177694311512699124450603524414712018978830820892303948322))
        false
       )
       (= (str%strslice_len (str%new_strlit 9095962212031312257797648792108600727785438254194753685056383017996676890996117860322259008240696177694311512699124450603524414712018978830820892303948322))
        3
       )
       (and
        (= (str%strslice_get_char (str%new_strlit 9095962212031312257797648792108600727785438254194753685056383017996676890996117860322259008240696177694311512699124450603524414712018978830820892303948322)
          0
         ) 51
        )
        (= (str%strslice_get_char (str%new_strlit 9095962212031312257797648792108600727785438254194753685056383017996676890996117860322259008240696177694311512699124450603524414712018978830820892303948322)
      ...
      (=>
       (ens%vstd!string.new_strlit. (str%new_strlit 9038720198121570375262744663106979804559867001753304710171458910314335930104403358043139843217001500799637627398722886436515522693374784495881920813156230)
        x@
       )
       (=>
        (= tmp%1 (= (vstd!seq.Seq.len.? $ CHAR (vstd!view.View.view.? $ STRSLICE (Poly%strslice%.
             x@
           ))
          ) 6
        ))
        (and
         ...
         (=>
          ...
          (and
           (=>
            %%location_label%%1
            (req%vstd!string.impl&%1.substring_char. x@ 0 3)
           )
           (=>
            (ens%vstd!string.impl&%1.substring_char. x@ 0 3 x0@)
            (=>
             (= tmp%2 (ext_eq false (TYPE%vstd!seq.Seq. $ CHAR) (vstd!view.View.view.? $ STRSLICE
                (Poly%strslice%. x0@)
               ) (vstd!view.View.view.? $ STRSLICE (Poly%strslice%. (vstd!string.new_strlit_spec.?
                  (Poly%strslice%. (str%new_strlit 6133966064217320592168196458547627854112780877370015635847102121010031092573336269892240588153267869748378672774063407218065470928577415864239381889158167))
             )))))
             (and
              (=>
               %%location_label%%2
              ...
              (=>
               ...
               (and
                (=>
                 %%location_label%%3
                 (req%vstd!string.impl&%1.substring_char. x@ 3 6)
                )
                (=>
                 (ens%vstd!string.impl&%1.substring_char. x@ 3 6 x1@)
                 (=>
                  (= tmp%3 (ext_eq false (TYPE%vstd!seq.Seq. $ CHAR) (vstd!view.View.view.? $ STRSLICE
                     (Poly%strslice%. x1@)
                    ) (vstd!view.View.view.? $ STRSLICE (Poly%strslice%. (vstd!string.new_strlit_spec.?
                       (Poly%strslice%. (str%new_strlit 9095962212031312257797648792108600727785438254194753685056383017996676890996117860322259008240696177694311512699124450603524414712018978830820892303948322))
                  )))))
                  (=>
                   %%location_label%%4
                   tmp%3
