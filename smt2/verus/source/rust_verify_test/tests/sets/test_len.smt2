...
(assert
 (distinct fuel%vstd!set.axiom_set_ext_equal. fuel%vstd!set.axiom_set_ext_equal_deep.
  fuel%vstd!set.axiom_set_contains_len. fuel%vstd!array.group_array_axioms. fuel%vstd!map.group_map_axioms.
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (s! Poly) (a! Poly)) (!
    ...
    :qid user_vstd__set__axiom_set_contains_len_3
    :skolemid skolem_user_vstd__set__axiom_set_contains_len_3
))))

;; Function-Def test_crate::test_len
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/sets-a55b6df8c4f72a7b-test_len/test.rs:17:7: 17:32 (#0)
...
(push)
 ...
 (assert
  (not (=>
    (= tmp%1 (>= (vstd!set.impl&%0.len.? A&. A& s!) 0))
    (=>
     %%location_label%%0
     tmp%1
 ))))
