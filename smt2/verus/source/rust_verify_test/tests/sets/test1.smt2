...
(assert
 (distinct fuel%vstd!set.impl&%0.filter. fuel%vstd!set.axiom_set_new. fuel%vstd!set.axiom_set_intersect.
  fuel%vstd!set.axiom_set_ext_equal. fuel%vstd!set.axiom_set_ext_equal_deep. fuel%vstd!set_lib.impl&%0.map.
...
;; Function-Decl vstd::set_lib::impl&%0::map
...
;; Function-Axioms vstd::set_lib::impl&%0::map
(assert
 ...
 (forall ((%%hole%%0 Dcr) (%%hole%%1 Type) (%%hole%%2 Poly) (%%hole%%3 Type) (%%hole%%4
   ...
   (= (%%apply%%0 (%%lambda%%0 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3 %%hole%%4 %%hole%%5
      %%hole%%6 %%hole%%7
       ...
       :qid user_vstd__set_lib__impl&%0__map_5
       :skolemid skolem_user_vstd__set_lib__impl&%0__map_5
   ))))
 ...
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (B&. Dcr) (B& Type) (self! Poly) (f! Poly)) (!
    (= (vstd!set_lib.impl&%0.map.? A&. A& B&. B& self! f!) (vstd!set.impl&%0.new.? B&.
      B& $ (TYPE%fun%1. B&. B& $ BOOL) (Poly%fun%1. (mk_fun (%%lambda%%0 A&. A& self! A& A&.
         A& self! (%Poly%fun%1. f!)
    )))))
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/sets-a55b6df8c4f72a7b-test1/test.rs:18:7: 18:20 (#0)
        ...
        (=>
         ...
         (and
          ...
          (=>
           tmp%2
           (=>
            (= pos2@ (%Poly%vstd!set.Set<int.>. (vstd!set_lib.impl&%0.map.? $ INT $ INT (Poly%vstd!set.Set<int.>.
                nonneg@
            ...
            (and
             (=>
              (has_type i@ INT)
              (=>
               (= tmp%3 (= (vstd!set.impl&%0.contains.? $ INT (Poly%vstd!set.Set<int.>. pos2@) i@)
                 (vstd!set.impl&%0.contains.? $ INT (Poly%vstd!set.Set<int.>. nonneg@) (I (Sub (%I i@)
                    1
               )))))
               (and
                (=>
                 ...
                 (=>
                  ...
                  (and
                   ...
                   (=>
                    tmp%5
                    (=>
                     (= tmp%6 (ext_eq false (TYPE%vstd!set.Set. $ INT) (Poly%vstd!set.Set<int.>. pos1@)
                       (Poly%vstd!set.Set<int.>. pos2@)
                     ))
                     (=>
                      %%location_label%%6
