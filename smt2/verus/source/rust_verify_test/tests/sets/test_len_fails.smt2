...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/sets-a55b6df8c4f72a7b-test_len_fails/test.rs:17:7: 17:45 (#0)
...
(push)
 ...
 (assert
  (not (=>
    (= tmp%1 (= (vstd!set.impl&%0.len.? A&. A& s1!) (vstd!set.impl&%0.len.? A&. A& s2!)))
    (=>
     %%location_label%%0
     tmp%1
 ))))
...
;; Function-Recommends test_crate::test_len
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/sets-a55b6df8c4f72a7b-test_len_fails/test.rs:17:7: 17:45 (#0)
(get-info :all-statistics)
(push)
 (declare-const A&. Dcr)
