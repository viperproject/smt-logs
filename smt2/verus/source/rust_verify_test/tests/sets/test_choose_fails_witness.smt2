...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/sets-a55b6df8c4f72a7b-test_choose_fails_witness/test.rs:22:7: 22:24 (#0)
 ...
 (assert
  (not (=>
    ...
    (=>
     ...
     (=>
      (= tmp%1 (vstd!set.impl&%0.contains.? $ INT (Poly%vstd!set.Set<int.>. s@) (vstd!set.impl&%0.choose.?
...
;; Function-Recommends test_crate::test_witness
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/sets-a55b6df8c4f72a7b-test_choose_fails_witness/test.rs:22:7: 22:24 (#0)
(get-info :all-statistics)
(push)
 (declare-const no%param Int)
 ...
 (assert
  (forall ((x$ Poly)) (!
    (= (%%apply%%0 %%lambda%%1 x$) (B (test_crate!f.? x$)))
