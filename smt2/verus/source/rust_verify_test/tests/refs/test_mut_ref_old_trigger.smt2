...
;; Function-Specs test_crate::add1
(declare-fun req%test_crate!add1. (alloc!vec.Vec<u64./allocator_global%.>.) Bool)
(declare-const %%global_location_label%%3 Bool)
(assert
 (forall ((pre%v! alloc!vec.Vec<u64./allocator_global%.>.)) (!
   (= (req%test_crate!add1. pre%v!) (=>
     ...
     (forall ((i$ Poly)) (!
       (=>
        ...
        (=>
         ...
         (< (%I (vstd!seq.Seq.index.? $ (UINT 64) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec.
              $ (UINT 64) $ ALLOCATOR_GLOBAL
             ) (Poly%alloc!vec.Vec<u64./allocator_global%.>. pre%v!)
            ) i$
           )
          ) 10
       )))
       ...
       :qid user_test_crate__add1_8
       :skolemid skolem_user_test_crate__add1_8
   ))))
   :pattern ((req%test_crate!add1. pre%v!))
   :qid internal_req__test_crate!add1._definition
   :skolemid skolem_internal_req__test_crate!add1._definition
)))

;; Function-Def test_crate::add1
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/refs-c093a47f3c91638e-test_mut_ref_old_trigger/test.rs:17:1: 17:26 (#0)
...
(push)
 ...
 (assert
  (forall ((i$ Poly)) (!
    ...
    :qid user_test_crate__add1_9
    :skolemid skolem_user_test_crate__add1_9
 )))
 (assert
  (not true)
 )
...
(declare-fun req%test_crate!test. (alloc!vec.Vec<u64./allocator_global%.>.) Bool)
(declare-const %%global_location_label%%4 Bool)
(assert
 (forall ((v! alloc!vec.Vec<u64./allocator_global%.>.)) (!
   (= (req%test_crate!test. v!) (=>
     ...
     (forall ((i$ Poly)) (!
       (=>
        ...
        (=>
         ...
         (< (%I (vstd!seq.Seq.index.? $ (UINT 64) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec.
              $ (UINT 64) $ ALLOCATOR_GLOBAL
             ) (Poly%alloc!vec.Vec<u64./allocator_global%.>. v!)
            ) i$
           )
          ) 5
       )))
       ...
       :qid user_test_crate__test_10
       :skolemid skolem_user_test_crate__test_10
   ))))
   :pattern ((req%test_crate!test. v!))
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/refs-c093a47f3c91638e-test_mut_ref_old_trigger/test.rs:23:1: 23:21 (#0)
(get-info :all-statistics)
(push)
 (declare-const v! alloc!vec.Vec<u64./allocator_global%.>.)
 (declare-const v1@0 alloc!vec.Vec<u64./allocator_global%.>.)
 (assert
  fuel_defaults
 )
 (assert
  (forall ((i$ Poly)) (!
    ...
    :qid user_test_crate__test_11
    :skolemid skolem_user_test_crate__test_11
 )))
 (declare-const v1@1 alloc!vec.Vec<u64./allocator_global%.>.)
