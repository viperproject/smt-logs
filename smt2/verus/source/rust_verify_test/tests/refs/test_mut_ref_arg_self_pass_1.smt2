...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/refs-c093a47f3c91638e-test_mut_ref_arg_self_pass_1/test.rs:20:5: 20:27 (#0)
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/refs-c093a47f3c91638e-test_mut_ref_arg_self_pass_1/test.rs:30:1: 30:12 (#0)
(get-info :all-statistics)
(push)
    ...
    (and
     ...
     (=>
      ...
      (=>
       ...
       (=>
        (= tmp%1 (= (Value./Value/v (%Poly%Value. (Poly%Value. v@1))) 3))
        (=>
         %%location_label%%1
         tmp%1
 ))))))))
