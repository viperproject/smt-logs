...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/refs-c093a47f3c91638e-test_mut_ref_arg_self_pass_2/test.rs:20:5: 20:27 (#0)
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/refs-c093a47f3c91638e-test_mut_ref_arg_self_pass_2/test.rs:30:1: 30:12 (#0)
(get-info :all-statistics)
(push)
 ...
 (assert
  (not (=>
    ...
    (and
     ...
     (=>
      (has_type (Poly%Value. v@1) TYPE%Value.)
      (=>
       (ens%impl&%0.add1. v@0 v@1)
       (and
        (=>
         %%location_label%%1
         (req%impl&%0.add1. v@1)
        ...
        (=>
         (has_type (Poly%Value. v@2) TYPE%Value.)
         (=>
          (ens%impl&%0.add1. v@1 v@2)
          (=>
           (= tmp%1 (= (Value./Value/v (%Poly%Value. (Poly%Value. v@2))) 4))
           (=>
            %%location_label%%2
            tmp%1
 )))))))))))
