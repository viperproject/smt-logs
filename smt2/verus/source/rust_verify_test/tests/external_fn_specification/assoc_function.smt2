...
;; Datatypes
(declare-datatypes ((X. 0) (tuple%0. 0)) (((X./X (X./X/?a Int))) ((tuple%0./tuple%0))))
...
(assert
 (forall ((_a! Int)) (!
   (=>
    (uInv 8 _a!)
    (has_type (Poly%X. (X./X _a!)) TYPE%X.)
   )
   :pattern ((has_type (Poly%X. (X./X _a!)) TYPE%X.))
...
(declare-fun ens%impl&%0.new. (Int X.) Bool)
(assert
 (forall ((a! Int) (res! X.)) (!
   (= (ens%impl&%0.new. a! res!) (and
     (has_type (Poly%X. res!) TYPE%X.)
     (= (X./X/a (%Poly%X. (Poly%X. res!))) a!)
   ))
   :pattern ((ens%impl&%0.new. a! res!))
   :qid internal_ens__impl&__0.new._definition
   :skolemid skolem_internal_ens__impl&__0.new._definition
)))

;; Function-Def crate::test
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/external_fn_specification-98f820c3b4a7f66c-assoc_function/test.rs:31:1: 31:10 (#0)
