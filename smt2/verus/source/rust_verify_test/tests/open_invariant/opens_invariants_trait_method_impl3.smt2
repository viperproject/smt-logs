...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/open_invariant-52348288733105e9-opens_invariants_trait_method_impl3/test.rs:27:11: 27:94 (#0)
(get-info :all-statistics)
(push)
 (declare-const credit! Poly)
 (declare-const i! Poly)
 (declare-const tmp%1 Poly)
 (declare-const tmp%2@0 Int)
 (declare-const inner~27@0 Int)
 (assert
  fuel_defaults
 )
 (assert
  (has_type credit! TYPE%vstd!invariant.OpenInvariantCredit.)
 )
 (assert
