...
;; Datatypes
(declare-sort vstd!invariant.LocalInvariant<tuple%0./u8./test_crate!B.>. 0)
(declare-sort vstd!invariant.OpenInvariantCredit. 0)
(declare-datatypes ((test_crate!B. 0) (test_crate!X. 0) (tuple%0. 0)) (((test_crate!B./B))
  ((test_crate!X./X)) ((tuple%0./tuple%0))
))
...
(declare-fun Poly%vstd!invariant.LocalInvariant<tuple%0./u8./test_crate!B.>. (vstd!invariant.LocalInvariant<tuple%0./u8./test_crate!B.>.)
 Poly
)
(declare-fun %Poly%vstd!invariant.LocalInvariant<tuple%0./u8./test_crate!B.>. (Poly)
 vstd!invariant.LocalInvariant<tuple%0./u8./test_crate!B.>.
)
...
(assert
 (forall ((x vstd!invariant.LocalInvariant<tuple%0./u8./test_crate!B.>.)) (!
   (= x (%Poly%vstd!invariant.LocalInvariant<tuple%0./u8./test_crate!B.>. (Poly%vstd!invariant.LocalInvariant<tuple%0./u8./test_crate!B.>.
      x
   )))
   :pattern ((Poly%vstd!invariant.LocalInvariant<tuple%0./u8./test_crate!B.>. x))
   :qid internal_vstd__invariant__LocalInvariant<tuple__0./u8./test_crate!B.>_box_axiom_definition
   :skolemid skolem_internal_vstd__invariant__LocalInvariant<tuple__0./u8./test_crate!B.>_box_axiom_definition
)))
(assert
 (forall ((x Poly)) (!
   (=>
    (has_type x (TYPE%vstd!invariant.LocalInvariant. $ TYPE%tuple%0. $ (UINT 8) $ TYPE%test_crate!B.))
    (= x (Poly%vstd!invariant.LocalInvariant<tuple%0./u8./test_crate!B.>. (%Poly%vstd!invariant.LocalInvariant<tuple%0./u8./test_crate!B.>.
       x
   ))))
   :pattern ((has_type x (TYPE%vstd!invariant.LocalInvariant. $ TYPE%tuple%0. $ (UINT 8)
      $ TYPE%test_crate!B.
   )))
   :qid internal_vstd__invariant__LocalInvariant<tuple__0./u8./test_crate!B.>_unbox_axiom_definition
   :skolemid skolem_internal_vstd__invariant__LocalInvariant<tuple__0./u8./test_crate!B.>_unbox_axiom_definition
)))
(assert
 (forall ((x vstd!invariant.LocalInvariant<tuple%0./u8./test_crate!B.>.)) (!
   (has_type (Poly%vstd!invariant.LocalInvariant<tuple%0./u8./test_crate!B.>. x) (TYPE%vstd!invariant.LocalInvariant.
     $ TYPE%tuple%0. $ (UINT 8) $ TYPE%test_crate!B.
   ))
   :pattern ((has_type (Poly%vstd!invariant.LocalInvariant<tuple%0./u8./test_crate!B.>.
      x
     ) (TYPE%vstd!invariant.LocalInvariant. $ TYPE%tuple%0. $ (UINT 8) $ TYPE%test_crate!B.)
   ))
   :qid internal_vstd__invariant__LocalInvariant<tuple__0./u8./test_crate!B.>_has_type_always_definition
   :skolemid skolem_internal_vstd__invariant__LocalInvariant<tuple__0./u8./test_crate!B.>_has_type_always_definition
)))
(assert
...
;; Function-Axioms test_crate::B::inv
(assert
...
(assert
 (=>
  ...
  (forall ((k! Poly) (v! Poly)) (!
    (= (vstd!invariant.InvariantPredicate.inv.? $ TYPE%test_crate!B. $ TYPE%tuple%0. $
      (UINT 8) k! v!
     ) (B true)
    )
    :pattern ((vstd!invariant.InvariantPredicate.inv.? $ TYPE%test_crate!B. $ TYPE%tuple%0.
      $ (UINT 8) k! v!
    ))
...
;; Trait-Impl-Axiom
(assert
 (tr_bound%vstd!invariant.InvariantPredicate. $ TYPE%test_crate!B. $ TYPE%tuple%0.
  $ (UINT 8)
))

;; Function-Def test_crate::X::stuff
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/open_invariant-52348288733105e9-opens_invariants_trait_method_impl2/test.rs:28:5: 28:61 (#0)
(get-info :all-statistics)
(push)
 (declare-const i! Poly)
 (declare-const tmp%1 Poly)
 (declare-const tmp%2@0 Int)
 (declare-const inner~47@0 Int)
 (declare-const credit@ vstd!invariant.OpenInvariantCredit.)
 (assert
  fuel_defaults
 )
 (assert
  (has_type i! (TYPE%vstd!invariant.LocalInvariant. $ TYPE%tuple%0. $ (UINT 8) $ TYPE%test_crate!B.))
 )
    ...
    (and
     ...
     (=>
      ...
      (=>
       (= inner~47@0 tmp%2@0)
       (=>
        (vstd!invariant.LocalInvariant.inv.? $ TYPE%tuple%0. $ (UINT 8) $ TYPE%test_crate!B.
         tmp%1 (I inner~47@0)
        )
        (=>
         %%location_label%%1
...
;; Function-Recommends test_crate::X::stuff
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/open_invariant-52348288733105e9-opens_invariants_trait_method_impl2/test.rs:28:5: 28:61 (#0)
(get-info :all-statistics)
(push)
 (declare-const i! Poly)
