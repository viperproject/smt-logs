...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/open_invariant-52348288733105e9-nest_local_loop_local/test.rs:20:9: 24:10 (#0)
...
(push)
 ...
 (declare-const inner~62@0 Int)
 (declare-const tmp%3 Poly)
 (declare-const tmp%4@0 Int)
 (declare-const jnner~108@0 Int)
 ...
 (assert
  (has_type j! (TYPE%vstd!invariant.LocalInvariant. A&. A& $ (UINT 8) B&. B&))
 )
 (assert
  ...
  (not (=>
    ...
    (=>
     ...
     (and
      (=>
       %%location_label%%0
       (not (= (vstd!invariant.LocalInvariant.namespace.? A&. A& $ (UINT 8) B&. B& tmp%3)
         (vstd!invariant.LocalInvariant.namespace.? A&. A& $ (UINT 8) B&. B& tmp%1)
      )))
      (=>
       (uInv 8 tmp%4@0)
       (=>
        (= jnner~108@0 tmp%4@0)
        (=>
         (vstd!invariant.LocalInvariant.inv.? A&. A& $ (UINT 8) B&. B& tmp%3 (I jnner~108@0))
         (and
          (=>
           %%location_label%%1
           (vstd!invariant.LocalInvariant.inv.? A&. A& $ (UINT 8) B&. B& tmp%3 (I jnner~108@0))
...
;; Function-Def test_crate::X
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/open_invariant-52348288733105e9-nest_local_loop_local/test.rs:17:1: 17:136 (#0)
(get-info :all-statistics)
(push)
 (declare-const A&. Dcr)
 (declare-const A& Type)
  ...
  (not (=>
    ...
    (=>
     ...
     (=>
      (= inner~62@0 tmp%2@0)
      (=>
       (vstd!invariant.LocalInvariant.inv.? A&. A& $ (UINT 8) B&. B& tmp%1 (I inner~62@0))
       (=>
        (= idx@0 0)
        (=>
         (uInv 64 idx@1)
