...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/open_invariant-52348288733105e9-inv_typ_invariants/test.rs:21:9: 23:10 (#0)
...
;; Function-Def test_crate::X
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/open_invariant-52348288733105e9-inv_typ_invariants/test.rs:18:1: 18:89 (#0)
(get-info :all-statistics)
(push)
 (declare-const A&. Dcr)
 (declare-const A& Type)
  ...
  (not (=>
    ...
    (=>
     ...
     (=>
      (= inner~47@0 tmp%2@0)
      (=>
       (vstd!invariant.LocalInvariant.inv.? A&. A& $ (UINT 8) B&. B& tmp%1 (I inner~47@0))
       (=>
        (= tmp%3 (<= inner~47@0 255))
        (=>
         %%location_label%%0
         tmp%3
 ))))))))
