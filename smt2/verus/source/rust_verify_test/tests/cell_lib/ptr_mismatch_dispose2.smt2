...
;; Function-Specs vstd::ptr::impl&%10::dispose
(declare-fun req%vstd!ptr.impl&%10.dispose. (Dcr Type vstd!ptr.PPtr. Poly Poly) Bool)
(declare-const %%global_location_label%%0 Bool)
(declare-const %%global_location_label%%1 Bool)
(declare-const %%global_location_label%%2 Bool)
(assert
 (forall ((V&. Dcr) (V& Type) (self! vstd!ptr.PPtr.) (perm! Poly) (dealloc! Poly))
  (!
   (= (req%vstd!ptr.impl&%10.dispose. V&. V& self! perm! dealloc!) (and
     (=>
     ...
     (=>
      ...
      (= (vstd!ptr.PointsToData./PointsToData/pptr (%Poly%vstd!ptr.PointsToData. (Poly%vstd!ptr.PointsToData.
       ...
       ) (vstd!ptr.DeallocData./DeallocData/pptr (%Poly%vstd!ptr.DeallocData. (Poly%vstd!ptr.DeallocData.
          (vstd!ptr.impl&%5.view.? V&. V& dealloc!)
   )))))))
   :pattern ((req%vstd!ptr.impl&%10.dispose. V&. V& self! perm! dealloc!))
   :qid internal_req__vstd!ptr.impl&__10.dispose._definition
   :skolemid skolem_internal_req__vstd!ptr.impl&__10.dispose._definition
)))

;; Function-Def test_crate::f
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/cell_lib-70eb3bfab7b8eeb3-ptr_mismatch_dispose2/test.rs:21:1: 21:11 (#0)
  ...
  (not (=>
    ...
    (=>
     ...
     (=>
      ...
      (=>
       (= verus_tmp_dealloc1@ (%Poly%vstd!ptr.Dealloc<u32.>. (tuple%3./tuple%3/2 (%Poly%tuple%3.
           (Poly%tuple%3. tmp%%@)
       ))))
       (=>
        (= token1@1 verus_tmp_token1@)
        (=>
         (= dealloc1@1 verus_tmp_dealloc1@)
         (=>
          ...
          (=>
           ...
           (=>
            ...
            (=>
             (= verus_tmp_dealloc2@ (%Poly%vstd!ptr.Dealloc<u32.>. (tuple%3./tuple%3/2 (%Poly%tuple%3.
                 (Poly%tuple%3. tmp%%$1@)
             ))))
             (=>
              (= token2@1 verus_tmp_token2@)
              (=>
               (= dealloc2@1 verus_tmp_dealloc2@)
               (=>
                %%location_label%%0
                (req%vstd!ptr.impl&%10.dispose. $ (UINT 32) ptr1@ (Poly%vstd!ptr.PointsTo<u32.>. token1@1)
                 (Poly%vstd!ptr.Dealloc<u32.>. dealloc2@1)
 ))))))))))))))))
 (get-info :version)
