...
;; Function-Specs vstd::ptr::impl&%10::replace
(declare-fun req%vstd!ptr.impl&%10.replace. (Dcr Type vstd!ptr.PPtr. Poly Poly) Bool)
(declare-const %%global_location_label%%2 Bool)
(declare-const %%global_location_label%%3 Bool)
(assert
 (forall ((V&. Dcr) (V& Type) (self! vstd!ptr.PPtr.) (pre%perm! Poly) (in_v! Poly))
  (!
   (= (req%vstd!ptr.impl&%10.replace. V&. V& self! pre%perm! in_v!) (and
     (=>
   ...
   :pattern ((req%vstd!ptr.impl&%10.replace. V&. V& self! pre%perm! in_v!))
   :qid internal_req__vstd!ptr.impl&__10.replace._definition
   :skolemid skolem_internal_req__vstd!ptr.impl&__10.replace._definition
)))
(declare-fun ens%vstd!ptr.impl&%10.replace. (Dcr Type vstd!ptr.PPtr. Poly Poly Poly
  Poly
 ) Bool
)
(assert
 (forall ((V&. Dcr) (V& Type) (self! vstd!ptr.PPtr.) (pre%perm! Poly) (perm! Poly) (
   ...
   (= (ens%vstd!ptr.impl&%10.replace. V&. V& self! pre%perm! perm! in_v! out_v!) (and
     (has_type out_v! V&)
     (has_type perm! (TYPE%vstd!ptr.PointsTo. V&. V&))
     (= (vstd!ptr.PointsToData./PointsToData/pptr (%Poly%vstd!ptr.PointsToData. (Poly%vstd!ptr.PointsToData.
         (vstd!ptr.impl&%2.view.? V&. V& perm!)
   ...
   :pattern ((ens%vstd!ptr.impl&%10.replace. V&. V& self! pre%perm! perm! in_v! out_v!))
   :qid internal_ens__vstd!ptr.impl&__10.replace._definition
   :skolemid skolem_internal_ens__vstd!ptr.impl&__10.replace._definition
)))
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/cell_lib-70eb3bfab7b8eeb3-ptr_mismatch_replace/test.rs:21:1: 21:11 (#0)
...
(push)
 ...
 (declare-const token2@3 vstd!ptr.PointsTo<u32.>.)
                ...
                (=>
                 ...
                 (and
                  ...
                  (=>
                   ...
                   (=>
                    %%location_label%%2
                    (req%vstd!ptr.impl&%10.replace. $ (UINT 32) ptr1@ (Poly%vstd!ptr.PointsTo<u32.>. token2@2)
                     (I 7)
 ))))))))))))))))))))
 (get-info :version)
