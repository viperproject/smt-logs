...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/cell_lib-70eb3bfab7b8eeb3-test_ptr_smoke/test.rs:20:13: 20:22 (#0)
...
(push)
 ...
 (declare-const ptr@ vstd!ptr.PPtr.)
 (declare-const verus_tmp_token@ vstd!ptr.PointsTo<u32.>.)
 (declare-const verus_tmp_dealloc@ vstd!ptr.Dealloc<u32.>.)
 (declare-const token@0 vstd!ptr.PointsTo<u32.>.)
 ...
 (declare-const token@1 vstd!ptr.PointsTo<u32.>.)
 (declare-const dealloc@1 vstd!ptr.Dealloc<u32.>.)
 (declare-const token@2 vstd!ptr.PointsTo<u32.>.)
 (declare-const token@3 vstd!ptr.PointsTo<u32.>.)
 (declare-const token@4 vstd!ptr.PointsTo<u32.>.)
 ;; assertion failed
 ...
 (assert
  (not (=>
    ...
    (=>
     (= ptr@ (%Poly%vstd!ptr.PPtr. (tuple%3./tuple%3/0 (%Poly%tuple%3. (Poly%tuple%3. tmp%%@)))))
     (=>
      (= verus_tmp_token@ (%Poly%vstd!ptr.PointsTo<u32.>. (tuple%3./tuple%3/1 (%Poly%tuple%3.
          (Poly%tuple%3. tmp%%@)
      ))))
      (=>
       ...
       (=>
        ...
        (=>
         ...
         (=>
          (= tmp%1 (= (vstd!ptr.PointsToData./PointsToData/pptr (%Poly%vstd!ptr.PointsToData. (
               Poly%vstd!ptr.PointsToData. (vstd!ptr.impl&%2.view.? $ (UINT 32) (Poly%vstd!ptr.PointsTo<u32.>.
                 token@1
             ))))
            ) (vstd!ptr.impl&%10.id.? $ (UINT 32) (Poly%vstd!ptr.PPtr. ptr@))
          ))
          (and
           (=>
            %%location_label%%0
           ...
           (=>
            ...
            (=>
             (= tmp%2 (ext_eq false (TYPE%core!option.Option. $ (UINT 32)) (Poly%core!option.Option.
                (vstd!ptr.PointsToData./PointsToData/value (%Poly%vstd!ptr.PointsToData. (Poly%vstd!ptr.PointsToData.
                   (vstd!ptr.impl&%2.view.? $ (UINT 32) (Poly%vstd!ptr.PointsTo<u32.>. token@1))
                )))
             ...
             (and
              ...
              (=>
               ...
               (and
                (=>
                 %%location_label%%2
                 (req%vstd!ptr.impl&%10.put. $ (UINT 32) ptr@ (Poly%vstd!ptr.PointsTo<u32.>. token@1)
                  (I 5)
                ))
                (=>
                 (ens%vstd!ptr.impl&%10.put. $ (UINT 32) ptr@ (Poly%vstd!ptr.PointsTo<u32.>. token@1)
                  (Poly%vstd!ptr.PointsTo<u32.>. token@2) (I 5)
                 )
                 (=>
                  (= tmp%3 (= (vstd!ptr.PointsToData./PointsToData/pptr (%Poly%vstd!ptr.PointsToData. (
                       Poly%vstd!ptr.PointsToData. (vstd!ptr.impl&%2.view.? $ (UINT 32) (Poly%vstd!ptr.PointsTo<u32.>.
                         token@2
                     ))))
                    ) (vstd!ptr.impl&%10.id.? $ (UINT 32) (Poly%vstd!ptr.PPtr. ptr@))
                   ...
                   (=>
                    ...
                    (=>
                     (= tmp%4 (ext_eq false (TYPE%core!option.Option. $ (UINT 32)) (Poly%core!option.Option.
                        (vstd!ptr.PointsToData./PointsToData/value (%Poly%vstd!ptr.PointsToData. (Poly%vstd!ptr.PointsToData.
                           (vstd!ptr.impl&%2.view.? $ (UINT 32) (Poly%vstd!ptr.PointsTo<u32.>. token@2))
                        )))
                     ...
                     (and
                      ...
                      (=>
                       ...
                       (and
                        (=>
                         %%location_label%%5
                         (req%vstd!ptr.impl&%10.replace. $ (UINT 32) ptr@ (Poly%vstd!ptr.PointsTo<u32.>. token@2)
                          (I 7)
                        ))
                        (=>
                         (ens%vstd!ptr.impl&%10.replace. $ (UINT 32) ptr@ (Poly%vstd!ptr.PointsTo<u32.>. token@2)
                          (Poly%vstd!ptr.PointsTo<u32.>. token@3) (I 7) tmp%5
                         )
                         (=>
                          (= x@ (%I tmp%5))
                          (=>
                           (= tmp%6 (= (vstd!ptr.PointsToData./PointsToData/pptr (%Poly%vstd!ptr.PointsToData. (
                                Poly%vstd!ptr.PointsToData. (vstd!ptr.impl&%2.view.? $ (UINT 32) (Poly%vstd!ptr.PointsTo<u32.>.
                                  token@3
                              ))))
                             ) (vstd!ptr.impl&%10.id.? $ (UINT 32) (Poly%vstd!ptr.PPtr. ptr@))
                            ...
                            (=>
                             ...
                             (=>
                              (= tmp%7 (ext_eq false (TYPE%core!option.Option. $ (UINT 32)) (Poly%core!option.Option.
                                 (vstd!ptr.PointsToData./PointsToData/value (%Poly%vstd!ptr.PointsToData. (Poly%vstd!ptr.PointsToData.
                                    (vstd!ptr.impl&%2.view.? $ (UINT 32) (Poly%vstd!ptr.PointsTo<u32.>. token@3))
                                 )))
                                 ...
                                 (and
                                  ...
                                  (=>
                                   ...
                                   (and
                                    (=>
                                     %%location_label%%9
                                     (req%vstd!ptr.impl&%10.borrow. $ (UINT 32) ptr@ (Poly%vstd!ptr.PointsTo<u32.>. token@3))
                                    )
                                    (=>
                                     (ens%vstd!ptr.impl&%10.borrow. $ (UINT 32) ptr@ (Poly%vstd!ptr.PointsTo<u32.>. token@3)
                                      tmp%9
                                     )
                                     (=>
                                      (= t@ (%I tmp%9))
                                       ...
                                       (and
                                        ...
                                        (=>
                                         ...
                                         (and
                                          (=>
                                           %%location_label%%11
                                           (req%vstd!ptr.impl&%10.take. $ (UINT 32) ptr@ (Poly%vstd!ptr.PointsTo<u32.>. token@3))
                                          )
                                          (=>
                                           (ens%vstd!ptr.impl&%10.take. $ (UINT 32) ptr@ (Poly%vstd!ptr.PointsTo<u32.>. token@3)
                                            (Poly%vstd!ptr.PointsTo<u32.>. token@4) tmp%11
                                           )
                                           (=>
                                            (= x$1@ (%I tmp%11))
                                            (=>
                                             (= tmp%12 (= (vstd!ptr.PointsToData./PointsToData/pptr (%Poly%vstd!ptr.PointsToData.
                                                 (Poly%vstd!ptr.PointsToData. (vstd!ptr.impl&%2.view.? $ (UINT 32) (Poly%vstd!ptr.PointsTo<u32.>.
                                                    token@4
                                                ))))
                                               ) (vstd!ptr.impl&%10.id.? $ (UINT 32) (Poly%vstd!ptr.PPtr. ptr@))
                                              ...
                                              (=>
                                               ...
                                               (=>
                                                (= tmp%13 (ext_eq false (TYPE%core!option.Option. $ (UINT 32)) (Poly%core!option.Option.
                                                   (vstd!ptr.PointsToData./PointsToData/value (%Poly%vstd!ptr.PointsToData. (Poly%vstd!ptr.PointsToData.
                                                      (vstd!ptr.impl&%2.view.? $ (UINT 32) (Poly%vstd!ptr.PointsTo<u32.>. token@4))
                                                   )))
                                                  ) (Poly%core!option.Option. core!option.Option./None)
                                                ))
                                                (and
                                                   ...
                                                   (and
                                                    ...
                                                    (=>
                                                     ...
                                                     (and
                                                      (=>
                                                       %%location_label%%15
                                                       (req%vstd!ptr.impl&%10.dispose. $ (UINT 32) ptr@ (Poly%vstd!ptr.PointsTo<u32.>. token@4)
