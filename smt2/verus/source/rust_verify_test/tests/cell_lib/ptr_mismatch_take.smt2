...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/cell_lib-70eb3bfab7b8eeb3-ptr_mismatch_take/test.rs:21:1: 21:11 (#0)
                ...
                (=>
                 ...
                 (and
                  ...
                  (=>
                   ...
                   (=>
                    %%location_label%%2
                    (req%vstd!ptr.impl&%10.take. $ (UINT 32) ptr1@ (Poly%vstd!ptr.PointsTo<u32.>. token2@2))
 )))))))))))))))))))
 (get-info :version)
