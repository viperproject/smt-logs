...
;; Function-Specs vstd::ptr::impl&%10::put
(declare-fun req%vstd!ptr.impl&%10.put. (Dcr Type vstd!ptr.PPtr. Poly Poly) Bool)
(declare-const %%global_location_label%%0 Bool)
(declare-const %%global_location_label%%1 Bool)
(assert
 (forall ((V&. Dcr) (V& Type) (self! vstd!ptr.PPtr.) (pre%perm! Poly) (v! Poly)) (!
   (= (req%vstd!ptr.impl&%10.put. V&. V& self! pre%perm! v!) (and
     (=>
   ...
   :pattern ((req%vstd!ptr.impl&%10.put. V&. V& self! pre%perm! v!))
   :qid internal_req__vstd!ptr.impl&__10.put._definition
   :skolemid skolem_internal_req__vstd!ptr.impl&__10.put._definition
)))
(declare-fun ens%vstd!ptr.impl&%10.put. (Dcr Type vstd!ptr.PPtr. Poly Poly Poly) Bool)
(assert
 (forall ((V&. Dcr) (V& Type) (self! vstd!ptr.PPtr.) (pre%perm! Poly) (perm! Poly) (
    v! Poly
   )
  ) (!
   (= (ens%vstd!ptr.impl&%10.put. V&. V& self! pre%perm! perm! v!) (and
   ...
   :pattern ((ens%vstd!ptr.impl&%10.put. V&. V& self! pre%perm! perm! v!))
   :qid internal_ens__vstd!ptr.impl&__10.put._definition
   :skolemid skolem_internal_ens__vstd!ptr.impl&__10.put._definition
)))
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/cell_lib-70eb3bfab7b8eeb3-ptr_mismatch_borrow/test.rs:21:1: 21:11 (#0)
...
(push)
 ...
 (declare-const ptr2@ vstd!ptr.PPtr.)
 (declare-const verus_tmp_token2@ vstd!ptr.PointsTo<u32.>.)
 (declare-const verus_tmp_dealloc$1@ vstd!ptr.Dealloc<u32.>.)
 (declare-const token2@0 vstd!ptr.PointsTo<u32.>.)
 (declare-const dealloc$1@0 vstd!ptr.Dealloc<u32.>.)
 (declare-const x@ Int)
 (assert
  fuel_defaults
 )
 ...
 (declare-const token2@1 vstd!ptr.PointsTo<u32.>.)
 (declare-const dealloc$1@1 vstd!ptr.Dealloc<u32.>.)
 (declare-const token1@2 vstd!ptr.PointsTo<u32.>.)
 (declare-const token2@2 vstd!ptr.PointsTo<u32.>.)
      ...
      (=>
       ...
       (=>
        ...
        (=>
         ...
         (=>
          (ens%vstd!ptr.impl&%10.empty. $ (UINT 32) tmp%%$1@)
          (=>
           (= ptr2@ (%Poly%vstd!ptr.PPtr. (tuple%3./tuple%3/0 (%Poly%tuple%3. (Poly%tuple%3. tmp%%$1@)))))
           (=>
            (= verus_tmp_token2@ (%Poly%vstd!ptr.PointsTo<u32.>. (tuple%3./tuple%3/1 (%Poly%tuple%3.
                (Poly%tuple%3. tmp%%$1@)
            ))))
            (=>
             (= verus_tmp_dealloc$1@ (%Poly%vstd!ptr.Dealloc<u32.>. (tuple%3./tuple%3/2 (%Poly%tuple%3.
                 (Poly%tuple%3. tmp%%$1@)
             ))))
             (=>
              (= token2@1 verus_tmp_token2@)
              (=>
               (= dealloc$1@1 verus_tmp_dealloc$1@)
               (and
                (=>
                 %%location_label%%0
                 (req%vstd!ptr.impl&%10.put. $ (UINT 32) ptr1@ (Poly%vstd!ptr.PointsTo<u32.>. token1@1)
                  (I 5)
                ))
                (=>
                 (ens%vstd!ptr.impl&%10.put. $ (UINT 32) ptr1@ (Poly%vstd!ptr.PointsTo<u32.>. token1@1)
                  (Poly%vstd!ptr.PointsTo<u32.>. token1@2) (I 5)
                 )
                 (and
                  (=>
                   %%location_label%%1
                   (req%vstd!ptr.impl&%10.put. $ (UINT 32) ptr2@ (Poly%vstd!ptr.PointsTo<u32.>. token2@1)
                    (I 5)
                  ))
                  (=>
                   (ens%vstd!ptr.impl&%10.put. $ (UINT 32) ptr2@ (Poly%vstd!ptr.PointsTo<u32.>. token2@1)
                    (Poly%vstd!ptr.PointsTo<u32.>. token2@2) (I 5)
                   )
                   (=>
                    %%location_label%%2
                    (req%vstd!ptr.impl&%10.borrow. $ (UINT 32) ptr1@ (Poly%vstd!ptr.PointsTo<u32.>. token2@2))
 )))))))))))))))))))
 (get-info :version)
