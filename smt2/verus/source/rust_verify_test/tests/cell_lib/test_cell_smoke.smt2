...
;; Function-Specs vstd::cell::impl&%3::borrow
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/cell_lib-70eb3bfab7b8eeb3-test_cell_smoke/test.rs:20:13: 20:22 (#0)
...
(push)
 ...
 (declare-const cell@ vstd!cell.PCell<u32.>.)
 (declare-const verus_tmp_token@ vstd!cell.PointsTo<u32.>.)
 (declare-const token@0 vstd!cell.PointsTo<u32.>.)
 (declare-const x@ Int)
 (declare-const t@ Int)
 ...
 (declare-const token@1 vstd!cell.PointsTo<u32.>.)
 (declare-const token@2 vstd!cell.PointsTo<u32.>.)
 (declare-const token@3 vstd!cell.PointsTo<u32.>.)
 (declare-const token@4 vstd!cell.PointsTo<u32.>.)
 ;; assertion failed
 ...
 (assert
  (not (=>
    ...
    (=>
     (= cell@ (%Poly%vstd!cell.PCell<u32.>. (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2.
          tmp%%@
     )))))
     (=>
      (= verus_tmp_token@ (%Poly%vstd!cell.PointsTo<u32.>. (tuple%2./tuple%2/1 (%Poly%tuple%2.
          (Poly%tuple%2. tmp%%@)
      ))))
      (=>
       (= token@1 verus_tmp_token@)
       (=>
        (= tmp%1 (= (vstd!cell.PointsToData./PointsToData/pcell (%Poly%vstd!cell.PointsToData.
            (Poly%vstd!cell.PointsToData. (vstd!cell.impl&%2.view.? $ (UINT 32) (Poly%vstd!cell.PointsTo<u32.>.
               token@1
           ))))
          ) (vstd!cell.impl&%3.id.? $ (UINT 32) (Poly%vstd!cell.PCell<u32.>. cell@))
        ))
        (and
         (=>
          %%location_label%%0
         ...
         (=>
          tmp%1
          (=>
           (= tmp%2 (ext_eq false (TYPE%core!option.Option. $ (UINT 32)) (Poly%core!option.Option.
              (vstd!cell.PointsToData./PointsToData/value (%Poly%vstd!cell.PointsToData. (Poly%vstd!cell.PointsToData.
                 (vstd!cell.impl&%2.view.? $ (UINT 32) (Poly%vstd!cell.PointsTo<u32.>. token@1))
              )))
           ...
           (and
            ...
            (=>
             ...
             (and
              (=>
               %%location_label%%2
               (req%vstd!cell.impl&%3.put. $ (UINT 32) (Poly%vstd!cell.PCell<u32.>. cell@) (Poly%vstd!cell.PointsTo<u32.>.
                 token@1
                ) (I 5)
              ))
              (=>
               (ens%vstd!cell.impl&%3.put. $ (UINT 32) (Poly%vstd!cell.PCell<u32.>. cell@) (Poly%vstd!cell.PointsTo<u32.>.
                 token@1
                ) (Poly%vstd!cell.PointsTo<u32.>. token@2) (I 5)
               )
               (=>
                (= tmp%3 (= (vstd!cell.PointsToData./PointsToData/pcell (%Poly%vstd!cell.PointsToData.
                    (Poly%vstd!cell.PointsToData. (vstd!cell.impl&%2.view.? $ (UINT 32) (Poly%vstd!cell.PointsTo<u32.>.
                       token@2
                   ))))
                  ) (vstd!cell.impl&%3.id.? $ (UINT 32) (Poly%vstd!cell.PCell<u32.>. cell@))
                ...
                (and
                 ...
                 (=>
                  tmp%3
                  (=>
                   (= tmp%4 (ext_eq false (TYPE%core!option.Option. $ (UINT 32)) (Poly%core!option.Option.
                      (vstd!cell.PointsToData./PointsToData/value (%Poly%vstd!cell.PointsToData. (Poly%vstd!cell.PointsToData.
                         (vstd!cell.impl&%2.view.? $ (UINT 32) (Poly%vstd!cell.PointsTo<u32.>. token@2))
                      )))
                   ...
                   (and
                    ...
                    (=>
                     ...
                     (and
                      (=>
                       %%location_label%%5
                       (req%vstd!cell.impl&%3.replace. $ (UINT 32) (Poly%vstd!cell.PCell<u32.>. cell@) (Poly%vstd!cell.PointsTo<u32.>.
                         token@2
                        ) (I 7)
                      ))
                      (=>
                       (ens%vstd!cell.impl&%3.replace. $ (UINT 32) (Poly%vstd!cell.PCell<u32.>. cell@) (Poly%vstd!cell.PointsTo<u32.>.
                         token@2
                        ) (Poly%vstd!cell.PointsTo<u32.>. token@3) (I 7) tmp%5
                       )
                       (=>
                        (= x@ (%I tmp%5))
                        (=>
                         (= tmp%6 (= (vstd!cell.PointsToData./PointsToData/pcell (%Poly%vstd!cell.PointsToData.
                             (Poly%vstd!cell.PointsToData. (vstd!cell.impl&%2.view.? $ (UINT 32) (Poly%vstd!cell.PointsTo<u32.>.
                                token@3
                            ))))
                           ) (vstd!cell.impl&%3.id.? $ (UINT 32) (Poly%vstd!cell.PCell<u32.>. cell@))
                         ...
                         (and
                          ...
                          (=>
                           tmp%6
                           (=>
                            (= tmp%7 (ext_eq false (TYPE%core!option.Option. $ (UINT 32)) (Poly%core!option.Option.
                               (vstd!cell.PointsToData./PointsToData/value (%Poly%vstd!cell.PointsToData. (Poly%vstd!cell.PointsToData.
                                  (vstd!cell.impl&%2.view.? $ (UINT 32) (Poly%vstd!cell.PointsTo<u32.>. token@3))
                               )))
                              ) (Poly%core!option.Option. (core!option.Option./Some (I 7)))
                            ))
                            (and
                             (=>
                              %%location_label%%7
                               ...
                               (and
                                ...
                                (=>
                                 ...
                                 (and
                                  (=>
                                   %%location_label%%9
                                   (req%vstd!cell.impl&%3.borrow. $ (UINT 32) (Poly%vstd!cell.PCell<u32.>. cell@) (Poly%vstd!cell.PointsTo<u32.>.
                                     token@3
                                  )))
                                  (=>
                                   (ens%vstd!cell.impl&%3.borrow. $ (UINT 32) (Poly%vstd!cell.PCell<u32.>. cell@) (Poly%vstd!cell.PointsTo<u32.>.
                                     token@3
                                    ) tmp%9
                                   )
                                   (=>
                                     ...
                                     (and
                                      ...
                                      (=>
                                       ...
                                       (and
                                        (=>
                                         %%location_label%%11
                                         (req%vstd!cell.impl&%3.take. $ (UINT 32) (Poly%vstd!cell.PCell<u32.>. cell@) (Poly%vstd!cell.PointsTo<u32.>.
                                           token@3
                                        )))
                                        (=>
                                         (ens%vstd!cell.impl&%3.take. $ (UINT 32) (Poly%vstd!cell.PCell<u32.>. cell@) (Poly%vstd!cell.PointsTo<u32.>.
                                           token@3
                                          ) (Poly%vstd!cell.PointsTo<u32.>. token@4) tmp%11
                                         )
                                         (=>
                                          (= x$1@ (%I tmp%11))
                                          (=>
                                           (= tmp%12 (= (vstd!cell.PointsToData./PointsToData/pcell (%Poly%vstd!cell.PointsToData.
                                               (Poly%vstd!cell.PointsToData. (vstd!cell.impl&%2.view.? $ (UINT 32) (Poly%vstd!cell.PointsTo<u32.>.
                                                  token@4
                                              ))))
                                             ) (vstd!cell.impl&%3.id.? $ (UINT 32) (Poly%vstd!cell.PCell<u32.>. cell@))
                                           ...
                                           (and
                                            ...
                                            (=>
                                             tmp%12
                                             (=>
                                              (= tmp%13 (ext_eq false (TYPE%core!option.Option. $ (UINT 32)) (Poly%core!option.Option.
                                                 (vstd!cell.PointsToData./PointsToData/value (%Poly%vstd!cell.PointsToData. (Poly%vstd!cell.PointsToData.
                                                    (vstd!cell.impl&%2.view.? $ (UINT 32) (Poly%vstd!cell.PointsTo<u32.>. token@4))
                                                 )))
                                                ) (Poly%core!option.Option. core!option.Option./None)
                                              ))
                                              (and
