...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/cell_lib-70eb3bfab7b8eeb3-cell_some_put/test.rs:21:1: 21:11 (#0)
...
(push)
 ...
 (declare-const token1@3 vstd!cell.PointsTo<u32.>.)
       ...
       (and
        ...
        (=>
         (ens%vstd!cell.impl&%3.put. $ (UINT 32) (Poly%vstd!cell.PCell<u32.>. cell1@) (Poly%vstd!cell.PointsTo<u32.>.
           token1@1
          ) (Poly%vstd!cell.PointsTo<u32.>. token1@2) (I 7)
         )
         (=>
          %%location_label%%1
          (req%vstd!cell.impl&%3.put. $ (UINT 32) (Poly%vstd!cell.PCell<u32.>. cell1@) (Poly%vstd!cell.PointsTo<u32.>.
