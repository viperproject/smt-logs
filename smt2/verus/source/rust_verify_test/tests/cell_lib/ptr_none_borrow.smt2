...
;; Function-Specs vstd::ptr::impl&%10::borrow
(declare-fun req%vstd!ptr.impl&%10.borrow. (Dcr Type vstd!ptr.PPtr. Poly) Bool)
(declare-const %%global_location_label%%0 Bool)
(declare-const %%global_location_label%%1 Bool)
(assert
 (forall ((V&. Dcr) (V& Type) (self! vstd!ptr.PPtr.) (perm! Poly)) (!
   (= (req%vstd!ptr.impl&%10.borrow. V&. V& self! perm!) (and
     (=>
     ...
     (=>
      ...
      (is-core!option.Option./Some (vstd!ptr.PointsToData./PointsToData/value (%Poly%vstd!ptr.PointsToData.
         (Poly%vstd!ptr.PointsToData. (vstd!ptr.impl&%2.view.? V&. V& perm!))
   ))))))
   :pattern ((req%vstd!ptr.impl&%10.borrow. V&. V& self! perm!))
   :qid internal_req__vstd!ptr.impl&__10.borrow._definition
   :skolemid skolem_internal_req__vstd!ptr.impl&__10.borrow._definition
)))
(declare-fun ens%vstd!ptr.impl&%10.borrow. (Dcr Type vstd!ptr.PPtr. Poly Poly) Bool)
(assert
 (forall ((V&. Dcr) (V& Type) (self! vstd!ptr.PPtr.) (perm! Poly) (v! Poly)) (!
   (= (ens%vstd!ptr.impl&%10.borrow. V&. V& self! perm! v!) (and
     (has_type v! V&)
   ...
   :pattern ((ens%vstd!ptr.impl&%10.borrow. V&. V& self! perm! v!))
   :qid internal_ens__vstd!ptr.impl&__10.borrow._definition
   :skolemid skolem_internal_ens__vstd!ptr.impl&__10.borrow._definition
)))
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/cell_lib-70eb3bfab7b8eeb3-ptr_none_borrow/test.rs:21:1: 21:11 (#0)
      ...
      (=>
       ...
       (=>
        ...
        (=>
         ...
         (=>
          %%location_label%%0
          (req%vstd!ptr.impl&%10.borrow. $ (UINT 32) ptr1@ (Poly%vstd!ptr.PointsTo<u32.>. token1@1))
 )))))))))
 (get-info :version)
