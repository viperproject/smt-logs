...
(declare-datatypes ((core!option.Option. 0) (vstd!cell.PointsToData. 0) (tuple%0. 0)
  (tuple%2. 0)
...
(assert
 (forall ((x vstd!cell.PCell<u32.>.)) (!
   (= x (%Poly%vstd!cell.PCell<u32.>. (Poly%vstd!cell.PCell<u32.>. x)))
   :pattern ((Poly%vstd!cell.PCell<u32.>. x))
   :qid internal_vstd__cell__PCell<u32.>_box_axiom_definition
   :skolemid skolem_internal_vstd__cell__PCell<u32.>_box_axiom_definition
)))
(assert
 (forall ((x Poly)) (!
   (=>
    (has_type x (TYPE%vstd!cell.PCell. $ (UINT 32)))
    (= x (Poly%vstd!cell.PCell<u32.>. (%Poly%vstd!cell.PCell<u32.>. x)))
   )
   :pattern ((has_type x (TYPE%vstd!cell.PCell. $ (UINT 32))))
   :qid internal_vstd__cell__PCell<u32.>_unbox_axiom_definition
   :skolemid skolem_internal_vstd__cell__PCell<u32.>_unbox_axiom_definition
)))
(assert
 (forall ((x vstd!cell.PCell<u32.>.)) (!
   (has_type (Poly%vstd!cell.PCell<u32.>. x) (TYPE%vstd!cell.PCell. $ (UINT 32)))
   :pattern ((has_type (Poly%vstd!cell.PCell<u32.>. x) (TYPE%vstd!cell.PCell. $ (UINT 32))))
   :qid internal_vstd__cell__PCell<u32.>_has_type_always_definition
   :skolemid skolem_internal_vstd__cell__PCell<u32.>_has_type_always_definition
)))
(assert
 (forall ((x vstd!cell.PointsTo<u32.>.)) (!
   (= x (%Poly%vstd!cell.PointsTo<u32.>. (Poly%vstd!cell.PointsTo<u32.>. x)))
   :pattern ((Poly%vstd!cell.PointsTo<u32.>. x))
   :qid internal_vstd__cell__PointsTo<u32.>_box_axiom_definition
   :skolemid skolem_internal_vstd__cell__PointsTo<u32.>_box_axiom_definition
)))
(assert
 (forall ((x Poly)) (!
   (=>
    (has_type x (TYPE%vstd!cell.PointsTo. $ (UINT 32)))
    (= x (Poly%vstd!cell.PointsTo<u32.>. (%Poly%vstd!cell.PointsTo<u32.>. x)))
   )
   :pattern ((has_type x (TYPE%vstd!cell.PointsTo. $ (UINT 32))))
   :qid internal_vstd__cell__PointsTo<u32.>_unbox_axiom_definition
   :skolemid skolem_internal_vstd__cell__PointsTo<u32.>_unbox_axiom_definition
)))
(assert
 (forall ((x vstd!cell.PointsTo<u32.>.)) (!
   (has_type (Poly%vstd!cell.PointsTo<u32.>. x) (TYPE%vstd!cell.PointsTo. $ (UINT 32)))
   :pattern ((has_type (Poly%vstd!cell.PointsTo<u32.>. x) (TYPE%vstd!cell.PointsTo. $ (
       UINT 32
   ))))
   :qid internal_vstd__cell__PointsTo<u32.>_has_type_always_definition
   :skolemid skolem_internal_vstd__cell__PointsTo<u32.>_has_type_always_definition
)))
(assert
...
(assert
 (forall ((x vstd!cell.PointsToData.)) (!
   ...
   :qid internal_vstd__cell__PointsToData_box_axiom_definition
   :skolemid skolem_internal_vstd__cell__PointsToData_box_axiom_definition
)))
(assert
 (forall ((V&. Dcr) (V& Type) (x Poly)) (!
   (=>
   ...
   :qid internal_vstd__cell__PointsToData_unbox_axiom_definition
   :skolemid skolem_internal_vstd__cell__PointsToData_unbox_axiom_definition
)))
(assert
...
;; Function-Axioms vstd::cell::impl&%2::view
(assert
...
;; Function-Specs vstd::cell::impl&%3::empty
...
;; Function-Specs vstd::cell::impl&%3::put
...
;; Function-Specs vstd::cell::impl&%3::take
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/cell_lib-70eb3bfab7b8eeb3-cell_mismatch_take/test.rs:21:1: 21:11 (#0)
(get-info :all-statistics)
(push)
 (declare-const no%param Int)
 (declare-const tmp%1 Poly)
 (declare-const tmp%%@ tuple%2.)
 (declare-const cell1@ vstd!cell.PCell<u32.>.)
 (declare-const verus_tmp_token1@ vstd!cell.PointsTo<u32.>.)
 (declare-const token1@0 vstd!cell.PointsTo<u32.>.)
 (declare-const tmp%%$1@ tuple%2.)
 (declare-const cell2@ vstd!cell.PCell<u32.>.)
 (declare-const verus_tmp_token2@ vstd!cell.PointsTo<u32.>.)
 (declare-const token2@0 vstd!cell.PointsTo<u32.>.)
 (declare-const x@ Int)
 (assert
  fuel_defaults
 )
 (declare-const token1@1 vstd!cell.PointsTo<u32.>.)
 (declare-const token2@1 vstd!cell.PointsTo<u32.>.)
 (declare-const token1@2 vstd!cell.PointsTo<u32.>.)
 (declare-const token2@2 vstd!cell.PointsTo<u32.>.)
 (declare-const token2@3 vstd!cell.PointsTo<u32.>.)
 ...
 (assert
  (not (=>
    (ens%vstd!cell.impl&%3.empty. $ (UINT 32) tmp%%@)
    (=>
     (= cell1@ (%Poly%vstd!cell.PCell<u32.>. (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2.
          tmp%%@
     )))))
     (=>
      (= verus_tmp_token1@ (%Poly%vstd!cell.PointsTo<u32.>. (tuple%2./tuple%2/1 (%Poly%tuple%2.
          (Poly%tuple%2. tmp%%@)
      ))))
      (=>
       (= token1@1 verus_tmp_token1@)
       (=>
        (ens%vstd!cell.impl&%3.empty. $ (UINT 32) tmp%%$1@)
        (=>
         (= cell2@ (%Poly%vstd!cell.PCell<u32.>. (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2.
              tmp%%$1@
         )))))
         (=>
          (= verus_tmp_token2@ (%Poly%vstd!cell.PointsTo<u32.>. (tuple%2./tuple%2/1 (%Poly%tuple%2.
              (Poly%tuple%2. tmp%%$1@)
          ))))
          (=>
           (= token2@1 verus_tmp_token2@)
           (and
            (=>
             %%location_label%%0
             (req%vstd!cell.impl&%3.put. $ (UINT 32) (Poly%vstd!cell.PCell<u32.>. cell1@) (Poly%vstd!cell.PointsTo<u32.>.
               token1@1
              ) (I 5)
            ))
            (=>
             (ens%vstd!cell.impl&%3.put. $ (UINT 32) (Poly%vstd!cell.PCell<u32.>. cell1@) (Poly%vstd!cell.PointsTo<u32.>.
               token1@1
              ) (Poly%vstd!cell.PointsTo<u32.>. token1@2) (I 5)
             )
             (and
              (=>
               %%location_label%%1
               (req%vstd!cell.impl&%3.put. $ (UINT 32) (Poly%vstd!cell.PCell<u32.>. cell2@) (Poly%vstd!cell.PointsTo<u32.>.
                 token2@1
                ) (I 5)
              ))
              (=>
               (ens%vstd!cell.impl&%3.put. $ (UINT 32) (Poly%vstd!cell.PCell<u32.>. cell2@) (Poly%vstd!cell.PointsTo<u32.>.
                 token2@1
                ) (Poly%vstd!cell.PointsTo<u32.>. token2@2) (I 5)
               )
               (=>
                %%location_label%%2
                (req%vstd!cell.impl&%3.take. $ (UINT 32) (Poly%vstd!cell.PCell<u32.>. cell1@) (Poly%vstd!cell.PointsTo<u32.>.
                  token2@2
 )))))))))))))))))
 (get-info :version)
