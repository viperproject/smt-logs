...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/cell_lib-70eb3bfab7b8eeb3-ptr_none_replace/test.rs:21:1: 21:11 (#0)
      ...
      (=>
       ...
       (=>
        ...
        (=>
         ...
         (=>
          %%location_label%%0
          (req%vstd!ptr.impl&%10.replace. $ (UINT 32) ptr1@ (Poly%vstd!ptr.PointsTo<u32.>. token1@1)
           (I 7)
 ))))))))))
 (get-info :version)
