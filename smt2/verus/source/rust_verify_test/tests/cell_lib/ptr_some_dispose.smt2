...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/cell_lib-70eb3bfab7b8eeb3-ptr_some_dispose/test.rs:21:1: 21:11 (#0)
        ...
        (=>
         ...
         (and
          ...
          (=>
           ...
           (=>
            %%location_label%%1
            (req%vstd!ptr.impl&%10.dispose. $ (UINT 32) ptr1@ (Poly%vstd!ptr.PointsTo<u32.>. token1@2)
             (Poly%vstd!ptr.Dealloc<u32.>. dealloc@1)
 ))))))))))))
 (get-info :version)
