...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/cell_lib-70eb3bfab7b8eeb3-ptr_mismatch_dispose/test.rs:21:1: 21:11 (#0)
            ...
            (=>
             ...
             (=>
              ...
              (=>
               ...
               (=>
                %%location_label%%0
                (req%vstd!ptr.impl&%10.dispose. $ (UINT 32) ptr1@ (Poly%vstd!ptr.PointsTo<u32.>. token2@1)
                 (Poly%vstd!ptr.Dealloc<u32.>. dealloc1@1)
 ))))))))))))))))
 (get-info :version)
