...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/literals-f9484e6d58c42f8e-set_literal_1/test.rs:18:7: 18:14 (#0)
...
(push)
 ...
 (assert
  (not (=>
    (= s1@ (%Poly%vstd!set.Set<int.>. (vstd!set.impl&%0.insert.? $ INT (vstd!set.impl&%0.empty.?
        $ INT
       ) (I 2)
    )))
    (=>
     (= s2@ (%Poly%vstd!set.Set<int.>. (vstd!set.impl&%0.insert.? $ INT (vstd!set.impl&%0.empty.?
         $ INT
        ) (I 2)
     )))
     (=>
