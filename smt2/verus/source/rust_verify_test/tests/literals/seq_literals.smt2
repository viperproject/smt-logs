...
;; Function-Def test_crate::sl
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/literals-f9484e6d58c42f8e-seq_literals/test.rs:18:7: 18:14 (#0)
...
(push)
 ...
 (assert
  (not (=>
    (= s1@ (%Poly%vstd!seq.Seq<int.>. (vstd!view.View.view.? $ (ARRAY $ INT $ (CONST_INT 5))
       (array_new $ INT 5 (%%array%%0 (I 2) (I 4) (I 6) (I 8) (I 10)))
    )))
    (=>
     (= tmp%1 (= (%I (vstd!seq.Seq.index.? $ INT (Poly%vstd!seq.Seq<int.>. s1@) (I 2)))
       6
     ))
     (=>
      %%location_label%%0
...
;; Function-Def test_crate::comma_at_end
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/literals-f9484e6d58c42f8e-seq_literals/test.rs:24:7: 24:24 (#0)
(get-info :all-statistics)
(push)
 (declare-const no%param Int)
 (declare-const tmp%1 Bool)
 ...
 (assert
  (not (=>
    (= s1@ (%Poly%vstd!seq.Seq<int.>. (vstd!view.View.view.? $ (ARRAY $ INT $ (CONST_INT 5))
       (array_new $ INT 5 (%%array%%1 (I 2) (I 4) (I 6) (I 8) (I 10)))
    )))
    (=>
     (= tmp%1 (= (%I (vstd!seq.Seq.index.? $ INT (Poly%vstd!seq.Seq<int.>. s1@) (I 2)))
       6
