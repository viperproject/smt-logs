...
(assert
 (distinct fuel%vstd!set.axiom_set_empty. fuel%vstd!set.axiom_set_ext_equal. fuel%vstd!set.axiom_set_ext_equal_deep.
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/literals-f9484e6d58c42f8e-set_literal_0/test.rs:18:7: 18:14 (#0)
...
(push)
 ...
 (assert
  (not (=>
    (= s1@ (%Poly%vstd!set.Set<int.>. (vstd!set.impl&%0.empty.? $ INT)))
    (=>
     (= s2@ (%Poly%vstd!set.Set<int.>. (vstd!set.impl&%0.empty.? $ INT)))
     (=>
