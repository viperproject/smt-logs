...
;; MODULE 'root module'
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/atomic_lib-86af995cc9979138-test_atomic_u32_pass/test.rs:95:1: 95:7 (#0)
...
(assert
 (not (=>
   %%location_label%%0
   (= (bvnot ((_ zero_extend 29) (bvand (_ bv6 3) ((_ zero_extend 1) (_ bv3 2))))) (_
     bv4294967293 32
)))))
(get-info :version)
