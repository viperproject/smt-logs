...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/atomic_lib-86af995cc9979138-test_signed_sub_underflow_fail/test.rs:19:1: 19:20 (#0)
...
(push)
 ...
 (assert
  (not (and
    ...
    (=>
     (= tmp%1 (Sub 0 1879048192))
     (=>
      (ens%vstd!atomic.impl&%17.new. tmp%1 tmp%%@)
      (=>
       ...
       (=>
        ...
        (=>
         ...
         (=>
          %%location_label%%1
          (req%vstd!atomic.impl&%17.fetch_sub. at@ perm@1 1879048192)
 )))))))))
 (get-info :version)
