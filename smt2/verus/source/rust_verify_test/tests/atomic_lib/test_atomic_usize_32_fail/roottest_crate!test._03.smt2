...
;; MODULE 'root module'
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/atomic_lib-86af995cc9979138-test_atomic_usize_32_fail/test.rs:54:1: 54:7 (#0)
...
(assert
 (not (=>
   %%location_label%%0
   (= (bvxor (_ bv2 2) (_ bv3 2)) ((_ zero_extend 1) (_ bv1 1)))
)))
(get-info :version)
