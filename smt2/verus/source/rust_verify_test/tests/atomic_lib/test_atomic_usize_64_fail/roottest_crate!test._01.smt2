...
;; MODULE 'root module'
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/atomic_lib-86af995cc9979138-test_atomic_usize_64_fail/test.rs:44:1: 44:7 (#0)
...
(assert
 (not (=>
   %%location_label%%0
   (= (bvor (_ bv9 4) ((_ zero_extend 2) (_ bv2 2))) (_ bv11 4))
)))
(get-info :version)
