...
;; Function-Specs vstd::atomic::impl&%7::fetch_add
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/atomic_lib-86af995cc9979138-test_unsigned_add_overflow_fail/test.rs:19:1: 19:20 (#0)
...
(push)
 ...
 (assert
  (not (=>
    (ens%vstd!atomic.impl&%7.new. 4026531840 tmp%%@)
    (=>
     ...
     (=>
      ...
      (=>
       ...
       (=>
        %%location_label%%0
        (req%vstd!atomic.impl&%7.fetch_add. at@ perm@1 4026531840)
 )))))))
 (get-info :version)
