...
;; Function-Specs vstd::atomic::impl&%17::fetch_add
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/atomic_lib-86af995cc9979138-test_signed_add_underflow_fail/test.rs:19:1: 19:20 (#0)
       ...
       (=>
        ...
        (=>
         ...
         (and
          ...
          (=>
           (= tmp%3 (Sub 0 1879048192))
           (=>
            %%location_label%%2
            (req%vstd!atomic.impl&%17.fetch_add. at@ perm@1 tmp%3)
 )))))))))))
 (get-info :version)
