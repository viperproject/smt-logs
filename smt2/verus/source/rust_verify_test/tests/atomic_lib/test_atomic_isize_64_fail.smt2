...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/atomic_lib-86af995cc9979138-test_atomic_isize_64_fail/test.rs:20:5: 20:14 (#0)
                          ...
                          (and
                           ...
                           (=>
                            ...
                            (and
                             (=>
                              %%location_label%%8
                              (req%vstd!atomic.impl&%21.fetch_add_wrapping. at@ perm@3 9223372036854775807)
                             )
                             (=>
                              (ens%vstd!atomic.impl&%21.fetch_add_wrapping. at@ perm@3 perm@4 9223372036854775807
                               l$2@
                              )
                              (=>
                               (= tmp%6 (= l$2@ 9))
                                ...
                                (=>
                                 ...
                                 (=>
                                  (= tmp%7 (= (vstd!atomic.PermissionDataIsize./PermissionDataIsize/value (%Poly%vstd!atomic.PermissionDataIsize.
                                    ...
                                    ) (Sub 0 (iClip SZ 9223372036854775800))
                                  ))
                                  (and
                                   (=>
                                    %%location_label%%10
                                   ...
                                   (=>
                                    ...
                                    (and
                                     (=>
                                      %%location_label%%11
                                      (req%vstd!atomic.impl&%21.fetch_sub_wrapping. at@ perm@4 9223372036854775807)
                                     )
                                     (=>
                                      (ens%vstd!atomic.impl&%21.fetch_sub_wrapping. at@ perm@4 perm@5 9223372036854775807
                                       l$3@
                                      )
                                      (=>
                                       (= tmp%8 (= l$3@ (Sub 0 (iClip SZ 9223372036854775800))))
                                       (and
                                        (=>
                                         %%location_label%%12
                                         tmp%8
                                          ...
                                          (and
                                           ...
                                           (=>
                                            ...
                                            (and
                                             (=>
                                              %%location_label%%14
                                              (iInv SZ (Sub 0 9223372036854775807))
                                             )
                                             (=>
                                                       ...
                                                       (=>
                                                        ...
                                                        (and
                                                         ...
                                                         (=>
                                                          ...
                                                          (=>
                                                           (= tmp%14 (= l$5@ (Sub 0 (iClip SZ 9223372036854775800))))
                                                           (and
                                                            (=>
                                                             %%location_label%%20
                                                             tmp%14
                  ...
                  (=>
                   ...
                   (=>
                    ...
                    (and
                     ...
                     (=>
                      (= l$3@ (Sub 0 (iClip SZ 9223372036854775800)))
                      (=>
                       (= (vstd!atomic.PermissionDataIsize./PermissionDataIsize/value (%Poly%vstd!atomic.PermissionDataIsize.
                          (Poly%vstd!atomic.PermissionDataIsize. (vstd!atomic.impl&%20.view.? (Poly%vstd!atomic.PermissionIsize.
                             perm@5
                       ...
                       (=>
                        (= tmp%1 (Sub 0 9223372036854775807))
                        (=>
                         (ens%vstd!atomic.impl&%21.fetch_sub_wrapping. at@ perm@5 perm@6 tmp%1 l$4@)
                         (=>
                          (= l$4@ 9)
                          (and
                           (=>
                           ...
                           (=>
                            ...
                            (=>
                             (= tmp%2 (Sub 0 9223372036854775807))
                             (=>
                              (ens%vstd!atomic.impl&%21.fetch_add_wrapping. at@ perm@6 perm@7 tmp%2 l$5@)
                              (=>
                               %%location_label%%3
                               (iInv SZ 9223372036854775800)
 ))))))))))))))))))))))))))))))
