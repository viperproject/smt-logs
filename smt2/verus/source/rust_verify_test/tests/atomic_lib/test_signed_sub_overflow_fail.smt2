...
(declare-datatypes ((vstd!atomic.PermissionDataI32. 0) (tuple%0. 0) (tuple%2. 0))
...
(assert
 (forall ((x vstd!atomic.PAtomicI32.)) (!
   ...
   :qid internal_vstd__atomic__PAtomicI32_box_axiom_definition
   :skolemid skolem_internal_vstd__atomic__PAtomicI32_box_axiom_definition
)))
(assert
 (forall ((x Poly)) (!
   (=>
   ...
   :qid internal_vstd__atomic__PAtomicI32_unbox_axiom_definition
   :skolemid skolem_internal_vstd__atomic__PAtomicI32_unbox_axiom_definition
)))
(assert
 (forall ((x vstd!atomic.PAtomicI32.)) (!
   ...
   :qid internal_vstd__atomic__PAtomicI32_has_type_always_definition
   :skolemid skolem_internal_vstd__atomic__PAtomicI32_has_type_always_definition
)))
(assert
 (forall ((x vstd!atomic.PermissionI32.)) (!
   ...
   :qid internal_vstd__atomic__PermissionI32_box_axiom_definition
   :skolemid skolem_internal_vstd__atomic__PermissionI32_box_axiom_definition
)))
(assert
 (forall ((x Poly)) (!
   (=>
   ...
   :qid internal_vstd__atomic__PermissionI32_unbox_axiom_definition
   :skolemid skolem_internal_vstd__atomic__PermissionI32_unbox_axiom_definition
)))
(assert
 (forall ((x vstd!atomic.PermissionI32.)) (!
   ...
   :qid internal_vstd__atomic__PermissionI32_has_type_always_definition
   :skolemid skolem_internal_vstd__atomic__PermissionI32_has_type_always_definition
)))
(assert
 (forall ((x vstd!atomic.PermissionDataI32.)) (!
   ...
   :qid internal_vstd__atomic__PermissionDataI32_box_axiom_definition
   :skolemid skolem_internal_vstd__atomic__PermissionDataI32_box_axiom_definition
)))
(assert
 (forall ((x Poly)) (!
   (=>
   ...
   :qid internal_vstd__atomic__PermissionDataI32_unbox_axiom_definition
   :skolemid skolem_internal_vstd__atomic__PermissionDataI32_unbox_axiom_definition
)))
(assert
...
;; Function-Decl vstd::atomic::impl&%16::view
(declare-fun vstd!atomic.impl&%16.view.? (Poly) vstd!atomic.PermissionDataI32.)

;; Function-Decl vstd::atomic::impl&%17::id
(declare-fun vstd!atomic.impl&%17.id.? (Poly) Int)

;; Function-Axioms vstd::atomic::impl&%16::view
(assert
 (forall ((self! Poly)) (!
   (=>
...
;; Function-Specs vstd::atomic::impl&%17::new
...
;; Function-Specs vstd::atomic::impl&%17::fetch_sub
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/atomic_lib-86af995cc9979138-test_signed_sub_overflow_fail/test.rs:19:1: 19:20 (#0)
...
(push)
 ...
 (declare-const at@ vstd!atomic.PAtomicI32.)
 ...
 (declare-const perm@2 vstd!atomic.PermissionI32.)
 ...
 (assert
  (not (=>
    (ens%vstd!atomic.impl&%17.new. 1879048192 tmp%%@)
    (=>
     (= at@ (%Poly%vstd!atomic.PAtomicI32. (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2.
          tmp%%@
     )))))
     (=>
      ...
      (=>
       ...
       (and
        (=>
         %%location_label%%0
         (iInv 32 (Sub 0 1879048192))
        )
        (=>
         (= tmp%2 (Sub 0 1879048192))
         (=>
          %%location_label%%1
          (req%vstd!atomic.impl&%17.fetch_sub. at@ perm@1 tmp%2)
 )))))))))
 (get-info :version)
