...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/atomic_lib-86af995cc9979138-test_signed_add_overflow_fail/test.rs:19:1: 19:20 (#0)
    ...
    (=>
     ...
     (=>
      ...
      (=>
       ...
       (=>
        %%location_label%%0
        (req%vstd!atomic.impl&%17.fetch_add. at@ perm@1 1879048192)
 )))))))
 (get-info :version)
