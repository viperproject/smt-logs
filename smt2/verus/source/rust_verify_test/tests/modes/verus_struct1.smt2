...
;; Datatypes
(declare-datatypes ((test_crate!S. 0) (tuple%0. 0)) (((test_crate!S./S (test_crate!S./S/?i
     Bool
    ) (test_crate!S./S/?j Bool)
   )
  ) ((tuple%0./tuple%0))
))
(declare-fun test_crate!S./S/i (test_crate!S.) Bool)
(declare-fun test_crate!S./S/j (test_crate!S.) Bool)
...
(assert
 (forall ((x test_crate!S.)) (!
   (= (test_crate!S./S/i x) (test_crate!S./S/?i x))
   :pattern ((test_crate!S./S/i x))
   :qid internal_test_crate!S./S/i_accessor_definition
   :skolemid skolem_internal_test_crate!S./S/i_accessor_definition
)))
(assert
 (forall ((x test_crate!S.)) (!
   (= (test_crate!S./S/j x) (test_crate!S./S/?j x))
   :pattern ((test_crate!S./S/j x))
   :qid internal_test_crate!S./S/j_accessor_definition
   :skolemid skolem_internal_test_crate!S./S/j_accessor_definition
)))
(assert
 (forall ((x test_crate!S.)) (!
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/modes-fd368d59d05662dd-verus_struct1/test.rs:20:1: 20:27 (#0)
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/modes-fd368d59d05662dd-verus_struct1/test.rs:23:1: 23:34 (#0)
(get-info :all-statistics)
(push)
 (declare-const i! Bool)
 (declare-const j! Bool)
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/modes-fd368d59d05662dd-verus_struct1/test.rs:26:1: 26:34 (#0)
(get-info :all-statistics)
(push)
 (declare-const i! Bool)
 (declare-const j! Bool)
 (declare-const s@ test_crate!S.)
 (declare-const jj@ Bool)
 (assert
  fuel_defaults
 )
 (assert
