...
;; Datatypes
(declare-datatypes ((tuple%0. 0) (tuple%3. 0)) (((tuple%0./tuple%0)) ((tuple%3./tuple%3
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/match-4460c9f52e99806e-test5/test.rs:15:1: 15:29 (#0)
(get-info :all-statistics)
(push)
 (declare-const A&. Dcr)
 (declare-const A& Type)
 (declare-const t! tuple%3.)
 ...
 (assert
  (has_type (Poly%tuple%3. t!) (TYPE%tuple%3. $ BOOL $ (UINT 8) A&. A&))
 )
 ;; assertion failed
 ...
 (assert
  (not (=>
    (= x@ (%B (tuple%3./tuple%3/0 (%Poly%tuple%3. (Poly%tuple%3. t!)))))
    (=>
     (= y@ (%I (tuple%3./tuple%3/1 (%Poly%tuple%3. (Poly%tuple%3. t!)))))
     (=>
      (= z@ (tuple%3./tuple%3/2 (%Poly%tuple%3. (Poly%tuple%3. t!))))
      (=>
       (= tmp%1 (ext_eq false (TYPE%tuple%3. $ BOOL $ (UINT 8) A&. A&) (Poly%tuple%3. (tuple%3./tuple%3
           (B x@) (I y@) z@
          )
         ) (Poly%tuple%3. t!)
       ))
       (and
        ...
        (=>
         tmp%1
         (=>
          (= tmp%2 (= x@ (%B (tuple%3./tuple%3/0 (%Poly%tuple%3. (Poly%tuple%3. t!))))))
          (and
           (=>
            %%location_label%%1
            tmp%2
           ...
           (=>
            tmp%2
            (=>
             (= tmp%3 (= y@ (%I (tuple%3./tuple%3/1 (%Poly%tuple%3. (Poly%tuple%3. t!))))))
             (and
              (=>
               %%location_label%%2
               tmp%3
              ...
              (=>
               tmp%3
               (=>
                (= tmp%4 (= z@ (tuple%3./tuple%3/2 (%Poly%tuple%3. (Poly%tuple%3. t!)))))
                (=>
                 %%location_label%%3
                 tmp%4
 ))))))))))))))))
