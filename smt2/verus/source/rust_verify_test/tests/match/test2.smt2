...
(declare-const fuel%impl&%0.arrow_Cons_0. FuelId)
(declare-const fuel%impl&%0.arrow_Cons_1. FuelId)
(declare-const fuel%len. FuelId)
(assert
 (distinct fuel%impl&%0.arrow_0. fuel%impl&%0.arrow_1. fuel%impl&%0.arrow_Cons_0. fuel%impl&%0.arrow_Cons_1.
  fuel%len.
))

;; Datatypes
(declare-sort allocator_global%. 0)
(declare-datatypes ((List. 0) (tuple%0. 0)) (((List./Nil) (List./Cons (List./Cons/?0 Poly)
    (List./Cons/?1 List.)
   )
  ) ((tuple%0./tuple%0))
))
(declare-fun List./Cons/0 (List.) Poly)
(declare-fun List./Cons/1 (List.) List.)
...
(assert
 (forall ((A&. Dcr) (A& Type) (_0! Poly) (_1! List.)) (!
   (=>
    (and
     (has_type _0! A&)
     (has_type (Poly%List. _1!) (TYPE%List. A&. A&))
    )
    (has_type (Poly%List. (List./Cons _0! _1!)) (TYPE%List. A&. A&))
   )
   :pattern ((has_type (Poly%List. (List./Cons _0! _1!)) (TYPE%List. A&. A&)))
...
(assert
 (forall ((A&. Dcr) (A& Type) (x Poly)) (!
   (=>
    (has_type x (TYPE%List. A&. A&))
    (has_type (List./Cons/0 (%Poly%List. x)) A&)
   )
   :pattern ((List./Cons/0 (%Poly%List. x)) (has_type x (TYPE%List. A&. A&)))
   :qid internal_List./Cons/0_invariant_definition
   :skolemid skolem_internal_List./Cons/0_invariant_definition
)))
(assert
 (forall ((x List.)) (!
   (= (List./Cons/1 x) (List./Cons/?1 x))
   :pattern ((List./Cons/1 x))
   :qid internal_List./Cons/1_accessor_definition
   :skolemid skolem_internal_List./Cons/1_accessor_definition
)))
(assert
 (forall ((A&. Dcr) (A& Type) (x Poly)) (!
   (=>
    (has_type x (TYPE%List. A&. A&))
    (has_type (Poly%List. (List./Cons/1 (%Poly%List. x))) (TYPE%List. A&. A&))
   )
   :pattern ((List./Cons/1 (%Poly%List. x)) (has_type x (TYPE%List. A&. A&)))
   :qid internal_List./Cons/1_invariant_definition
   :skolemid skolem_internal_List./Cons/1_invariant_definition
)))
(assert
 (forall ((x List.)) (!
   (=>
    (is-List./Cons x)
    (height_lt (height (List./Cons/0 x)) (height (Poly%List. x)))
   )
   :pattern ((height (List./Cons/0 x)))
...
(assert
 (forall ((x List.)) (!
   (=>
    (is-List./Cons x)
    (height_lt (height (Poly%List. (List./Cons/1 x))) (height (Poly%List. x)))
   )
   :pattern ((height (Poly%List. (List./Cons/1 x))))
   :qid prelude_datatype_height_List./Cons/1
   :skolemid skolem_prelude_datatype_height_List./Cons/1
)))
(assert
 (forall ((x tuple%0.)) (!
...
;; Function-Decl crate::List::arrow_1
(declare-fun impl&%0.arrow_1.? (Dcr Type Poly) List.)

;; Function-Decl crate::List::arrow_Cons_0
(declare-fun impl&%0.arrow_Cons_0.? (Dcr Type Poly) Poly)

;; Function-Decl crate::List::arrow_Cons_1
(declare-fun impl&%0.arrow_Cons_1.? (Dcr Type Poly) List.)
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (self! Poly)) (!
    (= (impl&%0.arrow_0.? A&. A& self!) (List./Cons/0 (%Poly%List. self!)))
    :pattern ((impl&%0.arrow_0.? A&. A& self!))
...
(assert
 (forall ((A&. Dcr) (A& Type) (self! Poly)) (!
   (=>
    ...
    (has_type (impl&%0.arrow_0.? A&. A& self!) A&)
   )
   :pattern ((impl&%0.arrow_0.? A&. A& self!))
...
;; Function-Axioms crate::List::arrow_1
(assert
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (self! Poly)) (!
    (= (impl&%0.arrow_1.? A&. A& self!) (List./Cons/1 (%Poly%List. self!)))
    :pattern ((impl&%0.arrow_1.? A&. A& self!))
...
(assert
 (forall ((A&. Dcr) (A& Type) (self! Poly)) (!
   (=>
    (has_type self! (TYPE%List. A&. A&))
    (has_type (Poly%List. (impl&%0.arrow_1.? A&. A& self!)) (TYPE%List. A&. A&))
   )
   :pattern ((impl&%0.arrow_1.? A&. A& self!))
...
(assert
 (fuel_bool_default fuel%impl&%0.arrow_Cons_0.)
)
(assert
 (=>
  (fuel_bool fuel%impl&%0.arrow_Cons_0.)
  (forall ((A&. Dcr) (A& Type) (self! Poly)) (!
    (= (impl&%0.arrow_Cons_0.? A&. A& self!) (List./Cons/0 (%Poly%List. self!)))
    :pattern ((impl&%0.arrow_Cons_0.? A&. A& self!))
    :qid internal_impl&__0.arrow_Cons_0.?_definition
    :skolemid skolem_internal_impl&__0.arrow_Cons_0.?_definition
))))
(assert
 (forall ((A&. Dcr) (A& Type) (self! Poly)) (!
   (=>
    (has_type self! (TYPE%List. A&. A&))
    (has_type (impl&%0.arrow_Cons_0.? A&. A& self!) A&)
   )
   :pattern ((impl&%0.arrow_Cons_0.? A&. A& self!))
   :qid internal_impl&__0.arrow_Cons_0.?_pre_post_definition
   :skolemid skolem_internal_impl&__0.arrow_Cons_0.?_pre_post_definition
)))

;; Function-Axioms crate::List::arrow_Cons_1
(assert
 (fuel_bool_default fuel%impl&%0.arrow_Cons_1.)
)
(assert
 (=>
  (fuel_bool fuel%impl&%0.arrow_Cons_1.)
  (forall ((A&. Dcr) (A& Type) (self! Poly)) (!
    (= (impl&%0.arrow_Cons_1.? A&. A& self!) (List./Cons/1 (%Poly%List. self!)))
    :pattern ((impl&%0.arrow_Cons_1.? A&. A& self!))
    :qid internal_impl&__0.arrow_Cons_1.?_definition
    :skolemid skolem_internal_impl&__0.arrow_Cons_1.?_definition
))))
(assert
 (forall ((A&. Dcr) (A& Type) (self! Poly)) (!
   (=>
    (has_type self! (TYPE%List. A&. A&))
    (has_type (Poly%List. (impl&%0.arrow_Cons_1.? A&. A& self!)) (TYPE%List. A&. A&))
   )
   :pattern ((impl&%0.arrow_Cons_1.? A&. A& self!))
   :qid internal_impl&__0.arrow_Cons_1.?_pre_post_definition
   :skolemid skolem_internal_impl&__0.arrow_Cons_1.?_pre_post_definition
)))

;; Spec-Termination crate::len
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/match-4460c9f52e99806e-test2/test.rs:20:6: 20:38 (#0)
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/match-4460c9f52e99806e-test2/test.rs:38:5: 56:6 (#0)
(get-info :all-statistics)
(push)
 (declare-const A&. Dcr)
 (declare-const A& Type)
       ...
       (or
        (and
         ...
         (=>
          ...
          (=>
           (= tl@ (List./Cons/1 (%Poly%List. (Poly%List. iter@0))))
           (=>
            (= iter@1 tl@)
            (=>
             (fuel_bool fuel%len.)
...
;; Function-Def crate::get_len
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/match-4460c9f52e99806e-test2/test.rs:29:1: 29:41 (#0)
(get-info :all-statistics)
(push)
 (declare-const A&. Dcr)
 (declare-const A& Type)
