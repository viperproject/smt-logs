...
(assert
 (forall ((no%param Int) (%return! Int)) (!
   (= (ens%test_crate!test. no%param %return!) (uInv 64 %return!))
   :pattern ((ens%test_crate!test. no%param %return!))
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/match-4460c9f52e99806e-test2_unreached_fail/test.rs:20:1: 20:23 (#0)
