...
(assert
 (distinct fuel%vstd!multiset.impl&%0.insert. fuel%vstd!multiset.impl&%0.subset_of.
  fuel%vstd!multiset.impl&%0.choose. fuel%vstd!multiset.axiom_multiset_empty. fuel%vstd!multiset.axiom_multiset_singleton.
  ...
  fuel%vstd!multiset.axiom_count_le_len. fuel%vstd!multiset.axiom_choose_count. fuel%vstd!array.group_array_axioms.
...
;; Function-Decl vstd::multiset::impl&%0::choose
...
(assert
 (=>
  ...
  (forall ((V&. Dcr) (V& Type) (m1! Poly) (m2! Poly) (v! Poly)) (!
    ...
    :qid user_vstd__multiset__axiom_multiset_sub_4
    :skolemid skolem_user_vstd__multiset__axiom_multiset_sub_4
))))
...
(assert
 (=>
  ...
  (forall ((V&. Dcr) (V& Type) (m1! Poly) (m2! Poly)) (!
    ...
    :qid user_vstd__multiset__axiom_multiset_ext_equal_6
    :skolemid skolem_user_vstd__multiset__axiom_multiset_ext_equal_6
))))
...
(assert
 (=>
  ...
  (forall ((V&. Dcr) (V& Type) (m1! Poly) (m2! Poly)) (!
    ...
    :qid user_vstd__multiset__axiom_multiset_ext_equal_deep_7
    :skolemid skolem_user_vstd__multiset__axiom_multiset_ext_equal_deep_7
))))

;; Broadcast vstd::multiset::axiom_len_empty
(assert
 (=>
  ...
  (forall ((V&. Dcr) (V& Type)) (!
    ...
    :qid user_vstd__multiset__axiom_len_empty_8
    :skolemid skolem_user_vstd__multiset__axiom_len_empty_8
))))
...
(assert
 (=>
  ...
  (forall ((V&. Dcr) (V& Type) (v! Poly)) (!
    ...
    :qid user_vstd__multiset__axiom_len_singleton_9
    :skolemid skolem_user_vstd__multiset__axiom_len_singleton_9
))))
...
(assert
 (=>
  ...
  (forall ((V&. Dcr) (V& Type) (m1! Poly) (m2! Poly)) (!
    ...
    :qid user_vstd__multiset__axiom_len_add_10
    :skolemid skolem_user_vstd__multiset__axiom_len_add_10
))))
 ...
 (=>
  ...
  (forall ((V&. Dcr) (V& Type) (self! Poly) (m2! Poly)) (!
    (= (vstd!multiset.impl&%0.subset_of.? V&. V& self! m2!) (forall ((v$ Poly)) (!
       ...
       :pattern ((vstd!multiset.impl&%0.count.? V&. V& m2! v$))
       :qid user_vstd__multiset__impl&%0__subset_of_11
       :skolemid skolem_user_vstd__multiset__impl&%0__subset_of_11
    )))
...
;; Broadcast vstd::multiset::axiom_len_sub
(assert
 (=>
  ...
  (forall ((V&. Dcr) (V& Type) (m1! Poly) (m2! Poly)) (!
    ...
    :qid user_vstd__multiset__axiom_len_sub_12
    :skolemid skolem_user_vstd__multiset__axiom_len_sub_12
))))
...
(assert
 (=>
  ...
  (forall ((V&. Dcr) (V& Type) (m! Poly) (v! Poly)) (!
    ...
    :qid user_vstd__multiset__axiom_count_le_len_13
    :skolemid skolem_user_vstd__multiset__axiom_count_le_len_13
))))

;; Function-Axioms vstd::multiset::impl&%0::choose
(assert
 ...
 (forall ((%%hole%%0 Type) (%%hole%%1 Dcr) (%%hole%%2 Type) (%%hole%%3 Poly) (%%hole%%4
   ...
   (=>
    (exists ((v$ Poly)) (!
      ...
      :qid user_vstd__multiset__impl&%0__choose_14
      :skolemid skolem_user_vstd__multiset__impl&%0__choose_14
    ))
    (exists ((v$ Poly)) (!
      (and
       (and
...
;; Broadcast vstd::multiset::axiom_choose_count
(assert
 (=>
  ...
  (forall ((V&. Dcr) (V& Type) (m! Poly)) (!
    ...
    :qid user_vstd__multiset__axiom_choose_count_15
    :skolemid skolem_user_vstd__multiset__axiom_choose_count_15
))))
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/multiset-e088e19343d547b3-multiset_basics/test.rs:17:1: 17:60 (#0)
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/multiset-e088e19343d547b3-multiset_basics/test.rs:24:1: 24:76 (#0)
(get-info :all-statistics)
(push)
 (declare-const V&. Dcr)
 (declare-const V& Type)
...
;; Function-Specs test_crate::insert2
(declare-fun ens%test_crate!insert2. (Dcr Type Poly Poly) Bool)
(assert
 (forall ((V&. Dcr) (V& Type) (a! Poly) (b! Poly)) (!
   (= (ens%test_crate!insert2. V&. V& a! b!) (= (vstd!multiset.impl&%0.insert.? V&. V&
      (vstd!multiset.impl&%0.insert.? V&. V& (vstd!multiset.impl&%0.empty.? V&. V&) a!)
      b!
     ) (vstd!multiset.impl&%0.insert.? V&. V& (vstd!multiset.impl&%0.insert.? V&. V& (vstd!multiset.impl&%0.empty.?
        V&. V&
       ) b!
      ) a!
   )))
   :pattern ((ens%test_crate!insert2. V&. V& a! b!))
   :qid internal_ens__test_crate!insert2._definition
   :skolemid skolem_internal_ens__test_crate!insert2._definition
)))

;; Function-Def test_crate::insert2
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/multiset-e088e19343d547b3-multiset_basics/test.rs:33:1: 33:36 (#0)
(get-info :all-statistics)
(push)
 (declare-const V&. Dcr)
 (declare-const V& Type)
 ...
 (assert
  (not (=>
    (= tmp%1 (ext_eq false (TYPE%vstd!multiset.Multiset. V&. V&) (vstd!multiset.impl&%0.insert.?
       V&. V& (vstd!multiset.impl&%0.insert.? V&. V& (vstd!multiset.impl&%0.empty.? V&. V&)
        a!
       ) b!
      ) (vstd!multiset.impl&%0.insert.? V&. V& (vstd!multiset.impl&%0.insert.? V&. V& (vstd!multiset.impl&%0.empty.?
         V&. V&
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/multiset-e088e19343d547b3-multiset_basics/test.rs:43:1: 43:48 (#0)
(get-info :all-statistics)
(push)
 (declare-const V&. Dcr)
 (declare-const V& Type)
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/multiset-e088e19343d547b3-multiset_basics/test.rs:52:1: 52:63 (#0)
(get-info :all-statistics)
(push)
 (declare-const V&. Dcr)
 (declare-const V& Type)
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/multiset-e088e19343d547b3-multiset_basics/test.rs:59:1: 59:63 (#0)
(get-info :all-statistics)
(push)
 (declare-const V&. Dcr)
 (declare-const V& Type)
...
;; Function-Specs test_crate::choose_count
(declare-fun req%test_crate!choose_count. (Dcr Type Poly) Bool)
(declare-const %%global_location_label%%2 Bool)
(assert
 (forall ((V&. Dcr) (V& Type) (m! Poly)) (!
   (= (req%test_crate!choose_count. V&. V& m!) (=>
     %%global_location_label%%2
     (not (= (vstd!multiset.impl&%0.len.? V&. V& m!) 0))
   ))
   :pattern ((req%test_crate!choose_count. V&. V& m!))
   :qid internal_req__test_crate!choose_count._definition
   :skolemid skolem_internal_req__test_crate!choose_count._definition
)))

;; Function-Def test_crate::choose_count
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/multiset-e088e19343d547b3-multiset_basics/test.rs:68:1: 68:45 (#0)
(get-info :all-statistics)
(push)
 (declare-const V&. Dcr)
 (declare-const V& Type)
 ...
 (assert
  (not (=>
    (= tmp%1 (> (vstd!multiset.impl&%0.count.? V&. V& m! (vstd!multiset.impl&%0.choose.?
        V&. V& m!
       )
      ) 0
    ))
...
;; Function-Specs test_crate::len_is_zero_if_count_for_each_value_is_zero
(declare-fun req%test_crate!len_is_zero_if_count_for_each_value_is_zero. (Dcr Type
  Poly
 ) Bool
)
...
(assert
 (forall ((V&. Dcr) (V& Type) (m! Poly)) (!
   (= (req%test_crate!len_is_zero_if_count_for_each_value_is_zero. V&. V& m!) (=>
     %%global_location_label%%3
     (forall ((v$ Poly)) (!
       (=>
        (has_type v$ V&)
        (= (vstd!multiset.impl&%0.count.? V&. V& m! v$) 0)
       )
       :pattern ((vstd!multiset.impl&%0.count.? V&. V& m! v$))
       :qid user_test_crate__len_is_zero_if_count_for_each_value_is_zero_16
       :skolemid skolem_user_test_crate__len_is_zero_if_count_for_each_value_is_zero_16
   ))))
   :pattern ((req%test_crate!len_is_zero_if_count_for_each_value_is_zero. V&. V& m!))
   :qid internal_req__test_crate!len_is_zero_if_count_for_each_value_is_zero._definition
   :skolemid skolem_internal_req__test_crate!len_is_zero_if_count_for_each_value_is_zero._definition
)))
(declare-fun ens%test_crate!len_is_zero_if_count_for_each_value_is_zero. (Dcr Type
  Poly
 ) Bool
)
(assert
 (forall ((V&. Dcr) (V& Type) (m! Poly)) (!
   (= (ens%test_crate!len_is_zero_if_count_for_each_value_is_zero. V&. V& m!) (= (vstd!multiset.impl&%0.len.?
      V&. V& m!
     ) 0
   ))
   :pattern ((ens%test_crate!len_is_zero_if_count_for_each_value_is_zero. V&. V& m!))
   :qid internal_ens__test_crate!len_is_zero_if_count_for_each_value_is_zero._definition
   :skolemid skolem_internal_ens__test_crate!len_is_zero_if_count_for_each_value_is_zero._definition
)))

;; Function-Def test_crate::len_is_zero_if_count_for_each_value_is_zero
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/multiset-e088e19343d547b3-multiset_basics/test.rs:75:1: 75:76 (#0)
(get-info :all-statistics)
(push)
 (declare-const V&. Dcr)
 (declare-const V& Type)
 ...
 (assert
  (forall ((v$ Poly)) (!
    ...
    :pattern ((vstd!multiset.impl&%0.count.? V&. V& m! v$))
    :qid user_test_crate__len_is_zero_if_count_for_each_value_is_zero_17
    :skolemid skolem_user_test_crate__len_is_zero_if_count_for_each_value_is_zero_17
 )))
 ...
 (assert
  (not (or
    (and
     ...
     (=>
      (not (not (= (vstd!multiset.impl&%0.len.? V&. V& m!) 0)))
      %%switch_label%%0
    ))
    (and
     (not %%switch_label%%0)
