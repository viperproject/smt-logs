...
(assert
 (distinct fuel%vstd!multiset.axiom_multiset_add. fuel%vstd!multiset.axiom_multiset_sub.
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/multiset-e088e19343d547b3-multiset_fail3/test.rs:17:1: 17:63 (#0)
  ...
  (not (=>
    ...
    (and
     ...
     (=>
      ...
      (=>
       %%location_label%%1
       (= (vstd!multiset.impl&%0.add.? V&. V& (vstd!multiset.impl&%0.sub.? V&. V& a! b!) b!)
        a!
 )))))))
 (get-info :version)
