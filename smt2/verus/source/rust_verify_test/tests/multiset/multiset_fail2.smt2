...
;; Function-Specs test_crate::add_fail
(declare-fun ens%test_crate!add_fail. (Dcr Type Poly Poly) Bool)
(assert
 (forall ((V&. Dcr) (V& Type) (a! Poly) (b! Poly)) (!
   (= (ens%test_crate!add_fail. V&. V& a! b!) (= (vstd!multiset.impl&%0.add.? V&. V& a!
      b!
     ) (vstd!multiset.impl&%0.add.? V&. V& a! a!)
   ))
   :pattern ((ens%test_crate!add_fail. V&. V& a! b!))
   :qid internal_ens__test_crate!add_fail._definition
   :skolemid skolem_internal_ens__test_crate!add_fail._definition
)))

;; Function-Def test_crate::add_fail
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/multiset-e088e19343d547b3-multiset_fail2/test.rs:17:1: 17:57 (#0)
  ...
  (not (=>
    ...
    (and
     ...
     (=>
      ...
      (=>
       %%location_label%%1
       (= (vstd!multiset.impl&%0.add.? V&. V& a! b!) (vstd!multiset.impl&%0.add.? V&. V& a!
         a!
 ))))))))
 (get-info :version)
...
;; Function-Recommends test_crate::add_fail
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/multiset-e088e19343d547b3-multiset_fail2/test.rs:17:1: 17:57 (#0)
(get-info :all-statistics)
(push)
 (declare-const V&. Dcr)
