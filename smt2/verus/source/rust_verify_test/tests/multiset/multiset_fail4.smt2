...
(assert
 (distinct fuel%vstd!multiset.impl&%0.choose. fuel%vstd!multiset.axiom_multiset_ext_equal.
...
(assert
 (=>
  ...
  (forall ((V&. Dcr) (V& Type) (m1! Poly) (m2! Poly)) (!
    ...
    :qid user_vstd__multiset__axiom_multiset_ext_equal_deep_2
    :skolemid skolem_user_vstd__multiset__axiom_multiset_ext_equal_deep_2
))))
 ...
 (forall ((%%hole%%0 Type) (%%hole%%1 Dcr) (%%hole%%2 Type) (%%hole%%3 Poly) (%%hole%%4
   ...
   (=>
    (exists ((v$ Poly)) (!
      ...
      :qid user_vstd__multiset__impl&%0__choose_3
      :skolemid skolem_user_vstd__multiset__impl&%0__choose_3
    ))
    (exists ((v$ Poly)) (!
      (and
       (and
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/multiset-e088e19343d547b3-multiset_fail4/test.rs:17:1: 17:45 (#0)
...
;; Function-Recommends test_crate::choose_count
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/multiset-e088e19343d547b3-multiset_fail4/test.rs:17:1: 17:45 (#0)
(get-info :all-statistics)
(push)
 (declare-const V&. Dcr)
