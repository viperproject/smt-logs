...
(declare-fun req%test_crate!test. (Dcr Type Dcr Type Poly Poly Poly) Bool)
(declare-const %%global_location_label%%0 Bool)
(assert
 (forall ((T&. Dcr) (T& Type) (F&. Dcr) (F& Type) (s! Poly) (key! Poly) (less! Poly))
  (!
   (= (req%test_crate!test. T&. T& F&. F& s! key! less!) (=>
     ...
     (forall ((x$ Poly) (y$ Poly)) (!
       (=>
        ...
        (closure_req F& $ (TYPE%tuple%2. T&. T& T&. T&) less! (Poly%tuple%2. (tuple%2./tuple%2
           x$ y$
       ))))
       :pattern ((closure_req F& $ (TYPE%tuple%2. T&. T& T&. T&) less! (Poly%tuple%2. (tuple%2./tuple%2
           x$ y$
       ))))
       :qid user_test_crate__test_0
       :skolemid skolem_user_test_crate__test_0
   ))))
   :pattern ((req%test_crate!test. T&. T& F&. F& s! key! less!))
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/exec_closures-b11772a2e0912ad7-right_decorations_for_tuple_arg/test.rs:17:1: 18:30 (#0)
