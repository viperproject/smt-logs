...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/exec_closures-b11772a2e0912ad7-test_assert_not_ensures_fail_0_args/test.rs:19:1: 19:12 (#0)
  ...
  (not (and
    ...
    (=>
     ...
     (=>
      (= f@ tmp%%1)
      (=>
       (= tmp%1 (not (closure_ens TYPE%anonymous_closure%8. $ TYPE%tuple%0. (Poly%anonymous_closure%8.
           f@
