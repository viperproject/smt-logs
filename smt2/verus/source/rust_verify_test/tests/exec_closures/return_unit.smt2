...
(assert
 (distinct fuel%vstd!pervasive.impl&%0.ensures. fuel%vstd!array.group_array_axioms.
...
(declare-sort anonymous_closure%9. 0)
...
(declare-const TYPE%anonymous_closure%9. Type)
...
(declare-fun Poly%anonymous_closure%9. (anonymous_closure%9.) Poly)
(declare-fun %Poly%anonymous_closure%9. (Poly) anonymous_closure%9.)
...
(assert
 (forall ((x anonymous_closure%9.)) (!
   (= x (%Poly%anonymous_closure%9. (Poly%anonymous_closure%9. x)))
   :pattern ((Poly%anonymous_closure%9. x))
   :qid internal_crate__anonymous_closure__9_box_axiom_definition
   :skolemid skolem_internal_crate__anonymous_closure__9_box_axiom_definition
)))
(assert
 (forall ((x Poly)) (!
   (=>
    (has_type x TYPE%anonymous_closure%9.)
    (= x (Poly%anonymous_closure%9. (%Poly%anonymous_closure%9. x)))
   )
   :pattern ((has_type x TYPE%anonymous_closure%9.))
   :qid internal_crate__anonymous_closure__9_unbox_axiom_definition
   :skolemid skolem_internal_crate__anonymous_closure__9_unbox_axiom_definition
)))
(assert
 (forall ((x anonymous_closure%9.)) (!
   (has_type (Poly%anonymous_closure%9. x) TYPE%anonymous_closure%9.)
   :pattern ((has_type (Poly%anonymous_closure%9. x) TYPE%anonymous_closure%9.))
   :qid internal_crate__anonymous_closure__9_has_type_always_definition
   :skolemid skolem_internal_crate__anonymous_closure__9_has_type_always_definition
)))
(assert
 (forall ((x tuple%0.)) (!
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/exec_closures-b11772a2e0912ad7-return_unit/test.rs:17:1: 17:10 (#0)
(get-info :all-statistics)
(push)
 (declare-const no%param Int)
 (declare-const x~4 Int)
 (declare-const res~13 tuple%0.)
 (declare-const tmp%%1 anonymous_closure%7.)
 (declare-const x~34 Int)
 (declare-const res~43 tuple%0.)
 (declare-const tmp%%4 anonymous_closure%9.)
 (declare-const x~65 Int)
 (declare-const %closure_return~66 tuple%0.)
 (declare-const tmp%%7 anonymous_closure%11.)
 (declare-const tmp%1 Bool)
 (declare-const f@ anonymous_closure%7.)
 (declare-const f1@ anonymous_closure%9.)
 (declare-const g@ anonymous_closure%11.)
 (assert
  fuel_defaults
 )
    ...
    (=>
     (and
      (forall ((tmp%%$ Poly)) (!
        ...
        :qid user_test_crate__test_0
        :skolemid skolem_user_test_crate__test_0
      ))
      (forall ((tmp%%$ Poly) (res$ Poly)) (!
        (=>
         (and
          (has_type tmp%%$ (TYPE%tuple%1. $ (UINT 64)))
          (has_type res$ TYPE%tuple%0.)
         )
         (=>
          ...
          (let
           ((x$ (%I (tuple%1./tuple%1/0 (%Poly%tuple%1. tmp%%$)))))
           (= (%Poly%tuple%0. res$) tuple%0./tuple%0)
        )))
        :pattern ((closure_ens TYPE%anonymous_closure%7. $ (TYPE%tuple%1. $ (UINT 64)) (Poly%anonymous_closure%7.
           tmp%%1
          ) tmp%%$ res$
        ))
        :qid user_test_crate__test_1
        :skolemid skolem_user_test_crate__test_1
     )))
     (=>
      (= f@ tmp%%1)
      (and
        ...
        (and
         (forall ((tmp%%$ Poly)) (!
           (=>
            ...
            (=>
             ...
             (closure_req TYPE%anonymous_closure%9. $ (TYPE%tuple%1. $ (UINT 64)) (Poly%anonymous_closure%9.
               tmp%%4
              ) tmp%%$
           )))
           :pattern ((closure_req TYPE%anonymous_closure%9. $ (TYPE%tuple%1. $ (UINT 64)) (Poly%anonymous_closure%9.
              tmp%%4
             ) tmp%%$
           ))
         ...
         (forall ((tmp%%$ Poly) (res$ Poly)) (!
           (=>
            ...
            (=>
             (closure_ens TYPE%anonymous_closure%9. $ (TYPE%tuple%1. $ (UINT 64)) (Poly%anonymous_closure%9.
               tmp%%4
              ) tmp%%$ res$
             )
             (let
           ...
           :pattern ((closure_ens TYPE%anonymous_closure%9. $ (TYPE%tuple%1. $ (UINT 64)) (Poly%anonymous_closure%9.
              tmp%%4
             ) tmp%%$ res$
           ))
         ...
         (=>
          (and
           ...
           (forall ((tmp%%$ Poly) (%closure_return$ Poly)) (!
             ...
             :qid user_test_crate__test_5
             :skolemid skolem_user_test_crate__test_5
          )))
          (=>
           (= g@ tmp%%7)
           (=>
            (= tmp%1 (not (closure_ens TYPE%anonymous_closure%11. $ (TYPE%tuple%1. $ (UINT 64))
               (Poly%anonymous_closure%11. g@) (Poly%tuple%1. (tuple%1./tuple%1 (I 2))) (Poly%tuple%0.
                tuple%0./tuple%0
            ))))
            (=>
             %%location_label%%2
