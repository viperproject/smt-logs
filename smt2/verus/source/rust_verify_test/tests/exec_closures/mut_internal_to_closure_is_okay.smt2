...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/exec_closures-b11772a2e0912ad7-mut_internal_to_closure_is_okay/test.rs:17:1: 17:11 (#0)
(get-info :all-statistics)
(push)
 (declare-const no%param Int)
 (declare-const t~8 Int)
 (declare-const %closure_return~9 tuple%0.)
 (declare-const a$1@0 Int)
    ...
    (=>
     (forall ((tmp%%$ Poly)) (!
       (=>
        ...
        (=>
         (let
          ((t$ (%I (tuple%1./tuple%1/0 (%Poly%tuple%1. tmp%%$)))))
          true
         )
         (closure_req TYPE%anonymous_closure%7. $ (TYPE%tuple%1. $ (UINT 8)) (Poly%anonymous_closure%7.
           tmp%%1
          ) tmp%%$
       )))
       :pattern ((closure_req TYPE%anonymous_closure%7. $ (TYPE%tuple%1. $ (UINT 8)) (Poly%anonymous_closure%7.
          tmp%%1
         ) tmp%%$
       ))
