...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/exec_closures-b11772a2e0912ad7-test_assert_not_ensures_fail_2_args/test.rs:17:1: 17:12 (#0)
  ...
  (not (and
    ...
    (=>
     ...
     (=>
      (= f@ tmp%%1)
      (=>
       (= tmp%1 (not (closure_ens TYPE%anonymous_closure%7. $ (TYPE%tuple%2. $ (UINT 64) $ (
            UINT 64
           )
