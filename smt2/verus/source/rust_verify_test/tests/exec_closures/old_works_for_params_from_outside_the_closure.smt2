...
(declare-fun req%test_crate!foo. (Bool) Bool)
(declare-const %%global_location_label%%0 Bool)
(assert
 (forall ((pre%b! Bool)) (!
   (= (req%test_crate!foo. pre%b!) (=>
     %%global_location_label%%0
     (= pre%b! true)
   ))
   :pattern ((req%test_crate!foo. pre%b!))
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/exec_closures-b11772a2e0912ad7-old_works_for_params_from_outside_the_closure/test.rs:17:1: 17:21 (#0)
(get-info :all-statistics)
(push)
 (declare-const b!@0 Bool)
 (declare-const i~31 Int)
 (declare-const %closure_return~32 tuple%0.)
