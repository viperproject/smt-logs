...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/exec_closures-b11772a2e0912ad7-basic_test_2_args/test.rs:17:1: 17:12 (#0)
     ...
     (=>
      ...
      (=>
       (= tmp%1 (closure_req TYPE%anonymous_closure%7. $ (TYPE%tuple%2. $ (UINT 64) $ (UINT
         ...
         ) (Poly%anonymous_closure%7. f@) (Poly%tuple%2. (tuple%2./tuple%2 (I 5) (I 5)))
       ))
       (and
        (=>
         %%location_label%%1
        ...
        (=>
         tmp%1
         (=>
          (= tmp%2 (not (closure_ens TYPE%anonymous_closure%7. $ (TYPE%tuple%2. $ (UINT 64) $ (
               UINT 64
              )
             ) (Poly%anonymous_closure%7. f@) (Poly%tuple%2. (tuple%2./tuple%2 (I 2) (I 2))) (
              I 3
          ))))
          (and
           (=>
