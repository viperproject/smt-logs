...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/exec_closures-b11772a2e0912ad7-test_call_requires_fail_2_args/test.rs:17:1: 17:12 (#0)
 ...
 (assert
  (not (=>
    ...
    (=>
     (= f@ tmp%%1)
     (=>
      (= tmp%2 (tuple%2./tuple%2 (I 3) (I 4)))
      (=>
       %%location_label%%0
       (req%vstd!pervasive.exec_nonstatic_call. $ (TYPE%tuple%2. $ (UINT 64) $ (UINT 64))
        $ TYPE%tuple%0. (REF $) TYPE%anonymous_closure%7. (Poly%anonymous_closure%7. f@)
        (Poly%tuple%2. tmp%2)
 )))))))
 (get-info :version)
