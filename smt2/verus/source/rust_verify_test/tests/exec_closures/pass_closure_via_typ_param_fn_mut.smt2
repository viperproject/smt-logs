...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/exec_closures-b11772a2e0912ad7-pass_closure_via_typ_param_fn_mut/test.rs:17:1: 17:34 (#0)
     ...
     (and
      (=>
       ...
       (req%vstd!pervasive.exec_nonstatic_call. $ (TYPE%tuple%1. $ (UINT 64)) $ (UINT 64)
        (MUT_REF T&.) T& t@0 (Poly%tuple%1. tmp%2)
      ))
      (=>
       (ens%vstd!pervasive.exec_nonstatic_call. $ (TYPE%tuple%1. $ (UINT 64)) $ (UINT 64)
        (MUT_REF T&.) T& t@0 (Poly%tuple%1. tmp%2) tmp%1
       )
       (=>
        (= ret@ (%I tmp%1))
        (=>
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/exec_closures-b11772a2e0912ad7-pass_closure_via_typ_param_fn_mut/test.rs:27:1: 27:8 (#0)
(get-info :all-statistics)
(push)
