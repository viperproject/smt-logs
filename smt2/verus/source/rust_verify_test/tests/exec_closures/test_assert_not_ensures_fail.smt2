...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/exec_closures-b11772a2e0912ad7-test_assert_not_ensures_fail/test.rs:17:1: 17:12 (#0)
(get-info :all-statistics)
(push)
 (declare-const no%param Int)
 (declare-const y~4 Int)
 (declare-const z~33 Int)
  ...
  (not (and
    ...
    (=>
     ...
     (=>
      (= f@ tmp%%1)
      (=>
       (= tmp%1 (not (closure_ens TYPE%anonymous_closure%7. $ (TYPE%tuple%1. $ (UINT 64)) (
           Poly%anonymous_closure%7. f@
          ) (Poly%tuple%1. (tuple%1./tuple%1 (I 2))) (I 3)
       )))
       (=>
        %%location_label%%2
        tmp%1
