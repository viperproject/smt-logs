...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/exec_closures-b11772a2e0912ad7-basic_test_0_args/test.rs:20:1: 20:12 (#0)
      ...
      (=>
       ...
       (and
        ...
        (=>
         ...
         (=>
          (= tmp%2 (=>
            (closure_ens TYPE%anonymous_closure%8. $ TYPE%tuple%0. (Poly%anonymous_closure%8. f@)
             (Poly%tuple%0. tuple%0./tuple%0) (Poly%tuple%0. tuple%0./tuple%0)
            )
            (test_crate!goo.? (I 0))
          ))
          (and
             ...
             (and
              (=>
               ...
               (req%vstd!pervasive.exec_nonstatic_call. $ TYPE%tuple%0. $ TYPE%tuple%0. (REF $) TYPE%anonymous_closure%8.
                (Poly%anonymous_closure%8. f@) (Poly%tuple%0. tmp%4)
              ))
              (=>
               (ens%vstd!pervasive.exec_nonstatic_call. $ TYPE%tuple%0. $ TYPE%tuple%0. (REF $) TYPE%anonymous_closure%8.
                (Poly%anonymous_closure%8. f@) (Poly%tuple%0. tmp%4) tmp%3
               )
               (=>
                (= t@ (%Poly%tuple%0. tmp%3))
                (=>
                 (= tmp%5 (test_crate!goo.? (I 0)))
                 (=>
                  %%location_label%%4
                  tmp%5
 )))))))))))))))))
