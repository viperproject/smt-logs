...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/exec_closures-b11772a2e0912ad7-test_call_ensures_fail_2_args/test.rs:17:1: 17:12 (#0)
  ...
  (not (and
    ...
    (=>
     (and
      (forall ((tmp%%$ Poly)) (!
        (=>
         ...
         (=>
          (let
           ((x$ (%I (tuple%2./tuple%2/0 (%Poly%tuple%2. tmp%%$)))))
           (let
            ((y$ (%I (tuple%2./tuple%2/1 (%Poly%tuple%2. tmp%%$)))))
            (= x$ y$)
          ))
          (closure_req TYPE%anonymous_closure%7. $ (TYPE%tuple%2. $ (UINT 64) $ (UINT 64)) (
            Poly%anonymous_closure%7. tmp%%1
           ) tmp%%$
        )))
        :pattern ((closure_req TYPE%anonymous_closure%7. $ (TYPE%tuple%2. $ (UINT 64) $ (UINT
            64
           )
          ) (Poly%anonymous_closure%7. tmp%%1) tmp%%$
        ))
      ...
      (forall ((tmp%%$ Poly) (z$ Poly)) (!
        (=>
         ...
         (=>
          (closure_ens TYPE%anonymous_closure%7. $ (TYPE%tuple%2. $ (UINT 64) $ (UINT 64)) (
            Poly%anonymous_closure%7. tmp%%1
           ) tmp%%$ z$
          )
          (let
        ...
        :pattern ((closure_ens TYPE%anonymous_closure%7. $ (TYPE%tuple%2. $ (UINT 64) $ (UINT
            64
           )
          ) (Poly%anonymous_closure%7. tmp%%1) tmp%%$ z$
        ))
     ...
     (=>
      (= f@ tmp%%1)
      (=>
       (= tmp%2 (tuple%2./tuple%2 (I 10) (I 10)))
       (and
        (=>
         %%location_label%%1
         (req%vstd!pervasive.exec_nonstatic_call. $ (TYPE%tuple%2. $ (UINT 64) $ (UINT 64))
          $ (UINT 64) (REF $) TYPE%anonymous_closure%7. (Poly%anonymous_closure%7. f@) (Poly%tuple%2.
           tmp%2
        )))
        (=>
         (ens%vstd!pervasive.exec_nonstatic_call. $ (TYPE%tuple%2. $ (UINT 64) $ (UINT 64))
          $ (UINT 64) (REF $) TYPE%anonymous_closure%7. (Poly%anonymous_closure%7. f@) (Poly%tuple%2.
           tmp%2
          ) tmp%1
         )
