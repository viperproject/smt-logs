...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/exec_closures-b11772a2e0912ad7-test_assert_requires_fail/test.rs:17:1: 17:12 (#0)
 ...
 (assert
  (not (=>
    ...
    (=>
     (= f@ tmp%%1)
     (=>
      (= tmp%1 (closure_req TYPE%anonymous_closure%7. $ (TYPE%tuple%1. $ (UINT 64)) (Poly%anonymous_closure%7.
         f@
        ) (Poly%tuple%1. (tuple%1./tuple%1 (I 3)))
      ))
      (=>
       %%location_label%%0
       tmp%1
