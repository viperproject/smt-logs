...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/exec_closures-b11772a2e0912ad7-test_requires_is_about_external_var/test.rs:22:17: 22:25 (#0)
(get-info :all-statistics)
(push)
 (declare-const b! Bool)
 (declare-const y~6 Int)
 (declare-const %closure_return~7 tuple%0.)
...
;; Function-Def test_crate::testfn
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/exec_closures-b11772a2e0912ad7-test_requires_is_about_external_var/test.rs:17:1: 17:19 (#0)
(get-info :all-statistics)
(push)
 (declare-const b! Bool)
 (declare-const y~6 Int)
  ...
  (not (and
     ...
     (=>
      ...
      (or
       ...
       (and
        (not %%switch_label%%0)
        (=>
         (= %closure_return~7 tuple%0./tuple%0)
         (=>
          %%location_label%%0
          b!
    ))))))
    (=>
     (and
      (forall ((tmp%%$ Poly)) (!
        (=>
         ...
         (=>
          (let
           ((y$ (%I (tuple%1./tuple%1/0 (%Poly%tuple%1. tmp%%$)))))
           (= y$ 2)
          )
     ...
     (=>
      (= f@ tmp%%1)
      (=>
       (= tmp%2 (tuple%1./tuple%1 (I 2)))
       (and
        (=>
         %%location_label%%1
         (req%vstd!pervasive.exec_nonstatic_call. $ (TYPE%tuple%1. $ (UINT 64)) $ TYPE%tuple%0.
          (REF $) TYPE%anonymous_closure%7. (Poly%anonymous_closure%7. f@) (Poly%tuple%1. tmp%2)
        ))
        (=>
         (ens%vstd!pervasive.exec_nonstatic_call. $ (TYPE%tuple%1. $ (UINT 64)) $ TYPE%tuple%0.
          (REF $) TYPE%anonymous_closure%7. (Poly%anonymous_closure%7. f@) (Poly%tuple%1. tmp%2)
          tmp%1
         )
         (=>
