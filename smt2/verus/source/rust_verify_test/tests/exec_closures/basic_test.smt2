...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/exec_closures-b11772a2e0912ad7-basic_test/test.rs:17:1: 17:12 (#0)
     ...
     (=>
      ...
      (=>
       (= tmp%1 (closure_req TYPE%anonymous_closure%7. $ (TYPE%tuple%1. $ (UINT 64)) (Poly%anonymous_closure%7.
          f@
         ) (Poly%tuple%1. (tuple%1./tuple%1 (I 2)))
       ))
       (and
        (=>
         %%location_label%%1
        ...
        (=>
         tmp%1
         (=>
          (= tmp%2 (not (closure_ens TYPE%anonymous_closure%7. $ (TYPE%tuple%1. $ (UINT 64)) (
