...
;; Function-Specs test_crate::some_call
(declare-fun req%test_crate!some_call. (Int) Bool)
(declare-const %%global_location_label%%0 Bool)
(assert
 (forall ((i! Int)) (!
   (= (req%test_crate!some_call. i!) (=>
     %%global_location_label%%0
     (= i! 21)
   ))
   :pattern ((req%test_crate!some_call. i!))
   :qid internal_req__test_crate!some_call._definition
   :skolemid skolem_internal_req__test_crate!some_call._definition
)))

;; Function-Def test_crate::some_call
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/exec_closures-b11772a2e0912ad7-test_calls_as_sub_expression_fail/test.rs:17:1: 17:21 (#0)
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/exec_closures-b11772a2e0912ad7-test_calls_as_sub_expression_fail/test.rs:21:1: 21:16 (#0)
(get-info :all-statistics)
(push)
  ...
  (not (and
    ...
    (=>
     (and
      (forall ((tmp%%$ Poly)) (!
        (=>
         ...
         (=>
          ...
          (closure_req TYPE%anonymous_closure%8. $ (TYPE%tuple%1. $ (UINT 64)) (Poly%anonymous_closure%8.
            tmp%%1
           ) tmp%%$
        )))
        :pattern ((closure_req TYPE%anonymous_closure%8. $ (TYPE%tuple%1. $ (UINT 64)) (Poly%anonymous_closure%8.
           tmp%%1
          ) tmp%%$
        ))
      ...
      (forall ((tmp%%$ Poly) (j$ Poly)) (!
        (=>
         ...
         (=>
          (closure_ens TYPE%anonymous_closure%8. $ (TYPE%tuple%1. $ (UINT 64)) (Poly%anonymous_closure%8.
            tmp%%1
           ) tmp%%$ j$
          )
          (let
        ...
        :pattern ((closure_ens TYPE%anonymous_closure%8. $ (TYPE%tuple%1. $ (UINT 64)) (Poly%anonymous_closure%8.
           tmp%%1
          ) tmp%%$ j$
        ))
     ...
     (=>
      (= f@ tmp%%1)
      (=>
       (= tmp%2 (tuple%1./tuple%1 (I 20)))
       (and
        (=>
         %%location_label%%1
         (req%vstd!pervasive.exec_nonstatic_call. $ (TYPE%tuple%1. $ (UINT 64)) $ (UINT 64)
          (REF $) TYPE%anonymous_closure%8. (Poly%anonymous_closure%8. f@) (Poly%tuple%1. tmp%2)
        ))
        (=>
         ...
         (=>
          %%location_label%%2
          (req%test_crate!some_call. (%I tmp%1))
 )))))))))
 (get-info :version)
 (set-option :rlimit 30000000)
 (check-sat)
...
;; Function-Recommends test_crate::foo
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/exec_closures-b11772a2e0912ad7-test_calls_as_sub_expression_fail/test.rs:21:1: 21:16 (#0)
(get-info :all-statistics)
(push)
 (declare-const b! Bool)
