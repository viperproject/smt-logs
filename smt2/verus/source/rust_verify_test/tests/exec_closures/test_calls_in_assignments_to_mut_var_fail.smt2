...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/exec_closures-b11772a2e0912ad7-test_calls_in_assignments_to_mut_var_fail/test.rs:17:1: 17:16 (#0)
  ...
  (not (=>
    (and
     ...
     (forall ((tmp%%$ Poly) (j$ Poly)) (!
       ...
       :qid user_test_crate__foo_3
       :skolemid skolem_user_test_crate__foo_3
    )))
    (=>
     (= f@ tmp%%1)
     (=>
          ...
          (and
           (=>
            ...
            (=>
             ...
             (=>
              (ens%vstd!pervasive.exec_nonstatic_call. $ (TYPE%tuple%1. $ (UINT 64)) $ (UINT 64)
               (REF $) TYPE%anonymous_closure%7. (Poly%anonymous_closure%7. f@) (Poly%tuple%1. tmp%4)
               tmp%3
              )
              (=>
               (= r@1 (%I tmp%3))
