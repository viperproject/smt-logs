...
(assert
 (distinct fuel%vstd!map.impl&%0.new. fuel%vstd!map.impl&%0.spec_index. fuel%vstd!map.axiom_map_index_decreases_finite.
  ...
  fuel%vstd!map.check_argument_is_map. fuel%vstd!map_lib.impl&%0.union_prefer_right.
  ...
  fuel%vstd!set.axiom_mk_map_index. fuel%vstd!set.axiom_set_insert_finite. fuel%vstd!set.axiom_set_remove_finite.
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (f! Poly) (a! Poly)) (!
    ...
    :qid user_vstd__set__axiom_set_new_8
    :skolemid skolem_user_vstd__set__axiom_set_new_8
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (s! Poly) (a! Poly)) (!
    ...
    :qid user_vstd__set__axiom_set_remove_same_11
    :skolemid skolem_user_vstd__set__axiom_set_remove_same_11
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (s! Poly) (a! Poly)) (!
    ...
    :qid user_vstd__set__axiom_set_remove_insert_12
    :skolemid skolem_user_vstd__set__axiom_set_remove_insert_12
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (s! Poly) (a1! Poly) (a2! Poly)) (!
    ...
    :qid user_vstd__set__axiom_set_remove_different_13
    :skolemid skolem_user_vstd__set__axiom_set_remove_different_13
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (s! Poly) (a! Poly)) (!
    ...
    :qid user_vstd__set__axiom_set_remove_finite_20
    :skolemid skolem_user_vstd__set__axiom_set_remove_finite_20
))))
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/quantifiers-91112ac9b9bc922b-test_nested_assert_forall_by_regression_155/test.rs:17:1: 17:26 (#0)
...
(push)
 ...
 (assert
  (not (=>
    (has_type m1@ (TYPE%vstd!map.Map. S&. S& T&. T&))
    (=>
     (has_type m2@ (TYPE%vstd!map.Map. S&. S& T&. T&))
     (=>
      (has_type n@ S&)
      (=>
       (and
        (vstd!set.impl&%0.contains.? S&. S& (vstd!map.impl&%0.dom.? S&. S& T&. T& m1@) n@)
        (not (vstd!set.impl&%0.contains.? S&. S& (vstd!map.impl&%0.dom.? S&. S& T&. T& m2@)
          n@
       )))
       (=>
        (= union1@ (vstd!map_lib.impl&%0.union_prefer_right.? S&. S& T&. T& (vstd!map.impl&%0.remove.?
           S&. S& T&. T& m1@ n@
          ) m2@
        ))
        (=>
         (= union2@ (vstd!map.impl&%0.remove.? S&. S& T&. T& (vstd!map_lib.impl&%0.union_prefer_right.?
            S&. S& T&. T& m1@ m2@
           ) n@
         ))
         (=>
          ...
          (=>
           ...
           (and
             ...
             (=>
              ...
              (=>
               ...
               (and
                (and
                 (=>
                  (vstd!set.impl&%0.contains.? S&. S& (vstd!map.impl&%0.dom.? S&. S& T&. T& m1$1@) key@)
                  (vstd!set.impl&%0.contains.? S&. S& (vstd!map.impl&%0.dom.? S&. S& T&. T& m2$1@) key@)
                 )
                 (=>
                  (vstd!set.impl&%0.contains.? S&. S& (vstd!map.impl&%0.dom.? S&. S& T&. T& m2$1@) key@)
                  (vstd!set.impl&%0.contains.? S&. S& (vstd!map.impl&%0.dom.? S&. S& T&. T& m1$1@) key@)
                ...
                (=>
                 ...
                 (= (vstd!map.impl&%0.index.? S&. S& T&. T& m1$1@ key@) (vstd!map.impl&%0.index.? S&.
                   S& T&. T& m2$1@ key@
             ))))))
             (=>
              (forall ((key$ Poly)) (!
                ...
                :pattern ((vstd!set.impl&%0.contains.? S&. S& (vstd!map.impl&%0.dom.? S&. S& T&. T&
                   m1$1@
                  ) key$
                ))
                :qid user_test_crate__test_21
                :skolemid skolem_user_test_crate__test_21
              ))
              (=>
               (= tmp%1 (ext_eq false (TYPE%vstd!map.Map. S&. S& T&. T&) m1$1@ m2$1@))
               (and
                (=>
                 %%location_label%%1
                 tmp%1
            ...
            (=>
             (= m1$1@ m2$1@)
             (=>
              (= tmp%2 (ext_eq false (TYPE%vstd!map.Map. S&. S& T&. T&) (vstd!map_lib.impl&%0.union_prefer_right.?
                 S&. S& T&. T& (vstd!map.impl&%0.remove.? S&. S& T&. T& m1@ n@) m2@
                ) union2@
              ))
              (and
               (=>
               ...
               (=>
                tmp%2
                (=>
                 (= tmp%3 (ext_eq false (TYPE%vstd!map.Map. S&. S& T&. T&) union1@ (vstd!map.impl&%0.remove.?
                    S&. S& T&. T& (vstd!map_lib.impl&%0.union_prefer_right.? S&. S& T&. T& m1@ m2@) n@
                 )))
                 (and
                  (=>
                   %%location_label%%4
                  ...
                  (=>
                   ...
                   (=>
                    %%location_label%%5
                    (= (vstd!map_lib.impl&%0.union_prefer_right.? S&. S& T&. T& (vstd!map.impl&%0.remove.?
                       S&. S& T&. T& m1@ n@
                      ) m2@
                     ) (vstd!map.impl&%0.remove.? S&. S& T&. T& (vstd!map_lib.impl&%0.union_prefer_right.?
                       S&. S& T&. T& m1@ m2@
                      ) n@
 )))))))))))))))))))))
 (get-info :version)
...
;; Function-Def test_crate::test_forall_forall
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/quantifiers-91112ac9b9bc922b-test_nested_assert_forall_by_regression_155/test.rs:30:1: 30:40 (#0)
(get-info :all-statistics)
(push)
 (declare-const S&. Dcr)
 (declare-const S& Type)
 ...
 (declare-const union1@ Poly)
 (declare-const union2@ Poly)
 (declare-const mm1@ Poly)
 (declare-const mm2@ Poly)
 (assert
  fuel_defaults
 )
 ;; assertion failed
             ...
             (=>
              ...
              (=>
               ...
               (and
                (and
                 (=>
                  (vstd!set.impl&%0.contains.? S&. S& (vstd!map.impl&%0.dom.? S&. S& T&. T& mm1@) key@)
                  (vstd!set.impl&%0.contains.? S&. S& (vstd!map.impl&%0.dom.? S&. S& T&. T& mm2@) key@)
                 )
                 (=>
                  (vstd!set.impl&%0.contains.? S&. S& (vstd!map.impl&%0.dom.? S&. S& T&. T& mm2@) key@)
                  (vstd!set.impl&%0.contains.? S&. S& (vstd!map.impl&%0.dom.? S&. S& T&. T& mm1@) key@)
                ...
                (=>
                 ...
                 (= (vstd!map.impl&%0.index.? S&. S& T&. T& mm1@ key@) (vstd!map.impl&%0.index.? S&.
                   S& T&. T& mm2@ key@
             ))))))
             (=>
              (forall ((key$ Poly)) (!
                ...
                :qid user_test_crate__test_forall_forall_24
                :skolemid skolem_user_test_crate__test_forall_forall_24
              ))
              (=>
               (= tmp%1 (ext_eq false (TYPE%vstd!map.Map. S&. S& T&. T&) mm1@ mm2@))
               (and
                (=>
                 %%location_label%%1
                 tmp%1
