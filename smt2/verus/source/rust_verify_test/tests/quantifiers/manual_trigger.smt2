...
;; Function-Specs test_crate::test_distinct3
(declare-fun req%test_crate!test_distinct3. (vstd!seq.Seq<int.>.) Bool)
(declare-const %%global_location_label%%2 Bool)
(declare-const %%global_location_label%%3 Bool)
(assert
 (forall ((s! vstd!seq.Seq<int.>.)) (!
   (= (req%test_crate!test_distinct3. s!) (and
     (=>
      %%global_location_label%%2
      (<= 5 (vstd!seq.Seq.len.? $ INT (Poly%vstd!seq.Seq<int.>. s!)))
     )
     (=>
        ...
        (=>
         ...
         (=>
          (and
           ...
           (< (%I j$) (vstd!seq.Seq.len.? $ INT (Poly%vstd!seq.Seq<int.>. s!)))
          )
          (not (= (vstd!seq.Seq.index.? $ INT (Poly%vstd!seq.Seq<int.>. s!) i$) (vstd!seq.Seq.index.?
             $ INT (Poly%vstd!seq.Seq<int.>. s!) j$
        )))))
        :pattern ((vstd!seq.Seq.index.? $ INT (Poly%vstd!seq.Seq<int.>. s!) i$) (vstd!seq.Seq.index.?
          $ INT (Poly%vstd!seq.Seq<int.>. s!) j$
        ))
        :qid user_test_crate__test_distinct3_5
        :skolemid skolem_user_test_crate__test_distinct3_5
   )))))
   :pattern ((req%test_crate!test_distinct3. s!))
   :qid internal_req__test_crate!test_distinct3._definition
   :skolemid skolem_internal_req__test_crate!test_distinct3._definition
)))

;; Function-Def test_crate::test_distinct3
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/quantifiers-91112ac9b9bc922b-manual_trigger/test.rs:16:7: 16:37 (#0)
...
(push)
 ...
 (assert
  (forall ((i$ Poly) (j$ Poly)) (!
    ...
    :qid user_test_crate__test_distinct3_6
    :skolemid skolem_user_test_crate__test_distinct3_6
 )))
 ;; assertion failed
 (declare-const %%location_label%%0 Bool)
 (assert
  (not (=>
    (= tmp%1 (not (= (vstd!seq.Seq.index.? $ INT (Poly%vstd!seq.Seq<int.>. s!) (I 4)) (vstd!seq.Seq.index.?
        $ INT (Poly%vstd!seq.Seq<int.>. s!) (I 2)
    ))))
    (=>
     %%location_label%%0
     tmp%1
