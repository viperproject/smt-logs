...
(assert
 (distinct fuel%vstd!raw_ptr.impl&%4.view. fuel%vstd!raw_ptr.ptrs_mut_eq. fuel%vstd!seq.impl&%0.spec_index.
  ...
  fuel%vstd!view.impl&%10.view. fuel%vstd!view.impl&%12.view. fuel%vstd!view.impl&%16.view.
   ...
   (= (req%vstd!hash_set.impl&%1.new. Key&. Key&) (and
     ...
     (=>
      ...
      (forall ((k1$ Poly) (k2$ Poly)) (!
        ...
        :qid user_vstd__hash_set__impl&%1__new_0
        :skolemid skolem_user_vstd__hash_set__impl&%1__new_0
   )))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (s1! Poly) (s2! Poly)) (!
    ...
    :qid user_vstd__set__axiom_set_ext_equal_deep_12
    :skolemid skolem_user_vstd__set__axiom_set_ext_equal_deep_12
))))
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/hash-94588ed97bed1cec-test_hash_set_with_view_fails/test.rs:47:1: 47:10 (#0)
...
(push)
 ...
 (declare-const s@ test_crate!MyStruct.)
 (assert
  fuel_defaults
 )
