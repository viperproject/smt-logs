...
(assert
 (distinct fuel%vstd!std_specs.hash.axiom_bool_obeys_hash_table_key_model. fuel%vstd!std_specs.hash.axiom_u8_obeys_hash_table_key_model.
  ...
  fuel%vstd!std_specs.hash.axiom_set_contains_deref_key. fuel%vstd!std_specs.hash.axiom_set_contains_box.
  fuel%vstd!std_specs.hash.axiom_set_deref_key_to_value. fuel%vstd!std_specs.hash.axiom_set_box_key_to_value.
  fuel%vstd!std_specs.hash.axiom_set_deref_key_removed. fuel%vstd!std_specs.hash.axiom_set_box_key_removed.
  ...
  fuel%vstd!set.axiom_set_ext_equal. fuel%vstd!set.axiom_set_ext_equal_deep. fuel%vstd!view.impl&%0.view.
  ...
  fuel%vstd!view.impl&%18.view. fuel%vstd!view.impl&%24.view. fuel%vstd!array.group_array_axioms.
...
;; Datatypes
(declare-sort std!collections.hash.set.HashSet<$%2<allocator_global%./u32.>./std!hash.random.RandomState.>.
 0
)
...
(declare-sort vstd!set.Set<$%2<allocator_global%./u32.>.>. 0)
...
(declare-fun Poly%std!collections.hash.set.HashSet<$%2<allocator_global%./u32.>./std!hash.random.RandomState.>.
 (std!collections.hash.set.HashSet<$%2<allocator_global%./u32.>./std!hash.random.RandomState.>.)
 Poly
)
(declare-fun %Poly%std!collections.hash.set.HashSet<$%2<allocator_global%./u32.>./std!hash.random.RandomState.>.
 (Poly) std!collections.hash.set.HashSet<$%2<allocator_global%./u32.>./std!hash.random.RandomState.>.
)
...
(declare-fun Poly%vstd!set.Set<$%2<allocator_global%./u32.>.>. (vstd!set.Set<$%2<allocator_global%./u32.>.>.)
 Poly
)
(declare-fun %Poly%vstd!set.Set<$%2<allocator_global%./u32.>.>. (Poly) vstd!set.Set<$%2<allocator_global%./u32.>.>.)
...
(assert
 (forall ((x std!collections.hash.set.HashSet<$%2<allocator_global%./u32.>./std!hash.random.RandomState.>.))
  (!
   (= x (%Poly%std!collections.hash.set.HashSet<$%2<allocator_global%./u32.>./std!hash.random.RandomState.>.
     (Poly%std!collections.hash.set.HashSet<$%2<allocator_global%./u32.>./std!hash.random.RandomState.>.
      x
   )))
   :pattern ((Poly%std!collections.hash.set.HashSet<$%2<allocator_global%./u32.>./std!hash.random.RandomState.>.
     x
   ))
   :qid internal_std__collections__hash__set__HashSet<$__2<allocator_global__./u32.>./std!hash.random.RandomState.>_box_axiom_definition
   :skolemid skolem_internal_std__collections__hash__set__HashSet<$__2<allocator_global__./u32.>./std!hash.random.RandomState.>_box_axiom_definition
)))
(assert
 (forall ((x Poly)) (!
   (=>
    (has_type x (TYPE%std!collections.hash.set.HashSet. (BOX $ ALLOCATOR_GLOBAL $) (UINT
       32
   ...
   :pattern ((has_type x (TYPE%std!collections.hash.set.HashSet. (BOX $ ALLOCATOR_GLOBAL
       $
      ) (UINT 32) $ TYPE%std!hash.random.RandomState.
   )))
   :qid internal_std__collections__hash__set__HashSet<$__2<allocator_global__./u32.>./std!hash.random.RandomState.>_unbox_axiom_definition
   :skolemid skolem_internal_std__collections__hash__set__HashSet<$__2<allocator_global__./u32.>./std!hash.random.RandomState.>_unbox_axiom_definition
)))
(assert
 (forall ((x std!collections.hash.set.HashSet<$%2<allocator_global%./u32.>./std!hash.random.RandomState.>.))
  (!
   (has_type (Poly%std!collections.hash.set.HashSet<$%2<allocator_global%./u32.>./std!hash.random.RandomState.>.
     x
    ) (TYPE%std!collections.hash.set.HashSet. (BOX $ ALLOCATOR_GLOBAL $) (UINT 32) $ TYPE%std!hash.random.RandomState.)
   )
   :pattern ((has_type (Poly%std!collections.hash.set.HashSet<$%2<allocator_global%./u32.>./std!hash.random.RandomState.>.
      x
     ) (TYPE%std!collections.hash.set.HashSet. (BOX $ ALLOCATOR_GLOBAL $) (UINT 32) $ TYPE%std!hash.random.RandomState.)
   ))
   :qid internal_std__collections__hash__set__HashSet<$__2<allocator_global__./u32.>./std!hash.random.RandomState.>_has_type_always_definition
   :skolemid skolem_internal_std__collections__hash__set__HashSet<$__2<allocator_global__./u32.>./std!hash.random.RandomState.>_has_type_always_definition
)))
(assert
...
(assert
 (forall ((x vstd!set.Set<$%2<allocator_global%./u32.>.>.)) (!
   (= x (%Poly%vstd!set.Set<$%2<allocator_global%./u32.>.>. (Poly%vstd!set.Set<$%2<allocator_global%./u32.>.>.
      x
   )))
   :pattern ((Poly%vstd!set.Set<$%2<allocator_global%./u32.>.>. x))
   :qid internal_vstd__set__Set<$__2<allocator_global__./u32.>.>_box_axiom_definition
   :skolemid skolem_internal_vstd__set__Set<$__2<allocator_global__./u32.>.>_box_axiom_definition
)))
(assert
 (forall ((x Poly)) (!
   (=>
    (has_type x (TYPE%vstd!set.Set. (BOX $ ALLOCATOR_GLOBAL $) (UINT 32)))
    (= x (Poly%vstd!set.Set<$%2<allocator_global%./u32.>.>. (%Poly%vstd!set.Set<$%2<allocator_global%./u32.>.>.
       x
   ))))
   :pattern ((has_type x (TYPE%vstd!set.Set. (BOX $ ALLOCATOR_GLOBAL $) (UINT 32))))
   :qid internal_vstd__set__Set<$__2<allocator_global__./u32.>.>_unbox_axiom_definition
   :skolemid skolem_internal_vstd__set__Set<$__2<allocator_global__./u32.>.>_unbox_axiom_definition
)))
(assert
 (forall ((x vstd!set.Set<$%2<allocator_global%./u32.>.>.)) (!
   (has_type (Poly%vstd!set.Set<$%2<allocator_global%./u32.>.>. x) (TYPE%vstd!set.Set.
     (BOX $ ALLOCATOR_GLOBAL $) (UINT 32)
   ))
   :pattern ((has_type (Poly%vstd!set.Set<$%2<allocator_global%./u32.>.>. x) (TYPE%vstd!set.Set.
      (BOX $ ALLOCATOR_GLOBAL $) (UINT 32)
   )))
   :qid internal_vstd__set__Set<$__2<allocator_global__./u32.>.>_has_type_always_definition
   :skolemid skolem_internal_vstd__set__Set<$__2<allocator_global__./u32.>.>_has_type_always_definition
)))
(assert
...
(assert
 (=>
  ...
  (forall ((Q&. Dcr) (Q& Type) (m! Poly) (k! Poly)) (!
    ...
    :qid user_vstd__std_specs__hash__axiom_set_contains_deref_key_6
    :skolemid skolem_user_vstd__std_specs__hash__axiom_set_contains_deref_key_6
))))
...
(assert
 (=>
  ...
  (forall ((Q&. Dcr) (Q& Type) (m! Poly) (k! Poly)) (!
    ...
    :qid user_vstd__std_specs__hash__axiom_set_contains_box_7
    :skolemid skolem_user_vstd__std_specs__hash__axiom_set_contains_box_7
))))
...
(assert
 (=>
  ...
  (forall ((Q&. Dcr) (Q& Type) (m! Poly) (k! Poly) (v! Poly)) (!
    ...
    :qid user_vstd__std_specs__hash__axiom_set_deref_key_to_value_8
    :skolemid skolem_user_vstd__std_specs__hash__axiom_set_deref_key_to_value_8
))))
...
(assert
 (=>
  ...
  (forall ((Q&. Dcr) (Q& Type) (m! Poly) (q! Poly) (v! Poly)) (!
    ...
    :qid user_vstd__std_specs__hash__axiom_set_box_key_to_value_9
    :skolemid skolem_user_vstd__std_specs__hash__axiom_set_box_key_to_value_9
))))
...
(assert
 (=>
  ...
  (forall ((Q&. Dcr) (Q& Type) (old_m! Poly) (new_m! Poly) (k! Poly)) (!
    ...
    :qid user_vstd__std_specs__hash__axiom_set_deref_key_removed_10
    :skolemid skolem_user_vstd__std_specs__hash__axiom_set_deref_key_removed_10
))))
...
(assert
 (=>
  ...
  (forall ((Q&. Dcr) (Q& Type) (old_m! Poly) (new_m! Poly) (q! Poly)) (!
    ...
    :qid user_vstd__std_specs__hash__axiom_set_box_key_removed_11
    :skolemid skolem_user_vstd__std_specs__hash__axiom_set_box_key_removed_11
))))
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/hash-94588ed97bed1cec-test_hash_set_box/test.rs:18:1: 18:10 (#0)
...
(push)
 ...
 (declare-const m@0 std!collections.hash.set.HashSet<$%2<allocator_global%./u32.>./std!hash.random.RandomState.>.)
 ...
 (declare-const m@1 std!collections.hash.set.HashSet<$%2<allocator_global%./u32.>./std!hash.random.RandomState.>.)
 (declare-const m@2 std!collections.hash.set.HashSet<$%2<allocator_global%./u32.>./std!hash.random.RandomState.>.)
 (declare-const m@3 std!collections.hash.set.HashSet<$%2<allocator_global%./u32.>./std!hash.random.RandomState.>.)
 (declare-const m@4 std!collections.hash.set.HashSet<$%2<allocator_global%./u32.>./std!hash.random.RandomState.>.)
 (declare-const m@5 std!collections.hash.set.HashSet<$%2<allocator_global%./u32.>./std!hash.random.RandomState.>.)
 (declare-const m@6 std!collections.hash.set.HashSet<$%2<allocator_global%./u32.>./std!hash.random.RandomState.>.)
 ...
 (assert
  (not (=>
    ...
    (=>
     (ens%std!collections.hash.set.impl&%0.new. (BOX $ ALLOCATOR_GLOBAL $) (UINT 32) tmp%1)
     (=>
      (= m@0 (%Poly%std!collections.hash.set.HashSet<$%2<allocator_global%./u32.>./std!hash.random.RandomState.>.
        tmp%1
      ))
      (=>
       (= tmp%2 (ext_eq false (TYPE%vstd!set.Set. (BOX $ ALLOCATOR_GLOBAL $) (UINT 32)) (vstd!view.View.view.?
          $ (TYPE%std!collections.hash.set.HashSet. (BOX $ ALLOCATOR_GLOBAL $) (UINT 32) $ TYPE%std!hash.random.RandomState.)
          (Poly%std!collections.hash.set.HashSet<$%2<allocator_global%./u32.>./std!hash.random.RandomState.>.
           m@0
          )
         ) (vstd!set.impl&%0.empty.? (BOX $ ALLOCATOR_GLOBAL $) (UINT 32))
       ))
       (and
        (=>
         %%location_label%%0
          ...
          (=>
           ...
           (=>
            ...
            (=>
             (= six@ (%I tmp%4))
             (=>
              (ens%std!collections.hash.set.impl&%2.insert. (BOX $ ALLOCATOR_GLOBAL $) (UINT 32)
               $ TYPE%std!hash.random.RandomState. (Poly%std!collections.hash.set.HashSet<$%2<allocator_global%./u32.>./std!hash.random.RandomState.>.
                m@0
               ) (Poly%std!collections.hash.set.HashSet<$%2<allocator_global%./u32.>./std!hash.random.RandomState.>.
                m@1
               ) (I three@) res@
              ...
              (and
               ...
               (=>
                ...
                (=>
                 ...
                 (=>
                  (ens%alloc!boxed.impl&%0.new. $ (UINT 32) (I 3) tmp%6)
                  (=>
                   (ens%std!collections.hash.set.impl&%2.insert. (BOX $ ALLOCATOR_GLOBAL $) (UINT 32)
                    $ TYPE%std!hash.random.RandomState. (Poly%std!collections.hash.set.HashSet<$%2<allocator_global%./u32.>./std!hash.random.RandomState.>.
                     m@2
                   ...
                   (and
                    ...
                    (=>
                     (not res$1@)
                     (=>
                      (ens%std!collections.hash.set.impl&%2.contains. (BOX $ ALLOCATOR_GLOBAL $) (UINT 32)
                       $ TYPE%std!hash.random.RandomState. $ (UINT 32) (Poly%std!collections.hash.set.HashSet<$%2<allocator_global%./u32.>./std!hash.random.RandomState.>.
                        m@3
                       ) (I 3) b@
                      )
                      (and
                       ...
                       (=>
                        b@
                        (=>
                         (ens%std!collections.hash.set.impl&%2.get. (BOX $ ALLOCATOR_GLOBAL $) (UINT 32) $
                          TYPE%std!hash.random.RandomState. $ (UINT 32) (Poly%std!collections.hash.set.HashSet<$%2<allocator_global%./u32.>./std!hash.random.RandomState.>.
                           m@3
                          ) (I 6) v@
                         )
                         (or
                          ...
                          (and
                           (not %%switch_label%%0)
                           (=>
                            (ens%std!collections.hash.set.impl&%2.remove. (BOX $ ALLOCATOR_GLOBAL $) (UINT 32)
                             $ TYPE%std!hash.random.RandomState. $ (UINT 32) (Poly%std!collections.hash.set.HashSet<$%2<allocator_global%./u32.>./std!hash.random.RandomState.>.
                              m@3
                             ) (Poly%std!collections.hash.set.HashSet<$%2<allocator_global%./u32.>./std!hash.random.RandomState.>.
                              m@4
                              ...
                              (=>
                               ...
                               (and
                                ...
                                (=>
                                 (not res$3@)
                                 (=>
                                  (= tmp%8 (not (vstd!set.impl&%0.contains.? (BOX $ ALLOCATOR_GLOBAL $) (UINT 32) (vstd!view.View.view.?
                                      $ (TYPE%std!collections.hash.set.HashSet. (BOX $ ALLOCATOR_GLOBAL $) (UINT 32) $ TYPE%std!hash.random.RandomState.)
                                      (Poly%std!collections.hash.set.HashSet<$%2<allocator_global%./u32.>./std!hash.random.RandomState.>.
                                       m@5
                                      )
                                  ...
                                  (and
                                   ...
                                   (=>
                                    tmp%8
                                    (=>
                                     (= tmp%9 (vstd!set.impl&%0.contains.? (BOX $ ALLOCATOR_GLOBAL $) (UINT 32) (vstd!view.View.view.?
                                        $ (TYPE%std!collections.hash.set.HashSet. (BOX $ ALLOCATOR_GLOBAL $) (UINT 32) $ TYPE%std!hash.random.RandomState.)
                                        (Poly%std!collections.hash.set.HashSet<$%2<allocator_global%./u32.>./std!hash.random.RandomState.>.
                                         m@5
                                        )
                                     ...
                                     (and
                                      ...
                                      (=>
                                       tmp%9
                                       (=>
                                        (ens%std!collections.hash.set.impl&%1.clear. (BOX $ ALLOCATOR_GLOBAL $) (UINT 32)
                                         $ TYPE%std!hash.random.RandomState. (Poly%std!collections.hash.set.HashSet<$%2<allocator_global%./u32.>./std!hash.random.RandomState.>.
                                          m@5
                                         ) (Poly%std!collections.hash.set.HashSet<$%2<allocator_global%./u32.>./std!hash.random.RandomState.>.
                                          m@6
