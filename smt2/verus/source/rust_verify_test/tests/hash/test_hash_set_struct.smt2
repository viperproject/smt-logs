...
(assert
 (distinct fuel%vstd!std_specs.hash.axiom_bool_obeys_hash_table_key_model. fuel%vstd!std_specs.hash.axiom_u8_obeys_hash_table_key_model.
  ...
  fuel%vstd!std_specs.hash.axiom_random_state_builds_valid_hashers. fuel%vstd!std_specs.hash.axiom_set_contains_deref_key.
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/hash-94588ed97bed1cec-test_hash_set_struct/test.rs:38:1: 38:10 (#0)
...
(push)
 ...
 (declare-const tmp%7 test_crate!MyStruct.)
 ...
 (declare-const m@2 std!collections.hash.set.HashSet<test_crate!MyStruct./std!hash.random.RandomState.>.)
 (declare-const m@3 std!collections.hash.set.HashSet<test_crate!MyStruct./std!hash.random.RandomState.>.)
 (declare-const m@4 std!collections.hash.set.HashSet<test_crate!MyStruct./std!hash.random.RandomState.>.)
 (declare-const m@5 std!collections.hash.set.HashSet<test_crate!MyStruct./std!hash.random.RandomState.>.)
 (declare-const m@6 std!collections.hash.set.HashSet<test_crate!MyStruct./std!hash.random.RandomState.>.)
    ...
    (=>
     ...
     (=>
      ...
      (=>
       ...
       (=>
        (= tmp%2 (ext_eq false (TYPE%vstd!set.Set. $ TYPE%test_crate!MyStruct.) (vstd!view.View.view.?
           $ (TYPE%std!collections.hash.set.HashSet. $ TYPE%test_crate!MyStruct. $ TYPE%std!hash.random.RandomState.)
           (Poly%std!collections.hash.set.HashSet<test_crate!MyStruct./std!hash.random.RandomState.>.
            m@0
           )
          ) (vstd!set.impl&%0.empty.? $ TYPE%test_crate!MyStruct.)
        ))
        (and
         (=>
          %%location_label%%0
           ...
           (=>
            (ens%std!collections.hash.set.impl&%2.insert. $ TYPE%test_crate!MyStruct. $ TYPE%std!hash.random.RandomState.
             (Poly%std!collections.hash.set.HashSet<test_crate!MyStruct./std!hash.random.RandomState.>.
              ...
              m@1
             ) (Poly%test_crate!MyStruct. s1@) res@
            )
            (and
             (=>
              %%location_label%%1
               ...
               (=>
                (ens%std!collections.hash.set.impl&%2.insert. $ TYPE%test_crate!MyStruct. $ TYPE%std!hash.random.RandomState.
                 (Poly%std!collections.hash.set.HashSet<test_crate!MyStruct./std!hash.random.RandomState.>.
                  ...
                  m@2
                 ) (Poly%test_crate!MyStruct. tmp%3) res$1@
                )
                (and
                 (=>
                  %%location_label%%2
                 ...
                 (=>
                  ...
                  (=>
                   ...
                   (=>
                    (= tmp%4 (vstd!set.impl&%0.contains.? $ TYPE%test_crate!MyStruct. (vstd!view.View.view.?
                       $ (TYPE%std!collections.hash.set.HashSet. $ TYPE%test_crate!MyStruct. $ TYPE%std!hash.random.RandomState.)
                       (Poly%std!collections.hash.set.HashSet<test_crate!MyStruct./std!hash.random.RandomState.>.
                        m@2
                       )
                    ...
                    (and
                     ...
                     (=>
                      tmp%4
                      (=>
                       (ens%std!collections.hash.set.impl&%2.contains. $ TYPE%test_crate!MyStruct. $ TYPE%std!hash.random.RandomState.
                        $ TYPE%test_crate!MyStruct. (Poly%std!collections.hash.set.HashSet<test_crate!MyStruct./std!hash.random.RandomState.>.
                         m@2
                       ...
                       (and
                        ...
                        (=>
                         b@
                         (=>
                          (ens%std!collections.hash.set.impl&%2.get. $ TYPE%test_crate!MyStruct. $ TYPE%std!hash.random.RandomState.
                           $ TYPE%test_crate!MyStruct. (Poly%std!collections.hash.set.HashSet<test_crate!MyStruct./std!hash.random.RandomState.>.
                            m@2
                          ...
                          (or
                           ...
                           (and
                            (not %%switch_label%%0)
                            (=>
                             (= s3@ (test_crate!MyStruct./MyStruct (%I (I 9)) (%I (I 9))))
                             (=>
                              (= tmp%7 (test_crate!MyStruct./MyStruct (%I (I 9)) (%I (I 9))))
                              (=>
                               (ens%std!collections.hash.set.impl&%2.insert. $ TYPE%test_crate!MyStruct. $ TYPE%std!hash.random.RandomState.
                                (Poly%std!collections.hash.set.HashSet<test_crate!MyStruct./std!hash.random.RandomState.>.
                                 m@2
                                 ...
                                 m@3
                                ) (Poly%test_crate!MyStruct. tmp%7) tmp%6
                               )
                               (=>
                                (ens%std!collections.hash.set.impl&%2.remove. $ TYPE%test_crate!MyStruct. $ TYPE%std!hash.random.RandomState.
                                 $ TYPE%test_crate!MyStruct. (Poly%std!collections.hash.set.HashSet<test_crate!MyStruct./std!hash.random.RandomState.>.
                                  m@3
                                 ) (Poly%std!collections.hash.set.HashSet<test_crate!MyStruct./std!hash.random.RandomState.>.
                                  m@4
                                 ) (Poly%test_crate!MyStruct. s3@) res$2@
                                )
                                (and
                                 (=>
                                  %%location_label%%7
                                  ...
                                  (=>
                                   (ens%std!collections.hash.set.impl&%2.remove. $ TYPE%test_crate!MyStruct. $ TYPE%std!hash.random.RandomState.
                                    $ TYPE%test_crate!MyStruct. (Poly%std!collections.hash.set.HashSet<test_crate!MyStruct./std!hash.random.RandomState.>.
                                     ...
                                     m@5
                                    ) (Poly%test_crate!MyStruct. s3@) res$3@
                                   )
                                   (and
                                    (=>
                                     %%location_label%%8
                                    ...
                                    (=>
                                     (not res$3@)
                                     (=>
                                      (ens%std!collections.hash.set.impl&%1.clear. $ TYPE%test_crate!MyStruct. $ TYPE%std!hash.random.RandomState.
                                       (Poly%std!collections.hash.set.HashSet<test_crate!MyStruct./std!hash.random.RandomState.>.
                                        m@5
                                       ) (Poly%std!collections.hash.set.HashSet<test_crate!MyStruct./std!hash.random.RandomState.>.
                                        m@6
                                      ...
                                      (=>
                                       (= tmp%8 (not (vstd!set.impl&%0.contains.? $ TYPE%test_crate!MyStruct. (vstd!view.View.view.?
                                           $ (TYPE%std!collections.hash.set.HashSet. $ TYPE%test_crate!MyStruct. $ TYPE%std!hash.random.RandomState.)
                                           (Poly%std!collections.hash.set.HashSet<test_crate!MyStruct./std!hash.random.RandomState.>.
                                            m@6
                                           )
