...
(declare-const fuel%vstd!std_specs.hash.axiom_spec_hash_map_len. FuelId)
...
(assert
 (distinct fuel%vstd!std_specs.hash.axiom_bool_obeys_hash_table_key_model. fuel%vstd!std_specs.hash.axiom_u8_obeys_hash_table_key_model.
  ...
  fuel%vstd!std_specs.hash.axiom_spec_hash_map_len. fuel%vstd!std_specs.hash.axiom_contains_deref_key.
  fuel%vstd!std_specs.hash.axiom_contains_box. fuel%vstd!std_specs.hash.axiom_maps_deref_key_to_value.
  fuel%vstd!std_specs.hash.axiom_maps_box_key_to_value. fuel%vstd!std_specs.hash.axiom_deref_key_removed.
  fuel%vstd!std_specs.hash.axiom_box_key_removed. fuel%vstd!map.impl&%0.spec_index.
  ...
  fuel%vstd!view.impl&%12.view. fuel%vstd!view.impl&%14.view. fuel%vstd!view.impl&%18.view.
  fuel%vstd!view.impl&%24.view. fuel%vstd!view.impl&%26.view. fuel%vstd!array.group_array_axioms.
...
(assert
 (=>
  ...
  (and
   ...
   (fuel_bool_default fuel%vstd!std_specs.hash.axiom_spec_hash_map_len.)
)))
(assert
...
;; Datatypes
(declare-sort std!collections.hash.map.HashMap<u32./i8./std!hash.random.RandomState.>.
 0
)
(declare-sort std!hash.random.DefaultHasher. 0)
(declare-sort std!hash.random.RandomState. 0)
(declare-sort vstd!map.Map<u32./i8.>. 0)
...
(declare-fun Poly%std!collections.hash.map.HashMap<u32./i8./std!hash.random.RandomState.>.
 (std!collections.hash.map.HashMap<u32./i8./std!hash.random.RandomState.>.) Poly
)
(declare-fun %Poly%std!collections.hash.map.HashMap<u32./i8./std!hash.random.RandomState.>.
 (Poly) std!collections.hash.map.HashMap<u32./i8./std!hash.random.RandomState.>.
)
...
(declare-fun Poly%vstd!map.Map<u32./i8.>. (vstd!map.Map<u32./i8.>.) Poly)
(declare-fun %Poly%vstd!map.Map<u32./i8.>. (Poly) vstd!map.Map<u32./i8.>.)
...
(assert
 (forall ((x std!collections.hash.map.HashMap<u32./i8./std!hash.random.RandomState.>.))
  (!
   (= x (%Poly%std!collections.hash.map.HashMap<u32./i8./std!hash.random.RandomState.>.
     (Poly%std!collections.hash.map.HashMap<u32./i8./std!hash.random.RandomState.>. x)
   ))
   :pattern ((Poly%std!collections.hash.map.HashMap<u32./i8./std!hash.random.RandomState.>.
     x
   ))
   :qid internal_std__collections__hash__map__HashMap<u32./i8./std!hash.random.RandomState.>_box_axiom_definition
   :skolemid skolem_internal_std__collections__hash__map__HashMap<u32./i8./std!hash.random.RandomState.>_box_axiom_definition
)))
(assert
 (forall ((x Poly)) (!
   (=>
    (has_type x (TYPE%std!collections.hash.map.HashMap. $ (UINT 32) $ (SINT 8) $ TYPE%std!hash.random.RandomState.))
    (= x (Poly%std!collections.hash.map.HashMap<u32./i8./std!hash.random.RandomState.>.
      (%Poly%std!collections.hash.map.HashMap<u32./i8./std!hash.random.RandomState.>. x)
   )))
   :pattern ((has_type x (TYPE%std!collections.hash.map.HashMap. $ (UINT 32) $ (SINT 8)
      $ TYPE%std!hash.random.RandomState.
   )))
   :qid internal_std__collections__hash__map__HashMap<u32./i8./std!hash.random.RandomState.>_unbox_axiom_definition
   :skolemid skolem_internal_std__collections__hash__map__HashMap<u32./i8./std!hash.random.RandomState.>_unbox_axiom_definition
)))
(assert
 (forall ((x std!collections.hash.map.HashMap<u32./i8./std!hash.random.RandomState.>.))
  (!
   (has_type (Poly%std!collections.hash.map.HashMap<u32./i8./std!hash.random.RandomState.>.
     x
    ) (TYPE%std!collections.hash.map.HashMap. $ (UINT 32) $ (SINT 8) $ TYPE%std!hash.random.RandomState.)
   )
   :pattern ((has_type (Poly%std!collections.hash.map.HashMap<u32./i8./std!hash.random.RandomState.>.
      x
     ) (TYPE%std!collections.hash.map.HashMap. $ (UINT 32) $ (SINT 8) $ TYPE%std!hash.random.RandomState.)
   ))
   :qid internal_std__collections__hash__map__HashMap<u32./i8./std!hash.random.RandomState.>_has_type_always_definition
   :skolemid skolem_internal_std__collections__hash__map__HashMap<u32./i8./std!hash.random.RandomState.>_has_type_always_definition
)))
(assert
...
(assert
 (forall ((x vstd!map.Map<u32./i8.>.)) (!
   (= x (%Poly%vstd!map.Map<u32./i8.>. (Poly%vstd!map.Map<u32./i8.>. x)))
   :pattern ((Poly%vstd!map.Map<u32./i8.>. x))
   :qid internal_vstd__map__Map<u32./i8.>_box_axiom_definition
   :skolemid skolem_internal_vstd__map__Map<u32./i8.>_box_axiom_definition
)))
(assert
 (forall ((x Poly)) (!
   (=>
    (has_type x (TYPE%vstd!map.Map. $ (UINT 32) $ (SINT 8)))
    (= x (Poly%vstd!map.Map<u32./i8.>. (%Poly%vstd!map.Map<u32./i8.>. x)))
   )
   :pattern ((has_type x (TYPE%vstd!map.Map. $ (UINT 32) $ (SINT 8))))
   :qid internal_vstd__map__Map<u32./i8.>_unbox_axiom_definition
   :skolemid skolem_internal_vstd__map__Map<u32./i8.>_unbox_axiom_definition
)))
(assert
 (forall ((x vstd!map.Map<u32./i8.>.)) (!
   (has_type (Poly%vstd!map.Map<u32./i8.>. x) (TYPE%vstd!map.Map. $ (UINT 32) $ (SINT 8)))
   :pattern ((has_type (Poly%vstd!map.Map<u32./i8.>. x) (TYPE%vstd!map.Map. $ (UINT 32)
      $ (SINT 8)
   )))
   :qid internal_vstd__map__Map<u32./i8.>_has_type_always_definition
   :skolemid skolem_internal_vstd__map__Map<u32./i8.>_has_type_always_definition
)))
(assert
...
;; Function-Decl vstd::std_specs::hash::spec_hash_map_len
(declare-fun vstd!std_specs.hash.spec_hash_map_len.? (Dcr Type Dcr Type Dcr Type Poly)
 Int
)
...
;; Function-Axioms vstd::std_specs::hash::spec_hash_map_len
(assert
 (forall ((Key&. Dcr) (Key& Type) (Value&. Dcr) (Value& Type) (S&. Dcr) (S& Type) (m!
    Poly
   )
  ) (!
   (=>
    ...
    (uInv SZ (vstd!std_specs.hash.spec_hash_map_len.? Key&. Key& Value&. Value& S&. S&
      m!
   )))
   :pattern ((vstd!std_specs.hash.spec_hash_map_len.? Key&. Key& Value&. Value& S&. S&
     m!
   ))
   :qid internal_vstd!std_specs.hash.spec_hash_map_len.?_pre_post_definition
   :skolemid skolem_internal_vstd!std_specs.hash.spec_hash_map_len.?_pre_post_definition
)))
...
;; Broadcast vstd::std_specs::hash::axiom_spec_hash_map_len
(assert
 (=>
  (fuel_bool fuel%vstd!std_specs.hash.axiom_spec_hash_map_len.)
  (forall ((Key&. Dcr) (Key& Type) (Value&. Dcr) (Value& Type) (S&. Dcr) (S& Type) (m!
     Poly
    )
   ) (!
    (=>
     ...
     (=>
      ...
      (= (vstd!std_specs.hash.spec_hash_map_len.? Key&. Key& Value&. Value& S&. S& m!) (
        vstd!map.impl&%0.len.? Key&. Key& Value&. Value& (vstd!view.View.view.? $ (TYPE%std!collections.hash.map.HashMap.
    ...
    :qid user_vstd__std_specs__hash__axiom_spec_hash_map_len_7
    :skolemid skolem_user_vstd__std_specs__hash__axiom_spec_hash_map_len_7
))))

;; Function-Specs std::collections::hash::map::impl&%1::len
(declare-fun ens%std!collections.hash.map.impl&%1.len. (Dcr Type Dcr Type Dcr Type
  Poly Int
 ) Bool
)
(assert
 (forall ((Key&. Dcr) (Key& Type) (Value&. Dcr) (Value& Type) (S&. Dcr) (S& Type) (m!
   ...
   (= (ens%std!collections.hash.map.impl&%1.len. Key&. Key& Value&. Value& S&. S& m! len!)
    (and
     (uInv SZ len!)
     (= len! (vstd!std_specs.hash.spec_hash_map_len.? Key&. Key& Value&. Value& S&. S& m!))
   ))
   :pattern ((ens%std!collections.hash.map.impl&%1.len. Key&. Key& Value&. Value& S&.
     S& m! len!
   ))
   :qid internal_ens__std!collections.hash.map.impl&__1.len._definition
   :skolemid skolem_internal_ens__std!collections.hash.map.impl&__1.len._definition
)))
...
(assert
 (=>
  ...
  (forall ((Q&. Dcr) (Q& Type) (Value&. Dcr) (Value& Type) (m! Poly) (k! Poly)) (!
    ...
    :qid user_vstd__std_specs__hash__axiom_contains_deref_key_8
    :skolemid skolem_user_vstd__std_specs__hash__axiom_contains_deref_key_8
))))
...
(assert
 (=>
  ...
  (forall ((Q&. Dcr) (Q& Type) (Value&. Dcr) (Value& Type) (m! Poly) (k! Poly)) (!
    ...
    :qid user_vstd__std_specs__hash__axiom_contains_box_9
    :skolemid skolem_user_vstd__std_specs__hash__axiom_contains_box_9
))))
 ...
 (=>
  ...
  (forall ((Q&. Dcr) (Q& Type) (Value&. Dcr) (Value& Type) (m! Poly) (k! Poly) (v! Poly))
   (!
    ...
    :qid user_vstd__std_specs__hash__axiom_maps_deref_key_to_value_10
    :skolemid skolem_user_vstd__std_specs__hash__axiom_maps_deref_key_to_value_10
))))
 ...
 (=>
  ...
  (forall ((Q&. Dcr) (Q& Type) (Value&. Dcr) (Value& Type) (m! Poly) (q! Poly) (v! Poly))
   (!
    ...
    :qid user_vstd__std_specs__hash__axiom_maps_box_key_to_value_11
    :skolemid skolem_user_vstd__std_specs__hash__axiom_maps_box_key_to_value_11
))))
...
(assert
 (=>
  ...
  (forall ((Q&. Dcr) (Q& Type) (Value&. Dcr) (Value& Type) (old_m! Poly) (new_m! Poly)
    ...
    :qid user_vstd__std_specs__hash__axiom_deref_key_removed_12
    :skolemid skolem_user_vstd__std_specs__hash__axiom_deref_key_removed_12
))))
...
(assert
 (=>
  ...
  (forall ((Q&. Dcr) (Q& Type) (Value&. Dcr) (Value& Type) (old_m! Poly) (new_m! Poly)
    ...
    :qid user_vstd__std_specs__hash__axiom_box_key_removed_13
    :skolemid skolem_user_vstd__std_specs__hash__axiom_box_key_removed_13
))))
...
(assert
 (=>
  ...
  (forall ((K&. Dcr) (K& Type) (V&. Dcr) (V& Type) (m! Poly) (key! Poly)) (!
    ...
    :qid user_vstd__map__axiom_map_index_decreases_finite_14
    :skolemid skolem_user_vstd__map__axiom_map_index_decreases_finite_14
))))
...
(assert
 (=>
  ...
  (forall ((K&. Dcr) (K& Type) (V&. Dcr) (V& Type) (m! Poly) (key! Poly)) (!
    ...
    :pattern ((height (vstd!map.impl&%0.index.? K&. K& V&. V& m! key!)))
    :qid user_vstd__map__axiom_map_index_decreases_infinite_15
    :skolemid skolem_user_vstd__map__axiom_map_index_decreases_infinite_15
))))
...
(assert
 (=>
  ...
  (forall ((K&. Dcr) (K& Type) (V&. Dcr) (V& Type)) (!
    ...
    :qid user_vstd__map__axiom_map_empty_16
    :skolemid skolem_user_vstd__map__axiom_map_empty_16
))))
 ...
 (=>
  ...
  (forall ((K&. Dcr) (K& Type) (V&. Dcr) (V& Type) (m! Poly) (key! Poly) (value! Poly))
   (!
    ...
    :qid user_vstd__map__axiom_map_insert_domain_17
    :skolemid skolem_user_vstd__map__axiom_map_insert_domain_17
))))
 ...
 (=>
  ...
  (forall ((K&. Dcr) (K& Type) (V&. Dcr) (V& Type) (m! Poly) (key! Poly) (value! Poly))
   (!
    ...
    :qid user_vstd__map__axiom_map_insert_same_18
    :skolemid skolem_user_vstd__map__axiom_map_insert_same_18
))))
...
(assert
 (=>
  ...
  (forall ((K&. Dcr) (K& Type) (V&. Dcr) (V& Type) (m! Poly) (key1! Poly) (key2! Poly)
    ...
    :qid user_vstd__map__axiom_map_insert_different_19
    :skolemid skolem_user_vstd__map__axiom_map_insert_different_19
))))
...
(assert
 (=>
  ...
  (forall ((K&. Dcr) (K& Type) (V&. Dcr) (V& Type) (m! Poly) (key! Poly)) (!
    ...
    :qid user_vstd__map__axiom_map_remove_domain_20
    :skolemid skolem_user_vstd__map__axiom_map_remove_domain_20
))))
 ...
 (=>
  ...
  (forall ((K&. Dcr) (K& Type) (V&. Dcr) (V& Type) (m! Poly) (key1! Poly) (key2! Poly))
   (!
    ...
    :qid user_vstd__map__axiom_map_remove_different_21
    :skolemid skolem_user_vstd__map__axiom_map_remove_different_21
))))
...
(assert
 (=>
  ...
  (forall ((K&. Dcr) (K& Type) (V&. Dcr) (V& Type) (m1! Poly) (m2! Poly)) (!
    ...
    :qid user_vstd__map__axiom_map_ext_equal_23
    :skolemid skolem_user_vstd__map__axiom_map_ext_equal_23
))))
...
(assert
 (=>
  ...
  (forall ((K&. Dcr) (K& Type) (V&. Dcr) (V& Type) (m1! Poly) (m2! Poly)) (!
    ...
    :qid user_vstd__map__axiom_map_ext_equal_deep_25
    :skolemid skolem_user_vstd__map__axiom_map_ext_equal_deep_25
))))
...
(assert
 (=>
  ...
  (forall ((T&. Dcr) (T& Type) (a! Poly)) (!
    ...
    :qid user_vstd__raw_ptr__ptrs_mut_eq_26
    :skolemid skolem_user_vstd__raw_ptr__ptrs_mut_eq_26
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (s! Poly) (i! Poly)) (!
    ...
    :qid user_vstd__seq__axiom_seq_index_decreases_27
    :skolemid skolem_user_vstd__seq__axiom_seq_index_decreases_27
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (s1! Poly) (s2! Poly)) (!
    ...
    :qid user_vstd__seq__axiom_seq_ext_equal_29
    :skolemid skolem_user_vstd__seq__axiom_seq_ext_equal_29
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (s1! Poly) (s2! Poly)) (!
    ...
    :qid user_vstd__seq__axiom_seq_ext_equal_deep_31
    :skolemid skolem_user_vstd__seq__axiom_seq_ext_equal_deep_31
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (s! Poly) (a! Poly)) (!
    ...
    :qid user_vstd__set__axiom_set_insert_same_33
    :skolemid skolem_user_vstd__set__axiom_set_insert_same_33
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (s! Poly) (a1! Poly) (a2! Poly)) (!
    ...
    :qid user_vstd__set__axiom_set_insert_different_34
    :skolemid skolem_user_vstd__set__axiom_set_insert_different_34
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (s! Poly) (a! Poly)) (!
    ...
    :qid user_vstd__set__axiom_set_remove_same_35
    :skolemid skolem_user_vstd__set__axiom_set_remove_same_35
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (s! Poly) (a! Poly)) (!
    ...
    :qid user_vstd__set__axiom_set_remove_insert_36
    :skolemid skolem_user_vstd__set__axiom_set_remove_insert_36
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (s! Poly) (a1! Poly) (a2! Poly)) (!
    ...
    :qid user_vstd__set__axiom_set_remove_different_37
    :skolemid skolem_user_vstd__set__axiom_set_remove_different_37
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (s1! Poly) (s2! Poly)) (!
    ...
    :qid user_vstd__set__axiom_set_ext_equal_39
    :skolemid skolem_user_vstd__set__axiom_set_ext_equal_39
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (s1! Poly) (s2! Poly)) (!
    ...
    :qid user_vstd__set__axiom_set_ext_equal_deep_40
    :skolemid skolem_user_vstd__set__axiom_set_ext_equal_deep_40
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type)) (!
    ...
    :qid user_vstd__set__axiom_set_empty_finite_41
    :skolemid skolem_user_vstd__set__axiom_set_empty_finite_41
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (s! Poly) (a! Poly)) (!
    ...
    :qid user_vstd__set__axiom_set_insert_finite_42
    :skolemid skolem_user_vstd__set__axiom_set_insert_finite_42
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (s! Poly) (a! Poly)) (!
    ...
    :qid user_vstd__set__axiom_set_remove_finite_43
    :skolemid skolem_user_vstd__set__axiom_set_remove_finite_43
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type)) (!
    ...
    :qid user_vstd__set__axiom_set_empty_len_44
    :skolemid skolem_user_vstd__set__axiom_set_empty_len_44
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (s! Poly) (a! Poly)) (!
    ...
    :qid user_vstd__set__axiom_set_insert_len_45
    :skolemid skolem_user_vstd__set__axiom_set_insert_len_45
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (s! Poly) (a! Poly)) (!
    ...
    :qid user_vstd__set__axiom_set_remove_len_46
    :skolemid skolem_user_vstd__set__axiom_set_remove_len_46
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (s! Poly) (a! Poly)) (!
    ...
    :qid user_vstd__set__axiom_set_contains_len_47
    :skolemid skolem_user_vstd__set__axiom_set_contains_len_47
))))
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/hash-94588ed97bed1cec-test_hash_map/test.rs:17:1: 17:10 (#0)
...
(push)
 ...
 (declare-const m@0 std!collections.hash.map.HashMap<u32./i8./std!hash.random.RandomState.>.)
 ...
 (declare-const m@1 std!collections.hash.map.HashMap<u32./i8./std!hash.random.RandomState.>.)
 (declare-const m@2 std!collections.hash.map.HashMap<u32./i8./std!hash.random.RandomState.>.)
 (declare-const m@3 std!collections.hash.map.HashMap<u32./i8./std!hash.random.RandomState.>.)
 (declare-const m@4 std!collections.hash.map.HashMap<u32./i8./std!hash.random.RandomState.>.)
 ...
 (assert
  (not (=>
    ...
    (=>
     (ens%std!collections.hash.map.impl&%0.new. $ (UINT 32) $ (SINT 8) tmp%1)
     (=>
      (= m@0 (%Poly%std!collections.hash.map.HashMap<u32./i8./std!hash.random.RandomState.>.
        tmp%1
      ))
      (=>
       (= tmp%2 (ext_eq false (TYPE%vstd!map.Map. $ (UINT 32) $ (SINT 8)) (vstd!view.View.view.?
          $ (TYPE%std!collections.hash.map.HashMap. $ (UINT 32) $ (SINT 8) $ TYPE%std!hash.random.RandomState.)
          (Poly%std!collections.hash.map.HashMap<u32./i8./std!hash.random.RandomState.>. m@0)
         ) (vstd!map.impl&%0.empty.? $ (UINT 32) $ (SINT 8))
       ))
       (and
        (=>
         %%location_label%%0
        ...
        (=>
         tmp%2
         (=>
          (ens%std!collections.hash.map.impl&%2.insert. $ (UINT 32) $ (SINT 8) $ TYPE%std!hash.random.RandomState.
           (Poly%std!collections.hash.map.HashMap<u32./i8./std!hash.random.RandomState.>. m@0)
           (Poly%std!collections.hash.map.HashMap<u32./i8./std!hash.random.RandomState.>. m@1)
           (I 3) (I 4) tmp%3
          )
          (and
           (=>
           ...
           (=>
            ...
            (=>
             (ens%std!collections.hash.map.impl&%2.insert. $ (UINT 32) $ (SINT 8) $ TYPE%std!hash.random.RandomState.
              (Poly%std!collections.hash.map.HashMap<u32./i8./std!hash.random.RandomState.>. m@1)
              (Poly%std!collections.hash.map.HashMap<u32./i8./std!hash.random.RandomState.>. m@2)
              (I 6) (I tmp%5) tmp%4
             )
             (=>
              (= tmp%6 (= (%I (vstd!map.impl&%0.index.? $ (UINT 32) $ (SINT 8) (vstd!view.View.view.?
                   $ (TYPE%std!collections.hash.map.HashMap. $ (UINT 32) $ (SINT 8) $ TYPE%std!hash.random.RandomState.)
                   (Poly%std!collections.hash.map.HashMap<u32./i8./std!hash.random.RandomState.>. m@2)
                  ) (I 3)
                 )
              ...
              (and
               ...
               (=>
                tmp%6
                (=>
                 (ens%std!collections.hash.map.impl&%2.contains_key. $ (UINT 32) $ (SINT 8) $ TYPE%std!hash.random.RandomState.
                  $ (UINT 32) (Poly%std!collections.hash.map.HashMap<u32./i8./std!hash.random.RandomState.>.
                   m@2
                  ) (I 3) b@
                 )
                 (and
                  ...
                  (=>
                   b@
                   (=>
                    (ens%std!collections.hash.map.impl&%1.len. $ (UINT 32) $ (SINT 8) $ TYPE%std!hash.random.RandomState.
                     (Poly%std!collections.hash.map.HashMap<u32./i8./std!hash.random.RandomState.>. m@2)
                     n@
                    )
                    (=>
                     ...
                     (and
                      ...
                      (=>
                       tmp%7
                       (=>
                        (ens%std!collections.hash.map.impl&%2.get. $ (UINT 32) $ (SINT 8) $ TYPE%std!hash.random.RandomState.
                         $ (UINT 32) (Poly%std!collections.hash.map.HashMap<u32./i8./std!hash.random.RandomState.>.
                          m@2
                         ) (I 6) v@
                        )
                        (or
                         ...
                         (and
                          (not %%switch_label%%0)
                          (=>
                           (ens%std!collections.hash.map.impl&%2.remove. $ (UINT 32) $ (SINT 8) $ TYPE%std!hash.random.RandomState.
                            $ (UINT 32) (Poly%std!collections.hash.map.HashMap<u32./i8./std!hash.random.RandomState.>.
                             m@2
                            ) (Poly%std!collections.hash.map.HashMap<u32./i8./std!hash.random.RandomState.>. m@3)
                            (I 6) tmp%9
                           )
                           (=>
                            (= tmp%10 (not (vstd!set.impl&%0.contains.? $ (UINT 32) (vstd!map.impl&%0.dom.? $ (UINT
                                 32
                                ) $ (SINT 8) (vstd!view.View.view.? $ (TYPE%std!collections.hash.map.HashMap. $ (UINT
                                   32
                            ...
                            (and
                             ...
                             (=>
                              tmp%10
                              (=>
                               (= tmp%11 (vstd!set.impl&%0.contains.? $ (UINT 32) (vstd!map.impl&%0.dom.? $ (UINT 32)
                                  $ (SINT 8) (vstd!view.View.view.? $ (TYPE%std!collections.hash.map.HashMap. $ (UINT
                                     32
                                    ) $ (SINT 8) $ TYPE%std!hash.random.RandomState.
                                   ) (Poly%std!collections.hash.map.HashMap<u32./i8./std!hash.random.RandomState.>. m@3)
                               ...
                               (and
                                ...
                                (=>
                                 tmp%11
                                 (=>
                                  (ens%std!collections.hash.map.impl&%1.clear. $ (UINT 32) $ (SINT 8) $ TYPE%std!hash.random.RandomState.
                                   (Poly%std!collections.hash.map.HashMap<u32./i8./std!hash.random.RandomState.>. m@3)
                                   (Poly%std!collections.hash.map.HashMap<u32./i8./std!hash.random.RandomState.>. m@4)
                                  )
                                  (=>
                                   (= tmp%12 (not (vstd!set.impl&%0.contains.? $ (UINT 32) (vstd!map.impl&%0.dom.? $ (UINT
                                        32
                                       ) $ (SINT 8) (vstd!view.View.view.? $ (TYPE%std!collections.hash.map.HashMap. $ (UINT
                                          32
                                         ) $ (SINT 8) $ TYPE%std!hash.random.RandomState.
