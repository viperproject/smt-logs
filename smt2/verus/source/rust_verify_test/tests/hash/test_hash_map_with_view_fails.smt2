...
(assert
 (distinct fuel%vstd!map.impl&%0.spec_index. fuel%vstd!map.axiom_map_index_decreases_finite.
  ...
  fuel%vstd!map.axiom_map_ext_equal. fuel%vstd!map.axiom_map_ext_equal_deep. fuel%vstd!raw_ptr.impl&%4.view.
  ...
  fuel%vstd!view.impl&%30.view. fuel%vstd!view.impl&%42.view. fuel%test_crate!impl&%4.view.
...
(assert
 (=>
  ...
  (forall ((K&. Dcr) (K& Type) (V&. Dcr) (V& Type) (m! Poly) (key! Poly)) (!
    ...
    :skolemid skolem_user_vstd__map__axiom_map_index_decreases_finite_1
))))
...
(assert
 (=>
  ...
  (forall ((K&. Dcr) (K& Type) (V&. Dcr) (V& Type) (m! Poly) (key! Poly)) (!
    ...
    :skolemid skolem_user_vstd__map__axiom_map_index_decreases_infinite_2
))))
...
(assert
 (=>
  ...
  (forall ((K&. Dcr) (K& Type) (V&. Dcr) (V& Type)) (!
    ...
    :skolemid skolem_user_vstd__map__axiom_map_empty_3
))))
 ...
 (=>
  ...
  (forall ((K&. Dcr) (K& Type) (V&. Dcr) (V& Type) (m! Poly) (key! Poly) (value! Poly))
   (!
    ...
    :skolemid skolem_user_vstd__map__axiom_map_insert_domain_4
))))
 ...
 (=>
  ...
  (forall ((K&. Dcr) (K& Type) (V&. Dcr) (V& Type) (m! Poly) (key! Poly) (value! Poly))
   (!
    ...
    :skolemid skolem_user_vstd__map__axiom_map_insert_same_5
))))
...
(assert
 (=>
  ...
  (forall ((T&. Dcr) (T& Type) (a! Poly)) (!
    ...
    :qid user_vstd__raw_ptr__ptrs_mut_eq_11
    :skolemid skolem_user_vstd__raw_ptr__ptrs_mut_eq_11
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (s! Poly) (i! Poly)) (!
    ...
    :qid user_vstd__seq__axiom_seq_index_decreases_12
    :skolemid skolem_user_vstd__seq__axiom_seq_index_decreases_12
))))
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/hash-94588ed97bed1cec-test_hash_map_with_view_fails/test.rs:47:1: 47:10 (#0)
