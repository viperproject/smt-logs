...
(declare-const fuel%vstd!hash_set.axiom_string_hash_set_spec_len. FuelId)
...
(assert
 (distinct fuel%vstd!std_specs.option.impl&%0.is_Some. fuel%vstd!std_specs.option.impl&%0.get_Some_0.
  ...
  fuel%vstd!hash_set.axiom_string_hash_set_spec_len. fuel%vstd!raw_ptr.impl&%4.view.
...
(declare-sort vstd!hash_set.StringHashSet. 0)
(declare-sort vstd!raw_ptr.DynMetadata. 0)
(declare-sort vstd!raw_ptr.Provenance. 0)
(declare-sort vstd!seq.Seq<char.>. 0)
(declare-sort vstd!set.Set<vstd!seq.Seq<char.>.>. 0)
...
(declare-const TYPE%vstd!hash_set.StringHashSet. Type)
...
(declare-fun Poly%vstd!hash_set.StringHashSet. (vstd!hash_set.StringHashSet.) Poly)
(declare-fun %Poly%vstd!hash_set.StringHashSet. (Poly) vstd!hash_set.StringHashSet.)
...
(declare-fun Poly%vstd!set.Set<vstd!seq.Seq<char.>.>. (vstd!set.Set<vstd!seq.Seq<char.>.>.)
 Poly
)
(declare-fun %Poly%vstd!set.Set<vstd!seq.Seq<char.>.>. (Poly) vstd!set.Set<vstd!seq.Seq<char.>.>.)
...
(assert
 (forall ((x vstd!hash_set.StringHashSet.)) (!
   (= x (%Poly%vstd!hash_set.StringHashSet. (Poly%vstd!hash_set.StringHashSet. x)))
   :pattern ((Poly%vstd!hash_set.StringHashSet. x))
   :qid internal_vstd__hash_set__StringHashSet_box_axiom_definition
   :skolemid skolem_internal_vstd__hash_set__StringHashSet_box_axiom_definition
)))
(assert
 (forall ((x Poly)) (!
   (=>
    (has_type x TYPE%vstd!hash_set.StringHashSet.)
    (= x (Poly%vstd!hash_set.StringHashSet. (%Poly%vstd!hash_set.StringHashSet. x)))
   )
   :pattern ((has_type x TYPE%vstd!hash_set.StringHashSet.))
   :qid internal_vstd__hash_set__StringHashSet_unbox_axiom_definition
   :skolemid skolem_internal_vstd__hash_set__StringHashSet_unbox_axiom_definition
)))
(assert
 (forall ((x vstd!hash_set.StringHashSet.)) (!
   (has_type (Poly%vstd!hash_set.StringHashSet. x) TYPE%vstd!hash_set.StringHashSet.)
   :pattern ((has_type (Poly%vstd!hash_set.StringHashSet. x) TYPE%vstd!hash_set.StringHashSet.))
   :qid internal_vstd__hash_set__StringHashSet_has_type_always_definition
   :skolemid skolem_internal_vstd__hash_set__StringHashSet_has_type_always_definition
)))
(assert
...
(assert
 (forall ((x vstd!set.Set<vstd!seq.Seq<char.>.>.)) (!
   (= x (%Poly%vstd!set.Set<vstd!seq.Seq<char.>.>. (Poly%vstd!set.Set<vstd!seq.Seq<char.>.>.
      x
   )))
   :pattern ((Poly%vstd!set.Set<vstd!seq.Seq<char.>.>. x))
   :qid internal_vstd__set__Set<vstd!seq.Seq<char.>.>_box_axiom_definition
   :skolemid skolem_internal_vstd__set__Set<vstd!seq.Seq<char.>.>_box_axiom_definition
)))
(assert
 (forall ((x Poly)) (!
   (=>
    (has_type x (TYPE%vstd!set.Set. $ (TYPE%vstd!seq.Seq. $ CHAR)))
    (= x (Poly%vstd!set.Set<vstd!seq.Seq<char.>.>. (%Poly%vstd!set.Set<vstd!seq.Seq<char.>.>.
       x
   ))))
   :pattern ((has_type x (TYPE%vstd!set.Set. $ (TYPE%vstd!seq.Seq. $ CHAR))))
   :qid internal_vstd__set__Set<vstd!seq.Seq<char.>.>_unbox_axiom_definition
   :skolemid skolem_internal_vstd__set__Set<vstd!seq.Seq<char.>.>_unbox_axiom_definition
)))
(assert
 (forall ((x vstd!set.Set<vstd!seq.Seq<char.>.>.)) (!
   (has_type (Poly%vstd!set.Set<vstd!seq.Seq<char.>.>. x) (TYPE%vstd!set.Set. $ (TYPE%vstd!seq.Seq.
      $ CHAR
   )))
   :pattern ((has_type (Poly%vstd!set.Set<vstd!seq.Seq<char.>.>. x) (TYPE%vstd!set.Set.
      $ (TYPE%vstd!seq.Seq. $ CHAR)
   )))
   :qid internal_vstd__set__Set<vstd!seq.Seq<char.>.>_has_type_always_definition
   :skolemid skolem_internal_vstd__set__Set<vstd!seq.Seq<char.>.>_has_type_always_definition
)))
(assert
 (forall ((x strslice%.)) (!
...
(assert
 (= (proj%%vstd!view.View./V $ TYPE%vstd!hash_set.StringHashSet.) $)
)
(assert
 (= (proj%vstd!view.View./V $ TYPE%vstd!hash_set.StringHashSet.) (TYPE%vstd!set.Set.
   $ (TYPE%vstd!seq.Seq. $ CHAR)
)))
(assert
 (forall ((T&. Dcr) (T& Type)) (!
...
;; Function-Decl vstd::hash_set::impl&%3::spec_len
(declare-fun vstd!hash_set.impl&%3.spec_len.? (Poly) Int)
...
(assert
 (forall ((tmp%%$ Poly) (res$ Poly)) (!
   ...
   :qid user_core__clone__impls__impl&%22__clone_3
   :skolemid skolem_user_core__clone__impls__impl&%22__clone_3
)))
...
(assert
 (forall ((tmp%%$ Poly) (res$ Poly) (T&. Dcr) (T& Type) (A&. Dcr) (A& Type)) (!
   ...
   :qid user_alloc__boxed__impl&%12__clone_8
   :skolemid skolem_user_alloc__boxed__impl&%12__clone_8
)))
...
;; Function-Specs vstd::hash_set::impl&%3::new
(declare-fun ens%vstd!hash_set.impl&%3.new. (Int vstd!hash_set.StringHashSet.) Bool)
(assert
 (forall ((no%param Int) (result! vstd!hash_set.StringHashSet.)) (!
   (= (ens%vstd!hash_set.impl&%3.new. no%param result!) (= (vstd!view.View.view.? $ TYPE%vstd!hash_set.StringHashSet.
      (Poly%vstd!hash_set.StringHashSet. result!)
     ) (vstd!set.impl&%0.empty.? $ (TYPE%vstd!seq.Seq. $ CHAR))
   ))
   :pattern ((ens%vstd!hash_set.impl&%3.new. no%param result!))
   :qid internal_ens__vstd!hash_set.impl&__3.new._definition
   :skolemid skolem_internal_ens__vstd!hash_set.impl&__3.new._definition
)))

;; Function-Axioms vstd::hash_set::impl&%3::spec_len
(assert
 (forall ((self! Poly)) (!
   (=>
    (has_type self! TYPE%vstd!hash_set.StringHashSet.)
    (uInv SZ (vstd!hash_set.impl&%3.spec_len.? self!))
   )
   :pattern ((vstd!hash_set.impl&%3.spec_len.? self!))
   :qid internal_vstd!hash_set.impl&__3.spec_len.?_pre_post_definition
   :skolemid skolem_internal_vstd!hash_set.impl&__3.spec_len.?_pre_post_definition
)))
...
;; Function-Specs vstd::hash_set::impl&%3::len
(declare-fun ens%vstd!hash_set.impl&%3.len. (vstd!hash_set.StringHashSet. Int) Bool)
(assert
 (forall ((self! vstd!hash_set.StringHashSet.) (result! Int)) (!
   (= (ens%vstd!hash_set.impl&%3.len. self! result!) (and
     (uInv SZ result!)
     (= result! (vstd!set.impl&%0.len.? $ (TYPE%vstd!seq.Seq. $ CHAR) (vstd!view.View.view.?
        $ TYPE%vstd!hash_set.StringHashSet. (Poly%vstd!hash_set.StringHashSet. self!)
   )))))
   :pattern ((ens%vstd!hash_set.impl&%3.len. self! result!))
   :qid internal_ens__vstd!hash_set.impl&__3.len._definition
   :skolemid skolem_internal_ens__vstd!hash_set.impl&__3.len._definition
)))
...
;; Function-Specs vstd::hash_set::impl&%3::insert
(declare-fun ens%vstd!hash_set.impl&%3.insert. (vstd!hash_set.StringHashSet. vstd!hash_set.StringHashSet.
  alloc!string.String. Bool
 ) Bool
)
(assert
 (forall ((pre%self! vstd!hash_set.StringHashSet.) (self! vstd!hash_set.StringHashSet.)
   (k! alloc!string.String.) (result! Bool)
  ) (!
   (= (ens%vstd!hash_set.impl&%3.insert. pre%self! self! k! result!) (and
     (= (vstd!view.View.view.? $ TYPE%vstd!hash_set.StringHashSet. (Poly%vstd!hash_set.StringHashSet.
        self!
       )
      ) (vstd!set.impl&%0.insert.? $ (TYPE%vstd!seq.Seq. $ CHAR) (vstd!view.View.view.? $
        TYPE%vstd!hash_set.StringHashSet. (Poly%vstd!hash_set.StringHashSet. pre%self!)
       ) (vstd!view.View.view.? $ TYPE%alloc!string.String. (Poly%alloc!string.String. k!))
     ))
     (= result! (not (vstd!set.impl&%0.contains.? $ (TYPE%vstd!seq.Seq. $ CHAR) (vstd!view.View.view.?
         $ TYPE%vstd!hash_set.StringHashSet. (Poly%vstd!hash_set.StringHashSet. pre%self!)
        ) (vstd!view.View.view.? $ TYPE%alloc!string.String. (Poly%alloc!string.String. k!))
   )))))
   :pattern ((ens%vstd!hash_set.impl&%3.insert. pre%self! self! k! result!))
   :qid internal_ens__vstd!hash_set.impl&__3.insert._definition
   :skolemid skolem_internal_ens__vstd!hash_set.impl&__3.insert._definition
)))
...
;; Function-Specs vstd::hash_set::impl&%3::remove
(declare-fun ens%vstd!hash_set.impl&%3.remove. (vstd!hash_set.StringHashSet. vstd!hash_set.StringHashSet.
  strslice%. Bool
 ) Bool
)
(assert
 (forall ((pre%self! vstd!hash_set.StringHashSet.) (self! vstd!hash_set.StringHashSet.)
   (k! strslice%.) (result! Bool)
  ) (!
   (= (ens%vstd!hash_set.impl&%3.remove. pre%self! self! k! result!) (and
     (= (vstd!view.View.view.? $ TYPE%vstd!hash_set.StringHashSet. (Poly%vstd!hash_set.StringHashSet.
        self!
       )
      ) (vstd!set.impl&%0.remove.? $ (TYPE%vstd!seq.Seq. $ CHAR) (vstd!view.View.view.? $
        TYPE%vstd!hash_set.StringHashSet. (Poly%vstd!hash_set.StringHashSet. pre%self!)
       ) (vstd!view.View.view.? $ STRSLICE (Poly%strslice%. k!))
     ))
     (= result! (vstd!set.impl&%0.contains.? $ (TYPE%vstd!seq.Seq. $ CHAR) (vstd!view.View.view.?
        $ TYPE%vstd!hash_set.StringHashSet. (Poly%vstd!hash_set.StringHashSet. pre%self!)
       ) (vstd!view.View.view.? $ STRSLICE (Poly%strslice%. k!))
   ))))
   :pattern ((ens%vstd!hash_set.impl&%3.remove. pre%self! self! k! result!))
   :qid internal_ens__vstd!hash_set.impl&__3.remove._definition
   :skolemid skolem_internal_ens__vstd!hash_set.impl&__3.remove._definition
)))

;; Function-Specs vstd::hash_set::impl&%3::contains
(declare-fun ens%vstd!hash_set.impl&%3.contains. (vstd!hash_set.StringHashSet. strslice%.
  Bool
 ) Bool
)
(assert
 (forall ((self! vstd!hash_set.StringHashSet.) (k! strslice%.) (result! Bool)) (!
   (= (ens%vstd!hash_set.impl&%3.contains. self! k! result!) (= result! (vstd!set.impl&%0.contains.?
      $ (TYPE%vstd!seq.Seq. $ CHAR) (vstd!view.View.view.? $ TYPE%vstd!hash_set.StringHashSet.
       (Poly%vstd!hash_set.StringHashSet. self!)
      ) (vstd!view.View.view.? $ STRSLICE (Poly%strslice%. k!))
   )))
   :pattern ((ens%vstd!hash_set.impl&%3.contains. self! k! result!))
   :qid internal_ens__vstd!hash_set.impl&__3.contains._definition
   :skolemid skolem_internal_ens__vstd!hash_set.impl&__3.contains._definition
)))

;; Function-Specs vstd::hash_set::impl&%3::get
(declare-fun ens%vstd!hash_set.impl&%3.get. (vstd!hash_set.StringHashSet. strslice%.
  core!option.Option.
 ) Bool
)
(assert
 (forall ((self! vstd!hash_set.StringHashSet.) (k! strslice%.) (result! core!option.Option.))
  (!
   (= (ens%vstd!hash_set.impl&%3.get. self! k! result!) (and
     (has_type (Poly%core!option.Option. result!) (TYPE%core!option.Option. (REF $) TYPE%alloc!string.String.))
     (ite
      (is-core!option.Option./Some result!)
      (let
       ((v$ (%Poly%alloc!string.String. (core!option.Option./Some/0 (%Poly%core!option.Option.
            (Poly%core!option.Option. result!)
       )))))
       (and
        (vstd!set.impl&%0.contains.? $ (TYPE%vstd!seq.Seq. $ CHAR) (vstd!view.View.view.? $
          TYPE%vstd!hash_set.StringHashSet. (Poly%vstd!hash_set.StringHashSet. self!)
         ) (vstd!view.View.view.? $ STRSLICE (Poly%strslice%. k!))
        )
        (= (vstd!view.View.view.? $ TYPE%alloc!string.String. (Poly%alloc!string.String. v$))
         (vstd!view.View.view.? $ STRSLICE (Poly%strslice%. k!))
      )))
      (not (vstd!set.impl&%0.contains.? $ (TYPE%vstd!seq.Seq. $ CHAR) (vstd!view.View.view.?
         $ TYPE%vstd!hash_set.StringHashSet. (Poly%vstd!hash_set.StringHashSet. self!)
        ) (vstd!view.View.view.? $ STRSLICE (Poly%strslice%. k!))
   )))))
   :pattern ((ens%vstd!hash_set.impl&%3.get. self! k! result!))
   :qid internal_ens__vstd!hash_set.impl&__3.get._definition
   :skolemid skolem_internal_ens__vstd!hash_set.impl&__3.get._definition
)))

;; Function-Specs vstd::hash_set::impl&%3::clear
(declare-fun ens%vstd!hash_set.impl&%3.clear. (vstd!hash_set.StringHashSet. vstd!hash_set.StringHashSet.)
 Bool
)
(assert
 (forall ((pre%self! vstd!hash_set.StringHashSet.) (self! vstd!hash_set.StringHashSet.))
  (!
   (= (ens%vstd!hash_set.impl&%3.clear. pre%self! self!) (= (vstd!view.View.view.? $ TYPE%vstd!hash_set.StringHashSet.
      (Poly%vstd!hash_set.StringHashSet. self!)
     ) (vstd!set.impl&%0.empty.? $ (TYPE%vstd!seq.Seq. $ CHAR))
   ))
   :pattern ((ens%vstd!hash_set.impl&%3.clear. pre%self! self!))
   :qid internal_ens__vstd!hash_set.impl&__3.clear._definition
   :skolemid skolem_internal_ens__vstd!hash_set.impl&__3.clear._definition
)))

;; Function-Specs vstd::hash_set::axiom_string_hash_set_spec_len
(declare-fun ens%vstd!hash_set.axiom_string_hash_set_spec_len. (vstd!hash_set.StringHashSet.)
 Bool
)
(assert
 (forall ((m! vstd!hash_set.StringHashSet.)) (!
   (= (ens%vstd!hash_set.axiom_string_hash_set_spec_len. m!) (= (vstd!hash_set.impl&%3.spec_len.?
      (Poly%vstd!hash_set.StringHashSet. m!)
     ) (vstd!set.impl&%0.len.? $ (TYPE%vstd!seq.Seq. $ CHAR) (vstd!view.View.view.? $ TYPE%vstd!hash_set.StringHashSet.
       (Poly%vstd!hash_set.StringHashSet. m!)
   ))))
   :pattern ((ens%vstd!hash_set.axiom_string_hash_set_spec_len. m!))
   :qid internal_ens__vstd!hash_set.axiom_string_hash_set_spec_len._definition
   :skolemid skolem_internal_ens__vstd!hash_set.axiom_string_hash_set_spec_len._definition
)))

;; Broadcast vstd::hash_set::axiom_string_hash_set_spec_len
(assert
 (=>
  (fuel_bool fuel%vstd!hash_set.axiom_string_hash_set_spec_len.)
  (forall ((m! Poly)) (!
    (=>
     (has_type m! TYPE%vstd!hash_set.StringHashSet.)
     (= (vstd!hash_set.impl&%3.spec_len.? m!) (vstd!set.impl&%0.len.? $ (TYPE%vstd!seq.Seq.
        $ CHAR
       ) (vstd!view.View.view.? $ TYPE%vstd!hash_set.StringHashSet. m!)
    )))
    :pattern ((vstd!hash_set.impl&%3.spec_len.? m!))
    :qid user_vstd__hash_set__axiom_string_hash_set_spec_len_9
    :skolemid skolem_user_vstd__hash_set__axiom_string_hash_set_spec_len_9
))))
...
(assert
 (=>
  ...
  (forall ((T&. Dcr) (T& Type) (a! Poly)) (!
    ...
    :qid user_vstd__raw_ptr__ptrs_mut_eq_10
    :skolemid skolem_user_vstd__raw_ptr__ptrs_mut_eq_10
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (s! Poly) (i! Poly)) (!
    ...
    :qid user_vstd__seq__axiom_seq_index_decreases_11
    :skolemid skolem_user_vstd__seq__axiom_seq_index_decreases_11
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (a! Poly)) (!
    ...
    :qid user_vstd__set__axiom_set_empty_16
    :skolemid skolem_user_vstd__set__axiom_set_empty_16
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (s! Poly) (a! Poly)) (!
    ...
    :qid user_vstd__set__axiom_set_insert_same_17
    :skolemid skolem_user_vstd__set__axiom_set_insert_same_17
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (s! Poly) (a1! Poly) (a2! Poly)) (!
    ...
    :qid user_vstd__set__axiom_set_insert_different_18
    :skolemid skolem_user_vstd__set__axiom_set_insert_different_18
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (s! Poly) (a! Poly)) (!
    ...
    :qid user_vstd__set__axiom_set_remove_same_19
    :skolemid skolem_user_vstd__set__axiom_set_remove_same_19
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (s! Poly) (a! Poly)) (!
    ...
    :qid user_vstd__set__axiom_set_remove_insert_20
    :skolemid skolem_user_vstd__set__axiom_set_remove_insert_20
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (s! Poly) (a1! Poly) (a2! Poly)) (!
    ...
    :qid user_vstd__set__axiom_set_remove_different_21
    :skolemid skolem_user_vstd__set__axiom_set_remove_different_21
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (s1! Poly) (s2! Poly)) (!
    ...
    :qid user_vstd__set__axiom_set_ext_equal_deep_24
    :skolemid skolem_user_vstd__set__axiom_set_ext_equal_deep_24
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type)) (!
    ...
    :qid user_vstd__set__axiom_set_empty_finite_25
    :skolemid skolem_user_vstd__set__axiom_set_empty_finite_25
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type)) (!
    ...
    :qid user_vstd__set__axiom_set_empty_len_28
    :skolemid skolem_user_vstd__set__axiom_set_empty_len_28
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (s! Poly) (a! Poly)) (!
    ...
    :qid user_vstd__set__axiom_set_insert_len_29
    :skolemid skolem_user_vstd__set__axiom_set_insert_len_29
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (s! Poly) (a! Poly)) (!
    ...
    :qid user_vstd__set__axiom_set_remove_len_30
    :skolemid skolem_user_vstd__set__axiom_set_remove_len_30
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (s! Poly) (a! Poly)) (!
    ...
    :qid user_vstd__set__axiom_set_contains_len_31
    :skolemid skolem_user_vstd__set__axiom_set_contains_len_31
))))
...
(assert
 (=>
  ...
  (forall ((s! Poly)) (!
    ...
    :qid user_vstd__string__axiom_str_literal_is_ascii_32
    :skolemid skolem_user_vstd__string__axiom_str_literal_is_ascii_32
))))
...
(assert
 (=>
  ...
  (forall ((s! Poly)) (!
    ...
    :qid user_vstd__string__axiom_str_literal_len_33
    :skolemid skolem_user_vstd__string__axiom_str_literal_len_33
))))
...
(assert
 (=>
  ...
  (forall ((s! Poly) (i! Poly)) (!
    ...
    :qid user_vstd__string__axiom_str_literal_get_char_34
    :skolemid skolem_user_vstd__string__axiom_str_literal_get_char_34
))))
...
(assert
 (forall ((tmp%%$ Poly) (res$ Poly)) (!
   ...
   :qid user_alloc__string__impl&%6__clone_35
   :skolemid skolem_user_alloc__string__impl&%6__clone_35
)))
...
;; Trait-Impl-Axiom
(assert
 (tr_bound%vstd!view.View. $ TYPE%vstd!hash_set.StringHashSet.)
)
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/hash-94588ed97bed1cec-test_string_hash_set/test.rs:17:1: 17:10 (#0)
...
(push)
 ...
 (declare-const tmp%5 alloc!string.String.)
 (declare-const tmp%6 Bool)
 (declare-const tmp%7 strslice%.)
 (declare-const tmp%8 Bool)
 (declare-const tmp%9 strslice%.)
 (declare-const tmp%10 Bool)
 (declare-const v$1@ alloc!string.String.)
 (declare-const tmp%11 strslice%.)
 (declare-const tmp%12 strslice%.)
 (declare-const tmp%13 Bool)
 (declare-const tmp%14 Bool)
 (declare-const tmp%15 Bool)
 (declare-const tmp%16 strslice%.)
 (declare-const m@0 vstd!hash_set.StringHashSet.)
 ...
 (declare-const m@1 vstd!hash_set.StringHashSet.)
 (declare-const m@2 vstd!hash_set.StringHashSet.)
 (declare-const m@3 vstd!hash_set.StringHashSet.)
 (declare-const m@4 vstd!hash_set.StringHashSet.)
 (declare-const m@5 vstd!hash_set.StringHashSet.)
 (declare-const m@6 vstd!hash_set.StringHashSet.)
 ...
 (assert
  (not (=>
    (ens%vstd!hash_set.impl&%3.new. 0 m@0)
    (=>
     (= tmp%1 (ext_eq false (TYPE%vstd!set.Set. $ (TYPE%vstd!seq.Seq. $ CHAR)) (vstd!view.View.view.?
        $ TYPE%vstd!hash_set.StringHashSet. (Poly%vstd!hash_set.StringHashSet. m@0)
       ) (vstd!set.impl&%0.empty.? $ (TYPE%vstd!seq.Seq. $ CHAR))
     ))
     (and
      (=>
      ...
      (=>
       ...
       (=>
        ...
        (=>
         ...
         (=>
          (ens%alloc!string.impl&%6.clone. (Poly%alloc!string.String. three@) tmp%2)
          (=>
           (ens%vstd!hash_set.impl&%3.insert. m@0 m@1 (%Poly%alloc!string.String. tmp%2) res@)
           (and
            (=>
             %%location_label%%1
             res@
            ...
            (=>
             res@
             (=>
              (ens%alloc!string.impl&%6.clone. (Poly%alloc!string.String. six@) tmp%3)
              (=>
               (ens%vstd!hash_set.impl&%3.insert. m@1 m@2 (%Poly%alloc!string.String. tmp%3) tmp%4)
               (=>
                (ens%alloc!string.impl&%38.to_string. (str%new_strlit 7540055160550341633250267082335447489856789760956007746206715705126346933451857289371095227217738790126722510655840889183812872020082602312599670652564834)
                 tmp%5
                )
                (=>
                 (ens%vstd!hash_set.impl&%3.insert. m@2 m@3 tmp%5 res$1@)
                 (and
                  (=>
                   %%location_label%%2
                   (not res$1@)
                   ...
                   (and
                    (=>
                     ...
                     (=>
                      ...
                      (=>
                       (= tmp%6 (not (= (vstd!seq.Seq.len.? $ CHAR (vstd!view.View.view.? $ TYPE%alloc!string.String.
                            (Poly%alloc!string.String. three@)
                           )
                          ) (vstd!seq.Seq.len.? $ CHAR (vstd!view.View.view.? $ TYPE%alloc!string.String. (Poly%alloc!string.String.
                             six@
                       ))))))
                       (and
                        (=>
                    ...
                    (=>
                     ...
                     (=>
                      ...
                      (=>
                       (ens%vstd!hash_set.impl&%3.contains. m@3 tmp%7 b@)
                       (and
                        (=>
                         %%location_label%%5
                         b@
                        ...
                        (=>
                         ...
                         (and
                          (=>
                           (ens%vstd!hash_set.axiom_string_hash_set_spec_len. m@3)
                           (=>
                            %%location_label%%6
                            (= (vstd!hash_set.impl&%3.spec_len.? (Poly%vstd!hash_set.StringHashSet. m@3)) 2)
                          ))
                          (=>
                           (= (vstd!hash_set.impl&%3.spec_len.? (Poly%vstd!hash_set.StringHashSet. m@3)) 2)
                           (=>
                            (ens%vstd!hash_set.impl&%3.len. m@3 n@)
                            (=>
                             (= tmp%8 (= n@ 2))
                             (and
                              (=>
                              ...
                              (=>
                               ...
                               (=>
                                ...
                                (=>
                                 (ens%vstd!hash_set.impl&%3.get. m@3 tmp%9 v@)
                                 (or
                                  (and
                                   (=>
                                    (is-core!option.Option./Some v@)
                                    (=>
                                     (= v$1@ (%Poly%alloc!string.String. (core!option.Option./Some/0 (%Poly%core!option.Option.
                                         (Poly%core!option.Option. v@)
                                     ))))
                                     (=>
                                      (= tmp%10 (ext_eq false (TYPE%vstd!seq.Seq. $ CHAR) (vstd!view.View.view.? $ TYPE%alloc!string.String.
                                         (Poly%alloc!string.String. v$1@)
                                        ) (vstd!view.View.view.? $ TYPE%alloc!string.String. (Poly%alloc!string.String. six@))
                                      ))
                                      (and
                                       (=>
                                  ...
                                  (and
                                   ...
                                   (=>
                                    ...
                                    (=>
                                     (ens%vstd!hash_set.impl&%3.remove. m@3 m@4 tmp%11 res$2@)
                                     (and
                                      (=>
                                       %%location_label%%10
                                       res$2@
                                      ...
                                      (=>
                                       res$2@
                                       (=>
                                        (ens%alloc!string.impl&%0.as_str. six@ tmp%12)
                                        (=>
                                         (ens%vstd!hash_set.impl&%3.remove. m@4 m@5 tmp%12 res$3@)
                                         (and
                                          (=>
                                           %%location_label%%11
                                           (not res$3@)
                                          ...
                                          (=>
                                           (not res$3@)
                                           (=>
                                            (= tmp%13 (not (vstd!set.impl&%0.contains.? $ (TYPE%vstd!seq.Seq. $ CHAR) (vstd!view.View.view.?
                                                $ TYPE%vstd!hash_set.StringHashSet. (Poly%vstd!hash_set.StringHashSet. m@5)
                                               ) (vstd!view.View.view.? $ TYPE%alloc!string.String. (Poly%alloc!string.String. six@))
                                            )))
                                            (and
                                             (=>
                                             ...
                                             (=>
                                              tmp%13
                                              (=>
                                               (= tmp%14 (vstd!set.impl&%0.contains.? $ (TYPE%vstd!seq.Seq. $ CHAR) (vstd!view.View.view.?
                                                  $ TYPE%vstd!hash_set.StringHashSet. (Poly%vstd!hash_set.StringHashSet. m@5)
                                               ...
                                               (and
                                                ...
                                                (=>
                                                 tmp%14
                                                 (=>
                                                  (ens%vstd!hash_set.impl&%3.clear. m@5 m@6)
                                                  (=>
                                                   (= tmp%15 (not (vstd!set.impl&%0.contains.? $ (TYPE%vstd!seq.Seq. $ CHAR) (vstd!view.View.view.?
                                                       $ TYPE%vstd!hash_set.StringHashSet. (Poly%vstd!hash_set.StringHashSet. m@6)
                                                      ) (vstd!view.View.view.? $ TYPE%alloc!string.String. (Poly%alloc!string.String. three@))
                                                   )))
                                                   (and
                                                    (=>
                                                    ...
                                                    (=>
                                                     tmp%15
                                                     (=>
                                                      (ens%alloc!string.impl&%0.as_str. three@ tmp%16)
                                                      (=>
                                                       (ens%vstd!hash_set.impl&%3.contains. m@6 tmp%16 b$1@)
                                                       (=>
                                                        %%location_label%%15
                                                        (not b$1@)
 )))))))))))))))))))))))))))))))))))))))))))))))))))))))
