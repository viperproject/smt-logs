...
(assert
 (distinct fuel%vstd!std_specs.hash.axiom_bool_obeys_hash_table_key_model. fuel%vstd!std_specs.hash.axiom_u8_obeys_hash_table_key_model.
  ...
  fuel%vstd!std_specs.hash.impl&%2.spec_index. fuel%vstd!map.impl&%0.spec_index. fuel%vstd!map.axiom_map_index_decreases_finite.
  ...
  fuel%vstd!set.axiom_set_insert_finite. fuel%vstd!view.impl&%0.view. fuel%vstd!view.impl&%2.view.
  ...
  fuel%vstd!view.impl&%18.view. fuel%vstd!view.impl&%24.view. fuel%vstd!view.impl&%30.view.
    ...
    (=>
     ...
     (= (ext_eq false (TYPE%vstd!seq.Seq. A&. A&) s1! s2!) (and
       ...
       (forall ((i$ Poly)) (!
         ...
         :qid user_vstd__seq__axiom_seq_ext_equal_20
         :skolemid skolem_user_vstd__seq__axiom_seq_ext_equal_20
    )))))
    :pattern ((ext_eq false (TYPE%vstd!seq.Seq. A&. A&) s1! s2!))
    :qid user_vstd__seq__axiom_seq_ext_equal_21
    :skolemid skolem_user_vstd__seq__axiom_seq_ext_equal_21
))))
    ...
    (=>
     ...
     (= (ext_eq true (TYPE%vstd!seq.Seq. A&. A&) s1! s2!) (and
       ...
       (forall ((i$ Poly)) (!
         ...
         :pattern ((vstd!seq.Seq.index.? A&. A& s1! i$))
         :pattern ((vstd!seq.Seq.index.? A&. A& s2! i$))
         :qid user_vstd__seq__axiom_seq_ext_equal_deep_22
         :skolemid skolem_user_vstd__seq__axiom_seq_ext_equal_deep_22
    )))))
    :pattern ((ext_eq true (TYPE%vstd!seq.Seq. A&. A&) s1! s2!))
    :qid user_vstd__seq__axiom_seq_ext_equal_deep_23
    :skolemid skolem_user_vstd__seq__axiom_seq_ext_equal_deep_23
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (a! Poly)) (!
    ...
    :qid user_vstd__set__axiom_set_empty_24
    :skolemid skolem_user_vstd__set__axiom_set_empty_24
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (s1! Poly) (s2! Poly)) (!
    ...
    :qid user_vstd__set__axiom_set_ext_equal_28
    :skolemid skolem_user_vstd__set__axiom_set_ext_equal_28
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (s1! Poly) (s2! Poly)) (!
    ...
    :qid user_vstd__set__axiom_set_ext_equal_deep_29
    :skolemid skolem_user_vstd__set__axiom_set_ext_equal_deep_29
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type)) (!
    ...
    :qid user_vstd__set__axiom_set_empty_finite_30
    :skolemid skolem_user_vstd__set__axiom_set_empty_finite_30
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (s! Poly) (a! Poly)) (!
    ...
    :qid user_vstd__set__axiom_set_insert_finite_31
    :skolemid skolem_user_vstd__set__axiom_set_insert_finite_31
))))
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/hash-94588ed97bed1cec-test_hash_map_struct_fails/test.rs:38:1: 38:10 (#0)
       ...
       (=>
        (ens%std!collections.hash.map.impl&%2.insert. $ TYPE%test_crate!MyStruct. $ (UINT 32)
         $ TYPE%std!hash.random.RandomState. (Poly%std!collections.hash.map.HashMap<test_crate!MyStruct./u32./std!hash.random.RandomState.>.
          ...
          m@1
         ) (Poly%test_crate!MyStruct. s1@) (I 4) tmp%2
        )
        (=>
         (= s2@ (test_crate!MyStruct./MyStruct (%I (I 3)) (%I (I 7))))
         (=>
          (= tmp%3 (= (%I (vstd!map.impl&%0.index.? $ TYPE%test_crate!MyStruct. $ (UINT 32) (vstd!view.View.view.?
               $ (TYPE%std!collections.hash.map.HashMap. $ TYPE%test_crate!MyStruct. $ (UINT 32)
                $ TYPE%std!hash.random.RandomState.
               ) (Poly%std!collections.hash.map.HashMap<test_crate!MyStruct./u32./std!hash.random.RandomState.>.
                m@1
      ...
      (=>
       ...
       (=>
        ...
        (=>
         (= s2@ (test_crate!MyStruct./MyStruct (%I (I 3)) (%I (I 7))))
         (=>
          (= tmp%4 (vstd!view.View.view.? $ (TYPE%std!collections.hash.map.HashMap. $ TYPE%test_crate!MyStruct.
             $ (UINT 32) $ TYPE%std!hash.random.RandomState.
            ) (Poly%std!collections.hash.map.HashMap<test_crate!MyStruct./u32./std!hash.random.RandomState.>.
             m@1
          )))
          (=>
           %%location_label%%0
           (req%vstd!map.impl&%0.spec_index. $ TYPE%test_crate!MyStruct. $ (UINT 32) tmp%4 (Poly%test_crate!MyStruct.
             s2@
 ))))))))))))
 (get-info :version)
 (set-option :rlimit 30000000)
