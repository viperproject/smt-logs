...
(declare-sort vstd!seq.Seq<std!hash.random.DefaultHasher.>. 0)
...
(declare-fun Poly%vstd!seq.Seq<std!hash.random.DefaultHasher.>. (vstd!seq.Seq<std!hash.random.DefaultHasher.>.)
 Poly
)
(declare-fun %Poly%vstd!seq.Seq<std!hash.random.DefaultHasher.>. (Poly) vstd!seq.Seq<std!hash.random.DefaultHasher.>.)
...
(assert
 (forall ((x vstd!seq.Seq<std!hash.random.DefaultHasher.>.)) (!
   (= x (%Poly%vstd!seq.Seq<std!hash.random.DefaultHasher.>. (Poly%vstd!seq.Seq<std!hash.random.DefaultHasher.>.
      x
   )))
   :pattern ((Poly%vstd!seq.Seq<std!hash.random.DefaultHasher.>. x))
   :qid internal_vstd__seq__Seq<std!hash.random.DefaultHasher.>_box_axiom_definition
   :skolemid skolem_internal_vstd__seq__Seq<std!hash.random.DefaultHasher.>_box_axiom_definition
)))
(assert
 (forall ((x Poly)) (!
   (=>
    (has_type x (TYPE%vstd!seq.Seq. $ TYPE%std!hash.random.DefaultHasher.))
    (= x (Poly%vstd!seq.Seq<std!hash.random.DefaultHasher.>. (%Poly%vstd!seq.Seq<std!hash.random.DefaultHasher.>.
       x
   ))))
   :pattern ((has_type x (TYPE%vstd!seq.Seq. $ TYPE%std!hash.random.DefaultHasher.)))
   :qid internal_vstd__seq__Seq<std!hash.random.DefaultHasher.>_unbox_axiom_definition
   :skolemid skolem_internal_vstd__seq__Seq<std!hash.random.DefaultHasher.>_unbox_axiom_definition
)))
(assert
 (forall ((x vstd!seq.Seq<std!hash.random.DefaultHasher.>.)) (!
   (has_type (Poly%vstd!seq.Seq<std!hash.random.DefaultHasher.>. x) (TYPE%vstd!seq.Seq.
     $ TYPE%std!hash.random.DefaultHasher.
   ))
   :pattern ((has_type (Poly%vstd!seq.Seq<std!hash.random.DefaultHasher.>. x) (TYPE%vstd!seq.Seq.
      $ TYPE%std!hash.random.DefaultHasher.
   )))
   :qid internal_vstd__seq__Seq<std!hash.random.DefaultHasher.>_has_type_always_definition
   :skolemid skolem_internal_vstd__seq__Seq<std!hash.random.DefaultHasher.>_has_type_always_definition
)))
(assert
...
(declare-fun tr_bound%vstd!std_specs.hash.DefaultHasherAdditionalSpecFns. (Dcr Type)
 Bool
)
(assert
...
(assert
 (forall ((Self%&. Dcr) (Self%& Type)) (!
   true
   :pattern ((tr_bound%vstd!std_specs.hash.DefaultHasherAdditionalSpecFns. Self%&. Self%&))
   :qid internal_vstd__std_specs__hash__DefaultHasherAdditionalSpecFns_trait_type_bounds_definition
   :skolemid skolem_internal_vstd__std_specs__hash__DefaultHasherAdditionalSpecFns_trait_type_bounds_definition
)))
...
;; Function-Decl vstd::std_specs::hash::DefaultHasherAdditionalSpecFns::spec_finish
(declare-fun vstd!std_specs.hash.DefaultHasherAdditionalSpecFns.spec_finish.? (Dcr
  Type Poly
 ) Poly
)
(declare-fun vstd!std_specs.hash.DefaultHasherAdditionalSpecFns.spec_finish%default%.?
 (Dcr Type Poly) Poly
)
...
;; Function-Axioms vstd::std_specs::hash::DefaultHasherAdditionalSpecFns::spec_finish
(assert
 (forall ((Self%&. Dcr) (Self%& Type) (s! Poly)) (!
   (=>
    (has_type s! (TYPE%vstd!seq.Seq. $ (TYPE%vstd!seq.Seq. $ (UINT 8))))
    (has_type (vstd!std_specs.hash.DefaultHasherAdditionalSpecFns.spec_finish.? Self%&.
      Self%& s!
     ) (UINT 64)
   ))
   :pattern ((vstd!std_specs.hash.DefaultHasherAdditionalSpecFns.spec_finish.? Self%&.
     Self%& s!
   ))
   :qid internal_vstd!std_specs.hash.DefaultHasherAdditionalSpecFns.spec_finish.?_pre_post_definition
   :skolemid skolem_internal_vstd!std_specs.hash.DefaultHasherAdditionalSpecFns.spec_finish.?_pre_post_definition
)))
...
;; Function-Specs std::hash::random::impl&%2::new
(declare-fun ens%std!hash.random.impl&%2.new. (Int std!hash.random.DefaultHasher.)
 Bool
)
(assert
 (forall ((no%param Int) (result! std!hash.random.DefaultHasher.)) (!
   (= (ens%std!hash.random.impl&%2.new. no%param result!) (= (vstd!view.View.view.? $ TYPE%std!hash.random.DefaultHasher.
      (Poly%std!hash.random.DefaultHasher. result!)
     ) (vstd!seq.Seq.empty.? $ (TYPE%vstd!seq.Seq. $ (UINT 8)))
   ))
   :pattern ((ens%std!hash.random.impl&%2.new. no%param result!))
   :qid internal_ens__std!hash.random.impl&__2.new._definition
   :skolemid skolem_internal_ens__std!hash.random.impl&__2.new._definition
)))
...
;; Function-Specs std::hash::random::impl&%4::write
(declare-fun ens%std!hash.random.impl&%4.write. (std!hash.random.DefaultHasher. std!hash.random.DefaultHasher.
  slice%<u8.>.
 ) Bool
)
(assert
 (forall ((pre%state! std!hash.random.DefaultHasher.) (state! std!hash.random.DefaultHasher.)
   (bytes! slice%<u8.>.)
  ) (!
   (= (ens%std!hash.random.impl&%4.write. pre%state! state! bytes!) (= (vstd!view.View.view.?
      $ TYPE%std!hash.random.DefaultHasher. (Poly%std!hash.random.DefaultHasher. state!)
     ) (vstd!seq.Seq.push.? $ (TYPE%vstd!seq.Seq. $ (UINT 8)) (vstd!view.View.view.? $ TYPE%std!hash.random.DefaultHasher.
       (Poly%std!hash.random.DefaultHasher. pre%state!)
      ) (vstd!view.View.view.? $ (SLICE $ (UINT 8)) (Poly%slice%<u8.>. bytes!))
   )))
   :pattern ((ens%std!hash.random.impl&%4.write. pre%state! state! bytes!))
   :qid internal_ens__std!hash.random.impl&__4.write._definition
   :skolemid skolem_internal_ens__std!hash.random.impl&__4.write._definition
)))

;; Function-Specs std::hash::random::impl&%4::finish
(declare-fun ens%std!hash.random.impl&%4.finish. (std!hash.random.DefaultHasher. Int)
 Bool
)
(assert
 (forall ((state! std!hash.random.DefaultHasher.) (result! Int)) (!
   (= (ens%std!hash.random.impl&%4.finish. state! result!) (and
     (uInv 64 result!)
     (= result! (%I (vstd!std_specs.hash.DefaultHasherAdditionalSpecFns.spec_finish.? $ TYPE%std!hash.random.DefaultHasher.
        (vstd!view.View.view.? $ TYPE%std!hash.random.DefaultHasher. (Poly%std!hash.random.DefaultHasher.
          state!
   )))))))
   :pattern ((ens%std!hash.random.impl&%4.finish. state! result!))
   :qid internal_ens__std!hash.random.impl&__4.finish._definition
   :skolemid skolem_internal_ens__std!hash.random.impl&__4.finish._definition
)))
...
;; Trait-Impl-Axiom
(assert
 (tr_bound%vstd!std_specs.hash.DefaultHasherAdditionalSpecFns. $ TYPE%std!hash.random.DefaultHasher.)
)
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/hash-94588ed97bed1cec-test_default_hasher/test.rs:18:1: 18:10 (#0)
...
(push)
 ...
 (declare-const hash@ vstd!seq.Seq<std!hash.random.DefaultHasher.>.)
 (declare-const tmp%12 Bool)
 (declare-const h1@0 std!hash.random.DefaultHasher.)
 (declare-const h2@0 std!hash.random.DefaultHasher.)
 (declare-const v1@0 alloc!vec.Vec<u8./allocator_global%.>.)
 (declare-const v2@0 alloc!vec.Vec<u8./allocator_global%.>.)
 (declare-const digest1@ Int)
 (declare-const digest2@ Int)
 (assert
  fuel_defaults
 )
 ...
 (declare-const v2@1 alloc!vec.Vec<u8./allocator_global%.>.)
 (declare-const v2@2 alloc!vec.Vec<u8./allocator_global%.>.)
 (declare-const h1@1 std!hash.random.DefaultHasher.)
 (declare-const h1@2 std!hash.random.DefaultHasher.)
 (declare-const h2@1 std!hash.random.DefaultHasher.)
 (declare-const h2@2 std!hash.random.DefaultHasher.)
 ;; assertion failed
 ...
 (assert
  (not (=>
    (ens%std!hash.random.impl&%2.new. 0 h1@0)
    (=>
     (ens%std!hash.random.impl&%2.new. 0 h2@0)
     (=>
      (= tmp%1 (ext_eq false (TYPE%vstd!seq.Seq. $ (TYPE%vstd!seq.Seq. $ (UINT 8))) (vstd!view.View.view.?
         $ TYPE%std!hash.random.DefaultHasher. (Poly%std!hash.random.DefaultHasher. h1@0)
        ) (vstd!seq.Seq.empty.? $ (TYPE%vstd!seq.Seq. $ (UINT 8)))
      ))
      (and
       (=>
       ...
       (=>
        tmp%1
        (=>
         (ens%alloc!vec.impl&%0.new. $ (UINT 8) tmp%2)
         (=>
          (= v1@0 (%Poly%alloc!vec.Vec<u8./allocator_global%.>. tmp%2))
          (=>
           (ens%alloc!vec.impl&%0.new. $ (UINT 8) tmp%3)
           (=>
            (= v2@0 (%Poly%alloc!vec.Vec<u8./allocator_global%.>. tmp%3))
            (=>
             (ens%alloc!vec.impl&%1.push. $ (UINT 8) $ ALLOCATOR_GLOBAL (Poly%alloc!vec.Vec<u8./allocator_global%.>.
               v1@0
              ) (Poly%alloc!vec.Vec<u8./allocator_global%.>. v1@1) (I 1)
             )
             (=>
              (ens%alloc!vec.impl&%1.push. $ (UINT 8) $ ALLOCATOR_GLOBAL (Poly%alloc!vec.Vec<u8./allocator_global%.>.
                v1@1
               ) (Poly%alloc!vec.Vec<u8./allocator_global%.>. v1@2) (I 2)
              )
              (=>
               (ens%alloc!vec.impl&%1.push. $ (UINT 8) $ ALLOCATOR_GLOBAL (Poly%alloc!vec.Vec<u8./allocator_global%.>.
                 v2@0
                ) (Poly%alloc!vec.Vec<u8./allocator_global%.>. v2@1) (I 3)
               )
               (=>
                (ens%alloc!vec.impl&%1.push. $ (UINT 8) $ ALLOCATOR_GLOBAL (Poly%alloc!vec.Vec<u8./allocator_global%.>.
                  v2@1
                 ) (Poly%alloc!vec.Vec<u8./allocator_global%.>. v2@2) (I 4)
                )
                (=>
                 ...
                 (=>
                  (ens%std!hash.random.impl&%4.write. h1@0 h1@1 (%Poly%slice%<u8.>. tmp%4))
                  (=>
                   (ens%alloc!vec.impl&%1.as_slice. $ (UINT 8) $ ALLOCATOR_GLOBAL (Poly%alloc!vec.Vec<u8./allocator_global%.>.
                     v2@2
                    ) tmp%5
                   ...
                   (=>
                    (ens%std!hash.random.impl&%4.write. h1@1 h1@2 (%Poly%slice%<u8.>. tmp%5))
                    (=>
                     (ens%alloc!vec.impl&%1.as_slice. $ (UINT 8) $ ALLOCATOR_GLOBAL (Poly%alloc!vec.Vec<u8./allocator_global%.>.
                       v1@2
                      ) tmp%6
                     ...
                     (=>
                      (ens%std!hash.random.impl&%4.write. h2@0 h2@1 (%Poly%slice%<u8.>. tmp%6))
                      (=>
                       (ens%alloc!vec.impl&%1.as_slice. $ (UINT 8) $ ALLOCATOR_GLOBAL (Poly%alloc!vec.Vec<u8./allocator_global%.>.
                         v2@2
                        ) tmp%7
                       ...
                       (=>
                        (ens%std!hash.random.impl&%4.write. h2@1 h2@2 (%Poly%slice%<u8.>. tmp%7))
                        (=>
                         (= s1@ (%Poly%vstd!seq.Seq<u8.>. (vstd!seq.Seq.push.? $ (UINT 8) (vstd!seq.Seq.push.?
                             $ (UINT 8) (vstd!seq.Seq.empty.? $ (UINT 8)) (I 1)
                            ) (I 2)
                         )))
                         (=>
                          (= s2@ (%Poly%vstd!seq.Seq<u8.>. (vstd!seq.Seq.push.? $ (UINT 8) (vstd!seq.Seq.push.?
                              $ (UINT 8) (vstd!seq.Seq.empty.? $ (UINT 8)) (I 3)
                             ) (I 4)
                          )))
                          (=>
                           (= tmp%8 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<u8.>. s1@)
                             (vstd!view.View.view.? $ (ARRAY $ (UINT 8) $ (CONST_INT 2)) (array_new $ (UINT 8) 2
                               (%%array%%0 (I 1) (I 2))
                           ))))
                           (and
                            (=>
                            ...
                            (=>
                             tmp%8
                             (=>
                              (= tmp%9 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<u8.>. s2@)
                                (vstd!view.View.view.? $ (ARRAY $ (UINT 8) $ (CONST_INT 2)) (array_new $ (UINT 8) 2
                                  (%%array%%0 (I 3) (I 4))
                              ))))
                              (and
                               ...
                               (=>
                                tmp%9
                                (=>
                                 (= hash@ (%Poly%vstd!seq.Seq<std!hash.random.DefaultHasher.>. (vstd!view.View.view.?
                                    $ (ARRAY $ TYPE%std!hash.random.DefaultHasher. $ (CONST_INT 2)) (array_new $ TYPE%std!hash.random.DefaultHasher.
                                     2 (%%array%%0 (Poly%std!hash.random.DefaultHasher. h1@2) (Poly%std!hash.random.DefaultHasher.
                                       h2@2
                                 ))))))
                                 (=>
                                  (= tmp%10 (ext_eq false (TYPE%vstd!seq.Seq. $ TYPE%std!hash.random.DefaultHasher.)
                                    (Poly%vstd!seq.Seq<std!hash.random.DefaultHasher.>. hash@) (vstd!seq.Seq.push.? $
                                     TYPE%std!hash.random.DefaultHasher. (vstd!seq.Seq.push.? $ TYPE%std!hash.random.DefaultHasher.
                                      (vstd!seq.Seq.empty.? $ TYPE%std!hash.random.DefaultHasher.) (Poly%std!hash.random.DefaultHasher.
                                       h1@2
                                      )
                                     ) (Poly%std!hash.random.DefaultHasher. h2@2)
                                  )))
                                  (and
                                   (=>
                                    %%location_label%%3
                                   ...
                                   (=>
                                    tmp%10
                                    (=>
                                     (= tmp%11 (ext_eq false (TYPE%vstd!seq.Seq. $ (TYPE%vstd!seq.Seq. $ (UINT 8))) (vstd!view.View.view.?
                                        $ TYPE%std!hash.random.DefaultHasher. (Poly%std!hash.random.DefaultHasher. h1@2)
                                       ) (vstd!view.View.view.? $ (ARRAY $ (TYPE%vstd!seq.Seq. $ (UINT 8)) $ (CONST_INT 2))
                                        (array_new $ (TYPE%vstd!seq.Seq. $ (UINT 8)) 2 (%%array%%0 (vstd!view.View.view.? $
                                           (ARRAY $ (UINT 8) $ (CONST_INT 2)) (array_new $ (UINT 8) 2 (%%array%%0 (I 1) (I 2)))
                                          ) (vstd!view.View.view.? $ (ARRAY $ (UINT 8) $ (CONST_INT 2)) (array_new $ (UINT 8)
                                            2 (%%array%%0 (I 3) (I 4))
                                     )))))))
                                     (and
                                      (=>
                                      ...
                                      (=>
                                       tmp%11
                                       (=>
                                        (ens%std!hash.random.impl&%4.finish. h1@2 digest1@)
                                        (=>
                                         (ens%std!hash.random.impl&%4.finish. h2@2 digest2@)
                                         (=>
                                          (= tmp%12 (= digest1@ digest2@))
                                          (=>
                                           %%location_label%%5
                                           tmp%12
 ))))))))))))))))))))))))))))))))))))))))))
