...
(declare-const fuel%vstd!std_specs.hash.axiom_u16_obeys_hash_table_key_model. FuelId)
(declare-const fuel%vstd!std_specs.hash.axiom_i32_obeys_hash_table_key_model. FuelId)
...
(assert
 (distinct fuel%vstd!std_specs.hash.axiom_bool_obeys_hash_table_key_model. fuel%vstd!std_specs.hash.axiom_u8_obeys_hash_table_key_model.
  fuel%vstd!std_specs.hash.axiom_u16_obeys_hash_table_key_model. fuel%vstd!std_specs.hash.axiom_i32_obeys_hash_table_key_model.
  ...
  fuel%vstd!std_specs.hash.axiom_random_state_builds_valid_hashers. fuel%vstd!raw_ptr.impl&%4.view.
  ...
  fuel%vstd!set.axiom_set_ext_equal_deep. fuel%vstd!view.impl&%0.view. fuel%vstd!view.impl&%2.view.
  ...
  fuel%vstd!view.impl&%24.view. fuel%vstd!view.impl&%30.view. fuel%vstd!array.group_array_axioms.
...
(assert
 (=>
  ...
  (and
   ...
   (fuel_bool_default fuel%vstd!std_specs.hash.axiom_u16_obeys_hash_table_key_model.)
   (fuel_bool_default fuel%vstd!std_specs.hash.axiom_i32_obeys_hash_table_key_model.)
...
;; Datatypes
(declare-sort std!collections.hash.set.HashSet<test_crate!MyStruct./std!hash.random.RandomState.>.
 0
)
...
(declare-sort vstd!set.Set<test_crate!MyStruct.>. 0)
(declare-sort allocator_global%. 0)
(declare-datatypes ((vstd!raw_ptr.Metadata. 0) (vstd!raw_ptr.PtrData. 0) (test_crate!MyStruct.
   0
  ) (tuple%0. 0)
...
(declare-fun Poly%std!collections.hash.set.HashSet<test_crate!MyStruct./std!hash.random.RandomState.>.
 (std!collections.hash.set.HashSet<test_crate!MyStruct./std!hash.random.RandomState.>.)
 Poly
)
(declare-fun %Poly%std!collections.hash.set.HashSet<test_crate!MyStruct./std!hash.random.RandomState.>.
 (Poly) std!collections.hash.set.HashSet<test_crate!MyStruct./std!hash.random.RandomState.>.
)
...
(declare-fun Poly%vstd!set.Set<test_crate!MyStruct.>. (vstd!set.Set<test_crate!MyStruct.>.)
 Poly
)
(declare-fun %Poly%vstd!set.Set<test_crate!MyStruct.>. (Poly) vstd!set.Set<test_crate!MyStruct.>.)
...
(assert
 (forall ((x std!collections.hash.set.HashSet<test_crate!MyStruct./std!hash.random.RandomState.>.))
  (!
   (= x (%Poly%std!collections.hash.set.HashSet<test_crate!MyStruct./std!hash.random.RandomState.>.
     (Poly%std!collections.hash.set.HashSet<test_crate!MyStruct./std!hash.random.RandomState.>.
      x
   )))
   :pattern ((Poly%std!collections.hash.set.HashSet<test_crate!MyStruct./std!hash.random.RandomState.>.
     x
   ))
   :qid internal_std__collections__hash__set__HashSet<test_crate!MyStruct./std!hash.random.RandomState.>_box_axiom_definition
   :skolemid skolem_internal_std__collections__hash__set__HashSet<test_crate!MyStruct./std!hash.random.RandomState.>_box_axiom_definition
)))
(assert
 (forall ((x Poly)) (!
   (=>
    (has_type x (TYPE%std!collections.hash.set.HashSet. $ TYPE%test_crate!MyStruct. $ TYPE%std!hash.random.RandomState.))
    (= x (Poly%std!collections.hash.set.HashSet<test_crate!MyStruct./std!hash.random.RandomState.>.
      (%Poly%std!collections.hash.set.HashSet<test_crate!MyStruct./std!hash.random.RandomState.>.
       x
   ))))
   :pattern ((has_type x (TYPE%std!collections.hash.set.HashSet. $ TYPE%test_crate!MyStruct.
      $ TYPE%std!hash.random.RandomState.
   )))
   :qid internal_std__collections__hash__set__HashSet<test_crate!MyStruct./std!hash.random.RandomState.>_unbox_axiom_definition
   :skolemid skolem_internal_std__collections__hash__set__HashSet<test_crate!MyStruct./std!hash.random.RandomState.>_unbox_axiom_definition
)))
(assert
 (forall ((x std!collections.hash.set.HashSet<test_crate!MyStruct./std!hash.random.RandomState.>.))
  (!
   (has_type (Poly%std!collections.hash.set.HashSet<test_crate!MyStruct./std!hash.random.RandomState.>.
     x
    ) (TYPE%std!collections.hash.set.HashSet. $ TYPE%test_crate!MyStruct. $ TYPE%std!hash.random.RandomState.)
   )
   :pattern ((has_type (Poly%std!collections.hash.set.HashSet<test_crate!MyStruct./std!hash.random.RandomState.>.
      x
     ) (TYPE%std!collections.hash.set.HashSet. $ TYPE%test_crate!MyStruct. $ TYPE%std!hash.random.RandomState.)
   ))
   :qid internal_std__collections__hash__set__HashSet<test_crate!MyStruct./std!hash.random.RandomState.>_has_type_always_definition
   :skolemid skolem_internal_std__collections__hash__set__HashSet<test_crate!MyStruct./std!hash.random.RandomState.>_has_type_always_definition
)))
(assert
...
(assert
 (forall ((x vstd!set.Set<test_crate!MyStruct.>.)) (!
   (= x (%Poly%vstd!set.Set<test_crate!MyStruct.>. (Poly%vstd!set.Set<test_crate!MyStruct.>.
      x
   )))
   :pattern ((Poly%vstd!set.Set<test_crate!MyStruct.>. x))
   :qid internal_vstd__set__Set<test_crate!MyStruct.>_box_axiom_definition
   :skolemid skolem_internal_vstd__set__Set<test_crate!MyStruct.>_box_axiom_definition
)))
(assert
 (forall ((x Poly)) (!
   (=>
    (has_type x (TYPE%vstd!set.Set. $ TYPE%test_crate!MyStruct.))
    (= x (Poly%vstd!set.Set<test_crate!MyStruct.>. (%Poly%vstd!set.Set<test_crate!MyStruct.>.
       x
   ))))
   :pattern ((has_type x (TYPE%vstd!set.Set. $ TYPE%test_crate!MyStruct.)))
   :qid internal_vstd__set__Set<test_crate!MyStruct.>_unbox_axiom_definition
   :skolemid skolem_internal_vstd__set__Set<test_crate!MyStruct.>_unbox_axiom_definition
)))
(assert
 (forall ((x vstd!set.Set<test_crate!MyStruct.>.)) (!
   (has_type (Poly%vstd!set.Set<test_crate!MyStruct.>. x) (TYPE%vstd!set.Set. $ TYPE%test_crate!MyStruct.))
   :pattern ((has_type (Poly%vstd!set.Set<test_crate!MyStruct.>. x) (TYPE%vstd!set.Set.
      $ TYPE%test_crate!MyStruct.
   )))
   :qid internal_vstd__set__Set<test_crate!MyStruct.>_has_type_always_definition
   :skolemid skolem_internal_vstd__set__Set<test_crate!MyStruct.>_has_type_always_definition
)))
(assert
...
;; Broadcast vstd::std_specs::hash::axiom_u16_obeys_hash_table_key_model
(assert
 (=>
  (fuel_bool fuel%vstd!std_specs.hash.axiom_u16_obeys_hash_table_key_model.)
  (vstd!std_specs.hash.obeys_key_model.? $ (UINT 16))
))

;; Broadcast vstd::std_specs::hash::axiom_i32_obeys_hash_table_key_model
(assert
 (=>
  (fuel_bool fuel%vstd!std_specs.hash.axiom_i32_obeys_hash_table_key_model.)
  (vstd!std_specs.hash.obeys_key_model.? $ (SINT 32))
))
...
(assert
 (=>
  ...
  (forall ((T&. Dcr) (T& Type) (a! Poly)) (!
    ...
    :qid user_vstd__raw_ptr__ptrs_mut_eq_7
    :skolemid skolem_user_vstd__raw_ptr__ptrs_mut_eq_7
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (s! Poly) (i! Poly)) (!
    ...
    :qid user_vstd__seq__axiom_seq_index_decreases_8
    :skolemid skolem_user_vstd__seq__axiom_seq_index_decreases_8
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (a! Poly)) (!
    ...
    :qid user_vstd__set__axiom_set_empty_13
    :skolemid skolem_user_vstd__set__axiom_set_empty_13
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (s! Poly) (a! Poly)) (!
    ...
    :qid user_vstd__set__axiom_set_insert_same_14
    :skolemid skolem_user_vstd__set__axiom_set_insert_same_14
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (s! Poly) (a1! Poly) (a2! Poly)) (!
    ...
    :qid user_vstd__set__axiom_set_insert_different_15
    :skolemid skolem_user_vstd__set__axiom_set_insert_different_15
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (s1! Poly) (s2! Poly)) (!
    ...
    :qid user_vstd__set__axiom_set_ext_equal_deep_18
    :skolemid skolem_user_vstd__set__axiom_set_ext_equal_deep_18
))))
...
;; Trait-Impl-Axiom
(assert
 (tr_bound%builtin!Integer. $ (UINT 16))
)

;; Trait-Impl-Axiom
(assert
 (tr_bound%builtin!Integer. $ (SINT 32))
)
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/hash-94588ed97bed1cec-test_hash_set_struct_fails/test.rs:38:1: 38:10 (#0)
...
(push)
 ...
 (declare-const m@0 std!collections.hash.set.HashSet<test_crate!MyStruct./std!hash.random.RandomState.>.)
 (declare-const s1@ test_crate!MyStruct.)
 (declare-const s2@ test_crate!MyStruct.)
 (assert
  fuel_defaults
 )
 (declare-const m@1 std!collections.hash.set.HashSet<test_crate!MyStruct./std!hash.random.RandomState.>.)
 ;; assertion failed
 ...
 (assert
  (not (=>
    ...
    (=>
     (ens%std!collections.hash.set.impl&%0.new. $ TYPE%test_crate!MyStruct. tmp%1)
     (=>
      (= m@0 (%Poly%std!collections.hash.set.HashSet<test_crate!MyStruct./std!hash.random.RandomState.>.
        tmp%1
      ))
      (=>
       (= s1@ (test_crate!MyStruct./MyStruct (%I (I 3)) (%I (I 7))))
       (=>
        (ens%std!collections.hash.set.impl&%2.insert. $ TYPE%test_crate!MyStruct. $ TYPE%std!hash.random.RandomState.
         (Poly%std!collections.hash.set.HashSet<test_crate!MyStruct./std!hash.random.RandomState.>.
          m@0
         ) (Poly%std!collections.hash.set.HashSet<test_crate!MyStruct./std!hash.random.RandomState.>.
          m@1
         ) (Poly%test_crate!MyStruct. s1@) tmp%2
        )
        (=>
         (= s2@ (test_crate!MyStruct./MyStruct (%I (I 3)) (%I (I 7))))
         (=>
          (= tmp%3 (vstd!set.impl&%0.contains.? $ TYPE%test_crate!MyStruct. (vstd!view.View.view.?
             $ (TYPE%std!collections.hash.set.HashSet. $ TYPE%test_crate!MyStruct. $ TYPE%std!hash.random.RandomState.)
             (Poly%std!collections.hash.set.HashSet<test_crate!MyStruct./std!hash.random.RandomState.>.
              m@1
             )
            ) (Poly%test_crate!MyStruct. s2@)
          ))
          (=>
           %%location_label%%0
           tmp%3
