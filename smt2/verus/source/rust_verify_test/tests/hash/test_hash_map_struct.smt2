...
(assert
 (distinct fuel%vstd!std_specs.hash.axiom_bool_obeys_hash_table_key_model. fuel%vstd!std_specs.hash.axiom_u8_obeys_hash_table_key_model.
  fuel%vstd!std_specs.hash.axiom_u16_obeys_hash_table_key_model. fuel%vstd!std_specs.hash.axiom_u32_obeys_hash_table_key_model.
  fuel%vstd!std_specs.hash.axiom_i32_obeys_hash_table_key_model. fuel%vstd!std_specs.hash.axiom_box_bool_obeys_hash_table_key_model.
  ...
  fuel%vstd!std_specs.hash.impl&%2.spec_index. fuel%vstd!std_specs.hash.axiom_contains_deref_key.
  fuel%vstd!std_specs.hash.axiom_contains_box. fuel%vstd!std_specs.hash.axiom_maps_deref_key_to_value.
  fuel%vstd!std_specs.hash.axiom_maps_box_key_to_value. fuel%vstd!map.impl&%0.spec_index.
  ...
  fuel%vstd!map.axiom_map_insert_different. fuel%vstd!map.axiom_map_ext_equal. fuel%vstd!map.axiom_map_ext_equal_deep.
  ...
  fuel%vstd!set.axiom_set_empty_finite. fuel%vstd!set.axiom_set_insert_finite. fuel%vstd!view.impl&%0.view.
  ...
  fuel%vstd!view.impl&%16.view. fuel%vstd!view.impl&%18.view. fuel%vstd!view.impl&%24.view.
  fuel%vstd!view.impl&%30.view. fuel%vstd!array.group_array_axioms. fuel%vstd!map.group_map_axioms.
...
;; Datatypes
(declare-sort std!collections.hash.map.HashMap<test_crate!MyStruct./u32./std!hash.random.RandomState.>.
 0
)
(declare-sort std!hash.random.DefaultHasher. 0)
(declare-sort std!hash.random.RandomState. 0)
(declare-sort vstd!map.Map<test_crate!MyStruct./u32.>. 0)
...
(declare-datatypes ((core!option.Option. 0) (vstd!raw_ptr.Metadata. 0) (vstd!raw_ptr.PtrData.
   0
  ) (test_crate!MyStruct. 0) (tuple%0. 0)
...
(declare-fun Poly%std!collections.hash.map.HashMap<test_crate!MyStruct./u32./std!hash.random.RandomState.>.
 (std!collections.hash.map.HashMap<test_crate!MyStruct./u32./std!hash.random.RandomState.>.)
 Poly
)
(declare-fun %Poly%std!collections.hash.map.HashMap<test_crate!MyStruct./u32./std!hash.random.RandomState.>.
 (Poly) std!collections.hash.map.HashMap<test_crate!MyStruct./u32./std!hash.random.RandomState.>.
)
...
(declare-fun Poly%vstd!map.Map<test_crate!MyStruct./u32.>. (vstd!map.Map<test_crate!MyStruct./u32.>.)
 Poly
)
(declare-fun %Poly%vstd!map.Map<test_crate!MyStruct./u32.>. (Poly) vstd!map.Map<test_crate!MyStruct./u32.>.)
...
(assert
 (forall ((x std!collections.hash.map.HashMap<test_crate!MyStruct./u32./std!hash.random.RandomState.>.))
  (!
   (= x (%Poly%std!collections.hash.map.HashMap<test_crate!MyStruct./u32./std!hash.random.RandomState.>.
     (Poly%std!collections.hash.map.HashMap<test_crate!MyStruct./u32./std!hash.random.RandomState.>.
      x
   )))
   :pattern ((Poly%std!collections.hash.map.HashMap<test_crate!MyStruct./u32./std!hash.random.RandomState.>.
     x
   ))
   :qid internal_std__collections__hash__map__HashMap<test_crate!MyStruct./u32./std!hash.random.RandomState.>_box_axiom_definition
   :skolemid skolem_internal_std__collections__hash__map__HashMap<test_crate!MyStruct./u32./std!hash.random.RandomState.>_box_axiom_definition
)))
(assert
 (forall ((x Poly)) (!
   (=>
    (has_type x (TYPE%std!collections.hash.map.HashMap. $ TYPE%test_crate!MyStruct. $ (
       UINT 32
   ...
   :pattern ((has_type x (TYPE%std!collections.hash.map.HashMap. $ TYPE%test_crate!MyStruct.
      $ (UINT 32) $ TYPE%std!hash.random.RandomState.
   )))
   :qid internal_std__collections__hash__map__HashMap<test_crate!MyStruct./u32./std!hash.random.RandomState.>_unbox_axiom_definition
   :skolemid skolem_internal_std__collections__hash__map__HashMap<test_crate!MyStruct./u32./std!hash.random.RandomState.>_unbox_axiom_definition
)))
(assert
 (forall ((x std!collections.hash.map.HashMap<test_crate!MyStruct./u32./std!hash.random.RandomState.>.))
  (!
   (has_type (Poly%std!collections.hash.map.HashMap<test_crate!MyStruct./u32./std!hash.random.RandomState.>.
     x
    ) (TYPE%std!collections.hash.map.HashMap. $ TYPE%test_crate!MyStruct. $ (UINT 32)
     $ TYPE%std!hash.random.RandomState.
   ))
   :pattern ((has_type (Poly%std!collections.hash.map.HashMap<test_crate!MyStruct./u32./std!hash.random.RandomState.>.
      x
     ) (TYPE%std!collections.hash.map.HashMap. $ TYPE%test_crate!MyStruct. $ (UINT 32)
      $ TYPE%std!hash.random.RandomState.
   )))
   :qid internal_std__collections__hash__map__HashMap<test_crate!MyStruct./u32./std!hash.random.RandomState.>_has_type_always_definition
   :skolemid skolem_internal_std__collections__hash__map__HashMap<test_crate!MyStruct./u32./std!hash.random.RandomState.>_has_type_always_definition
)))
(assert
...
(assert
 (forall ((x vstd!map.Map<test_crate!MyStruct./u32.>.)) (!
   (= x (%Poly%vstd!map.Map<test_crate!MyStruct./u32.>. (Poly%vstd!map.Map<test_crate!MyStruct./u32.>.
      x
   )))
   :pattern ((Poly%vstd!map.Map<test_crate!MyStruct./u32.>. x))
   :qid internal_vstd__map__Map<test_crate!MyStruct./u32.>_box_axiom_definition
   :skolemid skolem_internal_vstd__map__Map<test_crate!MyStruct./u32.>_box_axiom_definition
)))
(assert
 (forall ((x Poly)) (!
   (=>
    (has_type x (TYPE%vstd!map.Map. $ TYPE%test_crate!MyStruct. $ (UINT 32)))
    (= x (Poly%vstd!map.Map<test_crate!MyStruct./u32.>. (%Poly%vstd!map.Map<test_crate!MyStruct./u32.>.
       x
   ))))
   :pattern ((has_type x (TYPE%vstd!map.Map. $ TYPE%test_crate!MyStruct. $ (UINT 32))))
   :qid internal_vstd__map__Map<test_crate!MyStruct./u32.>_unbox_axiom_definition
   :skolemid skolem_internal_vstd__map__Map<test_crate!MyStruct./u32.>_unbox_axiom_definition
)))
(assert
 (forall ((x vstd!map.Map<test_crate!MyStruct./u32.>.)) (!
   (has_type (Poly%vstd!map.Map<test_crate!MyStruct./u32.>. x) (TYPE%vstd!map.Map. $ TYPE%test_crate!MyStruct.
     $ (UINT 32)
   ))
   :pattern ((has_type (Poly%vstd!map.Map<test_crate!MyStruct./u32.>. x) (TYPE%vstd!map.Map.
      $ TYPE%test_crate!MyStruct. $ (UINT 32)
   )))
   :qid internal_vstd__map__Map<test_crate!MyStruct./u32.>_has_type_always_definition
   :skolemid skolem_internal_vstd__map__Map<test_crate!MyStruct./u32.>_has_type_always_definition
)))
(assert
...
(assert
 (=>
  ...
  (forall ((Key&. Dcr) (Key& Type)) (!
    ...
    :qid user_vstd__std_specs__hash__axiom_box_integer_type_obeys_hash_table_key_model_6
    :skolemid skolem_user_vstd__std_specs__hash__axiom_box_integer_type_obeys_hash_table_key_model_6
))))
...
(assert
 (=>
  ...
  (forall ((K&. Dcr) (K& Type) (V&. Dcr) (V& Type) (m! Poly) (key! Poly)) (!
    ...
    :qid user_vstd__map__axiom_map_index_decreases_finite_12
    :skolemid skolem_user_vstd__map__axiom_map_index_decreases_finite_12
))))
...
(assert
 (=>
  ...
  (forall ((K&. Dcr) (K& Type) (V&. Dcr) (V& Type) (m! Poly) (key! Poly)) (!
    ...
    :pattern ((height (vstd!map.impl&%0.index.? K&. K& V&. V& m! key!)))
    :qid user_vstd__map__axiom_map_index_decreases_infinite_13
    :skolemid skolem_user_vstd__map__axiom_map_index_decreases_infinite_13
))))
...
(assert
 (=>
  ...
  (forall ((K&. Dcr) (K& Type) (V&. Dcr) (V& Type)) (!
    ...
    :qid user_vstd__map__axiom_map_empty_14
    :skolemid skolem_user_vstd__map__axiom_map_empty_14
))))
 ...
 (=>
  ...
  (forall ((K&. Dcr) (K& Type) (V&. Dcr) (V& Type) (m! Poly) (key! Poly) (value! Poly))
   (!
    ...
    :qid user_vstd__map__axiom_map_insert_domain_15
    :skolemid skolem_user_vstd__map__axiom_map_insert_domain_15
))))
 ...
 (=>
  ...
  (forall ((K&. Dcr) (K& Type) (V&. Dcr) (V& Type) (m! Poly) (key! Poly) (value! Poly))
   (!
    ...
    :qid user_vstd__map__axiom_map_insert_same_16
    :skolemid skolem_user_vstd__map__axiom_map_insert_same_16
))))
...
(assert
 (=>
  ...
  (forall ((K&. Dcr) (K& Type) (V&. Dcr) (V& Type) (m! Poly) (key1! Poly) (key2! Poly)
    ...
    :qid user_vstd__map__axiom_map_insert_different_17
    :skolemid skolem_user_vstd__map__axiom_map_insert_different_17
))))
    ...
    (=>
     ...
     (= (ext_eq false (TYPE%vstd!map.Map. K&. K& V&. V&) m1! m2!) (and
       ...
       (forall ((k$ Poly)) (!
         ...
         :qid user_vstd__map__axiom_map_ext_equal_18
         :skolemid skolem_user_vstd__map__axiom_map_ext_equal_18
    )))))
    ...
    (=>
     ...
     (= (ext_eq true (TYPE%vstd!map.Map. K&. K& V&. V&) m1! m2!) (and
       ...
       (forall ((k$ Poly)) (!
         ...
         :pattern ((vstd!map.impl&%0.index.? K&. K& V&. V& m1! k$))
         :pattern ((vstd!map.impl&%0.index.? K&. K& V&. V& m2! k$))
         :qid user_vstd__map__axiom_map_ext_equal_deep_20
         :skolemid skolem_user_vstd__map__axiom_map_ext_equal_deep_20
    )))))
...
(assert
 (=>
  ...
  (forall ((T&. Dcr) (T& Type) (a! Poly)) (!
    ...
    :qid user_vstd__raw_ptr__ptrs_mut_eq_22
    :skolemid skolem_user_vstd__raw_ptr__ptrs_mut_eq_22
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (s! Poly) (i! Poly)) (!
    ...
    :qid user_vstd__seq__axiom_seq_index_decreases_23
    :skolemid skolem_user_vstd__seq__axiom_seq_index_decreases_23
))))
    ...
    (=>
     ...
     (= (ext_eq false (TYPE%vstd!seq.Seq. A&. A&) s1! s2!) (and
       ...
       (forall ((i$ Poly)) (!
         ...
         :skolemid skolem_user_vstd__seq__axiom_seq_ext_equal_24
    )))))
    ...
    (=>
     ...
     (= (ext_eq true (TYPE%vstd!seq.Seq. A&. A&) s1! s2!) (and
       ...
       (forall ((i$ Poly)) (!
         ...
         :pattern ((vstd!seq.Seq.index.? A&. A& s1! i$))
         :pattern ((vstd!seq.Seq.index.? A&. A& s2! i$))
         :qid user_vstd__seq__axiom_seq_ext_equal_deep_26
         :skolemid skolem_user_vstd__seq__axiom_seq_ext_equal_deep_26
    )))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (a! Poly)) (!
    ...
    :qid user_vstd__set__axiom_set_empty_28
    :skolemid skolem_user_vstd__set__axiom_set_empty_28
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (s! Poly) (a! Poly)) (!
    ...
    :qid user_vstd__set__axiom_set_insert_same_29
    :skolemid skolem_user_vstd__set__axiom_set_insert_same_29
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (s! Poly) (a1! Poly) (a2! Poly)) (!
    ...
    :qid user_vstd__set__axiom_set_insert_different_30
    :skolemid skolem_user_vstd__set__axiom_set_insert_different_30
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (s1! Poly) (s2! Poly)) (!
    ...
    :qid user_vstd__set__axiom_set_ext_equal_32
    :skolemid skolem_user_vstd__set__axiom_set_ext_equal_32
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (s1! Poly) (s2! Poly)) (!
    ...
    :qid user_vstd__set__axiom_set_ext_equal_deep_33
    :skolemid skolem_user_vstd__set__axiom_set_ext_equal_deep_33
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type)) (!
    ...
    :qid user_vstd__set__axiom_set_empty_finite_34
    :skolemid skolem_user_vstd__set__axiom_set_empty_finite_34
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (s! Poly) (a! Poly)) (!
    ...
    :qid user_vstd__set__axiom_set_insert_finite_35
    :skolemid skolem_user_vstd__set__axiom_set_insert_finite_35
))))
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/hash-94588ed97bed1cec-test_hash_map_struct/test.rs:38:1: 38:10 (#0)
...
(push)
 ...
 (declare-const m@0 std!collections.hash.map.HashMap<test_crate!MyStruct./u32./std!hash.random.RandomState.>.)
 ...
 (declare-const m@1 std!collections.hash.map.HashMap<test_crate!MyStruct./u32./std!hash.random.RandomState.>.)
 (declare-const m@2 std!collections.hash.map.HashMap<test_crate!MyStruct./u32./std!hash.random.RandomState.>.)
 ...
 (assert
  (not (=>
    ...
    (=>
     ...
     (=>
      (ens%std!collections.hash.map.impl&%0.new. $ TYPE%test_crate!MyStruct. $ (UINT 32)
       tmp%1
      )
      (=>
       (= m@0 (%Poly%std!collections.hash.map.HashMap<test_crate!MyStruct./u32./std!hash.random.RandomState.>.
         tmp%1
       ))
       (=>
        (= tmp%2 (ext_eq false (TYPE%vstd!map.Map. $ TYPE%test_crate!MyStruct. $ (UINT 32))
          (vstd!view.View.view.? $ (TYPE%std!collections.hash.map.HashMap. $ TYPE%test_crate!MyStruct.
            $ (UINT 32) $ TYPE%std!hash.random.RandomState.
           ) (Poly%std!collections.hash.map.HashMap<test_crate!MyStruct./u32./std!hash.random.RandomState.>.
            m@0
           )
          ) (vstd!map.impl&%0.empty.? $ TYPE%test_crate!MyStruct. $ (UINT 32))
        ))
        (and
         (=>
          %%location_label%%0
         ...
         (=>
          ...
          (=>
           ...
           (=>
            (ens%std!collections.hash.map.impl&%2.insert. $ TYPE%test_crate!MyStruct. $ (UINT 32)
             $ TYPE%std!hash.random.RandomState. (Poly%std!collections.hash.map.HashMap<test_crate!MyStruct./u32./std!hash.random.RandomState.>.
              m@0
             ) (Poly%std!collections.hash.map.HashMap<test_crate!MyStruct./u32./std!hash.random.RandomState.>.
              m@1
             ) (Poly%test_crate!MyStruct. s1@) (I 4) tmp%3
            )
            (=>
             (= s2@ (test_crate!MyStruct./MyStruct (%I (I 3)) (%I (I 7))))
             (=>
              (= tmp%4 (= (%I (vstd!map.impl&%0.index.? $ TYPE%test_crate!MyStruct. $ (UINT 32) (vstd!view.View.view.?
                   $ (TYPE%std!collections.hash.map.HashMap. $ TYPE%test_crate!MyStruct. $ (UINT 32)
                    $ TYPE%std!hash.random.RandomState.
                   ) (Poly%std!collections.hash.map.HashMap<test_crate!MyStruct./u32./std!hash.random.RandomState.>.
                    m@1
              ...
              (and
               ...
               (=>
                tmp%4
                (=>
                 (= tmp%5 (vstd!set.impl&%0.contains.? $ TYPE%test_crate!MyStruct. (vstd!map.impl&%0.dom.?
                    $ TYPE%test_crate!MyStruct. $ (UINT 32) (vstd!view.View.view.? $ (TYPE%std!collections.hash.map.HashMap.
                      $ TYPE%test_crate!MyStruct. $ (UINT 32) $ TYPE%std!hash.random.RandomState.
                     ) (Poly%std!collections.hash.map.HashMap<test_crate!MyStruct./u32./std!hash.random.RandomState.>.
                      m@1
                    ))
                   ) (Poly%test_crate!MyStruct. s2@)
                 ...
                 (and
                  ...
                  (=>
                   tmp%5
                   (=>
                    (ens%std!collections.hash.map.impl&%2.contains_key. $ TYPE%test_crate!MyStruct. $
                     (UINT 32) $ TYPE%std!hash.random.RandomState. $ TYPE%test_crate!MyStruct. (Poly%std!collections.hash.map.HashMap<test_crate!MyStruct./u32./std!hash.random.RandomState.>.
                      m@1
                    ...
                    (and
                     ...
                     (=>
                      b@
                      (=>
                       (ens%std!collections.hash.map.impl&%2.get. $ TYPE%test_crate!MyStruct. $ (UINT 32)
                        $ TYPE%std!hash.random.RandomState. $ TYPE%test_crate!MyStruct. (Poly%std!collections.hash.map.HashMap<test_crate!MyStruct./u32./std!hash.random.RandomState.>.
                         m@1
                       ...
                       (or
                        ...
                        (and
                         (not %%switch_label%%0)
                         (=>
                          (ens%std!collections.hash.map.impl&%1.clear. $ TYPE%test_crate!MyStruct. $ (UINT 32)
                           $ TYPE%std!hash.random.RandomState. (Poly%std!collections.hash.map.HashMap<test_crate!MyStruct./u32./std!hash.random.RandomState.>.
                            m@1
                           ) (Poly%std!collections.hash.map.HashMap<test_crate!MyStruct./u32./std!hash.random.RandomState.>.
                            m@2
                          ...
                          (=>
                           (= tmp%7 (not (vstd!set.impl&%0.contains.? $ TYPE%test_crate!MyStruct. (vstd!map.impl&%0.dom.?
                               $ TYPE%test_crate!MyStruct. $ (UINT 32) (vstd!view.View.view.? $ (TYPE%std!collections.hash.map.HashMap.
                                 $ TYPE%test_crate!MyStruct. $ (UINT 32) $ TYPE%std!hash.random.RandomState.
                                ) (Poly%std!collections.hash.map.HashMap<test_crate!MyStruct./u32./std!hash.random.RandomState.>.
                                 m@2
