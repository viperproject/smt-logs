...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (s1! Poly) (s2! Poly)) (!
    ...
    :qid user_vstd__seq__axiom_seq_add_len_14
    :skolemid skolem_user_vstd__seq__axiom_seq_add_len_14
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (s1! Poly) (s2! Poly) (i! Poly)) (!
    ...
    :qid user_vstd__seq__axiom_seq_add_index1_15
    :skolemid skolem_user_vstd__seq__axiom_seq_add_index1_15
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (s1! Poly) (s2! Poly) (i! Poly)) (!
    ...
    :pattern ((vstd!seq.Seq.index.? A&. A& (vstd!seq.Seq.add.? A&. A& s1! s2!) i!))
    :qid user_vstd__seq__axiom_seq_add_index2_16
    :skolemid skolem_user_vstd__seq__axiom_seq_add_index2_16
))))

;; Function-Def test_crate::test_seq
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/seqs-32c605baea0b15ea-test1_fails2/test.rs:17:7: 17:20 (#0)
...
(push)
 ...
 (assert
  (forall ((%%hole%%0 Int) (i$ Poly)) (!
    (= (%%apply%%0 (%%lambda%%0 %%hole%%0) i$) (I (Mul %%hole%%0 (%I i$))))
 ...
 (assert
  (not (=>
    (= s1@ (%Poly%vstd!seq.Seq<int.>. (vstd!seq.Seq.new.? $ INT $ (TYPE%fun%1. $ INT $ INT)
       (I 5) (Poly%fun%1. (mk_fun (%%lambda%%0 10)))
    )))
    (=>
...
;; Function-Recommends test_crate::test_seq
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/seqs-32c605baea0b15ea-test1_fails2/test.rs:17:7: 17:20 (#0)
(get-info :all-statistics)
(push)
 (declare-const no%param Int)
 ...
 (assert
  (forall ((%%hole%%0 Int) (i$ Poly)) (!
    (= (%%apply%%0 (%%lambda%%1 %%hole%%0) i$) (I (Mul %%hole%%0 (%I i$))))
 ...
 (assert
  (not (=>
    ...
    (=>
     (= s1@ (%Poly%vstd!seq.Seq<int.>. (vstd!seq.Seq.new.? $ INT $ (TYPE%fun%1. $ INT $ INT)
        (I 5) (Poly%fun%1. (mk_fun (%%lambda%%1 10)))
     )))
     (=>
      (= (vstd!seq.Seq.len.? $ INT (Poly%vstd!seq.Seq<int.>. s1@)) 5)
      (and
       (=>
        %%location_label%%0
        (req%vstd!seq.Seq.index. $ INT (Poly%vstd!seq.Seq<int.>. s1@) (I 3))
       )
       (=>
        (= tmp%1 (vstd!seq.Seq.index.? $ INT (Poly%vstd!seq.Seq<int.>. s1@) (I 3)))
        (=>
         (= (%I tmp%1) 30)
         (=>
          (= s2@ (%Poly%vstd!seq.Seq<int.>. (vstd!seq.Seq.push.? $ INT (vstd!seq.Seq.push.? $ INT
          ...
          (=>
           (ext_eq false (TYPE%vstd!seq.Seq. $ INT) (Poly%vstd!seq.Seq<int.>. s1@) (Poly%vstd!seq.Seq<int.>.
             s2@
           ))
           (=>
            (= s1@ s2@)
            (and
             (=>
              %%location_label%%1
              (req%vstd!seq.Seq.subrange. $ INT (Poly%vstd!seq.Seq<int.>. s2@) (I 1) (I 4))
             )
             (=>
              (= tmp%2 (vstd!seq.Seq.subrange.? $ INT (Poly%vstd!seq.Seq<int.>. s2@) (I 1) (I 4)))
              (=>
               (= s3@ (%Poly%vstd!seq.Seq<int.>. tmp%2))
               (=>
                (= (vstd!seq.Seq.len.? $ INT (Poly%vstd!seq.Seq<int.>. s3@)) 3)
                (=>
                 (= s4@ (%Poly%vstd!seq.Seq<int.>. (vstd!seq.Seq.push.? $ INT (vstd!seq.Seq.push.? $ INT
                     (vstd!seq.Seq.push.? $ INT (vstd!seq.Seq.empty.? $ INT) (I 10)) (I 20)
                    ) (I 30)
                 ...
                 (=>
                  (ext_eq false (TYPE%vstd!seq.Seq. $ INT) (Poly%vstd!seq.Seq<int.>. s3@) (Poly%vstd!seq.Seq<int.>.
                    s4@
                  ))
                  (=>
                   (= s5@ (%Poly%vstd!seq.Seq<int.>. (vstd!seq.Seq.add.? $ INT (Poly%vstd!seq.Seq<int.>.
                   ...
                   (=>
                    (= (vstd!seq.Seq.len.? $ INT (Poly%vstd!seq.Seq<int.>. s5@)) 8)
                    (and
                     (=>
                      %%location_label%%2
                      (req%vstd!seq.Seq.index. $ INT (Poly%vstd!seq.Seq<int.>. s5@) (I 1))
                     )
                     (=>
                      (= tmp%3 (vstd!seq.Seq.index.? $ INT (Poly%vstd!seq.Seq<int.>. s5@) (I 1)))
                      (=>
                       (= (%I tmp%3) 20)
                       (=>
                        %%location_label%%3
                        (req%vstd!seq.Seq.index. $ INT (Poly%vstd!seq.Seq<int.>. s5@) (I 6))
 )))))))))))))))))))))))
 (get-info :version)
 (set-option :rlimit 30000000)
 (check-sat)
