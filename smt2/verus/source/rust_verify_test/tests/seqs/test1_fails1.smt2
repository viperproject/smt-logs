...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/seqs-32c605baea0b15ea-test1_fails1/test.rs:17:7: 17:20 (#0)
       ...
       (=>
        ...
        (and
         ...
         (=>
          tmp%2
          (=>
           (= tmp%3 (= (%I (vstd!seq.Seq.index.? $ INT (Poly%vstd!seq.Seq<int.>. s1@) (I 5)))
             50
           ))
           (=>
            %%location_label%%2
      ...
      (and
       ...
       (=>
        ...
        (=>
         ...
         (=>
          %%location_label%%1
          (req%vstd!seq.Seq.index. $ INT (Poly%vstd!seq.Seq<int.>. s1@) (I 5))
 )))))))))
 (get-info :version)
 (set-option :rlimit 30000000)
 (check-sat)
