...
(assert
 (distinct fuel%vstd!array.array_view. fuel%vstd!array.impl&%0.view. fuel%vstd!array.impl&%2.spec_index.
  ...
  fuel%vstd!seq_lib.impl&%0.map. fuel%vstd!seq_lib.impl&%0.contains. fuel%vstd!seq_lib.impl&%0.to_set.
  fuel%vstd!seq_lib.seq_to_set_is_finite. fuel%vstd!set.axiom_set_new. fuel%vstd!set.axiom_set_ext_equal.
...
(declare-sort vstd!set.Set<bool.>. 0)
...
(declare-fun Poly%vstd!set.Set<bool.>. (vstd!set.Set<bool.>.) Poly)
(declare-fun %Poly%vstd!set.Set<bool.>. (Poly) vstd!set.Set<bool.>.)
...
(assert
 (forall ((x vstd!set.Set<bool.>.)) (!
   (= x (%Poly%vstd!set.Set<bool.>. (Poly%vstd!set.Set<bool.>. x)))
   :pattern ((Poly%vstd!set.Set<bool.>. x))
   :qid internal_vstd__set__Set<bool.>_box_axiom_definition
   :skolemid skolem_internal_vstd__set__Set<bool.>_box_axiom_definition
)))
(assert
 (forall ((x Poly)) (!
   (=>
    (has_type x (TYPE%vstd!set.Set. $ BOOL))
    (= x (Poly%vstd!set.Set<bool.>. (%Poly%vstd!set.Set<bool.>. x)))
   )
   :pattern ((has_type x (TYPE%vstd!set.Set. $ BOOL)))
   :qid internal_vstd__set__Set<bool.>_unbox_axiom_definition
   :skolemid skolem_internal_vstd__set__Set<bool.>_unbox_axiom_definition
)))
(assert
 (forall ((x vstd!set.Set<bool.>.)) (!
   (has_type (Poly%vstd!set.Set<bool.>. x) (TYPE%vstd!set.Set. $ BOOL))
   :pattern ((has_type (Poly%vstd!set.Set<bool.>. x) (TYPE%vstd!set.Set. $ BOOL)))
   :qid internal_vstd__set__Set<bool.>_has_type_always_definition
   :skolemid skolem_internal_vstd__set__Set<bool.>_has_type_always_definition
)))
(assert
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type)) (!
    ...
    :qid user_vstd__seq__axiom_seq_empty_5
    :skolemid skolem_user_vstd__seq__axiom_seq_empty_5
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (len! Poly) (f! Poly)) (!
    ...
    :qid user_vstd__seq__axiom_seq_new_len_6
    :skolemid skolem_user_vstd__seq__axiom_seq_new_len_6
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (len! Poly) (f! Poly) (i! Poly)) (!
    ...
    :qid user_vstd__seq__axiom_seq_new_index_7
    :skolemid skolem_user_vstd__seq__axiom_seq_new_index_7
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (s! Poly) (a! Poly)) (!
    ...
    :qid user_vstd__seq__axiom_seq_push_len_8
    :skolemid skolem_user_vstd__seq__axiom_seq_push_len_8
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (s! Poly) (a! Poly) (i! Poly)) (!
    ...
    :qid user_vstd__seq__axiom_seq_push_index_same_9
    :skolemid skolem_user_vstd__seq__axiom_seq_push_index_same_9
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (s! Poly) (a! Poly) (i! Poly)) (!
    ...
    :pattern ((vstd!seq.Seq.index.? A&. A& (vstd!seq.Seq.push.? A&. A& s! a!) i!))
    :qid user_vstd__seq__axiom_seq_push_index_different_10
    :skolemid skolem_user_vstd__seq__axiom_seq_push_index_different_10
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (s1! Poly) (s2! Poly)) (!
    ...
    :qid user_vstd__seq__axiom_seq_add_len_17
    :skolemid skolem_user_vstd__seq__axiom_seq_add_len_17
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (s1! Poly) (s2! Poly) (i! Poly)) (!
    ...
    :qid user_vstd__seq__axiom_seq_add_index1_18
    :skolemid skolem_user_vstd__seq__axiom_seq_add_index1_18
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (s1! Poly) (s2! Poly) (i! Poly)) (!
    ...
    :pattern ((vstd!seq.Seq.index.? A&. A& (vstd!seq.Seq.add.? A&. A& s1! s2!) i!))
    :qid user_vstd__seq__axiom_seq_add_index2_19
    :skolemid skolem_user_vstd__seq__axiom_seq_add_index2_19
))))
 ...
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (self! Poly) (needle! Poly)) (!
    (= (vstd!seq_lib.impl&%0.contains.? A&. A& self! needle!) (exists ((i$ Poly)) (!
       ...
       :pattern ((vstd!seq.Seq.index.? A&. A& self! i$))
       :qid user_vstd__seq_lib__impl&%0__contains_20
       :skolemid skolem_user_vstd__seq_lib__impl&%0__contains_20
    )))
...
(assert
 (forall ((%%hole%%0 Dcr) (%%hole%%1 Type) (%%hole%%2 Poly) (a$ Poly)) (!
   (= (%%apply%%0 (%%lambda%%1 %%hole%%0 %%hole%%1 %%hole%%2) a$) (B (vstd!seq_lib.impl&%0.contains.?
      %%hole%%0 %%hole%%1 %%hole%%2 a$
   )))
   :pattern ((%%apply%%0 (%%lambda%%1 %%hole%%0 %%hole%%1 %%hole%%2) a$))
)))
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (self! Poly)) (!
    (= (vstd!seq_lib.impl&%0.to_set.? A&. A& self!) (vstd!set.impl&%0.new.? A&. A& $ (TYPE%fun%1.
       A&. A& $ BOOL
      ) (Poly%fun%1. (mk_fun (%%lambda%%1 A&. A& self!)))
    ))
...
;; Function-Specs vstd::seq_lib::seq_to_set_is_finite
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (seq! Poly)) (!
    ...
    :qid user_vstd__seq_lib__seq_to_set_is_finite_21
    :skolemid skolem_user_vstd__seq_lib__seq_to_set_is_finite_21
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (f! Poly) (a! Poly)) (!
    ...
    :qid user_vstd__set__axiom_set_new_22
    :skolemid skolem_user_vstd__set__axiom_set_new_22
))))
...
;; Function-Def test_crate::test_seq
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/seqs-32c605baea0b15ea-test1/test.rs:18:7: 18:20 (#0)
...
(push)
 ...
 (declare-const s5@ vstd!seq.Seq<int.>.)
 (declare-const s6@ vstd!seq.Seq<int.>.)
 (declare-const s7@ vstd!seq.Seq<bool.>.)
 (declare-const s8@ vstd!seq.Seq<int.>.)
 (assert
  fuel_defaults
 )
 ...
 (assert
  (forall ((%%hole%%0 Int) (i$ Poly)) (!
    (= (%%apply%%0 (%%lambda%%3 %%hole%%0) i$) (I (Mul %%hole%%0 (%I i$))))
    :pattern ((%%apply%%0 (%%lambda%%3 %%hole%%0) i$))
 )))
 (declare-fun %%lambda%%4 (Int) %%Function%%)
 (assert
  (forall ((%%hole%%0 Int) (i$ Poly) (a$ Poly)) (!
    (= (%%apply%%1 (%%lambda%%4 %%hole%%0) i$ a$) (I (Add (Mul %%hole%%0 (%I i$)) (%I a$))))
    :pattern ((%%apply%%1 (%%lambda%%4 %%hole%%0) i$ a$))
 )))
 ...
 (assert
  (forall ((%%hole%%0 Poly) (_x$ Poly)) (!
    (= (%%apply%%0 (%%lambda%%5 %%hole%%0) _x$) %%hole%%0)
    :pattern ((%%apply%%0 (%%lambda%%5 %%hole%%0) _x$))
 )))
 ;; assertion failed
 ...
 (assert
  (not (=>
    (= s1@ (%Poly%vstd!seq.Seq<int.>. (vstd!seq.Seq.new.? $ INT $ (TYPE%fun%1. $ INT $ INT)
       (I 5) (Poly%fun%1. (mk_fun (%%lambda%%3 10)))
    )))
    (=>
     (= tmp%1 (= (vstd!seq.Seq.len.? $ INT (Poly%vstd!seq.Seq<int.>. s1@)) 5))
     (and
      (=>
       %%location_label%%0
       tmp%1
      ...
      (=>
       tmp%1
       (=>
        (= tmp%2 (= (%I (vstd!seq.Seq.index.? $ INT (Poly%vstd!seq.Seq<int.>. s1@) (I 3)))
          30
        ))
        (and
         (=>
         ...
         (=>
          tmp%2
          (=>
           (= s2@ (%Poly%vstd!seq.Seq<int.>. (vstd!seq.Seq.push.? $ INT (vstd!seq.Seq.push.? $ INT
               (vstd!seq.Seq.push.? $ INT (vstd!seq.Seq.push.? $ INT (vstd!seq.Seq.push.? $ INT (vstd!seq.Seq.empty.?
                   $ INT
                  ) (I 0)
                 ) (I 10)
                ) (I 20)
           ...
           (=>
            (= tmp%3 (ext_eq false (TYPE%vstd!seq.Seq. $ INT) (Poly%vstd!seq.Seq<int.>. s1@) (Poly%vstd!seq.Seq<int.>.
               s2@
            )))
            (and
             (=>
             ...
             (=>
              tmp%3
              (=>
               (= tmp%4 (ext_eq false (TYPE%vstd!seq.Seq. $ INT) (Poly%vstd!seq.Seq<int.>. s1@) (Poly%vstd!seq.Seq<int.>.
                  s2@
               )))
               (and
                (=>
                ...
                (=>
                 tmp%4
                 (=>
                  (= s3@ (%Poly%vstd!seq.Seq<int.>. (vstd!seq.Seq.subrange.? $ INT (Poly%vstd!seq.Seq<int.>.
                      s2@
                     ) (I 1) (I 4)
                  )))
                  (=>
                   (= tmp%5 (= (vstd!seq.Seq.len.? $ INT (Poly%vstd!seq.Seq<int.>. s3@)) 3))
                   (and
                    (=>
                     %%location_label%%4
                     tmp%5
                    ...
                    (=>
                     tmp%5
                     (=>
                      (= s4@ (%Poly%vstd!seq.Seq<int.>. (vstd!seq.Seq.push.? $ INT (vstd!seq.Seq.push.? $ INT
                          (vstd!seq.Seq.push.? $ INT (vstd!seq.Seq.empty.? $ INT) (I 10)) (I 20)
                         ) (I 30)
                      )))
                      (=>
                       (= tmp%6 (ext_eq false (TYPE%vstd!seq.Seq. $ INT) (Poly%vstd!seq.Seq<int.>. s3@) (Poly%vstd!seq.Seq<int.>.
                          s4@
                       )))
                       (and
                        (=>
                        ...
                        (=>
                         tmp%6
                         (=>
                          (= s5@ (%Poly%vstd!seq.Seq<int.>. (vstd!seq.Seq.add.? $ INT (Poly%vstd!seq.Seq<int.>.
                              s3@
                             ) (Poly%vstd!seq.Seq<int.>. s1@)
                          )))
                          (=>
                           (= tmp%7 (= (vstd!seq.Seq.len.? $ INT (Poly%vstd!seq.Seq<int.>. s5@)) 8))
                           (and
                            (=>
                             %%location_label%%6
                             tmp%7
                            ...
                            (=>
                             tmp%7
                             (=>
                              (= tmp%8 (= (%I (vstd!seq.Seq.index.? $ INT (Poly%vstd!seq.Seq<int.>. s5@) (I 1)))
                                20
                              ))
                              (and
                               (=>
                               ...
                               (=>
                                tmp%8
                                (=>
                                 (= tmp%9 (= (%I (vstd!seq.Seq.index.? $ INT (Poly%vstd!seq.Seq<int.>. s5@) (I 6)))
                                   30
                                 ))
                                 (and
                                  (=>
                                  ...
                                  (=>
                                   tmp%9
                                   (=>
                                    (= s6@ (%Poly%vstd!seq.Seq<int.>. (vstd!seq_lib.impl&%0.map.? $ INT $ INT (Poly%vstd!seq.Seq<int.>.
                                        s4@
                                       ) (Poly%fun%2. (mk_fun (%%lambda%%4 2)))
                                    )))
                                    (=>
                                     (= tmp%10 (= (vstd!seq.Seq.len.? $ INT (Poly%vstd!seq.Seq<int.>. s6@)) (vstd!seq.Seq.len.?
                                        $ INT (Poly%vstd!seq.Seq<int.>. s4@)
                                     )))
                                     (and
                                      (=>
                                       %%location_label%%9
                                      ...
                                      (=>
                                       tmp%10
                                       (=>
                                        (= tmp%11 (= (%I (vstd!seq.Seq.index.? $ INT (Poly%vstd!seq.Seq<int.>. s6@) (I 2)))
                                          34
                                        ))
                                        (and
                                         (=>
                                         ...
                                         (=>
                                          tmp%11
                                          (=>
                                           (= s7@ (%Poly%vstd!seq.Seq<bool.>. (vstd!view.View.view.? $ (ARRAY $ BOOL $ (CONST_INT
                                                2
                                               )
                                              ) (array_new $ BOOL 2 (%%array%%0 (B false) (B true)))
                                           )))
                                           (=>
                                            (= tmp%12 (not (%B (vstd!seq.Seq.index.? $ BOOL (Poly%vstd!seq.Seq<bool.>. s7@) (I 0)))))
                                            (and
                                             (=>
                                              %%location_label%%11
                                              tmp%12
                                             ...
                                             (=>
                                              tmp%12
                                              (=>
                                               (= tmp%13 (%B (vstd!seq.Seq.index.? $ BOOL (Poly%vstd!seq.Seq<bool.>. s7@) (I 1))))
                                               (and
                                                (=>
                                                 %%location_label%%12
                                                 tmp%13
                                                ...
                                                (=>
                                                 tmp%13
                                                 (=>
                                                  (= s8@ (%Poly%vstd!seq.Seq<int.>. (vstd!seq.Seq.new.? $ INT $ (TYPE%fun%1. $ INT $ INT)
                                                     (I 10) (Poly%fun%1. (mk_fun (%%lambda%%5 (I 5))))
                                                  )))
                                                  (=>
                                                   (= tmp%14 (= (%I (vstd!seq.Seq.index.? $ INT (Poly%vstd!seq.Seq<int.>. s8@) (I 0)))
                                                     5
                                                   ))
                                                   (and
                                                    (=>
                                                    ...
                                                    (=>
                                                     tmp%14
                                                     (=>
                                                      (= tmp%15 (= (vstd!seq.Seq.len.? $ INT (Poly%vstd!seq.Seq<int.>. s8@)) 10))
                                                      (and
                                                       (=>
                                                        %%location_label%%14
                                                        tmp%15
                                                       ...
                                                       (=>
                                                        ...
                                                        (and
                                                         (=>
                                                          (ens%vstd!seq_lib.seq_to_set_is_finite. $ INT (Poly%vstd!seq.Seq<int.>. s1@))
                                                          (=>
                                                           %%location_label%%15
                                                           (vstd!set.impl&%0.finite.? $ INT (vstd!seq_lib.impl&%0.to_set.? $ INT (Poly%vstd!seq.Seq<int.>.
                                                              s1@
                                                         )))))
                                                         (=>
                                                          (vstd!set.impl&%0.finite.? $ INT (vstd!seq_lib.impl&%0.to_set.? $ INT (Poly%vstd!seq.Seq<int.>.
                                                          ...
                                                          (and
                                                           (=>
                                                            (ens%vstd!seq_lib.seq_to_set_is_finite. $ INT (Poly%vstd!seq.Seq<int.>. s6@))
                                                            (=>
                                                             %%location_label%%16
                                                             (vstd!set.impl&%0.finite.? $ INT (vstd!seq_lib.impl&%0.to_set.? $ INT (Poly%vstd!seq.Seq<int.>.
                                                                s6@
                                                           ...
                                                           (=>
                                                            ...
                                                            (=>
                                                             (ens%vstd!seq_lib.seq_to_set_is_finite. $ BOOL (Poly%vstd!seq.Seq<bool.>. s7@))
                                                             (=>
                                                              %%location_label%%17
                                                              (vstd!set.impl&%0.finite.? $ BOOL (vstd!seq_lib.impl&%0.to_set.? $ BOOL (Poly%vstd!seq.Seq<bool.>.
                                                                 s7@
 ))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 (get-info :version)
