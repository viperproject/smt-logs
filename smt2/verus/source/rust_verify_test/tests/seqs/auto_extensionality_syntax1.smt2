...
;; Function-Decl vstd::seq_lib::check_argument_is_seq
...
;; Function-Axioms vstd::seq_lib::check_argument_is_seq
(assert
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/seqs-32c605baea0b15ea-auto_extensionality_syntax1/test.rs:17:7: 17:16 (#0)
            ...
            (=>
             ...
             (and
              ...
              (=>
               (= s1$1@ s2$1@)
               (=>
                (= tmp%5 (ext_eq false (TYPE%vstd!seq.Seq. $ INT) (Poly%vstd!seq.Seq<int.>. s1@) (Poly%vstd!seq.Seq<int.>.
                   s2@
                )))
                (=>
                 %%location_label%%6
