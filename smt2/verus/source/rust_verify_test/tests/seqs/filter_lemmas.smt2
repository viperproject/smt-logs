...
(assert
 (distinct fuel%vstd!array.array_view. fuel%vstd!array.impl&%0.view. fuel%vstd!array.impl&%2.spec_index.
  fuel%vstd!array.lemma_array_index. fuel%vstd!array.array_len_matches_n. fuel%vstd!raw_ptr.impl&%4.view.
  fuel%vstd!raw_ptr.ptrs_mut_eq. fuel%vstd!seq.impl&%0.spec_index. fuel%vstd!seq.impl&%0.spec_add.
  ...
  fuel%vstd!seq.axiom_seq_ext_equal. fuel%vstd!seq.axiom_seq_ext_equal_deep. fuel%vstd!seq.axiom_seq_add_len.
  fuel%vstd!seq.axiom_seq_add_index1. fuel%vstd!seq.axiom_seq_add_index2. fuel%vstd!seq_lib.impl&%0.filter_lemma.
  fuel%vstd!seq_lib.impl&%0.filter_distributes_over_add. fuel%vstd!seq_lib.impl&%0.add_empty_left.
  fuel%vstd!seq_lib.impl&%0.add_empty_right. fuel%vstd!seq_lib.impl&%0.push_distributes_over_add.
  fuel%vstd!seq_lib.impl&%0.contains. fuel%vstd!view.impl&%0.view. fuel%vstd!view.impl&%2.view.
  fuel%vstd!view.impl&%4.view. fuel%vstd!view.impl&%6.view. fuel%vstd!view.impl&%10.view.
  fuel%vstd!view.impl&%12.view. fuel%vstd!view.impl&%24.view. fuel%vstd!array.group_array_axioms.
...
(assert
 (=>
  ...
  (and
   (fuel_bool_default fuel%vstd!seq_lib.impl&%0.filter_lemma.)
   ...
   (fuel_bool_default fuel%vstd!seq_lib.impl&%0.filter_distributes_over_add.)
)))
(assert
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (len! Poly) (f! Poly)) (!
    ...
    :qid user_vstd__seq__axiom_seq_new_len_4
    :skolemid skolem_user_vstd__seq__axiom_seq_new_len_4
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (len! Poly) (f! Poly) (i! Poly)) (!
    ...
    :qid user_vstd__seq__axiom_seq_new_index_5
    :skolemid skolem_user_vstd__seq__axiom_seq_new_index_5
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (s! Poly) (a! Poly)) (!
    ...
    :qid user_vstd__seq__axiom_seq_push_len_6
    :skolemid skolem_user_vstd__seq__axiom_seq_push_len_6
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (s! Poly) (a! Poly) (i! Poly)) (!
    ...
    :qid user_vstd__seq__axiom_seq_push_index_same_7
    :skolemid skolem_user_vstd__seq__axiom_seq_push_index_same_7
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (s! Poly) (a! Poly) (i! Poly)) (!
    ...
    :pattern ((vstd!seq.Seq.index.? A&. A& (vstd!seq.Seq.push.? A&. A& s! a!) i!))
    :qid user_vstd__seq__axiom_seq_push_index_different_8
    :skolemid skolem_user_vstd__seq__axiom_seq_push_index_different_8
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (s1! Poly) (s2! Poly)) (!
    ...
    :qid user_vstd__seq__axiom_seq_add_len_13
    :skolemid skolem_user_vstd__seq__axiom_seq_add_len_13
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (s1! Poly) (s2! Poly) (i! Poly)) (!
    ...
    :qid user_vstd__seq__axiom_seq_add_index1_14
    :skolemid skolem_user_vstd__seq__axiom_seq_add_index1_14
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (s1! Poly) (s2! Poly) (i! Poly)) (!
    ...
    :pattern ((vstd!seq.Seq.index.? A&. A& (vstd!seq.Seq.add.? A&. A& s1! s2!) i!))
    :qid user_vstd__seq__axiom_seq_add_index2_15
    :skolemid skolem_user_vstd__seq__axiom_seq_add_index2_15
))))
 ...
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (self! Poly) (needle! Poly)) (!
    (= (vstd!seq_lib.impl&%0.contains.? A&. A& self! needle!) (exists ((i$ Poly)) (!
       ...
       :pattern ((vstd!seq.Seq.index.? A&. A& self! i$))
       :qid user_vstd__seq_lib__impl&%0__contains_16
       :skolemid skolem_user_vstd__seq_lib__impl&%0__contains_16
    )))
...
;; Broadcast vstd::seq_lib::impl&%0::filter_lemma
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (self! Poly) (pred! Poly)) (!
     ...
     (and
      (and
       (forall ((i$ Poly)) (!
         ...
         :qid user_vstd__seq_lib__impl&%0__filter_lemma_17
         :skolemid skolem_user_vstd__seq_lib__impl&%0__filter_lemma_17
       ))
       (forall ((i$ Poly)) (!
         (=>
          (has_type i$ INT)
         ...
         :qid user_vstd__seq_lib__impl&%0__filter_lemma_18
         :skolemid skolem_user_vstd__seq_lib__impl&%0__filter_lemma_18
      )))
    ...
    :qid user_vstd__seq_lib__impl&%0__filter_lemma_19
    :skolemid skolem_user_vstd__seq_lib__impl&%0__filter_lemma_19
))))
...
;; Broadcast vstd::seq_lib::impl&%0::filter_distributes_over_add
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (a! Poly) (b! Poly) (pred! Poly)) (!
    ...
    :qid user_vstd__seq_lib__impl&%0__filter_distributes_over_add_20
    :skolemid skolem_user_vstd__seq_lib__impl&%0__filter_distributes_over_add_20
))))
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/seqs-32c605baea0b15ea-filter_lemmas/test.rs:18:7: 18:16 (#0)
...
(push)
 ...
 (declare-const s3@ vstd!seq.Seq<int.>.)
 (declare-const s4@ vstd!seq.Seq<int.>.)
 (assert
  fuel_defaults
 )
 (declare-fun %%lambda%%1 (Int Int Int Int Int Int Int Int Int Int Int) %%Function%%)
 (assert
 ...
 (assert
  (forall ((%%hole%%0 Int) (x$ Poly)) (!
    (= (%%apply%%0 (%%lambda%%2 %%hole%%0) x$) (B (< (%I x$) %%hole%%0)))
 ...
 (assert
  (not (=>
    (= s1@ (%Poly%vstd!seq.Seq<int.>. (vstd!seq.Seq.new.? $ INT $ (TYPE%fun%1. $ INT $ INT)
       (I 6) (Poly%fun%1. (mk_fun (%%lambda%%1 0 1 2 3 4 55 70 45 30 20 10)))
    )))
    (=>
     (= s2@ (%Poly%vstd!seq.Seq<int.>. (vstd!seq_lib.impl&%0.filter.? $ INT (Poly%vstd!seq.Seq<int.>.
         s1@
        ) (Poly%fun%1. (mk_fun (%%lambda%%2 40)))
     )))
     (=>
      (= s3@ (%Poly%vstd!seq.Seq<int.>. (vstd!view.View.view.? $ (ARRAY $ INT $ (CONST_INT 2))
         (array_new $ INT 2 (%%array%%0 (I 90) (I 100)))
      )))
      (=>
       (= s4@ (%Poly%vstd!seq.Seq<int.>. (vstd!seq_lib.impl&%0.filter.? $ INT (Poly%vstd!seq.Seq<int.>.
           s3@
          ) (Poly%fun%1. (mk_fun (%%lambda%%2 40)))
       )))
       (=>
        (= tmp%1 (forall ((i$ Poly)) (!
           (=>
            (has_type i$ NAT)
            (=>
             (< (%I i$) (vstd!seq.Seq.len.? $ INT (Poly%vstd!seq.Seq<int.>. s2@)))
             (< (%I (vstd!seq.Seq.index.? $ INT (Poly%vstd!seq.Seq<int.>. s2@) i$)) 40)
           ))
           :pattern ((vstd!seq.Seq.index.? $ INT (Poly%vstd!seq.Seq<int.>. s2@) i$))
           :qid user_test_crate__test_24
           :skolemid skolem_user_test_crate__test_24
        )))
        (and
         (=>
          %%location_label%%0
         ...
         (=>
          tmp%1
          (=>
           (= tmp%2 (ext_eq false (TYPE%vstd!seq.Seq. $ INT) (vstd!seq_lib.impl&%0.filter.? $ INT
              (vstd!seq.Seq.add.? $ INT (Poly%vstd!seq.Seq<int.>. s1@) (Poly%vstd!seq.Seq<int.>.
                s3@
               )
              ) (Poly%fun%1. (mk_fun (%%lambda%%2 40)))
             ) (vstd!seq.Seq.add.? $ INT (Poly%vstd!seq.Seq<int.>. s2@) (Poly%vstd!seq.Seq<int.>.
               s4@
           ))))
           (and
            (=>
            ...
            (=>
             tmp%2
             (=>
              (= tmp%3 (ext_eq false (TYPE%vstd!seq.Seq. $ INT) (vstd!seq.Seq.push.? $ INT (vstd!seq.Seq.add.?
                  $ INT (Poly%vstd!seq.Seq<int.>. s2@) (Poly%vstd!seq.Seq<int.>. s4@)
                 ) (I 120)
                ) (vstd!seq.Seq.add.? $ INT (Poly%vstd!seq.Seq<int.>. s2@) (vstd!seq.Seq.push.? $ INT
                  (Poly%vstd!seq.Seq<int.>. s4@) (I 120)
              ))))
              (=>
               %%location_label%%2
               tmp%3
