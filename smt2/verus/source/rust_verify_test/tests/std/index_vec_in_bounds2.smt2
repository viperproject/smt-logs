...
(assert
 (forall ((pre%v! alloc!vec.Vec<u8./allocator_global%.>.)) (!
   (= (req%test_crate!stuff. pre%v!) (=>
   ...
   :pattern ((req%test_crate!stuff. pre%v!))
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/std-a9a93a7619503a6c-index_vec_in_bounds2/test.rs:17:1: 17:26 (#0)
  ...
  (not (and
    ...
    (=>
     ...
     (=>
      (= a@ (%I tmp%1))
      (=>
       (= tmp%2 (= a@ (%I (vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec.
             $ (UINT 8) $ ALLOCATOR_GLOBAL
            ) (Poly%alloc!vec.Vec<u8./allocator_global%.>. v!@0)
           ) (I 0)
       ))))
       (=>
        %%location_label%%1
