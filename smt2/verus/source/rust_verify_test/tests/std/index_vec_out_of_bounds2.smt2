...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/std-a9a93a7619503a6c-index_vec_out_of_bounds2/test.rs:17:1: 17:24 (#0)
...
(push)
 ...
 (assert
  (not (=>
    %%location_label%%0
    (req%vstd!std_specs.vec.vec_index. T&. T& $ ALLOCATOR_GLOBAL v! 0)
 )))
 (get-info :version)
