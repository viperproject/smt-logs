...
;; Datatypes
(declare-sort alloc!vec.Vec<i32./allocator_global%.>. 0)
(declare-sort vstd!raw_ptr.DynMetadata. 0)
(declare-sort vstd!raw_ptr.Provenance. 0)
(declare-sort slice%<i32.>. 0)
...
(declare-fun Poly%alloc!vec.Vec<i32./allocator_global%.>. (alloc!vec.Vec<i32./allocator_global%.>.)
 Poly
)
(declare-fun %Poly%alloc!vec.Vec<i32./allocator_global%.>. (Poly) alloc!vec.Vec<i32./allocator_global%.>.)
...
(declare-fun Poly%slice%<i32.>. (slice%<i32.>.) Poly)
(declare-fun %Poly%slice%<i32.>. (Poly) slice%<i32.>.)
...
(assert
 (forall ((x alloc!vec.Vec<i32./allocator_global%.>.)) (!
   (= x (%Poly%alloc!vec.Vec<i32./allocator_global%.>. (Poly%alloc!vec.Vec<i32./allocator_global%.>.
      x
   )))
   :pattern ((Poly%alloc!vec.Vec<i32./allocator_global%.>. x))
   :qid internal_alloc__vec__Vec<i32./allocator_global__.>_box_axiom_definition
   :skolemid skolem_internal_alloc__vec__Vec<i32./allocator_global__.>_box_axiom_definition
)))
(assert
 (forall ((x Poly)) (!
   (=>
    (has_type x (TYPE%alloc!vec.Vec. $ (SINT 32) $ ALLOCATOR_GLOBAL))
    (= x (Poly%alloc!vec.Vec<i32./allocator_global%.>. (%Poly%alloc!vec.Vec<i32./allocator_global%.>.
       x
   ))))
   :pattern ((has_type x (TYPE%alloc!vec.Vec. $ (SINT 32) $ ALLOCATOR_GLOBAL)))
   :qid internal_alloc__vec__Vec<i32./allocator_global__.>_unbox_axiom_definition
   :skolemid skolem_internal_alloc__vec__Vec<i32./allocator_global__.>_unbox_axiom_definition
)))
(assert
 (forall ((x alloc!vec.Vec<i32./allocator_global%.>.)) (!
   (has_type (Poly%alloc!vec.Vec<i32./allocator_global%.>. x) (TYPE%alloc!vec.Vec. $ (
      SINT 32
     ) $ ALLOCATOR_GLOBAL
   ))
   :pattern ((has_type (Poly%alloc!vec.Vec<i32./allocator_global%.>. x) (TYPE%alloc!vec.Vec.
      $ (SINT 32) $ ALLOCATOR_GLOBAL
   )))
   :qid internal_alloc__vec__Vec<i32./allocator_global__.>_has_type_always_definition
   :skolemid skolem_internal_alloc__vec__Vec<i32./allocator_global__.>_has_type_always_definition
)))
(assert
...
(assert
 (forall ((x slice%<i32.>.)) (!
   (= x (%Poly%slice%<i32.>. (Poly%slice%<i32.>. x)))
   :pattern ((Poly%slice%<i32.>. x))
   :qid internal_crate__slice__<i32.>_box_axiom_definition
   :skolemid skolem_internal_crate__slice__<i32.>_box_axiom_definition
)))
(assert
 (forall ((x Poly)) (!
   (=>
    (has_type x (SLICE $ (SINT 32)))
    (= x (Poly%slice%<i32.>. (%Poly%slice%<i32.>. x)))
   )
   :pattern ((has_type x (SLICE $ (SINT 32))))
   :qid internal_crate__slice__<i32.>_unbox_axiom_definition
   :skolemid skolem_internal_crate__slice__<i32.>_unbox_axiom_definition
)))
(assert
 (forall ((x slice%<i32.>.)) (!
   (has_type (Poly%slice%<i32.>. x) (SLICE $ (SINT 32)))
   :pattern ((has_type (Poly%slice%<i32.>. x) (SLICE $ (SINT 32))))
   :qid internal_crate__slice__<i32.>_has_type_always_definition
   :skolemid skolem_internal_crate__slice__<i32.>_has_type_always_definition
)))
(assert
...
;; Function-Specs alloc::slice::impl&%0::into_vec
(declare-fun ens%alloc!slice.impl&%0.into_vec. (Dcr Type Dcr Type Poly Poly) Bool)
(assert
 (forall ((T&. Dcr) (T& Type) (A&. Dcr) (A& Type) (b! Poly) (v! Poly)) (!
   (= (ens%alloc!slice.impl&%0.into_vec. T&. T& A&. A& b! v!) (and
     (has_type v! (TYPE%alloc!vec.Vec. T&. T& A&. A&))
     (= (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& A&. A&) v!) (vstd!view.View.view.?
       $ (SLICE T&. T&) b!
   ))))
   :pattern ((ens%alloc!slice.impl&%0.into_vec. T&. T& A&. A& b! v!))
   :qid internal_ens__alloc!slice.impl&__0.into_vec._definition
   :skolemid skolem_internal_ens__alloc!slice.impl&__0.into_vec._definition
)))
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/std-a9a93a7619503a6c-vec_macro/test.rs:18:1: 18:10 (#0)
...
(push)
 ...
 (declare-const v@ alloc!vec.Vec<i32./allocator_global%.>.)
 (assert
  fuel_defaults
 )
 ...
 (assert
  (not (=>
    (= tmp%2 (%Poly%array%. (array_new $ (SINT 32) 3 (%%array%%0 (I 7) (I 8) (I 9)))))
    (=>
     (ens%alloc!boxed.impl&%0.new. $ (ARRAY $ (SINT 32) $ (CONST_INT 3)) (Poly%array%. tmp%2)
      tmp%1
     )
     (=>
      (ens%vstd!array.array_as_slice. $ (SINT 32) $ (CONST_INT 3) (%Poly%array%. tmp%1)
       tmp%3
      )
      (=>
       (ens%alloc!slice.impl&%0.into_vec. $ (SINT 32) $ ALLOCATOR_GLOBAL tmp%3 tmp%4)
       (=>
        (= v@ (%Poly%alloc!vec.Vec<i32./allocator_global%.>. tmp%4))
        (=>
         (= tmp%5 (= (vstd!std_specs.vec.spec_vec_len.? $ (SINT 32) $ ALLOCATOR_GLOBAL (Poly%alloc!vec.Vec<i32./allocator_global%.>.
             v@
            )
           ) 3
         ))
         (and
          ...
          (=>
           tmp%5
           (=>
            (= tmp%6 (= (%I (vstd!seq.Seq.index.? $ (SINT 32) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec.
                  $ (SINT 32) $ ALLOCATOR_GLOBAL
                 ) (Poly%alloc!vec.Vec<i32./allocator_global%.>. v@)
                ) (I 0)
               )
              ) 7
            ))
            (and
             ...
             (=>
              tmp%6
              (=>
               (= tmp%7 (= (%I (vstd!seq.Seq.index.? $ (SINT 32) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec.
                     $ (SINT 32) $ ALLOCATOR_GLOBAL
                    ) (Poly%alloc!vec.Vec<i32./allocator_global%.>. v@)
                   ) (I 1)
                  )
               ...
               (and
                ...
                (=>
                 tmp%7
                 (=>
                  (= tmp%8 (= (%I (vstd!seq.Seq.index.? $ (SINT 32) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec.
                        $ (SINT 32) $ ALLOCATOR_GLOBAL
                       ) (Poly%alloc!vec.Vec<i32./allocator_global%.>. v@)
                      ) (I 2)
                     )
