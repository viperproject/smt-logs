...
;; Function-Specs alloc::rc::impl&%8::new
(declare-fun ens%alloc!rc.impl&%8.new. (Dcr Type Poly Poly) Bool)
(assert
 (forall ((T&. Dcr) (T& Type) (t! Poly) (v! Poly)) (!
   (= (ens%alloc!rc.impl&%8.new. T&. T& t! v!) (and
     (has_type v! T&)
     (= v! t!)
   ))
   :pattern ((ens%alloc!rc.impl&%8.new. T&. T& t! v!))
   :qid internal_ens__alloc!rc.impl&__8.new._definition
   :skolemid skolem_internal_ens__alloc!rc.impl&__8.new._definition
)))

;; Function-Specs alloc::sync::impl&%14::new
(declare-fun ens%alloc!sync.impl&%14.new. (Dcr Type Poly Poly) Bool)
(assert
 (forall ((T&. Dcr) (T& Type) (t! Poly) (v! Poly)) (!
   (= (ens%alloc!sync.impl&%14.new. T&. T& t! v!) (and
     (has_type v! T&)
     (= v! t!)
   ))
   :pattern ((ens%alloc!sync.impl&%14.new. T&. T& t! v!))
   :qid internal_ens__alloc!sync.impl&__14.new._definition
   :skolemid skolem_internal_ens__alloc!sync.impl&__14.new._definition
)))

;; Function-Def test_crate::foo
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/std-a9a93a7619503a6c-rc_arc/test.rs:19:1: 19:9 (#0)
...
(push)
 ...
 (assert
  (not (=>
    (ens%alloc!rc.impl&%8.new. $ (SINT 32) (I 5) tmp%1)
    (=>
     (= x@ (%I tmp%1))
     (and
      (=>
       ...
       (=>
        ...
        (and
         ...
         (=>
          (= x1@ 5)
          (=>
           (ens%alloc!sync.impl&%14.new. $ (SINT 32) (I 5) tmp%2)
           (=>
            (= y@ (%I tmp%2))
            (and
             (=>
