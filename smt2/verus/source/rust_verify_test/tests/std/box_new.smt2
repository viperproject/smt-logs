...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/std-a9a93a7619503a6c-box_new/test.rs:17:1: 17:9 (#0)
...
(push)
 ...
 (assert
  (not (=>
    (ens%alloc!boxed.impl&%0.new. $ (UINT 32) (I 5) tmp%1)
    (=>
     (= x@ (%I tmp%1))
     (=>
      (= tmp%2 (= x@ 5))
