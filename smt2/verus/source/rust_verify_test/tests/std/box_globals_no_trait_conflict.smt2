...
;; Fuel
(declare-const fuel%test_crate!some_int. FuelId)
...
(assert
 (distinct fuel%test_crate!some_int. fuel%vstd!array.group_array_axioms. fuel%vstd!map.group_map_axioms.
...
;; Function-Decl test_crate::Tr::some_int
(declare-fun test_crate!Tr.some_int.? (Dcr Type) Poly)
(declare-fun test_crate!Tr.some_int%default%.? (Dcr Type) Poly)

;; Function-Decl test_crate::some_int0
(declare-fun test_crate!some_int0.? (Dcr Type) Int)

;; Function-Decl test_crate::some_int
(declare-fun test_crate!some_int.? (Dcr Type Poly) Int)

;; Function-Axioms test_crate::Tr::some_int
(assert
 (forall ((Self%&. Dcr) (Self%& Type)) (!
   (has_type (test_crate!Tr.some_int.? Self%&. Self%&) INT)
   :pattern ((test_crate!Tr.some_int.? Self%&. Self%&))
   :qid internal_test_crate!Tr.some_int.?_pre_post_definition
   :skolemid skolem_internal_test_crate!Tr.some_int.?_pre_post_definition
)))

;; Function-Axioms test_crate::some_int
(assert
 (fuel_bool_default fuel%test_crate!some_int.)
)
(assert
 (=>
  (fuel_bool fuel%test_crate!some_int.)
  (forall ((A&. Dcr) (A& Type) (b! Poly)) (!
    (= (test_crate!some_int.? A&. A& b!) (test_crate!some_int0.? A&. A&))
    :pattern ((test_crate!some_int.? A&. A& b!))
    :qid internal_test_crate!some_int.?_definition
    :skolemid skolem_internal_test_crate!some_int.?_definition
))))
...
(declare-fun req%test_crate!test. (Dcr Type Int Int) Bool)
(declare-const %%global_location_label%%0 Bool)
(assert
 (forall ((A&. Dcr) (A& Type) (b! Int) (c! Int)) (!
   (= (req%test_crate!test. A&. A& b! c!) (=>
     %%global_location_label%%0
     (= b! c!)
   ))
   :pattern ((req%test_crate!test. A&. A& b! c!))
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/std-a9a93a7619503a6c-box_globals_no_trait_conflict/test.rs:28:7: 28:55 (#0)
...
(push)
 ...
 (assert
  (not (=>
    (= tmp%1 (= (test_crate!some_int.? A&. A& (I b!)) (test_crate!some_int.? $ ALLOCATOR_GLOBAL
       (I c!)
    )))
    (=>
     %%location_label%%0
