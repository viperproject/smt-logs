...
;; Datatypes
(declare-datatypes ((core!marker.PhantomData. 0) (tuple%0. 0)) (((core!marker.PhantomData./PhantomData))
  ((tuple%0./tuple%0))
))
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/std-a9a93a7619503a6c-phantom_data_is_unit/test.rs:18:7: 18:57 (#0)
(get-info :all-statistics)
(push)
 (declare-const a! core!marker.PhantomData.)
 (declare-const b! core!marker.PhantomData.)
  ...
  (not (=>
    ...
    (and
     ...
     (=>
      tmp%1
      (=>
       (= tmp%2 (= a! core!marker.PhantomData./PhantomData))
       (=>
        %%location_label%%1
        tmp%2
 )))))))
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/std-a9a93a7619503a6c-phantom_data_is_unit/test.rs:23:1: 23:52 (#0)
(get-info :all-statistics)
(push)
 (declare-const a! core!marker.PhantomData.)
 (declare-const b! core!marker.PhantomData.)
 (declare-const tmp%1 Bool)
 (declare-const tmp%2 Bool)
 (declare-const z@ core!marker.PhantomData.)
 (assert
  fuel_defaults
 )
 ;; assertion failed
  ...
  (not (=>
    ...
    (and
     ...
     (=>
      tmp%1
      (=>
       (= z@ core!marker.PhantomData./PhantomData)
       (=>
        (= tmp%2 (= a! z@))
        (=>
         %%location_label%%1
