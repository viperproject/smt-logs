...
(declare-const fuel%test_crate!has_seven_and_not_nine. FuelId)
...
(assert
 (distinct fuel%vstd!set.axiom_set_empty. fuel%vstd!set.axiom_set_insert_same. fuel%vstd!set.axiom_set_insert_different.
  fuel%vstd!set.axiom_set_ext_equal. fuel%vstd!set.axiom_set_ext_equal_deep. fuel%test_crate!has_seven_and_not_nine.
...
;; Function-Decl test_crate::has_seven_and_not_nine
(declare-fun test_crate!has_seven_and_not_nine.? (Poly) Bool)
...
;; Function-Axioms test_crate::has_seven_and_not_nine
(assert
 (fuel_bool_default fuel%test_crate!has_seven_and_not_nine.)
)
(assert
 (=>
  (fuel_bool fuel%test_crate!has_seven_and_not_nine.)
  (forall ((intset! Poly)) (!
    (= (test_crate!has_seven_and_not_nine.? intset!) (and
      (vstd!set.impl&%0.contains.? $ INT intset! (I 7))
      (not (vstd!set.impl&%0.contains.? $ INT intset! (I 9)))
    ))
    :pattern ((test_crate!has_seven_and_not_nine.? intset!))
    :qid internal_test_crate!has_seven_and_not_nine.?_definition
    :skolemid skolem_internal_test_crate!has_seven_and_not_nine.?_definition
))))

;; Function-Def test_crate::try_out_some_set_literals
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/summer_school-9d3e788a530b70ff-e05_pass/test.rs:22:7: 22:51 (#0)
...
(push)
 ...
 (declare-const set138@ vstd!set.Set<int.>.)
 (declare-const set813@ vstd!set.Set<int.>.)
 (declare-const set7@ vstd!set.Set<int.>.)
 (declare-const set765@ vstd!set.Set<int.>.)
 (assert
  fuel_defaults
 )
 ;; assertion failed
 ...
 (assert
  (not (=>
    (= set138@ (%Poly%vstd!set.Set<int.>. (vstd!set.impl&%0.insert.? $ INT (vstd!set.impl&%0.insert.?
    ...
    (=>
     (= set813@ (%Poly%vstd!set.Set<int.>. (vstd!set.impl&%0.insert.? $ INT (vstd!set.impl&%0.insert.?
         $ INT (vstd!set.impl&%0.insert.? $ INT (vstd!set.impl&%0.empty.? $ INT) (I 8)) (I
          1
         )
        ) (I 3)
     )))
     (=>
      (= tmp%1 (ext_eq false (TYPE%vstd!set.Set. $ INT) (Poly%vstd!set.Set<int.>. set138@)
        (Poly%vstd!set.Set<int.>. set813@)
      ))
      (and
       (=>
        %%location_label%%0
       ...
       (=>
        tmp%1
        (=>
         (= set7@ (%Poly%vstd!set.Set<int.>. (vstd!set.impl&%0.insert.? $ INT (vstd!set.impl&%0.empty.?
             $ INT
            ) (I 7)
         )))
         (=>
          (= set765@ (%Poly%vstd!set.Set<int.>. (vstd!set.impl&%0.insert.? $ INT (vstd!set.impl&%0.insert.?
              $ INT (vstd!set.impl&%0.insert.? $ INT (vstd!set.impl&%0.empty.? $ INT) (I 7)) (I
               6
              )
             ) (I 5)
          )))
          (=>
           (= tmp%2 (test_crate!has_seven_and_not_nine.? (Poly%vstd!set.Set<int.>. set7@)))
           (and
            (=>
             %%location_label%%1
             tmp%2
            ...
            (=>
             tmp%2
             (=>
              (= tmp%3 (test_crate!has_seven_and_not_nine.? (Poly%vstd!set.Set<int.>. set765@)))
              (=>
               %%location_label%%2
               tmp%3
 ))))))))))))))
