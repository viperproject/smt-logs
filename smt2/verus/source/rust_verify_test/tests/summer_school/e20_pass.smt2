...
(declare-const fuel%test_crate!is_sorted. FuelId)
...
(assert
 (distinct fuel%vstd!std_specs.vec.impl&%0.spec_index. fuel%vstd!std_specs.vec.axiom_spec_len.
  ...
  fuel%vstd!view.impl&%24.view. fuel%test_crate!is_sorted. fuel%vstd!array.group_array_axioms.
...
;; Function-Decl test_crate::is_sorted
(declare-fun test_crate!is_sorted.? (Poly) Bool)
...
;; Function-Axioms test_crate::is_sorted
(assert
 (fuel_bool_default fuel%test_crate!is_sorted.)
)
(assert
 (=>
  (fuel_bool fuel%test_crate!is_sorted.)
  (forall ((seq! Poly)) (!
    (= (test_crate!is_sorted.? seq!) (forall ((i$ Poly) (j$ Poly)) (!
       (=>
        (and
         (has_type i$ INT)
         (has_type j$ INT)
        ...
        (=>
         (and
          ...
          (< (%I j$) (vstd!seq.Seq.len.? $ (UINT 64) seq!))
         )
         (<= (%I (vstd!seq.Seq.index.? $ (UINT 64) seq! i$)) (%I (vstd!seq.Seq.index.? $ (UINT
             64
            ) seq! j$
       )))))
       :pattern ((vstd!seq.Seq.index.? $ (UINT 64) seq! i$) (vstd!seq.Seq.index.? $ (UINT 64)
         seq! j$
       ))
       :qid user_test_crate__is_sorted_8
       :skolemid skolem_user_test_crate__is_sorted_8
    )))
    :pattern ((test_crate!is_sorted.? seq!))
    :qid internal_test_crate!is_sorted.?_definition
    :skolemid skolem_internal_test_crate!is_sorted.?_definition
))))
...
;; Function-Specs test_crate::is_seq_sorted
(declare-fun ens%test_crate!is_seq_sorted. (alloc!vec.Vec<u64./allocator_global%.>.
  Bool
 ) Bool
)
(assert
 (forall ((vec! alloc!vec.Vec<u64./allocator_global%.>.) (ret! Bool)) (!
   (= (ens%test_crate!is_seq_sorted. vec! ret!) (= ret! (test_crate!is_sorted.? (vstd!view.View.view.?
       $ (TYPE%alloc!vec.Vec. $ (UINT 64) $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<u64./allocator_global%.>.
        vec!
   )))))
   :pattern ((ens%test_crate!is_seq_sorted. vec! ret!))
   :qid internal_ens__test_crate!is_seq_sorted._definition
   :skolemid skolem_internal_ens__test_crate!is_seq_sorted._definition
)))

;; Function-Def test_crate::is_seq_sorted
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/summer_school-9d3e788a530b70ff-e20_pass/test.rs:34:5: 46:6 (#0)
(get-info :all-statistics)
(push)
 (declare-const ret! Bool)
 (declare-const vec! alloc!vec.Vec<u64./allocator_global%.>.)
 ...
 (assert
  (not (=>
    (< idx@0 (vstd!std_specs.vec.spec_vec_len.? $ (UINT 64) $ ALLOCATOR_GLOBAL (Poly%alloc!vec.Vec<u64./allocator_global%.>.
       vec!
    )))
    (=>
     (forall ((i$ Poly) (j$ Poly)) (!
       (=>
        ...
        (=>
         ...
         (<= (%I (vstd!seq.Seq.index.? $ (UINT 64) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec.
              $ (UINT 64) $ ALLOCATOR_GLOBAL
             ) (Poly%alloc!vec.Vec<u64./allocator_global%.>. vec!)
            ) i$
           )
          ) (%I (vstd!seq.Seq.index.? $ (UINT 64) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec.
              $ (UINT 64) $ ALLOCATOR_GLOBAL
       ...
       :pattern ((vstd!seq.Seq.index.? $ (UINT 64) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec.
        ...
        ) (vstd!seq.Seq.index.? $ (UINT 64) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $
           (UINT 64) $ ALLOCATOR_GLOBAL
          ) (Poly%alloc!vec.Vec<u64./allocator_global%.>. vec!)
         ) j$
       ))
       :qid user_test_crate__is_seq_sorted_9
       :skolemid skolem_user_test_crate__is_seq_sorted_9
     ))
     (=>
      (ens%alloc!vec.impl&%1.len. $ (UINT 64) $ ALLOCATOR_GLOBAL (Poly%alloc!vec.Vec<u64./allocator_global%.>.
        vec!
       ) tmp%2
      )
      (and
       ...
       (=>
        (< idx@0 (uClip SZ (Sub tmp%2 1)))
        (and
         (=>
          %%location_label%%1
          (req%vstd!std_specs.vec.vec_index. $ (UINT 64) $ ALLOCATOR_GLOBAL (Poly%alloc!vec.Vec<u64./allocator_global%.>.
            vec!
           ) idx@0
         ))
         (=>
          (ens%vstd!std_specs.vec.vec_index. $ (UINT 64) $ ALLOCATOR_GLOBAL (Poly%alloc!vec.Vec<u64./allocator_global%.>.
            vec!
           ) idx@0 tmp%3
          )
          (and
               ...
               (and
                (=>
                 ...
                 (=>
                  ...
                  (=>
                   %%location_label%%4
                   (= ret! (test_crate!is_sorted.? (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT
                        64
                       ) $ ALLOCATOR_GLOBAL
                      ) (Poly%alloc!vec.Vec<u64./allocator_global%.>. vec!)
                ))))))
                ...
                (and
                 ...
                 (=>
                  ...
                  (and
                   (=>
                    %%location_label%%6
                    (< idx@1 (vstd!std_specs.vec.spec_vec_len.? $ (UINT 64) $ ALLOCATOR_GLOBAL (Poly%alloc!vec.Vec<u64./allocator_global%.>.
                       vec!
                   ))))
                   (=>
                    %%location_label%%7
...
;; Function-Def test_crate::is_seq_sorted
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/summer_school-9d3e788a530b70ff-e20_pass/test.rs:25:1: 25:46 (#0)
(get-info :all-statistics)
(push)
 (declare-const ret! Bool)
 (declare-const vec! alloc!vec.Vec<u64./allocator_global%.>.)
           ...
           (=>
            ...
            (=>
             ...
             (and
              ...
              (=>
               (not (< idx@1 (uClip SZ (Sub tmp%2 1))))
               (=>
                (= ret! true)
                (=>
                 %%location_label%%4
