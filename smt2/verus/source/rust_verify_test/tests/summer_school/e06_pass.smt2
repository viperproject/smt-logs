...
(declare-const fuel%test_crate!has_four_five_six. FuelId)
...
(assert
 (distinct fuel%vstd!set.impl&%0.subset_of. fuel%vstd!set.axiom_set_empty. fuel%vstd!set.axiom_set_insert_same.
  fuel%vstd!set.axiom_set_insert_different. fuel%vstd!set.axiom_set_union. fuel%vstd!set.axiom_set_difference.
  fuel%vstd!set.axiom_set_ext_equal. fuel%vstd!set.axiom_set_ext_equal_deep. fuel%vstd!set.axiom_set_empty_finite.
  fuel%vstd!set.axiom_set_insert_finite. fuel%vstd!set.axiom_set_union_finite. fuel%vstd!set.axiom_set_difference_finite.
  fuel%vstd!set.axiom_set_empty_len. fuel%vstd!set.axiom_set_insert_len. fuel%vstd!set.axiom_set_contains_len.
  fuel%test_crate!has_four_five_six. fuel%vstd!array.group_array_axioms. fuel%vstd!map.group_map_axioms.
...
;; Function-Decl test_crate::has_four_five_six
(declare-fun test_crate!has_four_five_six.? (Poly) Bool)
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (s1! Poly) (s2! Poly) (a! Poly)) (!
    ...
    :qid user_vstd__set__axiom_set_difference_4
    :skolemid skolem_user_vstd__set__axiom_set_difference_4
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (s1! Poly) (s2! Poly)) (!
    ...
    :qid user_vstd__set__axiom_set_ext_equal_deep_7
    :skolemid skolem_user_vstd__set__axiom_set_ext_equal_deep_7
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type)) (!
    ...
    :qid user_vstd__set__axiom_set_empty_finite_8
    :skolemid skolem_user_vstd__set__axiom_set_empty_finite_8
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (s! Poly) (a! Poly)) (!
    ...
    :qid user_vstd__set__axiom_set_insert_finite_9
    :skolemid skolem_user_vstd__set__axiom_set_insert_finite_9
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (s1! Poly) (s2! Poly)) (!
    ...
    :qid user_vstd__set__axiom_set_union_finite_10
    :skolemid skolem_user_vstd__set__axiom_set_union_finite_10
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (s1! Poly) (s2! Poly)) (!
    ...
    :qid user_vstd__set__axiom_set_difference_finite_11
    :skolemid skolem_user_vstd__set__axiom_set_difference_finite_11
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type)) (!
    ...
    :qid user_vstd__set__axiom_set_empty_len_12
    :skolemid skolem_user_vstd__set__axiom_set_empty_len_12
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (s! Poly) (a! Poly)) (!
    ...
    :qid user_vstd__set__axiom_set_insert_len_13
    :skolemid skolem_user_vstd__set__axiom_set_insert_len_13
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (s! Poly) (a! Poly)) (!
    ...
    :qid user_vstd__set__axiom_set_contains_len_14
    :skolemid skolem_user_vstd__set__axiom_set_contains_len_14
))))
 ...
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (self! Poly) (s2! Poly)) (!
    (= (vstd!set.impl&%0.subset_of.? A&. A& self! s2!) (forall ((a$ Poly)) (!
       ...
       :pattern ((vstd!set.impl&%0.contains.? A&. A& s2! a$))
       :qid user_vstd__set__impl&%0__subset_of_15
       :skolemid skolem_user_vstd__set__impl&%0__subset_of_15
    )))
...
;; Function-Axioms test_crate::has_four_five_six
(assert
 (fuel_bool_default fuel%test_crate!has_four_five_six.)
)
(assert
 (=>
  (fuel_bool fuel%test_crate!has_four_five_six.)
  (forall ((intset! Poly)) (!
    (= (test_crate!has_four_five_six.? intset!) (let
      ((s$ (%Poly%vstd!set.Set<int.>. (vstd!set.impl&%0.insert.? $ INT (vstd!set.impl&%0.insert.?
           $ INT (vstd!set.impl&%0.insert.? $ INT (vstd!set.impl&%0.empty.? $ INT) (I 4)) (I
            5
           )
          ) (I 6)
      ))))
      (vstd!set.impl&%0.subset_of.? $ INT (Poly%vstd!set.Set<int.>. s$) intset!)
    ))
    :pattern ((test_crate!has_four_five_six.? intset!))
    :qid internal_test_crate!has_four_five_six.?_definition
    :skolemid skolem_internal_test_crate!has_four_five_six.?_definition
))))

;; Function-Def test_crate::some_assertions_about_sets
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/summer_school-9d3e788a530b70ff-e06_pass/test.rs:23:7: 23:38 (#0)
...
(push)
 ...
 (declare-const sadSet@ vstd!set.Set<int.>.)
 (declare-const happySet@ vstd!set.Set<int.>.)
 (assert
  fuel_defaults
 )
 ;; assertion failed
 ...
 (assert
  (not (=>
    (= sadSet@ (%Poly%vstd!set.Set<int.>. (vstd!set.impl&%0.insert.? $ INT (vstd!set.impl&%0.insert.?
        $ INT (vstd!set.impl&%0.insert.? $ INT (vstd!set.impl&%0.insert.? $ INT (vstd!set.impl&%0.insert.?
           $ INT (vstd!set.impl&%0.empty.? $ INT) (I 1)
          ) (I 2)
         ) (I 4)
        ) (I 6)
       ) (I 7)
    ...
    (and
     (=>
      (= tmp%1 (not (vstd!set.impl&%0.contains.? $ INT (Poly%vstd!set.Set<int.>. sadSet@)
         (I 5)
      )))
      (and
       (=>
       ...
       (=>
        ...
        (=>
         %%location_label%%1
         (not (test_crate!has_four_five_six.? (Poly%vstd!set.Set<int.>. sadSet@)))
     ))))
     (=>
      (not (test_crate!has_four_five_six.? (Poly%vstd!set.Set<int.>. sadSet@)))
      (=>
       (= happySet@ (%Poly%vstd!set.Set<int.>. (vstd!set.impl&%0.insert.? $ INT (vstd!set.impl&%0.insert.?
           $ INT (vstd!set.impl&%0.insert.? $ INT (vstd!set.impl&%0.insert.? $ INT (vstd!set.impl&%0.insert.?
       ...
       (=>
        (= tmp%2 (test_crate!has_four_five_six.? (Poly%vstd!set.Set<int.>. happySet@)))
        (and
         (=>
          %%location_label%%2
          tmp%2
         ...
         (=>
          tmp%2
          (=>
           (= tmp%3 (ext_eq false (TYPE%vstd!set.Set. $ INT) (vstd!set.impl&%0.difference.? $ INT
              (Poly%vstd!set.Set<int.>. happySet@) (vstd!set.impl&%0.insert.? $ INT (vstd!set.impl&%0.insert.?
                $ INT (vstd!set.impl&%0.insert.? $ INT (vstd!set.impl&%0.empty.? $ INT) (I 4)) (I
                 5
                )
               ) (I 6)
              )
             ) (vstd!set.impl&%0.insert.? $ INT (vstd!set.impl&%0.insert.? $ INT (vstd!set.impl&%0.insert.?
                $ INT (vstd!set.impl&%0.empty.? $ INT) (I 1)
               ) (I 2)
              ) (I 7)
           )))
           (and
            ...
            (=>
             tmp%3
             (=>
              (= tmp%4 (test_crate!has_four_five_six.? (vstd!set.impl&%0.union.? $ INT (vstd!set.impl&%0.insert.?
                  $ INT (vstd!set.impl&%0.insert.? $ INT (vstd!set.impl&%0.empty.? $ INT) (I 4)) (I
                   6
                  )
                 ) (vstd!set.impl&%0.insert.? $ INT (vstd!set.impl&%0.empty.? $ INT) (I 5))
              )))
              (and
               (=>
                %%location_label%%4
               ...
               (=>
                tmp%4
                (=>
                 (= tmp%5 (= (vstd!set.impl&%0.len.? $ INT (Poly%vstd!set.Set<int.>. happySet@)) 6))
                 (=>
                  %%location_label%%5
                  tmp%5
 )))))))))))))))))
