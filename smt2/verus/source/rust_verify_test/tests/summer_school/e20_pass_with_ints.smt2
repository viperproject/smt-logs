...
(assert
 (forall ((intvec! alloc!vec.Vec<u64./allocator_global%.>.) (out! Bool)) (!
   (= (ens%test_crate!is_seq_sorted. intvec! out!) (= out! (test_crate!is_sorted.? (Poly%vstd!seq.Seq<int.>.
       (test_crate!view_u64.? (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 64) $ ALLOCATOR_GLOBAL)
         (Poly%alloc!vec.Vec<u64./allocator_global%.>. intvec!)
   ))))))
   :pattern ((ens%test_crate!is_seq_sorted. intvec! out!))
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/summer_school-9d3e788a530b70ff-e20_pass_with_ints/test.rs:38:9: 51:10 (#0)
(get-info :all-statistics)
(push)
 (declare-const out! Bool)
 (declare-const intvec! alloc!vec.Vec<u64./allocator_global%.>.)
  ...
  (not (=>
    ...
    (=>
     (forall ((i$ Poly) (j$ Poly)) (!
       ...
       :qid user_test_crate__is_seq_sorted_11
       :skolemid skolem_user_test_crate__is_seq_sorted_11
     ))
     (=>
              ...
              (or
               (and
                (=>
                 (> (%I tmp%3) (%I tmp%4))
                 (=>
                  (= tmp%6 (> (%I (vstd!seq.Seq.index.? $ INT (Poly%vstd!seq.Seq<int.>. (test_crate!view_u64.?
                  ...
                  (and
                   ...
                   (=>
                    ...
                    (=>
                     ...
                     (=>
                      %%location_label%%5
                      (= out! (test_crate!is_sorted.? (Poly%vstd!seq.Seq<int.>. (test_crate!view_u64.? (vstd!view.View.view.?
                           $ (TYPE%alloc!vec.Vec. $ (UINT 64) $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<u64./allocator_global%.>.
                            intvec!
                ))))))))))))
                (=>
...
;; Function-Def test_crate::is_seq_sorted
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/summer_school-9d3e788a530b70ff-e20_pass_with_ints/test.rs:30:1: 30:49 (#0)
(get-info :all-statistics)
(push)
 (declare-const out! Bool)
 (declare-const intvec! alloc!vec.Vec<u64./allocator_global%.>.)
