...
(declare-const fuel%test_crate!is_even. FuelId)
...
(assert
 (distinct fuel%vstd!array.array_view. fuel%vstd!array.impl&%0.view. fuel%vstd!array.impl&%2.spec_index.
  ...
  fuel%vstd!seq.axiom_seq_ext_equal. fuel%vstd!seq.axiom_seq_ext_equal_deep. fuel%vstd!set.impl&%0.filter.
  fuel%vstd!set.axiom_set_empty. fuel%vstd!set.axiom_set_new. fuel%vstd!set.axiom_set_insert_same.
  fuel%vstd!set.axiom_set_insert_different. fuel%vstd!set.axiom_set_intersect. fuel%vstd!set.axiom_set_ext_equal.
  fuel%vstd!set.axiom_set_ext_equal_deep. fuel%vstd!set.axiom_mk_map_domain. fuel%vstd!set.axiom_mk_map_index.
  fuel%vstd!set.axiom_set_empty_finite. fuel%vstd!set.axiom_set_insert_finite. fuel%vstd!set.axiom_set_intersect_finite.
  fuel%vstd!set_lib.set_int_range. fuel%vstd!view.impl&%0.view. fuel%vstd!view.impl&%2.view.
  fuel%vstd!view.impl&%4.view. fuel%vstd!view.impl&%6.view. fuel%vstd!view.impl&%10.view.
  fuel%vstd!view.impl&%12.view. fuel%vstd!view.impl&%24.view. fuel%test_crate!is_even.
...
;; Function-Decl vstd::set::impl&%0::filter
...
;; Function-Decl test_crate::is_even
(declare-fun test_crate!is_even.? (Poly) Bool)
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (len! Poly) (f! Poly)) (!
    ...
    :qid user_vstd__seq__axiom_seq_new_len_14
    :skolemid skolem_user_vstd__seq__axiom_seq_new_len_14
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (len! Poly) (f! Poly) (i! Poly)) (!
    ...
    :qid user_vstd__seq__axiom_seq_new_index_15
    :skolemid skolem_user_vstd__seq__axiom_seq_new_index_15
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (f! Poly) (a! Poly)) (!
    ...
    :qid user_vstd__set__axiom_set_new_21
    :skolemid skolem_user_vstd__set__axiom_set_new_21
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (s! Poly) (a! Poly)) (!
    ...
    :qid user_vstd__set__axiom_set_insert_same_22
    :skolemid skolem_user_vstd__set__axiom_set_insert_same_22
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (s! Poly) (a1! Poly) (a2! Poly)) (!
    ...
    :qid user_vstd__set__axiom_set_insert_different_23
    :skolemid skolem_user_vstd__set__axiom_set_insert_different_23
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (s1! Poly) (s2! Poly) (a! Poly)) (!
    ...
    :qid user_vstd__set__axiom_set_intersect_24
...
(assert
 (=>
  ...
  (forall ((K&. Dcr) (K& Type) (V&. Dcr) (V& Type) (s! Poly) (f! Poly)) (!
    ...
    :qid user_vstd__set__axiom_mk_map_domain_28
    :skolemid skolem_user_vstd__set__axiom_mk_map_domain_28
))))
 ...
 (=>
  ...
  (forall ((K&. Dcr) (K& Type) (V&. Dcr) (V& Type) (s! Poly) (f! Poly) (key! Poly))
   (!
    ...
    :qid user_vstd__set__axiom_mk_map_index_29
    :skolemid skolem_user_vstd__set__axiom_mk_map_index_29
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (s1! Poly) (s2! Poly)) (!
    ...
    :qid user_vstd__set__axiom_set_intersect_finite_32
    :skolemid skolem_user_vstd__set__axiom_set_intersect_finite_32
))))
...
;; Function-Axioms vstd::set::impl&%0::filter
(assert
...
;; Function-Axioms test_crate::is_even
(assert
 (fuel_bool_default fuel%test_crate!is_even.)
)
(assert
 (=>
  (fuel_bool fuel%test_crate!is_even.)
  (forall ((x! Poly)) (!
    (= (test_crate!is_even.? x!) (= (Mul (EucDiv (%I x!) 2) 2) (%I x!)))
    :pattern ((test_crate!is_even.? x!))
    :qid internal_test_crate!is_even.?_definition
    :skolemid skolem_internal_test_crate!is_even.?_definition
))))
...
;; Function-Def test_crate::set_comprehension
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/summer_school-9d3e788a530b70ff-e14_pass/test.rs:24:7: 24:29 (#0)
(get-info :all-statistics)
(push)
 (declare-const no%param Int)
 (declare-const tmp%1 Bool)
 (declare-const tmp%2 Bool)
 (declare-const modest_evens@ vstd!set.Set<int.>.)
 (declare-const equivalent_evens@ vstd!set.Set<int.>.)
 (assert
  fuel_defaults
 )
 (declare-fun %%lambda%%2 (Int Int) %%Function%%)
 (assert
  (forall ((%%hole%%0 Int) (%%hole%%1 Int) (x$ Poly)) (!
    (= (%%apply%%0 (%%lambda%%2 %%hole%%0 %%hole%%1) x$) (B (and
       (and
        (<= %%hole%%0 (%I x$))
        (< (%I x$) %%hole%%1)
       )
       (test_crate!is_even.? x$)
    )))
    :pattern ((%%apply%%0 (%%lambda%%2 %%hole%%0 %%hole%%1) x$))
 )))
 (declare-fun %%lambda%%3 () %%Function%%)
 (assert
  (forall ((x$ Poly)) (!
    (= (%%apply%%0 %%lambda%%3 x$) (B (test_crate!is_even.? x$)))
    :pattern ((%%apply%%0 %%lambda%%3 x$))
 )))
 ;; assertion failed
 ...
 (assert
  (not (=>
    (= modest_evens@ (%Poly%vstd!set.Set<int.>. (vstd!set.impl&%0.new.? $ INT $ (TYPE%fun%1.
        $ INT $ BOOL
       ) (Poly%fun%1. (mk_fun (%%lambda%%2 0 10)))
    )))
    (=>
     (= tmp%1 (ext_eq false (TYPE%vstd!set.Set. $ INT) (Poly%vstd!set.Set<int.>. modest_evens@)
       (vstd!set.impl&%0.insert.? $ INT (vstd!set.impl&%0.insert.? $ INT (vstd!set.impl&%0.insert.?
          $ INT (vstd!set.impl&%0.insert.? $ INT (vstd!set.impl&%0.insert.? $ INT (vstd!set.impl&%0.empty.?
             $ INT
            ) (I 0)
           ) (I 2)
          ) (I 4)
     ...
     (and
      ...
      (=>
       tmp%1
       (=>
        (= equivalent_evens@ (%Poly%vstd!set.Set<int.>. (vstd!set.impl&%0.filter.? $ INT $ (
            TYPE%fun%1. $ INT $ BOOL
           ) (Poly%vstd!set.Set<int.>. (vstd!set_lib.set_int_range.? (I 0) (I 10))) (Poly%fun%1.
            (mk_fun %%lambda%%3)
        ))))
        (=>
         (= tmp%2 (ext_eq false (TYPE%vstd!set.Set. $ INT) (Poly%vstd!set.Set<int.>. modest_evens@)
           (Poly%vstd!set.Set<int.>. equivalent_evens@)
         ))
         (=>
          %%location_label%%1
          tmp%2
...
;; Function-Def test_crate::maps
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/summer_school-9d3e788a530b70ff-e14_pass/test.rs:33:7: 33:16 (#0)
(get-info :all-statistics)
(push)
 (declare-const no%param Int)
 (declare-const tmp%1 Bool)
 ...
 (declare-const double_map@ vstd!map.Map<int./int.>.)
 (declare-const replace_map@ vstd!map.Map<int./int.>.)
 (declare-const equivalent_double_map@ vstd!map.Map<int./int.>.)
 (assert
  fuel_defaults
 )
 ...
 (assert
  (forall ((%%hole%%0 Int) (x$ Poly)) (!
    (= (%%apply%%0 (%%lambda%%4 %%hole%%0) x$) (I (Mul (%I x$) %%hole%%0)))
    :pattern ((%%apply%%0 (%%lambda%%4 %%hole%%0) x$))
 )))
 ;; assertion failed
 (declare-const %%location_label%%0 Bool)
 ;; assertion failed
 ...
 (assert
  (not (=>
    (= double_map@ (%Poly%vstd!map.Map<int./int.>. (vstd!map.impl&%0.insert.? $ INT $ INT
       (vstd!map.impl&%0.insert.? $ INT $ INT (vstd!map.impl&%0.insert.? $ INT $ INT (vstd!map.impl&%0.insert.?
          $ INT $ INT (vstd!map.impl&%0.empty.? $ INT $ INT) (I 1) (I 2)
         ) (I 2) (I 4)
        ) (I 3) (I 6)
       ) (I 4) (I 8)
    )))
    (=>
     (= tmp%1 (= (%I (vstd!map.impl&%0.index.? $ INT $ INT (Poly%vstd!map.Map<int./int.>. double_map@)
         (I 3)
        )
       ) 6
     ))
     (and
      ...
      (=>
       tmp%1
       (=>
        (= replace_map@ (%Poly%vstd!map.Map<int./int.>. (vstd!map.impl&%0.insert.? $ INT $ INT
           (Poly%vstd!map.Map<int./int.>. double_map@) (I 3) (I 7)
        )))
        (=>
         (= tmp%2 (= (%I (vstd!map.impl&%0.index.? $ INT $ INT (Poly%vstd!map.Map<int./int.>. replace_map@)
             (I 1)
            )
           ) 2
         ))
         (and
          ...
          (=>
           tmp%2
           (=>
            (= tmp%3 (= (%I (vstd!map.impl&%0.index.? $ INT $ INT (Poly%vstd!map.Map<int./int.>. replace_map@)
                (I 2)
               )
              ) 4
            ))
            (and
             ...
             (=>
              tmp%3
              (=>
               (= tmp%4 (= (%I (vstd!map.impl&%0.index.? $ INT $ INT (Poly%vstd!map.Map<int./int.>. replace_map@)
                   (I 3)
                  )
                 ) 7
               ))
               (and
                ...
                (=>
                 tmp%4
                 (=>
                  (= equivalent_double_map@ (%Poly%vstd!map.Map<int./int.>. (vstd!set.impl&%0.mk_map.?
                     $ INT $ INT $ (TYPE%fun%1. $ INT $ INT) (Poly%vstd!set.Set<int.>. (vstd!set_lib.set_int_range.?
                       (I 1) (I 5)
                      )
                     ) (Poly%fun%1. (mk_fun (%%lambda%%4 2)))
                  )))
                  (=>
                   (= tmp%5 (ext_eq false (TYPE%vstd!map.Map. $ INT $ INT) (Poly%vstd!map.Map<int./int.>.
                      equivalent_double_map@
                     ) (Poly%vstd!map.Map<int./int.>. double_map@)
                   ))
                   (=>
                    %%location_label%%4
                    tmp%5
...
;; Function-Def test_crate::map_comprehension
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/summer_school-9d3e788a530b70ff-e14_pass/test.rs:48:7: 48:29 (#0)
(get-info :all-statistics)
(push)
 (declare-const no%param Int)
 (declare-const tmp%1 Bool)
 (declare-const tmp%2 Bool)
 (declare-const doubly_map@ vstd!map.Map<int./int.>.)
 (assert
  fuel_defaults
 )
 ...
 (assert
  (forall ((%%hole%%0 Int) (x$ Poly)) (!
    (= (%%apply%%0 (%%lambda%%5 %%hole%%0) x$) (I (Mul %%hole%%0 (%I x$))))
    :pattern ((%%apply%%0 (%%lambda%%5 %%hole%%0) x$))
 )))
 ;; assertion failed
 (declare-const %%location_label%%0 Bool)
 ;; assertion failed
 ...
 (assert
  (not (=>
    (= doubly_map@ (%Poly%vstd!map.Map<int./int.>. (vstd!set.impl&%0.mk_map.? $ INT $ INT
       $ (TYPE%fun%1. $ INT $ INT) (Poly%vstd!set.Set<int.>. (vstd!set_lib.set_int_range.?
         (I 0) (I 5)
        )
       ) (Poly%fun%1. (mk_fun (%%lambda%%5 2)))
    )))
    (=>
     (= tmp%1 (= (%I (vstd!map.impl&%0.index.? $ INT $ INT (Poly%vstd!map.Map<int./int.>. doubly_map@)
         (I 1)
        )
       ) 2
     ))
     (and
      ...
      (=>
       tmp%1
       (=>
        (= tmp%2 (= (%I (vstd!map.impl&%0.index.? $ INT $ INT (Poly%vstd!map.Map<int./int.>. doubly_map@)
            (I 4)
           )
          ) 8
        ))
...
;; Function-Def test_crate::seq_comprehension
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/summer_school-9d3e788a530b70ff-e14_pass/test.rs:54:7: 54:29 (#0)
(get-info :all-statistics)
(push)
 (declare-const no%param Int)
 (declare-const tmp%1 Bool)
 (declare-const tmp%2 Bool)
 (declare-const evens_in_order@ vstd!seq.Seq<int.>.)
 (assert
  fuel_defaults
 )
 ...
 (assert
  (forall ((%%hole%%0 Int) (i$ Poly)) (!
    (= (%%apply%%0 (%%lambda%%6 %%hole%%0) i$) (I (Mul (%I i$) %%hole%%0)))
    :pattern ((%%apply%%0 (%%lambda%%6 %%hole%%0) i$))
 )))
 ...
 (assert
  (not (=>
    (= evens_in_order@ (%Poly%vstd!seq.Seq<int.>. (vstd!seq.Seq.new.? $ INT $ (TYPE%fun%1.
        $ INT $ INT
       ) (I 5) (Poly%fun%1. (mk_fun (%%lambda%%6 2)))
    )))
    (=>
     (= tmp%1 (= (%I (vstd!seq.Seq.index.? $ INT (Poly%vstd!seq.Seq<int.>. evens_in_order@)
         (I 2)
        )
       ) 4
     ))
     (and
      ...
      (=>
       tmp%1
       (=>
        (= tmp%2 (ext_eq false (TYPE%vstd!seq.Seq. $ INT) (Poly%vstd!seq.Seq<int.>. evens_in_order@)
          (vstd!view.View.view.? $ (ARRAY $ INT $ (CONST_INT 5)) (array_new $ INT 5 (%%array%%0
             (I 0) (I 2) (I 4) (I 6) (I 8)
        )))))
        (=>
         %%location_label%%1
