...
(declare-const fuel%test_crate!view_u64. FuelId)
...
(assert
 (distinct fuel%vstd!std_specs.vec.impl&%0.spec_index. fuel%vstd!std_specs.vec.axiom_spec_len.
  ...
  fuel%vstd!seq.axiom_seq_ext_equal_deep. fuel%vstd!seq_lib.impl&%0.map. fuel%vstd!view.impl&%0.view.
  ...
  fuel%vstd!view.impl&%24.view. fuel%test_crate!is_sorted. fuel%test_crate!view_u64.
...
;; Function-Decl test_crate::view_u64
(declare-fun test_crate!view_u64.? (Poly) vstd!seq.Seq<int.>.)
...
(assert
 (forall ((%%hole%%0 Dcr) (%%hole%%1 Type) (%%hole%%2 Poly) (%%hole%%3 %%Function%%)
   ...
   (= (%%apply%%0 (%%lambda%%0 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3) i$) (%%apply%%1
  ...
  (forall ((A&. Dcr) (A& Type) (B&. Dcr) (B& Type) (self! Poly) (f! Poly)) (!
    (= (vstd!seq_lib.impl&%0.map.? A&. A& B&. B& self! f!) (vstd!seq.Seq.new.? B&. B& $
      (TYPE%fun%1. $ INT B&. B&) (I (vstd!seq.Seq.len.? A&. A& self!)) (Poly%fun%1. (mk_fun
        (%%lambda%%0 A&. A& self! (%Poly%fun%2. f!))
    ))))
...
(assert
 (=>
  ...
  (forall ((intseq! Poly)) (!
    (= (test_crate!is_sorted.? intseq!) (forall ((i$ Poly) (j$ Poly)) (!
       (=>
        (and
         (has_type i$ INT)
         (has_type j$ INT)
        ...
        (=>
         (and
          ...
          (< (%I j$) (vstd!seq.Seq.len.? $ INT intseq!))
         )
         (<= (%I (vstd!seq.Seq.index.? $ INT intseq! i$)) (%I (vstd!seq.Seq.index.? $ INT intseq!
            j$
       )))))
       :pattern ((vstd!seq.Seq.index.? $ INT intseq! i$) (vstd!seq.Seq.index.? $ INT intseq!
         j$
       ))
       :qid user_test_crate__is_sorted_10
       :skolemid skolem_user_test_crate__is_sorted_10
    )))
    :pattern ((test_crate!is_sorted.? intseq!))
    :qid internal_test_crate!is_sorted.?_definition
    :skolemid skolem_internal_test_crate!is_sorted.?_definition
))))

;; Function-Axioms test_crate::view_u64
(assert
 (fuel_bool_default fuel%test_crate!view_u64.)
)
(declare-fun %%lambda%%1 () %%Function%%)
(assert
 (forall ((_index$ Poly) (u$ Poly)) (!
   (= (%%apply%%1 %%lambda%%1 _index$ u$) u$)
   :pattern ((%%apply%%1 %%lambda%%1 _index$ u$))
)))
(assert
 (=>
  (fuel_bool fuel%test_crate!view_u64.)
  (forall ((u64seq! Poly)) (!
    (= (test_crate!view_u64.? u64seq!) (%Poly%vstd!seq.Seq<int.>. (vstd!seq_lib.impl&%0.map.?
       $ (UINT 64) $ INT u64seq! (Poly%fun%2. (mk_fun %%lambda%%1))
    )))
    :pattern ((test_crate!view_u64.? u64seq!))
    :qid internal_test_crate!view_u64.?_definition
    :skolemid skolem_internal_test_crate!view_u64.?_definition
))))
...
;; Function-Specs test_crate::binary_search
(declare-fun req%test_crate!binary_search. (alloc!vec.Vec<u64./allocator_global%.>.
  Int
 ) Bool
)
(declare-const %%global_location_label%%4 Bool)
(assert
 (forall ((haystack! alloc!vec.Vec<u64./allocator_global%.>.) (needle! Int)) (!
   (= (req%test_crate!binary_search. haystack! needle!) (=>
     %%global_location_label%%4
     (test_crate!is_sorted.? (Poly%vstd!seq.Seq<int.>. (test_crate!view_u64.? (vstd!view.View.view.?
         $ (TYPE%alloc!vec.Vec. $ (UINT 64) $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<u64./allocator_global%.>.
          haystack!
   )))))))
   :pattern ((req%test_crate!binary_search. haystack! needle!))
   :qid internal_req__test_crate!binary_search._definition
   :skolemid skolem_internal_req__test_crate!binary_search._definition
)))
(declare-fun ens%test_crate!binary_search. (alloc!vec.Vec<u64./allocator_global%.>.
  Int Int
 ) Bool
)
(assert
 (forall ((haystack! alloc!vec.Vec<u64./allocator_global%.>.) (needle! Int) (index! Int))
  (!
   (= (ens%test_crate!binary_search. haystack! needle! index!) (and
     (uInv SZ index!)
     (<= index! (vstd!std_specs.vec.spec_vec_len.? $ (UINT 64) $ ALLOCATOR_GLOBAL (Poly%alloc!vec.Vec<u64./allocator_global%.>.
        haystack!
     )))
     (forall ((i$ Poly)) (!
       (=>
        ...
        (=>
         ...
         (< (%I (vstd!seq.Seq.index.? $ (UINT 64) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec.
              $ (UINT 64) $ ALLOCATOR_GLOBAL
             ) (Poly%alloc!vec.Vec<u64./allocator_global%.>. haystack!)
            ) i$
           )
          ) needle!
       )))
       ...
       :qid user_test_crate__binary_search_11
       :skolemid skolem_user_test_crate__binary_search_11
     ))
     (forall ((i$ Poly)) (!
       (=>
        (has_type i$ INT)
        (=>
         ...
         (<= needle! (%I (vstd!seq.Seq.index.? $ (UINT 64) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec.
              $ (UINT 64) $ ALLOCATOR_GLOBAL
             ) (Poly%alloc!vec.Vec<u64./allocator_global%.>. haystack!)
            ) i$
       )))))
       ...
       :qid user_test_crate__binary_search_12
       :skolemid skolem_user_test_crate__binary_search_12
   ))))
   :pattern ((ens%test_crate!binary_search. haystack! needle! index!))
   :qid internal_ens__test_crate!binary_search._definition
   :skolemid skolem_internal_ens__test_crate!binary_search._definition
)))

;; Function-Def test_crate::binary_search
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/summer_school-9d3e788a530b70ff-e21_pass/test.rs:42:5: 66:6 (#0)
(get-info :all-statistics)
(push)
 (declare-const index! Int)
 (declare-const haystack! alloc!vec.Vec<u64./allocator_global%.>.)
 (declare-const needle! Int)
 (declare-const verus_tmp_decreases@ Int)
 (declare-const tmp%1 Poly)
 (declare-const verus_tmp_old_low@ Int)
 (declare-const i@ Poly)
 (declare-const tmp%2 Bool)
 (declare-const verus_tmp$1@0 Int)
 (declare-const old_low@0 Int)
 (declare-const verus_tmp_old_high@ Int)
 (declare-const i$1@ Poly)
 (declare-const tmp%3 Bool)
 (declare-const verus_tmp$2@0 Int)
 (declare-const old_high@0 Int)
 (declare-const tmp%4 Bool)
 (declare-const verus_tmp@0 Int)
 (declare-const decreases@0 Int)
 ...
 (assert
  (not (=>
    ...
    (=>
     (<= low@0 high@0)
     (=>
      (<= high@0 (vstd!std_specs.vec.spec_vec_len.? $ (UINT 64) $ ALLOCATOR_GLOBAL (Poly%alloc!vec.Vec<u64./allocator_global%.>.
         haystack!
      )))
      (=>
       (forall ((i$ Poly)) (!
         ...
         :qid user_test_crate__binary_search_15
         :skolemid skolem_user_test_crate__binary_search_15
       ))
       (=>
        (forall ((i$ Poly)) (!
          (=>
          ...
          :qid user_test_crate__binary_search_16
          :skolemid skolem_user_test_crate__binary_search_16
        ))
        (=>
         (< low@0 high@0)
         (=>
          (= verus_tmp@1 (Sub high@0 low@0))
          (=>
           (= verus_tmp_decreases@ verus_tmp@1)
           (=>
            (= decreases@1 verus_tmp_decreases@)
            (and
             (=>
              %%location_label%%0
              (uInv SZ (Sub high@0 low@0))
             )
             (and
              (=>
               %%location_label%%1
              ...
              (and
               (=>
                %%location_label%%2
                (uInv SZ (Add low@0 (uClip SZ (EucDiv (uClip SZ (Sub high@0 low@0)) 2))))
               )
               (=>
                (= mid@ (uClip SZ (Add low@0 (uClip SZ (EucDiv (uClip SZ (Sub high@0 low@0)) 2)))))
                (and
                 (=>
                  %%location_label%%3
                 ...
                 (=>
                  ...
                  (or
                   (and
                    (=>
                     ...
                     (=>
                      (= verus_tmp$1@1 low@0)
                      (=>
                       (= verus_tmp_old_low@ verus_tmp$1@1)
                       (=>
                        (= old_low@1 verus_tmp_old_low@)
                        (and
                         (=>
                          %%location_label%%4
                          (uInv SZ (Add mid@ 1))
                          ...
                          (and
                           (=>
                            ...
                            (=>
                             ...
                             (=>
                              (= tmp%2 (<= (%I (vstd!seq.Seq.index.? $ INT (Poly%vstd!seq.Seq<int.>. (test_crate!view_u64.?
                                    (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 64) $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<u64./allocator_global%.>.
                                      haystack!
                                   )))
                                  ) i@
                                 )
                                ) (%I (vstd!seq.Seq.index.? $ INT (Poly%vstd!seq.Seq<int.>. (test_crate!view_u64.? (vstd!view.View.view.?
                                     $ (TYPE%alloc!vec.Vec. $ (UINT 64) $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<u64./allocator_global%.>.
                                      haystack!
                                   )))
                                  ) (I mid@)
                           ...
                           (=>
                            (forall ((i$ Poly)) (!
                              ...
                              :qid user_test_crate__binary_search_17
                              :skolemid skolem_user_test_crate__binary_search_17
                            ))
                            (=>
                             (= verus_tmp$2@1 verus_tmp$2@0)
                             (=>
                              (= old_high@1 old_high@0)
                              (=>
                               (= high@1 high@0)
                               %%switch_label%%0
                    )))))))))))
                    (=>
                     (not (< (%I tmp%1) needle!))
                     (=>
                      (= verus_tmp$2@1 high@0)
                      (=>
                       (= verus_tmp_old_high@ verus_tmp$2@1)
                       (=>
                        (= old_high@1 verus_tmp_old_high@)
                        (=>
                         (= high@1 mid@)
                         (and
                          (=>
                           ...
                           (=>
                            (and
                             (< high@1 (%I i$1@))
                             (< (%I i$1@) (vstd!std_specs.vec.spec_vec_len.? $ (UINT 64) $ ALLOCATOR_GLOBAL (Poly%alloc!vec.Vec<u64./allocator_global%.>.
                                haystack!
                            ))))
                            (=>
                             (= tmp%3 (<= (%I (vstd!seq.Seq.index.? $ INT (Poly%vstd!seq.Seq<int.>. (test_crate!view_u64.?
                                   (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 64) $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<u64./allocator_global%.>.
                                     haystack!
                                  )))
                                 ) (I mid@)
                          ...
                          (=>
                           (forall ((i$ Poly)) (!
                             ...
                             :qid user_test_crate__binary_search_18
                             :skolemid skolem_user_test_crate__binary_search_18
                           ))
                           (=>
                   ...
                   (and
                    (not %%switch_label%%0)
                    (=>
                     (= tmp%4 (< (Sub high@1 low@1) decreases@1))
                     (and
                      (=>
                       %%location_label%%9
                       tmp%4
                       ...
                       (and
                        ...
                        (and
                         ...
                         (and
                          (=>
                           %%location_label%%12
                           (<= high@1 (vstd!std_specs.vec.spec_vec_len.? $ (UINT 64) $ ALLOCATOR_GLOBAL (Poly%alloc!vec.Vec<u64./allocator_global%.>.
                              haystack!
                          ))))
                          (and
                           (=>
...
;; Function-Def test_crate::binary_search
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/summer_school-9d3e788a530b70ff-e21_pass/test.rs:32:1: 32:67 (#0)
(get-info :all-statistics)
(push)
 (declare-const index! Int)
 (declare-const haystack! alloc!vec.Vec<u64./allocator_global%.>.)
                    ...
                    (and
                     (=>
                      ...
                      (forall ((i$ Poly)) (!
                        ...
                        :qid user_test_crate__binary_search_13
                        :skolemid skolem_user_test_crate__binary_search_13
                     )))
                     (=>
                      %%location_label%%7
                      (forall ((i$ Poly)) (!
                        ...
                        :qid user_test_crate__binary_search_14
                        :skolemid skolem_user_test_crate__binary_search_14
 )))))))))))))))))))))))
 (get-info :version)
 (set-option :rlimit 30000000)
 (check-sat)
