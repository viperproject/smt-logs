...
(assert
 (distinct fuel%vstd!set.impl&%0.subset_of. fuel%vstd!set.axiom_set_empty. fuel%vstd!set.axiom_set_insert_same.
  ...
  fuel%vstd!set.axiom_set_insert_len. fuel%vstd!set.axiom_set_contains_len. fuel%test_crate!has_four_five_six.
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/summer_school-9d3e788a530b70ff-e06_fail/test.rs:23:7: 23:38 (#0)
...
(push)
 ...
 (assert
  (not (=>
    ...
    (=>
     (= tmp%1 (= (vstd!set.impl&%0.len.? $ INT (Poly%vstd!set.Set<int.>. happySet@)) 7))
     (=>
      %%location_label%%0
      tmp%1
 )))))
...
;; Function-Recommends test_crate::some_assertions_about_sets
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/summer_school-9d3e788a530b70ff-e06_fail/test.rs:23:7: 23:38 (#0)
(get-info :all-statistics)
(push)
 (declare-const no%param Int)
