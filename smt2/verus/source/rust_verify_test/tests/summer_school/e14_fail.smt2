...
(assert
 (=>
  ...
  (forall ((K&. Dcr) (K& Type) (V&. Dcr) (V& Type) (s! Poly) (f! Poly)) (!
    ...
    :qid user_vstd__set__axiom_mk_map_domain_27
    :skolemid skolem_user_vstd__set__axiom_mk_map_domain_27
))))
 ...
 (=>
  ...
  (forall ((K&. Dcr) (K& Type) (V&. Dcr) (V& Type) (s! Poly) (f! Poly) (key! Poly))
   (!
    ...
    :qid user_vstd__set__axiom_mk_map_index_28
    :skolemid skolem_user_vstd__set__axiom_mk_map_index_28
))))
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/summer_school-9d3e788a530b70ff-e14_fail/test.rs:24:7: 24:29 (#0)
    ...
    (=>
     (= tmp%1 (ext_eq false (TYPE%vstd!set.Set. $ INT) (Poly%vstd!set.Set<int.>. modest_evens@)
       (vstd!set.impl&%0.insert.? $ INT (vstd!set.impl&%0.insert.? $ INT (vstd!set.impl&%0.insert.?
          $ INT (vstd!set.impl&%0.insert.? $ INT (vstd!set.impl&%0.empty.? $ INT) (I 0)) (I
           2
          )
         ) (I 4)
        ) (I 8)
...
;; Function-Recommends test_crate::set_comprehension
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/summer_school-9d3e788a530b70ff-e14_fail/test.rs:24:7: 24:29 (#0)
(get-info :all-statistics)
(push)
 (declare-const no%param Int)
 ...
 (assert
  (forall ((%%hole%%0 Int) (%%hole%%1 Int) (x$ Poly)) (!
    (= (%%apply%%0 (%%lambda%%3 %%hole%%0 %%hole%%1) x$) (B (and
       (and
        (<= %%hole%%0 (%I x$))
        (< (%I x$) %%hole%%1)
       )
    ...
    :pattern ((%%apply%%0 (%%lambda%%3 %%hole%%0 %%hole%%1) x$))
 )))
 (assert
  (not true)
 )
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/summer_school-9d3e788a530b70ff-e14_fail/test.rs:29:7: 29:16 (#0)
(get-info :all-statistics)
(push)
 (declare-const no%param Int)
 (declare-const tmp%1 Bool)
...
;; Function-Recommends test_crate::maps
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/summer_school-9d3e788a530b70ff-e14_fail/test.rs:29:7: 29:16 (#0)
(get-info :all-statistics)
(push)
 (declare-const no%param Int)
 ...
 (assert
  (not (=>
    ...
    (and
     (=>
      %%location_label%%0
      (req%vstd!map.impl&%0.spec_index. $ INT $ INT (Poly%vstd!map.Map<int./int.>. double_map@)
       (I 3)
     ))
     (=>
      (= tmp%1 (vstd!map.impl&%0.index.? $ INT $ INT (Poly%vstd!map.Map<int./int.>. double_map@)
        (I 3)
      ))
      (=>
       (= (%I tmp%1) 6)
       (=>
        ...
        (and
         (=>
          %%location_label%%1
          (req%vstd!map.impl&%0.spec_index. $ INT $ INT (Poly%vstd!map.Map<int./int.>. replace_map@)
           (I 1)
         ))
         (=>
          (= tmp%2 (vstd!map.impl&%0.index.? $ INT $ INT (Poly%vstd!map.Map<int./int.>. replace_map@)
            (I 1)
          ))
          (=>
           (= (%I tmp%2) 2)
           (and
            ...
            (=>
             (= tmp%3 (vstd!map.impl&%0.index.? $ INT $ INT (Poly%vstd!map.Map<int./int.>. replace_map@)
               (I 2)
             ))
             (=>
              (= (%I tmp%3) 4)
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/summer_school-9d3e788a530b70ff-e14_fail/test.rs:40:7: 40:29 (#0)
(get-info :all-statistics)
(push)
 (declare-const no%param Int)
 (declare-const tmp%1 Bool)
 ...
 (assert
  (forall ((%%hole%%0 Int) (x$ Poly)) (!
    (= (%%apply%%0 (%%lambda%%4 %%hole%%0) x$) (I (Mul %%hole%%0 (%I x$))))
...
;; Function-Recommends test_crate::map_comprehension
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/summer_school-9d3e788a530b70ff-e14_fail/test.rs:40:7: 40:29 (#0)
(get-info :all-statistics)
(push)
 (declare-const no%param Int)
  ...
  (not (=>
    ...
    (=>
     ...
     (and
      (=>
       %%location_label%%0
       (req%vstd!map.impl&%0.spec_index. $ INT $ INT (Poly%vstd!map.Map<int./int.>. doubly_map@)
        (I 1)
      ))
      (=>
       (= tmp%1 (vstd!map.impl&%0.index.? $ INT $ INT (Poly%vstd!map.Map<int./int.>. doubly_map@)
         (I 1)
       ))
       (=>
        (= (%I tmp%1) 2)
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/summer_school-9d3e788a530b70ff-e14_fail/test.rs:46:7: 46:29 (#0)
(get-info :all-statistics)
(push)
 (declare-const no%param Int)
 (declare-const tmp%1 Bool)
...
;; Function-Recommends test_crate::seq_comprehension
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/summer_school-9d3e788a530b70ff-e14_fail/test.rs:46:7: 46:29 (#0)
(get-info :all-statistics)
(push)
 (declare-const no%param Int)
 ...
 (assert
  (forall ((%%hole%%0 Int) (i$ Poly)) (!
    (= (%%apply%%0 (%%lambda%%7 %%hole%%0) i$) (I (Mul (%I i$) %%hole%%0)))
    :pattern ((%%apply%%0 (%%lambda%%7 %%hole%%0) i$))
 )))
 ...
 (assert
  (not (=>
    ...
    (=>
     (= evens_in_order@ (%Poly%vstd!seq.Seq<int.>. (vstd!seq.Seq.new.? $ INT $ (TYPE%fun%1.
         $ INT $ INT
        ) (I 5) (Poly%fun%1. (mk_fun (%%lambda%%7 2)))
     )))
     (=>
      %%location_label%%0
      (req%vstd!seq.impl&%0.spec_index. $ INT (Poly%vstd!seq.Seq<int.>. evens_in_order@)
       (I 2)
 ))))))
 (get-info :version)
 (set-option :rlimit 30000000)
