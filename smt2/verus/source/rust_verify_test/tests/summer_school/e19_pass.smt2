...
;; Function-Specs test_crate::find_max
(declare-fun req%test_crate!find_max. (alloc!vec.Vec<u64./allocator_global%.>.) Bool)
(declare-const %%global_location_label%%4 Bool)
(assert
 (forall ((int_vec! alloc!vec.Vec<u64./allocator_global%.>.)) (!
   (= (req%test_crate!find_max. int_vec!) (=>
   ...
   :pattern ((req%test_crate!find_max. int_vec!))
   :qid internal_req__test_crate!find_max._definition
   :skolemid skolem_internal_req__test_crate!find_max._definition
)))
(declare-fun ens%test_crate!find_max. (alloc!vec.Vec<u64./allocator_global%.>. Int)
 Bool
)
(assert
 (forall ((int_vec! alloc!vec.Vec<u64./allocator_global%.>.) (max_index_rc! Int)) (
   !
   (= (ens%test_crate!find_max. int_vec! max_index_rc!) (and
     (uInv SZ max_index_rc!)
     (< max_index_rc! (vstd!std_specs.vec.spec_vec_len.? $ (UINT 64) $ ALLOCATOR_GLOBAL
       (Poly%alloc!vec.Vec<u64./allocator_global%.>. int_vec!)
     ))
     (forall ((idx$ Poly)) (!
       (=>
        (has_type idx$ INT)
        (=>
         (and
          (<= 0 (%I idx$))
          (< (%I idx$) (vstd!std_specs.vec.spec_vec_len.? $ (UINT 64) $ ALLOCATOR_GLOBAL (Poly%alloc!vec.Vec<u64./allocator_global%.>.
             int_vec!
         ))))
       ...
       :qid user_test_crate__find_max_8
       :skolemid skolem_user_test_crate__find_max_8
   ))))
   :pattern ((ens%test_crate!find_max. int_vec! max_index_rc!))
   :qid internal_ens__test_crate!find_max._definition
   :skolemid skolem_internal_ens__test_crate!find_max._definition
)))

;; Function-Def test_crate::find_max
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/summer_school-9d3e788a530b70ff-e19_pass/test.rs:32:5: 43:6 (#0)
(get-info :all-statistics)
(push)
 (declare-const max_index_rc! Int)
 (declare-const int_vec! alloc!vec.Vec<u64./allocator_global%.>.)
 (declare-const tmp%1 Int)
 (declare-const tmp%2 Poly)
 (declare-const tmp%3 Poly)
 (declare-const count@0 Int)
 (declare-const max_index@0 Int)
 (assert
  fuel_defaults
 )
 (assert
 ...
 (assert
  (not (=>
    (< max_index@0 (vstd!std_specs.vec.spec_vec_len.? $ (UINT 64) $ ALLOCATOR_GLOBAL (Poly%alloc!vec.Vec<u64./allocator_global%.>.
       int_vec!
    )))
    (=>
     (forall ((prioridx$ Poly)) (!
       (=>
        (has_type prioridx$ INT)
        (=>
         (and
          (<= 0 (%I prioridx$))
          (< (%I prioridx$) count@0)
       ...
       :qid user_test_crate__find_max_10
       :skolemid skolem_user_test_crate__find_max_10
     ))
     (=>
           ...
           (or
            ...
            (and
             ...
             (and
              (=>
               %%location_label%%2
               (uInv SZ (Add count@0 1))
              )
              (=>
               (= count@1 (uClip SZ (Add count@0 1)))
               (and
                (=>
                 %%location_label%%3
                 (< max_index@1 (vstd!std_specs.vec.spec_vec_len.? $ (UINT 64) $ ALLOCATOR_GLOBAL (Poly%alloc!vec.Vec<u64./allocator_global%.>.
                    int_vec!
                ))))
                (=>
                 %%location_label%%4
...
;; Function-Def test_crate::find_max
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/summer_school-9d3e788a530b70ff-e19_pass/test.rs:21:1: 21:56 (#0)
(get-info :all-statistics)
(push)
 (declare-const max_index_rc! Int)
 (declare-const int_vec! alloc!vec.Vec<u64./allocator_global%.>.)
              ...
              (and
               ...
               (=>
                ...
                (forall ((idx$ Poly)) (!
                  ...
                  :qid user_test_crate__find_max_9
                  :skolemid skolem_user_test_crate__find_max_9
 )))))))))))))))))
 (get-info :version)
 (set-option :rlimit 30000000)
 (check-sat)
