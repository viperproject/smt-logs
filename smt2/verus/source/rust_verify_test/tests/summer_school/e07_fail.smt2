...
(assert
 (distinct fuel%vstd!array.array_view. fuel%vstd!array.impl&%0.view. fuel%vstd!array.impl&%2.spec_index.
  ...
  fuel%vstd!seq.axiom_seq_subrange_index. fuel%vstd!set.axiom_set_empty. fuel%vstd!set.axiom_set_insert_same.
  ...
  fuel%vstd!set.axiom_set_insert_len. fuel%vstd!set.axiom_set_contains_len. fuel%vstd!view.impl&%0.view.
...
(declare-sort vstd!seq.Seq<vstd!set.Set<int.>.>. 0)
...
(declare-fun Poly%vstd!seq.Seq<vstd!set.Set<int.>.>. (vstd!seq.Seq<vstd!set.Set<int.>.>.)
 Poly
)
(declare-fun %Poly%vstd!seq.Seq<vstd!set.Set<int.>.>. (Poly) vstd!seq.Seq<vstd!set.Set<int.>.>.)
...
(assert
 (forall ((x vstd!seq.Seq<vstd!set.Set<int.>.>.)) (!
   (= x (%Poly%vstd!seq.Seq<vstd!set.Set<int.>.>. (Poly%vstd!seq.Seq<vstd!set.Set<int.>.>.
      x
   )))
   :pattern ((Poly%vstd!seq.Seq<vstd!set.Set<int.>.>. x))
   :qid internal_vstd__seq__Seq<vstd!set.Set<int.>.>_box_axiom_definition
   :skolemid skolem_internal_vstd__seq__Seq<vstd!set.Set<int.>.>_box_axiom_definition
)))
(assert
 (forall ((x Poly)) (!
   (=>
    (has_type x (TYPE%vstd!seq.Seq. $ (TYPE%vstd!set.Set. $ INT)))
    (= x (Poly%vstd!seq.Seq<vstd!set.Set<int.>.>. (%Poly%vstd!seq.Seq<vstd!set.Set<int.>.>.
       x
   ))))
   :pattern ((has_type x (TYPE%vstd!seq.Seq. $ (TYPE%vstd!set.Set. $ INT))))
   :qid internal_vstd__seq__Seq<vstd!set.Set<int.>.>_unbox_axiom_definition
   :skolemid skolem_internal_vstd__seq__Seq<vstd!set.Set<int.>.>_unbox_axiom_definition
)))
(assert
 (forall ((x vstd!seq.Seq<vstd!set.Set<int.>.>.)) (!
   (has_type (Poly%vstd!seq.Seq<vstd!set.Set<int.>.>. x) (TYPE%vstd!seq.Seq. $ (TYPE%vstd!set.Set.
      $ INT
   )))
   :pattern ((has_type (Poly%vstd!seq.Seq<vstd!set.Set<int.>.>. x) (TYPE%vstd!seq.Seq.
      $ (TYPE%vstd!set.Set. $ INT)
   )))
   :qid internal_vstd__seq__Seq<vstd!set.Set<int.>.>_has_type_always_definition
   :skolemid skolem_internal_vstd__seq__Seq<vstd!set.Set<int.>.>_has_type_always_definition
)))
(assert
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (s! Poly) (j! Poly) (k! Poly)) (!
    ...
    :qid user_vstd__seq__axiom_seq_subrange_len_11
    :skolemid skolem_user_vstd__seq__axiom_seq_subrange_len_11
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (s! Poly) (j! Poly) (k! Poly) (i! Poly)) (!
    ...
    :qid user_vstd__seq__axiom_seq_subrange_index_12
    :skolemid skolem_user_vstd__seq__axiom_seq_subrange_index_12
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type)) (!
    ...
    :qid user_vstd__set__axiom_set_empty_len_21
    :skolemid skolem_user_vstd__set__axiom_set_empty_len_21
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (s! Poly) (a! Poly)) (!
    ...
    :qid user_vstd__set__axiom_set_insert_len_22
    :skolemid skolem_user_vstd__set__axiom_set_insert_len_22
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (s! Poly) (a! Poly)) (!
    ...
    :qid user_vstd__set__axiom_set_contains_len_23
    :skolemid skolem_user_vstd__set__axiom_set_contains_len_23
))))
...
;; Function-Def test_crate::experiments_with_sequences_1
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/summer_school-9d3e788a530b70ff-e07_fail/test.rs:20:7: 20:40 (#0)
(get-info :all-statistics)
(push)
 (declare-const no%param Int)
 (declare-const tmp%1 Bool)
 (declare-const fibo@ vstd!seq.Seq<int.>.)
 (assert
  fuel_defaults
 )
 ...
 (assert
  (not (=>
    (= fibo@ (%Poly%vstd!seq.Seq<int.>. (vstd!view.View.view.? $ (ARRAY $ INT $ (CONST_INT
         9
        )
       ) (array_new $ INT 9 (%%array%%0 (I 1) (I 1) (I 2) (I 3) (I 5) (I 8) (I 13) (I 21)
         (I 34)
    )))))
    (=>
     (= tmp%1 (= (%I (vstd!seq.Seq.index.? $ INT (Poly%vstd!seq.Seq<int.>. fibo@) (I 9)))
       55
     ))
     (=>
      %%location_label%%0
...
;; Function-Recommends test_crate::experiments_with_sequences_1
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/summer_school-9d3e788a530b70ff-e07_fail/test.rs:20:7: 20:40 (#0)
(get-info :all-statistics)
(push)
 (declare-const no%param Int)
 ...
 (assert
  (not (=>
    (= fibo@ (%Poly%vstd!seq.Seq<int.>. (vstd!view.View.view.? $ (ARRAY $ INT $ (CONST_INT
       ...
       ) (array_new $ INT 9 (%%array%%1 (I 1) (I 1) (I 2) (I 3) (I 5) (I 8) (I 13) (I 21)
         (I 34)
    )))))
    (=>
     %%location_label%%0
     (req%vstd!seq.Seq.index. $ INT (Poly%vstd!seq.Seq<int.>. fibo@) (I 9))
 ))))
 (get-info :version)
 (set-option :rlimit 30000000)
 (check-sat)
...
;; Function-Def test_crate::experiments_with_sequences_2
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/summer_school-9d3e788a530b70ff-e07_fail/test.rs:27:7: 27:40 (#0)
(get-info :all-statistics)
(push)
 (declare-const no%param Int)
 (declare-const tmp%1 Bool)
 ...
 (declare-fun %%array%%2 (Poly Poly Poly Poly Poly Poly Poly Poly Poly) %%Function%%)
 (assert
  (forall ((%%hole%%0 Poly) (%%hole%%1 Poly) (%%hole%%2 Poly) (%%hole%%3 Poly) (%%hole%%4
     Poly
    ) (%%hole%%5 Poly) (%%hole%%6 Poly) (%%hole%%7 Poly) (%%hole%%8 Poly)
 ...
 (assert
  (not (=>
    (= fibo@ (%Poly%vstd!seq.Seq<int.>. (vstd!view.View.view.? $ (ARRAY $ INT $ (CONST_INT
       ...
       ) (array_new $ INT 9 (%%array%%2 (I 1) (I 1) (I 2) (I 3) (I 5) (I 8) (I 13) (I 21)
         (I 34)
    )))))
    (=>
     (= tmp%1 (= (vstd!seq.Seq.len.? $ INT (vstd!seq.Seq.subrange.? $ INT (Poly%vstd!seq.Seq<int.>.
          fibo@
         ) (I 2) (I 5)
        )
       ) 4
...
;; Function-Recommends test_crate::experiments_with_sequences_2
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/summer_school-9d3e788a530b70ff-e07_fail/test.rs:27:7: 27:40 (#0)
(get-info :all-statistics)
(push)
 (declare-const no%param Int)
 ...
 (declare-fun %%array%%3 (Poly Poly Poly Poly Poly Poly Poly Poly Poly) %%Function%%)
 (assert
  (forall ((%%hole%%0 Poly) (%%hole%%1 Poly) (%%hole%%2 Poly) (%%hole%%3 Poly) (%%hole%%4
     Poly
    ) (%%hole%%5 Poly) (%%hole%%6 Poly) (%%hole%%7 Poly) (%%hole%%8 Poly)
 ...
 (assert
  (not (=>
    (= fibo@ (%Poly%vstd!seq.Seq<int.>. (vstd!view.View.view.? $ (ARRAY $ INT $ (CONST_INT
       ...
       ) (array_new $ INT 9 (%%array%%3 (I 1) (I 1) (I 2) (I 3) (I 5) (I 8) (I 13) (I 21)
         (I 34)
    )))))
    (=>
     %%location_label%%0
     (req%vstd!seq.Seq.subrange. $ INT (Poly%vstd!seq.Seq<int.>. fibo@) (I 2) (I 5))
 ))))
 (get-info :version)
 (set-option :rlimit 30000000)
 (check-sat)
...
;; Function-Def test_crate::experiments_with_sequences_3
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/summer_school-9d3e788a530b70ff-e07_fail/test.rs:33:7: 33:40 (#0)
(get-info :all-statistics)
(push)
 (declare-const no%param Int)
 (declare-const tmp%1 Bool)
 (declare-const seq_of_sets@ vstd!seq.Seq<vstd!set.Set<int.>.>.)
 (assert
  fuel_defaults
 )
 (declare-fun %%array%%4 (Poly Poly Poly) %%Function%%)
 (assert
  (forall ((%%hole%%0 Poly) (%%hole%%1 Poly) (%%hole%%2 Poly)) (!
    (let
     ((%%x%% (%%array%%4 %%hole%%0 %%hole%%1 %%hole%%2)))
     (and
      (= (%%apply%%1 %%x%% 0) %%hole%%0)
      (= (%%apply%%1 %%x%% 1) %%hole%%1)
      (= (%%apply%%1 %%x%% 2) %%hole%%2)
    ))
    :pattern ((%%array%%4 %%hole%%0 %%hole%%1 %%hole%%2))
    :qid __AIR_ARRAY_QID__
    :skolemid skolem___AIR_ARRAY_QID__
 )))
 ;; assertion failed
 ...
 (assert
  (not (=>
    (= seq_of_sets@ (%Poly%vstd!seq.Seq<vstd!set.Set<int.>.>. (vstd!view.View.view.? $ (
        ARRAY $ (TYPE%vstd!set.Set. $ INT) $ (CONST_INT 3)
       ) (array_new $ (TYPE%vstd!set.Set. $ INT) 3 (%%array%%4 (vstd!set.impl&%0.insert.? $
          INT (vstd!set.impl&%0.empty.? $ INT) (I 0)
         ) (vstd!set.impl&%0.insert.? $ INT (vstd!set.impl&%0.insert.? $ INT (vstd!set.impl&%0.empty.?
            $ INT
           ) (I 0)
          ) (I 1)
    ...
    (=>
     (= tmp%1 (= (vstd!set.impl&%0.len.? $ INT (vstd!seq.Seq.index.? $ (TYPE%vstd!set.Set.
          $ INT
         ) (Poly%vstd!seq.Seq<vstd!set.Set<int.>.>. seq_of_sets@) (I 1)
        )
       ) 3
     ))
     (=>
...
;; Function-Recommends test_crate::experiments_with_sequences_3
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/summer_school-9d3e788a530b70ff-e07_fail/test.rs:33:7: 33:40 (#0)
(get-info :all-statistics)
(push)
 (declare-const no%param Int)
 ...
 (declare-fun %%array%%5 (Poly Poly Poly) %%Function%%)
 (assert
  (forall ((%%hole%%0 Poly) (%%hole%%1 Poly) (%%hole%%2 Poly)) (!
    (let
     ((%%x%% (%%array%%5 %%hole%%0 %%hole%%1 %%hole%%2)))
     (and
      (= (%%apply%%1 %%x%% 0) %%hole%%0)
      (= (%%apply%%1 %%x%% 1) %%hole%%1)
      (= (%%apply%%1 %%x%% 2) %%hole%%2)
    ))
    :pattern ((%%array%%5 %%hole%%0 %%hole%%1 %%hole%%2))
    :qid __AIR_ARRAY_QID__
    :skolemid skolem___AIR_ARRAY_QID__
 )))
 ;; recommendation not met
 ...
 (assert
  (not (=>
    (= seq_of_sets@ (%Poly%vstd!seq.Seq<vstd!set.Set<int.>.>. (vstd!view.View.view.? $ (
        ARRAY $ (TYPE%vstd!set.Set. $ INT) $ (CONST_INT 3)
       ) (array_new $ (TYPE%vstd!set.Set. $ INT) 3 (%%array%%5 (vstd!set.impl&%0.insert.? $
          INT (vstd!set.impl&%0.empty.? $ INT) (I 0)
         ) (vstd!set.impl&%0.insert.? $ INT (vstd!set.impl&%0.insert.? $ INT (vstd!set.impl&%0.empty.?
            $ INT
           ) (I 0)
    ...
    (=>
     %%location_label%%0
     (req%vstd!seq.Seq.index. $ (TYPE%vstd!set.Set. $ INT) (Poly%vstd!seq.Seq<vstd!set.Set<int.>.>.
       seq_of_sets@
      ) (I 1)
 )))))
 (get-info :version)
