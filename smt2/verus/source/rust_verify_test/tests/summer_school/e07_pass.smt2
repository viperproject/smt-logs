...
(assert
 (distinct fuel%vstd!array.array_view. fuel%vstd!array.impl&%0.view. fuel%vstd!array.impl&%2.spec_index.
  ...
  fuel%vstd!set.axiom_set_insert_finite. fuel%vstd!set.axiom_set_empty_len. fuel%vstd!set.axiom_set_insert_len.
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type)) (!
    ...
    :qid user_vstd__set__axiom_set_empty_len_25
    :skolemid skolem_user_vstd__set__axiom_set_empty_len_25
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (s! Poly) (a! Poly)) (!
    ...
    :qid user_vstd__set__axiom_set_insert_len_26
    :skolemid skolem_user_vstd__set__axiom_set_insert_len_26
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (s! Poly) (a! Poly)) (!
    ...
    :qid user_vstd__set__axiom_set_contains_len_27
    :skolemid skolem_user_vstd__set__axiom_set_contains_len_27
))))
...
;; Function-Def test_crate::experiments_with_sequences
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/summer_school-9d3e788a530b70ff-e07_pass/test.rs:20:7: 20:38 (#0)
...
(push)
 ...
 (declare-const copy@ vstd!seq.Seq<int.>.)
 ...
 (declare-fun %%array%%2 (Poly Poly Poly) %%Function%%)
 (assert
  (forall ((%%hole%%0 Poly) (%%hole%%1 Poly) (%%hole%%2 Poly)) (!
    (let
     ((%%x%% (%%array%%2 %%hole%%0 %%hole%%1 %%hole%%2)))
     (and
      (= (%%apply%%1 %%x%% 0) %%hole%%0)
      (= (%%apply%%1 %%x%% 1) %%hole%%1)
      (= (%%apply%%1 %%x%% 2) %%hole%%2)
    ))
    :pattern ((%%array%%2 %%hole%%0 %%hole%%1 %%hole%%2))
    :qid __AIR_ARRAY_QID__
    :skolemid skolem___AIR_ARRAY_QID__
 )))
 ;; assertion failed
 ...
 (assert
  (not (=>
    ...
    (=>
     (= tmp%1 (= (%I (vstd!seq.Seq.index.? $ INT (Poly%vstd!seq.Seq<int.>. fibo@) (I 4)))
       5
     ))
     (and
      (=>
      ...
      (=>
       tmp%1
       (=>
        (= tmp%2 (= (vstd!seq.Seq.len.? $ INT (Poly%vstd!seq.Seq<int.>. fibo@)) 9))
        (and
         (=>
          %%location_label%%1
          tmp%2
         ...
         (=>
          tmp%2
          (=>
           (= tmp%3 (= (%I (vstd!seq.Seq.index.? $ INT (Poly%vstd!seq.Seq<int.>. fibo@) (I 0)))
             1
           ))
           (and
            (=>
            ...
            (=>
             tmp%3
             (=>
              (= tmp%4 (= (%I (vstd!seq.Seq.index.? $ INT (Poly%vstd!seq.Seq<int.>. fibo@) (I 8)))
                34
              ))
              (and
               (=>
               ...
               (=>
                tmp%4
                (=>
                 (= tmp%5 (= (%I (vstd!seq.Seq.index.? $ INT (Poly%vstd!seq.Seq<int.>. fibo@) (I 7)))
                   21
                 ))
                 (and
                  (=>
                  ...
                  (=>
                   tmp%5
                   (=>
                    (= tmp%6 (ext_eq false (TYPE%vstd!seq.Seq. $ INT) (vstd!seq.Seq.subrange.? $ INT (Poly%vstd!seq.Seq<int.>.
                        fibo@
                       ) (I 2) (I 4)
                      ) (vstd!view.View.view.? $ (ARRAY $ INT $ (CONST_INT 2)) (array_new $ INT 2 (%%array%%1
                         (I 2) (I 3)
                    )))))
                    (and
                     (=>
                     ...
                     (=>
                      tmp%6
                      (=>
                       (= tmp%7 (ext_eq false (TYPE%vstd!seq.Seq. $ INT) (vstd!seq.Seq.subrange.? $ INT (Poly%vstd!seq.Seq<int.>.
                           fibo@
                          ) (I 0) (I 3)
                         ) (vstd!view.View.view.? $ (ARRAY $ INT $ (CONST_INT 3)) (array_new $ INT 3 (%%array%%2
                            (I 1) (I 1) (I 2)
                       )))))
                       (and
                        (=>
                        ...
                        (=>
                         tmp%7
                         (=>
                          (= tmp%8 (ext_eq false (TYPE%vstd!seq.Seq. $ INT) (vstd!seq.Seq.subrange.? $ INT (Poly%vstd!seq.Seq<int.>.
                              fibo@
                             ) (I 7) (I (vstd!seq.Seq.len.? $ INT (Poly%vstd!seq.Seq<int.>. fibo@)))
                            ) (vstd!view.View.view.? $ (ARRAY $ INT $ (CONST_INT 2)) (array_new $ INT 2 (%%array%%1
                               (I 21) (I 34)
                          )))))
                          (and
                           ...
                           (=>
                            tmp%8
                            (=>
                             (= tmp%9 (= (vstd!seq.Seq.len.? $ INT (vstd!seq.Seq.subrange.? $ INT (Poly%vstd!seq.Seq<int.>.
                                  fibo@
                                 ) (I 2) (I 5)
                                )
                               ) 3
                             ...
                             (and
                              ...
                              (=>
                               tmp%9
                               (=>
                                (= tmp%10 (ext_eq false (TYPE%vstd!seq.Seq. $ INT) (vstd!seq.Seq.subrange.? $ INT (Poly%vstd!seq.Seq<int.>.
                                    fibo@
                                   ) (I 5) (I 6)
                                  ) (vstd!seq.Seq.push.? $ INT (vstd!seq.Seq.empty.? $ INT) (I 8))
                                ))
                                (and
                                 (=>
                                  %%location_label%%9
                                  ...
                                  (=>
                                   ...
                                   (=>
                                    (= seq_of_sets@ (%Poly%vstd!seq.Seq<vstd!set.Set<int.>.>. (vstd!view.View.view.? $ (
                                       ...
                                       ) (array_new $ (TYPE%vstd!set.Set. $ INT) 3 (%%array%%2 (vstd!set.impl&%0.insert.? $
                                    ...
                                    (=>
                                     (= tmp%11 (= (vstd!seq.Seq.len.? $ (TYPE%vstd!set.Set. $ INT) (Poly%vstd!seq.Seq<vstd!set.Set<int.>.>.
                                         seq_of_sets@
                                        )
                                       ) 3
                                     ))
                                     (and
                                      ...
                                      (=>
                                       tmp%11
                                       (=>
                                        (= tmp%12 (= (vstd!set.impl&%0.len.? $ INT (vstd!seq.Seq.index.? $ (TYPE%vstd!set.Set.
                                             $ INT
