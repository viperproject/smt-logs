...
(assert
 (distinct fuel%vstd!map.impl&%0.spec_index. fuel%vstd!map.axiom_map_index_decreases_finite.
  ...
  fuel%test_crate!X.impl&%4.tr. fuel%vstd!array.group_array_axioms. fuel%vstd!map.group_map_axioms.
...
(assert
 (forall ((pre! test_crate!X.State.) (post! test_crate!X.State.) (x! Bool) (y! Bool)
   ...
   (= (req%test_crate!X.show.tr. pre! post! x! y! z!) (=>
     %%global_location_label%%2
     (test_crate!X.impl&%4.tr.? (Poly%test_crate!X.State. pre!) (Poly%test_crate!X.State.
       post!
      ) (B x!) (B y!) (B z!)
   )))
   :pattern ((req%test_crate!X.show.tr. pre! post! x! y! z!))
...
(assert
 (forall ((pre! test_crate!X.State.) (post! test_crate!X.State.) (x! Bool) (y! Bool)
   ...
   (= (ens%test_crate!X.show.tr. pre! post! x! y! z!) (test_crate!X.impl&%4.next.? (Poly%test_crate!X.State.
      pre!
     ) (Poly%test_crate!X.State. post!)
   ))
   :pattern ((ens%test_crate!X.show.tr. pre! post! x! y! z!))
