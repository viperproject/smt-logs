...
(assert
 (distinct fuel%vstd!map.impl&%0.spec_index. fuel%vstd!map.axiom_map_index_decreases_finite.
  ...
  fuel%test_crate!X.impl&%0.arrow_tr_1. fuel%test_crate!X.impl&%0.arrow_tr_2. fuel%test_crate!X.impl&%0.arrow_dummy_to_use_type_params_0.
  fuel%test_crate!X.impl&%1.is_tr. fuel%test_crate!X.impl&%1.get_tr_0. fuel%test_crate!X.impl&%1.get_tr_1.
  fuel%test_crate!X.impl&%1.get_tr_2. fuel%test_crate!X.impl&%1.is_dummy_to_use_type_params.
...
(declare-datatypes ((test_crate!X.State. 0) (test_crate!X.Step. 0) (test_crate!X.Config.
  ...
  ) ((test_crate!X.Step./tr (test_crate!X.Step./tr/?0 Bool) (test_crate!X.Step./tr/?1
     Bool
    ) (test_crate!X.Step./tr/?2 Bool)
...
(declare-fun test_crate!X.Step./tr/0 (test_crate!X.Step.) Bool)
...
(declare-fun test_crate!X.impl&%4.tr.? (Poly Poly Poly Poly Poly) Bool)
...
(declare-fun test_crate!X.impl&%1.get_tr_0.? (Poly) Bool)
...
(declare-fun test_crate!X.impl&%4.tr_strong.? (Poly Poly Poly Poly Poly) Bool)

;; Function-Decl test_crate::X::State::tr_enabled
(declare-fun test_crate!X.impl&%4.tr_enabled.? (Poly Poly Poly Poly) Bool)
...
(assert
 (=>
  ...
  (forall ((pre! Poly) (post! Poly) (x! Poly) (y! Poly) (z! Poly)) (!
    (= (test_crate!X.impl&%4.tr.? pre! post! x! y! z!) (let
      ((tmp_assert$ true))
      (let
    ...
    :pattern ((test_crate!X.impl&%4.tr.? pre! post! x! y! z!))
      ...
      (let
       ...
       (let
        ...
        (let
         ...
         (test_crate!X.impl&%4.tr.? pre! post! (B x$) (B y$) (B z$))
    )))))
 ...
 (=>
  ...
  (forall ((pre! Poly) (post! Poly)) (!
    (= (test_crate!X.impl&%4.next.? pre! post!) (exists ((step$ Poly)) (!
       ...
       :pattern ((test_crate!X.impl&%4.next_by.? pre! post! step$))
       :qid user_test_crate__X__State__next_9
       :skolemid skolem_user_test_crate__X__State__next_9
    )))
...
(assert
 (=>
  ...
  (forall ((pre! Poly) (post! Poly) (x! Poly) (y! Poly) (z! Poly)) (!
    (= (test_crate!X.impl&%4.tr_strong.? pre! post! x! y! z!) (let
      ((update_tmp_m$ (test_crate!X.State./State/m (%Poly%test_crate!X.State. pre!))))
      (let
       ((update_tmp_a$ (test_crate!X.State./State/a (%Poly%test_crate!X.State. pre!))))
       (let
    ...
    :pattern ((test_crate!X.impl&%4.tr_strong.? pre! post! x! y! z!))
...
(assert
 (=>
  ...
  (forall ((pre! Poly) (x! Poly) (y! Poly) (z! Poly)) (!
    (= (test_crate!X.impl&%4.tr_enabled.? pre! x! y! z!) (let
      ((tmp_assert$ true))
      (let
       ((tmp_assert$1 (ite
          (%B x!)
    ...
    :pattern ((test_crate!X.impl&%4.tr_enabled.? pre! x! y! z!))
    ...
    (= (test_crate!X.impl&%4.next_strong_by.? pre! post! step!) (and
      ...
      (let
       ...
       (let
        ...
        (let
         ((z$ (test_crate!X.Step./tr/2 (%Poly%test_crate!X.Step. step!))))
         (test_crate!X.impl&%4.tr_strong.? pre! post! (B x$) (B y$) (B z$))
    )))))
 ...
 (=>
  ...
  (forall ((pre! Poly) (post! Poly)) (!
    (= (test_crate!X.impl&%4.next_strong.? pre! post!) (exists ((step$ Poly)) (!
       ...
       :pattern ((test_crate!X.impl&%4.next_strong_by.? pre! post! step$))
       :qid user_test_crate__X__State__next_strong_10
       :skolemid skolem_user_test_crate__X__State__next_strong_10
    )))
 ...
 (=>
  ...
  (forall ((post! Poly)) (!
    (= (test_crate!X.impl&%4.init.? post!) (exists ((step$ Poly)) (!
       ...
       :pattern ((test_crate!X.impl&%4.init_by.? post! step$))
       :qid user_test_crate__X__State__init_11
       :skolemid skolem_user_test_crate__X__State__init_11
    )))
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/state_machines-c25f1c939512e7ab-assert_in_if/test.rs:35:1: 53:3 (#42)
        ...
        (and
         (=>
          ...
          (and
           (=>
            %%location_label%%0
            (req%vstd!state_machine_internal.assert_safety. y!)
           )
           (=>
            (ens%vstd!state_machine_internal.assert_safety. y!)
            %%switch_label%%0
         )))
         (=>
          (not x!)
