...
(assert
 (distinct fuel%vstd!map.impl&%0.spec_index. fuel%vstd!map.axiom_map_index_decreases_finite.
  ...
  fuel%test_crate!X.impl&%7.tr. fuel%vstd!array.group_array_axioms. fuel%vstd!map.group_map_axioms.
    ...
    (= (test_crate!X.impl&%7.tr.? pre! post!) (let
      ...
      (let
       ...
       (let
        ...
        (let
         ((update_tmp_t$1 (%Poly%vstd!map.Map<int./int.>. (vstd!map.impl&%0.insert.? $ INT $ INT
             (Poly%vstd!map.Map<int./int.>. update_tmp_t$) (I 5) (I 7)
         ))))
         (=>
          tmp_assert$1
...
(assert
 (forall ((pre! test_crate!X.State.) (post! test_crate!X.State.)) (!
   (= (req%test_crate!X.show.tr. pre! post!) (=>
     ...
     (test_crate!X.impl&%7.tr.? (Poly%test_crate!X.State. pre!) (Poly%test_crate!X.State.
       post!
   ))))
...
(assert
 (forall ((pre! test_crate!X.State.) (post! test_crate!X.State.)) (!
   (= (ens%test_crate!X.show.tr. pre! post!) (test_crate!X.impl&%7.next.? (Poly%test_crate!X.State.
      pre!
