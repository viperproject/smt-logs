...
(assert
 (distinct fuel%vstd!std_specs.option.impl&%0.is_Some. fuel%vstd!std_specs.option.impl&%0.get_Some_0.
  ...
  fuel%vstd!map.axiom_map_ext_equal_deep. fuel%vstd!map_lib.impl&%0.contains_pair.
  fuel%vstd!set.axiom_set_ext_equal. fuel%vstd!set.axiom_set_ext_equal_deep. fuel%test_crate!X.impl&%0.arrow_0.
  fuel%test_crate!X.impl&%0.arrow_dummy_to_use_type_params_0. fuel%test_crate!X.impl&%1.is_dummy_to_use_type_params.
  ...
  fuel%test_crate!X.impl&%3.get_dummy_to_use_type_params_0. fuel%test_crate!X.impl&%7.next_by.
 ...
 (=>
  ...
  (forall ((pre! Poly) (post! Poly)) (!
    (= (test_crate!X.impl&%7.next.? pre! post!) (exists ((step$ Poly)) (!
       ...
       :pattern ((test_crate!X.impl&%7.next_by.? pre! post! step$))
       :qid user_test_crate__X__State__next_16
       :skolemid skolem_user_test_crate__X__State__next_16
    )))
 ...
 (=>
  ...
  (forall ((pre! Poly) (post! Poly)) (!
    (= (test_crate!X.impl&%7.next_strong.? pre! post!) (exists ((step$ Poly)) (!
       ...
       :pattern ((test_crate!X.impl&%7.next_strong_by.? pre! post! step$))
       :qid user_test_crate__X__State__next_strong_17
       :skolemid skolem_user_test_crate__X__State__next_strong_17
    )))
 ...
 (=>
  ...
  (forall ((post! Poly)) (!
    (= (test_crate!X.impl&%7.init.? post!) (exists ((step$ Poly)) (!
       ...
       :pattern ((test_crate!X.impl&%7.init_by.? post! step$))
       :qid user_test_crate__X__State__init_18
       :skolemid skolem_user_test_crate__X__State__init_18
    )))
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/state_machines-c25f1c939512e7ab-inherent_safety_condition_map_guard/test.rs:35:1: 49:3 (#42)
(get-info :all-statistics)
(push)
 (declare-const pre! test_crate!X.State.)
 (declare-const tmp%1 Bool)
 (declare-const tmp%2 Bool)
 (declare-const t@ vstd!map.Map<int./int.>.)
     ...
     (and
      (=>
       ...
       (and
        ...
        (=>
         (ens%vstd!state_machine_internal.assert_guard_map. tmp%1)
         (=>
          %%location_label%%1
       ...
       (=>
        ...
        (=>
         (= tmp%2 (and
           ...
           (= (%I (vstd!map.impl&%0.index.? $ INT $ INT (Poly%vstd!map.Map<int./int.>. t@) (I 5)))
            7
         )))
         (=>
          %%location_label%%2
        ...
        (and
         (=>
          ...
          (and
           (=>
            %%location_label%%0
            (req%vstd!map.impl&%0.index. $ INT $ INT (Poly%vstd!map.Map<int./int.>. t@) (I 5))
           )
           (=>
            (= tmp%2 (vstd!map.impl&%0.index.? $ INT $ INT (Poly%vstd!map.Map<int./int.>. t@) (
               I 5
            )))
            (=>
             (= tmp%3 (= (%I tmp%2) 7))
...
(assert
 (forall ((self! test_crate!X.Instance.) (tmp_tuple! tuple%2.)) (!
   (= (ens%test_crate!X.impl&%4.tr. self! tmp_tuple!) (and
     ...
     (let
      ((original_field_t$ (%Poly%vstd!map.Map<int./int.>. (tuple%2./tuple%2/0 (%Poly%tuple%2.
