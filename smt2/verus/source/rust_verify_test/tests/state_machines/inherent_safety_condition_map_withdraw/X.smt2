...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/state_machines-c25f1c939512e7ab-inherent_safety_condition_map_withdraw/test.rs:48:5: 48:47 (#0)
  ...
  (not (=>
    ...
    (and
     ...
     (=>
      tmp%1
      (=>
       (= tmp%2 (= (%I (vstd!map.impl&%0.index.? $ INT $ INT (Poly%vstd!map.Map<int./int.>. (
             test_crate!X.State./State/t (%Poly%test_crate!X.State. (Poly%test_crate!X.State. pre!))
            )
           ) (I 5)
          )
       ...
       (and
        ...
        (=>
         tmp%2
         (=>
          (= tmp%3 (not (vstd!set.impl&%0.contains.? $ INT (vstd!map.impl&%0.dom.? $ INT $ INT
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/state_machines-c25f1c939512e7ab-inherent_safety_condition_map_withdraw/test.rs:35:1: 53:3 (#42)
(get-info :all-statistics)
(push)
 (declare-const pre! test_crate!X.State.)
 (declare-const tmp%1 Bool)
 ...
 (assert
  (not (=>
    ...
    (=>
     ...
     (=>
      (= tmp%1 (vstd!map_lib.impl&%0.contains_pair.? $ INT $ INT (Poly%vstd!map.Map<int./int.>.
         update_tmp_t@
        ) (I 5) (I 7)
      ))
      (and
...
(assert
 (forall ((self! test_crate!X.Instance.) (param_token_0_t! Int)) (!
   (= (ens%test_crate!X.impl&%4.tr. self! param_token_0_t!) (= param_token_0_t! 7))
   :pattern ((ens%test_crate!X.impl&%4.tr. self! param_token_0_t!))
