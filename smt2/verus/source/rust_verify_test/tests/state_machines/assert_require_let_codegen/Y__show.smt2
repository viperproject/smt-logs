...
(assert
 (distinct fuel%test_crate!Y.impl&%19.initialize. fuel%test_crate!Y.impl&%19.tr1. fuel%vstd!array.group_array_axioms.
...
;; Datatypes
(declare-datatypes ((core!option.Option. 0) (test_crate!Y.State. 0) (tuple%0. 0) (tuple%2.
   0
  )
    ...
    (test_crate!Y.State./State/?opt2 core!option.Option.) (test_crate!Y.State./State/?opt3
     core!option.Option.
    ) (test_crate!Y.State./State/?opt4 core!option.Option.)
   )
...
(assert
 (forall ((pre! test_crate!Y.State.) (post! test_crate!Y.State.)) (!
   (= (ens%test_crate!Y.show.tr1. pre! post!) (test_crate!Y.impl&%19.next.? (Poly%test_crate!Y.State.
      pre!
...
(assert
 (forall ((post! test_crate!Y.State.)) (!
   (= (ens%test_crate!Y.show.initialize. post!) (test_crate!Y.impl&%19.init.? (Poly%test_crate!Y.State.
      post!
   )))
