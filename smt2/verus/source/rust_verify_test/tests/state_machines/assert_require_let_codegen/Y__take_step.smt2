...
(assert
 (distinct fuel%vstd!std_specs.option.impl&%0.is_Some. fuel%vstd!std_specs.option.impl&%0.is_None.
  ...
  fuel%test_crate!Y.impl&%19.tr1_strong. fuel%test_crate!Y.impl&%19.tr1_enabled. fuel%test_crate!Y.impl&%19.invariant.
  fuel%test_crate!Y.impl&%19.the_inv. fuel%vstd!array.group_array_axioms. fuel%vstd!map.group_map_axioms.
...
;; Datatypes
(declare-datatypes ((core!option.Option. 0) (test_crate!Y.State. 0) (tuple%2. 0))
...
(assert
 (forall ((no%param Int)) (!
   (= (req%test_crate!Y.take_step.initialize. no%param) (=>
     ...
     (test_crate!Y.impl&%19.initialize_enabled.? (I 0))
   ))
...
(assert
 (forall ((pre! test_crate!Y.State.)) (!
   (= (req%test_crate!Y.take_step.tr1. pre!) (=>
     ...
     (and
      (test_crate!Y.impl&%19.tr1_enabled.? (Poly%test_crate!Y.State. pre!))
