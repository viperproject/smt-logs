...
(assert
 (distinct fuel%vstd!std_specs.option.impl&%0.is_Some. fuel%vstd!std_specs.option.impl&%0.get_Some_0.
  ...
  fuel%vstd!set.axiom_set_insert_finite. fuel%vstd!set.axiom_set_remove_finite. fuel%test_crate!Y.impl&%13.initialize.
  fuel%test_crate!Y.impl&%13.tr1. fuel%test_crate!Y.impl&%13.tr2. fuel%test_crate!Y.impl&%13.tr3.
...
(declare-fun req%test_crate!Y.show.tr2. (test_crate!Y.State. test_crate!Y.State. Int)
 Bool
)
(declare-const %%global_location_label%%3 Bool)
(assert
 (forall ((pre! test_crate!Y.State.) (post! test_crate!Y.State.) (key! Int)) (!
   (= (req%test_crate!Y.show.tr2. pre! post! key!) (=>
     %%global_location_label%%3
     (test_crate!Y.impl&%13.tr2.? (Poly%test_crate!Y.State. pre!) (Poly%test_crate!Y.State.
       post!
      ) (I key!)
   )))
   :pattern ((req%test_crate!Y.show.tr2. pre! post! key!))
   :qid internal_req__test_crate!Y.show.tr2._definition
   :skolemid skolem_internal_req__test_crate!Y.show.tr2._definition
)))
(declare-fun ens%test_crate!Y.show.tr2. (test_crate!Y.State. test_crate!Y.State. Int)
 Bool
)
(assert
 (forall ((pre! test_crate!Y.State.) (post! test_crate!Y.State.) (key! Int)) (!
   (= (ens%test_crate!Y.show.tr2. pre! post! key!) (test_crate!Y.impl&%13.next.? (Poly%test_crate!Y.State.
      pre!
     ) (Poly%test_crate!Y.State. post!)
   ))
   :pattern ((ens%test_crate!Y.show.tr2. pre! post! key!))
...
(declare-fun req%test_crate!Y.show.tr3. (test_crate!Y.State. test_crate!Y.State. Int)
 Bool
)
(declare-const %%global_location_label%%4 Bool)
(assert
 (forall ((pre! test_crate!Y.State.) (post! test_crate!Y.State.) (key! Int)) (!
   (= (req%test_crate!Y.show.tr3. pre! post! key!) (=>
     %%global_location_label%%4
     (test_crate!Y.impl&%13.tr3.? (Poly%test_crate!Y.State. pre!) (Poly%test_crate!Y.State.
       post!
      ) (I key!)
   )))
   :pattern ((req%test_crate!Y.show.tr3. pre! post! key!))
   :qid internal_req__test_crate!Y.show.tr3._definition
   :skolemid skolem_internal_req__test_crate!Y.show.tr3._definition
)))
(declare-fun ens%test_crate!Y.show.tr3. (test_crate!Y.State. test_crate!Y.State. Int)
 Bool
)
(assert
 (forall ((pre! test_crate!Y.State.) (post! test_crate!Y.State.) (key! Int)) (!
   (= (ens%test_crate!Y.show.tr3. pre! post! key!) (test_crate!Y.impl&%13.next.? (Poly%test_crate!Y.State.
      pre!
     ) (Poly%test_crate!Y.State. post!)
   ))
   :pattern ((ens%test_crate!Y.show.tr3. pre! post! key!))
...
(assert
 (forall ((post! test_crate!Y.State.)) (!
   (= (ens%test_crate!Y.show.initialize. post!) (test_crate!Y.impl&%13.init.? (Poly%test_crate!Y.State.
      post!
   )))
