...
(assert
 (distinct fuel%vstd!std_specs.option.impl&%0.is_Some. fuel%vstd!std_specs.option.impl&%0.get_Some_0.
  ...
  fuel%test_crate!Y.impl&%13.initialize_enabled. fuel%test_crate!Y.impl&%13.tr1_strong.
  fuel%test_crate!Y.impl&%13.tr1_enabled. fuel%test_crate!Y.impl&%13.tr2_strong. fuel%test_crate!Y.impl&%13.tr2_enabled.
  fuel%test_crate!Y.impl&%13.tr3_strong. fuel%test_crate!Y.impl&%13.tr3_enabled. fuel%test_crate!Y.impl&%13.invariant.
  fuel%test_crate!Y.impl&%13.maps_eq. fuel%test_crate!Y.impl&%13.maps_6. fuel%vstd!array.group_array_axioms.
 ...
 (=>
  ...
  (forall ((self! Poly)) (!
    (= (test_crate!Y.impl&%13.maps_6.? self!) (forall ((k$ Poly)) (!
       ...
       :qid user_test_crate__Y__State__maps_6_24
       :skolemid skolem_user_test_crate__Y__State__maps_6_24
    )))
...
(assert
 (forall ((no%param Int)) (!
   (= (req%test_crate!Y.take_step.initialize. no%param) (=>
     ...
     (test_crate!Y.impl&%13.initialize_enabled.? (I 0))
   ))
...
(declare-fun req%test_crate!Y.take_step.tr2. (test_crate!Y.State. Int) Bool)
(declare-const %%global_location_label%%4 Bool)
(assert
 (forall ((pre! test_crate!Y.State.) (key! Int)) (!
   (= (req%test_crate!Y.take_step.tr2. pre! key!) (=>
     %%global_location_label%%4
     (and
      (test_crate!Y.impl&%13.tr2_enabled.? (Poly%test_crate!Y.State. pre!) (I key!))
      (test_crate!Y.impl&%13.invariant.? (Poly%test_crate!Y.State. pre!))
   )))
   :pattern ((req%test_crate!Y.take_step.tr2. pre! key!))
...
(declare-fun ens%test_crate!Y.take_step.tr2. (test_crate!Y.State. Int test_crate!Y.State.)
 Bool
)
(assert
 (forall ((pre! test_crate!Y.State.) (key! Int) (post! test_crate!Y.State.)) (!
   (= (ens%test_crate!Y.take_step.tr2. pre! key! post!) (and
     (has_type (Poly%test_crate!Y.State. post!) TYPE%test_crate!Y.State.)
     (and
   ...
   :pattern ((ens%test_crate!Y.take_step.tr2. pre! key! post!))
...
(declare-fun req%test_crate!Y.take_step.tr3. (test_crate!Y.State. Int) Bool)
(declare-const %%global_location_label%%5 Bool)
(assert
 (forall ((pre! test_crate!Y.State.) (key! Int)) (!
   (= (req%test_crate!Y.take_step.tr3. pre! key!) (=>
     %%global_location_label%%5
     (and
      (test_crate!Y.impl&%13.tr3_enabled.? (Poly%test_crate!Y.State. pre!) (I key!))
      (test_crate!Y.impl&%13.invariant.? (Poly%test_crate!Y.State. pre!))
   )))
   :pattern ((req%test_crate!Y.take_step.tr3. pre! key!))
...
(declare-fun ens%test_crate!Y.take_step.tr3. (test_crate!Y.State. Int test_crate!Y.State.)
 Bool
)
(assert
 (forall ((pre! test_crate!Y.State.) (key! Int) (post! test_crate!Y.State.)) (!
   (= (ens%test_crate!Y.take_step.tr3. pre! key! post!) (and
     (has_type (Poly%test_crate!Y.State. post!) TYPE%test_crate!Y.State.)
     (and
   ...
   :pattern ((ens%test_crate!Y.take_step.tr3. pre! key! post!))
