...
(assert
 (distinct fuel%vstd!set.impl&%0.subset_of. fuel%vstd!set.impl&%0.spec_le. fuel%vstd!set.axiom_set_empty.
  fuel%vstd!set.axiom_set_insert_same. fuel%vstd!set.axiom_set_insert_different. fuel%vstd!set.axiom_set_union.
  fuel%vstd!set.axiom_set_ext_equal. fuel%vstd!set.axiom_set_ext_equal_deep. fuel%test_crate!Y.impl&%11.tr_add.
  fuel%test_crate!Y.impl&%11.tr_add_strong. fuel%test_crate!Y.impl&%11.tr_have. fuel%test_crate!Y.impl&%11.tr_have_strong.
  fuel%test_crate!Y.impl&%11.tr_add_gen. fuel%test_crate!Y.impl&%11.tr_add_gen_strong.
  fuel%test_crate!Y.impl&%11.tr_have_gen. fuel%test_crate!Y.impl&%11.tr_have_gen_strong.
  ...
  fuel%test_crate!rel_tr2_strong. fuel%test_crate!rel_tr4. fuel%test_crate!rel_tr4_strong.
  fuel%test_crate!rel_tr5. fuel%test_crate!rel_tr5_strong. fuel%vstd!array.group_array_axioms.
...
(assert
 (forall ((self! test_crate!Y.Instance.) (param_token_0_b! test_crate!Y.b.)) (!
   (= (ens%test_crate!Y.impl&%8.tr_add. self! param_token_0_b!) (and
...
(declare-fun ens%test_crate!Y.impl&%8.tr_add_gen. (test_crate!Y.Instance. vstd!tokens.SetToken<int./test_crate!Y.b.>.)
 Bool
)
(assert
 (forall ((self! test_crate!Y.Instance.) (param_token_0_b! vstd!tokens.SetToken<int./test_crate!Y.b.>.))
  (!
   (= (ens%test_crate!Y.impl&%8.tr_add_gen. self! param_token_0_b!) (and
   ...
   :pattern ((ens%test_crate!Y.impl&%8.tr_add_gen. self! param_token_0_b!))
...
(declare-fun req%test_crate!Y.impl&%8.tr_have_gen. (test_crate!Y.Instance. vstd!tokens.SetToken<int./test_crate!Y.b.>.)
 Bool
)
...
(assert
 (forall ((self! test_crate!Y.Instance.) (param_token_0_b! vstd!tokens.SetToken<int./test_crate!Y.b.>.))
  (!
   (= (req%test_crate!Y.impl&%8.tr_have_gen. self! param_token_0_b!) (=>
   ...
   :pattern ((req%test_crate!Y.impl&%8.tr_have_gen. self! param_token_0_b!))
 ...
 (=>
  ...
  (forall ((pre! Poly) (post! Poly)) (!
    (= (test_crate!rel_tr1.? pre! post!) (= (test_crate!Y.State./State/b (%Poly%test_crate!Y.State.
      ...
      ) (%Poly%vstd!set.Set<int.>. (vstd!set.impl&%0.insert.? $ INT (Poly%vstd!set.Set<int.>.
...
(assert
 (=>
  ...
  (forall ((pre! Poly) (post! Poly)) (!
    (= (test_crate!rel_tr4.? pre! post!) (= (test_crate!Y.State./State/b (%Poly%test_crate!Y.State.
        post!
       )
      ) (%Poly%vstd!set.Set<int.>. (vstd!set.impl&%0.union.? $ INT (Poly%vstd!set.Set<int.>.
         (test_crate!Y.State./State/b (%Poly%test_crate!Y.State. pre!))
        ) (vstd!set.impl&%0.insert.? $ INT (vstd!set.impl&%0.empty.? $ INT) (I 6))
    ))))
...
(assert
 (=>
  ...
  (forall ((pre! Poly) (post! Poly)) (!
    (= (test_crate!rel_tr4_strong.? pre! post!) (= (test_crate!Y.State./State/b (%Poly%test_crate!Y.State.
        post!
       )
      ) (%Poly%vstd!set.Set<int.>. (vstd!set.impl&%0.union.? $ INT (Poly%vstd!set.Set<int.>.
         (test_crate!Y.State./State/b (%Poly%test_crate!Y.State. pre!))
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/state_machines-c25f1c939512e7ab-persistent_set_codegen/test.rs:110:7: 110:51 (#0)
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/state_machines-c25f1c939512e7ab-persistent_set_codegen/test.rs:124:7: 124:22 (#0)
(get-info :all-statistics)
(push)
 ...
 (declare-const token1_clone@ test_crate!Y.b.)
     ...
     (=>
      ...
      (=>
       ...
       (=>
        ...
        (=>
         (= tmp%1 (vstd!set.impl&%0.contains.? $ INT (vstd!set.impl&%0.insert.? $ INT (vstd!set.impl&%0.empty.?
             $ INT
            ) (I 19)
           ) (I 19)
         ))
         (and
          ...
          (=>
           tmp%1
           (=>
            (= tmp%2 (ext_eq false (TYPE%vstd!set.Set. $ INT) (vstd!tokens.impl&%1.set.? $ INT $
            ...
            (and
             ...
             (=>
              tmp%2
              (=>
               (= tmp%3 (= (vstd!tokens.impl&%1.instance_id.? $ INT $ TYPE%test_crate!Y.b. (Poly%vstd!tokens.SetToken<int./test_crate!Y.b.>.
                   token_f@
                  )
               ...
               (and
                ...
                (=>
                 tmp%3
                 (=>
                  (ens%test_crate!Y.impl&%8.tr_add. inst@ token1@)
                  (=>
                   (= tmp%4 (= (%Poly%vstd!tokens.InstanceId. (vstd!tokens.ElementToken.instance_id.? $
                   ...
                   (and
                    ...
                    (=>
                     tmp%4
                     (=>
                      (= tmp%5 (= (%I (vstd!tokens.ElementToken.element.? $ TYPE%test_crate!Y.b. $ INT (Poly%test_crate!Y.b.
                           token1@
                         ))
                        ) 5
                      ))
                      (and
                       ...
                       (=>
                        ...
                        (and
                         (=>
                          %%location_label%%5
                          (req%test_crate!Y.impl&%8.tr_have. inst@ token1@)
                         )
                         (=>
                          (ens%test_crate!Y.impl&%4.clone. token1@ token1_clone@)
                          (=>
                           (= tmp%6 (= token1_clone@ token1@))
                           (and
                            (=>
                             %%location_label%%6
                             tmp%6
                            ...
                            (=>
                             tmp%6
                             (=>
                              (ens%test_crate!Y.impl&%8.tr_add_gen. inst@ token_set@)
                              (=>
                               (= tmp%7 (vstd!set.impl&%0.contains.? $ INT (vstd!set.impl&%0.insert.? $ INT (vstd!set.impl&%0.empty.?
                                   $ INT
                                  ) (I 6)
                                 ) (I 6)
                               ))
                               (and
                                ...
                                (=>
                                 tmp%7
                                 (=>
                                  (= tmp%8 (ext_eq false (TYPE%vstd!set.Set. $ INT) (vstd!tokens.impl&%1.set.? $ INT $
                                  ...
                                  (and
                                   ...
                                   (=>
                                    tmp%8
                                    (=>
                                     (= tmp%9 (= (vstd!tokens.impl&%1.instance_id.? $ INT $ TYPE%test_crate!Y.b. (Poly%vstd!tokens.SetToken<int./test_crate!Y.b.>.
                                         token_set@
                                        )
                                       ) (test_crate!Y.impl&%8.id.? (Poly%test_crate!Y.Instance. inst@))
                                     ))
                                     (and
                                      ...
                                      (=>
                                       ...
                                       (=>
                                        %%location_label%%10
                                        (req%test_crate!Y.impl&%8.tr_have_gen. inst@ token_set@)
 )))))))))))))))))))))))))))))))))))))))
 (get-info :version)
 (set-option :rlimit 30000000)
 (check-sat)
