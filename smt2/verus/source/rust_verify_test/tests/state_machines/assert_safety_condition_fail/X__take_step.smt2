...
(assert
 (distinct fuel%test_crate!X.impl&%4.tr_strong. fuel%test_crate!X.impl&%4.tr_enabled.
...
(declare-fun test_crate!X.impl&%4.tr_strong.? (Poly Poly) Bool)

;; Function-Decl test_crate::X::State::tr_enabled
(declare-fun test_crate!X.impl&%4.tr_enabled.? (Poly) Bool)
...
(assert
 (=>
  ...
  (forall ((pre! Poly) (post! Poly)) (!
    (= (test_crate!X.impl&%4.tr_strong.? pre! post!) (let
    ...
    :pattern ((test_crate!X.impl&%4.tr_strong.? pre! post!))
...
(assert
 (=>
  ...
  (forall ((pre! Poly)) (!
    (= (test_crate!X.impl&%4.tr_enabled.? pre!) true)
    :pattern ((test_crate!X.impl&%4.tr_enabled.? pre!))
...
(assert
 (forall ((pre! test_crate!X.State.)) (!
   (= (req%test_crate!X.take_step.tr. pre!) (=>
     ...
     (and
      (test_crate!X.impl&%4.tr_enabled.? (Poly%test_crate!X.State. pre!))
