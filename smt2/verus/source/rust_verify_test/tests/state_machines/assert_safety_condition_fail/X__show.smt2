...
(assert
 (distinct fuel%test_crate!X.impl&%4.tr. fuel%vstd!array.group_array_axioms. fuel%vstd!map.group_map_axioms.
...
(declare-datatypes ((test_crate!X.State. 0) (tuple%0. 0)) (((test_crate!X.State./State
    (test_crate!X.State./State/?t Int)
   )
  ) ((tuple%0./tuple%0))
))
...
(declare-fun test_crate!X.impl&%4.tr.? (Poly Poly) Bool)
...
(assert
 (=>
  ...
  (forall ((pre! Poly) (post! Poly)) (!
    (= (test_crate!X.impl&%4.tr.? pre! post!) (let
      ((tmp_assert$ true))
      (let
       ...
       (let
        ((tmp_assert$1 (and
           tmp_assert$
           (= (test_crate!X.State./State/t (%Poly%test_crate!X.State. pre!)) 0)
        )))
        (=>
         tmp_assert$1
         (= (test_crate!X.State./State/t (%Poly%test_crate!X.State. post!)) update_tmp_t$)
    )))))
    :pattern ((test_crate!X.impl&%4.tr.? pre! post!))
...
(declare-fun req%test_crate!X.show.tr. (test_crate!X.State. test_crate!X.State.) Bool)
(declare-const %%global_location_label%%0 Bool)
(assert
 (forall ((pre! test_crate!X.State.) (post! test_crate!X.State.)) (!
   (= (req%test_crate!X.show.tr. pre! post!) (=>
     %%global_location_label%%0
     (test_crate!X.impl&%4.tr.? (Poly%test_crate!X.State. pre!) (Poly%test_crate!X.State.
       post!
   ))))
   :pattern ((req%test_crate!X.show.tr. pre! post!))
   :qid internal_req__test_crate!X.show.tr._definition
   :skolemid skolem_internal_req__test_crate!X.show.tr._definition
)))
(declare-fun ens%test_crate!X.show.tr. (test_crate!X.State. test_crate!X.State.) Bool)
(assert
 (forall ((pre! test_crate!X.State.) (post! test_crate!X.State.)) (!
   (= (ens%test_crate!X.show.tr. pre! post!) (test_crate!X.impl&%4.next.? (Poly%test_crate!X.State.
      pre!
     ) (Poly%test_crate!X.State. post!)
   ))
   :pattern ((ens%test_crate!X.show.tr. pre! post!))
