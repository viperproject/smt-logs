...
(assert
 (distinct fuel%test_crate!X.impl&%4.initialize. fuel%test_crate!X.impl&%4.tr1. fuel%test_crate!X.impl&%4.tr1_strong.
  fuel%test_crate!X.impl&%4.tr2. fuel%test_crate!X.impl&%4.tr2_strong. fuel%test_crate!X.impl&%4.tr3.
  fuel%test_crate!X.impl&%4.tr3_strong. fuel%test_crate!impl&%0.arrow_Bar_0. fuel%test_crate!impl&%0.arrow_Qax_0.
  fuel%test_crate!impl&%0.arrow_Duck_0. fuel%test_crate!rel_init. fuel%test_crate!rel_tr1.
  fuel%test_crate!rel_tr1_strong. fuel%test_crate!rel_tr2. fuel%test_crate!rel_tr2_strong.
  fuel%test_crate!rel_tr3. fuel%test_crate!rel_tr3_strong. fuel%vstd!array.group_array_axioms.
...
(declare-fun test_crate!rel_init.? (Poly Poly Poly Poly) Bool)
...
(declare-fun test_crate!rel_tr2.? (Poly Poly Poly Poly) Bool)

;; Function-Decl test_crate::rel_tr2_strong
(declare-fun test_crate!rel_tr2_strong.? (Poly Poly Poly Poly) Bool)

;; Function-Decl test_crate::rel_tr3
(declare-fun test_crate!rel_tr3.? (Poly Poly Poly Poly) Bool)

;; Function-Decl test_crate::rel_tr3_strong
(declare-fun test_crate!rel_tr3_strong.? (Poly Poly Poly Poly) Bool)
...
(assert
 (=>
  ...
  (forall ((post! Poly) (x! Poly) (y! Poly) (z! Poly)) (!
    (= (test_crate!rel_init.? post! x! y! z!) (and
      (and
       (and
    ...
    :pattern ((test_crate!rel_init.? post! x! y! z!))
...
(assert
 (=>
  ...
  (forall ((pre! Poly) (post! Poly) (b! Poly) (c! Poly)) (!
    (= (test_crate!rel_tr1.? pre! post! b! c!) (and
      (%B b!)
      (=>
       (<= (test_crate!X.State./State/y (%Poly%test_crate!X.State. pre!)) (test_crate!X.State./State/z
         (%Poly%test_crate!X.State. pre!)
       ...
       (and
        (and
         ...
         (= (test_crate!X.State./State/x (%Poly%test_crate!X.State. post!)) (test_crate!X.State./State/x
           (%Poly%test_crate!X.State. pre!)
        )))
        (= (test_crate!X.State./State/y (%Poly%test_crate!X.State. post!)) (test_crate!X.State./State/y
          (%Poly%test_crate!X.State. pre!)
    ))))))
    :pattern ((test_crate!rel_tr1.? pre! post! b! c!))
...
(assert
 (=>
  ...
  (forall ((pre! Poly) (post! Poly) (b! Poly) (c! Poly)) (!
    (= (test_crate!rel_tr1_strong.? pre! post! b! c!) (and
      (%B b!)
      (and
       (<= (test_crate!X.State./State/y (%Poly%test_crate!X.State. pre!)) (test_crate!X.State./State/z
         (%Poly%test_crate!X.State. pre!)
    ...
    :pattern ((test_crate!rel_tr1_strong.? pre! post! b! c!))
...
(assert
 (=>
  ...
  (forall ((pre! Poly) (post! Poly) (b! Poly) (c! Poly)) (!
    (= (test_crate!rel_tr2.? pre! post! b! c!) (and
      (ite
       (%B b!)
       (= (test_crate!X.State./State/z (%Poly%test_crate!X.State. post!)) (Add (test_crate!X.State./State/z
          (%Poly%test_crate!X.State. pre!)
    ...
    :pattern ((test_crate!rel_tr2.? pre! post! b! c!))
...
(assert
 (=>
  ...
  (forall ((pre! Poly) (post! Poly) (b! Poly) (c! Poly)) (!
    (= (test_crate!rel_tr2_strong.? pre! post! b! c!) (and
      (ite
       (%B b!)
       (= (test_crate!X.State./State/z (%Poly%test_crate!X.State. post!)) (Add (test_crate!X.State./State/z
          (%Poly%test_crate!X.State. pre!)
    ...
    :pattern ((test_crate!rel_tr2_strong.? pre! post! b! c!))
...
(assert
 (=>
  ...
  (forall ((pre! Poly) (post! Poly) (b! Poly) (c! Poly)) (!
    (= (test_crate!rel_tr3.? pre! post! b! c!) (and
      (ite
       (not (%B b!))
       (= (test_crate!X.State./State/z (%Poly%test_crate!X.State. post!)) (Add (test_crate!X.State./State/z
          (%Poly%test_crate!X.State. pre!)
    ...
    :pattern ((test_crate!rel_tr3.? pre! post! b! c!))
...
(assert
 (=>
  ...
  (forall ((pre! Poly) (post! Poly) (b! Poly) (c! Poly)) (!
    (= (test_crate!rel_tr3_strong.? pre! post! b! c!) (and
      (ite
       (not (%B b!))
       (= (test_crate!X.State./State/z (%Poly%test_crate!X.State. post!)) (Add (test_crate!X.State./State/z
          (%Poly%test_crate!X.State. pre!)
    ...
    :pattern ((test_crate!rel_tr3_strong.? pre! post! b! c!))
...
(declare-fun req%test_crate!correct_init. (test_crate!X.State. Int Int Int) Bool)
(declare-const %%global_location_label%%0 Bool)
(assert
 (forall ((post! test_crate!X.State.) (x! Int) (y! Int) (z! Int)) (!
   (= (req%test_crate!correct_init. post! x! y! z!) (=>
     %%global_location_label%%0
     (test_crate!X.impl&%4.initialize.? (Poly%test_crate!X.State. post!) (I x!) (I y!)
      (I z!)
   )))
   :pattern ((req%test_crate!correct_init. post! x! y! z!))
   :qid internal_req__test_crate!correct_init._definition
   :skolemid skolem_internal_req__test_crate!correct_init._definition
)))
(declare-fun ens%test_crate!correct_init. (test_crate!X.State. Int Int Int) Bool)
(assert
 (forall ((post! test_crate!X.State.) (x! Int) (y! Int) (z! Int)) (!
   (= (ens%test_crate!correct_init. post! x! y! z!) (test_crate!rel_init.? (Poly%test_crate!X.State.
      post!
     ) (I x!) (I y!) (I z!)
   ))
   :pattern ((ens%test_crate!correct_init. post! x! y! z!))
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/state_machines-c25f1c939512e7ab-relation_codegen/test.rs:167:7: 167:62 (#0)
...
(push)
 ...
 (assert
  (not (=>
    %%location_label%%0
    (test_crate!rel_init.? (Poly%test_crate!X.State. post!) (I x!) (I y!) (I z!))
 )))
 (get-info :version)
...
(declare-fun req%test_crate!rev_init. (test_crate!X.State. Int Int Int) Bool)
(declare-const %%global_location_label%%1 Bool)
(assert
 (forall ((post! test_crate!X.State.) (x! Int) (y! Int) (z! Int)) (!
   (= (req%test_crate!rev_init. post! x! y! z!) (=>
     %%global_location_label%%1
     (test_crate!rel_init.? (Poly%test_crate!X.State. post!) (I x!) (I y!) (I z!))
   ))
   :pattern ((req%test_crate!rev_init. post! x! y! z!))
   :qid internal_req__test_crate!rev_init._definition
   :skolemid skolem_internal_req__test_crate!rev_init._definition
)))
(declare-fun ens%test_crate!rev_init. (test_crate!X.State. Int Int Int) Bool)
(assert
 (forall ((post! test_crate!X.State.) (x! Int) (y! Int) (z! Int)) (!
   (= (ens%test_crate!rev_init. post! x! y! z!) (test_crate!X.impl&%4.initialize.? (Poly%test_crate!X.State.
      post!
     ) (I x!) (I y!) (I z!)
   ))
   :pattern ((ens%test_crate!rev_init. post! x! y! z!))
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/state_machines-c25f1c939512e7ab-relation_codegen/test.rs:172:7: 172:58 (#0)
(get-info :all-statistics)
(push)
 (declare-const post! test_crate!X.State.)
 (declare-const x! Int)
...
(declare-fun req%test_crate!correct_tr1. (test_crate!X.State. test_crate!X.State. Bool
  Bool
 ) Bool
)
...
(assert
 (forall ((pre! test_crate!X.State.) (post! test_crate!X.State.) (b! Bool) (c! Bool))
  (!
   (= (ens%test_crate!correct_tr1. pre! post! b! c!) (test_crate!rel_tr1.? (Poly%test_crate!X.State.
      pre!
     ) (Poly%test_crate!X.State. post!) (B b!) (B c!)
   ))
   :pattern ((ens%test_crate!correct_tr1. pre! post! b! c!))
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/state_machines-c25f1c939512e7ab-relation_codegen/test.rs:177:7: 177:70 (#0)
(get-info :all-statistics)
(push)
...
(declare-fun req%test_crate!rev_tr1. (test_crate!X.State. test_crate!X.State. Bool
  Bool
 ) Bool
)
...
(assert
 (forall ((pre! test_crate!X.State.) (post! test_crate!X.State.) (b! Bool) (c! Bool))
  (!
   (= (req%test_crate!rev_tr1. pre! post! b! c!) (=>
     %%global_location_label%%3
     (test_crate!rel_tr1.? (Poly%test_crate!X.State. pre!) (Poly%test_crate!X.State. post!)
      (B b!) (B c!)
   )))
   :pattern ((req%test_crate!rev_tr1. pre! post! b! c!))
   :qid internal_req__test_crate!rev_tr1._definition
   :skolemid skolem_internal_req__test_crate!rev_tr1._definition
)))
(declare-fun ens%test_crate!rev_tr1. (test_crate!X.State. test_crate!X.State. Bool
  Bool
 ) Bool
)
(assert
 (forall ((pre! test_crate!X.State.) (post! test_crate!X.State.) (b! Bool) (c! Bool))
  (!
   (= (ens%test_crate!rev_tr1. pre! post! b! c!) (test_crate!X.impl&%4.tr1.? (Poly%test_crate!X.State.
      pre!
     ) (Poly%test_crate!X.State. post!) (B b!) (B c!)
   ))
   :pattern ((ens%test_crate!rev_tr1. pre! post! b! c!))
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/state_machines-c25f1c939512e7ab-relation_codegen/test.rs:182:7: 182:66 (#0)
(get-info :all-statistics)
(push)
 (declare-const pre! test_crate!X.State.)
 (declare-const post! test_crate!X.State.)
...
(assert
 (forall ((pre! test_crate!X.State.) (post! test_crate!X.State.) (b! Bool) (c! Bool))
  (!
   (= (req%test_crate!correct_tr1_strong. pre! post! b! c!) (=>
     %%global_location_label%%4
     (test_crate!X.impl&%4.tr1_strong.? (Poly%test_crate!X.State. pre!) (Poly%test_crate!X.State.
       post!
      ) (B b!) (B c!)
   )))
   :pattern ((req%test_crate!correct_tr1_strong. pre! post! b! c!))
...
(assert
 (forall ((pre! test_crate!X.State.) (post! test_crate!X.State.) (b! Bool) (c! Bool))
  (!
   (= (ens%test_crate!correct_tr1_strong. pre! post! b! c!) (test_crate!rel_tr1_strong.?
     (Poly%test_crate!X.State. pre!) (Poly%test_crate!X.State. post!) (B b!) (B c!)
   ))
   :pattern ((ens%test_crate!correct_tr1_strong. pre! post! b! c!))
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/state_machines-c25f1c939512e7ab-relation_codegen/test.rs:187:7: 187:77 (#0)
(get-info :all-statistics)
(push)
 (declare-const pre! test_crate!X.State.)
 (declare-const post! test_crate!X.State.)
...
(assert
 (forall ((pre! test_crate!X.State.) (post! test_crate!X.State.) (b! Bool) (c! Bool))
  (!
   (= (req%test_crate!rev_tr1_strong. pre! post! b! c!) (=>
     %%global_location_label%%5
     (test_crate!rel_tr1_strong.? (Poly%test_crate!X.State. pre!) (Poly%test_crate!X.State.
       post!
      ) (B b!) (B c!)
   )))
   :pattern ((req%test_crate!rev_tr1_strong. pre! post! b! c!))
...
(assert
 (forall ((pre! test_crate!X.State.) (post! test_crate!X.State.) (b! Bool) (c! Bool))
  (!
   (= (ens%test_crate!rev_tr1_strong. pre! post! b! c!) (test_crate!X.impl&%4.tr1_strong.?
     (Poly%test_crate!X.State. pre!) (Poly%test_crate!X.State. post!) (B b!) (B c!)
   ))
   :pattern ((ens%test_crate!rev_tr1_strong. pre! post! b! c!))
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/state_machines-c25f1c939512e7ab-relation_codegen/test.rs:192:7: 192:73 (#0)
(get-info :all-statistics)
(push)
 (declare-const pre! test_crate!X.State.)
 (declare-const post! test_crate!X.State.)
...
(declare-fun req%test_crate!correct_tr2. (test_crate!X.State. test_crate!X.State. Bool
  Bool
 ) Bool
)
...
(assert
 (forall ((pre! test_crate!X.State.) (post! test_crate!X.State.) (b! Bool) (c! Bool))
  (!
   (= (req%test_crate!correct_tr2. pre! post! b! c!) (=>
     %%global_location_label%%6
     (test_crate!X.impl&%4.tr2.? (Poly%test_crate!X.State. pre!) (Poly%test_crate!X.State.
       post!
      ) (B b!) (B c!)
   )))
   :pattern ((req%test_crate!correct_tr2. pre! post! b! c!))
   :qid internal_req__test_crate!correct_tr2._definition
   :skolemid skolem_internal_req__test_crate!correct_tr2._definition
)))
(declare-fun ens%test_crate!correct_tr2. (test_crate!X.State. test_crate!X.State. Bool
  Bool
 ) Bool
)
(assert
 (forall ((pre! test_crate!X.State.) (post! test_crate!X.State.) (b! Bool) (c! Bool))
  (!
   (= (ens%test_crate!correct_tr2. pre! post! b! c!) (test_crate!rel_tr2.? (Poly%test_crate!X.State.
      pre!
     ) (Poly%test_crate!X.State. post!) (B b!) (B c!)
   ))
   :pattern ((ens%test_crate!correct_tr2. pre! post! b! c!))
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/state_machines-c25f1c939512e7ab-relation_codegen/test.rs:197:7: 197:70 (#0)
(get-info :all-statistics)
(push)
 (declare-const pre! test_crate!X.State.)
 (declare-const post! test_crate!X.State.)
 ...
 (assert
  (not (=>
    %%location_label%%0
    (test_crate!rel_tr2.? (Poly%test_crate!X.State. pre!) (Poly%test_crate!X.State. post!)
     (B b!) (B c!)
 ))))
 (get-info :version)
 (set-option :rlimit 30000000)
...
(declare-fun req%test_crate!rev_tr2. (test_crate!X.State. test_crate!X.State. Bool
  Bool
 ) Bool
)
...
(assert
 (forall ((pre! test_crate!X.State.) (post! test_crate!X.State.) (b! Bool) (c! Bool))
  (!
   (= (req%test_crate!rev_tr2. pre! post! b! c!) (=>
     %%global_location_label%%7
     (test_crate!rel_tr2.? (Poly%test_crate!X.State. pre!) (Poly%test_crate!X.State. post!)
      (B b!) (B c!)
   )))
   :pattern ((req%test_crate!rev_tr2. pre! post! b! c!))
   :qid internal_req__test_crate!rev_tr2._definition
   :skolemid skolem_internal_req__test_crate!rev_tr2._definition
)))
(declare-fun ens%test_crate!rev_tr2. (test_crate!X.State. test_crate!X.State. Bool
  Bool
 ) Bool
)
(assert
 (forall ((pre! test_crate!X.State.) (post! test_crate!X.State.) (b! Bool) (c! Bool))
  (!
   (= (ens%test_crate!rev_tr2. pre! post! b! c!) (test_crate!X.impl&%4.tr2.? (Poly%test_crate!X.State.
      pre!
     ) (Poly%test_crate!X.State. post!) (B b!) (B c!)
   ))
   :pattern ((ens%test_crate!rev_tr2. pre! post! b! c!))
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/state_machines-c25f1c939512e7ab-relation_codegen/test.rs:202:7: 202:66 (#0)
(get-info :all-statistics)
(push)
 (declare-const pre! test_crate!X.State.)
 (declare-const post! test_crate!X.State.)
...
(declare-fun req%test_crate!correct_tr2_strong. (test_crate!X.State. test_crate!X.State.
  Bool Bool
 ) Bool
)
...
(assert
 (forall ((pre! test_crate!X.State.) (post! test_crate!X.State.) (b! Bool) (c! Bool))
  (!
   (= (req%test_crate!correct_tr2_strong. pre! post! b! c!) (=>
     %%global_location_label%%8
     (test_crate!X.impl&%4.tr2_strong.? (Poly%test_crate!X.State. pre!) (Poly%test_crate!X.State.
       post!
      ) (B b!) (B c!)
   )))
   :pattern ((req%test_crate!correct_tr2_strong. pre! post! b! c!))
...
(declare-fun ens%test_crate!correct_tr2_strong. (test_crate!X.State. test_crate!X.State.
  Bool Bool
 ) Bool
)
(assert
 (forall ((pre! test_crate!X.State.) (post! test_crate!X.State.) (b! Bool) (c! Bool))
  (!
   (= (ens%test_crate!correct_tr2_strong. pre! post! b! c!) (test_crate!rel_tr2_strong.?
     (Poly%test_crate!X.State. pre!) (Poly%test_crate!X.State. post!) (B b!) (B c!)
   ))
   :pattern ((ens%test_crate!correct_tr2_strong. pre! post! b! c!))
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/state_machines-c25f1c939512e7ab-relation_codegen/test.rs:207:7: 207:77 (#0)
(get-info :all-statistics)
(push)
 (declare-const pre! test_crate!X.State.)
 (declare-const post! test_crate!X.State.)
 ...
 (assert
  (not (=>
    %%location_label%%0
    (test_crate!rel_tr2_strong.? (Poly%test_crate!X.State. pre!) (Poly%test_crate!X.State.
      post!
     ) (B b!) (B c!)
 ))))
 (get-info :version)
...
(declare-fun req%test_crate!rev_tr2_strong. (test_crate!X.State. test_crate!X.State.
  Bool Bool
 ) Bool
)
...
(assert
 (forall ((pre! test_crate!X.State.) (post! test_crate!X.State.) (b! Bool) (c! Bool))
  (!
   (= (req%test_crate!rev_tr2_strong. pre! post! b! c!) (=>
     %%global_location_label%%9
     (test_crate!rel_tr2_strong.? (Poly%test_crate!X.State. pre!) (Poly%test_crate!X.State.
       post!
      ) (B b!) (B c!)
   )))
   :pattern ((req%test_crate!rev_tr2_strong. pre! post! b! c!))
...
(declare-fun ens%test_crate!rev_tr2_strong. (test_crate!X.State. test_crate!X.State.
  Bool Bool
 ) Bool
)
(assert
 (forall ((pre! test_crate!X.State.) (post! test_crate!X.State.) (b! Bool) (c! Bool))
  (!
   (= (ens%test_crate!rev_tr2_strong. pre! post! b! c!) (test_crate!X.impl&%4.tr2_strong.?
     (Poly%test_crate!X.State. pre!) (Poly%test_crate!X.State. post!) (B b!) (B c!)
   ))
   :pattern ((ens%test_crate!rev_tr2_strong. pre! post! b! c!))
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/state_machines-c25f1c939512e7ab-relation_codegen/test.rs:212:7: 212:73 (#0)
(get-info :all-statistics)
(push)
 (declare-const pre! test_crate!X.State.)
 (declare-const post! test_crate!X.State.)
...
(declare-fun req%test_crate!correct_tr3. (test_crate!X.State. test_crate!X.State. Bool
  Bool
 ) Bool
)
...
(assert
 (forall ((pre! test_crate!X.State.) (post! test_crate!X.State.) (b! Bool) (c! Bool))
  (!
   (= (req%test_crate!correct_tr3. pre! post! b! c!) (=>
     %%global_location_label%%10
     (test_crate!X.impl&%4.tr3.? (Poly%test_crate!X.State. pre!) (Poly%test_crate!X.State.
       post!
      ) (B b!) (B c!)
   )))
   :pattern ((req%test_crate!correct_tr3. pre! post! b! c!))
   :qid internal_req__test_crate!correct_tr3._definition
   :skolemid skolem_internal_req__test_crate!correct_tr3._definition
)))
(declare-fun ens%test_crate!correct_tr3. (test_crate!X.State. test_crate!X.State. Bool
  Bool
 ) Bool
)
(assert
 (forall ((pre! test_crate!X.State.) (post! test_crate!X.State.) (b! Bool) (c! Bool))
  (!
   (= (ens%test_crate!correct_tr3. pre! post! b! c!) (test_crate!rel_tr3.? (Poly%test_crate!X.State.
      pre!
     ) (Poly%test_crate!X.State. post!) (B b!) (B c!)
   ))
   :pattern ((ens%test_crate!correct_tr3. pre! post! b! c!))
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/state_machines-c25f1c939512e7ab-relation_codegen/test.rs:217:7: 217:70 (#0)
(get-info :all-statistics)
(push)
 (declare-const pre! test_crate!X.State.)
 (declare-const post! test_crate!X.State.)
 ...
 (assert
  (not (=>
    %%location_label%%0
    (test_crate!rel_tr3.? (Poly%test_crate!X.State. pre!) (Poly%test_crate!X.State. post!)
     (B b!) (B c!)
 ))))
 (get-info :version)
 (set-option :rlimit 30000000)
...
(declare-fun req%test_crate!rev_tr3. (test_crate!X.State. test_crate!X.State. Bool
  Bool
 ) Bool
)
...
(assert
 (forall ((pre! test_crate!X.State.) (post! test_crate!X.State.) (b! Bool) (c! Bool))
  (!
   (= (req%test_crate!rev_tr3. pre! post! b! c!) (=>
     %%global_location_label%%11
     (test_crate!rel_tr3.? (Poly%test_crate!X.State. pre!) (Poly%test_crate!X.State. post!)
      (B b!) (B c!)
   )))
   :pattern ((req%test_crate!rev_tr3. pre! post! b! c!))
   :qid internal_req__test_crate!rev_tr3._definition
   :skolemid skolem_internal_req__test_crate!rev_tr3._definition
)))
(declare-fun ens%test_crate!rev_tr3. (test_crate!X.State. test_crate!X.State. Bool
  Bool
 ) Bool
)
(assert
 (forall ((pre! test_crate!X.State.) (post! test_crate!X.State.) (b! Bool) (c! Bool))
  (!
   (= (ens%test_crate!rev_tr3. pre! post! b! c!) (test_crate!X.impl&%4.tr3.? (Poly%test_crate!X.State.
      pre!
     ) (Poly%test_crate!X.State. post!) (B b!) (B c!)
   ))
   :pattern ((ens%test_crate!rev_tr3. pre! post! b! c!))
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/state_machines-c25f1c939512e7ab-relation_codegen/test.rs:222:7: 222:66 (#0)
(get-info :all-statistics)
(push)
 (declare-const pre! test_crate!X.State.)
 (declare-const post! test_crate!X.State.)
...
(declare-fun req%test_crate!correct_tr3_strong. (test_crate!X.State. test_crate!X.State.
  Bool Bool
 ) Bool
)
...
(assert
 (forall ((pre! test_crate!X.State.) (post! test_crate!X.State.) (b! Bool) (c! Bool))
  (!
   (= (req%test_crate!correct_tr3_strong. pre! post! b! c!) (=>
     %%global_location_label%%12
     (test_crate!X.impl&%4.tr3_strong.? (Poly%test_crate!X.State. pre!) (Poly%test_crate!X.State.
       post!
      ) (B b!) (B c!)
   )))
   :pattern ((req%test_crate!correct_tr3_strong. pre! post! b! c!))
...
(declare-fun ens%test_crate!correct_tr3_strong. (test_crate!X.State. test_crate!X.State.
  Bool Bool
 ) Bool
)
(assert
 (forall ((pre! test_crate!X.State.) (post! test_crate!X.State.) (b! Bool) (c! Bool))
  (!
   (= (ens%test_crate!correct_tr3_strong. pre! post! b! c!) (test_crate!rel_tr3_strong.?
     (Poly%test_crate!X.State. pre!) (Poly%test_crate!X.State. post!) (B b!) (B c!)
   ))
   :pattern ((ens%test_crate!correct_tr3_strong. pre! post! b! c!))
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/state_machines-c25f1c939512e7ab-relation_codegen/test.rs:227:7: 227:77 (#0)
(get-info :all-statistics)
(push)
 (declare-const pre! test_crate!X.State.)
 (declare-const post! test_crate!X.State.)
 ...
 (assert
  (not (=>
    %%location_label%%0
    (test_crate!rel_tr3_strong.? (Poly%test_crate!X.State. pre!) (Poly%test_crate!X.State.
      post!
     ) (B b!) (B c!)
 ))))
 (get-info :version)
...
(declare-fun req%test_crate!rev_tr3_strong. (test_crate!X.State. test_crate!X.State.
  Bool Bool
 ) Bool
)
...
(assert
 (forall ((pre! test_crate!X.State.) (post! test_crate!X.State.) (b! Bool) (c! Bool))
  (!
   (= (req%test_crate!rev_tr3_strong. pre! post! b! c!) (=>
     %%global_location_label%%13
     (test_crate!rel_tr3_strong.? (Poly%test_crate!X.State. pre!) (Poly%test_crate!X.State.
       post!
      ) (B b!) (B c!)
   )))
   :pattern ((req%test_crate!rev_tr3_strong. pre! post! b! c!))
...
(declare-fun ens%test_crate!rev_tr3_strong. (test_crate!X.State. test_crate!X.State.
  Bool Bool
 ) Bool
)
(assert
 (forall ((pre! test_crate!X.State.) (post! test_crate!X.State.) (b! Bool) (c! Bool))
  (!
   (= (ens%test_crate!rev_tr3_strong. pre! post! b! c!) (test_crate!X.impl&%4.tr3_strong.?
     (Poly%test_crate!X.State. pre!) (Poly%test_crate!X.State. post!) (B b!) (B c!)
   ))
   :pattern ((ens%test_crate!rev_tr3_strong. pre! post! b! c!))
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/state_machines-c25f1c939512e7ab-relation_codegen/test.rs:232:7: 232:73 (#0)
(get-info :all-statistics)
(push)
 (declare-const pre! test_crate!X.State.)
 (declare-const post! test_crate!X.State.)
