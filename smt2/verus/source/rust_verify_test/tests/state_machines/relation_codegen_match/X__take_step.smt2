...
(assert
 (distinct fuel%test_crate!X.impl&%4.initialize. fuel%test_crate!X.impl&%4.initialize_enabled.
  fuel%test_crate!X.impl&%4.tr1_strong. fuel%test_crate!X.impl&%4.tr1_enabled. fuel%test_crate!X.impl&%4.invariant.
...
;; Datatypes
(declare-datatypes ((test_crate!X.State. 0) (test_crate!Foo. 0)) (((test_crate!X.State./State
...
(declare-fun req%test_crate!X.take_step.initialize. (Int Int Int test_crate!Foo.)
 Bool
)
(declare-const %%global_location_label%%0 Bool)
(assert
 (forall ((x! Int) (y! Int) (z! Int) (foo! test_crate!Foo.)) (!
   (= (req%test_crate!X.take_step.initialize. x! y! z! foo!) (=>
     %%global_location_label%%0
     (test_crate!X.impl&%4.initialize_enabled.? (I x!) (I y!) (I z!) (Poly%test_crate!Foo.
       foo!
   ))))
   :pattern ((req%test_crate!X.take_step.initialize. x! y! z! foo!))
...
(declare-fun ens%test_crate!X.take_step.initialize. (Int Int Int test_crate!Foo. test_crate!X.State.)
 Bool
)
(assert
 (forall ((x! Int) (y! Int) (z! Int) (foo! test_crate!Foo.) (post! test_crate!X.State.))
  (!
   (= (ens%test_crate!X.take_step.initialize. x! y! z! foo! post!) (and
   ...
   :pattern ((ens%test_crate!X.take_step.initialize. x! y! z! foo! post!))
...
(declare-fun req%test_crate!X.take_step.tr1. (test_crate!X.State. test_crate!Foo. Bool)
 Bool
)
(declare-const %%global_location_label%%1 Bool)
(assert
 (forall ((pre! test_crate!X.State.) (foo! test_crate!Foo.) (c! Bool)) (!
   (= (req%test_crate!X.take_step.tr1. pre! foo! c!) (=>
     %%global_location_label%%1
     (and
      (test_crate!X.impl&%4.tr1_enabled.? (Poly%test_crate!X.State. pre!) (Poly%test_crate!Foo.
        foo!
       ) (B c!)
      )
      (test_crate!X.impl&%4.invariant.? (Poly%test_crate!X.State. pre!))
   )))
   :pattern ((req%test_crate!X.take_step.tr1. pre! foo! c!))
...
(declare-fun ens%test_crate!X.take_step.tr1. (test_crate!X.State. test_crate!Foo. Bool
  test_crate!X.State.
 ) Bool
)
(assert
 (forall ((pre! test_crate!X.State.) (foo! test_crate!Foo.) (c! Bool) (post! test_crate!X.State.))
  (!
   (= (ens%test_crate!X.take_step.tr1. pre! foo! c! post!) (and
   ...
   :pattern ((ens%test_crate!X.take_step.tr1. pre! foo! c! post!))
