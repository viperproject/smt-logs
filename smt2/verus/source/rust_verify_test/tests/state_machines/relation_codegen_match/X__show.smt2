...
(assert
 (distinct fuel%test_crate!X.impl&%4.initialize. fuel%test_crate!X.impl&%4.tr1. fuel%vstd!array.group_array_axioms.
...
(declare-fun req%test_crate!X.show.tr1. (test_crate!X.State. test_crate!X.State. test_crate!Foo.
  Bool
 ) Bool
)
...
(assert
 (forall ((pre! test_crate!X.State.) (post! test_crate!X.State.) (foo! test_crate!Foo.)
   ...
   (= (ens%test_crate!X.show.tr1. pre! post! foo! c!) (test_crate!X.impl&%4.next.? (Poly%test_crate!X.State.
      pre!
     ) (Poly%test_crate!X.State. post!)
   ))
   :pattern ((ens%test_crate!X.show.tr1. pre! post! foo! c!))
...
(declare-fun req%test_crate!X.show.initialize. (test_crate!X.State. Int Int Int test_crate!Foo.)
 Bool
)
...
(assert
 (forall ((post! test_crate!X.State.) (x! Int) (y! Int) (z! Int) (foo! test_crate!Foo.))
  (!
   (= (req%test_crate!X.show.initialize. post! x! y! z! foo!) (=>
     %%global_location_label%%1
     (test_crate!X.impl&%4.initialize.? (Poly%test_crate!X.State. post!) (I x!) (I y!)
      (I z!) (Poly%test_crate!Foo. foo!)
   )))
   :pattern ((req%test_crate!X.show.initialize. post! x! y! z! foo!))
...
(declare-fun ens%test_crate!X.show.initialize. (test_crate!X.State. Int Int Int test_crate!Foo.)
 Bool
)
(assert
 (forall ((post! test_crate!X.State.) (x! Int) (y! Int) (z! Int) (foo! test_crate!Foo.))
  (!
   (= (ens%test_crate!X.show.initialize. post! x! y! z! foo!) (test_crate!X.impl&%4.init.?
     (Poly%test_crate!X.State. post!)
   ))
   :pattern ((ens%test_crate!X.show.initialize. post! x! y! z! foo!))
