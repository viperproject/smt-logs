...
(assert
 (distinct fuel%vstd!std_specs.option.impl&%0.is_Some. fuel%vstd!std_specs.option.impl&%0.get_Some_0.
  ...
  fuel%vstd!set.axiom_set_insert_finite. fuel%test_crate!X.impl&%0.arrow_0. fuel%test_crate!X.impl&%0.arrow_dummy_to_use_type_params_0.
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type)) (!
    ...
    :qid user_vstd__set__axiom_set_empty_finite_23
    :skolemid skolem_user_vstd__set__axiom_set_empty_finite_23
))))
...
;; Function-Specs vstd::state_machine_internal::assert_general_guard_map
 ...
 (=>
  ...
  (forall ((K&. Dcr) (K& Type) (V&. Dcr) (V& Type) (self! Poly) (m2! Poly)) (!
    (= (vstd!map_lib.impl&%0.submap_of.? K&. K& V&. V& self! m2!) (forall ((k$ Poly)) (
       ...
       :qid user_vstd__map_lib__impl&%0__submap_of_25
       :skolemid skolem_user_vstd__map_lib__impl&%0__submap_of_25
    )))
 ...
 (=>
  ...
  (forall ((pre! Poly) (post! Poly)) (!
    (= (test_crate!X.impl&%7.next.? pre! post!) (exists ((step$ Poly)) (!
       ...
       :pattern ((test_crate!X.impl&%7.next_by.? pre! post! step$))
       :qid user_test_crate__X__State__next_26
       :skolemid skolem_user_test_crate__X__State__next_26
    )))
 ...
 (=>
  ...
  (forall ((pre! Poly) (post! Poly)) (!
    (= (test_crate!X.impl&%7.next_strong.? pre! post!) (exists ((step$ Poly)) (!
       ...
       :pattern ((test_crate!X.impl&%7.next_strong_by.? pre! post! step$))
       :qid user_test_crate__X__State__next_strong_27
       :skolemid skolem_user_test_crate__X__State__next_strong_27
    )))
 ...
 (=>
  ...
  (forall ((post! Poly)) (!
    (= (test_crate!X.impl&%7.init.? post!) (exists ((step$ Poly)) (!
       ...
       :pattern ((test_crate!X.impl&%7.init_by.? post! step$))
       :qid user_test_crate__X__State__init_28
       :skolemid skolem_user_test_crate__X__State__init_28
    )))
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/state_machines-c25f1c939512e7ab-inherent_safety_condition_map_general_guard/test.rs:35:1: 56:3 (#42)
 ...
 (assert
  (not (=>
    ...
    (=>
     ...
     (and
      (=>
       (= tmp%1 (vstd!map_lib.impl&%0.submap_of.? $ INT $ INT (vstd!map.impl&%0.insert.? $
       ...
       (and
        (=>
         %%location_label%%0
         (req%vstd!state_machine_internal.assert_general_guard_map. tmp%1)
        )
        (=>
         (ens%vstd!state_machine_internal.assert_general_guard_map. tmp%1)
         (=>
          %%location_label%%1
          (vstd!map_lib.impl&%0.submap_of.? $ INT $ INT (vstd!map.impl&%0.insert.? $ INT $ INT
            (vstd!map.impl&%0.empty.? $ INT $ INT) (I 5) (I 7)
           ) (Poly%vstd!map.Map<int./int.>. update_tmp_t@)
      )))))
      (=>
       (vstd!map_lib.impl&%0.submap_of.? $ INT $ INT (vstd!map.impl&%0.insert.? $ INT $ INT
       ...
       (=>
        ...
        (and
         (=>
          (= tmp%2 (vstd!set.impl&%0.contains.? $ INT (vstd!map.impl&%0.dom.? $ INT $ INT (vstd!map.impl&%0.insert.?
              $ INT $ INT (vstd!map.impl&%0.empty.? $ INT $ INT) (I 5) (I 7)
             )
            ) (I 5)
          ))
          (and
           ...
           (=>
            tmp%2
            (=>
             (= tmp%3 (= (%I (vstd!map.impl&%0.index.? $ INT $ INT (vstd!map.impl&%0.insert.? $ INT
                  $ INT (vstd!map.impl&%0.empty.? $ INT $ INT) (I 5) (I 7)
                 ) (I 5)
                )
               ) 7
             ))
             (and
              ...
              (=>
               tmp%3
               (=>
                (= tmp%4 (vstd!set.impl&%0.contains.? $ INT (vstd!map.impl&%0.dom.? $ INT $ INT (Poly%vstd!map.Map<int./int.>.
                    t@
                   )
                  ) (I 5)
                ))
                (and
                 (=>
                  %%location_label%%4
                  (req%vstd!state_machine_internal.assert_safety. tmp%4)
                 )
                 (=>
                  (ens%vstd!state_machine_internal.assert_safety. tmp%4)
                  (=>
                   %%location_label%%5
         ...
         (=>
          ...
          (=>
           (= tmp%5 (vstd!set.impl&%0.contains.? $ INT (vstd!map.impl&%0.dom.? $ INT $ INT (vstd!map.impl&%0.insert.?
               $ INT $ INT (vstd!map.impl&%0.empty.? $ INT $ INT) (I 5) (I 7)
              )
             ) (I 5)
           ))
           (and
            ...
            (=>
             tmp%5
             (=>
              (= tmp%6 (= (%I (vstd!map.impl&%0.index.? $ INT $ INT (vstd!map.impl&%0.insert.? $ INT
                   $ INT (vstd!map.impl&%0.empty.? $ INT $ INT) (I 5) (I 7)
                  ) (I 5)
                 )
                ) 7
              ...
              (and
               ...
               (=>
                tmp%6
                (=>
                 (= tmp%7 (= (%I (vstd!map.impl&%0.index.? $ INT $ INT (Poly%vstd!map.Map<int./int.>. t@)
                     (I 5)
                    )
                   ) 7
                 ))
                 (and
                  (=>
                   %%location_label%%8
                   (req%vstd!state_machine_internal.assert_safety. tmp%7)
                  )
                  (=>
                   (ens%vstd!state_machine_internal.assert_safety. tmp%7)
                   (=>
                    %%location_label%%9
    ...
    (=>
     ...
     (=>
      ...
      (=>
       ...
       (and
        (=>
         (vstd!set.impl&%0.contains.? $ INT (vstd!map.impl&%0.dom.? $ INT $ INT (vstd!map.impl&%0.insert.?
            $ INT $ INT (vstd!map.impl&%0.empty.? $ INT $ INT) (I 5) (I 7)
           )
          ) (I 5)
         )
         (=>
          (= tmp%3 (vstd!map.impl&%0.insert.? $ INT $ INT (vstd!map.impl&%0.empty.? $ INT $ INT)
            (I 5) (I 7)
          ))
          (=>
           %%location_label%%0
           (req%vstd!map.impl&%0.index. $ INT $ INT tmp%3 (I 5))
        )))
        (=>
         (vstd!set.impl&%0.contains.? $ INT (vstd!map.impl&%0.dom.? $ INT $ INT (Poly%vstd!map.Map<int./int.>.
            t@
         ...
         (=>
          ...
          (=>
           (= tmp%6 (vstd!map.impl&%0.insert.? $ INT $ INT (vstd!map.impl&%0.empty.? $ INT $ INT)
             (I 5) (I 7)
           ))
           (and
            (=>
             %%location_label%%1
             (req%vstd!map.impl&%0.index. $ INT $ INT tmp%6 (I 5))
            )
            (=>
             (= tmp%5 (vstd!map.impl&%0.index.? $ INT $ INT (vstd!map.impl&%0.insert.? $ INT $ INT
                (vstd!map.impl&%0.empty.? $ INT $ INT) (I 5) (I 7)
               ) (I 5)
             ))
             (=>
              ...
              (and
               ...
               (=>
                (= tmp%7 (vstd!map.impl&%0.index.? $ INT $ INT (Poly%vstd!map.Map<int./int.>. t@) (
                   I 5
                )))
                (=>
                 (= tmp%8 (= (%I tmp%7) 7))
 ...
 (forall ((self! test_crate!X.Instance.) (tmp_tuple! tuple%2.)) (!
   (= (ens%test_crate!X.impl&%4.tr. self! tmp_tuple!) (and
     (has_type (Poly%tuple%2. tmp_tuple!) (TYPE%tuple%2. (GHOST $) (TYPE%vstd!map.Map. $
        INT $ INT
       ) (TRACKED (REF $)) (TYPE%vstd!map.Map. $ INT $ INT)
     ))
     (let
      ...
      (let
       ((param_token_0_t$ (%Poly%vstd!map.Map<int./int.>. (tuple%2./tuple%2/1 (%Poly%tuple%2.
            (Poly%tuple%2. tmp_tuple!)
       )))))
       (let
        ...
        (let
         ...
         (and
          (and
           (= param_token_0_t$1 (%Poly%vstd!map.Map<int./int.>. (vstd!map.impl&%0.insert.? $ INT
              $ INT (vstd!map.impl&%0.empty.? $ INT $ INT) (I 5) (I 7)
           )))
           (let
