...
(declare-fun test_crate!Example.impl&%5.init.? (Poly Poly) Bool)
...
;; Function-Specs test_crate::Example::show::g
(declare-fun req%test_crate!Example.show.g. (test_crate!Example.State. test_crate!Example.InitLabel.)
 Bool
)
(declare-const %%global_location_label%%0 Bool)
(assert
 (forall ((post! test_crate!Example.State.) (l! test_crate!Example.InitLabel.)) (!
   (= (req%test_crate!Example.show.g. post! l!) (=>
     %%global_location_label%%0
     (test_crate!Example.impl&%5.g.? (Poly%test_crate!Example.State. post!) (Poly%test_crate!Example.InitLabel.
       l!
   ))))
   :pattern ((req%test_crate!Example.show.g. post! l!))
   :qid internal_req__test_crate!Example.show.g._definition
   :skolemid skolem_internal_req__test_crate!Example.show.g._definition
)))
(declare-fun ens%test_crate!Example.show.g. (test_crate!Example.State. test_crate!Example.InitLabel.)
 Bool
)
(assert
 (forall ((post! test_crate!Example.State.) (l! test_crate!Example.InitLabel.)) (!
   (= (ens%test_crate!Example.show.g. post! l!) (test_crate!Example.impl&%5.init.? (Poly%test_crate!Example.State.
      post!
     ) (Poly%test_crate!Example.InitLabel. l!)
   ))
   :pattern ((ens%test_crate!Example.show.g. post! l!))
   :qid internal_ens__test_crate!Example.show.g._definition
   :skolemid skolem_internal_ens__test_crate!Example.show.g._definition
)))
