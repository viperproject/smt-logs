...
(declare-const fuel%test_crate!X.impl&%10.inv. FuelId)
...
(assert
 (distinct fuel%test_crate!X.impl&%10.initialize. fuel%test_crate!X.impl&%10.initialize_enabled.
  fuel%test_crate!X.impl&%10.tr_strong. fuel%test_crate!X.impl&%10.tr_enabled. fuel%test_crate!X.impl&%10.invariant.
  fuel%test_crate!X.impl&%10.inv. fuel%vstd!array.group_array_axioms. fuel%vstd!map.group_map_axioms.
...
;; Datatypes
(declare-datatypes ((test_crate!X.State. 0) (tuple%2. 0)) (((test_crate!X.State./State
    (test_crate!X.State./State/?t tuple%2.)
   )
  ) ((tuple%2./tuple%2 (tuple%2./tuple%2/?0 Poly) (tuple%2./tuple%2/?1 Poly)))
))
(declare-fun test_crate!X.State./State/t (test_crate!X.State.) tuple%2.)
...
(assert
 (forall ((_t! tuple%2.)) (!
   (=>
    (has_type (Poly%tuple%2. _t!) (TYPE%tuple%2. $ INT $ INT))
...
(assert
 (forall ((x Poly)) (!
   (=>
    (has_type x TYPE%test_crate!X.State.)
    (has_type (Poly%tuple%2. (test_crate!X.State./State/t (%Poly%test_crate!X.State. x)))
...
(declare-fun test_crate!X.impl&%10.initialize.? (Poly) Bool)

;; Function-Decl test_crate::X::State::inv
(declare-fun test_crate!X.impl&%10.inv.? (Poly) Bool)

;; Function-Decl test_crate::X::State::initialize_enabled
(declare-fun test_crate!X.impl&%10.initialize_enabled.? (Poly) Bool)
...
(assert
 (=>
  ...
  (forall ((post! Poly)) (!
    (= (test_crate!X.impl&%10.initialize.? post!) (let
      ((update_tmp_t$ (tuple%2./tuple%2 (I 2) (I 2))))
      (= (test_crate!X.State./State/t (%Poly%test_crate!X.State. post!)) update_tmp_t$)
    ))
    :pattern ((test_crate!X.impl&%10.initialize.? post!))
...
;; Function-Axioms test_crate::X::State::inv
(assert
 (fuel_bool_default fuel%test_crate!X.impl&%10.inv.)
)
(assert
 (=>
  (fuel_bool fuel%test_crate!X.impl&%10.inv.)
  (forall ((self! Poly)) (!
    (= (test_crate!X.impl&%10.inv.? self!) (= (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2.
         (test_crate!X.State./State/t (%Poly%test_crate!X.State. self!))
       ))
      ) (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. (test_crate!X.State./State/t (%Poly%test_crate!X.State.
           self!
    )))))))
    :pattern ((test_crate!X.impl&%10.inv.? self!))
    :qid internal_test_crate!X.impl&__10.inv.?_definition
    :skolemid skolem_internal_test_crate!X.impl&__10.inv.?_definition
))))
...
(assert
 (=>
  ...
  (forall ((no%param Poly)) (!
    (= (test_crate!X.impl&%10.initialize_enabled.? no%param) true)
    :pattern ((test_crate!X.impl&%10.initialize_enabled.? no%param))
 ...
 (=>
  ...
  (forall ((pre! Poly) (post! Poly)) (!
    (= (test_crate!X.impl&%10.tr_strong.? pre! post!) (let
      ((tmp%%$ (test_crate!X.State./State/t (%Poly%test_crate!X.State. pre!))))
      (let
       ((a$ (%I (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. tmp%%$))))))
       (let
        ((b$ (%I (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. tmp%%$))))))
        (let
         ((update_tmp_t$ (tuple%2./tuple%2 (I (Add a$ 1)) (I (Add b$ 1)))))
         (= (test_crate!X.State./State/t (%Poly%test_crate!X.State. post!)) update_tmp_t$)
    )))))
...
(assert
 (=>
  ...
  (forall ((self! Poly)) (!
    (= (test_crate!X.impl&%10.invariant.? self!) (test_crate!X.impl&%10.inv.? self!))
...
(assert
 (forall ((no%param Int)) (!
   (= (req%test_crate!X.take_step.initialize. no%param) (=>
     ...
     (test_crate!X.impl&%10.initialize_enabled.? (I 0))
   ))
...
(assert
 (forall ((no%param Int) (post! test_crate!X.State.)) (!
   (= (ens%test_crate!X.take_step.initialize. no%param post!) (and
     (has_type (Poly%test_crate!X.State. post!) TYPE%test_crate!X.State.)
     (and
      (test_crate!X.impl&%10.initialize.? (Poly%test_crate!X.State. post!))
