...
(assert
 (distinct fuel%test_crate!X.impl&%10.initialize. fuel%test_crate!X.impl&%10.tr. fuel%vstd!array.group_array_axioms.
...
(assert
 (forall ((post! test_crate!X.State.)) (!
   (= (ens%test_crate!X.show.initialize. post!) (test_crate!X.impl&%10.init.? (Poly%test_crate!X.State.
      post!
   )))
