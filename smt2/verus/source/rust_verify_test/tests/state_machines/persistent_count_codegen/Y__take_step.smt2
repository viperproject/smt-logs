...
(assert
 (distinct fuel%vstd!state_machine_internal.nat_max. fuel%test_crate!Y.impl&%11.initialize.
  fuel%test_crate!Y.impl&%11.initialize_enabled. fuel%test_crate!Y.impl&%11.tr_add_strong.
  fuel%test_crate!Y.impl&%11.tr_add_enabled. fuel%test_crate!Y.impl&%11.tr_have_strong.
  fuel%test_crate!Y.impl&%11.tr_have_enabled. fuel%test_crate!Y.impl&%11.invariant.
...
;; Datatypes
(declare-datatypes ((test_crate!Y.State. 0)) (((test_crate!Y.State./State (test_crate!Y.State./State/?c
     Int
)))))
