...
(assert
 (distinct fuel%vstd!state_machine_internal.nat_max. fuel%test_crate!Y.impl&%11.initialize.
  fuel%test_crate!Y.impl&%11.tr_add. fuel%test_crate!Y.impl&%11.tr_have. fuel%vstd!array.group_array_axioms.
...
(declare-datatypes ((test_crate!Y.State. 0) (tuple%0. 0)) (((test_crate!Y.State./State
    (test_crate!Y.State./State/?c Int)
   )
  ) ((tuple%0./tuple%0))
))
