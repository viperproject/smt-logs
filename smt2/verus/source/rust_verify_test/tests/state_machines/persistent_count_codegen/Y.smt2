...
(assert
 (distinct fuel%vstd!std_specs.option.impl&%0.is_Some. fuel%vstd!std_specs.option.impl&%0.get_Some_0.
  ...
  fuel%vstd!state_machine_internal.nat_max. fuel%test_crate!Y.impl&%0.arrow_0. fuel%test_crate!Y.impl&%0.arrow_dummy_to_use_type_params_0.
  fuel%test_crate!Y.impl&%1.is_tr_add. fuel%test_crate!Y.impl&%1.is_tr_have. fuel%test_crate!Y.impl&%1.is_dummy_to_use_type_params.
  ...
  fuel%test_crate!Y.impl&%11.tr_add. fuel%test_crate!Y.impl&%11.tr_add_strong. fuel%test_crate!Y.impl&%11.tr_add_enabled.
  fuel%test_crate!Y.impl&%11.tr_have. fuel%test_crate!Y.impl&%11.tr_have_strong. fuel%test_crate!Y.impl&%11.tr_have_enabled.
...
(declare-datatypes ((core!option.Option. 0) (vstd!tokens.InstanceId. 0) (test_crate!Y.State.
  ...
  ((test_crate!Y.State./State (test_crate!Y.State./State/?c Int))) ((test_crate!Y.Step./tr_add)
   (test_crate!Y.Step./tr_have) (test_crate!Y.Step./dummy_to_use_type_params (test_crate!Y.Step./dummy_to_use_type_params/?0
     test_crate!Y.State.
   ))
...
(assert
 (has_type (Poly%test_crate!Y.Step. test_crate!Y.Step./tr_add) TYPE%test_crate!Y.Step.)
)
(assert
 (has_type (Poly%test_crate!Y.Step. test_crate!Y.Step./tr_have) TYPE%test_crate!Y.Step.)
)
(assert
...
;; Function-Specs vstd::tokens::MonotonicCountToken::arbitrary
 ...
 (=>
  ...
  (forall ((pre! Poly) (post! Poly) (step! Poly)) (!
    (= (test_crate!Y.impl&%11.next_by.? pre! post! step!) (ite
      ...
      (test_crate!Y.impl&%11.tr_add.? pre! post!)
      (and
       (is-test_crate!Y.Step./tr_have (%Poly%test_crate!Y.Step. step!))
       (test_crate!Y.impl&%11.tr_have.? pre! post!)
    )))
...
(assert
 (forall ((self! test_crate!Y.Instance.) (param_token_0_c! test_crate!Y.c.)) (!
   (= (ens%test_crate!Y.impl&%8.tr_add. self! param_token_0_c!) (and
     (has_type (Poly%test_crate!Y.c. param_token_0_c!) TYPE%test_crate!Y.c.)
     (= (%Poly%vstd!tokens.InstanceId. (vstd!tokens.MonotonicCountToken.instance_id.? $ TYPE%test_crate!Y.c.
 ...
 (=>
  ...
  (forall ((pre! Poly) (post! Poly) (step! Poly)) (!
    (= (test_crate!Y.impl&%11.next_strong_by.? pre! post! step!) (ite
      (is-test_crate!Y.Step./tr_add (%Poly%test_crate!Y.Step. step!))
      (test_crate!Y.impl&%11.tr_add_strong.? pre! post!)
      (and
       (is-test_crate!Y.Step./tr_have (%Poly%test_crate!Y.Step. step!))
       (test_crate!Y.impl&%11.tr_have_strong.? pre! post!)
    )))
