...
(assert
 (distinct fuel%vstd!std_specs.option.impl&%0.is_Some. fuel%vstd!std_specs.option.impl&%0.get_Some_0.
  ...
  fuel%vstd!set.axiom_set_empty_finite. fuel%vstd!set.axiom_set_insert_finite. fuel%test_crate!X.impl&%0.arrow_0.
...
(declare-sort vstd!tokens.MapToken<int./int./test_crate!X.t.>. 0)
...
(declare-fun Poly%vstd!tokens.MapToken<int./int./test_crate!X.t.>. (vstd!tokens.MapToken<int./int./test_crate!X.t.>.)
 Poly
)
(declare-fun %Poly%vstd!tokens.MapToken<int./int./test_crate!X.t.>. (Poly) vstd!tokens.MapToken<int./int./test_crate!X.t.>.)
...
(assert
 (forall ((x vstd!tokens.MapToken<int./int./test_crate!X.t.>.)) (!
   (= x (%Poly%vstd!tokens.MapToken<int./int./test_crate!X.t.>. (Poly%vstd!tokens.MapToken<int./int./test_crate!X.t.>.
      x
   )))
   :pattern ((Poly%vstd!tokens.MapToken<int./int./test_crate!X.t.>. x))
   :qid internal_vstd__tokens__MapToken<int./int./test_crate!X.t.>_box_axiom_definition
   :skolemid skolem_internal_vstd__tokens__MapToken<int./int./test_crate!X.t.>_box_axiom_definition
)))
(assert
 (forall ((x Poly)) (!
   (=>
    (has_type x (TYPE%vstd!tokens.MapToken. $ INT $ INT $ TYPE%test_crate!X.t.))
    (= x (Poly%vstd!tokens.MapToken<int./int./test_crate!X.t.>. (%Poly%vstd!tokens.MapToken<int./int./test_crate!X.t.>.
       x
   ))))
   :pattern ((has_type x (TYPE%vstd!tokens.MapToken. $ INT $ INT $ TYPE%test_crate!X.t.)))
   :qid internal_vstd__tokens__MapToken<int./int./test_crate!X.t.>_unbox_axiom_definition
   :skolemid skolem_internal_vstd__tokens__MapToken<int./int./test_crate!X.t.>_unbox_axiom_definition
)))
(assert
 (forall ((x vstd!tokens.MapToken<int./int./test_crate!X.t.>.)) (!
   (has_type (Poly%vstd!tokens.MapToken<int./int./test_crate!X.t.>. x) (TYPE%vstd!tokens.MapToken.
     $ INT $ INT $ TYPE%test_crate!X.t.
   ))
   :pattern ((has_type (Poly%vstd!tokens.MapToken<int./int./test_crate!X.t.>. x) (TYPE%vstd!tokens.MapToken.
      $ INT $ INT $ TYPE%test_crate!X.t.
   )))
   :qid internal_vstd__tokens__MapToken<int./int./test_crate!X.t.>_has_type_always_definition
   :skolemid skolem_internal_vstd__tokens__MapToken<int./int./test_crate!X.t.>_has_type_always_definition
)))
(assert
 ...
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (self! Poly) (s2! Poly)) (!
    (= (vstd!set.impl&%0.disjoint.? A&. A& self! s2!) (forall ((a$ Poly)) (!
       ...
       :pattern ((vstd!set.impl&%0.contains.? A&. A& s2! a$))
       :qid user_vstd__set__impl&%0__disjoint_28
       :skolemid skolem_user_vstd__set__impl&%0__disjoint_28
    )))
 ...
 (=>
  ...
  (forall ((pre! Poly) (post! Poly)) (!
    (= (test_crate!X.impl&%10.next.? pre! post!) (exists ((step$ Poly)) (!
       ...
       :pattern ((test_crate!X.impl&%10.next_by.? pre! post! step$))
       :qid user_test_crate__X__State__next_29
       :skolemid skolem_user_test_crate__X__State__next_29
    )))
 ...
 (=>
  ...
  (forall ((post! Poly)) (!
    (= (test_crate!X.impl&%10.init.? post!) (exists ((step$ Poly)) (!
       ...
       :pattern ((test_crate!X.impl&%10.init_by.? post! step$))
       :qid user_test_crate__X__State__init_31
       :skolemid skolem_user_test_crate__X__State__init_31
    )))
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/state_machines-c25f1c939512e7ab-inherent_safety_condition_map_general_add/test.rs:48:5: 48:47 (#0)
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/state_machines-c25f1c939512e7ab-inherent_safety_condition_map_general_add/test.rs:35:1: 53:3 (#42)
(get-info :all-statistics)
(push)
 (declare-const pre! test_crate!X.State.)
 (declare-const tmp%1 Bool)
 ...
 (assert
  (not (=>
    ...
    (=>
     ...
     (=>
      (= tmp%1 (vstd!set.impl&%0.disjoint.? $ INT (vstd!map.impl&%0.dom.? $ INT $ INT (Poly%vstd!map.Map<int./int.>.
          update_tmp_t@
         )
        ) (vstd!map.impl&%0.dom.? $ INT $ INT (vstd!map.impl&%0.insert.? $ INT $ INT (vstd!map.impl&%0.empty.?
           $ INT $ INT
      ...
      (and
       (=>
        %%location_label%%0
        (req%vstd!state_machine_internal.assert_general_add_map. tmp%1)
       )
       (=>
        (ens%vstd!state_machine_internal.assert_general_add_map. tmp%1)
        (=>
         %%location_label%%1
         (vstd!set.impl&%0.disjoint.? $ INT (vstd!map.impl&%0.dom.? $ INT $ INT (Poly%vstd!map.Map<int./int.>.
            update_tmp_t@
...
(declare-fun ens%test_crate!X.impl&%7.tr. (test_crate!X.Instance. vstd!tokens.MapToken<int./int./test_crate!X.t.>.)
 Bool
)
(assert
 (forall ((self! test_crate!X.Instance.) (param_token_0_t! vstd!tokens.MapToken<int./int./test_crate!X.t.>.))
  (!
   (= (ens%test_crate!X.impl&%7.tr. self! param_token_0_t!) (and
     (= (vstd!map.impl&%0.insert.? $ INT $ INT (vstd!map.impl&%0.empty.? $ INT $ INT) (I
        5
       ) (I 7)
      ) (vstd!tokens.impl&%0.map.? $ INT $ INT $ TYPE%test_crate!X.t. (Poly%vstd!tokens.MapToken<int./int./test_crate!X.t.>.
        param_token_0_t!
     )))
     (= (vstd!tokens.impl&%0.instance_id.? $ INT $ INT $ TYPE%test_crate!X.t. (Poly%vstd!tokens.MapToken<int./int./test_crate!X.t.>.
        param_token_0_t!
       )
