...
(declare-const fuel%test_crate!X.impl&%7.initialize_enabled. FuelId)
...
(assert
 (distinct fuel%vstd!std_specs.option.impl&%0.is_Some. fuel%vstd!std_specs.option.impl&%0.get_Some_0.
  ...
  fuel%vstd!set.axiom_set_insert_finite. fuel%vstd!set.axiom_set_remove_finite. fuel%test_crate!X.impl&%0.arrow_0.
  ...
  fuel%test_crate!X.impl&%3.is_initialize. fuel%test_crate!X.impl&%3.is_dummy_to_use_type_params.
  fuel%test_crate!X.impl&%3.get_dummy_to_use_type_params_0. fuel%test_crate!X.impl&%7.initialize.
  fuel%test_crate!X.impl&%7.initialize_enabled. fuel%test_crate!X.impl&%7.tr. fuel%test_crate!X.impl&%7.tr_strong.
  fuel%test_crate!X.impl&%7.tr_enabled. fuel%test_crate!X.impl&%7.next_by. fuel%test_crate!X.impl&%7.next.
  fuel%test_crate!X.impl&%7.next_strong_by. fuel%test_crate!X.impl&%7.next_strong.
...
(declare-datatypes ((core!option.Option. 0) (vstd!tokens.InstanceId. 0) (test_crate!X.State.
  ...
  ((test_crate!X.State./State (test_crate!X.State./State/?v vstd!map.Map<int./int.>.)))
...
(declare-fun test_crate!X.impl&%7.initialize_enabled.? (Poly) Bool)
 ...
 (=>
  ...
  (forall ((pre! Poly) (post! Poly)) (!
    (= (test_crate!X.impl&%7.next.? pre! post!) (exists ((step$ Poly)) (!
       ...
       :pattern ((test_crate!X.impl&%7.next_by.? pre! post! step$))
       :qid user_test_crate__X__State__next_28
       :skolemid skolem_user_test_crate__X__State__next_28
    )))
...
(assert
 (=>
  ...
  (forall ((post! Poly) (step! Poly)) (!
    (= (test_crate!X.impl&%7.init_by.? post! step!) (and
      (is-test_crate!X.Config./initialize (%Poly%test_crate!X.Config. step!))
      (test_crate!X.impl&%7.initialize.? post!)
    ))
 ...
 (=>
  ...
  (forall ((post! Poly)) (!
    (= (test_crate!X.impl&%7.init.? post!) (exists ((step$ Poly)) (!
       ...
       :pattern ((test_crate!X.impl&%7.init_by.? post! step$))
       :qid user_test_crate__X__State__init_29
       :skolemid skolem_user_test_crate__X__State__init_29
    )))
...
(assert
 (fuel_bool_default fuel%test_crate!X.impl&%7.initialize_enabled.)
)
(assert
 (=>
  (fuel_bool fuel%test_crate!X.impl&%7.initialize_enabled.)
  (forall ((no%param Poly)) (!
    (= (test_crate!X.impl&%7.initialize_enabled.? no%param) true)
    :pattern ((test_crate!X.impl&%7.initialize_enabled.? no%param))
    :qid internal_test_crate!X.impl&__7.initialize_enabled.?_definition
    :skolemid skolem_internal_test_crate!X.impl&__7.initialize_enabled.?_definition
))))
...
(declare-fun ens%test_crate!X.impl&%4.initialize. (vstd!map.Map<int./int.>. test_crate!X.Instance.)
 Bool
)
(assert
 (forall ((param_token_v! vstd!map.Map<int./int.>.) (%return! test_crate!X.Instance.))
  (!
   (= (ens%test_crate!X.impl&%4.initialize. param_token_v! %return!) (has_type (Poly%test_crate!X.Instance.
      %return!
     ) TYPE%test_crate!X.Instance.
   ))
   :pattern ((ens%test_crate!X.impl&%4.initialize. param_token_v! %return!))
   :qid internal_ens__test_crate!X.impl&__4.initialize._definition
   :skolemid skolem_internal_ens__test_crate!X.impl&__4.initialize._definition
)))
 ...
 (=>
  ...
  (forall ((pre! Poly) (post! Poly)) (!
    (= (test_crate!X.impl&%7.next_strong.? pre! post!) (exists ((step$ Poly)) (!
       ...
       :pattern ((test_crate!X.impl&%7.next_strong_by.? pre! post! step$))
       :qid user_test_crate__X__State__next_strong_30
       :skolemid skolem_user_test_crate__X__State__next_strong_30
    )))
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/state_machines-c25f1c939512e7ab-test_use_pre_no_field_withdraw_kv_key/test.rs:35:1: 53:3 (#42)
(get-info :all-statistics)
(push)
 (declare-const pre! test_crate!X.State.)
 (declare-const tmp%1 Bool)
 (declare-const update_tmp_v@ vstd!map.Map<int./int.>.)
 (declare-const update_tmp_v$1@ vstd!map.Map<int./int.>.)
 (assert
  fuel_defaults
 )
 (assert
