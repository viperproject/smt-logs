...
(assert
 (distinct fuel%vstd!map.impl&%0.spec_index. fuel%vstd!map.axiom_map_index_decreases_finite.
  ...
  fuel%test_crate!X.impl&%7.initialize_enabled. fuel%test_crate!X.impl&%7.tr_strong.
  fuel%test_crate!X.impl&%7.tr_enabled. fuel%test_crate!X.impl&%7.invariant. fuel%vstd!array.group_array_axioms.
...
(assert
 (forall ((no%param Int)) (!
   (= (req%test_crate!X.take_step.initialize. no%param) (=>
     ...
     (test_crate!X.impl&%7.initialize_enabled.? (I 0))
   ))
