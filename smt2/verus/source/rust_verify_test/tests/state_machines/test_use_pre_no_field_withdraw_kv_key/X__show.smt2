...
(declare-const fuel%test_crate!X.impl&%7.initialize. FuelId)
...
(assert
 (distinct fuel%vstd!map.impl&%0.spec_index. fuel%vstd!map.axiom_map_index_decreases_finite.
  ...
  fuel%vstd!set.axiom_set_insert_finite. fuel%vstd!set.axiom_set_remove_finite. fuel%test_crate!X.impl&%7.initialize.
...
(declare-datatypes ((test_crate!X.State. 0) (tuple%0. 0)) (((test_crate!X.State./State
    (test_crate!X.State./State/?v vstd!map.Map<int./int.>.)
   )
  ) ((tuple%0./tuple%0))
))
(declare-fun test_crate!X.State./State/v (test_crate!X.State.) vstd!map.Map<int./int.>.)
...
(assert
 (forall ((x test_crate!X.State.)) (!
   (= (test_crate!X.State./State/v x) (test_crate!X.State./State/?v x))
   :pattern ((test_crate!X.State./State/v x))
   :qid internal_test_crate!X.State./State/v_accessor_definition
   :skolemid skolem_internal_test_crate!X.State./State/v_accessor_definition
)))
(assert
 (forall ((x test_crate!X.State.)) (!
...
(declare-fun test_crate!X.impl&%7.initialize.? (Poly) Bool)
...
(assert
 (=>
  ...
  (forall ((K&. Dcr) (K& Type) (V&. Dcr) (V& Type) (m! Poly) (key! Poly)) (!
    ...
    :qid user_vstd__map__axiom_map_remove_domain_3
    :skolemid skolem_user_vstd__map__axiom_map_remove_domain_3
))))
 ...
 (=>
  ...
  (forall ((K&. Dcr) (K& Type) (V&. Dcr) (V& Type) (m! Poly) (key1! Poly) (key2! Poly))
   (!
    ...
    :qid user_vstd__map__axiom_map_remove_different_4
    :skolemid skolem_user_vstd__map__axiom_map_remove_different_4
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (a! Poly)) (!
    ...
    :qid user_vstd__set__axiom_set_empty_9
    :skolemid skolem_user_vstd__set__axiom_set_empty_9
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (s! Poly) (a! Poly)) (!
    ...
    :qid user_vstd__set__axiom_set_insert_same_10
    :skolemid skolem_user_vstd__set__axiom_set_insert_same_10
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (s! Poly) (a1! Poly) (a2! Poly)) (!
    ...
    :qid user_vstd__set__axiom_set_insert_different_11
    :skolemid skolem_user_vstd__set__axiom_set_insert_different_11
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (s! Poly) (a! Poly)) (!
    ...
    :qid user_vstd__set__axiom_set_remove_same_12
    :skolemid skolem_user_vstd__set__axiom_set_remove_same_12
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (s! Poly) (a! Poly)) (!
    ...
    :qid user_vstd__set__axiom_set_remove_insert_13
    :skolemid skolem_user_vstd__set__axiom_set_remove_insert_13
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (s! Poly) (a1! Poly) (a2! Poly)) (!
    ...
    :qid user_vstd__set__axiom_set_remove_different_14
    :skolemid skolem_user_vstd__set__axiom_set_remove_different_14
))))
 ...
 (=>
  ...
  (forall ((pre! Poly) (post! Poly)) (!
    (= (test_crate!X.impl&%7.tr.? pre! post!) (let
      ((tmp_assert$ true))
      (let
       ((update_tmp_v$ (test_crate!X.State./State/v (%Poly%test_crate!X.State. pre!))))
       (let
        ((tmp_assert$1 (and
           tmp_assert$
           (vstd!map_lib.impl&%0.contains_pair.? $ INT $ INT (Poly%vstd!map.Map<int./int.>. update_tmp_v$)
            (let
             ((s$ (%Poly%test_crate!X.State. pre!)))
             (vstd!map.impl&%0.index.? $ INT $ INT (Poly%vstd!map.Map<int./int.>. (test_crate!X.State./State/v
                (%Poly%test_crate!X.State. (Poly%test_crate!X.State. s$))
               )
              ) (I 0)
             )
            ) (I 5)
        ...
        (let
         ((update_tmp_v$1 (%Poly%vstd!map.Map<int./int.>. (vstd!map.impl&%0.remove.? $ INT $ INT
             (Poly%vstd!map.Map<int./int.>. update_tmp_v$) (let
              ((s$ (%Poly%test_crate!X.State. pre!)))
              (vstd!map.impl&%0.index.? $ INT $ INT (Poly%vstd!map.Map<int./int.>. (test_crate!X.State./State/v
                 (%Poly%test_crate!X.State. (Poly%test_crate!X.State. s$))
                )
         ...
         (=>
          tmp_assert$1
          (= (test_crate!X.State./State/v (%Poly%test_crate!X.State. post!)) update_tmp_v$1)
    ))))))
...
(assert
 (fuel_bool_default fuel%test_crate!X.impl&%7.initialize.)
)
(assert
 (=>
  (fuel_bool fuel%test_crate!X.impl&%7.initialize.)
  (forall ((post! Poly)) (!
    (= (test_crate!X.impl&%7.initialize.? post!) (let
      ((update_tmp_v$ (%Poly%vstd!map.Map<int./int.>. (vstd!map.impl&%0.empty.? $ INT $ INT))))
      (= (test_crate!X.State./State/v (%Poly%test_crate!X.State. post!)) update_tmp_v$)
    ))
    :pattern ((test_crate!X.impl&%7.initialize.? post!))
    :qid internal_test_crate!X.impl&__7.initialize.?_definition
    :skolemid skolem_internal_test_crate!X.impl&__7.initialize.?_definition
))))
...
(assert
 (forall ((post! test_crate!X.State.)) (!
   (= (req%test_crate!X.show.initialize. post!) (=>
     ...
     (test_crate!X.impl&%7.initialize.? (Poly%test_crate!X.State. post!))
   ))
...
(assert
 (forall ((post! test_crate!X.State.)) (!
   (= (ens%test_crate!X.show.initialize. post!) (test_crate!X.impl&%7.init.? (Poly%test_crate!X.State.
      post!
   )))
