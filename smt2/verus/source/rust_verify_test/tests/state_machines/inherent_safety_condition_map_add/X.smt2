...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (s! Poly) (a! Poly)) (!
    ...
    :qid user_vstd__set__axiom_set_insert_finite_21
    :skolemid skolem_user_vstd__set__axiom_set_insert_finite_21
))))
 ...
 (=>
  ...
  (forall ((pre! Poly) (post! Poly)) (!
    (= (test_crate!X.impl&%10.next.? pre! post!) (exists ((step$ Poly)) (!
       ...
       :pattern ((test_crate!X.impl&%10.next_by.? pre! post! step$))
       :qid user_test_crate__X__State__next_22
       :skolemid skolem_user_test_crate__X__State__next_22
    )))
 ...
 (=>
  ...
  (forall ((pre! Poly) (post! Poly)) (!
    (= (test_crate!X.impl&%10.next_strong.? pre! post!) (exists ((step$ Poly)) (!
       ...
       :pattern ((test_crate!X.impl&%10.next_strong_by.? pre! post! step$))
       :qid user_test_crate__X__State__next_strong_23
       :skolemid skolem_user_test_crate__X__State__next_strong_23
    )))
 ...
 (=>
  ...
  (forall ((post! Poly)) (!
    (= (test_crate!X.impl&%10.init.? post!) (exists ((step$ Poly)) (!
       ...
       :pattern ((test_crate!X.impl&%10.init_by.? post! step$))
       :qid user_test_crate__X__State__init_24
       :skolemid skolem_user_test_crate__X__State__init_24
    )))
...
;; Trait-Impl-Axiom
(assert
 (tr_bound%vstd!tokens.KeyValueToken. $ TYPE%test_crate!X.t. $ INT $ INT)
)

;; Trait-Impl-Axiom
(assert
 (tr_bound%vstd!tokens.UniqueKeyValueToken. $ TYPE%test_crate!X.t. $ INT $ INT)
)
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/state_machines-c25f1c939512e7ab-inherent_safety_condition_map_add/test.rs:48:5: 48:47 (#0)
...
(push)
 ...
 (assert
  (not (=>
    (= tmp%1 (not (vstd!set.impl&%0.contains.? $ INT (vstd!map.impl&%0.dom.? $ INT $ INT
    ...
    (and
     ...
     (=>
      tmp%1
      (=>
       (= tmp%2 (vstd!set.impl&%0.contains.? $ INT (vstd!map.impl&%0.dom.? $ INT $ INT (Poly%vstd!map.Map<int./int.>.
       ...
       (and
        ...
        (=>
         tmp%2
         (=>
          (= tmp%3 (= (%I (vstd!map.impl&%0.index.? $ INT $ INT (Poly%vstd!map.Map<int./int.>. (
                test_crate!X.State./State/t (%Poly%test_crate!X.State. (Poly%test_crate!X.State. post!))
               )
              ) (I 5)
             )
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/state_machines-c25f1c939512e7ab-inherent_safety_condition_map_add/test.rs:35:1: 53:3 (#42)
(get-info :all-statistics)
(push)
 (declare-const pre! test_crate!X.State.)
 (declare-const tmp%1 Bool)
 ...
 (assert
  (not (=>
    ...
    (=>
     ...
     (=>
      (= tmp%1 (not (vstd!set.impl&%0.contains.? $ INT (vstd!map.impl&%0.dom.? $ INT $ INT
          (Poly%vstd!map.Map<int./int.>. update_tmp_t@)
         ) (I 5)
      )))
      (and
       (=>
        %%location_label%%0
        (req%vstd!state_machine_internal.assert_add_map. tmp%1)
       )
       (=>
        (ens%vstd!state_machine_internal.assert_add_map. tmp%1)
        (=>
         %%location_label%%1
         (not (vstd!set.impl&%0.contains.? $ INT (vstd!map.impl&%0.dom.? $ INT $ INT (Poly%vstd!map.Map<int./int.>.
             update_tmp_t@
...
(assert
 (forall ((self! test_crate!X.Instance.) (param_token_0_t! test_crate!X.t.)) (!
   (= (ens%test_crate!X.impl&%7.tr. self! param_token_0_t!) (and
     ...
     (= (%Poly%vstd!tokens.InstanceId. (vstd!tokens.KeyValueToken.instance_id.? $ TYPE%test_crate!X.t.
        $ INT $ INT (Poly%test_crate!X.t. param_token_0_t!)
       )
      ) (test_crate!X.impl&%7.id.? (Poly%test_crate!X.Instance. self!))
     )
     (and
      (= (%I (vstd!tokens.KeyValueToken.key.? $ TYPE%test_crate!X.t. $ INT $ INT (Poly%test_crate!X.t.
          param_token_0_t!
        ))
       ) 5
      )
      (= (%I (vstd!tokens.KeyValueToken.value.? $ TYPE%test_crate!X.t. $ INT $ INT (Poly%test_crate!X.t.
          param_token_0_t!
        ))
       ) 7
   ))))
