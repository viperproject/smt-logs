...
;; Fuel
(declare-const fuel%test_crate!X.impl&%0.arrow_add_0. FuelId)
(declare-const fuel%test_crate!X.impl&%0.arrow_sub_0. FuelId)
(declare-const fuel%test_crate!X.impl&%0.arrow_dummy_to_use_type_params_0. FuelId)
(declare-const fuel%test_crate!X.impl&%1.is_add. FuelId)
(declare-const fuel%test_crate!X.impl&%1.get_add_0. FuelId)
(declare-const fuel%test_crate!X.impl&%1.is_sub. FuelId)
(declare-const fuel%test_crate!X.impl&%1.get_sub_0. FuelId)
...
(assert
 (distinct fuel%test_crate!X.impl&%0.arrow_add_0. fuel%test_crate!X.impl&%0.arrow_sub_0.
  fuel%test_crate!X.impl&%0.arrow_dummy_to_use_type_params_0. fuel%test_crate!X.impl&%1.is_add.
  fuel%test_crate!X.impl&%1.get_add_0. fuel%test_crate!X.impl&%1.is_sub. fuel%test_crate!X.impl&%1.get_sub_0.
  ...
  fuel%test_crate!X.impl&%4.initialize_enabled. fuel%test_crate!X.impl&%4.add. fuel%test_crate!X.impl&%4.add_strong.
  fuel%test_crate!X.impl&%4.add_enabled. fuel%test_crate!X.impl&%4.sub. fuel%test_crate!X.impl&%4.sub_strong.
  fuel%test_crate!X.impl&%4.sub_enabled. fuel%test_crate!X.impl&%4.next_by. fuel%test_crate!X.impl&%4.next.
...
(declare-datatypes ((test_crate!X.State. 0) (test_crate!X.Step. 0) (test_crate!X.Config.
 ...
 ) (((test_crate!X.State./State (test_crate!X.State./State/?number Int))) ((test_crate!X.Step./add
    (test_crate!X.Step./add/?0 Int)
   ) (test_crate!X.Step./sub (test_crate!X.Step./sub/?0 Int)) (test_crate!X.Step./dummy_to_use_type_params
...
(declare-fun test_crate!X.Step./add/0 (test_crate!X.Step.) Int)
(declare-fun test_crate!X.Step./sub/0 (test_crate!X.Step.) Int)
...
(assert
 (forall ((x test_crate!X.Step.)) (!
   (= (test_crate!X.Step./add/0 x) (test_crate!X.Step./add/?0 x))
   :pattern ((test_crate!X.Step./add/0 x))
   :qid internal_test_crate!X.Step./add/0_accessor_definition
   :skolemid skolem_internal_test_crate!X.Step./add/0_accessor_definition
)))
(assert
 (forall ((x test_crate!X.Step.)) (!
   (= (test_crate!X.Step./sub/0 x) (test_crate!X.Step./sub/?0 x))
   :pattern ((test_crate!X.Step./sub/0 x))
   :qid internal_test_crate!X.Step./sub/0_accessor_definition
   :skolemid skolem_internal_test_crate!X.Step./sub/0_accessor_definition
)))
(assert
 (forall ((x test_crate!X.Step.)) (!
...
;; Function-Decl test_crate::X::Step::arrow_add_0
(declare-fun test_crate!X.impl&%0.arrow_add_0.? (Poly) Int)

;; Function-Decl test_crate::X::Step::arrow_sub_0
(declare-fun test_crate!X.impl&%0.arrow_sub_0.? (Poly) Int)
...
;; Function-Decl test_crate::X::Step::is_add
(declare-fun test_crate!X.impl&%1.is_add.? (Poly) Bool)

;; Function-Decl test_crate::X::Step::get_add_0
(declare-fun test_crate!X.impl&%1.get_add_0.? (Poly) Int)

;; Function-Decl test_crate::X::Step::is_sub
(declare-fun test_crate!X.impl&%1.is_sub.? (Poly) Bool)

;; Function-Decl test_crate::X::Step::get_sub_0
(declare-fun test_crate!X.impl&%1.get_sub_0.? (Poly) Int)
 ...
 (=>
  ...
  (forall ((pre! Poly) (post! Poly) (step! Poly)) (!
    (= (test_crate!X.impl&%4.next_by.? pre! post! step!) (ite
      (is-test_crate!X.Step./add (%Poly%test_crate!X.Step. step!))
      (let
       ((n$ (test_crate!X.Step./add/0 (%Poly%test_crate!X.Step. step!))))
       (test_crate!X.impl&%4.add.? pre! post! (I n$))
      )
      (and
       (is-test_crate!X.Step./sub (%Poly%test_crate!X.Step. step!))
       (let
        ((n$ (test_crate!X.Step./sub/0 (%Poly%test_crate!X.Step. step!))))
        (test_crate!X.impl&%4.sub.? pre! post! (I n$))
    ))))
 ...
 (=>
  ...
  (forall ((post! Poly) (step! Poly)) (!
    (= (test_crate!X.impl&%4.init_by.? post! step!) (and
      ...
      (test_crate!X.impl&%4.initialize.? post!)
    ))
...
;; Function-Axioms test_crate::X::Step::arrow_add_0
(assert
 (fuel_bool_default fuel%test_crate!X.impl&%0.arrow_add_0.)
)
(assert
 (=>
  (fuel_bool fuel%test_crate!X.impl&%0.arrow_add_0.)
  (forall ((self! Poly)) (!
    (= (test_crate!X.impl&%0.arrow_add_0.? self!) (test_crate!X.Step./add/0 (%Poly%test_crate!X.Step.
       self!
    )))
    :pattern ((test_crate!X.impl&%0.arrow_add_0.? self!))
    :qid internal_test_crate!X.impl&__0.arrow_add_0.?_definition
    :skolemid skolem_internal_test_crate!X.impl&__0.arrow_add_0.?_definition
))))

;; Function-Axioms test_crate::X::Step::arrow_sub_0
(assert
 (fuel_bool_default fuel%test_crate!X.impl&%0.arrow_sub_0.)
)
(assert
 (=>
  (fuel_bool fuel%test_crate!X.impl&%0.arrow_sub_0.)
  (forall ((self! Poly)) (!
    (= (test_crate!X.impl&%0.arrow_sub_0.? self!) (test_crate!X.Step./sub/0 (%Poly%test_crate!X.Step.
       self!
    )))
    :pattern ((test_crate!X.impl&%0.arrow_sub_0.? self!))
    :qid internal_test_crate!X.impl&__0.arrow_sub_0.?_definition
    :skolemid skolem_internal_test_crate!X.impl&__0.arrow_sub_0.?_definition
))))
...
;; Function-Axioms test_crate::X::Step::is_add
(assert
 (fuel_bool_default fuel%test_crate!X.impl&%1.is_add.)
)
(assert
 (=>
  (fuel_bool fuel%test_crate!X.impl&%1.is_add.)
  (forall ((self! Poly)) (!
    (= (test_crate!X.impl&%1.is_add.? self!) (is-test_crate!X.Step./add (%Poly%test_crate!X.Step.
       self!
    )))
    :pattern ((test_crate!X.impl&%1.is_add.? self!))
    :qid internal_test_crate!X.impl&__1.is_add.?_definition
    :skolemid skolem_internal_test_crate!X.impl&__1.is_add.?_definition
))))

;; Function-Axioms test_crate::X::Step::get_add_0
(assert
 (fuel_bool_default fuel%test_crate!X.impl&%1.get_add_0.)
)
(assert
 (=>
  (fuel_bool fuel%test_crate!X.impl&%1.get_add_0.)
  (forall ((self! Poly)) (!
    (= (test_crate!X.impl&%1.get_add_0.? self!) (test_crate!X.Step./add/0 (%Poly%test_crate!X.Step.
       self!
    )))
    :pattern ((test_crate!X.impl&%1.get_add_0.? self!))
    :qid internal_test_crate!X.impl&__1.get_add_0.?_definition
    :skolemid skolem_internal_test_crate!X.impl&__1.get_add_0.?_definition
))))

;; Function-Axioms test_crate::X::Step::is_sub
(assert
 (fuel_bool_default fuel%test_crate!X.impl&%1.is_sub.)
)
(assert
 (=>
  (fuel_bool fuel%test_crate!X.impl&%1.is_sub.)
  (forall ((self! Poly)) (!
    (= (test_crate!X.impl&%1.is_sub.? self!) (is-test_crate!X.Step./sub (%Poly%test_crate!X.Step.
       self!
    )))
    :pattern ((test_crate!X.impl&%1.is_sub.? self!))
    :qid internal_test_crate!X.impl&__1.is_sub.?_definition
    :skolemid skolem_internal_test_crate!X.impl&__1.is_sub.?_definition
))))

;; Function-Axioms test_crate::X::Step::get_sub_0
(assert
 (fuel_bool_default fuel%test_crate!X.impl&%1.get_sub_0.)
)
(assert
 (=>
  (fuel_bool fuel%test_crate!X.impl&%1.get_sub_0.)
  (forall ((self! Poly)) (!
    (= (test_crate!X.impl&%1.get_sub_0.? self!) (test_crate!X.Step./sub/0 (%Poly%test_crate!X.Step.
       self!
    )))
    :pattern ((test_crate!X.impl&%1.get_sub_0.? self!))
    :qid internal_test_crate!X.impl&__1.get_sub_0.?_definition
    :skolemid skolem_internal_test_crate!X.impl&__1.get_sub_0.?_definition
))))
 ...
 (=>
  ...
  (forall ((pre! Poly) (post! Poly) (step! Poly)) (!
    (= (test_crate!X.impl&%4.next_strong_by.? pre! post! step!) (ite
      ...
      (let
       ((n$ (test_crate!X.Step./add/0 (%Poly%test_crate!X.Step. step!))))
       (test_crate!X.impl&%4.add_strong.? pre! post! (I n$))
      )
      (and
       (is-test_crate!X.Step./sub (%Poly%test_crate!X.Step. step!))
       (let
        ((n$ (test_crate!X.Step./sub/0 (%Poly%test_crate!X.Step. step!))))
        (test_crate!X.impl&%4.sub_strong.? pre! post! (I n$))
    ))))
