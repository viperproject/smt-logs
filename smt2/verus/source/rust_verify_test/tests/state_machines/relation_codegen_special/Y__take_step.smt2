...
(assert
 (distinct fuel%vstd!std_specs.option.impl&%0.is_None. fuel%vstd!map.impl&%0.spec_index.
  ...
  fuel%vstd!set.axiom_set_insert_finite. fuel%vstd!set.axiom_set_remove_finite. fuel%test_crate!Y.impl&%15.tr1_strong.
  fuel%test_crate!Y.impl&%15.tr1_enabled. fuel%test_crate!Y.impl&%15.tr2_strong. fuel%test_crate!Y.impl&%15.tr2_enabled.
  fuel%test_crate!Y.impl&%15.tr3_strong. fuel%test_crate!Y.impl&%15.tr3_enabled. fuel%test_crate!Y.impl&%15.tr4_strong.
  fuel%test_crate!Y.impl&%15.tr4_enabled. fuel%test_crate!Y.impl&%15.invariant. fuel%vstd!array.group_array_axioms.
...
(assert
 (forall ((pre! test_crate!Y.State.)) (!
   (= (req%test_crate!Y.take_step.tr4. pre!) (=>
     ...
     (and
      (test_crate!Y.impl&%15.tr4_enabled.? (Poly%test_crate!Y.State. pre!))
      (test_crate!Y.impl&%15.invariant.? (Poly%test_crate!Y.State. pre!))
   )))
