...
(assert
 (distinct fuel%vstd!map.impl&%0.spec_index. fuel%vstd!map.axiom_map_index_decreases_finite.
  ...
  fuel%test_crate!A.impl&%10.initialize. fuel%vstd!array.group_array_axioms. fuel%vstd!map.group_map_axioms.
...
(assert
 (forall ((post! test_crate!A.State.)) (!
   (= (ens%test_crate!A.show.initialize. post!) (test_crate!A.impl&%10.init.? (Poly%test_crate!A.State.
      post!
   )))
