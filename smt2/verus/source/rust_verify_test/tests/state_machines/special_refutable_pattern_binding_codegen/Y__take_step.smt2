...
(declare-const fuel%test_crate!Y.impl&%13.tr4_enabled. FuelId)
(declare-const fuel%test_crate!Y.impl&%13.tr5_strong. FuelId)
(declare-const fuel%test_crate!Y.impl&%13.tr5_enabled. FuelId)
(declare-const fuel%test_crate!Y.impl&%13.tr6_strong. FuelId)
(declare-const fuel%test_crate!Y.impl&%13.tr6_enabled. FuelId)
(declare-const fuel%test_crate!Y.impl&%13.tr7_strong. FuelId)
(declare-const fuel%test_crate!Y.impl&%13.tr7_enabled. FuelId)
(declare-const fuel%test_crate!Y.impl&%13.tr8_strong. FuelId)
(declare-const fuel%test_crate!Y.impl&%13.tr8_enabled. FuelId)
(declare-const fuel%test_crate!Y.impl&%13.tr9_strong. FuelId)
(declare-const fuel%test_crate!Y.impl&%13.tr9_enabled. FuelId)
(declare-const fuel%test_crate!Y.impl&%13.invariant. FuelId)
(declare-const fuel%test_crate!Y.impl&%13.the_inv. FuelId)
...
(assert
 (distinct fuel%vstd!std_specs.option.impl&%0.is_Some. fuel%vstd!std_specs.option.impl&%0.get_Some_0.
  ...
  fuel%vstd!set.axiom_set_remove_finite. fuel%test_crate!Y.impl&%13.initialize. fuel%test_crate!Y.impl&%13.initialize_enabled.
  fuel%test_crate!Y.impl&%13.tr1_strong. fuel%test_crate!Y.impl&%13.tr1_enabled. fuel%test_crate!Y.impl&%13.tr2_strong.
  fuel%test_crate!Y.impl&%13.tr2_enabled. fuel%test_crate!Y.impl&%13.tr3_strong. fuel%test_crate!Y.impl&%13.tr3_enabled.
  fuel%test_crate!Y.impl&%13.tr4_strong. fuel%test_crate!Y.impl&%13.tr4_enabled. fuel%test_crate!Y.impl&%13.tr5_strong.
  fuel%test_crate!Y.impl&%13.tr5_enabled. fuel%test_crate!Y.impl&%13.tr6_strong. fuel%test_crate!Y.impl&%13.tr6_enabled.
  fuel%test_crate!Y.impl&%13.tr7_strong. fuel%test_crate!Y.impl&%13.tr7_enabled. fuel%test_crate!Y.impl&%13.tr8_strong.
  fuel%test_crate!Y.impl&%13.tr8_enabled. fuel%test_crate!Y.impl&%13.tr9_strong. fuel%test_crate!Y.impl&%13.tr9_enabled.
  fuel%test_crate!Y.impl&%13.invariant. fuel%test_crate!Y.impl&%13.the_inv. fuel%vstd!array.group_array_axioms.
...
(declare-fun test_crate!Y.impl&%13.the_inv.? (Poly) Bool)

;; Function-Decl test_crate::Y::State::initialize_enabled
(declare-fun test_crate!Y.impl&%13.initialize_enabled.? (Poly Poly) Bool)
...
(declare-fun test_crate!Y.impl&%13.tr2_enabled.? (Poly) Bool)
...
(declare-fun test_crate!Y.impl&%13.tr4_enabled.? (Poly Poly) Bool)

;; Function-Decl test_crate::Y::State::tr5_strong
(declare-fun test_crate!Y.impl&%13.tr5_strong.? (Poly Poly Poly) Bool)

;; Function-Decl test_crate::Y::State::tr5_enabled
(declare-fun test_crate!Y.impl&%13.tr5_enabled.? (Poly Poly) Bool)

;; Function-Decl test_crate::Y::State::tr6_strong
(declare-fun test_crate!Y.impl&%13.tr6_strong.? (Poly Poly Poly) Bool)

;; Function-Decl test_crate::Y::State::tr6_enabled
(declare-fun test_crate!Y.impl&%13.tr6_enabled.? (Poly Poly) Bool)

;; Function-Decl test_crate::Y::State::tr7_strong
(declare-fun test_crate!Y.impl&%13.tr7_strong.? (Poly Poly Poly) Bool)

;; Function-Decl test_crate::Y::State::tr7_enabled
(declare-fun test_crate!Y.impl&%13.tr7_enabled.? (Poly Poly) Bool)

;; Function-Decl test_crate::Y::State::tr8_strong
(declare-fun test_crate!Y.impl&%13.tr8_strong.? (Poly Poly Poly) Bool)

;; Function-Decl test_crate::Y::State::tr8_enabled
(declare-fun test_crate!Y.impl&%13.tr8_enabled.? (Poly Poly) Bool)

;; Function-Decl test_crate::Y::State::tr9_strong
(declare-fun test_crate!Y.impl&%13.tr9_strong.? (Poly Poly Poly) Bool)

;; Function-Decl test_crate::Y::State::tr9_enabled
(declare-fun test_crate!Y.impl&%13.tr9_enabled.? (Poly Poly) Bool)
...
(assert
 (fuel_bool_default fuel%test_crate!Y.impl&%13.the_inv.)
)
(assert
 (=>
  (fuel_bool fuel%test_crate!Y.impl&%13.the_inv.)
  (forall ((self! Poly)) (!
    (= (test_crate!Y.impl&%13.the_inv.? self!) (and
      (= (test_crate!Y.State./State/m (%Poly%test_crate!Y.State. self!)) (test_crate!Y.State./State/storage_m
        (%Poly%test_crate!Y.State. self!)
      ))
      (= (test_crate!Y.State./State/opt (%Poly%test_crate!Y.State. self!)) (test_crate!Y.State./State/storage_opt
        (%Poly%test_crate!Y.State. self!)
    ))))
    :pattern ((test_crate!Y.impl&%13.the_inv.? self!))
    :qid internal_test_crate!Y.impl&__13.the_inv.?_definition
    :skolemid skolem_internal_test_crate!Y.impl&__13.the_inv.?_definition
))))
...
(assert
 (=>
  ...
  (forall ((m! Poly) (opt! Poly)) (!
    (= (test_crate!Y.impl&%13.initialize_enabled.? m! opt!) true)
    :pattern ((test_crate!Y.impl&%13.initialize_enabled.? m! opt!))
...
(assert
 (=>
  ...
  (forall ((pre! Poly)) (!
    (= (test_crate!Y.impl&%13.tr2_enabled.? pre!) (let
      ((update_tmp_opt$ (test_crate!Y.State./State/opt (%Poly%test_crate!Y.State. pre!))))
      (let
       ((update_tmp_storage_opt$ (test_crate!Y.State./State/storage_opt (%Poly%test_crate!Y.State.
           pre!
    ...
    :pattern ((test_crate!Y.impl&%13.tr2_enabled.? pre!))
...
(assert
 (=>
  ...
  (forall ((pre! Poly)) (!
    (= (test_crate!Y.impl&%13.tr3_enabled.? pre!) (let
      ((update_tmp_opt$ (test_crate!Y.State./State/opt (%Poly%test_crate!Y.State. pre!))))
      (let
       ((update_tmp_storage_opt$ (test_crate!Y.State./State/storage_opt (%Poly%test_crate!Y.State.
           pre!
...
(assert
 (fuel_bool_default fuel%test_crate!Y.impl&%13.tr4_enabled.)
)
(assert
 (=>
  (fuel_bool fuel%test_crate!Y.impl&%13.tr4_enabled.)
  (forall ((pre! Poly) (key! Poly)) (!
    (= (test_crate!Y.impl&%13.tr4_enabled.? pre! key!) (let
      ((update_tmp_m$ (test_crate!Y.State./State/m (%Poly%test_crate!Y.State. pre!))))
      (and
       (vstd!set.impl&%0.contains.? $ INT (vstd!map.impl&%0.dom.? $ INT $ TYPE%test_crate!Goo.
         (Poly%vstd!map.Map<int./test_crate!Goo.>. update_tmp_m$)
    ...
    :pattern ((test_crate!Y.impl&%13.tr4_enabled.? pre! key!))
    :qid internal_test_crate!Y.impl&__13.tr4_enabled.?_definition
    :skolemid skolem_internal_test_crate!Y.impl&__13.tr4_enabled.?_definition
))))
...
;; Function-Axioms test_crate::Y::State::tr5_enabled
(assert
 (fuel_bool_default fuel%test_crate!Y.impl&%13.tr5_enabled.)
)
(assert
 (=>
  (fuel_bool fuel%test_crate!Y.impl&%13.tr5_enabled.)
  (forall ((pre! Poly) (key! Poly)) (!
    (= (test_crate!Y.impl&%13.tr5_enabled.? pre! key!) (let
      ((update_tmp_m$ (test_crate!Y.State./State/m (%Poly%test_crate!Y.State. pre!))))
      (let
       ((update_tmp_storage_m$ (test_crate!Y.State./State/storage_m (%Poly%test_crate!Y.State.
           pre!
    ...
    :pattern ((test_crate!Y.impl&%13.tr5_enabled.? pre! key!))
    :qid internal_test_crate!Y.impl&__13.tr5_enabled.?_definition
    :skolemid skolem_internal_test_crate!Y.impl&__13.tr5_enabled.?_definition
))))
...
;; Function-Axioms test_crate::Y::State::tr6_enabled
(assert
 (fuel_bool_default fuel%test_crate!Y.impl&%13.tr6_enabled.)
)
(assert
 (=>
  (fuel_bool fuel%test_crate!Y.impl&%13.tr6_enabled.)
  (forall ((pre! Poly) (key! Poly)) (!
    (= (test_crate!Y.impl&%13.tr6_enabled.? pre! key!) (let
      ((update_tmp_m$ (test_crate!Y.State./State/m (%Poly%test_crate!Y.State. pre!))))
      (let
       ((update_tmp_storage_m$ (test_crate!Y.State./State/storage_m (%Poly%test_crate!Y.State.
           pre!
    ...
    :pattern ((test_crate!Y.impl&%13.tr6_enabled.? pre! key!))
    :qid internal_test_crate!Y.impl&__13.tr6_enabled.?_definition
    :skolemid skolem_internal_test_crate!Y.impl&__13.tr6_enabled.?_definition
))))
...
;; Function-Axioms test_crate::Y::State::tr7_enabled
(assert
 (fuel_bool_default fuel%test_crate!Y.impl&%13.tr7_enabled.)
)
(assert
 (=>
  (fuel_bool fuel%test_crate!Y.impl&%13.tr7_enabled.)
  (forall ((pre! Poly) (key! Poly)) (!
    (= (test_crate!Y.impl&%13.tr7_enabled.? pre! key!) (let
      ((update_tmp_m$ (test_crate!Y.State./State/m (%Poly%test_crate!Y.State. pre!))))
      (let
       ((update_tmp_opt$ (test_crate!Y.State./State/opt (%Poly%test_crate!Y.State. pre!))))
       (and
    ...
    :pattern ((test_crate!Y.impl&%13.tr7_enabled.? pre! key!))
    :qid internal_test_crate!Y.impl&__13.tr7_enabled.?_definition
    :skolemid skolem_internal_test_crate!Y.impl&__13.tr7_enabled.?_definition
))))
...
;; Function-Axioms test_crate::Y::State::tr8_enabled
(assert
 (fuel_bool_default fuel%test_crate!Y.impl&%13.tr8_enabled.)
)
(assert
 (=>
  (fuel_bool fuel%test_crate!Y.impl&%13.tr8_enabled.)
  (forall ((pre! Poly) (key! Poly)) (!
    (= (test_crate!Y.impl&%13.tr8_enabled.? pre! key!) (let
      ((update_tmp_m$ (test_crate!Y.State./State/m (%Poly%test_crate!Y.State. pre!))))
      (let
       ((update_tmp_opt$ (test_crate!Y.State./State/opt (%Poly%test_crate!Y.State. pre!))))
       (and
    ...
    :pattern ((test_crate!Y.impl&%13.tr8_enabled.? pre! key!))
    :qid internal_test_crate!Y.impl&__13.tr8_enabled.?_definition
    :skolemid skolem_internal_test_crate!Y.impl&__13.tr8_enabled.?_definition
))))
...
;; Function-Axioms test_crate::Y::State::tr9_enabled
(assert
 (fuel_bool_default fuel%test_crate!Y.impl&%13.tr9_enabled.)
)
(assert
 (=>
  (fuel_bool fuel%test_crate!Y.impl&%13.tr9_enabled.)
  (forall ((pre! Poly) (key! Poly)) (!
    (= (test_crate!Y.impl&%13.tr9_enabled.? pre! key!) (let
      ((update_tmp_m$ (test_crate!Y.State./State/m (%Poly%test_crate!Y.State. pre!))))
      (let
       ((update_tmp_opt$ (test_crate!Y.State./State/opt (%Poly%test_crate!Y.State. pre!))))
       (and
    ...
    :pattern ((test_crate!Y.impl&%13.tr9_enabled.? pre! key!))
    :qid internal_test_crate!Y.impl&__13.tr9_enabled.?_definition
    :skolemid skolem_internal_test_crate!Y.impl&__13.tr9_enabled.?_definition
))))
...
(assert
 (=>
  ...
  (forall ((self! Poly)) (!
    (= (test_crate!Y.impl&%13.invariant.? self!) (test_crate!Y.impl&%13.the_inv.? self!))
...
(declare-fun req%test_crate!Y.take_step.initialize. (vstd!map.Map<int./test_crate!Goo.>.
  core!option.Option.
 ) Bool
)
(declare-const %%global_location_label%%2 Bool)
(assert
 (forall ((m! vstd!map.Map<int./test_crate!Goo.>.) (opt! core!option.Option.)) (!
   (= (req%test_crate!Y.take_step.initialize. m! opt!) (=>
     %%global_location_label%%2
     (test_crate!Y.impl&%13.initialize_enabled.? (Poly%vstd!map.Map<int./test_crate!Goo.>.
       m!
      ) (Poly%core!option.Option. opt!)
   )))
   :pattern ((req%test_crate!Y.take_step.initialize. m! opt!))
...
(declare-fun ens%test_crate!Y.take_step.initialize. (vstd!map.Map<int./test_crate!Goo.>.
  core!option.Option. test_crate!Y.State.
 ) Bool
)
(assert
 (forall ((m! vstd!map.Map<int./test_crate!Goo.>.) (opt! core!option.Option.) (post!
    test_crate!Y.State.
   )
  ) (!
   (= (ens%test_crate!Y.take_step.initialize. m! opt! post!) (and
   ...
   :pattern ((ens%test_crate!Y.take_step.initialize. m! opt! post!))
...
;; Function-Specs test_crate::Y::take_step::tr1
(declare-fun req%test_crate!Y.take_step.tr1. (test_crate!Y.State.) Bool)
(declare-const %%global_location_label%%3 Bool)
(assert
 (forall ((pre! test_crate!Y.State.)) (!
   (= (req%test_crate!Y.take_step.tr1. pre!) (=>
     %%global_location_label%%3
     (and
      (test_crate!Y.impl&%13.tr1_enabled.? (Poly%test_crate!Y.State. pre!))
      (test_crate!Y.impl&%13.invariant.? (Poly%test_crate!Y.State. pre!))
   )))
   :pattern ((req%test_crate!Y.take_step.tr1. pre!))
   :qid internal_req__test_crate!Y.take_step.tr1._definition
   :skolemid skolem_internal_req__test_crate!Y.take_step.tr1._definition
)))
(declare-fun ens%test_crate!Y.take_step.tr1. (test_crate!Y.State. test_crate!Y.State.)
 Bool
)
(assert
 (forall ((pre! test_crate!Y.State.) (post! test_crate!Y.State.)) (!
   (= (ens%test_crate!Y.take_step.tr1. pre! post!) (and
     (has_type (Poly%test_crate!Y.State. post!) TYPE%test_crate!Y.State.)
     (and
   ...
   :pattern ((ens%test_crate!Y.take_step.tr1. pre! post!))
   :qid internal_ens__test_crate!Y.take_step.tr1._definition
   :skolemid skolem_internal_ens__test_crate!Y.take_step.tr1._definition
)))

;; Function-Specs test_crate::Y::take_step::tr2
(declare-fun req%test_crate!Y.take_step.tr2. (test_crate!Y.State.) Bool)
(declare-const %%global_location_label%%4 Bool)
(assert
 (forall ((pre! test_crate!Y.State.)) (!
   (= (req%test_crate!Y.take_step.tr2. pre!) (=>
     %%global_location_label%%4
     (and
      (test_crate!Y.impl&%13.tr2_enabled.? (Poly%test_crate!Y.State. pre!))
      (test_crate!Y.impl&%13.invariant.? (Poly%test_crate!Y.State. pre!))
   )))
   :pattern ((req%test_crate!Y.take_step.tr2. pre!))
   :qid internal_req__test_crate!Y.take_step.tr2._definition
   :skolemid skolem_internal_req__test_crate!Y.take_step.tr2._definition
)))
(declare-fun ens%test_crate!Y.take_step.tr2. (test_crate!Y.State. test_crate!Y.State.)
 Bool
)
(assert
 (forall ((pre! test_crate!Y.State.) (post! test_crate!Y.State.)) (!
   (= (ens%test_crate!Y.take_step.tr2. pre! post!) (and
     (has_type (Poly%test_crate!Y.State. post!) TYPE%test_crate!Y.State.)
     (and
   ...
   :pattern ((ens%test_crate!Y.take_step.tr2. pre! post!))
   :qid internal_ens__test_crate!Y.take_step.tr2._definition
   :skolemid skolem_internal_ens__test_crate!Y.take_step.tr2._definition
)))

;; Function-Specs test_crate::Y::take_step::tr3
(declare-fun req%test_crate!Y.take_step.tr3. (test_crate!Y.State.) Bool)
(declare-const %%global_location_label%%5 Bool)
(assert
 (forall ((pre! test_crate!Y.State.)) (!
   (= (req%test_crate!Y.take_step.tr3. pre!) (=>
     %%global_location_label%%5
     (and
      (test_crate!Y.impl&%13.tr3_enabled.? (Poly%test_crate!Y.State. pre!))
      (test_crate!Y.impl&%13.invariant.? (Poly%test_crate!Y.State. pre!))
   )))
   :pattern ((req%test_crate!Y.take_step.tr3. pre!))
   :qid internal_req__test_crate!Y.take_step.tr3._definition
   :skolemid skolem_internal_req__test_crate!Y.take_step.tr3._definition
)))
(declare-fun ens%test_crate!Y.take_step.tr3. (test_crate!Y.State. test_crate!Y.State.)
 Bool
)
(assert
 (forall ((pre! test_crate!Y.State.) (post! test_crate!Y.State.)) (!
   (= (ens%test_crate!Y.take_step.tr3. pre! post!) (and
     (has_type (Poly%test_crate!Y.State. post!) TYPE%test_crate!Y.State.)
     (and
   ...
   :pattern ((ens%test_crate!Y.take_step.tr3. pre! post!))
   :qid internal_ens__test_crate!Y.take_step.tr3._definition
   :skolemid skolem_internal_ens__test_crate!Y.take_step.tr3._definition
)))

;; Function-Specs test_crate::Y::take_step::tr4
(declare-fun req%test_crate!Y.take_step.tr4. (test_crate!Y.State. Int) Bool)
(declare-const %%global_location_label%%6 Bool)
(assert
 (forall ((pre! test_crate!Y.State.) (key! Int)) (!
   (= (req%test_crate!Y.take_step.tr4. pre! key!) (=>
     %%global_location_label%%6
     (and
      (test_crate!Y.impl&%13.tr4_enabled.? (Poly%test_crate!Y.State. pre!) (I key!))
      (test_crate!Y.impl&%13.invariant.? (Poly%test_crate!Y.State. pre!))
   )))
   :pattern ((req%test_crate!Y.take_step.tr4. pre! key!))
   :qid internal_req__test_crate!Y.take_step.tr4._definition
   :skolemid skolem_internal_req__test_crate!Y.take_step.tr4._definition
)))
(declare-fun ens%test_crate!Y.take_step.tr4. (test_crate!Y.State. Int test_crate!Y.State.)
 Bool
)
(assert
 (forall ((pre! test_crate!Y.State.) (key! Int) (post! test_crate!Y.State.)) (!
   (= (ens%test_crate!Y.take_step.tr4. pre! key! post!) (and
     (has_type (Poly%test_crate!Y.State. post!) TYPE%test_crate!Y.State.)
     (and
   ...
   :pattern ((ens%test_crate!Y.take_step.tr4. pre! key! post!))
   :qid internal_ens__test_crate!Y.take_step.tr4._definition
   :skolemid skolem_internal_ens__test_crate!Y.take_step.tr4._definition
)))

;; Function-Specs test_crate::Y::take_step::tr5
(declare-fun req%test_crate!Y.take_step.tr5. (test_crate!Y.State. Int) Bool)
(declare-const %%global_location_label%%7 Bool)
(assert
 (forall ((pre! test_crate!Y.State.) (key! Int)) (!
   (= (req%test_crate!Y.take_step.tr5. pre! key!) (=>
     %%global_location_label%%7
     (and
      (test_crate!Y.impl&%13.tr5_enabled.? (Poly%test_crate!Y.State. pre!) (I key!))
      (test_crate!Y.impl&%13.invariant.? (Poly%test_crate!Y.State. pre!))
   )))
   :pattern ((req%test_crate!Y.take_step.tr5. pre! key!))
   :qid internal_req__test_crate!Y.take_step.tr5._definition
   :skolemid skolem_internal_req__test_crate!Y.take_step.tr5._definition
)))
(declare-fun ens%test_crate!Y.take_step.tr5. (test_crate!Y.State. Int test_crate!Y.State.)
 Bool
)
(assert
 (forall ((pre! test_crate!Y.State.) (key! Int) (post! test_crate!Y.State.)) (!
   (= (ens%test_crate!Y.take_step.tr5. pre! key! post!) (and
     (has_type (Poly%test_crate!Y.State. post!) TYPE%test_crate!Y.State.)
     (and
   ...
   :pattern ((ens%test_crate!Y.take_step.tr5. pre! key! post!))
   :qid internal_ens__test_crate!Y.take_step.tr5._definition
   :skolemid skolem_internal_ens__test_crate!Y.take_step.tr5._definition
)))

;; Function-Specs test_crate::Y::take_step::tr6
(declare-fun req%test_crate!Y.take_step.tr6. (test_crate!Y.State. Int) Bool)
(declare-const %%global_location_label%%8 Bool)
(assert
 (forall ((pre! test_crate!Y.State.) (key! Int)) (!
   (= (req%test_crate!Y.take_step.tr6. pre! key!) (=>
     %%global_location_label%%8
     (and
      (test_crate!Y.impl&%13.tr6_enabled.? (Poly%test_crate!Y.State. pre!) (I key!))
      (test_crate!Y.impl&%13.invariant.? (Poly%test_crate!Y.State. pre!))
   )))
   :pattern ((req%test_crate!Y.take_step.tr6. pre! key!))
   :qid internal_req__test_crate!Y.take_step.tr6._definition
   :skolemid skolem_internal_req__test_crate!Y.take_step.tr6._definition
)))
(declare-fun ens%test_crate!Y.take_step.tr6. (test_crate!Y.State. Int test_crate!Y.State.)
 Bool
)
(assert
 (forall ((pre! test_crate!Y.State.) (key! Int) (post! test_crate!Y.State.)) (!
   (= (ens%test_crate!Y.take_step.tr6. pre! key! post!) (and
     (has_type (Poly%test_crate!Y.State. post!) TYPE%test_crate!Y.State.)
     (and
   ...
   :pattern ((ens%test_crate!Y.take_step.tr6. pre! key! post!))
   :qid internal_ens__test_crate!Y.take_step.tr6._definition
   :skolemid skolem_internal_ens__test_crate!Y.take_step.tr6._definition
)))

;; Function-Specs test_crate::Y::take_step::tr7
(declare-fun req%test_crate!Y.take_step.tr7. (test_crate!Y.State. Int) Bool)
(declare-const %%global_location_label%%9 Bool)
(assert
 (forall ((pre! test_crate!Y.State.) (key! Int)) (!
   (= (req%test_crate!Y.take_step.tr7. pre! key!) (=>
     %%global_location_label%%9
     (and
      (test_crate!Y.impl&%13.tr7_enabled.? (Poly%test_crate!Y.State. pre!) (I key!))
      (test_crate!Y.impl&%13.invariant.? (Poly%test_crate!Y.State. pre!))
   )))
   :pattern ((req%test_crate!Y.take_step.tr7. pre! key!))
   :qid internal_req__test_crate!Y.take_step.tr7._definition
   :skolemid skolem_internal_req__test_crate!Y.take_step.tr7._definition
)))
(declare-fun ens%test_crate!Y.take_step.tr7. (test_crate!Y.State. Int test_crate!Y.State.)
 Bool
)
(assert
 (forall ((pre! test_crate!Y.State.) (key! Int) (post! test_crate!Y.State.)) (!
   (= (ens%test_crate!Y.take_step.tr7. pre! key! post!) (and
     (has_type (Poly%test_crate!Y.State. post!) TYPE%test_crate!Y.State.)
     (and
   ...
   :pattern ((ens%test_crate!Y.take_step.tr7. pre! key! post!))
   :qid internal_ens__test_crate!Y.take_step.tr7._definition
   :skolemid skolem_internal_ens__test_crate!Y.take_step.tr7._definition
)))

;; Function-Specs test_crate::Y::take_step::tr8
(declare-fun req%test_crate!Y.take_step.tr8. (test_crate!Y.State. Int) Bool)
(declare-const %%global_location_label%%10 Bool)
(assert
 (forall ((pre! test_crate!Y.State.) (key! Int)) (!
   (= (req%test_crate!Y.take_step.tr8. pre! key!) (=>
     %%global_location_label%%10
     (and
      (test_crate!Y.impl&%13.tr8_enabled.? (Poly%test_crate!Y.State. pre!) (I key!))
      (test_crate!Y.impl&%13.invariant.? (Poly%test_crate!Y.State. pre!))
   )))
   :pattern ((req%test_crate!Y.take_step.tr8. pre! key!))
   :qid internal_req__test_crate!Y.take_step.tr8._definition
   :skolemid skolem_internal_req__test_crate!Y.take_step.tr8._definition
)))
(declare-fun ens%test_crate!Y.take_step.tr8. (test_crate!Y.State. Int test_crate!Y.State.)
 Bool
)
(assert
 (forall ((pre! test_crate!Y.State.) (key! Int) (post! test_crate!Y.State.)) (!
   (= (ens%test_crate!Y.take_step.tr8. pre! key! post!) (and
     (has_type (Poly%test_crate!Y.State. post!) TYPE%test_crate!Y.State.)
     (and
   ...
   :pattern ((ens%test_crate!Y.take_step.tr8. pre! key! post!))
   :qid internal_ens__test_crate!Y.take_step.tr8._definition
   :skolemid skolem_internal_ens__test_crate!Y.take_step.tr8._definition
)))

;; Function-Specs test_crate::Y::take_step::tr9
(declare-fun req%test_crate!Y.take_step.tr9. (test_crate!Y.State. Int) Bool)
(declare-const %%global_location_label%%11 Bool)
(assert
 (forall ((pre! test_crate!Y.State.) (key! Int)) (!
   (= (req%test_crate!Y.take_step.tr9. pre! key!) (=>
     %%global_location_label%%11
     (and
      (test_crate!Y.impl&%13.tr9_enabled.? (Poly%test_crate!Y.State. pre!) (I key!))
      (test_crate!Y.impl&%13.invariant.? (Poly%test_crate!Y.State. pre!))
   )))
   :pattern ((req%test_crate!Y.take_step.tr9. pre! key!))
   :qid internal_req__test_crate!Y.take_step.tr9._definition
   :skolemid skolem_internal_req__test_crate!Y.take_step.tr9._definition
)))
(declare-fun ens%test_crate!Y.take_step.tr9. (test_crate!Y.State. Int test_crate!Y.State.)
 Bool
)
(assert
 (forall ((pre! test_crate!Y.State.) (key! Int) (post! test_crate!Y.State.)) (!
   (= (ens%test_crate!Y.take_step.tr9. pre! key! post!) (and
     (has_type (Poly%test_crate!Y.State. post!) TYPE%test_crate!Y.State.)
     (and
   ...
   :pattern ((ens%test_crate!Y.take_step.tr9. pre! key! post!))
   :qid internal_ens__test_crate!Y.take_step.tr9._definition
   :skolemid skolem_internal_ens__test_crate!Y.take_step.tr9._definition
)))
