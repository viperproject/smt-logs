...
(assert
 (has_type (Poly%test_crate!X.Step. test_crate!X.Step./tr) TYPE%test_crate!X.Step.)
)
(assert
...
(declare-fun test_crate!X.impl&%10.tr.? (Poly Poly) Bool)
...
(assert
 (=>
  ...
  (forall ((pre! Poly) (post! Poly)) (!
    (= (test_crate!X.impl&%10.tr.? pre! post!) (let
      ((tmp_assert$ true))
      (let
       ...
       (let
        ((tmp_assert$1 (and
           tmp_assert$
           (is-core!option.Option./None update_tmp_t$)
        )))
        (let
         ((update_tmp_t$1 (core!option.Option./Some (I 5))))
         (=>
          tmp_assert$1
          (= (test_crate!X.State./State/t (%Poly%test_crate!X.State. post!)) update_tmp_t$1)
    ))))))
    :pattern ((test_crate!X.impl&%10.tr.? pre! post!))
 ...
 (=>
  ...
  (forall ((pre! Poly) (post! Poly) (step! Poly)) (!
    (= (test_crate!X.impl&%10.next_by.? pre! post! step!) (and
      ...
      (test_crate!X.impl&%10.tr.? pre! post!)
    ))
 ...
 (=>
  ...
  (forall ((pre! Poly) (post! Poly) (step! Poly)) (!
    (= (test_crate!X.impl&%10.next_strong_by.? pre! post! step!) (and
      (is-test_crate!X.Step./tr (%Poly%test_crate!X.Step. step!))
      (test_crate!X.impl&%10.tr_strong.? pre! post!)
    ))
...
(declare-fun req%test_crate!X.impl&%10.is_inductive. (test_crate!X.State. test_crate!X.State.)
 Bool
)
(declare-const %%global_location_label%%2 Bool)
(assert
 (forall ((pre! test_crate!X.State.) (post! test_crate!X.State.)) (!
   (= (req%test_crate!X.impl&%10.is_inductive. pre! post!) (=>
   ...
   :pattern ((req%test_crate!X.impl&%10.is_inductive. pre! post!))
   :qid internal_req__test_crate!X.impl&__10.is_inductive._definition
   :skolemid skolem_internal_req__test_crate!X.impl&__10.is_inductive._definition
)))
(declare-fun ens%test_crate!X.impl&%10.is_inductive. (test_crate!X.State. test_crate!X.State.)
 Bool
)
(assert
 (forall ((pre! test_crate!X.State.) (post! test_crate!X.State.)) (!
   (= (ens%test_crate!X.impl&%10.is_inductive. pre! post!) (test_crate!X.impl&%10.invariant.?
     (Poly%test_crate!X.State. post!)
   ))
   :pattern ((ens%test_crate!X.impl&%10.is_inductive. pre! post!))
   :qid internal_ens__test_crate!X.impl&__10.is_inductive._definition
   :skolemid skolem_internal_ens__test_crate!X.impl&__10.is_inductive._definition
)))

;; Function-Def test_crate::X::State::is_inductive
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/state_machines-c25f1c939512e7ab-inherent_safety_condition_option_add/test.rs:48:5: 48:47 (#0)
...
(push)
 ...
 (assert
  (not (=>
    (= tmp%1 (is-core!option.Option./None (test_crate!X.State./State/t (%Poly%test_crate!X.State.
    ...
    (and
     ...
     (=>
      tmp%1
      (=>
       (= tmp%2 (is-core!option.Option./Some (test_crate!X.State./State/t (%Poly%test_crate!X.State.
           (Poly%test_crate!X.State. post!)
       ))))
       (and
        (=>
        ...
        (=>
         tmp%2
         (=>
          (= tmp%3 (= (%I (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option.
                (test_crate!X.State./State/t (%Poly%test_crate!X.State. (Poly%test_crate!X.State. post!)))
             )))
            ) 5
          ))
          (and
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/state_machines-c25f1c939512e7ab-inherent_safety_condition_option_add/test.rs:35:1: 53:3 (#42)
(get-info :all-statistics)
(push)
 (declare-const pre! test_crate!X.State.)
 (declare-const tmp%1 Bool)
 (declare-const update_tmp_t@ core!option.Option.)
 (declare-const update_tmp_t$1@ core!option.Option.)
 (assert
  fuel_defaults
 )
 (assert
 ...
 (assert
  (not (=>
    ...
    (=>
     ...
     (=>
      (= tmp%1 (is-core!option.Option./None update_tmp_t@))
      (and
       (=>
        %%location_label%%0
...
(declare-fun ens%test_crate!X.impl&%7.tr. (test_crate!X.Instance. test_crate!X.t.)
 Bool
)
(assert
 (forall ((self! test_crate!X.Instance.) (param_token_0_t! test_crate!X.t.)) (!
   (= (ens%test_crate!X.impl&%7.tr. self! param_token_0_t!) (and
     (has_type (Poly%test_crate!X.t. param_token_0_t!) TYPE%test_crate!X.t.)
     (= (%Poly%vstd!tokens.InstanceId. (vstd!tokens.ValueToken.instance_id.? $ TYPE%test_crate!X.t.
        $ INT (Poly%test_crate!X.t. param_token_0_t!)
       )
   ...
   :pattern ((ens%test_crate!X.impl&%7.tr. self! param_token_0_t!))
