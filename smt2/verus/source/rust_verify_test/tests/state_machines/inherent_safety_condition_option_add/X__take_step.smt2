...
(assert
 (distinct fuel%vstd!std_specs.option.impl&%0.is_None. fuel%test_crate!X.impl&%10.tr_strong.
...
;; Datatypes
(declare-datatypes ((core!option.Option. 0) (test_crate!X.State. 0)) (((core!option.Option./None)
