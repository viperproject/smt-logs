...
(assert
 (distinct fuel%vstd!std_specs.option.impl&%0.is_Some. fuel%vstd!std_specs.option.impl&%0.is_None.
  ...
  fuel%test_crate!Y.impl&%10.tr1_strong. fuel%test_crate!Y.impl&%10.tr1_enabled. fuel%test_crate!Y.impl&%10.tr2_strong.
  fuel%test_crate!Y.impl&%10.tr2_enabled. fuel%test_crate!Y.impl&%10.tr3_strong. fuel%test_crate!Y.impl&%10.tr3_enabled.
...
(assert
 (forall ((pre! test_crate!Y.State.)) (!
   (= (req%test_crate!Y.take_step.tr2. pre!) (=>
     ...
     (and
      (test_crate!Y.impl&%10.tr2_enabled.? (Poly%test_crate!Y.State. pre!))
      (test_crate!Y.impl&%10.invariant.? (Poly%test_crate!Y.State. pre!))
   )))
...
(assert
 (forall ((pre! test_crate!Y.State.)) (!
   (= (req%test_crate!Y.take_step.tr3. pre!) (=>
     ...
     (and
      (test_crate!Y.impl&%10.tr3_enabled.? (Poly%test_crate!Y.State. pre!))
      (test_crate!Y.impl&%10.invariant.? (Poly%test_crate!Y.State. pre!))
   )))
