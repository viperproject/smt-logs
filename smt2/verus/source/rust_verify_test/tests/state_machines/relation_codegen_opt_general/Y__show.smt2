...
(assert
 (distinct fuel%vstd!std_specs.option.impl&%0.is_Some. fuel%vstd!std_specs.option.impl&%0.is_None.
  ...
  fuel%test_crate!Y.impl&%10.tr1. fuel%test_crate!Y.impl&%10.tr2. fuel%test_crate!Y.impl&%10.tr3.
...
(assert
 (forall ((pre! test_crate!Y.State.) (post! test_crate!Y.State.)) (!
   (= (ens%test_crate!Y.show.tr2. pre! post!) (test_crate!Y.impl&%10.next.? (Poly%test_crate!Y.State.
      pre!
     ) (Poly%test_crate!Y.State. post!)
   ))
...
(assert
 (forall ((pre! test_crate!Y.State.) (post! test_crate!Y.State.)) (!
   (= (ens%test_crate!Y.show.tr3. pre! post!) (test_crate!Y.impl&%10.next.? (Poly%test_crate!Y.State.
      pre!
     ) (Poly%test_crate!Y.State. post!)
   ))
