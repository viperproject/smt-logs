...
(declare-const fuel%test_crate!Y.impl&%10.tr2. FuelId)
(declare-const fuel%test_crate!Y.impl&%10.tr2_strong. FuelId)
(declare-const fuel%test_crate!Y.impl&%10.tr2_enabled. FuelId)
(declare-const fuel%test_crate!Y.impl&%10.tr3. FuelId)
(declare-const fuel%test_crate!Y.impl&%10.tr3_strong. FuelId)
(declare-const fuel%test_crate!Y.impl&%10.tr3_enabled. FuelId)
...
(assert
 (distinct fuel%vstd!std_specs.option.impl&%0.is_Some. fuel%vstd!std_specs.option.impl&%0.get_Some_0.
  ...
  fuel%vstd!std_specs.option.spec_unwrap. fuel%vstd!state_machine_internal.opt_is_none.
  fuel%vstd!state_machine_internal.opt_ge. fuel%vstd!state_machine_internal.opt_add.
  fuel%vstd!state_machine_internal.opt_sub. fuel%vstd!tokens.option_value_eq_option_token.
  ...
  fuel%test_crate!Y.impl&%10.tr1_strong. fuel%test_crate!Y.impl&%10.tr1_enabled. fuel%test_crate!Y.impl&%10.tr2.
  fuel%test_crate!Y.impl&%10.tr2_strong. fuel%test_crate!Y.impl&%10.tr2_enabled. fuel%test_crate!Y.impl&%10.tr3.
  fuel%test_crate!Y.impl&%10.tr3_strong. fuel%test_crate!Y.impl&%10.tr3_enabled. fuel%test_crate!Y.impl&%10.next_by.
...
(declare-datatypes ((core!option.Option. 0) (vstd!tokens.InstanceId. 0) (test_crate!Y.State.
  ...
  ((test_crate!Y.State./State (test_crate!Y.State./State/?opt core!option.Option.) (test_crate!Y.State./State/?storage_opt
     core!option.Option.
   ))
  ...
  ) ((test_crate!Y.Instance./Instance (test_crate!Y.Instance./Instance/?send_sync vstd!state_machine_internal.SyncSendIfSyncSend<int.>.)
...
(declare-fun test_crate!Y.Instance./Instance/send_sync (test_crate!Y.Instance.) vstd!state_machine_internal.SyncSendIfSyncSend<int.>.)
...
(assert
 (forall ((_opt! core!option.Option.) (_storage_opt! core!option.Option.)) (!
   (=>
    (and
    ...
    (has_type (Poly%test_crate!Y.State. (test_crate!Y.State./State _opt! _storage_opt!))
     TYPE%test_crate!Y.State.
   ))
   :pattern ((has_type (Poly%test_crate!Y.State. (test_crate!Y.State./State _opt! _storage_opt!))
     TYPE%test_crate!Y.State.
   ))
...
(declare-fun test_crate!Y.impl&%10.tr2.? (Poly Poly) Bool)
...
(declare-fun test_crate!Y.impl&%10.tr3.? (Poly Poly) Bool)
...
(declare-fun test_crate!Y.impl&%10.tr2_strong.? (Poly Poly) Bool)

;; Function-Decl test_crate::Y::State::tr2_enabled
(declare-fun test_crate!Y.impl&%10.tr2_enabled.? (Poly) Bool)

;; Function-Decl test_crate::Y::State::tr3_strong
(declare-fun test_crate!Y.impl&%10.tr3_strong.? (Poly Poly) Bool)

;; Function-Decl test_crate::Y::State::tr3_enabled
(declare-fun test_crate!Y.impl&%10.tr3_enabled.? (Poly) Bool)
...
;; Function-Specs vstd::state_machine_internal::assert_general_add_option
...
;; Function-Specs vstd::state_machine_internal::assert_general_withdraw_option
...
;; Function-Specs vstd::state_machine_internal::assert_general_deposit_option
...
;; Function-Specs vstd::state_machine_internal::assert_general_guard_option
  ...
  (forall ((pre! Poly) (post! Poly)) (!
    (= (test_crate!Y.impl&%10.tr1.? pre! post!) (let
      ...
      (let
       ...
       (and
        (=>
         (is-core!option.Option./Some core!option.Option./None)
         (= update_tmp_opt$ core!option.Option./None)
        )
        (and
...
(assert
 (fuel_bool_default fuel%test_crate!Y.impl&%10.tr2.)
)
(assert
 (=>
  (fuel_bool fuel%test_crate!Y.impl&%10.tr2.)
  (forall ((pre! Poly) (post! Poly)) (!
    (= (test_crate!Y.impl&%10.tr2.? pre! post!) (let
      ((tmp_assert$ true))
      (let
       ((update_tmp_opt$ (test_crate!Y.State./State/opt (%Poly%test_crate!Y.State. pre!))))
       (let
        ...
        (let
         ((tmp_assert$1 (and
            tmp_assert$
            (or
             (is-core!option.Option./None core!option.Option./None)
    ...
    :pattern ((test_crate!Y.impl&%10.tr2.? pre! post!))
    :qid internal_test_crate!Y.impl&__10.tr2.?_definition
    :skolemid skolem_internal_test_crate!Y.impl&__10.tr2.?_definition
))))
...
(assert
 (fuel_bool_default fuel%test_crate!Y.impl&%10.tr3.)
)
(assert
 (=>
  (fuel_bool fuel%test_crate!Y.impl&%10.tr3.)
  (forall ((pre! Poly) (post! Poly)) (!
    (= (test_crate!Y.impl&%10.tr3.? pre! post!) (let
      ((tmp_assert$ true))
      (let
       ((update_tmp_opt$ (test_crate!Y.State./State/opt (%Poly%test_crate!Y.State. pre!))))
       (let
         ...
         (let
          ...
          (let
           ((tmp_assert$1 (and
              ...
              (=>
               (is-core!option.Option./Some core!option.Option./None)
               (= update_tmp_storage_opt$ core!option.Option./None)
           ))))
           (let
            ((update_tmp_storage_opt$1 (ite
               (is-core!option.Option./Some core!option.Option./None)
    ...
    :pattern ((test_crate!Y.impl&%10.tr3.? pre! post!))
    :qid internal_test_crate!Y.impl&__10.tr3.?_definition
    :skolemid skolem_internal_test_crate!Y.impl&__10.tr3.?_definition
))))
  ...
  (forall ((pre! Poly) (post! Poly) (step! Poly)) (!
    (= (test_crate!Y.impl&%10.next_by.? pre! post! step!) (ite
      ...
      (ite
       ...
       (test_crate!Y.impl&%10.tr2.? pre! post!)
       (and
        (is-test_crate!Y.Step./tr3 (%Poly%test_crate!Y.Step. step!))
        (test_crate!Y.impl&%10.tr3.? pre! post!)
    ))))
...
(assert
 (=>
  ...
  (forall ((pre! Poly)) (!
    (= (test_crate!Y.impl&%10.tr1_enabled.? pre!) (let
      ((update_tmp_opt$ (test_crate!Y.State./State/opt (%Poly%test_crate!Y.State. pre!))))
      (=>
       (is-core!option.Option./Some core!option.Option./None)
       (= update_tmp_opt$ core!option.Option./None)
...
(declare-fun req%test_crate!Y.impl&%7.tr1. (test_crate!Y.Instance. core!option.Option.)
 Bool
)
(declare-const %%global_location_label%%2 Bool)
(assert
 (forall ((self! test_crate!Y.Instance.) (param_token_0_opt! core!option.Option.))
  (!
   (= (req%test_crate!Y.impl&%7.tr1. self! param_token_0_opt!) (=>
     %%global_location_label%%2
     (vstd!tokens.option_value_le_option_token.? $ INT $ TYPE%test_crate!Y.opt. (Poly%core!option.Option.
       core!option.Option./None
      ) (Poly%core!option.Option. param_token_0_opt!) (Poly%vstd!tokens.InstanceId. (test_crate!Y.impl&%7.id.?
        (Poly%test_crate!Y.Instance. self!)
   )))))
   :pattern ((req%test_crate!Y.impl&%7.tr1. self! param_token_0_opt!))
...
(assert
 (fuel_bool_default fuel%test_crate!Y.impl&%10.tr2_strong.)
)
(assert
 (=>
  (fuel_bool fuel%test_crate!Y.impl&%10.tr2_strong.)
  (forall ((pre! Poly) (post! Poly)) (!
    (= (test_crate!Y.impl&%10.tr2_strong.? pre! post!) (let
      ((update_tmp_opt$ (test_crate!Y.State./State/opt (%Poly%test_crate!Y.State. pre!))))
      (let
       ((update_tmp_storage_opt$ (test_crate!Y.State./State/storage_opt (%Poly%test_crate!Y.State.
           pre!
    ...
    :pattern ((test_crate!Y.impl&%10.tr2_strong.? pre! post!))
    :qid internal_test_crate!Y.impl&__10.tr2_strong.?_definition
    :skolemid skolem_internal_test_crate!Y.impl&__10.tr2_strong.?_definition
))))

;; Function-Axioms test_crate::Y::State::tr2_enabled
(assert
 (fuel_bool_default fuel%test_crate!Y.impl&%10.tr2_enabled.)
)
(assert
 (=>
  (fuel_bool fuel%test_crate!Y.impl&%10.tr2_enabled.)
  (forall ((pre! Poly)) (!
    (= (test_crate!Y.impl&%10.tr2_enabled.? pre!) true)
    :pattern ((test_crate!Y.impl&%10.tr2_enabled.? pre!))
    :qid internal_test_crate!Y.impl&__10.tr2_enabled.?_definition
    :skolemid skolem_internal_test_crate!Y.impl&__10.tr2_enabled.?_definition
))))

;; Function-Axioms test_crate::Y::State::tr3_strong
(assert
 (fuel_bool_default fuel%test_crate!Y.impl&%10.tr3_strong.)
)
(assert
 (=>
  (fuel_bool fuel%test_crate!Y.impl&%10.tr3_strong.)
  (forall ((pre! Poly) (post! Poly)) (!
    (= (test_crate!Y.impl&%10.tr3_strong.? pre! post!) (let
      ((update_tmp_opt$ (test_crate!Y.State./State/opt (%Poly%test_crate!Y.State. pre!))))
      (let
       ((update_tmp_storage_opt$ (test_crate!Y.State./State/storage_opt (%Poly%test_crate!Y.State.
           pre!
    ...
    :pattern ((test_crate!Y.impl&%10.tr3_strong.? pre! post!))
    :qid internal_test_crate!Y.impl&__10.tr3_strong.?_definition
    :skolemid skolem_internal_test_crate!Y.impl&__10.tr3_strong.?_definition
))))

;; Function-Axioms test_crate::Y::State::tr3_enabled
(assert
 (fuel_bool_default fuel%test_crate!Y.impl&%10.tr3_enabled.)
)
(assert
 (=>
  (fuel_bool fuel%test_crate!Y.impl&%10.tr3_enabled.)
  (forall ((pre! Poly)) (!
    (= (test_crate!Y.impl&%10.tr3_enabled.? pre!) (let
      ((update_tmp_opt$ (test_crate!Y.State./State/opt (%Poly%test_crate!Y.State. pre!))))
      (=>
       (is-core!option.Option./Some core!option.Option./None)
       (= update_tmp_opt$ core!option.Option./None)
    )))
    :pattern ((test_crate!Y.impl&%10.tr3_enabled.? pre!))
    :qid internal_test_crate!Y.impl&__10.tr3_enabled.?_definition
    :skolemid skolem_internal_test_crate!Y.impl&__10.tr3_enabled.?_definition
))))
 ...
 (=>
  ...
  (forall ((pre! Poly) (post! Poly) (step! Poly)) (!
    (= (test_crate!Y.impl&%10.next_strong_by.? pre! post! step!) (ite
      ...
      (ite
       (is-test_crate!Y.Step./tr2 (%Poly%test_crate!Y.Step. step!))
       (test_crate!Y.impl&%10.tr2_strong.? pre! post!)
       (and
        (is-test_crate!Y.Step./tr3 (%Poly%test_crate!Y.Step. step!))
        (test_crate!Y.impl&%10.tr3_strong.? pre! post!)
    ))))
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/state_machines-c25f1c939512e7ab-relation_codegen_opt_general/test.rs:35:1: 69:3 (#42)
     ...
     (=>
      ...
      (=>
       ...
       (and
        (=>
         %%location_label%%0
         (req%vstd!state_machine_internal.assert_general_add_option. tmp%1)
        )
        (=>
         (ens%vstd!state_machine_internal.assert_general_add_option. tmp%1)
         (=>
          (= update_tmp_opt$1@ (ite
            (is-core!option.Option./Some core!option.Option./None)
            core!option.Option./None
          ...
          (=>
           ...
           (=>
            %%location_label%%1
            (req%vstd!state_machine_internal.assert_general_deposit_option. tmp%2)
 )))))))))))
 (get-info :version)
      ...
      (=>
       ...
       (=>
        ...
        (=>
         ...
         (=>
          %%location_label%%0
          (req%vstd!state_machine_internal.assert_general_withdraw_option. tmp%1)
 )))))))))
 (get-info :version)
 (set-option :rlimit 30000000)
 (check-sat)
...
;; Function-Def test_crate::Y::State::ro_asserts
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/state_machines-c25f1c939512e7ab-relation_codegen_opt_general/test.rs:35:1: 69:3 (#42)
(get-info :all-statistics)
(push)
 (declare-const pre! test_crate!Y.State.)
    ...
    (=>
     ...
     (=>
      ...
      (=>
       ...
       (=>
        %%location_label%%0
        (req%vstd!state_machine_internal.assert_general_guard_option. tmp%1)
 )))))))
 (get-info :version)
 (set-option :rlimit 30000000)
 (check-sat)
...
;; Function-Specs test_crate::Y::Instance::ro
(declare-fun ens%test_crate!Y.impl&%7.ro. (test_crate!Y.Instance. core!option.Option.)
 Bool
)
(assert
 (forall ((self! test_crate!Y.Instance.) (param_token_0_storage_opt! core!option.Option.))
  (!
   (= (ens%test_crate!Y.impl&%7.ro. self! param_token_0_storage_opt!) (and
     (has_type (Poly%core!option.Option. param_token_0_storage_opt!) (TYPE%core!option.Option.
       $ INT
     ))
     (= param_token_0_storage_opt! core!option.Option./None)
   ))
   :pattern ((ens%test_crate!Y.impl&%7.ro. self! param_token_0_storage_opt!))
   :qid internal_ens__test_crate!Y.impl&__7.ro._definition
   :skolemid skolem_internal_ens__test_crate!Y.impl&__7.ro._definition
)))

;; Function-Specs test_crate::Y::Instance::tr2
(declare-fun req%test_crate!Y.impl&%7.tr2. (test_crate!Y.Instance. core!option.Option.)
 Bool
)
(declare-const %%global_location_label%%3 Bool)
(assert
 (forall ((self! test_crate!Y.Instance.) (param_token_1_storage_opt! core!option.Option.))
  (!
   (= (req%test_crate!Y.impl&%7.tr2. self! param_token_1_storage_opt!) (=>
     %%global_location_label%%3
     (= param_token_1_storage_opt! core!option.Option./None)
   ))
   :pattern ((req%test_crate!Y.impl&%7.tr2. self! param_token_1_storage_opt!))
   :qid internal_req__test_crate!Y.impl&__7.tr2._definition
   :skolemid skolem_internal_req__test_crate!Y.impl&__7.tr2._definition
)))
(declare-fun ens%test_crate!Y.impl&%7.tr2. (test_crate!Y.Instance. core!option.Option.
  core!option.Option.
 ) Bool
)
(assert
 (forall ((self! test_crate!Y.Instance.) (param_token_1_storage_opt! core!option.Option.)
   (param_token_0_opt! core!option.Option.)
  ) (!
   (= (ens%test_crate!Y.impl&%7.tr2. self! param_token_1_storage_opt! param_token_0_opt!)
    (and
     (has_type (Poly%core!option.Option. param_token_0_opt!) (TYPE%core!option.Option. $
       TYPE%test_crate!Y.opt.
     ))
   ...
   :pattern ((ens%test_crate!Y.impl&%7.tr2. self! param_token_1_storage_opt! param_token_0_opt!))
   :qid internal_ens__test_crate!Y.impl&__7.tr2._definition
   :skolemid skolem_internal_ens__test_crate!Y.impl&__7.tr2._definition
)))

;; Function-Specs test_crate::Y::Instance::tr3
(declare-fun req%test_crate!Y.impl&%7.tr3. (test_crate!Y.Instance. core!option.Option.)
 Bool
)
...
(assert
 (forall ((self! test_crate!Y.Instance.) (param_token_0_opt! core!option.Option.))
  (!
   (= (req%test_crate!Y.impl&%7.tr3. self! param_token_0_opt!) (=>
   ...
   :pattern ((req%test_crate!Y.impl&%7.tr3. self! param_token_0_opt!))
   :qid internal_req__test_crate!Y.impl&__7.tr3._definition
   :skolemid skolem_internal_req__test_crate!Y.impl&__7.tr3._definition
)))
(declare-fun ens%test_crate!Y.impl&%7.tr3. (test_crate!Y.Instance. core!option.Option.
  core!option.Option.
 ) Bool
)
(assert
 (forall ((self! test_crate!Y.Instance.) (param_token_0_opt! core!option.Option.) (param_token_1_storage_opt!
    core!option.Option.
   )
  ) (!
   (= (ens%test_crate!Y.impl&%7.tr3. self! param_token_0_opt! param_token_1_storage_opt!)
    (and
     (has_type (Poly%core!option.Option. param_token_1_storage_opt!) (TYPE%core!option.Option.
       $ INT
     ))
     (= param_token_1_storage_opt! core!option.Option./None)
   ))
   :pattern ((ens%test_crate!Y.impl&%7.tr3. self! param_token_0_opt! param_token_1_storage_opt!))
   :qid internal_ens__test_crate!Y.impl&__7.tr3._definition
   :skolemid skolem_internal_ens__test_crate!Y.impl&__7.tr3._definition
)))
