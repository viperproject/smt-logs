...
(assert
 (distinct fuel%vstd!map.impl&%0.spec_index. fuel%vstd!map.axiom_map_index_decreases_finite.
  ...
  fuel%test_crate!A.impl&%11.initialize. fuel%vstd!array.group_array_axioms. fuel%vstd!map.group_map_axioms.
...
;; Function-Specs test_crate::A::show::initialize
(declare-fun req%test_crate!A.show.initialize. (test_crate!A.State.) Bool)
(declare-const %%global_location_label%%2 Bool)
(assert
 (forall ((post! test_crate!A.State.)) (!
   (= (req%test_crate!A.show.initialize. post!) (=>
     %%global_location_label%%2
     (test_crate!A.impl&%11.initialize.? (Poly%test_crate!A.State. post!))
   ))
   :pattern ((req%test_crate!A.show.initialize. post!))
   :qid internal_req__test_crate!A.show.initialize._definition
   :skolemid skolem_internal_req__test_crate!A.show.initialize._definition
)))
(declare-fun ens%test_crate!A.show.initialize. (test_crate!A.State.) Bool)
(assert
 (forall ((post! test_crate!A.State.)) (!
   (= (ens%test_crate!A.show.initialize. post!) (test_crate!A.impl&%11.init.? (Poly%test_crate!A.State.
      post!
   )))
   :pattern ((ens%test_crate!A.show.initialize. post!))
   :qid internal_ens__test_crate!A.show.initialize._definition
   :skolemid skolem_internal_ens__test_crate!A.show.initialize._definition
)))
