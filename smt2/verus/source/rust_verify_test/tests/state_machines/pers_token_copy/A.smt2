...
(declare-const fuel%test_crate!A.impl&%11.initialize. FuelId)
(declare-const fuel%test_crate!A.impl&%11.initialize_enabled. FuelId)
(declare-const fuel%test_crate!A.impl&%11.next_by. FuelId)
(declare-const fuel%test_crate!A.impl&%11.next. FuelId)
(declare-const fuel%test_crate!A.impl&%11.next_strong_by. FuelId)
(declare-const fuel%test_crate!A.impl&%11.next_strong. FuelId)
(declare-const fuel%test_crate!A.impl&%11.init_by. FuelId)
(declare-const fuel%test_crate!A.impl&%11.init. FuelId)
(declare-const fuel%test_crate!A.impl&%11.invariant. FuelId)
...
(assert
 (distinct fuel%vstd!std_specs.option.impl&%0.is_Some. fuel%vstd!std_specs.option.impl&%0.get_Some_0.
  ...
  fuel%test_crate!A.impl&%3.get_dummy_to_use_type_params_0. fuel%test_crate!A.impl&%11.initialize.
  fuel%test_crate!A.impl&%11.initialize_enabled. fuel%test_crate!A.impl&%11.next_by.
  fuel%test_crate!A.impl&%11.next. fuel%test_crate!A.impl&%11.next_strong_by. fuel%test_crate!A.impl&%11.next_strong.
  fuel%test_crate!A.impl&%11.init_by. fuel%test_crate!A.impl&%11.init. fuel%test_crate!A.impl&%11.invariant.
...
(declare-sort vstd!tokens.MapToken<int./test_crate!Y./test_crate!A.x.>. 0)
(declare-datatypes ((core!option.Option. 0) (vstd!tokens.InstanceId. 0) (test_crate!A.State.
  ...
  ) ((test_crate!A.x./x (test_crate!A.x./x/?dummy_instance test_crate!A.Instance.)))
...
(declare-fun Poly%vstd!tokens.MapToken<int./test_crate!Y./test_crate!A.x.>. (vstd!tokens.MapToken<int./test_crate!Y./test_crate!A.x.>.)
 Poly
)
(declare-fun %Poly%vstd!tokens.MapToken<int./test_crate!Y./test_crate!A.x.>. (Poly)
 vstd!tokens.MapToken<int./test_crate!Y./test_crate!A.x.>.
)
...
(assert
 (forall ((x vstd!tokens.MapToken<int./test_crate!Y./test_crate!A.x.>.)) (!
   (= x (%Poly%vstd!tokens.MapToken<int./test_crate!Y./test_crate!A.x.>. (Poly%vstd!tokens.MapToken<int./test_crate!Y./test_crate!A.x.>.
      x
   )))
   :pattern ((Poly%vstd!tokens.MapToken<int./test_crate!Y./test_crate!A.x.>. x))
   :qid internal_vstd__tokens__MapToken<int./test_crate!Y./test_crate!A.x.>_box_axiom_definition
   :skolemid skolem_internal_vstd__tokens__MapToken<int./test_crate!Y./test_crate!A.x.>_box_axiom_definition
)))
(assert
 (forall ((x Poly)) (!
   (=>
    (has_type x (TYPE%vstd!tokens.MapToken. $ INT $ TYPE%test_crate!Y. $ TYPE%test_crate!A.x.))
    (= x (Poly%vstd!tokens.MapToken<int./test_crate!Y./test_crate!A.x.>. (%Poly%vstd!tokens.MapToken<int./test_crate!Y./test_crate!A.x.>.
       x
   ))))
   :pattern ((has_type x (TYPE%vstd!tokens.MapToken. $ INT $ TYPE%test_crate!Y. $ TYPE%test_crate!A.x.)))
   :qid internal_vstd__tokens__MapToken<int./test_crate!Y./test_crate!A.x.>_unbox_axiom_definition
   :skolemid skolem_internal_vstd__tokens__MapToken<int./test_crate!Y./test_crate!A.x.>_unbox_axiom_definition
)))
(assert
 (forall ((x vstd!tokens.MapToken<int./test_crate!Y./test_crate!A.x.>.)) (!
   (has_type (Poly%vstd!tokens.MapToken<int./test_crate!Y./test_crate!A.x.>. x) (TYPE%vstd!tokens.MapToken.
     $ INT $ TYPE%test_crate!Y. $ TYPE%test_crate!A.x.
   ))
   :pattern ((has_type (Poly%vstd!tokens.MapToken<int./test_crate!Y./test_crate!A.x.>.
      x
     ) (TYPE%vstd!tokens.MapToken. $ INT $ TYPE%test_crate!Y. $ TYPE%test_crate!A.x.)
   ))
   :qid internal_vstd__tokens__MapToken<int./test_crate!Y./test_crate!A.x.>_has_type_always_definition
   :skolemid skolem_internal_vstd__tokens__MapToken<int./test_crate!Y./test_crate!A.x.>_has_type_always_definition
)))
(assert
...
(assert
 (forall ((_dummy_instance! test_crate!A.Instance.)) (!
   (=>
    (has_type (Poly%test_crate!A.Instance. _dummy_instance!) TYPE%test_crate!A.Instance.)
    (has_type (Poly%test_crate!A.x. (test_crate!A.x./x _dummy_instance!)) TYPE%test_crate!A.x.)
   )
   :pattern ((has_type (Poly%test_crate!A.x. (test_crate!A.x./x _dummy_instance!)) TYPE%test_crate!A.x.))
...
(declare-fun test_crate!A.impl&%11.initialize.? (Poly) Bool)

;; Function-Decl test_crate::A::State::init_by
(declare-fun test_crate!A.impl&%11.init_by.? (Poly Poly) Bool)

;; Function-Decl test_crate::A::State::init
(declare-fun test_crate!A.impl&%11.init.? (Poly) Bool)

;; Function-Decl test_crate::A::State::initialize_enabled
(declare-fun test_crate!A.impl&%11.initialize_enabled.? (Poly) Bool)

;; Function-Decl test_crate::A::State::invariant
(declare-fun test_crate!A.impl&%11.invariant.? (Poly) Bool)

;; Function-Decl test_crate::A::Instance::id
(declare-fun test_crate!A.impl&%8.id.? (Poly) vstd!tokens.InstanceId.)
...
(declare-fun test_crate!A.impl&%11.next_by.? (Poly Poly Poly) Bool)

;; Function-Decl test_crate::A::State::next
(declare-fun test_crate!A.impl&%11.next.? (Poly Poly) Bool)

;; Function-Decl test_crate::A::State::next_strong_by
(declare-fun test_crate!A.impl&%11.next_strong_by.? (Poly Poly Poly) Bool)

;; Function-Decl test_crate::A::State::next_strong
(declare-fun test_crate!A.impl&%11.next_strong.? (Poly Poly) Bool)
...
(assert
 (fuel_bool_default fuel%test_crate!A.impl&%11.initialize.)
)
(assert
 (=>
  (fuel_bool fuel%test_crate!A.impl&%11.initialize.)
  (forall ((post! Poly)) (!
    (= (test_crate!A.impl&%11.initialize.? post!) (let
    ...
    :pattern ((test_crate!A.impl&%11.initialize.? post!))
    :qid internal_test_crate!A.impl&__11.initialize.?_definition
    :skolemid skolem_internal_test_crate!A.impl&__11.initialize.?_definition
))))

;; Function-Axioms test_crate::A::State::init_by
(assert
 (=>
  (fuel_bool fuel%test_crate!A.impl&%11.init_by.)
  (forall ((post! Poly) (step! Poly)) (!
    (= (test_crate!A.impl&%11.init_by.? post! step!) (and
      (is-test_crate!A.Config./initialize (%Poly%test_crate!A.Config. step!))
      (test_crate!A.impl&%11.initialize.? post!)
    ))
    :pattern ((test_crate!A.impl&%11.init_by.? post! step!))
    :qid internal_test_crate!A.impl&__11.init_by.?_definition
    :skolemid skolem_internal_test_crate!A.impl&__11.init_by.?_definition
))))

;; Function-Axioms test_crate::A::State::init
(assert
 (=>
  (fuel_bool fuel%test_crate!A.impl&%11.init.)
  (forall ((post! Poly)) (!
    (= (test_crate!A.impl&%11.init.? post!) (exists ((step$ Poly)) (!
       (and
        (has_type step$ TYPE%test_crate!A.Config.)
        (test_crate!A.impl&%11.init_by.? post! step$)
       )
       :pattern ((test_crate!A.impl&%11.init_by.? post! step$))
       :qid user_test_crate__A__State__init_19
       :skolemid skolem_user_test_crate__A__State__init_19
    )))
    :pattern ((test_crate!A.impl&%11.init.? post!))
    :qid internal_test_crate!A.impl&__11.init.?_definition
    :skolemid skolem_internal_test_crate!A.impl&__11.init.?_definition
))))

;; Function-Axioms test_crate::A::State::initialize_enabled
(assert
 (fuel_bool_default fuel%test_crate!A.impl&%11.initialize_enabled.)
)
(assert
 (=>
  (fuel_bool fuel%test_crate!A.impl&%11.initialize_enabled.)
  (forall ((no%param Poly)) (!
    (= (test_crate!A.impl&%11.initialize_enabled.? no%param) true)
    :pattern ((test_crate!A.impl&%11.initialize_enabled.? no%param))
    :qid internal_test_crate!A.impl&__11.initialize_enabled.?_definition
    :skolemid skolem_internal_test_crate!A.impl&__11.initialize_enabled.?_definition
))))

;; Function-Axioms test_crate::A::State::invariant
(assert
 (fuel_bool_default fuel%test_crate!A.impl&%11.invariant.)
)
(assert
 (=>
  (fuel_bool fuel%test_crate!A.impl&%11.invariant.)
  (forall ((self! Poly)) (!
    (= (test_crate!A.impl&%11.invariant.? self!) true)
    :pattern ((test_crate!A.impl&%11.invariant.? self!))
    :qid internal_test_crate!A.impl&__11.invariant.?_definition
    :skolemid skolem_internal_test_crate!A.impl&__11.invariant.?_definition
))))

;; Function-Specs test_crate::A::x::clone
(declare-fun ens%test_crate!A.impl&%4.clone. (test_crate!A.x. test_crate!A.x.) Bool)
(assert
 (forall ((self! test_crate!A.x.) (s! test_crate!A.x.)) (!
   (= (ens%test_crate!A.impl&%4.clone. self! s!) (and
     (has_type (Poly%test_crate!A.x. s!) TYPE%test_crate!A.x.)
     (= self! s!)
   ))
   :pattern ((ens%test_crate!A.impl&%4.clone. self! s!))
   :qid internal_ens__test_crate!A.impl&__4.clone._definition
   :skolemid skolem_internal_ens__test_crate!A.impl&__4.clone._definition
)))

;; Function-Specs test_crate::A::Instance::clone
(declare-fun ens%test_crate!A.impl&%8.clone. (test_crate!A.Instance. test_crate!A.Instance.)
 Bool
)
(assert
 (forall ((self! test_crate!A.Instance.) (s! test_crate!A.Instance.)) (!
   (= (ens%test_crate!A.impl&%8.clone. self! s!) (and
     (has_type (Poly%test_crate!A.Instance. s!) TYPE%test_crate!A.Instance.)
     (= self! s!)
   ))
   :pattern ((ens%test_crate!A.impl&%8.clone. self! s!))
   :qid internal_ens__test_crate!A.impl&__8.clone._definition
   :skolemid skolem_internal_ens__test_crate!A.impl&__8.clone._definition
)))

;; Trait-Impl-Axiom
(assert
 (tr_bound%vstd!tokens.KeyValueToken. $ TYPE%test_crate!A.x. $ INT $ TYPE%test_crate!Y.)
)

;; Function-Specs test_crate::A::Instance::initialize
(declare-fun ens%test_crate!A.impl&%8.initialize. (Int tuple%2.) Bool)
(assert
 (forall ((no%param Int) (tmp_tuple! tuple%2.)) (!
   (= (ens%test_crate!A.impl&%8.initialize. no%param tmp_tuple!) (and
     (has_type (Poly%tuple%2. tmp_tuple!) (TYPE%tuple%2. (TRACKED $) TYPE%test_crate!A.Instance.
       (TRACKED $) (TYPE%vstd!tokens.MapToken. $ INT $ TYPE%test_crate!Y. $ TYPE%test_crate!A.x.)
     ))
     (let
      ...
      (let
       ((param_token_x$ (%Poly%vstd!tokens.MapToken<int./test_crate!Y./test_crate!A.x.>. (tuple%2./tuple%2/1
       ...
       (let
        ...
        (let
         ...
         (and
          (= (vstd!map.impl&%0.empty.? $ INT $ TYPE%test_crate!Y.) (vstd!tokens.impl&%0.map.?
            $ INT $ TYPE%test_crate!Y. $ TYPE%test_crate!A.x. (Poly%vstd!tokens.MapToken<int./test_crate!Y./test_crate!A.x.>.
             param_token_x$1
          )))
          (= (vstd!tokens.impl&%0.instance_id.? $ INT $ TYPE%test_crate!Y. $ TYPE%test_crate!A.x.
            (Poly%vstd!tokens.MapToken<int./test_crate!Y./test_crate!A.x.>. param_token_x$1)
           ) (test_crate!A.impl&%8.id.? (Poly%test_crate!A.Instance. instance$1))
   ))))))))
   :pattern ((ens%test_crate!A.impl&%8.initialize. no%param tmp_tuple!))
   :qid internal_ens__test_crate!A.impl&__8.initialize._definition
   :skolemid skolem_internal_ens__test_crate!A.impl&__8.initialize._definition
)))
...
(assert
 (=>
  (fuel_bool fuel%test_crate!A.impl&%11.next_by.)
  (forall ((pre! Poly) (post! Poly) (step! Poly)) (!
    (= (test_crate!A.impl&%11.next_by.? pre! post! step!) false)
    :pattern ((test_crate!A.impl&%11.next_by.? pre! post! step!))
    :qid internal_test_crate!A.impl&__11.next_by.?_definition
    :skolemid skolem_internal_test_crate!A.impl&__11.next_by.?_definition
))))

;; Function-Axioms test_crate::A::State::next
(assert
 (=>
  (fuel_bool fuel%test_crate!A.impl&%11.next.)
  (forall ((pre! Poly) (post! Poly)) (!
    (= (test_crate!A.impl&%11.next.? pre! post!) (exists ((step$ Poly)) (!
       (and
        (has_type step$ TYPE%test_crate!A.Step.)
        (test_crate!A.impl&%11.next_by.? pre! post! step$)
       )
       :pattern ((test_crate!A.impl&%11.next_by.? pre! post! step$))
       :qid user_test_crate__A__State__next_20
       :skolemid skolem_user_test_crate__A__State__next_20
    )))
    :pattern ((test_crate!A.impl&%11.next.? pre! post!))
    :qid internal_test_crate!A.impl&__11.next.?_definition
    :skolemid skolem_internal_test_crate!A.impl&__11.next.?_definition
))))

;; Function-Axioms test_crate::A::State::next_strong_by
(assert
 (=>
  (fuel_bool fuel%test_crate!A.impl&%11.next_strong_by.)
  (forall ((pre! Poly) (post! Poly) (step! Poly)) (!
    (= (test_crate!A.impl&%11.next_strong_by.? pre! post! step!) false)
    :pattern ((test_crate!A.impl&%11.next_strong_by.? pre! post! step!))
    :qid internal_test_crate!A.impl&__11.next_strong_by.?_definition
    :skolemid skolem_internal_test_crate!A.impl&__11.next_strong_by.?_definition
))))

;; Function-Axioms test_crate::A::State::next_strong
(assert
 (=>
  (fuel_bool fuel%test_crate!A.impl&%11.next_strong.)
  (forall ((pre! Poly) (post! Poly)) (!
    (= (test_crate!A.impl&%11.next_strong.? pre! post!) (exists ((step$ Poly)) (!
       (and
        (has_type step$ TYPE%test_crate!A.Step.)
        (test_crate!A.impl&%11.next_strong_by.? pre! post! step$)
       )
       :pattern ((test_crate!A.impl&%11.next_strong_by.? pre! post! step$))
       :qid user_test_crate__A__State__next_strong_21
       :skolemid skolem_user_test_crate__A__State__next_strong_21
    )))
    :pattern ((test_crate!A.impl&%11.next_strong.? pre! post!))
    :qid internal_test_crate!A.impl&__11.next_strong.?_definition
    :skolemid skolem_internal_test_crate!A.impl&__11.next_strong.?_definition
))))
...
;; Trait-Impl-Axiom
(assert
 (tr_bound%core!clone.Clone. $ TYPE%test_crate!A.x.)
)
