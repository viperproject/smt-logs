...
(assert
 (distinct fuel%vstd!map.impl&%0.spec_index. fuel%vstd!map.axiom_map_index_decreases_finite.
  ...
  fuel%test_crate!A.impl&%11.initialize. fuel%test_crate!A.impl&%11.initialize_enabled.
  fuel%test_crate!A.impl&%11.invariant. fuel%vstd!array.group_array_axioms. fuel%vstd!map.group_map_axioms.
...
(assert
 (forall ((no%param Int)) (!
   (= (req%test_crate!A.take_step.initialize. no%param) (=>
     ...
     (test_crate!A.impl&%11.initialize_enabled.? (I 0))
   ))
...
(assert
 (forall ((no%param Int) (post! test_crate!A.State.)) (!
   (= (ens%test_crate!A.take_step.initialize. no%param post!) (and
     ...
     (test_crate!A.impl&%11.invariant.? (Poly%test_crate!A.State. post!))
   ))
