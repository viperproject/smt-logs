...
(assert
 (distinct fuel%test_crate!X.impl&%10.tr. fuel%vstd!array.group_array_axioms. fuel%vstd!map.group_map_axioms.
...
(assert
 (=>
  ...
  (forall ((post! Poly) (x! Poly)) (!
    (= (test_crate!X.impl&%10.tr.? post! x!) (let
      ((update_tmp_t$ (%I x!)))
      (= (test_crate!X.State./State/t (%Poly%test_crate!X.State. post!)) update_tmp_t$)
    ))
    :pattern ((test_crate!X.impl&%10.tr.? post! x!))
...
(declare-fun req%test_crate!X.show.tr. (test_crate!X.State. Int) Bool)
(declare-const %%global_location_label%%0 Bool)
(assert
 (forall ((post! test_crate!X.State.) (x! Int)) (!
   (= (req%test_crate!X.show.tr. post! x!) (=>
     %%global_location_label%%0
     (test_crate!X.impl&%10.tr.? (Poly%test_crate!X.State. post!) (I x!))
   ))
   :pattern ((req%test_crate!X.show.tr. post! x!))
   :qid internal_req__test_crate!X.show.tr._definition
   :skolemid skolem_internal_req__test_crate!X.show.tr._definition
)))
(declare-fun ens%test_crate!X.show.tr. (test_crate!X.State. Int) Bool)
(assert
 (forall ((post! test_crate!X.State.) (x! Int)) (!
   (= (ens%test_crate!X.show.tr. post! x!) (test_crate!X.impl&%10.init.? (Poly%test_crate!X.State.
      post!
   )))
   :pattern ((ens%test_crate!X.show.tr. post! x!))
