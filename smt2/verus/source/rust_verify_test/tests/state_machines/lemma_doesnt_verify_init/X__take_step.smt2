...
(assert
 (distinct fuel%test_crate!X.impl&%10.tr. fuel%test_crate!X.impl&%10.tr_enabled. fuel%test_crate!X.impl&%10.invariant.
...
(declare-fun req%test_crate!X.take_step.tr. (Int) Bool)
(declare-const %%global_location_label%%0 Bool)
(assert
 (forall ((x! Int)) (!
   (= (req%test_crate!X.take_step.tr. x!) (=>
     %%global_location_label%%0
     (test_crate!X.impl&%10.tr_enabled.? (I x!))
   ))
   :pattern ((req%test_crate!X.take_step.tr. x!))
...
(declare-fun ens%test_crate!X.take_step.tr. (Int test_crate!X.State.) Bool)
(assert
 (forall ((x! Int) (post! test_crate!X.State.)) (!
   (= (ens%test_crate!X.take_step.tr. x! post!) (and
     (test_crate!X.impl&%10.tr.? (Poly%test_crate!X.State. post!) (I x!))
     (test_crate!X.impl&%10.invariant.? (Poly%test_crate!X.State. post!))
   ))
   :pattern ((ens%test_crate!X.take_step.tr. x! post!))
