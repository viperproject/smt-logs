...
(declare-datatypes ((test_crate!X.State. 0) (test_crate!Foo. 0) (test_crate!Y. 0) (
   tuple%0. 0
  ) (tuple%2. 0)
  ...
  ) ((test_crate!Y./Y (test_crate!Y./Y/?a Int) (test_crate!Y./Y/?b Int))) ((tuple%0./tuple%0))
...
(declare-fun test_crate!Y./Y/a (test_crate!Y.) Int)
(declare-fun test_crate!Y./Y/b (test_crate!Y.) Int)
...
(assert
 (forall ((x test_crate!Y.)) (!
   (= (test_crate!Y./Y/a x) (test_crate!Y./Y/?a x))
   :pattern ((test_crate!Y./Y/a x))
   :qid internal_test_crate!Y./Y/a_accessor_definition
   :skolemid skolem_internal_test_crate!Y./Y/a_accessor_definition
)))
(assert
 (forall ((x test_crate!Y.)) (!
   (= (test_crate!Y./Y/b x) (test_crate!Y./Y/?b x))
   :pattern ((test_crate!Y./Y/b x))
   :qid internal_test_crate!Y./Y/b_accessor_definition
   :skolemid skolem_internal_test_crate!Y./Y/b_accessor_definition
)))
(assert
 (forall ((x test_crate!Y.)) (!
...
(declare-fun test_crate!tr_weak.? (Poly Poly Poly Poly Poly Poly) Bool)

;; Function-Decl test_crate::tr_strong
(declare-fun test_crate!tr_strong.? (Poly Poly Poly Poly Poly Poly) Bool)
...
(assert
 (=>
  ...
  (forall ((pre! Poly) (post! Poly) (x! Poly) (y! Poly) (z! Poly) (b! Poly)) (!
    (= (test_crate!tr_weak.? pre! post! x! y! z! b!) (=>
      (=>
       (%B b!)
       (= (%I x!) 9)
      )
    ...
    :pattern ((test_crate!tr_weak.? pre! post! x! y! z! b!))
...
(assert
 (=>
  ...
  (forall ((pre! Poly) (post! Poly) (x! Poly) (y! Poly) (z! Poly) (b! Poly)) (!
    (= (test_crate!tr_strong.? pre! post! x! y! z! b!) (and
      (and
       (=>
        (%B b!)
        (= (%I x!) 9)
    ...
    :pattern ((test_crate!tr_strong.? pre! post! x! y! z! b!))
...
(declare-fun ens%test_crate!test. (test_crate!X.State. test_crate!X.State. Int Int
  Int Bool
 ) Bool
)
(assert
 (forall ((pre! test_crate!X.State.) (post! test_crate!X.State.) (x! Int) (y! Int) (
   ...
   (= (ens%test_crate!test. pre! post! x! y! z! b!) (= (test_crate!X.impl&%4.tr.? (Poly%test_crate!X.State.
       pre!
      ) (Poly%test_crate!X.State. post!) (I x!) (I y!) (I z!) (B b!)
     ) (test_crate!tr_weak.? (Poly%test_crate!X.State. pre!) (Poly%test_crate!X.State. post!)
      (I x!) (I y!) (I z!) (B b!)
   )))
   :pattern ((ens%test_crate!test. pre! post! x! y! z! b!))
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/state_machines-c25f1c939512e7ab-if_let_assert_with_no_else/test.rs:65:7: 65:78 (#0)
...
(declare-fun ens%test_crate!test2. (test_crate!X.State. test_crate!X.State. Int Int
  Int Bool
 ) Bool
)
(assert
 (forall ((pre! test_crate!X.State.) (post! test_crate!X.State.) (x! Int) (y! Int) (
   ...
   (= (ens%test_crate!test2. pre! post! x! y! z! b!) (= (test_crate!X.impl&%4.tr_strong.?
      (Poly%test_crate!X.State. pre!) (Poly%test_crate!X.State. post!) (I x!) (I y!) (I
       z!
      ) (B b!)
   ...
   :pattern ((ens%test_crate!test2. pre! post! x! y! z! b!))
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/state_machines-c25f1c939512e7ab-if_let_assert_with_no_else/test.rs:75:7: 75:79 (#0)
(get-info :all-statistics)
(push)
 (declare-const pre! test_crate!X.State.)
 (declare-const post! test_crate!X.State.)
