...
(assert
 (distinct fuel%vstd!map.impl&%0.new. fuel%vstd!map.impl&%0.spec_index. fuel%vstd!map.axiom_map_index_decreases_finite.
  ...
  fuel%vstd!map_lib.impl&%0.contains_pair. fuel%vstd!map_lib.impl&%0.submap_of. fuel%vstd!map_lib.impl&%0.spec_le.
  fuel%vstd!map_lib.impl&%0.union_prefer_right. fuel%vstd!map_lib.impl&%0.agrees. fuel%vstd!set.axiom_set_empty.
  ...
  fuel%vstd!set.axiom_set_remove_finite. fuel%vstd!tokens.impl&%0.dom. fuel%test_crate!Y.impl&%11.tr1.
  fuel%test_crate!Y.impl&%11.tr1_strong. fuel%test_crate!Y.impl&%11.tr2. fuel%test_crate!Y.impl&%11.tr2_strong.
  fuel%test_crate!Y.impl&%11.tr3. fuel%test_crate!Y.impl&%11.tr3_strong. fuel%test_crate!impl&%0.arrow_Bar_0.
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (f! Poly) (a! Poly)) (!
    ...
    :qid user_vstd__set__axiom_set_new_13
    :skolemid skolem_user_vstd__set__axiom_set_new_13
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (s! Poly) (a! Poly)) (!
    ...
    :qid user_vstd__set__axiom_set_remove_same_16
    :skolemid skolem_user_vstd__set__axiom_set_remove_same_16
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (s! Poly) (a! Poly)) (!
    ...
    :qid user_vstd__set__axiom_set_remove_insert_17
    :skolemid skolem_user_vstd__set__axiom_set_remove_insert_17
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (s! Poly) (a1! Poly) (a2! Poly)) (!
    ...
    :qid user_vstd__set__axiom_set_remove_different_18
    :skolemid skolem_user_vstd__set__axiom_set_remove_different_18
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (s1! Poly) (s2! Poly)) (!
    ...
    :qid user_vstd__set__axiom_set_ext_equal_deep_21
    :skolemid skolem_user_vstd__set__axiom_set_ext_equal_deep_21
))))
...
(assert
 (=>
  ...
  (forall ((K&. Dcr) (K& Type) (V&. Dcr) (V& Type) (s! Poly) (f! Poly)) (!
    ...
    :qid user_vstd__set__axiom_mk_map_domain_22
    :skolemid skolem_user_vstd__set__axiom_mk_map_domain_22
))))
 ...
 (=>
  ...
  (forall ((K&. Dcr) (K& Type) (V&. Dcr) (V& Type) (s! Poly) (f! Poly) (key! Poly))
   (!
    ...
    :qid user_vstd__set__axiom_mk_map_index_23
    :skolemid skolem_user_vstd__set__axiom_mk_map_index_23
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type)) (!
    ...
    :qid user_vstd__set__axiom_set_empty_finite_24
    :skolemid skolem_user_vstd__set__axiom_set_empty_finite_24
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (s! Poly) (a! Poly)) (!
    ...
    :qid user_vstd__set__axiom_set_insert_finite_25
    :skolemid skolem_user_vstd__set__axiom_set_insert_finite_25
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (s! Poly) (a! Poly)) (!
    ...
    :qid user_vstd__set__axiom_set_remove_finite_26
    :skolemid skolem_user_vstd__set__axiom_set_remove_finite_26
))))
 ...
 (=>
  ...
  (forall ((K&. Dcr) (K& Type) (V&. Dcr) (V& Type) (self! Poly) (m2! Poly)) (!
    (= (vstd!map_lib.impl&%0.agrees.? K&. K& V&. V& self! m2!) (forall ((k$ Poly)) (!
       ...
       :pattern ((vstd!map.impl&%0.index.? K&. K& V&. V& m2! k$))
       :qid user_vstd__map_lib__impl&%0__agrees_27
       :skolemid skolem_user_vstd__map_lib__impl&%0__agrees_27
    )))
  ...
  (forall ((pre! Poly) (post! Poly)) (!
    (= (test_crate!rel_tr1.? pre! post!) (and
      ...
      (=>
       ...
       (= (test_crate!Y.State./State/c (%Poly%test_crate!Y.State. post!)) (%Poly%vstd!map.Map<int./int.>.
         (vstd!map.impl&%0.insert.? $ INT $ INT (Poly%vstd!map.Map<int./int.>. (test_crate!Y.State./State/c
            (%Poly%test_crate!Y.State. pre!)
           )
          ) (I 3) (I 4)
    ))))))
 ...
 (=>
  ...
  (forall ((pre! Poly) (post! Poly)) (!
    (= (test_crate!rel_tr3.? pre! post!) (and
      ...
      (= (test_crate!Y.State./State/c (%Poly%test_crate!Y.State. pre!)) (test_crate!Y.State./State/c
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/state_machines-c25f1c939512e7ab-persistent_map_codegen/test.rs:141:7: 141:51 (#0)
...
(push)
 ...
 (assert
  (not (=>
    (= m1@ (%Poly%vstd!map.Map<int./int.>. (vstd!map.impl&%0.insert.? $ INT $ INT (vstd!map.impl&%0.insert.?
        $ INT $ INT (Poly%vstd!map.Map<int./int.>. (test_crate!Y.State./State/c (%Poly%test_crate!Y.State.
           (Poly%test_crate!Y.State. pre!)
         ))
        ) (I 5) (I 9)
       ) (I 12) (I 15)
    ...
    (=>
     (= m2@ (%Poly%vstd!map.Map<int./int.>. (vstd!map_lib.impl&%0.union_prefer_right.? $
        INT $ INT (Poly%vstd!map.Map<int./int.>. (test_crate!Y.State./State/c (%Poly%test_crate!Y.State.
           (Poly%test_crate!Y.State. pre!)
         ))
        ) (vstd!map.impl&%0.insert.? $ INT $ INT (vstd!map.impl&%0.insert.? $ INT $ INT (vstd!map.impl&%0.empty.?
        ...
        (=>
         ...
         (and
          ...
          (=>
           ...
           (= (vstd!map.impl&%0.index.? $ INT $ INT (Poly%vstd!map.Map<int./int.>. m1@) key@)
            (vstd!map.impl&%0.index.? $ INT $ INT (Poly%vstd!map.Map<int./int.>. m2@) key@)
       )))))
       (=>
        (forall ((key$ Poly)) (!
          (=>
          ...
          :pattern ((vstd!set.impl&%0.contains.? $ INT (vstd!map.impl&%0.dom.? $ INT $ INT (Poly%vstd!map.Map<int./int.>.
              m1@
             )
            ) key$
          ))
          :qid user_test_crate__correct_tr_29
          :skolemid skolem_user_test_crate__correct_tr_29
        ))
        (=>
       ...
       (or
        (and
         (=>
          (test_crate!rel_tr3.? (Poly%test_crate!Y.State. pre!) (Poly%test_crate!Y.State. post!))
          (=>
           (= tmp%2 (vstd!map_lib.impl&%0.submap_of.? $ INT $ INT (vstd!map.impl&%0.insert.? $
              INT $ INT (vstd!map.impl&%0.insert.? $ INT $ INT (vstd!map.impl&%0.empty.? $ INT $
                INT
               ) (I 5) (I 9)
              ) (I 12) (I 15)
             ) (Poly%vstd!map.Map<int./int.>. (test_crate!Y.State./State/c (%Poly%test_crate!Y.State.
                (Poly%test_crate!Y.State. pre!)
           )))))
           (and
            (=>
            ...
            (=>
             tmp%2
             (=>
              (= tmp%3 (test_crate!Y.impl&%11.tr3.? (Poly%test_crate!Y.State. pre!) (Poly%test_crate!Y.State.
                 post!
              )))
              (and
               (=>
         ...
         (=>
          (not (test_crate!rel_tr3.? (Poly%test_crate!Y.State. pre!) (Poly%test_crate!Y.State.
             post!
          )))
          %%switch_label%%1
        ))
         ...
         (or
          (and
           (=>
            ...
            (=>
             (= tmp%4 (vstd!set.impl&%0.contains.? $ INT (vstd!map.impl&%0.dom.? $ INT $ INT (vstd!map.impl&%0.insert.?
                 $ INT $ INT (vstd!map.impl&%0.insert.? $ INT $ INT (vstd!map.impl&%0.empty.? $ INT
                   $ INT
                  ) (I 5) (I 9)
                 ) (I 12) (I 15)
               ...
               (=>
                ...
                (and
                 ...
                 (=>
                  tmp%5
                  (=>
                   (= tmp%6 (vstd!set.impl&%0.contains.? $ INT (vstd!map.impl&%0.dom.? $ INT $ INT (Poly%vstd!map.Map<int./int.>.
                       (test_crate!Y.State./State/c (%Poly%test_crate!Y.State. (Poly%test_crate!Y.State. pre!)))
                      )
                     ) (I 5)
                   ))
                   (and
                    ...
                    (=>
                     tmp%6
                     (=>
                      (= tmp%7 (vstd!set.impl&%0.contains.? $ INT (vstd!map.impl&%0.dom.? $ INT $ INT (Poly%vstd!map.Map<int./int.>.
                          (test_crate!Y.State./State/c (%Poly%test_crate!Y.State. (Poly%test_crate!Y.State. pre!)))
                         )
                        ) (I 12)
                      ))
                      (and
                       ...
                       (=>
                        tmp%7
                        (=>
                         (= tmp%8 (test_crate!rel_tr3.? (Poly%test_crate!Y.State. pre!) (Poly%test_crate!Y.State.
                            post!
                         )))
                         (and
                          (=>
           ...
           (=>
            (not (test_crate!Y.impl&%11.tr3.? (Poly%test_crate!Y.State. pre!) (Poly%test_crate!Y.State.
               post!
            )))
            %%switch_label%%0
          ))
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/state_machines-c25f1c939512e7ab-persistent_map_codegen/test.rs:176:7: 176:21 (#0)
(get-info :all-statistics)
(push)
 ...
 (declare-const verus_tmp_init_m@ vstd!tokens.MapToken<int./int./test_crate!Y.c.>.)
 (declare-const inst@ test_crate!Y.Instance.)
 (declare-const init_m@0 vstd!tokens.MapToken<int./int./test_crate!Y.c.>.)
 (declare-const m_1@ test_crate!Y.c.)
 (declare-const cloned@ test_crate!Y.c.)
 (declare-const m_3@ test_crate!Y.c.)
 (declare-const m_5_12@ vstd!tokens.MapToken<int./int./test_crate!Y.c.>.)
 (assert
  fuel_defaults
 )
 (declare-const init_m@1 vstd!tokens.MapToken<int./int./test_crate!Y.c.>.)
 ;; assertion failed
 (declare-const %%location_label%%0 Bool)
 ...
 (assert
  (not (=>
    ...
    (=>
     ...
     (=>
      (= verus_tmp_init_m@ (%Poly%vstd!tokens.MapToken<int./int./test_crate!Y.c.>. (tuple%2./tuple%2/1
         (%Poly%tuple%2. (Poly%tuple%2. tmp%%@))
      )))
      (=>
       (= inst@ verus_tmp_inst@)
       (=>
        (= init_m@0 verus_tmp_init_m@)
        (=>
         (= tmp%1 (vstd!set.impl&%0.contains.? $ INT (vstd!map.impl&%0.dom.? $ INT $ INT (vstd!tokens.impl&%0.map.?
             $ INT $ INT $ TYPE%test_crate!Y.c. (Poly%vstd!tokens.MapToken<int./int./test_crate!Y.c.>.
              init_m@0
            ))
           ) (I 1)
         ))
         (and
          ...
          (=>
           ...
           (and
            (=>
             %%location_label%%1
             (req%vstd!tokens.impl&%0.remove. $ INT $ INT $ TYPE%test_crate!Y.c. (Poly%vstd!tokens.MapToken<int./int./test_crate!Y.c.>.
               init_m@0
              ) (I 1)
            ))
            (=>
             (ens%vstd!tokens.impl&%0.remove. $ INT $ INT $ TYPE%test_crate!Y.c. (Poly%vstd!tokens.MapToken<int./int./test_crate!Y.c.>.
               init_m@0
              ) (Poly%vstd!tokens.MapToken<int./int./test_crate!Y.c.>. init_m@1) (I 1) tmp%2
             )
             (=>
              (= m_1@ (%Poly%test_crate!Y.c. tmp%2))
              (=>
               (= tmp%3 (= (%I (vstd!tokens.KeyValueToken.value.? $ TYPE%test_crate!Y.c. $ INT $ INT
                   (Poly%test_crate!Y.c. m_1@)
                  )
                 ) 2
               ))
               (and
                ...
                (=>
                 tmp%3
                 (=>
                  (ens%test_crate!Y.impl&%4.clone. m_1@ cloned@)
                  (=>
                   (= tmp%4 (= (%Poly%vstd!tokens.InstanceId. (vstd!tokens.KeyValueToken.instance_id.? $
                       TYPE%test_crate!Y.c. $ INT $ INT (Poly%test_crate!Y.c. cloned@)
                      )
                   ...
                   (and
                    ...
                    (=>
                     tmp%4
                     (=>
                      (= tmp%5 (= (%I (vstd!tokens.KeyValueToken.key.? $ TYPE%test_crate!Y.c. $ INT $ INT (
                           Poly%test_crate!Y.c. cloned@
                         ))
                        ) 1
                      ))
                      (and
                       ...
                       (=>
                        tmp%5
                        (=>
                         (= tmp%6 (= (%I (vstd!tokens.KeyValueToken.value.? $ TYPE%test_crate!Y.c. $ INT $ INT
                             (Poly%test_crate!Y.c. cloned@)
                            )
                           ) 2
                         ))
                         (and
                          ...
                          (=>
                           ...
                           (and
                            (=>
                             %%location_label%%6
                             (req%test_crate!Y.impl&%8.tr1. inst@ m_1@)
                            )
                            (=>
                             (ens%test_crate!Y.impl&%8.tr1. inst@ m_1@ m_3@)
                             (=>
                              (= tmp%7 (= (%I (vstd!tokens.KeyValueToken.value.? $ TYPE%test_crate!Y.c. $ INT $ INT
                                  (Poly%test_crate!Y.c. m_3@)
                                 )
                                ) 4
                              ))
                              (and
                               ...
                               (=>
                                tmp%7
                                (=>
                                 (ens%test_crate!Y.impl&%8.tr2. inst@ m_5_12@)
                                 (=>
                                  (= tmp%8 (ext_eq false (TYPE%vstd!map.Map. $ INT $ INT) (vstd!tokens.impl&%0.map.? $
                                     INT $ INT $ TYPE%test_crate!Y.c. (Poly%vstd!tokens.MapToken<int./int./test_crate!Y.c.>.
                                      m_5_12@
                                     )
                                    ) (vstd!map.impl&%0.insert.? $ INT $ INT (vstd!map.impl&%0.insert.? $ INT $ INT (vstd!map.impl&%0.empty.?
                                  ...
                                  (and
                                   ...
                                   (=>
                                    tmp%8
                                    (=>
                                     (= tmp%9 (= (vstd!tokens.impl&%0.instance_id.? $ INT $ INT $ TYPE%test_crate!Y.c. (Poly%vstd!tokens.MapToken<int./int./test_crate!Y.c.>.
                                         m_5_12@
                                        )
                                       ) (test_crate!Y.impl&%8.id.? (Poly%test_crate!Y.Instance. inst@))
                                     ))
                                     (and
                                      ...
                                      (=>
                                       ...
                                       (=>
                                        %%location_label%%10
                                        (req%test_crate!Y.impl&%8.tr3. inst@ m_5_12@)
 )))))))))))))))))))))))))))))))))))))))
 (get-info :version)
 (set-option :rlimit 30000000)
 (check-sat)
