...
(assert
 (distinct fuel%vstd!std_specs.option.impl&%0.is_Some. fuel%vstd!std_specs.option.impl&%0.is_None.
  fuel%vstd!state_machine_internal.opt_is_none. fuel%vstd!state_machine_internal.opt_add.
  fuel%test_crate!X.impl&%10.tr. fuel%vstd!array.group_array_axioms. fuel%vstd!map.group_map_axioms.
      ...
      (let
       ...
       (let
        ((tmp_assert$1 (and
           tmp_assert$
           (or
            (is-core!option.Option./None (core!option.Option./Some (I 5)))
...
(assert
 (forall ((pre! test_crate!X.State.) (post! test_crate!X.State.)) (!
   (= (req%test_crate!X.show.tr. pre! post!) (=>
     ...
     (test_crate!X.impl&%10.tr.? (Poly%test_crate!X.State. pre!) (Poly%test_crate!X.State.
       post!
   ))))
...
(assert
 (forall ((pre! test_crate!X.State.) (post! test_crate!X.State.)) (!
   (= (ens%test_crate!X.show.tr. pre! post!) (test_crate!X.impl&%10.next.? (Poly%test_crate!X.State.
      pre!
