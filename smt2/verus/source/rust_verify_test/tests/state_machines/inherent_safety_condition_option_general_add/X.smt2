...
(assert
 (distinct fuel%vstd!std_specs.option.impl&%0.is_Some. fuel%vstd!std_specs.option.impl&%0.get_Some_0.
  ...
  fuel%vstd!tokens.option_value_eq_option_token. fuel%test_crate!X.impl&%0.arrow_0.
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/state_machines-c25f1c939512e7ab-inherent_safety_condition_option_general_add/test.rs:48:5: 48:47 (#0)
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/state_machines-c25f1c939512e7ab-inherent_safety_condition_option_general_add/test.rs:35:1: 53:3 (#42)
(get-info :all-statistics)
(push)
 (declare-const pre! test_crate!X.State.)
 (declare-const tmp%1 Bool)
...
(declare-fun ens%test_crate!X.impl&%7.tr. (test_crate!X.Instance. core!option.Option.)
 Bool
)
(assert
 (forall ((self! test_crate!X.Instance.) (param_token_0_t! core!option.Option.)) (!
   (= (ens%test_crate!X.impl&%7.tr. self! param_token_0_t!) (and
     (has_type (Poly%core!option.Option. param_token_0_t!) (TYPE%core!option.Option. $ TYPE%test_crate!X.t.))
     (vstd!tokens.option_value_eq_option_token.? $ INT $ TYPE%test_crate!X.t. (Poly%core!option.Option.
       (core!option.Option./Some (I 5))
      ) (Poly%core!option.Option. param_token_0_t!) (Poly%vstd!tokens.InstanceId. (test_crate!X.impl&%7.id.?
        (Poly%test_crate!X.Instance. self!)
   )))))
