...
(assert
 (distinct fuel%vstd!map.impl&%0.new. fuel%vstd!map.impl&%0.spec_index. fuel%vstd!map.axiom_map_index_decreases_finite.
  ...
  fuel%test_crate!Y.impl&%11.initialize_enabled. fuel%test_crate!Y.impl&%11.tr1_strong.
  fuel%test_crate!Y.impl&%11.tr1_enabled. fuel%test_crate!Y.impl&%11.tr2_strong. fuel%test_crate!Y.impl&%11.tr2_enabled.
  fuel%test_crate!Y.impl&%11.tr3_strong. fuel%test_crate!Y.impl&%11.tr3_enabled. fuel%test_crate!Y.impl&%11.invariant.
  fuel%test_crate!Y.impl&%11.the_inv. fuel%vstd!array.group_array_axioms. fuel%vstd!map.group_map_axioms.
...
(assert
 (forall ((pre! test_crate!Y.State.)) (!
   (= (req%test_crate!Y.take_step.tr1. pre!) (=>
     ...
     (and
      (test_crate!Y.impl&%11.tr1_enabled.? (Poly%test_crate!Y.State. pre!))
...
(assert
 (forall ((pre! test_crate!Y.State.)) (!
   (= (req%test_crate!Y.take_step.tr2. pre!) (=>
     ...
     (and
      (test_crate!Y.impl&%11.tr2_enabled.? (Poly%test_crate!Y.State. pre!))
      (test_crate!Y.impl&%11.invariant.? (Poly%test_crate!Y.State. pre!))
   )))
...
(assert
 (forall ((pre! test_crate!Y.State.)) (!
   (= (req%test_crate!Y.take_step.tr3. pre!) (=>
     ...
     (and
      (test_crate!Y.impl&%11.tr3_enabled.? (Poly%test_crate!Y.State. pre!))
      (test_crate!Y.impl&%11.invariant.? (Poly%test_crate!Y.State. pre!))
   )))
