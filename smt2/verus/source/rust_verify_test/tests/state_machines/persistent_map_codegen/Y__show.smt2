...
(assert
 (distinct fuel%vstd!map.impl&%0.new. fuel%vstd!map.impl&%0.spec_index. fuel%vstd!map.axiom_map_index_decreases_finite.
  ...
  fuel%vstd!map_lib.impl&%0.submap_of. fuel%vstd!map_lib.impl&%0.union_prefer_right.
  ...
  fuel%vstd!set.axiom_set_empty_finite. fuel%vstd!set.axiom_set_insert_finite. fuel%test_crate!Y.impl&%11.initialize.
  fuel%test_crate!Y.impl&%11.tr1. fuel%test_crate!Y.impl&%11.tr2. fuel%test_crate!Y.impl&%11.tr3.
...
(declare-datatypes ((test_crate!Y.State. 0) (tuple%0. 0)) (((test_crate!Y.State./State
    (test_crate!Y.State./State/?c vstd!map.Map<int./int.>.)
   )
  ) ((tuple%0./tuple%0))
))
 ...
 (=>
  ...
  (forall ((K&. Dcr) (K& Type) (V&. Dcr) (V& Type) (self! Poly) (m2! Poly)) (!
    (= (vstd!map_lib.impl&%0.agrees.? K&. K& V&. V& self! m2!) (forall ((k$ Poly)) (!
       ...
       :pattern ((vstd!map.impl&%0.index.? K&. K& V&. V& m2! k$))
       :qid user_vstd__map_lib__impl&%0__agrees_21
       :skolemid skolem_user_vstd__map_lib__impl&%0__agrees_21
    )))
 ...
 (=>
  ...
  (forall ((K&. Dcr) (K& Type) (V&. Dcr) (V& Type) (self! Poly) (m2! Poly)) (!
    (= (vstd!map_lib.impl&%0.submap_of.? K&. K& V&. V& self! m2!) (forall ((k$ Poly)) (
       ...
       :qid user_vstd__map_lib__impl&%0__submap_of_22
       :skolemid skolem_user_vstd__map_lib__impl&%0__submap_of_22
    )))
...
(assert
 (forall ((pre! test_crate!Y.State.) (post! test_crate!Y.State.)) (!
   (= (req%test_crate!Y.show.tr1. pre! post!) (=>
     ...
     (test_crate!Y.impl&%11.tr1.? (Poly%test_crate!Y.State. pre!) (Poly%test_crate!Y.State.
       post!
   ))))
...
(assert
 (forall ((pre! test_crate!Y.State.) (post! test_crate!Y.State.)) (!
   (= (ens%test_crate!Y.show.tr1. pre! post!) (test_crate!Y.impl&%11.next.? (Poly%test_crate!Y.State.
      pre!
...
(assert
 (forall ((pre! test_crate!Y.State.) (post! test_crate!Y.State.)) (!
   (= (req%test_crate!Y.show.tr2. pre! post!) (=>
     ...
     (test_crate!Y.impl&%11.tr2.? (Poly%test_crate!Y.State. pre!) (Poly%test_crate!Y.State.
       post!
   ))))
...
(assert
 (forall ((pre! test_crate!Y.State.) (post! test_crate!Y.State.)) (!
   (= (ens%test_crate!Y.show.tr2. pre! post!) (test_crate!Y.impl&%11.next.? (Poly%test_crate!Y.State.
      pre!
     ) (Poly%test_crate!Y.State. post!)
   ))
...
(assert
 (forall ((pre! test_crate!Y.State.) (post! test_crate!Y.State.)) (!
   (= (req%test_crate!Y.show.tr3. pre! post!) (=>
     ...
     (test_crate!Y.impl&%11.tr3.? (Poly%test_crate!Y.State. pre!) (Poly%test_crate!Y.State.
       post!
   ))))
...
(assert
 (forall ((pre! test_crate!Y.State.) (post! test_crate!Y.State.)) (!
   (= (ens%test_crate!Y.show.tr3. pre! post!) (test_crate!Y.impl&%11.next.? (Poly%test_crate!Y.State.
      pre!
     ) (Poly%test_crate!Y.State. post!)
   ))
