...
(assert
 (distinct fuel%vstd!std_specs.option.impl&%0.is_Some. fuel%vstd!std_specs.option.impl&%0.is_None.
  ...
  fuel%vstd!state_machine_internal.opt_sub. fuel%test_crate!Y.impl&%15.tr1. fuel%test_crate!Y.impl&%15.tr2.
  fuel%test_crate!Y.impl&%15.tr3. fuel%test_crate!Y.impl&%15.tr4. fuel%vstd!array.group_array_axioms.
...
(assert
 (forall ((pre! test_crate!Y.State.) (post! test_crate!Y.State.)) (!
   (= (ens%test_crate!Y.show.tr1. pre! post!) (test_crate!Y.impl&%15.next.? (Poly%test_crate!Y.State.
      pre!
...
(assert
 (forall ((pre! test_crate!Y.State.) (post! test_crate!Y.State.)) (!
   (= (ens%test_crate!Y.show.tr2. pre! post!) (test_crate!Y.impl&%15.next.? (Poly%test_crate!Y.State.
      pre!
     ) (Poly%test_crate!Y.State. post!)
   ))
...
(assert
 (forall ((pre! test_crate!Y.State.) (post! test_crate!Y.State.)) (!
   (= (ens%test_crate!Y.show.tr3. pre! post!) (test_crate!Y.impl&%15.next.? (Poly%test_crate!Y.State.
      pre!
     ) (Poly%test_crate!Y.State. post!)
   ))
...
(declare-fun req%test_crate!Y.show.tr4. (test_crate!Y.State. test_crate!Y.State.)
 Bool
)
(declare-const %%global_location_label%%5 Bool)
(assert
 (forall ((pre! test_crate!Y.State.) (post! test_crate!Y.State.)) (!
   (= (req%test_crate!Y.show.tr4. pre! post!) (=>
     %%global_location_label%%5
     (test_crate!Y.impl&%15.tr4.? (Poly%test_crate!Y.State. pre!) (Poly%test_crate!Y.State.
       post!
   ))))
   :pattern ((req%test_crate!Y.show.tr4. pre! post!))
   :qid internal_req__test_crate!Y.show.tr4._definition
   :skolemid skolem_internal_req__test_crate!Y.show.tr4._definition
)))
(declare-fun ens%test_crate!Y.show.tr4. (test_crate!Y.State. test_crate!Y.State.)
 Bool
)
(assert
 (forall ((pre! test_crate!Y.State.) (post! test_crate!Y.State.)) (!
   (= (ens%test_crate!Y.show.tr4. pre! post!) (test_crate!Y.impl&%15.next.? (Poly%test_crate!Y.State.
      pre!
     ) (Poly%test_crate!Y.State. post!)
   ))
   :pattern ((ens%test_crate!Y.show.tr4. pre! post!))
