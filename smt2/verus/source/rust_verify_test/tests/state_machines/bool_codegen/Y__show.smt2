...
(assert
 (distinct fuel%test_crate!Y.impl&%10.init_false. fuel%test_crate!Y.impl&%10.init_true.
  fuel%test_crate!Y.impl&%10.tr_add. fuel%test_crate!Y.impl&%10.tr_have. fuel%test_crate!Y.impl&%10.tr_remove.
  fuel%test_crate!Y.impl&%10.tr_add_gen. fuel%test_crate!Y.impl&%10.tr_have_gen. fuel%test_crate!Y.impl&%10.tr_remove_gen.
...
(assert
 (forall ((pre! test_crate!Y.State.) (post! test_crate!Y.State.)) (!
   (= (ens%test_crate!Y.show.tr_add. pre! post!) (test_crate!Y.impl&%10.next.? (Poly%test_crate!Y.State.
      pre!
...
(assert
 (forall ((pre! test_crate!Y.State.) (post! test_crate!Y.State.)) (!
   (= (ens%test_crate!Y.show.tr_have. pre! post!) (test_crate!Y.impl&%10.next.? (Poly%test_crate!Y.State.
      pre!
     ) (Poly%test_crate!Y.State. post!)
   ))
...
;; Function-Specs test_crate::Y::show::tr_remove
(declare-fun req%test_crate!Y.show.tr_remove. (test_crate!Y.State. test_crate!Y.State.)
 Bool
)
(declare-const %%global_location_label%%2 Bool)
(assert
 (forall ((pre! test_crate!Y.State.) (post! test_crate!Y.State.)) (!
   (= (req%test_crate!Y.show.tr_remove. pre! post!) (=>
     %%global_location_label%%2
     (test_crate!Y.impl&%10.tr_remove.? (Poly%test_crate!Y.State. pre!) (Poly%test_crate!Y.State.
       post!
   ))))
   :pattern ((req%test_crate!Y.show.tr_remove. pre! post!))
   :qid internal_req__test_crate!Y.show.tr_remove._definition
   :skolemid skolem_internal_req__test_crate!Y.show.tr_remove._definition
)))
(declare-fun ens%test_crate!Y.show.tr_remove. (test_crate!Y.State. test_crate!Y.State.)
 Bool
)
(assert
 (forall ((pre! test_crate!Y.State.) (post! test_crate!Y.State.)) (!
   (= (ens%test_crate!Y.show.tr_remove. pre! post!) (test_crate!Y.impl&%10.next.? (Poly%test_crate!Y.State.
      pre!
     ) (Poly%test_crate!Y.State. post!)
   ))
   :pattern ((ens%test_crate!Y.show.tr_remove. pre! post!))
   :qid internal_ens__test_crate!Y.show.tr_remove._definition
   :skolemid skolem_internal_ens__test_crate!Y.show.tr_remove._definition
)))
...
(assert
 (forall ((pre! test_crate!Y.State.) (post! test_crate!Y.State.) (x! Bool)) (!
   (= (ens%test_crate!Y.show.tr_add_gen. pre! post! x!) (test_crate!Y.impl&%10.next.?
...
(assert
 (forall ((pre! test_crate!Y.State.) (post! test_crate!Y.State.) (x! Bool)) (!
   (= (ens%test_crate!Y.show.tr_have_gen. pre! post! x!) (test_crate!Y.impl&%10.next.?
     (Poly%test_crate!Y.State. pre!) (Poly%test_crate!Y.State. post!)
   ))
...
;; Function-Specs test_crate::Y::show::tr_remove_gen
(declare-fun req%test_crate!Y.show.tr_remove_gen. (test_crate!Y.State. test_crate!Y.State.
  Bool
 ) Bool
)
...
(assert
 (forall ((pre! test_crate!Y.State.) (post! test_crate!Y.State.) (x! Bool)) (!
   (= (req%test_crate!Y.show.tr_remove_gen. pre! post! x!) (=>
     %%global_location_label%%5
     (test_crate!Y.impl&%10.tr_remove_gen.? (Poly%test_crate!Y.State. pre!) (Poly%test_crate!Y.State.
       post!
      ) (B x!)
   )))
   :pattern ((req%test_crate!Y.show.tr_remove_gen. pre! post! x!))
   :qid internal_req__test_crate!Y.show.tr_remove_gen._definition
   :skolemid skolem_internal_req__test_crate!Y.show.tr_remove_gen._definition
)))
(declare-fun ens%test_crate!Y.show.tr_remove_gen. (test_crate!Y.State. test_crate!Y.State.
  Bool
 ) Bool
)
(assert
 (forall ((pre! test_crate!Y.State.) (post! test_crate!Y.State.) (x! Bool)) (!
   (= (ens%test_crate!Y.show.tr_remove_gen. pre! post! x!) (test_crate!Y.impl&%10.next.?
     (Poly%test_crate!Y.State. pre!) (Poly%test_crate!Y.State. post!)
   ))
   :pattern ((ens%test_crate!Y.show.tr_remove_gen. pre! post! x!))
   :qid internal_ens__test_crate!Y.show.tr_remove_gen._definition
   :skolemid skolem_internal_ens__test_crate!Y.show.tr_remove_gen._definition
)))
...
(assert
 (forall ((post! test_crate!Y.State.)) (!
   (= (req%test_crate!Y.show.init_false. post!) (=>
     ...
     (test_crate!Y.impl&%10.init_false.? (Poly%test_crate!Y.State. post!))
   ))
...
(assert
 (forall ((post! test_crate!Y.State.)) (!
   (= (ens%test_crate!Y.show.init_false. post!) (test_crate!Y.impl&%10.init.? (Poly%test_crate!Y.State.
      post!
   )))
...
(assert
 (forall ((post! test_crate!Y.State.)) (!
   (= (req%test_crate!Y.show.init_true. post!) (=>
     ...
     (test_crate!Y.impl&%10.init_true.? (Poly%test_crate!Y.State. post!))
   ))
...
(assert
 (forall ((post! test_crate!Y.State.)) (!
   (= (ens%test_crate!Y.show.init_true. post!) (test_crate!Y.impl&%10.init.? (Poly%test_crate!Y.State.
      post!
   )))
