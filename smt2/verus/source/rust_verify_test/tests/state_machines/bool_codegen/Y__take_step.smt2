...
(assert
 (distinct fuel%test_crate!Y.impl&%10.init_false. fuel%test_crate!Y.impl&%10.init_false_enabled.
...
(assert
 (forall ((no%param Int)) (!
   (= (req%test_crate!Y.take_step.init_false. no%param) (=>
     ...
     (test_crate!Y.impl&%10.init_false_enabled.? (I 0))
   ))
...
(assert
 (forall ((no%param Int)) (!
   (= (req%test_crate!Y.take_step.init_true. no%param) (=>
     ...
     (test_crate!Y.impl&%10.init_true_enabled.? (I 0))
   ))
...
(assert
 (forall ((pre! test_crate!Y.State.) (x! Bool)) (!
   (= (req%test_crate!Y.take_step.tr_have_gen. pre! x!) (=>
     ...
     (and
      (test_crate!Y.impl&%10.tr_have_gen_enabled.? (Poly%test_crate!Y.State. pre!) (B x!))
      (test_crate!Y.impl&%10.invariant.? (Poly%test_crate!Y.State. pre!))
   )))
...
(assert
 (forall ((pre! test_crate!Y.State.) (x! Bool)) (!
   (= (req%test_crate!Y.take_step.tr_remove_gen. pre! x!) (=>
     %%global_location_label%%5
     (and
      (test_crate!Y.impl&%10.tr_remove_gen_enabled.? (Poly%test_crate!Y.State. pre!) (B x!))
      (test_crate!Y.impl&%10.invariant.? (Poly%test_crate!Y.State. pre!))
   )))
   :pattern ((req%test_crate!Y.take_step.tr_remove_gen. pre! x!))
...
(declare-fun ens%test_crate!Y.take_step.tr_remove_gen. (test_crate!Y.State. Bool test_crate!Y.State.)
 Bool
)
(assert
 (forall ((pre! test_crate!Y.State.) (x! Bool) (post! test_crate!Y.State.)) (!
   (= (ens%test_crate!Y.take_step.tr_remove_gen. pre! x! post!) (and
   ...
   :pattern ((ens%test_crate!Y.take_step.tr_remove_gen. pre! x! post!))
...
(assert
 (forall ((pre! test_crate!Y.State.) (x! Bool)) (!
   (= (req%test_crate!Y.take_step.tr_add_gen. pre! x!) (=>
     ...
     (and
      (test_crate!Y.impl&%10.tr_add_gen_enabled.? (Poly%test_crate!Y.State. pre!) (B x!))
      (test_crate!Y.impl&%10.invariant.? (Poly%test_crate!Y.State. pre!))
   )))
