...
(declare-datatypes ((core!option.Option. 0) (vstd!tokens.InstanceId. 0) (test_crate!X.State.
  ...
  ((test_crate!X.State./State (test_crate!X.State./State/?t test_crate!X.Instance.)))
...
(declare-fun test_crate!X.State./State/t (test_crate!X.State.) test_crate!X.Instance.)
...
(assert
 (forall ((_t! test_crate!X.Instance.)) (!
   (=>
    (has_type (Poly%test_crate!X.Instance. _t!) TYPE%test_crate!X.Instance.)
...
(assert
 (forall ((x Poly)) (!
   (=>
    (has_type x TYPE%test_crate!X.State.)
    (has_type (Poly%test_crate!X.Instance. (test_crate!X.State./State/t (%Poly%test_crate!X.State.
        x
      ))
...
(assert
 (forall ((x test_crate!X.State.)) (!
   (=>
    ...
    (height_lt (height (Poly%test_crate!X.Instance. (test_crate!X.State./State/t x)))
     (height (Poly%test_crate!X.State. x))
   ))
   :pattern ((height (Poly%test_crate!X.Instance. (test_crate!X.State./State/t x))))
   :qid prelude_datatype_height_test_crate!X.State./State/t
   :skolemid skolem_prelude_datatype_height_test_crate!X.State./State/t
)))
(assert
...
;; Trait-Impl-Axiom
(assert
 (tr_bound%vstd!tokens.ValueToken. $ TYPE%test_crate!X.t. $ TYPE%test_crate!X.Instance.)
)

;; Trait-Impl-Axiom
(assert
 (tr_bound%vstd!tokens.UniqueValueToken. $ TYPE%test_crate!X.t. $ TYPE%test_crate!X.Instance.)
)
