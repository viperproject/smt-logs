...
(assert
 (distinct fuel%vstd!map.impl&%0.spec_index. fuel%vstd!map.axiom_map_index_decreases_finite.
  ...
  fuel%test_crate!X.impl&%4.tr_strong. fuel%test_crate!impl&%0.arrow_Bar_0. fuel%test_crate!impl&%0.arrow_Qax_0.
  fuel%test_crate!impl&%0.arrow_Duck_0. fuel%test_crate!tr_weak. fuel%test_crate!tr_strong.
...
(declare-datatypes ((test_crate!X.State. 0) (test_crate!Foo. 0) (tuple%0. 0) (tuple%2.
   0
  )
        ...
        (=>
         ...
         (and
          (and
           (=>
            (%B v!)
            (= (test_crate!X.State./State/b (%Poly%test_crate!X.State. post!)) 11)
           )
           (=>
            (not (%B v!))
...
(declare-fun ens%test_crate!test. (test_crate!X.State. test_crate!X.State. Bool Bool
  Bool Bool Bool
 ) Bool
)
(assert
 (forall ((pre! test_crate!X.State.) (post! test_crate!X.State.) (x! Bool) (y! Bool)
   (z! Bool) (w! Bool) (v! Bool)
  ) (!
   (= (ens%test_crate!test. pre! post! x! y! z! w! v!) (= (test_crate!X.impl&%4.tr.? (Poly%test_crate!X.State.
       pre!
      ) (Poly%test_crate!X.State. post!) (B x!) (B y!) (B z!) (B w!) (B v!)
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/state_machines-c25f1c939512e7ab-double_scoped_updates_if/test.rs:90:9: 90:92 (#0)
...
(declare-fun ens%test_crate!test2. (test_crate!X.State. test_crate!X.State. Bool Bool
  Bool Bool Bool
 ) Bool
)
(assert
 (forall ((pre! test_crate!X.State.) (post! test_crate!X.State.) (x! Bool) (y! Bool)
   ...
   (= (ens%test_crate!test2. pre! post! x! y! z! w! v!) (= (test_crate!X.impl&%4.tr_strong.?
      (Poly%test_crate!X.State. pre!) (Poly%test_crate!X.State. post!) (B x!) (B y!) (B
       z!
      ) (B w!) (B v!)
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/state_machines-c25f1c939512e7ab-double_scoped_updates_if/test.rs:115:9: 115:93 (#0)
(get-info :all-statistics)
(push)
 (declare-const pre! test_crate!X.State.)
 (declare-const post! test_crate!X.State.)
