...
(assert
 (distinct fuel%vstd!map.impl&%0.spec_index. fuel%vstd!map.axiom_map_index_decreases_finite.
  ...
  fuel%test_crate!X.impl&%4.tr. fuel%test_crate!X.impl&%4.tr_strong. fuel%test_crate!impl&%0.arrow_Bar_0.
...
(assert
 (forall ((s! test_crate!X.State.) (s1! test_crate!X.State.) (x! Bool) (y! Bool) (z!
    Bool
   )
  ) (!
   (= (ens%test_crate!test. s! s1! x! y! z!) (= (test_crate!X.impl&%4.tr.? (Poly%test_crate!X.State.
       s!
      ) (Poly%test_crate!X.State. s1!) (B x!) (B y!) (B z!)
     ) (=>
      (=>
       x!
       y!
   ...
   :pattern ((ens%test_crate!test. s! s1! x! y! z!))
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/state_machines-c25f1c939512e7ab-assert_in_if/test.rs:55:7: 55:68 (#0)
(get-info :all-statistics)
(push)
 (declare-const s! test_crate!X.State.)
 (declare-const s1! test_crate!X.State.)
 ...
 (assert
  (not (=>
    %%location_label%%0
    (= (test_crate!X.impl&%4.tr.? (Poly%test_crate!X.State. s!) (Poly%test_crate!X.State.
       s1!
      ) (B x!) (B y!) (B z!)
     ) (=>
      (=>
...
(assert
 (forall ((s! test_crate!X.State.) (s1! test_crate!X.State.) (x! Bool) (y! Bool) (z!
   ...
   (= (ens%test_crate!test2. s! s1! x! y! z!) (= (test_crate!X.impl&%4.tr_strong.? (Poly%test_crate!X.State.
       s!
      ) (Poly%test_crate!X.State. s1!) (B x!) (B y!) (B z!)
     ) (and
      (and
   ...
   :pattern ((ens%test_crate!test2. s! s1! x! y! z!))
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/state_machines-c25f1c939512e7ab-assert_in_if/test.rs:61:7: 61:69 (#0)
(get-info :all-statistics)
(push)
 (declare-const s! test_crate!X.State.)
 (declare-const s1! test_crate!X.State.)
 ...
 (assert
  (not (=>
    %%location_label%%0
    (= (test_crate!X.impl&%4.tr_strong.? (Poly%test_crate!X.State. s!) (Poly%test_crate!X.State.
       s1!
      ) (B x!) (B y!) (B z!)
     ) (and
      (and
