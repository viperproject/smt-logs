...
(assert
 (distinct fuel%vstd!map.impl&%0.spec_index. fuel%vstd!map.axiom_map_index_decreases_finite.
  ...
  fuel%vstd!state_machine_internal.impl&%3.update_at_index. fuel%test_crate!X.impl&%4.tr_strong.
  fuel%test_crate!X.impl&%4.tr_enabled. fuel%test_crate!X.impl&%4.invariant. fuel%vstd!array.group_array_axioms.
...
(declare-fun req%test_crate!X.take_step.tr. (test_crate!X.State. Int Int Int Bool)
 Bool
)
(declare-const %%global_location_label%%2 Bool)
(assert
 (forall ((pre! test_crate!X.State.) (x! Int) (y! Int) (z! Int) (b! Bool)) (!
   (= (req%test_crate!X.take_step.tr. pre! x! y! z! b!) (=>
     %%global_location_label%%2
     (and
      (test_crate!X.impl&%4.tr_enabled.? (Poly%test_crate!X.State. pre!) (I x!) (I y!) (
        I z!
       ) (B b!)
      )
      (test_crate!X.impl&%4.invariant.? (Poly%test_crate!X.State. pre!))
   )))
   :pattern ((req%test_crate!X.take_step.tr. pre! x! y! z! b!))
...
(declare-fun ens%test_crate!X.take_step.tr. (test_crate!X.State. Int Int Int Bool test_crate!X.State.)
 Bool
)
(assert
 (forall ((pre! test_crate!X.State.) (x! Int) (y! Int) (z! Int) (b! Bool) (post! test_crate!X.State.))
  (!
   (= (ens%test_crate!X.take_step.tr. pre! x! y! z! b! post!) (and
   ...
   :pattern ((ens%test_crate!X.take_step.tr. pre! x! y! z! b! post!))
