...
(declare-datatypes ((test_crate!X.State. 0) (tuple%0. 0) (tuple%2. 0)) (((test_crate!X.State./State
    (test_crate!X.State./State/?m vstd!map.Map<int./int.>.)
   )
...
;; Function-Specs test_crate::X::show::tr
(declare-fun req%test_crate!X.show.tr. (test_crate!X.State. test_crate!X.State. Int
  Int Int Bool
 ) Bool
)
(declare-const %%global_location_label%%2 Bool)
(assert
 (forall ((pre! test_crate!X.State.) (post! test_crate!X.State.) (x! Int) (y! Int) (
    z! Int
   ) (b! Bool)
  ) (!
   (= (req%test_crate!X.show.tr. pre! post! x! y! z! b!) (=>
     %%global_location_label%%2
     (test_crate!X.impl&%4.tr.? (Poly%test_crate!X.State. pre!) (Poly%test_crate!X.State.
       post!
      ) (I x!) (I y!) (I z!) (B b!)
   )))
   :pattern ((req%test_crate!X.show.tr. pre! post! x! y! z! b!))
   :qid internal_req__test_crate!X.show.tr._definition
   :skolemid skolem_internal_req__test_crate!X.show.tr._definition
)))
(declare-fun ens%test_crate!X.show.tr. (test_crate!X.State. test_crate!X.State. Int
  Int Int Bool
 ) Bool
)
(assert
 (forall ((pre! test_crate!X.State.) (post! test_crate!X.State.) (x! Int) (y! Int) (
   ...
   (= (ens%test_crate!X.show.tr. pre! post! x! y! z! b!) (test_crate!X.impl&%4.next.?
     (Poly%test_crate!X.State. pre!) (Poly%test_crate!X.State. post!)
   ))
   :pattern ((ens%test_crate!X.show.tr. pre! post! x! y! z! b!))
   :qid internal_ens__test_crate!X.show.tr._definition
   :skolemid skolem_internal_ens__test_crate!X.show.tr._definition
)))
