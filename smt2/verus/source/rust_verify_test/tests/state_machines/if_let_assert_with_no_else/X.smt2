...
(assert
 (distinct fuel%vstd!map.impl&%0.spec_index. fuel%vstd!map.axiom_map_index_decreases_finite.
  ...
  fuel%vstd!state_machine_internal.impl&%3.update_at_index. fuel%test_crate!X.impl&%0.arrow_3.
  fuel%test_crate!X.impl&%0.arrow_2. fuel%test_crate!X.impl&%0.arrow_1. fuel%test_crate!X.impl&%0.arrow_tr_0.
  fuel%test_crate!X.impl&%0.arrow_tr_1. fuel%test_crate!X.impl&%0.arrow_tr_2. fuel%test_crate!X.impl&%0.arrow_tr_3.
  fuel%test_crate!X.impl&%0.arrow_dummy_to_use_type_params_0. fuel%test_crate!X.impl&%1.is_tr.
  fuel%test_crate!X.impl&%1.get_tr_0. fuel%test_crate!X.impl&%1.get_tr_1. fuel%test_crate!X.impl&%1.get_tr_2.
  fuel%test_crate!X.impl&%1.get_tr_3. fuel%test_crate!X.impl&%1.is_dummy_to_use_type_params.
  ...
  fuel%test_crate!X.impl&%3.get_dummy_to_use_type_params_0. fuel%test_crate!X.impl&%4.tr.
  fuel%test_crate!X.impl&%4.tr_strong. fuel%test_crate!X.impl&%4.tr_enabled. fuel%test_crate!X.impl&%4.next_by.
...
(declare-datatypes ((test_crate!X.State. 0) (test_crate!X.Step. 0) (test_crate!X.Config.
  ...
  ((test_crate!X.Step./tr (test_crate!X.Step./tr/?0 Int) (test_crate!X.Step./tr/?1 Int)
    (test_crate!X.Step./tr/?2 Int) (test_crate!X.Step./tr/?3 Bool)
...
(declare-fun test_crate!X.Step./tr/1 (test_crate!X.Step.) Int)
(declare-fun test_crate!X.Step./tr/2 (test_crate!X.Step.) Int)
...
(declare-fun test_crate!X.impl&%4.tr.? (Poly Poly Poly Poly Poly Poly) Bool)
...
(declare-fun test_crate!X.impl&%0.arrow_2.? (Poly) Int)

;; Function-Decl test_crate::X::Step::arrow_1
(declare-fun test_crate!X.impl&%0.arrow_1.? (Poly) Int)
...
(declare-fun test_crate!X.impl&%0.arrow_tr_1.? (Poly) Int)

;; Function-Decl test_crate::X::Step::arrow_tr_2
(declare-fun test_crate!X.impl&%0.arrow_tr_2.? (Poly) Int)
...
(declare-fun test_crate!X.impl&%1.get_tr_1.? (Poly) Int)

;; Function-Decl test_crate::X::Step::get_tr_2
(declare-fun test_crate!X.impl&%1.get_tr_2.? (Poly) Int)
...
(declare-fun test_crate!X.impl&%4.tr_strong.? (Poly Poly Poly Poly Poly Poly) Bool)

;; Function-Decl test_crate::X::State::tr_enabled
(declare-fun test_crate!X.impl&%4.tr_enabled.? (Poly Poly Poly Poly Poly) Bool)
...
(assert
 (=>
  ...
  (forall ((pre! Poly) (post! Poly) (x! Poly) (y! Poly) (z! Poly) (b! Poly)) (!
    (= (test_crate!X.impl&%4.tr.? pre! post! x! y! z! b!) (let
      ((tmp_assert$ true))
      (let
               ...
               (let
                ...
                (let
                 ((update_tmp_m$1 (%Poly%vstd!map.Map<int./int.>. (vstd!map.impl&%0.insert.? $ INT $ INT
                     (Poly%vstd!map.Map<int./int.>. update_tmp_m$) y! (I 12)
                 ))))
                 (tuple%2./tuple%2 (B tmp_assert$1) (Poly%vstd!map.Map<int./int.>. update_tmp_m$1))
            )))))
            (let
             ((tmp_assert$2 (%B (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. tmp%%$1))))))
             (let
              ((update_tmp_m$2 (%Poly%vstd!map.Map<int./int.>. (tuple%2./tuple%2/1 (%Poly%tuple%2. (
                    Poly%tuple%2. tmp%%$1
              ))))))
              (tuple%2./tuple%2 (B tmp_assert$2) (Poly%vstd!map.Map<int./int.>. update_tmp_m$2))
           )))
           (tuple%2./tuple%2 (B tmp_assert$) (Poly%vstd!map.Map<int./int.>. update_tmp_m$))
        )))
        (let
         ((tmp_assert$3 (%B (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. tmp%%$))))))
         (let
          ((update_tmp_m$3 (%Poly%vstd!map.Map<int./int.>. (tuple%2./tuple%2/1 (%Poly%tuple%2. (
                Poly%tuple%2. tmp%%$
          ))))))
          (let
           ((update_tmp_m$4 (%Poly%vstd!map.Map<int./int.>. (vstd!map.impl&%0.insert.? $ INT $ INT
               (Poly%vstd!map.Map<int./int.>. update_tmp_m$3) z! (I 13)
           ))))
           (=>
            tmp_assert$3
            (= (test_crate!X.State./State/m (%Poly%test_crate!X.State. post!)) update_tmp_m$4)
    ))))))))
    :pattern ((test_crate!X.impl&%4.tr.? pre! post! x! y! z! b!))
      ...
      (let
       ...
       (let
        ...
        (let
         ...
         (let
          ((b$ (test_crate!X.Step./tr/3 (%Poly%test_crate!X.Step. step!))))
          (test_crate!X.impl&%4.tr.? pre! post! (I x$) (I y$) (I z$) (B b$))
    ))))))
...
(assert
 (=>
  ...
  (forall ((pre! Poly) (post! Poly) (x! Poly) (y! Poly) (z! Poly) (b! Poly)) (!
    (= (test_crate!X.impl&%4.tr_strong.? pre! post! x! y! z! b!) (let
      ((update_tmp_m$ (test_crate!X.State./State/m (%Poly%test_crate!X.State. pre!))))
      (and
       (=>
        (%B b!)
       ...
       (let
        ...
        (let
         ((update_tmp_m$4 (%Poly%vstd!map.Map<int./int.>. (vstd!map.impl&%0.insert.? $ INT $ INT
             (Poly%vstd!map.Map<int./int.>. update_tmp_m$1) z! (I 13)
         ))))
         (= (test_crate!X.State./State/m (%Poly%test_crate!X.State. post!)) update_tmp_m$4)
    )))))
    :pattern ((test_crate!X.impl&%4.tr_strong.? pre! post! x! y! z! b!))
...
(assert
 (=>
  ...
  (forall ((pre! Poly) (x! Poly) (y! Poly) (z! Poly) (b! Poly)) (!
    (= (test_crate!X.impl&%4.tr_enabled.? pre! x! y! z! b!) true)
    :pattern ((test_crate!X.impl&%4.tr_enabled.? pre! x! y! z! b!))
      ...
      (let
       ...
       (let
        ...
        (let
         ...
         (let
          ((b$ (test_crate!X.Step./tr/3 (%Poly%test_crate!X.Step. step!))))
          (test_crate!X.impl&%4.tr_strong.? pre! post! (I x$) (I y$) (I z$) (B b$))
    ))))))
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/state_machines-c25f1c939512e7ab-if_let_assert_with_no_else/test.rs:40:1: 56:3 (#42)
         ...
         (=>
          ...
          (=>
           (= update_tmp_m$1@ (%Poly%vstd!map.Map<int./int.>. (vstd!map.impl&%0.insert.? $ INT
              $ INT (Poly%vstd!map.Map<int./int.>. update_tmp_m@) (I y!) (I 12)
           )))
           %%switch_label%%0
       ))))
       (=>
