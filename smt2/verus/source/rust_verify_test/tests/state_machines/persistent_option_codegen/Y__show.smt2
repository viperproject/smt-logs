...
(assert
 (distinct fuel%vstd!std_specs.option.impl&%0.is_Some. fuel%vstd!std_specs.option.impl&%0.get_Some_0.
  ...
  fuel%test_crate!Y.impl&%15.tr1. fuel%test_crate!Y.impl&%15.tr2. fuel%test_crate!Y.impl&%15.tr3.
...
(assert
 (forall ((post! test_crate!Y.State.)) (!
   (= (ens%test_crate!Y.show.initialize. post!) (test_crate!Y.impl&%15.init.? (Poly%test_crate!Y.State.
      post!
   )))
