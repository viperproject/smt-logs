...
(assert
 (distinct fuel%vstd!std_specs.option.impl&%0.is_Some. fuel%vstd!std_specs.option.impl&%0.get_Some_0.
  ...
  fuel%vstd!state_machine_internal.opt_agree. fuel%test_crate!Y.impl&%15.initialize.
  fuel%test_crate!Y.impl&%15.initialize_enabled. fuel%test_crate!Y.impl&%15.tr1_strong.
  fuel%test_crate!Y.impl&%15.tr1_enabled. fuel%test_crate!Y.impl&%15.tr2_strong. fuel%test_crate!Y.impl&%15.tr2_enabled.
  fuel%test_crate!Y.impl&%15.tr3_strong. fuel%test_crate!Y.impl&%15.tr3_enabled. fuel%test_crate!Y.impl&%15.invariant.
  fuel%test_crate!Y.impl&%15.the_inv. fuel%vstd!array.group_array_axioms. fuel%vstd!map.group_map_axioms.
...
(assert
 (forall ((no%param Int)) (!
   (= (req%test_crate!Y.take_step.initialize. no%param) (=>
     ...
     (test_crate!Y.impl&%15.initialize_enabled.? (I 0))
   ))
...
(assert
 (forall ((pre! test_crate!Y.State.)) (!
   (= (req%test_crate!Y.take_step.tr1. pre!) (=>
     ...
     (and
      (test_crate!Y.impl&%15.tr1_enabled.? (Poly%test_crate!Y.State. pre!))
...
(assert
 (forall ((pre! test_crate!Y.State.)) (!
   (= (req%test_crate!Y.take_step.tr2. pre!) (=>
     ...
     (and
      (test_crate!Y.impl&%15.tr2_enabled.? (Poly%test_crate!Y.State. pre!))
      (test_crate!Y.impl&%15.invariant.? (Poly%test_crate!Y.State. pre!))
   )))
...
(assert
 (forall ((pre! test_crate!Y.State.)) (!
   (= (req%test_crate!Y.take_step.tr3. pre!) (=>
     ...
     (and
      (test_crate!Y.impl&%15.tr3_enabled.? (Poly%test_crate!Y.State. pre!))
      (test_crate!Y.impl&%15.invariant.? (Poly%test_crate!Y.State. pre!))
   )))
