...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/state_machines-c25f1c939512e7ab-inherent_safety_condition_option_deposit/test.rs:48:5: 48:47 (#0)
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/state_machines-c25f1c939512e7ab-inherent_safety_condition_option_deposit/test.rs:35:1: 53:3 (#42)
(get-info :all-statistics)
(push)
 (declare-const pre! test_crate!X.State.)
 (declare-const tmp%1 Bool)
    ...
    (=>
     ...
     (=>
      ...
      (and
       ...
       (=>
        (ens%vstd!state_machine_internal.assert_deposit_option. tmp%1)
        (=>
         %%location_label%%1
         (is-core!option.Option./None update_tmp_t@)
 ))))))))
...
(declare-fun req%test_crate!X.impl&%4.tr. (test_crate!X.Instance. Int) Bool)
(declare-const %%global_location_label%%2 Bool)
(assert
 (forall ((self! test_crate!X.Instance.) (param_token_0_t! Int)) (!
   (= (req%test_crate!X.impl&%4.tr. self! param_token_0_t!) (=>
     %%global_location_label%%2
     (= param_token_0_t! 5)
   ))
   :pattern ((req%test_crate!X.impl&%4.tr. self! param_token_0_t!))
   :qid internal_req__test_crate!X.impl&__4.tr._definition
   :skolemid skolem_internal_req__test_crate!X.impl&__4.tr._definition
)))
