...
(declare-const fuel%test_crate!Y.impl&%1.is_upd. FuelId)
(declare-const fuel%test_crate!Y.impl&%1.is_req. FuelId)
...
(declare-const fuel%test_crate!Y.impl&%2.arrow_1. FuelId)
(declare-const fuel%test_crate!Y.impl&%2.arrow_initialize_0. FuelId)
(declare-const fuel%test_crate!Y.impl&%2.arrow_initialize_1. FuelId)
...
(declare-const fuel%test_crate!Y.impl&%3.get_initialize_0. FuelId)
(declare-const fuel%test_crate!Y.impl&%3.get_initialize_1. FuelId)
...
(declare-const fuel%test_crate!Y.impl&%13.upd. FuelId)
(declare-const fuel%test_crate!Y.impl&%13.upd_strong. FuelId)
(declare-const fuel%test_crate!Y.impl&%13.upd_enabled. FuelId)
(declare-const fuel%test_crate!Y.impl&%13.req. FuelId)
(declare-const fuel%test_crate!Y.impl&%13.req_strong. FuelId)
(declare-const fuel%test_crate!Y.impl&%13.req_enabled. FuelId)
...
(assert
 (distinct fuel%vstd!std_specs.option.impl&%0.is_Some. fuel%vstd!std_specs.option.impl&%0.get_Some_0.
  ...
  fuel%test_crate!Y.impl&%1.is_upd. fuel%test_crate!Y.impl&%1.is_req. fuel%test_crate!Y.impl&%1.is_dummy_to_use_type_params.
  fuel%test_crate!Y.impl&%1.get_dummy_to_use_type_params_0. fuel%test_crate!Y.impl&%2.arrow_1.
  fuel%test_crate!Y.impl&%2.arrow_initialize_0. fuel%test_crate!Y.impl&%2.arrow_initialize_1.
  fuel%test_crate!Y.impl&%2.arrow_dummy_to_use_type_params_0. fuel%test_crate!Y.impl&%3.is_initialize.
  fuel%test_crate!Y.impl&%3.get_initialize_0. fuel%test_crate!Y.impl&%3.get_initialize_1.
  ...
  fuel%test_crate!Y.impl&%13.upd. fuel%test_crate!Y.impl&%13.upd_strong. fuel%test_crate!Y.impl&%13.upd_enabled.
  fuel%test_crate!Y.impl&%13.req. fuel%test_crate!Y.impl&%13.req_strong. fuel%test_crate!Y.impl&%13.req_enabled.
  ...
  fuel%test_crate!Y.impl&%13.invariant. fuel%vstd!array.group_array_axioms. fuel%vstd!map.group_map_axioms.
...
(declare-datatypes ((core!option.Option. 0) (vstd!tokens.InstanceId. 0) (test_crate!Y.State.
   ...
   0
  ) (test_crate!Y.y. 0) (tuple%0. 0) (tuple%1. 0) (tuple%3. 0)
  ...
  ((test_crate!Y.State./State (test_crate!Y.State./State/?x Int) (test_crate!Y.State./State/?y
     Int
   ))
  ) ((test_crate!Y.Step./upd) (test_crate!Y.Step./req) (test_crate!Y.Step./dummy_to_use_type_params
    (test_crate!Y.Step./dummy_to_use_type_params/?0 test_crate!Y.State.)
   )
  ) ((test_crate!Y.Config./initialize (test_crate!Y.Config./initialize/?0 Int) (test_crate!Y.Config./initialize/?1
     Int
    )
  ...
  ) ((test_crate!Y.y./y (test_crate!Y.y./y/?dummy_instance test_crate!Y.Instance.) (test_crate!Y.y./y/?no_copy
     vstd!state_machine_internal.NoCopy.
   ))
...
(declare-fun test_crate!Y.State./State/y (test_crate!Y.State.) Int)
(declare-fun test_crate!Y.Step./dummy_to_use_type_params/0 (test_crate!Y.Step.) test_crate!Y.State.)
(declare-fun test_crate!Y.Config./initialize/0 (test_crate!Y.Config.) Int)
(declare-fun test_crate!Y.Config./initialize/1 (test_crate!Y.Config.) Int)
...
(declare-fun test_crate!Y.y./y/dummy_instance (test_crate!Y.y.) test_crate!Y.Instance.)
(declare-fun test_crate!Y.y./y/no_copy (test_crate!Y.y.) vstd!state_machine_internal.NoCopy.)
...
(assert
 (forall ((x test_crate!Y.State.)) (!
   (= (test_crate!Y.State./State/y x) (test_crate!Y.State./State/?y x))
   :pattern ((test_crate!Y.State./State/y x))
   :qid internal_test_crate!Y.State./State/y_accessor_definition
   :skolemid skolem_internal_test_crate!Y.State./State/y_accessor_definition
)))
(assert
 (forall ((x test_crate!Y.State.)) (!
...
(assert
 (forall ((x test_crate!Y.Config.)) (!
   (= (test_crate!Y.Config./initialize/0 x) (test_crate!Y.Config./initialize/?0 x))
   :pattern ((test_crate!Y.Config./initialize/0 x))
   :qid internal_test_crate!Y.Config./initialize/0_accessor_definition
   :skolemid skolem_internal_test_crate!Y.Config./initialize/0_accessor_definition
)))
(assert
 (forall ((x test_crate!Y.Config.)) (!
   (= (test_crate!Y.Config./initialize/1 x) (test_crate!Y.Config./initialize/?1 x))
   :pattern ((test_crate!Y.Config./initialize/1 x))
   :qid internal_test_crate!Y.Config./initialize/1_accessor_definition
   :skolemid skolem_internal_test_crate!Y.Config./initialize/1_accessor_definition
)))
(assert
 (forall ((x test_crate!Y.Config.)) (!
...
(assert
 (forall ((_dummy_instance! test_crate!Y.Instance.) (_no_copy! vstd!state_machine_internal.NoCopy.))
  (!
   (=>
    (has_type (Poly%test_crate!Y.Instance. _dummy_instance!) TYPE%test_crate!Y.Instance.)
    (has_type (Poly%test_crate!Y.y. (test_crate!Y.y./y _dummy_instance! _no_copy!)) TYPE%test_crate!Y.y.)
   )
   :pattern ((has_type (Poly%test_crate!Y.y. (test_crate!Y.y./y _dummy_instance! _no_copy!))
     TYPE%test_crate!Y.y.
   ))
   :qid internal_test_crate!Y.y./y_constructor_definition
   :skolemid skolem_internal_test_crate!Y.y./y_constructor_definition
)))
(assert
 (forall ((x test_crate!Y.y.)) (!
   (= (test_crate!Y.y./y/dummy_instance x) (test_crate!Y.y./y/?dummy_instance x))
   :pattern ((test_crate!Y.y./y/dummy_instance x))
   :qid internal_test_crate!Y.y./y/dummy_instance_accessor_definition
   :skolemid skolem_internal_test_crate!Y.y./y/dummy_instance_accessor_definition
)))
(assert
 (forall ((x Poly)) (!
   (=>
    (has_type x TYPE%test_crate!Y.y.)
    (has_type (Poly%test_crate!Y.Instance. (test_crate!Y.y./y/dummy_instance (%Poly%test_crate!Y.y.
        x
      ))
     ) TYPE%test_crate!Y.Instance.
   ))
   :pattern ((test_crate!Y.y./y/dummy_instance (%Poly%test_crate!Y.y. x)) (has_type x
     TYPE%test_crate!Y.y.
   ))
   :qid internal_test_crate!Y.y./y/dummy_instance_invariant_definition
   :skolemid skolem_internal_test_crate!Y.y./y/dummy_instance_invariant_definition
)))
(assert
 (forall ((x test_crate!Y.y.)) (!
   (= (test_crate!Y.y./y/no_copy x) (test_crate!Y.y./y/?no_copy x))
   :pattern ((test_crate!Y.y./y/no_copy x))
   :qid internal_test_crate!Y.y./y/no_copy_accessor_definition
   :skolemid skolem_internal_test_crate!Y.y./y/no_copy_accessor_definition
)))
(assert
 (forall ((x tuple%0.)) (!
...
;; Function-Decl test_crate::Y::State::upd
(declare-fun test_crate!Y.impl&%13.upd.? (Poly Poly) Bool)

;; Function-Decl test_crate::Y::State::req
(declare-fun test_crate!Y.impl&%13.req.? (Poly Poly) Bool)
...
;; Function-Decl test_crate::Y::State::upd_enabled
(declare-fun test_crate!Y.impl&%13.upd_enabled.? (Poly) Bool)

;; Function-Decl test_crate::Y::State::upd_strong
(declare-fun test_crate!Y.impl&%13.upd_strong.? (Poly Poly) Bool)

;; Function-Decl test_crate::Y::State::req_enabled
(declare-fun test_crate!Y.impl&%13.req_enabled.? (Poly) Bool)

;; Function-Decl test_crate::Y::State::req_strong
(declare-fun test_crate!Y.impl&%13.req_strong.? (Poly Poly) Bool)
...
;; Function-Decl test_crate::Y::Step::is_upd
(declare-fun test_crate!Y.impl&%1.is_upd.? (Poly) Bool)

;; Function-Decl test_crate::Y::Step::is_req
(declare-fun test_crate!Y.impl&%1.is_req.? (Poly) Bool)
...
;; Function-Decl test_crate::Y::Config::arrow_1
(declare-fun test_crate!Y.impl&%2.arrow_1.? (Poly) Int)

;; Function-Decl test_crate::Y::Config::arrow_initialize_0
(declare-fun test_crate!Y.impl&%2.arrow_initialize_0.? (Poly) Int)

;; Function-Decl test_crate::Y::Config::arrow_initialize_1
(declare-fun test_crate!Y.impl&%2.arrow_initialize_1.? (Poly) Int)
...
;; Function-Decl test_crate::Y::Config::get_initialize_0
(declare-fun test_crate!Y.impl&%3.get_initialize_0.? (Poly) Int)

;; Function-Decl test_crate::Y::Config::get_initialize_1
(declare-fun test_crate!Y.impl&%3.get_initialize_1.? (Poly) Int)
...
;; Function-Axioms test_crate::Y::State::upd
(assert
 (fuel_bool_default fuel%test_crate!Y.impl&%13.upd.)
)
(assert
 (=>
  (fuel_bool fuel%test_crate!Y.impl&%13.upd.)
  (forall ((pre! Poly) (post! Poly)) (!
    (= (test_crate!Y.impl&%13.upd.? pre! post!) (let
      ((update_tmp_x$ (test_crate!Y.State./State/x (%Poly%test_crate!Y.State. pre!))))
      (and
       (ite
        (= (test_crate!Y.State./State/x (%Poly%test_crate!Y.State. pre!)) 0)
        (let
         ((update_tmp_y$ 1))
         (= (test_crate!Y.State./State/y (%Poly%test_crate!Y.State. post!)) update_tmp_y$)
        )
        (let
         ((update_tmp_y$ 2))
         (= (test_crate!Y.State./State/y (%Poly%test_crate!Y.State. post!)) update_tmp_y$)
    ...
    :pattern ((test_crate!Y.impl&%13.upd.? pre! post!))
    :qid internal_test_crate!Y.impl&__13.upd.?_definition
    :skolemid skolem_internal_test_crate!Y.impl&__13.upd.?_definition
))))

;; Function-Axioms test_crate::Y::State::req
(assert
 (fuel_bool_default fuel%test_crate!Y.impl&%13.req.)
)
(assert
 (=>
  (fuel_bool fuel%test_crate!Y.impl&%13.req.)
  (forall ((pre! Poly) (post! Poly)) (!
    (= (test_crate!Y.impl&%13.req.? pre! post!) (let
      ((update_tmp_x$ (test_crate!Y.State./State/x (%Poly%test_crate!Y.State. pre!))))
      (and
       (ite
        (= (test_crate!Y.State./State/x (%Poly%test_crate!Y.State. pre!)) 0)
        (and
         (= (test_crate!Y.State./State/y (%Poly%test_crate!Y.State. pre!)) 1)
         (let
          ((update_tmp_y$ 20))
          (= (test_crate!Y.State./State/y (%Poly%test_crate!Y.State. post!)) update_tmp_y$)
        ))
        (and
         (= (test_crate!Y.State./State/y (%Poly%test_crate!Y.State. pre!)) 2)
         (let
          ((update_tmp_y$ 25))
          (= (test_crate!Y.State./State/y (%Poly%test_crate!Y.State. post!)) update_tmp_y$)
       )))
    ...
    :pattern ((test_crate!Y.impl&%13.req.? pre! post!))
    :qid internal_test_crate!Y.impl&__13.req.?_definition
    :skolemid skolem_internal_test_crate!Y.impl&__13.req.?_definition
))))
 ...
 (=>
  ...
  (forall ((pre! Poly) (post! Poly) (step! Poly)) (!
    (= (test_crate!Y.impl&%13.next_by.? pre! post! step!) (ite
      (is-test_crate!Y.Step./upd (%Poly%test_crate!Y.Step. step!))
      (test_crate!Y.impl&%13.upd.? pre! post!)
      (and
       (is-test_crate!Y.Step./req (%Poly%test_crate!Y.Step. step!))
       (test_crate!Y.impl&%13.req.? pre! post!)
    )))
...
(assert
 (=>
  ...
  (forall ((post! Poly) (x! Poly) (y! Poly)) (!
    (= (test_crate!Y.impl&%13.initialize.? post! x! y!) (let
      ((update_tmp_x$ (%I x!)))
      (let
       ((update_tmp_y$ (%I y!)))
       (and
    ...
    :pattern ((test_crate!Y.impl&%13.initialize.? post! x! y!))
 ...
 (=>
  ...
  (forall ((post! Poly) (step! Poly)) (!
    (= (test_crate!Y.impl&%13.init_by.? post! step!) (and
      ...
      (let
       ((x$ (test_crate!Y.Config./initialize/0 (%Poly%test_crate!Y.Config. step!))))
       (let
        ((y$ (test_crate!Y.Config./initialize/1 (%Poly%test_crate!Y.Config. step!))))
        (test_crate!Y.impl&%13.initialize.? post! (I x$) (I y$))
    ))))
...
(assert
 (=>
  ...
  (forall ((x! Poly) (y! Poly)) (!
    (= (test_crate!Y.impl&%13.initialize_enabled.? x! y!) true)
    :pattern ((test_crate!Y.impl&%13.initialize_enabled.? x! y!))
...
;; Function-Axioms test_crate::Y::State::upd_enabled
(assert
 (fuel_bool_default fuel%test_crate!Y.impl&%13.upd_enabled.)
)
(assert
 (=>
  (fuel_bool fuel%test_crate!Y.impl&%13.upd_enabled.)
  (forall ((pre! Poly)) (!
    (= (test_crate!Y.impl&%13.upd_enabled.? pre!) true)
    :pattern ((test_crate!Y.impl&%13.upd_enabled.? pre!))
    :qid internal_test_crate!Y.impl&__13.upd_enabled.?_definition
    :skolemid skolem_internal_test_crate!Y.impl&__13.upd_enabled.?_definition
))))

;; Function-Axioms test_crate::Y::State::upd_strong
(assert
 (fuel_bool_default fuel%test_crate!Y.impl&%13.upd_strong.)
)
(assert
 (=>
  (fuel_bool fuel%test_crate!Y.impl&%13.upd_strong.)
  (forall ((pre! Poly) (post! Poly)) (!
    (= (test_crate!Y.impl&%13.upd_strong.? pre! post!) (let
      ((update_tmp_x$ (test_crate!Y.State./State/x (%Poly%test_crate!Y.State. pre!))))
      (and
       (ite
        (= (test_crate!Y.State./State/x (%Poly%test_crate!Y.State. pre!)) 0)
    ...
    :pattern ((test_crate!Y.impl&%13.upd_strong.? pre! post!))
    :qid internal_test_crate!Y.impl&__13.upd_strong.?_definition
    :skolemid skolem_internal_test_crate!Y.impl&__13.upd_strong.?_definition
))))

;; Function-Axioms test_crate::Y::State::req_enabled
(assert
 (fuel_bool_default fuel%test_crate!Y.impl&%13.req_enabled.)
)
(assert
 (=>
  (fuel_bool fuel%test_crate!Y.impl&%13.req_enabled.)
  (forall ((pre! Poly)) (!
    (= (test_crate!Y.impl&%13.req_enabled.? pre!) (ite
      (= (test_crate!Y.State./State/x (%Poly%test_crate!Y.State. pre!)) 0)
      (= (test_crate!Y.State./State/y (%Poly%test_crate!Y.State. pre!)) 1)
      (= (test_crate!Y.State./State/y (%Poly%test_crate!Y.State. pre!)) 2)
    ))
    :pattern ((test_crate!Y.impl&%13.req_enabled.? pre!))
    :qid internal_test_crate!Y.impl&__13.req_enabled.?_definition
    :skolemid skolem_internal_test_crate!Y.impl&__13.req_enabled.?_definition
))))

;; Function-Axioms test_crate::Y::State::req_strong
(assert
 (fuel_bool_default fuel%test_crate!Y.impl&%13.req_strong.)
)
(assert
 (=>
  (fuel_bool fuel%test_crate!Y.impl&%13.req_strong.)
  (forall ((pre! Poly) (post! Poly)) (!
    (= (test_crate!Y.impl&%13.req_strong.? pre! post!) (let
      ((update_tmp_x$ (test_crate!Y.State./State/x (%Poly%test_crate!Y.State. pre!))))
      (and
       (ite
        (= (test_crate!Y.State./State/x (%Poly%test_crate!Y.State. pre!)) 0)
    ...
    :pattern ((test_crate!Y.impl&%13.req_strong.? pre! post!))
    :qid internal_test_crate!Y.impl&__13.req_strong.?_definition
    :skolemid skolem_internal_test_crate!Y.impl&__13.req_strong.?_definition
))))
...
(assert
 (forall ((self! test_crate!Y.Instance.) (param_token_x! test_crate!Y.x.) (pre%param_token_y!
   ...
   (= (ens%test_crate!Y.impl&%10.upd. self! param_token_x! pre%param_token_y! param_token_y!)
    (and
     (has_type (Poly%test_crate!Y.y. param_token_y!) TYPE%test_crate!Y.y.)
     (= (%Poly%vstd!tokens.InstanceId. (vstd!tokens.ValueToken.instance_id.? $ TYPE%test_crate!Y.y.
...
;; Function-Axioms test_crate::Y::Step::is_upd
(assert
 (fuel_bool_default fuel%test_crate!Y.impl&%1.is_upd.)
)
(assert
 (=>
  (fuel_bool fuel%test_crate!Y.impl&%1.is_upd.)
  (forall ((self! Poly)) (!
    (= (test_crate!Y.impl&%1.is_upd.? self!) (is-test_crate!Y.Step./upd (%Poly%test_crate!Y.Step.
       self!
    )))
    :pattern ((test_crate!Y.impl&%1.is_upd.? self!))
    :qid internal_test_crate!Y.impl&__1.is_upd.?_definition
    :skolemid skolem_internal_test_crate!Y.impl&__1.is_upd.?_definition
))))

;; Function-Axioms test_crate::Y::Step::is_req
(assert
 (fuel_bool_default fuel%test_crate!Y.impl&%1.is_req.)
)
(assert
 (=>
  (fuel_bool fuel%test_crate!Y.impl&%1.is_req.)
  (forall ((self! Poly)) (!
    (= (test_crate!Y.impl&%1.is_req.? self!) (is-test_crate!Y.Step./req (%Poly%test_crate!Y.Step.
       self!
    )))
    :pattern ((test_crate!Y.impl&%1.is_req.? self!))
    :qid internal_test_crate!Y.impl&__1.is_req.?_definition
    :skolemid skolem_internal_test_crate!Y.impl&__1.is_req.?_definition
))))
...
;; Function-Axioms test_crate::Y::Config::arrow_1
(assert
 (fuel_bool_default fuel%test_crate!Y.impl&%2.arrow_1.)
)
(assert
 (=>
  (fuel_bool fuel%test_crate!Y.impl&%2.arrow_1.)
  (forall ((self! Poly)) (!
    (= (test_crate!Y.impl&%2.arrow_1.? self!) (test_crate!Y.Config./initialize/1 (%Poly%test_crate!Y.Config.
       self!
    )))
    :pattern ((test_crate!Y.impl&%2.arrow_1.? self!))
    :qid internal_test_crate!Y.impl&__2.arrow_1.?_definition
    :skolemid skolem_internal_test_crate!Y.impl&__2.arrow_1.?_definition
))))

;; Function-Axioms test_crate::Y::Config::arrow_initialize_0
(assert
 (fuel_bool_default fuel%test_crate!Y.impl&%2.arrow_initialize_0.)
)
(assert
 (=>
  (fuel_bool fuel%test_crate!Y.impl&%2.arrow_initialize_0.)
  (forall ((self! Poly)) (!
    (= (test_crate!Y.impl&%2.arrow_initialize_0.? self!) (test_crate!Y.Config./initialize/0
      (%Poly%test_crate!Y.Config. self!)
    ))
    :pattern ((test_crate!Y.impl&%2.arrow_initialize_0.? self!))
    :qid internal_test_crate!Y.impl&__2.arrow_initialize_0.?_definition
    :skolemid skolem_internal_test_crate!Y.impl&__2.arrow_initialize_0.?_definition
))))

;; Function-Axioms test_crate::Y::Config::arrow_initialize_1
(assert
 (fuel_bool_default fuel%test_crate!Y.impl&%2.arrow_initialize_1.)
)
(assert
 (=>
  (fuel_bool fuel%test_crate!Y.impl&%2.arrow_initialize_1.)
  (forall ((self! Poly)) (!
    (= (test_crate!Y.impl&%2.arrow_initialize_1.? self!) (test_crate!Y.Config./initialize/1
      (%Poly%test_crate!Y.Config. self!)
    ))
    :pattern ((test_crate!Y.impl&%2.arrow_initialize_1.? self!))
    :qid internal_test_crate!Y.impl&__2.arrow_initialize_1.?_definition
    :skolemid skolem_internal_test_crate!Y.impl&__2.arrow_initialize_1.?_definition
))))
...
;; Function-Axioms test_crate::Y::Config::get_initialize_0
(assert
 (fuel_bool_default fuel%test_crate!Y.impl&%3.get_initialize_0.)
)
(assert
 (=>
  (fuel_bool fuel%test_crate!Y.impl&%3.get_initialize_0.)
  (forall ((self! Poly)) (!
    (= (test_crate!Y.impl&%3.get_initialize_0.? self!) (test_crate!Y.Config./initialize/0
      (%Poly%test_crate!Y.Config. self!)
    ))
    :pattern ((test_crate!Y.impl&%3.get_initialize_0.? self!))
    :qid internal_test_crate!Y.impl&__3.get_initialize_0.?_definition
    :skolemid skolem_internal_test_crate!Y.impl&__3.get_initialize_0.?_definition
))))

;; Function-Axioms test_crate::Y::Config::get_initialize_1
(assert
 (fuel_bool_default fuel%test_crate!Y.impl&%3.get_initialize_1.)
)
(assert
 (=>
  (fuel_bool fuel%test_crate!Y.impl&%3.get_initialize_1.)
  (forall ((self! Poly)) (!
    (= (test_crate!Y.impl&%3.get_initialize_1.? self!) (test_crate!Y.Config./initialize/1
      (%Poly%test_crate!Y.Config. self!)
    ))
    :pattern ((test_crate!Y.impl&%3.get_initialize_1.? self!))
    :qid internal_test_crate!Y.impl&__3.get_initialize_1.?_definition
    :skolemid skolem_internal_test_crate!Y.impl&__3.get_initialize_1.?_definition
))))
 ...
 (=>
  ...
  (forall ((pre! Poly) (post! Poly) (step! Poly)) (!
    (= (test_crate!Y.impl&%13.next_strong_by.? pre! post! step!) (ite
      (is-test_crate!Y.Step./upd (%Poly%test_crate!Y.Step. step!))
      (test_crate!Y.impl&%13.upd_strong.? pre! post!)
      (and
       (is-test_crate!Y.Step./req (%Poly%test_crate!Y.Step. step!))
       (test_crate!Y.impl&%13.req_strong.? pre! post!)
    )))
...
;; Trait-Impl-Axiom
(assert
 (tr_bound%vstd!tokens.UniqueValueToken. $ TYPE%test_crate!Y.y. $ INT)
)
