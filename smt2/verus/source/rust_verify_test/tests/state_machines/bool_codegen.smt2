...
(assert
 (distinct fuel%vstd!std_specs.option.impl&%0.is_Some. fuel%vstd!std_specs.option.impl&%0.get_Some_0.
  ...
  fuel%test_crate!Y.impl&%10.tr_add. fuel%test_crate!Y.impl&%10.tr_add_strong. fuel%test_crate!Y.impl&%10.tr_have.
  fuel%test_crate!Y.impl&%10.tr_have_strong. fuel%test_crate!Y.impl&%10.tr_remove.
 ...
 (=>
  ...
  (forall ((pre! Poly) (post! Poly)) (!
    (= (test_crate!rel_tr1.? pre! post!) (=>
      (= (test_crate!Y.State./State/b (%Poly%test_crate!Y.State. pre!)) false)
 ...
 (=>
  ...
  (forall ((pre! Poly) (post! Poly)) (!
    (= (test_crate!rel_tr3.? pre! post!) (and
      (= (test_crate!Y.State./State/b (%Poly%test_crate!Y.State. pre!)) true)
      (= (test_crate!Y.State./State/b (%Poly%test_crate!Y.State. post!)) false)
    ))
...
(assert
 (=>
  ...
  (forall ((pre! Poly) (post! Poly) (x! Poly)) (!
    (= (test_crate!rel_tr4.? pre! post! x!) (=>
      (or
       (not (test_crate!Y.State./State/b (%Poly%test_crate!Y.State. pre!)))
       (not (%B x!))
      )
      (= (test_crate!Y.State./State/b (%Poly%test_crate!Y.State. post!)) (or
...
(assert
 (=>
  ...
  (forall ((pre! Poly) (post! Poly) (x! Poly)) (!
    (= (test_crate!rel_tr4_strong.? pre! post! x!) (and
      (or
       (not (test_crate!Y.State./State/b (%Poly%test_crate!Y.State. pre!)))
       (not (%B x!))
      )
...
(assert
 (=>
  ...
  (forall ((pre! Poly) (post! Poly) (x! Poly)) (!
    (= (test_crate!rel_tr6.? pre! post! x!) (and
      (=>
       (%B x!)
       (test_crate!Y.State./State/b (%Poly%test_crate!Y.State. pre!))
      )
      (= (test_crate!Y.State./State/b (%Poly%test_crate!Y.State. post!)) (and
        (test_crate!Y.State./State/b (%Poly%test_crate!Y.State. pre!))
        (not (%B x!))
    ))))
    :pattern ((test_crate!rel_tr6.? pre! post! x!))
...
(assert
 (=>
  ...
  (forall ((pre! Poly) (post! Poly) (x! Poly)) (!
    (= (test_crate!rel_tr6_strong.? pre! post! x!) (and
      (=>
       (%B x!)
       (test_crate!Y.State./State/b (%Poly%test_crate!Y.State. pre!))
      )
    ...
    :pattern ((test_crate!rel_tr6_strong.? pre! post! x!))
...
(assert
 (forall ((self! test_crate!Y.Instance.) (param_token_0_b! test_crate!Y.b.)) (!
   (= (ens%test_crate!Y.impl&%7.tr_add. self! param_token_0_b!) (= (%Poly%vstd!tokens.InstanceId.
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/state_machines-c25f1c939512e7ab-bool_codegen/test.rs:144:7: 144:60 (#0)
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/state_machines-c25f1c939512e7ab-bool_codegen/test.rs:162:7: 162:22 (#0)
(get-info :all-statistics)
(push)
 ...
 (assert
  (not (=>
    (ens%test_crate!Y.impl&%7.init_false. 0 tmp%%@)
    (=>
        ...
        (=>
         ...
         (and
          ...
          (=>
           tmp%1
           (=>
            (ens%test_crate!Y.impl&%7.tr_add. inst@ tok@)
            (=>
             ...
             (and
              ...
              (=>
               ...
               (and
                (=>
                 %%location_label%%2
                 (req%test_crate!Y.impl&%7.tr_have. inst@ tok@)
                )
                (and
                 (=>
                  %%location_label%%3
                  (req%test_crate!Y.impl&%7.tr_remove. inst@ tok@)
                 )
                 (=>
                  (ens%test_crate!Y.impl&%7.tr_add_gen. inst@ true opt_tok@)
                  (=>
                   (= tmp%3 (is-core!option.Option./Some opt_tok@))
                   (and
                    (=>
                     %%location_label%%4
                     tmp%3
                    ...
                    (=>
                     tmp%3
                     (=>
                      (= tmp%4 (= (%Poly%vstd!tokens.InstanceId. (vstd!tokens.SimpleToken.instance_id.? $ TYPE%test_crate!Y.b.
                      ...
                      (and
                       ...
                       (=>
                        ...
                        (and
                         (=>
                          %%location_label%%6
                          (req%test_crate!Y.impl&%7.tr_have_gen. inst@ true opt_tok@)
                         )
                         (and
                          (=>
                           %%location_label%%7
                           (req%test_crate!Y.impl&%7.tr_remove_gen. inst@ true opt_tok@)
                          )
                          (=>
                           (ens%test_crate!Y.impl&%7.tr_add_gen. inst@ false opt_tok$1@)
                           (=>
                            (= tmp%5 (is-core!option.Option./None opt_tok$1@))
                            (and
                             (=>
                              %%location_label%%8
                              tmp%5
                             ...
                             (=>
                              ...
                              (and
                               (=>
                                %%location_label%%9
                                (req%test_crate!Y.impl&%7.tr_have_gen. inst@ false opt_tok$1@)
                               )
                               (=>
                                %%location_label%%10
                                (req%test_crate!Y.impl&%7.tr_remove_gen. inst@ false opt_tok$1@)
 )))))))))))))))))))))))))))))))
 (get-info :version)
 (set-option :rlimit 30000000)
 (check-sat)
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/state_machines-c25f1c939512e7ab-bool_codegen/test.rs:183:7: 183:27 (#0)
(get-info :all-statistics)
(push)
 (declare-const no%param Int)
 (declare-const tmp%1 Bool)
        ...
        (=>
         ...
         (and
          ...
          (=>
           tmp%1
           (=>
            (ens%test_crate!Y.impl&%7.tr_add_gen. inst@ false opt_tok@)
            (=>
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/state_machines-c25f1c939512e7ab-bool_codegen/test.rs:192:7: 192:22 (#0)
(get-info :all-statistics)
(push)
 (declare-const no%param Int)
 (declare-const tmp%1 Bool)
 ...
 (assert
  (not (=>
    (ens%test_crate!Y.impl&%7.init_true. 0 tmp%%@)
    (=>
     (= verus_tmp_inst@ (%Poly%test_crate!Y.Instance. (tuple%2./tuple%2/0 (%Poly%tuple%2.
         (Poly%tuple%2. tmp%%@)
     ))))
