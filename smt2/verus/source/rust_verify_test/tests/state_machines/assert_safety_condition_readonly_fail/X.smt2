 ...
 (=>
  ...
  (forall ((pre! Poly) (post! Poly) (step! Poly)) (!
    (= (test_crate!X.impl&%4.next_by.? pre! post! step!) (and
      ...
      (test_crate!X.impl&%4.tr.? pre! post!)
    ))
 ...
 (=>
  ...
  (forall ((pre! Poly) (post! Poly) (step! Poly)) (!
    (= (test_crate!X.impl&%4.next_strong_by.? pre! post! step!) (and
      (is-test_crate!X.Step./tr (%Poly%test_crate!X.Step. step!))
      (test_crate!X.impl&%4.tr_strong.? pre! post!)
    ))
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/state_machines-c25f1c939512e7ab-assert_safety_condition_readonly_fail/test.rs:35:1: 45:3 (#42)
