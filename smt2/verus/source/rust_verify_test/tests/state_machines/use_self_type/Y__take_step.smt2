...
(assert
 (distinct fuel%test_crate!Y.impl&%13.ini. fuel%test_crate!Y.impl&%13.ini_enabled.
  fuel%test_crate!Y.impl&%13.tr_strong. fuel%test_crate!Y.impl&%13.tr_enabled. fuel%test_crate!Y.impl&%13.tr2_strong.
  fuel%test_crate!Y.impl&%13.tr2_enabled. fuel%test_crate!Y.impl&%13.tr3_strong. fuel%test_crate!Y.impl&%13.tr3_enabled.
  fuel%test_crate!Y.impl&%13.invariant. fuel%test_crate!Y.impl&%13.add1. fuel%vstd!array.group_array_axioms.
...
(declare-datatypes ((core!option.Option. 0) (test_crate!Y.State. 0)) (((core!option.Option./None)
...
;; Function-Specs test_crate::Y::take_step::ini
(declare-fun req%test_crate!Y.take_step.ini. (test_crate!Y.State.) Bool)
(declare-const %%global_location_label%%0 Bool)
(assert
 (forall ((t! test_crate!Y.State.)) (!
   (= (req%test_crate!Y.take_step.ini. t!) (=>
     %%global_location_label%%0
     (test_crate!Y.impl&%13.ini_enabled.? (Poly%test_crate!Y.State. t!))
   ))
   :pattern ((req%test_crate!Y.take_step.ini. t!))
   :qid internal_req__test_crate!Y.take_step.ini._definition
   :skolemid skolem_internal_req__test_crate!Y.take_step.ini._definition
)))
(declare-fun ens%test_crate!Y.take_step.ini. (test_crate!Y.State. test_crate!Y.State.)
 Bool
)
(assert
 (forall ((t! test_crate!Y.State.) (post! test_crate!Y.State.)) (!
   (= (ens%test_crate!Y.take_step.ini. t! post!) (and
   ...
   :pattern ((ens%test_crate!Y.take_step.ini. t! post!))
   :qid internal_ens__test_crate!Y.take_step.ini._definition
   :skolemid skolem_internal_ens__test_crate!Y.take_step.ini._definition
)))
...
;; Function-Specs test_crate::Y::take_step::tr
(declare-fun req%test_crate!Y.take_step.tr. (test_crate!Y.State. Int) Bool)
(declare-const %%global_location_label%%1 Bool)
(assert
 (forall ((pre! test_crate!Y.State.) (a! Int)) (!
   (= (req%test_crate!Y.take_step.tr. pre! a!) (=>
     %%global_location_label%%1
     (and
      (test_crate!Y.impl&%13.tr_enabled.? (Poly%test_crate!Y.State. pre!) (I a!))
      (test_crate!Y.impl&%13.invariant.? (Poly%test_crate!Y.State. pre!))
   )))
   :pattern ((req%test_crate!Y.take_step.tr. pre! a!))
   :qid internal_req__test_crate!Y.take_step.tr._definition
   :skolemid skolem_internal_req__test_crate!Y.take_step.tr._definition
)))
(declare-fun ens%test_crate!Y.take_step.tr. (test_crate!Y.State. Int test_crate!Y.State.)
 Bool
)
(assert
 (forall ((pre! test_crate!Y.State.) (a! Int) (post! test_crate!Y.State.)) (!
   (= (ens%test_crate!Y.take_step.tr. pre! a! post!) (and
     (has_type (Poly%test_crate!Y.State. post!) TYPE%test_crate!Y.State.)
     (and
      (test_crate!Y.impl&%13.tr_strong.? (Poly%test_crate!Y.State. pre!) (Poly%test_crate!Y.State.
        post!
       ) (I a!)
      )
      (test_crate!Y.impl&%13.invariant.? (Poly%test_crate!Y.State. post!))
   )))
   :pattern ((ens%test_crate!Y.take_step.tr. pre! a! post!))
   :qid internal_ens__test_crate!Y.take_step.tr._definition
   :skolemid skolem_internal_ens__test_crate!Y.take_step.tr._definition
)))
...
(declare-fun req%test_crate!Y.take_step.tr2. (test_crate!Y.State. core!option.Option.)
 Bool
)
(declare-const %%global_location_label%%2 Bool)
(assert
 (forall ((pre! test_crate!Y.State.) (y! core!option.Option.)) (!
   (= (req%test_crate!Y.take_step.tr2. pre! y!) (=>
     %%global_location_label%%2
     (and
      (test_crate!Y.impl&%13.tr2_enabled.? (Poly%test_crate!Y.State. pre!) (Poly%core!option.Option.
        y!
      ))
      (test_crate!Y.impl&%13.invariant.? (Poly%test_crate!Y.State. pre!))
   )))
   :pattern ((req%test_crate!Y.take_step.tr2. pre! y!))
...
(declare-fun ens%test_crate!Y.take_step.tr2. (test_crate!Y.State. core!option.Option.
  test_crate!Y.State.
 ) Bool
)
(assert
 (forall ((pre! test_crate!Y.State.) (y! core!option.Option.) (post! test_crate!Y.State.))
  (!
   (= (ens%test_crate!Y.take_step.tr2. pre! y! post!) (and
     (has_type (Poly%test_crate!Y.State. post!) TYPE%test_crate!Y.State.)
     (and
   ...
   :pattern ((ens%test_crate!Y.take_step.tr2. pre! y! post!))
