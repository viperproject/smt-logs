...
(assert
 (distinct fuel%test_crate!Y.impl&%13.ini. fuel%test_crate!Y.impl&%13.tr. fuel%test_crate!Y.impl&%13.tr2.
  fuel%test_crate!Y.impl&%13.tr3. fuel%test_crate!Y.impl&%13.add1. fuel%vstd!array.group_array_axioms.
...
(declare-datatypes ((core!option.Option. 0) (test_crate!Y.State. 0) (tuple%0. 0))
...
;; Function-Specs test_crate::Y::show::tr
(declare-fun req%test_crate!Y.show.tr. (test_crate!Y.State. test_crate!Y.State. Int)
 Bool
)
(declare-const %%global_location_label%%0 Bool)
(assert
 (forall ((pre! test_crate!Y.State.) (post! test_crate!Y.State.) (a! Int)) (!
   (= (req%test_crate!Y.show.tr. pre! post! a!) (=>
     %%global_location_label%%0
     (test_crate!Y.impl&%13.tr.? (Poly%test_crate!Y.State. pre!) (Poly%test_crate!Y.State.
       post!
      ) (I a!)
   )))
   :pattern ((req%test_crate!Y.show.tr. pre! post! a!))
   :qid internal_req__test_crate!Y.show.tr._definition
   :skolemid skolem_internal_req__test_crate!Y.show.tr._definition
)))
(declare-fun ens%test_crate!Y.show.tr. (test_crate!Y.State. test_crate!Y.State. Int)
 Bool
)
(assert
 (forall ((pre! test_crate!Y.State.) (post! test_crate!Y.State.) (a! Int)) (!
   (= (ens%test_crate!Y.show.tr. pre! post! a!) (test_crate!Y.impl&%13.next.? (Poly%test_crate!Y.State.
      pre!
     ) (Poly%test_crate!Y.State. post!)
   ))
   :pattern ((ens%test_crate!Y.show.tr. pre! post! a!))
   :qid internal_ens__test_crate!Y.show.tr._definition
   :skolemid skolem_internal_ens__test_crate!Y.show.tr._definition
)))

;; Function-Specs test_crate::Y::show::tr2
(declare-fun req%test_crate!Y.show.tr2. (test_crate!Y.State. test_crate!Y.State. core!option.Option.)
 Bool
)
(declare-const %%global_location_label%%1 Bool)
(assert
 (forall ((pre! test_crate!Y.State.) (post! test_crate!Y.State.) (y! core!option.Option.))
  (!
   (= (req%test_crate!Y.show.tr2. pre! post! y!) (=>
     %%global_location_label%%1
     (test_crate!Y.impl&%13.tr2.? (Poly%test_crate!Y.State. pre!) (Poly%test_crate!Y.State.
       post!
      ) (Poly%core!option.Option. y!)
   )))
   :pattern ((req%test_crate!Y.show.tr2. pre! post! y!))
   :qid internal_req__test_crate!Y.show.tr2._definition
   :skolemid skolem_internal_req__test_crate!Y.show.tr2._definition
)))
(declare-fun ens%test_crate!Y.show.tr2. (test_crate!Y.State. test_crate!Y.State. core!option.Option.)
 Bool
)
(assert
 (forall ((pre! test_crate!Y.State.) (post! test_crate!Y.State.) (y! core!option.Option.))
  (!
   (= (ens%test_crate!Y.show.tr2. pre! post! y!) (test_crate!Y.impl&%13.next.? (Poly%test_crate!Y.State.
      pre!
     ) (Poly%test_crate!Y.State. post!)
   ))
   :pattern ((ens%test_crate!Y.show.tr2. pre! post! y!))
...
;; Function-Specs test_crate::Y::show::ini
(declare-fun req%test_crate!Y.show.ini. (test_crate!Y.State. test_crate!Y.State.)
 Bool
)
(declare-const %%global_location_label%%3 Bool)
(assert
 (forall ((post! test_crate!Y.State.) (t! test_crate!Y.State.)) (!
   (= (req%test_crate!Y.show.ini. post! t!) (=>
     %%global_location_label%%3
     (test_crate!Y.impl&%13.ini.? (Poly%test_crate!Y.State. post!) (Poly%test_crate!Y.State.
       t!
   ))))
   :pattern ((req%test_crate!Y.show.ini. post! t!))
   :qid internal_req__test_crate!Y.show.ini._definition
   :skolemid skolem_internal_req__test_crate!Y.show.ini._definition
)))
(declare-fun ens%test_crate!Y.show.ini. (test_crate!Y.State. test_crate!Y.State.)
 Bool
)
(assert
 (forall ((post! test_crate!Y.State.) (t! test_crate!Y.State.)) (!
   (= (ens%test_crate!Y.show.ini. post! t!) (test_crate!Y.impl&%13.init.? (Poly%test_crate!Y.State.
      post!
   )))
   :pattern ((ens%test_crate!Y.show.ini. post! t!))
   :qid internal_ens__test_crate!Y.show.ini._definition
   :skolemid skolem_internal_ens__test_crate!Y.show.ini._definition
)))
