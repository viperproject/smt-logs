...
(assert
 (=>
  ...
  (forall ((pre! Poly) (post! Poly) (step! Poly)) (!
    (= (test_crate!X.impl&%4.next_by.? pre! post! step!) false)
...
(assert
 (=>
  ...
  (forall ((pre! Poly) (post! Poly) (step! Poly)) (!
    (= (test_crate!X.impl&%4.next_strong_by.? pre! post! step!) false)
 ...
 (=>
  ...
  (forall ((pre! Poly) (post! Poly)) (!
    (= (test_crate!X.impl&%4.next_strong.? pre! post!) (exists ((step$ Poly)) (!
       ...
       :pattern ((test_crate!X.impl&%4.next_strong_by.? pre! post! step$))
       :qid user_test_crate__X__State__next_strong_1
       :skolemid skolem_user_test_crate__X__State__next_strong_1
    )))
 ...
 (=>
  ...
  (forall ((post! Poly)) (!
    (= (test_crate!X.impl&%4.init.? post!) (exists ((step$ Poly)) (!
       ...
       :pattern ((test_crate!X.impl&%4.init_by.? post! step$))
       :qid user_test_crate__X__State__init_2
       :skolemid skolem_user_test_crate__X__State__init_2
    )))
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/state_machines-c25f1c939512e7ab-assert_safety_condition_property_fail/test.rs:35:1: 45:3 (#42)
(get-info :all-statistics)
(push)
 (declare-const pre! test_crate!X.State.)
 (declare-const tmp%1 Bool)
 (declare-const update_tmp_t@ Int)
 (assert
  fuel_defaults
 )
 ...
 (assert
  (not (=>
    ...
    (=>
     ...
     (=>
      (= tmp%1 (= (test_crate!X.State./State/t (%Poly%test_crate!X.State. (Poly%test_crate!X.State.
           pre!
         ))
        ) 0
      ))
