...
(assert
 (distinct fuel%vstd!std_specs.option.impl&%0.is_Some. fuel%vstd!std_specs.option.impl&%0.get_Some_0.
  ...
  fuel%vstd!set.impl&%0.subset_of. fuel%vstd!set.impl&%0.spec_le. fuel%vstd!set.axiom_set_empty.
  fuel%vstd!set.axiom_set_insert_same. fuel%vstd!set.axiom_set_insert_different. fuel%vstd!set.axiom_set_union.
  fuel%vstd!set.axiom_set_ext_equal. fuel%vstd!set.axiom_set_ext_equal_deep. fuel%test_crate!Y.impl&%0.arrow_0.
  fuel%test_crate!Y.impl&%0.arrow_dummy_to_use_type_params_0. fuel%test_crate!Y.impl&%1.is_tr_add.
  fuel%test_crate!Y.impl&%1.is_tr_have. fuel%test_crate!Y.impl&%1.is_tr_add_gen. fuel%test_crate!Y.impl&%1.is_tr_have_gen.
  ...
  fuel%test_crate!Y.impl&%3.is_initialize. fuel%test_crate!Y.impl&%3.is_dummy_to_use_type_params.
  fuel%test_crate!Y.impl&%3.get_dummy_to_use_type_params_0. fuel%test_crate!Y.impl&%11.initialize.
  fuel%test_crate!Y.impl&%11.initialize_enabled. fuel%test_crate!Y.impl&%11.tr_add.
  ...
  fuel%test_crate!Y.impl&%11.tr_add_gen_enabled. fuel%test_crate!Y.impl&%11.tr_have_gen.
...
(declare-datatypes ((core!option.Option. 0) (vstd!tokens.InstanceId. 0) (test_crate!Y.State.
  ...
  ((test_crate!Y.Step./tr_add) (test_crate!Y.Step./tr_have) (test_crate!Y.Step./tr_add_gen)
   (test_crate!Y.Step./tr_have_gen) (test_crate!Y.Step./dummy_to_use_type_params (test_crate!Y.Step./dummy_to_use_type_params/?0
     test_crate!Y.State.
   ))
  ...
  ) ((test_crate!Y.b./b (test_crate!Y.b./b/?dummy_instance test_crate!Y.Instance.)))
...
(assert
 (forall ((_dummy_instance! test_crate!Y.Instance.)) (!
   (=>
    ...
    (has_type (Poly%test_crate!Y.b. (test_crate!Y.b./b _dummy_instance!)) TYPE%test_crate!Y.b.)
   )
   :pattern ((has_type (Poly%test_crate!Y.b. (test_crate!Y.b./b _dummy_instance!)) TYPE%test_crate!Y.b.))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (s1! Poly) (s2! Poly) (a! Poly)) (!
    ...
    :qid user_vstd__set__axiom_set_union_10
    :skolemid skolem_user_vstd__set__axiom_set_union_10
))))
 ...
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (self! Poly) (s2! Poly)) (!
    (= (vstd!set.impl&%0.subset_of.? A&. A& self! s2!) (forall ((a$ Poly)) (!
       ...
       :pattern ((vstd!set.impl&%0.contains.? A&. A& s2! a$))
       :qid user_vstd__set__impl&%0__subset_of_14
       :skolemid skolem_user_vstd__set__impl&%0__subset_of_14
    )))
    ...
    (= (test_crate!Y.impl&%11.next_by.? pre! post! step!) (ite
      ...
      (ite
       ...
       (ite
        ...
        (test_crate!Y.impl&%11.tr_add_gen.? pre! post!)
        (and
         (is-test_crate!Y.Step./tr_have_gen (%Poly%test_crate!Y.Step. step!))
         (test_crate!Y.impl&%11.tr_have_gen.? pre! post!)
    )))))
 ...
 (=>
  ...
  (forall ((pre! Poly) (post! Poly)) (!
    (= (test_crate!Y.impl&%11.next.? pre! post!) (exists ((step$ Poly)) (!
       ...
       :pattern ((test_crate!Y.impl&%11.next_by.? pre! post! step$))
       :qid user_test_crate__Y__State__next_15
       :skolemid skolem_user_test_crate__Y__State__next_15
    )))
 ...
 (=>
  ...
  (forall ((post! Poly)) (!
    (= (test_crate!Y.impl&%11.init.? post!) (exists ((step$ Poly)) (!
       ...
       :pattern ((test_crate!Y.impl&%11.init_by.? post! step$))
       :qid user_test_crate__Y__State__init_16
       :skolemid skolem_user_test_crate__Y__State__init_16
    )))
...
(assert
 (forall ((self! test_crate!Y.b.) (s! test_crate!Y.b.)) (!
   (= (ens%test_crate!Y.impl&%4.clone. self! s!) (and
     (has_type (Poly%test_crate!Y.b. s!) TYPE%test_crate!Y.b.)
     (= self! s!)
   ))
  ...
  (forall ((pre! Poly) (post! Poly) (step! Poly)) (!
    (= (test_crate!Y.impl&%11.next_strong_by.? pre! post! step!) (ite
      ...
      (ite
       ...
       (ite
        (is-test_crate!Y.Step./tr_add_gen (%Poly%test_crate!Y.Step. step!))
        (test_crate!Y.impl&%11.tr_add_gen_strong.? pre! post!)
        (and
         (is-test_crate!Y.Step./tr_have_gen (%Poly%test_crate!Y.Step. step!))
         (test_crate!Y.impl&%11.tr_have_gen_strong.? pre! post!)
    )))))
 ...
 (=>
  ...
  (forall ((pre! Poly) (post! Poly)) (!
    (= (test_crate!Y.impl&%11.next_strong.? pre! post!) (exists ((step$ Poly)) (!
       ...
       :pattern ((test_crate!Y.impl&%11.next_strong_by.? pre! post! step$))
       :qid user_test_crate__Y__State__next_strong_17
       :skolemid skolem_user_test_crate__Y__State__next_strong_17
    )))
...
;; Trait-Impl-Axiom
(assert
 (tr_bound%core!clone.Clone. $ TYPE%test_crate!Y.b.)
)
