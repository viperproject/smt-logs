...
(assert
 (distinct fuel%vstd!set.impl&%0.subset_of. fuel%vstd!set.axiom_set_empty. fuel%vstd!set.axiom_set_insert_same.
  fuel%vstd!set.axiom_set_insert_different. fuel%vstd!set.axiom_set_union. fuel%vstd!set.axiom_set_ext_equal.
  fuel%vstd!set.axiom_set_ext_equal_deep. fuel%test_crate!Y.impl&%11.initialize. fuel%test_crate!Y.impl&%11.tr_add.
  fuel%test_crate!Y.impl&%11.tr_have. fuel%test_crate!Y.impl&%11.tr_add_gen. fuel%test_crate!Y.impl&%11.tr_have_gen.
...
(declare-fun test_crate!Y.impl&%11.tr_add_gen.? (Poly Poly) Bool)
...
(declare-fun test_crate!Y.impl&%11.tr_have_gen.? (Poly Poly) Bool)
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (s1! Poly) (s2! Poly) (a! Poly)) (!
    ...
    :qid user_vstd__set__axiom_set_union_3
    :skolemid skolem_user_vstd__set__axiom_set_union_3
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (s1! Poly) (s2! Poly)) (!
    ...
    :qid user_vstd__set__axiom_set_ext_equal_5
    :skolemid skolem_user_vstd__set__axiom_set_ext_equal_5
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (s1! Poly) (s2! Poly)) (!
    ...
    :qid user_vstd__set__axiom_set_ext_equal_deep_6
    :skolemid skolem_user_vstd__set__axiom_set_ext_equal_deep_6
))))
...
(assert
 (=>
  ...
  (forall ((pre! Poly) (post! Poly)) (!
    (= (test_crate!Y.impl&%11.tr_add_gen.? pre! post!) (let
      ((update_tmp_b$ (test_crate!Y.State./State/b (%Poly%test_crate!Y.State. pre!))))
      (let
    ...
    :pattern ((test_crate!Y.impl&%11.tr_add_gen.? pre! post!))
 ...
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (self! Poly) (s2! Poly)) (!
    (= (vstd!set.impl&%0.subset_of.? A&. A& self! s2!) (forall ((a$ Poly)) (!
       ...
       :pattern ((vstd!set.impl&%0.contains.? A&. A& s2! a$))
       :qid user_vstd__set__impl&%0__subset_of_7
       :skolemid skolem_user_vstd__set__impl&%0__subset_of_7
    )))
...
(assert
 (=>
  ...
  (forall ((pre! Poly) (post! Poly)) (!
    (= (test_crate!Y.impl&%11.tr_have_gen.? pre! post!) (let
      ((update_tmp_b$ (test_crate!Y.State./State/b (%Poly%test_crate!Y.State. pre!))))
      (and
    ...
    :pattern ((test_crate!Y.impl&%11.tr_have_gen.? pre! post!))
...
(assert
 (forall ((pre! test_crate!Y.State.) (post! test_crate!Y.State.)) (!
   (= (req%test_crate!Y.show.tr_add_gen. pre! post!) (=>
     %%global_location_label%%2
     (test_crate!Y.impl&%11.tr_add_gen.? (Poly%test_crate!Y.State. pre!) (Poly%test_crate!Y.State.
       post!
   ))))
   :pattern ((req%test_crate!Y.show.tr_add_gen. pre! post!))
...
(assert
 (forall ((pre! test_crate!Y.State.) (post! test_crate!Y.State.)) (!
   (= (ens%test_crate!Y.show.tr_add_gen. pre! post!) (test_crate!Y.impl&%11.next.? (Poly%test_crate!Y.State.
      pre!
     ) (Poly%test_crate!Y.State. post!)
   ))
   :pattern ((ens%test_crate!Y.show.tr_add_gen. pre! post!))
...
(assert
 (forall ((pre! test_crate!Y.State.) (post! test_crate!Y.State.)) (!
   (= (req%test_crate!Y.show.tr_have_gen. pre! post!) (=>
     %%global_location_label%%3
     (test_crate!Y.impl&%11.tr_have_gen.? (Poly%test_crate!Y.State. pre!) (Poly%test_crate!Y.State.
       post!
   ))))
   :pattern ((req%test_crate!Y.show.tr_have_gen. pre! post!))
...
(assert
 (forall ((pre! test_crate!Y.State.) (post! test_crate!Y.State.)) (!
   (= (ens%test_crate!Y.show.tr_have_gen. pre! post!) (test_crate!Y.impl&%11.next.? (Poly%test_crate!Y.State.
      pre!
     ) (Poly%test_crate!Y.State. post!)
   ))
   :pattern ((ens%test_crate!Y.show.tr_have_gen. pre! post!))
...
(declare-fun req%test_crate!Y.show.initialize. (test_crate!Y.State.) Bool)
(declare-const %%global_location_label%%4 Bool)
(assert
 (forall ((post! test_crate!Y.State.)) (!
   (= (req%test_crate!Y.show.initialize. post!) (=>
     %%global_location_label%%4
     (test_crate!Y.impl&%11.initialize.? (Poly%test_crate!Y.State. post!))
   ))
   :pattern ((req%test_crate!Y.show.initialize. post!))
...
(declare-fun ens%test_crate!Y.show.initialize. (test_crate!Y.State.) Bool)
(assert
 (forall ((post! test_crate!Y.State.)) (!
   (= (ens%test_crate!Y.show.initialize. post!) (test_crate!Y.impl&%11.init.? (Poly%test_crate!Y.State.
      post!
   )))
   :pattern ((ens%test_crate!Y.show.initialize. post!))
