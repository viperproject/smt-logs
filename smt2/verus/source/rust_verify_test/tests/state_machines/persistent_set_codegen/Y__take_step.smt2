...
(declare-const fuel%test_crate!Y.impl&%11.tr_add_enabled. FuelId)
(declare-const fuel%test_crate!Y.impl&%11.tr_have_strong. FuelId)
(declare-const fuel%test_crate!Y.impl&%11.tr_have_enabled. FuelId)
(declare-const fuel%test_crate!Y.impl&%11.tr_add_gen_strong. FuelId)
(declare-const fuel%test_crate!Y.impl&%11.tr_add_gen_enabled. FuelId)
(declare-const fuel%test_crate!Y.impl&%11.tr_have_gen_strong. FuelId)
(declare-const fuel%test_crate!Y.impl&%11.tr_have_gen_enabled. FuelId)
...
(assert
 (distinct fuel%vstd!set.impl&%0.subset_of. fuel%vstd!set.axiom_set_empty. fuel%vstd!set.axiom_set_insert_same.
  ...
  fuel%vstd!set.axiom_set_ext_equal_deep. fuel%test_crate!Y.impl&%11.initialize. fuel%test_crate!Y.impl&%11.initialize_enabled.
  fuel%test_crate!Y.impl&%11.tr_add_strong. fuel%test_crate!Y.impl&%11.tr_add_enabled.
  fuel%test_crate!Y.impl&%11.tr_have_strong. fuel%test_crate!Y.impl&%11.tr_have_enabled.
  fuel%test_crate!Y.impl&%11.tr_add_gen_strong. fuel%test_crate!Y.impl&%11.tr_add_gen_enabled.
  fuel%test_crate!Y.impl&%11.tr_have_gen_strong. fuel%test_crate!Y.impl&%11.tr_have_gen_enabled.
  fuel%test_crate!Y.impl&%11.invariant. fuel%vstd!array.group_array_axioms. fuel%vstd!map.group_map_axioms.
...
(declare-fun test_crate!Y.impl&%11.tr_add_enabled.? (Poly) Bool)
...
(declare-fun test_crate!Y.impl&%11.tr_have_enabled.? (Poly) Bool)
...
(declare-fun test_crate!Y.impl&%11.tr_add_gen_enabled.? (Poly) Bool)

;; Function-Decl test_crate::Y::State::tr_add_gen_strong
(declare-fun test_crate!Y.impl&%11.tr_add_gen_strong.? (Poly Poly) Bool)

;; Function-Decl test_crate::Y::State::tr_have_gen_enabled
(declare-fun test_crate!Y.impl&%11.tr_have_gen_enabled.? (Poly) Bool)

;; Function-Decl test_crate::Y::State::tr_have_gen_strong
(declare-fun test_crate!Y.impl&%11.tr_have_gen_strong.? (Poly Poly) Bool)
...
(assert
 (=>
  ...
  (forall ((self! Poly)) (!
    (= (test_crate!Y.impl&%11.invariant.? self!) true)
...
(assert
 (forall ((no%param Int)) (!
   (= (req%test_crate!Y.take_step.initialize. no%param) (=>
     ...
     (test_crate!Y.impl&%11.initialize_enabled.? (I 0))
   ))
...
(assert
 (fuel_bool_default fuel%test_crate!Y.impl&%11.tr_add_enabled.)
)
(assert
 (=>
  (fuel_bool fuel%test_crate!Y.impl&%11.tr_add_enabled.)
  (forall ((pre! Poly)) (!
    (= (test_crate!Y.impl&%11.tr_add_enabled.? pre!) true)
    :pattern ((test_crate!Y.impl&%11.tr_add_enabled.? pre!))
    :qid internal_test_crate!Y.impl&__11.tr_add_enabled.?_definition
    :skolemid skolem_internal_test_crate!Y.impl&__11.tr_add_enabled.?_definition
))))
...
(assert
 (forall ((pre! test_crate!Y.State.)) (!
   (= (req%test_crate!Y.take_step.tr_add. pre!) (=>
     ...
     (and
      (test_crate!Y.impl&%11.tr_add_enabled.? (Poly%test_crate!Y.State. pre!))
...
(assert
 (fuel_bool_default fuel%test_crate!Y.impl&%11.tr_have_enabled.)
)
(assert
 (=>
  (fuel_bool fuel%test_crate!Y.impl&%11.tr_have_enabled.)
  (forall ((pre! Poly)) (!
    (= (test_crate!Y.impl&%11.tr_have_enabled.? pre!) (let
      ((update_tmp_b$ (test_crate!Y.State./State/b (%Poly%test_crate!Y.State. pre!))))
      (vstd!set.impl&%0.contains.? $ INT (Poly%vstd!set.Set<int.>. update_tmp_b$) (I 5))
    ))
    :pattern ((test_crate!Y.impl&%11.tr_have_enabled.? pre!))
    :qid internal_test_crate!Y.impl&__11.tr_have_enabled.?_definition
    :skolemid skolem_internal_test_crate!Y.impl&__11.tr_have_enabled.?_definition
))))
...
(assert
 (forall ((pre! test_crate!Y.State.)) (!
   (= (req%test_crate!Y.take_step.tr_have. pre!) (=>
     ...
     (and
      (test_crate!Y.impl&%11.tr_have_enabled.? (Poly%test_crate!Y.State. pre!))
      (test_crate!Y.impl&%11.invariant.? (Poly%test_crate!Y.State. pre!))
   )))
...
(assert
 (fuel_bool_default fuel%test_crate!Y.impl&%11.tr_add_gen_enabled.)
)
(assert
 (=>
  (fuel_bool fuel%test_crate!Y.impl&%11.tr_add_gen_enabled.)
  (forall ((pre! Poly)) (!
    (= (test_crate!Y.impl&%11.tr_add_gen_enabled.? pre!) true)
    :pattern ((test_crate!Y.impl&%11.tr_add_gen_enabled.? pre!))
    :qid internal_test_crate!Y.impl&__11.tr_add_gen_enabled.?_definition
    :skolemid skolem_internal_test_crate!Y.impl&__11.tr_add_gen_enabled.?_definition
))))
...
(assert
 (=>
  ...
  (forall ((pre! Poly) (post! Poly)) (!
    (= (test_crate!Y.impl&%11.tr_add_gen_strong.? pre! post!) (let
      ((update_tmp_b$ (test_crate!Y.State./State/b (%Poly%test_crate!Y.State. pre!))))
      (let
    ...
    :pattern ((test_crate!Y.impl&%11.tr_add_gen_strong.? pre! post!))
...
(assert
 (forall ((pre! test_crate!Y.State.)) (!
   (= (req%test_crate!Y.take_step.tr_add_gen. pre!) (=>
     ...
     (and
      (test_crate!Y.impl&%11.tr_add_gen_enabled.? (Poly%test_crate!Y.State. pre!))
      (test_crate!Y.impl&%11.invariant.? (Poly%test_crate!Y.State. pre!))
   )))
...
(assert
 (fuel_bool_default fuel%test_crate!Y.impl&%11.tr_have_gen_enabled.)
)
(assert
 (=>
  (fuel_bool fuel%test_crate!Y.impl&%11.tr_have_gen_enabled.)
  (forall ((pre! Poly)) (!
    (= (test_crate!Y.impl&%11.tr_have_gen_enabled.? pre!) (let
      ((update_tmp_b$ (test_crate!Y.State./State/b (%Poly%test_crate!Y.State. pre!))))
    ...
    :pattern ((test_crate!Y.impl&%11.tr_have_gen_enabled.? pre!))
    :qid internal_test_crate!Y.impl&__11.tr_have_gen_enabled.?_definition
    :skolemid skolem_internal_test_crate!Y.impl&__11.tr_have_gen_enabled.?_definition
))))
...
(assert
 (=>
  ...
  (forall ((pre! Poly) (post! Poly)) (!
    (= (test_crate!Y.impl&%11.tr_have_gen_strong.? pre! post!) (let
      ((update_tmp_b$ (test_crate!Y.State./State/b (%Poly%test_crate!Y.State. pre!))))
      (and
       (vstd!set.impl&%0.subset_of.? $ INT (vstd!set.impl&%0.insert.? $ INT (vstd!set.impl&%0.empty.?
          $ INT
    ...
    :pattern ((test_crate!Y.impl&%11.tr_have_gen_strong.? pre! post!))
...
(assert
 (forall ((pre! test_crate!Y.State.)) (!
   (= (req%test_crate!Y.take_step.tr_have_gen. pre!) (=>
     ...
     (and
      (test_crate!Y.impl&%11.tr_have_gen_enabled.? (Poly%test_crate!Y.State. pre!))
      (test_crate!Y.impl&%11.invariant.? (Poly%test_crate!Y.State. pre!))
   )))
