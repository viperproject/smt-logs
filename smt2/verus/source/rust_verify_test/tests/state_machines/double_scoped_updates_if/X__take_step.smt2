...
(declare-datatypes ((test_crate!X.State. 0) (tuple%0. 0)) (((test_crate!X.State./State
    (test_crate!X.State./State/?m vstd!map.Map<int./int.>.) (test_crate!X.State./State/?a
     Int
    ) (test_crate!X.State./State/?b Int)
   )
  ) ((tuple%0./tuple%0))
))
          ...
          (and
           ...
           (let
            ((update_tmp_m$1 (%Poly%vstd!map.Map<int./int.>. (vstd!map.impl&%0.insert.? $ INT $ INT
                (Poly%vstd!map.Map<int./int.>. update_tmp_m$) (I 0) (I 10)
            ))))
...
(declare-fun req%test_crate!X.take_step.tr. (test_crate!X.State. Bool Bool Bool Bool
  Bool
 ) Bool
)
(declare-const %%global_location_label%%2 Bool)
(assert
 (forall ((pre! test_crate!X.State.) (x! Bool) (y! Bool) (z! Bool) (w! Bool) (v! Bool))
  (!
   (= (req%test_crate!X.take_step.tr. pre! x! y! z! w! v!) (=>
     %%global_location_label%%2
     (and
      (test_crate!X.impl&%4.tr_enabled.? (Poly%test_crate!X.State. pre!) (B x!) (B y!) (
        B z!
       ) (B w!) (B v!)
      )
...
(declare-fun ens%test_crate!X.take_step.tr. (test_crate!X.State. Bool Bool Bool Bool
  Bool test_crate!X.State.
 ) Bool
)
(assert
 (forall ((pre! test_crate!X.State.) (x! Bool) (y! Bool) (z! Bool) (w! Bool) (v! Bool)
   (post! test_crate!X.State.)
  ) (!
