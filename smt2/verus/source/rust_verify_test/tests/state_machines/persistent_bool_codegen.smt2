...
(declare-const fuel%test_crate!Y.impl&%11.tr_add_gen. FuelId)
(declare-const fuel%test_crate!Y.impl&%11.tr_add_gen_strong. FuelId)
(declare-const fuel%test_crate!Y.impl&%11.tr_have_gen. FuelId)
(declare-const fuel%test_crate!Y.impl&%11.tr_have_gen_strong. FuelId)
...
(assert
 (distinct fuel%vstd!std_specs.option.impl&%0.is_Some. fuel%vstd!std_specs.option.impl&%0.get_Some_0.
  fuel%vstd!std_specs.option.impl&%0.is_None. fuel%vstd!std_specs.option.impl&%0.arrow_0.
  ...
  fuel%test_crate!Y.impl&%11.tr_add. fuel%test_crate!Y.impl&%11.tr_add_strong. fuel%test_crate!Y.impl&%11.tr_have.
  fuel%test_crate!Y.impl&%11.tr_have_strong. fuel%test_crate!Y.impl&%11.tr_add_gen.
  fuel%test_crate!Y.impl&%11.tr_add_gen_strong. fuel%test_crate!Y.impl&%11.tr_have_gen.
  fuel%test_crate!Y.impl&%11.tr_have_gen_strong. fuel%test_crate!impl&%0.arrow_Bar_0.
  ...
  fuel%test_crate!rel_tr4. fuel%test_crate!rel_tr4_strong. fuel%test_crate!rel_tr5.
  fuel%test_crate!rel_tr5_strong. fuel%vstd!array.group_array_axioms. fuel%vstd!map.group_map_axioms.
...
(declare-datatypes ((core!option.Option. 0) (vstd!tokens.InstanceId. 0) (test_crate!Y.State.
   0
  ) (test_crate!Foo. 0) (tuple%0. 0) (tuple%2. 0)
  ...
  ((test_crate!Y.State./State (test_crate!Y.State./State/?b Bool))) ((test_crate!Foo./Bar
...
(declare-fun test_crate!Y.impl&%11.tr_add_gen.? (Poly Poly Poly) Bool)

;; Function-Decl test_crate::Y::State::tr_have_gen
(declare-fun test_crate!Y.impl&%11.tr_have_gen.? (Poly Poly Poly) Bool)
...
(declare-fun test_crate!Y.impl&%11.tr_add_gen_strong.? (Poly Poly Poly) Bool)

;; Function-Decl test_crate::Y::State::tr_have_gen_strong
(declare-fun test_crate!Y.impl&%11.tr_have_gen_strong.? (Poly Poly Poly) Bool)
...
(assert
 (fuel_bool_default fuel%test_crate!Y.impl&%11.tr_add_gen.)
)
(assert
 (=>
  (fuel_bool fuel%test_crate!Y.impl&%11.tr_add_gen.)
  (forall ((pre! Poly) (post! Poly) (x! Poly)) (!
    (= (test_crate!Y.impl&%11.tr_add_gen.? pre! post! x!) (let
      ((update_tmp_b$ (test_crate!Y.State./State/b (%Poly%test_crate!Y.State. pre!))))
      (let
       ((update_tmp_b$1 (or
          update_tmp_b$
    ...
    :pattern ((test_crate!Y.impl&%11.tr_add_gen.? pre! post! x!))
    :qid internal_test_crate!Y.impl&__11.tr_add_gen.?_definition
    :skolemid skolem_internal_test_crate!Y.impl&__11.tr_add_gen.?_definition
))))

;; Function-Axioms test_crate::Y::State::tr_have_gen
(assert
 (fuel_bool_default fuel%test_crate!Y.impl&%11.tr_have_gen.)
)
(assert
 (=>
  (fuel_bool fuel%test_crate!Y.impl&%11.tr_have_gen.)
  (forall ((pre! Poly) (post! Poly) (x! Poly)) (!
    (= (test_crate!Y.impl&%11.tr_have_gen.? pre! post! x!) (let
      ((update_tmp_b$ (test_crate!Y.State./State/b (%Poly%test_crate!Y.State. pre!))))
      (and
       (=>
        (%B x!)
    ...
    :pattern ((test_crate!Y.impl&%11.tr_have_gen.? pre! post! x!))
    :qid internal_test_crate!Y.impl&__11.tr_have_gen.?_definition
    :skolemid skolem_internal_test_crate!Y.impl&__11.tr_have_gen.?_definition
))))
...
(assert
 (fuel_bool_default fuel%test_crate!Y.impl&%11.tr_add_gen_strong.)
)
(assert
 (=>
  (fuel_bool fuel%test_crate!Y.impl&%11.tr_add_gen_strong.)
  (forall ((pre! Poly) (post! Poly) (x! Poly)) (!
    (= (test_crate!Y.impl&%11.tr_add_gen_strong.? pre! post! x!) (let
      ((update_tmp_b$ (test_crate!Y.State./State/b (%Poly%test_crate!Y.State. pre!))))
      (let
       ((update_tmp_b$1 (or
          update_tmp_b$
    ...
    :pattern ((test_crate!Y.impl&%11.tr_add_gen_strong.? pre! post! x!))
    :qid internal_test_crate!Y.impl&__11.tr_add_gen_strong.?_definition
    :skolemid skolem_internal_test_crate!Y.impl&__11.tr_add_gen_strong.?_definition
))))

;; Function-Axioms test_crate::Y::State::tr_have_gen_strong
(assert
 (fuel_bool_default fuel%test_crate!Y.impl&%11.tr_have_gen_strong.)
)
(assert
 (=>
  (fuel_bool fuel%test_crate!Y.impl&%11.tr_have_gen_strong.)
  (forall ((pre! Poly) (post! Poly) (x! Poly)) (!
    (= (test_crate!Y.impl&%11.tr_have_gen_strong.? pre! post! x!) (let
      ((update_tmp_b$ (test_crate!Y.State./State/b (%Poly%test_crate!Y.State. pre!))))
      (and
       (=>
        (%B x!)
    ...
    :pattern ((test_crate!Y.impl&%11.tr_have_gen_strong.? pre! post! x!))
    :qid internal_test_crate!Y.impl&__11.tr_have_gen_strong.?_definition
    :skolemid skolem_internal_test_crate!Y.impl&__11.tr_have_gen_strong.?_definition
))))

;; Function-Specs test_crate::Y::b::clone
(declare-fun ens%test_crate!Y.impl&%4.clone. (test_crate!Y.b. test_crate!Y.b.) Bool)
(assert
 (forall ((self! test_crate!Y.b.) (s! test_crate!Y.b.)) (!
...
(declare-fun ens%test_crate!Y.impl&%8.init_false. (Int tuple%2.) Bool)
(assert
 (forall ((no%param Int) (tmp_tuple! tuple%2.)) (!
   (= (ens%test_crate!Y.impl&%8.init_false. no%param tmp_tuple!) (and
       ...
       (let
        ...
        (let
         ...
         (vstd!tokens.bool_value_eq_option_token.? $ TYPE%test_crate!Y.b. (B false) (Poly%core!option.Option.
           param_token_b$1
          ) (Poly%vstd!tokens.InstanceId. (test_crate!Y.impl&%8.id.? (Poly%test_crate!Y.Instance.
             instance$1
   ))))))))))
   :pattern ((ens%test_crate!Y.impl&%8.init_false. no%param tmp_tuple!))
   :qid internal_ens__test_crate!Y.impl&__8.init_false._definition
   :skolemid skolem_internal_ens__test_crate!Y.impl&__8.init_false._definition
)))

;; Function-Specs test_crate::Y::Instance::init_true
(declare-fun ens%test_crate!Y.impl&%8.init_true. (Int tuple%2.) Bool)
(assert
 (forall ((no%param Int) (tmp_tuple! tuple%2.)) (!
   (= (ens%test_crate!Y.impl&%8.init_true. no%param tmp_tuple!) (and
     (has_type (Poly%tuple%2. tmp_tuple!) (TYPE%tuple%2. (TRACKED $) TYPE%test_crate!Y.Instance.
       (TRACKED $) (TYPE%core!option.Option. $ TYPE%test_crate!Y.b.)
     ))
     (let
   ...
   :pattern ((ens%test_crate!Y.impl&%8.init_true. no%param tmp_tuple!))
   :qid internal_ens__test_crate!Y.impl&__8.init_true._definition
   :skolemid skolem_internal_ens__test_crate!Y.impl&__8.init_true._definition
)))

;; Function-Specs test_crate::Y::Instance::tr_add
(declare-fun ens%test_crate!Y.impl&%8.tr_add. (test_crate!Y.Instance. test_crate!Y.b.)
 Bool
)
(assert
 (forall ((self! test_crate!Y.Instance.) (param_token_0_b! test_crate!Y.b.)) (!
   (= (ens%test_crate!Y.impl&%8.tr_add. self! param_token_0_b!) (= (%Poly%vstd!tokens.InstanceId.
      (vstd!tokens.SimpleToken.instance_id.? $ TYPE%test_crate!Y.b. (Poly%test_crate!Y.b.
        param_token_0_b!
      ))
     ) (test_crate!Y.impl&%8.id.? (Poly%test_crate!Y.Instance. self!))
   ))
   :pattern ((ens%test_crate!Y.impl&%8.tr_add. self! param_token_0_b!))
...
(declare-fun req%test_crate!Y.impl&%8.tr_have. (test_crate!Y.Instance. test_crate!Y.b.)
 Bool
)
...
(assert
 (forall ((self! test_crate!Y.Instance.) (param_token_0_b! test_crate!Y.b.)) (!
   (= (req%test_crate!Y.impl&%8.tr_have. self! param_token_0_b!) (and
     (=>
   ...
   :pattern ((req%test_crate!Y.impl&%8.tr_have. self! param_token_0_b!))
...
(declare-fun ens%test_crate!Y.impl&%8.tr_add_gen. (test_crate!Y.Instance. Bool core!option.Option.)
 Bool
)
(assert
 (forall ((self! test_crate!Y.Instance.) (x! Bool) (param_token_0_b! core!option.Option.))
  (!
   (= (ens%test_crate!Y.impl&%8.tr_add_gen. self! x! param_token_0_b!) (and
   ...
   :pattern ((ens%test_crate!Y.impl&%8.tr_add_gen. self! x! param_token_0_b!))
   :qid internal_ens__test_crate!Y.impl&__8.tr_add_gen._definition
   :skolemid skolem_internal_ens__test_crate!Y.impl&__8.tr_add_gen._definition
)))
...
(declare-fun req%test_crate!Y.impl&%8.tr_have_gen. (test_crate!Y.Instance. Bool core!option.Option.)
 Bool
)
...
(assert
 (forall ((self! test_crate!Y.Instance.) (x! Bool) (param_token_0_b! core!option.Option.))
  (!
   (= (req%test_crate!Y.impl&%8.tr_have_gen. self! x! param_token_0_b!) (=>
   ...
   :pattern ((req%test_crate!Y.impl&%8.tr_have_gen. self! x! param_token_0_b!))
   :qid internal_req__test_crate!Y.impl&__8.tr_have_gen._definition
   :skolemid skolem_internal_req__test_crate!Y.impl&__8.tr_have_gen._definition
)))
...
(assert
 (=>
  ...
  (forall ((pre! Poly) (post! Poly)) (!
    (= (test_crate!rel_tr1.? pre! post!) (= (test_crate!Y.State./State/b (%Poly%test_crate!Y.State.
        post!
       )
      ) true
    ))
...
(assert
 (=>
  ...
  (forall ((pre! Poly) (post! Poly)) (!
    (= (test_crate!rel_tr1_strong.? pre! post!) (= (test_crate!Y.State./State/b (%Poly%test_crate!Y.State.
        post!
       )
      ) true
    ))
 ...
 (=>
  ...
  (forall ((pre! Poly) (post! Poly)) (!
    (= (test_crate!rel_tr2.? pre! post!) (and
      (= (test_crate!Y.State./State/b (%Poly%test_crate!Y.State. pre!)) true)
      (= (test_crate!Y.State./State/b (%Poly%test_crate!Y.State. post!)) true)
    ))
...
(assert
 (=>
  ...
  (forall ((pre! Poly) (post! Poly) (x! Poly)) (!
    (= (test_crate!rel_tr4.? pre! post! x!) (= (test_crate!Y.State./State/b (%Poly%test_crate!Y.State.
        post!
       )
      ) (or
       (test_crate!Y.State./State/b (%Poly%test_crate!Y.State. pre!))
       (%B x!)
    )))
    :pattern ((test_crate!rel_tr4.? pre! post! x!))
...
(assert
 (=>
  ...
  (forall ((pre! Poly) (post! Poly) (x! Poly)) (!
    (= (test_crate!rel_tr4_strong.? pre! post! x!) (= (test_crate!Y.State./State/b (%Poly%test_crate!Y.State.
        post!
       )
      ) (or
       (test_crate!Y.State./State/b (%Poly%test_crate!Y.State. pre!))
    ...
    :pattern ((test_crate!rel_tr4_strong.? pre! post! x!))
...
(assert
 (=>
  ...
  (forall ((pre! Poly) (post! Poly) (x! Poly)) (!
    (= (test_crate!rel_tr5.? pre! post! x!) (and
      (=>
       (%B x!)
       (test_crate!Y.State./State/b (%Poly%test_crate!Y.State. pre!))
      )
      (= (test_crate!Y.State./State/b (%Poly%test_crate!Y.State. post!)) (test_crate!Y.State./State/b
        (%Poly%test_crate!Y.State. pre!)
    ))))
    :pattern ((test_crate!rel_tr5.? pre! post! x!))
...
(assert
 (=>
  ...
  (forall ((pre! Poly) (post! Poly) (x! Poly)) (!
    (= (test_crate!rel_tr5_strong.? pre! post! x!) (and
      (=>
       (%B x!)
       (test_crate!Y.State./State/b (%Poly%test_crate!Y.State. pre!))
      )
    ...
    :pattern ((test_crate!rel_tr5_strong.? pre! post! x!))
...
(declare-fun ens%test_crate!correct_tr. (test_crate!Y.State. test_crate!Y.State. Bool)
 Bool
)
(assert
 (forall ((pre! test_crate!Y.State.) (post! test_crate!Y.State.) (x! Bool)) (!
   (= (ens%test_crate!correct_tr. pre! post! x!) (and
     ...
     (= (test_crate!rel_tr4.? (Poly%test_crate!Y.State. pre!) (Poly%test_crate!Y.State. post!)
       (B x!)
      ) (test_crate!Y.impl&%11.tr_add_gen.? (Poly%test_crate!Y.State. pre!) (Poly%test_crate!Y.State.
        post!
       ) (B x!)
     ))
     (= (test_crate!rel_tr4_strong.? (Poly%test_crate!Y.State. pre!) (Poly%test_crate!Y.State.
      ...
      ) (test_crate!Y.impl&%11.tr_add_gen_strong.? (Poly%test_crate!Y.State. pre!) (Poly%test_crate!Y.State.
        post!
       ) (B x!)
     ))
     (= (test_crate!rel_tr5.? (Poly%test_crate!Y.State. pre!) (Poly%test_crate!Y.State. post!)
       (B x!)
      ) (test_crate!Y.impl&%11.tr_have_gen.? (Poly%test_crate!Y.State. pre!) (Poly%test_crate!Y.State.
        post!
       ) (B x!)
     ))
     (= (test_crate!rel_tr5_strong.? (Poly%test_crate!Y.State. pre!) (Poly%test_crate!Y.State.
      ...
      ) (test_crate!Y.impl&%11.tr_have_gen_strong.? (Poly%test_crate!Y.State. pre!) (Poly%test_crate!Y.State.
        post!
       ) (B x!)
   ))))
   :pattern ((ens%test_crate!correct_tr. pre! post! x!))
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/state_machines-c25f1c939512e7ab-persistent_bool_codegen/test.rs:112:7: 112:60 (#0)
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/state_machines-c25f1c939512e7ab-persistent_bool_codegen/test.rs:126:7: 126:22 (#0)
(get-info :all-statistics)
(push)
 ...
 (declare-const verus_tmp_token_f@ core!option.Option.)
 (declare-const inst@ test_crate!Y.Instance.)
 (declare-const token_f@ core!option.Option.)
 (declare-const tok@ test_crate!Y.b.)
 (declare-const tok1@ test_crate!Y.b.)
 (declare-const opt_tok@ core!option.Option.)
 (declare-const opt_tok$1@ core!option.Option.)
 (assert
  fuel_defaults
 )
 ;; assertion failed
 ...
 (assert
  (not (=>
    (ens%test_crate!Y.impl&%8.init_false. 0 tmp%%@)
    (=>
     (= verus_tmp_inst@ (%Poly%test_crate!Y.Instance. (tuple%2./tuple%2/0 (%Poly%tuple%2.
         (Poly%tuple%2. tmp%%@)
     ))))
     (=>
      (= verus_tmp_token_f@ (%Poly%core!option.Option. (tuple%2./tuple%2/1 (%Poly%tuple%2.
          (Poly%tuple%2. tmp%%@)
      ))))
      (=>
       (= inst@ verus_tmp_inst@)
       (=>
        ...
        (=>
         (= tmp%1 (is-core!option.Option./None token_f@))
         (and
          (=>
           %%location_label%%0
           tmp%1
          ...
          (=>
           tmp%1
           (=>
            (ens%test_crate!Y.impl&%8.tr_add. inst@ tok@)
            (=>
             (= tmp%2 (= (%Poly%vstd!tokens.InstanceId. (vstd!tokens.SimpleToken.instance_id.? $ TYPE%test_crate!Y.b.
                 (Poly%test_crate!Y.b. tok@)
                )
               ) (test_crate!Y.impl&%8.id.? (Poly%test_crate!Y.Instance. inst@))
             ))
             (and
              (=>
               %%location_label%%1
              ...
              (=>
               ...
               (and
                (=>
                 %%location_label%%2
                 (req%test_crate!Y.impl&%8.tr_have. inst@ tok@)
                )
                (=>
                 (ens%test_crate!Y.impl&%4.clone. tok@ tok1@)
                 (=>
                  (= tmp%3 (= tok@ tok1@))
                  (and
                   (=>
                   ...
                   (=>
                    tmp%3
                    (=>
                     (ens%test_crate!Y.impl&%8.tr_add_gen. inst@ true opt_tok@)
                     (=>
                      (= tmp%4 (is-core!option.Option./Some opt_tok@))
                      (and
                       (=>
                        %%location_label%%4
                        tmp%4
                       ...
                       (=>
                        tmp%4
                        (=>
                         (= tmp%5 (= (%Poly%vstd!tokens.InstanceId. (vstd!tokens.SimpleToken.instance_id.? $ TYPE%test_crate!Y.b.
                             (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. opt_tok@)))
                            )
                           ) (test_crate!Y.impl&%8.id.? (Poly%test_crate!Y.Instance. inst@))
                         ))
                         (and
                          ...
                          (=>
                           ...
                           (and
                            (=>
                             %%location_label%%6
                             (req%test_crate!Y.impl&%8.tr_have_gen. inst@ true opt_tok@)
                            )
                            (=>
                             (ens%test_crate!Y.impl&%8.tr_add_gen. inst@ false opt_tok$1@)
                             (=>
                              (= tmp%6 (is-core!option.Option./None opt_tok$1@))
                              (and
                               (=>
                                %%location_label%%7
                                tmp%6
                               ...
                               (=>
                                ...
                                (=>
                                 %%location_label%%8
                                 (req%test_crate!Y.impl&%8.tr_have_gen. inst@ false opt_tok$1@)
 ))))))))))))))))))))))))))))))))
 (get-info :version)
 (set-option :rlimit 30000000)
 (check-sat)
...
;; Function-Def test_crate::test_inst1_fail
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/state_machines-c25f1c939512e7ab-persistent_bool_codegen/test.rs:147:7: 147:27 (#0)
(get-info :all-statistics)
(push)
 (declare-const no%param Int)
 (declare-const tmp%1 Bool)
        ...
        (=>
         ...
         (and
          ...
          (=>
           tmp%1
           (=>
            (ens%test_crate!Y.impl&%8.tr_add_gen. inst@ false opt_tok@)
            (=>
             (= tmp%2 (is-core!option.Option./None opt_tok@))
             (and
              (=>
               %%location_label%%1
               tmp%2
...
;; Function-Recommends test_crate::test_inst1_fail
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/state_machines-c25f1c939512e7ab-persistent_bool_codegen/test.rs:147:7: 147:27 (#0)
(get-info :all-statistics)
(push)
 (declare-const no%param Int)
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/state_machines-c25f1c939512e7ab-persistent_bool_codegen/test.rs:156:7: 156:22 (#0)
(get-info :all-statistics)
(push)
 (declare-const no%param Int)
 (declare-const tmp%1 Bool)
 ...
 (declare-const tmp%%@ tuple%2.)
 (declare-const verus_tmp_inst@ test_crate!Y.Instance.)
 (declare-const verus_tmp_token_t@ core!option.Option.)
 (declare-const inst@ test_crate!Y.Instance.)
 (declare-const token_t@ core!option.Option.)
 (assert
  fuel_defaults
 )
 ;; assertion failed
 ...
 (assert
  (not (=>
    (ens%test_crate!Y.impl&%8.init_true. 0 tmp%%@)
    (=>
     (= verus_tmp_inst@ (%Poly%test_crate!Y.Instance. (tuple%2./tuple%2/0 (%Poly%tuple%2.
         (Poly%tuple%2. tmp%%@)
     ))))
     (=>
      (= verus_tmp_token_t@ (%Poly%core!option.Option. (tuple%2./tuple%2/1 (%Poly%tuple%2.
          (Poly%tuple%2. tmp%%@)
      ))))
      (=>
       (= inst@ verus_tmp_inst@)
       (=>
        (= token_t@ verus_tmp_token_t@)
        (=>
         (= tmp%1 (is-core!option.Option./Some token_t@))
         (and
          (=>
           %%location_label%%0
           tmp%1
          ...
          (=>
           ...
           (=>
            (= tmp%2 (= (%Poly%vstd!tokens.InstanceId. (vstd!tokens.SimpleToken.instance_id.? $ TYPE%test_crate!Y.b.
                (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option. token_t@)))
               )
              ) (test_crate!Y.impl&%8.id.? (Poly%test_crate!Y.Instance. inst@))
            ))
            (=>
