...
(assert
 (distinct fuel%test_crate!X.impl&%10.tr_strong. fuel%test_crate!X.impl&%10.tr_enabled.
  fuel%test_crate!X.impl&%10.invariant. fuel%test_crate!X.impl&%10.the_inv. fuel%vstd!array.group_array_axioms.
...
(declare-fun req%test_crate!X.take_step.tr. (test_crate!X.State. Int) Bool)
(declare-const %%global_location_label%%0 Bool)
(assert
 (forall ((pre! test_crate!X.State.) (x! Int)) (!
   (= (req%test_crate!X.take_step.tr. pre! x!) (=>
     %%global_location_label%%0
     (and
      (test_crate!X.impl&%10.tr_enabled.? (Poly%test_crate!X.State. pre!) (I x!))
      (test_crate!X.impl&%10.invariant.? (Poly%test_crate!X.State. pre!))
   )))
   :pattern ((req%test_crate!X.take_step.tr. pre! x!))
...
(declare-fun ens%test_crate!X.take_step.tr. (test_crate!X.State. Int test_crate!X.State.)
 Bool
)
(assert
 (forall ((pre! test_crate!X.State.) (x! Int) (post! test_crate!X.State.)) (!
   (= (ens%test_crate!X.take_step.tr. pre! x! post!) (and
   ...
   :pattern ((ens%test_crate!X.take_step.tr. pre! x! post!))
