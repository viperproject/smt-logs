...
(assert
 (forall ((pre! test_crate!X.State.) (post! test_crate!X.State.) (x! Int)) (!
   (= (ens%test_crate!X.show.tr. pre! post! x!) (test_crate!X.impl&%10.next.? (Poly%test_crate!X.State.
      pre!
     ) (Poly%test_crate!X.State. post!)
   ))
   :pattern ((ens%test_crate!X.show.tr. pre! post! x!))
