...
(assert
 (distinct fuel%vstd!std_specs.option.impl&%0.is_Some. fuel%vstd!std_specs.option.impl&%0.get_Some_0.
  ...
  fuel%vstd!std_specs.option.spec_unwrap. fuel%vstd!state_machine_internal.opt_ge.
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/state_machines-c25f1c939512e7ab-inherent_safety_condition_option_general_guard/test.rs:35:1: 49:3 (#42)
     ...
     (and
      (=>
       ...
       (and
        ...
        (=>
         (ens%vstd!state_machine_internal.assert_general_guard_option. tmp%1)
         (=>
          %%location_label%%1
          (=>
           (is-core!option.Option./Some (core!option.Option./Some (I 5)))
 ...
 (forall ((self! test_crate!X.Instance.) (tmp_tuple! tuple%2.)) (!
   (= (ens%test_crate!X.impl&%4.tr. self! tmp_tuple!) (and
     (has_type (Poly%tuple%2. tmp_tuple!) (TYPE%tuple%2. (GHOST $) (TYPE%core!option.Option.
        $ INT
       ) (TRACKED (REF $)) (TYPE%core!option.Option. $ INT)
     ))
     (let
      ...
      (let
       ((param_token_0_t$ (%Poly%core!option.Option. (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2.
             tmp_tuple!
       ))))))
       (let
        ...
        (let
         ...
         (and
          (= param_token_0_t$1 (core!option.Option./Some (I 5)))
          (let
