...
(assert
 (distinct fuel%test_crate!Y.impl&%10.tr1. fuel%vstd!array.group_array_axioms. fuel%vstd!map.group_map_axioms.
...
(assert
 (forall ((pre! test_crate!Y.State.) (post! test_crate!Y.State.)) (!
   (= (ens%test_crate!Y.show.tr1. pre! post!) (test_crate!Y.impl&%10.next.? (Poly%test_crate!Y.State.
      pre!
