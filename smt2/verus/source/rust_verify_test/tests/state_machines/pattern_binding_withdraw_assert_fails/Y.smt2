...
(assert
 (distinct fuel%vstd!std_specs.option.impl&%0.is_Some. fuel%vstd!std_specs.option.impl&%0.get_Some_0.
  ...
  fuel%vstd!set.axiom_set_remove_finite. fuel%test_crate!Y.impl&%0.arrow_0. fuel%test_crate!Y.impl&%0.arrow_dummy_to_use_type_params_0.
  fuel%test_crate!Y.impl&%1.is_tr1. fuel%test_crate!Y.impl&%1.is_tr2. fuel%test_crate!Y.impl&%1.is_tr3.
  fuel%test_crate!Y.impl&%1.is_tr4. fuel%test_crate!Y.impl&%1.is_tr5. fuel%test_crate!Y.impl&%1.is_tr6.
  ...
  fuel%test_crate!Y.impl&%7.tr1. fuel%test_crate!Y.impl&%7.tr1_strong. fuel%test_crate!Y.impl&%7.tr1_enabled.
  fuel%test_crate!Y.impl&%7.tr2. fuel%test_crate!Y.impl&%7.tr2_strong. fuel%test_crate!Y.impl&%7.tr2_enabled.
  fuel%test_crate!Y.impl&%7.tr3. fuel%test_crate!Y.impl&%7.tr3_strong. fuel%test_crate!Y.impl&%7.tr3_enabled.
  fuel%test_crate!Y.impl&%7.tr4. fuel%test_crate!Y.impl&%7.tr4_strong. fuel%test_crate!Y.impl&%7.tr4_enabled.
  fuel%test_crate!Y.impl&%7.tr5. fuel%test_crate!Y.impl&%7.tr5_strong. fuel%test_crate!Y.impl&%7.tr5_enabled.
  fuel%test_crate!Y.impl&%7.tr6. fuel%test_crate!Y.impl&%7.tr6_strong. fuel%test_crate!Y.impl&%7.tr6_enabled.
  fuel%test_crate!Y.impl&%7.next_by. fuel%test_crate!Y.impl&%7.next. fuel%test_crate!Y.impl&%7.next_strong_by.
  fuel%test_crate!Y.impl&%7.next_strong. fuel%test_crate!Y.impl&%7.init_by. fuel%test_crate!Y.impl&%7.init.
  fuel%test_crate!Y.impl&%7.invariant. fuel%vstd!array.group_array_axioms. fuel%vstd!map.group_map_axioms.
...
(declare-datatypes ((core!option.Option. 0) (vstd!tokens.InstanceId. 0) (test_crate!Y.State.
   0
  ) (test_crate!Y.Step. 0) (test_crate!Y.Config. 0) (test_crate!Y.Instance. 0) (test_crate!Goo.
   0
  ...
  ((test_crate!Y.State./State (test_crate!Y.State./State/?storage_m vstd!map.Map<int./test_crate!Goo.>.)
   ...
   (test_crate!Y.Step./tr5) (test_crate!Y.Step./tr6) (test_crate!Y.Step./dummy_to_use_type_params
...
(assert
 (has_type (Poly%test_crate!Y.Step. test_crate!Y.Step./tr5) TYPE%test_crate!Y.Step.)
)
(assert
 (has_type (Poly%test_crate!Y.Step. test_crate!Y.Step./tr6) TYPE%test_crate!Y.Step.)
)
(assert
...
(declare-fun test_crate!Y.impl&%7.tr1.? (Poly Poly) Bool)

;; Function-Decl test_crate::Y::State::tr2
(declare-fun test_crate!Y.impl&%7.tr2.? (Poly Poly) Bool)

;; Function-Decl test_crate::Y::State::tr3
(declare-fun test_crate!Y.impl&%7.tr3.? (Poly Poly) Bool)

;; Function-Decl test_crate::Y::State::tr4
(declare-fun test_crate!Y.impl&%7.tr4.? (Poly Poly) Bool)

;; Function-Decl test_crate::Y::State::tr5
(declare-fun test_crate!Y.impl&%7.tr5.? (Poly Poly) Bool)

;; Function-Decl test_crate::Y::State::tr6
(declare-fun test_crate!Y.impl&%7.tr6.? (Poly Poly) Bool)

;; Function-Decl test_crate::Y::State::next_by
(declare-fun test_crate!Y.impl&%7.next_by.? (Poly Poly Poly) Bool)

;; Function-Decl test_crate::Y::State::next
(declare-fun test_crate!Y.impl&%7.next.? (Poly Poly) Bool)

;; Function-Decl test_crate::Y::Instance::id
(declare-fun test_crate!Y.impl&%4.id.? (Poly) vstd!tokens.InstanceId.)
...
(declare-fun test_crate!Y.impl&%7.next_strong_by.? (Poly Poly Poly) Bool)

;; Function-Decl test_crate::Y::State::next_strong
(declare-fun test_crate!Y.impl&%7.next_strong.? (Poly Poly) Bool)

;; Function-Decl test_crate::Y::State::init_by
(declare-fun test_crate!Y.impl&%7.init_by.? (Poly Poly) Bool)

;; Function-Decl test_crate::Y::State::init
(declare-fun test_crate!Y.impl&%7.init.? (Poly) Bool)
...
(assert
 (fuel_bool_default fuel%test_crate!Y.impl&%7.tr1.)
)
(assert
 (=>
  (fuel_bool fuel%test_crate!Y.impl&%7.tr1.)
  (forall ((pre! Poly) (post! Poly)) (!
    (= (test_crate!Y.impl&%7.tr1.? pre! post!) (let
      ((tmp_assert$ true))
      (let
    ...
    :pattern ((test_crate!Y.impl&%7.tr1.? pre! post!))
    :qid internal_test_crate!Y.impl&__7.tr1.?_definition
    :skolemid skolem_internal_test_crate!Y.impl&__7.tr1.?_definition
))))

;; Function-Axioms test_crate::Y::State::tr2
(assert
 (fuel_bool_default fuel%test_crate!Y.impl&%7.tr2.)
)
(assert
 (=>
  (fuel_bool fuel%test_crate!Y.impl&%7.tr2.)
  (forall ((pre! Poly) (post! Poly)) (!
    (= (test_crate!Y.impl&%7.tr2.? pre! post!) (let
      ((tmp_assert$ true))
      (let
       ((update_tmp_storage_m$ (test_crate!Y.State./State/storage_m (%Poly%test_crate!Y.State.
           pre!
    ...
    :pattern ((test_crate!Y.impl&%7.tr2.? pre! post!))
    :qid internal_test_crate!Y.impl&__7.tr2.?_definition
    :skolemid skolem_internal_test_crate!Y.impl&__7.tr2.?_definition
))))

;; Function-Axioms test_crate::Y::State::tr3
(assert
 (fuel_bool_default fuel%test_crate!Y.impl&%7.tr3.)
)
(assert
 (=>
  (fuel_bool fuel%test_crate!Y.impl&%7.tr3.)
  (forall ((pre! Poly) (post! Poly)) (!
    (= (test_crate!Y.impl&%7.tr3.? pre! post!) (let
      ((tmp_assert$ true))
      (let
       ((update_tmp_storage_m$ (test_crate!Y.State./State/storage_m (%Poly%test_crate!Y.State.
           pre!
    ...
    :pattern ((test_crate!Y.impl&%7.tr3.? pre! post!))
    :qid internal_test_crate!Y.impl&__7.tr3.?_definition
    :skolemid skolem_internal_test_crate!Y.impl&__7.tr3.?_definition
))))

;; Function-Axioms test_crate::Y::State::tr4
(assert
 (fuel_bool_default fuel%test_crate!Y.impl&%7.tr4.)
)
(assert
 (=>
  (fuel_bool fuel%test_crate!Y.impl&%7.tr4.)
  (forall ((pre! Poly) (post! Poly)) (!
    (= (test_crate!Y.impl&%7.tr4.? pre! post!) (let
      ((tmp_assert$ true))
      (let
       ((update_tmp_storage_m$ (test_crate!Y.State./State/storage_m (%Poly%test_crate!Y.State.
           pre!
    ...
    :pattern ((test_crate!Y.impl&%7.tr4.? pre! post!))
    :qid internal_test_crate!Y.impl&__7.tr4.?_definition
    :skolemid skolem_internal_test_crate!Y.impl&__7.tr4.?_definition
))))

;; Function-Axioms test_crate::Y::State::tr5
(assert
 (fuel_bool_default fuel%test_crate!Y.impl&%7.tr5.)
)
(assert
 (=>
  (fuel_bool fuel%test_crate!Y.impl&%7.tr5.)
  (forall ((pre! Poly) (post! Poly)) (!
    (= (test_crate!Y.impl&%7.tr5.? pre! post!) (let
      ((tmp_assert$ true))
      (let
       ((update_tmp_storage_m$ (test_crate!Y.State./State/storage_m (%Poly%test_crate!Y.State.
           pre!
    ...
    :pattern ((test_crate!Y.impl&%7.tr5.? pre! post!))
    :qid internal_test_crate!Y.impl&__7.tr5.?_definition
    :skolemid skolem_internal_test_crate!Y.impl&__7.tr5.?_definition
))))

;; Function-Axioms test_crate::Y::State::tr6
(assert
 (fuel_bool_default fuel%test_crate!Y.impl&%7.tr6.)
)
(assert
 (=>
  (fuel_bool fuel%test_crate!Y.impl&%7.tr6.)
  (forall ((pre! Poly) (post! Poly)) (!
    (= (test_crate!Y.impl&%7.tr6.? pre! post!) (let
      ((tmp_assert$ true))
      (let
       ((update_tmp_storage_m$ (test_crate!Y.State./State/storage_m (%Poly%test_crate!Y.State.
           pre!
    ...
    :pattern ((test_crate!Y.impl&%7.tr6.? pre! post!))
    :qid internal_test_crate!Y.impl&__7.tr6.?_definition
    :skolemid skolem_internal_test_crate!Y.impl&__7.tr6.?_definition
))))

;; Function-Axioms test_crate::Y::State::next_by
(assert
 (=>
  (fuel_bool fuel%test_crate!Y.impl&%7.next_by.)
  (forall ((pre! Poly) (post! Poly) (step! Poly)) (!
    (= (test_crate!Y.impl&%7.next_by.? pre! post! step!) (ite
      (is-test_crate!Y.Step./tr1 (%Poly%test_crate!Y.Step. step!))
      (test_crate!Y.impl&%7.tr1.? pre! post!)
      (ite
       (is-test_crate!Y.Step./tr2 (%Poly%test_crate!Y.Step. step!))
       (test_crate!Y.impl&%7.tr2.? pre! post!)
       (ite
        (is-test_crate!Y.Step./tr3 (%Poly%test_crate!Y.Step. step!))
        (test_crate!Y.impl&%7.tr3.? pre! post!)
        (ite
         (is-test_crate!Y.Step./tr4 (%Poly%test_crate!Y.Step. step!))
         (test_crate!Y.impl&%7.tr4.? pre! post!)
         (ite
          (is-test_crate!Y.Step./tr5 (%Poly%test_crate!Y.Step. step!))
          (test_crate!Y.impl&%7.tr5.? pre! post!)
          (and
           (is-test_crate!Y.Step./tr6 (%Poly%test_crate!Y.Step. step!))
           (test_crate!Y.impl&%7.tr6.? pre! post!)
    )))))))
    :pattern ((test_crate!Y.impl&%7.next_by.? pre! post! step!))
    :qid internal_test_crate!Y.impl&__7.next_by.?_definition
    :skolemid skolem_internal_test_crate!Y.impl&__7.next_by.?_definition
))))

;; Function-Axioms test_crate::Y::State::next
(assert
 (=>
  (fuel_bool fuel%test_crate!Y.impl&%7.next.)
  (forall ((pre! Poly) (post! Poly)) (!
    (= (test_crate!Y.impl&%7.next.? pre! post!) (exists ((step$ Poly)) (!
       (and
        (has_type step$ TYPE%test_crate!Y.Step.)
        (test_crate!Y.impl&%7.next_by.? pre! post! step$)
       )
       :pattern ((test_crate!Y.impl&%7.next_by.? pre! post! step$))
       :qid user_test_crate__Y__State__next_26
       :skolemid skolem_user_test_crate__Y__State__next_26
    )))
    :pattern ((test_crate!Y.impl&%7.next.? pre! post!))
    :qid internal_test_crate!Y.impl&__7.next.?_definition
    :skolemid skolem_internal_test_crate!Y.impl&__7.next.?_definition
))))

;; Function-Specs test_crate::Y::Instance::clone
(declare-fun ens%test_crate!Y.impl&%4.clone. (test_crate!Y.Instance. test_crate!Y.Instance.)
 Bool
)
(assert
...
(assert
 (=>
  (fuel_bool fuel%test_crate!Y.impl&%7.next_strong_by.)
  (forall ((pre! Poly) (post! Poly) (step! Poly)) (!
    (= (test_crate!Y.impl&%7.next_strong_by.? pre! post! step!) (ite
      (is-test_crate!Y.Step./tr1 (%Poly%test_crate!Y.Step. step!))
      (test_crate!Y.impl&%7.tr1_strong.? pre! post!)
      (ite
       (is-test_crate!Y.Step./tr2 (%Poly%test_crate!Y.Step. step!))
       (test_crate!Y.impl&%7.tr2_strong.? pre! post!)
       (ite
        (is-test_crate!Y.Step./tr3 (%Poly%test_crate!Y.Step. step!))
        (test_crate!Y.impl&%7.tr3_strong.? pre! post!)
        (ite
         (is-test_crate!Y.Step./tr4 (%Poly%test_crate!Y.Step. step!))
         (test_crate!Y.impl&%7.tr4_strong.? pre! post!)
         (ite
          (is-test_crate!Y.Step./tr5 (%Poly%test_crate!Y.Step. step!))
          (test_crate!Y.impl&%7.tr5_strong.? pre! post!)
          (and
           (is-test_crate!Y.Step./tr6 (%Poly%test_crate!Y.Step. step!))
           (test_crate!Y.impl&%7.tr6_strong.? pre! post!)
    )))))))
    :pattern ((test_crate!Y.impl&%7.next_strong_by.? pre! post! step!))
    :qid internal_test_crate!Y.impl&__7.next_strong_by.?_definition
    :skolemid skolem_internal_test_crate!Y.impl&__7.next_strong_by.?_definition
))))

;; Function-Axioms test_crate::Y::State::next_strong
(assert
 (=>
  (fuel_bool fuel%test_crate!Y.impl&%7.next_strong.)
  (forall ((pre! Poly) (post! Poly)) (!
    (= (test_crate!Y.impl&%7.next_strong.? pre! post!) (exists ((step$ Poly)) (!
       (and
        (has_type step$ TYPE%test_crate!Y.Step.)
        (test_crate!Y.impl&%7.next_strong_by.? pre! post! step$)
       )
       :pattern ((test_crate!Y.impl&%7.next_strong_by.? pre! post! step$))
       :qid user_test_crate__Y__State__next_strong_27
       :skolemid skolem_user_test_crate__Y__State__next_strong_27
    )))
    :pattern ((test_crate!Y.impl&%7.next_strong.? pre! post!))
    :qid internal_test_crate!Y.impl&__7.next_strong.?_definition
    :skolemid skolem_internal_test_crate!Y.impl&__7.next_strong.?_definition
))))

;; Function-Axioms test_crate::Y::State::init_by
(assert
 (=>
  (fuel_bool fuel%test_crate!Y.impl&%7.init_by.)
  (forall ((post! Poly) (step! Poly)) (!
    (= (test_crate!Y.impl&%7.init_by.? post! step!) false)
    :pattern ((test_crate!Y.impl&%7.init_by.? post! step!))
    :qid internal_test_crate!Y.impl&__7.init_by.?_definition
    :skolemid skolem_internal_test_crate!Y.impl&__7.init_by.?_definition
))))

;; Function-Axioms test_crate::Y::State::init
(assert
 (=>
  (fuel_bool fuel%test_crate!Y.impl&%7.init.)
  (forall ((post! Poly)) (!
    (= (test_crate!Y.impl&%7.init.? post!) (exists ((step$ Poly)) (!
       (and
        (has_type step$ TYPE%test_crate!Y.Config.)
        (test_crate!Y.impl&%7.init_by.? post! step$)
       )
       :pattern ((test_crate!Y.impl&%7.init_by.? post! step$))
       :qid user_test_crate__Y__State__init_28
       :skolemid skolem_user_test_crate__Y__State__init_28
    )))
    :pattern ((test_crate!Y.impl&%7.init.? post!))
    :qid internal_test_crate!Y.impl&__7.init.?_definition
    :skolemid skolem_internal_test_crate!Y.impl&__7.init.?_definition
))))
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/state_machines-c25f1c939512e7ab-pattern_binding_withdraw_assert_fails/test.rs:41:1: 97:3 (#43)
  ...
  (not (=>
    ...
    (=>
     ...
     (=>
      ...
      (=>
       (is-core!option.Option./Some (test_crate!Y.State./State/storage_opt (%Poly%test_crate!Y.State.
          (Poly%test_crate!Y.State. pre!)
       )))
       (=>
        (= tmp%1 (and
...
;; Function-Recommends test_crate::Y::State::tr2_asserts
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/state_machines-c25f1c939512e7ab-pattern_binding_withdraw_assert_fails/test.rs:41:1: 97:3 (#43)
(get-info :all-statistics)
(push)
 (declare-const pre! test_crate!Y.State.)
...
(push)
 ...
 (declare-const id1$4@ Int)
 (declare-const id2$4@ Int)
 (declare-const update_tmp_storage_opt$1@ core!option.Option.)
 (declare-const update_tmp_storage_m@ vstd!map.Map<int./test_crate!Goo.>.)
 (declare-const update_tmp_storage_opt@ core!option.Option.)
 (assert
...
;; Function-Recommends test_crate::Y::State::tr3_asserts
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/state_machines-c25f1c939512e7ab-pattern_binding_withdraw_assert_fails/test.rs:41:1: 97:3 (#43)
(get-info :all-statistics)
(push)
 (declare-const pre! test_crate!Y.State.)
...
;; Function-Recommends test_crate::Y::State::tr4_asserts
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/state_machines-c25f1c939512e7ab-pattern_binding_withdraw_assert_fails/test.rs:41:1: 97:3 (#43)
(get-info :all-statistics)
(push)
 (declare-const pre! test_crate!Y.State.)
 (declare-const tmp%1 Poly)
 (declare-const tmp%%@ test_crate!Goo.)
 (declare-const tmp%2 Bool)
 (declare-const tmp%3 Poly)
 (declare-const tmp%%$1@ test_crate!Goo.)
      ...
      (=>
       ...
       (or
        (and
         (=>
          ...
          (and
           (=>
            %%location_label%%0
            (req%vstd!map.impl&%0.index. $ INT $ TYPE%test_crate!Goo. (Poly%vstd!map.Map<int./test_crate!Goo.>.
              update_tmp_storage_m@
             ) (I 1)
           ))
           (=>
            (= tmp%1 (vstd!map.impl&%0.index.? $ INT $ TYPE%test_crate!Goo. (Poly%vstd!map.Map<int./test_crate!Goo.>.
               update_tmp_storage_m@
              ) (I 1)
            ))
            (=>
             (= tmp%%@ (%Poly%test_crate!Goo. tmp%1))
             (=>
              (= tmp%2 (is-test_crate!Goo./Bar tmp%%@))
              %%switch_label%%1
         )))))
         (=>
          (not (vstd!set.impl&%0.contains.? $ INT (vstd!map.impl&%0.dom.? $ INT $ TYPE%test_crate!Goo.
             (Poly%vstd!map.Map<int./test_crate!Goo.>. update_tmp_storage_m@)
            ) (I 1)
          ))
          (=>
        ...
        (and
         (not %%switch_label%%1)
         (=>
          (ens%vstd!state_machine_internal.assert_withdraw_map. tmp%2)
          (or
           (and
            (=>
             (vstd!set.impl&%0.contains.? $ INT (vstd!map.impl&%0.dom.? $ INT $ TYPE%test_crate!Goo.
             ...
             (and
              ...
              (=>
               (= tmp%3 (vstd!map.impl&%0.index.? $ INT $ TYPE%test_crate!Goo. (Poly%vstd!map.Map<int./test_crate!Goo.>.
                  update_tmp_storage_m@
                 ) (I 1)
               ))
               (=>
                (= tmp%%$1@ (%Poly%test_crate!Goo. tmp%3))
                (=>
                 (= tmp%4 (is-test_crate!Goo./Bar tmp%%$1@))
                 %%switch_label%%0
            )))))
            (=>
             (not (vstd!set.impl&%0.contains.? $ INT (vstd!map.impl&%0.dom.? $ INT $ TYPE%test_crate!Goo.
...
;; Function-Recommends test_crate::Y::State::tr5_asserts
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/state_machines-c25f1c939512e7ab-pattern_binding_withdraw_assert_fails/test.rs:41:1: 97:3 (#43)
(get-info :all-statistics)
(push)
 (declare-const pre! test_crate!Y.State.)
 ...
 (declare-const tmp%%$3@ test_crate!Goo.)
 (declare-const id1$3@ Int)
 (declare-const update_tmp_storage_m$1@ vstd!map.Map<int./test_crate!Goo.>.)
 (declare-const update_tmp_storage_m@ vstd!map.Map<int./test_crate!Goo.>.)
 (declare-const update_tmp_storage_opt@ core!option.Option.)
                ...
                (=>
                 ...
                 (=>
                  (= tmp%4 (and
                    ...
                    (let
                     ((id1$ (test_crate!Goo./Qux/0 (%Poly%test_crate!Goo. (Poly%test_crate!Goo. tmp%%$1@)))))
                     true
                  )))
                  %%switch_label%%0
             )))))
...
;; Function-Recommends test_crate::Y::State::tr6_asserts
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/state_machines-c25f1c939512e7ab-pattern_binding_withdraw_assert_fails/test.rs:41:1: 97:3 (#43)
(get-info :all-statistics)
(push)
 (declare-const pre! test_crate!Y.State.)
 ...
 (declare-const tmp%4 Bool)
 (declare-const tmp%5 Poly)
 (declare-const tmp%%$4@ test_crate!Goo.)
 (declare-const tmp%%$3@ tuple%2.)
 (declare-const id1$4@ Int)
 (declare-const id2$4@ Int)
 (declare-const update_tmp_storage_m$1@ vstd!map.Map<int./test_crate!Goo.>.)
                ...
                (=>
                 ...
                 (=>
                  (= tmp%4 (and
                    ...
                    (let
                     ((id1$ (test_crate!Goo./Tal/0 (%Poly%test_crate!Goo. (Poly%test_crate!Goo. tmp%%$1@)))))
                     (let
                      ((id2$ (test_crate!Goo./Tal/1 (%Poly%test_crate!Goo. (Poly%test_crate!Goo. tmp%%$1@)))))
                      true
                  ))))
                  %%switch_label%%0
             )))))
...
(declare-fun ens%test_crate!Y.impl&%4.tr1. (test_crate!Y.Instance. test_crate!Goo.)
 Bool
)
(assert
 (forall ((self! test_crate!Y.Instance.) (param_token_0_storage_opt! test_crate!Goo.))
  (!
   (= (ens%test_crate!Y.impl&%4.tr1. self! param_token_0_storage_opt!) (and
     (has_type (Poly%test_crate!Goo. param_token_0_storage_opt!) TYPE%test_crate!Goo.)
     (is-test_crate!Goo./Bar param_token_0_storage_opt!)
   ))
   :pattern ((ens%test_crate!Y.impl&%4.tr1. self! param_token_0_storage_opt!))
   :qid internal_ens__test_crate!Y.impl&__4.tr1._definition
   :skolemid skolem_internal_ens__test_crate!Y.impl&__4.tr1._definition
)))

;; Function-Specs test_crate::Y::Instance::tr2
(declare-fun ens%test_crate!Y.impl&%4.tr2. (test_crate!Y.Instance. test_crate!Goo.)
 Bool
)
(assert
 (forall ((self! test_crate!Y.Instance.) (param_token_0_storage_opt! test_crate!Goo.))
  (!
   (= (ens%test_crate!Y.impl&%4.tr2. self! param_token_0_storage_opt!) (and
     (has_type (Poly%test_crate!Goo. param_token_0_storage_opt!) TYPE%test_crate!Goo.)
     (and
      (is-test_crate!Goo./Qux param_token_0_storage_opt!)
      (let
       ((id1$ (test_crate!Goo./Qux/0 (%Poly%test_crate!Goo. (Poly%test_crate!Goo. param_token_0_storage_opt!)))))
       true
   ))))
   :pattern ((ens%test_crate!Y.impl&%4.tr2. self! param_token_0_storage_opt!))
   :qid internal_ens__test_crate!Y.impl&__4.tr2._definition
   :skolemid skolem_internal_ens__test_crate!Y.impl&__4.tr2._definition
)))

;; Function-Specs test_crate::Y::Instance::tr3
(declare-fun ens%test_crate!Y.impl&%4.tr3. (test_crate!Y.Instance. test_crate!Goo.)
 Bool
)
(assert
 (forall ((self! test_crate!Y.Instance.) (param_token_0_storage_opt! test_crate!Goo.))
  (!
   (= (ens%test_crate!Y.impl&%4.tr3. self! param_token_0_storage_opt!) (and
     (has_type (Poly%test_crate!Goo. param_token_0_storage_opt!) TYPE%test_crate!Goo.)
     (and
      (is-test_crate!Goo./Tal param_token_0_storage_opt!)
      (let
       ((id1$ (test_crate!Goo./Tal/0 (%Poly%test_crate!Goo. (Poly%test_crate!Goo. param_token_0_storage_opt!)))))
       (let
        ((id2$ (test_crate!Goo./Tal/1 (%Poly%test_crate!Goo. (Poly%test_crate!Goo. param_token_0_storage_opt!)))))
        true
   )))))
   :pattern ((ens%test_crate!Y.impl&%4.tr3. self! param_token_0_storage_opt!))
   :qid internal_ens__test_crate!Y.impl&__4.tr3._definition
   :skolemid skolem_internal_ens__test_crate!Y.impl&__4.tr3._definition
)))

;; Function-Specs test_crate::Y::Instance::tr4
(declare-fun ens%test_crate!Y.impl&%4.tr4. (test_crate!Y.Instance. test_crate!Goo.)
 Bool
)
(assert
 (forall ((self! test_crate!Y.Instance.) (param_token_0_storage_m! test_crate!Goo.))
  (!
   (= (ens%test_crate!Y.impl&%4.tr4. self! param_token_0_storage_m!) (and
     (has_type (Poly%test_crate!Goo. param_token_0_storage_m!) TYPE%test_crate!Goo.)
     (is-test_crate!Goo./Bar param_token_0_storage_m!)
   ))
   :pattern ((ens%test_crate!Y.impl&%4.tr4. self! param_token_0_storage_m!))
   :qid internal_ens__test_crate!Y.impl&__4.tr4._definition
   :skolemid skolem_internal_ens__test_crate!Y.impl&__4.tr4._definition
)))

;; Function-Specs test_crate::Y::Instance::tr5
(declare-fun ens%test_crate!Y.impl&%4.tr5. (test_crate!Y.Instance. test_crate!Goo.)
 Bool
)
(assert
 (forall ((self! test_crate!Y.Instance.) (param_token_0_storage_m! test_crate!Goo.))
  (!
   (= (ens%test_crate!Y.impl&%4.tr5. self! param_token_0_storage_m!) (and
     (has_type (Poly%test_crate!Goo. param_token_0_storage_m!) TYPE%test_crate!Goo.)
     (and
      (is-test_crate!Goo./Qux param_token_0_storage_m!)
      (let
       ((id1$ (test_crate!Goo./Qux/0 (%Poly%test_crate!Goo. (Poly%test_crate!Goo. param_token_0_storage_m!)))))
       true
   ))))
   :pattern ((ens%test_crate!Y.impl&%4.tr5. self! param_token_0_storage_m!))
   :qid internal_ens__test_crate!Y.impl&__4.tr5._definition
   :skolemid skolem_internal_ens__test_crate!Y.impl&__4.tr5._definition
)))

;; Function-Specs test_crate::Y::Instance::tr6
(declare-fun ens%test_crate!Y.impl&%4.tr6. (test_crate!Y.Instance. test_crate!Goo.)
 Bool
)
(assert
 (forall ((self! test_crate!Y.Instance.) (param_token_0_storage_m! test_crate!Goo.))
  (!
   (= (ens%test_crate!Y.impl&%4.tr6. self! param_token_0_storage_m!) (and
     (has_type (Poly%test_crate!Goo. param_token_0_storage_m!) TYPE%test_crate!Goo.)
     (and
      (is-test_crate!Goo./Tal param_token_0_storage_m!)
      (let
       ((id1$ (test_crate!Goo./Tal/0 (%Poly%test_crate!Goo. (Poly%test_crate!Goo. param_token_0_storage_m!)))))
       (let
        ((id2$ (test_crate!Goo./Tal/1 (%Poly%test_crate!Goo. (Poly%test_crate!Goo. param_token_0_storage_m!)))))
        true
   )))))
   :pattern ((ens%test_crate!Y.impl&%4.tr6. self! param_token_0_storage_m!))
   :qid internal_ens__test_crate!Y.impl&__4.tr6._definition
   :skolemid skolem_internal_ens__test_crate!Y.impl&__4.tr6._definition
)))
