...
(declare-const fuel%test_crate!Y.impl&%7.tr1_strong. FuelId)
(declare-const fuel%test_crate!Y.impl&%7.tr1_enabled. FuelId)
(declare-const fuel%test_crate!Y.impl&%7.tr2_strong. FuelId)
(declare-const fuel%test_crate!Y.impl&%7.tr2_enabled. FuelId)
(declare-const fuel%test_crate!Y.impl&%7.tr3_strong. FuelId)
(declare-const fuel%test_crate!Y.impl&%7.tr3_enabled. FuelId)
(declare-const fuel%test_crate!Y.impl&%7.tr4_strong. FuelId)
(declare-const fuel%test_crate!Y.impl&%7.tr4_enabled. FuelId)
(declare-const fuel%test_crate!Y.impl&%7.tr5_strong. FuelId)
(declare-const fuel%test_crate!Y.impl&%7.tr5_enabled. FuelId)
(declare-const fuel%test_crate!Y.impl&%7.tr6_strong. FuelId)
(declare-const fuel%test_crate!Y.impl&%7.tr6_enabled. FuelId)
(declare-const fuel%test_crate!Y.impl&%7.invariant. FuelId)
...
(assert
 (distinct fuel%vstd!std_specs.option.impl&%0.is_Some. fuel%vstd!std_specs.option.impl&%0.get_Some_0.
  ...
  fuel%vstd!set.axiom_set_remove_finite. fuel%test_crate!Y.impl&%7.tr1_strong. fuel%test_crate!Y.impl&%7.tr1_enabled.
  fuel%test_crate!Y.impl&%7.tr2_strong. fuel%test_crate!Y.impl&%7.tr2_enabled. fuel%test_crate!Y.impl&%7.tr3_strong.
  fuel%test_crate!Y.impl&%7.tr3_enabled. fuel%test_crate!Y.impl&%7.tr4_strong. fuel%test_crate!Y.impl&%7.tr4_enabled.
  fuel%test_crate!Y.impl&%7.tr5_strong. fuel%test_crate!Y.impl&%7.tr5_enabled. fuel%test_crate!Y.impl&%7.tr6_strong.
  fuel%test_crate!Y.impl&%7.tr6_enabled. fuel%test_crate!Y.impl&%7.invariant. fuel%vstd!array.group_array_axioms.
...
(declare-datatypes ((core!option.Option. 0) (test_crate!Y.State. 0) (test_crate!Goo.
  ...
  ) ((test_crate!Y.State./State (test_crate!Y.State./State/?storage_m vstd!map.Map<int./test_crate!Goo.>.)
...
(assert
 (forall ((_storage_m! vstd!map.Map<int./test_crate!Goo.>.) (_storage_opt! core!option.Option.))
  (!
   (=>
    (has_type (Poly%core!option.Option. _storage_opt!) (TYPE%core!option.Option. $ TYPE%test_crate!Goo.))
    (has_type (Poly%test_crate!Y.State. (test_crate!Y.State./State _storage_m! _storage_opt!))
     TYPE%test_crate!Y.State.
   ))
   :pattern ((has_type (Poly%test_crate!Y.State. (test_crate!Y.State./State _storage_m!
       _storage_opt!
      )
     ) TYPE%test_crate!Y.State.
   ))
...
(declare-fun test_crate!Y.impl&%7.tr1_strong.? (Poly Poly) Bool)

;; Function-Decl test_crate::Y::State::tr1_enabled
(declare-fun test_crate!Y.impl&%7.tr1_enabled.? (Poly) Bool)

;; Function-Decl test_crate::Y::State::tr2_strong
(declare-fun test_crate!Y.impl&%7.tr2_strong.? (Poly Poly) Bool)

;; Function-Decl test_crate::Y::State::tr2_enabled
(declare-fun test_crate!Y.impl&%7.tr2_enabled.? (Poly) Bool)

;; Function-Decl test_crate::Y::State::tr3_strong
(declare-fun test_crate!Y.impl&%7.tr3_strong.? (Poly Poly) Bool)

;; Function-Decl test_crate::Y::State::tr3_enabled
(declare-fun test_crate!Y.impl&%7.tr3_enabled.? (Poly) Bool)

;; Function-Decl test_crate::Y::State::tr4_strong
(declare-fun test_crate!Y.impl&%7.tr4_strong.? (Poly Poly) Bool)

;; Function-Decl test_crate::Y::State::tr4_enabled
(declare-fun test_crate!Y.impl&%7.tr4_enabled.? (Poly) Bool)

;; Function-Decl test_crate::Y::State::tr5_strong
(declare-fun test_crate!Y.impl&%7.tr5_strong.? (Poly Poly) Bool)

;; Function-Decl test_crate::Y::State::tr5_enabled
(declare-fun test_crate!Y.impl&%7.tr5_enabled.? (Poly) Bool)

;; Function-Decl test_crate::Y::State::tr6_strong
(declare-fun test_crate!Y.impl&%7.tr6_strong.? (Poly Poly) Bool)

;; Function-Decl test_crate::Y::State::tr6_enabled
(declare-fun test_crate!Y.impl&%7.tr6_enabled.? (Poly) Bool)

;; Function-Decl test_crate::Y::State::invariant
(declare-fun test_crate!Y.impl&%7.invariant.? (Poly) Bool)
...
(assert
 (fuel_bool_default fuel%test_crate!Y.impl&%7.tr1_strong.)
)
(assert
 (=>
  (fuel_bool fuel%test_crate!Y.impl&%7.tr1_strong.)
  (forall ((pre! Poly) (post! Poly)) (!
    (= (test_crate!Y.impl&%7.tr1_strong.? pre! post!) (let
    ...
    :pattern ((test_crate!Y.impl&%7.tr1_strong.? pre! post!))
    :qid internal_test_crate!Y.impl&__7.tr1_strong.?_definition
    :skolemid skolem_internal_test_crate!Y.impl&__7.tr1_strong.?_definition
))))

;; Function-Axioms test_crate::Y::State::tr1_enabled
(assert
 (fuel_bool_default fuel%test_crate!Y.impl&%7.tr1_enabled.)
)
(assert
 (=>
  (fuel_bool fuel%test_crate!Y.impl&%7.tr1_enabled.)
  (forall ((pre! Poly)) (!
    (= (test_crate!Y.impl&%7.tr1_enabled.? pre!) true)
    :pattern ((test_crate!Y.impl&%7.tr1_enabled.? pre!))
    :qid internal_test_crate!Y.impl&__7.tr1_enabled.?_definition
    :skolemid skolem_internal_test_crate!Y.impl&__7.tr1_enabled.?_definition
))))

;; Function-Axioms test_crate::Y::State::tr2_strong
(assert
 (fuel_bool_default fuel%test_crate!Y.impl&%7.tr2_strong.)
)
(assert
 (=>
  (fuel_bool fuel%test_crate!Y.impl&%7.tr2_strong.)
  (forall ((pre! Poly) (post! Poly)) (!
    (= (test_crate!Y.impl&%7.tr2_strong.? pre! post!) (let
      ((update_tmp_storage_m$ (test_crate!Y.State./State/storage_m (%Poly%test_crate!Y.State.
          pre!
      ))))
      (let
        ...
        (and
         ...
         (let
          ...
          (and
           ...
           (let
            ((id1$ (test_crate!Goo./Qux/0 (%Poly%test_crate!Goo. (Poly%test_crate!Goo. tmp%%$)))))
            true
        ))))
        (and
         (let
          ((id1$ (let
             ...
             (ite
              (is-test_crate!Goo./Qux tmp%%$)
              (let
               ((id1$2 (test_crate!Goo./Qux/0 (%Poly%test_crate!Goo. (Poly%test_crate!Goo. tmp%%$)))))
               id1$2
              )
    ...
    :pattern ((test_crate!Y.impl&%7.tr2_strong.? pre! post!))
    :qid internal_test_crate!Y.impl&__7.tr2_strong.?_definition
    :skolemid skolem_internal_test_crate!Y.impl&__7.tr2_strong.?_definition
))))

;; Function-Axioms test_crate::Y::State::tr2_enabled
(assert
 (fuel_bool_default fuel%test_crate!Y.impl&%7.tr2_enabled.)
)
(assert
 (=>
  (fuel_bool fuel%test_crate!Y.impl&%7.tr2_enabled.)
  (forall ((pre! Poly)) (!
    (= (test_crate!Y.impl&%7.tr2_enabled.? pre!) true)
    :pattern ((test_crate!Y.impl&%7.tr2_enabled.? pre!))
    :qid internal_test_crate!Y.impl&__7.tr2_enabled.?_definition
    :skolemid skolem_internal_test_crate!Y.impl&__7.tr2_enabled.?_definition
))))

;; Function-Axioms test_crate::Y::State::tr3_strong
(assert
 (fuel_bool_default fuel%test_crate!Y.impl&%7.tr3_strong.)
)
(assert
 (=>
  (fuel_bool fuel%test_crate!Y.impl&%7.tr3_strong.)
  (forall ((pre! Poly) (post! Poly)) (!
    (= (test_crate!Y.impl&%7.tr3_strong.? pre! post!) (let
      ((update_tmp_storage_m$ (test_crate!Y.State./State/storage_m (%Poly%test_crate!Y.State.
          pre!
      ))))
      (let
        ...
        (and
         ...
         (let
          ...
          (and
           ...
           (let
            ((id1$ (test_crate!Goo./Tal/0 (%Poly%test_crate!Goo. (Poly%test_crate!Goo. tmp%%$)))))
            (let
             ((id2$ (test_crate!Goo./Tal/1 (%Poly%test_crate!Goo. (Poly%test_crate!Goo. tmp%%$)))))
             true
        )))))
        (and
         (let
          ((tmp%%$ (let
             ...
             (ite
              ...
              (let
               ((id1$ (test_crate!Goo./Tal/0 (%Poly%test_crate!Goo. (Poly%test_crate!Goo. tmp%%$2)))))
               (let
                ((id2$ (test_crate!Goo./Tal/1 (%Poly%test_crate!Goo. (Poly%test_crate!Goo. tmp%%$2)))))
                (tuple%2./tuple%2 (I id1$) (I id2$))
              ))
              (%Poly%tuple%2. (vstd!pervasive.arbitrary.? $ (TYPE%tuple%2. $ (UINT 64) $ (UINT 64))))
          ))))
          (let
           ((id1$ (%I (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. tmp%%$))))))
           (let
            ((id2$ (%I (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. tmp%%$))))))
            (let
             ((update_tmp_storage_opt$1 core!option.Option./None))
             (= (test_crate!Y.State./State/storage_opt (%Poly%test_crate!Y.State. post!)) update_tmp_storage_opt$1)
         ))))
    ...
    :pattern ((test_crate!Y.impl&%7.tr3_strong.? pre! post!))
    :qid internal_test_crate!Y.impl&__7.tr3_strong.?_definition
    :skolemid skolem_internal_test_crate!Y.impl&__7.tr3_strong.?_definition
))))

;; Function-Axioms test_crate::Y::State::tr3_enabled
(assert
 (fuel_bool_default fuel%test_crate!Y.impl&%7.tr3_enabled.)
)
(assert
 (=>
  (fuel_bool fuel%test_crate!Y.impl&%7.tr3_enabled.)
  (forall ((pre! Poly)) (!
    (= (test_crate!Y.impl&%7.tr3_enabled.? pre!) true)
    :pattern ((test_crate!Y.impl&%7.tr3_enabled.? pre!))
    :qid internal_test_crate!Y.impl&__7.tr3_enabled.?_definition
    :skolemid skolem_internal_test_crate!Y.impl&__7.tr3_enabled.?_definition
))))

;; Function-Axioms test_crate::Y::State::tr4_strong
(assert
 (fuel_bool_default fuel%test_crate!Y.impl&%7.tr4_strong.)
)
(assert
 (=>
  (fuel_bool fuel%test_crate!Y.impl&%7.tr4_strong.)
  (forall ((pre! Poly) (post! Poly)) (!
    (= (test_crate!Y.impl&%7.tr4_strong.? pre! post!) (let
      ((update_tmp_storage_m$ (test_crate!Y.State./State/storage_m (%Poly%test_crate!Y.State.
          pre!
      ))))
      (let
        ...
        (and
         ...
         (let
          ((tmp%%$ (%Poly%test_crate!Goo. (vstd!map.impl&%0.index.? $ INT $ TYPE%test_crate!Goo.
              (Poly%vstd!map.Map<int./test_crate!Goo.>. update_tmp_storage_m$) (I 1)
          ))))
          (is-test_crate!Goo./Bar tmp%%$)
        ))
        (let
    ...
    :pattern ((test_crate!Y.impl&%7.tr4_strong.? pre! post!))
    :qid internal_test_crate!Y.impl&__7.tr4_strong.?_definition
    :skolemid skolem_internal_test_crate!Y.impl&__7.tr4_strong.?_definition
))))

;; Function-Axioms test_crate::Y::State::tr4_enabled
(assert
 (fuel_bool_default fuel%test_crate!Y.impl&%7.tr4_enabled.)
)
(assert
 (=>
  (fuel_bool fuel%test_crate!Y.impl&%7.tr4_enabled.)
  (forall ((pre! Poly)) (!
    (= (test_crate!Y.impl&%7.tr4_enabled.? pre!) true)
    :pattern ((test_crate!Y.impl&%7.tr4_enabled.? pre!))
    :qid internal_test_crate!Y.impl&__7.tr4_enabled.?_definition
    :skolemid skolem_internal_test_crate!Y.impl&__7.tr4_enabled.?_definition
))))

;; Function-Axioms test_crate::Y::State::tr5_strong
(assert
 (fuel_bool_default fuel%test_crate!Y.impl&%7.tr5_strong.)
)
(assert
 (=>
  (fuel_bool fuel%test_crate!Y.impl&%7.tr5_strong.)
  (forall ((pre! Poly) (post! Poly)) (!
    (= (test_crate!Y.impl&%7.tr5_strong.? pre! post!) (let
      ((update_tmp_storage_m$ (test_crate!Y.State./State/storage_m (%Poly%test_crate!Y.State.
          pre!
      ))))
      (let
    ...
    :pattern ((test_crate!Y.impl&%7.tr5_strong.? pre! post!))
    :qid internal_test_crate!Y.impl&__7.tr5_strong.?_definition
    :skolemid skolem_internal_test_crate!Y.impl&__7.tr5_strong.?_definition
))))

;; Function-Axioms test_crate::Y::State::tr5_enabled
(assert
 (fuel_bool_default fuel%test_crate!Y.impl&%7.tr5_enabled.)
)
(assert
 (=>
  (fuel_bool fuel%test_crate!Y.impl&%7.tr5_enabled.)
  (forall ((pre! Poly)) (!
    (= (test_crate!Y.impl&%7.tr5_enabled.? pre!) true)
    :pattern ((test_crate!Y.impl&%7.tr5_enabled.? pre!))
    :qid internal_test_crate!Y.impl&__7.tr5_enabled.?_definition
    :skolemid skolem_internal_test_crate!Y.impl&__7.tr5_enabled.?_definition
))))

;; Function-Axioms test_crate::Y::State::tr6_strong
(assert
 (fuel_bool_default fuel%test_crate!Y.impl&%7.tr6_strong.)
)
(assert
 (=>
  (fuel_bool fuel%test_crate!Y.impl&%7.tr6_strong.)
  (forall ((pre! Poly) (post! Poly)) (!
    (= (test_crate!Y.impl&%7.tr6_strong.? pre! post!) (let
      ((update_tmp_storage_m$ (test_crate!Y.State./State/storage_m (%Poly%test_crate!Y.State.
          pre!
      ))))
      (let
    ...
    :pattern ((test_crate!Y.impl&%7.tr6_strong.? pre! post!))
    :qid internal_test_crate!Y.impl&__7.tr6_strong.?_definition
    :skolemid skolem_internal_test_crate!Y.impl&__7.tr6_strong.?_definition
))))

;; Function-Axioms test_crate::Y::State::tr6_enabled
(assert
 (fuel_bool_default fuel%test_crate!Y.impl&%7.tr6_enabled.)
)
(assert
 (=>
  (fuel_bool fuel%test_crate!Y.impl&%7.tr6_enabled.)
  (forall ((pre! Poly)) (!
    (= (test_crate!Y.impl&%7.tr6_enabled.? pre!) true)
    :pattern ((test_crate!Y.impl&%7.tr6_enabled.? pre!))
    :qid internal_test_crate!Y.impl&__7.tr6_enabled.?_definition
    :skolemid skolem_internal_test_crate!Y.impl&__7.tr6_enabled.?_definition
))))

;; Function-Axioms test_crate::Y::State::invariant
(assert
 (fuel_bool_default fuel%test_crate!Y.impl&%7.invariant.)
)
(assert
 (=>
  (fuel_bool fuel%test_crate!Y.impl&%7.invariant.)
  (forall ((self! Poly)) (!
    (= (test_crate!Y.impl&%7.invariant.? self!) true)
    :pattern ((test_crate!Y.impl&%7.invariant.? self!))
    :qid internal_test_crate!Y.impl&__7.invariant.?_definition
    :skolemid skolem_internal_test_crate!Y.impl&__7.invariant.?_definition
))))
...
(assert
 (forall ((pre! test_crate!Y.State.)) (!
   (= (req%test_crate!Y.take_step.tr1. pre!) (=>
     ...
     (and
      (test_crate!Y.impl&%7.tr1_enabled.? (Poly%test_crate!Y.State. pre!))
      (test_crate!Y.impl&%7.invariant.? (Poly%test_crate!Y.State. pre!))
   )))
...
(assert
 (forall ((pre! test_crate!Y.State.) (post! test_crate!Y.State.)) (!
   (= (ens%test_crate!Y.take_step.tr1. pre! post!) (and
     ...
     (and
      (test_crate!Y.impl&%7.tr1_strong.? (Poly%test_crate!Y.State. pre!) (Poly%test_crate!Y.State.
        post!
      ))
      (test_crate!Y.impl&%7.invariant.? (Poly%test_crate!Y.State. post!))
   )))
...
(assert
 (forall ((pre! test_crate!Y.State.)) (!
   (= (req%test_crate!Y.take_step.tr2. pre!) (=>
     ...
     (and
      (test_crate!Y.impl&%7.tr2_enabled.? (Poly%test_crate!Y.State. pre!))
      (test_crate!Y.impl&%7.invariant.? (Poly%test_crate!Y.State. pre!))
   )))
...
(assert
 (forall ((pre! test_crate!Y.State.) (post! test_crate!Y.State.)) (!
   (= (ens%test_crate!Y.take_step.tr2. pre! post!) (and
     (has_type (Poly%test_crate!Y.State. post!) TYPE%test_crate!Y.State.)
     (and
      (test_crate!Y.impl&%7.tr2_strong.? (Poly%test_crate!Y.State. pre!) (Poly%test_crate!Y.State.
        post!
      ))
      (test_crate!Y.impl&%7.invariant.? (Poly%test_crate!Y.State. post!))
   )))
...
(assert
 (forall ((pre! test_crate!Y.State.)) (!
   (= (req%test_crate!Y.take_step.tr3. pre!) (=>
     ...
     (and
      (test_crate!Y.impl&%7.tr3_enabled.? (Poly%test_crate!Y.State. pre!))
      (test_crate!Y.impl&%7.invariant.? (Poly%test_crate!Y.State. pre!))
   )))
...
(assert
 (forall ((pre! test_crate!Y.State.) (post! test_crate!Y.State.)) (!
   (= (ens%test_crate!Y.take_step.tr3. pre! post!) (and
     (has_type (Poly%test_crate!Y.State. post!) TYPE%test_crate!Y.State.)
     (and
      (test_crate!Y.impl&%7.tr3_strong.? (Poly%test_crate!Y.State. pre!) (Poly%test_crate!Y.State.
        post!
      ))
      (test_crate!Y.impl&%7.invariant.? (Poly%test_crate!Y.State. post!))
   )))
...
(declare-fun req%test_crate!Y.take_step.tr4. (test_crate!Y.State.) Bool)
(declare-const %%global_location_label%%5 Bool)
(assert
 (forall ((pre! test_crate!Y.State.)) (!
   (= (req%test_crate!Y.take_step.tr4. pre!) (=>
     %%global_location_label%%5
     (and
      (test_crate!Y.impl&%7.tr4_enabled.? (Poly%test_crate!Y.State. pre!))
      (test_crate!Y.impl&%7.invariant.? (Poly%test_crate!Y.State. pre!))
   )))
   :pattern ((req%test_crate!Y.take_step.tr4. pre!))
...
(declare-fun ens%test_crate!Y.take_step.tr4. (test_crate!Y.State. test_crate!Y.State.)
 Bool
)
(assert
 (forall ((pre! test_crate!Y.State.) (post! test_crate!Y.State.)) (!
   (= (ens%test_crate!Y.take_step.tr4. pre! post!) (and
     (has_type (Poly%test_crate!Y.State. post!) TYPE%test_crate!Y.State.)
     (and
      (test_crate!Y.impl&%7.tr4_strong.? (Poly%test_crate!Y.State. pre!) (Poly%test_crate!Y.State.
        post!
      ))
      (test_crate!Y.impl&%7.invariant.? (Poly%test_crate!Y.State. post!))
   )))
   :pattern ((ens%test_crate!Y.take_step.tr4. pre! post!))
...
(declare-fun req%test_crate!Y.take_step.tr5. (test_crate!Y.State.) Bool)
(declare-const %%global_location_label%%6 Bool)
(assert
 (forall ((pre! test_crate!Y.State.)) (!
   (= (req%test_crate!Y.take_step.tr5. pre!) (=>
     %%global_location_label%%6
     (and
      (test_crate!Y.impl&%7.tr5_enabled.? (Poly%test_crate!Y.State. pre!))
      (test_crate!Y.impl&%7.invariant.? (Poly%test_crate!Y.State. pre!))
   )))
   :pattern ((req%test_crate!Y.take_step.tr5. pre!))
...
(declare-fun ens%test_crate!Y.take_step.tr5. (test_crate!Y.State. test_crate!Y.State.)
 Bool
)
(assert
 (forall ((pre! test_crate!Y.State.) (post! test_crate!Y.State.)) (!
   (= (ens%test_crate!Y.take_step.tr5. pre! post!) (and
     (has_type (Poly%test_crate!Y.State. post!) TYPE%test_crate!Y.State.)
     (and
      (test_crate!Y.impl&%7.tr5_strong.? (Poly%test_crate!Y.State. pre!) (Poly%test_crate!Y.State.
        post!
      ))
      (test_crate!Y.impl&%7.invariant.? (Poly%test_crate!Y.State. post!))
   )))
   :pattern ((ens%test_crate!Y.take_step.tr5. pre! post!))
...
(declare-fun req%test_crate!Y.take_step.tr6. (test_crate!Y.State.) Bool)
(declare-const %%global_location_label%%7 Bool)
(assert
 (forall ((pre! test_crate!Y.State.)) (!
   (= (req%test_crate!Y.take_step.tr6. pre!) (=>
     %%global_location_label%%7
     (and
      (test_crate!Y.impl&%7.tr6_enabled.? (Poly%test_crate!Y.State. pre!))
      (test_crate!Y.impl&%7.invariant.? (Poly%test_crate!Y.State. pre!))
   )))
   :pattern ((req%test_crate!Y.take_step.tr6. pre!))
...
(declare-fun ens%test_crate!Y.take_step.tr6. (test_crate!Y.State. test_crate!Y.State.)
 Bool
)
(assert
 (forall ((pre! test_crate!Y.State.) (post! test_crate!Y.State.)) (!
   (= (ens%test_crate!Y.take_step.tr6. pre! post!) (and
     (has_type (Poly%test_crate!Y.State. post!) TYPE%test_crate!Y.State.)
     (and
      (test_crate!Y.impl&%7.tr6_strong.? (Poly%test_crate!Y.State. pre!) (Poly%test_crate!Y.State.
        post!
      ))
      (test_crate!Y.impl&%7.invariant.? (Poly%test_crate!Y.State. post!))
   )))
   :pattern ((ens%test_crate!Y.take_step.tr6. pre! post!))
