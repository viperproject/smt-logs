...
(assert
 (distinct fuel%vstd!std_specs.option.impl&%0.is_Some. fuel%vstd!std_specs.option.impl&%0.get_Some_0.
  ...
  fuel%vstd!set.axiom_set_remove_finite. fuel%test_crate!Y.impl&%7.tr1. fuel%test_crate!Y.impl&%7.tr2.
  fuel%test_crate!Y.impl&%7.tr3. fuel%test_crate!Y.impl&%7.tr4. fuel%test_crate!Y.impl&%7.tr5.
  fuel%test_crate!Y.impl&%7.tr6. fuel%vstd!array.group_array_axioms. fuel%vstd!map.group_map_axioms.
...
(assert
 (forall ((pre! test_crate!Y.State.) (post! test_crate!Y.State.)) (!
   (= (req%test_crate!Y.show.tr1. pre! post!) (=>
     ...
     (test_crate!Y.impl&%7.tr1.? (Poly%test_crate!Y.State. pre!) (Poly%test_crate!Y.State.
       post!
   ))))
...
(assert
 (forall ((pre! test_crate!Y.State.) (post! test_crate!Y.State.)) (!
   (= (ens%test_crate!Y.show.tr1. pre! post!) (test_crate!Y.impl&%7.next.? (Poly%test_crate!Y.State.
      pre!
...
(assert
 (forall ((pre! test_crate!Y.State.) (post! test_crate!Y.State.)) (!
   (= (req%test_crate!Y.show.tr2. pre! post!) (=>
     ...
     (test_crate!Y.impl&%7.tr2.? (Poly%test_crate!Y.State. pre!) (Poly%test_crate!Y.State.
       post!
   ))))
...
(assert
 (forall ((pre! test_crate!Y.State.) (post! test_crate!Y.State.)) (!
   (= (ens%test_crate!Y.show.tr2. pre! post!) (test_crate!Y.impl&%7.next.? (Poly%test_crate!Y.State.
      pre!
     ) (Poly%test_crate!Y.State. post!)
   ))
...
(assert
 (forall ((pre! test_crate!Y.State.) (post! test_crate!Y.State.)) (!
   (= (req%test_crate!Y.show.tr3. pre! post!) (=>
     ...
     (test_crate!Y.impl&%7.tr3.? (Poly%test_crate!Y.State. pre!) (Poly%test_crate!Y.State.
       post!
   ))))
...
(assert
 (forall ((pre! test_crate!Y.State.) (post! test_crate!Y.State.)) (!
   (= (ens%test_crate!Y.show.tr3. pre! post!) (test_crate!Y.impl&%7.next.? (Poly%test_crate!Y.State.
      pre!
     ) (Poly%test_crate!Y.State. post!)
   ))
...
(assert
 (forall ((pre! test_crate!Y.State.) (post! test_crate!Y.State.)) (!
   (= (req%test_crate!Y.show.tr4. pre! post!) (=>
     ...
     (test_crate!Y.impl&%7.tr4.? (Poly%test_crate!Y.State. pre!) (Poly%test_crate!Y.State.
       post!
   ))))
...
(assert
 (forall ((pre! test_crate!Y.State.) (post! test_crate!Y.State.)) (!
   (= (ens%test_crate!Y.show.tr4. pre! post!) (test_crate!Y.impl&%7.next.? (Poly%test_crate!Y.State.
      pre!
     ) (Poly%test_crate!Y.State. post!)
   ))
...
(declare-fun req%test_crate!Y.show.tr5. (test_crate!Y.State. test_crate!Y.State.)
 Bool
)
(declare-const %%global_location_label%%6 Bool)
(assert
 (forall ((pre! test_crate!Y.State.) (post! test_crate!Y.State.)) (!
   (= (req%test_crate!Y.show.tr5. pre! post!) (=>
     %%global_location_label%%6
     (test_crate!Y.impl&%7.tr5.? (Poly%test_crate!Y.State. pre!) (Poly%test_crate!Y.State.
       post!
   ))))
   :pattern ((req%test_crate!Y.show.tr5. pre! post!))
   :qid internal_req__test_crate!Y.show.tr5._definition
   :skolemid skolem_internal_req__test_crate!Y.show.tr5._definition
)))
(declare-fun ens%test_crate!Y.show.tr5. (test_crate!Y.State. test_crate!Y.State.)
 Bool
)
(assert
 (forall ((pre! test_crate!Y.State.) (post! test_crate!Y.State.)) (!
   (= (ens%test_crate!Y.show.tr5. pre! post!) (test_crate!Y.impl&%7.next.? (Poly%test_crate!Y.State.
      pre!
     ) (Poly%test_crate!Y.State. post!)
   ))
   :pattern ((ens%test_crate!Y.show.tr5. pre! post!))
...
(declare-fun req%test_crate!Y.show.tr6. (test_crate!Y.State. test_crate!Y.State.)
 Bool
)
(declare-const %%global_location_label%%7 Bool)
(assert
 (forall ((pre! test_crate!Y.State.) (post! test_crate!Y.State.)) (!
   (= (req%test_crate!Y.show.tr6. pre! post!) (=>
     %%global_location_label%%7
     (test_crate!Y.impl&%7.tr6.? (Poly%test_crate!Y.State. pre!) (Poly%test_crate!Y.State.
       post!
   ))))
   :pattern ((req%test_crate!Y.show.tr6. pre! post!))
   :qid internal_req__test_crate!Y.show.tr6._definition
   :skolemid skolem_internal_req__test_crate!Y.show.tr6._definition
)))
(declare-fun ens%test_crate!Y.show.tr6. (test_crate!Y.State. test_crate!Y.State.)
 Bool
)
(assert
 (forall ((pre! test_crate!Y.State.) (post! test_crate!Y.State.)) (!
   (= (ens%test_crate!Y.show.tr6. pre! post!) (test_crate!Y.impl&%7.next.? (Poly%test_crate!Y.State.
      pre!
     ) (Poly%test_crate!Y.State. post!)
   ))
   :pattern ((ens%test_crate!Y.show.tr6. pre! post!))
