...
;; Datatypes
(declare-sort test_crate!A.Instance. 0)
(declare-datatypes ((test_crate!Foo. 0) (test_crate!Y. 0) (tuple%2. 0)) (((test_crate!Foo./Bar
    (test_crate!Foo./Bar/?0 Int)
   ) (test_crate!Foo./Qax (test_crate!Foo./Qax/?0 Int)) (test_crate!Foo./Duck (test_crate!Foo./Duck/?0
     Int
   ))
  ) ((test_crate!Y./Y)) ((tuple%2./tuple%2 (tuple%2./tuple%2/?0 Poly) (tuple%2./tuple%2/?1
     Poly
)))))
...
(assert
 (forall ((x test_crate!A.Instance.)) (!
   (has_type (Poly%test_crate!A.Instance. x) TYPE%test_crate!A.Instance.)
   :pattern ((has_type (Poly%test_crate!A.Instance. x) TYPE%test_crate!A.Instance.))
   :qid internal_test_crate__A__Instance_has_type_always_definition
   :skolemid skolem_internal_test_crate__A__Instance_has_type_always_definition
)))
(assert
...
(declare-fun ens%test_crate!test. (test_crate!A.Instance. tuple%2.) Bool)
(assert
 (forall ((t! test_crate!A.Instance.) (%return! tuple%2.)) (!
   (= (ens%test_crate!test. t! %return!) (has_type (Poly%tuple%2. %return!) (TYPE%tuple%2.
      $ TYPE%test_crate!A.Instance. $ TYPE%test_crate!A.Instance.
   )))
   :pattern ((ens%test_crate!test. t! %return!))
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/state_machines-c25f1c939512e7ab-inst_copy/test.rs:50:7: 50:80 (#0)
(get-info :all-statistics)
(push)
 (declare-const %return! tuple%2.)
 (declare-const t! test_crate!A.Instance.)
 (assert
  fuel_defaults
 )
 (assert
