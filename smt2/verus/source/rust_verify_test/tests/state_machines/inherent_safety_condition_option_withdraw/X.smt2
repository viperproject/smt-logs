...
(assert
 (distinct fuel%vstd!std_specs.option.impl&%0.is_Some. fuel%vstd!std_specs.option.impl&%0.get_Some_0.
  fuel%vstd!std_specs.option.impl&%0.arrow_Some_0. fuel%vstd!std_specs.option.is_some.
  fuel%vstd!std_specs.option.is_none. fuel%vstd!std_specs.option.spec_unwrap. fuel%test_crate!X.impl&%0.arrow_0.
  ...
  fuel%test_crate!X.impl&%7.tr. fuel%test_crate!X.impl&%7.tr_strong. fuel%test_crate!X.impl&%7.tr_enabled.
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/state_machines-c25f1c939512e7ab-inherent_safety_condition_option_withdraw/test.rs:48:5: 48:47 (#0)
...
(push)
 ...
 (assert
  (not (=>
    (= tmp%1 (is-core!option.Option./Some (test_crate!X.State./State/t (%Poly%test_crate!X.State.
    ...
    (and
     ...
     (=>
      tmp%1
      (=>
       (= tmp%2 (= (%I (core!option.Option./Some/0 (%Poly%core!option.Option. (Poly%core!option.Option.
       ...
       (and
        ...
        (=>
         tmp%2
         (=>
          (= tmp%3 (is-core!option.Option./None (test_crate!X.State./State/t (%Poly%test_crate!X.State.
              (Poly%test_crate!X.State. post!)
          ))))
          (and
           (=>
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/state_machines-c25f1c939512e7ab-inherent_safety_condition_option_withdraw/test.rs:35:1: 53:3 (#42)
(get-info :all-statistics)
(push)
 (declare-const pre! test_crate!X.State.)
 (declare-const tmp%1 Bool)
...
(assert
 (forall ((self! test_crate!X.Instance.) (param_token_0_t! Int)) (!
   (= (ens%test_crate!X.impl&%4.tr. self! param_token_0_t!) (= param_token_0_t! 5))
