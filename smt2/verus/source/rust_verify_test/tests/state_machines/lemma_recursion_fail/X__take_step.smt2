...
(declare-const fuel%test_crate!X.impl&%10.inv_2. FuelId)
...
(assert
 (distinct fuel%test_crate!X.impl&%10.initialize. fuel%test_crate!X.impl&%10.initialize_enabled.
  fuel%test_crate!X.impl&%10.invariant. fuel%test_crate!X.impl&%10.inv_2. fuel%vstd!array.group_array_axioms.
...
;; Datatypes
(declare-datatypes ((test_crate!X.State. 0)) (((test_crate!X.State./State (test_crate!X.State./State/?t
     Int
)))))
...
;; Function-Decl test_crate::X::State::inv_2
(declare-fun test_crate!X.impl&%10.inv_2.? (Poly) Bool)
...
;; Function-Axioms test_crate::X::State::inv_2
(assert
 (fuel_bool_default fuel%test_crate!X.impl&%10.inv_2.)
)
(assert
 (=>
  (fuel_bool fuel%test_crate!X.impl&%10.inv_2.)
  (forall ((self! Poly)) (!
    (= (test_crate!X.impl&%10.inv_2.? self!) (= (test_crate!X.State./State/t (%Poly%test_crate!X.State.
        self!
       )
      ) 2
    ))
    :pattern ((test_crate!X.impl&%10.inv_2.? self!))
    :qid internal_test_crate!X.impl&__10.inv_2.?_definition
    :skolemid skolem_internal_test_crate!X.impl&__10.inv_2.?_definition
))))
...
(assert
 (=>
  ...
  (forall ((self! Poly)) (!
    (= (test_crate!X.impl&%10.invariant.? self!) (test_crate!X.impl&%10.inv_2.? self!))
