...
(declare-datatypes ((core!option.Option. 0) (test_crate!X.State. 0) (tuple%0. 0) (tuple%2.
   0
  )
...
(declare-fun req%test_crate!X.show.tr. (test_crate!X.State. test_crate!X.State. core!option.Option.
...
(assert
 (forall ((pre! test_crate!X.State.) (post! test_crate!X.State.) (x! core!option.Option.)
   ...
   (= (req%test_crate!X.show.tr. pre! post! x! y! z! w! v!) (=>
   ...
   :pattern ((req%test_crate!X.show.tr. pre! post! x! y! z! w! v!))
   :qid internal_req__test_crate!X.show.tr._definition
   :skolemid skolem_internal_req__test_crate!X.show.tr._definition
)))
(declare-fun ens%test_crate!X.show.tr. (test_crate!X.State. test_crate!X.State. core!option.Option.
  Bool Bool Bool core!option.Option.
 ) Bool
)
(assert
 (forall ((pre! test_crate!X.State.) (post! test_crate!X.State.) (x! core!option.Option.)
   ...
   (= (ens%test_crate!X.show.tr. pre! post! x! y! z! w! v!) (test_crate!X.impl&%4.next.?
     (Poly%test_crate!X.State. pre!) (Poly%test_crate!X.State. post!)
   ))
   :pattern ((ens%test_crate!X.show.tr. pre! post! x! y! z! w! v!))
