...
(assert
 (distinct fuel%test_crate!Z.impl&%13.initialize. fuel%test_crate!Z.impl&%13.tr1. fuel%test_crate!Z.impl&%13.tr2.
  fuel%test_crate!Z.impl&%13.tr3. fuel%vstd!array.group_array_axioms. fuel%vstd!map.group_map_axioms.
...
;; Datatypes
(declare-datatypes ((test_crate!Z.State. 0) (tuple%0. 0)) (((test_crate!Z.State./State
    (test_crate!Z.State./State/?v1 Int) (test_crate!Z.State./State/?v2 Int) (test_crate!Z.State./State/?nt
     Int
    ) (test_crate!Z.State./State/?c Int)
   )
  ) ((tuple%0./tuple%0))
))
...
;; Function-Specs test_crate::Z::show::tr1
(declare-fun req%test_crate!Z.show.tr1. (test_crate!Z.State. test_crate!Z.State.)
 Bool
)
(declare-const %%global_location_label%%0 Bool)
(assert
 (forall ((pre! test_crate!Z.State.) (post! test_crate!Z.State.)) (!
   (= (req%test_crate!Z.show.tr1. pre! post!) (=>
     %%global_location_label%%0
     (test_crate!Z.impl&%13.tr1.? (Poly%test_crate!Z.State. pre!) (Poly%test_crate!Z.State.
       post!
   ))))
   :pattern ((req%test_crate!Z.show.tr1. pre! post!))
   :qid internal_req__test_crate!Z.show.tr1._definition
   :skolemid skolem_internal_req__test_crate!Z.show.tr1._definition
)))
(declare-fun ens%test_crate!Z.show.tr1. (test_crate!Z.State. test_crate!Z.State.)
 Bool
)
(assert
 (forall ((pre! test_crate!Z.State.) (post! test_crate!Z.State.)) (!
   (= (ens%test_crate!Z.show.tr1. pre! post!) (test_crate!Z.impl&%13.next.? (Poly%test_crate!Z.State.
      pre!
     ) (Poly%test_crate!Z.State. post!)
   ))
   :pattern ((ens%test_crate!Z.show.tr1. pre! post!))
   :qid internal_ens__test_crate!Z.show.tr1._definition
   :skolemid skolem_internal_ens__test_crate!Z.show.tr1._definition
)))

;; Function-Specs test_crate::Z::show::tr2
(declare-fun req%test_crate!Z.show.tr2. (test_crate!Z.State. test_crate!Z.State.)
 Bool
)
(declare-const %%global_location_label%%1 Bool)
(assert
 (forall ((pre! test_crate!Z.State.) (post! test_crate!Z.State.)) (!
   (= (req%test_crate!Z.show.tr2. pre! post!) (=>
     %%global_location_label%%1
     (test_crate!Z.impl&%13.tr2.? (Poly%test_crate!Z.State. pre!) (Poly%test_crate!Z.State.
       post!
   ))))
   :pattern ((req%test_crate!Z.show.tr2. pre! post!))
   :qid internal_req__test_crate!Z.show.tr2._definition
   :skolemid skolem_internal_req__test_crate!Z.show.tr2._definition
)))
(declare-fun ens%test_crate!Z.show.tr2. (test_crate!Z.State. test_crate!Z.State.)
 Bool
)
(assert
 (forall ((pre! test_crate!Z.State.) (post! test_crate!Z.State.)) (!
   (= (ens%test_crate!Z.show.tr2. pre! post!) (test_crate!Z.impl&%13.next.? (Poly%test_crate!Z.State.
      pre!
     ) (Poly%test_crate!Z.State. post!)
   ))
   :pattern ((ens%test_crate!Z.show.tr2. pre! post!))
   :qid internal_ens__test_crate!Z.show.tr2._definition
   :skolemid skolem_internal_ens__test_crate!Z.show.tr2._definition
)))

;; Function-Specs test_crate::Z::show::tr3
(declare-fun req%test_crate!Z.show.tr3. (test_crate!Z.State. test_crate!Z.State.)
 Bool
)
(declare-const %%global_location_label%%2 Bool)
(assert
 (forall ((pre! test_crate!Z.State.) (post! test_crate!Z.State.)) (!
   (= (req%test_crate!Z.show.tr3. pre! post!) (=>
     %%global_location_label%%2
     (test_crate!Z.impl&%13.tr3.? (Poly%test_crate!Z.State. pre!) (Poly%test_crate!Z.State.
       post!
   ))))
   :pattern ((req%test_crate!Z.show.tr3. pre! post!))
   :qid internal_req__test_crate!Z.show.tr3._definition
   :skolemid skolem_internal_req__test_crate!Z.show.tr3._definition
)))
(declare-fun ens%test_crate!Z.show.tr3. (test_crate!Z.State. test_crate!Z.State.)
 Bool
)
(assert
 (forall ((pre! test_crate!Z.State.) (post! test_crate!Z.State.)) (!
   (= (ens%test_crate!Z.show.tr3. pre! post!) (test_crate!Z.impl&%13.next.? (Poly%test_crate!Z.State.
      pre!
     ) (Poly%test_crate!Z.State. post!)
   ))
   :pattern ((ens%test_crate!Z.show.tr3. pre! post!))
   :qid internal_ens__test_crate!Z.show.tr3._definition
   :skolemid skolem_internal_ens__test_crate!Z.show.tr3._definition
)))
...
;; Function-Specs test_crate::Z::show::initialize
(declare-fun req%test_crate!Z.show.initialize. (test_crate!Z.State.) Bool)
(declare-const %%global_location_label%%3 Bool)
(assert
 (forall ((post! test_crate!Z.State.)) (!
   (= (req%test_crate!Z.show.initialize. post!) (=>
     %%global_location_label%%3
     (test_crate!Z.impl&%13.initialize.? (Poly%test_crate!Z.State. post!))
   ))
   :pattern ((req%test_crate!Z.show.initialize. post!))
   :qid internal_req__test_crate!Z.show.initialize._definition
   :skolemid skolem_internal_req__test_crate!Z.show.initialize._definition
)))
(declare-fun ens%test_crate!Z.show.initialize. (test_crate!Z.State.) Bool)
(assert
 (forall ((post! test_crate!Z.State.)) (!
   (= (ens%test_crate!Z.show.initialize. post!) (test_crate!Z.impl&%13.init.? (Poly%test_crate!Z.State.
      post!
   )))
   :pattern ((ens%test_crate!Z.show.initialize. post!))
   :qid internal_ens__test_crate!Z.show.initialize._definition
   :skolemid skolem_internal_ens__test_crate!Z.show.initialize._definition
)))
