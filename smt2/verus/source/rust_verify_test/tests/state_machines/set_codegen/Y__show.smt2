...
(assert
 (distinct fuel%vstd!set.impl&%0.subset_of. fuel%vstd!set.impl&%0.disjoint. fuel%vstd!set.axiom_set_empty.
  ...
  fuel%vstd!set.axiom_set_ext_equal_deep. fuel%test_crate!Y.impl&%10.initialize. fuel%test_crate!Y.impl&%10.tr_add.
  fuel%test_crate!Y.impl&%10.tr_have. fuel%test_crate!Y.impl&%10.tr_remove. fuel%test_crate!Y.impl&%10.tr_add_gen.
  fuel%test_crate!Y.impl&%10.tr_have_gen. fuel%test_crate!Y.impl&%10.tr_remove_gen.
...
(assert
 (forall ((pre! test_crate!Y.State.) (post! test_crate!Y.State.)) (!
   (= (ens%test_crate!Y.show.tr_add_gen. pre! post!) (test_crate!Y.impl&%10.next.? (Poly%test_crate!Y.State.
      pre!
     ) (Poly%test_crate!Y.State. post!)
   ))
...
(assert
 (forall ((pre! test_crate!Y.State.) (post! test_crate!Y.State.)) (!
   (= (ens%test_crate!Y.show.tr_have_gen. pre! post!) (test_crate!Y.impl&%10.next.? (Poly%test_crate!Y.State.
      pre!
     ) (Poly%test_crate!Y.State. post!)
   ))
...
(assert
 (forall ((pre! test_crate!Y.State.) (post! test_crate!Y.State.)) (!
   (= (req%test_crate!Y.show.tr_remove_gen. pre! post!) (=>
     %%global_location_label%%5
     (test_crate!Y.impl&%10.tr_remove_gen.? (Poly%test_crate!Y.State. pre!) (Poly%test_crate!Y.State.
       post!
   ))))
   :pattern ((req%test_crate!Y.show.tr_remove_gen. pre! post!))
...
(assert
 (forall ((pre! test_crate!Y.State.) (post! test_crate!Y.State.)) (!
   (= (ens%test_crate!Y.show.tr_remove_gen. pre! post!) (test_crate!Y.impl&%10.next.?
     (Poly%test_crate!Y.State. pre!) (Poly%test_crate!Y.State. post!)
   ))
   :pattern ((ens%test_crate!Y.show.tr_remove_gen. pre! post!))
...
(assert
 (forall ((post! test_crate!Y.State.)) (!
   (= (ens%test_crate!Y.show.initialize. post!) (test_crate!Y.impl&%10.init.? (Poly%test_crate!Y.State.
      post!
   )))
