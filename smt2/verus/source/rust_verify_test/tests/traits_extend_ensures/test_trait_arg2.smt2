...
;; Datatypes
(declare-datatypes ((Y. 0) (X. 0) (X2. 0) (Z. 0) (tuple%0. 0) (tuple%3. 0)) (((Y./Y (
     Y./Y/?j Int
   ))
  ) ((X./X (X./X/?b Poly))) ((X2./X2 (X2./X2/?b Poly))) ((Z./Z (Z./Z/?j Int))) ((tuple%0./tuple%0))
...
(declare-fun TYPE%X2. (Dcr Type) Type)
...
(declare-fun Poly%X2. (X2.) Poly)
(declare-fun %Poly%X2. (Poly) X2.)
...
(assert
 (forall ((x X2.)) (!
   (= x (%Poly%X2. (Poly%X2. x)))
   :pattern ((Poly%X2. x))
   :qid internal_crate__X2_box_axiom_definition
   :skolemid skolem_internal_crate__X2_box_axiom_definition
)))
(assert
 (forall ((B&. Dcr) (B& Type) (x Poly)) (!
   (=>
    (has_type x (TYPE%X2. B&. B&))
    (= x (Poly%X2. (%Poly%X2. x)))
   )
   :pattern ((has_type x (TYPE%X2. B&. B&)))
   :qid internal_crate__X2_unbox_axiom_definition
   :skolemid skolem_internal_crate__X2_unbox_axiom_definition
)))
(assert
 (forall ((B&. Dcr) (B& Type) (_b! Poly)) (!
   (=>
    (has_type _b! B&)
    (has_type (Poly%X2. (X2./X2 _b!)) (TYPE%X2. B&. B&))
   )
   :pattern ((has_type (Poly%X2. (X2./X2 _b!)) (TYPE%X2. B&. B&)))
   :qid internal_X2./X2_constructor_definition
   :skolemid skolem_internal_X2./X2_constructor_definition
)))
(assert
 (forall ((x X2.)) (!
   (= (X2./X2/b x) (X2./X2/?b x))
   :pattern ((X2./X2/b x))
   :qid internal_X2./X2/b_accessor_definition
   :skolemid skolem_internal_X2./X2/b_accessor_definition
)))
(assert
 (forall ((B&. Dcr) (B& Type) (x Poly)) (!
   (=>
    (has_type x (TYPE%X2. B&. B&))
    (has_type (X2./X2/b (%Poly%X2. x)) B&)
   )
   :pattern ((X2./X2/b (%Poly%X2. x)) (has_type x (TYPE%X2. B&. B&)))
   :qid internal_X2./X2/b_invariant_definition
   :skolemid skolem_internal_X2./X2/b_invariant_definition
)))
(assert
 (forall ((x X2.)) (!
   (=>
    (is-X2./X2 x)
    (height_lt (height (X2./X2/b x)) (height (Poly%X2. x)))
   )
   :pattern ((height (X2./X2/b x)))
   :qid prelude_datatype_height_X2./X2/b
   :skolemid skolem_prelude_datatype_height_X2./X2/b
)))
(assert
 (forall ((x Z.)) (!
   (= x (%Poly%Z. (Poly%Z. x)))
...
(declare-fun ens%Tr.stuff. (Dcr Type Dcr Type Poly Poly Poly) Bool)
(assert
 (forall ((Self%&. Dcr) (Self%& Type) (B&. Dcr) (B& Type) (a! Poly) (b! Poly) (res! Poly))
  (!
   (= (ens%Tr.stuff. Self%&. Self%& B&. B& a! b! res!) (and
     (has_type res! (TYPE%tuple%3. B&. B& B&. B& B&. B&))
     (= (tuple%3./tuple%3/0 (%Poly%tuple%3. res!)) (tuple%3./tuple%3/1 (%Poly%tuple%3. res!)))
   ))
   :pattern ((ens%Tr.stuff. Self%&. Self%& B&. B& a! b! res!))
   :qid internal_ens__Tr.stuff._definition
   :skolemid skolem_internal_ens__Tr.stuff._definition
)))

;; Function-Specs crate::X::stuff
(declare-fun ens%impl&%0.stuff. (Dcr Type Poly Poly Poly) Bool)
(assert
 (forall ((B&. Dcr) (B& Type) (a! Poly) (b! Poly) (res! Poly)) (!
   (= (ens%impl&%0.stuff. B&. B& a! b! res!) (and
     (ens%Tr.stuff. $ (TYPE%X. B&. B&) B&. B& a! b! res!)
     (= (tuple%3./tuple%3/1 (%Poly%tuple%3. res!)) (tuple%3./tuple%3/2 (%Poly%tuple%3. res!)))
   ))
   :pattern ((ens%impl&%0.stuff. B&. B& a! b! res!))
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/traits_extend_ensures-c9c47fc5e5a45603-test_trait_arg2/test.rs:25:11: 25:50 (#0)
...
(assert
 (forall ((B&. Dcr) (B& Type)) (!
   (tr_bound%Tr. $ (TYPE%X. B&. B&) B&. B&)
   :pattern ((tr_bound%Tr. $ (TYPE%X. B&. B&) B&. B&))
   :qid internal_crate__impl&__0_trait_impl_definition
   :skolemid skolem_internal_crate__impl&__0_trait_impl_definition
)))

;; Function-Specs crate::X2::stuff
(declare-fun ens%impl&%1.stuff. (Dcr Type Poly Poly Poly) Bool)
(assert
 (forall ((B&. Dcr) (B& Type) (a! Poly) (b! Poly) (res! Poly)) (!
   (= (ens%impl&%1.stuff. B&. B& a! b! res!) (and
     (ens%Tr.stuff. $ (TYPE%X2. B&. B&) B&. B& a! b! res!)
     (= (tuple%3./tuple%3/1 (%Poly%tuple%3. res!)) (tuple%3./tuple%3/2 (%Poly%tuple%3. res!)))
   ))
   :pattern ((ens%impl&%1.stuff. B&. B& a! b! res!))
   :qid internal_ens__impl&__1.stuff._definition
   :skolemid skolem_internal_ens__impl&__1.stuff._definition
)))

;; Function-Def crate::X2::stuff
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/traits_extend_ensures-c9c47fc5e5a45603-test_trait_arg2/test.rs:35:11: 35:50 (#0)
(get-info :all-statistics)
(push)
 (declare-const B&. Dcr)
 (declare-const B& Type)
 ...
 (assert
  (not (=>
    (= res! (Poly%tuple%3. (tuple%3./tuple%3 a! b! b!)))
    (and
     (=>
      %%location_label%%0
      (= (tuple%3./tuple%3/0 (%Poly%tuple%3. res!)) (tuple%3./tuple%3/1 (%Poly%tuple%3. res!)))
...
;; Function-Recommends crate::X2::stuff
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/traits_extend_ensures-c9c47fc5e5a45603-test_trait_arg2/test.rs:35:11: 35:50 (#0)
(get-info :all-statistics)
(push)
 (declare-const B&. Dcr)
...
(assert
 (forall ((B&. Dcr) (B& Type)) (!
   (tr_bound%Tr. $ (TYPE%X2. B&. B&) B&. B&)
   :pattern ((tr_bound%Tr. $ (TYPE%X2. B&. B&) B&. B&))
   :qid internal_crate__impl&__1_trait_impl_definition
   :skolemid skolem_internal_crate__impl&__1_trait_impl_definition
)))

;; Function-Specs crate::Z::stuff
(declare-fun ens%impl&%2.stuff. (Poly Poly Poly) Bool)
(assert
 (forall ((a! Poly) (b! Poly) (res! Poly)) (!
   (= (ens%impl&%2.stuff. a! b! res!) (and
     (ens%Tr.stuff. $ TYPE%Z. $ (UINT 8) a! b! res!)
     (= (tuple%3./tuple%3/1 (%Poly%tuple%3. res!)) (tuple%3./tuple%3/2 (%Poly%tuple%3. res!)))
   ))
   :pattern ((ens%impl&%2.stuff. a! b! res!))
   :qid internal_ens__impl&__2.stuff._definition
   :skolemid skolem_internal_ens__impl&__2.stuff._definition
)))

;; Function-Def crate::Z::stuff
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/traits_extend_ensures-c9c47fc5e5a45603-test_trait_arg2/test.rs:52:11: 52:55 (#0)
(get-info :all-statistics)
(push)
 (declare-const res! Poly)
 (declare-const a! Poly)
 ...
 (assert
  (not (=>
    (= res! (Poly%tuple%3. (tuple%3./tuple%3 (I 0) (I 0) (I 1))))
    (and
     (=>
      %%location_label%%0
      (= (tuple%3./tuple%3/0 (%Poly%tuple%3. res!)) (tuple%3./tuple%3/1 (%Poly%tuple%3. res!)))
...
;; Function-Recommends crate::Z::stuff
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/traits_extend_ensures-c9c47fc5e5a45603-test_trait_arg2/test.rs:52:11: 52:55 (#0)
(get-info :all-statistics)
(push)
 (declare-const res! Poly)
...
;; Trait-Impl-Axiom
(assert
 (tr_bound%Tr. $ TYPE%Z. $ (UINT 8))
)

;; Function-Def crate::test
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/traits_extend_ensures-c9c47fc5e5a45603-test_trait_arg2/test.rs:42:7: 42:26 (#0)
(get-info :all-statistics)
(push)
 (declare-const a! Y.)
 (declare-const b! Y.)
 ...
 (assert
  (not (=>
    (ens%impl&%0.stuff. $ TYPE%Y. (Poly%Y. a!) (Poly%Y. b!) tmp%1)
    (=>
     (= r@ (%Poly%tuple%3. tmp%1))
     (=>
      (= tmp%2 (= (tuple%3./tuple%3/0 (%Poly%tuple%3. (Poly%tuple%3. r@))) (tuple%3./tuple%3/1
         (%Poly%tuple%3. (Poly%tuple%3. r@))
      )))
      (and
       (=>
        %%location_label%%0
       ...
       (=>
        tmp%2
        (=>
         (= tmp%3 (= (tuple%3./tuple%3/1 (%Poly%tuple%3. (Poly%tuple%3. r@))) (tuple%3./tuple%3/2
            (%Poly%tuple%3. (Poly%tuple%3. r@))
         )))
         (and
          (=>
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/traits_extend_ensures-c9c47fc5e5a45603-test_trait_arg2/test.rs:59:7: 59:29 (#0)
(get-info :all-statistics)
(push)
 (declare-const a! Int)
 (declare-const b! Int)
 ...
 (assert
  (not (=>
    (ens%impl&%2.stuff. (I a!) (I b!) tmp%1)
    (=>
     (= r@ (%Poly%tuple%3. tmp%1))
     (=>
      (= tmp%2 (= (tuple%3./tuple%3/0 (%Poly%tuple%3. (Poly%tuple%3. r@))) (tuple%3./tuple%3/1
