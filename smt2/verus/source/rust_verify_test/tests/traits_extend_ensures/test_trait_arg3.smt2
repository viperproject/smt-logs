...
;; Datatypes
(declare-datatypes ((Y. 0) (X. 0) (X2. 0) (X3. 0) (Z. 0) (tuple%0. 0) (tuple%3. 0))
 (((Y./Y (Y./Y/?j Int))) ((X./X (X./X/?b Poly))) ((X2./X2 (X2./X2/?b Poly))) ((X3./X3
    (X3./X3/?b Poly)
   )
  ) ((Z./Z (Z./Z/?j Int))) ((tuple%0./tuple%0)) ((tuple%3./tuple%3 (tuple%3./tuple%3/?0
     Poly
    ) (tuple%3./tuple%3/?1 Poly) (tuple%3./tuple%3/?2 Poly)
))))
(declare-fun Y./Y/j (Y.) Int)
(declare-fun X./X/b (X.) Poly)
(declare-fun X2./X2/b (X2.) Poly)
(declare-fun X3./X3/b (X3.) Poly)
...
(declare-fun TYPE%X3. (Dcr Type) Type)
...
(declare-fun Poly%X3. (X3.) Poly)
(declare-fun %Poly%X3. (Poly) X3.)
...
(assert
 (forall ((x X3.)) (!
   (= x (%Poly%X3. (Poly%X3. x)))
   :pattern ((Poly%X3. x))
   :qid internal_crate__X3_box_axiom_definition
   :skolemid skolem_internal_crate__X3_box_axiom_definition
)))
(assert
 (forall ((B&. Dcr) (B& Type) (x Poly)) (!
   (=>
    (has_type x (TYPE%X3. B&. B&))
    (= x (Poly%X3. (%Poly%X3. x)))
   )
   :pattern ((has_type x (TYPE%X3. B&. B&)))
   :qid internal_crate__X3_unbox_axiom_definition
   :skolemid skolem_internal_crate__X3_unbox_axiom_definition
)))
(assert
 (forall ((B&. Dcr) (B& Type) (_b! Poly)) (!
   (=>
    (has_type _b! B&)
    (has_type (Poly%X3. (X3./X3 _b!)) (TYPE%X3. B&. B&))
   )
   :pattern ((has_type (Poly%X3. (X3./X3 _b!)) (TYPE%X3. B&. B&)))
   :qid internal_X3./X3_constructor_definition
   :skolemid skolem_internal_X3./X3_constructor_definition
)))
(assert
 (forall ((x X3.)) (!
   (= (X3./X3/b x) (X3./X3/?b x))
   :pattern ((X3./X3/b x))
   :qid internal_X3./X3/b_accessor_definition
   :skolemid skolem_internal_X3./X3/b_accessor_definition
)))
(assert
 (forall ((B&. Dcr) (B& Type) (x Poly)) (!
   (=>
    (has_type x (TYPE%X3. B&. B&))
    (has_type (X3./X3/b (%Poly%X3. x)) B&)
   )
   :pattern ((X3./X3/b (%Poly%X3. x)) (has_type x (TYPE%X3. B&. B&)))
   :qid internal_X3./X3/b_invariant_definition
   :skolemid skolem_internal_X3./X3/b_invariant_definition
)))
(assert
 (forall ((x X3.)) (!
   (=>
    (is-X3./X3 x)
    (height_lt (height (X3./X3/b x)) (height (Poly%X3. x)))
   )
   :pattern ((height (X3./X3/b x)))
   :qid prelude_datatype_height_X3./X3/b
   :skolemid skolem_prelude_datatype_height_X3./X3/b
)))
(assert
 (forall ((x Z.)) (!
   (= x (%Poly%Z. (Poly%Z. x)))
...
(assert
 (=>
  ...
  (forall ((self! Poly) (other! Poly)) (!
    (= (Compare.comp.? $ TYPE%Y. self! other!) (B (= (Y./Y/j (%Poly%Y. self!)) (Add (Y./Y/j
         (%Poly%Y. other!)
        ) 1
    ))))
    :pattern ((Compare.comp.? $ TYPE%Y. self! other!))
...
(assert
 (forall ((B&. Dcr) (B& Type) (a! Poly) (b! Poly) (c! Poly) (res! Poly)) (!
   (= (ens%impl&%1.stuff. B&. B& a! b! c! res!) (and
     (ens%Tr.stuff. $ (TYPE%X. B&. B&) B&. B& a! b! c! res!)
     (%B (Compare.comp.? B&. B& (tuple%3./tuple%3/1 (%Poly%tuple%3. res!)) (tuple%3./tuple%3/2
        (%Poly%tuple%3. res!)
   )))))
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/traits_extend_ensures-c9c47fc5e5a45603-test_trait_arg3/test.rs:35:11: 35:56 (#0)
...
(assert
 (forall ((B&. Dcr) (B& Type) (a! Poly) (b! Poly) (c! Poly) (res! Poly)) (!
   (= (ens%impl&%2.stuff. B&. B& a! b! c! res!) (and
     (ens%Tr.stuff. $ (TYPE%X2. B&. B&) B&. B& a! b! c! res!)
     (%B (Compare.comp.? B&. B& (tuple%3./tuple%3/1 (%Poly%tuple%3. res!)) (tuple%3./tuple%3/2
        (%Poly%tuple%3. res!)
   )))))
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/traits_extend_ensures-c9c47fc5e5a45603-test_trait_arg3/test.rs:45:11: 45:56 (#0)
(get-info :all-statistics)
(push)
 (declare-const B&. Dcr)
 (declare-const B& Type)
...
;; Function-Def crate::X3::stuff
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/traits_extend_ensures-c9c47fc5e5a45603-test_trait_arg3/test.rs:55:11: 55:56 (#0)
(get-info :all-statistics)
(push)
 (declare-const B&. Dcr)
 (declare-const B& Type)
...
(assert
 (forall ((B&. Dcr) (B& Type)) (!
   (=>
    (tr_bound%Compare. B&. B&)
    (tr_bound%Tr. $ (TYPE%X3. B&. B&) B&. B&)
   )
   :pattern ((tr_bound%Tr. $ (TYPE%X3. B&. B&) B&. B&))
...
(declare-fun ens%impl&%5.stuff. (Poly Poly Poly Poly) Bool)
(assert
 (forall ((a! Poly) (b! Poly) (c! Poly) (res! Poly)) (!
   (= (ens%impl&%5.stuff. a! b! c! res!) (and
     (ens%Tr.stuff. $ TYPE%Z. $ (UINT 8) a! b! c! res!)
     (%B (Compare.comp.? $ (UINT 8) (tuple%3./tuple%3/1 (%Poly%tuple%3. res!)) (tuple%3./tuple%3/2
        (%Poly%tuple%3. res!)
   )))))
   :pattern ((ens%impl&%5.stuff. a! b! c! res!))
   :qid internal_ens__impl&__5.stuff._definition
   :skolemid skolem_internal_ens__impl&__5.stuff._definition
)))

;; Function-Def crate::Z::stuff
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/traits_extend_ensures-c9c47fc5e5a45603-test_trait_arg3/test.rs:80:11: 80:62 (#0)
(get-info :all-statistics)
(push)
 (declare-const res! Poly)
 (declare-const a! Poly)
 ...
 (assert
  (%B (Compare.comp.? $ (UINT 8) a! b!))
 )
 (assert
  (%B (Compare.comp.? $ (UINT 8) b! c!))
 )
 ;; postcondition not satisfied
 (declare-const %%location_label%%0 Bool)
 ;; postcondition not satisfied
 ...
 (assert
  (not (=>
    (= res! (Poly%tuple%3. (tuple%3./tuple%3 (I 1) (I 1) (I 0))))
    (and
     (=>
      %%location_label%%0
      (%B (Compare.comp.? $ (UINT 8) (tuple%3./tuple%3/0 (%Poly%tuple%3. res!)) (tuple%3./tuple%3/1
         (%Poly%tuple%3. res!)
     ))))
     (=>
      %%location_label%%1
...
(declare-fun req%test. (Y. Y. Y.) Bool)
 ...
 (forall ((a! Y.) (b! Y.) (c! Y.)) (!
   (= (req%test. a! b! c!) (and
     (=>
      ...
      (%B (Compare.comp.? $ TYPE%Y. (Poly%Y. a!) (Poly%Y. b!)))
     )
     (=>
      %%global_location_label%%3
      (%B (Compare.comp.? $ TYPE%Y. (Poly%Y. b!) (Poly%Y. c!)))
   )))
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/traits_extend_ensures-c9c47fc5e5a45603-test_trait_arg3/test.rs:62:7: 62:32 (#0)
(get-info :all-statistics)
(push)
 (declare-const a! Y.)
 (declare-const b! Y.)
 ...
 (assert
  (not (and
    (=>
     %%location_label%%0
     (req%Tr.stuff. $ (TYPE%X. $ TYPE%Y.) $ TYPE%Y. (Poly%Y. a!) (Poly%Y. b!) (Poly%Y. c!))
    )
    (=>
     (ens%impl&%1.stuff. $ TYPE%Y. (Poly%Y. a!) (Poly%Y. b!) (Poly%Y. c!) tmp%1)
     (=>
      (= r@ (%Poly%tuple%3. tmp%1))
      (=>
       (= tmp%2 (%B (Compare.comp.? $ TYPE%Y. (tuple%3./tuple%3/0 (%Poly%tuple%3. (Poly%tuple%3.
             r@
           ))
       ...
       (and
        ...
        (=>
         tmp%2
         (=>
          (= tmp%3 (%B (Compare.comp.? $ TYPE%Y. (tuple%3./tuple%3/1 (%Poly%tuple%3. (Poly%tuple%3.
                r@
              ))
...
(declare-fun req%test2. (Int Int Int) Bool)
...
(assert
 (forall ((a! Int) (b! Int) (c! Int)) (!
   ...
   :pattern ((req%test2. a! b! c!))
   :qid internal_req__test2._definition
   :skolemid skolem_internal_req__test2._definition
)))

;; Function-Def crate::test2
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/traits_extend_ensures-c9c47fc5e5a45603-test_trait_arg3/test.rs:87:7: 87:36 (#0)
(get-info :all-statistics)
(push)
 (declare-const a! Int)
 (declare-const b! Int)
 ...
 (assert
  (not (and
    (=>
     %%location_label%%0
     (req%Tr.stuff. $ TYPE%Z. $ (UINT 8) (I a!) (I b!) (I c!))
    )
    (=>
     (ens%impl&%5.stuff. (I a!) (I b!) (I c!) tmp%1)
     (=>
      (= r@ (%Poly%tuple%3. tmp%1))
      (=>
       (= tmp%2 (= (%I (tuple%3./tuple%3/0 (%Poly%tuple%3. (Poly%tuple%3. r@)))) (Add (%I (tuple%3./tuple%3/1
       ...
       (and
        ...
        (=>
         tmp%2
         (=>
          (= tmp%3 (= (%I (tuple%3./tuple%3/1 (%Poly%tuple%3. (Poly%tuple%3. r@)))) (Add (%I (tuple%3./tuple%3/2
               (%Poly%tuple%3. (Poly%tuple%3. r@))
              )
             ) 1
          )))
