...
(assert
 (distinct fuel%vstd!set.impl&%0.choose. fuel%vstd!set.axiom_set_ext_equal. fuel%vstd!set.axiom_set_ext_equal_deep.
  fuel%vstd!set.axiom_set_choose_finite. fuel%vstd!set.axiom_set_contains_len. fuel%vstd!set.axiom_set_choose_len.
 ...
 (forall ((%%hole%%0 Type) (%%hole%%1 Dcr) (%%hole%%2 Type) (%%hole%%3 Poly) (%%hole%%4
   ...
   (=>
    (exists ((a$ Poly)) (!
      ...
      :qid user_vstd__set__impl&%0__choose_3
      :skolemid skolem_user_vstd__set__impl&%0__choose_3
    ))
    (exists ((a$ Poly)) (!
      (and
       (and
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (s! Poly)) (!
    ...
    :qid user_vstd__set__axiom_set_choose_finite_4
    :skolemid skolem_user_vstd__set__axiom_set_choose_finite_4
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (s! Poly) (a! Poly)) (!
    ...
    :qid user_vstd__set__axiom_set_contains_len_5
    :skolemid skolem_user_vstd__set__axiom_set_contains_len_5
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (s! Poly)) (!
    ...
    :qid user_vstd__set__axiom_set_choose_len_6
    :skolemid skolem_user_vstd__set__axiom_set_choose_len_6
))))

;; Function-Specs test_crate::choose_contains_set
(declare-fun req%test_crate!choose_contains_set. (vstd!set.Set<nat.>.) Bool)
(declare-const %%global_location_label%%0 Bool)
(declare-const %%global_location_label%%1 Bool)
(assert
 (forall ((m! vstd!set.Set<nat.>.)) (!
   (= (req%test_crate!choose_contains_set. m!) (and
     (=>
      %%global_location_label%%0
      (vstd!set.impl&%0.finite.? $ NAT (Poly%vstd!set.Set<nat.>. m!))
     )
     (=>
      %%global_location_label%%1
      (> (vstd!set.impl&%0.len.? $ NAT (Poly%vstd!set.Set<nat.>. m!)) 0)
   )))
   :pattern ((req%test_crate!choose_contains_set. m!))
   :qid internal_req__test_crate!choose_contains_set._definition
   :skolemid skolem_internal_req__test_crate!choose_contains_set._definition
)))

;; Function-Def test_crate::choose_contains_set
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/maps-df7fca472355527b-set_choose_regression_408/test.rs:16:7: 16:42 (#0)
(get-info :all-statistics)
(push)
 (declare-const m! vstd!set.Set<nat.>.)
 ...
 (assert
  (not (=>
    (= c@ (%I (vstd!set.impl&%0.choose.? $ NAT (Poly%vstd!set.Set<nat.>. m!))))
    (=>
     (= tmp%1 (vstd!set.impl&%0.contains.? $ NAT (Poly%vstd!set.Set<nat.>. m!) (I c@)))
     (=>
      %%location_label%%0
      tmp%1
 )))))
