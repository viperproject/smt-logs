...
(assert
 (distinct fuel%vstd!map.impl&%0.spec_index. fuel%vstd!map.axiom_map_index_decreases_finite.
  ...
  fuel%vstd!map.axiom_map_ext_equal_deep. fuel%vstd!set.axiom_set_empty. fuel%vstd!set.axiom_set_insert_same.
  ...
  fuel%vstd!set.axiom_set_insert_finite. fuel%vstd!array.group_array_axioms. fuel%vstd!map.group_map_axioms.
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (a! Poly)) (!
    ...
    :qid user_vstd__set__axiom_set_empty_6
    :skolemid skolem_user_vstd__set__axiom_set_empty_6
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (s! Poly) (a! Poly)) (!
    ...
    :qid user_vstd__set__axiom_set_insert_same_7
    :skolemid skolem_user_vstd__set__axiom_set_insert_same_7
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (s! Poly) (a1! Poly) (a2! Poly)) (!
    ...
    :qid user_vstd__set__axiom_set_insert_different_8
    :skolemid skolem_user_vstd__set__axiom_set_insert_different_8
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (s1! Poly) (s2! Poly)) (!
    ...
    :qid user_vstd__set__axiom_set_ext_equal_10
    :skolemid skolem_user_vstd__set__axiom_set_ext_equal_10
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (s1! Poly) (s2! Poly)) (!
    ...
    :qid user_vstd__set__axiom_set_ext_equal_deep_11
    :skolemid skolem_user_vstd__set__axiom_set_ext_equal_deep_11
))))
...
(assert
 (=>
  ...
  (forall ((K&. Dcr) (K& Type) (V&. Dcr) (V& Type) (s! Poly) (f! Poly)) (!
    ...
    :qid user_vstd__set__axiom_mk_map_domain_12
    :skolemid skolem_user_vstd__set__axiom_mk_map_domain_12
))))
 ...
 (=>
  ...
  (forall ((K&. Dcr) (K& Type) (V&. Dcr) (V& Type) (s! Poly) (f! Poly) (key! Poly))
   (!
    ...
    :qid user_vstd__set__axiom_mk_map_index_13
    :skolemid skolem_user_vstd__set__axiom_mk_map_index_13
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type)) (!
    ...
    :qid user_vstd__set__axiom_set_empty_finite_14
    :skolemid skolem_user_vstd__set__axiom_set_empty_finite_14
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (s! Poly) (a! Poly)) (!
    ...
    :qid user_vstd__set__axiom_set_insert_finite_15
    :skolemid skolem_user_vstd__set__axiom_set_insert_finite_15
))))

;; Function-Def test_crate::test_map
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/maps-df7fca472355527b-test1_fails2/test.rs:18:7: 18:20 (#0)
...
;; Function-Recommends test_crate::test_map
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/maps-df7fca472355527b-test1_fails2/test.rs:18:7: 18:20 (#0)
(get-info :all-statistics)
(push)
 (declare-const no%param Int)
 ...
 (assert
  (forall ((%%hole%%0 Int) (k$ Poly)) (!
    (= (%%apply%%0 (%%lambda%%2 %%hole%%0) k$) (I (Mul %%hole%%0 (%I k$))))
    :pattern ((%%apply%%0 (%%lambda%%2 %%hole%%0) k$))
 )))
 (declare-fun %%lambda%%3 (Int Int) %%Function%%)
 (assert
  (forall ((%%hole%%0 Int) (%%hole%%1 Int) (k$ Poly)) (!
    (= (%%apply%%0 (%%lambda%%3 %%hole%%0 %%hole%%1) k$) (I (Add (Mul %%hole%%0 (%I k$))
       (Mul %%hole%%1 (%I k$))
    )))
    :pattern ((%%apply%%0 (%%lambda%%3 %%hole%%0 %%hole%%1) k$))
 )))
  ...
  (not (=>
    ...
    (=>
     ...
     (=>
      (= m1@ (%Poly%vstd!map.Map<int./int.>. (vstd!set.impl&%0.mk_map.? $ INT $ INT $ (TYPE%fun%1.
          $ INT $ INT
         ) (Poly%vstd!set.Set<int.>. s1@) (Poly%fun%1. (mk_fun (%%lambda%%2 10)))
      )))
      (=>
       %%location_label%%0
       (req%vstd!map.impl&%0.index. $ INT $ INT (Poly%vstd!map.Map<int./int.>. m1@) (I 2))
 ))))))
 (get-info :version)
 (set-option :rlimit 30000000)
 (check-sat)
