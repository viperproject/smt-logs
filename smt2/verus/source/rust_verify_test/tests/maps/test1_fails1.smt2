...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/maps-df7fca472355527b-test1_fails1/test.rs:18:7: 18:20 (#0)
     ...
     (=>
      ...
      (and
       ...
       (=>
        tmp%1
        (=>
         (= tmp%2 (= (%I (vstd!map.impl&%0.index.? $ INT $ INT (Poly%vstd!map.Map<int./int.>. m1@)
             (I 4)
            )
           ) 40
         ))
          ...
          (=>
           ...
           (=>
            ...
            (=>
             ...
             (=>
              (= tmp%3 (ext_eq false (TYPE%vstd!map.Map. $ INT $ INT) (Poly%vstd!map.Map<int./int.>.
                 m1@
    ...
    (=>
     ...
     (=>
      ...
      (and
       ...
       (=>
        (= tmp%1 (vstd!map.impl&%0.index.? $ INT $ INT (Poly%vstd!map.Map<int./int.>. m1@)
          (I 2)
        ))
        (=>
         (= (%I tmp%1) 20)
         (=>
          %%location_label%%1
          (req%vstd!map.impl&%0.index. $ INT $ INT (Poly%vstd!map.Map<int./int.>. m1@) (I 4))
 )))))))))
 (get-info :version)
 (set-option :rlimit 30000000)
 (check-sat)
