...
(assert
 (distinct fuel%vstd!map.impl&%0.spec_index. fuel%vstd!map.axiom_map_index_decreases_finite.
  ...
  fuel%vstd!map_lib.impl&%0.contains_value. fuel%vstd!set.axiom_set_empty. fuel%vstd!set.axiom_set_insert_same.
...
;; Function-Decl vstd::map_lib::impl&%0::contains_value
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type)) (!
    ...
    :qid user_vstd__set__axiom_set_empty_finite_16
    :skolemid skolem_user_vstd__set__axiom_set_empty_finite_16
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (s! Poly) (a! Poly)) (!
    ...
    :qid user_vstd__set__axiom_set_insert_finite_17
    :skolemid skolem_user_vstd__set__axiom_set_insert_finite_17
))))
...
;; Function-Axioms vstd::map_lib::impl&%0::contains_value
(assert
  ...
  (forall ((K&. Dcr) (K& Type) (V&. Dcr) (V& Type) (self! Poly) (v! Poly)) (!
    (= (vstd!map_lib.impl&%0.contains_value.? K&. K& V&. V& self! v!) (exists ((i$ Poly))
      (!
       ...
       :qid user_vstd__map_lib__impl&%0__contains_value_18
       :skolemid skolem_user_vstd__map_lib__impl&%0__contains_value_18
    )))
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/maps-df7fca472355527b-map_contains/test.rs:18:7: 18:16 (#0)
...
(push)
 ...
 (assert
  (not (=>
    (= m@ (%Poly%vstd!map.Map<int./int.>. (vstd!map.impl&%0.insert.? $ INT $ INT (vstd!map.impl&%0.insert.?
        $ INT $ INT (vstd!map.impl&%0.empty.? $ INT $ INT) (I 10) (I 100)
       ) (I 20) (I 200)
    )))
    (=>
     ...
     (and
      ...
      (=>
       tmp%1
       (=>
        (= tmp%2 (vstd!map_lib.impl&%0.contains_value.? $ INT $ INT (Poly%vstd!map.Map<int./int.>.
           m@
          ) (I 100)
        ))
        (=>
