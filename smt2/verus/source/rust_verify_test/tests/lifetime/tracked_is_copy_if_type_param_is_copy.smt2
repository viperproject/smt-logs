...
(declare-const TYPE%test_crate!T. Type)
(declare-const TYPE%tuple%0. Type)
(declare-fun TYPE%tuple%1. (Dcr Type) Type)
(declare-fun FNDEF%core!clone.Clone.clone. (Dcr Type) Type)
(declare-fun Poly%test_crate!T. (test_crate!T.) Poly)
(declare-fun %Poly%test_crate!T. (Poly) test_crate!T.)
(declare-fun Poly%tuple%0. (tuple%0.) Poly)
(declare-fun %Poly%tuple%0. (Poly) tuple%0.)
(declare-fun Poly%tuple%1. (tuple%1.) Poly)
(declare-fun %Poly%tuple%1. (Poly) tuple%1.)
(assert
 (forall ((x test_crate!T.)) (!
   (= x (%Poly%test_crate!T. (Poly%test_crate!T. x)))
   :pattern ((Poly%test_crate!T. x))
   :qid internal_test_crate__T_box_axiom_definition
   :skolemid skolem_internal_test_crate__T_box_axiom_definition
)))
(assert
 (forall ((x Poly)) (!
   (=>
    (has_type x TYPE%test_crate!T.)
    (= x (Poly%test_crate!T. (%Poly%test_crate!T. x)))
   )
   :pattern ((has_type x TYPE%test_crate!T.))
   :qid internal_test_crate__T_unbox_axiom_definition
   :skolemid skolem_internal_test_crate__T_unbox_axiom_definition
)))
(assert
 (forall ((x test_crate!T.)) (!
   (has_type (Poly%test_crate!T. x) TYPE%test_crate!T.)
   :pattern ((has_type (Poly%test_crate!T. x) TYPE%test_crate!T.))
   :qid internal_test_crate__T_has_type_always_definition
   :skolemid skolem_internal_test_crate__T_has_type_always_definition
)))
(assert
 (forall ((x tuple%0.)) (!
...
(assert
 (forall ((tmp%%$ Poly) (res$ Poly) (T&. Dcr) (T& Type) (A&. Dcr) (A& Type)) (!
   ...
   :qid user_alloc__boxed__impl&%12__clone_5
   :skolemid skolem_user_alloc__boxed__impl&%12__clone_5
)))
...
;; Trait-Impl-Axiom
(assert
 (tr_bound%core!clone.Clone. $ TYPE%test_crate!T.)
)

;; Function-Def test_crate::test
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/lifetime-8999a93e6e940ccb-tracked_is_copy_if_type_param_is_copy/test.rs:29:1: 29:23 (#0)
(get-info :all-statistics)
(push)
 (declare-const t! test_crate!T.)
 (assert
  fuel_defaults
 )
 (assert
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/lifetime-8999a93e6e940ccb-tracked_is_copy_if_type_param_is_copy/test.rs:32:1: 32:24 (#0)
(get-info :all-statistics)
(push)
 (declare-const t! test_crate!T.)
 (assert
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/lifetime-8999a93e6e940ccb-tracked_is_copy_if_type_param_is_copy/test.rs:37:1: 37:24 (#0)
(get-info :all-statistics)
(push)
 (declare-const t! test_crate!T.)
 ...
 (assert
  (not (=>
    (ens%builtin!impl&%4.clone. $ TYPE%test_crate!T. (Poly%test_crate!T. t!) tmp%1)
    (=>
     (ens%builtin!impl&%4.clone. $ TYPE%test_crate!T. (Poly%test_crate!T. t!) tmp%2)
     (=>
      (ens%builtin!impl&%4.clone. $ TYPE%test_crate!T. (Poly%test_crate!T. t!) tmp%3)
      (=>
       (= x@ (%Poly%test_crate!T. tmp%3))
       (=>
        (= tmp%4 (= x@ t!))
        (=>
         %%location_label%%0
