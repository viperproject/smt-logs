...
;; Function-Specs test_crate::get_internal
(declare-fun req%test_crate!get_internal. (alloc!vec.Vec<u8./allocator_global%.>. Int)
 Bool
)
(declare-const %%global_location_label%%4 Bool)
(assert
 (forall ((v! alloc!vec.Vec<u8./allocator_global%.>.) (i! Int)) (!
   (= (req%test_crate!get_internal. v! i!) (=>
     %%global_location_label%%4
     (and
      (<= 0 i!)
      (< i! (vstd!std_specs.vec.spec_vec_len.? $ (UINT 8) $ ALLOCATOR_GLOBAL (Poly%alloc!vec.Vec<u8./allocator_global%.>.
         v!
   ))))))
   :pattern ((req%test_crate!get_internal. v! i!))
   :qid internal_req__test_crate!get_internal._definition
   :skolemid skolem_internal_req__test_crate!get_internal._definition
)))
(declare-fun ens%test_crate!get_internal. (alloc!vec.Vec<u8./allocator_global%.>. Int
  Int
 ) Bool
)
(assert
 (forall ((v! alloc!vec.Vec<u8./allocator_global%.>.) (i! Int) (r! Int)) (!
   (= (ens%test_crate!get_internal. v! i! r!) (and
     (uInv 8 r!)
     (= r! (%I (vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec.
          $ (UINT 8) $ ALLOCATOR_GLOBAL
         ) (Poly%alloc!vec.Vec<u8./allocator_global%.>. v!)
        ) (I i!)
   )))))
   :pattern ((ens%test_crate!get_internal. v! i! r!))
   :qid internal_ens__test_crate!get_internal._definition
   :skolemid skolem_internal_ens__test_crate!get_internal._definition
)))

;; Function-Def test_crate::get_internal
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/lifetime-8999a93e6e940ccb-index_with_extra_ref_issue1009/test.rs:17:1: 17:62 (#0)
...
;; Function-Specs test_crate::get_internal2
(declare-fun req%test_crate!get_internal2. (alloc!vec.Vec<u8./allocator_global%.>.
  Int
 ) Bool
)
...
(assert
 (forall ((v! alloc!vec.Vec<u8./allocator_global%.>.) (i! Int)) (!
   (= (req%test_crate!get_internal2. v! i!) (=>
   ...
   :pattern ((req%test_crate!get_internal2. v! i!))
   :qid internal_req__test_crate!get_internal2._definition
   :skolemid skolem_internal_req__test_crate!get_internal2._definition
)))
(declare-fun ens%test_crate!get_internal2. (alloc!vec.Vec<u8./allocator_global%.>.
  Int Int
 ) Bool
)
(assert
 (forall ((v! alloc!vec.Vec<u8./allocator_global%.>.) (i! Int) (r! Int)) (!
   (= (ens%test_crate!get_internal2. v! i! r!) (and
     (uInv 8 r!)
     (= r! (%I (vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec.
          $ (UINT 8) $ ALLOCATOR_GLOBAL
         ) (Poly%alloc!vec.Vec<u8./allocator_global%.>. v!)
   ...
   :pattern ((ens%test_crate!get_internal2. v! i! r!))
   :qid internal_ens__test_crate!get_internal2._definition
   :skolemid skolem_internal_ens__test_crate!get_internal2._definition
)))

;; Function-Def test_crate::get_internal2
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/lifetime-8999a93e6e940ccb-index_with_extra_ref_issue1009/test.rs:26:1: 26:63 (#0)
(get-info :all-statistics)
(push)
 (declare-const r! Int)
 (declare-const v! alloc!vec.Vec<u8./allocator_global%.>.)
