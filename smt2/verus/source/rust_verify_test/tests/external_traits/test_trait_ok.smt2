...
;; Function-Decl crate::llama
(declare-fun llama.? (Poly) Bool)

;; Function-Specs crate::X::bar
(declare-fun ens%impl&%0.bar. () Bool)
(assert
 (= ens%impl&%0.bar. (llama.? (I 0)))
)
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/external_traits-cafe10d85d81bb58-test_trait_ok/test.rs:42:1: 42:10 (#0)
