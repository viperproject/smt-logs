...
(declare-const fuel%test_crate!len_of_slice. FuelId)
...
(assert
 (distinct fuel%vstd!array.array_view. fuel%vstd!array.impl&%0.view. fuel%vstd!array.impl&%2.spec_index.
  ...
  fuel%vstd!view.impl&%24.view. fuel%test_crate!len_of_slice. fuel%vstd!array.group_array_axioms.
...
;; Function-Decl test_crate::len_of_slice
(declare-fun test_crate!len_of_slice.? (Poly) Int)
...
(assert
 (=>
  ...
  (forall ((T&. Dcr) (T& Type) (N&. Dcr) (N& Type) (ar! Poly)) (!
    ...
    :pattern ((vstd!array.spec_array_as_slice.? T&. T& N&. N& ar!))
    :qid user_vstd__array__axiom_spec_array_as_slice_2
    :skolemid skolem_user_vstd__array__axiom_spec_array_as_slice_2
))))
...
;; Function-Axioms test_crate::len_of_slice
(assert
 (fuel_bool_default fuel%test_crate!len_of_slice.)
)
(assert
 (=>
  (fuel_bool fuel%test_crate!len_of_slice.)
  (forall ((ar! Poly)) (!
    (= (test_crate!len_of_slice.? ar!) (vstd!seq.Seq.len.? $ (UINT 8) (vstd!view.View.view.?
       $ (SLICE $ (UINT 8)) ar!
    )))
    :pattern ((test_crate!len_of_slice.? ar!))
    :qid internal_test_crate!len_of_slice.?_definition
    :skolemid skolem_internal_test_crate!len_of_slice.?_definition
))))
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/arrays-02fac289d0d9180f-test_array_to_slice/test.rs:17:1: 17:23 (#0)
(get-info :all-statistics)
(push)
 (declare-const ar! %%Function%%)
 (declare-const tmp%1 Poly)
 (declare-const tmp%2 Bool)
 (declare-const sl@ slice%<u8.>.)
 (assert
  fuel_defaults
 )
 (assert
  (has_type (Poly%array%. ar!) (ARRAY $ (UINT 8) $ (CONST_INT 3)))
 )
 ;; assertion failed
 (declare-const %%location_label%%0 Bool)
 (assert
  (not (=>
    (ens%vstd!array.array_as_slice. $ (UINT 8) $ (CONST_INT 3) ar! tmp%1)
    (=>
     (= sl@ (%Poly%slice%<u8.>. tmp%1))
     (=>
      (= tmp%2 (= (vstd!seq.Seq.len.? $ (UINT 8) (vstd!view.View.view.? $ (SLICE $ (UINT 8))
          (Poly%slice%<u8.>. sl@)
         )
        ) 3
      ))
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/arrays-02fac289d0d9180f-test_array_to_slice/test.rs:22:1: 22:11 (#0)
(get-info :all-statistics)
(push)
 ...
 (assert
  (not (=>
    (= ar@ (%Poly%array%. (array_new $ (UINT 8) 3 (%%array%%0 (I 4) (I 5) (I 6)))))
    (=>
     (ens%vstd!array.array_as_slice. $ (UINT 8) $ (CONST_INT 3) ar@ tmp%1)
     (=>
      (= sl@ (%Poly%slice%<u8.>. tmp%1))
      (=>
       ...
       (and
        ...
        (=>
         tmp%2
         (=>
          (= tmp%3 (= (%I (vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.? $ (SLICE $ (UINT
                 8
                )
               ) (Poly%slice%<u8.>. sl@)
              ) (I 1)
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/arrays-02fac289d0d9180f-test_array_to_slice/test.rs:29:1: 29:39 (#0)
(get-info :all-statistics)
(push)
 (declare-const N&. Dcr)
 ...
 (assert
  (not (=>
    (ens%vstd!array.array_as_slice. $ (UINT 8) N&. N& ar! tmp%1)
    (=>
     (= sl@ (%Poly%slice%<u8.>. tmp%1))
     (=>
      (= tmp%2 (= (vstd!seq.Seq.len.? $ (UINT 8) (vstd!view.View.view.? $ (SLICE $ (UINT 8))
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/arrays-02fac289d0d9180f-test_array_to_slice/test.rs:38:1: 38:39 (#0)
(get-info :all-statistics)
(push)
 (declare-const N&. Dcr)
 (declare-const N& Type)
 ...
 (assert
  (not (=>
    (= tmp%1 (= (test_crate!len_of_slice.? (vstd!array.spec_array_as_slice.? $ (UINT 8) N&.
        N& (Poly%array%. ar!)
       )
      ) (vstd!seq.Seq.len.? $ (UINT 8) (vstd!view.View.view.? $ (ARRAY $ (UINT 8) N&. N&)
        (Poly%array%. ar!)
    ))))
    (=>
     %%location_label%%0
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/arrays-02fac289d0d9180f-test_array_to_slice/test.rs:42:1: 42:43 (#0)
(get-info :all-statistics)
(push)
 (declare-const N&. Dcr)
 (declare-const N& Type)
