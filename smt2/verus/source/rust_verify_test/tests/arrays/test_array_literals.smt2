...
(assert
 (distinct fuel%vstd!array.array_view. fuel%vstd!array.impl&%0.view. fuel%vstd!array.impl&%2.spec_index.
  ...
  fuel%vstd!seq.axiom_seq_ext_equal_deep. fuel%vstd!seq_lib.impl&%0.contains. fuel%vstd!view.impl&%0.view.
 ...
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (self! Poly) (needle! Poly)) (!
    (= (vstd!seq_lib.impl&%0.contains.? A&. A& self! needle!) (exists ((i$ Poly)) (!
       ...
       :pattern ((vstd!seq.Seq.index.? A&. A& self! i$))
       :qid user_vstd__seq_lib__impl&%0__contains_10
       :skolemid skolem_user_vstd__seq_lib__impl&%0__contains_10
    )))
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/arrays-02fac289d0d9180f-test_array_literals/test.rs:17:1: 17:11 (#0)
...
(push)
 ...
 (declare-fun %%array%%0 (Poly Poly Poly Poly Poly Poly) %%Function%%)
 (assert
  (forall ((%%hole%%0 Poly) (%%hole%%1 Poly) (%%hole%%2 Poly) (%%hole%%3 Poly) (%%hole%%4
    ...
    (let
     ((%%x%% (%%array%%0 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3 %%hole%%4 %%hole%%5)))
     (and
      (= (%%apply%%1 %%x%% 0) %%hole%%0)
      (= (%%apply%%1 %%x%% 1) %%hole%%1)
      (= (%%apply%%1 %%x%% 2) %%hole%%2)
    ...
    :pattern ((%%array%%0 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3 %%hole%%4 %%hole%%5))
 ...
 (assert
  (not (=>
    (= x@ (%Poly%array%. (array_new $ (UINT 8) 6 (%%array%%0 (I 11) (I 12) (I 13) (I 14)
        (I 15) (I 16)
    ))))
    (=>
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/arrays-02fac289d0d9180f-test_array_literals/test.rs:28:1: 28:30 (#0)
(get-info :all-statistics)
(push)
 (declare-const T&. Dcr)
 ...
 (declare-fun %%array%%1 (Poly Poly Poly) %%Function%%)
 (assert
  (forall ((%%hole%%0 Poly) (%%hole%%1 Poly) (%%hole%%2 Poly)) (!
    (let
     ((%%x%% (%%array%%1 %%hole%%0 %%hole%%1 %%hole%%2)))
     (and
      (= (%%apply%%1 %%x%% 0) %%hole%%0)
      (= (%%apply%%1 %%x%% 1) %%hole%%1)
      (= (%%apply%%1 %%x%% 2) %%hole%%2)
    ))
    :pattern ((%%array%%1 %%hole%%0 %%hole%%1 %%hole%%2))
    :qid __AIR_ARRAY_QID__
    :skolemid skolem___AIR_ARRAY_QID__
 )))
 ;; assertion failed
 ...
 (assert
  (not (=>
    (= x@ (%Poly%array%. (array_new T&. T& 3 (%%array%%1 a! b! c!))))
    (=>
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/arrays-02fac289d0d9180f-test_array_literals/test.rs:36:1: 36:11 (#0)
(get-info :all-statistics)
(push)
 (declare-const no%param Int)
 (declare-const tmp%1 Bool)
 ...
 (declare-fun %%array%%2 (Poly Poly Poly Poly Poly Poly) %%Function%%)
 (assert
  (forall ((%%hole%%0 Poly) (%%hole%%1 Poly) (%%hole%%2 Poly) (%%hole%%3 Poly) (%%hole%%4
     Poly
    ) (%%hole%%5 Poly)
    ...
    (let
     ((%%x%% (%%array%%2 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3 %%hole%%4 %%hole%%5)))
     (and
      (= (%%apply%%1 %%x%% 0) %%hole%%0)
      (= (%%apply%%1 %%x%% 1) %%hole%%1)
      (= (%%apply%%1 %%x%% 2) %%hole%%2)
    ...
    :pattern ((%%array%%2 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3 %%hole%%4 %%hole%%5))
    :qid __AIR_ARRAY_QID__
    :skolemid skolem___AIR_ARRAY_QID__
 )))
 ;; assertion failed
 ...
 (assert
  (not (=>
    (= x@ (%Poly%array%. (array_new $ (UINT 8) 6 (%%array%%2 (I 11) (I 12) (I 13) (I 14)
        (I 15) (I 16)
    ))))
    (=>
     (= tmp%1 (= (vstd!seq.Seq.len.? $ (UINT 8) (vstd!view.View.view.? $ (ARRAY $ (UINT 8)
...
(push)
 ...
 (declare-fun %%array%%3 (Poly Poly Poly Poly Poly Poly) %%Function%%)
 (assert
  (forall ((%%hole%%0 Poly) (%%hole%%1 Poly) (%%hole%%2 Poly) (%%hole%%3 Poly) (%%hole%%4
     Poly
    ) (%%hole%%5 Poly)
    ...
    (let
     ((%%x%% (%%array%%3 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3 %%hole%%4 %%hole%%5)))
     (and
      (= (%%apply%%1 %%x%% 0) %%hole%%0)
      (= (%%apply%%1 %%x%% 1) %%hole%%1)
      (= (%%apply%%1 %%x%% 2) %%hole%%2)
    ...
    :pattern ((%%array%%3 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3 %%hole%%4 %%hole%%5))
    :qid __AIR_ARRAY_QID__
    :skolemid skolem___AIR_ARRAY_QID__
 )))
 ...
 (assert
  (not (=>
    (= x@ (%Poly%array%. (array_new $ (UINT 8) 6 (%%array%%3 (I 11) (I 12) (I 13) (I 14)
        (I 15) (I 16)
    ))))
    (=>
     (= (vstd!seq.Seq.len.? $ (UINT 8) (vstd!view.View.view.? $ (ARRAY $ (UINT 8) $ (CONST_INT
          6
         )
        ) (Poly%array%. x@)
       )
     ...
     (=>
      (= tmp%2 (vstd!view.View.view.? $ (ARRAY $ (UINT 8) $ (CONST_INT 6)) (Poly%array%. x@)))
      (=>
       %%location_label%%0
       (req%vstd!seq.impl&%0.spec_index. $ (UINT 8) tmp%2 (I 0))
 ))))))
 (get-info :version)
 (set-option :rlimit 30000000)
 (check-sat)
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/arrays-02fac289d0d9180f-test_array_literals/test.rs:42:1: 42:11 (#0)
(get-info :all-statistics)
(push)
 (declare-const no%param Int)
 (declare-const tmp%1 Bool)
 ...
 (assert
  (not (=>
    (= a1@ (%Poly%array%. (array_new $ (UINT 8) 3 (%%array%%4 (I 10) (I 20) (I 30)))))
    (=>
     (= a2@ (%Poly%array%. (array_new $ (UINT 8) 3 (%%array%%4 (I 10) (I 20) (I 40)))))
     (=>
      (= tmp%1 (not (= a1@ a2@)))
      (and
       (=>
       ...
       (=>
        tmp%1
        (=>
         (= tmp%2 (not (= (vstd!view.View.view.? $ (ARRAY $ (UINT 8) $ (CONST_INT 3)) (Poly%array%.
              a1@
             )
            ) (vstd!view.View.view.? $ (ARRAY $ (UINT 8) $ (CONST_INT 3)) (Poly%array%. a2@))
         )))
         (and
          (=>
           %%location_label%%1
          ...
          (=>
           tmp%2
           (=>
            (= tmp%3 (vstd!seq_lib.impl&%0.contains.? $ (UINT 8) (vstd!view.View.view.? $ (ARRAY
                $ (UINT 8) $ (CONST_INT 3)
               ) (Poly%array%. a1@)
              ) (I 30)
            ))
            (and
             ...
             (=>
              tmp%3
              (=>
               (= tmp%4 (vstd!seq_lib.impl&%0.contains.? $ (UINT 8) (vstd!view.View.view.? $ (ARRAY
                   $ (UINT 8) $ (CONST_INT 3)
                  ) (Poly%array%. a2@)
                 ) (I 30)
               ))
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/arrays-02fac289d0d9180f-test_array_literals/test.rs:51:7: 51:17 (#0)
(get-info :all-statistics)
(push)
 (declare-const no%param Int)
 (declare-const tmp%1 Bool)
 ...
 (declare-fun %%array%%6 (Poly Poly Poly) %%Function%%)
 (assert
  (forall ((%%hole%%0 Poly) (%%hole%%1 Poly) (%%hole%%2 Poly)) (!
    (let
     ((%%x%% (%%array%%6 %%hole%%0 %%hole%%1 %%hole%%2)))
     (and
      (= (%%apply%%1 %%x%% 0) %%hole%%0)
      (= (%%apply%%1 %%x%% 1) %%hole%%1)
      (= (%%apply%%1 %%x%% 2) %%hole%%2)
    ))
    :pattern ((%%array%%6 %%hole%%0 %%hole%%1 %%hole%%2))
    :qid __AIR_ARRAY_QID__
    :skolemid skolem___AIR_ARRAY_QID__
 )))
 ;; assertion failed
 ...
 (assert
  (not (=>
    (= s1@ (%Poly%vstd!seq.Seq<int.>. (vstd!view.View.view.? $ (ARRAY $ INT $ (CONST_INT 3))
       (array_new $ INT 3 (%%array%%6 (I 10) (I 20) (I 30)))
    )))
    (=>
     (= s2@ (%Poly%vstd!seq.Seq<int.>. (vstd!view.View.view.? $ (ARRAY $ INT $ (CONST_INT 3))
        (array_new $ INT 3 (%%array%%6 (I 10) (I 20) (I 40)))
     )))
     (=>
      (= tmp%1 (not (= s1@ s2@)))
      (and
...
(push)
 ...
 (declare-fun %%array%%7 (Poly Poly Poly) %%Function%%)
 (assert
  (forall ((%%hole%%0 Poly) (%%hole%%1 Poly) (%%hole%%2 Poly)) (!
    (let
     ((%%x%% (%%array%%7 %%hole%%0 %%hole%%1 %%hole%%2)))
     (and
      (= (%%apply%%1 %%x%% 0) %%hole%%0)
      (= (%%apply%%1 %%x%% 1) %%hole%%1)
      (= (%%apply%%1 %%x%% 2) %%hole%%2)
    ))
    :pattern ((%%array%%7 %%hole%%0 %%hole%%1 %%hole%%2))
    :qid __AIR_ARRAY_QID__
    :skolemid skolem___AIR_ARRAY_QID__
 )))
 (assert
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/arrays-02fac289d0d9180f-test_array_literals/test.rs:58:7: 58:17 (#0)
(get-info :all-statistics)
(push)
 (declare-const no%param Int)
 (declare-const tmp%1 Bool)
 ...
 (declare-fun %%array%%8 (Poly Poly Poly) %%Function%%)
 (assert
  (forall ((%%hole%%0 Poly) (%%hole%%1 Poly) (%%hole%%2 Poly)) (!
    (let
     ((%%x%% (%%array%%8 %%hole%%0 %%hole%%1 %%hole%%2)))
     (and
      (= (%%apply%%1 %%x%% 0) %%hole%%0)
      (= (%%apply%%1 %%x%% 1) %%hole%%1)
      (= (%%apply%%1 %%x%% 2) %%hole%%2)
    ))
    :pattern ((%%array%%8 %%hole%%0 %%hole%%1 %%hole%%2))
    :qid __AIR_ARRAY_QID__
    :skolemid skolem___AIR_ARRAY_QID__
 )))
 ;; assertion failed
 ...
 (assert
  (not (=>
    (= s@ (%Poly%vstd!seq.Seq<int.>. (vstd!view.View.view.? $ (ARRAY $ INT $ (CONST_INT 3))
       (array_new $ INT 3 (%%array%%8 (I 10) (I 20) (I 30)))
    )))
    (=>
     (= tmp%1 (vstd!seq_lib.impl&%0.contains.? $ INT (Poly%vstd!seq.Seq<int.>. s@) (I 30)))
     (and
      (=>
       %%location_label%%0
       tmp%1
      ...
      (=>
       tmp%1
       (=>
        (= tmp%2 (vstd!seq_lib.impl&%0.contains.? $ INT (Poly%vstd!seq.Seq<int.>. s@) (I 40)))
        (=>
         %%location_label%%1
         tmp%2
 ))))))))
...
(push)
 ...
 (declare-fun %%array%%9 (Poly Poly Poly) %%Function%%)
 (assert
  (forall ((%%hole%%0 Poly) (%%hole%%1 Poly) (%%hole%%2 Poly)) (!
    (let
     ((%%x%% (%%array%%9 %%hole%%0 %%hole%%1 %%hole%%2)))
     (and
      (= (%%apply%%1 %%x%% 0) %%hole%%0)
      (= (%%apply%%1 %%x%% 1) %%hole%%1)
      (= (%%apply%%1 %%x%% 2) %%hole%%2)
    ))
    :pattern ((%%array%%9 %%hole%%0 %%hole%%1 %%hole%%2))
    :qid __AIR_ARRAY_QID__
    :skolemid skolem___AIR_ARRAY_QID__
 )))
 (assert
