...
(assert
 (distinct fuel%vstd!array.array_view. fuel%vstd!array.impl&%0.view. fuel%vstd!array.impl&%2.spec_index.
  fuel%vstd!array.lemma_array_index. fuel%vstd!array.array_len_matches_n. fuel%vstd!array.axiom_spec_array_fill_for_copy_type.
    ...
    (=>
     ...
     (=>
      ...
      (forall ((i$ Poly)) (!
        ...
        :qid user_vstd__array__axiom_spec_array_fill_for_copy_type_2
        :skolemid skolem_user_vstd__array__axiom_spec_array_fill_for_copy_type_2
    ))))
    :pattern ((vstd!array.spec_array_fill_for_copy_type.? T&. T& N&. N& t!))
    :qid user_vstd__array__axiom_spec_array_fill_for_copy_type_3
    :skolemid skolem_user_vstd__array__axiom_spec_array_fill_for_copy_type_3
))))
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/arrays-02fac289d0d9180f-test_array_repeat/test.rs:17:1: 17:11 (#0)
...
(push)
 ...
 (assert
  (not (=>
    (ens%vstd!array.array_fill_for_copy_types. $ (UINT 8) $ (CONST_INT 6) (I 11) x@)
    (=>
     ...
     (and
      ...
      (=>
       tmp%1
       (=>
        (= tmp%2 (= (%I (vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.? $ (ARRAY $ (UINT
               8
              ) $ (CONST_INT 6)
             ) (Poly%array%. x@)
            ) (I 0)
        ...
        (and
         ...
         (=>
          tmp%2
          (=>
           (= tmp%3 (= (%I (vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.? $ (ARRAY $ (UINT
                  8
                 ) $ (CONST_INT 6)
                ) (Poly%array%. x@)
               ) (I 1)
           ...
           (and
            ...
            (=>
             tmp%3
             (=>
              (= tmp%4 (= (%I (vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.? $ (ARRAY $ (UINT
                     8
                    ) $ (CONST_INT 6)
                   ) (Poly%array%. x@)
                  ) (I 2)
              ...
              (and
               ...
               (=>
                tmp%4
                (=>
                 (= tmp%5 (= (%I (vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.? $ (ARRAY $ (UINT
                        8
                       ) $ (CONST_INT 6)
                      ) (Poly%array%. x@)
                     ) (I 3)
                 ...
                 (and
                  ...
                  (=>
                   tmp%5
                   (=>
                    (= tmp%6 (= (%I (vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.? $ (ARRAY $ (UINT
                           8
                          ) $ (CONST_INT 6)
                         ) (Poly%array%. x@)
                        ) (I 4)
                    ...
                    (and
                     ...
                     (=>
                      tmp%6
                      (=>
                       (= tmp%7 (= (%I (vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.? $ (ARRAY $ (UINT
                              8
                             ) $ (CONST_INT 6)
                            ) (Poly%array%. x@)
                           ) (I 5)
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/arrays-02fac289d0d9180f-test_array_repeat/test.rs:28:1: 28:24 (#0)
(get-info :all-statistics)
(push)
 (declare-const T&. Dcr)
 ...
 (assert
  (not (=>
    (ens%vstd!array.array_fill_for_copy_types. T&. T& $ (CONST_INT 3) a! x@)
    (=>
     (= tmp%1 (= (vstd!seq.Seq.len.? T&. T& (vstd!view.View.view.? $ (ARRAY T&. T& $ (CONST_INT
           3
          )
         ) (Poly%array%. x@)
        )
     ...
     (and
      ...
      (=>
       tmp%1
       (=>
        (= tmp%2 (= (vstd!seq.Seq.index.? T&. T& (vstd!view.View.view.? $ (ARRAY T&. T& $ (CONST_INT
              3
             )
            ) (Poly%array%. x@)
           ) (I 0)
        ...
        (and
         ...
         (=>
          tmp%2
          (=>
           (= tmp%3 (= (vstd!seq.Seq.index.? T&. T& (vstd!view.View.view.? $ (ARRAY T&. T& $ (CONST_INT
                 3
                )
               ) (Poly%array%. x@)
              ) (I 1)
           ...
           (and
            ...
            (=>
             tmp%3
             (=>
              (= tmp%4 (= (vstd!seq.Seq.index.? T&. T& (vstd!view.View.view.? $ (ARRAY T&. T& $ (CONST_INT
                    3
                   )
                  ) (Poly%array%. x@)
                 ) (I 2)
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/arrays-02fac289d0d9180f-test_array_repeat/test.rs:36:1: 36:50 (#0)
(get-info :all-statistics)
(push)
 (declare-const T&. Dcr)
 (declare-const T& Type)
 ...
 (assert
  (not (=>
    (ens%vstd!array.array_fill_for_copy_types. T&. T& N&. N& a! x@)
    (=>
     (= tmp%1 (= (vstd!seq.Seq.len.? T&. T& (vstd!view.View.view.? $ (ARRAY T&. T& N&. N&)
         (Poly%array%. x@)
        )
       ) (const_int N&)
     ))
     (and
      ...
      (=>
       ...
       (=>
        ...
        (=>
         (= tmp%2 (= (vstd!seq.Seq.index.? T&. T& (vstd!view.View.view.? $ (ARRAY T&. T& N&. N&)
             (Poly%array%. x@)
            ) (I i!)
           ) a!
         ))
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/arrays-02fac289d0d9180f-test_array_repeat/test.rs:44:7: 44:56 (#0)
(get-info :all-statistics)
(push)
 (declare-const T&. Dcr)
 (declare-const T& Type)
 ...
 (assert
  (not (=>
    (= x@ (vstd!array.spec_array_fill_for_copy_type.? T&. T& N&. N& a!))
    (=>
     (= tmp%1 (= (vstd!seq.Seq.len.? T&. T& (vstd!view.View.view.? $ (ARRAY T&. T& N&. N&)
         (Poly%array%. x@)
        )
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/arrays-02fac289d0d9180f-test_array_repeat/test.rs:52:1: 52:11 (#0)
(get-info :all-statistics)
(push)
 (declare-const no%param Int)
 (declare-const tmp%1 Bool)
