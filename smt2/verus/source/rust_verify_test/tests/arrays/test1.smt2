...
(declare-datatypes ((vstd!raw_ptr.Metadata. 0) (vstd!raw_ptr.PtrData. 0) (test_crate!S.
  ...
  ) ((test_crate!S./S (test_crate!S./S/?ar %%Function%%))) ((tuple%0./tuple%0))
))
...
(declare-fun test_crate!S./S/ar (test_crate!S.) %%Function%%)
...
(assert
 (forall ((_ar! %%Function%%)) (!
   (=>
    (has_type (Poly%array%. _ar!) (ARRAY $ (UINT SZ) $ (CONST_INT 4)))
    (has_type (Poly%test_crate!S. (test_crate!S./S _ar!)) TYPE%test_crate!S.)
   )
   :pattern ((has_type (Poly%test_crate!S. (test_crate!S./S _ar!)) TYPE%test_crate!S.))
   :qid internal_test_crate!S./S_constructor_definition
   :skolemid skolem_internal_test_crate!S./S_constructor_definition
)))
(assert
 (forall ((x test_crate!S.)) (!
   (= (test_crate!S./S/ar x) (test_crate!S./S/?ar x))
   :pattern ((test_crate!S./S/ar x))
   :qid internal_test_crate!S./S/ar_accessor_definition
   :skolemid skolem_internal_test_crate!S./S/ar_accessor_definition
)))
(assert
 (forall ((x Poly)) (!
   (=>
    (has_type x TYPE%test_crate!S.)
    (has_type (Poly%array%. (test_crate!S./S/ar (%Poly%test_crate!S. x))) (ARRAY $ (UINT
       SZ
      ) $ (CONST_INT 4)
   )))
   :pattern ((test_crate!S./S/ar (%Poly%test_crate!S. x)) (has_type x TYPE%test_crate!S.))
   :qid internal_test_crate!S./S/ar_invariant_definition
   :skolemid skolem_internal_test_crate!S./S/ar_invariant_definition
)))
(assert
 (forall ((x tuple%0.)) (!
...
;; Function-Specs vstd::array::impl&%3::set
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (s! Poly) (i! Poly) (a! Poly)) (!
    ...
    :qid user_vstd__seq__axiom_seq_update_len_6
    :skolemid skolem_user_vstd__seq__axiom_seq_update_len_6
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (s! Poly) (i! Poly) (a! Poly)) (!
    ...
    :qid user_vstd__seq__axiom_seq_update_same_7
    :skolemid skolem_user_vstd__seq__axiom_seq_update_same_7
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (s! Poly) (i1! Poly) (i2! Poly) (a! Poly)) (!
    ...
    :qid user_vstd__seq__axiom_seq_update_different_8
    :skolemid skolem_user_vstd__seq__axiom_seq_update_different_8
))))
...
(declare-fun req%test_crate!test. (%%Function%%) Bool)
(declare-const %%global_location_label%%6 Bool)
(assert
 (forall ((ar! %%Function%%)) (!
   (= (req%test_crate!test. ar!) (=>
   ...
   :pattern ((req%test_crate!test. ar!))
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/arrays-02fac289d0d9180f-test1/test.rs:18:1: 18:22 (#0)
...
(push)
 ...
 (assert
  (has_type (Poly%array%. ar!) (ARRAY $ (UINT 8) $ (CONST_INT 20)))
 )
 (assert
  (= (%I (vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.? $ (ARRAY $ (UINT 8) $ (
        CONST_INT 20
 ...
 (assert
  (not (and
    (=>
     %%location_label%%0
     (req%vstd!array.array_index_get. $ (UINT 8) $ (CONST_INT 20) ar! 1)
    )
    (=>
     (ens%vstd!array.array_index_get. $ (UINT 8) $ (CONST_INT 20) ar! 1 tmp%1)
     (=>
      (= x@ (%I tmp%1))
      (=>
       (= tmp%2 (= x@ 19))
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/arrays-02fac289d0d9180f-test1/test.rs:25:1: 25:23 (#0)
(get-info :all-statistics)
(push)
 (declare-const ar! %%Function%%)
 (declare-const tmp%1 Poly)
 ...
 (assert
  (not (=>
    %%location_label%%0
    (req%vstd!array.array_index_get. $ (UINT 8) $ (CONST_INT 20) ar! 20)
 )))
 (get-info :version)
 (set-option :rlimit 30000000)
 (check-sat)
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/arrays-02fac289d0d9180f-test1/test.rs:29:1: 29:23 (#0)
(get-info :all-statistics)
(push)
 (declare-const ar! %%Function%%)
 ...
 (assert
  (not (=>
    (= tmp%1 (= (vstd!seq.Seq.len.? $ (UINT 8) (vstd!view.View.view.? $ (ARRAY $ (UINT 8)
         $ (CONST_INT 20)
        ) (Poly%array%. ar!)
       )
      ) 20
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/arrays-02fac289d0d9180f-test1/test.rs:33:1: 33:23 (#0)
(get-info :all-statistics)
(push)
 (declare-const ar! %%Function%%)
 (declare-const tmp%1 Bool)
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/arrays-02fac289d0d9180f-test1/test.rs:37:1: 37:38 (#0)
(get-info :all-statistics)
(push)
 (declare-const N&. Dcr)
 ...
 (assert
  (has_type (Poly%array%. ar!) (ARRAY $ (UINT 8) N&. N&))
 )
 (assert
  (uInv SZ (const_int N&))
 )
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/arrays-02fac289d0d9180f-test1/test.rs:41:1: 41:23 (#0)
(get-info :all-statistics)
(push)
 (declare-const ar! %%Function%%)
 (declare-const tmp%1 Bool)
 (declare-const ar@0 %%Function%%)
 (assert
  fuel_defaults
 )
 (assert
 ...
 (assert
  (not (=>
    ...
    (and
     (=>
      %%location_label%%0
      (req%vstd!array.impl&%3.set. $ (UINT 8) $ (CONST_INT 20) ar@0 7 (I 50))
     )
     (=>
      (has_type (Poly%array%. ar@1) (ARRAY $ (UINT 8) $ (CONST_INT 20)))
      (=>
       (ens%vstd!array.impl&%3.set. $ (UINT 8) $ (CONST_INT 20) ar@0 ar@1 7 (I 50))
       (=>
        (= tmp%1 (= (%I (vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.? $ (ARRAY $ (UINT
               8
              ) $ (CONST_INT 20)
             ) (Poly%array%. ar@1)
            ) (I 7)
...
;; Function-Specs test_crate::test7
(declare-fun req%test_crate!test7. (%%Function%%) Bool)
(declare-const %%global_location_label%%7 Bool)
(assert
 (forall ((ar! %%Function%%)) (!
   (= (req%test_crate!test7. ar!) (=>
   ...
   :pattern ((req%test_crate!test7. ar!))
   :qid internal_req__test_crate!test7._definition
   :skolemid skolem_internal_req__test_crate!test7._definition
)))

;; Function-Def test_crate::test7
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/arrays-02fac289d0d9180f-test1/test.rs:47:1: 47:23 (#0)
(get-info :all-statistics)
(push)
 (declare-const ar! %%Function%%)
 (declare-const tmp%1 Poly)
...
;; Function-Def test_crate::test8
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/arrays-02fac289d0d9180f-test1/test.rs:54:1: 54:23 (#0)
(get-info :all-statistics)
(push)
 (declare-const ar! %%Function%%)
 (declare-const tmp%1 Poly)
...
;; Function-Recommends test_crate::test8
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/arrays-02fac289d0d9180f-test1/test.rs:54:1: 54:23 (#0)
(get-info :all-statistics)
(push)
 (declare-const ar! %%Function%%)
...
;; Function-Specs test_crate::test9
(declare-fun ens%test_crate!test9. (test_crate!S. test_crate!S.) Bool)
(assert
 (forall ((pre%s! test_crate!S.) (s! test_crate!S.)) (!
   (= (ens%test_crate!test9. pre%s! s!) (has_type (Poly%test_crate!S. s!) TYPE%test_crate!S.))
   :pattern ((ens%test_crate!test9. pre%s! s!))
   :qid internal_ens__test_crate!test9._definition
   :skolemid skolem_internal_ens__test_crate!test9._definition
)))

;; Function-Def test_crate::test9
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/arrays-02fac289d0d9180f-test1/test.rs:62:1: 62:20 (#0)
(get-info :all-statistics)
(push)
 ...
 (assert
  (has_type (Poly%test_crate!S. s!@0) TYPE%test_crate!S.)
 )
 (declare-const ar@1 %%Function%%)
 ;; precondition not satisfied
 (declare-const %%location_label%%0 Bool)
 ...
 (assert
  (not (=>
    (= ar@0 (test_crate!S./S/ar (%Poly%test_crate!S. (Poly%test_crate!S. s!@0))))
    (and
     (=>
      %%location_label%%0
      (req%vstd!array.impl&%3.set. $ (UINT SZ) $ (CONST_INT 4) ar@0 0 (I 42))
     )
     (=>
      (has_type (Poly%array%. ar@1) (ARRAY $ (UINT SZ) $ (CONST_INT 4)))
      (=>
       (ens%vstd!array.impl&%3.set. $ (UINT SZ) $ (CONST_INT 4) ar@0 ar@1 0 (I 42))
       (=>
        (= tmp%1 (= (%I (vstd!seq.Seq.index.? $ (UINT SZ) (vstd!view.View.view.? $ (ARRAY $ (UINT
               SZ
              ) $ (CONST_INT 4)
             ) (Poly%array%. ar@1)
            ) (I 0)
...
;; Function-Def test_crate::test10
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/arrays-02fac289d0d9180f-test1/test.rs:68:1: 68:12 (#0)
(get-info :all-statistics)
(push)
 ...
 (assert
  (not (=>
    (= ar@0 (%Poly%array%. (array_new $ (SINT 32) 2 (%%array%%0 (I 0) (I 0)))))
    (=>
     (= tmp%1 (= (%I (vstd!seq.Seq.index.? $ (SINT 32) (vstd!view.View.view.? $ (ARRAY $ (SINT
            32
           ) $ (CONST_INT 2)
          ) (Poly%array%. ar@0)
         ) (I 0)
     ...
     (and
      ...
      (=>
       ...
       (and
        (=>
         %%location_label%%1
         (req%vstd!array.impl&%3.set. $ (SINT 32) $ (CONST_INT 2) ar@0 0 (I 42))
        )
        (=>
         (has_type (Poly%array%. ar@1) (ARRAY $ (SINT 32) $ (CONST_INT 2)))
         (=>
          (ens%vstd!array.impl&%3.set. $ (SINT 32) $ (CONST_INT 2) ar@0 ar@1 0 (I 42))
          (=>
           (= tmp%2 (= (%I (vstd!seq.Seq.index.? $ (SINT 32) (vstd!view.View.view.? $ (ARRAY $ (SINT
                  32
                 ) $ (CONST_INT 2)
                ) (Poly%array%. ar@1)
               ) (I 0)
           ...
           (and
            ...
            (=>
             tmp%2
             (=>
              (= tmp%3 (= (%I (vstd!seq.Seq.index.? $ (SINT 32) (vstd!view.View.view.? $ (ARRAY $ (SINT
                     32
                    ) $ (CONST_INT 2)
                   ) (Poly%array%. ar@1)
                  ) (I 1)
