...
(assert
 (distinct fuel%vstd!std_specs.option.impl&%0.is_Some. fuel%vstd!std_specs.option.impl&%0.get_Some_0.
  fuel%vstd!std_specs.option.is_some. fuel%vstd!std_specs.option.spec_unwrap. fuel%vstd!array.group_array_axioms.
...
;; Datatypes
(declare-datatypes ((core!option.Option. 0) (test_crate!X. 0)) (((core!option.Option./None)
...
(declare-fun req%test_crate!test2. (core!option.Option.) Bool)
(declare-const %%global_location_label%%2 Bool)
(assert
 (forall ((p! core!option.Option.)) (!
   (= (req%test_crate!test2. p!) (=>
     %%global_location_label%%2
     (is-core!option.Option./Some p!)
   ))
   :pattern ((req%test_crate!test2. p!))
   :qid internal_req__test_crate!test2._definition
   :skolemid skolem_internal_req__test_crate!test2._definition
)))
(declare-fun ens%test_crate!test2. (core!option.Option. %%Function%%) Bool)
(assert
 (forall ((p! core!option.Option.) (res! %%Function%%)) (!
   (= (ens%test_crate!test2. p! res!) (and
     (has_type (Poly%array%. res!) (ARRAY $ TYPE%test_crate!X. $ (CONST_INT 75)))
     (= (core!option.Option./Some (Poly%array%. res!)) p!)
   ))
   :pattern ((ens%test_crate!test2. p! res!))
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/arrays-02fac289d0d9180f-test_array_type_id/test.rs:17:1: 17:58 (#0)
(get-info :all-statistics)
(push)
 (declare-const res! %%Function%%)
 (declare-const p! core!option.Option.)
 ...
 (assert
  (has_type (Poly%core!option.Option. p!) (TYPE%core!option.Option. $ (ARRAY $ TYPE%test_crate!X.
     $ (CONST_INT 75)
 ))))
 (assert
  (is-core!option.Option./Some p!)
 ...
 (assert
  (not (=>
    (ens%core!option.impl&%0.as_ref. $ (ARRAY $ TYPE%test_crate!X. $ (CONST_INT 75)) p!
     tmp%1
    )
    (and
     (=>
      %%location_label%%0
      (req%core!option.impl&%0.unwrap. (REF $) (ARRAY $ TYPE%test_crate!X. $ (CONST_INT 75))
       tmp%1
     ))
     (=>
      (ens%core!option.impl&%0.unwrap. (REF $) (ARRAY $ TYPE%test_crate!X. $ (CONST_INT 75))
       tmp%1 tmp%2
      )
      (=>
       (= res! (%Poly%array%. tmp%2))
       (=>
        %%location_label%%1
        (= (core!option.Option./Some (Poly%array%. res!)) p!)
 )))))))
