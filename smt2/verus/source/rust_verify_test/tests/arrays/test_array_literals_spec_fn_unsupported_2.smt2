...
(assert
 (distinct fuel%vstd!array.array_view. fuel%vstd!array.impl&%0.view. fuel%vstd!array.impl&%2.spec_index.
  ...
  fuel%vstd!view.impl&%12.view. fuel%vstd!view.impl&%20.view. fuel%vstd!view.impl&%24.view.
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/arrays-02fac289d0d9180f-test_array_literals_spec_fn_unsupported_2/test.rs:16:6: 16:15 (#0)
(get-info :all-statistics)
(push)
 (declare-const no%param Int)
 (declare-const verus_tmp_a@ %%Function%%)
 (declare-const tmp%1 Bool)
 (declare-const verus_tmp@0 %%Function%%)
 (declare-const a@0 %%Function%%)
 (assert
  fuel_defaults
 )
 ...
 (declare-const verus_tmp@1 %%Function%%)
 (declare-const a@1 %%Function%%)
 ;; assertion failed
 (declare-const %%location_label%%0 Bool)
 (assert
  (not (=>
    (= verus_tmp@1 (%Poly%array%. (array_new $ (UINT 64) 3 (%%array%%0 (I 3) (I 4) (I 5)))))
    (=>
     (= verus_tmp_a@ verus_tmp@1)
     (=>
      (= a@1 verus_tmp_a@)
      (=>
