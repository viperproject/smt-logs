...
(assert
 (distinct fuel%vstd!raw_ptr.impl&%4.view. fuel%vstd!raw_ptr.ptrs_mut_eq. fuel%vstd!raw_ptr.spec_cast_ptr_to_usize.
  ...
  fuel%vstd!view.impl&%12.view. fuel%vstd!view.impl&%16.view. fuel%vstd!view.impl&%24.view.
  fuel%vstd!view.impl&%36.view. fuel%vstd!array.group_array_axioms. fuel%vstd!map.group_map_axioms.
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/raw_ptrs-3e1b37f726a021e8-pointer_cast_to_ints/test.rs:18:7: 18:28 (#0)
 ...
 (assert
  (not (=>
    (= tmp%1 (= (vstd!raw_ptr.PtrData./PtrData/addr (%Poly%vstd!raw_ptr.PtrData. (vstd!view.View.view.?
      ...
      ) (vstd!raw_ptr.spec_cast_ptr_to_usize.? T&. T& x!)
    ))
    (and
     (=>
      %%location_label%%0
     ...
     (=>
      ...
      (=>
       (= tmp%2 (= (vstd!raw_ptr.PtrData./PtrData/addr (%Poly%vstd!raw_ptr.PtrData. (vstd!view.View.view.?
         ...
         ) (nClip (vstd!raw_ptr.spec_cast_ptr_to_usize.? T&. T& x!))
       ))
       (and
        (=>
         %%location_label%%1
        ...
        (=>
         ...
         (=>
          (= tmp%3 (= (vstd!raw_ptr.PtrData./PtrData/addr (%Poly%vstd!raw_ptr.PtrData. (vstd!view.View.view.?
            ...
            ) (uClip SZ (vstd!raw_ptr.spec_cast_ptr_to_usize.? T&. T& x!))
          ))
          (and
           (=>
            %%location_label%%2
           ...
           (=>
            tmp%3
            (=>
             (= tmp%4 (= (uClip 16 (vstd!raw_ptr.PtrData./PtrData/addr (%Poly%vstd!raw_ptr.PtrData.
                  (vstd!view.View.view.? $ (PTR T&. T&) x!)
                ))
               ) (uClip 16 (vstd!raw_ptr.spec_cast_ptr_to_usize.? T&. T& x!))
             ))
             (=>
              %%location_label%%3
              tmp%4
...
;; Function-Def test_crate::test_fails
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/raw_ptrs-3e1b37f726a021e8-pointer_cast_to_ints/test.rs:25:7: 25:34 (#0)
(get-info :all-statistics)
(push)
 (declare-const T&. Dcr)
 (declare-const T& Type)
...
;; Function-Recommends test_crate::test_fails
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/raw_ptrs-3e1b37f726a021e8-pointer_cast_to_ints/test.rs:25:7: 25:34 (#0)
(get-info :all-statistics)
(push)
 (declare-const T&. Dcr)
 ...
 (assert
  (not (=>
    %%location_label%%0
    (uInv 16 (vstd!raw_ptr.spec_cast_ptr_to_usize.? T&. T& x!))
 )))
 (get-info :version)
 (set-option :rlimit 30000000)
 (check-sat)
...
;; Function-Def test_crate::test_fails2
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/raw_ptrs-3e1b37f726a021e8-pointer_cast_to_ints/test.rs:29:7: 29:35 (#0)
(get-info :all-statistics)
(push)
 (declare-const T&. Dcr)
 (declare-const T& Type)
 ...
 (assert
  (not (=>
    (= tmp%1 (= (vstd!raw_ptr.PtrData./PtrData/addr (%Poly%vstd!raw_ptr.PtrData. (vstd!view.View.view.?
      ...
      ) (iClip SZ (vstd!raw_ptr.spec_cast_ptr_to_usize.? T&. T& x!))
    ))
    (=>
     %%location_label%%0
     tmp%1
...
;; Function-Recommends test_crate::test_fails2
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/raw_ptrs-3e1b37f726a021e8-pointer_cast_to_ints/test.rs:29:7: 29:35 (#0)
(get-info :all-statistics)
(push)
 (declare-const T&. Dcr)
 ...
 (assert
  (not (=>
    %%location_label%%0
    (iInv SZ (vstd!raw_ptr.spec_cast_ptr_to_usize.? T&. T& x!))
 )))
 (get-info :version)
 (set-option :rlimit 30000000)
 (check-sat)
...
;; Function-Def test_crate::exec_test
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/raw_ptrs-3e1b37f726a021e8-pointer_cast_to_ints/test.rs:33:1: 33:27 (#0)
(get-info :all-statistics)
(push)
 (declare-const T&. Dcr)
 (declare-const T& Type)
 ...
 (assert
  (not (=>
    (ens%vstd!raw_ptr.cast_ptr_to_usize. T&. T& x! tmp%1)
    (=>
     (= x1@ (uClip SZ tmp%1))
     (=>
      (= tmp%2 (= (vstd!raw_ptr.PtrData./PtrData/addr (%Poly%vstd!raw_ptr.PtrData. (vstd!view.View.view.?
      ...
      (and
       ...
       (=>
        tmp%2
        (=>
         (ens%vstd!raw_ptr.cast_ptr_to_usize. T&. T& x! tmp%3)
         (=>
          (= x2@ (uClip 16 tmp%3))
          (=>
           (= tmp%4 (= (uClip 16 (vstd!raw_ptr.PtrData./PtrData/addr (%Poly%vstd!raw_ptr.PtrData.
...
;; Function-Def test_crate::exec_test_fails
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/raw_ptrs-3e1b37f726a021e8-pointer_cast_to_ints/test.rs:41:1: 41:33 (#0)
(get-info :all-statistics)
(push)
 (declare-const T&. Dcr)
 (declare-const T& Type)
...
;; Function-Recommends test_crate::exec_test_fails
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/raw_ptrs-3e1b37f726a021e8-pointer_cast_to_ints/test.rs:41:1: 41:33 (#0)
(get-info :all-statistics)
(push)
 (declare-const T&. Dcr)
...
;; Function-Def test_crate::exec_test_fails2
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/raw_ptrs-3e1b37f726a021e8-pointer_cast_to_ints/test.rs:46:1: 46:34 (#0)
(get-info :all-statistics)
(push)
 (declare-const T&. Dcr)
 (declare-const T& Type)
...
;; Function-Recommends test_crate::exec_test_fails2
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/raw_ptrs-3e1b37f726a021e8-pointer_cast_to_ints/test.rs:46:1: 46:34 (#0)
(get-info :all-statistics)
(push)
 (declare-const T&. Dcr)
