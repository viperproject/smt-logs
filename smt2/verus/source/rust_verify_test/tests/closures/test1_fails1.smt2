...
(assert
 (forall ((f! %%Function%%) (b! Bool)) (!
   (= (ens%takefun. f! b!) (= b! (%B (%%apply%%0 f! (I 10) (I 20)))))
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/closures-126f5b55da384ca6-test1_fails1/test.rs:15:7: 15:55 (#0)
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/closures-126f5b55da384ca6-test1_fails1/test.rs:22:7: 22:20 (#0)
(get-info :all-statistics)
(push)
 ...
 (assert
  (forall ((%%hole%%0 Int) (x$ Poly) (y$ Poly)) (!
    (= (%%apply%%0 (%%lambda%%0 %%hole%%0) x$ y$) (B (< (uClip %%hole%%0 (%I x$)) (%I y$))))
    :pattern ((%%apply%%0 (%%lambda%%0 %%hole%%0) x$ y$))
 )))
 ;; assertion failed
 (declare-const %%location_label%%0 Bool)
 (assert
  (not (=>
    (= tmp%1 (mk_fun (%%lambda%%0 64)))
    (=>
     (ens%takefun. tmp%1 b@)
     (=>
      %%location_label%%0
...
;; Function-Recommends crate::testtake
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/closures-126f5b55da384ca6-test1_fails1/test.rs:22:7: 22:20 (#0)
(get-info :all-statistics)
(push)
 (declare-const no%param Int)
 ...
 (assert
  (forall ((%%hole%%0 Int) (x$ Poly) (y$ Poly)) (!
    (= (%%apply%%0 (%%lambda%%1 %%hole%%0) x$ y$) (B (< (uClip %%hole%%0 (%I x$)) (%I y$))))
    :pattern ((%%apply%%0 (%%lambda%%1 %%hole%%0) x$ y$))
 )))
 (assert
  (not true)
 )
