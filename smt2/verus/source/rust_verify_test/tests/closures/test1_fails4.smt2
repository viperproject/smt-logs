...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/closures-126f5b55da384ca6-test1_fails4/test.rs:15:7: 15:20 (#0)
...
;; Function-Recommends crate::testfun1
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/closures-126f5b55da384ca6-test1_fails4/test.rs:15:7: 15:20 (#0)
(get-info :all-statistics)
(push)
 (declare-const no%param Int)
 ...
 (assert
  (forall ((%%hole%%0 Int) (x$ Poly)) (!
    (= (%%apply%%0 (%%lambda%%1 %%hole%%0) x$) (I (Add (%I x$) %%hole%%0)))
    :pattern ((%%apply%%0 (%%lambda%%1 %%hole%%0) x$))
 )))
 (assert
  (not true)
 )
