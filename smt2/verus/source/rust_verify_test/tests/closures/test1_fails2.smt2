...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (a! Poly) (f! Poly)) (!
    (= (polytestfun.? A&. A& a! f!) (%%apply%%0 (%Poly%fun%2. f!) a! a!))
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/closures-126f5b55da384ca6-test1_fails2/test.rs:19:7: 19:35 (#0)
...
(push)
 ...
 (declare-fun %%lambda%%0 (Bool) %%Function%%)
 (assert
  (forall ((%%hole%%0 Bool) (x$ Poly) (y$ Poly)) (!
    (= (%%apply%%0 (%%lambda%%0 %%hole%%0) x$ y$) (ite
      %%hole%%0
      x$
      y$
    ))
 ...
 (assert
  (not (=>
    (= aa@ (polytestfun.? A&. A& a! (Poly%fun%2. (mk_fun (%%lambda%%0 b!)))))
    (=>
     (= tmp%1 (not (= a! aa@)))
     (=>
      %%location_label%%0
...
;; Function-Recommends crate::testfun
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/closures-126f5b55da384ca6-test1_fails2/test.rs:19:7: 19:35 (#0)
(get-info :all-statistics)
(push)
 (declare-const A&. Dcr)
 ...
 (declare-fun %%lambda%%1 (Bool) %%Function%%)
 (assert
  (forall ((%%hole%%0 Bool) (x$ Poly) (y$ Poly)) (!
    (= (%%apply%%0 (%%lambda%%1 %%hole%%0) x$ y$) (ite
      %%hole%%0
      x$
      y$
    ))
