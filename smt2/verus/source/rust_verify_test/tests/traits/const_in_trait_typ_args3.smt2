...
;; Datatypes
(declare-datatypes ((Foo. 0) (Bar. 0) (tuple%0. 0)) (((Foo./Foo)) ((Bar./Bar)) ((tuple%0./tuple%0))))
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/traits-e45926d1282e7df0-const_in_trait_typ_args3/test.rs:24:5: 24:36 (#0)
...
(push)
 ...
 (assert
  (not (=>
    ...
    (=>
     %%location_label%%0
     (= (%I %return!) (const_int (CONST_INT 20)))
 ))))
 (get-info :version)
...
;; Function-Recommends crate::Foo::exec_get_x
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/traits-e45926d1282e7df0-const_in_trait_typ_args3/test.rs:24:5: 24:36 (#0)
(get-info :all-statistics)
(push)
 (declare-const %return! Poly)
...
;; Trait-Impl-Axiom
(assert
 (tr_bound%Trait. $ TYPE%Foo. $ (CONST_INT 20))
)

;; Function-Def crate::Bar::exec_get_x
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/traits-e45926d1282e7df0-const_in_trait_typ_args3/test.rs:31:5: 31:36 (#0)
(get-info :all-statistics)
(push)
 (declare-const X&. Dcr)
...
;; Function-Recommends crate::Bar::exec_get_x
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/traits-e45926d1282e7df0-const_in_trait_typ_args3/test.rs:31:5: 31:36 (#0)
(get-info :all-statistics)
(push)
 (declare-const X&. Dcr)
