...
(assert
 (distinct fuel%m1.Q.e. fuel%m1.p_prop_1. fuel%m1.p_prop_2.)
)

;; Datatypes
(declare-sort m1.S. 0)
(declare-datatypes ((m1.QQ. 0) (tuple%0. 0)) (((m1.QQ./QQ)) ((tuple%0./tuple%0))))
...
;; Function-Specs crate::m1::p_prop_1
(declare-fun ens%m1.p_prop_1. (m1.S.) Bool)
(assert
 (forall ((s! m1.S.)) (!
   (= (ens%m1.p_prop_1. s!) (= (%I (m1.Q.e.? $ TYPE%m1.QQ. $ TYPE%m1.S. (Poly%m1.S. s!)))
     200
   ))
   :pattern ((ens%m1.p_prop_1. s!))
   :qid internal_ens__m1.p_prop_1._definition
   :skolemid skolem_internal_ens__m1.p_prop_1._definition
)))
...
;; Function-Specs crate::m1::p_prop_2
(declare-fun ens%m1.p_prop_2. (m1.S.) Bool)
(assert
 (forall ((s! m1.S.)) (!
   (= (ens%m1.p_prop_2. s!) (= (%I (m1.Q.e.? $ TYPE%m1.QQ. (REF $) TYPE%m1.S. (Poly%m1.S.
        s!
      ))
     ) 300
   ))
   :pattern ((ens%m1.p_prop_2. s!))
   :qid internal_ens__m1.p_prop_2._definition
   :skolemid skolem_internal_ens__m1.p_prop_2._definition
)))
...
;; Function-Def crate::m2::test1
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/traits-e45926d1282e7df0-trait_encoding_soundness_experiments_1/test.rs:65:11: 65:25 (#0)
 ...
 (assert
  (not (=>
    ...
    (=>
     (fuel_bool fuel%m1.p_prop_2.)
     (=>
      (= tmp%1 (= (%I (m1.Q.e.? $ TYPE%m1.QQ. $ TYPE%m1.S. (Poly%m1.S. s!))) 200))
      (and
       (=>
        %%location_label%%0
        tmp%1
       ...
       (=>
        tmp%1
        (=>
         (= tmp%2 (= (%I (m1.Q.e.? $ TYPE%m1.QQ. (REF $) TYPE%m1.S. (Poly%m1.S. s!))) 300))
         (=>
          %%location_label%%1
          tmp%2
 )))))))))
...
;; Function-Def crate::m2::test2
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/traits-e45926d1282e7df0-trait_encoding_soundness_experiments_1/test.rs:72:11: 72:25 (#0)
(get-info :all-statistics)
(push)
 (declare-const s! m1.S.)
 (declare-const tmp%1 Bool)
 ...
 (assert
  (not (=>
    ...
    (=>
     (fuel_bool fuel%m1.p_prop_2.)
     (=>
      (= tmp%1 (= (%I (m1.Q.e.? $ TYPE%m1.QQ. $ TYPE%m1.S. (Poly%m1.S. s!))) 300))
      (=>
       %%location_label%%0
       tmp%1
 ))))))
...
;; Function-Recommends crate::m2::test2
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/traits-e45926d1282e7df0-trait_encoding_soundness_experiments_1/test.rs:72:11: 72:25 (#0)
(get-info :all-statistics)
(push)
 (declare-const s! m1.S.)
