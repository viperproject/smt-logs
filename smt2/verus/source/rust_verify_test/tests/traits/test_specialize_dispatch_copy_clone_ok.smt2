...
;; Datatypes
(declare-datatypes ((test_crate!Ticks32. 0) (tuple%1. 0)) (((test_crate!Ticks32./Ticks32
    (test_crate!Ticks32./Ticks32/?0 Int)
   )
  ) ((tuple%1./tuple%1 (tuple%1./tuple%1/?0 Poly)))
))
(declare-fun test_crate!Ticks32./Ticks32/0 (test_crate!Ticks32.) Int)
(declare-fun tuple%1./tuple%1/0 (tuple%1.) Poly)
(declare-const TYPE%test_crate!Ticks32. Type)
(declare-fun TYPE%tuple%1. (Dcr Type) Type)
(declare-fun FNDEF%core!clone.Clone.clone. (Dcr Type) Type)
(declare-fun Poly%test_crate!Ticks32. (test_crate!Ticks32.) Poly)
(declare-fun %Poly%test_crate!Ticks32. (Poly) test_crate!Ticks32.)
(declare-fun Poly%tuple%1. (tuple%1.) Poly)
(declare-fun %Poly%tuple%1. (Poly) tuple%1.)
(assert
 (forall ((x test_crate!Ticks32.)) (!
   (= x (%Poly%test_crate!Ticks32. (Poly%test_crate!Ticks32. x)))
   :pattern ((Poly%test_crate!Ticks32. x))
   :qid internal_test_crate__Ticks32_box_axiom_definition
   :skolemid skolem_internal_test_crate__Ticks32_box_axiom_definition
)))
(assert
 (forall ((x Poly)) (!
   (=>
    (has_type x TYPE%test_crate!Ticks32.)
    (= x (Poly%test_crate!Ticks32. (%Poly%test_crate!Ticks32. x)))
   )
   :pattern ((has_type x TYPE%test_crate!Ticks32.))
   :qid internal_test_crate__Ticks32_unbox_axiom_definition
   :skolemid skolem_internal_test_crate__Ticks32_unbox_axiom_definition
)))
(assert
 (forall ((_0! Int)) (!
   (=>
    (uInv 32 _0!)
    (has_type (Poly%test_crate!Ticks32. (test_crate!Ticks32./Ticks32 _0!)) TYPE%test_crate!Ticks32.)
   )
   :pattern ((has_type (Poly%test_crate!Ticks32. (test_crate!Ticks32./Ticks32 _0!)) TYPE%test_crate!Ticks32.))
   :qid internal_test_crate!Ticks32./Ticks32_constructor_definition
   :skolemid skolem_internal_test_crate!Ticks32./Ticks32_constructor_definition
)))
(assert
 (forall ((x test_crate!Ticks32.)) (!
   (= (test_crate!Ticks32./Ticks32/0 x) (test_crate!Ticks32./Ticks32/?0 x))
   :pattern ((test_crate!Ticks32./Ticks32/0 x))
   :qid internal_test_crate!Ticks32./Ticks32/0_accessor_definition
   :skolemid skolem_internal_test_crate!Ticks32./Ticks32/0_accessor_definition
)))
(assert
 (forall ((x Poly)) (!
   (=>
    (has_type x TYPE%test_crate!Ticks32.)
    (uInv 32 (test_crate!Ticks32./Ticks32/0 (%Poly%test_crate!Ticks32. x)))
   )
   :pattern ((test_crate!Ticks32./Ticks32/0 (%Poly%test_crate!Ticks32. x)) (has_type x
     TYPE%test_crate!Ticks32.
   ))
   :qid internal_test_crate!Ticks32./Ticks32/0_invariant_definition
   :skolemid skolem_internal_test_crate!Ticks32./Ticks32/0_invariant_definition
)))
(assert
 (forall ((x tuple%1.)) (!
...
(declare-fun tr_bound%test_crate!Ticks. (Dcr Type) Bool)
(assert
...
(assert
 (forall ((Self%&. Dcr) (Self%& Type)) (!
   (=>
    (tr_bound%test_crate!Ticks. Self%&. Self%&)
    (tr_bound%core!clone.Clone. Self%&. Self%&)
   )
   :pattern ((tr_bound%test_crate!Ticks. Self%&. Self%&))
   :qid internal_test_crate__Ticks_trait_type_bounds_definition
   :skolemid skolem_internal_test_crate__Ticks_trait_type_bounds_definition
)))
...
;; Function-Specs test_crate::Ticks::width
(declare-fun ens%test_crate!Ticks.width. (Dcr Type Poly) Bool)
(assert
 (forall ((Self%&. Dcr) (Self%& Type) (%return! Poly)) (!
   (= (ens%test_crate!Ticks.width. Self%&. Self%& %return!) (has_type %return! (UINT 32)))
   :pattern ((ens%test_crate!Ticks.width. Self%&. Self%& %return!))
   :qid internal_ens__test_crate!Ticks.width._definition
   :skolemid skolem_internal_ens__test_crate!Ticks.width._definition
)))
...
;; Function-Def test_crate::Ticks32::clone
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/traits-e45926d1282e7df0-test_specialize_dispatch_copy_clone_ok/test.rs:19:5: 19:28 (#0)
...
(push)
 ...
 (assert
  (has_type self! TYPE%test_crate!Ticks32.)
 )
 (assert
  (not true)
 )
...
;; Trait-Impl-Axiom
(assert
 (tr_bound%core!clone.Clone. $ TYPE%test_crate!Ticks32.)
)

;; Function-Def test_crate::Ticks32::width
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/traits-e45926d1282e7df0-test_specialize_dispatch_copy_clone_ok/test.rs:24:5: 24:22 (#0)
(get-info :all-statistics)
(push)
 (declare-const %return! Poly)
 (assert
...
;; Trait-Impl-Axiom
(assert
 (tr_bound%test_crate!Ticks. $ TYPE%test_crate!Ticks32.)
)
