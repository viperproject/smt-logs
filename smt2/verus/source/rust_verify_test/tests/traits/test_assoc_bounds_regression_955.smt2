...
(declare-fun proj%%test_crate!A./Input (Dcr Type) Dcr)
(declare-fun proj%test_crate!A./Input (Dcr Type) Type)
(declare-fun proj%%test_crate!A./Output (Dcr Type) Dcr)
(declare-fun proj%test_crate!A./Output (Dcr Type) Type)
(declare-fun proj%%test_crate!B./MyA (Dcr Type) Dcr)
(declare-fun proj%test_crate!B./MyA (Dcr Type) Type)
...
(declare-fun tr_bound%test_crate!A. (Dcr Type) Bool)
(declare-fun tr_bound%test_crate!B. (Dcr Type) Bool)
(assert
...
(assert
 (forall ((Self%&. Dcr) (Self%& Type)) (!
   (=>
    (tr_bound%test_crate!A. Self%&. Self%&)
    (and
     (tr_bound%vstd!view.View. (proj%%test_crate!A./Input Self%&. Self%&) (proj%test_crate!A./Input
       Self%&. Self%&
     ))
     (tr_bound%vstd!view.View. (proj%%test_crate!A./Output Self%&. Self%&) (proj%test_crate!A./Output
       Self%&. Self%&
   ))))
   :pattern ((tr_bound%test_crate!A. Self%&. Self%&))
   :qid internal_test_crate__A_trait_type_bounds_definition
   :skolemid skolem_internal_test_crate__A_trait_type_bounds_definition
)))
(assert
 (forall ((Self%&. Dcr) (Self%& Type)) (!
   (=>
    (tr_bound%test_crate!B. Self%&. Self%&)
    (tr_bound%test_crate!A. (proj%%test_crate!B./MyA Self%&. Self%&) (proj%test_crate!B./MyA
      Self%&. Self%&
   )))
   :pattern ((tr_bound%test_crate!B. Self%&. Self%&))
   :qid internal_test_crate__B_trait_type_bounds_definition
   :skolemid skolem_internal_test_crate__B_trait_type_bounds_definition
)))

;; Function-Specs test_crate::B::foo
(declare-fun ens%test_crate!B.foo. (Dcr Type Poly Poly) Bool)
(assert
 (forall ((Self%&. Dcr) (Self%& Type) (input! Poly) (%return! Poly)) (!
   (= (ens%test_crate!B.foo. Self%&. Self%& input! %return!) (has_type %return! (proj%test_crate!A./Output
      (proj%%test_crate!B./MyA Self%&. Self%&) (proj%test_crate!B./MyA Self%&. Self%&)
   )))
   :pattern ((ens%test_crate!B.foo. Self%&. Self%& input! %return!))
   :qid internal_ens__test_crate!B.foo._definition
   :skolemid skolem_internal_ens__test_crate!B.foo._definition
)))
