...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/overflow-b15e46e4cdf71384-test_overflow_spec_pass/test.rs:16:1: 16:16 (#0)
(get-info :all-statistics)
(push)
 (declare-const a! Int)
 (declare-const verus_tmp_j@0 Int)
 ...
 (assert
  (not (=>
    (= verus_tmp@1 a!)
    (=>
     (= verus_tmp_j@0 verus_tmp@1)
     (=>
      (= j@1 verus_tmp_j@0)
      (=>
       (= j@2 (uClip 64 (Add j@1 2)))
       (=>
        (= tmp%1 (= j@2 (uClip 64 (Add a! 2))))
        (=>
         %%location_label%%0
         tmp%1
 ))))))))
