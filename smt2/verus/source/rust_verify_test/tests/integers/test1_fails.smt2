...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/integers-b0e0613f666db427-test1_fails/test.rs:19:7: 19:38 (#0)
...
(push)
 ...
 (assert
  (not (=>
    (= tmp%1 (= (add1_int.? (I u!)) (uClip 8 (Add u! 1))))
    (=>
     %%location_label%%0
     tmp%1
 ))))
