...
(assert
 (distinct fuel%vstd!std_specs.vec.axiom_spec_len. fuel%vstd!raw_ptr.impl&%4.view.
  ...
  fuel%vstd!view.impl&%12.view. fuel%vstd!view.impl&%24.view. fuel%test_crate!impl&%0.f.
...
;; Datatypes
(declare-sort alloc!vec.Vec<tuple%0./allocator_global%.>. 0)
...
(declare-datatypes ((vstd!raw_ptr.Metadata. 0) (vstd!raw_ptr.PtrData. 0) (test_crate!S.
  ...
  ) ((test_crate!S./S (test_crate!S./S/?vec alloc!vec.Vec<tuple%0./allocator_global%.>.)))
  ((tuple%0./tuple%0))
))
...
(declare-fun test_crate!S./S/vec (test_crate!S.) alloc!vec.Vec<tuple%0./allocator_global%.>.)
...
(declare-fun Poly%alloc!vec.Vec<tuple%0./allocator_global%.>. (alloc!vec.Vec<tuple%0./allocator_global%.>.)
 Poly
)
(declare-fun %Poly%alloc!vec.Vec<tuple%0./allocator_global%.>. (Poly) alloc!vec.Vec<tuple%0./allocator_global%.>.)
...
(assert
 (forall ((x alloc!vec.Vec<tuple%0./allocator_global%.>.)) (!
   (= x (%Poly%alloc!vec.Vec<tuple%0./allocator_global%.>. (Poly%alloc!vec.Vec<tuple%0./allocator_global%.>.
      x
   )))
   :pattern ((Poly%alloc!vec.Vec<tuple%0./allocator_global%.>. x))
   :qid internal_alloc__vec__Vec<tuple__0./allocator_global__.>_box_axiom_definition
   :skolemid skolem_internal_alloc__vec__Vec<tuple__0./allocator_global__.>_box_axiom_definition
)))
(assert
 (forall ((x Poly)) (!
   (=>
    (has_type x (TYPE%alloc!vec.Vec. $ TYPE%tuple%0. $ ALLOCATOR_GLOBAL))
    (= x (Poly%alloc!vec.Vec<tuple%0./allocator_global%.>. (%Poly%alloc!vec.Vec<tuple%0./allocator_global%.>.
       x
   ))))
   :pattern ((has_type x (TYPE%alloc!vec.Vec. $ TYPE%tuple%0. $ ALLOCATOR_GLOBAL)))
   :qid internal_alloc__vec__Vec<tuple__0./allocator_global__.>_unbox_axiom_definition
   :skolemid skolem_internal_alloc__vec__Vec<tuple__0./allocator_global__.>_unbox_axiom_definition
)))
(assert
 (forall ((x alloc!vec.Vec<tuple%0./allocator_global%.>.)) (!
   (has_type (Poly%alloc!vec.Vec<tuple%0./allocator_global%.>. x) (TYPE%alloc!vec.Vec.
     $ TYPE%tuple%0. $ ALLOCATOR_GLOBAL
   ))
   :pattern ((has_type (Poly%alloc!vec.Vec<tuple%0./allocator_global%.>. x) (TYPE%alloc!vec.Vec.
      $ TYPE%tuple%0. $ ALLOCATOR_GLOBAL
   )))
   :qid internal_alloc__vec__Vec<tuple__0./allocator_global__.>_has_type_always_definition
   :skolemid skolem_internal_alloc__vec__Vec<tuple__0./allocator_global__.>_has_type_always_definition
)))
(assert
...
(assert
 (forall ((x test_crate!S.)) (!
   (= (test_crate!S./S/vec x) (test_crate!S./S/?vec x))
   :pattern ((test_crate!S./S/vec x))
   :qid internal_test_crate!S./S/vec_accessor_definition
   :skolemid skolem_internal_test_crate!S./S/vec_accessor_definition
)))
(assert
 (forall ((x test_crate!S.)) (!
...
;; Function-Decl test_crate::S::f
(declare-fun test_crate!impl&%0.f.? (Poly) Bool)
...
(assert
 (=>
  ...
  (forall ((T&. Dcr) (T& Type) (a! Poly)) (!
    ...
    :qid user_vstd__raw_ptr__ptrs_mut_eq_1
    :skolemid skolem_user_vstd__raw_ptr__ptrs_mut_eq_1
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (s! Poly) (i! Poly)) (!
    ...
    :qid user_vstd__seq__axiom_seq_index_decreases_2
    :skolemid skolem_user_vstd__seq__axiom_seq_index_decreases_2
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type)) (!
    ...
    :qid user_vstd__seq__axiom_seq_empty_3
    :skolemid skolem_user_vstd__seq__axiom_seq_empty_3
))))
...
;; Function-Axioms test_crate::S::f
(assert
...
(assert
 (=>
  ...
  (forall ((self! Poly)) (!
    (= (test_crate!impl&%0.f.? self!) (< 0 (vstd!std_specs.vec.spec_vec_len.? $ TYPE%tuple%0.
       $ ALLOCATOR_GLOBAL (Poly%alloc!vec.Vec<tuple%0./allocator_global%.>. (test_crate!S./S/vec
         (%Poly%test_crate!S. self!)
    )))))
    :pattern ((test_crate!impl&%0.f.? self!))
    :qid internal_test_crate!impl&__0.f.?_definition
    :skolemid skolem_internal_test_crate!impl&__0.f.?_definition
))))
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/when_used_as_spec-ef366eee3048cea7-vec_len_regression_issue212/test.rs:27:1: 27:10 (#0)
(get-info :all-statistics)
(push)
 (declare-const no%param Int)
 (declare-const tmp%1 Poly)
 (declare-const tmp%2 Bool)
 (declare-const tmp%3 tuple%0.)
 (declare-const tmp%4 Bool)
 (declare-const s@0 test_crate!S.)
 (assert
  fuel_defaults
 )
 (declare-const s@1 test_crate!S.)
 ;; assertion failed
 ...
 (assert
  (not (=>
    (ens%alloc!vec.impl&%0.new. $ TYPE%tuple%0. tmp%1)
    (=>
     (= s@0 (test_crate!S./S (%Poly%alloc!vec.Vec<tuple%0./allocator_global%.>. tmp%1)))
     (=>
      (= tmp%2 (not (test_crate!impl&%0.f.? (Poly%test_crate!S. s@0))))
      (and
       (=>
        %%location_label%%0
        tmp%2
       ...
       (=>
        tmp%2
        (=>
         (= tmp%3 tuple%0./tuple%0)
         (=>
          (ens%alloc!vec.impl&%1.push. $ TYPE%tuple%0. $ ALLOCATOR_GLOBAL (Poly%alloc!vec.Vec<tuple%0./allocator_global%.>.
            (test_crate!S./S/vec (%Poly%test_crate!S. (Poly%test_crate!S. s@0)))
           ) (Poly%alloc!vec.Vec<tuple%0./allocator_global%.>. (test_crate!S./S/vec (%Poly%test_crate!S.
              (Poly%test_crate!S. s@1)
            ))
           ) (Poly%tuple%0. tmp%3)
          )
          (=>
           (= tmp%4 (test_crate!impl&%0.f.? (Poly%test_crate!S. s@1)))
           (=>
            %%location_label%%1
            tmp%4
 )))))))))))
