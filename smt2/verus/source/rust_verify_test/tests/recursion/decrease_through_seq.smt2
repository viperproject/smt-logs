...
(assert
 (distinct fuel%vstd!seq.impl&%0.spec_index. fuel%vstd!seq.axiom_seq_index_decreases.
  fuel%vstd!seq.axiom_seq_ext_equal. fuel%vstd!seq.axiom_seq_ext_equal_deep. fuel%test_crate!f.
...
(declare-datatypes ((test_crate!S. 0) (tuple%0. 0)) (((test_crate!S./S (test_crate!S./S/?x
     vstd!seq.Seq<$%2<allocator_global%./test_crate!S.>.>.
   ))
  ) ((tuple%0./tuple%0))
))
(declare-fun test_crate!S./S/x (test_crate!S.) vstd!seq.Seq<$%2<allocator_global%./test_crate!S.>.>.)
...
(assert
 (forall ((x test_crate!S.)) (!
   (= (test_crate!S./S/x x) (test_crate!S./S/?x x))
   :pattern ((test_crate!S./S/x x))
   :qid internal_test_crate!S./S/x_accessor_definition
   :skolemid skolem_internal_test_crate!S./S/x_accessor_definition
)))
(assert
 (forall ((x test_crate!S.)) (!
...
(assert
 (forall ((x test_crate!S.)) (!
   (=>
    (is-test_crate!S./S x)
    (height_lt (height (Poly%vstd!seq.Seq<$%2<allocator_global%./test_crate!S.>.>. (test_crate!S./S/x
        x
      ))
     ) (height (Poly%test_crate!S. x))
   ))
   :pattern ((height (Poly%vstd!seq.Seq<$%2<allocator_global%./test_crate!S.>.>. (test_crate!S./S/x
       x
   ))))
   :qid prelude_datatype_height_test_crate!S./S/x
   :skolemid skolem_prelude_datatype_height_test_crate!S./S/x
)))
(assert
 (forall ((x tuple%0.)) (!
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/recursion-323c2b72cefe3aab-decrease_through_seq/test.rs:21:6: 21:23 (#0)
...
(push)
 ...
 (declare-const decrease%init0 test_crate!S.)
 (assert
  fuel_defaults
 )
 (assert
  (has_type s! TYPE%test_crate!S.)
 )
 ...
 (assert
  (not (=>
    (= decrease%init0 (%Poly%test_crate!S. s!))
    (or
     (and
      (=>
       (> (vstd!seq.Seq.len.? (BOX $ ALLOCATOR_GLOBAL $) TYPE%test_crate!S. (Poly%vstd!seq.Seq<$%2<allocator_global%./test_crate!S.>.>.
          (test_crate!S./S/x (%Poly%test_crate!S. s!))
         )
        ) 0
       )
       (=>
        (= tmp%2 (vstd!seq.Seq.index.? (BOX $ ALLOCATOR_GLOBAL $) TYPE%test_crate!S. (Poly%vstd!seq.Seq<$%2<allocator_global%./test_crate!S.>.>.
           (test_crate!S./S/x (%Poly%test_crate!S. s!))
          ) (I 0)
        ))
        (and
         (=>
          %%location_label%%0
          (check_decrease_height (Poly%test_crate!S. (let
             ((s!$0 (%Poly%test_crate!S. tmp%2)))
             s!$0
            )
           ) (Poly%test_crate!S. decrease%init0) false
         ))
         (=>
          (= tmp%1 (test_crate!f.? (vstd!seq.Seq.index.? (BOX $ ALLOCATOR_GLOBAL $) TYPE%test_crate!S.
             (Poly%vstd!seq.Seq<$%2<allocator_global%./test_crate!S.>.>. (test_crate!S./S/x (%Poly%test_crate!S.
                s!
              ))
             ) (I 0)
          )))
      ...
      (=>
       (not (> (vstd!seq.Seq.len.? (BOX $ ALLOCATOR_GLOBAL $) TYPE%test_crate!S. (Poly%vstd!seq.Seq<$%2<allocator_global%./test_crate!S.>.>.
           (test_crate!S./S/x (%Poly%test_crate!S. s!))
          )
         ) 0
       ))
 ...
 (forall ((s! Poly) (fuel% Fuel)) (!
   (=>
    ...
    (= (test_crate!rec%f.? s! (succ fuel%)) (ite
      ...
      (test_crate!rec%f.? (vstd!seq.Seq.index.? (BOX $ ALLOCATOR_GLOBAL $) TYPE%test_crate!S.
        (Poly%vstd!seq.Seq<$%2<allocator_global%./test_crate!S.>.>. (test_crate!S./S/x (%Poly%test_crate!S.
           s!
         ))
        ) (I 0)
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/recursion-323c2b72cefe3aab-decrease_through_seq/test.rs:31:7: 31:17 (#0)
(get-info :all-statistics)
(push)
 (declare-const s! test_crate!S.)
  ...
  (not (=>
    ...
    (or
     (and
      (=>
       (> (vstd!seq.Seq.len.? (BOX $ ALLOCATOR_GLOBAL $) TYPE%test_crate!S. (Poly%vstd!seq.Seq<$%2<allocator_global%./test_crate!S.>.>.
          (test_crate!S./S/x (%Poly%test_crate!S. (Poly%test_crate!S. s!)))
         )
        ) 0
       )
       (=>
        (= tmp%1 (%Poly%test_crate!S. (vstd!seq.Seq.index.? (BOX $ ALLOCATOR_GLOBAL $) TYPE%test_crate!S.
           (Poly%vstd!seq.Seq<$%2<allocator_global%./test_crate!S.>.>. (test_crate!S./S/x (%Poly%test_crate!S.
              (Poly%test_crate!S. s!)
            ))
           ) (I 0)
...
;; Function-Recommends test_crate::p
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/recursion-323c2b72cefe3aab-decrease_through_seq/test.rs:31:7: 31:17 (#0)
(get-info :all-statistics)
(push)
 (declare-const s! test_crate!S.)
  ...
  (not (or
    (and
     (=>
      ...
      (=>
       (= tmp%2 (Poly%vstd!seq.Seq<$%2<allocator_global%./test_crate!S.>.>. (test_crate!S./S/x
          (%Poly%test_crate!S. (Poly%test_crate!S. s!))
       )))
       (=>
        %%location_label%%0
        (req%vstd!seq.impl&%0.spec_index. (BOX $ ALLOCATOR_GLOBAL $) TYPE%test_crate!S. tmp%2
         (I 0)
     ))))
     (=>
      (not (> (vstd!seq.Seq.len.? (BOX $ ALLOCATOR_GLOBAL $) TYPE%test_crate!S. (Poly%vstd!seq.Seq<$%2<allocator_global%./test_crate!S.>.>.
...
;; Function-Def test_crate::q
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/recursion-323c2b72cefe3aab-decrease_through_seq/test.rs:40:7: 40:17 (#0)
(get-info :all-statistics)
(push)
 (declare-const s! test_crate!S.)
 (declare-const tmp%1 test_crate!S.)
...
;; Function-Recommends test_crate::q
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/recursion-323c2b72cefe3aab-decrease_through_seq/test.rs:40:7: 40:17 (#0)
(get-info :all-statistics)
(push)
 (declare-const s! test_crate!S.)
