...
(declare-datatypes ((test_crate!MyMap. 0) (test_crate!S. 0) (tuple%0. 0)) (((test_crate!MyMap./MyMap
    (test_crate!MyMap./MyMap/?0 Poly)
   )
  ) ((test_crate!S./S (test_crate!S./S/?x test_crate!MyMap.))) ((tuple%0./tuple%0))
))
(declare-fun test_crate!MyMap./MyMap/0 (test_crate!MyMap.) Poly)
(declare-fun test_crate!S./S/x (test_crate!S.) test_crate!MyMap.)
(declare-fun TYPE%vstd!map.Map. (Dcr Type Dcr Type) Type)
(declare-fun TYPE%vstd!set.Set. (Dcr Type) Type)
(declare-fun TYPE%test_crate!MyMap. (Dcr Type Dcr Type) Type)
...
(declare-fun Poly%test_crate!MyMap. (test_crate!MyMap.) Poly)
(declare-fun %Poly%test_crate!MyMap. (Poly) test_crate!MyMap.)
...
(assert
 (forall ((x test_crate!MyMap.)) (!
   (= x (%Poly%test_crate!MyMap. (Poly%test_crate!MyMap. x)))
   :pattern ((Poly%test_crate!MyMap. x))
   :qid internal_test_crate__MyMap_box_axiom_definition
   :skolemid skolem_internal_test_crate__MyMap_box_axiom_definition
)))
(assert
 (forall ((A&. Dcr) (A& Type) (B&. Dcr) (B& Type) (x Poly)) (!
   (=>
    (has_type x (TYPE%test_crate!MyMap. A&. A& B&. B&))
    (= x (Poly%test_crate!MyMap. (%Poly%test_crate!MyMap. x)))
   )
   :pattern ((has_type x (TYPE%test_crate!MyMap. A&. A& B&. B&)))
   :qid internal_test_crate__MyMap_unbox_axiom_definition
   :skolemid skolem_internal_test_crate__MyMap_unbox_axiom_definition
)))
(assert
 (forall ((A&. Dcr) (A& Type) (B&. Dcr) (B& Type) (_0! Poly)) (!
   (=>
    (has_type _0! (TYPE%vstd!map.Map. A&. A& B&. B&))
    (has_type (Poly%test_crate!MyMap. (test_crate!MyMap./MyMap _0!)) (TYPE%test_crate!MyMap.
      A&. A& B&. B&
   )))
   :pattern ((has_type (Poly%test_crate!MyMap. (test_crate!MyMap./MyMap _0!)) (TYPE%test_crate!MyMap.
      A&. A& B&. B&
   )))
   :qid internal_test_crate!MyMap./MyMap_constructor_definition
   :skolemid skolem_internal_test_crate!MyMap./MyMap_constructor_definition
)))
(assert
 (forall ((x test_crate!MyMap.)) (!
   (= (test_crate!MyMap./MyMap/0 x) (test_crate!MyMap./MyMap/?0 x))
   :pattern ((test_crate!MyMap./MyMap/0 x))
   :qid internal_test_crate!MyMap./MyMap/0_accessor_definition
   :skolemid skolem_internal_test_crate!MyMap./MyMap/0_accessor_definition
)))
(assert
 (forall ((A&. Dcr) (A& Type) (B&. Dcr) (B& Type) (x Poly)) (!
   (=>
    (has_type x (TYPE%test_crate!MyMap. A&. A& B&. B&))
    (has_type (test_crate!MyMap./MyMap/0 (%Poly%test_crate!MyMap. x)) (TYPE%vstd!map.Map.
      A&. A& B&. B&
   )))
   :pattern ((test_crate!MyMap./MyMap/0 (%Poly%test_crate!MyMap. x)) (has_type x (TYPE%test_crate!MyMap.
      A&. A& B&. B&
   )))
   :qid internal_test_crate!MyMap./MyMap/0_invariant_definition
   :skolemid skolem_internal_test_crate!MyMap./MyMap/0_invariant_definition
)))
(assert
 (forall ((x test_crate!MyMap.)) (!
   (=>
    (is-test_crate!MyMap./MyMap x)
    (height_lt (height (test_crate!MyMap./MyMap/0 x)) (height (Poly%test_crate!MyMap. x)))
   )
   :pattern ((height (test_crate!MyMap./MyMap/0 x)))
   :qid prelude_datatype_height_test_crate!MyMap./MyMap/0
   :skolemid skolem_prelude_datatype_height_test_crate!MyMap./MyMap/0
)))
(assert
...
(assert
 (forall ((_x! test_crate!MyMap.)) (!
   (=>
    (has_type (Poly%test_crate!MyMap. _x!) (TYPE%test_crate!MyMap. $ INT (BOX $ ALLOCATOR_GLOBAL
       $
      ) TYPE%test_crate!S.
    ))
    (has_type (Poly%test_crate!S. (test_crate!S./S _x!)) TYPE%test_crate!S.)
   )
   :pattern ((has_type (Poly%test_crate!S. (test_crate!S./S _x!)) TYPE%test_crate!S.))
...
(assert
 (forall ((x Poly)) (!
   (=>
    (has_type x TYPE%test_crate!S.)
    (has_type (Poly%test_crate!MyMap. (test_crate!S./S/x (%Poly%test_crate!S. x))) (TYPE%test_crate!MyMap.
      $ INT (BOX $ ALLOCATOR_GLOBAL $) TYPE%test_crate!S.
   )))
   :pattern ((test_crate!S./S/x (%Poly%test_crate!S. x)) (has_type x TYPE%test_crate!S.))
   :qid internal_test_crate!S./S/x_invariant_definition
   :skolemid skolem_internal_test_crate!S./S/x_invariant_definition
)))
(assert
 (forall ((x test_crate!S.)) (!
   (=>
    (is-test_crate!S./S x)
    (height_lt (height (Poly%test_crate!MyMap. (test_crate!S./S/x x))) (height (Poly%test_crate!S.
       x
   ))))
   :pattern ((height (Poly%test_crate!MyMap. (test_crate!S./S/x x))))
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/recursion-323c2b72cefe3aab-decrease_through_my_map/test.rs:24:6: 24:23 (#0)
     ...
     (and
      (=>
       (vstd!set.impl&%0.contains.? $ INT (vstd!map.impl&%0.dom.? $ INT (BOX $ ALLOCATOR_GLOBAL
          $
         ) TYPE%test_crate!S. (test_crate!MyMap./MyMap/0 (%Poly%test_crate!MyMap. (Poly%test_crate!MyMap.
       ...
       (=>
        (= tmp%2 (vstd!map.impl&%0.index.? $ INT (BOX $ ALLOCATOR_GLOBAL $) TYPE%test_crate!S.
          (test_crate!MyMap./MyMap/0 (%Poly%test_crate!MyMap. (Poly%test_crate!MyMap. (test_crate!S./S/x
              (%Poly%test_crate!S. s!)
           )))
          ) (I 3)
        ))
  ...
  (not (or
    (and
     (=>
      ...
      (=>
       (= tmp%2 (test_crate!MyMap./MyMap/0 (%Poly%test_crate!MyMap. (Poly%test_crate!MyMap.
           (test_crate!S./S/x (%Poly%test_crate!S. s!))
       ))))
       (and
        (=>
        ...
        (=>
         (= tmp%1 (vstd!map.impl&%0.index.? $ INT (BOX $ ALLOCATOR_GLOBAL $) TYPE%test_crate!S.
           (test_crate!MyMap./MyMap/0 (%Poly%test_crate!MyMap. (Poly%test_crate!MyMap. (test_crate!S./S/x
               (%Poly%test_crate!S. s!)
            )))
           ) (I 3)
