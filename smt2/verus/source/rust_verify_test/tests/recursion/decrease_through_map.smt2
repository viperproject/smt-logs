...
(assert
 (distinct fuel%vstd!map.impl&%0.spec_index. fuel%vstd!map.axiom_map_index_decreases_finite.
  ...
  fuel%test_crate!f. fuel%vstd!array.group_array_axioms. fuel%vstd!map.group_map_axioms.
...
;; Datatypes
(declare-sort vstd!map.Map<int./$%2<allocator_global%./test_crate!S.>.>. 0)
(declare-sort vstd!set.Set<int.>. 0)
(declare-sort allocator_global%. 0)
(declare-datatypes ((test_crate!S. 0) (tuple%0. 0)) (((test_crate!S./S (test_crate!S./S/?x
     vstd!map.Map<int./$%2<allocator_global%./test_crate!S.>.>.
   ))
  ) ((tuple%0./tuple%0))
))
(declare-fun test_crate!S./S/x (test_crate!S.) vstd!map.Map<int./$%2<allocator_global%./test_crate!S.>.>.)
(declare-fun TYPE%vstd!map.Map. (Dcr Type Dcr Type) Type)
(declare-fun TYPE%vstd!set.Set. (Dcr Type) Type)
(declare-const TYPE%test_crate!S. Type)
(declare-const TYPE%tuple%0. Type)
(declare-fun Poly%vstd!map.Map<int./$%2<allocator_global%./test_crate!S.>.>. (vstd!map.Map<int./$%2<allocator_global%./test_crate!S.>.>.)
 Poly
)
(declare-fun %Poly%vstd!map.Map<int./$%2<allocator_global%./test_crate!S.>.>. (Poly)
 vstd!map.Map<int./$%2<allocator_global%./test_crate!S.>.>.
)
...
(assert
 (forall ((x vstd!map.Map<int./$%2<allocator_global%./test_crate!S.>.>.)) (!
   (= x (%Poly%vstd!map.Map<int./$%2<allocator_global%./test_crate!S.>.>. (Poly%vstd!map.Map<int./$%2<allocator_global%./test_crate!S.>.>.
      x
   )))
   :pattern ((Poly%vstd!map.Map<int./$%2<allocator_global%./test_crate!S.>.>. x))
   :qid internal_vstd__map__Map<int./$__2<allocator_global__./test_crate!S.>.>_box_axiom_definition
   :skolemid skolem_internal_vstd__map__Map<int./$__2<allocator_global__./test_crate!S.>.>_box_axiom_definition
)))
(assert
 (forall ((x Poly)) (!
   (=>
    (has_type x (TYPE%vstd!map.Map. $ INT (BOX $ ALLOCATOR_GLOBAL $) TYPE%test_crate!S.))
    (= x (Poly%vstd!map.Map<int./$%2<allocator_global%./test_crate!S.>.>. (%Poly%vstd!map.Map<int./$%2<allocator_global%./test_crate!S.>.>.
       x
   ))))
   :pattern ((has_type x (TYPE%vstd!map.Map. $ INT (BOX $ ALLOCATOR_GLOBAL $) TYPE%test_crate!S.)))
   :qid internal_vstd__map__Map<int./$__2<allocator_global__./test_crate!S.>.>_unbox_axiom_definition
   :skolemid skolem_internal_vstd__map__Map<int./$__2<allocator_global__./test_crate!S.>.>_unbox_axiom_definition
)))
(assert
 (forall ((x vstd!map.Map<int./$%2<allocator_global%./test_crate!S.>.>.)) (!
   (has_type (Poly%vstd!map.Map<int./$%2<allocator_global%./test_crate!S.>.>. x) (TYPE%vstd!map.Map.
     $ INT (BOX $ ALLOCATOR_GLOBAL $) TYPE%test_crate!S.
   ))
   :pattern ((has_type (Poly%vstd!map.Map<int./$%2<allocator_global%./test_crate!S.>.>.
      x
     ) (TYPE%vstd!map.Map. $ INT (BOX $ ALLOCATOR_GLOBAL $) TYPE%test_crate!S.)
   ))
   :qid internal_vstd__map__Map<int./$__2<allocator_global__./test_crate!S.>.>_has_type_always_definition
   :skolemid skolem_internal_vstd__map__Map<int./$__2<allocator_global__./test_crate!S.>.>_has_type_always_definition
)))
(assert
...
(assert
 (forall ((x test_crate!S.)) (!
   (=>
    (is-test_crate!S./S x)
    (height_lt (height (Poly%vstd!map.Map<int./$%2<allocator_global%./test_crate!S.>.>.
       (test_crate!S./S/x x)
      )
     ) (height (Poly%test_crate!S. x))
   ))
   :pattern ((height (Poly%vstd!map.Map<int./$%2<allocator_global%./test_crate!S.>.>. (
       test_crate!S./S/x x
   ))))
...
(assert
 (forall ((x test_crate!S.)) (!
   (=>
    (is-test_crate!S./S x)
    (height_lt (height (fun_from_recursive_field (Poly%vstd!map.Map<int./$%2<allocator_global%./test_crate!S.>.>.
        (test_crate!S./S/x x)
      ))
     ) (height (Poly%test_crate!S. x))
   ))
   :pattern ((height (fun_from_recursive_field (Poly%vstd!map.Map<int./$%2<allocator_global%./test_crate!S.>.>.
       (test_crate!S./S/x x)
   ))))
   :qid prelude_datatype_height_test_crate!S./S/x
   :skolemid skolem_prelude_datatype_height_test_crate!S./S/x
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/recursion-323c2b72cefe3aab-decrease_through_map/test.rs:21:6: 21:23 (#0)
 ...
 (assert
  (not (=>
    ...
    (or
     (and
      (=>
       (vstd!set.impl&%0.contains.? $ INT (vstd!map.impl&%0.dom.? $ INT (BOX $ ALLOCATOR_GLOBAL
          $
         ) TYPE%test_crate!S. (Poly%vstd!map.Map<int./$%2<allocator_global%./test_crate!S.>.>.
          (test_crate!S./S/x (%Poly%test_crate!S. s!))
         )
        ) (I 3)
       )
       (=>
        (= tmp%2 (vstd!map.impl&%0.index.? $ INT (BOX $ ALLOCATOR_GLOBAL $) TYPE%test_crate!S.
          (Poly%vstd!map.Map<int./$%2<allocator_global%./test_crate!S.>.>. (test_crate!S./S/x
            (%Poly%test_crate!S. s!)
           )
          ) (I 3)
        ))
        (and
         ...
         (=>
          (= tmp%1 (test_crate!f.? (vstd!map.impl&%0.index.? $ INT (BOX $ ALLOCATOR_GLOBAL $)
             TYPE%test_crate!S. (Poly%vstd!map.Map<int./$%2<allocator_global%./test_crate!S.>.>.
              (test_crate!S./S/x (%Poly%test_crate!S. s!))
             ) (I 3)
          )))
      ...
      (=>
       (not (vstd!set.impl&%0.contains.? $ INT (vstd!map.impl&%0.dom.? $ INT (BOX $ ALLOCATOR_GLOBAL
           $
          ) TYPE%test_crate!S. (Poly%vstd!map.Map<int./$%2<allocator_global%./test_crate!S.>.>.
           (test_crate!S./S/x (%Poly%test_crate!S. s!))
          )
 ...
 (forall ((s! Poly) (fuel% Fuel)) (!
   (=>
    ...
    (= (test_crate!rec%f.? s! (succ fuel%)) (ite
      ...
      (test_crate!rec%f.? (vstd!map.impl&%0.index.? $ INT (BOX $ ALLOCATOR_GLOBAL $) TYPE%test_crate!S.
        (Poly%vstd!map.Map<int./$%2<allocator_global%./test_crate!S.>.>. (test_crate!S./S/x
          (%Poly%test_crate!S. s!)
         )
        ) (I 3)
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/recursion-323c2b72cefe3aab-decrease_through_map/test.rs:31:7: 31:17 (#0)
(get-info :all-statistics)
(push)
    ...
    (or
     (and
      (=>
       ...
       (=>
        (= tmp%1 (%Poly%test_crate!S. (vstd!map.impl&%0.index.? $ INT (BOX $ ALLOCATOR_GLOBAL
            $
           ) TYPE%test_crate!S. (Poly%vstd!map.Map<int./$%2<allocator_global%./test_crate!S.>.>.
            (test_crate!S./S/x (%Poly%test_crate!S. (Poly%test_crate!S. s!)))
           ) (I 3)
  ...
  (not (or
    (and
     (=>
      ...
      (=>
       (= tmp%2 (Poly%vstd!map.Map<int./$%2<allocator_global%./test_crate!S.>.>. (test_crate!S./S/x
          (%Poly%test_crate!S. (Poly%test_crate!S. s!))
       )))
       (=>
        %%location_label%%0
        (req%vstd!map.impl&%0.spec_index. $ INT (BOX $ ALLOCATOR_GLOBAL $) TYPE%test_crate!S.
         tmp%2 (I 3)
     ))))
     (=>
      (not (vstd!set.impl&%0.contains.? $ INT (vstd!map.impl&%0.dom.? $ INT (BOX $ ALLOCATOR_GLOBAL
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/recursion-323c2b72cefe3aab-decrease_through_map/test.rs:40:7: 40:17 (#0)
(get-info :all-statistics)
(push)
 (declare-const s! test_crate!S.)
 (declare-const tmp%1 test_crate!S.)
