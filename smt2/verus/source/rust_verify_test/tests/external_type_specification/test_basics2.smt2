...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/external_type_specification-fcf9a85748f2cc6d-test_basics2/test.rs:27:1: 27:10 (#0)
...
(push)
 ...
 (declare-const x@ Int)
 (declare-const ss@ core!ops.range.Range.)
 (declare-const se@ core!option.Option.)
 (assert
  fuel_defaults
 )
 ...
 (assert
  (not (=>
    (= ss@ (core!ops.range.Range./Range (I 5) (I 7)))
    (=>
     (= tmp%1 (= (%I (core!ops.range.Range./Range/start (%Poly%core!ops.range.Range. (Poly%core!ops.range.Range.
           ss@
        )))
       ) 5
     ))
     (and
      ...
      (=>
       tmp%1
       (=>
        (= se@ (core!option.Option./Some (I 5)))
        (or
         (and
          (=>
           (is-core!option.Option./Some se@)
           (=>
          ...
          (=>
           (not (is-core!option.Option./Some se@))
           (=>
            %%location_label%%2
            false
         )))
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/external_type_specification-fcf9a85748f2cc6d-test_basics2/test.rs:38:1: 38:59 (#0)
(get-info :all-statistics)
(push)
 (declare-const y! core!time.Duration.)
 (declare-const z! core!time.Duration.)
 (declare-const tmp%1 Bool)
 (assert
  fuel_defaults
 )
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/external_type_specification-fcf9a85748f2cc6d-test_basics2/test.rs:42:1: 42:11 (#0)
(get-info :all-statistics)
(push)
 (declare-const no%param Int)
 (declare-const tmp%1 Bool)
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/external_type_specification-fcf9a85748f2cc6d-test_basics2/test.rs:47:1: 47:11 (#0)
(get-info :all-statistics)
(push)
 (declare-const no%param Int)
 (declare-const x@ Int)
