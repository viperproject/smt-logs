...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/loops_no_spinoff-c00882ddee9f0402-for_loop2/test.rs:16:1: 16:15 (#0)
 ...
 (assert
  (not (=>
    ...
    (=>
     (= end@0 10)
     (=>
      (= tmp%2 (core!ops.range.Range./Range (I 0) (I end@0)))
      (=>
            ...
            (=>
             ...
             (%B (vstd!pervasive.ForLoopGhostIterator.ghost_invariant.? $ (TYPE%vstd!std_specs.range.RangeGhostIterator.
                ...
                (core!option.Option./Some (vstd!pervasive.ForLoopGhostIteratorNew.ghost_iter.? $ (TYPE%core!ops.range.Range.
                   ...
                   (Poly%core!ops.range.Range. (core!ops.range.Range./Range (I 0) (I end@0)))
            )))))))
            (and
             (=>
              %%location_label%%2
                    ...
                    (=>
                     ...
                     (=>
                      ...
                      (=>
                       ...
                       (=>
                        (ens%core!iter.range.impl&%6.next. $ (SINT 32) VERUS_exec_iter@1 VERUS_exec_iter@2
                         tmp%%$1@
                        )
                        (or
                         (and
                                       ...
                                       (and
                                        (=>
                                         ...
                                         (let
                                          ...
                                          (= n@2 (Mul (%I (vstd!std_specs.range.RangeGhostIterator./RangeGhostIterator/cur (%Poly%vstd!std_specs.range.RangeGhostIterator.
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/loops_no_spinoff-c00882ddee9f0402-for_loop2/test.rs:32:1: 32:20 (#0)
(get-info :all-statistics)
(push)
 (declare-const no%param Int)
 (declare-const tmp%1 Poly)
...
;; Function-Def test_crate::non_spec
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/loops_no_spinoff-c00882ddee9f0402-for_loop2/test.rs:48:1: 48:14 (#0)
(get-info :all-statistics)
(push)
 (declare-const no%param Int)
 (assert
...
;; Function-Def test_crate::test_loop_modes_transient_state
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/loops_no_spinoff-c00882ddee9f0402-for_loop2/test.rs:50:1: 50:37 (#0)
(get-info :all-statistics)
(push)
 (declare-const no%param Int)
 (declare-const z@ Int)
  ...
  (not (=>
    ...
    (=>
     ...
     (=>
      (= z@ end@0)
      (=>
       (= tmp%2 (core!ops.range.Range./Range (I 0) (I z@)))
       (=>
        (ens%core!iter.traits.collect.impl&%1.into_iter. $ (TYPE%core!ops.range.Range. $ (SINT
           32
          )
