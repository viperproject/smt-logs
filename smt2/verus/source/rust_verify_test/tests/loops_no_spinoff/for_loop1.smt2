...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/loops_no_spinoff-c00882ddee9f0402-for_loop1/test.rs:16:1: 16:15 (#0)
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/loops_no_spinoff-c00882ddee9f0402-for_loop1/test.rs:29:1: 29:20 (#0)
(get-info :all-statistics)
(push)
 (declare-const no%param Int)
 (declare-const tmp%1 Poly)
 ...
 (declare-const VERUS_loop_next@2 Int)
 (declare-const n@2 Int)
 (declare-const VERUS_ghost_iter@3 vstd!std_specs.range.RangeGhostIterator.)
 (declare-const %%break_label%%break_label%0 Bool)
 (declare-const %%switch_label%%0 Bool)
 ;; invariant not satisfied before loop
 (declare-const %%location_label%%0 Bool)
                      ...
                      (and
                       ...
                       (=>
                        ...
                        (=>
                         (= VERUS_loop_next@2 VERUS_loop_next@1)
                         (=>
                          (= VERUS_ghost_iter@3 VERUS_ghost_iter@2)
                          (=>
                           (= n@2 n@1)
                           %%break_label%%break_label%0
                      )))))
                           ...
                           (and
                            ...
                            (=>
                             ...
                             (=>
                              (= tmp%%$2@ tuple%0./tuple%0)
                              (=>
                               (= VERUS_ghost_iter@3 (%Poly%vstd!std_specs.range.RangeGhostIterator. (vstd!pervasive.ForLoopGhostIterator.ghost_advance.?
                                  $ (TYPE%vstd!std_specs.range.RangeGhostIterator. $ (SINT 32)) (Poly%vstd!std_specs.range.RangeGhostIterator.
                                   VERUS_ghost_iter@2
                                  ) (Poly%core!ops.range.Range. VERUS_exec_iter@2)
                               )))
                               (and
                                (=>
                                 ...
                                 (%B (vstd!pervasive.ForLoopGhostIterator.exec_invariant.? $ (TYPE%vstd!std_specs.range.RangeGhostIterator.
                                    $ (SINT 32)
                                   ) (Poly%vstd!std_specs.range.RangeGhostIterator. VERUS_ghost_iter@3) (Poly%core!ops.range.Range.
                                    VERUS_exec_iter@2
                                ))))
                                (and
                                 (=>
                                  ...
                                  (%B (vstd!pervasive.ForLoopGhostIterator.ghost_invariant.? $ (TYPE%vstd!std_specs.range.RangeGhostIterator.
                                     $ (SINT 32)
                                    ) (Poly%vstd!std_specs.range.RangeGhostIterator. VERUS_ghost_iter@3) (Poly%core!option.Option.
                                     (core!option.Option./Some (vstd!pervasive.ForLoopGhostIteratorNew.ghost_iter.? $ (TYPE%core!ops.range.Range.
                                        $ (SINT 32)
                                       ) (vstd!std_specs.core.iter_into_iter_spec.? $ (TYPE%core!ops.range.Range. $ (SINT 32))
                                        (Poly%core!ops.range.Range. (core!ops.range.Range./Range (I 0) (I 10)))
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/loops_no_spinoff-c00882ddee9f0402-for_loop1/test.rs:41:1: 41:20 (#0)
(get-info :all-statistics)
(push)
 (declare-const no%param Int)
 (declare-const tmp%1 Poly)
