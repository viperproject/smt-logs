...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/loops_no_spinoff-c00882ddee9f0402-for_loop3/test.rs:16:1: 16:37 (#0)
...
(push)
 ...
 (declare-const VERUS_exec_iter@2 core!ops.range.Range.)
 (declare-const VERUS_loop_next@2 Int)
 (declare-const v@2 alloc!vec.Vec<u32./allocator_global%.>.)
 (declare-const iter@3 vstd!std_specs.range.RangeGhostIterator.)
                ...
                (=>
                 ...
                 (=>
                  ...
                  (=>
                   ...
                   (=>
                    (has_type (Poly%core!ops.range.Range. VERUS_exec_iter@2) (TYPE%core!ops.range.Range.
                      $ (UINT 32)
                    ))
                    (=>
                     (ens%core!iter.range.impl&%6.next. $ (UINT 32) VERUS_exec_iter@1 VERUS_exec_iter@2
                      tmp%%$1@
                     )
                     (or
                      (and
                       ...
                       (=>
                        ...
                        (=>
                         (ens%alloc!vec.impl&%1.push. $ (UINT 32) $ ALLOCATOR_GLOBAL (Poly%alloc!vec.Vec<u32./allocator_global%.>.
                           v@1
                          ) (Poly%alloc!vec.Vec<u32./allocator_global%.>. v@2) (I i@)
                         )
                         (=>
                          (= tmp%%$2@ tuple%0./tuple%0)
                          (=>
                           (= iter@3 (%Poly%vstd!std_specs.range.RangeGhostIterator. (vstd!pervasive.ForLoopGhostIterator.ghost_advance.?
                              $ (TYPE%vstd!std_specs.range.RangeGhostIterator. $ (UINT 32)) (Poly%vstd!std_specs.range.RangeGhostIterator.
                               iter@2
                              ) (Poly%core!ops.range.Range. VERUS_exec_iter@2)
                           )))
                           (and
                            (=>
                             %%location_label%%5
                             (%B (vstd!pervasive.ForLoopGhostIterator.exec_invariant.? $ (TYPE%vstd!std_specs.range.RangeGhostIterator.
                                $ (UINT 32)
                               ) (Poly%vstd!std_specs.range.RangeGhostIterator. iter@3) (Poly%core!ops.range.Range.
                                VERUS_exec_iter@2
                            ))))
                            (and
                             (=>
                              ...
                              (%B (vstd!pervasive.ForLoopGhostIterator.ghost_invariant.? $ (TYPE%vstd!std_specs.range.RangeGhostIterator.
                                 $ (UINT 32)
                                ) (Poly%vstd!std_specs.range.RangeGhostIterator. iter@3) (Poly%core!option.Option.
                                 (core!option.Option./Some (vstd!pervasive.ForLoopGhostIteratorNew.ghost_iter.? $ (TYPE%core!ops.range.Range.
                                    $ (UINT 32)
                                   ) (vstd!std_specs.core.iter_into_iter_spec.? $ (TYPE%core!ops.range.Range. $ (UINT 32))
                                    (Poly%core!ops.range.Range. (core!ops.range.Range./Range (I 0) (I n!)))
                             ...
                             (=>
                              ...
                              (let
                               ...
                               (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 32)) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec.
                                  $ (UINT 32) $ ALLOCATOR_GLOBAL
                                 ) (Poly%alloc!vec.Vec<u32./allocator_global%.>. v@2)
                                ) (vstd!view.View.view.? $ (TYPE%vstd!std_specs.range.RangeGhostIterator. $ (UINT 32))
                                 (Poly%vstd!std_specs.range.RangeGhostIterator. iter@3)
 ))))))))))))))))))))))))))))))))
 (get-info :version)
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/loops_no_spinoff-c00882ddee9f0402-for_loop3/test.rs:32:1: 32:42 (#0)
(get-info :all-statistics)
(push)
 (declare-const v! alloc!vec.Vec<u32./allocator_global%.>.)
 (declare-const n! Int)
                      ...
                      (and
                       ...
                       (=>
                        ...
                        (=>
                         (ens%alloc!vec.impl&%1.push. $ (UINT 32) $ ALLOCATOR_GLOBAL (Poly%alloc!vec.Vec<u32./allocator_global%.>.
                           v@1
                          ) (Poly%alloc!vec.Vec<u32./allocator_global%.>. v@2) (I 0)
                         )
                         (=>
                          (= tmp%%$2@ tuple%0./tuple%0)
                          (=>
