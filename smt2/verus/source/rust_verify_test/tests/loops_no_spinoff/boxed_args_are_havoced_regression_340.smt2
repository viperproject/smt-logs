...
(declare-sort test_crate!Mod.X<u64.>. 0)
...
(declare-fun TYPE%test_crate!Mod.X. (Dcr Type) Type)
...
(declare-fun Poly%test_crate!Mod.X<u64.>. (test_crate!Mod.X<u64.>.) Poly)
(declare-fun %Poly%test_crate!Mod.X<u64.>. (Poly) test_crate!Mod.X<u64.>.)
...
(assert
 (forall ((x test_crate!Mod.X<u64.>.)) (!
   (= x (%Poly%test_crate!Mod.X<u64.>. (Poly%test_crate!Mod.X<u64.>. x)))
   :pattern ((Poly%test_crate!Mod.X<u64.>. x))
   :qid internal_test_crate__Mod__X<u64.>_box_axiom_definition
   :skolemid skolem_internal_test_crate__Mod__X<u64.>_box_axiom_definition
)))
(assert
 (forall ((x Poly)) (!
   (=>
    (has_type x (TYPE%test_crate!Mod.X. $ (UINT 64)))
    (= x (Poly%test_crate!Mod.X<u64.>. (%Poly%test_crate!Mod.X<u64.>. x)))
   )
   :pattern ((has_type x (TYPE%test_crate!Mod.X. $ (UINT 64))))
   :qid internal_test_crate__Mod__X<u64.>_unbox_axiom_definition
   :skolemid skolem_internal_test_crate__Mod__X<u64.>_unbox_axiom_definition
)))
(assert
 (forall ((x test_crate!Mod.X<u64.>.)) (!
   (has_type (Poly%test_crate!Mod.X<u64.>. x) (TYPE%test_crate!Mod.X. $ (UINT 64)))
   :pattern ((has_type (Poly%test_crate!Mod.X<u64.>. x) (TYPE%test_crate!Mod.X. $ (UINT
       64
   ))))
   :qid internal_test_crate__Mod__X<u64.>_has_type_always_definition
   :skolemid skolem_internal_test_crate__Mod__X<u64.>_has_type_always_definition
)))
(assert
...
;; Function-Decl test_crate::Mod::X::view
(declare-fun test_crate!Mod.impl&%0.view.? (Dcr Type Poly) Poly)
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (s! Poly) (a! Poly)) (!
    ...
    :qid user_vstd__seq__axiom_seq_push_len_3
    :skolemid skolem_user_vstd__seq__axiom_seq_push_len_3
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (s! Poly) (a! Poly) (i! Poly)) (!
    ...
    :qid user_vstd__seq__axiom_seq_push_index_same_4
    :skolemid skolem_user_vstd__seq__axiom_seq_push_index_same_4
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (s! Poly) (a! Poly) (i! Poly)) (!
    ...
    :pattern ((vstd!seq.Seq.index.? A&. A& (vstd!seq.Seq.push.? A&. A& s! a!) i!))
    :qid user_vstd__seq__axiom_seq_push_index_different_5
    :skolemid skolem_user_vstd__seq__axiom_seq_push_index_different_5
))))
...
;; Function-Axioms test_crate::Mod::X::view
(assert
 (forall ((T&. Dcr) (T& Type) (self! Poly)) (!
   (=>
    (has_type self! (TYPE%test_crate!Mod.X. T&. T&))
    (has_type (test_crate!Mod.impl&%0.view.? T&. T& self!) T&)
   )
   :pattern ((test_crate!Mod.impl&%0.view.? T&. T& self!))
   :qid internal_test_crate!Mod.impl&__0.view.?_pre_post_definition
   :skolemid skolem_internal_test_crate!Mod.impl&__0.view.?_pre_post_definition
)))
...
;; Function-Specs test_crate::Mod::X::new
(declare-fun ens%test_crate!Mod.impl&%0.new. (Dcr Type Poly Poly) Bool)
(assert
 (forall ((T&. Dcr) (T& Type) (t! Poly) (s! Poly)) (!
   (= (ens%test_crate!Mod.impl&%0.new. T&. T& t! s!) (and
     (has_type s! (TYPE%test_crate!Mod.X. T&. T&))
     (= (test_crate!Mod.impl&%0.view.? T&. T& s!) t!)
   ))
   :pattern ((ens%test_crate!Mod.impl&%0.new. T&. T& t! s!))
   :qid internal_ens__test_crate!Mod.impl&__0.new._definition
   :skolemid skolem_internal_ens__test_crate!Mod.impl&__0.new._definition
)))

;; Function-Specs test_crate::Mod::X::some_mutator
(declare-fun ens%test_crate!Mod.impl&%0.some_mutator. (Dcr Type Poly Poly) Bool)
(assert
 (forall ((T&. Dcr) (T& Type) (pre%self! Poly) (self! Poly)) (!
   (= (ens%test_crate!Mod.impl&%0.some_mutator. T&. T& pre%self! self!) (has_type self!
     (TYPE%test_crate!Mod.X. T&. T&)
   ))
   :pattern ((ens%test_crate!Mod.impl&%0.some_mutator. T&. T& pre%self! self!))
   :qid internal_ens__test_crate!Mod.impl&__0.some_mutator._definition
   :skolemid skolem_internal_ens__test_crate!Mod.impl&__0.some_mutator._definition
)))

;; Function-Specs test_crate::Mod::some_mutator
(declare-fun ens%test_crate!Mod.some_mutator. (Dcr Type Poly Poly) Bool)
(assert
 (forall ((T&. Dcr) (T& Type) (pre%x! Poly) (x! Poly)) (!
   (= (ens%test_crate!Mod.some_mutator. T&. T& pre%x! x!) (has_type x! (TYPE%test_crate!Mod.X.
      T&. T&
   )))
   :pattern ((ens%test_crate!Mod.some_mutator. T&. T& pre%x! x!))
   :qid internal_ens__test_crate!Mod.some_mutator._definition
   :skolemid skolem_internal_ens__test_crate!Mod.some_mutator._definition
)))

;; Function-Def test_crate::test1
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/loops_no_spinoff-c00882ddee9f0402-boxed_args_are_havoced_regression_340/test.rs:39:1: 39:11 (#0)
...
(push)
 ...
 (declare-const x@0 test_crate!Mod.X<u64.>.)
 (declare-const i@0 Int)
 (assert
  fuel_defaults
 )
 (declare-const x@1 test_crate!Mod.X<u64.>.)
 (declare-const i@1 Int)
 (declare-const x@2 test_crate!Mod.X<u64.>.)
 ...
 (assert
  (not (=>
    (ens%test_crate!Mod.impl&%0.new. $ (UINT 64) (I 5) tmp%1)
    (=>
     (= x@0 (%Poly%test_crate!Mod.X<u64.>. tmp%1))
     (=>
      (= tmp%2 (= (%I (test_crate!Mod.impl&%0.view.? $ (UINT 64) (Poly%test_crate!Mod.X<u64.>.
           x@0
         ))
        ) 5
      ))
        ...
        (=>
         ...
         (or
          (and
           ...
           (=>
            (= tmp%3 (= (%I (test_crate!Mod.impl&%0.view.? $ (UINT 64) (Poly%test_crate!Mod.X<u64.>.
                 x@2
               ))
              ) 5
            ))
          ...
          (=>
           ...
           (or
            ...
            (and
             (not %%switch_label%%0)
             (=>
              (ens%test_crate!Mod.impl&%0.some_mutator. $ (UINT 64) (Poly%test_crate!Mod.X<u64.>.
                x@1
               ) (Poly%test_crate!Mod.X<u64.>. x@2)
              )
              (=>
               %%location_label%%2
               (iInv 32 (Add i@1 1))
...
;; Function-Recommends test_crate::test1
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/loops_no_spinoff-c00882ddee9f0402-boxed_args_are_havoced_regression_340/test.rs:39:1: 39:11 (#0)
(get-info :all-statistics)
(push)
 (declare-const no%param Int)
 ...
 (assert
  (not (=>
    ...
    (=>
     (= x@0 (%Poly%test_crate!Mod.X<u64.>. tmp%1))
     (=>
      (= (%I (test_crate!Mod.impl&%0.view.? $ (UINT 64) (Poly%test_crate!Mod.X<u64.>. x@0)))
       5
      )
      (=>
       (= i@0 0)
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/loops_no_spinoff-c00882ddee9f0402-boxed_args_are_havoced_regression_340/test.rs:54:1: 54:11 (#0)
(get-info :all-statistics)
(push)
 (declare-const no%param Int)
 (declare-const tmp%1 Poly)
          ...
          (=>
           ...
           (or
            ...
            (and
             (not %%switch_label%%0)
             (=>
              (ens%test_crate!Mod.some_mutator. $ (UINT 64) (Poly%test_crate!Mod.X<u64.>. x@1) (
                Poly%test_crate!Mod.X<u64.>. x@2
              ))
              (=>
               %%location_label%%2
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/loops_no_spinoff-c00882ddee9f0402-boxed_args_are_havoced_regression_340/test.rs:69:1: 69:11 (#0)
(get-info :all-statistics)
(push)
 (declare-const no%param Int)
 (declare-const tmp%1 Poly)
      ...
      (and
       (=>
        ...
        (= (vstd!seq.Seq.len.? $ (UINT 64) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT
           ...
           ) (Poly%alloc!vec.Vec<u64./allocator_global%.>. v@0)
          )
         ) i@0
       ))
       (or
        (and
         (not %%break_label%%break_label%0)
         (=>
          (= tmp%2 (= (vstd!seq.Seq.len.? $ (UINT 64) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec.
               $ (UINT 64) $ ALLOCATOR_GLOBAL
              ) (Poly%alloc!vec.Vec<u64./allocator_global%.>. v@2)
             )
            ) 0
          ))
          (=>
        ...
        (=>
         ...
         (=>
          (= (vstd!seq.Seq.len.? $ (UINT 64) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT
             ...
             ) (Poly%alloc!vec.Vec<u64./allocator_global%.>. v@1)
            )
           ) i@1
          )
          (or
           ...
           (and
            ...
            (=>
             (ens%alloc!vec.impl&%1.push. $ (UINT 64) $ ALLOCATOR_GLOBAL (Poly%alloc!vec.Vec<u64./allocator_global%.>.
               v@1
              ) (Poly%alloc!vec.Vec<u64./allocator_global%.>. v@2) (I 7)
             )
             (and
              (=>
               %%location_label%%2
