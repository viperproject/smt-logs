...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/ext_equal-1201012c76859bc3-test_seq/test.rs:16:7: 16:40 (#0)
    ...
    (=>
     ...
     (=>
      (= (vstd!seq.Seq.index.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. s1!) (I 0)) (vstd!seq.Seq.index.?
        $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. s2!) (I 0)
      ))
      (=>
       (= tmp%1 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<u8.>. s1!)
...
;; Function-Def test_crate::test_auto_ext_equal_in_assert
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/ext_equal-1201012c76859bc3-test_seq/test.rs:23:7: 23:65 (#0)
(get-info :all-statistics)
(push)
 (declare-const s1! vstd!seq.Seq<u8.>.)
 (declare-const s2! vstd!seq.Seq<u8.>.)
 ...
 (assert
  (not (=>
    (= tmp%1 (=>
      ...
      (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<u8.>. s1!) (Poly%vstd!seq.Seq<u8.>.
        s2!
    ))))
    (=>
     %%location_label%%0
...
;; Function-Specs test_crate::test_no_auto_ext_equal_in_ensures
(declare-fun ens%test_crate!test_no_auto_ext_equal_in_ensures. (vstd!seq.Seq<u8.>.
  vstd!seq.Seq<u8.>.
 ) Bool
)
(assert
 (forall ((s1! vstd!seq.Seq<u8.>.) (s2! vstd!seq.Seq<u8.>.)) (!
   (= (ens%test_crate!test_no_auto_ext_equal_in_ensures. s1! s2!) (=>
     (and
      (and
       (= (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. s1!)) 1)
       (= (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. s2!)) 1)
   ...
   :pattern ((ens%test_crate!test_no_auto_ext_equal_in_ensures. s1! s2!))
   :qid internal_ens__test_crate!test_no_auto_ext_equal_in_ensures._definition
   :skolemid skolem_internal_ens__test_crate!test_no_auto_ext_equal_in_ensures._definition
)))

;; Function-Def test_crate::test_no_auto_ext_equal_in_ensures
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/ext_equal-1201012c76859bc3-test_seq/test.rs:27:7: 27:69 (#0)
(get-info :all-statistics)
(push)
 (declare-const s1! vstd!seq.Seq<u8.>.)
 (declare-const s2! vstd!seq.Seq<u8.>.)
...
;; Function-Recommends test_crate::test_no_auto_ext_equal_in_ensures
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/ext_equal-1201012c76859bc3-test_seq/test.rs:27:7: 27:69 (#0)
(get-info :all-statistics)
(push)
 (declare-const s1! vstd!seq.Seq<u8.>.)
    ...
    (and
     (=>
      ...
      (and
       (=>
        %%location_label%%0
        (req%vstd!seq.impl&%0.spec_index. $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. s1!) (I 0))
       )
       (=>
        (= tmp%1 (vstd!seq.Seq.index.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. s1!) (I 0)))
        (and
         (=>
          %%location_label%%1
          (req%vstd!seq.impl&%0.spec_index. $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. s2!) (I 0))
         )
         (=>
          (= tmp%2 (vstd!seq.Seq.index.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. s2!) (I 0)))
          (=>
           (= tmp%3 (= tmp%1 tmp%2))
           %%switch_label%%0
     ))))))
