...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/ext_equal-1201012c76859bc3-test_seq_not_deep/test.rs:16:7: 16:50 (#0)
     ...
     (=>
      ...
      (=>
       ...
       (=>
        ...
        (=>
         (= tmp%1 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (vstd!seq.Seq.index.? $ (TYPE%vstd!seq.Seq.
             $ (UINT 8)
            ) (Poly%vstd!seq.Seq<vstd!seq.Seq<u8.>.>. s1!) (I 0)
           ) (vstd!seq.Seq.index.? $ (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<vstd!seq.Seq<u8.>.>.
             s2!
            ) (I 0)
         )))
         (and
          ...
          (=>
           tmp%1
           (=>
            (= tmp%2 (ext_eq false (TYPE%vstd!seq.Seq. $ (TYPE%vstd!seq.Seq. $ (UINT 8))) (Poly%vstd!seq.Seq<vstd!seq.Seq<u8.>.>.
               s1!
