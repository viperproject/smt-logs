...
(assert
 (distinct fuel%vstd!seq.impl&%0.spec_index. fuel%vstd!seq.axiom_seq_index_decreases.
  fuel%vstd!seq.axiom_seq_ext_equal. fuel%vstd!seq.axiom_seq_ext_equal_deep. fuel%vstd!array.group_array_axioms.
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/ext_equal-1201012c76859bc3-test_seq_not_deep_fails/test.rs:16:7: 16:50 (#0)
(get-info :all-statistics)
(push)
 (declare-const s1! vstd!seq.Seq<vstd!seq.Seq<u8.>.>.)
 (declare-const s2! vstd!seq.Seq<vstd!seq.Seq<u8.>.>.)
 ...
 (assert
  (not (=>
    (= (vstd!seq.Seq.len.? $ (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<vstd!seq.Seq<u8.>.>.
       s1!
      )
     ) 1
    )
    (=>
     ...
     (=>
      (= (vstd!seq.Seq.len.? $ (UINT 8) (vstd!seq.Seq.index.? $ (TYPE%vstd!seq.Seq. $ (UINT
           8
          )
         ) (Poly%vstd!seq.Seq<vstd!seq.Seq<u8.>.>. s1!) (I 0)
        )
       ) 1
      )
      (=>
       (= (vstd!seq.Seq.len.? $ (UINT 8) (vstd!seq.Seq.index.? $ (TYPE%vstd!seq.Seq. $ (UINT
          ...
          ) (Poly%vstd!seq.Seq<vstd!seq.Seq<u8.>.>. s2!) (I 0)
         )
        ) 1
       )
       (=>
        (= (vstd!seq.Seq.index.? $ (UINT 8) (vstd!seq.Seq.index.? $ (TYPE%vstd!seq.Seq. $ (UINT
             8
            )
           ) (Poly%vstd!seq.Seq<vstd!seq.Seq<u8.>.>. s1!) (I 0)
          ) (I 0)
        ...
        (=>
         (= tmp%1 (ext_eq false (TYPE%vstd!seq.Seq. $ (TYPE%vstd!seq.Seq. $ (UINT 8))) (Poly%vstd!seq.Seq<vstd!seq.Seq<u8.>.>.
            s1!
           ) (Poly%vstd!seq.Seq<vstd!seq.Seq<u8.>.>. s2!)
         ))
         (=>
          %%location_label%%0
          tmp%1
