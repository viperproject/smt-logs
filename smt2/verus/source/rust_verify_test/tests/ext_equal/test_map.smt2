...
;; Datatypes
(declare-sort vstd!map.Map<u8./bool.>. 0)
(declare-sort vstd!set.Set<u8.>. 0)
(declare-datatypes ((tuple%0. 0)) (((tuple%0./tuple%0))))
(declare-fun TYPE%vstd!map.Map. (Dcr Type Dcr Type) Type)
(declare-fun TYPE%vstd!set.Set. (Dcr Type) Type)
(declare-const TYPE%tuple%0. Type)
(declare-fun Poly%vstd!map.Map<u8./bool.>. (vstd!map.Map<u8./bool.>.) Poly)
(declare-fun %Poly%vstd!map.Map<u8./bool.>. (Poly) vstd!map.Map<u8./bool.>.)
(declare-fun Poly%vstd!set.Set<u8.>. (vstd!set.Set<u8.>.) Poly)
(declare-fun %Poly%vstd!set.Set<u8.>. (Poly) vstd!set.Set<u8.>.)
(declare-fun Poly%tuple%0. (tuple%0.) Poly)
(declare-fun %Poly%tuple%0. (Poly) tuple%0.)
(assert
 (forall ((x vstd!map.Map<u8./bool.>.)) (!
   (= x (%Poly%vstd!map.Map<u8./bool.>. (Poly%vstd!map.Map<u8./bool.>. x)))
   :pattern ((Poly%vstd!map.Map<u8./bool.>. x))
   :qid internal_vstd__map__Map<u8./bool.>_box_axiom_definition
   :skolemid skolem_internal_vstd__map__Map<u8./bool.>_box_axiom_definition
)))
(assert
 (forall ((x Poly)) (!
   (=>
    (has_type x (TYPE%vstd!map.Map. $ (UINT 8) $ BOOL))
    (= x (Poly%vstd!map.Map<u8./bool.>. (%Poly%vstd!map.Map<u8./bool.>. x)))
   )
   :pattern ((has_type x (TYPE%vstd!map.Map. $ (UINT 8) $ BOOL)))
   :qid internal_vstd__map__Map<u8./bool.>_unbox_axiom_definition
   :skolemid skolem_internal_vstd__map__Map<u8./bool.>_unbox_axiom_definition
)))
(assert
 (forall ((x vstd!map.Map<u8./bool.>.)) (!
   (has_type (Poly%vstd!map.Map<u8./bool.>. x) (TYPE%vstd!map.Map. $ (UINT 8) $ BOOL))
   :pattern ((has_type (Poly%vstd!map.Map<u8./bool.>. x) (TYPE%vstd!map.Map. $ (UINT 8)
      $ BOOL
   )))
   :qid internal_vstd__map__Map<u8./bool.>_has_type_always_definition
   :skolemid skolem_internal_vstd__map__Map<u8./bool.>_has_type_always_definition
)))
(assert
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/ext_equal-1201012c76859bc3-test_map/test.rs:16:7: 16:52 (#0)
(get-info :all-statistics)
(push)
 (declare-const m1! vstd!map.Map<u8./bool.>.)
 (declare-const m2! vstd!map.Map<u8./bool.>.)
  ...
  (not (=>
    (forall ((i$ Poly)) (!
      (=>
       ...
       (=>
        (<= 1 (%I i$))
        (not (vstd!set.impl&%0.contains.? $ (UINT 8) (vstd!map.impl&%0.dom.? $ (UINT 8) $ BOOL
           (Poly%vstd!map.Map<u8./bool.>. m1!)
          ) i$
      ))))
      :pattern ((vstd!set.impl&%0.contains.? $ (UINT 8) (vstd!map.impl&%0.dom.? $ (UINT 8)
         $ BOOL (Poly%vstd!map.Map<u8./bool.>. m1!)
        ) i$
      ))
      :qid user_test_crate__test_9
      :skolemid skolem_user_test_crate__test_9
    ))
    (=>
     (forall ((i$ Poly)) (!
       (=>
        ...
        (=>
         (<= 1 (%I i$))
         (not (vstd!set.impl&%0.contains.? $ (UINT 8) (vstd!map.impl&%0.dom.? $ (UINT 8) $ BOOL
            (Poly%vstd!map.Map<u8./bool.>. m2!)
           ) i$
       ))))
       :pattern ((vstd!set.impl&%0.contains.? $ (UINT 8) (vstd!map.impl&%0.dom.? $ (UINT 8)
          $ BOOL (Poly%vstd!map.Map<u8./bool.>. m2!)
         ) i$
       ))
     ...
     (=>
      (vstd!set.impl&%0.contains.? $ (UINT 8) (vstd!map.impl&%0.dom.? $ (UINT 8) $ BOOL (
         Poly%vstd!map.Map<u8./bool.>. m1!
        )
       ) (I 0)
      )
      (=>
       ...
       (=>
        (= (vstd!map.impl&%0.index.? $ (UINT 8) $ BOOL (Poly%vstd!map.Map<u8./bool.>. m1!)
          (I 0)
         ) (vstd!map.impl&%0.index.? $ (UINT 8) $ BOOL (Poly%vstd!map.Map<u8./bool.>. m2!)
          (I 0)
        ))
        (=>
         (= tmp%1 (ext_eq false (TYPE%vstd!map.Map. $ (UINT 8) $ BOOL) (Poly%vstd!map.Map<u8./bool.>.
            m1!
           ) (Poly%vstd!map.Map<u8./bool.>. m2!)
         ))
         (=>
