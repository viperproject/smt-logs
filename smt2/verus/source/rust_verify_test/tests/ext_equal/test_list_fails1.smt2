...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/ext_equal-1201012c76859bc3-test_list_fails1/test.rs:18:7: 18:71 (#0)
        ...
        (=>
         ...
         (=>
          ...
          (=>
           ...
           (=>
            (= tmp%1 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<u8.>. s2!)
              (Poly%vstd!seq.Seq<u8.>. s4!)
            ))
            (and
             (=>
             ...
             (=>
              tmp%1
              (=>
               (= tmp%2 (ext_eq false TYPE%test_crate!List. (Poly%test_crate!List. x@) (Poly%test_crate!List.
                  y@
               )))
               (=>
                %%location_label%%1
