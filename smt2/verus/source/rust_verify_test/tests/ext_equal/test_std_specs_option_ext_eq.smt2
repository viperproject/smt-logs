...
(assert
 (distinct fuel%vstd!std_specs.option.impl&%0.is_Some. fuel%vstd!std_specs.option.impl&%0.get_Some_0.
  ...
  fuel%vstd!seq.axiom_seq_ext_equal_deep. fuel%vstd!array.group_array_axioms. fuel%vstd!map.group_map_axioms.
...
(declare-fun req%test_crate!test. (core!option.Option. core!option.Option.) Bool)
(declare-const %%global_location_label%%2 Bool)
(declare-const %%global_location_label%%3 Bool)
(assert
 (forall ((a! core!option.Option.) (b! core!option.Option.)) (!
   (= (req%test_crate!test. a! b!) (and
     (=>
      %%global_location_label%%2
      (= (is-core!option.Option./Some a!) (is-core!option.Option./Some b!))
     )
     (=>
       ...
       (and
        (and
         (and
          (and
           (and
            (= (vstd!seq.Seq.len.? $ INT (core!option.Option./Some/0 (%Poly%core!option.Option. (
           ...
           (= (%I (vstd!seq.Seq.index.? $ INT (core!option.Option./Some/0 (%Poly%core!option.Option.
                (Poly%core!option.Option. a!)
               )
              ) (I 0)
             )
   ...
   :pattern ((req%test_crate!test. a! b!))
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/ext_equal-1201012c76859bc3-test_std_specs_option_ext_eq/test.rs:16:7: 16:84 (#0)
(get-info :all-statistics)
(push)
 (declare-const a! core!option.Option.)
 ...
 (assert
  (has_type (Poly%core!option.Option. a!) (TYPE%core!option.Option. $ (TYPE%vstd!seq.Seq.
     $ INT
 ))))
 (assert
  (has_type (Poly%core!option.Option. b!) (TYPE%core!option.Option. $ (TYPE%vstd!seq.Seq.
     $ INT
 ))))
 (assert
  (= (is-core!option.Option./Some a!) (is-core!option.Option./Some b!))
 ...
 (assert
  (not (=>
    (= tmp%1 (ext_eq false (TYPE%core!option.Option. $ (TYPE%vstd!seq.Seq. $ INT)) (Poly%core!option.Option.
       a!
      ) (Poly%core!option.Option. b!)
    ))
    (=>
