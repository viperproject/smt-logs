...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/ext_equal-1201012c76859bc3-test_seq_deep_fails1/test.rs:16:7: 16:50 (#0)
    ...
    (=>
     ...
     (=>
      ...
      (=>
       ...
       (=>
        (= tmp%1 (ext_eq true (TYPE%vstd!seq.Seq. $ (TYPE%vstd!seq.Seq. $ (UINT 8))) (Poly%vstd!seq.Seq<vstd!seq.Seq<u8.>.>.
           s1!
