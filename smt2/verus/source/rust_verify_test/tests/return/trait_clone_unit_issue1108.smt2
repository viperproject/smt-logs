...
(declare-fun tr_bound%test_crate!PolyfillClone. (Dcr Type) Bool)
(assert
...
(assert
 (forall ((Self%&. Dcr) (Self%& Type)) (!
   (=>
    (tr_bound%test_crate!PolyfillClone. Self%&. Self%&)
    (tr_bound%vstd!view.View. Self%&. Self%&)
   )
   :pattern ((tr_bound%test_crate!PolyfillClone. Self%&. Self%&))
   :qid internal_test_crate__PolyfillClone_trait_type_bounds_definition
   :skolemid skolem_internal_test_crate__PolyfillClone_trait_type_bounds_definition
)))
...
;; Function-Specs test_crate::PolyfillClone::clone
(declare-fun ens%test_crate!PolyfillClone.clone. (Dcr Type Poly Poly) Bool)
(assert
 (forall ((Self%&. Dcr) (Self%& Type) (self! Poly) (res! Poly)) (!
   (= (ens%test_crate!PolyfillClone.clone. Self%&. Self%& self! res!) (and
     (has_type res! Self%&)
     (= (vstd!view.View.view.? Self%&. Self%& res!) (vstd!view.View.view.? Self%&. Self%&
       self!
   ))))
   :pattern ((ens%test_crate!PolyfillClone.clone. Self%&. Self%& self! res!))
   :qid internal_ens__test_crate!PolyfillClone.clone._definition
   :skolemid skolem_internal_ens__test_crate!PolyfillClone.clone._definition
)))
...
;; Function-Def test_crate::impl&%0::clone
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/return-24ed1b163e579b78-trait_clone_unit_issue1108/test.rs:25:5: 25:28 (#0)
...
(push)
 ...
 (assert
  (not (=>
    ...
    (=>
     %%location_label%%0
     (= (vstd!view.View.view.? $ TYPE%tuple%0. %return!) (vstd!view.View.view.? $ TYPE%tuple%0.
       self!
 ))))))
 (get-info :version)
...
;; Trait-Impl-Axiom
(assert
 (tr_bound%test_crate!PolyfillClone. $ TYPE%tuple%0.)
)
