...
;; MODULE 'root module'
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/bitvector-4ec8901e1a80eec7-test7/test.rs:17:5: 17:11 (#0)
...
(assert
 (not (=>
   ...
   (=>
    (and
     (= b1! ((_ zero_extend 63) (_ bv1 1)))
     (= b2! b3!)
    )
    (= (bvadd b1! b2!) (bvadd b3! ((_ zero_extend 63) (_ bv1 1))))
))))
(get-info :version)
