...
;; MODULE 'root module'
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/bitvector-4ec8901e1a80eec7-bit_vector_usize_as_32bit/test.rs:43:5: 43:11 (#0)
...
(assert
 (not (=>
   %%location_label%%0
   (= (bvlshr (bvshl ((_ zero_extend 31) (_ bv1 1)) ((_ zero_extend 26) (_ bv35 6))) (
      (_ zero_extend 26) (_ bv34 6)
     )
