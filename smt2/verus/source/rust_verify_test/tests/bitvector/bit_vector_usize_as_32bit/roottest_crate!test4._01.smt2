...
;; MODULE 'root module'
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/bitvector-4ec8901e1a80eec7-bit_vector_usize_as_32bit/test.rs:31:5: 31:11 (#0)
...
(assert
 (not (=>
   %%location_label%%0
   (= ((_ zero_extend 32) (bvnot x!)) (bvnot ((_ zero_extend 32) x!)))
)))
(get-info :version)
