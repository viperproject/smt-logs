...
;; MODULE 'root module'
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/bitvector-4ec8901e1a80eec7-bit_vector_usize_as_64bit/test.rs:26:5: 26:11 (#0)
...
(assert
 (not (=>
   %%location_label%%0
   (= (bvlshr y! ((_ zero_extend 58) (_ bv32 6))) ((_ zero_extend 63) (_ bv0 1)))
)))
(get-info :version)
