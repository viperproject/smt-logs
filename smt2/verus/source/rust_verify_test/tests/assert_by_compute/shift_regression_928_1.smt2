...
;; Function-Decl test_crate::id
(declare-fun test_crate!id.? (Poly) Int)

;; Function-Def test_crate::bar
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/assert_by_compute-161a97ac6c96a80b-shift_regression_928_1/test.rs:17:1: 17:19 (#0)
...
(push)
 ...
 (assert
  (not (=>
    %%location_label%%0
    (= (uClip 64 (bitshr (I 10) (I (uClip 64 (test_crate!id.? (I 5)))))) 0)
 )))
 (get-info :version)
