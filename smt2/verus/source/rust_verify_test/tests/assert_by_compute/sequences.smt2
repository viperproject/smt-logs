...
(declare-const fuel%test_crate!use_seq. FuelId)
(declare-const fuel%test_crate!f. FuelId)
(declare-const fuel%test_crate!g. FuelId)
...
(assert
 (distinct fuel%vstd!array.array_view. fuel%vstd!array.impl&%0.view. fuel%vstd!array.impl&%2.spec_index.
  ...
  fuel%vstd!raw_ptr.ptrs_mut_eq. fuel%vstd!seq.impl&%0.spec_index. fuel%vstd!seq.Seq.last.
  ...
  fuel%vstd!seq.axiom_seq_add_index2. fuel%vstd!view.impl&%0.view. fuel%vstd!view.impl&%2.view.
  ...
  fuel%vstd!view.impl&%42.view. fuel%test_crate!use_seq. fuel%test_crate!f. fuel%test_crate!g.
...
;; Function-Decl test_crate::use_seq
(declare-fun test_crate!use_seq.? (Poly) tuple%2.)

;; Function-Decl test_crate::f
(declare-fun test_crate!f.? (Poly Poly) Int)

;; Function-Decl test_crate::g
(declare-fun test_crate!g.? (Poly Poly) vstd!seq.Seq<int.>.)
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (s! Poly) (i! Poly) (a! Poly)) (!
    ...
    :qid user_vstd__seq__axiom_seq_update_len_11
    :skolemid skolem_user_vstd__seq__axiom_seq_update_len_11
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (s! Poly) (i! Poly) (a! Poly)) (!
    ...
    :qid user_vstd__seq__axiom_seq_update_same_12
    :skolemid skolem_user_vstd__seq__axiom_seq_update_same_12
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (s! Poly) (i1! Poly) (i2! Poly) (a! Poly)) (!
    ...
    :qid user_vstd__seq__axiom_seq_update_different_13
    :skolemid skolem_user_vstd__seq__axiom_seq_update_different_13
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (s! Poly) (j! Poly) (k! Poly)) (!
    ...
    :qid user_vstd__seq__axiom_seq_subrange_len_18
    :skolemid skolem_user_vstd__seq__axiom_seq_subrange_len_18
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (s! Poly) (j! Poly) (k! Poly) (i! Poly)) (!
    ...
    :qid user_vstd__seq__axiom_seq_subrange_index_19
    :skolemid skolem_user_vstd__seq__axiom_seq_subrange_index_19
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (s1! Poly) (s2! Poly)) (!
    ...
    :qid user_vstd__seq__axiom_seq_add_len_20
    :skolemid skolem_user_vstd__seq__axiom_seq_add_len_20
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (s1! Poly) (s2! Poly) (i! Poly)) (!
    ...
    :qid user_vstd__seq__axiom_seq_add_index1_21
    :skolemid skolem_user_vstd__seq__axiom_seq_add_index1_21
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (s1! Poly) (s2! Poly) (i! Poly)) (!
    ...
    :pattern ((vstd!seq.Seq.index.? A&. A& (vstd!seq.Seq.add.? A&. A& s1! s2!) i!))
    :qid user_vstd__seq__axiom_seq_add_index2_22
    :skolemid skolem_user_vstd__seq__axiom_seq_add_index2_22
))))
...
;; Function-Axioms test_crate::use_seq
(assert
 (fuel_bool_default fuel%test_crate!use_seq.)
)
...
(assert
 (=>
  (fuel_bool fuel%test_crate!use_seq.)
  (forall ((s! Poly)) (!
    (= (test_crate!use_seq.? s!) (let
      ((s_new$ (%Poly%vstd!seq.Seq<u32.>. (vstd!seq.Seq.update.? $ (UINT 32) s! (I 1) (I 42)))))
      (let
       ((s_add$ (%Poly%vstd!seq.Seq<u32.>. (vstd!seq.Seq.add.? $ (UINT 32) (vstd!seq.Seq.push.?
            $ (UINT 32) s! (I 13)
           ) (vstd!view.View.view.? $ (ARRAY $ (UINT 32) $ (CONST_INT 3)) (array_new $ (UINT 32)
             3 (%%array%%0 (I 14) (I 15) (I 16))
       ))))))
       (tuple%2./tuple%2 (vstd!seq.Seq.index.? $ (UINT 32) (Poly%vstd!seq.Seq<u32.>. s_new$)
         (I 1)
        ) (vstd!seq.Seq.index.? $ (UINT 32) (Poly%vstd!seq.Seq<u32.>. s_add$) (I 4))
    ))))
    :pattern ((test_crate!use_seq.? s!))
    :qid internal_test_crate!use_seq.?_definition
    :skolemid skolem_internal_test_crate!use_seq.?_definition
))))
(assert
 (forall ((s! Poly)) (!
   (=>
    (has_type s! (TYPE%vstd!seq.Seq. $ (UINT 32)))
    (has_type (Poly%tuple%2. (test_crate!use_seq.? s!)) (TYPE%tuple%2. $ (UINT 32) $ (UINT
       32
   ))))
   :pattern ((test_crate!use_seq.? s!))
   :qid internal_test_crate!use_seq.?_pre_post_definition
   :skolemid skolem_internal_test_crate!use_seq.?_pre_post_definition
)))
...
(assert
 (=>
  ...
  (forall ((s! Poly) (idx! Poly)) (!
    (= (test_crate!f.? s! idx!) (%I (vstd!seq.Seq.index.? $ INT s! idx!)))
    :pattern ((test_crate!f.? s! idx!))
    :qid internal_test_crate!f.?_definition
    :skolemid skolem_internal_test_crate!f.?_definition
))))

;; Function-Axioms test_crate::g
(assert
 (fuel_bool_default fuel%test_crate!g.)
)
(assert
 (=>
  (fuel_bool fuel%test_crate!g.)
  (forall ((a! Poly) (b! Poly)) (!
    (= (test_crate!g.? a! b!) (%Poly%vstd!seq.Seq<int.>. (vstd!seq.Seq.add.? $ INT a! b!)))
    :pattern ((test_crate!g.? a! b!))
    :qid internal_test_crate!g.?_definition
    :skolemid skolem_internal_test_crate!g.?_definition
))))
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/assert_by_compute-161a97ac6c96a80b-sequences/test.rs:18:7: 18:16 (#0)
...
(push)
 ...
 (assert
  (forall ((x$ Poly)) (!
    (= (%%apply%%0 %%lambda%%1 x$) x$)
    :pattern ((%%apply%%0 %%lambda%%1 x$))
 )))
 (declare-fun %%lambda%%2 () %%Function%%)
 (assert
  (forall ((x$ Poly)) (!
    (= (%%apply%%0 %%lambda%%2 x$) (I (Add (%I x$) (%I x$))))
    :pattern ((%%apply%%0 %%lambda%%2 x$))
 )))
 (assert
  (not true)
 )
...
;; Function-Def test_crate::test_seq_modification
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/assert_by_compute-161a97ac6c96a80b-sequences/test.rs:47:1: 47:27 (#0)
(get-info :all-statistics)
(push)
 (declare-const no%param Int)
 (assert
...
;; Function-Def test_crate::test_github_issue_294
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/assert_by_compute-161a97ac6c96a80b-sequences/test.rs:66:7: 66:33 (#0)
(get-info :all-statistics)
(push)
 (declare-const no%param Int)
 ...
 (assert
  (not (=>
    (= x@ (%Poly%vstd!seq.Seq<int.>. (vstd!view.View.view.? $ (ARRAY $ INT $ (CONST_INT 3))
       (array_new $ INT 3 (%%array%%0 (I 1) (I 2) (I 3)))
    )))
    (and
     (=>
      %%location_label%%0
      (= (%I (vstd!seq.Seq.index.? $ INT (Poly%vstd!seq.Seq<int.>. x@) (I 0))) 1)
     )
     (=>
      (= (test_crate!f.? (Poly%vstd!seq.Seq<int.>. x@) (I 0)) 1)
      (=>
       (= y@ (%Poly%vstd!seq.Seq<int.>. (vstd!view.View.view.? $ (ARRAY $ INT $ (CONST_INT 3))
          (array_new $ INT 3 (%%array%%0 (I 4) (I 5) (I 6)))
       )))
       (and
        (=>
         %%location_label%%1
         (= (vstd!seq.Seq.len.? $ INT (vstd!seq.Seq.add.? $ INT (Poly%vstd!seq.Seq<int.>. x@)
            (Poly%vstd!seq.Seq<int.>. y@)
           )
          ) 6
        ))
        (=>
         (= (vstd!seq.Seq.len.? $ INT (Poly%vstd!seq.Seq<int.>. (test_crate!g.? (Poly%vstd!seq.Seq<int.>.
              x@
             ) (Poly%vstd!seq.Seq<int.>. y@)
           ))
          ) 6
         ...
         (and
          (=>
           %%location_label%%2
           (and
            (= (vstd!seq.Seq.len.? $ INT (vstd!seq.Seq.add.? $ INT (vstd!array.array_view.? $ INT
                $ (CONST_INT 3) (array_new $ INT 3 (%%array%%0 (I 7) (I 8) (I 9)))
          ...
          (=>
           (let
            ((z$ (%Poly%vstd!seq.Seq<int.>. (vstd!view.View.view.? $ (ARRAY $ INT $ (CONST_INT 3))
                (array_new $ INT 3 (%%array%%0 (I 7) (I 8) (I 9)))
            ))))
            (and
             (= (vstd!seq.Seq.len.? $ INT (Poly%vstd!seq.Seq<int.>. (test_crate!g.? (Poly%vstd!seq.Seq<int.>.
                  x@
                 ) (Poly%vstd!seq.Seq<int.>. z$)
               ))
              ) 6
             )
             (= (vstd!seq.Seq.len.? $ INT (Poly%vstd!seq.Seq<int.>. (test_crate!g.? (Poly%vstd!seq.Seq<int.>.
           ...
           (and
            (=>
             %%location_label%%3
             (and
              (= y@ (%Poly%vstd!seq.Seq<int.>. (vstd!array.array_view.? $ INT $ (CONST_INT 3) (array_new
                  $ INT 3 (%%array%%0 (I 4) (I 5) (I 6))
              ))))
              (= (%Poly%vstd!seq.Seq<int.>. (vstd!array.array_view.? $ INT $ (CONST_INT 3) (array_new
                  $ INT 3 (%%array%%0 (I 4) (I 5) (I 6))
                ))
               ) y@
            )))
