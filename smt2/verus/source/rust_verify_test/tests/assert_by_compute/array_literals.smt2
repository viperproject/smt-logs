...
(assert
 (distinct fuel%vstd!array.array_view. fuel%vstd!array.impl&%0.view. fuel%vstd!array.impl&%2.spec_index.
  ...
  fuel%vstd!view.impl&%24.view. fuel%test_crate!MyArray. fuel%vstd!array.group_array_axioms.
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/assert_by_compute-161a97ac6c96a80b-array_literals/test.rs:17:1: 17:40 (#0)
...
(assert
 (=>
  ...
  (= test_crate!MyArray.? (%Poly%array%. (array_new $ (UINT 32) 3 (%%array%%0 (I 31) (I
       32
      ) (I 33)
))))))
(assert
...
;; Function-Def test_crate::mytest
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/assert_by_compute-161a97ac6c96a80b-array_literals/test.rs:19:7: 19:18 (#0)
(get-info :all-statistics)
(push)
 ...
 (assert
  (not (=>
    (= (%I (vstd!seq.Seq.index.? $ (UINT 32) (vstd!view.View.view.? $ (ARRAY $ (UINT 32) $
         (CONST_INT 2)
        ) (array_new $ (UINT 32) 2 (%%array%%1 (I 41) (I 42)))
       ) (I 1)
      )
     ) 42
    )
    (=>
     ...
     (=>
      ...
      (=>
       %%location_label%%0
       (= (%I (vstd!seq.Seq.index.? $ (UINT 32) (vstd!array.array_view.? $ (UINT 32) $ (CONST_INT
            3
           ) (array_new $ (UINT 32) 3 (%%array%%0 (I 31) (I 32) (I 33)))
          ) (I x@)
         )
        ) 31
 )))))))
