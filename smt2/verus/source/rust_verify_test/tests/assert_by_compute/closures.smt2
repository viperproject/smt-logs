...
;; Fuel
(declare-const fuel%call_it. FuelId)
(assert
 true
)
...
;; Function-Decl crate::call_it
(declare-fun call_it.? (Poly Poly) Int)

;; Function-Axioms crate::call_it
(assert
 (fuel_bool_default fuel%call_it.)
)
(assert
 (=>
  (fuel_bool fuel%call_it.)
  (forall ((f! Poly) (arg! Poly)) (!
    (= (call_it.? f! arg!) (%I (let
       ((y$ 100))
       (%%apply%%0 (%Poly%fun%1. f!) arg!)
    )))
    :pattern ((call_it.? f! arg!))
    :qid internal_call_it.?_definition
    :skolemid skolem_internal_call_it.?_definition
))))

;; Function-Def crate::test
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/assert_by_compute-161a97ac6c96a80b-closures/test.rs:15:1: 15:16 (#0)
...
(push)
 ...
 (assert
  (forall ((x$ Poly) (y$2 Poly)) (!
    (= (%%apply%%1 %%lambda%%1 x$ y$2) (I (Add (%I x$) (%I y$2))))
    :pattern ((%%apply%%1 %%lambda%%1 x$ y$2))
 )))
 ;; assertion failed
 (declare-const %%location_label%%0 Bool)
 (assert
  (not (=>
    (= (%I (%%apply%%0 (mk_fun (%%lambda%%0 1)) (I 5))) 6)
    (=>
     (= y@ 5)
     (=>
      %%location_label%%0
...
;; Function-Def crate::scoping_test
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/assert_by_compute-161a97ac6c96a80b-closures/test.rs:33:7: 33:24 (#0)
(get-info :all-statistics)
(push)
