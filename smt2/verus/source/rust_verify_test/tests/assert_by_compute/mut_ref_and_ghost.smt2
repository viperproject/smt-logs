...
(declare-fun req%test_crate!test. (Int) Bool)
(declare-const %%global_location_label%%0 Bool)
(assert
 (forall ((pre%a! Int)) (!
   (= (req%test_crate!test. pre%a!) (=>
     %%global_location_label%%0
     (< pre%a! 1000)
   ))
   :pattern ((req%test_crate!test. pre%a!))
...
(assert
 (forall ((pre%a! Int) (a! Int)) (!
   (= (ens%test_crate!test. pre%a! a!) (and
     (uInv 64 a!)
     (= a! (Add pre%a! 30))
   ))
   :pattern ((ens%test_crate!test. pre%a! a!))
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/assert_by_compute-161a97ac6c96a80b-mut_ref_and_ghost/test.rs:18:1: 18:21 (#0)
(get-info :all-statistics)
(push)
 (declare-const a!@0 Int)
 (declare-const verus_tmp_old_a@ Int)
 (declare-const verus_tmp@0 Int)
 (declare-const old_a@0 Int)
 (assert
  fuel_defaults
 )
 (assert
 ...
 (assert
  (not (=>
    (= verus_tmp@1 a!@0)
    (=>
     (= verus_tmp_old_a@ verus_tmp@1)
     (=>
      (= old_a@1 verus_tmp_old_a@)
      (and
       (=>
        %%location_label%%0
        (uInv 64 (Mul 5 6))
       ...
       (and
        (=>
         %%location_label%%1
         (uInv 64 (Add a!@0 (uClip 64 (Mul 5 6))))
        )
        (=>
         (= a!@1 (uClip 64 (Add a!@0 (uClip 64 (Mul 5 6)))))
         (and
          (=>
           %%location_label%%2
           (= a!@1 (Add old_a@1 30))
