...
;; MODULE 'root module, function test_crate::sub_add_cancel'
...
(assert
 (distinct fuel%vstd!multiset.impl&%0.subset_of. fuel%vstd!multiset.impl&%0.le. fuel%vstd!multiset.axiom_multiset_add.
  fuel%vstd!multiset.axiom_multiset_sub. fuel%vstd!multiset.axiom_multiset_ext_equal.
  fuel%vstd!multiset.axiom_multiset_ext_equal_deep. fuel%vstd!array.group_array_axioms.
...
;; Function-Decl vstd::multiset::impl&%0::le
...
(assert
 (=>
  ...
  (forall ((V&. Dcr) (V& Type) (m1! Poly) (m2! Poly) (v! Poly)) (!
    ...
    :qid user_vstd__multiset__axiom_multiset_sub_1
    :skolemid skolem_user_vstd__multiset__axiom_multiset_sub_1
))))
    ...
    (=>
     ...
     (= (ext_eq false (TYPE%vstd!multiset.Multiset. V&. V&) m1! m2!) (forall ((v$ Poly))
       (!
        ...
        :qid user_vstd__multiset__axiom_multiset_ext_equal_2
        :skolemid skolem_user_vstd__multiset__axiom_multiset_ext_equal_2
    ))))
    :pattern ((ext_eq false (TYPE%vstd!multiset.Multiset. V&. V&) m1! m2!))
    :qid user_vstd__multiset__axiom_multiset_ext_equal_3
    :skolemid skolem_user_vstd__multiset__axiom_multiset_ext_equal_3
))))
...
(assert
 (=>
  ...
  (forall ((V&. Dcr) (V& Type) (m1! Poly) (m2! Poly)) (!
    ...
    :qid user_vstd__multiset__axiom_multiset_ext_equal_deep_4
    :skolemid skolem_user_vstd__multiset__axiom_multiset_ext_equal_deep_4
))))
 ...
 (=>
  ...
  (forall ((V&. Dcr) (V& Type) (self! Poly) (m2! Poly)) (!
    (= (vstd!multiset.impl&%0.subset_of.? V&. V& self! m2!) (forall ((v$ Poly)) (!
       ...
       :pattern ((vstd!multiset.impl&%0.count.? V&. V& m2! v$))
       :qid user_vstd__multiset__impl&%0__subset_of_5
       :skolemid skolem_user_vstd__multiset__impl&%0__subset_of_5
    )))
...
;; Function-Axioms vstd::multiset::impl&%0::le
(assert
...
;; Function-Specs test_crate::sub_add_cancel
(declare-fun req%test_crate!sub_add_cancel. (Dcr Type Poly Poly) Bool)
(declare-const %%global_location_label%%0 Bool)
(assert
 (forall ((V&. Dcr) (V& Type) (a! Poly) (b! Poly)) (!
   (= (req%test_crate!sub_add_cancel. V&. V& a! b!) (=>
     %%global_location_label%%0
     (vstd!multiset.impl&%0.subset_of.? V&. V& b! a!)
   ))
   :pattern ((req%test_crate!sub_add_cancel. V&. V& a! b!))
   :qid internal_req__test_crate!sub_add_cancel._definition
   :skolemid skolem_internal_req__test_crate!sub_add_cancel._definition
)))
(declare-fun ens%test_crate!sub_add_cancel. (Dcr Type Poly Poly) Bool)
(assert
 (forall ((V&. Dcr) (V& Type) (a! Poly) (b! Poly)) (!
   (= (ens%test_crate!sub_add_cancel. V&. V& a! b!) (= (vstd!multiset.impl&%0.add.? V&.
      V& (vstd!multiset.impl&%0.sub.? V&. V& a! b!) b!
     ) a!
   ))
   :pattern ((ens%test_crate!sub_add_cancel. V&. V& a! b!))
   :qid internal_ens__test_crate!sub_add_cancel._definition
   :skolemid skolem_internal_ens__test_crate!sub_add_cancel._definition
)))

;; Function-Def test_crate::sub_add_cancel
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/z3_restart-0070d73d3baf3d36-multiset_basics/test.rs:65:1: 65:63 (#0)
...
(push)
 ...
 (assert
  (not (=>
    (= tmp%1 (ext_eq false (TYPE%vstd!multiset.Multiset. V&. V&) (vstd!multiset.impl&%0.add.?
       V&. V& (vstd!multiset.impl&%0.sub.? V&. V& a! b!) b!
      ) a!
    ))
    (and
     (=>
...
;; Function-Recommends test_crate::sub_add_cancel
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/z3_restart-0070d73d3baf3d36-multiset_basics/test.rs:65:1: 65:63 (#0)
(get-info :all-statistics)
(push)
 (declare-const V&. Dcr)
