...
;; MODULE 'root module, function test_crate::insert2_count'
...
(assert
 (distinct fuel%vstd!multiset.impl&%0.insert. fuel%vstd!multiset.axiom_multiset_empty.
...
;; Function-Decl vstd::multiset::impl&%0::empty
...
;; Function-Axioms vstd::multiset::impl&%0::empty
(assert
 (forall ((V&. Dcr) (V& Type)) (!
...
;; Broadcast vstd::multiset::axiom_multiset_empty
(assert
 (=>
  ...
  (forall ((V&. Dcr) (V& Type) (v! Poly)) (!
    ...
    :qid user_vstd__multiset__axiom_multiset_empty_0
    :skolemid skolem_user_vstd__multiset__axiom_multiset_empty_0
))))
...
(assert
 (=>
  ...
  (forall ((V&. Dcr) (V& Type) (v! Poly)) (!
    ...
    :pattern ((vstd!multiset.impl&%0.singleton.? V&. V& v!))
    :qid user_vstd__multiset__axiom_multiset_singleton_1
    :skolemid skolem_user_vstd__multiset__axiom_multiset_singleton_1
))))
...
(assert
 (=>
  ...
  (forall ((V&. Dcr) (V& Type) (v! Poly) (w! Poly)) (!
    ...
    :qid user_vstd__multiset__axiom_multiset_singleton_different_2
    :skolemid skolem_user_vstd__multiset__axiom_multiset_singleton_different_2
))))
...
(assert
 (=>
  ...
  (forall ((V&. Dcr) (V& Type) (m1! Poly) (m2! Poly) (v! Poly)) (!
    ...
    :qid user_vstd__multiset__axiom_multiset_add_3
    :skolemid skolem_user_vstd__multiset__axiom_multiset_add_3
))))
    ...
    (=>
     ...
     (= (ext_eq false (TYPE%vstd!multiset.Multiset. V&. V&) m1! m2!) (forall ((v$ Poly))
       (!
        ...
        :qid user_vstd__multiset__axiom_multiset_ext_equal_4
        :skolemid skolem_user_vstd__multiset__axiom_multiset_ext_equal_4
    ))))
    :pattern ((ext_eq false (TYPE%vstd!multiset.Multiset. V&. V&) m1! m2!))
    :qid user_vstd__multiset__axiom_multiset_ext_equal_5
    :skolemid skolem_user_vstd__multiset__axiom_multiset_ext_equal_5
))))
...
(assert
 (=>
  ...
  (forall ((V&. Dcr) (V& Type) (m1! Poly) (m2! Poly)) (!
    ...
    :qid user_vstd__multiset__axiom_multiset_ext_equal_deep_6
    :skolemid skolem_user_vstd__multiset__axiom_multiset_ext_equal_deep_6
))))
...
;; Function-Specs test_crate::insert2_count
(declare-fun req%test_crate!insert2_count. (Dcr Type Poly Poly Poly) Bool)
(declare-const %%global_location_label%%0 Bool)
(assert
 (forall ((V&. Dcr) (V& Type) (a! Poly) (b! Poly) (c! Poly)) (!
   (= (req%test_crate!insert2_count. V&. V& a! b! c!) (=>
   ...
   :pattern ((req%test_crate!insert2_count. V&. V& a! b! c!))
   :qid internal_req__test_crate!insert2_count._definition
   :skolemid skolem_internal_req__test_crate!insert2_count._definition
)))

;; Function-Def test_crate::insert2_count
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/z3_restart-0070d73d3baf3d36-multiset_basics/test.rs:47:1: 47:48 (#0)
...
(push)
 ...
 (assert
  (not (=>
    (= tmp%1 (= (vstd!multiset.impl&%0.count.? V&. V& (vstd!multiset.impl&%0.insert.? V&.
        V& (vstd!multiset.impl&%0.insert.? V&. V& (vstd!multiset.impl&%0.empty.? V&. V&) a!)
        b!
       ) a!
      ) 1
    ))
    (and
     ...
     (=>
      tmp%1
      (=>
       (= tmp%2 (= (vstd!multiset.impl&%0.count.? V&. V& (vstd!multiset.impl&%0.insert.? V&.
           V& (vstd!multiset.impl&%0.insert.? V&. V& (vstd!multiset.impl&%0.empty.? V&. V&) a!)
           b!
          ) b!
         ) 1
       ...
       (and
        ...
        (=>
         tmp%2
         (=>
          (= tmp%3 (= (vstd!multiset.impl&%0.count.? V&. V& (vstd!multiset.impl&%0.insert.? V&.
              V& (vstd!multiset.impl&%0.insert.? V&. V& (vstd!multiset.impl&%0.empty.? V&. V&) a!)
              b!
             ) c!
            ) 0
