...
;; MODULE 'root module, function test_crate::commutative'
...
;; Function-Specs test_crate::commutative
(declare-fun ens%test_crate!commutative. (Dcr Type Poly Poly) Bool)
(assert
 (forall ((V&. Dcr) (V& Type) (a! Poly) (b! Poly)) (!
   (= (ens%test_crate!commutative. V&. V& a! b!) (= (vstd!multiset.impl&%0.add.? V&. V&
      a! b!
     ) (vstd!multiset.impl&%0.add.? V&. V& b! a!)
   ))
   :pattern ((ens%test_crate!commutative. V&. V& a! b!))
   :qid internal_ens__test_crate!commutative._definition
   :skolemid skolem_internal_ens__test_crate!commutative._definition
)))

;; Function-Def test_crate::commutative
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/z3_restart-0070d73d3baf3d36-multiset_basics/test.rs:18:1: 18:60 (#0)
  ...
  (not (=>
    ...
    (and
     ...
     (=>
      ...
      (=>
       %%location_label%%1
       (= (vstd!multiset.impl&%0.add.? V&. V& a! b!) (vstd!multiset.impl&%0.add.? V&. V& b!
         a!
 ))))))))
 (get-info :version)
