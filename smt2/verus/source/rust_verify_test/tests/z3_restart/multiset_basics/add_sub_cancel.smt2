...
;; MODULE 'root module, function test_crate::add_sub_cancel'
...
;; Function-Specs test_crate::add_sub_cancel
(declare-fun ens%test_crate!add_sub_cancel. (Dcr Type Poly Poly) Bool)
(assert
 (forall ((V&. Dcr) (V& Type) (a! Poly) (b! Poly)) (!
   (= (ens%test_crate!add_sub_cancel. V&. V& a! b!) (= (vstd!multiset.impl&%0.sub.? V&.
      V& (vstd!multiset.impl&%0.add.? V&. V& a! b!) b!
     ) a!
   ))
   :pattern ((ens%test_crate!add_sub_cancel. V&. V& a! b!))
   :qid internal_ens__test_crate!add_sub_cancel._definition
   :skolemid skolem_internal_ens__test_crate!add_sub_cancel._definition
)))

;; Function-Def test_crate::add_sub_cancel
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/z3_restart-0070d73d3baf3d36-multiset_basics/test.rs:57:1: 57:63 (#0)
...
(push)
 ...
 (assert
  (not (=>
    (= tmp%1 (ext_eq false (TYPE%vstd!multiset.Multiset. V&. V&) (vstd!multiset.impl&%0.sub.?
       V&. V& (vstd!multiset.impl&%0.add.? V&. V& a! b!) b!
      ) a!
    ))
    (and
     (=>
     ...
     (=>
      ...
      (=>
       %%location_label%%1
       (= (vstd!multiset.impl&%0.sub.? V&. V& (vstd!multiset.impl&%0.add.? V&. V& a! b!) b!)
        a!
 )))))))
 (get-info :version)
