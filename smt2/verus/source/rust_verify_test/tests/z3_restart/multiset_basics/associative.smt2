...
;; MODULE 'root module, function test_crate::associative'
...
(assert
 (distinct fuel%vstd!multiset.axiom_multiset_add. fuel%vstd!multiset.axiom_multiset_ext_equal.
...
(assert
 (=>
  ...
  (forall ((V&. Dcr) (V& Type) (m1! Poly) (m2! Poly)) (!
    ...
    :qid user_vstd__multiset__axiom_multiset_ext_equal_deep_3
    :skolemid skolem_user_vstd__multiset__axiom_multiset_ext_equal_deep_3
))))

;; Function-Specs test_crate::associative
(declare-fun ens%test_crate!associative. (Dcr Type Poly Poly Poly) Bool)
(assert
 (forall ((V&. Dcr) (V& Type) (a! Poly) (b! Poly) (c! Poly)) (!
   (= (ens%test_crate!associative. V&. V& a! b! c!) (= (vstd!multiset.impl&%0.add.? V&.
      V& a! (vstd!multiset.impl&%0.add.? V&. V& b! c!)
     ) (vstd!multiset.impl&%0.add.? V&. V& (vstd!multiset.impl&%0.add.? V&. V& a! b!) c!)
   ))
   :pattern ((ens%test_crate!associative. V&. V& a! b! c!))
   :qid internal_ens__test_crate!associative._definition
   :skolemid skolem_internal_ens__test_crate!associative._definition
)))

;; Function-Def test_crate::associative
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/z3_restart-0070d73d3baf3d36-multiset_basics/test.rs:26:1: 26:76 (#0)
...
(push)
 ...
 (assert
  (has_type c! (TYPE%vstd!multiset.Multiset. V&. V&))
 )
 ;; assertion failed
 ...
 (assert
  (not (=>
    (= tmp%1 (ext_eq false (TYPE%vstd!multiset.Multiset. V&. V&) (vstd!multiset.impl&%0.add.?
       V&. V& a! (vstd!multiset.impl&%0.add.? V&. V& b! c!)
      ) (vstd!multiset.impl&%0.add.? V&. V& (vstd!multiset.impl&%0.add.? V&. V& a! b!) c!)
    ))
    (and
     (=>
     ...
     (=>
      ...
      (=>
       %%location_label%%1
       (= (vstd!multiset.impl&%0.add.? V&. V& a! (vstd!multiset.impl&%0.add.? V&. V& b! c!))
        (vstd!multiset.impl&%0.add.? V&. V& (vstd!multiset.impl&%0.add.? V&. V& a! b!) c!)
 )))))))
 (get-info :version)
