...
(assert
 (distinct fuel%vstd!std_specs.option.impl&%0.get_Some_0. fuel%vstd!std_specs.option.impl&%0.is_None.
  fuel%test_crate!f2. fuel%vstd!array.group_array_axioms. fuel%vstd!map.group_map_axioms.
...
(declare-fun test_crate!f2.? (Poly) Bool)
...
(assert
 (=>
  ...
  (forall ((no%param Poly)) (!
    (= (test_crate!f2.? no%param) (let
      ((x$ core!option.Option./None))
      (is-core!option.Option./None x$)
    ))
    :pattern ((test_crate!f2.? no%param))
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/erase-c5f87086239d8397-test_regression_78/test.rs:17:7: 17:36 (#0)
