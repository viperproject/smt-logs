...
(declare-const fuel%test_crate!impl&%0.arrow_M0_0. FuelId)
(declare-const fuel%test_crate!impl&%1.arrow_0. FuelId)
(declare-const fuel%test_crate!impl&%1.arrow_M0_0. FuelId)
(declare-const fuel%test_crate!impl&%2.view. FuelId)
...
(assert
 (distinct fuel%vstd!raw_ptr.impl&%4.view. fuel%vstd!raw_ptr.ptrs_mut_eq. fuel%vstd!seq.impl&%0.spec_index.
  ...
  fuel%vstd!view.impl&%14.view. fuel%vstd!view.impl&%24.view. fuel%test_crate!impl&%0.arrow_0.
  fuel%test_crate!impl&%0.arrow_M0_0. fuel%test_crate!impl&%1.arrow_0. fuel%test_crate!impl&%1.arrow_M0_0.
  fuel%test_crate!impl&%2.view. fuel%vstd!array.group_array_axioms. fuel%vstd!map.group_map_axioms.
...
(declare-datatypes ((vstd!raw_ptr.Metadata. 0) (vstd!raw_ptr.PtrData. 0) (test_crate!SpecMsg.
   0
  ) (test_crate!Msg. 0) (tuple%0. 0)
  ...
  ) ((test_crate!SpecMsg./M0 (test_crate!SpecMsg./M0/?0 vstd!seq.Seq<u8.>.))) ((test_crate!Msg./M0
    (test_crate!Msg./M0/?0 slice%<u8.>.)
   )
  ) ((tuple%0./tuple%0))
))
...
(declare-fun test_crate!SpecMsg./M0/0 (test_crate!SpecMsg.) vstd!seq.Seq<u8.>.)
(declare-fun test_crate!Msg./M0/0 (test_crate!Msg.) slice%<u8.>.)
...
(declare-const TYPE%test_crate!SpecMsg. Type)
(declare-const TYPE%test_crate!Msg. Type)
...
(declare-fun Poly%test_crate!SpecMsg. (test_crate!SpecMsg.) Poly)
(declare-fun %Poly%test_crate!SpecMsg. (Poly) test_crate!SpecMsg.)
(declare-fun Poly%test_crate!Msg. (test_crate!Msg.) Poly)
(declare-fun %Poly%test_crate!Msg. (Poly) test_crate!Msg.)
...
(assert
 (forall ((x test_crate!SpecMsg.)) (!
   (= x (%Poly%test_crate!SpecMsg. (Poly%test_crate!SpecMsg. x)))
   :pattern ((Poly%test_crate!SpecMsg. x))
   :qid internal_test_crate__SpecMsg_box_axiom_definition
   :skolemid skolem_internal_test_crate__SpecMsg_box_axiom_definition
)))
(assert
 (forall ((x Poly)) (!
   (=>
    (has_type x TYPE%test_crate!SpecMsg.)
    (= x (Poly%test_crate!SpecMsg. (%Poly%test_crate!SpecMsg. x)))
   )
   :pattern ((has_type x TYPE%test_crate!SpecMsg.))
   :qid internal_test_crate__SpecMsg_unbox_axiom_definition
   :skolemid skolem_internal_test_crate__SpecMsg_unbox_axiom_definition
)))
(assert
 (forall ((x test_crate!SpecMsg.)) (!
   (= (test_crate!SpecMsg./M0/0 x) (test_crate!SpecMsg./M0/?0 x))
   :pattern ((test_crate!SpecMsg./M0/0 x))
   :qid internal_test_crate!SpecMsg./M0/0_accessor_definition
   :skolemid skolem_internal_test_crate!SpecMsg./M0/0_accessor_definition
)))
(assert
 (forall ((x test_crate!SpecMsg.)) (!
   (has_type (Poly%test_crate!SpecMsg. x) TYPE%test_crate!SpecMsg.)
   :pattern ((has_type (Poly%test_crate!SpecMsg. x) TYPE%test_crate!SpecMsg.))
   :qid internal_test_crate__SpecMsg_has_type_always_definition
   :skolemid skolem_internal_test_crate__SpecMsg_has_type_always_definition
)))
(assert
 (forall ((x test_crate!Msg.)) (!
   (= x (%Poly%test_crate!Msg. (Poly%test_crate!Msg. x)))
   :pattern ((Poly%test_crate!Msg. x))
   :qid internal_test_crate__Msg_box_axiom_definition
   :skolemid skolem_internal_test_crate__Msg_box_axiom_definition
)))
(assert
 (forall ((x Poly)) (!
   (=>
    (has_type x TYPE%test_crate!Msg.)
    (= x (Poly%test_crate!Msg. (%Poly%test_crate!Msg. x)))
   )
   :pattern ((has_type x TYPE%test_crate!Msg.))
   :qid internal_test_crate__Msg_unbox_axiom_definition
   :skolemid skolem_internal_test_crate__Msg_unbox_axiom_definition
)))
(assert
 (forall ((x test_crate!Msg.)) (!
   (= (test_crate!Msg./M0/0 x) (test_crate!Msg./M0/?0 x))
   :pattern ((test_crate!Msg./M0/0 x))
   :qid internal_test_crate!Msg./M0/0_accessor_definition
   :skolemid skolem_internal_test_crate!Msg./M0/0_accessor_definition
)))
(assert
 (forall ((x test_crate!Msg.)) (!
   (has_type (Poly%test_crate!Msg. x) TYPE%test_crate!Msg.)
   :pattern ((has_type (Poly%test_crate!Msg. x) TYPE%test_crate!Msg.))
   :qid internal_test_crate__Msg_has_type_always_definition
   :skolemid skolem_internal_test_crate__Msg_has_type_always_definition
)))
(assert
 (forall ((x tuple%0.)) (!
...
(assert
 (= (proj%%vstd!view.View./V $ TYPE%test_crate!Msg.) $)
)
(assert
 (= (proj%vstd!view.View./V $ TYPE%test_crate!Msg.) TYPE%test_crate!SpecMsg.)
)
...
;; Function-Decl test_crate::SpecMsg::arrow_0
(declare-fun test_crate!impl&%0.arrow_0.? (Poly) vstd!seq.Seq<u8.>.)

;; Function-Decl test_crate::SpecMsg::arrow_M0_0
(declare-fun test_crate!impl&%0.arrow_M0_0.? (Poly) vstd!seq.Seq<u8.>.)

;; Function-Decl test_crate::Msg::arrow_0
(declare-fun test_crate!impl&%1.arrow_0.? (Poly) slice%<u8.>.)

;; Function-Decl test_crate::Msg::arrow_M0_0
(declare-fun test_crate!impl&%1.arrow_M0_0.? (Poly) slice%<u8.>.)
...
;; Function-Axioms test_crate::SpecMsg::arrow_0
(assert
...
(assert
 (=>
  ...
  (forall ((self! Poly)) (!
    (= (test_crate!impl&%0.arrow_0.? self!) (test_crate!SpecMsg./M0/0 (%Poly%test_crate!SpecMsg.
       self!
    )))
...
;; Function-Axioms test_crate::SpecMsg::arrow_M0_0
(assert
 (fuel_bool_default fuel%test_crate!impl&%0.arrow_M0_0.)
)
(assert
 (=>
  (fuel_bool fuel%test_crate!impl&%0.arrow_M0_0.)
  (forall ((self! Poly)) (!
    (= (test_crate!impl&%0.arrow_M0_0.? self!) (test_crate!SpecMsg./M0/0 (%Poly%test_crate!SpecMsg.
       self!
    )))
    :pattern ((test_crate!impl&%0.arrow_M0_0.? self!))
    :qid internal_test_crate!impl&__0.arrow_M0_0.?_definition
    :skolemid skolem_internal_test_crate!impl&__0.arrow_M0_0.?_definition
))))

;; Function-Axioms test_crate::Msg::arrow_0
(assert
...
(assert
 (=>
  ...
  (forall ((self! Poly)) (!
    (= (test_crate!impl&%1.arrow_0.? self!) (test_crate!Msg./M0/0 (%Poly%test_crate!Msg.
       self!
    )))
    :pattern ((test_crate!impl&%1.arrow_0.? self!))
    :qid internal_test_crate!impl&__1.arrow_0.?_definition
    :skolemid skolem_internal_test_crate!impl&__1.arrow_0.?_definition
))))

;; Function-Axioms test_crate::Msg::arrow_M0_0
(assert
 (fuel_bool_default fuel%test_crate!impl&%1.arrow_M0_0.)
)
(assert
 (=>
  (fuel_bool fuel%test_crate!impl&%1.arrow_M0_0.)
  (forall ((self! Poly)) (!
    (= (test_crate!impl&%1.arrow_M0_0.? self!) (test_crate!Msg./M0/0 (%Poly%test_crate!Msg.
       self!
    )))
    :pattern ((test_crate!impl&%1.arrow_M0_0.? self!))
    :qid internal_test_crate!impl&__1.arrow_M0_0.?_definition
    :skolemid skolem_internal_test_crate!impl&__1.arrow_M0_0.?_definition
))))
...
;; Function-Axioms test_crate::Msg::view
(assert
 (fuel_bool_default fuel%test_crate!impl&%2.view.)
)
(assert
 (=>
  (fuel_bool fuel%test_crate!impl&%2.view.)
  (forall ((self! Poly)) (!
    (= (vstd!view.View.view.? $ TYPE%test_crate!Msg. self!) (Poly%test_crate!SpecMsg. (
       let
       ((m$ (test_crate!Msg./M0/0 (%Poly%test_crate!Msg. self!))))
       (test_crate!SpecMsg./M0 (%Poly%vstd!seq.Seq<u8.>. (vstd!view.View.view.? $ (SLICE $ (
            UINT 8
           )
          ) (Poly%slice%<u8.>. m$)
    ))))))
    :pattern ((vstd!view.View.view.? $ TYPE%test_crate!Msg. self!))
    :qid internal_vstd!view.View.view.?_definition
    :skolemid skolem_internal_vstd!view.View.view.?_definition
))))
...
;; Trait-Impl-Axiom
(assert
 (tr_bound%vstd!view.View. $ TYPE%test_crate!Msg.)
)
