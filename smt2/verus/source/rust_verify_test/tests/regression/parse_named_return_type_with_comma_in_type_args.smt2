...
;; Function-Specs test_crate::some_proof
(declare-fun ens%test_crate!some_proof. (Int vstd!map.Map<int./int.>.) Bool)
(assert
 (forall ((no%param Int) (m! vstd!map.Map<int./int.>.)) (!
   (= (ens%test_crate!some_proof. no%param m!) (= m! (%Poly%vstd!map.Map<int./int.>. (vstd!map.impl&%0.empty.?
       $ INT $ INT
   ))))
   :pattern ((ens%test_crate!some_proof. no%param m!))
   :qid internal_ens__test_crate!some_proof._definition
   :skolemid skolem_internal_ens__test_crate!some_proof._definition
)))

;; Function-Def test_crate::some_proof
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/regression-491396d30b1dad7a-parse_named_return_type_with_comma_in_type_args/test.rs:17:7: 17:43 (#0)
...
;; Function-Def test_crate::cats
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/regression-491396d30b1dad7a-parse_named_return_type_with_comma_in_type_args/test.rs:23:7: 23:16 (#0)
(get-info :all-statistics)
(push)
 (declare-const no%param Int)
