...
(assert
 (distinct fuel%vstd!raw_ptr.impl&%4.view. fuel%vstd!raw_ptr.ptrs_mut_eq. fuel%vstd!seq.impl&%0.spec_index.
  ...
  fuel%vstd!view.impl&%14.view. fuel%vstd!view.impl&%24.view. fuel%vstd!array.group_array_axioms.
...
;; Function-Def test_crate::blah
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/regression-491396d30b1dad7a-zulip_external_body_clone_regression_800_2/test.rs:17:1: 17:34 (#0)
...
(push)
 ...
 (assert
  (not (=>
    (= tmp%1 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec.
        $ (UINT 8) $ ALLOCATOR_GLOBAL
       ) (Poly%alloc!vec.Vec<u8./allocator_global%.>. rc!)
