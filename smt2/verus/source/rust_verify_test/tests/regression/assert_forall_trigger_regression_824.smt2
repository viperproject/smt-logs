...
(declare-fun req%test_crate!test. (vstd!seq.Seq<u32.>.) Bool)
(declare-const %%global_location_label%%2 Bool)
(assert
 (forall ((a! vstd!seq.Seq<u32.>.)) (!
   (= (req%test_crate!test. a!) (=>
     %%global_location_label%%2
     (forall ((i$ Poly)) (!
       (=>
        (has_type i$ INT)
        (test_crate!f.? (vstd!seq.Seq.index.? $ (UINT 32) (Poly%vstd!seq.Seq<u32.>. a!) i$))
       )
       :pattern ((test_crate!f.? (vstd!seq.Seq.index.? $ (UINT 32) (Poly%vstd!seq.Seq<u32.>.
           a!
          ) i$
       )))
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/regression-491396d30b1dad7a-assert_forall_trigger_regression_824/test.rs:18:7: 18:27 (#0)
(get-info :all-statistics)
(push)
 (declare-const a! vstd!seq.Seq<u32.>.)
 ...
 (assert
  (forall ((i$ Poly)) (!
    ...
    :qid user_test_crate__test_7
    :skolemid skolem_user_test_crate__test_7
 )))
 ;; assertion failed
