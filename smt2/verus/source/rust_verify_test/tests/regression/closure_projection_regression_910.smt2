...
(declare-const fuel%test_crate!f1. FuelId)
(declare-const fuel%test_crate!f2. FuelId)
...
(assert
 (distinct fuel%vstd!map.impl&%0.spec_index. fuel%vstd!map.axiom_map_index_decreases_finite.
  ...
  fuel%vstd!map.axiom_map_ext_equal_deep. fuel%vstd!seq.impl&%0.spec_index. fuel%vstd!seq.axiom_seq_index_decreases.
  ...
  fuel%test_crate!f1. fuel%test_crate!f2. fuel%vstd!array.group_array_axioms. fuel%vstd!map.group_map_axioms.
...
;; Datatypes
(declare-datatypes ((test_crate!L. 0) (tuple%0. 0)) (((test_crate!L./L (test_crate!L./L/?x
     Poly
   ))
  ) ((tuple%0./tuple%0))
))
(declare-fun test_crate!L./L/x (test_crate!L.) Poly)
(declare-fun TYPE%fun%1. (Dcr Type Dcr Type) Type)
(declare-fun TYPE%vstd!map.Map. (Dcr Type Dcr Type) Type)
(declare-fun TYPE%vstd!seq.Seq. (Dcr Type) Type)
(declare-fun TYPE%vstd!set.Set. (Dcr Type) Type)
(declare-fun TYPE%test_crate!L. (Dcr Type) Type)
(declare-const TYPE%tuple%0. Type)
(declare-fun Poly%fun%1. (%%Function%%) Poly)
(declare-fun %Poly%fun%1. (Poly) %%Function%%)
(declare-fun Poly%test_crate!L. (test_crate!L.) Poly)
(declare-fun %Poly%test_crate!L. (Poly) test_crate!L.)
...
(assert
 (forall ((x test_crate!L.)) (!
   (= x (%Poly%test_crate!L. (Poly%test_crate!L. x)))
   :pattern ((Poly%test_crate!L. x))
   :qid internal_test_crate__L_box_axiom_definition
   :skolemid skolem_internal_test_crate__L_box_axiom_definition
)))
(assert
 (forall ((D&. Dcr) (D& Type) (x Poly)) (!
   (=>
    (has_type x (TYPE%test_crate!L. D&. D&))
    (= x (Poly%test_crate!L. (%Poly%test_crate!L. x)))
   )
   :pattern ((has_type x (TYPE%test_crate!L. D&. D&)))
   :qid internal_test_crate__L_unbox_axiom_definition
   :skolemid skolem_internal_test_crate__L_unbox_axiom_definition
)))
(assert
 (forall ((D&. Dcr) (D& Type) (_x! Poly)) (!
   (=>
    (has_type _x! (proj%test_crate!T./X D&. D&))
    (has_type (Poly%test_crate!L. (test_crate!L./L _x!)) (TYPE%test_crate!L. D&. D&))
   )
   :pattern ((has_type (Poly%test_crate!L. (test_crate!L./L _x!)) (TYPE%test_crate!L. D&.
      D&
   )))
   :qid internal_test_crate!L./L_constructor_definition
   :skolemid skolem_internal_test_crate!L./L_constructor_definition
)))
(assert
 (forall ((x test_crate!L.)) (!
   (= (test_crate!L./L/x x) (test_crate!L./L/?x x))
   :pattern ((test_crate!L./L/x x))
   :qid internal_test_crate!L./L/x_accessor_definition
   :skolemid skolem_internal_test_crate!L./L/x_accessor_definition
)))
(assert
 (forall ((D&. Dcr) (D& Type) (x Poly)) (!
   (=>
    (has_type x (TYPE%test_crate!L. D&. D&))
    (has_type (test_crate!L./L/x (%Poly%test_crate!L. x)) (proj%test_crate!T./X D&. D&))
   )
   :pattern ((test_crate!L./L/x (%Poly%test_crate!L. x)) (has_type x (TYPE%test_crate!L.
      D&. D&
   )))
   :qid internal_test_crate!L./L/x_invariant_definition
   :skolemid skolem_internal_test_crate!L./L/x_invariant_definition
)))
(assert
 (forall ((x tuple%0.)) (!
...
;; Function-Decl test_crate::f1
(declare-fun test_crate!f1.? (Dcr Type Poly) Poly)

;; Function-Decl test_crate::f2
(declare-fun test_crate!f2.? (Dcr Type Poly) %%Function%%)
...
;; Function-Axioms test_crate::f1
(assert
 (fuel_bool_default fuel%test_crate!f1.)
)
...
(assert
 (forall ((%%hole%%0 Dcr) (%%hole%%1 Type) (%%hole%%2 Dcr) (%%hole%%3 Type) (%%hole%%4
   ...
   (= (%%apply%%0 (%%lambda%%0 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3 %%hole%%4) i$)
    (test_crate!L./L/x (%Poly%test_crate!L. (vstd!map.impl&%0.index.? %%hole%%0 %%hole%%1
       %%hole%%2 %%hole%%3 %%hole%%4 (I (nClip (%I i$)))
   ))))
...
(assert
 (=>
  (fuel_bool fuel%test_crate!f1.)
  (forall ((DT&. Dcr) (DT& Type) (l! Poly)) (!
    (= (test_crate!f1.? DT&. DT& l!) (vstd!seq.Seq.new.? (proj%%test_crate!T./X DT&. DT&)
      (proj%test_crate!T./X DT&. DT&) $ (TYPE%fun%1. $ INT (proj%%test_crate!T./X DT&. DT&)
       (proj%test_crate!T./X DT&. DT&)
      ) (I 1) (Poly%fun%1. (mk_fun (%%lambda%%0 $ NAT $ (TYPE%test_crate!L. DT&. DT&) l!)))
    ))
    :pattern ((test_crate!f1.? DT&. DT& l!))
    :qid internal_test_crate!f1.?_definition
    :skolemid skolem_internal_test_crate!f1.?_definition
))))
(assert
 (forall ((DT&. Dcr) (DT& Type) (l! Poly)) (!
   (=>
    (has_type l! (TYPE%vstd!map.Map. $ NAT $ (TYPE%test_crate!L. DT&. DT&)))
    (has_type (test_crate!f1.? DT&. DT& l!) (TYPE%vstd!seq.Seq. (proj%%test_crate!T./X DT&.
       DT&
      ) (proj%test_crate!T./X DT&. DT&)
   )))
   :pattern ((test_crate!f1.? DT&. DT& l!))
   :qid internal_test_crate!f1.?_pre_post_definition
   :skolemid skolem_internal_test_crate!f1.?_pre_post_definition
)))

;; Function-Axioms test_crate::f2
(assert
 (fuel_bool_default fuel%test_crate!f2.)
)
(declare-fun %%lambda%%1 () %%Function%%)
(assert
 (forall ((ll$ Poly)) (!
   (= (%%apply%%0 %%lambda%%1 ll$) (test_crate!L./L/x (%Poly%test_crate!L. ll$)))
   :pattern ((%%apply%%0 %%lambda%%1 ll$))
)))
(assert
 (=>
  (fuel_bool fuel%test_crate!f2.)
  (forall ((DT&. Dcr) (DT& Type) (l! Poly)) (!
    (= (test_crate!f2.? DT&. DT& l!) (mk_fun %%lambda%%1))
    :pattern ((test_crate!f2.? DT&. DT& l!))
    :qid internal_test_crate!f2.?_definition
    :skolemid skolem_internal_test_crate!f2.?_definition
))))
(assert
 (forall ((DT&. Dcr) (DT& Type) (l! Poly)) (!
   (=>
    (has_type l! (TYPE%test_crate!L. DT&. DT&))
    (has_type (Poly%fun%1. (test_crate!f2.? DT&. DT& l!)) (TYPE%fun%1. $ (TYPE%test_crate!L.
       DT&. DT&
      ) (proj%%test_crate!T./X DT&. DT&) (proj%test_crate!T./X DT&. DT&)
   )))
   :pattern ((test_crate!f2.? DT&. DT& l!))
   :qid internal_test_crate!f2.?_pre_post_definition
   :skolemid skolem_internal_test_crate!f2.?_pre_post_definition
)))
