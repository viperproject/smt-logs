...
(declare-fun req%test_crate!test. (vstd!seq.Seq<char.>. vstd!seq.Seq<char.>.) Bool)
(declare-const %%global_location_label%%2 Bool)
(assert
 (forall ((s2! vstd!seq.Seq<char.>.) (s1! vstd!seq.Seq<char.>.)) (!
   (= (req%test_crate!test. s2! s1!) (=>
     %%global_location_label%%2
     (or
      (= (vstd!seq.Seq.add.? $ CHAR (Poly%vstd!seq.Seq<char.>. s1!) (vstd!view.View.view.?
         $ STRSLICE (Poly%strslice%. (vstd!string.new_strlit_spec.? (Poly%strslice%. (str%new_strlit
             5388136328217397110659312206446935086729223426505375089767442509753233922224321551999046696882810187485328533041437738437057175209261070078385347875926518
        )))))
       ) (vstd!seq.Seq.add.? $ CHAR (Poly%vstd!seq.Seq<char.>. s2!) (vstd!view.View.view.?
         $ STRSLICE (Poly%strslice%. (vstd!string.new_strlit_spec.? (Poly%strslice%. (str%new_strlit
             978859438434856299649944205888080642458087422378818033532324611655114718767434957729753515648256153334304800913515307878389324195557151612099605921448102
      )))))))
      (= (vstd!seq.Seq.add.? $ CHAR (Poly%vstd!seq.Seq<char.>. s1!) (vstd!view.View.view.?
         $ STRSLICE (Poly%strslice%. (vstd!string.new_strlit_spec.? (Poly%strslice%. (str%new_strlit
             978859438434856299649944205888080642458087422378818033532324611655114718767434957729753515648256153334304800913515307878389324195557151612099605921448102
   ...
   :pattern ((req%test_crate!test. s2! s1!))
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/regression-491396d30b1dad7a-str_len_contradiction_from_suspect_unsoundness_report/test.rs:17:7: 17:44 (#0)
(get-info :all-statistics)
(push)
 (declare-const s2! vstd!seq.Seq<char.>.)
 (declare-const s1! vstd!seq.Seq<char.>.)
 ...
 (declare-const str1@ vstd!seq.Seq<char.>.)
 (declare-const str2@ vstd!seq.Seq<char.>.)
 (assert
  fuel_defaults
 )
 (assert
 ...
 (assert
  (not (and
    (=>
     (and
      (= (str%strslice_is_ascii (str%new_strlit 978859438434856299649944205888080642458087422378818033532324611655114718767434957729753515648256153334304800913515307878389324195557151612099605921448102))
       true
      )
      (= (str%strslice_len (str%new_strlit 978859438434856299649944205888080642458087422378818033532324611655114718767434957729753515648256153334304800913515307878389324195557151612099605921448102))
       4
      )
      (and
       (= (str%strslice_get_char (str%new_strlit 978859438434856299649944205888080642458087422378818033532324611655114718767434957729753515648256153334304800913515307878389324195557151612099605921448102)
         0
        ) 45
       )
       (= (str%strslice_get_char (str%new_strlit 978859438434856299649944205888080642458087422378818033532324611655114718767434957729753515648256153334304800913515307878389324195557151612099605921448102)
     ...
     (=>
      (and
       (= (str%strslice_is_ascii (str%new_strlit 5388136328217397110659312206446935086729223426505375089767442509753233922224321551999046696882810187485328533041437738437057175209261070078385347875926518))
        true
       )
       (= (str%strslice_len (str%new_strlit 5388136328217397110659312206446935086729223426505375089767442509753233922224321551999046696882810187485328533041437738437057175209261070078385347875926518))
        3
       )
       (and
        (= (str%strslice_get_char (str%new_strlit 5388136328217397110659312206446935086729223426505375089767442509753233922224321551999046696882810187485328533041437738437057175209261070078385347875926518)
          0
         ) 45
        )
        (= (str%strslice_get_char (str%new_strlit 5388136328217397110659312206446935086729223426505375089767442509753233922224321551999046696882810187485328533041437738437057175209261070078385347875926518)
      ...
      (=>
       (= tmp%1 (let
         ((tmp%%$ (nClip (Add (vstd!seq.Seq.len.? $ CHAR (Poly%vstd!seq.Seq<char.>. s1!)) (vstd!seq.Seq.len.?
              $ CHAR (vstd!view.View.view.? $ STRSLICE (Poly%strslice%. (vstd!string.new_strlit_spec.?
                 (Poly%strslice%. (str%new_strlit 5388136328217397110659312206446935086729223426505375089767442509753233922224321551999046696882810187485328533041437738437057175209261070078385347875926518))
         ))))))))
         (and
          (= (vstd!seq.Seq.len.? $ CHAR (vstd!seq.Seq.add.? $ CHAR (Poly%vstd!seq.Seq<char.>. s1!)
             (vstd!view.View.view.? $ STRSLICE (Poly%strslice%. (vstd!string.new_strlit_spec.? (Poly%strslice%.
                 (str%new_strlit 5388136328217397110659312206446935086729223426505375089767442509753233922224321551999046696882810187485328533041437738437057175209261070078385347875926518)
            )))))
           ) tmp%%$
          )
          (= tmp%%$ (nClip (Add (vstd!seq.Seq.len.? $ CHAR (Poly%vstd!seq.Seq<char.>. s1!)) 3)))
       )))
       (and
        (=>
         %%location_label%%0
        ...
        (=>
         ...
         (=>
          (= tmp%2 (let
            ((tmp%%$ (nClip (Add (vstd!seq.Seq.len.? $ CHAR (Poly%vstd!seq.Seq<char.>. s1!)) (vstd!seq.Seq.len.?
                 $ CHAR (vstd!view.View.view.? $ STRSLICE (Poly%strslice%. (vstd!string.new_strlit_spec.?
                    (Poly%strslice%. (str%new_strlit 978859438434856299649944205888080642458087422378818033532324611655114718767434957729753515648256153334304800913515307878389324195557151612099605921448102))
            ))))))))
            (and
             (= (vstd!seq.Seq.len.? $ CHAR (vstd!seq.Seq.add.? $ CHAR (Poly%vstd!seq.Seq<char.>. s1!)
                (vstd!view.View.view.? $ STRSLICE (Poly%strslice%. (vstd!string.new_strlit_spec.? (Poly%strslice%.
                    (str%new_strlit 978859438434856299649944205888080642458087422378818033532324611655114718767434957729753515648256153334304800913515307878389324195557151612099605921448102)
               )))))
              ) tmp%%$
             )
             (= tmp%%$ (nClip (Add (vstd!seq.Seq.len.? $ CHAR (Poly%vstd!seq.Seq<char.>. s1!)) 4)))
          )))
          (and
           (=>
            %%location_label%%1
           ...
           (=>
            ...
            (=>
             (= tmp%3 (let
               ((tmp%%$ (nClip (Add (vstd!seq.Seq.len.? $ CHAR (Poly%vstd!seq.Seq<char.>. s2!)) (vstd!seq.Seq.len.?
                    $ CHAR (vstd!view.View.view.? $ STRSLICE (Poly%strslice%. (vstd!string.new_strlit_spec.?
                       (Poly%strslice%. (str%new_strlit 978859438434856299649944205888080642458087422378818033532324611655114718767434957729753515648256153334304800913515307878389324195557151612099605921448102))
               ))))))))
               (and
                (= (vstd!seq.Seq.len.? $ CHAR (vstd!seq.Seq.add.? $ CHAR (Poly%vstd!seq.Seq<char.>. s2!)
                   (vstd!view.View.view.? $ STRSLICE (Poly%strslice%. (vstd!string.new_strlit_spec.? (Poly%strslice%.
                       (str%new_strlit 978859438434856299649944205888080642458087422378818033532324611655114718767434957729753515648256153334304800913515307878389324195557151612099605921448102)
                  )))))
                 ) tmp%%$
                )
                (= tmp%%$ (nClip (Add (vstd!seq.Seq.len.? $ CHAR (Poly%vstd!seq.Seq<char.>. s2!)) 4)))
             )))
             (and
              (=>
               %%location_label%%2
              ...
              (=>
               ...
               (=>
                %%location_label%%3
                (or
                 (= (nClip (Add (vstd!seq.Seq.len.? $ CHAR (Poly%vstd!seq.Seq<char.>. s1!)) 3)) (nClip
                   (Add (vstd!seq.Seq.len.? $ CHAR (Poly%vstd!seq.Seq<char.>. s2!)) 4)
                 ))
                 (= (nClip (Add (vstd!seq.Seq.len.? $ CHAR (Poly%vstd!seq.Seq<char.>. s1!)) 4)) (nClip
                   (Add (vstd!seq.Seq.len.? $ CHAR (Poly%vstd!seq.Seq<char.>. s2!)) 4)
    )))))))))))))))
    (=>
     (or
     ...
     (=>
      (= str1@ (%Poly%vstd!seq.Seq<char.>. (vstd!seq.Seq.add.? $ CHAR (Poly%vstd!seq.Seq<char.>.
          s1!
         ) (vstd!view.View.view.? $ STRSLICE (Poly%strslice%. (vstd!string.new_strlit_spec.?
            (Poly%strslice%. (str%new_strlit 5388136328217397110659312206446935086729223426505375089767442509753233922224321551999046696882810187485328533041437738437057175209261070078385347875926518))
      ))))))
      (=>
       (= str2@ (%Poly%vstd!seq.Seq<char.>. (vstd!seq.Seq.add.? $ CHAR (Poly%vstd!seq.Seq<char.>.
           s2!
          ) (vstd!view.View.view.? $ STRSLICE (Poly%strslice%. (vstd!string.new_strlit_spec.?
             (Poly%strslice%. (str%new_strlit 978859438434856299649944205888080642458087422378818033532324611655114718767434957729753515648256153334304800913515307878389324195557151612099605921448102))
       ))))))
       (and
        (=>
         ...
         (=>
          (= tmp%4 (let
            ((tmp%%$ (vstd!seq.Seq.len.? $ CHAR (vstd!seq.Seq.add.? $ CHAR (Poly%vstd!seq.Seq<char.>.
                 s1!
                ) (vstd!view.View.view.? $ STRSLICE (Poly%strslice%. (vstd!string.new_strlit_spec.?
                   (Poly%strslice%. (str%new_strlit 5388136328217397110659312206446935086729223426505375089767442509753233922224321551999046696882810187485328533041437738437057175209261070078385347875926518))
            )))))))
            (let
             ((tmp%%$4 (nClip (Add (vstd!seq.Seq.len.? $ CHAR (Poly%vstd!seq.Seq<char.>. s1!)) (vstd!seq.Seq.len.?
                  $ CHAR (vstd!view.View.view.? $ STRSLICE (Poly%strslice%. (vstd!string.new_strlit_spec.?
                     (Poly%strslice%. (str%new_strlit 5388136328217397110659312206446935086729223426505375089767442509753233922224321551999046696882810187485328533041437738437057175209261070078385347875926518))
             ))))))))
             (and
              (and
               (= (vstd!seq.Seq.len.? $ CHAR (Poly%vstd!seq.Seq<char.>. str1@)) tmp%%$)
               (= tmp%%$ tmp%%$4)
              )
              (= tmp%%$4 (nClip (Add (vstd!seq.Seq.len.? $ CHAR (Poly%vstd!seq.Seq<char.>. s1!)) 3)))
          ))))
          (and
           (=>
            %%location_label%%4
           ...
           (=>
            ...
            (=>
             %%location_label%%5
             (= (vstd!seq.Seq.len.? $ CHAR (Poly%vstd!seq.Seq<char.>. str1@)) (nClip (Add (vstd!seq.Seq.len.?
                 $ CHAR (Poly%vstd!seq.Seq<char.>. s1!)
                ) 3
        ))))))))
        (=>
         (= (vstd!seq.Seq.len.? $ CHAR (Poly%vstd!seq.Seq<char.>. str1@)) (nClip (Add (vstd!seq.Seq.len.?
          ...
          (=>
           ...
           (=>
            (= tmp%5 (let
              ...
              (let
               ((tmp%%$6 (nClip (Add (vstd!seq.Seq.len.? $ CHAR (Poly%vstd!seq.Seq<char.>. s2!)) (vstd!seq.Seq.len.?
                    $ CHAR (vstd!view.View.view.? $ STRSLICE (Poly%strslice%. (vstd!string.new_strlit_spec.?
                       (Poly%strslice%. (str%new_strlit 978859438434856299649944205888080642458087422378818033532324611655114718767434957729753515648256153334304800913515307878389324195557151612099605921448102))
               ))))))))
               (and
                (and
                 (= (vstd!seq.Seq.len.? $ CHAR (Poly%vstd!seq.Seq<char.>. str2@)) tmp%%$)
                 (= tmp%%$ tmp%%$6)
                )
                (= tmp%%$6 (nClip (Add (vstd!seq.Seq.len.? $ CHAR (Poly%vstd!seq.Seq<char.>. s2!)) 4)))
            ))))
            (and
             (=>
              %%location_label%%6
             ...
             (=>
              ...
              (=>
               %%location_label%%7
               (= (vstd!seq.Seq.len.? $ CHAR (Poly%vstd!seq.Seq<char.>. str2@)) (nClip (Add (vstd!seq.Seq.len.?
                   $ CHAR (Poly%vstd!seq.Seq<char.>. s2!)
                  ) 4
          ))))))))
          (=>
           (= (vstd!seq.Seq.len.? $ CHAR (Poly%vstd!seq.Seq<char.>. str2@)) (nClip (Add (vstd!seq.Seq.len.?
           ...
           (or
            (and
             (=>
              (= (vstd!seq.Seq.len.? $ CHAR (Poly%vstd!seq.Seq<char.>. str2@)) (vstd!seq.Seq.len.?
                $ CHAR (Poly%vstd!seq.Seq<char.>. str1@)
              ))
              (=>
               (= tmp%6 (= (nClip (Add (vstd!seq.Seq.len.? $ CHAR (Poly%vstd!seq.Seq<char.>. s1!)) 3))
                 (nClip (Add (vstd!seq.Seq.len.? $ CHAR (Poly%vstd!seq.Seq<char.>. s2!)) 4))
               ))
               (and
                (=>
                 %%location_label%%8
                ...
                (=>
                 tmp%6
                 (=>
                  (= tmp%7 (ext_eq false (TYPE%vstd!seq.Seq. $ CHAR) (vstd!seq.Seq.add.? $ CHAR (Poly%vstd!seq.Seq<char.>.
                      s1!
                     ) (vstd!view.View.view.? $ STRSLICE (Poly%strslice%. (vstd!string.new_strlit_spec.?
                        (Poly%strslice%. (str%new_strlit 5388136328217397110659312206446935086729223426505375089767442509753233922224321551999046696882810187485328533041437738437057175209261070078385347875926518))
                     )))
                  ...
                  (and
                   ...
                   (=>
                    tmp%7
                    (=>
                     (= tmp%8 (ext_eq false (TYPE%vstd!seq.Seq. $ CHAR) (Poly%vstd!seq.Seq<char.>. str1@)
                       (vstd!seq.Seq.add.? $ CHAR (Poly%vstd!seq.Seq<char.>. s2!) (vstd!view.View.view.? $
                         STRSLICE (Poly%strslice%. (vstd!string.new_strlit_spec.? (Poly%strslice%. (str%new_strlit
                             978859438434856299649944205888080642458087422378818033532324611655114718767434957729753515648256153334304800913515307878389324195557151612099605921448102
                     ))))))))
                     (and
                      ...
                      (=>
                       tmp%8
                       (=>
                        (= tmp%9 (ext_eq false (TYPE%vstd!seq.Seq. $ CHAR) (Poly%vstd!seq.Seq<char.>. str1@)
                          (vstd!seq.Seq.add.? $ CHAR (Poly%vstd!seq.Seq<char.>. s1!) (vstd!view.View.view.? $
                            STRSLICE (Poly%strslice%. (vstd!string.new_strlit_spec.? (Poly%strslice%. (str%new_strlit
                                5388136328217397110659312206446935086729223426505375089767442509753233922224321551999046696882810187485328533041437738437057175209261070078385347875926518
                        ))))))))
                         ...
                         (=>
                          ...
                          (=>
                           ...
                           (=>
                            ...
                            (=>
                             (= tmp%10 (= (%I (vstd!seq.Seq.index.? $ CHAR (Poly%vstd!seq.Seq<char.>. str2@) (I (Sub
                                   (vstd!seq.Seq.len.? $ CHAR (Poly%vstd!seq.Seq<char.>. str2@)) 1
                                )))
                               ) 101
                             ))
                             (and
                              ...
                              (=>
                               tmp%10
                               (=>
                                (= tmp%11 (= (%I (vstd!seq.Seq.index.? $ CHAR (Poly%vstd!seq.Seq<char.>. str2@) (I (Sub
                                      (vstd!seq.Seq.len.? $ CHAR (Poly%vstd!seq.Seq<char.>. str2@)) 1
                                   )))
                                  ) 98
                                ))
             ...
             (=>
              (not (= (vstd!seq.Seq.len.? $ CHAR (Poly%vstd!seq.Seq<char.>. str2@)) (vstd!seq.Seq.len.?
                 $ CHAR (Poly%vstd!seq.Seq<char.>. str1@)
              )))
              %%switch_label%%0
            ))
            (and
             ...
             (=>
              %%location_label%%15
              (not (= (vstd!seq.Seq.add.? $ CHAR (Poly%vstd!seq.Seq<char.>. s1!) (vstd!view.View.view.?
                  $ STRSLICE (Poly%strslice%. (vstd!string.new_strlit_spec.? (Poly%strslice%. (str%new_strlit
                      5388136328217397110659312206446935086729223426505375089767442509753233922224321551999046696882810187485328533041437738437057175209261070078385347875926518
                 )))))
                ) (vstd!seq.Seq.add.? $ CHAR (Poly%vstd!seq.Seq<char.>. s2!) (vstd!view.View.view.?
