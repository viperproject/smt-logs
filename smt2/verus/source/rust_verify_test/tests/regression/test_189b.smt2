...
(declare-const fuel%test_crate!different_set. FuelId)
...
(assert
 (distinct fuel%vstd!set.axiom_set_empty. fuel%vstd!set.axiom_set_insert_same. fuel%vstd!set.axiom_set_insert_different.
  fuel%vstd!set.axiom_set_ext_equal. fuel%vstd!set.axiom_set_ext_equal_deep. fuel%test_crate!different_set.
...
(assert
 (forall ((x vstd!set.Set<i32.>.)) (!
   (= x (%Poly%vstd!set.Set<i32.>. (Poly%vstd!set.Set<i32.>. x)))
   :pattern ((Poly%vstd!set.Set<i32.>. x))
   :qid internal_vstd__set__Set<i32.>_box_axiom_definition
   :skolemid skolem_internal_vstd__set__Set<i32.>_box_axiom_definition
)))
(assert
 (forall ((x Poly)) (!
   (=>
    (has_type x (TYPE%vstd!set.Set. $ (SINT 32)))
    (= x (Poly%vstd!set.Set<i32.>. (%Poly%vstd!set.Set<i32.>. x)))
   )
   :pattern ((has_type x (TYPE%vstd!set.Set. $ (SINT 32))))
   :qid internal_vstd__set__Set<i32.>_unbox_axiom_definition
   :skolemid skolem_internal_vstd__set__Set<i32.>_unbox_axiom_definition
)))
(assert
 (forall ((x vstd!set.Set<i32.>.)) (!
   (has_type (Poly%vstd!set.Set<i32.>. x) (TYPE%vstd!set.Set. $ (SINT 32)))
   :pattern ((has_type (Poly%vstd!set.Set<i32.>. x) (TYPE%vstd!set.Set. $ (SINT 32))))
   :qid internal_vstd__set__Set<i32.>_has_type_always_definition
   :skolemid skolem_internal_vstd__set__Set<i32.>_has_type_always_definition
)))
(assert
 (forall ((x tuple%0.)) (!
...
;; Function-Decl test_crate::different_set
(declare-fun test_crate!different_set.? (Dcr Type Poly) Poly)
...
;; Function-Axioms test_crate::different_set
(assert
 (fuel_bool_default fuel%test_crate!different_set.)
)
(assert
 (=>
  (fuel_bool fuel%test_crate!different_set.)
  (forall ((V&. Dcr) (V& Type) (s! Poly)) (!
    (= (test_crate!different_set.? V&. V& s!) s!)
    :pattern ((test_crate!different_set.? V&. V& s!))
    :qid internal_test_crate!different_set.?_definition
    :skolemid skolem_internal_test_crate!different_set.?_definition
))))
(assert
 (forall ((V&. Dcr) (V& Type) (s! Poly)) (!
   (=>
    (has_type s! (TYPE%vstd!set.Set. V&. V&))
    (has_type (test_crate!different_set.? V&. V& s!) (TYPE%vstd!set.Set. V&. V&))
   )
   :pattern ((test_crate!different_set.? V&. V& s!))
   :qid internal_test_crate!different_set.?_pre_post_definition
   :skolemid skolem_internal_test_crate!different_set.?_pre_post_definition
)))

;; Function-Def test_crate::test_sets_1
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/regression-491396d30b1dad7a-test_189b/test.rs:19:7: 19:23 (#0)
(get-info :all-statistics)
(push)
 (declare-const no%param Int)
 (declare-const tmp%1 Bool)
 (declare-const s1@ vstd!set.Set<i32.>.)
 (assert
  fuel_defaults
 )
 ;; assertion failed
 ...
 (assert
  (not (=>
    (= s1@ (%Poly%vstd!set.Set<i32.>. (vstd!set.impl&%0.insert.? $ (SINT 32) (vstd!set.impl&%0.empty.?
        $ (SINT 32)
       ) (I 1)
    )))
    (=>
     (= tmp%1 (not (vstd!set.impl&%0.contains.? $ (SINT 32) (test_crate!different_set.? $
         (SINT 32) (vstd!set.impl&%0.empty.? $ (SINT 32))
        ) (I 1)
     )))
     (and
      (=>
      ...
      (=>
       ...
       (=>
        ...
        (exists ((s3$ Poly)) (!
          (and
           (has_type s3$ (TYPE%vstd!set.Set. $ (SINT 32)))
           (not (= (%Poly%vstd!set.Set<i32.>. (test_crate!different_set.? $ (SINT 32) s3$)) s1@))
          )
          :pattern ((test_crate!different_set.? $ (SINT 32) s3$))
          :qid user_test_crate__test_sets_1_6
          :skolemid skolem_user_test_crate__test_sets_1_6
 )))))))))
 (get-info :version)
