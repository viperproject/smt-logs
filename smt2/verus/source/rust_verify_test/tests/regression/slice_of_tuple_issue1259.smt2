...
(assert
 (distinct fuel%vstd!raw_ptr.impl&%4.view. fuel%vstd!raw_ptr.ptrs_mut_eq. fuel%vstd!seq.impl&%0.spec_index.
  ...
  fuel%vstd!slice.axiom_spec_len. fuel%vstd!view.impl&%0.view. fuel%vstd!view.impl&%2.view.
  fuel%vstd!view.impl&%4.view. fuel%vstd!view.impl&%6.view. fuel%vstd!view.impl&%10.view.
  fuel%vstd!view.impl&%12.view. fuel%vstd!view.impl&%18.view. fuel%vstd!view.impl&%20.view.
...
(declare-sort slice%<tuple%2<u32./u32.>.>. 0)
...
(declare-fun Poly%slice%<tuple%2<u32./u32.>.>. (slice%<tuple%2<u32./u32.>.>.) Poly)
(declare-fun %Poly%slice%<tuple%2<u32./u32.>.>. (Poly) slice%<tuple%2<u32./u32.>.>.)
...
(assert
 (forall ((x slice%<tuple%2<u32./u32.>.>.)) (!
   (= x (%Poly%slice%<tuple%2<u32./u32.>.>. (Poly%slice%<tuple%2<u32./u32.>.>. x)))
   :pattern ((Poly%slice%<tuple%2<u32./u32.>.>. x))
   :qid internal_crate__slice__<tuple__2<u32./u32.>.>_box_axiom_definition
   :skolemid skolem_internal_crate__slice__<tuple__2<u32./u32.>.>_box_axiom_definition
)))
(assert
 (forall ((x Poly)) (!
   (=>
    (has_type x (SLICE $ (TYPE%tuple%2. $ (UINT 32) $ (UINT 32))))
    (= x (Poly%slice%<tuple%2<u32./u32.>.>. (%Poly%slice%<tuple%2<u32./u32.>.>. x)))
   )
   :pattern ((has_type x (SLICE $ (TYPE%tuple%2. $ (UINT 32) $ (UINT 32)))))
   :qid internal_crate__slice__<tuple__2<u32./u32.>.>_unbox_axiom_definition
   :skolemid skolem_internal_crate__slice__<tuple__2<u32./u32.>.>_unbox_axiom_definition
)))
(assert
 (forall ((x slice%<tuple%2<u32./u32.>.>.)) (!
   (has_type (Poly%slice%<tuple%2<u32./u32.>.>. x) (SLICE $ (TYPE%tuple%2. $ (UINT 32)
      $ (UINT 32)
   )))
   :pattern ((has_type (Poly%slice%<tuple%2<u32./u32.>.>. x) (SLICE $ (TYPE%tuple%2. $ (
        UINT 32
       ) $ (UINT 32)
   ))))
   :qid internal_crate__slice__<tuple__2<u32./u32.>.>_has_type_always_definition
   :skolemid skolem_internal_crate__slice__<tuple__2<u32./u32.>.>_has_type_always_definition
)))
(assert
...
(assert
 (=>
  ...
  (forall ((T&. Dcr) (T& Type) (slice! Poly)) (!
    ...
    :pattern ((vstd!slice.spec_slice_len.? T&. T& slice!))
    :qid user_vstd__slice__axiom_spec_len_6
    :skolemid skolem_user_vstd__slice__axiom_spec_len_6
))))
...
;; Function-Specs test_crate::run
(declare-fun req%test_crate!run. (slice%<tuple%2<u32./u32.>.>.) Bool)
(declare-const %%global_location_label%%3 Bool)
(assert
 (forall ((val! slice%<tuple%2<u32./u32.>.>.)) (!
   (= (req%test_crate!run. val!) (=>
     %%global_location_label%%3
     (> (vstd!slice.spec_slice_len.? $ (TYPE%tuple%2. $ (UINT 32) $ (UINT 32)) (Poly%slice%<tuple%2<u32./u32.>.>.
        val!
       )
      ) 0
   )))
   :pattern ((req%test_crate!run. val!))
   :qid internal_req__test_crate!run._definition
   :skolemid skolem_internal_req__test_crate!run._definition
)))
(declare-fun ens%test_crate!run. (slice%<tuple%2<u32./u32.>.>. Int) Bool)
(assert
 (forall ((val! slice%<tuple%2<u32./u32.>.>.) (%return! Int)) (!
   (= (ens%test_crate!run. val! %return!) (uInv 64 %return!))
   :pattern ((ens%test_crate!run. val! %return!))
   :qid internal_ens__test_crate!run._definition
   :skolemid skolem_internal_ens__test_crate!run._definition
)))

;; Function-Def test_crate::run
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/regression-491396d30b1dad7a-slice_of_tuple_issue1259/test.rs:16:1: 16:38 (#0)
(get-info :all-statistics)
(push)
 (declare-const %return! Int)
 (declare-const val! slice%<tuple%2<u32./u32.>.>.)
 ...
 (assert
  (not (and
    (=>
     %%location_label%%0
     (req%vstd!slice.slice_index_get. $ (TYPE%tuple%2. $ (UINT 32) $ (UINT 32)) (Poly%slice%<tuple%2<u32./u32.>.>.
       val!
      ) 0
    ))
    (=>
     (ens%vstd!slice.slice_index_get. $ (TYPE%tuple%2. $ (UINT 32) $ (UINT 32)) (Poly%slice%<tuple%2<u32./u32.>.>.
       val!
      ) 0 tmp%1
     )
     (and
      ...
      (=>
       ...
       (=>
        %%location_label%%2
        (uInv 64 (Add (uClip 64 (%I (tuple%2./tuple%2/0 (%Poly%tuple%2. tmp%1)))) (uClip 64
           (%I (tuple%2./tuple%2/1 (%Poly%tuple%2. tmp%2)))
 ))))))))))
 (get-info :version)
