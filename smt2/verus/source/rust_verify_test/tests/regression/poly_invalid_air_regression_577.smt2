...
(assert
 (distinct fuel%vstd!raw_ptr.impl&%4.view. fuel%vstd!raw_ptr.ptrs_mut_eq. fuel%vstd!seq.impl&%0.spec_index.
  fuel%vstd!seq.axiom_seq_index_decreases. fuel%vstd!seq.axiom_seq_empty. fuel%vstd!seq.axiom_seq_ext_equal.
  fuel%vstd!seq.axiom_seq_ext_equal_deep. fuel%vstd!view.impl&%0.view. fuel%vstd!view.impl&%2.view.
...
(declare-datatypes ((vstd!raw_ptr.Metadata. 0) (vstd!raw_ptr.PtrData. 0) (test_crate!Bar.
   0
  ) (tuple%0. 0)
  ...
  ) ((test_crate!Bar./Bar (test_crate!Bar./Bar/?vec alloc!vec.Vec<u8./allocator_global%.>.)
    (test_crate!Bar./Bar/?field0 Int)
   )
  ) ((tuple%0./tuple%0))
))
...
(declare-fun test_crate!Bar./Bar/vec (test_crate!Bar.) alloc!vec.Vec<u8./allocator_global%.>.)
(declare-fun test_crate!Bar./Bar/field0 (test_crate!Bar.) Int)
...
(declare-const TYPE%test_crate!Bar. Type)
...
(declare-fun Poly%test_crate!Bar. (test_crate!Bar.) Poly)
(declare-fun %Poly%test_crate!Bar. (Poly) test_crate!Bar.)
...
(assert
 (forall ((x test_crate!Bar.)) (!
   (= x (%Poly%test_crate!Bar. (Poly%test_crate!Bar. x)))
   :pattern ((Poly%test_crate!Bar. x))
   :qid internal_test_crate__Bar_box_axiom_definition
   :skolemid skolem_internal_test_crate__Bar_box_axiom_definition
)))
(assert
 (forall ((x Poly)) (!
   (=>
    (has_type x TYPE%test_crate!Bar.)
    (= x (Poly%test_crate!Bar. (%Poly%test_crate!Bar. x)))
   )
   :pattern ((has_type x TYPE%test_crate!Bar.))
   :qid internal_test_crate__Bar_unbox_axiom_definition
   :skolemid skolem_internal_test_crate__Bar_unbox_axiom_definition
)))
(assert
 (forall ((_vec! alloc!vec.Vec<u8./allocator_global%.>.) (_field0! Int)) (!
   (=>
    (uInv 8 _field0!)
    (has_type (Poly%test_crate!Bar. (test_crate!Bar./Bar _vec! _field0!)) TYPE%test_crate!Bar.)
   )
   :pattern ((has_type (Poly%test_crate!Bar. (test_crate!Bar./Bar _vec! _field0!)) TYPE%test_crate!Bar.))
   :qid internal_test_crate!Bar./Bar_constructor_definition
   :skolemid skolem_internal_test_crate!Bar./Bar_constructor_definition
)))
(assert
 (forall ((x test_crate!Bar.)) (!
   (= (test_crate!Bar./Bar/vec x) (test_crate!Bar./Bar/?vec x))
   :pattern ((test_crate!Bar./Bar/vec x))
   :qid internal_test_crate!Bar./Bar/vec_accessor_definition
   :skolemid skolem_internal_test_crate!Bar./Bar/vec_accessor_definition
)))
(assert
 (forall ((x test_crate!Bar.)) (!
   (= (test_crate!Bar./Bar/field0 x) (test_crate!Bar./Bar/?field0 x))
   :pattern ((test_crate!Bar./Bar/field0 x))
   :qid internal_test_crate!Bar./Bar/field0_accessor_definition
   :skolemid skolem_internal_test_crate!Bar./Bar/field0_accessor_definition
)))
(assert
 (forall ((x Poly)) (!
   (=>
    (has_type x TYPE%test_crate!Bar.)
    (uInv 8 (test_crate!Bar./Bar/field0 (%Poly%test_crate!Bar. x)))
   )
   :pattern ((test_crate!Bar./Bar/field0 (%Poly%test_crate!Bar. x)) (has_type x TYPE%test_crate!Bar.))
   :qid internal_test_crate!Bar./Bar/field0_invariant_definition
   :skolemid skolem_internal_test_crate!Bar./Bar/field0_invariant_definition
)))
(assert
 (forall ((x tuple%0.)) (!
...
(declare-fun tr_bound%test_crate!Foo. (Dcr Type) Bool)
(assert
...
(assert
 (forall ((Self%&. Dcr) (Self%& Type)) (!
   true
   :pattern ((tr_bound%test_crate!Foo. Self%&. Self%&))
   :qid internal_test_crate__Foo_trait_type_bounds_definition
   :skolemid skolem_internal_test_crate__Foo_trait_type_bounds_definition
)))
...
;; Function-Specs test_crate::Foo::do_something
(declare-fun ens%test_crate!Foo.do_something. (Dcr Type Poly Poly Poly) Bool)
(assert
 (forall ((Self%&. Dcr) (Self%& Type) (pre%self! Poly) (self! Poly) (val! Poly)) (!
   (= (ens%test_crate!Foo.do_something. Self%&. Self%& pre%self! self! val!) (has_type
     self! Self%&
   ))
   :pattern ((ens%test_crate!Foo.do_something. Self%&. Self%& pre%self! self! val!))
   :qid internal_ens__test_crate!Foo.do_something._definition
   :skolemid skolem_internal_ens__test_crate!Foo.do_something._definition
)))
...
;; Function-Def test_crate::Bar::do_something
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/regression-491396d30b1dad7a-poly_invalid_air_regression_577/test.rs:36:5: 36:40 (#0)
...
(push)
 ...
 (assert
  (has_type self!@0 TYPE%test_crate!Bar.)
 )
 (assert
  (has_type val! (UINT 8))
 )
...
;; Trait-Impl-Axiom
(assert
 (tr_bound%test_crate!Foo. $ TYPE%test_crate!Bar.)
)

;; Function-Specs test_crate::Bar::new
(declare-fun ens%test_crate!impl&%0.new. (Int test_crate!Bar.) Bool)
(assert
 (forall ((no%param Int) (%return! test_crate!Bar.)) (!
   (= (ens%test_crate!impl&%0.new. no%param %return!) (has_type (Poly%test_crate!Bar. %return!)
     TYPE%test_crate!Bar.
   ))
   :pattern ((ens%test_crate!impl&%0.new. no%param %return!))
   :qid internal_ens__test_crate!impl&__0.new._definition
   :skolemid skolem_internal_ens__test_crate!impl&__0.new._definition
)))

;; Function-Def test_crate::Bar::new
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/regression-491396d30b1dad7a-poly_invalid_air_regression_577/test.rs:27:5: 27:21 (#0)
(get-info :all-statistics)
(push)
 (declare-const %return! test_crate!Bar.)
