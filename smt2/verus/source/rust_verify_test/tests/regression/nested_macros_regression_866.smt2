...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/regression-491396d30b1dad7a-nested_macros_regression_866/test.rs:19:13: 19:21 (#10)
 ...
 (assert
  (not (=>
    (= tmp%1 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 64)) (vstd!view.View.view.? $ (ARRAY
        $ (UINT 64) $ (CONST_INT 2)
       ) (array_new $ (UINT 64) 2 (%%array%%0 (I 1) (I 2)))
      ) (vstd!view.View.view.? $ (ARRAY $ (UINT 64) $ (CONST_INT 2)) (array_new $ (UINT 64)
        2 (%%array%%0 (I 1) (I 2))
    ))))
    (and
     (=>
     ...
     (=>
      tmp%1
      (=>
       (= tmp%2 (ext_eq true (TYPE%vstd!seq.Seq. $ (UINT 64)) (vstd!view.View.view.? $ (ARRAY
           $ (UINT 64) $ (CONST_INT 2)
          ) (array_new $ (UINT 64) 2 (%%array%%0 (I 1) (I 2)))
         ) (vstd!view.View.view.? $ (ARRAY $ (UINT 64) $ (CONST_INT 2)) (array_new $ (UINT 64)
           2 (%%array%%0 (I 1) (I 2))
       ...
       (and
        ...
        (=>
         tmp%2
         (=>
          (= tmp%3 (not (ext_eq false BOOL (B false) (B true))))
          (and
           (=>
            %%location_label%%2
            tmp%3
           ...
           (=>
            tmp%3
            (=>
             (= tmp%4 (not (ext_eq true BOOL (B false) (B true))))
             (=>
              %%location_label%%3
              tmp%4
 )))))))))))))
