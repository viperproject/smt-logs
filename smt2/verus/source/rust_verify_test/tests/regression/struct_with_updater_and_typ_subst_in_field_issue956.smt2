...
;; Datatypes
(declare-datatypes ((X. 0) (tuple%0. 0)) (((X./X (X./X/?a Int) (X./X/?b Poly))) ((tuple%0./tuple%0))))
...
(assert
 (forall ((T&. Dcr) (T& Type) (_a! Int) (_b! Poly)) (!
   (=>
    (has_type _b! T&)
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/regression-491396d30b1dad7a-struct_with_updater_and_typ_subst_in_field_issue956/test.rs:20:7: 20:27 (#0)
