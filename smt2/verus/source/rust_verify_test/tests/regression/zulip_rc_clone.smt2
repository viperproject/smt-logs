...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/regression-491396d30b1dad7a-zulip_rc_clone/test.rs:18:1: 18:25 (#0)
(get-info :all-statistics)
(push)
 (declare-const rc! alloc!vec.Vec<u8./allocator_global%.>.)
 (declare-const rc2@ alloc!vec.Vec<u8./allocator_global%.>.)
 (assert
  fuel_defaults
 )
 (assert
