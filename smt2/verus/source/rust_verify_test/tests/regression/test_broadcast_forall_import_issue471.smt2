...
(assert
 (distinct fuel%vstd!seq.impl&%0.spec_index. fuel%vstd!seq.axiom_seq_index_decreases.
  fuel%vstd!seq.axiom_seq_ext_equal. fuel%vstd!seq.axiom_seq_ext_equal_deep. fuel%vstd!seq_lib.impl&%0.contains.
  fuel%vstd!seq_lib.impl&%0.to_set. fuel%vstd!seq_lib.seq_to_set_is_finite. fuel%vstd!set.axiom_set_new.
  fuel%vstd!set.axiom_set_ext_equal. fuel%vstd!set.axiom_set_ext_equal_deep. fuel%vstd!array.group_array_axioms.
...
(assert
 (=>
  ...
  (fuel_bool_default fuel%vstd!seq_lib.seq_to_set_is_finite.)
))
(assert
 (=>
...
(assert
 (forall ((x vstd!set.Set<usize.>.)) (!
   (= x (%Poly%vstd!set.Set<usize.>. (Poly%vstd!set.Set<usize.>. x)))
   :pattern ((Poly%vstd!set.Set<usize.>. x))
   :qid internal_vstd__set__Set<usize.>_box_axiom_definition
   :skolemid skolem_internal_vstd__set__Set<usize.>_box_axiom_definition
)))
(assert
 (forall ((x Poly)) (!
   (=>
    (has_type x (TYPE%vstd!set.Set. $ (UINT SZ)))
    (= x (Poly%vstd!set.Set<usize.>. (%Poly%vstd!set.Set<usize.>. x)))
   )
   :pattern ((has_type x (TYPE%vstd!set.Set. $ (UINT SZ))))
   :qid internal_vstd__set__Set<usize.>_unbox_axiom_definition
   :skolemid skolem_internal_vstd__set__Set<usize.>_unbox_axiom_definition
)))
(assert
 (forall ((x vstd!set.Set<usize.>.)) (!
   (has_type (Poly%vstd!set.Set<usize.>. x) (TYPE%vstd!set.Set. $ (UINT SZ)))
   :pattern ((has_type (Poly%vstd!set.Set<usize.>. x) (TYPE%vstd!set.Set. $ (UINT SZ))))
   :qid internal_vstd__set__Set<usize.>_has_type_always_definition
   :skolemid skolem_internal_vstd__set__Set<usize.>_has_type_always_definition
)))
(assert
 (forall ((x tuple%0.)) (!
 ...
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (self! Poly) (needle! Poly)) (!
    (= (vstd!seq_lib.impl&%0.contains.? A&. A& self! needle!) (exists ((i$ Poly)) (!
       ...
       :pattern ((vstd!seq.Seq.index.? A&. A& self! i$))
       :qid user_vstd__seq_lib__impl&%0__contains_5
       :skolemid skolem_user_vstd__seq_lib__impl&%0__contains_5
    )))
...
;; Broadcast vstd::seq_lib::seq_to_set_is_finite
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (seq! Poly)) (!
    ...
    :qid user_vstd__seq_lib__seq_to_set_is_finite_6
    :skolemid skolem_user_vstd__seq_lib__seq_to_set_is_finite_6
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (f! Poly) (a! Poly)) (!
    ...
    :qid user_vstd__set__axiom_set_new_7
    :skolemid skolem_user_vstd__set__axiom_set_new_7
))))
...
;; Function-Def test_crate::weird_broadcast_failure
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/regression-491396d30b1dad7a-test_broadcast_forall_import_issue471/test.rs:7:7: 7:49 (#0)
...
(push)
 ...
 (assert
  (not (=>
    (= tmp%1 (vstd!set.impl&%0.finite.? $ (UINT SZ) (vstd!seq_lib.impl&%0.to_set.? $ (UINT
        SZ
       ) (Poly%vstd!seq.Seq<usize.>. seq!)
    )))
    (=>
     %%location_label%%0
     tmp%1
