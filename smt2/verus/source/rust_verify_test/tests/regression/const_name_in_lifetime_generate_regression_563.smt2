...
;; Fuel
(declare-const fuel%test_crate!CONST_VALUE. FuelId)
...
(assert
 (distinct fuel%test_crate!CONST_VALUE. fuel%vstd!array.group_array_axioms. fuel%vstd!map.group_map_axioms.
...
;; Function-Decl test_crate::CONST_VALUE
(declare-fun test_crate!CONST_VALUE.? () Int)
...
;; Function-Def test_crate::CONST_VALUE
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/regression-491396d30b1dad7a-const_name_in_lifetime_generate_regression_563/test.rs:15:1: 15:38 (#0)
...
;; Function-Axioms test_crate::CONST_VALUE
(assert
 (fuel_bool_default fuel%test_crate!CONST_VALUE.)
)
(assert
 (=>
  (fuel_bool fuel%test_crate!CONST_VALUE.)
  (= test_crate!CONST_VALUE.? 32)
))
(assert
 (<= 0 test_crate!CONST_VALUE.?)
)

;; Function-Def test_crate::Data::foo
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/regression-491396d30b1dad7a-const_name_in_lifetime_generate_regression_563/test.rs:19:11: 19:23 (#0)
(get-info :all-statistics)
(push)
 (declare-const self! test_crate!Data.)
 ...
 (assert
  (not (=>
    (= value@ test_crate!CONST_VALUE.?)
    (or
     (and
      (=>
       (>= (%I (vstd!pervasive.arbitrary.? $ NAT)) value@)
       %%switch_label%%0
      )
      (=>
       (not (>= (%I (vstd!pervasive.arbitrary.? $ NAT)) value@))
       %%switch_label%%0
     ))
     (not %%switch_label%%0)
 ))))
