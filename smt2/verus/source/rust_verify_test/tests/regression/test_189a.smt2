...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/regression-491396d30b1dad7a-test_189a/test.rs:17:7: 17:23 (#0)
...
(push)
 ...
 (declare-const s2@ vstd!set.Set<i32.>.)
 (assert
  fuel_defaults
 )
 ;; assertion failed
 ...
 (assert
  (not (=>
    ...
    (=>
     (= s2@ (%Poly%vstd!set.Set<i32.>. (vstd!set.impl&%0.empty.? $ (SINT 32))))
     (=>
      (= tmp%1 (not (vstd!set.impl&%0.contains.? $ (SINT 32) (Poly%vstd!set.Set<i32.>. s2@)
         (I 1)
      )))
      (and
       (=>
