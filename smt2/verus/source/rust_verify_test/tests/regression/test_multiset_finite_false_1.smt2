...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/regression-491396d30b1dad7a-test_multiset_finite_false_1/test.rs:16:7: 16:36 (#0)
    ...
    (=>
     ...
     (and
      ...
      (=>
       tmp%1
       (=>
        (= tmp%2 (not (vstd!set.impl&%0.finite.? $ NAT (vstd!multiset.impl&%0.dom.? $ NAT (Poly%vstd!multiset.Multiset<nat.>.
             m@
        )))))
        (=>
         %%location_label%%1
