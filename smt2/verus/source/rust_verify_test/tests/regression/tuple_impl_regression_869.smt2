...
(declare-fun proj%%Tau./T (Dcr Type) Dcr)
(declare-fun proj%Tau./T (Dcr Type) Type)

;; Datatypes
(declare-datatypes ((tuple%0. 0) (tuple%2. 0) (tuple%3. 0)) (((tuple%0./tuple%0)) (
...
;; Traits
(declare-fun tr_bound%Tau. (Dcr Type) Bool)
(assert
 (forall ((Self%&. Dcr) (Self%& Type)) (!
   true
   :pattern ((tr_bound%Tau. Self%&. Self%&))
   :qid internal_crate__Tau_trait_type_bounds_definition
   :skolemid skolem_internal_crate__Tau_trait_type_bounds_definition
)))

;; Associated-Type-Impls
(assert
 (forall ((A&. Dcr) (A& Type) (B&. Dcr) (B& Type)) (!
   (= (proj%%Tau./T $ (TYPE%tuple%2. A&. A& B&. B&)) $)
   :pattern ((proj%%Tau./T $ (TYPE%tuple%2. A&. A& B&. B&)))
   :qid internal_proj____Tau./T_assoc_type_impl_true_definition
   :skolemid skolem_internal_proj____Tau./T_assoc_type_impl_true_definition
)))
(assert
 (forall ((A&. Dcr) (A& Type) (B&. Dcr) (B& Type)) (!
   (= (proj%Tau./T $ (TYPE%tuple%2. A&. A& B&. B&)) BOOL)
   :pattern ((proj%Tau./T $ (TYPE%tuple%2. A&. A& B&. B&)))
   :qid internal_proj__Tau./T_assoc_type_impl_false_definition
   :skolemid skolem_internal_proj__Tau./T_assoc_type_impl_false_definition
)))
(assert
 (forall ((A&. Dcr) (A& Type) (B&. Dcr) (B& Type) (C&. Dcr) (C& Type)) (!
   (= (proj%%Tau./T $ (TYPE%tuple%3. A&. A& B&. B& C&. C&)) $)
   :pattern ((proj%%Tau./T $ (TYPE%tuple%3. A&. A& B&. B& C&. C&)))
   :qid internal_proj____Tau./T_assoc_type_impl_true_definition
   :skolemid skolem_internal_proj____Tau./T_assoc_type_impl_true_definition
)))
(assert
 (forall ((A&. Dcr) (A& Type) (B&. Dcr) (B& Type) (C&. Dcr) (C& Type)) (!
   (= (proj%Tau./T $ (TYPE%tuple%3. A&. A& B&. B& C&. C&)) BOOL)
   :pattern ((proj%Tau./T $ (TYPE%tuple%3. A&. A& B&. B& C&. C&)))
   :qid internal_proj__Tau./T_assoc_type_impl_false_definition
   :skolemid skolem_internal_proj__Tau./T_assoc_type_impl_false_definition
)))

;; Function-Specs crate::Tau::foo
(declare-fun ens%Tau.foo. (Dcr Type Poly) Bool)
(assert
 (forall ((Self%&. Dcr) (Self%& Type) (%return! Poly)) (!
   (= (ens%Tau.foo. Self%&. Self%& %return!) (has_type %return! (proj%Tau./T Self%&. Self%&)))
   :pattern ((ens%Tau.foo. Self%&. Self%& %return!))
   :qid internal_ens__Tau.foo._definition
   :skolemid skolem_internal_ens__Tau.foo._definition
)))

;; Function-Def crate::impl&%0::foo
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/regression-491396d30b1dad7a-tuple_impl_regression_869/test.rs:21:5: 21:21 (#0)
...
(assert
 (forall ((A&. Dcr) (A& Type) (B&. Dcr) (B& Type)) (!
   (tr_bound%Tau. $ (TYPE%tuple%2. A&. A& B&. B&))
   :pattern ((tr_bound%Tau. $ (TYPE%tuple%2. A&. A& B&. B&)))
   :qid internal_crate__impl&__0_trait_impl_definition
   :skolemid skolem_internal_crate__impl&__0_trait_impl_definition
)))

;; Function-Def crate::impl&%1::foo
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/regression-491396d30b1dad7a-tuple_impl_regression_869/test.rs:26:5: 26:21 (#0)
(get-info :all-statistics)
(push)
 (declare-const A&. Dcr)
 (declare-const A& Type)
...
(assert
 (forall ((A&. Dcr) (A& Type) (B&. Dcr) (B& Type) (C&. Dcr) (C& Type)) (!
   (tr_bound%Tau. $ (TYPE%tuple%3. A&. A& B&. B& C&. C&))
   :pattern ((tr_bound%Tau. $ (TYPE%tuple%3. A&. A& B&. B& C&. C&)))
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/regression-491396d30b1dad7a-tuple_impl_regression_869/test.rs:31:1: 31:10 (#0)
(get-info :all-statistics)
(push)
