...
(declare-fun tr_bound%test_crate!m2.B. (Dcr Type Dcr Type) Bool)
(assert
...
(assert
 (forall ((Self%&. Dcr) (Self%& Type) (T&. Dcr) (T& Type)) (!
   (=>
    (tr_bound%test_crate!m2.B. Self%&. Self%& T&. T&)
    (tr_bound%vstd!view.View. T&. T&)
   )
   :pattern ((tr_bound%test_crate!m2.B. Self%&. Self%& T&. T&))
   :qid internal_test_crate__m2__B_trait_type_bounds_definition
   :skolemid skolem_internal_test_crate__m2__B_trait_type_bounds_definition
)))
...
;; Function-Decl test_crate::m2::B::b1
(declare-fun test_crate!m2.B.b1.? (Dcr Type Dcr Type Poly) Poly)
(declare-fun test_crate!m2.B.b1%default%.? (Dcr Type Dcr Type Poly) Poly)

;; Function-Decl test_crate::m2::B::b2
(declare-fun test_crate!m2.B.b2.? (Dcr Type Dcr Type Poly) Poly)
(declare-fun test_crate!m2.B.b2%default%.? (Dcr Type Dcr Type Poly) Poly)
...
;; Function-Axioms test_crate::m2::B::b1
(assert
 (forall ((Self%&. Dcr) (Self%& Type) (T&. Dcr) (T& Type) (t! Poly)) (!
   (=>
    (has_type t! T&)
    (has_type (test_crate!m2.B.b1.? Self%&. Self%& T&. T& t!) BOOL)
   )
   :pattern ((test_crate!m2.B.b1.? Self%&. Self%& T&. T& t!))
   :qid internal_test_crate!m2.B.b1.?_pre_post_definition
   :skolemid skolem_internal_test_crate!m2.B.b1.?_pre_post_definition
)))

;; Function-Axioms test_crate::m2::B::b2
(assert
 (forall ((Self%&. Dcr) (Self%& Type) (T&. Dcr) (T& Type) (t! Poly)) (!
   (=>
    (has_type t! (proj%vstd!view.View./V T&. T&))
    (has_type (test_crate!m2.B.b2.? Self%&. Self%& T&. T& t!) BOOL)
   )
   :pattern ((test_crate!m2.B.b2.? Self%&. Self%& T&. T& t!))
   :qid internal_test_crate!m2.B.b2.?_pre_post_definition
   :skolemid skolem_internal_test_crate!m2.B.b2.?_pre_post_definition
)))

;; Function-Specs test_crate::m2::B::b_proof
(declare-fun req%test_crate!m2.B.b_proof. (Dcr Type Dcr Type Poly) Bool)
(declare-const %%global_location_label%%0 Bool)
(assert
 (forall ((Self%&. Dcr) (Self%& Type) (T&. Dcr) (T& Type) (t! Poly)) (!
   (= (req%test_crate!m2.B.b_proof. Self%&. Self%& T&. T& t!) (=>
     %%global_location_label%%0
     (%B (test_crate!m2.B.b1.? Self%&. Self%& T&. T& t!))
   ))
   :pattern ((req%test_crate!m2.B.b_proof. Self%&. Self%& T&. T& t!))
   :qid internal_req__test_crate!m2.B.b_proof._definition
   :skolemid skolem_internal_req__test_crate!m2.B.b_proof._definition
)))
(declare-fun ens%test_crate!m2.B.b_proof. (Dcr Type Dcr Type Poly) Bool)
(assert
 (forall ((Self%&. Dcr) (Self%& Type) (T&. Dcr) (T& Type) (t! Poly)) (!
   (= (ens%test_crate!m2.B.b_proof. Self%&. Self%& T&. T& t!) (%B (test_crate!m2.B.b2.?
      Self%&. Self%& T&. T& (vstd!view.View.view.? T&. T& t!)
   )))
   :pattern ((ens%test_crate!m2.B.b_proof. Self%&. Self%& T&. T& t!))
   :qid internal_ens__test_crate!m2.B.b_proof._definition
   :skolemid skolem_internal_ens__test_crate!m2.B.b_proof._definition
)))
