...
(declare-const fuel%test_crate!m3.impl&%0.b1. FuelId)
(declare-const fuel%test_crate!m3.impl&%0.b2. FuelId)
(declare-const fuel%test_crate!m1.impl&%0.view. FuelId)
...
(assert
 (distinct fuel%vstd!raw_ptr.impl&%4.view. fuel%vstd!raw_ptr.ptrs_mut_eq. fuel%vstd!seq.impl&%0.spec_index.
  ...
  fuel%vstd!view.impl&%24.view. fuel%test_crate!m3.impl&%0.b1. fuel%test_crate!m3.impl&%0.b2.
  fuel%test_crate!m1.impl&%0.view. fuel%vstd!array.group_array_axioms. fuel%vstd!map.group_map_axioms.
...
(declare-datatypes ((vstd!raw_ptr.Metadata. 0) (vstd!raw_ptr.PtrData. 0) (test_crate!m3.C.
   0
  ) (test_crate!m0.MyBool. 0) (tuple%0. 0)
  ...
  ) ((test_crate!m3.C./C)) ((test_crate!m0.MyBool./MyBool (test_crate!m0.MyBool./MyBool/?0
     Bool
   ))
  ) ((tuple%0./tuple%0))
))
...
(declare-fun test_crate!m0.MyBool./MyBool/0 (test_crate!m0.MyBool.) Bool)
...
(declare-const TYPE%test_crate!m3.C. Type)
(declare-const TYPE%test_crate!m0.MyBool. Type)
...
(declare-fun Poly%test_crate!m3.C. (test_crate!m3.C.) Poly)
(declare-fun %Poly%test_crate!m3.C. (Poly) test_crate!m3.C.)
(declare-fun Poly%test_crate!m0.MyBool. (test_crate!m0.MyBool.) Poly)
(declare-fun %Poly%test_crate!m0.MyBool. (Poly) test_crate!m0.MyBool.)
...
(assert
 (forall ((x test_crate!m3.C.)) (!
   (= x (%Poly%test_crate!m3.C. (Poly%test_crate!m3.C. x)))
   :pattern ((Poly%test_crate!m3.C. x))
   :qid internal_test_crate__m3__C_box_axiom_definition
   :skolemid skolem_internal_test_crate__m3__C_box_axiom_definition
)))
(assert
 (forall ((x Poly)) (!
   (=>
    (has_type x TYPE%test_crate!m3.C.)
    (= x (Poly%test_crate!m3.C. (%Poly%test_crate!m3.C. x)))
   )
   :pattern ((has_type x TYPE%test_crate!m3.C.))
   :qid internal_test_crate__m3__C_unbox_axiom_definition
   :skolemid skolem_internal_test_crate__m3__C_unbox_axiom_definition
)))
(assert
 (forall ((x test_crate!m3.C.)) (!
   (has_type (Poly%test_crate!m3.C. x) TYPE%test_crate!m3.C.)
   :pattern ((has_type (Poly%test_crate!m3.C. x) TYPE%test_crate!m3.C.))
   :qid internal_test_crate__m3__C_has_type_always_definition
   :skolemid skolem_internal_test_crate__m3__C_has_type_always_definition
)))
(assert
 (forall ((x test_crate!m0.MyBool.)) (!
   (= x (%Poly%test_crate!m0.MyBool. (Poly%test_crate!m0.MyBool. x)))
   :pattern ((Poly%test_crate!m0.MyBool. x))
   :qid internal_test_crate__m0__MyBool_box_axiom_definition
   :skolemid skolem_internal_test_crate__m0__MyBool_box_axiom_definition
)))
(assert
 (forall ((x Poly)) (!
   (=>
    (has_type x TYPE%test_crate!m0.MyBool.)
    (= x (Poly%test_crate!m0.MyBool. (%Poly%test_crate!m0.MyBool. x)))
   )
   :pattern ((has_type x TYPE%test_crate!m0.MyBool.))
   :qid internal_test_crate__m0__MyBool_unbox_axiom_definition
   :skolemid skolem_internal_test_crate__m0__MyBool_unbox_axiom_definition
)))
(assert
 (forall ((x test_crate!m0.MyBool.)) (!
   (= (test_crate!m0.MyBool./MyBool/0 x) (test_crate!m0.MyBool./MyBool/?0 x))
   :pattern ((test_crate!m0.MyBool./MyBool/0 x))
   :qid internal_test_crate!m0.MyBool./MyBool/0_accessor_definition
   :skolemid skolem_internal_test_crate!m0.MyBool./MyBool/0_accessor_definition
)))
(assert
 (forall ((x test_crate!m0.MyBool.)) (!
   (has_type (Poly%test_crate!m0.MyBool. x) TYPE%test_crate!m0.MyBool.)
   :pattern ((has_type (Poly%test_crate!m0.MyBool. x) TYPE%test_crate!m0.MyBool.))
   :qid internal_test_crate__m0__MyBool_has_type_always_definition
   :skolemid skolem_internal_test_crate__m0__MyBool_has_type_always_definition
)))
(assert
 (forall ((x tuple%0.)) (!
...
(assert
 (= (proj%%vstd!view.View./V $ TYPE%test_crate!m0.MyBool.) $)
)
(assert
 (= (proj%vstd!view.View./V $ TYPE%test_crate!m0.MyBool.) BOOL)
)
...
;; Function-Axioms test_crate::m0::MyBool::view
(assert
 (fuel_bool_default fuel%test_crate!m1.impl&%0.view.)
)
(assert
 (=>
  (fuel_bool fuel%test_crate!m1.impl&%0.view.)
  (forall ((self! Poly)) (!
    (= (vstd!view.View.view.? $ TYPE%test_crate!m0.MyBool. self!) (B (test_crate!m0.MyBool./MyBool/0
       (%Poly%test_crate!m0.MyBool. self!)
    )))
    :pattern ((vstd!view.View.view.? $ TYPE%test_crate!m0.MyBool. self!))
    :qid internal_vstd!view.View.view.?_definition
    :skolemid skolem_internal_vstd!view.View.view.?_definition
))))

;; Function-Axioms test_crate::m3::C::b1
(assert
 (fuel_bool_default fuel%test_crate!m3.impl&%0.b1.)
)
(assert
 (=>
  (fuel_bool fuel%test_crate!m3.impl&%0.b1.)
  (forall ((t! Poly)) (!
    (= (test_crate!m2.B.b1.? $ TYPE%test_crate!m3.C. $ TYPE%test_crate!m0.MyBool. t!)
     (B (test_crate!m0.MyBool./MyBool/0 (%Poly%test_crate!m0.MyBool. t!)))
    )
    :pattern ((test_crate!m2.B.b1.? $ TYPE%test_crate!m3.C. $ TYPE%test_crate!m0.MyBool.
      t!
    ))
    :qid internal_test_crate!m2.B.b1.?_definition
    :skolemid skolem_internal_test_crate!m2.B.b1.?_definition
))))

;; Function-Axioms test_crate::m3::C::b2
(assert
 (fuel_bool_default fuel%test_crate!m3.impl&%0.b2.)
)
(assert
 (=>
  (fuel_bool fuel%test_crate!m3.impl&%0.b2.)
  (forall ((t! Poly)) (!
    (= (test_crate!m2.B.b2.? $ TYPE%test_crate!m3.C. $ TYPE%test_crate!m0.MyBool. t!)
     t!
    )
    :pattern ((test_crate!m2.B.b2.? $ TYPE%test_crate!m3.C. $ TYPE%test_crate!m0.MyBool.
      t!
    ))
    :qid internal_test_crate!m2.B.b2.?_definition
    :skolemid skolem_internal_test_crate!m2.B.b2.?_definition
))))
...
;; Trait-Impl-Axiom
(assert
 (tr_bound%vstd!view.View. $ TYPE%test_crate!m0.MyBool.)
)

;; Function-Def test_crate::m3::C::b_proof
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/regression-491396d30b1dad7a-axiom_ordering_patched/test.rs:38:15: 38:47 (#0)
...
(push)
 ...
 (assert
  (has_type t! TYPE%test_crate!m0.MyBool.)
 )
 (assert
  (%B (test_crate!m2.B.b1.? $ TYPE%test_crate!m3.C. $ TYPE%test_crate!m0.MyBool. t!))
 )
 ...
 (assert
  (not (=>
    %%location_label%%0
    (%B (test_crate!m2.B.b2.? $ TYPE%test_crate!m3.C. $ TYPE%test_crate!m0.MyBool. (vstd!view.View.view.?
       $ TYPE%test_crate!m0.MyBool. t!
 ))))))
 (get-info :version)
...
;; Trait-Impl-Axiom
(assert
 (tr_bound%test_crate!m2.B. $ TYPE%test_crate!m3.C. $ TYPE%test_crate!m0.MyBool.)
)
