...
(declare-const fuel%test_crate!m1.aa. FuelId)
...
(assert
 (distinct fuel%vstd!raw_ptr.impl&%4.view. fuel%vstd!raw_ptr.ptrs_mut_eq. fuel%vstd!seq.impl&%0.spec_index.
  ...
  fuel%vstd!view.impl&%24.view. fuel%test_crate!m1.impl&%0.view. fuel%test_crate!m1.aa.
...
(declare-datatypes ((vstd!raw_ptr.Metadata. 0) (vstd!raw_ptr.PtrData. 0) (test_crate!m0.MyBool.
   0
  ) (tuple%0. 0)
  ...
  ) ((test_crate!m0.MyBool./MyBool (test_crate!m0.MyBool./MyBool/?0 Bool))) ((tuple%0./tuple%0))
))
...
;; Function-Decl test_crate::m1::aa
(declare-fun test_crate!m1.aa.? (Dcr Type Poly) Poly)
...
;; Function-Axioms test_crate::m1::aa
(assert
 (fuel_bool_default fuel%test_crate!m1.aa.)
)
(assert
 (=>
  (fuel_bool fuel%test_crate!m1.aa.)
  (forall ((T&. Dcr) (T& Type) (t! Poly)) (!
    (= (test_crate!m1.aa.? T&. T& t!) (vstd!view.View.view.? T&. T& t!))
    :pattern ((test_crate!m1.aa.? T&. T& t!))
    :qid internal_test_crate!m1.aa.?_definition
    :skolemid skolem_internal_test_crate!m1.aa.?_definition
))))
(assert
 (forall ((T&. Dcr) (T& Type) (t! Poly)) (!
   (=>
    (has_type t! T&)
    (has_type (test_crate!m1.aa.? T&. T& t!) (proj%vstd!view.View./V T&. T&))
   )
   :pattern ((test_crate!m1.aa.? T&. T& t!))
   :qid internal_test_crate!m1.aa.?_pre_post_definition
   :skolemid skolem_internal_test_crate!m1.aa.?_pre_post_definition
)))
