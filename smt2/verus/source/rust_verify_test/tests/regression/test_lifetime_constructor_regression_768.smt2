...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/regression-491396d30b1dad7a-test_lifetime_constructor_regression_768/test.rs:16:7: 16:15 (#0)
(get-info :all-statistics)
(push)
 (declare-const no%param Int)
 (declare-const input@ core!option.Option.)
 (assert
  fuel_defaults
 )
 (assert
