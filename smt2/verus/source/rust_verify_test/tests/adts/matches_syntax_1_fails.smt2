...
(declare-const fuel%impl&%0.arrow_Other_v. FuelId)
(assert
 (distinct fuel%impl&%0.arrow_0. fuel%impl&%0.arrow_This_0. fuel%impl&%0.arrow_That_v.
  fuel%impl&%0.arrow_Other_v.
))

;; Datatypes
(declare-datatypes ((S. 0) (tuple%0. 0)) (((S./This (S./This/?0 Int)) (S./That (S./That/?v
     Int
    )
   ) (S./Other (S./Other/?v Int))
  ) ((tuple%0./tuple%0))
))
(declare-fun S./This/0 (S.) Int)
(declare-fun S./That/v (S.) Int)
(declare-fun S./Other/v (S.) Int)
...
(assert
 (forall ((_0! Int)) (!
   (=>
    (<= 0 _0!)
    (has_type (Poly%S. (S./This _0!)) TYPE%S.)
   )
   :pattern ((has_type (Poly%S. (S./This _0!)) TYPE%S.))
...
(assert
 (forall ((x Poly)) (!
   ...
   :pattern ((S./This/0 (%Poly%S. x)) (has_type x TYPE%S.))
   :qid internal_S./This/0_invariant_definition
   :skolemid skolem_internal_S./This/0_invariant_definition
)))
(assert
 (forall ((_v! Int)) (!
   (has_type (Poly%S. (S./That _v!)) TYPE%S.)
   :pattern ((has_type (Poly%S. (S./That _v!)) TYPE%S.))
...
(assert
 (forall ((_v! Int)) (!
   (has_type (Poly%S. (S./Other _v!)) TYPE%S.)
   :pattern ((has_type (Poly%S. (S./Other _v!)) TYPE%S.))
   :qid internal_S./Other_constructor_definition
   :skolemid skolem_internal_S./Other_constructor_definition
)))
(assert
 (forall ((x S.)) (!
   (= (S./Other/v x) (S./Other/?v x))
   :pattern ((S./Other/v x))
   :qid internal_S./Other/v_accessor_definition
   :skolemid skolem_internal_S./Other/v_accessor_definition
)))
(assert
 (forall ((x tuple%0.)) (!
...
;; Function-Decl crate::S::arrow_Other_v
(declare-fun impl&%0.arrow_Other_v.? (Poly) Int)
...
(assert
 (=>
  ...
  (forall ((self! Poly)) (!
    (= (impl&%0.arrow_0.? self!) (S./This/0 (%Poly%S. self!)))
...
(assert
 (=>
  ...
  (forall ((self! Poly)) (!
    (= (impl&%0.arrow_This_0.? self!) (S./This/0 (%Poly%S. self!)))
...
(assert
 (=>
  ...
  (forall ((self! Poly)) (!
    (= (impl&%0.arrow_That_v.? self!) (S./That/v (%Poly%S. self!)))
...
;; Function-Axioms crate::S::arrow_Other_v
(assert
 (fuel_bool_default fuel%impl&%0.arrow_Other_v.)
)
(assert
 (=>
  (fuel_bool fuel%impl&%0.arrow_Other_v.)
  (forall ((self! Poly)) (!
    (= (impl&%0.arrow_Other_v.? self!) (S./Other/v (%Poly%S. self!)))
    :pattern ((impl&%0.arrow_Other_v.? self!))
    :qid internal_impl&__0.arrow_Other_v.?_definition
    :skolemid skolem_internal_impl&__0.arrow_Other_v.?_definition
))))
   ...
   (= (req%test1. t!) (=>
     ...
     (and
      (=>
       (is-S./That t!)
       (let
        ((a$ (S./That/v (%Poly%S. (Poly%S. t!)))))
        (= a$ 3)
      ))
      (=>
       (is-S./This t!)
       (let
        ((v$ (S./This/0 (%Poly%S. (Poly%S. t!)))))
        (= v$ 4)
   )))))
   :pattern ((req%test1. t!))
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/adts-142d23e2e82b3767-matches_syntax_1_fails/test.rs:22:7: 22:21 (#0)
