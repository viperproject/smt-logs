...
;; Datatypes
(declare-datatypes ((Value. 0) (tuple%0. 0)) (((Value./Value (Value./Value/?v Int)))
  ((tuple%0./tuple%0))
))
...
(assert
 (forall ((a! Int) (res! Int)) (!
   (= (ens%add1. a! res!) (and
     (uInv 64 res!)
     (= res! (uClip 64 (Add a! 1)))
   ))
   :pattern ((ens%add1. a! res!))
   :qid internal_ens__add1._definition
   :skolemid skolem_internal_ens__add1._definition
)))

;; Function-Def crate::add1
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/adts-142d23e2e82b3767-test_mut_complex_arg/test.rs:19:1: 19:27 (#0)
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/adts-142d23e2e82b3767-test_mut_complex_arg/test.rs:25:1: 25:11 (#0)
(get-info :all-statistics)
(push)
 ...
 (declare-const v@0 Value.)
 (assert
  fuel_defaults
 )
 (declare-const v@1 Value.)
 ...
 (assert
  (not (=>
    (= v@0 (Value./Value (%I (I 2))))
    (=>
     (= tmp%2 (Value./Value/v (%Poly%Value. (Poly%Value. v@0))))
     (and
      (=>
       %%location_label%%0
       (req%add1. tmp%2)
      ...
      (=>
       (ens%add1. tmp%2 tmp%1)
       (=>
        (= (Value./Value/v (%Poly%Value. (Poly%Value. v@1))) tmp%1)
        (=>
         (= tmp%3 (= (Value./Value/v (%Poly%Value. (Poly%Value. v@1))) 3))
         (=>
          %%location_label%%1
          tmp%3
 )))))))))
