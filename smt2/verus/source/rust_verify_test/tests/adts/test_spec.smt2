...
;; Datatypes
(declare-datatypes ((test_crate!S. 0) (tuple%0. 0) (tuple%1. 0) (tuple%2. 0)) (((test_crate!S./S
    (test_crate!S./S/?a Int) (test_crate!S./S/?b Int)
   )
...
(assert
 (forall ((_a! Int) (_b! Int)) (!
   (=>
    (uInv 8 _a!)
    (has_type (Poly%test_crate!S. (test_crate!S./S _a! _b!)) TYPE%test_crate!S.)
   )
   :pattern ((has_type (Poly%test_crate!S. (test_crate!S./S _a! _b!)) TYPE%test_crate!S.))
...
(assert
 (forall ((x Poly)) (!
   (=>
    (has_type x TYPE%test_crate!S.)
    (uInv 8 (test_crate!S./S/a (%Poly%test_crate!S. x)))
   )
...
;; Function-Def test_crate::S::clone
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/adts-142d23e2e82b3767-test_spec/test.rs:23:5: 23:28 (#0)
...
(push)
 ...
 (assert
  (has_type self! TYPE%test_crate!S.)
 )
 (assert
  (not true)
 )
...
;; Trait-Impl-Axiom
(assert
 (tr_bound%core!clone.Clone. $ TYPE%test_crate!S.)
)

;; Function-Specs test_crate::S::equals
(declare-fun ens%test_crate!impl&%2.equals. (test_crate!S. test_crate!S. Bool) Bool)
(assert
 (forall ((self! test_crate!S.) (rhs! test_crate!S.) (b! Bool)) (!
   (= (ens%test_crate!impl&%2.equals. self! rhs! b!) (= b! (= (test_crate!S./S/a (%Poly%test_crate!S.
        (Poly%test_crate!S. self!)
       )
      ) (test_crate!S./S/a (%Poly%test_crate!S. (Poly%test_crate!S. rhs!)))
   )))
   :pattern ((ens%test_crate!impl&%2.equals. self! rhs! b!))
   :qid internal_ens__test_crate!impl&__2.equals._definition
   :skolemid skolem_internal_ens__test_crate!impl&__2.equals._definition
)))

;; Function-Def test_crate::S::equals
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/adts-142d23e2e82b3767-test_spec/test.rs:31:5: 31:42 (#0)
(get-info :all-statistics)
(push)
 (declare-const b! Bool)
 (declare-const self! test_crate!S.)
 (declare-const rhs! test_crate!S.)
 (assert
  fuel_defaults
 )
 (assert
  (has_type (Poly%test_crate!S. self!) TYPE%test_crate!S.)
 )
 (assert
  (has_type (Poly%test_crate!S. rhs!) TYPE%test_crate!S.)
 )
 ;; postcondition not satisfied
 (declare-const %%location_label%%0 Bool)
 (assert
  (not (=>
    (= b! (= (test_crate!S./S/a (%Poly%test_crate!S. (Poly%test_crate!S. self!))) (test_crate!S./S/a
       (%Poly%test_crate!S. (Poly%test_crate!S. rhs!))
    )))
    (=>
     %%location_label%%0
     (= b! (= (test_crate!S./S/a (%Poly%test_crate!S. (Poly%test_crate!S. self!))) (test_crate!S./S/a
...
(declare-fun ens%test_crate!test. (Int tuple%2.) Bool)
(assert
 (forall ((no%param Int) (s! tuple%2.)) (!
   (= (ens%test_crate!test. no%param s!) (and
     (has_type (Poly%tuple%2. s!) (TYPE%tuple%2. $ TYPE%test_crate!S. $ TYPE%test_crate!S.))
     (= (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. s!))) (tuple%2./tuple%2/1 (%Poly%tuple%2.
        (Poly%tuple%2. s!)
   )))))
   :pattern ((ens%test_crate!test. no%param s!))
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/adts-142d23e2e82b3767-test_spec/test.rs:39:1: 39:24 (#0)
(get-info :all-statistics)
(push)
 (declare-const s! tuple%2.)
 (declare-const no%param Int)
 (declare-const tmp%1 Bool)
 (declare-const s1@ test_crate!S.)
 (declare-const s2@ test_crate!S.)
 (declare-const b@ Bool)
 (assert
  fuel_defaults
 )
 ...
 (assert
  (not (=>
    (= s1@ (test_crate!S./S (%I (I 10)) (%I (I 20))))
    (=>
     (= s2@ s1@)
     (=>
      (= tmp%1 (= (test_crate!S./S/b (%Poly%test_crate!S. (Poly%test_crate!S. s1@))) (test_crate!S./S/b
         (%Poly%test_crate!S. (Poly%test_crate!S. s2@))
      )))
      (and
       (=>
        %%location_label%%0
       ...
       (=>
        tmp%1
        (=>
         (ens%test_crate!impl&%2.equals. s1@ s2@ b@)
         (and
          (=>
           %%location_label%%1
           b@
          ...
          (=>
           b@
           (=>
            (= s! (tuple%2./tuple%2 (Poly%test_crate!S. s1@) (Poly%test_crate!S. s2@)))
            (=>
             %%location_label%%2
             (= (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. s!))) (tuple%2./tuple%2/1 (%Poly%tuple%2.
                (Poly%tuple%2. s!)
