...
(assert
 (distinct fuel%vstd!layout.size_of_as_usize. fuel%test_crate!VERUS_layout_of_S_LL_u64_RR_.
...
(assert
 (= (vstd!layout.size_of.? $ (TYPE%test_crate!S. $ (UINT 64))) 8)
)
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/layout-754b166a24df736f-test_size_of_3/test.rs:20:1: 20:10 (#0)
...
(push)
 ...
 (assert
  (not (=>
    (= tmp%1 (= (uClip SZ (vstd!layout.size_of.? $ (TYPE%test_crate!S. $ (UINT 64)))) 8))
    (=>
     %%location_label%%0
     tmp%1
 ))))
