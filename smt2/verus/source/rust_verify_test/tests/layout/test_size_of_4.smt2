...
(declare-const fuel%test_crate!VERUS_layout_of_S_LL_U_RR_. FuelId)
...
(assert
 (distinct fuel%vstd!layout.size_of_as_usize. fuel%test_crate!VERUS_layout_of_S_LL_U_RR_.
...
;; Datatypes
(declare-datatypes ((test_crate!U. 0) (test_crate!S. 0) (tuple%0. 0)) (((test_crate!U./U))
  ((test_crate!S./S (test_crate!S./S/?v Poly))) ((tuple%0./tuple%0))
))
(declare-fun test_crate!S./S/v (test_crate!S.) Poly)
(declare-const TYPE%test_crate!U. Type)
(declare-fun TYPE%test_crate!S. (Dcr Type) Type)
(declare-const TYPE%tuple%0. Type)
(declare-fun Poly%test_crate!U. (test_crate!U.) Poly)
(declare-fun %Poly%test_crate!U. (Poly) test_crate!U.)
(declare-fun Poly%test_crate!S. (test_crate!S.) Poly)
(declare-fun %Poly%test_crate!S. (Poly) test_crate!S.)
(declare-fun Poly%tuple%0. (tuple%0.) Poly)
(declare-fun %Poly%tuple%0. (Poly) tuple%0.)
(assert
 (forall ((x test_crate!U.)) (!
   (= x (%Poly%test_crate!U. (Poly%test_crate!U. x)))
   :pattern ((Poly%test_crate!U. x))
   :qid internal_test_crate__U_box_axiom_definition
   :skolemid skolem_internal_test_crate__U_box_axiom_definition
)))
(assert
 (forall ((x Poly)) (!
   (=>
    (has_type x TYPE%test_crate!U.)
    (= x (Poly%test_crate!U. (%Poly%test_crate!U. x)))
   )
   :pattern ((has_type x TYPE%test_crate!U.))
   :qid internal_test_crate__U_unbox_axiom_definition
   :skolemid skolem_internal_test_crate__U_unbox_axiom_definition
)))
(assert
 (forall ((x test_crate!U.)) (!
   (has_type (Poly%test_crate!U. x) TYPE%test_crate!U.)
   :pattern ((has_type (Poly%test_crate!U. x) TYPE%test_crate!U.))
   :qid internal_test_crate__U_has_type_always_definition
   :skolemid skolem_internal_test_crate__U_has_type_always_definition
)))
(assert
...
(assert
 (forall ((V&. Dcr) (V& Type) (_v! Poly)) (!
   (=>
    (has_type _v! (proj%test_crate!T./X V&. V&))
    (has_type (Poly%test_crate!S. (test_crate!S./S _v!)) (TYPE%test_crate!S. V&. V&))
   )
   :pattern ((has_type (Poly%test_crate!S. (test_crate!S./S _v!)) (TYPE%test_crate!S. V&.
      V&
   )))
...
(assert
 (forall ((V&. Dcr) (V& Type) (x Poly)) (!
   (=>
    (has_type x (TYPE%test_crate!S. V&. V&))
    (has_type (test_crate!S./S/v (%Poly%test_crate!S. x)) (proj%test_crate!T./X V&. V&))
   )
...
(assert
 (= (proj%%test_crate!T./X $ TYPE%test_crate!U.) $)
)
(assert
 (= (proj%test_crate!T./X $ TYPE%test_crate!U.) (UINT 64))
)
...
;; Broadcast test_crate::VERUS_layout_of_S_LL_U_RR_
(assert
 (= (vstd!layout.size_of.? $ (TYPE%test_crate!S. $ TYPE%test_crate!U.)) 8)
)
...
;; Trait-Impl-Axiom
(assert
 (tr_bound%test_crate!T. $ TYPE%test_crate!U.)
)

;; Function-Def test_crate::test
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/layout-754b166a24df736f-test_size_of_4/test.rs:30:1: 30:10 (#0)
...
(push)
 ...
 (assert
  (not (=>
    (= tmp%1 (= (uClip SZ (vstd!layout.size_of.? $ (TYPE%test_crate!S. $ TYPE%test_crate!U.)))
      8
    ))
    (=>
     %%location_label%%0
