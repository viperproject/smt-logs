...
(declare-const fuel%test_crate!VERUS_layout_of_isize. FuelId)
...
(assert
 (distinct fuel%test_crate!VERUS_layout_of_usize. fuel%test_crate!VERUS_layout_of_isize.
...
;; Broadcast test_crate::VERUS_layout_of_isize
(assert
 (= (vstd!layout.size_of.? $ (SINT SZ)) 8)
)
