...
(assert
 (distinct fuel%vstd!layout.size_of_as_usize. fuel%test_crate!VERUS_layout_of_usize.
  fuel%test_crate!VERUS_layout_of_isize. fuel%vstd!array.group_array_axioms. fuel%vstd!map.group_map_axioms.
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/layout-754b166a24df736f-test_size_of_1/test.rs:18:1: 18:10 (#0)
...
(push)
 ...
 (assert
  (not (=>
    (= tmp%1 (= (uClip SZ (vstd!layout.size_of.? $ (UINT SZ))) 8))
    (and
     (=>
      %%location_label%%0
      tmp%1
     ...
     (=>
      tmp%1
      (=>
       (= tmp%2 (not (= (uClip SZ (vstd!layout.size_of.? $ (UINT SZ))) 4)))
       (and
        (=>
         %%location_label%%1
         tmp%2
        ...
        (=>
         tmp%2
         (=>
          (= tmp%3 (= (uClip SZ (vstd!layout.size_of.? $ (SINT SZ))) 8))
          (and
           (=>
            %%location_label%%2
            tmp%3
           ...
           (=>
            tmp%3
            (=>
             (= tmp%4 (not (= (uClip SZ (vstd!layout.size_of.? $ (SINT SZ))) 4)))
             (=>
              %%location_label%%3
              tmp%4
 )))))))))))))
