...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/layout-754b166a24df736f-test_set_to_64/test.rs:17:1: 17:11 (#0)
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/layout-754b166a24df736f-test_set_to_64/test.rs:20:1: 20:11 (#0)
(get-info :all-statistics)
(push)
 (declare-const no%param Int)
 (assert
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/layout-754b166a24df736f-test_set_to_64/test.rs:24:1: 24:20 (#0)
(get-info :all-statistics)
(push)
 (declare-const no%param Int)
 (declare-const tmp%1 Bool)
  ...
  (not (=>
    ...
    (and
     ...
     (=>
      tmp%1
      (=>
       (= tmp%2 (= (- (uHi SZ) 1) 18446744073709551615))
       (and
        (=>
         %%location_label%%1
         tmp%2
        ...
        (=>
         tmp%2
         (=>
          (= tmp%3 (= (- (iHi SZ) 1) 9223372036854775807))
          (and
           (=>
            %%location_label%%2
            tmp%3
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/layout-754b166a24df736f-test_set_to_64/test.rs:32:1: 32:11 (#0)
(get-info :all-statistics)
(push)
 (declare-const no%param Int)
 (declare-const tmp%1 Bool)
