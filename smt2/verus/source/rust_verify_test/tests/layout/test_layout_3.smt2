...
(declare-const fuel%test_crate!VERUS_layout_of_S. FuelId)
...
(assert
 (distinct fuel%vstd!layout.size_of_as_usize. fuel%vstd!layout.align_of_as_usize. fuel%test_crate!VERUS_layout_of_S.
...
;; Datatypes
(declare-datatypes ((test_crate!S. 0) (tuple%0. 0)) (((test_crate!S./S (test_crate!S./S/?v
     Int
    ) (test_crate!S./S/?z Int)
   )
  ) ((tuple%0./tuple%0))
))
(declare-fun test_crate!S./S/v (test_crate!S.) Int)
(declare-fun test_crate!S./S/z (test_crate!S.) Int)
...
(assert
 (forall ((_v! Int) (_z! Int)) (!
   (=>
    (and
     (uInv 64 _v!)
     (uInv 32 _z!)
    )
    (has_type (Poly%test_crate!S. (test_crate!S./S _v! _z!)) TYPE%test_crate!S.)
   )
   :pattern ((has_type (Poly%test_crate!S. (test_crate!S./S _v! _z!)) TYPE%test_crate!S.))
   :qid internal_test_crate!S./S_constructor_definition
   :skolemid skolem_internal_test_crate!S./S_constructor_definition
)))
(assert
 (forall ((x test_crate!S.)) (!
   (= (test_crate!S./S/v x) (test_crate!S./S/?v x))
   :pattern ((test_crate!S./S/v x))
   :qid internal_test_crate!S./S/v_accessor_definition
   :skolemid skolem_internal_test_crate!S./S/v_accessor_definition
)))
(assert
 (forall ((x Poly)) (!
   (=>
    (has_type x TYPE%test_crate!S.)
    (uInv 64 (test_crate!S./S/v (%Poly%test_crate!S. x)))
   )
   :pattern ((test_crate!S./S/v (%Poly%test_crate!S. x)) (has_type x TYPE%test_crate!S.))
   :qid internal_test_crate!S./S/v_invariant_definition
   :skolemid skolem_internal_test_crate!S./S/v_invariant_definition
)))
(assert
 (forall ((x test_crate!S.)) (!
   (= (test_crate!S./S/z x) (test_crate!S./S/?z x))
   :pattern ((test_crate!S./S/z x))
   :qid internal_test_crate!S./S/z_accessor_definition
   :skolemid skolem_internal_test_crate!S./S/z_accessor_definition
)))
(assert
 (forall ((x Poly)) (!
   (=>
    (has_type x TYPE%test_crate!S.)
    (uInv 32 (test_crate!S./S/z (%Poly%test_crate!S. x)))
   )
   :pattern ((test_crate!S./S/z (%Poly%test_crate!S. x)) (has_type x TYPE%test_crate!S.))
   :qid internal_test_crate!S./S/z_invariant_definition
   :skolemid skolem_internal_test_crate!S./S/z_invariant_definition
)))
(assert
 (forall ((x tuple%0.)) (!
...
;; Function-Decl vstd::layout::align_of_as_usize
...
;; Broadcast test_crate::VERUS_layout_of_S
(assert
 (and
  (= (vstd!layout.size_of.? $ TYPE%test_crate!S.) 16)
  (= (vstd!layout.align_of.? $ TYPE%test_crate!S.) 8)
))
...
;; Function-Specs vstd::layout::align_of_as_usize
...
;; Function-Axioms vstd::layout::align_of_as_usize
(assert
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/layout-754b166a24df736f-test_layout_3/test.rs:20:1: 20:10 (#0)
...
(push)
 ...
 (assert
  (not (=>
    (= tmp%1 (= (uClip SZ (vstd!layout.size_of.? $ TYPE%test_crate!S.)) 16))
    (and
     (=>
      %%location_label%%0
      tmp%1
     ...
     (=>
      tmp%1
      (=>
       (= tmp%2 (not (= (uClip SZ (vstd!layout.size_of.? $ TYPE%test_crate!S.)) 8)))
       (and
        (=>
         %%location_label%%1
         tmp%2
        ...
        (=>
         tmp%2
         (=>
          (= tmp%3 (= (uClip SZ (vstd!layout.align_of.? $ TYPE%test_crate!S.)) 8))
          (and
           (=>
            %%location_label%%2
            tmp%3
           ...
           (=>
            tmp%3
            (=>
             (= tmp%4 (not (= (uClip SZ (vstd!layout.align_of.? $ TYPE%test_crate!S.)) 16)))
             (=>
              %%location_label%%3
              tmp%4
 )))))))))))))
