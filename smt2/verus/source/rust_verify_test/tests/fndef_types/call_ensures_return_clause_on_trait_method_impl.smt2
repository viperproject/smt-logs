...
(assert
 (distinct fuel%test_crate!impl&%0.ens. fuel%vstd!array.group_array_axioms. fuel%vstd!map.group_map_axioms.
   ...
   (=>
    ...
    (=>
     ...
     (%B (let
       ...
       (let
        ((i$ (%I (tuple%2./tuple%2/1 (%Poly%tuple%2. tmp%%$)))))
        (test_crate!Tr.ens.? Self%&. Self%& self$ (I i$) s$)
   )))))
...
(assert
 (forall ((self! Poly) (i! Poly) (s! Poly)) (!
   (= (ens%test_crate!impl&%0.test. self! i! s!) (and
     ...
     (= (%Poly%test_crate!X. s!) (test_crate!X./X (%I (I (uClip 8 (Add (test_crate!X./X/j (%Poly%test_crate!X.
             self!
            )
           ) (%I i!)
   ))))))))
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/fndef_types-2b591f3dc5716dd9-call_ensures_return_clause_on_trait_method_impl/test.rs:34:13: 34:21 (#0)
...
;; Function-Def test_crate::X::test
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/fndef_types-2b591f3dc5716dd9-call_ensures_return_clause_on_trait_method_impl/test.rs:29:5: 29:38 (#0)
(get-info :all-statistics)
(push)
 (declare-const s! Poly)
 (declare-const self! Poly)
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/fndef_types-2b591f3dc5716dd9-call_ensures_return_clause_on_trait_method_impl/test.rs:42:1: 42:28 (#0)
(get-info :all-statistics)
(push)
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/fndef_types-2b591f3dc5716dd9-call_ensures_return_clause_on_trait_method_impl/test.rs:47:1: 47:33 (#0)
(get-info :all-statistics)
(push)
 (declare-const x! test_crate!X.)
 (declare-const i! Int)
