...
(declare-datatypes ((vstd!raw_ptr.Metadata. 0) (vstd!raw_ptr.PtrData. 0) (test_crate!X.
   0
  ) (tuple%0. 0) (tuple%1. 0)
  ...
  ) ((test_crate!X./X)) ((tuple%0./tuple%0)) ((tuple%1./tuple%1 (tuple%1./tuple%1/?0 Poly)))
))
...
(declare-const FNDEF%test_crate!double. Type)
...
;; Function-Specs test_crate::vec_map
(declare-fun req%test_crate!vec_map. (Dcr Type Dcr Type Dcr Type Poly Poly) Bool)
(declare-const %%global_location_label%%3 Bool)
(assert
 (forall ((T&. Dcr) (T& Type) (U&. Dcr) (U& Type) (impl%2&. Dcr) (impl%2& Type) (v! Poly)
   (f! Poly)
  ) (!
   (= (req%test_crate!vec_map. T&. T& U&. U& impl%2&. impl%2& v! f!) (=>
     ...
     (forall ((i$ Poly)) (!
       (=>
        ...
        (=>
         (and
          (<= 0 (%I i$))
          (< (%I i$) (vstd!std_specs.vec.spec_vec_len.? T&. T& $ ALLOCATOR_GLOBAL v!))
         )
         (closure_req impl%2& $ (TYPE%tuple%1. (REF T&.) T&) f! (Poly%tuple%1. (tuple%1./tuple%1
            (vstd!seq.Seq.index.? T&. T& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $
               ALLOCATOR_GLOBAL
              ) v!
             ) i$
       ...
       :qid user_test_crate__vec_map_12
       :skolemid skolem_user_test_crate__vec_map_12
   ))))
   :pattern ((req%test_crate!vec_map. T&. T& U&. U& impl%2&. impl%2& v! f!))
   :qid internal_req__test_crate!vec_map._definition
   :skolemid skolem_internal_req__test_crate!vec_map._definition
)))
(declare-fun ens%test_crate!vec_map. (Dcr Type Dcr Type Dcr Type Poly Poly Poly) Bool)
(assert
 (forall ((T&. Dcr) (T& Type) (U&. Dcr) (U& Type) (impl%2&. Dcr) (impl%2& Type) (v! Poly)
   (f! Poly) (result! Poly)
  ) (!
   (= (ens%test_crate!vec_map. T&. T& U&. U& impl%2&. impl%2& v! f! result!) (and
     (has_type result! (TYPE%alloc!vec.Vec. U&. U& $ ALLOCATOR_GLOBAL))
     (= (vstd!std_specs.vec.spec_vec_len.? U&. U& $ ALLOCATOR_GLOBAL result!) (vstd!std_specs.vec.spec_vec_len.?
       T&. T& $ ALLOCATOR_GLOBAL v!
     ))
     (forall ((i$ Poly)) (!
       (=>
        (has_type i$ INT)
        (=>
         ...
         (closure_ens impl%2& $ (TYPE%tuple%1. (REF T&.) T&) f! (Poly%tuple%1. (tuple%1./tuple%1
            (vstd!seq.Seq.index.? T&. T& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $
               ALLOCATOR_GLOBAL
              ) v!
             ) i$
       ...
       :pattern ((vstd!seq.Seq.index.? U&. U& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec.
           U&. U& $ ALLOCATOR_GLOBAL
          ) result!
         ) i$
       ))
       :qid user_test_crate__vec_map_13
       :skolemid skolem_user_test_crate__vec_map_13
   ))))
   :pattern ((ens%test_crate!vec_map. T&. T& U&. U& impl%2&. impl%2& v! f! result!))
   :qid internal_ens__test_crate!vec_map._definition
   :skolemid skolem_internal_ens__test_crate!vec_map._definition
)))

;; Function-Def test_crate::vec_map
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/fndef_types-2b591f3dc5716dd9-bound_vars_issue1005/test.rs:17:1: 17:69 (#0)
...
(push)
 ...
 (declare-const impl%2&. Dcr)
 (declare-const impl%2& Type)
 ...
 (assert
  (forall ((i$ Poly)) (!
    ...
    :qid user_test_crate__vec_map_15
    :skolemid skolem_user_test_crate__vec_map_15
 )))
 (assert
  (not true)
 )
...
;; Function-Specs test_crate::double
(declare-fun req%test_crate!double. (Int) Bool)
(declare-const %%global_location_label%%4 Bool)
(assert
 (forall ((x! Int)) (!
   (= (req%test_crate!double. x!) (=>
     %%global_location_label%%4
     (and
      (<= 0 x!)
      (< x! 128)
   )))
   :pattern ((req%test_crate!double. x!))
   :qid internal_req__test_crate!double._definition
   :skolemid skolem_internal_req__test_crate!double._definition
)))
(declare-fun ens%test_crate!double. (Int Int) Bool)
(assert
 (forall ((x! Int) (res! Int)) (!
   (= (ens%test_crate!double. x! res!) (and
     (uInv 8 res!)
     (= res! (Mul 2 x!))
   ))
   :pattern ((ens%test_crate!double. x! res!))
   :qid internal_ens__test_crate!double._definition
   :skolemid skolem_internal_ens__test_crate!double._definition
)))
(assert
 (forall ((tmp%%$ Poly)) (!
   (=>
    ...
    (=>
     ...
     (closure_req FNDEF%test_crate!double. $ (TYPE%tuple%1. (REF $) (UINT 8)) (F fndef_singleton)
      tmp%%$
   )))
   :pattern ((closure_req FNDEF%test_crate!double. $ (TYPE%tuple%1. (REF $) (UINT 8))
     (F fndef_singleton) tmp%%$
   ))
   :qid user_test_crate__double_16
   :skolemid skolem_user_test_crate__double_16
)))
(assert
 (forall ((tmp%%$ Poly) (res$ Poly)) (!
   (=>
    ...
    (=>
     (closure_ens FNDEF%test_crate!double. $ (TYPE%tuple%1. (REF $) (UINT 8)) (F fndef_singleton)
      tmp%%$ res$
     )
     (let
      ((x$ (%I (tuple%1./tuple%1/0 (%Poly%tuple%1. tmp%%$)))))
   ...
   :pattern ((closure_ens FNDEF%test_crate!double. $ (TYPE%tuple%1. (REF $) (UINT 8))
     (F fndef_singleton) tmp%%$ res$
   ))
   :qid user_test_crate__double_17
   :skolemid skolem_user_test_crate__double_17
)))

;; Function-Def test_crate::double
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/fndef_types-2b591f3dc5716dd9-bound_vars_issue1005/test.rs:28:1: 28:30 (#0)
(get-info :all-statistics)
(push)
...
;; Function-Def test_crate::test_vec_map
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/fndef_types-2b591f3dc5716dd9-bound_vars_issue1005/test.rs:35:1: 35:18 (#0)
(get-info :all-statistics)
(push)
 (declare-const no%param Int)
 (declare-const tmp%1 Poly)
 (declare-const tmp%2 Poly)
 (declare-const tmp%3 fndef)
 (declare-const tmp%4 Bool)
 (declare-const v@0 alloc!vec.Vec<u8./allocator_global%.>.)
 (declare-const w@ alloc!vec.Vec<u8./allocator_global%.>.)
 (assert
  fuel_defaults
 )
 ...
 (assert
  (not (=>
    ...
    (=>
     (= v@0 (%Poly%alloc!vec.Vec<u8./allocator_global%.>. tmp%1))
     (=>
      (ens%alloc!vec.impl&%1.push. $ (UINT 8) $ ALLOCATOR_GLOBAL (Poly%alloc!vec.Vec<u8./allocator_global%.>.
        v@0
       ) (Poly%alloc!vec.Vec<u8./allocator_global%.>. v@1) (I 0)
      )
      (=>
       (ens%alloc!vec.impl&%1.push. $ (UINT 8) $ ALLOCATOR_GLOBAL (Poly%alloc!vec.Vec<u8./allocator_global%.>.
         v@1
        ) (Poly%alloc!vec.Vec<u8./allocator_global%.>. v@2) (I 10)
       )
       (=>
        (ens%alloc!vec.impl&%1.push. $ (UINT 8) $ ALLOCATOR_GLOBAL (Poly%alloc!vec.Vec<u8./allocator_global%.>.
          v@2
         ) (Poly%alloc!vec.Vec<u8./allocator_global%.>. v@3) (I 20)
        )
        (=>
         (= tmp%3 fndef_singleton)
         (and
          (=>
           %%location_label%%0
           (req%test_crate!vec_map. $ (UINT 8) $ (UINT 8) $ FNDEF%test_crate!double. (Poly%alloc!vec.Vec<u8./allocator_global%.>.
             v@3
            ) (F tmp%3)
          ))
          (=>
           (ens%test_crate!vec_map. $ (UINT 8) $ (UINT 8) $ FNDEF%test_crate!double. (Poly%alloc!vec.Vec<u8./allocator_global%.>.
             v@3
            ) (F tmp%3) tmp%2
           )
           (=>
            (= w@ (%Poly%alloc!vec.Vec<u8./allocator_global%.>. tmp%2))
            (=>
             (= tmp%4 (= (%I (vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec.
                   $ (UINT 8) $ ALLOCATOR_GLOBAL
                  ) (Poly%alloc!vec.Vec<u8./allocator_global%.>. w@)
                 ) (I 2)
                )
               ) 40
             ))
...
;; Function-Specs test_crate::constrain
(declare-fun ens%test_crate!constrain. (Dcr Type Poly Poly) Bool)
(assert
 (forall ((T&. Dcr) (T& Type) (t! Poly) (%return! Poly)) (!
   (= (ens%test_crate!constrain. T&. T& t! %return!) (has_type %return! T&))
   :pattern ((ens%test_crate!constrain. T&. T& t! %return!))
   :qid internal_ens__test_crate!constrain._definition
   :skolemid skolem_internal_ens__test_crate!constrain._definition
)))

;; Function-Def test_crate::constrain
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/fndef_types-2b591f3dc5716dd9-bound_vars_issue1005/test.rs:49:1: 50:40 (#0)
(get-info :all-statistics)
(push)
 (declare-const T&. Dcr)
 (declare-const T& Type)
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/fndef_types-2b591f3dc5716dd9-bound_vars_issue1005/test.rs:55:1: 55:10 (#0)
(get-info :all-statistics)
(push)
 (declare-const no%param Int)
 (declare-const x~7 test_crate!X.)
 (declare-const %closure_return~8 test_crate!X.)
 (declare-const tmp%%1 anonymous_closure%20.)
 (declare-const tmp%1 Poly)
 (declare-const tmp%2 Poly)
 (declare-const tmp%3 tuple%1.)
 (declare-const f@ anonymous_closure%20.)
 (declare-const x$1@ test_crate!X.)
 (declare-const t@ test_crate!X.)
 (assert
  fuel_defaults
 )
  ...
  (not (=>
    (forall ((tmp%%$ Poly)) (!
      (=>
       ...
       (=>
        (let
         ((x$ (%Poly%test_crate!X. (tuple%1./tuple%1/0 (%Poly%tuple%1. tmp%%$)))))
         true
        )
        (closure_req TYPE%anonymous_closure%20. $ (TYPE%tuple%1. (REF $) TYPE%test_crate!X.)
         (Poly%anonymous_closure%20. tmp%%1) tmp%%$
      )))
      :pattern ((closure_req TYPE%anonymous_closure%20. $ (TYPE%tuple%1. (REF $) TYPE%test_crate!X.)
        (Poly%anonymous_closure%20. tmp%%1) tmp%%$
      ))
      :qid user_test_crate__test_18
      :skolemid skolem_user_test_crate__test_18
    ))
    (=>
     (ens%test_crate!constrain. $ TYPE%anonymous_closure%20. (Poly%anonymous_closure%20.
       tmp%%1
      ) tmp%1
     )
     (=>
      (= f@ (%Poly%anonymous_closure%20. tmp%1))
      (=>
       (= x$1@ test_crate!X./X)
       (=>
        (= tmp%3 (tuple%1./tuple%1 (Poly%test_crate!X. x$1@)))
        (=>
         %%location_label%%0
         (req%vstd!pervasive.exec_nonstatic_call. $ (TYPE%tuple%1. (REF $) TYPE%test_crate!X.)
          (REF $) TYPE%test_crate!X. (REF $) TYPE%anonymous_closure%20. (Poly%anonymous_closure%20.
           f@
          ) (Poly%tuple%1. tmp%3)
 )))))))))
 (get-info :version)
