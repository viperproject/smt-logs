...
(declare-fun FNDEF%test_crate!llama. (Dcr Type) Type)
...
(assert
 (forall ((_x! Int)) (!
   (=>
    (uInv 8 _x!)
    (has_type (Poly%test_crate!X. (test_crate!X./X _x!)) TYPE%test_crate!X.)
   )
   :pattern ((has_type (Poly%test_crate!X. (test_crate!X./X _x!)) TYPE%test_crate!X.))
   :qid internal_test_crate!X./X_constructor_definition
   :skolemid skolem_internal_test_crate!X./X_constructor_definition
)))
(assert
 (forall ((x test_crate!X.)) (!
   (= (test_crate!X./X/x x) (test_crate!X./X/?x x))
   :pattern ((test_crate!X./X/x x))
   :qid internal_test_crate!X./X/x_accessor_definition
   :skolemid skolem_internal_test_crate!X./X/x_accessor_definition
)))
(assert
 (forall ((x Poly)) (!
   (=>
    (has_type x TYPE%test_crate!X.)
    (uInv 8 (test_crate!X./X/x (%Poly%test_crate!X. x)))
   )
   :pattern ((test_crate!X./X/x (%Poly%test_crate!X. x)) (has_type x TYPE%test_crate!X.))
   :qid internal_test_crate!X./X/x_invariant_definition
   :skolemid skolem_internal_test_crate!X./X/x_invariant_definition
)))
(assert
 (forall ((x tuple%0.)) (!
...
(declare-fun req%test_crate!llama. (Dcr Type Poly Poly Poly) Bool)
(declare-const %%global_location_label%%0 Bool)
(assert
 (forall ((T&. Dcr) (T& Type) (x! Poly) (y! Poly) (z! Poly)) (!
   (= (req%test_crate!llama. T&. T& x! y! z!) (=>
     %%global_location_label%%0
     (= x! y!)
   ))
   :pattern ((req%test_crate!llama. T&. T& x! y! z!))
   :qid internal_req__test_crate!llama._definition
   :skolemid skolem_internal_req__test_crate!llama._definition
)))
(declare-fun ens%test_crate!llama. (Dcr Type Poly Poly Poly Bool) Bool)
(assert
 (forall ((T&. Dcr) (T& Type) (x! Poly) (y! Poly) (z! Poly) (b! Bool)) (!
   (= (ens%test_crate!llama. T&. T& x! y! z! b!) (= b! (= y! z!)))
   :pattern ((ens%test_crate!llama. T&. T& x! y! z! b!))
...
(assert
 (forall ((tmp%%$ Poly) (T&. Dcr) (T& Type)) (!
   (=>
    (has_type tmp%%$ (TYPE%tuple%3. T&. T& T&. T& T&. T&))
    (=>
     (let
      ((x$ (tuple%3./tuple%3/0 (%Poly%tuple%3. tmp%%$))))
      (let
     ...
     (closure_req (FNDEF%test_crate!llama. T&. T&) $ (TYPE%tuple%3. T&. T& T&. T& T&. T&)
      (F fndef_singleton) tmp%%$
   )))
   :pattern ((closure_req (FNDEF%test_crate!llama. T&. T&) $ (TYPE%tuple%3. T&. T& T&.
      T& T&. T&
     ) (F fndef_singleton) tmp%%$
   ))
...
(assert
 (forall ((tmp%%$ Poly) (b$ Poly) (T&. Dcr) (T& Type)) (!
   (=>
    (and
     (has_type tmp%%$ (TYPE%tuple%3. T&. T& T&. T& T&. T&))
     (has_type b$ BOOL)
    ...
    (=>
     (closure_ens (FNDEF%test_crate!llama. T&. T&) $ (TYPE%tuple%3. T&. T& T&. T& T&. T&)
   ...
   :pattern ((closure_ens (FNDEF%test_crate!llama. T&. T&) $ (TYPE%tuple%3. T&. T& T&.
      T& T&. T&
     ) (F fndef_singleton) tmp%%$ b$
   ))
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/fndef_types-2b591f3dc5716dd9-generics_test/test.rs:15:1: 15:42 (#0)
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/fndef_types-2b591f3dc5716dd9-generics_test/test.rs:24:1: 24:10 (#0)
(get-info :all-statistics)
(push)
 ...
 (assert
  (not (=>
    (= t@ fndef_singleton)
    (=>
     (= tmp%2 (tuple%3./tuple%3 (I 4) (I 4) (I 6)))
     (and
      (=>
       %%location_label%%0
       (req%vstd!pervasive.exec_nonstatic_call. $ (TYPE%tuple%3. $ (SINT 32) $ (SINT 32) $
         (SINT 32)
        ) $ BOOL $ (FNDEF%test_crate!llama. $ (SINT 32)) (F t@) (Poly%tuple%3. tmp%2)
      ))
      (=>
       (ens%vstd!pervasive.exec_nonstatic_call. $ (TYPE%tuple%3. $ (SINT 32) $ (SINT 32) $
         (SINT 32)
        ) $ BOOL $ (FNDEF%test_crate!llama. $ (SINT 32)) (F t@) (Poly%tuple%3. tmp%2) tmp%1
       )
       (=>
        (= b@ (%B tmp%1))
        (and
         ...
         (=>
          (not b@)
          (=>
           (= tmp%4 (tuple%3./tuple%3 (I 4) (I 4) (I 4)))
           (and
            (=>
             %%location_label%%2
             (req%vstd!pervasive.exec_nonstatic_call. $ (TYPE%tuple%3. $ (SINT 32) $ (SINT 32) $
               (SINT 32)
              ) $ BOOL $ (FNDEF%test_crate!llama. $ (SINT 32)) (F t@) (Poly%tuple%3. tmp%4)
            ))
            (=>
             (ens%vstd!pervasive.exec_nonstatic_call. $ (TYPE%tuple%3. $ (SINT 32) $ (SINT 32) $
               (SINT 32)
              ) $ BOOL $ (FNDEF%test_crate!llama. $ (SINT 32)) (F t@) (Poly%tuple%3. tmp%4) tmp%3
             )
             (=>
              (= b$1@ (%B tmp%3))
              (and
               ...
               (=>
                b$1@
                (=>
                 (= tmp%5 (forall ((x$ Poly) (y$ Poly) (z$ Poly)) (!
                    (=>
                     (and
                      (has_type x$ (UINT 8))
                      (has_type y$ (UINT 8))
                     ...
                     (=>
                      (= x$ y$)
                      (closure_req (FNDEF%test_crate!llama. $ (UINT 8)) $ (TYPE%tuple%3. $ (UINT 8) $ (UINT
                         8
                        ) $ (UINT 8)
                 ...
                 (and
                  ...
                  (=>
                   tmp%5
                   (=>
                    (= tmp%6 (forall ((x$ Poly) (y$ Poly) (z$ Poly) (b$2 Poly)) (!
                       (=>
                        (and
                         (has_type x$ (UINT 8))
                         (has_type y$ (UINT 8))
                        ...
                        (=>
                         (closure_ens (FNDEF%test_crate!llama. $ (UINT 8)) $ (TYPE%tuple%3. $ (UINT 8) $ (UINT
                            8
                           ) $ (UINT 8)
                          ) (F fndef_singleton) (Poly%tuple%3. (tuple%3./tuple%3 x$ y$ z$)) b$2
                         )
                         (= (%B b$2) (= y$ z$))
                       ))
                       :pattern ((closure_ens (FNDEF%test_crate!llama. $ (UINT 8)) $ (TYPE%tuple%3. $ (UINT
                           8
                          ) $ (UINT 8) $ (UINT 8)
                         ) (F fndef_singleton) (Poly%tuple%3. (tuple%3./tuple%3 x$ y$ z$)) b$2
                       ))
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/fndef_types-2b591f3dc5716dd9-generics_test/test.rs:37:1: 37:11 (#0)
(get-info :all-statistics)
(push)
 (declare-const no%param Int)
 (declare-const tmp%1 Poly)
 ...
 (assert
  (not (=>
    (= t@ fndef_singleton)
    (=>
     (= tmp%2 (tuple%3./tuple%3 (I 4) (I 4) (I 4)))
     (and
      (=>
       %%location_label%%0
       (req%vstd!pervasive.exec_nonstatic_call. $ (TYPE%tuple%3. $ (SINT 32) $ (SINT 32) $
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/fndef_types-2b591f3dc5716dd9-generics_test/test.rs:44:1: 44:11 (#0)
(get-info :all-statistics)
(push)
 (declare-const no%param Int)
 (declare-const tmp%1 Poly)
 ...
 (assert
  (not (=>
    (= t@ fndef_singleton)
    (=>
     (= tmp%2 (tuple%3./tuple%3 (I 12) (I 13) (I 14)))
     (=>
      %%location_label%%0
      (req%vstd!pervasive.exec_nonstatic_call. $ (TYPE%tuple%3. $ (SINT 32) $ (SINT 32) $
        (SINT 32)
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/fndef_types-2b591f3dc5716dd9-generics_test/test.rs:50:1: 50:11 (#0)
(get-info :all-statistics)
(push)
 (declare-const no%param Int)
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/fndef_types-2b591f3dc5716dd9-generics_test/test.rs:54:1: 54:11 (#0)
(get-info :all-statistics)
(push)
 (declare-const no%param Int)
 (declare-const tmp%1 Bool)
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/fndef_types-2b591f3dc5716dd9-generics_test/test.rs:60:1: 60:43 (#0)
(get-info :all-statistics)
(push)
 (declare-const F&. Dcr)
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/fndef_types-2b591f3dc5716dd9-generics_test/test.rs:68:1: 68:16 (#0)
(get-info :all-statistics)
(push)
 (declare-const no%param Int)
 ...
 (assert
  (not (=>
    ...
    (=>
     %%location_label%%0
     (req%test_crate!takes_fn1. $ (FNDEF%test_crate!llama. $ TYPE%test_crate!X.) (F tmp%1))
 ))))
 (get-info :version)
 (set-option :rlimit 30000000)
 (check-sat)
...
(assert
 (forall ((F&. Dcr) (F& Type) (f! Poly)) (!
   (= (req%test_crate!takes_fn2. F&. F& f!) (=>
     ...
     (closure_req F& $ (TYPE%tuple%3. $ (UINT 8) $ (UINT 8) $ (UINT 8)) f! (Poly%tuple%3.
       (tuple%3./tuple%3 (I 6) (I 7) (I 8))
   ))))
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/fndef_types-2b591f3dc5716dd9-generics_test/test.rs:72:1: 72:46 (#0)
(get-info :all-statistics)
(push)
 (declare-const F&. Dcr)
 (declare-const F& Type)
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/fndef_types-2b591f3dc5716dd9-generics_test/test.rs:78:1: 78:16 (#0)
(get-info :all-statistics)
(push)
 (declare-const no%param Int)
 (declare-const tmp%1 fndef)
 ...
 (assert
  (not (=>
    ...
    (=>
     %%location_label%%0
     (req%test_crate!takes_fn2. $ (FNDEF%test_crate!llama. $ (UINT 8)) (F tmp%1))
 ))))
 (get-info :version)
 (set-option :rlimit 30000000)
 (check-sat)
   ...
   (= (req%test_crate!takes_fn3. F&. F& f!) (=>
     ...
     (forall ((x$ Poly) (y$ Poly) (z$ Poly) (b$ Poly)) (!
       (=>
        ...
        (=>
         (closure_ens F& $ (TYPE%tuple%3. $ (UINT 8) $ (UINT 8) $ (UINT 8)) f! (Poly%tuple%3.
           (tuple%3./tuple%3 x$ y$ z$)
          ) b$
         )
         (= (%B b$) (not (= y$ z$)))
       ))
       :pattern ((closure_ens F& $ (TYPE%tuple%3. $ (UINT 8) $ (UINT 8) $ (UINT 8)) f! (Poly%tuple%3.
          (tuple%3./tuple%3 x$ y$ z$)
         ) b$
       ))
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/fndef_types-2b591f3dc5716dd9-generics_test/test.rs:82:1: 82:46 (#0)
(get-info :all-statistics)
(push)
 (declare-const F&. Dcr)
 (declare-const F& Type)
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/fndef_types-2b591f3dc5716dd9-generics_test/test.rs:88:1: 88:16 (#0)
(get-info :all-statistics)
(push)
 (declare-const no%param Int)
 (declare-const tmp%1 fndef)
 ...
 (assert
  (not (=>
    ...
    (=>
     %%location_label%%0
     (req%test_crate!takes_fn3. $ (FNDEF%test_crate!llama. $ (UINT 8)) (F tmp%1))
 ))))
 (get-info :version)
 (set-option :rlimit 30000000)
 (check-sat)
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/fndef_types-2b591f3dc5716dd9-generics_test/test.rs:92:1: 92:46 (#0)
(get-info :all-statistics)
(push)
 (declare-const T&. Dcr)
 (declare-const T& Type)
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/fndef_types-2b591f3dc5716dd9-generics_test/test.rs:98:1: 98:16 (#0)
(get-info :all-statistics)
(push)
 (declare-const no%param Int)
 (declare-const tmp%1 fndef)
 ...
 (assert
  (not (=>
    ...
    (=>
     %%location_label%%0
     (req%test_crate!takes_fn4. $ (UINT 8) $ (FNDEF%test_crate!llama. $ (UINT 8)) (F tmp%1))
 ))))
 (get-info :version)
 (set-option :rlimit 30000000)
 (check-sat)
