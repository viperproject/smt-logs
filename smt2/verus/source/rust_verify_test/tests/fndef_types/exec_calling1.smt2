 ...
 (forall ((tmp%%$ Poly)) (!
   (=>
    ...
    (=>
     ...
     (closure_req FNDEF%test_crate!b. $ (TYPE%tuple%1. $ (UINT 8)) (F fndef_singleton)
      tmp%%$
   )))
   :pattern ((closure_req FNDEF%test_crate!b. $ (TYPE%tuple%1. $ (UINT 8)) (F fndef_singleton)
     tmp%%$
   ))
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/fndef_types-2b591f3dc5716dd9-exec_calling1/test.rs:21:1: 21:12 (#0)
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/fndef_types-2b591f3dc5716dd9-exec_calling1/test.rs:16:1: 16:7 (#0)
(get-info :all-statistics)
(push)
 ...
 (assert
  (not (=>
    (= x@ fndef_singleton)
    (=>
     (= tmp%2 (tuple%1./tuple%1 (I 0)))
     (=>
      %%location_label%%0
      (req%vstd!pervasive.exec_nonstatic_call. $ (TYPE%tuple%1. $ (UINT 8)) $ TYPE%tuple%0.
       $ FNDEF%test_crate!b. (F x@) (Poly%tuple%1. tmp%2)
 ))))))
 (get-info :version)
 (set-option :rlimit 30000000)
 (check-sat)
