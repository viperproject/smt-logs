...
;; Datatypes
(declare-datatypes ((X. 0) (tuple%0. 0) (tuple%1. 0)) (((X./X (X./X/?u Int))) ((tuple%0./tuple%0))
...
(declare-fun FNDEF%stuff. (Dcr Type) Type)
...
;; Function-Decl crate::Tr::foo
(declare-fun Tr.foo.? (Dcr Type Poly) Poly)
(declare-fun Tr.foo%default%.? (Dcr Type Poly) Poly)

;; Function-Axioms crate::Tr::foo
(assert
 (forall ((Self%&. Dcr) (Self%& Type) (self! Poly)) (!
   (=>
    (has_type self! Self%&)
    (has_type (Tr.foo.? Self%&. Self%& self!) BOOL)
   )
   :pattern ((Tr.foo.? Self%&. Self%& self!))
   :qid internal_Tr.foo.?_pre_post_definition
   :skolemid skolem_internal_Tr.foo.?_pre_post_definition
)))
...
(declare-fun req%stuff. (Dcr Type Poly) Bool)
 ...
 (forall ((tmp%%$ Poly) (T&. Dcr) (T& Type)) (!
   (=>
    ...
    (=>
     ...
     (closure_req (FNDEF%stuff. T&. T&) $ (TYPE%tuple%1. T&. T&) (F fndef_singleton) tmp%%$)
   ))
   :pattern ((closure_req (FNDEF%stuff. T&. T&) $ (TYPE%tuple%1. T&. T&) (F fndef_singleton)
     tmp%%$
   ))
   :qid user_crate__stuff_0
   :skolemid skolem_user_crate__stuff_0
)))

;; Function-Def crate::stuff
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/fndef_types-2b591f3dc5716dd9-test_function_takes_trait_bound/test.rs:25:1: 25:22 (#0)
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/fndef_types-2b591f3dc5716dd9-test_function_takes_trait_bound/test.rs:28:7: 28:20 (#0)
(get-info :all-statistics)
(push)
 (declare-const x! X.)
 ...
 (assert
  (not (=>
    (= tmp%1 (=>
      (%B (Tr.foo.? $ TYPE%X. (Poly%X. x!)))
      (closure_req (FNDEF%stuff. $ TYPE%X.) $ (TYPE%tuple%1. $ TYPE%X.) (F fndef_singleton)
       (Poly%tuple%1. (tuple%1./tuple%1 (Poly%X. x!)))
    )))
    (=>
     %%location_label%%0
     tmp%1
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/fndef_types-2b591f3dc5716dd9-test_function_takes_trait_bound/test.rs:32:7: 32:28 (#0)
(get-info :all-statistics)
(push)
 (declare-const T&. Dcr)
 (declare-const T& Type)
 ...
 (assert
  (not (=>
    (= tmp%1 (=>
      (%B (Tr.foo.? T&. T& t!))
      (closure_req (FNDEF%stuff. T&. T&) $ (TYPE%tuple%1. T&. T&) (F fndef_singleton) (Poly%tuple%1.
        (tuple%1./tuple%1 t!)
    ))))
    (=>
     %%location_label%%0
