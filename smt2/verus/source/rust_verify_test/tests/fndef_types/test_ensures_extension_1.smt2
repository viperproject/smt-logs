...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/fndef_types-2b591f3dc5716dd9-test_ensures_extension_1/test.rs:23:5: 23:32 (#0)
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/fndef_types-2b591f3dc5716dd9-test_ensures_extension_1/test.rs:30:1: 30:31 (#0)
(get-info :all-statistics)
(push)
 (declare-const T&. Dcr)
 ...
 (assert
  (not (=>
    (= tmp%1 (=>
      (closure_ens (FNDEF%Tr.stuff. T&. T&) $ (TYPE%tuple%1. (REF T&.) T&) (F fndef_singleton)
       (Poly%tuple%1. (tuple%1./tuple%1 t!)) (I res!)
      )
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/fndef_types-2b591f3dc5716dd9-test_ensures_extension_1/test.rs:34:1: 34:22 (#0)
(get-info :all-statistics)
(push)
 (declare-const T&. Dcr)
 (declare-const T& Type)
 ...
 (assert
  (not (=>
    (= tmp%1 (not (closure_ens (FNDEF%Tr.stuff. T&. T&) $ (TYPE%tuple%1. (REF T&.) T&) (
        F fndef_singleton
       ) (Poly%tuple%1. (tuple%1./tuple%1 t!)) (I 4)
    )))
    (=>
     %%location_label%%0
     tmp%1
