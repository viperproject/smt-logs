...
(declare-fun req%Tr.hello. (Dcr Type Poly Poly) Bool)
(declare-const %%global_location_label%%0 Bool)
(assert
 (forall ((Self%&. Dcr) (Self%& Type) (i! Poly) (j! Poly)) (!
   (= (req%Tr.hello. Self%&. Self%& i! j!) (=>
     %%global_location_label%%0
     (%B (Tr.stuff.? Self%&. Self%& i! j!))
   ))
   :pattern ((req%Tr.hello. Self%&. Self%& i! j!))
   :qid internal_req__Tr.hello._definition
   :skolemid skolem_internal_req__Tr.hello._definition
)))
(assert
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/fndef_types-2b591f3dc5716dd9-trait_default_method_call_requires_with_default_spec_fn/test.rs:18:5: 18:29 (#0)
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/fndef_types-2b591f3dc5716dd9-trait_default_method_call_requires_with_default_spec_fn/test.rs:31:5: 31:29 (#0)
(get-info :all-statistics)
(push)
 (declare-const A&. Dcr)
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/fndef_types-2b591f3dc5716dd9-trait_default_method_call_requires_with_default_spec_fn/test.rs:46:5: 46:29 (#0)
(get-info :all-statistics)
(push)
 (declare-const A&. Dcr)
 (declare-const A& Type)
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/fndef_types-2b591f3dc5716dd9-trait_default_method_call_requires_with_default_spec_fn/test.rs:65:1: 65:31 (#0)
(get-info :all-statistics)
(push)
 (declare-const T&. Dcr)
 ...
 (assert
  (not (=>
    (= tmp%1 (=>
      ...
      (closure_req (FNDEF%Tr.hello. T&. T&) $ (TYPE%tuple%2. $ (UINT 64) $ (UINT 64)) (F
        fndef_singleton
       ) (Poly%tuple%2. (tuple%2./tuple%2 (I i!) (I j!)))
    )))
    (=>
     %%location_label%%0
     tmp%1
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/fndef_types-2b591f3dc5716dd9-trait_default_method_call_requires_with_default_spec_fn/test.rs:69:1: 69:36 (#0)
(get-info :all-statistics)
(push)
 (declare-const T&. Dcr)
 (declare-const T& Type)
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/fndef_types-2b591f3dc5716dd9-trait_default_method_call_requires_with_default_spec_fn/test.rs:73:1: 73:25 (#0)
(get-info :all-statistics)
(push)
 (declare-const i! Int)
 (declare-const j! Int)
 ...
 (assert
  (not (=>
    (= tmp%1 (=>
      (= i! j!)
      (closure_req (FNDEF%Tr.hello. $ (TYPE%X. $ BOOL)) $ (TYPE%tuple%2. $ (UINT 64) $ (UINT
         64
        )
       ) (F fndef_singleton) (Poly%tuple%2. (tuple%2./tuple%2 (I i!) (I j!)))
    )))
    (=>
     %%location_label%%0
     tmp%1
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/fndef_types-2b591f3dc5716dd9-trait_default_method_call_requires_with_default_spec_fn/test.rs:77:1: 77:25 (#0)
(get-info :all-statistics)
(push)
 (declare-const i! Int)
 (declare-const j! Int)
 ...
 (assert
  (not (=>
    (= tmp%1 (=>
      (= i! j!)
      (closure_req (FNDEF%Tr.hello. $ (TYPE%Y. $ BOOL)) $ (TYPE%tuple%2. $ (UINT 64) $ (UINT
         64
        )
       ) (F fndef_singleton) (Poly%tuple%2. (tuple%2./tuple%2 (I i!) (I j!)))
    )))
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/fndef_types-2b591f3dc5716dd9-trait_default_method_call_requires_with_default_spec_fn/test.rs:81:1: 81:25 (#0)
(get-info :all-statistics)
(push)
 (declare-const i! Int)
 (declare-const j! Int)
 ...
 (assert
  (not (=>
    (= tmp%1 (=>
      (= i! (Add j! 1))
      (closure_req (FNDEF%Tr.hello. $ (TYPE%Z. $ BOOL)) $ (TYPE%tuple%2. $ (UINT 64) $ (UINT
         64
        )
       ) (F fndef_singleton) (Poly%tuple%2. (tuple%2./tuple%2 (I i!) (I j!)))
    )))
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/fndef_types-2b591f3dc5716dd9-trait_default_method_call_requires_with_default_spec_fn/test.rs:85:1: 85:30 (#0)
(get-info :all-statistics)
(push)
 (declare-const i! Int)
 (declare-const j! Int)
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/fndef_types-2b591f3dc5716dd9-trait_default_method_call_requires_with_default_spec_fn/test.rs:89:1: 89:25 (#0)
(get-info :all-statistics)
(push)
 (declare-const i! Int)
 (declare-const j! Int)
 ...
 (assert
  (not (=>
    (= tmp%1 (=>
      (= i! (Add j! 1))
      (closure_req (FNDEF%Tr.hello. $ (TYPE%W. $ BOOL)) $ (TYPE%tuple%2. $ (UINT 64) $ (UINT
         64
        )
       ) (F fndef_singleton) (Poly%tuple%2. (tuple%2./tuple%2 (I i!) (I j!)))
    )))
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/fndef_types-2b591f3dc5716dd9-trait_default_method_call_requires_with_default_spec_fn/test.rs:93:1: 93:30 (#0)
(get-info :all-statistics)
(push)
 (declare-const i! Int)
 (declare-const j! Int)
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/fndef_types-2b591f3dc5716dd9-trait_default_method_call_requires_with_default_spec_fn/test.rs:97:1: 97:25 (#0)
(get-info :all-statistics)
(push)
 (declare-const i! Int)
 (declare-const j! Int)
 ...
 (assert
  (not (=>
    (= tmp%1 (=>
      (= (= i! 4) (= j! 4))
      (closure_req (FNDEF%Tr.hello. $ (TYPE%U. $ BOOL)) $ (TYPE%tuple%2. $ (UINT 64) $ (UINT
         64
        )
       ) (F fndef_singleton) (Poly%tuple%2. (tuple%2./tuple%2 (I i!) (I j!)))
    )))
