...
(assert
 (forall ((x! Int)) (!
   (= (req%test. x!) (=>
     ...
     (= fndef_singleton fndef_singleton)
   ))
   :pattern ((req%test. x!))
 ...
 (forall ((tmp%%$ Poly)) (!
   (=>
    ...
    (=>
     ...
     (closure_req FNDEF%test. $ (TYPE%tuple%1. $ (UINT 8)) (F fndef_singleton) tmp%%$)
   ))
   :pattern ((closure_req FNDEF%test. $ (TYPE%tuple%1. $ (UINT 8)) (F fndef_singleton)
     tmp%%$
   ))
   :qid user_crate__test_0
   :skolemid skolem_user_crate__test_0
)))

;; Function-Def crate::test
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/fndef_types-2b591f3dc5716dd9-recursion5_okay/test.rs:15:1: 15:15 (#0)
