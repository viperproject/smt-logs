...
(assert
 (forall ((Self%&. Dcr) (Self%& Type) (self! Poly) (%return! Poly)) (!
   (= (ens%Tr.stuff. Self%&. Self%& self! %return!) (has_type %return! (UINT 8)))
   :pattern ((ens%Tr.stuff. Self%&. Self%& self! %return!))
...
(assert
 (forall ((tmp%%$ Poly) (res$ Poly)) (!
   ...
   :qid user_crate__X__stuff_1
   :skolemid skolem_user_crate__X__stuff_1
)))

;; Function-Def crate::X::stuff
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/fndef_types-2b591f3dc5716dd9-test_ensures_extension_3/test.rs:22:5: 22:32 (#0)
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/fndef_types-2b591f3dc5716dd9-test_ensures_extension_3/test.rs:29:1: 29:25 (#0)
(get-info :all-statistics)
(push)
 (declare-const t! Int)
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/fndef_types-2b591f3dc5716dd9-test_ensures_extension_3/test.rs:34:1: 34:11 (#0)
(get-info :all-statistics)
(push)
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/fndef_types-2b591f3dc5716dd9-test_ensures_extension_3/test.rs:39:1: 39:22 (#0)
(get-info :all-statistics)
(push)
 (declare-const T&. Dcr)
