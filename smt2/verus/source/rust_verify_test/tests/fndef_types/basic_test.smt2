...
(assert
 (forall ((x! Int) (b! Bool)) (!
   (= (ens%test_crate!llama. x! b!) (= b! (= x! 4)))
   :pattern ((ens%test_crate!llama. x! b!))
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/fndef_types-2b591f3dc5716dd9-basic_test/test.rs:15:1: 15:28 (#0)
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/fndef_types-2b591f3dc5716dd9-basic_test/test.rs:22:1: 22:10 (#0)
(get-info :all-statistics)
(push)
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/fndef_types-2b591f3dc5716dd9-basic_test/test.rs:36:1: 36:11 (#0)
(get-info :all-statistics)
(push)
 (declare-const no%param Int)
 (declare-const tmp%1 Poly)
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/fndef_types-2b591f3dc5716dd9-basic_test/test.rs:43:1: 43:11 (#0)
(get-info :all-statistics)
(push)
 (declare-const no%param Int)
 (declare-const tmp%1 Poly)
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/fndef_types-2b591f3dc5716dd9-basic_test/test.rs:49:1: 49:11 (#0)
(get-info :all-statistics)
(push)
 (declare-const no%param Int)
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/fndef_types-2b591f3dc5716dd9-basic_test/test.rs:53:1: 53:11 (#0)
(get-info :all-statistics)
(push)
 (declare-const no%param Int)
 (declare-const tmp%1 Bool)
 ...
 (forall ((F&. Dcr) (F& Type) (f! Poly)) (!
   (= (req%test_crate!takes_fn1. F&. F& f!) (and
     (=>
      ...
      (closure_req F& $ (TYPE%tuple%1. $ (UINT 8)) f! (Poly%tuple%1. (tuple%1./tuple%1 (I 4))))
     )
     (=>
      %%global_location_label%%2
      (closure_req F& $ (TYPE%tuple%1. $ (UINT 8)) f! (Poly%tuple%1. (tuple%1./tuple%1 (I 7))))
     )
     (=>
      ...
      (forall ((x$ Poly) (y$ Poly)) (!
        (=>
         ...
         (=>
          (closure_ens F& $ (TYPE%tuple%1. $ (UINT 8)) f! (Poly%tuple%1. (tuple%1./tuple%1 x$))
           y$
          )
          (=>
           (= (%I x$) 4)
        ...
        :pattern ((closure_ens F& $ (TYPE%tuple%1. $ (UINT 8)) f! (Poly%tuple%1. (tuple%1./tuple%1
            x$
           )
          ) y$
        ))
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/fndef_types-2b591f3dc5716dd9-basic_test/test.rs:57:1: 57:38 (#0)
(get-info :all-statistics)
(push)
 (declare-const F&. Dcr)
 ...
 (assert
  (forall ((x$ Poly) (y$ Poly)) (!
    ...
    :qid user_test_crate__takes_fn1_10
    :skolemid skolem_user_test_crate__takes_fn1_10
 )))
 (assert
  (not true)
 )
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/fndef_types-2b591f3dc5716dd9-basic_test/test.rs:65:1: 65:16 (#0)
(get-info :all-statistics)
(push)
 (declare-const no%param Int)
 ...
 (assert
  (not (=>
    ...
    (=>
     %%location_label%%0
     (req%test_crate!takes_fn1. $ FNDEF%test_crate!llama. (F tmp%1))
 ))))
 (get-info :version)
 (set-option :rlimit 30000000)
 (check-sat)
...
(assert
 (forall ((F&. Dcr) (F& Type) (f! Poly)) (!
   (= (req%test_crate!takes_fn2. F&. F& f!) (=>
     ...
     (closure_req F& $ (TYPE%tuple%1. $ (UINT 8)) f! (Poly%tuple%1. (tuple%1./tuple%1 (I 6))))
   ))
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/fndef_types-2b591f3dc5716dd9-basic_test/test.rs:69:1: 69:38 (#0)
(get-info :all-statistics)
(push)
 (declare-const F&. Dcr)
 (declare-const F& Type)
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/fndef_types-2b591f3dc5716dd9-basic_test/test.rs:75:1: 75:16 (#0)
(get-info :all-statistics)
(push)
 (declare-const no%param Int)
 (declare-const tmp%1 fndef)
 ...
 (assert
  (not (=>
    ...
    (=>
     %%location_label%%0
     (req%test_crate!takes_fn2. $ FNDEF%test_crate!llama. (F tmp%1))
 ))))
 (get-info :version)
 (set-option :rlimit 30000000)
 (check-sat)
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/fndef_types-2b591f3dc5716dd9-basic_test/test.rs:79:1: 79:38 (#0)
(get-info :all-statistics)
(push)
 (declare-const F&. Dcr)
 (declare-const F& Type)
 ...
 (assert
  (forall ((x$ Poly) (y$ Poly)) (!
    ...
    :qid user_test_crate__takes_fn3_12
    :skolemid skolem_user_test_crate__takes_fn3_12
 )))
 (assert
  (not true)
 )
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/fndef_types-2b591f3dc5716dd9-basic_test/test.rs:85:1: 85:16 (#0)
(get-info :all-statistics)
(push)
 (declare-const no%param Int)
 (declare-const tmp%1 fndef)
 ...
 (assert
  (not (=>
    ...
    (=>
     %%location_label%%0
     (req%test_crate!takes_fn3. $ FNDEF%test_crate!llama. (F tmp%1))
 ))))
 (get-info :version)
 (set-option :rlimit 30000000)
 (check-sat)
