...
(declare-const FNDEF%test_crate!llama. Type)
...
;; Function-Specs test_crate::llama
(declare-fun req%test_crate!llama. (Int) Bool)
(declare-const %%global_location_label%%0 Bool)
(assert
 (forall ((x! Int)) (!
   (= (req%test_crate!llama. x!) (=>
     %%global_location_label%%0
     (or
      (= x! 4)
      (= x! 7)
   )))
   :pattern ((req%test_crate!llama. x!))
   :qid internal_req__test_crate!llama._definition
   :skolemid skolem_internal_req__test_crate!llama._definition
)))
(declare-fun ens%test_crate!llama. (Int Bool) Bool)
(assert
 (forall ((x! Int) (%return! Bool)) (!
   (= (ens%test_crate!llama. x! %return!) (= %return! (= x! 4)))
   :pattern ((ens%test_crate!llama. x! %return!))
   :qid internal_ens__test_crate!llama._definition
   :skolemid skolem_internal_ens__test_crate!llama._definition
)))
(assert
 (forall ((tmp%%$ Poly)) (!
   (=>
    (has_type tmp%%$ (TYPE%tuple%1. $ (UINT 8)))
    (=>
     (let
     ...
     (closure_req FNDEF%test_crate!llama. $ (TYPE%tuple%1. $ (UINT 8)) (F fndef_singleton)
      tmp%%$
   )))
   :pattern ((closure_req FNDEF%test_crate!llama. $ (TYPE%tuple%1. $ (UINT 8)) (F fndef_singleton)
     tmp%%$
   ))
   :qid user_test_crate__llama_0
   :skolemid skolem_user_test_crate__llama_0
)))
(assert
 (forall ((tmp%%$ Poly) (%return$ Poly)) (!
   (=>
    (and
     (has_type tmp%%$ (TYPE%tuple%1. $ (UINT 8)))
    ...
    (=>
     (closure_ens FNDEF%test_crate!llama. $ (TYPE%tuple%1. $ (UINT 8)) (F fndef_singleton)
      tmp%%$ %return$
     )
     (let
      ((x$ (%I (tuple%1./tuple%1/0 (%Poly%tuple%1. tmp%%$)))))
   ...
   :pattern ((closure_ens FNDEF%test_crate!llama. $ (TYPE%tuple%1. $ (UINT 8)) (F fndef_singleton)
     tmp%%$ %return$
   ))
   :qid user_test_crate__llama_1
   :skolemid skolem_user_test_crate__llama_1
)))

;; Function-Def test_crate::llama
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/fndef_types-2b591f3dc5716dd9-test_returns_clause/test.rs:15:1: 15:24 (#0)
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/fndef_types-2b591f3dc5716dd9-test_returns_clause/test.rs:22:1: 22:10 (#0)
(get-info :all-statistics)
(push)
 ...
 (assert
  (not (=>
    (= t@ fndef_singleton)
    (=>
     (= tmp%2 (tuple%1./tuple%1 (I 4)))
     (and
      (=>
       %%location_label%%0
       (req%vstd!pervasive.exec_nonstatic_call. $ (TYPE%tuple%1. $ (UINT 8)) $ BOOL $ FNDEF%test_crate!llama.
        (F t@) (Poly%tuple%1. tmp%2)
      ))
      (=>
       (ens%vstd!pervasive.exec_nonstatic_call. $ (TYPE%tuple%1. $ (UINT 8)) $ BOOL $ FNDEF%test_crate!llama.
        (F t@) (Poly%tuple%1. tmp%2) tmp%1
       )
       (=>
        (= b@ (%B tmp%1))
        (and
         ...
         (=>
          b@
          (=>
           (= tmp%4 (tuple%1./tuple%1 (I 7)))
           (and
            (=>
             %%location_label%%2
             (req%vstd!pervasive.exec_nonstatic_call. $ (TYPE%tuple%1. $ (UINT 8)) $ BOOL $ FNDEF%test_crate!llama.
              (F t@) (Poly%tuple%1. tmp%4)
            ))
            (=>
             (ens%vstd!pervasive.exec_nonstatic_call. $ (TYPE%tuple%1. $ (UINT 8)) $ BOOL $ FNDEF%test_crate!llama.
              (F t@) (Poly%tuple%1. tmp%4) tmp%3
             )
             (=>
              (= b$1@ (%B tmp%3))
              (and
                   ...
                   (=>
                    (= tmp%6 (forall ((x$ Poly) (y$ Poly)) (!
                       (=>
                        ...
                        (=>
                         (closure_ens FNDEF%test_crate!llama. $ (TYPE%tuple%1. $ (UINT 8)) (F fndef_singleton)
                          (Poly%tuple%1. (tuple%1./tuple%1 x$)) y$
                         )
                         (=>
                          (= (%I x$) 4)
                          (%B y$)
                     ...
                     (=>
                      ...
                      (=>
                       (= tmp%7 (forall ((x$ Poly) (y$ Poly)) (!
                          ...
                          :qid user_test_crate__test_4
                          :skolemid skolem_user_test_crate__test_4
                       )))
                       (=>
                        %%location_label%%6
                        tmp%7
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/fndef_types-2b591f3dc5716dd9-test_returns_clause/test.rs:36:1: 36:11 (#0)
(get-info :all-statistics)
(push)
 (declare-const no%param Int)
 (declare-const tmp%1 Poly)
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/fndef_types-2b591f3dc5716dd9-test_returns_clause/test.rs:43:1: 43:11 (#0)
(get-info :all-statistics)
(push)
 (declare-const no%param Int)
 (declare-const tmp%1 Poly)
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/fndef_types-2b591f3dc5716dd9-test_returns_clause/test.rs:49:1: 49:11 (#0)
(get-info :all-statistics)
(push)
 (declare-const no%param Int)
 ...
 (assert
  (not (=>
    (= tmp%1 (forall ((x$ Poly)) (!
       ...
       :pattern ((tuple%1./tuple%1 x$))
       :qid user_test_crate__test4_5
       :skolemid skolem_user_test_crate__test4_5
    )))
    (=>
     %%location_label%%0
     tmp%1
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/fndef_types-2b591f3dc5716dd9-test_returns_clause/test.rs:53:1: 53:11 (#0)
(get-info :all-statistics)
(push)
 (declare-const no%param Int)
 (declare-const tmp%1 Bool)
 ...
 (assert
  (not (=>
    (= tmp%1 (forall ((x$ Poly) (y$ Poly)) (!
       ...
       :qid user_test_crate__test5_7
       :skolemid skolem_user_test_crate__test5_7
    )))
    (=>
     %%location_label%%0
     tmp%1
