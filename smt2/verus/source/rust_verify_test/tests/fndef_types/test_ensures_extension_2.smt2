...
;; Datatypes
(declare-datatypes ((X. 0) (tuple%0. 0) (tuple%1. 0)) (((X./X (X./X/?t Int))) ((tuple%0./tuple%0))
  ((tuple%1./tuple%1 (tuple%1./tuple%1/?0 Poly)))
))
(declare-fun X./X/t (X.) Int)
(declare-fun tuple%1./tuple%1/0 (tuple%1.) Poly)
(declare-const TYPE%X. Type)
(declare-const TYPE%tuple%0. Type)
(declare-fun TYPE%tuple%1. (Dcr Type) Type)
(declare-fun FNDEF%Tr.stuff. (Dcr Type) Type)
(declare-const FNDEF%impl&%0.stuff. Type)
...
(assert
 (forall ((_t! Int)) (!
   (=>
    (uInv 8 _t!)
    (has_type (Poly%X. (X./X _t!)) TYPE%X.)
   )
   :pattern ((has_type (Poly%X. (X./X _t!)) TYPE%X.))
...
(assert
 (forall ((x X.)) (!
   (= (X./X/t x) (X./X/?t x))
   :pattern ((X./X/t x))
   :qid internal_X./X/t_accessor_definition
   :skolemid skolem_internal_X./X/t_accessor_definition
)))
(assert
 (forall ((x Poly)) (!
   (=>
    (has_type x TYPE%X.)
    (uInv 8 (X./X/t (%Poly%X. x)))
   )
   :pattern ((X./X/t (%Poly%X. x)) (has_type x TYPE%X.))
   :qid internal_X./X/t_invariant_definition
   :skolemid skolem_internal_X./X/t_invariant_definition
)))
(assert
 (forall ((x tuple%0.)) (!
...
(declare-fun ens%Tr.stuff. (Dcr Type Poly Poly) Bool)
(assert
 (forall ((Self%&. Dcr) (Self%& Type) (self! Poly) (res! Poly)) (!
   (= (ens%Tr.stuff. Self%&. Self%& self! res!) (and
     (has_type res! (UINT 8))
     (= (uClip 8 (EucMod (%I res!) 2)) 0)
   ))
   :pattern ((ens%Tr.stuff. Self%&. Self%& self! res!))
 ...
 (forall ((tmp%%$ Poly) (Self%&. Dcr) (Self%& Type)) (!
   (=>
    ...
    (=>
     ...
     (closure_req (FNDEF%Tr.stuff. Self%&. Self%&) $ (TYPE%tuple%1. (REF Self%&.) Self%&)
      (F fndef_singleton) tmp%%$
   )))
   :pattern ((closure_req (FNDEF%Tr.stuff. Self%&. Self%&) $ (TYPE%tuple%1. (REF Self%&.)
      Self%&
     ) (F fndef_singleton) tmp%%$
   ))
   :qid user_crate__Tr__stuff_0
   :skolemid skolem_user_crate__Tr__stuff_0
)))
(assert
 (forall ((tmp%%$ Poly) (res$ Poly) (Self%&. Dcr) (Self%& Type)) (!
   (=>
    (and
     (has_type tmp%%$ (TYPE%tuple%1. (REF Self%&.) Self%&))
     (has_type res$ (UINT 8))
    ...
    (=>
     (closure_ens (FNDEF%Tr.stuff. Self%&. Self%&) $ (TYPE%tuple%1. (REF Self%&.) Self%&)
   ...
   :pattern ((closure_ens (FNDEF%Tr.stuff. Self%&. Self%&) $ (TYPE%tuple%1. (REF Self%&.)
      Self%&
     ) (F fndef_singleton) tmp%%$ res$
   ))
   :qid user_crate__Tr__stuff_1
   :skolemid skolem_user_crate__Tr__stuff_1
)))

;; Function-Specs crate::X::stuff
(declare-fun ens%impl&%0.stuff. (Poly Poly) Bool)
(assert
 (forall ((self! Poly) (res! Poly)) (!
   (= (ens%impl&%0.stuff. self! res!) (and
     (ens%Tr.stuff. $ TYPE%X. self! res!)
     (and
      (<= 0 (%I res!))
      (<= (%I res!) (X./X/t (%Poly%X. self!)))
   )))
   :pattern ((ens%impl&%0.stuff. self! res!))
   :qid internal_ens__impl&__0.stuff._definition
   :skolemid skolem_internal_ens__impl&__0.stuff._definition
)))
(assert
 (forall ((tmp%%$ Poly) (res$ Poly)) (!
   (=>
    (and
     (has_type tmp%%$ (TYPE%tuple%1. (REF $) TYPE%X.))
     (has_type res$ (UINT 8))
    )
    (=>
     (closure_ens (FNDEF%Tr.stuff. $ TYPE%X.) $ (TYPE%tuple%1. (REF $) TYPE%X.) (F fndef_singleton)
      tmp%%$ res$
     )
     (let
      ((self$ (%Poly%X. (tuple%1./tuple%1/0 (%Poly%tuple%1. tmp%%$)))))
      (and
       (<= 0 (%I res$))
       (<= (%I res$) (X./X/t (%Poly%X. (Poly%X. self$))))
   ))))
   :pattern ((closure_ens (FNDEF%Tr.stuff. $ TYPE%X.) $ (TYPE%tuple%1. (REF $) TYPE%X.)
     (F fndef_singleton) tmp%%$ res$
   ))
   :qid user_crate__X__stuff_2
   :skolemid skolem_user_crate__X__stuff_2
)))

;; Function-Def crate::X::stuff
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/fndef_types-2b591f3dc5716dd9-test_ensures_extension_2/test.rs:23:5: 23:32 (#0)
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/fndef_types-2b591f3dc5716dd9-test_ensures_extension_2/test.rs:30:1: 30:25 (#0)
(get-info :all-statistics)
(push)
 (declare-const t! Int)
 ...
 (assert
  (not (=>
    ...
    (=>
     (= tmp%1 (=>
       (closure_ens (FNDEF%Tr.stuff. $ TYPE%X.) $ (TYPE%tuple%1. (REF $) TYPE%X.) (F fndef_singleton)
        (Poly%tuple%1. (tuple%1./tuple%1 (Poly%X. x@))) (I res!)
       )
       (and
        (= (uClip 8 (EucMod res! 2)) 0)
        (and
         (<= 0 res!)
         (<= res! t!)
     ))))
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/fndef_types-2b591f3dc5716dd9-test_ensures_extension_2/test.rs:35:1: 35:11 (#0)
(get-info :all-statistics)
(push)
 ...
 (assert
  (not (=>
    (= x@ (X./X (%I (I 20))))
    (=>
     (= tmp%1 (not (closure_ens (FNDEF%Tr.stuff. $ TYPE%X.) $ (TYPE%tuple%1. (REF $) TYPE%X.)
        (F fndef_singleton) (Poly%tuple%1. (tuple%1./tuple%1 (Poly%X. x@))) (I 10)
     )))
     (=>
      %%location_label%%0
      tmp%1
