...
(declare-const FNDEF%test_crate!b. Type)
...
;; Function-Specs test_crate::b
(assert
 (forall ((tmp%%$ Poly)) (!
   (=>
    (has_type tmp%%$ TYPE%tuple%0.)
    (closure_req FNDEF%test_crate!b. $ TYPE%tuple%0. (F fndef_singleton) tmp%%$)
   )
   :pattern ((closure_req FNDEF%test_crate!b. $ TYPE%tuple%0. (F fndef_singleton) tmp%%$))
   :qid user_test_crate__b_0
   :skolemid skolem_user_test_crate__b_0
)))

;; Function-Def test_crate::b
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/fndef_types-2b591f3dc5716dd9-exec_calling2/test.rs:21:1: 21:7 (#0)
...
;; Function-Def test_crate::a
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/fndef_types-2b591f3dc5716dd9-exec_calling2/test.rs:16:1: 16:7 (#0)
(get-info :all-statistics)
(push)
 (declare-const no%param Int)
 (declare-const tmp%1 Poly)
 (declare-const tmp%2 tuple%0.)
 (declare-const x@ fndef)
 (assert
  fuel_defaults
 )
 ...
 (assert
  (not (=>
    ...
    (=>
     ...
     (=>
      %%location_label%%0
      (req%vstd!pervasive.exec_nonstatic_call. $ TYPE%tuple%0. $ TYPE%tuple%0. $ FNDEF%test_crate!b.
       (F x@) (Poly%tuple%0. tmp%2)
 ))))))
 (get-info :version)
 (set-option :rlimit 30000000)
 (check-sat)
