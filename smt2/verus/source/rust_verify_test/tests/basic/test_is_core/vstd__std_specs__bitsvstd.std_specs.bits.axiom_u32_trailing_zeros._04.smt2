...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/basic-cf562145df495703-test_is_core/../../../../vstd/std_specs/bits.rs:467:5: 467:11 (#0)
 ...
 (not (=>
   ...
   (= (let
     ...
     (ite
      ...
      tmp$$$$bitvectmp1
      (bvudiv i! ((_ zero_extend 30) tmp$$$$bitvectmp0))
     )
    ) (bvlshr i! ((_ zero_extend 31) (_ bv1 1)))
))))
(get-info :version)
