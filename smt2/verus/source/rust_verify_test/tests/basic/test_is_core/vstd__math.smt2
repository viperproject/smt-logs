...
;; MODULE 'module vstd::math'

;; Fuel
(declare-const fuel%vstd.math.min. FuelId)
(declare-const fuel%vstd.math.max. FuelId)
(declare-const fuel%vstd.math.max3. FuelId)
(declare-const fuel%vstd.math.clip. FuelId)
(declare-const fuel%vstd.math.abs. FuelId)
(declare-const fuel%vstd.math.add. FuelId)
(declare-const fuel%vstd.math.sub. FuelId)
(declare-const fuel%vstd.math.div. FuelId)
(assert
 (distinct fuel%vstd.math.min. fuel%vstd.math.max. fuel%vstd.math.max3. fuel%vstd.math.clip.
  fuel%vstd.math.abs. fuel%vstd.math.add. fuel%vstd.math.sub. fuel%vstd.math.div.
))
...
;; Function-Decl crate::vstd::math::max
(declare-fun vstd.math.max.? (Poly Poly) Int)

;; Function-Decl crate::vstd::math::max3
(declare-fun vstd.math.max3.? (Poly Poly Poly) Int)

;; Function-Decl crate::vstd::math::clip
(declare-fun vstd.math.clip.? (Poly) Int)

;; Function-Decl crate::vstd::math::abs
(declare-fun vstd.math.abs.? (Poly) Int)
...
;; Function-Axioms crate::vstd::math::max
(assert
 (fuel_bool_default fuel%vstd.math.max.)
)
(assert
 (=>
  (fuel_bool fuel%vstd.math.max.)
  (forall ((x! Poly) (y! Poly)) (!
    (= (vstd.math.max.? x! y!) (%I (ite
       (>= (%I x!) (%I y!))
       x!
       y!
    )))
    :pattern ((vstd.math.max.? x! y!))
    :qid internal_vstd.math.max.?_definition
    :skolemid skolem_internal_vstd.math.max.?_definition
))))

;; Function-Axioms crate::vstd::math::max3
(assert
 (fuel_bool_default fuel%vstd.math.max3.)
)
(assert
 (=>
  (fuel_bool fuel%vstd.math.max3.)
  (forall ((x! Poly) (y! Poly) (z! Poly)) (!
    (= (vstd.math.max3.? x! y! z!) (ite
      (< (%I x!) (%I y!))
      (vstd.math.max.? y! z!)
      (vstd.math.max.? x! z!)
    ))
    :pattern ((vstd.math.max3.? x! y! z!))
    :qid internal_vstd.math.max3.?_definition
    :skolemid skolem_internal_vstd.math.max3.?_definition
))))
...
;; Function-Axioms crate::vstd::math::abs
(assert
 (fuel_bool_default fuel%vstd.math.abs.)
)
(assert
 (=>
  (fuel_bool fuel%vstd.math.abs.)
  (forall ((x! Poly)) (!
    (= (vstd.math.abs.? x!) (ite
      (< (%I x!) 0)
      (nClip (Sub 0 (%I x!)))
    ...
    :pattern ((vstd.math.abs.? x!))
    :qid internal_vstd.math.abs.?_definition
    :skolemid skolem_internal_vstd.math.abs.?_definition
))))
(assert
 (forall ((x! Poly)) (!
   (=>
   ...
   :pattern ((vstd.math.abs.? x!))
   :qid internal_vstd.math.abs.?_pre_post_definition
   :skolemid skolem_internal_vstd.math.abs.?_pre_post_definition
)))
