...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/basic-cf562145df495703-test_is_core/../../../../vstd/bits.rs:130:17: 130:23 (#1143)
...
(assert
 (not (=>
   %%location_label%%0
   (= (bvshl x! shift!) (bvmul (bvshl x! (bvsub shift! ((_ zero_extend 15) (_ bv1 1))))
