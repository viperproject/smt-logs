...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/basic-cf562145df495703-test_is_core/../../../../vstd/std_specs/bits.rs:481:9: 481:15 (#0)
...
(assert
 (not (=>
   ...
   (=>
    ...
    (=>
     (and
      (= (bvshl i! (bvsub ((_ zero_extend 26) (_ bv32 6)) y@)) ((_ zero_extend 31) (_ bv0
         1
      )))
      (and
       (bvule ((_ zero_extend 31) (_ bv0 1)) j@)
       (bvult j@ y@)
     ))
     (= (bvand (bvlshr i! j@) ((_ zero_extend 31) (_ bv1 1))) ((_ zero_extend 31) (_ bv0
        1
))))))))
(get-info :version)
