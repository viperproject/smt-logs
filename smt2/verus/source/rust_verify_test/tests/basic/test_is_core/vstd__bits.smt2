...
;; Function-Def crate::vstd::bits::lemma_u64_shr_is_div
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/basic-cf562145df495703-test_is_core/../../../../vstd/bits.rs:39:9: 39:57 (#1073)
      ...
      (and
       ...
       (=>
        ...
        (and
         ...
         (=>
          (= (uClip 64 (bitshr (I x!) (I shift!))) (uClip 64 (EucDiv (uClip 64 (bitshr (I x!) (I
                (uClip 64 (uClip 64 (Sub shift! 1)))
              ))
             ) 2
          )))
          (and
              ...
              (=>
               ...
               (and
                ...
                (and
                 (=>
                  %%location_label%%4
                  (req%vstd.bits.lemma_u64_shr_is_div. x! tmp%1)
                 )
                 (=>
                  (ens%vstd.bits.lemma_u64_shr_is_div. x! tmp%1)
                  (=>
                   %%location_label%%5
                   (= (uClip 64 (EucDiv (uClip 64 (bitshr (I x!) (I (uClip 64 (uClip 64 (Sub shift! 1))))))
                      2
                     )
                    ) (nClip (EucDiv (nClip (EucDiv x! (vstd.arithmetic.power2.pow2.? (I (nClip (Sub shift! 1))))))
                      2
              ))))))))
              (=>
               (= (uClip 64 (EucDiv (uClip 64 (bitshr (I x!) (I (uClip 64 (uClip 64 (Sub shift! 1))))))
               ...
               (and
                (=>
                 (= tmp%2 (nClip (Sub shift! 1)))
                 (=>
                  (ens%vstd.arithmetic.power2.lemma_pow2_pos. tmp%2)
                  (=>
                   (ens%vstd.arithmetic.power2.lemma2_to64. 0)
                   (=>
                    (= tmp%3 (vstd.arithmetic.power2.pow2.? (I (nClip (Sub shift! 1)))))
                    (and
                     (=>
                      %%location_label%%6
                      (req%vstd.arithmetic.div_mod.lemma_div_denominator. x! tmp%3 2)
                     )
                     (=>
                      (ens%vstd.arithmetic.div_mod.lemma_div_denominator. x! tmp%3 2)
                      (=>
                       %%location_label%%7
                       (= (nClip (EucDiv (nClip (EucDiv x! (vstd.arithmetic.power2.pow2.? (I (nClip (Sub shift! 1))))))
                          2
                         )
                        ) (nClip (EucDiv x! (nClip (Mul (vstd.arithmetic.power2.pow2.? (I (nClip (Sub shift! 1))))
                            (vstd.arithmetic.power2.pow2.? (I 1))
                ))))))))))))
                (=>
                 (= (nClip (EucDiv (nClip (EucDiv x! (vstd.arithmetic.power2.pow2.? (I (nClip (Sub shift! 1))))))
                    2
                 ...
                 (and
                  (=>
                   (= tmp%4 (nClip (Sub shift! 1)))
                   (=>
                    (ens%vstd.arithmetic.power2.lemma_pow2_adds. tmp%4 1)
                    (=>
                     %%location_label%%8
                     (= (nClip (EucDiv x! (nClip (Mul (vstd.arithmetic.power2.pow2.? (I (nClip (Sub shift! 1))))
                          (vstd.arithmetic.power2.pow2.? (I 1))
                  ...
                  (=>
                   ...
                   (=>
                    %%location_label%%9
                    (= (uClip 64 (bitshr (I x!) (I shift!))) (nClip (EucDiv x! (vstd.arithmetic.power2.pow2.?
                        (I shift!)
           )))))))))))))
           (=>
            (= (uClip 64 (bitshr (I x!) (I shift!))) (nClip (EucDiv x! (vstd.arithmetic.power2.pow2.?
...
;; Function-Def crate::vstd::bits::lemma_u32_shr_is_div
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/basic-cf562145df495703-test_is_core/../../../../vstd/bits.rs:39:9: 39:57 (#1080)
(get-info :all-statistics)
(push)
 (declare-const x! Int)
 (declare-const shift! Int)
      ...
      (and
       ...
       (=>
        ...
        (and
         ...
         (=>
          (= (uClip 32 (bitshr (I x!) (I shift!))) (uClip 32 (EucDiv (uClip 32 (bitshr (I x!) (I
                (uClip 32 (uClip 32 (Sub shift! 1)))
              ))
             ) 2
          )))
          (and
              ...
              (=>
               ...
               (and
                ...
                (and
                 (=>
                  %%location_label%%4
                  (req%vstd.bits.lemma_u32_shr_is_div. x! tmp%1)
                 )
                 (=>
                  (ens%vstd.bits.lemma_u32_shr_is_div. x! tmp%1)
                  (=>
                   %%location_label%%5
                   (= (uClip 32 (EucDiv (uClip 32 (bitshr (I x!) (I (uClip 32 (uClip 32 (Sub shift! 1))))))
                      2
                     )
                    ) (nClip (EucDiv (nClip (EucDiv x! (vstd.arithmetic.power2.pow2.? (I (nClip (Sub shift! 1))))))
                      2
                ...
                (=>
                 ...
                 (and
                  ...
                  (=>
                   ...
                   (=>
                    %%location_label%%9
                    (= (uClip 32 (bitshr (I x!) (I shift!))) (nClip (EucDiv x! (vstd.arithmetic.power2.pow2.?
                        (I shift!)
           )))))))))))))
           (=>
            (= (uClip 32 (bitshr (I x!) (I shift!))) (nClip (EucDiv x! (vstd.arithmetic.power2.pow2.?
...
;; Function-Def crate::vstd::bits::lemma_u16_shr_is_div
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/basic-cf562145df495703-test_is_core/../../../../vstd/bits.rs:39:9: 39:57 (#1087)
(get-info :all-statistics)
(push)
 (declare-const x! Int)
 (declare-const shift! Int)
      ...
      (and
       ...
       (=>
        ...
        (and
         ...
         (=>
          (= (uClip 16 (bitshr (I x!) (I shift!))) (uClip 16 (EucDiv (uClip 16 (bitshr (I x!) (I
                (uClip 16 (uClip 16 (Sub shift! 1)))
              ))
             ) 2
          )))
          (and
              ...
              (=>
               ...
               (and
                ...
                (and
                 (=>
                  %%location_label%%4
                  (req%vstd.bits.lemma_u16_shr_is_div. x! tmp%1)
                 )
                 (=>
                  (ens%vstd.bits.lemma_u16_shr_is_div. x! tmp%1)
                  (=>
                   %%location_label%%5
                   (= (uClip 16 (EucDiv (uClip 16 (bitshr (I x!) (I (uClip 16 (uClip 16 (Sub shift! 1))))))
                      2
                     )
                    ) (nClip (EucDiv (nClip (EucDiv x! (vstd.arithmetic.power2.pow2.? (I (nClip (Sub shift! 1))))))
                      2
                ...
                (=>
                 ...
                 (and
                  ...
                  (=>
                   ...
                   (=>
                    %%location_label%%9
                    (= (uClip 16 (bitshr (I x!) (I shift!))) (nClip (EucDiv x! (vstd.arithmetic.power2.pow2.?
                        (I shift!)
           )))))))))))))
           (=>
            (= (uClip 16 (bitshr (I x!) (I shift!))) (nClip (EucDiv x! (vstd.arithmetic.power2.pow2.?
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/basic-cf562145df495703-test_is_core/../../../../vstd/bits.rs:39:9: 39:57 (#1094)
(get-info :all-statistics)
(push)
 (declare-const x! Int)
 (declare-const shift! Int)
      ...
      (and
       ...
       (=>
        ...
        (and
         ...
         (=>
          (= (uClip 8 (bitshr (I x!) (I shift!))) (uClip 8 (EucDiv (uClip 8 (bitshr (I x!) (I (uClip
                 8 (uClip 8 (Sub shift! 1))
              )))
             ) 2
          )))
          (and
              ...
              (=>
               ...
               (and
                ...
                (and
                 (=>
                  %%location_label%%4
                  (req%vstd.bits.lemma_u8_shr_is_div. x! tmp%1)
                 )
                 (=>
                  (ens%vstd.bits.lemma_u8_shr_is_div. x! tmp%1)
                  (=>
                   %%location_label%%5
                   (= (uClip 8 (EucDiv (uClip 8 (bitshr (I x!) (I (uClip 8 (uClip 8 (Sub shift! 1))))))
                      2
                     )
                    ) (nClip (EucDiv (nClip (EucDiv x! (vstd.arithmetic.power2.pow2.? (I (nClip (Sub shift! 1))))))
                      2
                ...
                (=>
                 ...
                 (and
                  ...
                  (=>
                   ...
                   (=>
                    %%location_label%%9
                    (= (uClip 8 (bitshr (I x!) (I shift!))) (nClip (EucDiv x! (vstd.arithmetic.power2.pow2.?
                        (I shift!)
           )))))))))))))
           (=>
            (= (uClip 8 (bitshr (I x!) (I shift!))) (nClip (EucDiv x! (vstd.arithmetic.power2.pow2.?
...
;; Broadcast crate::vstd::bits::lemma_u8_shr_is_div
(assert
 (=>
  ...
  (forall ((x! Poly) (shift! Poly)) (!
    (=>
     ...
     (=>
      ...
      (= (uClip 8 (bitshr (I (%I x!)) (I (%I shift!)))) (nClip (EucDiv (%I x!) (vstd.arithmetic.power2.pow2.?
          shift!
    ))))))
    :pattern ((uClip 8 (bitshr (I (%I x!)) (I (%I shift!)))))
    :qid user_crate__vstd__bits__lemma_u8_shr_is_div_28
    :skolemid skolem_user_crate__vstd__bits__lemma_u8_shr_is_div_28
))))

;; Function-Specs crate::vstd::bits::lemma_u64_pow2_no_overflow
...
(assert
 (forall ((n! Int)) (!
   (= (ens%vstd.bits.lemma_u64_pow2_no_overflow. n!) (<= (vstd.arithmetic.power2.pow2.?
      (I n!)
...
;; Function-Def crate::vstd::bits::lemma_u64_pow2_no_overflow
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/basic-cf562145df495703-test_is_core/../../../../vstd/bits.rs:91:9: 91:45 (#1101)
(get-info :all-statistics)
(push)
 (declare-const n! Int)
 (assert
 ...
 (assert
  (not (and
    (=>
     %%location_label%%0
     (req%vstd.arithmetic.power2.lemma_pow2_strictly_increases. n! 64)
    )
    (=>
     (ens%vstd.arithmetic.power2.lemma_pow2_strictly_increases. n! 64)
     (=>
      (ens%vstd.arithmetic.power2.lemma2_to64. 0)
      (=>
       %%location_label%%1
       (<= (vstd.arithmetic.power2.pow2.? (I n!)) 18446744073709551615)
 ))))))
 (get-info :version)
 (set-option :rlimit 30000000)
 (check-sat)
...
;; Broadcast crate::vstd::bits::lemma_u64_pow2_no_overflow
(assert
 (=>
  ...
  (forall ((n! Poly)) (!
    (=>
     ...
     (=>
      ...
      (<= (vstd.arithmetic.power2.pow2.? n!) 18446744073709551615)
    ))
    :pattern ((vstd.arithmetic.power2.pow2.? n!))
    :qid user_crate__vstd__bits__lemma_u64_pow2_no_overflow_34
    :skolemid skolem_user_crate__vstd__bits__lemma_u64_pow2_no_overflow_34
))))

;; Function-Specs crate::vstd::bits::lemma_u32_pow2_no_overflow
(declare-fun req%vstd.bits.lemma_u32_pow2_no_overflow. (Int) Bool)
(declare-const %%global_location_label%%16 Bool)
(assert
 (forall ((n! Int)) (!
   (= (req%vstd.bits.lemma_u32_pow2_no_overflow. n!) (=>
     %%global_location_label%%16
     (and
      (<= 0 n!)
      (< n! 32)
   )))
   :pattern ((req%vstd.bits.lemma_u32_pow2_no_overflow. n!))
   :qid internal_req__vstd.bits.lemma_u32_pow2_no_overflow._definition
   :skolemid skolem_internal_req__vstd.bits.lemma_u32_pow2_no_overflow._definition
)))
(declare-fun ens%vstd.bits.lemma_u32_pow2_no_overflow. (Int) Bool)
(assert
 (forall ((n! Int)) (!
   (= (ens%vstd.bits.lemma_u32_pow2_no_overflow. n!) (<= (vstd.arithmetic.power2.pow2.?
      (I n!)
     ) 4294967295
   ))
   :pattern ((ens%vstd.bits.lemma_u32_pow2_no_overflow. n!))
   :qid internal_ens__vstd.bits.lemma_u32_pow2_no_overflow._definition
   :skolemid skolem_internal_ens__vstd.bits.lemma_u32_pow2_no_overflow._definition
)))

;; Function-Def crate::vstd::bits::lemma_u32_pow2_no_overflow
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/basic-cf562145df495703-test_is_core/../../../../vstd/bits.rs:91:9: 91:45 (#1108)
(get-info :all-statistics)
(push)
 (declare-const n! Int)
 (assert
 ...
 (assert
  (not (and
    (=>
     %%location_label%%0
     (req%vstd.arithmetic.power2.lemma_pow2_strictly_increases. n! 32)
    )
    (=>
     (ens%vstd.arithmetic.power2.lemma_pow2_strictly_increases. n! 32)
     (=>
      (ens%vstd.arithmetic.power2.lemma2_to64. 0)
      (=>
       %%location_label%%1
       (<= (vstd.arithmetic.power2.pow2.? (I n!)) 4294967295)
 ))))))
 (get-info :version)
 (set-option :rlimit 30000000)
 (check-sat)
...
;; Broadcast crate::vstd::bits::lemma_u32_pow2_no_overflow
(assert
 (=>
  (fuel_bool fuel%vstd.bits.lemma_u32_pow2_no_overflow.)
  (forall ((n! Poly)) (!
    (=>
     (has_type n! NAT)
     (=>
      ...
      (<= (vstd.arithmetic.power2.pow2.? n!) 4294967295)
    ))
    :pattern ((vstd.arithmetic.power2.pow2.? n!))
    :qid user_crate__vstd__bits__lemma_u32_pow2_no_overflow_35
    :skolemid skolem_user_crate__vstd__bits__lemma_u32_pow2_no_overflow_35
))))

;; Function-Specs crate::vstd::bits::lemma_u16_pow2_no_overflow
(declare-fun req%vstd.bits.lemma_u16_pow2_no_overflow. (Int) Bool)
(declare-const %%global_location_label%%17 Bool)
(assert
 (forall ((n! Int)) (!
   (= (req%vstd.bits.lemma_u16_pow2_no_overflow. n!) (=>
     %%global_location_label%%17
     (and
      (<= 0 n!)
      (< n! 16)
   )))
   :pattern ((req%vstd.bits.lemma_u16_pow2_no_overflow. n!))
   :qid internal_req__vstd.bits.lemma_u16_pow2_no_overflow._definition
   :skolemid skolem_internal_req__vstd.bits.lemma_u16_pow2_no_overflow._definition
)))
(declare-fun ens%vstd.bits.lemma_u16_pow2_no_overflow. (Int) Bool)
(assert
 (forall ((n! Int)) (!
   (= (ens%vstd.bits.lemma_u16_pow2_no_overflow. n!) (<= (vstd.arithmetic.power2.pow2.?
      (I n!)
     ) 65535
   ))
   :pattern ((ens%vstd.bits.lemma_u16_pow2_no_overflow. n!))
   :qid internal_ens__vstd.bits.lemma_u16_pow2_no_overflow._definition
   :skolemid skolem_internal_ens__vstd.bits.lemma_u16_pow2_no_overflow._definition
)))

;; Function-Def crate::vstd::bits::lemma_u16_pow2_no_overflow
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/basic-cf562145df495703-test_is_core/../../../../vstd/bits.rs:91:9: 91:45 (#1115)
(get-info :all-statistics)
(push)
 (declare-const n! Int)
 (assert
 ...
 (assert
  (not (and
    (=>
     %%location_label%%0
     (req%vstd.arithmetic.power2.lemma_pow2_strictly_increases. n! 16)
    )
    (=>
     (ens%vstd.arithmetic.power2.lemma_pow2_strictly_increases. n! 16)
     (=>
      (ens%vstd.arithmetic.power2.lemma2_to64. 0)
      (=>
       %%location_label%%1
       (<= (vstd.arithmetic.power2.pow2.? (I n!)) 65535)
 ))))))
 (get-info :version)
 (set-option :rlimit 30000000)
 (check-sat)
...
;; Broadcast crate::vstd::bits::lemma_u16_pow2_no_overflow
(assert
 (=>
  (fuel_bool fuel%vstd.bits.lemma_u16_pow2_no_overflow.)
  (forall ((n! Poly)) (!
    (=>
     (has_type n! NAT)
     (=>
      ...
      (<= (vstd.arithmetic.power2.pow2.? n!) 65535)
    ))
    :pattern ((vstd.arithmetic.power2.pow2.? n!))
    :qid user_crate__vstd__bits__lemma_u16_pow2_no_overflow_36
    :skolemid skolem_user_crate__vstd__bits__lemma_u16_pow2_no_overflow_36
))))

;; Function-Specs crate::vstd::bits::lemma_u8_pow2_no_overflow
(declare-fun req%vstd.bits.lemma_u8_pow2_no_overflow. (Int) Bool)
(declare-const %%global_location_label%%18 Bool)
(assert
 (forall ((n! Int)) (!
   (= (req%vstd.bits.lemma_u8_pow2_no_overflow. n!) (=>
     %%global_location_label%%18
     (and
      (<= 0 n!)
      (< n! 8)
   )))
   :pattern ((req%vstd.bits.lemma_u8_pow2_no_overflow. n!))
   :qid internal_req__vstd.bits.lemma_u8_pow2_no_overflow._definition
   :skolemid skolem_internal_req__vstd.bits.lemma_u8_pow2_no_overflow._definition
)))
(declare-fun ens%vstd.bits.lemma_u8_pow2_no_overflow. (Int) Bool)
(assert
 (forall ((n! Int)) (!
   (= (ens%vstd.bits.lemma_u8_pow2_no_overflow. n!) (<= (vstd.arithmetic.power2.pow2.?
      (I n!)
     ) 255
   ))
   :pattern ((ens%vstd.bits.lemma_u8_pow2_no_overflow. n!))
   :qid internal_ens__vstd.bits.lemma_u8_pow2_no_overflow._definition
   :skolemid skolem_internal_ens__vstd.bits.lemma_u8_pow2_no_overflow._definition
)))

;; Function-Def crate::vstd::bits::lemma_u8_pow2_no_overflow
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/basic-cf562145df495703-test_is_core/../../../../vstd/bits.rs:91:9: 91:45 (#1122)
(get-info :all-statistics)
(push)
 (declare-const n! Int)
 (assert
 ...
 (assert
  (not (and
    (=>
     %%location_label%%0
     (req%vstd.arithmetic.power2.lemma_pow2_strictly_increases. n! 8)
    )
    (=>
     (ens%vstd.arithmetic.power2.lemma_pow2_strictly_increases. n! 8)
     (=>
      (ens%vstd.arithmetic.power2.lemma2_to64. 0)
      (=>
       %%location_label%%1
       (<= (vstd.arithmetic.power2.pow2.? (I n!)) 255)
 ))))))
 (get-info :version)
 (set-option :rlimit 30000000)
 (check-sat)
...
;; Broadcast crate::vstd::bits::lemma_u8_pow2_no_overflow
(assert
 (=>
  (fuel_bool fuel%vstd.bits.lemma_u8_pow2_no_overflow.)
  (forall ((n! Poly)) (!
    (=>
     (has_type n! NAT)
     (=>
      ...
      (<= (vstd.arithmetic.power2.pow2.? n!) 255)
    ))
    :pattern ((vstd.arithmetic.power2.pow2.? n!))
    :qid user_crate__vstd__bits__lemma_u8_pow2_no_overflow_37
    :skolemid skolem_user_crate__vstd__bits__lemma_u8_pow2_no_overflow_37
))))

;; Function-Specs crate::vstd::bits::lemma_u64_shl_is_mul
...
;; Function-Def crate::vstd::bits::lemma_u64_shl_is_mul
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/basic-cf562145df495703-test_is_core/../../../../vstd/bits.rs:117:9: 117:57 (#1129)
(get-info :all-statistics)
(push)
 (declare-const x! Int)
 (declare-const shift! Int)
 ...
 (assert
  (not (=>
    ...
    (and
     (=>
      %%location_label%%0
      (req%vstd.bits.lemma_u64_pow2_no_overflow. shift!)
     )
     (=>
      (ens%vstd.bits.lemma_u64_pow2_no_overflow. shift!)
      (or
       (and
        (=>
         (= shift! 0)
        ...
        (=>
         ...
         (and
          ...
          (=>
           (= (uClip 64 (bitshl (I x!) (I shift!))) (uClip 64 (Mul (uClip 64 (bitshl (I x!) (I (uClip
                  64 (uClip 64 (Sub shift! 1))
               )))
              ) 2
           )))
           (and
            (=>
             (= tmp%1 (nClip (Sub shift! 1)))
             (and
              (=>
               %%location_label%%3
               (req%vstd.arithmetic.power2.lemma_pow2_strictly_increases. tmp%1 shift!)
              )
              (=>
               (ens%vstd.arithmetic.power2.lemma_pow2_strictly_increases. tmp%1 shift!)
               (=>
                (= tmp%2 (vstd.arithmetic.power2.pow2.? (I (nClip (Sub shift! 1)))))
                (=>
                 (= tmp%3 (vstd.arithmetic.power2.pow2.? (I shift!)))
                 (and
                  (=>
                   %%location_label%%4
                   (req%vstd.arithmetic.mul.lemma_mul_inequality. tmp%2 tmp%3 x!)
                  )
                  (=>
                   (ens%vstd.arithmetic.mul.lemma_mul_inequality. tmp%2 tmp%3 x!)
                   (=>
                    (= tmp%4 (vstd.arithmetic.power2.pow2.? (I (nClip (Sub shift! 1)))))
                    (=>
                     (ens%vstd.arithmetic.mul.lemma_mul_is_commutative. x! tmp%4)
                     (=>
                      (= tmp%5 (vstd.arithmetic.power2.pow2.? (I shift!)))
                      (=>
                       (ens%vstd.arithmetic.mul.lemma_mul_is_commutative. x! tmp%5)
                       (=>
                        (= tmp%6 (uClip 64 (Sub shift! 1)))
                        (and
                         (=>
                          %%location_label%%5
                          (check_decrease_int (let
                         ...
                         (and
                          (=>
                           %%location_label%%6
                           (req%vstd.bits.lemma_u64_shl_is_mul. x! tmp%6)
                          )
                          (=>
                           (ens%vstd.bits.lemma_u64_shl_is_mul. x! tmp%6)
                           (=>
                            %%location_label%%7
                            (= (uClip 64 (bitshl (I x!) (I (uClip 64 (uClip 64 (Sub shift! 1)))))) (Mul x! (vstd.arithmetic.power2.pow2.?
                               (I (uClip 64 (Sub shift! 1)))
            )))))))))))))))))))
            (=>
             (= (uClip 64 (bitshl (I x!) (I (uClip 64 (uClip 64 (Sub shift! 1)))))) (Mul x! (vstd.arithmetic.power2.pow2.?
                (I (uClip 64 (Sub shift! 1)))
             ...
             (and
              (and
               (=>
                %%location_label%%8
                (= (Mul (uClip 64 (bitshl (I x!) (I (uClip 64 (uClip 64 (Sub shift! 1)))))) 2) (Mul
                  (Mul x! (vstd.arithmetic.power2.pow2.? (I (uClip 64 (Sub shift! 1))))) 2
               )))
               (=>
                (= (Mul (uClip 64 (bitshl (I x!) (I (uClip 64 (uClip 64 (Sub shift! 1)))))) 2) (Mul
                  (Mul x! (vstd.arithmetic.power2.pow2.? (I (uClip 64 (Sub shift! 1))))) 2
                ...
                (and
                 (=>
                  (= tmp%7 (vstd.arithmetic.power2.pow2.? (I (uClip 64 (Sub shift! 1)))))
                  (=>
                   (ens%vstd.arithmetic.mul.lemma_mul_is_associative. x! tmp%7 2)
                   (=>
                    %%location_label%%9
                    (= (Mul (Mul x! (vstd.arithmetic.power2.pow2.? (I (uClip 64 (Sub shift! 1))))) 2)
                     (Mul x! (nClip (Mul (vstd.arithmetic.power2.pow2.? (I (uClip 64 (Sub shift! 1)))) 2)))
                 ))))
                 (=>
                  (= (Mul (Mul x! (vstd.arithmetic.power2.pow2.? (I (uClip 64 (Sub shift! 1))))) 2)
                   (Mul x! (nClip (Mul (vstd.arithmetic.power2.pow2.? (I (uClip 64 (Sub shift! 1)))) 2)))
                  ...
                  (and
                   (=>
                    (= tmp%8 (nClip (Sub shift! 1)))
                    (=>
                     (ens%vstd.arithmetic.power2.lemma_pow2_adds. tmp%8 1)
                     (=>
                      (ens%vstd.arithmetic.power2.lemma2_to64. 0)
                      (=>
                       %%location_label%%10
                       (= (Mul x! (nClip (Mul (vstd.arithmetic.power2.pow2.? (I (uClip 64 (Sub shift! 1))))
                           2
                         ))
                        ) (Mul x! (vstd.arithmetic.power2.pow2.? (I shift!)))
                   )))))
                   (=>
                    ...
                    (=>
                     %%location_label%%11
                     (= (Mul (uClip 64 (bitshl (I x!) (I (uClip 64 (uClip 64 (Sub shift! 1)))))) 2) (Mul
                       x! (vstd.arithmetic.power2.pow2.? (I shift!))
              )))))))))
              (=>
               (= (Mul (uClip 64 (bitshl (I x!) (I (uClip 64 (uClip 64 (Sub shift! 1)))))) 2) (Mul
                 x! (vstd.arithmetic.power2.pow2.? (I shift!))
       ...
       (and
        ...
        (=>
         %%location_label%%12
         (= (uClip 64 (bitshl (I x!) (I shift!))) (Mul x! (vstd.arithmetic.power2.pow2.? (I shift!))))
 ))))))))
 (get-info :version)
 (set-option :rlimit 30000000)
 (check-sat)
...
;; Broadcast crate::vstd::bits::lemma_u64_shl_is_mul
(assert
 (=>
  ...
  (forall ((x! Poly) (shift! Poly)) (!
    ...
    :qid user_crate__vstd__bits__lemma_u64_shl_is_mul_38
    :skolemid skolem_user_crate__vstd__bits__lemma_u64_shl_is_mul_38
))))

;; Function-Specs crate::vstd::bits::lemma_u32_shl_is_mul
...
;; Function-Def crate::vstd::bits::lemma_u32_shl_is_mul
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/basic-cf562145df495703-test_is_core/../../../../vstd/bits.rs:117:9: 117:57 (#1136)
(get-info :all-statistics)
(push)
 (declare-const x! Int)
 (declare-const shift! Int)
 ...
 (assert
  (not (=>
    ...
    (and
     (=>
      %%location_label%%0
      (req%vstd.bits.lemma_u32_pow2_no_overflow. shift!)
     )
     (=>
      (ens%vstd.bits.lemma_u32_pow2_no_overflow. shift!)
      (or
       (and
        (=>
         (= shift! 0)
        ...
        (=>
         ...
         (and
          ...
          (=>
           (= (uClip 32 (bitshl (I x!) (I shift!))) (uClip 32 (Mul (uClip 32 (bitshl (I x!) (I (uClip
                  32 (uClip 32 (Sub shift! 1))
               )))
              ) 2
           )))
           (and
                       ...
                       (=>
                        ...
                        (and
                         ...
                         (and
                          (=>
                           %%location_label%%6
                           (req%vstd.bits.lemma_u32_shl_is_mul. x! tmp%6)
                          )
                          (=>
                           (ens%vstd.bits.lemma_u32_shl_is_mul. x! tmp%6)
                           (=>
                            %%location_label%%7
                            (= (uClip 32 (bitshl (I x!) (I (uClip 32 (uClip 32 (Sub shift! 1)))))) (Mul x! (vstd.arithmetic.power2.pow2.?
                               (I (uClip 32 (Sub shift! 1)))
            )))))))))))))))))))
            (=>
             (= (uClip 32 (bitshl (I x!) (I (uClip 32 (uClip 32 (Sub shift! 1)))))) (Mul x! (vstd.arithmetic.power2.pow2.?
                (I (uClip 32 (Sub shift! 1)))
             ...
             (and
              (and
               (=>
                %%location_label%%8
                (= (Mul (uClip 32 (bitshl (I x!) (I (uClip 32 (uClip 32 (Sub shift! 1)))))) 2) (Mul
                  (Mul x! (vstd.arithmetic.power2.pow2.? (I (uClip 32 (Sub shift! 1))))) 2
               )))
               (=>
                (= (Mul (uClip 32 (bitshl (I x!) (I (uClip 32 (uClip 32 (Sub shift! 1)))))) 2) (Mul
                  (Mul x! (vstd.arithmetic.power2.pow2.? (I (uClip 32 (Sub shift! 1))))) 2
                ...
                (and
                 (=>
                  (= tmp%7 (vstd.arithmetic.power2.pow2.? (I (uClip 32 (Sub shift! 1)))))
                  (=>
                   (ens%vstd.arithmetic.mul.lemma_mul_is_associative. x! tmp%7 2)
                   (=>
                    %%location_label%%9
                    (= (Mul (Mul x! (vstd.arithmetic.power2.pow2.? (I (uClip 32 (Sub shift! 1))))) 2)
                     (Mul x! (nClip (Mul (vstd.arithmetic.power2.pow2.? (I (uClip 32 (Sub shift! 1)))) 2)))
                 ))))
                 (=>
                  (= (Mul (Mul x! (vstd.arithmetic.power2.pow2.? (I (uClip 32 (Sub shift! 1))))) 2)
                   (Mul x! (nClip (Mul (vstd.arithmetic.power2.pow2.? (I (uClip 32 (Sub shift! 1)))) 2)))
                   ...
                   (=>
                    ...
                    (=>
                     ...
                     (=>
                      ...
                      (=>
                       %%location_label%%10
                       (= (Mul x! (nClip (Mul (vstd.arithmetic.power2.pow2.? (I (uClip 32 (Sub shift! 1))))
                           2
                         ))
                        ) (Mul x! (vstd.arithmetic.power2.pow2.? (I shift!)))
                   )))))
       ...
       (and
        ...
        (=>
         %%location_label%%12
         (= (uClip 32 (bitshl (I x!) (I shift!))) (Mul x! (vstd.arithmetic.power2.pow2.? (I shift!))))
 ))))))))
 (get-info :version)
 (set-option :rlimit 30000000)
 (check-sat)
...
;; Broadcast crate::vstd::bits::lemma_u32_shl_is_mul
(assert
 (=>
  ...
  (forall ((x! Poly) (shift! Poly)) (!
    ...
    :qid user_crate__vstd__bits__lemma_u32_shl_is_mul_44
    :skolemid skolem_user_crate__vstd__bits__lemma_u32_shl_is_mul_44
))))

;; Function-Specs crate::vstd::bits::lemma_u16_shl_is_mul
...
;; Function-Def crate::vstd::bits::lemma_u16_shl_is_mul
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/basic-cf562145df495703-test_is_core/../../../../vstd/bits.rs:117:9: 117:57 (#1143)
(get-info :all-statistics)
(push)
 (declare-const x! Int)
 (declare-const shift! Int)
 ...
 (assert
  (not (=>
    ...
    (and
     (=>
      %%location_label%%0
      (req%vstd.bits.lemma_u16_pow2_no_overflow. shift!)
     )
     (=>
      (ens%vstd.bits.lemma_u16_pow2_no_overflow. shift!)
      (or
       (and
        (=>
         (= shift! 0)
        ...
        (=>
         ...
         (and
          ...
          (=>
           (= (uClip 16 (bitshl (I x!) (I shift!))) (uClip 16 (Mul (uClip 16 (bitshl (I x!) (I (uClip
                  16 (uClip 16 (Sub shift! 1))
               )))
              ) 2
           )))
           (and
                       ...
                       (=>
                        ...
                        (and
                         ...
                         (and
                          (=>
                           %%location_label%%6
                           (req%vstd.bits.lemma_u16_shl_is_mul. x! tmp%6)
                          )
                          (=>
                           (ens%vstd.bits.lemma_u16_shl_is_mul. x! tmp%6)
                           (=>
                            %%location_label%%7
                            (= (uClip 16 (bitshl (I x!) (I (uClip 16 (uClip 16 (Sub shift! 1)))))) (Mul x! (vstd.arithmetic.power2.pow2.?
                               (I (uClip 16 (Sub shift! 1)))
            )))))))))))))))))))
            (=>
             (= (uClip 16 (bitshl (I x!) (I (uClip 16 (uClip 16 (Sub shift! 1)))))) (Mul x! (vstd.arithmetic.power2.pow2.?
                (I (uClip 16 (Sub shift! 1)))
             ...
             (and
              (and
               (=>
                %%location_label%%8
                (= (Mul (uClip 16 (bitshl (I x!) (I (uClip 16 (uClip 16 (Sub shift! 1)))))) 2) (Mul
                  (Mul x! (vstd.arithmetic.power2.pow2.? (I (uClip 16 (Sub shift! 1))))) 2
               )))
               (=>
                (= (Mul (uClip 16 (bitshl (I x!) (I (uClip 16 (uClip 16 (Sub shift! 1)))))) 2) (Mul
                  (Mul x! (vstd.arithmetic.power2.pow2.? (I (uClip 16 (Sub shift! 1))))) 2
                ...
                (and
                 (=>
                  (= tmp%7 (vstd.arithmetic.power2.pow2.? (I (uClip 16 (Sub shift! 1)))))
                  (=>
                   (ens%vstd.arithmetic.mul.lemma_mul_is_associative. x! tmp%7 2)
                   (=>
                    %%location_label%%9
                    (= (Mul (Mul x! (vstd.arithmetic.power2.pow2.? (I (uClip 16 (Sub shift! 1))))) 2)
                     (Mul x! (nClip (Mul (vstd.arithmetic.power2.pow2.? (I (uClip 16 (Sub shift! 1)))) 2)))
                 ))))
                 (=>
                  (= (Mul (Mul x! (vstd.arithmetic.power2.pow2.? (I (uClip 16 (Sub shift! 1))))) 2)
                   (Mul x! (nClip (Mul (vstd.arithmetic.power2.pow2.? (I (uClip 16 (Sub shift! 1)))) 2)))
                   ...
                   (=>
                    ...
                    (=>
                     ...
                     (=>
                      ...
                      (=>
                       %%location_label%%10
                       (= (Mul x! (nClip (Mul (vstd.arithmetic.power2.pow2.? (I (uClip 16 (Sub shift! 1))))
                           2
                         ))
                        ) (Mul x! (vstd.arithmetic.power2.pow2.? (I shift!)))
                   )))))
       ...
       (and
        ...
        (=>
         %%location_label%%12
         (= (uClip 16 (bitshl (I x!) (I shift!))) (Mul x! (vstd.arithmetic.power2.pow2.? (I shift!))))
 ))))))))
 (get-info :version)
 (set-option :rlimit 30000000)
 (check-sat)
...
;; Broadcast crate::vstd::bits::lemma_u16_shl_is_mul
(assert
 (=>
  ...
  (forall ((x! Poly) (shift! Poly)) (!
    ...
    :qid user_crate__vstd__bits__lemma_u16_shl_is_mul_50
    :skolemid skolem_user_crate__vstd__bits__lemma_u16_shl_is_mul_50
))))

;; Function-Specs crate::vstd::bits::lemma_u8_shl_is_mul
...
;; Function-Def crate::vstd::bits::lemma_u8_shl_is_mul
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/basic-cf562145df495703-test_is_core/../../../../vstd/bits.rs:117:9: 117:57 (#1150)
(get-info :all-statistics)
(push)
 (declare-const x! Int)
 (declare-const shift! Int)
 ...
 (assert
  (not (=>
    ...
    (and
     (=>
      %%location_label%%0
      (req%vstd.bits.lemma_u8_pow2_no_overflow. shift!)
     )
     (=>
      (ens%vstd.bits.lemma_u8_pow2_no_overflow. shift!)
      (or
       (and
        (=>
         (= shift! 0)
        ...
        (=>
         ...
         (and
          ...
          (=>
           (= (uClip 8 (bitshl (I x!) (I shift!))) (uClip 8 (Mul (uClip 8 (bitshl (I x!) (I (uClip
                  8 (uClip 8 (Sub shift! 1))
               )))
              ) 2
           )))
                       ...
                       (=>
                        ...
                        (and
                         ...
                         (and
                          (=>
                           %%location_label%%6
                           (req%vstd.bits.lemma_u8_shl_is_mul. x! tmp%6)
                          )
                          (=>
                           (ens%vstd.bits.lemma_u8_shl_is_mul. x! tmp%6)
                           (=>
                            %%location_label%%7
                            (= (uClip 8 (bitshl (I x!) (I (uClip 8 (uClip 8 (Sub shift! 1)))))) (Mul x! (vstd.arithmetic.power2.pow2.?
                               (I (uClip 8 (Sub shift! 1)))
            )))))))))))))))))))
            (=>
             (= (uClip 8 (bitshl (I x!) (I (uClip 8 (uClip 8 (Sub shift! 1)))))) (Mul x! (vstd.arithmetic.power2.pow2.?
                (I (uClip 8 (Sub shift! 1)))
             ...
             (and
              (and
               (=>
                %%location_label%%8
                (= (Mul (uClip 8 (bitshl (I x!) (I (uClip 8 (uClip 8 (Sub shift! 1)))))) 2) (Mul (Mul
                   x! (vstd.arithmetic.power2.pow2.? (I (uClip 8 (Sub shift! 1))))
                  ) 2
               )))
               (=>
                (= (Mul (uClip 8 (bitshl (I x!) (I (uClip 8 (uClip 8 (Sub shift! 1)))))) 2) (Mul (Mul
                ...
                (and
                 (=>
                  (= tmp%7 (vstd.arithmetic.power2.pow2.? (I (uClip 8 (Sub shift! 1)))))
                  (=>
                   (ens%vstd.arithmetic.mul.lemma_mul_is_associative. x! tmp%7 2)
                   (=>
                    %%location_label%%9
                    (= (Mul (Mul x! (vstd.arithmetic.power2.pow2.? (I (uClip 8 (Sub shift! 1))))) 2) (
                      Mul x! (nClip (Mul (vstd.arithmetic.power2.pow2.? (I (uClip 8 (Sub shift! 1)))) 2))
                 )))))
                 (=>
                  (= (Mul (Mul x! (vstd.arithmetic.power2.pow2.? (I (uClip 8 (Sub shift! 1))))) 2) (
                    Mul x! (nClip (Mul (vstd.arithmetic.power2.pow2.? (I (uClip 8 (Sub shift! 1)))) 2))
                  ...
                  (and
                   ...
                   (=>
                    ...
                    (=>
                     %%location_label%%11
                     (= (Mul (uClip 8 (bitshl (I x!) (I (uClip 8 (uClip 8 (Sub shift! 1)))))) 2) (Mul x!
                       (vstd.arithmetic.power2.pow2.? (I shift!))
              )))))))))
              (=>
               (= (Mul (uClip 8 (bitshl (I x!) (I (uClip 8 (uClip 8 (Sub shift! 1)))))) 2) (Mul x!
                 (vstd.arithmetic.power2.pow2.? (I shift!))
       ...
       (and
        ...
        (=>
         %%location_label%%12
         (= (uClip 8 (bitshl (I x!) (I shift!))) (Mul x! (vstd.arithmetic.power2.pow2.? (I shift!))))
 ))))))))
 (get-info :version)
 (set-option :rlimit 30000000)
 (check-sat)
...
;; Broadcast crate::vstd::bits::lemma_u8_shl_is_mul
(assert
 (=>
  ...
  (forall ((x! Poly) (shift! Poly)) (!
    ...
    :qid user_crate__vstd__bits__lemma_u8_shl_is_mul_56
    :skolemid skolem_user_crate__vstd__bits__lemma_u8_shl_is_mul_56
))))

;; Function-Specs crate::vstd::bits::lemma_low_bits_mask_unfold
...
;; Function-Def crate::vstd::bits::lemma_low_bits_mask_unfold
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/basic-cf562145df495703-test_is_core/../../../../vstd/bits.rs:178:1: 178:58 (#0)
(get-info :all-statistics)
(push)
 (declare-const n! Int)
 (declare-const tmp%1 Int)
 ...
 (assert
  (not (and
    (and
     (=>
      %%location_label%%0
      (= (vstd.bits.low_bits_mask.? (I n!)) (nClip (Sub (vstd.arithmetic.power2.pow2.? (I n!))
         1
     ))))
     (=>
      (= (vstd.bits.low_bits_mask.? (I n!)) (nClip (Sub (vstd.arithmetic.power2.pow2.? (I n!))
      ...
      (and
       (and
        (=>
         %%location_label%%1
         (req%vstd.arithmetic.power2.lemma_pow2_unfold. n!)
        )
        (=>
         (ens%vstd.arithmetic.power2.lemma_pow2_unfold. n!)
         (=>
          %%location_label%%2
          (= (nClip (Sub (vstd.arithmetic.power2.pow2.? (I n!)) 1)) (nClip (Sub (nClip (Mul 2 (vstd.arithmetic.power2.pow2.?
                (I (nClip (Sub n! 1)))
              ))
             ) 1
       ))))))
       (=>
        ...
        (and
         (=>
          %%location_label%%3
          (= (nClip (Sub (nClip (Mul 2 (vstd.arithmetic.power2.pow2.? (I (nClip (Sub n! 1))))))
             1
            )
           ) (nClip (Add (Mul 2 (Sub (vstd.arithmetic.power2.pow2.? (I (nClip (Sub n! 1)))) 1))
             1
         ))))
         (=>
          (= (nClip (Sub (nClip (Mul 2 (vstd.arithmetic.power2.pow2.? (I (nClip (Sub n! 1))))))
          ...
          (and
           (=>
            (= tmp%1 (nClip (Sub n! 1)))
            (=>
             (ens%vstd.arithmetic.power2.lemma_pow2_pos. tmp%1)
             (=>
              %%location_label%%4
              (= (nClip (Add (Mul 2 (Sub (vstd.arithmetic.power2.pow2.? (I (nClip (Sub n! 1)))) 1))
                 1
           ...
           (=>
            ...
            (=>
             %%location_label%%5
             (= (vstd.bits.low_bits_mask.? (I n!)) (nClip (Add (nClip (Mul 2 (vstd.bits.low_bits_mask.?
                   (I (nClip (Sub n! 1)))
                 ))
                ) 1
    ))))))))))))
...
;; Broadcast crate::vstd::bits::lemma_low_bits_mask_unfold
(assert
 (=>
  ...
  (forall ((n! Poly)) (!
    ...
    :pattern ((vstd.bits.low_bits_mask.? n!))
    :qid user_crate__vstd__bits__lemma_low_bits_mask_unfold_62
    :skolemid skolem_user_crate__vstd__bits__lemma_low_bits_mask_unfold_62
))))

;; Function-Specs crate::vstd::bits::lemma_low_bits_mask_is_odd
(declare-fun req%vstd.bits.lemma_low_bits_mask_is_odd. (Int) Bool)
(declare-const %%global_location_label%%28 Bool)
(assert
 (forall ((n! Int)) (!
   (= (req%vstd.bits.lemma_low_bits_mask_is_odd. n!) (=>
     %%global_location_label%%28
     (> n! 0)
   ))
   :pattern ((req%vstd.bits.lemma_low_bits_mask_is_odd. n!))
   :qid internal_req__vstd.bits.lemma_low_bits_mask_is_odd._definition
   :skolemid skolem_internal_req__vstd.bits.lemma_low_bits_mask_is_odd._definition
)))
(declare-fun ens%vstd.bits.lemma_low_bits_mask_is_odd. (Int) Bool)
(assert
 (forall ((n! Int)) (!
   (= (ens%vstd.bits.lemma_low_bits_mask_is_odd. n!) (= (nClip (EucMod (vstd.bits.low_bits_mask.?
        (I n!)
       ) 2
      )
     ) 1
   ))
   :pattern ((ens%vstd.bits.lemma_low_bits_mask_is_odd. n!))
   :qid internal_ens__vstd.bits.lemma_low_bits_mask_is_odd._definition
   :skolemid skolem_internal_ens__vstd.bits.lemma_low_bits_mask_is_odd._definition
)))

;; Function-Def crate::vstd::bits::lemma_low_bits_mask_is_odd
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/basic-cf562145df495703-test_is_core/../../../../vstd/bits.rs:199:1: 199:58 (#0)
(get-info :all-statistics)
(push)
 (declare-const n! Int)
 (declare-const tmp%1 Int)
  ...
  (not (and
    (and
     (and
      ...
      (=>
       (ens%vstd.bits.lemma_low_bits_mask_unfold. n!)
       (=>
        %%location_label%%1
        (= (nClip (EucMod (vstd.bits.low_bits_mask.? (I n!)) 2)) (nClip (EucMod (nClip (Add (nClip
              (Mul 2 (vstd.bits.low_bits_mask.? (I (nClip (Sub n! 1)))))
             ) 1
            )
           ) 2
     ))))))
     (=>
      ...
      (and
       (=>
        (= tmp%1 (vstd.bits.low_bits_mask.? (I (nClip (Sub n! 1)))))
        (and
         (=>
          %%location_label%%2
          (req%vstd.arithmetic.div_mod.lemma_mod_multiples_vanish. tmp%1 1 2)
         )
         (=>
          (ens%vstd.arithmetic.div_mod.lemma_mod_multiples_vanish. tmp%1 1 2)
          (=>
           %%location_label%%3
           (= (nClip (EucMod (nClip (Add (nClip (Mul 2 (vstd.bits.low_bits_mask.? (I (nClip (Sub n! 1))))))
                1
               )
              ) 2
             )
       ...
       (=>
        ...
        (=>
         %%location_label%%4
         (= (nClip (EucMod (vstd.bits.low_bits_mask.? (I n!)) 2)) (nClip (EucMod 1 2)))
    )))))
    (=>
     (= (nClip (EucMod (vstd.bits.low_bits_mask.? (I n!)) 2)) (nClip (EucMod 1 2)))
     (=>
      %%location_label%%5
      (= (nClip (EucMod (vstd.bits.low_bits_mask.? (I n!)) 2)) 1)
 )))))
 (get-info :version)
 (set-option :rlimit 30000000)
 (check-sat)
...
;; Broadcast crate::vstd::bits::lemma_low_bits_mask_is_odd
(assert
 (=>
  (fuel_bool fuel%vstd.bits.lemma_low_bits_mask_is_odd.)
  (forall ((n! Poly)) (!
    (=>
     (has_type n! NAT)
     (=>
      (> (%I n!) 0)
      (= (nClip (EucMod (vstd.bits.low_bits_mask.? n!) 2)) 1)
    ))
    :pattern ((nClip (EucMod (vstd.bits.low_bits_mask.? n!) 2)))
    :qid user_crate__vstd__bits__lemma_low_bits_mask_is_odd_68
    :skolemid skolem_user_crate__vstd__bits__lemma_low_bits_mask_is_odd_68
))))

;; Function-Specs crate::vstd::bits::lemma_low_bits_mask_div2
...
(assert
 (forall ((n! Int)) (!
   (= (ens%vstd.bits.lemma_low_bits_mask_div2. n!) (= (nClip (EucDiv (vstd.bits.low_bits_mask.?
        (I n!)
       ) 2
      )
...
;; Function-Def crate::vstd::bits::lemma_low_bits_mask_div2
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/basic-cf562145df495703-test_is_core/../../../../vstd/bits.rs:218:1: 218:56 (#0)
(get-info :all-statistics)
(push)
 (declare-const n! Int)
 (assert
 ...
 (assert
  (not (and
    ...
    (=>
     ...
     (=>
      %%location_label%%1
      (= (nClip (EucDiv (vstd.bits.low_bits_mask.? (I n!)) 2)) (vstd.bits.low_bits_mask.?
        (I (nClip (Sub n! 1)))
 )))))))
 (get-info :version)
 (set-option :rlimit 30000000)
...
;; Broadcast crate::vstd::bits::lemma_low_bits_mask_div2
(assert
 (=>
  ...
  (forall ((n! Poly)) (!
    (=>
     ...
     (=>
      (> (%I n!) 0)
      (= (nClip (EucDiv (vstd.bits.low_bits_mask.? n!) 2)) (vstd.bits.low_bits_mask.? (I (
          nClip (Sub (%I n!) 1)
    ))))))
    :pattern ((nClip (EucDiv (vstd.bits.low_bits_mask.? n!) 2)))
    :qid user_crate__vstd__bits__lemma_low_bits_mask_div2_72
    :skolemid skolem_user_crate__vstd__bits__lemma_low_bits_mask_div2_72
))))

;; Function-Specs crate::vstd::bits::lemma_low_bits_mask_values
...
;; Function-Def crate::vstd::bits::lemma_low_bits_mask_values
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/basic-cf562145df495703-test_is_core/../../../../vstd/bits.rs:229:1: 229:42 (#0)
(get-info :all-statistics)
(push)
...
;; Function-Specs crate::vstd::bits::lemma_u64_and_split_low_bit
(declare-fun ens%vstd.bits.lemma_u64_and_split_low_bit. (Int Int) Bool)
(assert
 (forall ((x! Int) (m! Int)) (!
   (= (ens%vstd.bits.lemma_u64_and_split_low_bit. x! m!) (= (uClip 64 (bitand (I x!) (I m!)))
     (uClip 64 (Add (uClip 64 (Mul (uClip 64 (bitand (I (uClip 64 (EucDiv x! 2))) (I (uClip 64
             (EucDiv m! 2)
          )))
         ) 2
        )
       ) (uClip 64 (bitand (I (uClip 64 (EucMod x! 2))) (I (uClip 64 (EucMod m! 2)))))
   ))))
   :pattern ((ens%vstd.bits.lemma_u64_and_split_low_bit. x! m!))
   :qid internal_ens__vstd.bits.lemma_u64_and_split_low_bit._definition
   :skolemid skolem_internal_ens__vstd.bits.lemma_u64_and_split_low_bit._definition
)))

;; Function-Specs crate::vstd::bits::lemma_u64_low_bits_mask_is_mod
...
(assert
 (forall ((x! Int) (n! Int)) (!
   (= (ens%vstd.bits.lemma_u64_low_bits_mask_is_mod. x! n!) (= (uClip 64 (bitand (I x!)
     ...
     ) (uClip 64 (EucMod x! (uClip 64 (vstd.arithmetic.power2.pow2.? (I n!)))))
   ))
...
;; Function-Def crate::vstd::bits::lemma_u64_low_bits_mask_is_mod
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/basic-cf562145df495703-test_is_core/../../../../vstd/bits.rs:315:9: 315:53 (#1162)
(get-info :all-statistics)
(push)
 (declare-const x! Int)
 (declare-const n! Int)
 ...
 (assert
  (not (=>
    ...
    (and
     ...
     (=>
      (ens%vstd.bits.lemma_u64_pow2_no_overflow. n!)
      (=>
       (ens%vstd.arithmetic.power2.lemma_pow2_pos. n!)
       (or
        (and
         (=>
          (= n! 0)
          (=>
           ...
           (and
            ...
            (=>
             (= (uClip 64 (bitand (I x!) (I 0))) 0)
             (=>
              (= (vstd.arithmetic.power2.pow2.? (I 0)) 1)
              (=>
               (= tmp%1 (= (uClip 64 (EucMod x! 1)) 0))
               (and
                (=>
                 %%location_label%%2
                 tmp%1
          ...
          (and
           ...
           (=>
            ...
            (and
             ...
             (=>
              (= (uClip 64 (EucMod x! 2)) (uClip 64 (bitand (I (uClip 64 (EucMod x! 2))) (I 1))))
              (and
               (and
                (=>
                 %%location_label%%5
                 (= (uClip 64 (EucMod x! (uClip 64 (vstd.arithmetic.power2.pow2.? (I n!))))) (uClip
                   64 (EucMod x! (uClip 64 (nClip (Mul 2 (vstd.arithmetic.power2.pow2.? (I (nClip (Sub n! 1))))))))
                )))
                (=>
                 (= (uClip 64 (EucMod x! (uClip 64 (vstd.arithmetic.power2.pow2.? (I n!))))) (uClip
                   64 (EucMod x! (uClip 64 (nClip (Mul 2 (vstd.arithmetic.power2.pow2.? (I (nClip (Sub n! 1))))))))
                 ...
                 (and
                  (=>
                   ...
                   (=>
                    (ens%vstd.arithmetic.power2.lemma_pow2_pos. tmp%2)
                    (=>
                     (= tmp%3 (vstd.arithmetic.power2.pow2.? (I (nClip (Sub n! 1)))))
                     (and
                      (=>
                       %%location_label%%6
                       (req%vstd.arithmetic.div_mod.lemma_mod_breakdown. x! 2 tmp%3)
                      )
                      (=>
                       (ens%vstd.arithmetic.div_mod.lemma_mod_breakdown. x! 2 tmp%3)
                       (=>
                        %%location_label%%7
                        (= (uClip 64 (EucMod x! (uClip 64 (nClip (Mul 2 (vstd.arithmetic.power2.pow2.? (I (nClip (
                                  Sub n! 1
                          ))))))))
                         ) (uClip 64 (Add (uClip 64 (Mul 2 (uClip 64 (EucMod (uClip 64 (EucDiv x! 2)) (uClip 64 (
                                 vstd.arithmetic.power2.pow2.? (I (nClip (Sub n! 1)))
                            )))))
                           ) (uClip 64 (EucMod x! 2))
                  )))))))))
                  (=>
                     ...
                     (=>
                      ...
                      (and
                       ...
                       (and
                        (=>
                         %%location_label%%9
                         (req%vstd.bits.lemma_u64_low_bits_mask_is_mod. tmp%4 tmp%5)
                        )
                        (=>
                         (ens%vstd.bits.lemma_u64_low_bits_mask_is_mod. tmp%4 tmp%5)
                         (=>
                          %%location_label%%10
                          (= (uClip 64 (Add (uClip 64 (Mul 2 (uClip 64 (EucMod (uClip 64 (EucDiv x! 2)) (uClip 64 (
                                   vstd.arithmetic.power2.pow2.? (I (nClip (Sub n! 1)))
                           ...
                           ) (uClip 64 (Add (uClip 64 (Mul 2 (uClip 64 (bitand (I (uClip 64 (EucDiv x! 2))) (I (uClip
                                   64 (vstd.bits.low_bits_mask.? (I (nClip (Sub n! 1))))
                              )))))
                             ) (uClip 64 (EucMod x! 2))
                    )))))))))
                    (=>
                     ...
                     (and
                      (and
                       ...
                       (=>
                        (ens%vstd.bits.lemma_low_bits_mask_div2. n!)
                        (=>
                         %%location_label%%12
                         (= (uClip 64 (Add (uClip 64 (Mul 2 (uClip 64 (bitand (I (uClip 64 (EucDiv x! 2))) (I (uClip
                                  64 (vstd.bits.low_bits_mask.? (I (nClip (Sub n! 1))))
                                  ...
                                  64 (EucDiv (uClip 64 (vstd.bits.low_bits_mask.? (I n!))) 2)
                             )))))
                            ) (uClip 64 (EucMod x! 2))
                      ))))))
                      (=>
                       ...
                       (and
                        (and
                         ...
                         (=>
                          (ens%vstd.bits.lemma_low_bits_mask_is_odd. n!)
                          (=>
                           %%location_label%%14
                           (= (uClip 64 (Add (uClip 64 (Mul 2 (uClip 64 (bitand (I (uClip 64 (EucDiv x! 2))) (I (uClip
                                    64 (EucDiv (uClip 64 (vstd.bits.low_bits_mask.? (I n!))) 2)
                              ...
                              ) (uClip 64 (bitand (I (uClip 64 (EucMod x! 2))) (I (uClip 64 (EucMod (uClip 64 (vstd.bits.low_bits_mask.?
                                     (I n!)
                                    )
                                   ) 2
                        )))))))))))
                        (=>
                         ...
                         (and
                          (=>
                           (= tmp%6 (uClip 64 (vstd.bits.low_bits_mask.? (I n!))))
                           (=>
                            (ens%vstd.bits.lemma_u64_and_split_low_bit. (uClip 64 x!) tmp%6)
                            (=>
                             %%location_label%%15
                             (= (uClip 64 (Add (uClip 64 (Mul 2 (uClip 64 (bitand (I (uClip 64 (EucDiv x! 2))) (I (uClip
                                      64 (EucDiv (uClip 64 (vstd.bits.low_bits_mask.? (I n!))) 2)
                              ...
                              ) (uClip 64 (bitand (I x!) (I (uClip 64 (vstd.bits.low_bits_mask.? (I n!))))))
                          ))))
                          (=>
                           (= (uClip 64 (Add (uClip 64 (Mul 2 (uClip 64 (bitand (I (uClip 64 (EucDiv x! 2))) (I (uClip
                                    64 (EucDiv (uClip 64 (vstd.bits.low_bits_mask.? (I n!))) 2)
                           ...
                           (=>
                            %%location_label%%16
                            (= (uClip 64 (EucMod x! (uClip 64 (vstd.arithmetic.power2.pow2.? (I n!))))) (uClip
                              64 (bitand (I x!) (I (uClip 64 (vstd.bits.low_bits_mask.? (I n!)))))
               )))))))))))))))
               (=>
                (= (uClip 64 (EucMod x! (uClip 64 (vstd.arithmetic.power2.pow2.? (I n!))))) (uClip
                  64 (bitand (I x!) (I (uClip 64 (vstd.bits.low_bits_mask.? (I n!)))))
        ...
        (and
         ...
         (=>
          %%location_label%%17
          (= (uClip 64 (bitand (I x!) (I (uClip 64 (vstd.bits.low_bits_mask.? (I n!)))))) (uClip
            64 (EucMod x! (uClip 64 (vstd.arithmetic.power2.pow2.? (I n!))))
 )))))))))))
 (get-info :version)
 (set-option :rlimit 30000000)
 (check-sat)
...
;; Broadcast crate::vstd::bits::lemma_u64_low_bits_mask_is_mod
(assert
 (=>
    ...
    (=>
     ...
     (=>
      ...
      (= (uClip 64 (bitand (I (%I x!)) (I (uClip 64 (vstd.bits.low_bits_mask.? n!))))) (
        uClip 64 (EucMod (%I x!) (uClip 64 (vstd.arithmetic.power2.pow2.? n!)))
    ))))
    :pattern ((uClip 64 (bitand (I (%I x!)) (I (uClip 64 (vstd.bits.low_bits_mask.? n!))))))
    :qid user_crate__vstd__bits__lemma_u64_low_bits_mask_is_mod_73
    :skolemid skolem_user_crate__vstd__bits__lemma_u64_low_bits_mask_is_mod_73
))))

;; Function-Specs crate::vstd::bits::lemma_u32_and_split_low_bit
(declare-fun ens%vstd.bits.lemma_u32_and_split_low_bit. (Int Int) Bool)
(assert
 (forall ((x! Int) (m! Int)) (!
   (= (ens%vstd.bits.lemma_u32_and_split_low_bit. x! m!) (= (uClip 32 (bitand (I x!) (I m!)))
     (uClip 32 (Add (uClip 32 (Mul (uClip 32 (bitand (I (uClip 32 (EucDiv x! 2))) (I (uClip 32
             (EucDiv m! 2)
          )))
         ) 2
        )
       ) (uClip 32 (bitand (I (uClip 32 (EucMod x! 2))) (I (uClip 32 (EucMod m! 2)))))
   ))))
   :pattern ((ens%vstd.bits.lemma_u32_and_split_low_bit. x! m!))
   :qid internal_ens__vstd.bits.lemma_u32_and_split_low_bit._definition
   :skolemid skolem_internal_ens__vstd.bits.lemma_u32_and_split_low_bit._definition
)))

;; Function-Specs crate::vstd::bits::lemma_u32_low_bits_mask_is_mod
...
(assert
 (forall ((x! Int) (n! Int)) (!
   (= (ens%vstd.bits.lemma_u32_low_bits_mask_is_mod. x! n!) (= (uClip 32 (bitand (I x!)
     ...
     ) (uClip 32 (EucMod x! (uClip 32 (vstd.arithmetic.power2.pow2.? (I n!)))))
   ))
...
;; Function-Def crate::vstd::bits::lemma_u32_low_bits_mask_is_mod
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/basic-cf562145df495703-test_is_core/../../../../vstd/bits.rs:315:9: 315:53 (#1169)
(get-info :all-statistics)
(push)
 (declare-const x! Int)
 (declare-const n! Int)
 ...
 (assert
  (not (=>
    ...
    (and
     ...
     (=>
      (ens%vstd.bits.lemma_u32_pow2_no_overflow. n!)
      (=>
       (ens%vstd.arithmetic.power2.lemma_pow2_pos. n!)
       (or
        (and
         (=>
          ...
          (=>
           ...
           (and
            ...
            (=>
             (= (uClip 32 (bitand (I x!) (I 0))) 0)
             (=>
              (= (vstd.arithmetic.power2.pow2.? (I 0)) 1)
              (=>
               (= tmp%1 (= (uClip 32 (EucMod x! 1)) 0))
               (and
                (=>
                 %%location_label%%2
                 tmp%1
          ...
          (and
           ...
           (=>
            ...
            (and
             ...
             (=>
              (= (uClip 32 (EucMod x! 2)) (uClip 32 (bitand (I (uClip 32 (EucMod x! 2))) (I 1))))
              (and
               (and
                (=>
                 %%location_label%%5
                 (= (uClip 32 (EucMod x! (uClip 32 (vstd.arithmetic.power2.pow2.? (I n!))))) (uClip
                   32 (EucMod x! (uClip 32 (nClip (Mul 2 (vstd.arithmetic.power2.pow2.? (I (nClip (Sub n! 1))))))))
                )))
                (=>
                 (= (uClip 32 (EucMod x! (uClip 32 (vstd.arithmetic.power2.pow2.? (I n!))))) (uClip
                   32 (EucMod x! (uClip 32 (nClip (Mul 2 (vstd.arithmetic.power2.pow2.? (I (nClip (Sub n! 1))))))))
                    ...
                    (=>
                     ...
                     (and
                      ...
                      (=>
                       ...
                       (=>
                        %%location_label%%7
                        (= (uClip 32 (EucMod x! (uClip 32 (nClip (Mul 2 (vstd.arithmetic.power2.pow2.? (I (nClip (
                                  Sub n! 1
                          ))))))))
                         ) (uClip 32 (Add (uClip 32 (Mul 2 (uClip 32 (EucMod (uClip 32 (EucDiv x! 2)) (uClip 32 (
                                 vstd.arithmetic.power2.pow2.? (I (nClip (Sub n! 1)))
                            )))))
                           ) (uClip 32 (EucMod x! 2))
                  )))))))))
                     ...
                     (=>
                      ...
                      (and
                       ...
                       (and
                        (=>
                         %%location_label%%9
                         (req%vstd.bits.lemma_u32_low_bits_mask_is_mod. tmp%4 tmp%5)
                        )
                        (=>
                         (ens%vstd.bits.lemma_u32_low_bits_mask_is_mod. tmp%4 tmp%5)
                         (=>
                          %%location_label%%10
                          (= (uClip 32 (Add (uClip 32 (Mul 2 (uClip 32 (EucMod (uClip 32 (EucDiv x! 2)) (uClip 32 (
                                   vstd.arithmetic.power2.pow2.? (I (nClip (Sub n! 1)))
                           ...
                           ) (uClip 32 (Add (uClip 32 (Mul 2 (uClip 32 (bitand (I (uClip 32 (EucDiv x! 2))) (I (uClip
                                   32 (vstd.bits.low_bits_mask.? (I (nClip (Sub n! 1))))
                              )))))
                             ) (uClip 32 (EucMod x! 2))
                    )))))))))
                    (=>
                       ...
                       (=>
                        ...
                        (=>
                         ...
                         (= (uClip 32 (Add (uClip 32 (Mul 2 (uClip 32 (bitand (I (uClip 32 (EucDiv x! 2))) (I (uClip
                                  ...
                                  32 (EucDiv (uClip 32 (vstd.bits.low_bits_mask.? (I n!))) 2)
                             )))))
                            ) (uClip 32 (EucMod x! 2))
                      ))))))
                      (=>
                       ...
                       (and
                         ...
                         (=>
                          ...
                          (=>
                           ...
                           (= (uClip 32 (Add (uClip 32 (Mul 2 (uClip 32 (bitand (I (uClip 32 (EucDiv x! 2))) (I (uClip
                              ...
                              ) (uClip 32 (bitand (I (uClip 32 (EucMod x! 2))) (I (uClip 32 (EucMod (uClip 32 (vstd.bits.low_bits_mask.?
                                     (I n!)
                                    )
                                   ) 2
                        )))))))))))
                        (=>
                         ...
                         (and
                          (=>
                           (= tmp%6 (uClip 32 (vstd.bits.low_bits_mask.? (I n!))))
                           (=>
                            (ens%vstd.bits.lemma_u32_and_split_low_bit. (uClip 32 x!) tmp%6)
                            (=>
                             %%location_label%%15
                             (= (uClip 32 (Add (uClip 32 (Mul 2 (uClip 32 (bitand (I (uClip 32 (EucDiv x! 2))) (I (uClip
                                      32 (EucDiv (uClip 32 (vstd.bits.low_bits_mask.? (I n!))) 2)
                              ...
                              ) (uClip 32 (bitand (I x!) (I (uClip 32 (vstd.bits.low_bits_mask.? (I n!))))))
                          ))))
                          (=>
                           (= (uClip 32 (Add (uClip 32 (Mul 2 (uClip 32 (bitand (I (uClip 32 (EucDiv x! 2))) (I (uClip
                                    32 (EucDiv (uClip 32 (vstd.bits.low_bits_mask.? (I n!))) 2)
                           ...
                           (=>
                            %%location_label%%16
                            (= (uClip 32 (EucMod x! (uClip 32 (vstd.arithmetic.power2.pow2.? (I n!))))) (uClip
                              32 (bitand (I x!) (I (uClip 32 (vstd.bits.low_bits_mask.? (I n!)))))
               )))))))))))))))
               (=>
                (= (uClip 32 (EucMod x! (uClip 32 (vstd.arithmetic.power2.pow2.? (I n!))))) (uClip
                  32 (bitand (I x!) (I (uClip 32 (vstd.bits.low_bits_mask.? (I n!)))))
        ...
        (and
         ...
         (=>
          %%location_label%%17
          (= (uClip 32 (bitand (I x!) (I (uClip 32 (vstd.bits.low_bits_mask.? (I n!)))))) (uClip
            32 (EucMod x! (uClip 32 (vstd.arithmetic.power2.pow2.? (I n!))))
 )))))))))))
 (get-info :version)
 (set-option :rlimit 30000000)
 (check-sat)
...
;; Broadcast crate::vstd::bits::lemma_u32_low_bits_mask_is_mod
(assert
 (=>
    ...
    (=>
     ...
     (=>
      ...
      (= (uClip 32 (bitand (I (%I x!)) (I (uClip 32 (vstd.bits.low_bits_mask.? n!))))) (
        uClip 32 (EucMod (%I x!) (uClip 32 (vstd.arithmetic.power2.pow2.? n!)))
    ))))
    :pattern ((uClip 32 (bitand (I (%I x!)) (I (uClip 32 (vstd.bits.low_bits_mask.? n!))))))
    :qid user_crate__vstd__bits__lemma_u32_low_bits_mask_is_mod_81
    :skolemid skolem_user_crate__vstd__bits__lemma_u32_low_bits_mask_is_mod_81
))))

;; Function-Specs crate::vstd::bits::lemma_u16_and_split_low_bit
(declare-fun ens%vstd.bits.lemma_u16_and_split_low_bit. (Int Int) Bool)
(assert
 (forall ((x! Int) (m! Int)) (!
   (= (ens%vstd.bits.lemma_u16_and_split_low_bit. x! m!) (= (uClip 16 (bitand (I x!) (I m!)))
     (uClip 16 (Add (uClip 16 (Mul (uClip 16 (bitand (I (uClip 16 (EucDiv x! 2))) (I (uClip 16
             (EucDiv m! 2)
          )))
         ) 2
        )
       ) (uClip 16 (bitand (I (uClip 16 (EucMod x! 2))) (I (uClip 16 (EucMod m! 2)))))
   ))))
   :pattern ((ens%vstd.bits.lemma_u16_and_split_low_bit. x! m!))
   :qid internal_ens__vstd.bits.lemma_u16_and_split_low_bit._definition
   :skolemid skolem_internal_ens__vstd.bits.lemma_u16_and_split_low_bit._definition
)))

;; Function-Specs crate::vstd::bits::lemma_u16_low_bits_mask_is_mod
...
(assert
 (forall ((x! Int) (n! Int)) (!
   (= (ens%vstd.bits.lemma_u16_low_bits_mask_is_mod. x! n!) (= (uClip 16 (bitand (I x!)
     ...
     ) (uClip 16 (EucMod x! (uClip 16 (vstd.arithmetic.power2.pow2.? (I n!)))))
   ))
...
;; Function-Def crate::vstd::bits::lemma_u16_low_bits_mask_is_mod
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/basic-cf562145df495703-test_is_core/../../../../vstd/bits.rs:315:9: 315:53 (#1176)
(get-info :all-statistics)
(push)
 (declare-const x! Int)
 (declare-const n! Int)
 ...
 (assert
  (not (=>
    ...
    (and
     ...
     (=>
      (ens%vstd.bits.lemma_u16_pow2_no_overflow. n!)
      (=>
       (ens%vstd.arithmetic.power2.lemma_pow2_pos. n!)
       (or
        (and
         (=>
          ...
          (=>
           ...
           (and
            ...
            (=>
             (= (uClip 16 (bitand (I x!) (I 0))) 0)
             (=>
              (= (vstd.arithmetic.power2.pow2.? (I 0)) 1)
              (=>
               (= tmp%1 (= (uClip 16 (EucMod x! 1)) 0))
               (and
                (=>
                 %%location_label%%2
                 tmp%1
          ...
          (and
           ...
           (=>
            ...
            (and
             ...
             (=>
              (= (uClip 16 (EucMod x! 2)) (uClip 16 (bitand (I (uClip 16 (EucMod x! 2))) (I 1))))
              (and
               (and
                (=>
                 %%location_label%%5
                 (= (uClip 16 (EucMod x! (uClip 16 (vstd.arithmetic.power2.pow2.? (I n!))))) (uClip
                   16 (EucMod x! (uClip 16 (nClip (Mul 2 (vstd.arithmetic.power2.pow2.? (I (nClip (Sub n! 1))))))))
                )))
                (=>
                 (= (uClip 16 (EucMod x! (uClip 16 (vstd.arithmetic.power2.pow2.? (I n!))))) (uClip
                   16 (EucMod x! (uClip 16 (nClip (Mul 2 (vstd.arithmetic.power2.pow2.? (I (nClip (Sub n! 1))))))))
                    ...
                    (=>
                     ...
                     (and
                      ...
                      (=>
                       ...
                       (=>
                        %%location_label%%7
                        (= (uClip 16 (EucMod x! (uClip 16 (nClip (Mul 2 (vstd.arithmetic.power2.pow2.? (I (nClip (
                                  Sub n! 1
                          ))))))))
                         ) (uClip 16 (Add (uClip 16 (Mul 2 (uClip 16 (EucMod (uClip 16 (EucDiv x! 2)) (uClip 16 (
                                 vstd.arithmetic.power2.pow2.? (I (nClip (Sub n! 1)))
                            )))))
                           ) (uClip 16 (EucMod x! 2))
                  )))))))))
                     ...
                     (=>
                      ...
                      (and
                       ...
                       (and
                        (=>
                         %%location_label%%9
                         (req%vstd.bits.lemma_u16_low_bits_mask_is_mod. tmp%4 tmp%5)
                        )
                        (=>
                         (ens%vstd.bits.lemma_u16_low_bits_mask_is_mod. tmp%4 tmp%5)
                         (=>
                          %%location_label%%10
                          (= (uClip 16 (Add (uClip 16 (Mul 2 (uClip 16 (EucMod (uClip 16 (EucDiv x! 2)) (uClip 16 (
                                   vstd.arithmetic.power2.pow2.? (I (nClip (Sub n! 1)))
                           ...
                           ) (uClip 16 (Add (uClip 16 (Mul 2 (uClip 16 (bitand (I (uClip 16 (EucDiv x! 2))) (I (uClip
                                   16 (vstd.bits.low_bits_mask.? (I (nClip (Sub n! 1))))
                              )))))
                             ) (uClip 16 (EucMod x! 2))
                    )))))))))
                    (=>
                       ...
                       (=>
                        ...
                        (=>
                         ...
                         (= (uClip 16 (Add (uClip 16 (Mul 2 (uClip 16 (bitand (I (uClip 16 (EucDiv x! 2))) (I (uClip
                                  ...
                                  16 (EucDiv (uClip 16 (vstd.bits.low_bits_mask.? (I n!))) 2)
                             )))))
                            ) (uClip 16 (EucMod x! 2))
                      ))))))
                      (=>
                       ...
                       (and
                         ...
                         (=>
                          ...
                          (=>
                           ...
                           (= (uClip 16 (Add (uClip 16 (Mul 2 (uClip 16 (bitand (I (uClip 16 (EucDiv x! 2))) (I (uClip
                              ...
                              ) (uClip 16 (bitand (I (uClip 16 (EucMod x! 2))) (I (uClip 16 (EucMod (uClip 16 (vstd.bits.low_bits_mask.?
                                     (I n!)
                                    )
                                   ) 2
                        )))))))))))
                        (=>
                         ...
                         (and
                          (=>
                           (= tmp%6 (uClip 16 (vstd.bits.low_bits_mask.? (I n!))))
                           (=>
                            (ens%vstd.bits.lemma_u16_and_split_low_bit. (uClip 16 x!) tmp%6)
                            (=>
                             %%location_label%%15
                             (= (uClip 16 (Add (uClip 16 (Mul 2 (uClip 16 (bitand (I (uClip 16 (EucDiv x! 2))) (I (uClip
                                      16 (EucDiv (uClip 16 (vstd.bits.low_bits_mask.? (I n!))) 2)
                              ...
                              ) (uClip 16 (bitand (I x!) (I (uClip 16 (vstd.bits.low_bits_mask.? (I n!))))))
                          ))))
                          (=>
                           (= (uClip 16 (Add (uClip 16 (Mul 2 (uClip 16 (bitand (I (uClip 16 (EucDiv x! 2))) (I (uClip
                                    16 (EucDiv (uClip 16 (vstd.bits.low_bits_mask.? (I n!))) 2)
                           ...
                           (=>
                            %%location_label%%16
                            (= (uClip 16 (EucMod x! (uClip 16 (vstd.arithmetic.power2.pow2.? (I n!))))) (uClip
                              16 (bitand (I x!) (I (uClip 16 (vstd.bits.low_bits_mask.? (I n!)))))
               )))))))))))))))
               (=>
                (= (uClip 16 (EucMod x! (uClip 16 (vstd.arithmetic.power2.pow2.? (I n!))))) (uClip
                  16 (bitand (I x!) (I (uClip 16 (vstd.bits.low_bits_mask.? (I n!)))))
        ...
        (and
         ...
         (=>
          %%location_label%%17
          (= (uClip 16 (bitand (I x!) (I (uClip 16 (vstd.bits.low_bits_mask.? (I n!)))))) (uClip
            16 (EucMod x! (uClip 16 (vstd.arithmetic.power2.pow2.? (I n!))))
 )))))))))))
 (get-info :version)
 (set-option :rlimit 30000000)
 (check-sat)
...
;; Broadcast crate::vstd::bits::lemma_u16_low_bits_mask_is_mod
(assert
 (=>
    ...
    (=>
     ...
     (=>
      ...
      (= (uClip 16 (bitand (I (%I x!)) (I (uClip 16 (vstd.bits.low_bits_mask.? n!))))) (
        uClip 16 (EucMod (%I x!) (uClip 16 (vstd.arithmetic.power2.pow2.? n!)))
    ))))
    :pattern ((uClip 16 (bitand (I (%I x!)) (I (uClip 16 (vstd.bits.low_bits_mask.? n!))))))
    :qid user_crate__vstd__bits__lemma_u16_low_bits_mask_is_mod_89
    :skolemid skolem_user_crate__vstd__bits__lemma_u16_low_bits_mask_is_mod_89
))))

;; Function-Specs crate::vstd::bits::lemma_u8_and_split_low_bit
(declare-fun ens%vstd.bits.lemma_u8_and_split_low_bit. (Int Int) Bool)
(assert
 (forall ((x! Int) (m! Int)) (!
   (= (ens%vstd.bits.lemma_u8_and_split_low_bit. x! m!) (= (uClip 8 (bitand (I x!) (I m!)))
     (uClip 8 (Add (uClip 8 (Mul (uClip 8 (bitand (I (uClip 8 (EucDiv x! 2))) (I (uClip 8 (EucDiv
              m! 2
          ))))
         ) 2
        )
       ) (uClip 8 (bitand (I (uClip 8 (EucMod x! 2))) (I (uClip 8 (EucMod m! 2)))))
   ))))
   :pattern ((ens%vstd.bits.lemma_u8_and_split_low_bit. x! m!))
   :qid internal_ens__vstd.bits.lemma_u8_and_split_low_bit._definition
   :skolemid skolem_internal_ens__vstd.bits.lemma_u8_and_split_low_bit._definition
)))

;; Function-Specs crate::vstd::bits::lemma_u8_low_bits_mask_is_mod
...
(assert
 (forall ((x! Int) (n! Int)) (!
   (= (ens%vstd.bits.lemma_u8_low_bits_mask_is_mod. x! n!) (= (uClip 8 (bitand (I x!) (I
     ...
     ) (uClip 8 (EucMod x! (uClip 8 (vstd.arithmetic.power2.pow2.? (I n!)))))
   ))
...
;; Function-Def crate::vstd::bits::lemma_u8_low_bits_mask_is_mod
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/basic-cf562145df495703-test_is_core/../../../../vstd/bits.rs:315:9: 315:53 (#1183)
(get-info :all-statistics)
(push)
 (declare-const x! Int)
 (declare-const n! Int)
 ...
 (assert
  (not (=>
    ...
    (and
     ...
     (=>
      (ens%vstd.bits.lemma_u8_pow2_no_overflow. n!)
      (=>
       (ens%vstd.arithmetic.power2.lemma_pow2_pos. n!)
       (or
        (and
         (=>
          ...
          (=>
           ...
           (and
            ...
            (=>
             (= (uClip 8 (bitand (I x!) (I 0))) 0)
             (=>
              (= (vstd.arithmetic.power2.pow2.? (I 0)) 1)
              (=>
               (= tmp%1 (= (uClip 8 (EucMod x! 1)) 0))
               (and
                (=>
                 %%location_label%%2
                 tmp%1
          ...
          (and
           ...
           (=>
            ...
            (and
             ...
             (=>
              (= (uClip 8 (EucMod x! 2)) (uClip 8 (bitand (I (uClip 8 (EucMod x! 2))) (I 1))))
              (and
               (and
                (=>
                 %%location_label%%5
                 (= (uClip 8 (EucMod x! (uClip 8 (vstd.arithmetic.power2.pow2.? (I n!))))) (uClip 8
                   (EucMod x! (uClip 8 (nClip (Mul 2 (vstd.arithmetic.power2.pow2.? (I (nClip (Sub n! 1))))))))
                )))
                (=>
                 (= (uClip 8 (EucMod x! (uClip 8 (vstd.arithmetic.power2.pow2.? (I n!))))) (uClip 8
                   (EucMod x! (uClip 8 (nClip (Mul 2 (vstd.arithmetic.power2.pow2.? (I (nClip (Sub n! 1))))))))
                    ...
                    (=>
                     ...
                     (and
                      ...
                      (=>
                       ...
                       (=>
                        %%location_label%%7
                        (= (uClip 8 (EucMod x! (uClip 8 (nClip (Mul 2 (vstd.arithmetic.power2.pow2.? (I (nClip (Sub
                                  n! 1
                          ))))))))
                         ) (uClip 8 (Add (uClip 8 (Mul 2 (uClip 8 (EucMod (uClip 8 (EucDiv x! 2)) (uClip 8 (vstd.arithmetic.power2.pow2.?
                                 (I (nClip (Sub n! 1)))
                            )))))
                           ) (uClip 8 (EucMod x! 2))
                  )))))))))
                     ...
                     (=>
                      ...
                      (and
                       ...
                       (and
                        (=>
                         %%location_label%%9
                         (req%vstd.bits.lemma_u8_low_bits_mask_is_mod. tmp%4 tmp%5)
                        )
                        (=>
                         (ens%vstd.bits.lemma_u8_low_bits_mask_is_mod. tmp%4 tmp%5)
                         (=>
                          %%location_label%%10
                          (= (uClip 8 (Add (uClip 8 (Mul 2 (uClip 8 (EucMod (uClip 8 (EucDiv x! 2)) (uClip 8 (vstd.arithmetic.power2.pow2.?
                                   (I (nClip (Sub n! 1)))
                           ...
                           ) (uClip 8 (Add (uClip 8 (Mul 2 (uClip 8 (bitand (I (uClip 8 (EucDiv x! 2))) (I (uClip 8
                                   (vstd.bits.low_bits_mask.? (I (nClip (Sub n! 1))))
                              )))))
                             ) (uClip 8 (EucMod x! 2))
                    )))))))))
                       ...
                       (=>
                        ...
                        (=>
                         ...
                         (= (uClip 8 (Add (uClip 8 (Mul 2 (uClip 8 (bitand (I (uClip 8 (EucDiv x! 2))) (I (uClip 8
                                  ...
                                  (EucDiv (uClip 8 (vstd.bits.low_bits_mask.? (I n!))) 2)
                             )))))
                            ) (uClip 8 (EucMod x! 2))
                      ))))))
                      (=>
                       ...
                       (and
                         ...
                         (=>
                          ...
                          (=>
                           ...
                           (= (uClip 8 (Add (uClip 8 (Mul 2 (uClip 8 (bitand (I (uClip 8 (EucDiv x! 2))) (I (uClip 8
                              ...
                              ) (uClip 8 (bitand (I (uClip 8 (EucMod x! 2))) (I (uClip 8 (EucMod (uClip 8 (vstd.bits.low_bits_mask.?
                                     (I n!)
                                    )
                                   ) 2
                        )))))))))))
                        (=>
                         ...
                         (and
                          (=>
                           (= tmp%6 (uClip 8 (vstd.bits.low_bits_mask.? (I n!))))
                           (=>
                            (ens%vstd.bits.lemma_u8_and_split_low_bit. (uClip 8 x!) tmp%6)
                            (=>
                             %%location_label%%15
                             (= (uClip 8 (Add (uClip 8 (Mul 2 (uClip 8 (bitand (I (uClip 8 (EucDiv x! 2))) (I (uClip 8
                                      (EucDiv (uClip 8 (vstd.bits.low_bits_mask.? (I n!))) 2)
                              ...
                              ) (uClip 8 (bitand (I x!) (I (uClip 8 (vstd.bits.low_bits_mask.? (I n!))))))
                          ))))
                          (=>
                           (= (uClip 8 (Add (uClip 8 (Mul 2 (uClip 8 (bitand (I (uClip 8 (EucDiv x! 2))) (I (uClip 8
                                    (EucDiv (uClip 8 (vstd.bits.low_bits_mask.? (I n!))) 2)
                           ...
                           (=>
                            %%location_label%%16
                            (= (uClip 8 (EucMod x! (uClip 8 (vstd.arithmetic.power2.pow2.? (I n!))))) (uClip 8
                              (bitand (I x!) (I (uClip 8 (vstd.bits.low_bits_mask.? (I n!)))))
               )))))))))))))))
               (=>
                (= (uClip 8 (EucMod x! (uClip 8 (vstd.arithmetic.power2.pow2.? (I n!))))) (uClip 8
                  (bitand (I x!) (I (uClip 8 (vstd.bits.low_bits_mask.? (I n!)))))
        ...
        (and
         ...
         (=>
          %%location_label%%17
          (= (uClip 8 (bitand (I x!) (I (uClip 8 (vstd.bits.low_bits_mask.? (I n!)))))) (uClip
            8 (EucMod x! (uClip 8 (vstd.arithmetic.power2.pow2.? (I n!))))
 )))))))))))
 (get-info :version)
 (set-option :rlimit 30000000)
 (check-sat)
...
;; Broadcast crate::vstd::bits::lemma_u8_low_bits_mask_is_mod
(assert
 (=>
  ...
  (forall ((x! Poly) (n! Poly)) (!
    (=>
     ...
     (=>
      (< (%I n!) 8)
      (= (uClip 8 (bitand (I (%I x!)) (I (uClip 8 (vstd.bits.low_bits_mask.? n!))))) (uClip
        8 (EucMod (%I x!) (uClip 8 (vstd.arithmetic.power2.pow2.? n!)))
    ))))
    :pattern ((uClip 8 (bitand (I (%I x!)) (I (uClip 8 (vstd.bits.low_bits_mask.? n!))))))
    :qid user_crate__vstd__bits__lemma_u8_low_bits_mask_is_mod_97
    :skolemid skolem_user_crate__vstd__bits__lemma_u8_low_bits_mask_is_mod_97
))))
