...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/basic-cf562145df495703-test_is_core/../../../../vstd/std_specs/bits.rs:504:9: 504:15 (#0)
...
(assert
 (not (=>
   ...
   (=>
    ...
    (=>
     (and
      (= (bvshl (bvnot i!) (bvsub ((_ zero_extend 26) (_ bv32 6)) y@)) ((_ zero_extend 31)
        (_ bv0 1)
      ))
      (and
