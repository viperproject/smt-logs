...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/basic-cf562145df495703-test_is_core/../../../../vstd/std_specs/bits.rs:153:5: 153:11 (#0)
...
(assert
 (not (=>
   ...
   (=>
    (and
     (bvult ((_ zero_extend 7) (_ bv0 1)) x@)
     (bvult x@ ((_ zero_extend 4) (_ bv8 4)))
    )
    (= (bvlshr (bvlshr i! ((_ zero_extend 7) (_ bv1 1))) (bvsub ((_ zero_extend 5) (_ bv7
         3
        )
       ) x@
      )
     ) (bvlshr i! (bvsub ((_ zero_extend 5) (_ bv7 3)) (bvsub x@ ((_ zero_extend 7) (_ bv1
          1
))))))))))
(get-info :version)
