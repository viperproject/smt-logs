...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/basic-cf562145df495703-test_is_core/../../../../vstd/std_specs/bits.rs:372:9: 372:15 (#0)
...
(assert
 (not (=>
   %%location_label%%0
   (=>
    (bvule y@ ((_ zero_extend 11) (_ bv16 5)))
    (=>
     (= (bvlshr (bvnot i!) (bvsub ((_ zero_extend 11) (_ bv16 5)) y@)) ((_ zero_extend 15)
       (_ bv0 1)
     ))
     (=>
      (and
       (bvule (bvsub ((_ zero_extend 11) (_ bv16 5)) y@) j@)
       (bvult j@ ((_ zero_extend 11) (_ bv16 5)))
      )
      (= (bvand (bvlshr i! j@) ((_ zero_extend 15) (_ bv1 1))) ((_ zero_extend 15) (_ bv1
         1
)))))))))
(get-info :version)
