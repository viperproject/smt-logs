...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/basic-cf562145df495703-test_is_core/../../../../vstd/bytes.rs:156:9: 156:15 (#0)
   ...
   (=>
    (and
     (and
      (and
       (and
        (= x$1@ (bvor (bvor (bvor s0@ (bvshl s1@ ((_ zero_extend 28) (_ bv8 4)))) (bvshl s2@
            ((_ zero_extend 27) (_ bv16 5))
           )
          ) (bvshl s3@ ((_ zero_extend 27) (_ bv24 5)))
        ))
        (bvult s0@ ((_ zero_extend 23) (_ bv256 9)))
       )
       (bvult s1@ ((_ zero_extend 23) (_ bv256 9)))
      )
      (bvult s2@ ((_ zero_extend 23) (_ bv256 9)))
     )
     (bvult s3@ ((_ zero_extend 23) (_ bv256 9)))
    )
    (and
     (and
      (and
       (= s0@ (bvand x$1@ ((_ zero_extend 24) (_ bv255 8))))
       (= s1@ (bvand (bvlshr x$1@ ((_ zero_extend 28) (_ bv8 4))) ((_ zero_extend 24) (_ bv255
           8
      )))))
      (= s2@ (bvand (bvlshr x$1@ ((_ zero_extend 27) (_ bv16 5))) ((_ zero_extend 24) (_ bv255
          8
     )))))
     (= s3@ (bvand (bvlshr x$1@ ((_ zero_extend 27) (_ bv24 5))) ((_ zero_extend 24) (_ bv255
         8
)))))))))
(get-info :version)
