...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/basic-cf562145df495703-test_is_core/../../../../vstd/std_specs/bits.rs:180:5: 180:11 (#0)
...
(assert
 (not (=>
   %%location_label%%0
   (=>
    (not (= (bvand (bvlshr (bvnot i!) (bvsub ((_ zero_extend 5) (_ bv7 3)) x@)) ((_ zero_extend
         7
        ) (_ bv1 1)
       )
      ) ((_ zero_extend 7) (_ bv0 1))
    ))
    (= (bvand (bvlshr i! (bvsub ((_ zero_extend 5) (_ bv7 3)) x@)) ((_ zero_extend 7) (_
        bv1 1
      ))
     ) ((_ zero_extend 7) (_ bv0 1))
)))))
