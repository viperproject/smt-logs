...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/basic-cf562145df495703-test_is_core/../../../../vstd/bytes.rs:117:1: 117:52 (#0)
 ...
 (assert
  (not (and
    (=>
     (has_type x@ (UINT 32))
     (=>
      (= s@ (vstd.bytes.spec_u32_to_le_bytes.? x@))
      (and
       (=>
        %%location_label%%0
        true
       ...
       (=>
        (and
         (and
          (and
           (< (uClip 32 (bitand (I (%I x@)) (I 255))) 256)
           (< (uClip 32 (bitand (I (uClip 32 (bitshr (I (%I x@)) (I 8)))) (I 255))) 256)
          )
          (< (uClip 32 (bitand (I (uClip 32 (bitshr (I (%I x@)) (I 16)))) (I 255))) 256)
         )
         (< (uClip 32 (bitand (I (uClip 32 (bitshr (I (%I x@)) (I 24)))) (I 255))) 256)
        )
        (and
         (=>
          %%location_label%%1
         ...
         (=>
          (= (%I x@) (uClip 32 (bitor (I (uClip 32 (bitor (I (uClip 32 (bitor (I (uClip 32 (bitand (I (%I
                        x@
                       )
                      ) (I 255)
                    ))
                   ) (I (uClip 32 (bitshl (I (uClip 32 (bitand (I (uClip 32 (bitshr (I (%I x@)) (I 8)))) (
                          I 255
                       )))
                      ) (I 8)
                 )))))
                ) (I (uClip 32 (bitshl (I (uClip 32 (bitand (I (uClip 32 (bitshr (I (%I x@)) (I 16))))
                      (I 255)
                    ))
                   ) (I 16)
              )))))
             ) (I (uClip 32 (bitshl (I (uClip 32 (bitand (I (uClip 32 (bitshr (I (%I x@)) (I 24))))
                   (I 255)
                 ))
                ) (I 24)
          ))))))
    ...
    (=>
     (forall ((x$ Poly)) (!
       ...
       :qid user_crate__vstd__bytes__lemma_auto_spec_u32_to_from_le_bytes_13
       :skolemid skolem_user_crate__vstd__bytes__lemma_auto_spec_u32_to_from_le_bytes_13
     ))
     (and
      (=>
       (has_type s$1@ (TYPE%vstd.seq.Seq. $ (UINT 8)))
       (=>
        (= (vstd!seq.Seq.len.? $ (UINT 8) s$1@) 4)
        (=>
         (= x$1@ (vstd.bytes.spec_u32_from_le_bytes.? s$1@))
         (=>
          (= s0@ (uClip 32 (%I (vstd!seq.Seq.index.? $ (UINT 8) s$1@ (I 0)))))
          (=>
           (= s1@ (uClip 32 (%I (vstd!seq.Seq.index.? $ (UINT 8) s$1@ (I 1)))))
           (=>
            (= s2@ (uClip 32 (%I (vstd!seq.Seq.index.? $ (UINT 8) s$1@ (I 2)))))
            (=>
             (= s3@ (uClip 32 (%I (vstd!seq.Seq.index.? $ (UINT 8) s$1@ (I 3)))))
             (and
              (=>
               %%location_label%%3
               true
               ...
               (=>
                (and
                 (and
                  (and
                   (and
                    (= x$1@ (uClip 32 (bitor (I (uClip 32 (bitor (I (uClip 32 (bitor (I s0@) (I (uClip 32 (bitshl
                                (I s1@) (I 8)
                           )))))
                          ) (I (uClip 32 (bitshl (I s2@) (I 16))))
                        ))
                       ) (I (uClip 32 (bitshl (I s3@) (I 24))))
                    )))
                    (< s0@ 256)
                   )
                   (< s1@ 256)
                ...
                (and
                 (and
                  (and
                   (= s0@ (uClip 32 (bitand (I x$1@) (I 255))))
                   (= s1@ (uClip 32 (bitand (I (uClip 32 (bitshr (I x$1@) (I 8)))) (I 255))))
                  )
                  (= s2@ (uClip 32 (bitand (I (uClip 32 (bitshr (I x$1@) (I 16)))) (I 255))))
                 )
                 (= s3@ (uClip 32 (bitand (I (uClip 32 (bitshr (I x$1@) (I 24)))) (I 255))))
               ))
               (=>
                (= s1$1@ (vstd.bytes.spec_u32_to_le_bytes.? (I (vstd.bytes.spec_u32_from_le_bytes.? s$1@))))
                (=>
                 ...
                 (and
                     ...
                     (and
                      ...
                      (=>
                       (forall ((idx$ Poly)) (!
                         ...
                         :qid user_crate__vstd__bytes__lemma_auto_spec_u32_to_from_le_bytes_14
                         :skolemid skolem_user_crate__vstd__bytes__lemma_auto_spec_u32_to_from_le_bytes_14
                       ))
                       (=>
                  ...
                  (=>
                   ...
                   (=>
                    %%location_label%%8
                    (= (vstd.bytes.spec_u32_to_le_bytes.? (I (vstd.bytes.spec_u32_from_le_bytes.? s$1@)))
      ...
      (=>
       (forall ((s$ Poly)) (!
         ...
         :qid user_crate__vstd__bytes__lemma_auto_spec_u32_to_from_le_bytes_16
         :skolemid skolem_user_crate__vstd__bytes__lemma_auto_spec_u32_to_from_le_bytes_16
       ))
       (and
        (=>
         %%location_label%%9
         (forall ((x$ Poly)) (!
           ...
           :qid user_crate__vstd__bytes__lemma_auto_spec_u32_to_from_le_bytes_11
           :skolemid skolem_user_crate__vstd__bytes__lemma_auto_spec_u32_to_from_le_bytes_11
        )))
        (=>
         %%location_label%%10
         (forall ((s$ Poly)) (!
           ...
           :qid user_crate__vstd__bytes__lemma_auto_spec_u32_to_from_le_bytes_12
           :skolemid skolem_user_crate__vstd__bytes__lemma_auto_spec_u32_to_from_le_bytes_12
 ))))))))))
 (get-info :version)
...
;; Function-Specs crate::vstd::bytes::lemma_auto_spec_u64_to_from_le_bytes
 ...
 (forall ((no%param Int)) (!
   (= (ens%vstd.bytes.lemma_auto_spec_u64_to_from_le_bytes. no%param) (and
     (forall ((x$ Poly)) (!
       ...
       :pattern ((vstd.bytes.spec_u64_to_le_bytes.? x$))
       :qid user_crate__vstd__bytes__lemma_auto_spec_u64_to_from_le_bytes_17
       :skolemid skolem_user_crate__vstd__bytes__lemma_auto_spec_u64_to_from_le_bytes_17
     ))
     (forall ((s$ Poly)) (!
       (=>
        (has_type s$ (TYPE%vstd.seq.Seq. $ (UINT 8)))
       ...
       :qid user_crate__vstd__bytes__lemma_auto_spec_u64_to_from_le_bytes_18
       :skolemid skolem_user_crate__vstd__bytes__lemma_auto_spec_u64_to_from_le_bytes_18
   ))))
 ...
 (forall ((no%param Int)) (!
   (= (ens%vstd.bytes.lemma_auto_spec_u128_to_from_le_bytes. no%param) (and
     (forall ((x$ Poly)) (!
       ...
       :qid user_crate__vstd__bytes__lemma_auto_spec_u128_to_from_le_bytes_19
       :skolemid skolem_user_crate__vstd__bytes__lemma_auto_spec_u128_to_from_le_bytes_19
     ))
     (forall ((s$ Poly)) (!
       (=>
        (has_type s$ (TYPE%vstd.seq.Seq. $ (UINT 8)))
       ...
       :qid user_crate__vstd__bytes__lemma_auto_spec_u128_to_from_le_bytes_20
       :skolemid skolem_user_crate__vstd__bytes__lemma_auto_spec_u128_to_from_le_bytes_20
   ))))
