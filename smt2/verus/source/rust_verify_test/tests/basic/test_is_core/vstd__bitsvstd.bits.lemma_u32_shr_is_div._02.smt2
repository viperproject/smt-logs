...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/basic-cf562145df495703-test_is_core/../../../../vstd/bits.rs:51:17: 51:23 (#1080)
 ...
 (not (=>
   ...
   (= (bvlshr x! shift!) (let
     ...
     (ite
      ...
      tmp$$$$bitvectmp1
      (bvudiv (bvlshr x! (bvsub shift! ((_ zero_extend 31) (_ bv1 1)))) ((_ zero_extend 30)
        tmp$$$$bitvectmp0
))))))))
(get-info :version)
