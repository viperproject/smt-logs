...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/basic-cf562145df495703-test_is_core/../../../../vstd/std_specs/bits.rs:472:5: 472:11 (#0)
...
(assert
 (not (=>
   %%location_label%%0
   (=>
    (not (= (bvand i! ((_ zero_extend 31) (_ bv1 1))) ((_ zero_extend 31) (_ bv0 1))))
    (= (bvand i! ((_ zero_extend 31) (_ bv1 1))) ((_ zero_extend 31) (_ bv1 1)))
))))
(get-info :version)
