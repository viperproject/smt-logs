...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/basic-cf562145df495703-test_is_core/../../../../vstd/bits.rs:48:17: 48:23 (#1087)
...
(assert
 (not (=>
   %%location_label%%0
   (= (bvlshr x! ((_ zero_extend 15) (_ bv0 1))) x!)
)))
(get-info :version)
