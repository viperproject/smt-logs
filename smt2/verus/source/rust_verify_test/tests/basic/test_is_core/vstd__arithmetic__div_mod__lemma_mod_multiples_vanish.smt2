...
;; MODULE 'module vstd::arithmetic::div_mod, function crate::vstd::arithmetic::div_mod::lemma_mod_multiples_vanish'
...
(assert
 (distinct fuel%vstd.arithmetic.internals.mod_internals.mod_auto_plus. fuel%vstd.arithmetic.internals.mod_internals.mod_auto_minus.
  ...
  fuel%vstd.arithmetic.div_mod.lemma_mod_multiples_vanish. fuel%vstd.math.add. fuel%vstd.math.sub.
...
;; Function-Def crate::vstd::arithmetic::div_mod::lemma_mod_multiples_vanish
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/basic-cf562145df495703-test_is_core/../../../../vstd/arithmetic/div_mod.rs:1175:1: 1175:74 (#0)
...
(push)
 ...
 (assert
  (forall ((%%hole%%0 Int) (%%hole%%1 Int) (%%hole%%2 Int) (%%hole%%3 Int) (u$ Poly))
   (!
    (= (%%apply%%0 (%%lambda%%0 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3) u$) (B (= (EucMod
        (Add (Mul %%hole%%0 (%I u$)) %%hole%%1) %%hole%%2
       ) %%hole%%3
    )))
    :pattern ((%%apply%%0 (%%lambda%%0 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3) u$))
 )))
  ...
  (not (and
    ...
    (=>
     ...
     (=>
      ...
      (=>
       (= f@ (mk_fun (%%lambda%%0 m! b! m! (EucMod b! m!))))
       (and
        (=>
         %%location_label%%1
...
(assert
 (=>
  ...
  (forall ((a! Int) (b! Int) (m! Int)) (!
    ...
    :qid user_crate__vstd__arithmetic__div_mod__lemma_mod_multiples_vanish_10
    :skolemid skolem_user_crate__vstd__arithmetic__div_mod__lemma_mod_multiples_vanish_10
))))
