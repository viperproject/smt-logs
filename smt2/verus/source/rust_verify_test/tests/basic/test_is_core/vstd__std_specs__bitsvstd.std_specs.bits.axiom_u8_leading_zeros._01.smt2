...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/basic-cf562145df495703-test_is_core/../../../../vstd/std_specs/bits.rs:148:5: 148:11 (#0)
 ...
 (not (=>
   ...
   (= (let
     ...
     (ite
      ...
      tmp$$$$bitvectmp1
      (bvudiv i! ((_ zero_extend 6) tmp$$$$bitvectmp0))
     )
    ) (bvlshr i! ((_ zero_extend 7) (_ bv1 1)))
))))
(get-info :version)
