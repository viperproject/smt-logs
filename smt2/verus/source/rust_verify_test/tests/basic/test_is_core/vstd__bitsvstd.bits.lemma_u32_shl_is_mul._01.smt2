...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/basic-cf562145df495703-test_is_core/../../../../vstd/bits.rs:127:17: 127:23 (#1136)
...
(assert
 (not (=>
   %%location_label%%0
   (= (bvshl x! ((_ zero_extend 31) (_ bv0 1))) x!)
)))
(get-info :version)
