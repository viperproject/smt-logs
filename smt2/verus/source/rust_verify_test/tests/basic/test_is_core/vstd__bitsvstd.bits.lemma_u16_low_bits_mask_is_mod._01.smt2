...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/basic-cf562145df495703-test_is_core/../../../../vstd/bits.rs:329:17: 329:23 (#1176)
...
(assert
 (not (=>
   %%location_label%%0
   (= (bvand x! ((_ zero_extend 15) (_ bv0 1))) ((_ zero_extend 15) (_ bv0 1)))
)))
(get-info :version)
