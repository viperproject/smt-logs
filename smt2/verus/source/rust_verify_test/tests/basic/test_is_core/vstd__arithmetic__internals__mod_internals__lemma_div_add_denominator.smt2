...
;; MODULE 'module vstd::arithmetic::internals::mod_internals, function crate::vstd::arithmetic::internals::mod_internals::lemma_div_add_denominator'
...
(assert
 (distinct fuel%vstd.arithmetic.internals.mul_internals.lemma_mul_commutes. fuel%vstd.arithmetic.internals.mul_internals.lemma_mul_distributes_plus.
  fuel%vstd.arithmetic.internals.mul_internals.lemma_mul_distributes_minus. fuel%vstd.arithmetic.mul.lemma_mul_inequality.
...
(assert
 (=>
  ...
  (forall ((x! Int) (y! Int)) (!
    (= (Mul x! y!) (Mul y! x!))
    :pattern ((Mul x! y!))
    :qid user_crate__vstd__arithmetic__internals__mul_internals__lemma_mul_commutes_0
    :skolemid skolem_user_crate__vstd__arithmetic__internals__mul_internals__lemma_mul_commutes_0
))))
...
(assert
 (=>
  ...
  (forall ((x! Int) (y! Int) (z! Int)) (!
    ...
    :qid user_crate__vstd__arithmetic__internals__mul_internals__lemma_mul_distributes_plus_1
    :skolemid skolem_user_crate__vstd__arithmetic__internals__mul_internals__lemma_mul_distributes_plus_1
))))
...
(assert
 (=>
  ...
  (forall ((x! Int) (y! Int) (z! Int)) (!
    ...
    :qid user_crate__vstd__arithmetic__internals__mul_internals__lemma_mul_distributes_minus_2
    :skolemid skolem_user_crate__vstd__arithmetic__internals__mul_internals__lemma_mul_distributes_minus_2
))))
...
(assert
 (=>
  ...
  (forall ((x! Int) (y! Int) (z! Int)) (!
    ...
    :qid user_crate__vstd__arithmetic__mul__lemma_mul_inequality_3
    :skolemid skolem_user_crate__vstd__arithmetic__mul__lemma_mul_inequality_3
))))
...
;; Function-Def crate::vstd::arithmetic::internals::mod_internals::lemma_div_add_denominator
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/basic-cf562145df495703-test_is_core/../../../../vstd/arithmetic/internals/mod_internals.rs:147:1: 147:55 (#0)
     ...
     (=>
      ...
      (and
       ...
       (=>
        ...
        (=>
         (= zp@ (Sub (Sub (EucDiv (Add x! n!) n!) (EucDiv x! n!)) 1))
         (and
          (=>
           (fuel_bool fuel%vstd.arithmetic.internals.mul_internals.group_mul_properties_internal.)
           (=>
            %%location_label%%2
            (= 0 (Sub (Add (Mul n! zp@) (EucMod (Add x! n!) n!)) (EucMod x! n!)))
          ))
          (=>
           (= 0 (Sub (Add (Mul n! zp@) (EucMod (Add x! n!) n!)) (EucMod x! n!)))
           (or
            (and
             (=>
              ...
              (and
               (=>
                %%location_label%%3
                (req%vstd.arithmetic.mul.lemma_mul_inequality. 1 zp@ n!)
               )
               (=>
                (ens%vstd.arithmetic.mul.lemma_mul_inequality. 1 zp@ n!)
                %%switch_label%%1
             )))
             (=>
              (not (> zp@ 0))
               ...
               (=>
                ...
                (=>
                 ...
                 (and
                  (=>
                   %%location_label%%4
                   (req%vstd.arithmetic.mul.lemma_mul_inequality. zp@ tmp%2 n!)
                  )
                  (=>
                   (ens%vstd.arithmetic.mul.lemma_mul_inequality. zp@ tmp%2 n!)
                   %%switch_label%%0
               ))))
               (=>
                (not (< zp@ 0))
