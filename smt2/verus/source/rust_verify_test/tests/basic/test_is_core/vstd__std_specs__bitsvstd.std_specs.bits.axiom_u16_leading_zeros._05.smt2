...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/basic-cf562145df495703-test_is_core/../../../../vstd/std_specs/bits.rs:338:5: 338:11 (#0)
...
(assert
 (not (=>
   ...
   (=>
    (and
     (bvult ((_ zero_extend 15) (_ bv0 1)) x@)
     (bvult x@ ((_ zero_extend 11) (_ bv16 5)))
    )
    (= (bvlshr (bvlshr i! ((_ zero_extend 15) (_ bv1 1))) (bvsub ((_ zero_extend 12) (_ bv15
         4
        )
       ) x@
      )
     ) (bvlshr i! (bvsub ((_ zero_extend 12) (_ bv15 4)) (bvsub x@ ((_ zero_extend 15) (_ bv1
          1
))))))))))
(get-info :version)
