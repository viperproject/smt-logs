...
;; MODULE 'module vstd::std_specs::num::i16_specs'

;; Fuel
(declare-const fuel%vstd.std_specs.num.i16_specs.wrapping_add. FuelId)
(declare-const fuel%vstd.std_specs.num.i16_specs.wrapping_add_unsigned. FuelId)
(declare-const fuel%vstd.std_specs.num.i16_specs.wrapping_sub. FuelId)
(declare-const fuel%vstd.std_specs.num.i16_specs.signed_crop. FuelId)
(declare-const fuel%vstd.std_specs.num.i16_specs.wrapping_mul. FuelId)
(declare-const fuel%vstd.std_specs.num.i16_specs.checked_add. FuelId)
(declare-const fuel%vstd.std_specs.num.i16_specs.checked_add_unsigned. FuelId)
(declare-const fuel%vstd.std_specs.num.i16_specs.saturating_add. FuelId)
(declare-const fuel%vstd.std_specs.num.i16_specs.checked_sub. FuelId)
(declare-const fuel%vstd.std_specs.num.i16_specs.checked_sub_unsigned. FuelId)
(declare-const fuel%vstd.std_specs.num.i16_specs.checked_mul. FuelId)
...
(assert
 (distinct fuel%vstd.std_specs.num.i16_specs.wrapping_add. fuel%vstd.std_specs.num.i16_specs.wrapping_add_unsigned.
  fuel%vstd.std_specs.num.i16_specs.wrapping_sub. fuel%vstd.std_specs.num.i16_specs.signed_crop.
  fuel%vstd.std_specs.num.i16_specs.wrapping_mul. fuel%vstd.std_specs.num.i16_specs.checked_add.
  fuel%vstd.std_specs.num.i16_specs.checked_add_unsigned. fuel%vstd.std_specs.num.i16_specs.saturating_add.
  fuel%vstd.std_specs.num.i16_specs.checked_sub. fuel%vstd.std_specs.num.i16_specs.checked_sub_unsigned.
  fuel%vstd.std_specs.num.i16_specs.checked_mul. fuel%vstd.std_specs.option.impl&%0.is_Some.
...
;; Function-Decl crate::vstd::std_specs::num::i16_specs::wrapping_add
(declare-fun vstd.std_specs.num.i16_specs.wrapping_add.? (Poly Poly) Int)

;; Function-Decl crate::vstd::std_specs::num::i16_specs::wrapping_add_unsigned
(declare-fun vstd.std_specs.num.i16_specs.wrapping_add_unsigned.? (Poly Poly) Int)

;; Function-Decl crate::vstd::std_specs::num::i16_specs::wrapping_sub
(declare-fun vstd.std_specs.num.i16_specs.wrapping_sub.? (Poly Poly) Int)

;; Function-Decl crate::vstd::std_specs::num::i16_specs::signed_crop
(declare-fun vstd.std_specs.num.i16_specs.signed_crop.? (Poly) Int)

;; Function-Decl crate::vstd::std_specs::num::i16_specs::wrapping_mul
(declare-fun vstd.std_specs.num.i16_specs.wrapping_mul.? (Poly Poly) Int)

;; Function-Decl crate::vstd::std_specs::num::i16_specs::checked_add
(declare-fun vstd.std_specs.num.i16_specs.checked_add.? (Poly Poly) core!option.Option.)

;; Function-Decl crate::vstd::std_specs::num::i16_specs::checked_add_unsigned
(declare-fun vstd.std_specs.num.i16_specs.checked_add_unsigned.? (Poly Poly) core!option.Option.)

;; Function-Decl crate::vstd::std_specs::num::i16_specs::saturating_add
(declare-fun vstd.std_specs.num.i16_specs.saturating_add.? (Poly Poly) Int)

;; Function-Decl crate::vstd::std_specs::num::i16_specs::checked_sub
(declare-fun vstd.std_specs.num.i16_specs.checked_sub.? (Poly Poly) core!option.Option.)

;; Function-Decl crate::vstd::std_specs::num::i16_specs::checked_sub_unsigned
(declare-fun vstd.std_specs.num.i16_specs.checked_sub_unsigned.? (Poly Poly) core!option.Option.)

;; Function-Decl crate::vstd::std_specs::num::i16_specs::checked_mul
(declare-fun vstd.std_specs.num.i16_specs.checked_mul.? (Poly Poly) core!option.Option.)
...
(assert
 (forall ((tmp%%$ Poly) (res$ Poly)) (!
   (=>
    (and
     (has_type tmp%%$ (TYPE%tuple%1. (REF $) (SINT 16)))
     (has_type res$ (SINT 16))
    )
    (=>
     (closure_ens (FNDEF%core!clone.Clone.clone. $ (SINT 16)) $ (TYPE%tuple%1. (REF $) (
        SINT 16
       )
      ) (F fndef_singleton) tmp%%$ res$
     )
   ...
   :pattern ((closure_ens (FNDEF%core!clone.Clone.clone. $ (SINT 16)) $ (TYPE%tuple%1.
      (REF $) (SINT 16)
     ) (F fndef_singleton) tmp%%$ res$
   ))
   :qid user_core__clone__impls__impl&%13__clone_2
   :skolemid skolem_user_core__clone__impls__impl&%13__clone_2
)))

;; Function-Axioms crate::vstd::std_specs::num::i16_specs::wrapping_add
(assert
 (fuel_bool_default fuel%vstd.std_specs.num.i16_specs.wrapping_add.)
)
(assert
 (=>
  (fuel_bool fuel%vstd.std_specs.num.i16_specs.wrapping_add.)
  (forall ((x! Poly) (y! Poly)) (!
    (= (vstd.std_specs.num.i16_specs.wrapping_add.? x! y!) (ite
      (> (Add (%I x!) (%I y!)) 32767)
      (iClip 16 (Sub (Add (%I x!) (%I y!)) 65536))
      (ite
       (< (Add (%I x!) (%I y!)) (- 32768))
       (iClip 16 (Add (Add (%I x!) (%I y!)) 65536))
       (iClip 16 (Add (%I x!) (%I y!)))
    )))
    :pattern ((vstd.std_specs.num.i16_specs.wrapping_add.? x! y!))
    :qid internal_vstd.std_specs.num.i16_specs.wrapping_add.?_definition
    :skolemid skolem_internal_vstd.std_specs.num.i16_specs.wrapping_add.?_definition
))))
(assert
 (forall ((x! Poly) (y! Poly)) (!
   (=>
    ...
    (iInv 16 (vstd.std_specs.num.i16_specs.wrapping_add.? x! y!))
   )
   :pattern ((vstd.std_specs.num.i16_specs.wrapping_add.? x! y!))
   :qid internal_vstd.std_specs.num.i16_specs.wrapping_add.?_pre_post_definition
   :skolemid skolem_internal_vstd.std_specs.num.i16_specs.wrapping_add.?_pre_post_definition
)))

;; Function-Specs core::num::impl&%1::wrapping_add
(declare-fun ens%core!num.impl&%1.wrapping_add. (Int Int Int) Bool)
(assert
 (forall ((x! Int) (y! Int) (res! Int)) (!
   (= (ens%core!num.impl&%1.wrapping_add. x! y! res!) (and
     (iInv 16 res!)
     (= res! (vstd.std_specs.num.i16_specs.wrapping_add.? (I x!) (I y!)))
   ))
   :pattern ((ens%core!num.impl&%1.wrapping_add. x! y! res!))
   :qid internal_ens__core!num.impl&__1.wrapping_add._definition
   :skolemid skolem_internal_ens__core!num.impl&__1.wrapping_add._definition
)))

;; Function-Axioms crate::vstd::std_specs::num::i16_specs::wrapping_add_unsigned
(assert
 (fuel_bool_default fuel%vstd.std_specs.num.i16_specs.wrapping_add_unsigned.)
)
(assert
 (=>
  (fuel_bool fuel%vstd.std_specs.num.i16_specs.wrapping_add_unsigned.)
  (forall ((x! Poly) (y! Poly)) (!
    (= (vstd.std_specs.num.i16_specs.wrapping_add_unsigned.? x! y!) (ite
      (> (Add (%I x!) (%I y!)) 32767)
      (iClip 16 (Sub (Add (%I x!) (%I y!)) 65536))
      (iClip 16 (Add (%I x!) (%I y!)))
    ))
    :pattern ((vstd.std_specs.num.i16_specs.wrapping_add_unsigned.? x! y!))
    :qid internal_vstd.std_specs.num.i16_specs.wrapping_add_unsigned.?_definition
    :skolemid skolem_internal_vstd.std_specs.num.i16_specs.wrapping_add_unsigned.?_definition
))))
(assert
 (forall ((x! Poly) (y! Poly)) (!
   (=>
    ...
    (iInv 16 (vstd.std_specs.num.i16_specs.wrapping_add_unsigned.? x! y!))
   )
   :pattern ((vstd.std_specs.num.i16_specs.wrapping_add_unsigned.? x! y!))
   :qid internal_vstd.std_specs.num.i16_specs.wrapping_add_unsigned.?_pre_post_definition
   :skolemid skolem_internal_vstd.std_specs.num.i16_specs.wrapping_add_unsigned.?_pre_post_definition
)))

;; Function-Specs core::num::impl&%1::wrapping_add_unsigned
(declare-fun ens%core!num.impl&%1.wrapping_add_unsigned. (Int Int Int) Bool)
(assert
 (forall ((x! Int) (y! Int) (res! Int)) (!
   (= (ens%core!num.impl&%1.wrapping_add_unsigned. x! y! res!) (and
     (iInv 16 res!)
     (= res! (vstd.std_specs.num.i16_specs.wrapping_add_unsigned.? (I x!) (I y!)))
   ))
   :pattern ((ens%core!num.impl&%1.wrapping_add_unsigned. x! y! res!))
   :qid internal_ens__core!num.impl&__1.wrapping_add_unsigned._definition
   :skolemid skolem_internal_ens__core!num.impl&__1.wrapping_add_unsigned._definition
)))

;; Function-Axioms crate::vstd::std_specs::num::i16_specs::wrapping_sub
(assert
 (fuel_bool_default fuel%vstd.std_specs.num.i16_specs.wrapping_sub.)
)
(assert
 (=>
  (fuel_bool fuel%vstd.std_specs.num.i16_specs.wrapping_sub.)
  (forall ((x! Poly) (y! Poly)) (!
    (= (vstd.std_specs.num.i16_specs.wrapping_sub.? x! y!) (ite
      (> (Sub (%I x!) (%I y!)) 32767)
      (iClip 16 (Sub (Sub (%I x!) (%I y!)) 65536))
      (ite
       (< (Sub (%I x!) (%I y!)) (- 32768))
       (iClip 16 (Add (Sub (%I x!) (%I y!)) 65536))
       (iClip 16 (Sub (%I x!) (%I y!)))
    )))
    :pattern ((vstd.std_specs.num.i16_specs.wrapping_sub.? x! y!))
    :qid internal_vstd.std_specs.num.i16_specs.wrapping_sub.?_definition
    :skolemid skolem_internal_vstd.std_specs.num.i16_specs.wrapping_sub.?_definition
))))
(assert
 (forall ((x! Poly) (y! Poly)) (!
   (=>
    ...
    (iInv 16 (vstd.std_specs.num.i16_specs.wrapping_sub.? x! y!))
   )
   :pattern ((vstd.std_specs.num.i16_specs.wrapping_sub.? x! y!))
   :qid internal_vstd.std_specs.num.i16_specs.wrapping_sub.?_pre_post_definition
   :skolemid skolem_internal_vstd.std_specs.num.i16_specs.wrapping_sub.?_pre_post_definition
)))

;; Function-Specs core::num::impl&%1::wrapping_sub
(declare-fun ens%core!num.impl&%1.wrapping_sub. (Int Int Int) Bool)
(assert
 (forall ((x! Int) (y! Int) (res! Int)) (!
   (= (ens%core!num.impl&%1.wrapping_sub. x! y! res!) (and
     (iInv 16 res!)
     (= res! (vstd.std_specs.num.i16_specs.wrapping_sub.? (I x!) (I y!)))
   ))
   :pattern ((ens%core!num.impl&%1.wrapping_sub. x! y! res!))
   :qid internal_ens__core!num.impl&__1.wrapping_sub._definition
   :skolemid skolem_internal_ens__core!num.impl&__1.wrapping_sub._definition
)))

;; Function-Axioms crate::vstd::std_specs::num::i16_specs::signed_crop
(assert
 (fuel_bool_default fuel%vstd.std_specs.num.i16_specs.signed_crop.)
)
(assert
 (=>
  (fuel_bool fuel%vstd.std_specs.num.i16_specs.signed_crop.)
  (forall ((x! Poly)) (!
    (= (vstd.std_specs.num.i16_specs.signed_crop.? x!) (ite
      (> (EucMod (%I x!) 65536) 32767)
      (iClip 16 (Sub (EucMod (%I x!) 65536) 65536))
      (iClip 16 (EucMod (%I x!) 65536))
    ))
    :pattern ((vstd.std_specs.num.i16_specs.signed_crop.? x!))
    :qid internal_vstd.std_specs.num.i16_specs.signed_crop.?_definition
    :skolemid skolem_internal_vstd.std_specs.num.i16_specs.signed_crop.?_definition
))))
(assert
 (forall ((x! Poly)) (!
   (=>
    (has_type x! INT)
    (iInv 16 (vstd.std_specs.num.i16_specs.signed_crop.? x!))
   )
   :pattern ((vstd.std_specs.num.i16_specs.signed_crop.? x!))
   :qid internal_vstd.std_specs.num.i16_specs.signed_crop.?_pre_post_definition
   :skolemid skolem_internal_vstd.std_specs.num.i16_specs.signed_crop.?_pre_post_definition
)))

;; Function-Axioms crate::vstd::std_specs::num::i16_specs::wrapping_mul
(assert
 (fuel_bool_default fuel%vstd.std_specs.num.i16_specs.wrapping_mul.)
)
(assert
 (=>
  (fuel_bool fuel%vstd.std_specs.num.i16_specs.wrapping_mul.)
  (forall ((x! Poly) (y! Poly)) (!
    (= (vstd.std_specs.num.i16_specs.wrapping_mul.? x! y!) (vstd.std_specs.num.i16_specs.signed_crop.?
      (I (Mul (%I x!) (%I y!)))
    ))
    :pattern ((vstd.std_specs.num.i16_specs.wrapping_mul.? x! y!))
    :qid internal_vstd.std_specs.num.i16_specs.wrapping_mul.?_definition
    :skolemid skolem_internal_vstd.std_specs.num.i16_specs.wrapping_mul.?_definition
))))
(assert
 (forall ((x! Poly) (y! Poly)) (!
   (=>
    ...
    (iInv 16 (vstd.std_specs.num.i16_specs.wrapping_mul.? x! y!))
   )
   :pattern ((vstd.std_specs.num.i16_specs.wrapping_mul.? x! y!))
   :qid internal_vstd.std_specs.num.i16_specs.wrapping_mul.?_pre_post_definition
   :skolemid skolem_internal_vstd.std_specs.num.i16_specs.wrapping_mul.?_pre_post_definition
)))

;; Function-Specs core::num::impl&%1::wrapping_mul
(declare-fun ens%core!num.impl&%1.wrapping_mul. (Int Int Int) Bool)
(assert
 (forall ((x! Int) (y! Int) (res! Int)) (!
   (= (ens%core!num.impl&%1.wrapping_mul. x! y! res!) (and
     (iInv 16 res!)
     (= res! (vstd.std_specs.num.i16_specs.wrapping_mul.? (I x!) (I y!)))
   ))
   :pattern ((ens%core!num.impl&%1.wrapping_mul. x! y! res!))
   :qid internal_ens__core!num.impl&__1.wrapping_mul._definition
   :skolemid skolem_internal_ens__core!num.impl&__1.wrapping_mul._definition
)))

;; Function-Axioms crate::vstd::std_specs::num::i16_specs::checked_add
(assert
 (fuel_bool_default fuel%vstd.std_specs.num.i16_specs.checked_add.)
)
(assert
 (=>
  (fuel_bool fuel%vstd.std_specs.num.i16_specs.checked_add.)
  (forall ((x! Poly) (y! Poly)) (!
    (= (vstd.std_specs.num.i16_specs.checked_add.? x! y!) (ite
      (or
       (> (Add (%I x!) (%I y!)) 32767)
       (< (Add (%I x!) (%I y!)) (- 32768))
      )
      core!option.Option./None
      (core!option.Option./Some (I (iClip 16 (Add (%I x!) (%I y!)))))
    ))
    :pattern ((vstd.std_specs.num.i16_specs.checked_add.? x! y!))
    :qid internal_vstd.std_specs.num.i16_specs.checked_add.?_definition
    :skolemid skolem_internal_vstd.std_specs.num.i16_specs.checked_add.?_definition
))))
(assert
 (forall ((x! Poly) (y! Poly)) (!
   (=>
    ...
    (has_type (Poly%core!option.Option. (vstd.std_specs.num.i16_specs.checked_add.? x! y!))
     (TYPE%core!option.Option. $ (SINT 16))
   ))
   :pattern ((vstd.std_specs.num.i16_specs.checked_add.? x! y!))
   :qid internal_vstd.std_specs.num.i16_specs.checked_add.?_pre_post_definition
   :skolemid skolem_internal_vstd.std_specs.num.i16_specs.checked_add.?_pre_post_definition
)))

;; Function-Specs core::num::impl&%1::checked_add
(declare-fun ens%core!num.impl&%1.checked_add. (Int Int core!option.Option.) Bool)
(assert
 (forall ((x! Int) (y! Int) (res! core!option.Option.)) (!
   (= (ens%core!num.impl&%1.checked_add. x! y! res!) (and
     (has_type (Poly%core!option.Option. res!) (TYPE%core!option.Option. $ (SINT 16)))
     (= res! (vstd.std_specs.num.i16_specs.checked_add.? (I x!) (I y!)))
   ))
   :pattern ((ens%core!num.impl&%1.checked_add. x! y! res!))
   :qid internal_ens__core!num.impl&__1.checked_add._definition
   :skolemid skolem_internal_ens__core!num.impl&__1.checked_add._definition
)))

;; Function-Axioms crate::vstd::std_specs::num::i16_specs::checked_add_unsigned
(assert
 (fuel_bool_default fuel%vstd.std_specs.num.i16_specs.checked_add_unsigned.)
)
(assert
 (=>
  (fuel_bool fuel%vstd.std_specs.num.i16_specs.checked_add_unsigned.)
  (forall ((x! Poly) (y! Poly)) (!
    (= (vstd.std_specs.num.i16_specs.checked_add_unsigned.? x! y!) (ite
      (> (Add (%I x!) (%I y!)) 32767)
      core!option.Option./None
      (core!option.Option./Some (I (iClip 16 (Add (%I x!) (%I y!)))))
    ))
    :pattern ((vstd.std_specs.num.i16_specs.checked_add_unsigned.? x! y!))
    :qid internal_vstd.std_specs.num.i16_specs.checked_add_unsigned.?_definition
    :skolemid skolem_internal_vstd.std_specs.num.i16_specs.checked_add_unsigned.?_definition
))))
(assert
 (forall ((x! Poly) (y! Poly)) (!
   (=>
    ...
    (has_type (Poly%core!option.Option. (vstd.std_specs.num.i16_specs.checked_add_unsigned.?
       x! y!
      )
     ) (TYPE%core!option.Option. $ (SINT 16))
   ))
   :pattern ((vstd.std_specs.num.i16_specs.checked_add_unsigned.? x! y!))
   :qid internal_vstd.std_specs.num.i16_specs.checked_add_unsigned.?_pre_post_definition
   :skolemid skolem_internal_vstd.std_specs.num.i16_specs.checked_add_unsigned.?_pre_post_definition
)))

;; Function-Specs core::num::impl&%1::checked_add_unsigned
(declare-fun ens%core!num.impl&%1.checked_add_unsigned. (Int Int core!option.Option.)
 Bool
)
(assert
 (forall ((x! Int) (y! Int) (res! core!option.Option.)) (!
   (= (ens%core!num.impl&%1.checked_add_unsigned. x! y! res!) (and
     (has_type (Poly%core!option.Option. res!) (TYPE%core!option.Option. $ (SINT 16)))
     (= res! (vstd.std_specs.num.i16_specs.checked_add_unsigned.? (I x!) (I y!)))
   ))
   :pattern ((ens%core!num.impl&%1.checked_add_unsigned. x! y! res!))
   :qid internal_ens__core!num.impl&__1.checked_add_unsigned._definition
   :skolemid skolem_internal_ens__core!num.impl&__1.checked_add_unsigned._definition
)))

;; Function-Axioms crate::vstd::std_specs::num::i16_specs::saturating_add
(assert
 (fuel_bool_default fuel%vstd.std_specs.num.i16_specs.saturating_add.)
)
(assert
 (=>
  (fuel_bool fuel%vstd.std_specs.num.i16_specs.saturating_add.)
  (forall ((x! Poly) (y! Poly)) (!
    (= (vstd.std_specs.num.i16_specs.saturating_add.? x! y!) (ite
      (> (Add (%I x!) (%I y!)) 65535)
      65535
      (uClip 16 (Add (%I x!) (%I y!)))
    ))
    :pattern ((vstd.std_specs.num.i16_specs.saturating_add.? x! y!))
    :qid internal_vstd.std_specs.num.i16_specs.saturating_add.?_definition
    :skolemid skolem_internal_vstd.std_specs.num.i16_specs.saturating_add.?_definition
))))
(assert
 (forall ((x! Poly) (y! Poly)) (!
   (=>
    ...
    (uInv 16 (vstd.std_specs.num.i16_specs.saturating_add.? x! y!))
   )
   :pattern ((vstd.std_specs.num.i16_specs.saturating_add.? x! y!))
   :qid internal_vstd.std_specs.num.i16_specs.saturating_add.?_pre_post_definition
   :skolemid skolem_internal_vstd.std_specs.num.i16_specs.saturating_add.?_pre_post_definition
)))

;; Function-Specs core::num::impl&%7::saturating_add
(declare-fun ens%core!num.impl&%7.saturating_add. (Int Int Int) Bool)
(assert
 (forall ((x! Int) (y! Int) (res! Int)) (!
   (= (ens%core!num.impl&%7.saturating_add. x! y! res!) (and
     (uInv 16 res!)
     (= res! (vstd.std_specs.num.i16_specs.saturating_add.? (I x!) (I y!)))
   ))
   :pattern ((ens%core!num.impl&%7.saturating_add. x! y! res!))
   :qid internal_ens__core!num.impl&__7.saturating_add._definition
   :skolemid skolem_internal_ens__core!num.impl&__7.saturating_add._definition
)))

;; Function-Axioms crate::vstd::std_specs::num::i16_specs::checked_sub
(assert
 (fuel_bool_default fuel%vstd.std_specs.num.i16_specs.checked_sub.)
)
(assert
 (=>
  (fuel_bool fuel%vstd.std_specs.num.i16_specs.checked_sub.)
  (forall ((x! Poly) (y! Poly)) (!
    (= (vstd.std_specs.num.i16_specs.checked_sub.? x! y!) (ite
      (or
       (> (Sub (%I x!) (%I y!)) 32767)
       (< (Sub (%I x!) (%I y!)) (- 32768))
      )
      core!option.Option./None
      (core!option.Option./Some (I (iClip 16 (Sub (%I x!) (%I y!)))))
    ))
    :pattern ((vstd.std_specs.num.i16_specs.checked_sub.? x! y!))
    :qid internal_vstd.std_specs.num.i16_specs.checked_sub.?_definition
    :skolemid skolem_internal_vstd.std_specs.num.i16_specs.checked_sub.?_definition
))))
(assert
 (forall ((x! Poly) (y! Poly)) (!
   (=>
    ...
    (has_type (Poly%core!option.Option. (vstd.std_specs.num.i16_specs.checked_sub.? x! y!))
     (TYPE%core!option.Option. $ (SINT 16))
   ))
   :pattern ((vstd.std_specs.num.i16_specs.checked_sub.? x! y!))
   :qid internal_vstd.std_specs.num.i16_specs.checked_sub.?_pre_post_definition
   :skolemid skolem_internal_vstd.std_specs.num.i16_specs.checked_sub.?_pre_post_definition
)))

;; Function-Specs core::num::impl&%1::checked_sub
(declare-fun ens%core!num.impl&%1.checked_sub. (Int Int core!option.Option.) Bool)
(assert
 (forall ((x! Int) (y! Int) (res! core!option.Option.)) (!
   (= (ens%core!num.impl&%1.checked_sub. x! y! res!) (and
     (has_type (Poly%core!option.Option. res!) (TYPE%core!option.Option. $ (SINT 16)))
     (= res! (vstd.std_specs.num.i16_specs.checked_sub.? (I x!) (I y!)))
   ))
   :pattern ((ens%core!num.impl&%1.checked_sub. x! y! res!))
   :qid internal_ens__core!num.impl&__1.checked_sub._definition
   :skolemid skolem_internal_ens__core!num.impl&__1.checked_sub._definition
)))

;; Function-Axioms crate::vstd::std_specs::num::i16_specs::checked_sub_unsigned
(assert
 (fuel_bool_default fuel%vstd.std_specs.num.i16_specs.checked_sub_unsigned.)
)
(assert
 (=>
  (fuel_bool fuel%vstd.std_specs.num.i16_specs.checked_sub_unsigned.)
  (forall ((x! Poly) (y! Poly)) (!
    (= (vstd.std_specs.num.i16_specs.checked_sub_unsigned.? x! y!) (ite
      (< (Sub (%I x!) (%I y!)) (- 32768))
      core!option.Option./None
      (core!option.Option./Some (I (iClip 16 (Sub (%I x!) (%I y!)))))
    ))
    :pattern ((vstd.std_specs.num.i16_specs.checked_sub_unsigned.? x! y!))
    :qid internal_vstd.std_specs.num.i16_specs.checked_sub_unsigned.?_definition
    :skolemid skolem_internal_vstd.std_specs.num.i16_specs.checked_sub_unsigned.?_definition
))))
(assert
 (forall ((x! Poly) (y! Poly)) (!
   (=>
    ...
    (has_type (Poly%core!option.Option. (vstd.std_specs.num.i16_specs.checked_sub_unsigned.?
       x! y!
      )
     ) (TYPE%core!option.Option. $ (SINT 16))
   ))
   :pattern ((vstd.std_specs.num.i16_specs.checked_sub_unsigned.? x! y!))
   :qid internal_vstd.std_specs.num.i16_specs.checked_sub_unsigned.?_pre_post_definition
   :skolemid skolem_internal_vstd.std_specs.num.i16_specs.checked_sub_unsigned.?_pre_post_definition
)))

;; Function-Specs core::num::impl&%1::checked_sub_unsigned
(declare-fun ens%core!num.impl&%1.checked_sub_unsigned. (Int Int core!option.Option.)
 Bool
)
(assert
 (forall ((x! Int) (y! Int) (res! core!option.Option.)) (!
   (= (ens%core!num.impl&%1.checked_sub_unsigned. x! y! res!) (and
     (has_type (Poly%core!option.Option. res!) (TYPE%core!option.Option. $ (SINT 16)))
     (= res! (vstd.std_specs.num.i16_specs.checked_sub_unsigned.? (I x!) (I y!)))
   ))
   :pattern ((ens%core!num.impl&%1.checked_sub_unsigned. x! y! res!))
   :qid internal_ens__core!num.impl&__1.checked_sub_unsigned._definition
   :skolemid skolem_internal_ens__core!num.impl&__1.checked_sub_unsigned._definition
)))

;; Function-Axioms crate::vstd::std_specs::num::i16_specs::checked_mul
(assert
 (fuel_bool_default fuel%vstd.std_specs.num.i16_specs.checked_mul.)
)
(assert
 (=>
  (fuel_bool fuel%vstd.std_specs.num.i16_specs.checked_mul.)
  (forall ((x! Poly) (y! Poly)) (!
    (= (vstd.std_specs.num.i16_specs.checked_mul.? x! y!) (ite
      (or
       (> (Mul (%I x!) (%I y!)) 32767)
       (< (Mul (%I x!) (%I y!)) (- 32768))
      )
      core!option.Option./None
      (core!option.Option./Some (I (iClip 16 (Mul (%I x!) (%I y!)))))
    ))
    :pattern ((vstd.std_specs.num.i16_specs.checked_mul.? x! y!))
    :qid internal_vstd.std_specs.num.i16_specs.checked_mul.?_definition
    :skolemid skolem_internal_vstd.std_specs.num.i16_specs.checked_mul.?_definition
))))
(assert
 (forall ((x! Poly) (y! Poly)) (!
   (=>
    ...
    (has_type (Poly%core!option.Option. (vstd.std_specs.num.i16_specs.checked_mul.? x! y!))
     (TYPE%core!option.Option. $ (SINT 16))
   ))
   :pattern ((vstd.std_specs.num.i16_specs.checked_mul.? x! y!))
   :qid internal_vstd.std_specs.num.i16_specs.checked_mul.?_pre_post_definition
   :skolemid skolem_internal_vstd.std_specs.num.i16_specs.checked_mul.?_pre_post_definition
)))

;; Function-Specs core::num::impl&%1::checked_mul
(declare-fun ens%core!num.impl&%1.checked_mul. (Int Int core!option.Option.) Bool)
(assert
 (forall ((x! Int) (y! Int) (res! core!option.Option.)) (!
   (= (ens%core!num.impl&%1.checked_mul. x! y! res!) (and
     (has_type (Poly%core!option.Option. res!) (TYPE%core!option.Option. $ (SINT 16)))
     (= res! (vstd.std_specs.num.i16_specs.checked_mul.? (I x!) (I y!)))
   ))
   :pattern ((ens%core!num.impl&%1.checked_mul. x! y! res!))
   :qid internal_ens__core!num.impl&__1.checked_mul._definition
   :skolemid skolem_internal_ens__core!num.impl&__1.checked_mul._definition
)))
