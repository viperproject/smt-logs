...
;; MODULE 'module vstd::std_specs::atomic::atomic_specs_bool'
...
;; Datatypes
(declare-sort core!sync.atomic.AtomicBool. 0)
...
(declare-const TYPE%core!sync.atomic.AtomicBool. Type)
(declare-const TYPE%core!sync.atomic.Ordering. Type)
(declare-fun TYPE%core!result.Result. (Dcr Type Dcr Type) Type)
(declare-const TYPE%tuple%0. Type)
(declare-fun Poly%core!sync.atomic.AtomicBool. (core!sync.atomic.AtomicBool.) Poly)
(declare-fun %Poly%core!sync.atomic.AtomicBool. (Poly) core!sync.atomic.AtomicBool.)
...
(assert
 (forall ((x core!sync.atomic.AtomicBool.)) (!
   (= x (%Poly%core!sync.atomic.AtomicBool. (Poly%core!sync.atomic.AtomicBool. x)))
   :pattern ((Poly%core!sync.atomic.AtomicBool. x))
   :qid internal_core__sync__atomic__AtomicBool_box_axiom_definition
   :skolemid skolem_internal_core__sync__atomic__AtomicBool_box_axiom_definition
)))
(assert
 (forall ((x Poly)) (!
   (=>
    (has_type x TYPE%core!sync.atomic.AtomicBool.)
    (= x (Poly%core!sync.atomic.AtomicBool. (%Poly%core!sync.atomic.AtomicBool. x)))
   )
   :pattern ((has_type x TYPE%core!sync.atomic.AtomicBool.))
   :qid internal_core__sync__atomic__AtomicBool_unbox_axiom_definition
   :skolemid skolem_internal_core__sync__atomic__AtomicBool_unbox_axiom_definition
)))
(assert
 (forall ((x core!sync.atomic.AtomicBool.)) (!
   (has_type (Poly%core!sync.atomic.AtomicBool. x) TYPE%core!sync.atomic.AtomicBool.)
   :pattern ((has_type (Poly%core!sync.atomic.AtomicBool. x) TYPE%core!sync.atomic.AtomicBool.))
   :qid internal_core__sync__atomic__AtomicBool_has_type_always_definition
   :skolemid skolem_internal_core__sync__atomic__AtomicBool_has_type_always_definition
)))
(assert
...
;; Function-Specs core::sync::atomic::impl&%5::compare_exchange
(declare-fun ens%core!sync.atomic.impl&%5.compare_exchange. (core!sync.atomic.AtomicBool.
  Bool Bool core!sync.atomic.Ordering. core!sync.atomic.Ordering. core!result.Result.
 ) Bool
)
(assert
 (forall ((atomic! core!sync.atomic.AtomicBool.) (current! Bool) (new! Bool) (success!
    core!sync.atomic.Ordering.
   ) (failure! core!sync.atomic.Ordering.) (%return! core!result.Result.)
  ) (!
   (= (ens%core!sync.atomic.impl&%5.compare_exchange. atomic! current! new! success! failure!
     %return!
    ) (has_type (Poly%core!result.Result. %return!) (TYPE%core!result.Result. $ BOOL $
      BOOL
   )))
   :pattern ((ens%core!sync.atomic.impl&%5.compare_exchange. atomic! current! new! success!
     failure! %return!
   ))
   :qid internal_ens__core!sync.atomic.impl&__5.compare_exchange._definition
   :skolemid skolem_internal_ens__core!sync.atomic.impl&__5.compare_exchange._definition
)))

;; Function-Specs core::sync::atomic::impl&%5::compare_exchange_weak
(declare-fun ens%core!sync.atomic.impl&%5.compare_exchange_weak. (core!sync.atomic.AtomicBool.
  Bool Bool core!sync.atomic.Ordering. core!sync.atomic.Ordering. core!result.Result.
 ) Bool
)
(assert
 (forall ((atomic! core!sync.atomic.AtomicBool.) (current! Bool) (new! Bool) (success!
   ...
   (= (ens%core!sync.atomic.impl&%5.compare_exchange_weak. atomic! current! new! success!
     failure! %return!
    ) (has_type (Poly%core!result.Result. %return!) (TYPE%core!result.Result. $ BOOL $
      BOOL
   )))
   :pattern ((ens%core!sync.atomic.impl&%5.compare_exchange_weak. atomic! current! new!
     success! failure! %return!
   ))
   :qid internal_ens__core!sync.atomic.impl&__5.compare_exchange_weak._definition
   :skolemid skolem_internal_ens__core!sync.atomic.impl&__5.compare_exchange_weak._definition
)))
