...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/basic-cf562145df495703-test_is_core/../../../../vstd/std_specs/bits.rs:277:5: 277:11 (#0)
...
(assert
 (not (=>
   %%location_label%%0
   (= (bvshl i! ((_ zero_extend 15) (_ bv0 1))) i!)
)))
(get-info :version)
