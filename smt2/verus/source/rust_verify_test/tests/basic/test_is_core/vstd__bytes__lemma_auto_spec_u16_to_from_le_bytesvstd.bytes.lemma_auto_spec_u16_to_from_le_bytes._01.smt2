...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/basic-cf562145df495703-test_is_core/../../../../vstd/bytes.rs:48:9: 48:15 (#0)
...
(assert
 (not (=>
   %%location_label%%0
   (and
    (bvult (bvand x@ ((_ zero_extend 8) (_ bv255 8))) ((_ zero_extend 7) (_ bv256 9)))
    (bvult (bvand (bvlshr x@ ((_ zero_extend 12) (_ bv8 4))) ((_ zero_extend 8) (_ bv255
        8
      ))
     ) ((_ zero_extend 7) (_ bv256 9))
)))))
(get-info :version)
