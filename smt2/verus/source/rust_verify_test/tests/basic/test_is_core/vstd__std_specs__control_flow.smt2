...
;; MODULE 'module vstd::std_specs::control_flow'
...
(assert
 (distinct fuel%vstd.std_specs.control_flow.spec_from_blanket_identity. fuel%vstd.std_specs.option.is_none.)
)

;; Datatypes
(declare-sort core!convert.Infallible. 0)
(declare-datatypes ((core!ops.control_flow.ControlFlow. 0) (core!option.Option. 0)
  (core!result.Result. 0) (tuple%0. 0) (tuple%2. 0)
...
;; Function-Decl crate::vstd::std_specs::control_flow::spec_from
...
;; Function-Def crate::vstd::std_specs::control_flow::spec_from_blanket_identity
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/basic-cf562145df495703-test_is_core/../../../../vstd/std_specs/control_flow.rs:57:1: 57:65 (#0)
...
;; Broadcast crate::vstd::std_specs::control_flow::spec_from_blanket_identity
(assert
 (=>
  ...
  (forall ((T&. Dcr) (T& Type) (t! Poly) (s! Poly)) (!
    ...
    :qid user_crate__vstd__std_specs__control_flow__spec_from_blanket_identity_0
    :skolemid skolem_user_crate__vstd__std_specs__control_flow__spec_from_blanket_identity_0
))))
...
(assert
 (forall ((T&. Dcr) (T& Type)) (!
   ...
   :qid internal_core__option__impl&__10_trait_impl_definition
   :skolemid skolem_internal_core__option__impl&__10_trait_impl_definition
)))
