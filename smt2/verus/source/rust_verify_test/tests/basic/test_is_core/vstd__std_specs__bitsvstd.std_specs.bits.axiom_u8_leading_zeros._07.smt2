...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/basic-cf562145df495703-test_is_core/../../../../vstd/std_specs/bits.rs:162:9: 162:15 (#0)
...
(assert
 (not (=>
   %%location_label%%0
   (=>
    (bvule y@ ((_ zero_extend 4) (_ bv8 4)))
    (=>
     (= (bvlshr i! (bvsub ((_ zero_extend 4) (_ bv8 4)) y@)) ((_ zero_extend 7) (_ bv0 1)))
     (=>
      (and
       (bvule (bvsub ((_ zero_extend 4) (_ bv8 4)) y@) j@)
       (bvult j@ ((_ zero_extend 4) (_ bv8 4)))
      )
      (= (bvand (bvlshr i! j@) ((_ zero_extend 7) (_ bv1 1))) ((_ zero_extend 7) (_ bv0 1)))
))))))
(get-info :version)
