...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/basic-cf562145df495703-test_is_core/../../../../vstd/bytes.rs:32:1: 32:52 (#0)
 ...
 (assert
  (not (and
    (=>
     (has_type x@ (UINT 16))
     (=>
      (= s@ (vstd.bytes.spec_u16_to_le_bytes.? x@))
      (and
       (=>
        %%location_label%%0
        true
       ...
       (=>
        (and
         (< (uClip 16 (bitand (I (%I x@)) (I 255))) 256)
         (< (uClip 16 (bitand (I (uClip 16 (bitshr (I (%I x@)) (I 8)))) (I 255))) 256)
        )
        (and
         (=>
          %%location_label%%1
         ...
         (=>
          (= (%I x@) (uClip 16 (bitor (I (uClip 16 (bitand (I (%I x@)) (I 255)))) (I (uClip 16 (
                bitshl (I (uClip 16 (bitand (I (uClip 16 (bitshr (I (%I x@)) (I 8)))) (I 255))))
                (I 8)
          ))))))
          (=>
           %%location_label%%2
    ...
    (=>
     (forall ((x$ Poly)) (!
       ...
       :qid user_crate__vstd__bytes__lemma_auto_spec_u16_to_from_le_bytes_11
       :skolemid skolem_user_crate__vstd__bytes__lemma_auto_spec_u16_to_from_le_bytes_11
     ))
     (and
      (=>
       (has_type s$1@ (TYPE%vstd.seq.Seq. $ (UINT 8)))
       (=>
        (= (vstd!seq.Seq.len.? $ (UINT 8) s$1@) 2)
        (=>
         (= x$1@ (vstd.bytes.spec_u16_from_le_bytes.? s$1@))
         (=>
          (= s0@ (uClip 16 (%I (vstd!seq.Seq.index.? $ (UINT 8) s$1@ (I 0)))))
          (=>
           (= s1@ (uClip 16 (%I (vstd!seq.Seq.index.? $ (UINT 8) s$1@ (I 1)))))
           (and
            (=>
             %%location_label%%3
             true
            ...
            (=>
             (=>
              (and
               (and
                (= x$1@ (uClip 16 (bitor (I s0@) (I (uClip 16 (bitshl (I s1@) (I 8)))))))
                (< s0@ 256)
               )
               (< s1@ 256)
              )
              (and
               (= s0@ (uClip 16 (bitand (I x$1@) (I 255))))
               (= s1@ (uClip 16 (bitand (I (uClip 16 (bitshr (I x$1@) (I 8)))) (I 255))))
             ))
             (=>
              (= s1$1@ (vstd.bytes.spec_u16_to_le_bytes.? (I (vstd.bytes.spec_u16_from_le_bytes.? s$1@))))
              (=>
               (= s2@ (%Poly%vstd.seq.Seq<u8.>. s$1@))
               (and
                (=>
                   ...
                   (and
                    ...
                    (=>
                     (forall ((idx$ Poly)) (!
                       ...
                       :qid user_crate__vstd__bytes__lemma_auto_spec_u16_to_from_le_bytes_12
                       :skolemid skolem_user_crate__vstd__bytes__lemma_auto_spec_u16_to_from_le_bytes_12
                     ))
                     (=>
                ...
                (=>
                 ...
                 (=>
                  %%location_label%%8
                  (= (vstd.bytes.spec_u16_to_le_bytes.? (I (vstd.bytes.spec_u16_from_le_bytes.? s$1@)))
      ...
      (=>
       (forall ((s$ Poly)) (!
         ...
         :qid user_crate__vstd__bytes__lemma_auto_spec_u16_to_from_le_bytes_14
         :skolemid skolem_user_crate__vstd__bytes__lemma_auto_spec_u16_to_from_le_bytes_14
       ))
       (and
        (=>
         %%location_label%%9
         (forall ((x$ Poly)) (!
           ...
           :qid user_crate__vstd__bytes__lemma_auto_spec_u16_to_from_le_bytes_9
           :skolemid skolem_user_crate__vstd__bytes__lemma_auto_spec_u16_to_from_le_bytes_9
        )))
        (=>
         %%location_label%%10
         (forall ((s$ Poly)) (!
           ...
           :qid user_crate__vstd__bytes__lemma_auto_spec_u16_to_from_le_bytes_10
           :skolemid skolem_user_crate__vstd__bytes__lemma_auto_spec_u16_to_from_le_bytes_10
 ))))))))))
 (get-info :version)
