...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/basic-cf562145df495703-test_is_core/../../../../vstd/std_specs/bits.rs:560:9: 560:15 (#0)
...
(assert
 (not (=>
   %%location_label%%0
   (=>
    (bvule y@ ((_ zero_extend 26) (_ bv32 6)))
    (=>
     (= (bvlshr (bvnot i!) (bvsub ((_ zero_extend 26) (_ bv32 6)) y@)) ((_ zero_extend 31)
       (_ bv0 1)
     ))
     (=>
      (and
       (bvule (bvsub ((_ zero_extend 26) (_ bv32 6)) y@) j@)
       (bvult j@ ((_ zero_extend 26) (_ bv32 6)))
      )
      (= (bvand (bvlshr i! j@) ((_ zero_extend 31) (_ bv1 1))) ((_ zero_extend 31) (_ bv1
         1
)))))))))
(get-info :version)
