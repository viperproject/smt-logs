...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/basic-cf562145df495703-test_is_core/../../../../vstd/bytes.rs:225:1: 225:52 (#0)
 ...
 (assert
  (not (and
    (=>
     (has_type x@ (UINT 64))
     (=>
      (= s@ (vstd.bytes.spec_u64_to_le_bytes.? x@))
      (and
       (=>
        %%location_label%%0
        true
          ...
          (and
           (and
            (and
             (and
              (and
               (< (uClip 64 (bitand (I (%I x@)) (I 255))) 256)
               (< (uClip 64 (bitand (I (uClip 64 (bitshr (I (%I x@)) (I 8)))) (I 255))) 256)
              )
              (< (uClip 64 (bitand (I (uClip 64 (bitshr (I (%I x@)) (I 16)))) (I 255))) 256)
             )
             (< (uClip 64 (bitand (I (uClip 64 (bitshr (I (%I x@)) (I 24)))) (I 255))) 256)
            )
            (< (uClip 64 (bitand (I (uClip 64 (bitshr (I (%I x@)) (I 32)))) (I 255))) 256)
           )
           (< (uClip 64 (bitand (I (uClip 64 (bitshr (I (%I x@)) (I 40)))) (I 255))) 256)
          )
          (< (uClip 64 (bitand (I (uClip 64 (bitshr (I (%I x@)) (I 48)))) (I 255))) 256)
         )
         (< (uClip 64 (bitand (I (uClip 64 (bitshr (I (%I x@)) (I 56)))) (I 255))) 256)
        )
        (and
         (=>
          %%location_label%%1
         ...
         (=>
          (= (%I x@) (uClip 64 (bitor (I (uClip 64 (bitor (I (uClip 64 (bitor (I (uClip 64 (bitor (I (uClip
                        64 (bitor (I (uClip 64 (bitor (I (uClip 64 (bitor (I (uClip 64 (bitand (I (%I x@)) (I 255))))
                               (I (uClip 64 (bitshl (I (uClip 64 (bitand (I (uClip 64 (bitshr (I (%I x@)) (I 8)))) (I 255))))
                                  (I 8)
                             )))))
                            ) (I (uClip 64 (bitshl (I (uClip 64 (bitand (I (uClip 64 (bitshr (I (%I x@)) (I 16))))
                                  (I 255)
                                ))
                               ) (I 16)
                          )))))
                         ) (I (uClip 64 (bitshl (I (uClip 64 (bitand (I (uClip 64 (bitshr (I (%I x@)) (I 24))))
                               (I 255)
                             ))
                            ) (I 24)
                       )))))
                      ) (I (uClip 64 (bitshl (I (uClip 64 (bitand (I (uClip 64 (bitshr (I (%I x@)) (I 32))))
                            (I 255)
                          ))
                         ) (I 32)
                    )))))
                   ) (I (uClip 64 (bitshl (I (uClip 64 (bitand (I (uClip 64 (bitshr (I (%I x@)) (I 40))))
                         (I 255)
                       ))
                      ) (I 40)
                 )))))
                ) (I (uClip 64 (bitshl (I (uClip 64 (bitand (I (uClip 64 (bitshr (I (%I x@)) (I 48))))
                      (I 255)
                    ))
                   ) (I 48)
              )))))
             ) (I (uClip 64 (bitshl (I (uClip 64 (bitand (I (uClip 64 (bitshr (I (%I x@)) (I 56))))
                   (I 255)
                 ))
                ) (I 56)
          ))))))
    ...
    (=>
     (forall ((x$ Poly)) (!
       ...
       :pattern ((vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd.seq.Seq<u8.>. (vstd.bytes.spec_u64_to_le_bytes.?
           x$
       ))))
       :qid user_crate__vstd__bytes__lemma_auto_spec_u64_to_from_le_bytes_11
       :skolemid skolem_user_crate__vstd__bytes__lemma_auto_spec_u64_to_from_le_bytes_11
     ))
     (and
      (=>
       (has_type s$1@ (TYPE%vstd.seq.Seq. $ (UINT 8)))
       (=>
        (= (vstd!seq.Seq.len.? $ (UINT 8) s$1@) 8)
        (=>
         (= x$1@ (vstd.bytes.spec_u64_from_le_bytes.? s$1@))
         (=>
          (= s0@ (uClip 64 (%I (vstd!seq.Seq.index.? $ (UINT 8) s$1@ (I 0)))))
          (=>
           (= s1@ (uClip 64 (%I (vstd!seq.Seq.index.? $ (UINT 8) s$1@ (I 1)))))
           (=>
            (= s2@ (uClip 64 (%I (vstd!seq.Seq.index.? $ (UINT 8) s$1@ (I 2)))))
            (=>
             (= s3@ (uClip 64 (%I (vstd!seq.Seq.index.? $ (UINT 8) s$1@ (I 3)))))
             (=>
              (= s4@ (uClip 64 (%I (vstd!seq.Seq.index.? $ (UINT 8) s$1@ (I 4)))))
              (=>
               (= s5@ (uClip 64 (%I (vstd!seq.Seq.index.? $ (UINT 8) s$1@ (I 5)))))
               (=>
                (= s6@ (uClip 64 (%I (vstd!seq.Seq.index.? $ (UINT 8) s$1@ (I 6)))))
                (=>
                 (= s7@ (uClip 64 (%I (vstd!seq.Seq.index.? $ (UINT 8) s$1@ (I 7)))))
                 (and
                  (=>
                   %%location_label%%3
                   true
                       ...
                       (and
                        (and
                         (and
                          (and
                           (and
                            (= x$1@ (uClip 64 (bitor (I (uClip 64 (bitor (I (uClip 64 (bitor (I (uClip 64 (bitor (I (uClip
                                          64 (bitor (I (uClip 64 (bitor (I (uClip 64 (bitor (I s0@) (I (uClip 64 (bitshl (I s1@) (I 8)))))))
                                              (I (uClip 64 (bitshl (I s2@) (I 16))))
                                            ))
                                           ) (I (uClip 64 (bitshl (I s3@) (I 24))))
                                         ))
                                        ) (I (uClip 64 (bitshl (I s4@) (I 32))))
                                      ))
                                     ) (I (uClip 64 (bitshl (I s5@) (I 40))))
                                   ))
                                  ) (I (uClip 64 (bitshl (I s6@) (I 48))))
                                ))
                               ) (I (uClip 64 (bitshl (I s7@) (I 56))))
                            )))
                            (< s0@ 256)
                           )
                           (< s1@ 256)
                      ...
                      (and
                       (and
                        (and
                         (and
                          (and
                           (= s0@ (uClip 64 (bitand (I x$1@) (I 255))))
                           (= s1@ (uClip 64 (bitand (I (uClip 64 (bitshr (I x$1@) (I 8)))) (I 255))))
                          )
                          (= s2@ (uClip 64 (bitand (I (uClip 64 (bitshr (I x$1@) (I 16)))) (I 255))))
                         )
                         (= s3@ (uClip 64 (bitand (I (uClip 64 (bitshr (I x$1@) (I 24)))) (I 255))))
                        )
                        (= s4@ (uClip 64 (bitand (I (uClip 64 (bitshr (I x$1@) (I 32)))) (I 255))))
                       )
                       (= s5@ (uClip 64 (bitand (I (uClip 64 (bitshr (I x$1@) (I 40)))) (I 255))))
                      )
                      (= s6@ (uClip 64 (bitand (I (uClip 64 (bitshr (I x$1@) (I 48)))) (I 255))))
                     )
                     (= s7@ (uClip 64 (bitand (I (uClip 64 (bitshr (I x$1@) (I 56)))) (I 255))))
                   ))
                   (=>
                    (= s1$1@ (vstd.bytes.spec_u64_to_le_bytes.? (I (vstd.bytes.spec_u64_from_le_bytes.? s$1@))))
                    (=>
                     ...
                     (and
                         ...
                         (and
                          ...
                          (=>
                           (forall ((idx$ Poly)) (!
                             ...
                             :qid user_crate__vstd__bytes__lemma_auto_spec_u64_to_from_le_bytes_12
                             :skolemid skolem_user_crate__vstd__bytes__lemma_auto_spec_u64_to_from_le_bytes_12
                           ))
                           (=>
                      ...
                      (=>
                       ...
                       (=>
                        %%location_label%%8
                        (= (vstd.bytes.spec_u64_to_le_bytes.? (I (vstd.bytes.spec_u64_from_le_bytes.? s$1@)))
      ...
      (=>
       (forall ((s$ Poly)) (!
         ...
         :qid user_crate__vstd__bytes__lemma_auto_spec_u64_to_from_le_bytes_14
         :skolemid skolem_user_crate__vstd__bytes__lemma_auto_spec_u64_to_from_le_bytes_14
       ))
       (and
        (=>
         %%location_label%%9
         (forall ((x$ Poly)) (!
           ...
           :pattern ((vstd.bytes.spec_u64_to_le_bytes.? x$))
           :qid user_crate__vstd__bytes__lemma_auto_spec_u64_to_from_le_bytes_9
           :skolemid skolem_user_crate__vstd__bytes__lemma_auto_spec_u64_to_from_le_bytes_9
        )))
        (=>
         %%location_label%%10
         (forall ((s$ Poly)) (!
           ...
           :qid user_crate__vstd__bytes__lemma_auto_spec_u64_to_from_le_bytes_10
           :skolemid skolem_user_crate__vstd__bytes__lemma_auto_spec_u64_to_from_le_bytes_10
 ))))))))))
 (get-info :version)
