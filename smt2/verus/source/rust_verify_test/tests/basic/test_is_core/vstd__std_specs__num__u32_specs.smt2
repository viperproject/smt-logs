...
;; MODULE 'module vstd::std_specs::num::u32_specs'

;; Fuel
(declare-const fuel%vstd.std_specs.num.u32_specs.wrapping_add. FuelId)
(declare-const fuel%vstd.std_specs.num.u32_specs.wrapping_add_signed. FuelId)
(declare-const fuel%vstd.std_specs.num.u32_specs.wrapping_sub. FuelId)
(declare-const fuel%vstd.std_specs.num.u32_specs.checked_add. FuelId)
(declare-const fuel%vstd.std_specs.num.u32_specs.checked_add_signed. FuelId)
(declare-const fuel%vstd.std_specs.num.u32_specs.checked_sub. FuelId)
(declare-const fuel%vstd.std_specs.num.u32_specs.checked_mul. FuelId)
(declare-const fuel%vstd.std_specs.num.u32_specs.checked_div. FuelId)
...
(assert
 (distinct fuel%vstd.std_specs.num.u32_specs.wrapping_add. fuel%vstd.std_specs.num.u32_specs.wrapping_add_signed.
  fuel%vstd.std_specs.num.u32_specs.wrapping_sub. fuel%vstd.std_specs.num.u32_specs.checked_add.
  fuel%vstd.std_specs.num.u32_specs.checked_add_signed. fuel%vstd.std_specs.num.u32_specs.checked_sub.
  fuel%vstd.std_specs.num.u32_specs.checked_mul. fuel%vstd.std_specs.num.u32_specs.checked_div.
...
;; Function-Decl crate::vstd::std_specs::num::u32_specs::wrapping_add
(declare-fun vstd.std_specs.num.u32_specs.wrapping_add.? (Poly Poly) Int)

;; Function-Decl crate::vstd::std_specs::num::u32_specs::wrapping_add_signed
(declare-fun vstd.std_specs.num.u32_specs.wrapping_add_signed.? (Poly Poly) Int)

;; Function-Decl crate::vstd::std_specs::num::u32_specs::wrapping_sub
(declare-fun vstd.std_specs.num.u32_specs.wrapping_sub.? (Poly Poly) Int)

;; Function-Decl crate::vstd::std_specs::num::u32_specs::checked_add
(declare-fun vstd.std_specs.num.u32_specs.checked_add.? (Poly Poly) core!option.Option.)

;; Function-Decl crate::vstd::std_specs::num::u32_specs::checked_add_signed
(declare-fun vstd.std_specs.num.u32_specs.checked_add_signed.? (Poly Poly) core!option.Option.)

;; Function-Decl crate::vstd::std_specs::num::u32_specs::checked_sub
(declare-fun vstd.std_specs.num.u32_specs.checked_sub.? (Poly Poly) core!option.Option.)

;; Function-Decl crate::vstd::std_specs::num::u32_specs::checked_mul
(declare-fun vstd.std_specs.num.u32_specs.checked_mul.? (Poly Poly) core!option.Option.)

;; Function-Decl crate::vstd::std_specs::num::u32_specs::checked_div
(declare-fun vstd.std_specs.num.u32_specs.checked_div.? (Poly Poly) core!option.Option.)
...
;; Function-Axioms crate::vstd::std_specs::num::u32_specs::wrapping_add
(assert
 (fuel_bool_default fuel%vstd.std_specs.num.u32_specs.wrapping_add.)
)
(assert
 (=>
  (fuel_bool fuel%vstd.std_specs.num.u32_specs.wrapping_add.)
  (forall ((x! Poly) (y! Poly)) (!
    (= (vstd.std_specs.num.u32_specs.wrapping_add.? x! y!) (ite
      (> (Add (%I x!) (%I y!)) 4294967295)
      (uClip 32 (Sub (Add (%I x!) (%I y!)) 4294967296))
      (uClip 32 (Add (%I x!) (%I y!)))
    ))
    :pattern ((vstd.std_specs.num.u32_specs.wrapping_add.? x! y!))
    :qid internal_vstd.std_specs.num.u32_specs.wrapping_add.?_definition
    :skolemid skolem_internal_vstd.std_specs.num.u32_specs.wrapping_add.?_definition
))))
(assert
 (forall ((x! Poly) (y! Poly)) (!
   (=>
    ...
    (uInv 32 (vstd.std_specs.num.u32_specs.wrapping_add.? x! y!))
   )
   :pattern ((vstd.std_specs.num.u32_specs.wrapping_add.? x! y!))
   :qid internal_vstd.std_specs.num.u32_specs.wrapping_add.?_pre_post_definition
   :skolemid skolem_internal_vstd.std_specs.num.u32_specs.wrapping_add.?_pre_post_definition
)))

;; Function-Specs core::num::impl&%8::wrapping_add
(declare-fun ens%core!num.impl&%8.wrapping_add. (Int Int Int) Bool)
(assert
 (forall ((x! Int) (y! Int) (res! Int)) (!
   (= (ens%core!num.impl&%8.wrapping_add. x! y! res!) (and
     (uInv 32 res!)
     (= res! (vstd.std_specs.num.u32_specs.wrapping_add.? (I x!) (I y!)))
   ))
   :pattern ((ens%core!num.impl&%8.wrapping_add. x! y! res!))
   :qid internal_ens__core!num.impl&__8.wrapping_add._definition
   :skolemid skolem_internal_ens__core!num.impl&__8.wrapping_add._definition
)))

;; Function-Axioms crate::vstd::std_specs::num::u32_specs::wrapping_add_signed
(assert
 (fuel_bool_default fuel%vstd.std_specs.num.u32_specs.wrapping_add_signed.)
)
(assert
 (=>
  (fuel_bool fuel%vstd.std_specs.num.u32_specs.wrapping_add_signed.)
  (forall ((x! Poly) (y! Poly)) (!
    (= (vstd.std_specs.num.u32_specs.wrapping_add_signed.? x! y!) (ite
      (> (Add (%I x!) (%I y!)) 4294967295)
      (uClip 32 (Sub (Add (%I x!) (%I y!)) 4294967296))
      (ite
       (< (Add (%I x!) (%I y!)) 0)
       (uClip 32 (Add (Add (%I x!) (%I y!)) 4294967296))
       (uClip 32 (Add (%I x!) (%I y!)))
    )))
    :pattern ((vstd.std_specs.num.u32_specs.wrapping_add_signed.? x! y!))
    :qid internal_vstd.std_specs.num.u32_specs.wrapping_add_signed.?_definition
    :skolemid skolem_internal_vstd.std_specs.num.u32_specs.wrapping_add_signed.?_definition
))))
(assert
 (forall ((x! Poly) (y! Poly)) (!
   (=>
    ...
    (uInv 32 (vstd.std_specs.num.u32_specs.wrapping_add_signed.? x! y!))
   )
   :pattern ((vstd.std_specs.num.u32_specs.wrapping_add_signed.? x! y!))
   :qid internal_vstd.std_specs.num.u32_specs.wrapping_add_signed.?_pre_post_definition
   :skolemid skolem_internal_vstd.std_specs.num.u32_specs.wrapping_add_signed.?_pre_post_definition
)))

;; Function-Specs core::num::impl&%8::wrapping_add_signed
(declare-fun ens%core!num.impl&%8.wrapping_add_signed. (Int Int Int) Bool)
(assert
 (forall ((x! Int) (y! Int) (res! Int)) (!
   (= (ens%core!num.impl&%8.wrapping_add_signed. x! y! res!) (and
     (uInv 32 res!)
     (= res! (vstd.std_specs.num.u32_specs.wrapping_add_signed.? (I x!) (I y!)))
   ))
   :pattern ((ens%core!num.impl&%8.wrapping_add_signed. x! y! res!))
   :qid internal_ens__core!num.impl&__8.wrapping_add_signed._definition
   :skolemid skolem_internal_ens__core!num.impl&__8.wrapping_add_signed._definition
)))

;; Function-Axioms crate::vstd::std_specs::num::u32_specs::wrapping_sub
(assert
 (fuel_bool_default fuel%vstd.std_specs.num.u32_specs.wrapping_sub.)
)
(assert
 (=>
  (fuel_bool fuel%vstd.std_specs.num.u32_specs.wrapping_sub.)
  (forall ((x! Poly) (y! Poly)) (!
    (= (vstd.std_specs.num.u32_specs.wrapping_sub.? x! y!) (ite
      (< (Sub (%I x!) (%I y!)) 0)
      (uClip 32 (Add (Sub (%I x!) (%I y!)) 4294967296))
      (uClip 32 (Sub (%I x!) (%I y!)))
    ))
    :pattern ((vstd.std_specs.num.u32_specs.wrapping_sub.? x! y!))
    :qid internal_vstd.std_specs.num.u32_specs.wrapping_sub.?_definition
    :skolemid skolem_internal_vstd.std_specs.num.u32_specs.wrapping_sub.?_definition
))))
(assert
 (forall ((x! Poly) (y! Poly)) (!
   (=>
    ...
    (uInv 32 (vstd.std_specs.num.u32_specs.wrapping_sub.? x! y!))
   )
   :pattern ((vstd.std_specs.num.u32_specs.wrapping_sub.? x! y!))
   :qid internal_vstd.std_specs.num.u32_specs.wrapping_sub.?_pre_post_definition
   :skolemid skolem_internal_vstd.std_specs.num.u32_specs.wrapping_sub.?_pre_post_definition
)))

;; Function-Specs core::num::impl&%8::wrapping_sub
(declare-fun ens%core!num.impl&%8.wrapping_sub. (Int Int Int) Bool)
(assert
 (forall ((x! Int) (y! Int) (res! Int)) (!
   (= (ens%core!num.impl&%8.wrapping_sub. x! y! res!) (and
     (uInv 32 res!)
     (= res! (vstd.std_specs.num.u32_specs.wrapping_sub.? (I x!) (I y!)))
   ))
   :pattern ((ens%core!num.impl&%8.wrapping_sub. x! y! res!))
   :qid internal_ens__core!num.impl&__8.wrapping_sub._definition
   :skolemid skolem_internal_ens__core!num.impl&__8.wrapping_sub._definition
)))

;; Function-Axioms crate::vstd::std_specs::num::u32_specs::checked_add
(assert
 (fuel_bool_default fuel%vstd.std_specs.num.u32_specs.checked_add.)
)
(assert
 (=>
  (fuel_bool fuel%vstd.std_specs.num.u32_specs.checked_add.)
  (forall ((x! Poly) (y! Poly)) (!
    (= (vstd.std_specs.num.u32_specs.checked_add.? x! y!) (ite
      (> (Add (%I x!) (%I y!)) 4294967295)
      core!option.Option./None
      (core!option.Option./Some (I (uClip 32 (Add (%I x!) (%I y!)))))
    ))
    :pattern ((vstd.std_specs.num.u32_specs.checked_add.? x! y!))
    :qid internal_vstd.std_specs.num.u32_specs.checked_add.?_definition
    :skolemid skolem_internal_vstd.std_specs.num.u32_specs.checked_add.?_definition
))))
(assert
 (forall ((x! Poly) (y! Poly)) (!
   (=>
    ...
    (has_type (Poly%core!option.Option. (vstd.std_specs.num.u32_specs.checked_add.? x! y!))
     (TYPE%core!option.Option. $ (UINT 32))
   ))
   :pattern ((vstd.std_specs.num.u32_specs.checked_add.? x! y!))
   :qid internal_vstd.std_specs.num.u32_specs.checked_add.?_pre_post_definition
   :skolemid skolem_internal_vstd.std_specs.num.u32_specs.checked_add.?_pre_post_definition
)))
...
(assert
 (forall ((x! Int) (y! Int) (res! core!option.Option.)) (!
   (= (ens%core!num.impl&%8.checked_add. x! y! res!) (and
     (has_type (Poly%core!option.Option. res!) (TYPE%core!option.Option. $ (UINT 32)))
     (= res! (vstd.std_specs.num.u32_specs.checked_add.? (I x!) (I y!)))
   ))
   :pattern ((ens%core!num.impl&%8.checked_add. x! y! res!))
...
;; Function-Axioms crate::vstd::std_specs::num::u32_specs::checked_add_signed
(assert
 (fuel_bool_default fuel%vstd.std_specs.num.u32_specs.checked_add_signed.)
)
(assert
 (=>
  (fuel_bool fuel%vstd.std_specs.num.u32_specs.checked_add_signed.)
  (forall ((x! Poly) (y! Poly)) (!
    (= (vstd.std_specs.num.u32_specs.checked_add_signed.? x! y!) (ite
      (or
       (> (Add (%I x!) (%I y!)) 4294967295)
       (< (Add (%I x!) (%I y!)) 0)
      )
    ...
    :pattern ((vstd.std_specs.num.u32_specs.checked_add_signed.? x! y!))
    :qid internal_vstd.std_specs.num.u32_specs.checked_add_signed.?_definition
    :skolemid skolem_internal_vstd.std_specs.num.u32_specs.checked_add_signed.?_definition
))))
(assert
 (forall ((x! Poly) (y! Poly)) (!
   (=>
    ...
    (has_type (Poly%core!option.Option. (vstd.std_specs.num.u32_specs.checked_add_signed.?
       x! y!
      )
     ) (TYPE%core!option.Option. $ (UINT 32))
   ))
   :pattern ((vstd.std_specs.num.u32_specs.checked_add_signed.? x! y!))
   :qid internal_vstd.std_specs.num.u32_specs.checked_add_signed.?_pre_post_definition
   :skolemid skolem_internal_vstd.std_specs.num.u32_specs.checked_add_signed.?_pre_post_definition
)))

;; Function-Specs core::num::impl&%8::checked_add_signed
(declare-fun ens%core!num.impl&%8.checked_add_signed. (Int Int core!option.Option.)
 Bool
)
(assert
 (forall ((x! Int) (y! Int) (res! core!option.Option.)) (!
   (= (ens%core!num.impl&%8.checked_add_signed. x! y! res!) (and
     (has_type (Poly%core!option.Option. res!) (TYPE%core!option.Option. $ (UINT 32)))
     (= res! (vstd.std_specs.num.u32_specs.checked_add_signed.? (I x!) (I y!)))
   ))
   :pattern ((ens%core!num.impl&%8.checked_add_signed. x! y! res!))
   :qid internal_ens__core!num.impl&__8.checked_add_signed._definition
   :skolemid skolem_internal_ens__core!num.impl&__8.checked_add_signed._definition
)))

;; Function-Axioms crate::vstd::std_specs::num::u32_specs::checked_sub
(assert
 (fuel_bool_default fuel%vstd.std_specs.num.u32_specs.checked_sub.)
)
(assert
 (=>
  (fuel_bool fuel%vstd.std_specs.num.u32_specs.checked_sub.)
  (forall ((x! Poly) (y! Poly)) (!
    (= (vstd.std_specs.num.u32_specs.checked_sub.? x! y!) (ite
      (< (Sub (%I x!) (%I y!)) 0)
      core!option.Option./None
      (core!option.Option./Some (I (uClip 32 (Sub (%I x!) (%I y!)))))
    ))
    :pattern ((vstd.std_specs.num.u32_specs.checked_sub.? x! y!))
    :qid internal_vstd.std_specs.num.u32_specs.checked_sub.?_definition
    :skolemid skolem_internal_vstd.std_specs.num.u32_specs.checked_sub.?_definition
))))
(assert
 (forall ((x! Poly) (y! Poly)) (!
   (=>
    ...
    (has_type (Poly%core!option.Option. (vstd.std_specs.num.u32_specs.checked_sub.? x! y!))
     (TYPE%core!option.Option. $ (UINT 32))
   ))
   :pattern ((vstd.std_specs.num.u32_specs.checked_sub.? x! y!))
   :qid internal_vstd.std_specs.num.u32_specs.checked_sub.?_pre_post_definition
   :skolemid skolem_internal_vstd.std_specs.num.u32_specs.checked_sub.?_pre_post_definition
)))

;; Function-Specs core::num::impl&%8::checked_sub
(declare-fun ens%core!num.impl&%8.checked_sub. (Int Int core!option.Option.) Bool)
(assert
 (forall ((x! Int) (y! Int) (res! core!option.Option.)) (!
   (= (ens%core!num.impl&%8.checked_sub. x! y! res!) (and
     (has_type (Poly%core!option.Option. res!) (TYPE%core!option.Option. $ (UINT 32)))
     (= res! (vstd.std_specs.num.u32_specs.checked_sub.? (I x!) (I y!)))
   ))
   :pattern ((ens%core!num.impl&%8.checked_sub. x! y! res!))
   :qid internal_ens__core!num.impl&__8.checked_sub._definition
   :skolemid skolem_internal_ens__core!num.impl&__8.checked_sub._definition
)))

;; Function-Axioms crate::vstd::std_specs::num::u32_specs::checked_mul
(assert
 (fuel_bool_default fuel%vstd.std_specs.num.u32_specs.checked_mul.)
)
(assert
 (=>
  (fuel_bool fuel%vstd.std_specs.num.u32_specs.checked_mul.)
  (forall ((x! Poly) (y! Poly)) (!
    (= (vstd.std_specs.num.u32_specs.checked_mul.? x! y!) (ite
      (> (Mul (%I x!) (%I y!)) 4294967295)
      core!option.Option./None
      (core!option.Option./Some (I (uClip 32 (Mul (%I x!) (%I y!)))))
    ))
    :pattern ((vstd.std_specs.num.u32_specs.checked_mul.? x! y!))
    :qid internal_vstd.std_specs.num.u32_specs.checked_mul.?_definition
    :skolemid skolem_internal_vstd.std_specs.num.u32_specs.checked_mul.?_definition
))))
(assert
 (forall ((x! Poly) (y! Poly)) (!
   (=>
    ...
    (has_type (Poly%core!option.Option. (vstd.std_specs.num.u32_specs.checked_mul.? x! y!))
     (TYPE%core!option.Option. $ (UINT 32))
   ))
   :pattern ((vstd.std_specs.num.u32_specs.checked_mul.? x! y!))
   :qid internal_vstd.std_specs.num.u32_specs.checked_mul.?_pre_post_definition
   :skolemid skolem_internal_vstd.std_specs.num.u32_specs.checked_mul.?_pre_post_definition
)))

;; Function-Specs core::num::impl&%8::checked_mul
(declare-fun ens%core!num.impl&%8.checked_mul. (Int Int core!option.Option.) Bool)
(assert
 (forall ((lhs! Int) (rhs! Int) (result! core!option.Option.)) (!
   (= (ens%core!num.impl&%8.checked_mul. lhs! rhs! result!) (and
     (has_type (Poly%core!option.Option. result!) (TYPE%core!option.Option. $ (UINT 32)))
     (= result! (vstd.std_specs.num.u32_specs.checked_mul.? (I lhs!) (I rhs!)))
   ))
   :pattern ((ens%core!num.impl&%8.checked_mul. lhs! rhs! result!))
   :qid internal_ens__core!num.impl&__8.checked_mul._definition
   :skolemid skolem_internal_ens__core!num.impl&__8.checked_mul._definition
)))

;; Function-Axioms crate::vstd::std_specs::num::u32_specs::checked_div
(assert
 (fuel_bool_default fuel%vstd.std_specs.num.u32_specs.checked_div.)
)
(assert
 (=>
  (fuel_bool fuel%vstd.std_specs.num.u32_specs.checked_div.)
  (forall ((x! Poly) (y! Poly)) (!
    (= (vstd.std_specs.num.u32_specs.checked_div.? x! y!) (ite
      (= (%I y!) 0)
      core!option.Option./None
      (core!option.Option./Some (I (uClip 32 (EucDiv (%I x!) (%I y!)))))
    ))
    :pattern ((vstd.std_specs.num.u32_specs.checked_div.? x! y!))
    :qid internal_vstd.std_specs.num.u32_specs.checked_div.?_definition
    :skolemid skolem_internal_vstd.std_specs.num.u32_specs.checked_div.?_definition
))))
(assert
 (forall ((x! Poly) (y! Poly)) (!
   (=>
    ...
    (has_type (Poly%core!option.Option. (vstd.std_specs.num.u32_specs.checked_div.? x! y!))
     (TYPE%core!option.Option. $ (UINT 32))
   ))
   :pattern ((vstd.std_specs.num.u32_specs.checked_div.? x! y!))
   :qid internal_vstd.std_specs.num.u32_specs.checked_div.?_pre_post_definition
   :skolemid skolem_internal_vstd.std_specs.num.u32_specs.checked_div.?_pre_post_definition
)))

;; Function-Specs core::num::impl&%8::checked_div
(declare-fun ens%core!num.impl&%8.checked_div. (Int Int core!option.Option.) Bool)
(assert
 (forall ((lhs! Int) (rhs! Int) (result! core!option.Option.)) (!
   (= (ens%core!num.impl&%8.checked_div. lhs! rhs! result!) (and
     (has_type (Poly%core!option.Option. result!) (TYPE%core!option.Option. $ (UINT 32)))
     (= result! (vstd.std_specs.num.u32_specs.checked_div.? (I lhs!) (I rhs!)))
   ))
   :pattern ((ens%core!num.impl&%8.checked_div. lhs! rhs! result!))
   :qid internal_ens__core!num.impl&__8.checked_div._definition
   :skolemid skolem_internal_ens__core!num.impl&__8.checked_div._definition
)))

;; Function-Specs core::num::impl&%8::checked_div_euclid
(declare-fun ens%core!num.impl&%8.checked_div_euclid. (Int Int core!option.Option.)
 Bool
)
(assert
 (forall ((lhs! Int) (rhs! Int) (result! core!option.Option.)) (!
   (= (ens%core!num.impl&%8.checked_div_euclid. lhs! rhs! result!) (and
     (has_type (Poly%core!option.Option. result!) (TYPE%core!option.Option. $ (UINT 32)))
     (= result! (vstd.std_specs.num.u32_specs.checked_div.? (I lhs!) (I rhs!)))
   ))
   :pattern ((ens%core!num.impl&%8.checked_div_euclid. lhs! rhs! result!))
   :qid internal_ens__core!num.impl&__8.checked_div_euclid._definition
   :skolemid skolem_internal_ens__core!num.impl&__8.checked_div_euclid._definition
)))
