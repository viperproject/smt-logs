...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/basic-cf562145df495703-test_is_core/../../../../vstd/bits.rs:365:15: 365:52 (#1176)
...
;; Function-Def crate::vstd::bits::lemma_u16_and_split_low_bit
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/basic-cf562145df495703-test_is_core/../../../../vstd/bits.rs:365:15: 365:52 (#1176)
...
(declare-const tmp$$$$bitvectmp1 (_ BitVec 16))
(declare-const tmp$$$$bitvectmp3 (_ BitVec 16))
(declare-const tmp$$$$bitvectmp5 (_ BitVec 16))
(declare-const tmp$$$$bitvectmp7 (_ BitVec 16))
 ...
 (not (=>
   ...
   (= (bvand x! m!) (bvadd (bvmul (bvand (let
        ...
        (ite
         ...
         tmp$$$$bitvectmp1
         (bvudiv x! ((_ zero_extend 14) tmp$$$$bitvectmp0))
        )
       ) (let
        ...
        (ite
         ...
         tmp$$$$bitvectmp3
         (bvudiv m! ((_ zero_extend 14) tmp$$$$bitvectmp2))
       ))
      ) ((_ zero_extend 14) (_ bv2 2))
     ) (bvand (let
       ((tmp$$$$bitvectmp4 (_ bv2 2)))
       (ite
        (= tmp$$$$bitvectmp4 (_ bv0 2))
        tmp$$$$bitvectmp5
        (bvurem x! ((_ zero_extend 14) tmp$$$$bitvectmp4))
       )
      ) (let
       ...
       (ite
        ...
        tmp$$$$bitvectmp7
        (bvurem m! ((_ zero_extend 14) tmp$$$$bitvectmp6))
))))))))
(get-info :version)
