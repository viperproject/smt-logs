...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/basic-cf562145df495703-test_is_core/../../../../vstd/std_specs/bits.rs:110:9: 110:15 (#0)
...
(assert
 (not (=>
   ...
   (=>
    ...
    (=>
     (and
      (= (bvshl i! (bvsub ((_ zero_extend 4) (_ bv8 4)) y@)) ((_ zero_extend 7) (_ bv0 1)))
      (and
       (bvule ((_ zero_extend 7) (_ bv0 1)) j@)
       (bvult j@ y@)
     ))
