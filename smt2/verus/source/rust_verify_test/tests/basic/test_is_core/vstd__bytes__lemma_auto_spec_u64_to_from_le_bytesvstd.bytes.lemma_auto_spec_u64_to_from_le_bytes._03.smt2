...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/basic-cf562145df495703-test_is_core/../../../../vstd/bytes.rs:278:9: 278:15 (#0)
       ...
       (and
        (and
         (and
          (and
           (and
            (= x$1@ (bvor (bvor (bvor (bvor (bvor (bvor (bvor s0@ (bvshl s1@ ((_ zero_extend 60) (_ bv8
                       4
                    )))
                   ) (bvshl s2@ ((_ zero_extend 59) (_ bv16 5)))
                  ) (bvshl s3@ ((_ zero_extend 59) (_ bv24 5)))
                 ) (bvshl s4@ ((_ zero_extend 58) (_ bv32 6)))
                ) (bvshl s5@ ((_ zero_extend 58) (_ bv40 6)))
               ) (bvshl s6@ ((_ zero_extend 58) (_ bv48 6)))
              ) (bvshl s7@ ((_ zero_extend 58) (_ bv56 6)))
            ))
            (bvult s0@ ((_ zero_extend 55) (_ bv256 9)))
           )
           (bvult s1@ ((_ zero_extend 55) (_ bv256 9)))
          )
          (bvult s2@ ((_ zero_extend 55) (_ bv256 9)))
         )
         (bvult s3@ ((_ zero_extend 55) (_ bv256 9)))
        )
        (bvult s4@ ((_ zero_extend 55) (_ bv256 9)))
       )
       (bvult s5@ ((_ zero_extend 55) (_ bv256 9)))
      )
      (bvult s6@ ((_ zero_extend 55) (_ bv256 9)))
     )
     (bvult s7@ ((_ zero_extend 55) (_ bv256 9)))
    )
    (and
     (and
      (and
       (and
        (and
         (and
          (and
           (= s0@ (bvand x$1@ ((_ zero_extend 56) (_ bv255 8))))
           (= s1@ (bvand (bvlshr x$1@ ((_ zero_extend 60) (_ bv8 4))) ((_ zero_extend 56) (_ bv255
               8
          )))))
          (= s2@ (bvand (bvlshr x$1@ ((_ zero_extend 59) (_ bv16 5))) ((_ zero_extend 56) (_ bv255
              8
         )))))
         (= s3@ (bvand (bvlshr x$1@ ((_ zero_extend 59) (_ bv24 5))) ((_ zero_extend 56) (_ bv255
             8
        )))))
        (= s4@ (bvand (bvlshr x$1@ ((_ zero_extend 58) (_ bv32 6))) ((_ zero_extend 56) (_ bv255
            8
       )))))
       (= s5@ (bvand (bvlshr x$1@ ((_ zero_extend 58) (_ bv40 6))) ((_ zero_extend 56) (_ bv255
           8
      )))))
      (= s6@ (bvand (bvlshr x$1@ ((_ zero_extend 58) (_ bv48 6))) ((_ zero_extend 56) (_ bv255
          8
     )))))
     (= s7@ (bvand (bvlshr x$1@ ((_ zero_extend 58) (_ bv56 6))) ((_ zero_extend 56) (_ bv255
         8
)))))))))
(get-info :version)
