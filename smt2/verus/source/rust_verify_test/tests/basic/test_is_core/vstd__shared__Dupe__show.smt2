...
;; MODULE 'module vstd::shared::Dupe::show'
...
;; Datatypes
(declare-datatypes ((core!option.Option. 0) (vstd.shared.Dupe.State. 0) (tuple%0. 0))
...
;; Function-Specs crate::vstd::shared::Dupe::show::initialize_one
(declare-fun req%vstd.shared.Dupe.show.initialize_one. (Dcr Type vstd.shared.Dupe.State.
  Poly
 ) Bool
)
...
(assert
 (forall ((T&. Dcr) (T& Type) (post! vstd.shared.Dupe.State.) (t! Poly)) (!
   (= (req%vstd.shared.Dupe.show.initialize_one. T&. T& post! t!) (=>
     %%global_location_label%%0
     (vstd.shared.Dupe.impl&%7.initialize_one.? T&. T& (Poly%vstd.shared.Dupe.State. post!)
      t!
   )))
   :pattern ((req%vstd.shared.Dupe.show.initialize_one. T&. T& post! t!))
   :qid internal_req__vstd.shared.Dupe.show.initialize_one._definition
   :skolemid skolem_internal_req__vstd.shared.Dupe.show.initialize_one._definition
)))
(declare-fun ens%vstd.shared.Dupe.show.initialize_one. (Dcr Type vstd.shared.Dupe.State.
  Poly
 ) Bool
)
(assert
 (forall ((T&. Dcr) (T& Type) (post! vstd.shared.Dupe.State.) (t! Poly)) (!
   (= (ens%vstd.shared.Dupe.show.initialize_one. T&. T& post! t!) (vstd.shared.Dupe.impl&%7.init.?
     T&. T& (Poly%vstd.shared.Dupe.State. post!)
   ))
   :pattern ((ens%vstd.shared.Dupe.show.initialize_one. T&. T& post! t!))
   :qid internal_ens__vstd.shared.Dupe.show.initialize_one._definition
   :skolemid skolem_internal_ens__vstd.shared.Dupe.show.initialize_one._definition
)))
