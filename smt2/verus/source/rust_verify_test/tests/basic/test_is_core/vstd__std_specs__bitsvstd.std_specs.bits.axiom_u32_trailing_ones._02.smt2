...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/basic-cf562145df495703-test_is_core/../../../../vstd/std_specs/bits.rs:498:5: 498:11 (#0)
...
(assert
 (not (=>
   %%location_label%%0
   (=>
    (= (bvnot i!) ((_ zero_extend 31) (_ bv0 1)))
    (= i! (_ bv4294967295 32))
))))
(get-info :version)
