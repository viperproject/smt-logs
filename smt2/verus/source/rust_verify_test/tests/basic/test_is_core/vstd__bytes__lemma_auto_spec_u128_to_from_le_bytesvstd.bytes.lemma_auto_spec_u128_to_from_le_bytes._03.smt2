...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/basic-cf562145df495703-test_is_core/../../../../vstd/bytes.rs:446:9: 446:15 (#0)
...
(declare-const x$1@ (_ BitVec 128))
(declare-const s0@ (_ BitVec 128))
(declare-const s1@ (_ BitVec 128))
(declare-const s2@ (_ BitVec 128))
(declare-const s3@ (_ BitVec 128))
(declare-const s4@ (_ BitVec 128))
(declare-const s5@ (_ BitVec 128))
(declare-const s6@ (_ BitVec 128))
(declare-const s7@ (_ BitVec 128))
(declare-const s8@ (_ BitVec 128))
(declare-const s9@ (_ BitVec 128))
(declare-const s10@ (_ BitVec 128))
(declare-const s11@ (_ BitVec 128))
(declare-const s12@ (_ BitVec 128))
(declare-const s13@ (_ BitVec 128))
(declare-const s14@ (_ BitVec 128))
(declare-const s15@ (_ BitVec 128))
(assert
 true
)
               ...
               (and
                (and
                 (and
                  (and
                   (and
                    (= x$1@ (bvor (bvor (bvor (bvor (bvor (bvor (bvor (bvor (bvor (bvor (bvor (bvor (bvor (bvor (bvor
                                    s0@ (bvshl s1@ ((_ zero_extend 124) (_ bv8 4)))
                                   ) (bvshl s2@ ((_ zero_extend 123) (_ bv16 5)))
                                  ) (bvshl s3@ ((_ zero_extend 123) (_ bv24 5)))
                                 ) (bvshl s4@ ((_ zero_extend 122) (_ bv32 6)))
                                ) (bvshl s5@ ((_ zero_extend 122) (_ bv40 6)))
                               ) (bvshl s6@ ((_ zero_extend 122) (_ bv48 6)))
                              ) (bvshl s7@ ((_ zero_extend 122) (_ bv56 6)))
                             ) (bvshl s8@ ((_ zero_extend 121) (_ bv64 7)))
                            ) (bvshl s9@ ((_ zero_extend 121) (_ bv72 7)))
                           ) (bvshl s10@ ((_ zero_extend 121) (_ bv80 7)))
                          ) (bvshl s11@ ((_ zero_extend 121) (_ bv88 7)))
                         ) (bvshl s12@ ((_ zero_extend 121) (_ bv96 7)))
                        ) (bvshl s13@ ((_ zero_extend 121) (_ bv104 7)))
                       ) (bvshl s14@ ((_ zero_extend 121) (_ bv112 7)))
                      ) (bvshl s15@ ((_ zero_extend 121) (_ bv120 7)))
                    ))
                    (bvult s0@ ((_ zero_extend 119) (_ bv256 9)))
                   )
                   (bvult s1@ ((_ zero_extend 119) (_ bv256 9)))
                  )
                  (bvult s2@ ((_ zero_extend 119) (_ bv256 9)))
                 )
                 (bvult s3@ ((_ zero_extend 119) (_ bv256 9)))
                )
                (bvult s4@ ((_ zero_extend 119) (_ bv256 9)))
               )
               (bvult s5@ ((_ zero_extend 119) (_ bv256 9)))
              )
              (bvult s6@ ((_ zero_extend 119) (_ bv256 9)))
             )
             (bvult s7@ ((_ zero_extend 119) (_ bv256 9)))
            )
            (bvult s8@ ((_ zero_extend 119) (_ bv256 9)))
           )
           (bvult s9@ ((_ zero_extend 119) (_ bv256 9)))
          )
          (bvult s10@ ((_ zero_extend 119) (_ bv256 9)))
         )
         (bvult s11@ ((_ zero_extend 119) (_ bv256 9)))
        )
        (bvult s12@ ((_ zero_extend 119) (_ bv256 9)))
       )
       (bvult s13@ ((_ zero_extend 119) (_ bv256 9)))
      )
      (bvult s14@ ((_ zero_extend 119) (_ bv256 9)))
     )
     (bvult s15@ ((_ zero_extend 119) (_ bv256 9)))
    )
    (and
     (and
      (and
              ...
              (and
               (and
                (and
                 (and
                  (and
                   (= s0@ (bvand x$1@ ((_ zero_extend 120) (_ bv255 8))))
                   (= s1@ (bvand (bvlshr x$1@ ((_ zero_extend 124) (_ bv8 4))) ((_ zero_extend 120) (_ bv255
                       8
                  )))))
                  (= s2@ (bvand (bvlshr x$1@ ((_ zero_extend 123) (_ bv16 5))) ((_ zero_extend 120) (_
                      bv255 8
                 )))))
                 (= s3@ (bvand (bvlshr x$1@ ((_ zero_extend 123) (_ bv24 5))) ((_ zero_extend 120) (_
                     bv255 8
                )))))
                (= s4@ (bvand (bvlshr x$1@ ((_ zero_extend 122) (_ bv32 6))) ((_ zero_extend 120) (_
                    bv255 8
               )))))
               (= s5@ (bvand (bvlshr x$1@ ((_ zero_extend 122) (_ bv40 6))) ((_ zero_extend 120) (_
                   bv255 8
              )))))
              (= s6@ (bvand (bvlshr x$1@ ((_ zero_extend 122) (_ bv48 6))) ((_ zero_extend 120) (_
                  bv255 8
             )))))
             (= s7@ (bvand (bvlshr x$1@ ((_ zero_extend 122) (_ bv56 6))) ((_ zero_extend 120) (_
                 bv255 8
            )))))
            (= s8@ (bvand (bvlshr x$1@ ((_ zero_extend 121) (_ bv64 7))) ((_ zero_extend 120) (_
                bv255 8
           )))))
           (= s9@ (bvand (bvlshr x$1@ ((_ zero_extend 121) (_ bv72 7))) ((_ zero_extend 120) (_
               bv255 8
          )))))
          (= s10@ (bvand (bvlshr x$1@ ((_ zero_extend 121) (_ bv80 7))) ((_ zero_extend 120) (
              _ bv255 8
         )))))
         (= s11@ (bvand (bvlshr x$1@ ((_ zero_extend 121) (_ bv88 7))) ((_ zero_extend 120) (
             _ bv255 8
        )))))
        (= s12@ (bvand (bvlshr x$1@ ((_ zero_extend 121) (_ bv96 7))) ((_ zero_extend 120) (
            _ bv255 8
       )))))
       (= s13@ (bvand (bvlshr x$1@ ((_ zero_extend 121) (_ bv104 7))) ((_ zero_extend 120)
          (_ bv255 8)
      ))))
      (= s14@ (bvand (bvlshr x$1@ ((_ zero_extend 121) (_ bv112 7))) ((_ zero_extend 120)
         (_ bv255 8)
     ))))
     (= s15@ (bvand (bvlshr x$1@ ((_ zero_extend 121) (_ bv120 7))) ((_ zero_extend 120)
        (_ bv255 8)
))))))))
(get-info :version)
