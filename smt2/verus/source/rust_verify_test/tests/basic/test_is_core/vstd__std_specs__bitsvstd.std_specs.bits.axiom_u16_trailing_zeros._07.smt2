...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/basic-cf562145df495703-test_is_core/../../../../vstd/std_specs/bits.rs:283:5: 283:11 (#0)
...
(assert
 (not (=>
   %%location_label%%0
   (= (bvshl i! ((_ zero_extend 11) (_ bv16 5))) ((_ zero_extend 15) (_ bv0 1)))
)))
(get-info :version)
