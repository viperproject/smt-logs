...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/basic-cf562145df495703-test_is_core/../../../../vstd/bits.rs:365:15: 365:52 (#1169)
...
;; Function-Def crate::vstd::bits::lemma_u32_and_split_low_bit
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/basic-cf562145df495703-test_is_core/../../../../vstd/bits.rs:365:15: 365:52 (#1169)
...
(declare-const tmp$$$$bitvectmp1 (_ BitVec 32))
(declare-const tmp$$$$bitvectmp3 (_ BitVec 32))
(declare-const tmp$$$$bitvectmp5 (_ BitVec 32))
(declare-const tmp$$$$bitvectmp7 (_ BitVec 32))
;; bitvector assertion not satisfied
(declare-const %%location_label%%0 Bool)
(assert
 (not (=>
   %%location_label%%0
   (= (bvand x! m!) (bvadd (bvmul (bvand (let
        ((tmp$$$$bitvectmp0 (_ bv2 2)))
        (ite
         (= tmp$$$$bitvectmp0 (_ bv0 2))
         tmp$$$$bitvectmp1
         (bvudiv x! ((_ zero_extend 30) tmp$$$$bitvectmp0))
        )
       ) (let
        ...
        (ite
         ...
         tmp$$$$bitvectmp3
         (bvudiv m! ((_ zero_extend 30) tmp$$$$bitvectmp2))
       ))
      ) ((_ zero_extend 30) (_ bv2 2))
     ) (bvand (let
       ((tmp$$$$bitvectmp4 (_ bv2 2)))
       (ite
        (= tmp$$$$bitvectmp4 (_ bv0 2))
        tmp$$$$bitvectmp5
        (bvurem x! ((_ zero_extend 30) tmp$$$$bitvectmp4))
       )
      ) (let
       ((tmp$$$$bitvectmp6 (_ bv2 2)))
       (ite
        (= tmp$$$$bitvectmp6 (_ bv0 2))
        tmp$$$$bitvectmp7
        (bvurem m! ((_ zero_extend 30) tmp$$$$bitvectmp6))
))))))))
(get-info :version)
