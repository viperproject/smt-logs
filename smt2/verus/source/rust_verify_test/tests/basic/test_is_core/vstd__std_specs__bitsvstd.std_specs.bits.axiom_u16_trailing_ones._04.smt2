...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/basic-cf562145df495703-test_is_core/../../../../vstd/std_specs/bits.rs:316:9: 316:15 (#0)
...
(assert
 (not (=>
   ...
   (=>
    ...
    (=>
     (and
      (= (bvshl (bvnot i!) (bvsub ((_ zero_extend 11) (_ bv16 5)) y@)) ((_ zero_extend 15)
        (_ bv0 1)
      ))
      (and
       (bvule ((_ zero_extend 15) (_ bv0 1)) j@)
       (bvult j@ y@)
     ))
