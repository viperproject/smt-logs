...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/basic-cf562145df495703-test_is_core/../../../../vstd/std_specs/bits.rs:473:5: 473:11 (#0)
...
(assert
 (not (=>
   %%location_label%%0
   (=>
    (= (bvand i! ((_ zero_extend 31) (_ bv1 1))) ((_ zero_extend 31) (_ bv0 1)))
    (=>
     (= (bvshl (bvlshr i! ((_ zero_extend 31) (_ bv1 1))) (bvsub ((_ zero_extend 26) (_ bv32
          6
         )
        ) x@
       )
     ...
     (= (bvshl i! (bvsub ((_ zero_extend 26) (_ bv32 6)) (bvadd x@ ((_ zero_extend 31) (_ bv1
           1
       ))))
      ) ((_ zero_extend 31) (_ bv0 1))
))))))
