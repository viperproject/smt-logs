...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/basic-cf562145df495703-test_is_core/../../../../vstd/bits.rs:130:17: 130:23 (#1136)
...
(declare-const shift! (_ BitVec 32))
(declare-const x! (_ BitVec 32))
(assert
 (and
  (bvult ((_ zero_extend 31) (_ bv0 1)) shift!)
  (bvult shift! ((_ zero_extend 26) (_ bv32 6)))
))
...
(assert
 (not (=>
   %%location_label%%0
   (= (bvshl x! shift!) (bvmul (bvshl x! (bvsub shift! ((_ zero_extend 31) (_ bv1 1))))
