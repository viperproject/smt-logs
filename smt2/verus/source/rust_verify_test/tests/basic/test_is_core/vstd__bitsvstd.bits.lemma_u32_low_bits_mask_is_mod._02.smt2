...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/basic-cf562145df495703-test_is_core/../../../../vstd/bits.rs:334:17: 334:23 (#1169)
 ...
 (not (=>
   ...
   (= (let
     ...
     (ite
      ...
      tmp$$$$bitvectmp1
      (bvurem x! ((_ zero_extend 30) tmp$$$$bitvectmp0))
     )
    ) (bvand (let
      ...
      (ite
       ...
       tmp$$$$bitvectmp3
       (bvurem x! ((_ zero_extend 30) tmp$$$$bitvectmp2))
      )
