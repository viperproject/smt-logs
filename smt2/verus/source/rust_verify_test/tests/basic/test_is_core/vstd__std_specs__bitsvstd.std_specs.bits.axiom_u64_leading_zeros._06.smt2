...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/basic-cf562145df495703-test_is_core/../../../../vstd/std_specs/bits.rs:718:5: 718:11 (#0)
 ...
 (not (=>
   ...
   (=>
    (and
     ...
     (bvule x@ ((_ zero_extend 57) (_ bv64 7)))
    )
    (=>
     (= (bvlshr (bvlshr i! ((_ zero_extend 63) (_ bv1 1))) (bvsub ((_ zero_extend 57) (_ bv64
          7
         )
        ) x@
       )
     ...
     (= (bvlshr i! (bvsub ((_ zero_extend 57) (_ bv64 7)) (bvsub x@ ((_ zero_extend 63) (_ bv1
           1
       ))))
      ) ((_ zero_extend 63) (_ bv0 1))
))))))
