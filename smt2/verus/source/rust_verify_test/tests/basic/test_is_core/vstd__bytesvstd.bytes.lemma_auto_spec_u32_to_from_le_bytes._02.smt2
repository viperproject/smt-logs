...
;; MODULE 'module vstd::bytes'
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/basic-cf562145df495703-test_is_core/../../../../vstd/bytes.rs:140:9: 140:15 (#0)
...
(declare-const fuel%vstd.bytes.spec_u16_to_le_bytes. FuelId)
(declare-const fuel%vstd.bytes.spec_u16_from_le_bytes. FuelId)
(declare-const fuel%vstd.bytes.spec_u32_to_le_bytes. FuelId)
(declare-const fuel%vstd.bytes.spec_u32_from_le_bytes. FuelId)
(declare-const fuel%vstd.bytes.spec_u64_to_le_bytes. FuelId)
(declare-const fuel%vstd.bytes.spec_u64_from_le_bytes. FuelId)
...
(assert
 (distinct fuel%vstd.array.array_view. fuel%vstd.array.impl&%0.view. fuel%vstd.bytes.spec_u16_to_le_bytes.
  fuel%vstd.bytes.spec_u16_from_le_bytes. fuel%vstd.bytes.spec_u32_to_le_bytes. fuel%vstd.bytes.spec_u32_from_le_bytes.
  fuel%vstd.bytes.spec_u64_to_le_bytes. fuel%vstd.bytes.spec_u64_from_le_bytes. fuel%vstd.bytes.spec_u128_to_le_bytes.
  fuel%vstd.bytes.spec_u128_from_le_bytes. fuel%vstd.raw_ptr.impl&%4.view. fuel%vstd.seq.impl&%0.spec_index.
  fuel%vstd.seq.axiom_seq_index_decreases. fuel%vstd.seq.axiom_seq_new_len. fuel%vstd.seq.axiom_seq_new_index.
  fuel%vstd.seq.axiom_seq_ext_equal. fuel%vstd.seq.axiom_seq_ext_equal_deep. fuel%vstd.seq_lib.check_argument_is_seq.
...
;; Function-Decl crate::vstd::bytes::spec_u16_from_le_bytes
(declare-fun vstd.bytes.spec_u16_from_le_bytes.? (Poly) Int)

;; Function-Decl crate::vstd::bytes::spec_u32_from_le_bytes
(declare-fun vstd.bytes.spec_u32_from_le_bytes.? (Poly) Int)

;; Function-Decl crate::vstd::bytes::spec_u64_from_le_bytes
...
;; Function-Decl crate::vstd::bytes::spec_u16_to_le_bytes
(declare-fun vstd.bytes.spec_u16_to_le_bytes.? (Poly) vstd.seq.Seq<u8.>.)

;; Function-Decl crate::vstd::bytes::spec_u32_to_le_bytes
(declare-fun vstd.bytes.spec_u32_to_le_bytes.? (Poly) vstd.seq.Seq<u8.>.)

;; Function-Decl crate::vstd::bytes::spec_u64_to_le_bytes
...
;; Function-Specs crate::vstd::bytes::spec_u16_from_le_bytes
(declare-fun req%vstd.bytes.spec_u16_from_le_bytes. (Poly) Bool)
(declare-const %%global_location_label%%2 Bool)
(assert
 (forall ((s! Poly)) (!
   (= (req%vstd.bytes.spec_u16_from_le_bytes. s!) (=>
     %%global_location_label%%2
     (= (vstd!seq.Seq.len.? $ (UINT 8) s!) 2)
   ))
   :pattern ((req%vstd.bytes.spec_u16_from_le_bytes. s!))
   :qid internal_req__vstd.bytes.spec_u16_from_le_bytes._definition
   :skolemid skolem_internal_req__vstd.bytes.spec_u16_from_le_bytes._definition
)))

;; Function-Axioms crate::vstd::bytes::spec_u16_from_le_bytes
(assert
 (fuel_bool_default fuel%vstd.bytes.spec_u16_from_le_bytes.)
)
(assert
 (=>
  (fuel_bool fuel%vstd.bytes.spec_u16_from_le_bytes.)
  (forall ((s! Poly)) (!
    (= (vstd.bytes.spec_u16_from_le_bytes.? s!) (uClip 16 (bitor (I (uClip 16 (%I (vstd!seq.Seq.index.?
           $ (UINT 8) s! (I 0)
        )))
       ) (I (uClip 16 (bitshl (I (uClip 16 (%I (vstd!seq.Seq.index.? $ (UINT 8) s! (I 1)))))
          (I 8)
    ))))))
    :pattern ((vstd.bytes.spec_u16_from_le_bytes.? s!))
    :qid internal_vstd.bytes.spec_u16_from_le_bytes.?_definition
    :skolemid skolem_internal_vstd.bytes.spec_u16_from_le_bytes.?_definition
))))
(assert
 (forall ((s! Poly)) (!
   (=>
    (has_type s! (TYPE%vstd.seq.Seq. $ (UINT 8)))
    (uInv 16 (vstd.bytes.spec_u16_from_le_bytes.? s!))
   )
   :pattern ((vstd.bytes.spec_u16_from_le_bytes.? s!))
   :qid internal_vstd.bytes.spec_u16_from_le_bytes.?_pre_post_definition
   :skolemid skolem_internal_vstd.bytes.spec_u16_from_le_bytes.?_pre_post_definition
)))

;; Function-Specs crate::vstd::bytes::u16_from_le_bytes
(declare-fun req%vstd.bytes.u16_from_le_bytes. (slice%<u8.>.) Bool)
(declare-const %%global_location_label%%3 Bool)
(assert
 (forall ((s! slice%<u8.>.)) (!
   (= (req%vstd.bytes.u16_from_le_bytes. s!) (=>
   ...
   :pattern ((req%vstd.bytes.u16_from_le_bytes. s!))
   :qid internal_req__vstd.bytes.u16_from_le_bytes._definition
   :skolemid skolem_internal_req__vstd.bytes.u16_from_le_bytes._definition
)))
(declare-fun ens%vstd.bytes.u16_from_le_bytes. (slice%<u8.>. Int) Bool)
(assert
 (forall ((s! slice%<u8.>.) (x! Int)) (!
   (= (ens%vstd.bytes.u16_from_le_bytes. s! x!) (and
     (uInv 16 x!)
     (= x! (vstd.bytes.spec_u16_from_le_bytes.? (vstd.view.View.view.? $ (SLICE $ (UINT 8))
        (Poly%slice%<u8.>. s!)
   )))))
   :pattern ((ens%vstd.bytes.u16_from_le_bytes. s! x!))
   :qid internal_ens__vstd.bytes.u16_from_le_bytes._definition
   :skolemid skolem_internal_ens__vstd.bytes.u16_from_le_bytes._definition
)))

;; Function-Specs crate::vstd::bytes::spec_u32_from_le_bytes
(declare-fun req%vstd.bytes.spec_u32_from_le_bytes. (Poly) Bool)
(declare-const %%global_location_label%%4 Bool)
(assert
 (forall ((s! Poly)) (!
   (= (req%vstd.bytes.spec_u32_from_le_bytes. s!) (=>
     %%global_location_label%%4
     (= (vstd!seq.Seq.len.? $ (UINT 8) s!) 4)
   ))
   :pattern ((req%vstd.bytes.spec_u32_from_le_bytes. s!))
   :qid internal_req__vstd.bytes.spec_u32_from_le_bytes._definition
   :skolemid skolem_internal_req__vstd.bytes.spec_u32_from_le_bytes._definition
)))

;; Function-Axioms crate::vstd::bytes::spec_u32_from_le_bytes
(assert
 (fuel_bool_default fuel%vstd.bytes.spec_u32_from_le_bytes.)
)
(assert
 (=>
  (fuel_bool fuel%vstd.bytes.spec_u32_from_le_bytes.)
  (forall ((s! Poly)) (!
    (= (vstd.bytes.spec_u32_from_le_bytes.? s!) (uClip 32 (bitor (I (uClip 32 (bitor (I (uClip
            32 (bitor (I (uClip 32 (%I (vstd!seq.Seq.index.? $ (UINT 8) s! (I 0))))) (I (uClip 32
               (bitshl (I (uClip 32 (%I (vstd!seq.Seq.index.? $ (UINT 8) s! (I 1))))) (I 8))
           ))))
          ) (I (uClip 32 (bitshl (I (uClip 32 (%I (vstd!seq.Seq.index.? $ (UINT 8) s! (I 2)))))
             (I 16)
        )))))
       ) (I (uClip 32 (bitshl (I (uClip 32 (%I (vstd!seq.Seq.index.? $ (UINT 8) s! (I 3)))))
          (I 24)
    ))))))
    :pattern ((vstd.bytes.spec_u32_from_le_bytes.? s!))
    :qid internal_vstd.bytes.spec_u32_from_le_bytes.?_definition
    :skolemid skolem_internal_vstd.bytes.spec_u32_from_le_bytes.?_definition
))))
(assert
 (forall ((s! Poly)) (!
   (=>
    (has_type s! (TYPE%vstd.seq.Seq. $ (UINT 8)))
    (uInv 32 (vstd.bytes.spec_u32_from_le_bytes.? s!))
   )
   :pattern ((vstd.bytes.spec_u32_from_le_bytes.? s!))
   :qid internal_vstd.bytes.spec_u32_from_le_bytes.?_pre_post_definition
   :skolemid skolem_internal_vstd.bytes.spec_u32_from_le_bytes.?_pre_post_definition
)))

;; Function-Specs crate::vstd::bytes::u32_from_le_bytes
(declare-fun req%vstd.bytes.u32_from_le_bytes. (slice%<u8.>.) Bool)
(declare-const %%global_location_label%%5 Bool)
(assert
 (forall ((s! slice%<u8.>.)) (!
   (= (req%vstd.bytes.u32_from_le_bytes. s!) (=>
   ...
   :pattern ((req%vstd.bytes.u32_from_le_bytes. s!))
   :qid internal_req__vstd.bytes.u32_from_le_bytes._definition
   :skolemid skolem_internal_req__vstd.bytes.u32_from_le_bytes._definition
)))
(declare-fun ens%vstd.bytes.u32_from_le_bytes. (slice%<u8.>. Int) Bool)
(assert
 (forall ((s! slice%<u8.>.) (x! Int)) (!
   (= (ens%vstd.bytes.u32_from_le_bytes. s! x!) (and
     (uInv 32 x!)
     (= x! (vstd.bytes.spec_u32_from_le_bytes.? (vstd.view.View.view.? $ (SLICE $ (UINT 8))
        (Poly%slice%<u8.>. s!)
   )))))
   :pattern ((ens%vstd.bytes.u32_from_le_bytes. s! x!))
   :qid internal_ens__vstd.bytes.u32_from_le_bytes._definition
   :skolemid skolem_internal_ens__vstd.bytes.u32_from_le_bytes._definition
)))

;; Function-Specs crate::vstd::bytes::spec_u64_from_le_bytes
...
;; Function-Axioms crate::vstd::bytes::spec_u64_from_le_bytes
(assert
 (fuel_bool_default fuel%vstd.bytes.spec_u64_from_le_bytes.)
)
(assert
 (=>
  (fuel_bool fuel%vstd.bytes.spec_u64_from_le_bytes.)
  (forall ((s! Poly)) (!
    (= (vstd.bytes.spec_u64_from_le_bytes.? s!) (uClip 64 (bitor (I (uClip 64 (bitor (I (uClip
            64 (bitor (I (uClip 64 (bitor (I (uClip 64 (bitor (I (uClip 64 (bitor (I (uClip 64 (bitor (I (uClip
                           64 (%I (vstd!seq.Seq.index.? $ (UINT 8) s! (I 0)))
                          )
                         ) (I (uClip 64 (bitshl (I (uClip 64 (%I (vstd!seq.Seq.index.? $ (UINT 8) s! (I 1)))))
                            (I 8)
                       )))))
                      ) (I (uClip 64 (bitshl (I (uClip 64 (%I (vstd!seq.Seq.index.? $ (UINT 8) s! (I 2)))))
                         (I 16)
                    )))))
                   ) (I (uClip 64 (bitshl (I (uClip 64 (%I (vstd!seq.Seq.index.? $ (UINT 8) s! (I 3)))))
                      (I 24)
                 )))))
                ) (I (uClip 64 (bitshl (I (uClip 64 (%I (vstd!seq.Seq.index.? $ (UINT 8) s! (I 4)))))
                   (I 32)
              )))))
             ) (I (uClip 64 (bitshl (I (uClip 64 (%I (vstd!seq.Seq.index.? $ (UINT 8) s! (I 5)))))
                (I 40)
           )))))
          ) (I (uClip 64 (bitshl (I (uClip 64 (%I (vstd!seq.Seq.index.? $ (UINT 8) s! (I 6)))))
             (I 48)
        )))))
       ) (I (uClip 64 (bitshl (I (uClip 64 (%I (vstd!seq.Seq.index.? $ (UINT 8) s! (I 7)))))
          (I 56)
    ))))))
    :pattern ((vstd.bytes.spec_u64_from_le_bytes.? s!))
    :qid internal_vstd.bytes.spec_u64_from_le_bytes.?_definition
    :skolemid skolem_internal_vstd.bytes.spec_u64_from_le_bytes.?_definition
))))
(assert
 (forall ((s! Poly)) (!
   (=>
...
;; Function-Specs crate::vstd::bytes::u64_from_le_bytes
...
(assert
 (forall ((s! slice%<u8.>.) (x! Int)) (!
   (= (ens%vstd.bytes.u64_from_le_bytes. s! x!) (and
     (uInv 64 x!)
     (= x! (vstd.bytes.spec_u64_from_le_bytes.? (vstd.view.View.view.? $ (SLICE $ (UINT 8))
        (Poly%slice%<u8.>. s!)
   )))))
...
;; Function-Specs crate::vstd::bytes::u128_from_le_bytes
(declare-fun req%vstd.bytes.u128_from_le_bytes. (slice%<u8.>.) Bool)
(declare-const %%global_location_label%%9 Bool)
(assert
 (forall ((s! slice%<u8.>.)) (!
   (= (req%vstd.bytes.u128_from_le_bytes. s!) (=>
   ...
   :pattern ((req%vstd.bytes.u128_from_le_bytes. s!))
   :qid internal_req__vstd.bytes.u128_from_le_bytes._definition
   :skolemid skolem_internal_req__vstd.bytes.u128_from_le_bytes._definition
)))
(declare-fun ens%vstd.bytes.u128_from_le_bytes. (slice%<u8.>. Int) Bool)
(assert
 (forall ((s! slice%<u8.>.) (x! Int)) (!
   (= (ens%vstd.bytes.u128_from_le_bytes. s! x!) (and
     (uInv 128 x!)
     (= x! (vstd.bytes.spec_u128_from_le_bytes.? (vstd.view.View.view.? $ (SLICE $ (UINT 8))
        (Poly%slice%<u8.>. s!)
   )))))
   :pattern ((ens%vstd.bytes.u128_from_le_bytes. s! x!))
   :qid internal_ens__vstd.bytes.u128_from_le_bytes._definition
   :skolemid skolem_internal_ens__vstd.bytes.u128_from_le_bytes._definition
)))

;; Function-Axioms crate::vstd::bytes::spec_u16_to_le_bytes
(assert
 (fuel_bool_default fuel%vstd.bytes.spec_u16_to_le_bytes.)
)
...
(assert
 (=>
  (fuel_bool fuel%vstd.bytes.spec_u16_to_le_bytes.)
  (forall ((x! Poly)) (!
    (= (vstd.bytes.spec_u16_to_le_bytes.? x!) (%Poly%vstd.seq.Seq<u8.>. (vstd.view.View.view.?
       $ (ARRAY $ (UINT 8) $ (CONST_INT 2)) (array_new $ (UINT 8) 2 (%%array%%0 (I (uClip 8
           (uClip 16 (bitand (I (%I x!)) (I 255)))
          )
         ) (I (uClip 8 (uClip 16 (bitand (I (uClip 16 (bitshr (I (%I x!)) (I 8)))) (I 255)))))
    )))))
    :pattern ((vstd.bytes.spec_u16_to_le_bytes.? x!))
    :qid internal_vstd.bytes.spec_u16_to_le_bytes.?_definition
    :skolemid skolem_internal_vstd.bytes.spec_u16_to_le_bytes.?_definition
))))

;; Function-Axioms crate::vstd::bytes::spec_u32_to_le_bytes
(assert
 (fuel_bool_default fuel%vstd.bytes.spec_u32_to_le_bytes.)
)
...
(assert
 (=>
  (fuel_bool fuel%vstd.bytes.spec_u32_to_le_bytes.)
  (forall ((x! Poly)) (!
    (= (vstd.bytes.spec_u32_to_le_bytes.? x!) (%Poly%vstd.seq.Seq<u8.>. (vstd.view.View.view.?
       $ (ARRAY $ (UINT 8) $ (CONST_INT 4)) (array_new $ (UINT 8) 4 (%%array%%1 (I (uClip 8
           (uClip 32 (bitand (I (%I x!)) (I 255)))
          )
         ) (I (uClip 8 (uClip 32 (bitand (I (uClip 32 (bitshr (I (%I x!)) (I 8)))) (I 255)))))
         (I (uClip 8 (uClip 32 (bitand (I (uClip 32 (bitshr (I (%I x!)) (I 16)))) (I 255)))))
         (I (uClip 8 (uClip 32 (bitand (I (uClip 32 (bitshr (I (%I x!)) (I 24)))) (I 255)))))
    )))))
    :pattern ((vstd.bytes.spec_u32_to_le_bytes.? x!))
    :qid internal_vstd.bytes.spec_u32_to_le_bytes.?_definition
    :skolemid skolem_internal_vstd.bytes.spec_u32_to_le_bytes.?_definition
))))

;; Function-Axioms crate::vstd::bytes::spec_u64_to_le_bytes
(assert
 (fuel_bool_default fuel%vstd.bytes.spec_u64_to_le_bytes.)
)
(declare-fun %%array%%2 (Poly Poly Poly Poly Poly Poly Poly Poly) %%Function%%)
(assert
...
(assert
 (=>
  (fuel_bool fuel%vstd.bytes.spec_u64_to_le_bytes.)
  (forall ((x! Poly)) (!
    (= (vstd.bytes.spec_u64_to_le_bytes.? x!) (%Poly%vstd.seq.Seq<u8.>. (vstd.view.View.view.?
       $ (ARRAY $ (UINT 8) $ (CONST_INT 8)) (array_new $ (UINT 8) 8 (%%array%%2 (I (uClip 8
           (uClip 64 (bitand (I (%I x!)) (I 255)))
          )
         ) (I (uClip 8 (uClip 64 (bitand (I (uClip 64 (bitshr (I (%I x!)) (I 8)))) (I 255)))))
         (I (uClip 8 (uClip 64 (bitand (I (uClip 64 (bitshr (I (%I x!)) (I 16)))) (I 255)))))
         (I (uClip 8 (uClip 64 (bitand (I (uClip 64 (bitshr (I (%I x!)) (I 24)))) (I 255)))))
         (I (uClip 8 (uClip 64 (bitand (I (uClip 64 (bitshr (I (%I x!)) (I 32)))) (I 255)))))
         (I (uClip 8 (uClip 64 (bitand (I (uClip 64 (bitshr (I (%I x!)) (I 40)))) (I 255)))))
         (I (uClip 8 (uClip 64 (bitand (I (uClip 64 (bitshr (I (%I x!)) (I 48)))) (I 255)))))
         (I (uClip 8 (uClip 64 (bitand (I (uClip 64 (bitshr (I (%I x!)) (I 56)))) (I 255)))))
    )))))
    :pattern ((vstd.bytes.spec_u64_to_le_bytes.? x!))
    :qid internal_vstd.bytes.spec_u64_to_le_bytes.?_definition
    :skolemid skolem_internal_vstd.bytes.spec_u64_to_le_bytes.?_definition
))))
...
(declare-fun %%array%%3 (Poly Poly Poly Poly Poly Poly Poly Poly Poly Poly Poly Poly
  Poly Poly Poly Poly
 ) %%Function%%
)
(assert
 ...
 (=>
  ...
  (forall ((x! Poly)) (!
    (= (vstd.bytes.spec_u128_to_le_bytes.? x!) (%Poly%vstd.seq.Seq<u8.>. (vstd.view.View.view.?
       $ (ARRAY $ (UINT 8) $ (CONST_INT 16)) (array_new $ (UINT 8) 16 (%%array%%3 (I (uClip
...
;; Function-Specs crate::vstd::bytes::lemma_auto_spec_u16_to_from_le_bytes
(declare-fun ens%vstd.bytes.lemma_auto_spec_u16_to_from_le_bytes. (Int) Bool)
(assert
 (forall ((no%param Int)) (!
   (= (ens%vstd.bytes.lemma_auto_spec_u16_to_from_le_bytes. no%param) (and
     (forall ((x$ Poly)) (!
       (=>
        (has_type x$ (UINT 16))
        (and
         (= (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd.seq.Seq<u8.>. (vstd.bytes.spec_u16_to_le_bytes.?
             x$
           ))
          ) 2
         )
         (= (vstd.bytes.spec_u16_from_le_bytes.? (Poly%vstd.seq.Seq<u8.>. (vstd.bytes.spec_u16_to_le_bytes.?
             x$
           ))
          ) (%I x$)
       )))
       :pattern ((vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd.seq.Seq<u8.>. (vstd.bytes.spec_u16_to_le_bytes.?
           x$
       ))))
       :qid user_crate__vstd__bytes__lemma_auto_spec_u16_to_from_le_bytes_7
       :skolemid skolem_user_crate__vstd__bytes__lemma_auto_spec_u16_to_from_le_bytes_7
     ))
     (forall ((s$ Poly)) (!
       (=>
        (has_type s$ (TYPE%vstd.seq.Seq. $ (UINT 8)))
        (=>
         (= (vstd!seq.Seq.len.? $ (UINT 8) s$) 2)
         (= (vstd.bytes.spec_u16_to_le_bytes.? (I (vstd.bytes.spec_u16_from_le_bytes.? s$)))
          (%Poly%vstd.seq.Seq<u8.>. s$)
       )))
       :pattern ((vstd.bytes.spec_u16_to_le_bytes.? (I (vstd.bytes.spec_u16_from_le_bytes.?
           s$
       ))))
       :qid user_crate__vstd__bytes__lemma_auto_spec_u16_to_from_le_bytes_8
       :skolemid skolem_user_crate__vstd__bytes__lemma_auto_spec_u16_to_from_le_bytes_8
   ))))
   :pattern ((ens%vstd.bytes.lemma_auto_spec_u16_to_from_le_bytes. no%param))
   :qid internal_ens__vstd.bytes.lemma_auto_spec_u16_to_from_le_bytes._definition
   :skolemid skolem_internal_ens__vstd.bytes.lemma_auto_spec_u16_to_from_le_bytes._definition
)))

;; Function-Specs crate::vstd::bytes::lemma_auto_spec_u32_to_from_le_bytes
(declare-fun ens%vstd.bytes.lemma_auto_spec_u32_to_from_le_bytes. (Int) Bool)
(assert
 (forall ((no%param Int)) (!
   (= (ens%vstd.bytes.lemma_auto_spec_u32_to_from_le_bytes. no%param) (and
     (forall ((x$ Poly)) (!
       (=>
        (has_type x$ (UINT 32))
        (and
         (= (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd.seq.Seq<u8.>. (vstd.bytes.spec_u32_to_le_bytes.?
             x$
           ))
          ) 4
         )
         (= (vstd.bytes.spec_u32_from_le_bytes.? (Poly%vstd.seq.Seq<u8.>. (vstd.bytes.spec_u32_to_le_bytes.?
             x$
           ))
          ) (%I x$)
       )))
       :pattern ((vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd.seq.Seq<u8.>. (vstd.bytes.spec_u32_to_le_bytes.?
           x$
       ))))
       :qid user_crate__vstd__bytes__lemma_auto_spec_u32_to_from_le_bytes_9
       :skolemid skolem_user_crate__vstd__bytes__lemma_auto_spec_u32_to_from_le_bytes_9
     ))
     (forall ((s$ Poly)) (!
       (=>
        (has_type s$ (TYPE%vstd.seq.Seq. $ (UINT 8)))
        (=>
         (= (vstd!seq.Seq.len.? $ (UINT 8) s$) 4)
         (= (vstd.bytes.spec_u32_to_le_bytes.? (I (vstd.bytes.spec_u32_from_le_bytes.? s$)))
          (%Poly%vstd.seq.Seq<u8.>. s$)
       )))
       :pattern ((vstd.bytes.spec_u32_to_le_bytes.? (I (vstd.bytes.spec_u32_from_le_bytes.?
           s$
       ))))
       :qid user_crate__vstd__bytes__lemma_auto_spec_u32_to_from_le_bytes_10
       :skolemid skolem_user_crate__vstd__bytes__lemma_auto_spec_u32_to_from_le_bytes_10
   ))))
   :pattern ((ens%vstd.bytes.lemma_auto_spec_u32_to_from_le_bytes. no%param))
   :qid internal_ens__vstd.bytes.lemma_auto_spec_u32_to_from_le_bytes._definition
   :skolemid skolem_internal_ens__vstd.bytes.lemma_auto_spec_u32_to_from_le_bytes._definition
)))

;; Function-Def crate::vstd::bytes::lemma_auto_spec_u32_to_from_le_bytes
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/basic-cf562145df495703-test_is_core/../../../../vstd/bytes.rs:140:9: 140:15 (#0)
...
(assert
 (not (=>
   %%location_label%%0
   (= x@ (bvor (bvor (bvor (bvand x@ ((_ zero_extend 24) (_ bv255 8))) (bvshl (bvand (bvlshr
          x@ ((_ zero_extend 28) (_ bv8 4))
         ) ((_ zero_extend 24) (_ bv255 8))
        ) ((_ zero_extend 28) (_ bv8 4))
       )
      ) (bvshl (bvand (bvlshr x@ ((_ zero_extend 27) (_ bv16 5))) ((_ zero_extend 24) (_ bv255
          8
        ))
       ) ((_ zero_extend 27) (_ bv16 5))
      )
     ) (bvshl (bvand (bvlshr x@ ((_ zero_extend 27) (_ bv24 5))) ((_ zero_extend 24) (_ bv255
         8
       ))
      ) ((_ zero_extend 27) (_ bv24 5))
))))))
(get-info :version)
