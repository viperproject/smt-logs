...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/basic-cf562145df495703-test_is_core/../../../../vstd/std_specs/bits.rs:693:9: 693:15 (#0)
...
(assert
 (not (=>
   ...
   (=>
    ...
    (=>
     (and
      (= (bvshl (bvnot i!) (bvsub ((_ zero_extend 57) (_ bv64 7)) y@)) ((_ zero_extend 63)
        (_ bv0 1)
      ))
      (and
     ...
     (= (bvand (bvlshr i! j@) ((_ zero_extend 63) (_ bv1 1))) ((_ zero_extend 63) (_ bv1
        1
))))))))
(get-info :version)
