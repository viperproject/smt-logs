...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/basic-cf562145df495703-test_is_core/../../../../vstd/bytes.rs:133:9: 133:15 (#0)
...
(assert
 (not (=>
   ...
   (and
    (and
     (and
      (bvult (bvand x@ ((_ zero_extend 24) (_ bv255 8))) ((_ zero_extend 23) (_ bv256 9)))
      (bvult (bvand (bvlshr x@ ((_ zero_extend 28) (_ bv8 4))) ((_ zero_extend 24) (_ bv255
          8
        ))
       ) ((_ zero_extend 23) (_ bv256 9))
     ))
     (bvult (bvand (bvlshr x@ ((_ zero_extend 27) (_ bv16 5))) ((_ zero_extend 24) (_ bv255
         8
       ))
      ) ((_ zero_extend 23) (_ bv256 9))
    ))
    (bvult (bvand (bvlshr x@ ((_ zero_extend 27) (_ bv24 5))) ((_ zero_extend 24) (_ bv255
        8
      ))
     ) ((_ zero_extend 23) (_ bv256 9))
)))))
