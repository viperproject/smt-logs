...
;; MODULE 'module vstd::bytes, function crate::vstd::bytes::lemma_auto_spec_u64_to_from_le_bytes'
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/basic-cf562145df495703-test_is_core/../../../../vstd/bytes.rs:243:9: 243:15 (#0)
...
(assert
 (distinct fuel%vstd.array.array_view. fuel%vstd.array.impl&%0.view. fuel%vstd.bytes.spec_u64_to_le_bytes.
  fuel%vstd.bytes.spec_u64_from_le_bytes. fuel%vstd.seq.impl&%0.spec_index. fuel%vstd.seq.axiom_seq_index_decreases.
  ...
  fuel%vstd.view.impl&%6.view. fuel%vstd.view.impl&%12.view. fuel%vstd.view.impl&%16.view.
 ...
 (=>
  ...
  (forall ((x! Poly)) (!
    (= (vstd.bytes.spec_u64_to_le_bytes.? x!) (%Poly%vstd.seq.Seq<u8.>. (vstd.view.View.view.?
       $ (ARRAY $ (UINT 8) $ (CONST_INT 8)) (array_new $ (UINT 8) 8 (%%array%%0 (I (uClip 8
 ...
 (forall ((no%param Int)) (!
   (= (ens%vstd.bytes.lemma_auto_spec_u64_to_from_le_bytes. no%param) (and
     (forall ((x$ Poly)) (!
       ...
       :pattern ((vstd.bytes.spec_u64_to_le_bytes.? x$))
       :qid user_crate__vstd__bytes__lemma_auto_spec_u64_to_from_le_bytes_7
       :skolemid skolem_user_crate__vstd__bytes__lemma_auto_spec_u64_to_from_le_bytes_7
     ))
     (forall ((s$ Poly)) (!
       (=>
        (has_type s$ (TYPE%vstd.seq.Seq. $ (UINT 8)))
       ...
       :qid user_crate__vstd__bytes__lemma_auto_spec_u64_to_from_le_bytes_8
       :skolemid skolem_user_crate__vstd__bytes__lemma_auto_spec_u64_to_from_le_bytes_8
   ))))
...
;; Function-Def crate::vstd::bytes::lemma_auto_spec_u64_to_from_le_bytes
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/basic-cf562145df495703-test_is_core/../../../../vstd/bytes.rs:243:9: 243:15 (#0)
     ...
     (and
      (and
       (and
        (and
         (and
          (bvult (bvand x@ ((_ zero_extend 56) (_ bv255 8))) ((_ zero_extend 55) (_ bv256 9)))
          (bvult (bvand (bvlshr x@ ((_ zero_extend 60) (_ bv8 4))) ((_ zero_extend 56) (_ bv255
              8
            ))
           ) ((_ zero_extend 55) (_ bv256 9))
         ))
         (bvult (bvand (bvlshr x@ ((_ zero_extend 59) (_ bv16 5))) ((_ zero_extend 56) (_ bv255
             8
           ))
          ) ((_ zero_extend 55) (_ bv256 9))
        ))
        (bvult (bvand (bvlshr x@ ((_ zero_extend 59) (_ bv24 5))) ((_ zero_extend 56) (_ bv255
            8
          ))
         ) ((_ zero_extend 55) (_ bv256 9))
       ))
       (bvult (bvand (bvlshr x@ ((_ zero_extend 58) (_ bv32 6))) ((_ zero_extend 56) (_ bv255
           8
         ))
        ) ((_ zero_extend 55) (_ bv256 9))
      ))
      (bvult (bvand (bvlshr x@ ((_ zero_extend 58) (_ bv40 6))) ((_ zero_extend 56) (_ bv255
          8
        ))
       ) ((_ zero_extend 55) (_ bv256 9))
     ))
     (bvult (bvand (bvlshr x@ ((_ zero_extend 58) (_ bv48 6))) ((_ zero_extend 56) (_ bv255
         8
       ))
      ) ((_ zero_extend 55) (_ bv256 9))
    ))
    (bvult (bvand (bvlshr x@ ((_ zero_extend 58) (_ bv56 6))) ((_ zero_extend 56) (_ bv255
        8
      ))
     ) ((_ zero_extend 55) (_ bv256 9))
)))))
