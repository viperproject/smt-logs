...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/basic-cf562145df495703-test_is_core/../../../../vstd/std_specs/bits.rs:716:5: 716:11 (#0)
...
(assert
 (not (=>
   ...
   (=>
    (and
     (bvult ((_ zero_extend 63) (_ bv0 1)) x@)
     (bvult x@ ((_ zero_extend 57) (_ bv64 7)))
    )
    (= (bvlshr (bvlshr i! ((_ zero_extend 63) (_ bv1 1))) (bvsub ((_ zero_extend 58) (_ bv63
         6
        )
       ) x@
      )
     ) (bvlshr i! (bvsub ((_ zero_extend 58) (_ bv63 6)) (bvsub x@ ((_ zero_extend 63) (_ bv1
          1
))))))))))
(get-info :version)
