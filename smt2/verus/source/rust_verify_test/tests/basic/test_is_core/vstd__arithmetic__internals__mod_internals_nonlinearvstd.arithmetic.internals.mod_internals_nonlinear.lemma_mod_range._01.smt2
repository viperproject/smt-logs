...
;; MODULE 'module vstd::arithmetic::internals::mod_internals_nonlinear'
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/basic-cf562145df495703-test_is_core/../../../../vstd/arithmetic/internals/mod_internals_nonlinear.rs:71:1: 71:45 (#0)
...
;; Function-Specs crate::vstd::arithmetic::internals::mod_internals_nonlinear::lemma_mod_of_zero_is_zero
(declare-fun req%vstd.arithmetic.internals.mod_internals_nonlinear.lemma_mod_of_zero_is_zero.
 (Int) Bool
)
(declare-const %%global_location_label%%0 Bool)
(assert
 (forall ((m! Int)) (!
   (= (req%vstd.arithmetic.internals.mod_internals_nonlinear.lemma_mod_of_zero_is_zero.
     m!
    ) (=>
     %%global_location_label%%0
     (< 0 m!)
   ))
   :pattern ((req%vstd.arithmetic.internals.mod_internals_nonlinear.lemma_mod_of_zero_is_zero.
     m!
   ))
   :qid internal_req__vstd.arithmetic.internals.mod_internals_nonlinear.lemma_mod_of_zero_is_zero._definition
   :skolemid skolem_internal_req__vstd.arithmetic.internals.mod_internals_nonlinear.lemma_mod_of_zero_is_zero._definition
)))
(declare-fun ens%vstd.arithmetic.internals.mod_internals_nonlinear.lemma_mod_of_zero_is_zero.
 (Int) Bool
)
(assert
 (forall ((m! Int)) (!
   (= (ens%vstd.arithmetic.internals.mod_internals_nonlinear.lemma_mod_of_zero_is_zero.
     m!
    ) (= (EucMod 0 m!) 0)
   )
   :pattern ((ens%vstd.arithmetic.internals.mod_internals_nonlinear.lemma_mod_of_zero_is_zero.
     m!
   ))
   :qid internal_ens__vstd.arithmetic.internals.mod_internals_nonlinear.lemma_mod_of_zero_is_zero._definition
   :skolemid skolem_internal_ens__vstd.arithmetic.internals.mod_internals_nonlinear.lemma_mod_of_zero_is_zero._definition
)))
...
;; Function-Specs crate::vstd::arithmetic::internals::mod_internals_nonlinear::lemma_0_mod_anything
(declare-fun ens%vstd.arithmetic.internals.mod_internals_nonlinear.lemma_0_mod_anything.
 (Int) Bool
)
(assert
 (forall ((no%param Int)) (!
   (= (ens%vstd.arithmetic.internals.mod_internals_nonlinear.lemma_0_mod_anything. no%param)
    (forall ((m$ Poly)) (!
      (=>
       (has_type m$ INT)
       (=>
        (> (%I m$) 0)
        (= (vstd.arithmetic.internals.mod_internals_nonlinear.modulus.? (I 0) m$) 0)
      ))
      :pattern ((vstd.arithmetic.internals.mod_internals_nonlinear.modulus.? (I 0) m$))
      :qid user_crate__vstd__arithmetic__internals__mod_internals_nonlinear__lemma_0_mod_anything_0
      :skolemid skolem_user_crate__vstd__arithmetic__internals__mod_internals_nonlinear__lemma_0_mod_anything_0
   )))
   :pattern ((ens%vstd.arithmetic.internals.mod_internals_nonlinear.lemma_0_mod_anything.
     no%param
   ))
   :qid internal_ens__vstd.arithmetic.internals.mod_internals_nonlinear.lemma_0_mod_anything._definition
   :skolemid skolem_internal_ens__vstd.arithmetic.internals.mod_internals_nonlinear.lemma_0_mod_anything._definition
)))
...
;; Function-Def crate::vstd::arithmetic::internals::mod_internals_nonlinear::lemma_mod_range
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/basic-cf562145df495703-test_is_core/../../../../vstd/arithmetic/internals/mod_internals_nonlinear.rs:71:1: 71:45 (#0)
