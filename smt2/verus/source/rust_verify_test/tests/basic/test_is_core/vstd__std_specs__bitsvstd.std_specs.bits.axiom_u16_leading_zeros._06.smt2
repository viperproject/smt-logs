...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/basic-cf562145df495703-test_is_core/../../../../vstd/std_specs/bits.rs:340:5: 340:11 (#0)
 ...
 (not (=>
   ...
   (=>
    (and
     ...
     (bvule x@ ((_ zero_extend 11) (_ bv16 5)))
    )
    (=>
     (= (bvlshr (bvlshr i! ((_ zero_extend 15) (_ bv1 1))) (bvsub ((_ zero_extend 11) (_ bv16
          5
         )
        ) x@
       )
      ) ((_ zero_extend 15) (_ bv0 1))
     )
     (= (bvlshr i! (bvsub ((_ zero_extend 11) (_ bv16 5)) (bvsub x@ ((_ zero_extend 15) (_ bv1
           1
       ))))
      ) ((_ zero_extend 15) (_ bv0 1))
))))))
