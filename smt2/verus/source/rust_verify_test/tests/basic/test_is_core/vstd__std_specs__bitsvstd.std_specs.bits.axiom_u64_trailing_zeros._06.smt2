...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/basic-cf562145df495703-test_is_core/../../../../vstd/std_specs/bits.rs:659:5: 659:11 (#0)
...
(assert
 (not (=>
   ...
   (=>
    ...
    (= (bvlshr (bvlshr i! ((_ zero_extend 63) (_ bv1 1))) x@) (bvlshr i! (bvadd x@ ((_ zero_extend
         63
        ) (_ bv1 1)
))))))))
(get-info :version)
