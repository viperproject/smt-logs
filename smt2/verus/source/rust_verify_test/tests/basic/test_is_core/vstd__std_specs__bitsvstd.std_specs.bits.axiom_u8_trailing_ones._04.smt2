...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/basic-cf562145df495703-test_is_core/../../../../vstd/std_specs/bits.rs:132:9: 132:15 (#0)
...
(assert
 (not (=>
   ...
   (=>
    ...
    (=>
     (and
      (= (bvshl (bvnot i!) (bvsub ((_ zero_extend 4) (_ bv8 4)) y@)) ((_ zero_extend 7) (
         _ bv0 1
      )))
      (and
