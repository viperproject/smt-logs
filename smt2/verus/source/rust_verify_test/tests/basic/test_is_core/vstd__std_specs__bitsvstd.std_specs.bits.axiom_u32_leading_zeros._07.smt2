...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/basic-cf562145df495703-test_is_core/../../../../vstd/std_specs/bits.rs:536:9: 536:15 (#0)
...
(assert
 (not (=>
   ...
   (=>
    ...
    (=>
     (= (bvlshr i! (bvsub ((_ zero_extend 26) (_ bv32 6)) y@)) ((_ zero_extend 31) (_ bv0
        1
     )))
     (=>
      (and
