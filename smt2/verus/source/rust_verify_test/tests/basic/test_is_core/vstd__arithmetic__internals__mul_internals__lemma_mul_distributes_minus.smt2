...
;; MODULE 'module vstd::arithmetic::internals::mul_internals, function crate::vstd::arithmetic::internals::mul_internals::lemma_mul_distributes_minus'
...
(assert
 (distinct fuel%vstd.arithmetic.internals.mul_internals.lemma_mul_distributes_minus.
 ...
 (forall ((no%param Int)) (!
   (= (ens%vstd.arithmetic.internals.mul_internals.lemma_mul_successor. no%param) (and
     (forall ((x$ Int) (y$ Int)) (!
       ...
       :qid user_crate__vstd__arithmetic__internals__mul_internals__lemma_mul_successor_0
       :skolemid skolem_user_crate__vstd__arithmetic__internals__mul_internals__lemma_mul_successor_0
     ))
     (forall ((x$ Int) (y$ Int)) (!
       (= (Mul (Sub x$ 1) y$) (Sub (Mul x$ y$) y$))
       :pattern ((Mul (Sub x$ 1) y$))
       :qid user_crate__vstd__arithmetic__internals__mul_internals__lemma_mul_successor_1
       :skolemid skolem_user_crate__vstd__arithmetic__internals__mul_internals__lemma_mul_successor_1
   ))))
   ...
   (= (req%vstd.arithmetic.internals.mul_internals.lemma_mul_induction. f!) (and
     ...
     (=>
      ...
      (forall ((i$ Poly)) (!
        ...
        :qid user_crate__vstd__arithmetic__internals__mul_internals__lemma_mul_induction_2
        :skolemid skolem_user_crate__vstd__arithmetic__internals__mul_internals__lemma_mul_induction_2
     )))
     (=>
      ...
      (forall ((i$ Poly)) (!
        ...
        :qid user_crate__vstd__arithmetic__internals__mul_internals__lemma_mul_induction_3
        :skolemid skolem_user_crate__vstd__arithmetic__internals__mul_internals__lemma_mul_induction_3
   )))))
...
(assert
 (forall ((f! %%Function%%)) (!
   (= (ens%vstd.arithmetic.internals.mul_internals.lemma_mul_induction. f!) (forall ((i$
      ...
      :pattern ((%%apply%%0 f! i$))
      :qid user_crate__vstd__arithmetic__internals__mul_internals__lemma_mul_induction_4
      :skolemid skolem_user_crate__vstd__arithmetic__internals__mul_internals__lemma_mul_induction_4
   )))
...
;; Function-Def crate::vstd::arithmetic::internals::mul_internals::lemma_mul_distributes_minus
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/basic-cf562145df495703-test_is_core/../../../../vstd/arithmetic/internals/mul_internals.rs:127:1: 127:75 (#0)
...
(push)
 ...
 (assert
  (forall ((%%hole%%0 Int) (%%hole%%1 Int) (%%hole%%2 Int) (%%hole%%3 Int) (i$ Poly))
   (!
    (= (%%apply%%0 (%%lambda%%0 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3) i$) (B (= (Mul (
         Sub %%hole%%0 (%I i$)
        ) %%hole%%1
       ) (Sub %%hole%%3 (Mul (%I i$) %%hole%%2))
    )))
 ...
 (assert
  (not (=>
    (ens%vstd.arithmetic.internals.mul_internals.lemma_mul_successor. 0)
    (and
     (=>
      (= f2@ (mk_fun (%%lambda%%0 x@ z@ z@ (Mul x@ z@))))
      (=>
       (= tmp%1 (%B (%%apply%%0 f2@ (I 0))))
       (and
        (=>
         %%location_label%%0
         tmp%1
         ...
         (and
          (=>
           ...
           (=>
            ...
            (=>
             (= tmp%2 (let
               ((tmp%%$ (Mul (Sub (Sub x@ (%I i@)) 1) z@)))
               (and
                (= (Mul (Sub x@ (Add (%I i@) 1)) z@) tmp%%$)
                (= tmp%%$ (Sub (Mul (Sub x@ (%I i@)) z@) z@))
             )))
             (and
              (=>
               %%location_label%%1
              ...
              (=>
               ...
               (=>
                %%location_label%%2
                (%B (%%apply%%0 f2@ (I (vstd.math.add.? i@ (I 1)))))
          ))))))
          (=>
           (forall ((i$ Poly)) (!
             (=>
             ...
             :pattern ((%%apply%%0 f2@ i$) (%%apply%%0 f2@ (I (vstd.math.add.? i$ (I 1)))))
             :qid user_crate__vstd__arithmetic__internals__mul_internals__lemma_mul_distributes_minus_6
             :skolemid skolem_user_crate__vstd__arithmetic__internals__mul_internals__lemma_mul_distributes_minus_6
           ))
           (and
            (=>
             (has_type i$1@ INT)
             (=>
              ...
              (=>
               (= tmp%3 (let
                 ((tmp%%$ (Mul (Add (Sub x@ (%I i$1@)) 1) z@)))
                 (and
                  (= (Mul (Sub x@ (Sub (%I i$1@) 1)) z@) tmp%%$)
                  (= tmp%%$ (Add (Mul (Sub x@ (%I i$1@)) z@) z@))
               )))
               (and
                (=>
                 %%location_label%%3
                ...
                (=>
                 ...
                 (=>
                  %%location_label%%4
                  (%B (%%apply%%0 f2@ (I (vstd.math.sub.? i$1@ (I 1)))))
            ))))))
            (=>
             (forall ((i$ Poly)) (!
               (=>
                ...
                (=>
                 ...
                 (%B (%%apply%%0 f2@ (I (vstd.math.sub.? i$ (I 1)))))
               ))
               :pattern ((%%apply%%0 f2@ i$) (%%apply%%0 f2@ (I (vstd.math.sub.? i$ (I 1)))))
             ...
             (and
              (=>
               %%location_label%%5
               (req%vstd.arithmetic.internals.mul_internals.lemma_mul_induction. f2@)
              )
              (=>
               (ens%vstd.arithmetic.internals.mul_internals.lemma_mul_induction. f2@)
               (=>
                (= tmp%4 (%B (%%apply%%0 f2@ (I y@))))
                (and
                 (=>
                  %%location_label%%6
                  tmp%4
     ...
     (=>
      (forall ((x$ Int) (y$ Int) (z$ Int)) (!
        ...
        :qid user_crate__vstd__arithmetic__internals__mul_internals__lemma_mul_distributes_minus_8
        :skolemid skolem_user_crate__vstd__arithmetic__internals__mul_internals__lemma_mul_distributes_minus_8
      ))
      (=>
       %%location_label%%8
       (= (Mul (Sub x! y!) z!) (Sub (Mul x! z!) (Mul y! z!)))
...
(assert
 (=>
  ...
  (forall ((x! Int) (y! Int) (z! Int)) (!
    (= (Mul (Sub x! y!) z!) (Sub (Mul x! z!) (Mul y! z!)))
    :pattern ((Mul (Sub x! y!) z!))
    :qid user_crate__vstd__arithmetic__internals__mul_internals__lemma_mul_distributes_minus_5
    :skolemid skolem_user_crate__vstd__arithmetic__internals__mul_internals__lemma_mul_distributes_minus_5
))))
