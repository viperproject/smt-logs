...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/basic-cf562145df495703-test_is_core/../../../../vstd/std_specs/bits.rs:522:5: 522:11 (#0)
...
(assert
 (not (=>
   %%location_label%%0
   (= (bvand (bvlshr (bvlshr i! ((_ zero_extend 31) (_ bv1 1))) ((_ sign_extend 26) (bvsub
        ((_ zero_extend 1) (_ bv31 5)) ((_ zero_extend 5) (_ bv0 1))
      ))
