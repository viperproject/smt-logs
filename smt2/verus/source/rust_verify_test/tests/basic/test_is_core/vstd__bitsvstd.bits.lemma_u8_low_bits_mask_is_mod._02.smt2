...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/basic-cf562145df495703-test_is_core/../../../../vstd/bits.rs:334:17: 334:23 (#1183)
...
(declare-const tmp$$$$bitvectmp1 (_ BitVec 8))
(declare-const tmp$$$$bitvectmp3 (_ BitVec 8))
(assert
 true
)
...
(assert
 (not (=>
   %%location_label%%0
   (= (let
     ((tmp$$$$bitvectmp0 (_ bv2 2)))
     (ite
      (= tmp$$$$bitvectmp0 (_ bv0 2))
      tmp$$$$bitvectmp1
      (bvurem x! ((_ zero_extend 6) tmp$$$$bitvectmp0))
     )
    ) (bvand (let
      ((tmp$$$$bitvectmp2 (_ bv2 2)))
      (ite
       (= tmp$$$$bitvectmp2 (_ bv0 2))
       tmp$$$$bitvectmp3
       (bvurem x! ((_ zero_extend 6) tmp$$$$bitvectmp2))
      )
     ) ((_ zero_extend 7) (_ bv1 1))
)))))
(get-info :version)
