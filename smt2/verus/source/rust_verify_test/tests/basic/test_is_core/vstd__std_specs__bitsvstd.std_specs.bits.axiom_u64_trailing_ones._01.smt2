...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/basic-cf562145df495703-test_is_core/../../../../vstd/std_specs/bits.rs:686:5: 686:11 (#0)
...
(assert
 (not (=>
   %%location_label%%0
   (= (bvnot (_ bv18446744073709551615 64)) ((_ zero_extend 63) (_ bv0 1)))
)))
(get-info :version)
