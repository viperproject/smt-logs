...
;; MODULE 'module vstd::shared::Dupe::take_step'
...
(assert
 (distinct fuel%vstd.shared.Dupe.impl&%7.initialize_one. fuel%vstd.shared.Dupe.impl&%7.initialize_one_enabled.
  fuel%vstd.shared.Dupe.impl&%7.invariant. fuel%vstd.shared.Dupe.impl&%7.agreement.
))

;; Datatypes
(declare-datatypes ((core!option.Option. 0) (vstd.shared.Dupe.State. 0)) (((core!option.Option./None)
...
;; Function-Specs crate::vstd::shared::Dupe::take_step::initialize_one
(declare-fun req%vstd.shared.Dupe.take_step.initialize_one. (Dcr Type Poly) Bool)
(declare-const %%global_location_label%%0 Bool)
(assert
 (forall ((T&. Dcr) (T& Type) (t! Poly)) (!
   (= (req%vstd.shared.Dupe.take_step.initialize_one. T&. T& t!) (=>
     %%global_location_label%%0
     (vstd.shared.Dupe.impl&%7.initialize_one_enabled.? T&. T& t!)
   ))
   :pattern ((req%vstd.shared.Dupe.take_step.initialize_one. T&. T& t!))
   :qid internal_req__vstd.shared.Dupe.take_step.initialize_one._definition
   :skolemid skolem_internal_req__vstd.shared.Dupe.take_step.initialize_one._definition
)))
(declare-fun ens%vstd.shared.Dupe.take_step.initialize_one. (Dcr Type Poly vstd.shared.Dupe.State.)
 Bool
)
(assert
 (forall ((T&. Dcr) (T& Type) (t! Poly) (post! vstd.shared.Dupe.State.)) (!
   (= (ens%vstd.shared.Dupe.take_step.initialize_one. T&. T& t! post!) (and
   ...
   :pattern ((ens%vstd.shared.Dupe.take_step.initialize_one. T&. T& t! post!))
   :qid internal_ens__vstd.shared.Dupe.take_step.initialize_one._definition
   :skolemid skolem_internal_ens__vstd.shared.Dupe.take_step.initialize_one._definition
)))
