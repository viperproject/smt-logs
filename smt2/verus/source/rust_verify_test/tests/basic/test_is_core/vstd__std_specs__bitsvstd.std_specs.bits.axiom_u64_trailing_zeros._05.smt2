...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/basic-cf562145df495703-test_is_core/../../../../vstd/std_specs/bits.rs:657:5: 657:11 (#0)
...
(assert
 (not (=>
   ...
   (=>
    ...
    (not (= i! ((_ zero_extend 63) (_ bv1 1))))
))))
(get-info :version)
