...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/basic-cf562145df495703-test_is_core/../../../../vstd/std_specs/bits.rs:149:5: 149:11 (#0)
...
(assert
 (not (=>
   %%location_label%%0
   (= (bvand (bvlshr (bvlshr i! ((_ zero_extend 7) (_ bv1 1))) ((_ sign_extend 4) (bvsub
        ((_ zero_extend 1) (_ bv7 3)) ((_ zero_extend 3) (_ bv0 1))
      ))
