...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/basic-cf562145df495703-test_is_core/../../../../vstd/std_specs/bits.rs:285:5: 285:11 (#0)
...
(assert
 (not (=>
   ...
   (=>
    ...
    (=>
     (= (bvshl (bvlshr i! ((_ zero_extend 15) (_ bv1 1))) (bvsub ((_ zero_extend 11) (_ bv16
          5
         )
        ) x@
       )
     ...
     (= (bvshl i! (bvsub ((_ zero_extend 11) (_ bv16 5)) (bvadd x@ ((_ zero_extend 15) (_ bv1
           1
       ))))
      ) ((_ zero_extend 15) (_ bv0 1))
))))))
