...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/basic-cf562145df495703-test_is_core/../../../../vstd/std_specs/bits.rs:712:5: 712:11 (#0)
...
(assert
 (not (=>
   %%location_label%%0
   (= (bvand (bvlshr (bvlshr i! ((_ zero_extend 63) (_ bv1 1))) ((_ sign_extend 57) (bvsub
        ((_ zero_extend 1) (_ bv63 6)) ((_ zero_extend 6) (_ bv0 1))
      ))
