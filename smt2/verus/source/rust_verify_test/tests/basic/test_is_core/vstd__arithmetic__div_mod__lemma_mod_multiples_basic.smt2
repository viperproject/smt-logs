...
;; MODULE 'module vstd::arithmetic::div_mod, function crate::vstd::arithmetic::div_mod::lemma_mod_multiples_basic'
...
(assert
 (distinct fuel%vstd.arithmetic.internals.mod_internals.mod_auto_plus. fuel%vstd.arithmetic.internals.mod_internals.mod_auto_minus.
  ...
  fuel%vstd.arithmetic.div_mod.lemma_mod_multiples_basic. fuel%vstd.math.add. fuel%vstd.math.sub.
...
;; Function-Def crate::vstd::arithmetic::div_mod::lemma_mod_multiples_basic
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/basic-cf562145df495703-test_is_core/../../../../vstd/arithmetic/div_mod.rs:1136:1: 1136:65 (#0)
...
(push)
 ...
 (assert
  (forall ((%%hole%%0 Int) (%%hole%%1 Int) (%%hole%%2 Int) (u$ Poly)) (!
    (= (%%apply%%0 (%%lambda%%0 %%hole%%0 %%hole%%1 %%hole%%2) u$) (B (= (EucMod (Mul (%I u$)
         %%hole%%0
        ) %%hole%%1
       ) %%hole%%2
    )))
...
(assert
 (=>
  ...
  (forall ((x! Int) (m! Int)) (!
    ...
    :qid user_crate__vstd__arithmetic__div_mod__lemma_mod_multiples_basic_10
    :skolemid skolem_user_crate__vstd__arithmetic__div_mod__lemma_mod_multiples_basic_10
))))
