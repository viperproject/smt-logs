...
;; Function-Def crate::vstd::arithmetic::internals::mod_internals_nonlinear::lemma_mod_of_zero_is_zero
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/basic-cf562145df495703-test_is_core/../../../../vstd/arithmetic/internals/mod_internals_nonlinear.rs:29:7: 29:43 (#0)
...
;; Function-Def crate::vstd::arithmetic::internals::mod_internals_nonlinear::lemma_0_mod_anything
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/basic-cf562145df495703-test_is_core/../../../../vstd/arithmetic/internals/mod_internals_nonlinear.rs:50:7: 50:32 (#0)
(get-info :all-statistics)
(push)
 ...
 (assert
  (not (=>
    ...
    (forall ((m$ Poly)) (!
      ...
      :pattern ((vstd.arithmetic.internals.mod_internals_nonlinear.modulus.? (I 0) m$))
      :qid user_crate__vstd__arithmetic__internals__mod_internals_nonlinear__lemma_0_mod_anything_1
      :skolemid skolem_user_crate__vstd__arithmetic__internals__mod_internals_nonlinear__lemma_0_mod_anything_1
 )))))
 (get-info :version)
 (set-option :rlimit 30000000)
 (check-sat)
