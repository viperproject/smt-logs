...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/basic-cf562145df495703-test_is_core/../../../../vstd/std_specs/bits.rs:670:9: 670:15 (#0)
...
(assert
 (not (=>
   %%location_label%%0
   (=>
    (bvule y@ ((_ zero_extend 57) (_ bv64 7)))
    (=>
     (and
      (= (bvshl i! (bvsub ((_ zero_extend 57) (_ bv64 7)) y@)) ((_ zero_extend 63) (_ bv0
         1
      )))
      (and
       (bvule ((_ zero_extend 63) (_ bv0 1)) j@)
       (bvult j@ y@)
     ))
     (= (bvand (bvlshr i! j@) ((_ zero_extend 63) (_ bv1 1))) ((_ zero_extend 63) (_ bv0
        1
))))))))
(get-info :version)
