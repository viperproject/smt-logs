...
;; MODULE 'module vstd::bytes, function crate::vstd::bytes::lemma_auto_spec_u16_to_from_le_bytes'
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/basic-cf562145df495703-test_is_core/../../../../vstd/bytes.rs:65:9: 65:15 (#0)
...
(assert
 (distinct fuel%vstd.array.array_view. fuel%vstd.array.impl&%0.view. fuel%vstd.bytes.spec_u16_to_le_bytes.
  fuel%vstd.bytes.spec_u16_from_le_bytes. fuel%vstd.seq.impl&%0.spec_index. fuel%vstd.seq.axiom_seq_index_decreases.
...
;; Function-Def crate::vstd::bytes::lemma_auto_spec_u16_to_from_le_bytes
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/basic-cf562145df495703-test_is_core/../../../../vstd/bytes.rs:65:9: 65:15 (#0)
...
(assert
 (not (=>
   ...
   (=>
    (and
     (and
      (= x$1@ (bvor s0@ (bvshl s1@ ((_ zero_extend 12) (_ bv8 4)))))
      (bvult s0@ ((_ zero_extend 7) (_ bv256 9)))
     )
     (bvult s1@ ((_ zero_extend 7) (_ bv256 9)))
    )
    (and
     (= s0@ (bvand x$1@ ((_ zero_extend 8) (_ bv255 8))))
     (= s1@ (bvand (bvlshr x$1@ ((_ zero_extend 12) (_ bv8 4))) ((_ zero_extend 8) (_ bv255
         8
)))))))))
(get-info :version)
