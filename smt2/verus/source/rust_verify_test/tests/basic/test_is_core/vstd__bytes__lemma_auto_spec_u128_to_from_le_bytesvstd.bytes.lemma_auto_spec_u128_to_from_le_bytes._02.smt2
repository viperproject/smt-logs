...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/basic-cf562145df495703-test_is_core/../../../../vstd/bytes.rs:406:9: 406:15 (#0)
...
(assert
 (not (=>
   %%location_label%%0
   (= x@ (bvor (bvor (bvor (bvor (bvor (bvor (bvor (bvor (bvor (bvor (bvor (bvor (bvor (bvor (bvor (
                    bvand x@ ((_ zero_extend 120) (_ bv255 8))
                   ) (bvshl (bvand (bvlshr x@ ((_ zero_extend 124) (_ bv8 4))) ((_ zero_extend 120) (_ bv255
                       8
                     ))
                    ) ((_ zero_extend 124) (_ bv8 4))
                   )
                  ) (bvshl (bvand (bvlshr x@ ((_ zero_extend 123) (_ bv16 5))) ((_ zero_extend 120) (_
                      bv255 8
                    ))
                   ) ((_ zero_extend 123) (_ bv16 5))
                  )
                 ) (bvshl (bvand (bvlshr x@ ((_ zero_extend 123) (_ bv24 5))) ((_ zero_extend 120) (_
                     bv255 8
                   ))
                  ) ((_ zero_extend 123) (_ bv24 5))
                 )
                ) (bvshl (bvand (bvlshr x@ ((_ zero_extend 122) (_ bv32 6))) ((_ zero_extend 120) (_
                    bv255 8
                  ))
                 ) ((_ zero_extend 122) (_ bv32 6))
                )
               ) (bvshl (bvand (bvlshr x@ ((_ zero_extend 122) (_ bv40 6))) ((_ zero_extend 120) (_
                   bv255 8
                 ))
                ) ((_ zero_extend 122) (_ bv40 6))
               )
              ) (bvshl (bvand (bvlshr x@ ((_ zero_extend 122) (_ bv48 6))) ((_ zero_extend 120) (_
                  bv255 8
                ))
               ) ((_ zero_extend 122) (_ bv48 6))
              )
             ) (bvshl (bvand (bvlshr x@ ((_ zero_extend 122) (_ bv56 6))) ((_ zero_extend 120) (_
                 bv255 8
               ))
              ) ((_ zero_extend 122) (_ bv56 6))
             )
            ) (bvshl (bvand (bvlshr x@ ((_ zero_extend 121) (_ bv64 7))) ((_ zero_extend 120) (_
                bv255 8
              ))
             ) ((_ zero_extend 121) (_ bv64 7))
            )
           ) (bvshl (bvand (bvlshr x@ ((_ zero_extend 121) (_ bv72 7))) ((_ zero_extend 120) (_
               bv255 8
             ))
            ) ((_ zero_extend 121) (_ bv72 7))
           )
          ) (bvshl (bvand (bvlshr x@ ((_ zero_extend 121) (_ bv80 7))) ((_ zero_extend 120) (_
              bv255 8
            ))
           ) ((_ zero_extend 121) (_ bv80 7))
          )
         ) (bvshl (bvand (bvlshr x@ ((_ zero_extend 121) (_ bv88 7))) ((_ zero_extend 120) (_
             bv255 8
           ))
          ) ((_ zero_extend 121) (_ bv88 7))
         )
        ) (bvshl (bvand (bvlshr x@ ((_ zero_extend 121) (_ bv96 7))) ((_ zero_extend 120) (_
            bv255 8
          ))
         ) ((_ zero_extend 121) (_ bv96 7))
        )
       ) (bvshl (bvand (bvlshr x@ ((_ zero_extend 121) (_ bv104 7))) ((_ zero_extend 120) (
           _ bv255 8
         ))
        ) ((_ zero_extend 121) (_ bv104 7))
       )
      ) (bvshl (bvand (bvlshr x@ ((_ zero_extend 121) (_ bv112 7))) ((_ zero_extend 120) (
          _ bv255 8
        ))
       ) ((_ zero_extend 121) (_ bv112 7))
      )
     ) (bvshl (bvand (bvlshr x@ ((_ zero_extend 121) (_ bv120 7))) ((_ zero_extend 120) (
         _ bv255 8
       ))
      ) ((_ zero_extend 121) (_ bv120 7))
))))))
(get-info :version)
