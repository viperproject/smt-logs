...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/basic-cf562145df495703-test_is_core/../../../../vstd/std_specs/bits.rs:334:5: 334:11 (#0)
...
(assert
 (not (=>
   %%location_label%%0
   (= (bvand (bvlshr (bvlshr i! ((_ zero_extend 15) (_ bv1 1))) ((_ sign_extend 11) (bvsub
        ((_ zero_extend 1) (_ bv15 4)) ((_ zero_extend 4) (_ bv0 1))
      ))
     ) ((_ zero_extend 15) (_ bv1 1))
