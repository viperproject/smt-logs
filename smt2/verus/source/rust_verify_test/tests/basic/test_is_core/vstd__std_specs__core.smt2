...
;; MODULE 'module vstd::std_specs::core'
...
(declare-datatypes ((core!option.Option. 0) (core!result.Result. 0) (core!marker.PhantomData.
  ...
  ) ((core!marker.PhantomData./PhantomData)) ((tuple%0./tuple%0))
))
...
(declare-fun TYPE%core!mem.manually_drop.ManuallyDrop. (Dcr Type) Type)
...
;; Function-Decl crate::vstd::std_specs::core::iter_into_iter_spec
...
;; Function-Specs core::intrinsics::likely
(declare-fun ens%core!intrinsics.likely. (Bool Bool) Bool)
(assert
 (forall ((b! Bool) (c! Bool)) (!
   (= (ens%core!intrinsics.likely. b! c!) (= c! b!))
   :pattern ((ens%core!intrinsics.likely. b! c!))
   :qid internal_ens__core!intrinsics.likely._definition
   :skolemid skolem_internal_ens__core!intrinsics.likely._definition
)))

;; Function-Specs core::intrinsics::unlikely
(declare-fun ens%core!intrinsics.unlikely. (Bool Bool) Bool)
(assert
 (forall ((b! Bool) (c! Bool)) (!
   (= (ens%core!intrinsics.unlikely. b! c!) (= c! b!))
   :pattern ((ens%core!intrinsics.unlikely. b! c!))
   :qid internal_ens__core!intrinsics.unlikely._definition
   :skolemid skolem_internal_ens__core!intrinsics.unlikely._definition
)))

;; Function-Axioms crate::vstd::std_specs::core::iter_into_iter_spec
(assert
