...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/basic-cf562145df495703-test_is_core/../../../../vstd/bits.rs:365:15: 365:52 (#1162)
...
;; Function-Def crate::vstd::bits::lemma_u64_and_split_low_bit
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/basic-cf562145df495703-test_is_core/../../../../vstd/bits.rs:365:15: 365:52 (#1162)
...
(declare-const tmp$$$$bitvectmp5 (_ BitVec 64))
(declare-const tmp$$$$bitvectmp7 (_ BitVec 64))
 ...
 (not (=>
   ...
   (= (bvand x! m!) (bvadd (bvmul (bvand (let
        ...
        (ite
         ...
         tmp$$$$bitvectmp1
         (bvudiv x! ((_ zero_extend 62) tmp$$$$bitvectmp0))
        )
       ) (let
        ...
        (ite
         ...
         tmp$$$$bitvectmp3
         (bvudiv m! ((_ zero_extend 62) tmp$$$$bitvectmp2))
       ))
       ...
       (ite
        ...
        tmp$$$$bitvectmp5
        (bvurem x! ((_ zero_extend 62) tmp$$$$bitvectmp4))
       )
      ) (let
       ...
       (ite
        ...
        tmp$$$$bitvectmp7
        (bvurem m! ((_ zero_extend 62) tmp$$$$bitvectmp6))
))))))))
(get-info :version)
