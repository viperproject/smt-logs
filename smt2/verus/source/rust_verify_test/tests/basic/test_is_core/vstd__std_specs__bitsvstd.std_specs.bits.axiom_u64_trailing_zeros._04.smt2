...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/basic-cf562145df495703-test_is_core/../../../../vstd/std_specs/bits.rs:656:5: 656:11 (#0)
 ...
 (not (=>
   ...
   (= (let
     ...
     (ite
      ...
      tmp$$$$bitvectmp1
      (bvudiv i! ((_ zero_extend 62) tmp$$$$bitvectmp0))
     )
    ) (bvlshr i! ((_ zero_extend 63) (_ bv1 1)))
))))
(get-info :version)
