...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/basic-cf562145df495703-test_is_core/../../../../vstd/std_specs/bits.rs:662:5: 662:11 (#0)
...
(assert
 (not (=>
   %%location_label%%0
   (=>
    (= (bvand i! ((_ zero_extend 63) (_ bv1 1))) ((_ zero_extend 63) (_ bv0 1)))
    (=>
     (= (bvshl (bvlshr i! ((_ zero_extend 63) (_ bv1 1))) (bvsub ((_ zero_extend 57) (_ bv64
          7
         )
        ) x@
       )
     ...
     (= (bvshl i! (bvsub ((_ zero_extend 57) (_ bv64 7)) (bvadd x@ ((_ zero_extend 63) (_ bv1
           1
       ))))
      ) ((_ zero_extend 63) (_ bv0 1))
))))))
