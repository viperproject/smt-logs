...
;; MODULE 'module vstd::arithmetic::internals::mod_internals, function crate::vstd::arithmetic::internals::mod_internals::lemma_mod_add_denominator'
...
(assert
 (distinct fuel%vstd.arithmetic.internals.mul_internals.lemma_mul_commutes. fuel%vstd.arithmetic.internals.mul_internals.lemma_mul_distributes_plus.
  ...
  fuel%vstd.arithmetic.mul.lemma_mul_is_distributive_sub_other_way. fuel%vstd.arithmetic.internals.mul_internals.group_mul_properties_internal.
...
(assert
 (=>
  ...
  (forall ((x! Int) (y! Int) (z! Int)) (!
    ...
    :qid user_crate__vstd__arithmetic__mul__lemma_mul_is_distributive_add_1
    :skolemid skolem_user_crate__vstd__arithmetic__mul__lemma_mul_is_distributive_add_1
))))
...
(assert
 (=>
  ...
  (forall ((x! Int) (y! Int)) (!
    (= (Mul x! y!) (Mul y! x!))
    :pattern ((Mul x! y!))
    :qid user_crate__vstd__arithmetic__internals__mul_internals__lemma_mul_commutes_2
    :skolemid skolem_user_crate__vstd__arithmetic__internals__mul_internals__lemma_mul_commutes_2
))))
...
(assert
 (=>
  ...
  (forall ((x! Int) (y! Int) (z! Int)) (!
    ...
    :qid user_crate__vstd__arithmetic__internals__mul_internals__lemma_mul_distributes_plus_3
    :skolemid skolem_user_crate__vstd__arithmetic__internals__mul_internals__lemma_mul_distributes_plus_3
))))
...
(assert
 (=>
  ...
  (forall ((x! Int) (y! Int) (z! Int)) (!
    ...
    :qid user_crate__vstd__arithmetic__internals__mul_internals__lemma_mul_distributes_minus_4
    :skolemid skolem_user_crate__vstd__arithmetic__internals__mul_internals__lemma_mul_distributes_minus_4
))))
...
(assert
 (=>
  ...
  (forall ((x! Int) (y! Int) (z! Int)) (!
    ...
    :qid user_crate__vstd__arithmetic__mul__lemma_mul_is_distributive_add_other_way_5
    :skolemid skolem_user_crate__vstd__arithmetic__mul__lemma_mul_is_distributive_add_other_way_5
))))
...
(assert
 (=>
  ...
  (forall ((x! Int) (y! Int) (z! Int)) (!
    ...
    :qid user_crate__vstd__arithmetic__mul__lemma_mul_is_distributive_sub_6
    :skolemid skolem_user_crate__vstd__arithmetic__mul__lemma_mul_is_distributive_sub_6
))))
...
(assert
 (=>
  ...
  (forall ((x! Int) (y! Int) (z! Int)) (!
    ...
    :qid user_crate__vstd__arithmetic__mul__lemma_mul_is_distributive_sub_other_way_7
    :skolemid skolem_user_crate__vstd__arithmetic__mul__lemma_mul_is_distributive_sub_other_way_7
))))
...
(assert
 (=>
  ...
  (forall ((x! Int) (y! Int) (z! Int)) (!
    ...
    :qid user_crate__vstd__arithmetic__mul__lemma_mul_inequality_8
    :skolemid skolem_user_crate__vstd__arithmetic__mul__lemma_mul_inequality_8
))))
...
;; Function-Def crate::vstd::arithmetic::internals::mod_internals::lemma_mod_add_denominator
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/basic-cf562145df495703-test_is_core/../../../../vstd/arithmetic/internals/mod_internals.rs:196:1: 196:55 (#0)
         ...
         (and
          (and
           (=>
            ...
            (=>
             %%location_label%%2
             (= (Mul n! (Sub (Sub (EucDiv (Add x! n!) n!) (EucDiv x! n!)) 1)) (Sub (Mul n! (Sub (EucDiv
                  (Add x! n!) n!
                 ) (EucDiv x! n!)
                )
               ) n!
           ...
           (=>
            ...
            (=>
             %%location_label%%3
             (= (Mul n! zp@) (Sub (Mul n! (Sub (EucDiv (Add x! n!) n!) (EucDiv x! n!))) n!))
          )))
          (=>
           (= (Mul n! zp@) (Sub (Mul n! (Sub (EucDiv (Add x! n!) n!) (EucDiv x! n!))) n!))
           (and
