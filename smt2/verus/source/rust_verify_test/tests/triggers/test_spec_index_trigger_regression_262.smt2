...
(declare-fun test_crate!foo.? (Poly) Bool)
...
;; Function-Specs test_crate::f
(declare-fun req%test_crate!f. (vstd!seq.Seq<nat.>.) Bool)
(declare-const %%global_location_label%%2 Bool)
(declare-const %%global_location_label%%3 Bool)
(assert
 (forall ((s! vstd!seq.Seq<nat.>.)) (!
   (= (req%test_crate!f. s!) (and
     (=>
      %%global_location_label%%2
      (= (vstd!seq.Seq.len.? $ NAT (Poly%vstd!seq.Seq<nat.>. s!)) 10)
     )
     (=>
      ...
      (forall ((r$ Poly)) (!
        (=>
         ...
         (and
          (test_crate!foo.? r$)
          (< 0 (%I (vstd!seq.Seq.index.? $ NAT (Poly%vstd!seq.Seq<nat.>. s!) r$)))
        ))
        :pattern ((vstd!seq.Seq.index.? $ NAT (Poly%vstd!seq.Seq<nat.>. s!) r$))
        :qid user_test_crate__f_5
        :skolemid skolem_user_test_crate__f_5
   )))))
   :pattern ((req%test_crate!f. s!))
   :qid internal_req__test_crate!f._definition
   :skolemid skolem_internal_req__test_crate!f._definition
)))

;; Function-Def test_crate::f
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/triggers-6bc46aa0f19547fb-test_spec_index_trigger_regression_262/test.rs:19:7: 19:24 (#0)
(get-info :all-statistics)
(push)
 (declare-const s! vstd!seq.Seq<nat.>.)
 ...
 (assert
  (forall ((r$ Poly)) (!
    ...
    :pattern ((vstd!seq.Seq.index.? $ NAT (Poly%vstd!seq.Seq<nat.>. s!) r$))
    :qid user_test_crate__f_6
    :skolemid skolem_user_test_crate__f_6
 )))
 ;; assertion failed
 (declare-const %%location_label%%0 Bool)
 (assert
  (not (=>
    (= tmp%1 (< 0 (%I (vstd!seq.Seq.index.? $ NAT (Poly%vstd!seq.Seq<nat.>. s!) (I 3)))))
    (=>
     %%location_label%%0
     tmp%1
 ))))
