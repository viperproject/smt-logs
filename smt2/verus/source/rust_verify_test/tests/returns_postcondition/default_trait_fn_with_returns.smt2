...
(declare-fun ens%Tr.test. (Dcr Type Poly Poly) Bool)
(assert
 (forall ((Self%&. Dcr) (Self%& Type) (self! Poly) (%return! Poly)) (!
   (= (ens%Tr.test. Self%&. Self%& self! %return!) (and
     (has_type %return! Self%&)
     (= %return! self!)
   ))
   :pattern ((ens%Tr.test. Self%&. Self%& self! %return!))
   :qid internal_ens__Tr.test._definition
   :skolemid skolem_internal_ens__Tr.test._definition
)))

;; Function-Def crate::Tr::test
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/returns_postcondition-a69f6b6a80bc9aa7-default_trait_fn_with_returns/test.rs:16:5: 16:28 (#0)
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/returns_postcondition-a69f6b6a80bc9aa7-default_trait_fn_with_returns/test.rs:28:1: 28:22 (#0)
(get-info :all-statistics)
(push)
 (declare-const T&. Dcr)
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/returns_postcondition-a69f6b6a80bc9aa7-default_trait_fn_with_returns/test.rs:33:1: 33:22 (#0)
(get-info :all-statistics)
(push)
 (declare-const T&. Dcr)
 (declare-const T& Type)
