...
;; Datatypes
(declare-sort test_crate!Obj<test_crate!Node.>. 0)
(declare-sort vstd!raw_ptr.DynMetadata. 0)
(declare-sort vstd!raw_ptr.Provenance. 0)
(declare-sort vstd!seq.Seq<test_crate!Node.>. 0)
(declare-sort slice%<test_crate!Node.>. 0)
(declare-sort allocator_global%. 0)
(declare-datatypes ((vstd!raw_ptr.Metadata. 0) (vstd!raw_ptr.PtrData. 0) (test_crate!Node.
   0
  ) (test_crate!Data. 0) (tuple%0. 0)
  ...
  ) ((test_crate!Node./Node)) ((test_crate!Data./Data (test_crate!Data./Data/?x Int)
    (test_crate!Data./Data/?y Poly)
   )
  ) ((tuple%0./tuple%0))
))
...
(declare-fun test_crate!Data./Data/x (test_crate!Data.) Int)
(declare-fun test_crate!Data./Data/y (test_crate!Data.) Poly)
...
(declare-const TYPE%test_crate!Node. Type)
(declare-fun TYPE%test_crate!Data. (Dcr Type) Type)
(declare-fun TYPE%test_crate!Obj. (Dcr Type) Type)
(declare-const TYPE%tuple%0. Type)
(declare-fun Poly%test_crate!Obj<test_crate!Node.>. (test_crate!Obj<test_crate!Node.>.)
 Poly
)
(declare-fun %Poly%test_crate!Obj<test_crate!Node.>. (Poly) test_crate!Obj<test_crate!Node.>.)
...
(declare-fun Poly%vstd!seq.Seq<test_crate!Node.>. (vstd!seq.Seq<test_crate!Node.>.)
 Poly
)
(declare-fun %Poly%vstd!seq.Seq<test_crate!Node.>. (Poly) vstd!seq.Seq<test_crate!Node.>.)
(declare-fun Poly%slice%<test_crate!Node.>. (slice%<test_crate!Node.>.) Poly)
(declare-fun %Poly%slice%<test_crate!Node.>. (Poly) slice%<test_crate!Node.>.)
...
(assert
 (forall ((x test_crate!Obj<test_crate!Node.>.)) (!
   (= x (%Poly%test_crate!Obj<test_crate!Node.>. (Poly%test_crate!Obj<test_crate!Node.>.
      x
   )))
   :pattern ((Poly%test_crate!Obj<test_crate!Node.>. x))
   :qid internal_test_crate__Obj<test_crate!Node.>_box_axiom_definition
   :skolemid skolem_internal_test_crate__Obj<test_crate!Node.>_box_axiom_definition
)))
(assert
 (forall ((x Poly)) (!
   (=>
    (has_type x (TYPE%test_crate!Obj. $ TYPE%test_crate!Node.))
    (= x (Poly%test_crate!Obj<test_crate!Node.>. (%Poly%test_crate!Obj<test_crate!Node.>.
       x
   ))))
   :pattern ((has_type x (TYPE%test_crate!Obj. $ TYPE%test_crate!Node.)))
   :qid internal_test_crate__Obj<test_crate!Node.>_unbox_axiom_definition
   :skolemid skolem_internal_test_crate__Obj<test_crate!Node.>_unbox_axiom_definition
)))
(assert
 (forall ((x test_crate!Obj<test_crate!Node.>.)) (!
   (has_type (Poly%test_crate!Obj<test_crate!Node.>. x) (TYPE%test_crate!Obj. $ TYPE%test_crate!Node.))
   :pattern ((has_type (Poly%test_crate!Obj<test_crate!Node.>. x) (TYPE%test_crate!Obj.
      $ TYPE%test_crate!Node.
   )))
   :qid internal_test_crate__Obj<test_crate!Node.>_has_type_always_definition
   :skolemid skolem_internal_test_crate__Obj<test_crate!Node.>_has_type_always_definition
)))
(assert
...
(assert
 (forall ((x vstd!seq.Seq<test_crate!Node.>.)) (!
   (= x (%Poly%vstd!seq.Seq<test_crate!Node.>. (Poly%vstd!seq.Seq<test_crate!Node.>. x)))
   :pattern ((Poly%vstd!seq.Seq<test_crate!Node.>. x))
   :qid internal_vstd__seq__Seq<test_crate!Node.>_box_axiom_definition
   :skolemid skolem_internal_vstd__seq__Seq<test_crate!Node.>_box_axiom_definition
)))
(assert
 (forall ((x Poly)) (!
   (=>
    (has_type x (TYPE%vstd!seq.Seq. $ TYPE%test_crate!Node.))
    (= x (Poly%vstd!seq.Seq<test_crate!Node.>. (%Poly%vstd!seq.Seq<test_crate!Node.>. x)))
   )
   :pattern ((has_type x (TYPE%vstd!seq.Seq. $ TYPE%test_crate!Node.)))
   :qid internal_vstd__seq__Seq<test_crate!Node.>_unbox_axiom_definition
   :skolemid skolem_internal_vstd__seq__Seq<test_crate!Node.>_unbox_axiom_definition
)))
(assert
 (forall ((x vstd!seq.Seq<test_crate!Node.>.)) (!
   (has_type (Poly%vstd!seq.Seq<test_crate!Node.>. x) (TYPE%vstd!seq.Seq. $ TYPE%test_crate!Node.))
   :pattern ((has_type (Poly%vstd!seq.Seq<test_crate!Node.>. x) (TYPE%vstd!seq.Seq. $ TYPE%test_crate!Node.)))
   :qid internal_vstd__seq__Seq<test_crate!Node.>_has_type_always_definition
   :skolemid skolem_internal_vstd__seq__Seq<test_crate!Node.>_has_type_always_definition
)))
(assert
 (forall ((x slice%<test_crate!Node.>.)) (!
   (= x (%Poly%slice%<test_crate!Node.>. (Poly%slice%<test_crate!Node.>. x)))
   :pattern ((Poly%slice%<test_crate!Node.>. x))
   :qid internal_crate__slice__<test_crate!Node.>_box_axiom_definition
   :skolemid skolem_internal_crate__slice__<test_crate!Node.>_box_axiom_definition
)))
(assert
 (forall ((x Poly)) (!
   (=>
    (has_type x (SLICE $ TYPE%test_crate!Node.))
    (= x (Poly%slice%<test_crate!Node.>. (%Poly%slice%<test_crate!Node.>. x)))
   )
   :pattern ((has_type x (SLICE $ TYPE%test_crate!Node.)))
   :qid internal_crate__slice__<test_crate!Node.>_unbox_axiom_definition
   :skolemid skolem_internal_crate__slice__<test_crate!Node.>_unbox_axiom_definition
)))
(assert
 (forall ((x slice%<test_crate!Node.>.)) (!
   (has_type (Poly%slice%<test_crate!Node.>. x) (SLICE $ TYPE%test_crate!Node.))
   :pattern ((has_type (Poly%slice%<test_crate!Node.>. x) (SLICE $ TYPE%test_crate!Node.)))
   :qid internal_crate__slice__<test_crate!Node.>_has_type_always_definition
   :skolemid skolem_internal_crate__slice__<test_crate!Node.>_has_type_always_definition
)))
(assert
...
(assert
 (forall ((x Poly)) (!
   (=>
    (has_type x TYPE%test_crate!Node.)
    (= x (Poly%test_crate!Node. (%Poly%test_crate!Node. x)))
   )
   :pattern ((has_type x TYPE%test_crate!Node.))
   :qid internal_test_crate__Node_unbox_axiom_definition
   :skolemid skolem_internal_test_crate__Node_unbox_axiom_definition
)))
(assert
 (forall ((x test_crate!Node.)) (!
   (has_type (Poly%test_crate!Node. x) TYPE%test_crate!Node.)
   :pattern ((has_type (Poly%test_crate!Node. x) TYPE%test_crate!Node.))
   :qid internal_test_crate__Node_has_type_always_definition
   :skolemid skolem_internal_test_crate__Node_has_type_always_definition
)))
(assert
...
(assert
 (forall ((T&. Dcr) (T& Type) (x Poly)) (!
   (=>
    (has_type x (TYPE%test_crate!Data. T&. T&))
    (= x (Poly%test_crate!Data. (%Poly%test_crate!Data. x)))
   )
   :pattern ((has_type x (TYPE%test_crate!Data. T&. T&)))
   :qid internal_test_crate__Data_unbox_axiom_definition
   :skolemid skolem_internal_test_crate__Data_unbox_axiom_definition
)))
(assert
 (forall ((T&. Dcr) (T& Type) (_x! Int) (_y! Poly)) (!
   (=>
    (has_type _y! (SLICE T&. T&))
    (has_type (Poly%test_crate!Data. (test_crate!Data./Data _x! _y!)) (TYPE%test_crate!Data.
      T&. T&
   )))
   :pattern ((has_type (Poly%test_crate!Data. (test_crate!Data./Data _x! _y!)) (TYPE%test_crate!Data.
      T&. T&
   )))
   :qid internal_test_crate!Data./Data_constructor_definition
   :skolemid skolem_internal_test_crate!Data./Data_constructor_definition
)))
(assert
 (forall ((x test_crate!Data.)) (!
   (= (test_crate!Data./Data/x x) (test_crate!Data./Data/?x x))
   :pattern ((test_crate!Data./Data/x x))
   :qid internal_test_crate!Data./Data/x_accessor_definition
   :skolemid skolem_internal_test_crate!Data./Data/x_accessor_definition
)))
(assert
 (forall ((x test_crate!Data.)) (!
   (= (test_crate!Data./Data/y x) (test_crate!Data./Data/?y x))
   :pattern ((test_crate!Data./Data/y x))
   :qid internal_test_crate!Data./Data/y_accessor_definition
   :skolemid skolem_internal_test_crate!Data./Data/y_accessor_definition
)))
(assert
 (forall ((T&. Dcr) (T& Type) (x Poly)) (!
   (=>
    (has_type x (TYPE%test_crate!Data. T&. T&))
    (has_type (test_crate!Data./Data/y (%Poly%test_crate!Data. x)) (SLICE T&. T&))
   )
   :pattern ((test_crate!Data./Data/y (%Poly%test_crate!Data. x)) (has_type x (TYPE%test_crate!Data.
      T&. T&
   )))
   :qid internal_test_crate!Data./Data/y_invariant_definition
   :skolemid skolem_internal_test_crate!Data./Data/y_invariant_definition
)))
(assert
 (forall ((x test_crate!Data.)) (!
   (=>
    (is-test_crate!Data./Data x)
    (height_lt (height (test_crate!Data./Data/y x)) (height (Poly%test_crate!Data. x)))
   )
   :pattern ((height (test_crate!Data./Data/y x)))
   :qid prelude_datatype_height_test_crate!Data./Data/y
   :skolemid skolem_prelude_datatype_height_test_crate!Data./Data/y
)))
(assert
 (forall ((x tuple%0.)) (!
...
;; Function-Decl test_crate::Obj::view
(declare-fun test_crate!impl&%0.view.? (Dcr Type Poly) test_crate!Data.)
...
;; Function-Axioms test_crate::Obj::view
(assert
 (forall ((T&. Dcr) (T& Type) (self! Poly)) (!
   (=>
    (has_type self! (TYPE%test_crate!Obj. T&. T&))
    (has_type (Poly%test_crate!Data. (test_crate!impl&%0.view.? T&. T& self!)) (TYPE%test_crate!Data.
      T&. T&
   )))
   :pattern ((test_crate!impl&%0.view.? T&. T& self!))
   :qid internal_test_crate!impl&__0.view.?_pre_post_definition
   :skolemid skolem_internal_test_crate!impl&__0.view.?_pre_post_definition
)))
...
(declare-fun ens%test_crate!test. (test_crate!Obj<test_crate!Node.>. test_crate!Obj<test_crate!Node.>.)
 Bool
)
(assert
 (forall ((pre%x! test_crate!Obj<test_crate!Node.>.) (x! test_crate!Obj<test_crate!Node.>.))
  (!
   (= (ens%test_crate!test. pre%x! x!) (= (vstd!seq.Seq.len.? $ TYPE%test_crate!Node. (
       vstd!view.View.view.? $ (SLICE $ TYPE%test_crate!Node.) (test_crate!Data./Data/y (
         %Poly%test_crate!Data. (Poly%test_crate!Data. (test_crate!impl&%0.view.? $ TYPE%test_crate!Node.
           (Poly%test_crate!Obj<test_crate!Node.>. x!)
      )))))
     ) (vstd!seq.Seq.len.? $ TYPE%test_crate!Node. (vstd!view.View.view.? $ (SLICE $ TYPE%test_crate!Node.)
       (test_crate!Data./Data/y (%Poly%test_crate!Data. (Poly%test_crate!Data. (test_crate!impl&%0.view.?
           $ TYPE%test_crate!Node. (Poly%test_crate!Obj<test_crate!Node.>. pre%x!)
   ))))))))
   :pattern ((ens%test_crate!test. pre%x! x!))
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/generics-f20d107bb25349b4-test_generic_primitive_has_type/test.rs:32:1: 32:27 (#0)
(get-info :all-statistics)
(push)
 (declare-const x!@0 test_crate!Obj<test_crate!Node.>.)
 (assert
  fuel_defaults
 )
 ...
 (assert
  (not (=>
    ...
    (= (vstd!seq.Seq.len.? $ TYPE%test_crate!Node. (vstd!view.View.view.? $ (SLICE $ TYPE%test_crate!Node.)
       (test_crate!Data./Data/y (%Poly%test_crate!Data. (Poly%test_crate!Data. (test_crate!impl&%0.view.?
           $ TYPE%test_crate!Node. (Poly%test_crate!Obj<test_crate!Node.>. x!@0)
      )))))
     ) (vstd!seq.Seq.len.? $ TYPE%test_crate!Node. (vstd!view.View.view.? $ (SLICE $ TYPE%test_crate!Node.)
       (test_crate!Data./Data/y (%Poly%test_crate!Data. (Poly%test_crate!Data. (test_crate!impl&%0.view.?
           $ TYPE%test_crate!Node. (Poly%test_crate!Obj<test_crate!Node.>. x!@0)
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/generics-f20d107bb25349b4-test_generic_primitive_has_type/test.rs:37:1: 37:23 (#0)
(get-info :all-statistics)
(push)
 (declare-const x! test_crate!Obj<test_crate!Node.>.)
 (declare-const verus_tmp_j@ slice%<test_crate!Node.>.)
 (declare-const verus_tmp_h@ slice%<test_crate!Node.>.)
 (declare-const tmp%1 Bool)
 (declare-const verus_tmp@0 slice%<test_crate!Node.>.)
 (declare-const j@0 slice%<test_crate!Node.>.)
 (declare-const x2@0 test_crate!Obj<test_crate!Node.>.)
 (declare-const verus_tmp$1@0 slice%<test_crate!Node.>.)
 (declare-const h@0 slice%<test_crate!Node.>.)
 (assert
  fuel_defaults
 )
 (declare-const verus_tmp@1 slice%<test_crate!Node.>.)
 (declare-const j@1 slice%<test_crate!Node.>.)
 (declare-const x2@1 test_crate!Obj<test_crate!Node.>.)
 (declare-const verus_tmp$1@1 slice%<test_crate!Node.>.)
 (declare-const h@1 slice%<test_crate!Node.>.)
 ;; assertion failed
 (declare-const %%location_label%%0 Bool)
 (assert
  (not (=>
    (= verus_tmp@1 (%Poly%slice%<test_crate!Node.>. (test_crate!Data./Data/y (%Poly%test_crate!Data.
        (Poly%test_crate!Data. (test_crate!impl&%0.view.? $ TYPE%test_crate!Node. (Poly%test_crate!Obj<test_crate!Node.>.
           x!
    )))))))
    (=>
     (= verus_tmp_j@ verus_tmp@1)
     (=>
      (= j@1 verus_tmp_j@)
      (=>
       (= x2@0 x!)
       (=>
        (ens%test_crate!test. x2@0 x2@1)
        (=>
         (= verus_tmp$1@1 (%Poly%slice%<test_crate!Node.>. (test_crate!Data./Data/y (%Poly%test_crate!Data.
             (Poly%test_crate!Data. (test_crate!impl&%0.view.? $ TYPE%test_crate!Node. (Poly%test_crate!Obj<test_crate!Node.>.
                x2@1
         )))))))
         (=>
          (= verus_tmp_h@ verus_tmp$1@1)
          (=>
           (= h@1 verus_tmp_h@)
           (=>
            (= tmp%1 (= (vstd!seq.Seq.len.? $ TYPE%test_crate!Node. (vstd!view.View.view.? $ (SLICE
                 $ TYPE%test_crate!Node.
                ) (Poly%slice%<test_crate!Node.>. j@1)
               )
              ) (vstd!seq.Seq.len.? $ TYPE%test_crate!Node. (vstd!view.View.view.? $ (SLICE $ TYPE%test_crate!Node.)
                (Poly%slice%<test_crate!Node.>. h@1)
            ))))
            (=>
             %%location_label%%0
             tmp%1
