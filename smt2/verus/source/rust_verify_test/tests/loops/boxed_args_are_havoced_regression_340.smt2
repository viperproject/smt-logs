...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/loops-2d70692a01dbf123-boxed_args_are_havoced_regression_340/test.rs:45:5: 48:6 (#0)
...
(push)
 ...
 (assert
  (has_type tmp%1 (TYPE%test_crate!Mod.X. $ (UINT 64)))
 )
 (assert
  (iInv 32 i@0)
 )
...
;; Function-Def test_crate::test1
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/loops-2d70692a01dbf123-boxed_args_are_havoced_regression_340/test.rs:39:1: 39:11 (#0)
(get-info :all-statistics)
(push)
 (declare-const no%param Int)
 (declare-const tmp%1 Poly)
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/loops-2d70692a01dbf123-boxed_args_are_havoced_regression_340/test.rs:59:5: 62:6 (#0)
(get-info :all-statistics)
(push)
 (declare-const no%param Int)
 (declare-const tmp%1 Poly)
 ...
 (assert
  (not (=>
    (< i@0 5)
    (=>
     (ens%test_crate!Mod.some_mutator. $ (UINT 64) (Poly%test_crate!Mod.X<u64.>. x@0) (
       Poly%test_crate!Mod.X<u64.>. x@1
     ))
     (=>
      %%location_label%%0
...
;; Function-Def test_crate::test2
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/loops-2d70692a01dbf123-boxed_args_are_havoced_regression_340/test.rs:53:1: 53:11 (#0)
(get-info :all-statistics)
(push)
 (declare-const no%param Int)
 (declare-const tmp%1 Poly)
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/loops-2d70692a01dbf123-boxed_args_are_havoced_regression_340/test.rs:71:5: 77:6 (#0)
(get-info :all-statistics)
(push)
 (declare-const no%param Int)
 (declare-const tmp%1 Poly)
 ...
 (assert
  (has_type tmp%1 (TYPE%alloc!vec.Vec. $ (UINT 64) $ ALLOCATOR_GLOBAL))
 )
 (assert
  (iInv 32 i@0)
 )
    ...
    (=>
     ...
     (=>
      (ens%alloc!vec.impl&%1.push. $ (UINT 64) $ ALLOCATOR_GLOBAL (Poly%alloc!vec.Vec<u64./allocator_global%.>.
        v@0
       ) (Poly%alloc!vec.Vec<u64./allocator_global%.>. v@1) (I 7)
      )
      (and
       (=>
        %%location_label%%0
...
;; Function-Def test_crate::test3
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/loops-2d70692a01dbf123-boxed_args_are_havoced_regression_340/test.rs:67:1: 67:11 (#0)
(get-info :all-statistics)
(push)
 (declare-const no%param Int)
 (declare-const tmp%1 Poly)
