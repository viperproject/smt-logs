...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/loops-2d70692a01dbf123-for_loop_vec_custom_iterator/test.rs:29:5: 29:43 (#0)
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/loops-2d70692a01dbf123-for_loop_vec_custom_iterator/test.rs:117:1: 117:74 (#0)
(get-info :all-statistics)
(push)
 (declare-const T&. Dcr)
 (declare-const T& Type)
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/loops-2d70692a01dbf123-for_loop_vec_custom_iterator/test.rs:130:5: 135:6 (#0)
(get-info :all-statistics)
(push)
 ...
 (assert
  (has_type (Poly%test_crate!VecIterCopy. tmp%1) (TYPE%test_crate!VecIterCopy. $ (UINT
     8
 ))))
 (assert
  (has_type tmp%2 (TYPE%test_crate!VecIterCopy. $ (UINT 8)))
 )
 (assert
  (has_type (Poly%test_crate!VecIterCopy. tmp%%@) (TYPE%test_crate!VecIterCopy. $ (UINT
     8
 ))))
 (assert
  (has_type (Poly%test_crate!VecIterCopy. VERUS_exec_iter@0) (TYPE%test_crate!VecIterCopy.
    $ (UINT 8)
 )))
 (assert
  (has_type (Poly%test_crate!VecGhostIterCopy. iter@0) (TYPE%test_crate!VecGhostIterCopy.
    $ (UINT 8)
 )))
 ...
 (assert
  (not (=>
    (%B (vstd!pervasive.ForLoopGhostIterator.exec_invariant.? $ (TYPE%test_crate!VecGhostIterCopy.
       $ (UINT 8)
      ) (Poly%test_crate!VecGhostIterCopy. iter@0) (Poly%test_crate!VecIterCopy. VERUS_exec_iter@0)
    ))
    (=>
     (%B (vstd!pervasive.ForLoopGhostIterator.ghost_invariant.? $ (TYPE%test_crate!VecGhostIterCopy.
        $ (UINT 8)
       ) (Poly%test_crate!VecGhostIterCopy. iter@0) (Poly%core!option.Option. (core!option.Option./Some
         (vstd!pervasive.ForLoopGhostIteratorNew.ghost_iter.? $ (TYPE%test_crate!VecIterCopy.
           $ (UINT 8)
     ...
     (=>
           ...
           (=>
            (and
             ...
             (< (%I i$) (test_crate!VecGhostIterCopy./VecGhostIterCopy/cur (%Poly%test_crate!VecGhostIterCopy.
                (Poly%test_crate!VecGhostIterCopy. iter@0)
            ))))
            (> (%I (vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec.
                 $ (UINT 8) $ ALLOCATOR_GLOBAL
                ) (Poly%alloc!vec.Vec<u8./allocator_global%.>. v!)
      ...
      (=>
       ...
       (=>
        (ens%test_crate!impl&%0.next. $ (UINT 8) VERUS_exec_iter@0 VERUS_exec_iter@1 tmp%%$1@)
        (or
         (and
          (=>
          ...
          (=>
           ...
           (and
            (=>
             ...
             (%B (vstd!pervasive.ForLoopGhostIterator.exec_invariant.? $ (TYPE%test_crate!VecGhostIterCopy.
                $ (UINT 8)
               ) (Poly%test_crate!VecGhostIterCopy. iter@0) (Poly%test_crate!VecIterCopy. VERUS_exec_iter@1)
            )))
            (and
             (=>
              %%location_label%%1
             ...
             (and
              ...
              (=>
               %%location_label%%3
               (%B (vstd!pervasive.ForLoopGhostIterator.ghost_ensures.? $ (TYPE%test_crate!VecGhostIterCopy.
                  $ (UINT 8)
                 ) (Poly%test_crate!VecGhostIterCopy. iter@0)
         ))))))))
         (and
          ...
          (=>
           ...
           (=>
            ...
            (=>
             ...
             (=>
              (= iter@1 (%Poly%test_crate!VecGhostIterCopy. (vstd!pervasive.ForLoopGhostIterator.ghost_advance.?
                 $ (TYPE%test_crate!VecGhostIterCopy. $ (UINT 8)) (Poly%test_crate!VecGhostIterCopy.
                  iter@0
                 ) (Poly%test_crate!VecIterCopy. VERUS_exec_iter@1)
              )))
              (and
               (=>
                %%location_label%%4
                (%B (vstd!pervasive.ForLoopGhostIterator.exec_invariant.? $ (TYPE%test_crate!VecGhostIterCopy.
                   $ (UINT 8)
                  ) (Poly%test_crate!VecGhostIterCopy. iter@1) (Poly%test_crate!VecIterCopy. VERUS_exec_iter@1)
               )))
               (and
                (=>
                 %%location_label%%5
...
;; Function-Def test_crate::all_positive
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/loops-2d70692a01dbf123-for_loop_vec_custom_iterator/test.rs:124:1: 124:41 (#0)
(get-info :all-statistics)
(push)
 (declare-const b! Bool)
 (declare-const v! alloc!vec.Vec<u8./allocator_global%.>.)
