...
(assert
 (distinct fuel%vstd!std_specs.core.iter_into_iter_spec. fuel%vstd!std_specs.option.impl&%0.is_Some.
  ...
  fuel%vstd!std_specs.range.impl&%1.ghost_advance. fuel%vstd!std_specs.range.impl&%6.spec_is_lt.
  fuel%vstd!std_specs.range.impl&%6.spec_forward_checked. fuel%vstd!std_specs.range.impl&%6.spec_forward_checked_int.
  fuel%vstd!std_specs.range.axiom_spec_range_next_u64. fuel%vstd!std_specs.range.impl&%8.spec_is_lt.
  fuel%vstd!std_specs.range.impl&%8.spec_forward_checked. fuel%vstd!std_specs.range.impl&%8.spec_forward_checked_int.
  fuel%vstd!std_specs.range.axiom_spec_range_next_usize. fuel%vstd!std_specs.range.impl&%11.spec_is_lt.
  fuel%vstd!std_specs.range.impl&%11.spec_forward_checked. fuel%vstd!std_specs.range.impl&%11.spec_forward_checked_int.
  fuel%vstd!std_specs.range.axiom_spec_range_next_i32. fuel%vstd!array.group_array_axioms.
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/loops-2d70692a01dbf123-for_loop1/test.rs:18:5: 24:6 (#0)
...
(push)
 ...
 (assert
  (has_type tmp%1 (TYPE%core!ops.range.Range. $ (SINT 32)))
 )
 (assert
  (has_type (Poly%core!ops.range.Range. tmp%2) (TYPE%core!ops.range.Range. $ (SINT 32)))
 )
 (assert
  (has_type (Poly%core!ops.range.Range. tmp%%@) (TYPE%core!ops.range.Range. $ (SINT 32)))
 )
 (assert
    ...
    (=>
     (%B (vstd!pervasive.ForLoopGhostIterator.ghost_invariant.? $ (TYPE%vstd!std_specs.range.RangeGhostIterator.
        ...
        (core!option.Option./Some (vstd!pervasive.ForLoopGhostIteratorNew.ghost_iter.? $ (TYPE%core!ops.range.Range.
           $ (SINT 32)
          ) (vstd!std_specs.core.iter_into_iter_spec.? $ (TYPE%core!ops.range.Range. $ (SINT 32))
           (Poly%core!ops.range.Range. (core!ops.range.Range./Range (I 0) (I 10)))
     ))))))
     (=>
      (let
       ((x$ (ite
          (is-core!option.Option./Some (%Poly%core!option.Option. (vstd!pervasive.ForLoopGhostIterator.ghost_peek_next.?
             $ (TYPE%vstd!std_specs.range.RangeGhostIterator. $ (SINT 32)) (Poly%vstd!std_specs.range.RangeGhostIterator.
              iter@0
          ))))
          (let
          ...
          (%I (vstd!pervasive.arbitrary.? $ (SINT 32)))
       )))
       (= n@0 (Mul (%I (vstd!std_specs.range.RangeGhostIterator./RangeGhostIterator/cur (%Poly%vstd!std_specs.range.RangeGhostIterator.
      ...
      (=>
       ...
       (=>
        (ens%core!iter.range.impl&%6.next. $ (SINT 32) VERUS_exec_iter@0 VERUS_exec_iter@1
         tmp%%$1@
        )
        (or
         (and
           ...
           (=>
            ...
            (and
             ...
             (=>
              tmp%3
              (=>
               (= tmp%4 (= x@ (%I (vstd!std_specs.range.RangeGhostIterator./RangeGhostIterator/cur (
                    %Poly%vstd!std_specs.range.RangeGhostIterator. (Poly%vstd!std_specs.range.RangeGhostIterator.
                     iter@0
               ))))))
               (and
                (=>
                      ...
                      (and
                       ...
                       (=>
                        ...
                        (let
                         ...
                         (= n@1 (Mul (%I (vstd!std_specs.range.RangeGhostIterator./RangeGhostIterator/cur (%Poly%vstd!std_specs.range.RangeGhostIterator.
...
;; Function-Def test_crate::test_loop
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/loops-2d70692a01dbf123-for_loop1/test.rs:16:1: 16:15 (#0)
(get-info :all-statistics)
(push)
 (declare-const no%param Int)
 (declare-const tmp%1 Poly)
  ...
  (not (=>
    ...
    (=>
     ...
     (=>
      ...
      (=>
       (= tmp%%@ (%Poly%core!ops.range.Range. tmp%1))
       (=>
        ...
        (=>
         (= iter@1 (%Poly%vstd!std_specs.range.RangeGhostIterator. (vstd!pervasive.ForLoopGhostIteratorNew.ghost_iter.?
            $ (TYPE%core!ops.range.Range. $ (SINT 32)) (Poly%core!ops.range.Range. VERUS_exec_iter@0)
         )))
         (and
          (=>
           %%location_label%%0
...
;; Function-Def test_crate::test_loop_peek
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/loops-2d70692a01dbf123-for_loop1/test.rs:30:5: 35:6 (#0)
(get-info :all-statistics)
(push)
 (declare-const no%param Int)
 (declare-const tmp%1 Poly)
...
;; Function-Def test_crate::test_loop_peek
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/loops-2d70692a01dbf123-for_loop1/test.rs:28:1: 28:20 (#0)
(get-info :all-statistics)
(push)
 (declare-const no%param Int)
 (declare-const tmp%1 Poly)
     ...
     (=>
      ...
      (=>
       ...
       (=>
        (= VERUS_exec_iter@0 tmp%%@)
        (=>
         (= VERUS_ghost_iter@1 (%Poly%vstd!std_specs.range.RangeGhostIterator. (vstd!pervasive.ForLoopGhostIteratorNew.ghost_iter.?
            $ (TYPE%core!ops.range.Range. $ (SINT 32)) (Poly%core!ops.range.Range. VERUS_exec_iter@0)
         )))
         (and
          (=>
           ...
           (and
            ...
            (=>
             ...
             (=>
              ...
              (=>
               (has_type (Poly%vstd!std_specs.range.RangeGhostIterator. VERUS_ghost_iter@2) (TYPE%vstd!std_specs.range.RangeGhostIterator.
                 $ (SINT 32)
               ))
               (=>
                (%B (vstd!pervasive.ForLoopGhostIterator.exec_invariant.? $ (TYPE%vstd!std_specs.range.RangeGhostIterator.
                   $ (SINT 32)
                  ) (Poly%vstd!std_specs.range.RangeGhostIterator. VERUS_ghost_iter@2) (Poly%core!ops.range.Range.
                   VERUS_exec_iter@1
                )))
                (=>
                 (%B (vstd!pervasive.ForLoopGhostIterator.ghost_invariant.? $ (TYPE%vstd!std_specs.range.RangeGhostIterator.
                    $ (SINT 32)
                   ) (Poly%vstd!std_specs.range.RangeGhostIterator. VERUS_ghost_iter@2) (Poly%core!option.Option.
                    (core!option.Option./Some (vstd!pervasive.ForLoopGhostIteratorNew.ghost_iter.? $ (TYPE%core!ops.range.Range.
                       $ (SINT 32)
                      ) (vstd!std_specs.core.iter_into_iter_spec.? $ (TYPE%core!ops.range.Range. $ (SINT 32))
                       (Poly%core!ops.range.Range. (core!ops.range.Range./Range (I 0) (I 10)))
                 ...
                 (=>
                  ...
                  (=>
                   (%B (vstd!pervasive.ForLoopGhostIterator.ghost_ensures.? $ (TYPE%vstd!std_specs.range.RangeGhostIterator.
                      $ (SINT 32)
                     ) (Poly%vstd!std_specs.range.RangeGhostIterator. VERUS_ghost_iter@2)
                   ))
                   (=>
                    (= VERUS_loop_result@ tuple%0./tuple%0)
                    (=>
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/loops-2d70692a01dbf123-for_loop1/test.rs:41:5: 47:6 (#0)
(get-info :all-statistics)
(push)
 (declare-const no%param Int)
 (declare-const tmp%1 Poly)
...
;; Function-Def test_crate::test_loop_fail
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/loops-2d70692a01dbf123-for_loop1/test.rs:39:1: 39:20 (#0)
(get-info :all-statistics)
(push)
 (declare-const no%param Int)
 (declare-const tmp%1 Poly)
