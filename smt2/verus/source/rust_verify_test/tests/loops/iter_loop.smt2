...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/loops-2d70692a01dbf123-iter_loop/test.rs:19:5: 34:6 (#0)
...
(push)
 ...
 (assert
  (has_type (Poly%core!ops.range.Range. iter@0) (TYPE%core!ops.range.Range. $ (SINT 32)))
 )
    ...
    (=>
     ...
     (=>
      ...
      (=>
       ...
       (=>
        (ens%core!iter.range.impl&%6.next. $ (SINT 32) iter@0 iter@1 tmp%%@)
        (or
         (and
          (=>
           (is-core!option.Option./Some tmp%%@)
              ...
              (=>
               ...
               (=>
                (= tmp%4 (= x@ (Sub (%I (core!ops.range.Range./Range/start (%Poly%core!ops.range.Range.
                      (Poly%core!ops.range.Range. iter@1)
                    ))
                   ) 1
                )))
                (and
...
;; Function-Def test_crate::test_loop
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/loops-2d70692a01dbf123-iter_loop/test.rs:16:1: 16:15 (#0)
(get-info :all-statistics)
(push)
 (declare-const no%param Int)
 (declare-const tmp%1 Poly)
...
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/loops-2d70692a01dbf123-iter_loop/test.rs:42:5: 57:6 (#0)
(get-info :all-statistics)
(push)
 (declare-const no%param Int)
 (declare-const tmp%1 Poly)
...
;; Function-Def test_crate::test_loop_fail
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/loops-2d70692a01dbf123-iter_loop/test.rs:39:1: 39:20 (#0)
(get-info :all-statistics)
(push)
 (declare-const no%param Int)
 (declare-const tmp%1 Poly)
