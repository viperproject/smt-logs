...
;; Fuel
(declare-const fuel%test_crate!f_is_true. FuelId)
...
(assert
 (distinct fuel%test_crate!f_is_true. fuel%vstd!array.group_array_axioms. fuel%vstd!map.group_map_axioms.
...
(declare-fun test_crate!f.? (Poly) Bool)

;; Broadcast test_crate::f_is_true
(assert
 (=>
  (fuel_bool fuel%test_crate!f_is_true.)
  (test_crate!f.? (I 0))
))
