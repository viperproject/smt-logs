...
(declare-const fuel%ring.Ring_succ. FuelId)
(declare-const fuel%ring.Ring_prev. FuelId)
(assert
 (distinct fuel%ring.impl&%0.inv. fuel%ring.impl&%0.succ. fuel%ring.impl&%0.prev. fuel%ring.Ring_succ.
  fuel%ring.Ring_prev.
))
...
(assert
 (=>
  ...
  (forall ((self! Poly)) (!
    (= (ring.impl&%0.inv.? self!) (< (ring.Ring./Ring/i (%Poly%ring.Ring. self!)) 10))
    :pattern ((ring.impl&%0.inv.? self!))
...
(assert
 (=>
  ...
  (forall ((self! Poly)) (!
    (= (ring.impl&%0.succ.? self!) (ring.Ring./Ring (%I (I (ite
...
(assert
 (=>
  ...
  (forall ((self! Poly)) (!
    (= (ring.impl&%0.prev.? self!) (ring.Ring./Ring (%I (I (ite
...
;; Function-Def crate::ring::Ring_succ
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/broadcast_forall-4e960397774ab489-test_ring_algebra_mod_level_3/test.rs:36:5: 36:46 (#0)
...
;; Broadcast crate::ring::Ring_succ
(assert
 (=>
  (fuel_bool fuel%ring.Ring_succ.)
  (forall ((p! Poly)) (!
    (=>
    ...
    :qid user_crate__ring__Ring_succ_0
    :skolemid skolem_user_crate__ring__Ring_succ_0
))))

;; Function-Def crate::ring::Ring_prev
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/broadcast_forall-4e960397774ab489-test_ring_algebra_mod_level_3/test.rs:41:5: 41:46 (#0)
(get-info :all-statistics)
(push)
 (declare-const p! ring.Ring.)
 (assert
...
;; Broadcast crate::ring::Ring_prev
(assert
 (=>
  (fuel_bool fuel%ring.Ring_prev.)
  (forall ((p! Poly)) (!
    (=>
     (has_type p! TYPE%ring.Ring.)
     (=>
    ...
    :qid user_crate__ring__Ring_prev_1
    :skolemid skolem_user_crate__ring__Ring_prev_1
))))
