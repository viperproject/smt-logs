...
;; Fuel
(declare-const fuel%test_crate!X.impl&%4.stuff. FuelId)
...
(assert
 (distinct fuel%test_crate!X.impl&%4.stuff. fuel%vstd!array.group_array_axioms. fuel%vstd!map.group_map_axioms.
...
(declare-datatypes ((test_crate!X.State. 0) (tuple%0. 0)) (((test_crate!X.State./State
    (test_crate!X.State./State/?a Int)
   )
  ) ((tuple%0./tuple%0))
))
...
;; Function-Decl test_crate::X::State::stuff
(declare-fun test_crate!X.impl&%4.stuff.? (Poly Poly) Bool)

;; Function-Decl test_crate::X::State::next
(declare-fun test_crate!X.impl&%4.next.? (Poly Poly) Bool)

;; Function-Axioms test_crate::X::State::stuff
(assert
 (fuel_bool_default fuel%test_crate!X.impl&%4.stuff.)
)
(assert
 (=>
  (fuel_bool fuel%test_crate!X.impl&%4.stuff.)
  (forall ((pre! Poly) (post! Poly)) (!
    (= (test_crate!X.impl&%4.stuff.? pre! post!) (let
      ((update_tmp_a$ 5))
      (= (test_crate!X.State./State/a (%Poly%test_crate!X.State. post!)) update_tmp_a$)
    ))
    :pattern ((test_crate!X.impl&%4.stuff.? pre! post!))
    :qid internal_test_crate!X.impl&__4.stuff.?_definition
    :skolemid skolem_internal_test_crate!X.impl&__4.stuff.?_definition
))))

;; Function-Specs test_crate::X::show::stuff
(declare-fun req%test_crate!X.show.stuff. (test_crate!X.State. test_crate!X.State.)
 Bool
)
(declare-const %%global_location_label%%0 Bool)
(assert
 (forall ((pre! test_crate!X.State.) (post! test_crate!X.State.)) (!
   (= (req%test_crate!X.show.stuff. pre! post!) (=>
     %%global_location_label%%0
     (test_crate!X.impl&%4.stuff.? (Poly%test_crate!X.State. pre!) (Poly%test_crate!X.State.
       post!
   ))))
   :pattern ((req%test_crate!X.show.stuff. pre! post!))
   :qid internal_req__test_crate!X.show.stuff._definition
   :skolemid skolem_internal_req__test_crate!X.show.stuff._definition
)))
(declare-fun ens%test_crate!X.show.stuff. (test_crate!X.State. test_crate!X.State.)
 Bool
)
(assert
 (forall ((pre! test_crate!X.State.) (post! test_crate!X.State.)) (!
   (= (ens%test_crate!X.show.stuff. pre! post!) (test_crate!X.impl&%4.next.? (Poly%test_crate!X.State.
      pre!
     ) (Poly%test_crate!X.State. post!)
   ))
   :pattern ((ens%test_crate!X.show.stuff. pre! post!))
   :qid internal_ens__test_crate!X.show.stuff._definition
   :skolemid skolem_internal_ens__test_crate!X.show.stuff._definition
)))
