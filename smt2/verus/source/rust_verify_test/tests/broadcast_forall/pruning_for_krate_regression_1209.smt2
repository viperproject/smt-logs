...
(assert
 (distinct fuel%vstd!arithmetic.div_mod.lemma_mod_breakdown. fuel%vstd!array.group_array_axioms.
...
(assert
 (=>
  ...
  (forall ((x! Int) (y! Int) (z! Int)) (!
    ...
    :qid user_vstd__arithmetic__div_mod__lemma_mod_breakdown_0
    :skolemid skolem_user_vstd__arithmetic__div_mod__lemma_mod_breakdown_0
))))

;; Function-Specs test_crate::mod_mult_zero_implies_mod_zero
(declare-fun req%test_crate!mod_mult_zero_implies_mod_zero. (Int Int Int) Bool)
(declare-const %%global_location_label%%3 Bool)
(declare-const %%global_location_label%%4 Bool)
(declare-const %%global_location_label%%5 Bool)
(assert
 (forall ((a! Int) (b! Int) (c! Int)) (!
   (= (req%test_crate!mod_mult_zero_implies_mod_zero. a! b! c!) (and
     (=>
      %%global_location_label%%3
      (= (nClip (EucMod a! (nClip (Mul b! c!)))) 0)
     )
     (=>
   ...
   :pattern ((req%test_crate!mod_mult_zero_implies_mod_zero. a! b! c!))
   :qid internal_req__test_crate!mod_mult_zero_implies_mod_zero._definition
   :skolemid skolem_internal_req__test_crate!mod_mult_zero_implies_mod_zero._definition
)))
(declare-fun ens%test_crate!mod_mult_zero_implies_mod_zero. (Int Int Int) Bool)
(assert
 (forall ((a! Int) (b! Int) (c! Int)) (!
   (= (ens%test_crate!mod_mult_zero_implies_mod_zero. a! b! c!) (= (nClip (EucMod a! b!))
     0
   ))
   :pattern ((ens%test_crate!mod_mult_zero_implies_mod_zero. a! b! c!))
   :qid internal_ens__test_crate!mod_mult_zero_implies_mod_zero._definition
   :skolemid skolem_internal_ens__test_crate!mod_mult_zero_implies_mod_zero._definition
)))

;; Function-Def test_crate::mod_mult_zero_implies_mod_zero
;; /home/runner/work/smt-logs/smt-logs/verus/verus/source/target/release/test_inputs/broadcast_forall-4e960397774ab489-pruning_for_krate_regression_1209/test.rs:15:1: 15:68 (#0)
